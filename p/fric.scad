...
// 1 16 -1 -2 -5.925 0 1 0 0 0 2 -0.125 0 0 rect3.dat
  [1,16,-1,-2,-5.925,0,1,0,0,0,2,-0.125,0,0, ldraw_lib__rect3()],
// 1 16 1 -2 -5.925 0 -1 0 0 0 2 0.125 0 0 rect3.dat
  [1,16,1,-2,-5.925,0,-1,0,0,0,2,0.125,0,0, ldraw_lib__rect3()],
// 1 16 0 -4 -6.25 0 0 -1 -1 0 0 0 0.25 0.2 1-4cylo.dat
  [1,16,0,-4,-6.25,0,0,-1,-1,0,0,0,0.25,0.2, ldraw_lib__1_4cylo()],
// 1 16 0 -4 -6.25 1 0 0 0 0 -1 0.2 0.25 0 1-4cylo.dat
  [1,16,0,-4,-6.25,1,0,0,0,0,-1,0.2,0.25,0, ldraw_lib__1_4cylo()],
...
// 1 16 0 -4 -6.25 0 0 -1 -1 0 0 0 1 0.2 1-4chrd.dat
  [1,16,0,-4,-6.25,0,0,-1,-1,0,0,0,1,0.2, ldraw_lib__1_4chrd()],
// 1 16 0 -4 -6.25 1 0 0 0 0 -1 0.2 1 0 1-4chrd.dat
  [1,16,0,-4,-6.25,1,0,0,0,0,-1,0.2,1,0, ldraw_lib__1_4chrd()],
...
module ldraw_lib__fric(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__fric(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
