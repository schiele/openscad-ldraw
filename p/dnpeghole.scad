...
use <rect1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__dnpeghole(realsolid=false) = [
...
// 1 16 -17.351 -2 0 -2.649 0 0 0 1 0 0 0 -18.5 rect1.dat
  [1,16,-17.351,-2,0,-2.649,0,0,0,1,0,0,0,-18.5, ldraw_lib__rect1(realsolid)],
...
// 1 16 0 -2 0 0 0 1.5 0 -16 0 5.2983 0 0 box3u8p.dat
  [1,16,0,-2,0,0,0,1.5,0,-16,0,5.2983,0,0, ldraw_lib__box3u8p(realsolid)],
...
// 1 16 0 -2 -20 15 0 0 0 1 0 0 0 15 2-4edge.dat
  [1,16,0,-2,-20,15,0,0,0,1,0,0,0,15, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -2 20 15 0 0 0 1 0 0 0 -15 2-4edge.dat
  [1,16,0,-2,20,15,0,0,0,1,0,0,0,-15, ldraw_lib__2_4edge(realsolid)],
// 4 16 5.741 2 -6.142 -5.741 2 -6.142 -5.741 2 6.142 5.741 2 6.142
  [4,16,5.741,2,-6.142,-5.741,2,-6.142,-5.741,2,6.142,5.741,2,6.142],
...
module ldraw_lib__dnpeghole(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__dnpeghole(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
