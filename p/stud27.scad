...
use <4-4ring6.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stud27(realsolid=false) = [
...
// 1 16 0 0 0 0 0 11 0 -4 0 11 0 0 4-4cylo.dat
  [1,16,0,0,0,0,0,11,0,-4,0,11,0,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 0 0 0 0 14 0 -4 0 14 0 0 4-4cylo.dat
  [1,16,0,0,0,0,0,14,0,-4,0,14,0,0, ldraw_lib__4_4cylo(realsolid)],
...
module ldraw_lib__stud27(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stud27(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
