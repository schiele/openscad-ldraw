...
// 1 16 0 0 0 5.54328 0 -2.2961 0 1 0 2.2961 0 5.54328 1-8edge.dat
  [1,16,0,0,0,5.54328,0,-2.2961,0,1,0,2.2961,0,5.54328, ldraw_lib__1_8edge()],
...
// 1 16 0 0 0 2.2961 0 5.54328 0 1 0 -5.54328 0 2.2961 1-8edge.dat
  [1,16,0,0,0,2.2961,0,5.54328,0,1,0,-5.54328,0,2.2961, ldraw_lib__1_8edge()],
...
module ldraw_lib__axlehol3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__axlehol3(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
