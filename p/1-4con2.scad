use <../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__1_4con2(realsolid=false) = [
// 0 Cone  2 x 0.25
// 0 Name: 1-4con2.dat
...
module ldraw_lib__1_4con2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__1_4con2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__1_4con2(line=0.2);