...
use <stud20.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stug20_3x3(realsolid=false) = [
...
// 1 16 -40 0 40 1 0 0 0 1 0 0 0 1 stud20.dat
  [1,16,-40,0,40,1,0,0,0,1,0,0,0,1, ldraw_lib__stud20(realsolid)],
...
module ldraw_lib__stug20_3x3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stug20_3x3(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
