...
// 1 16 0 -4 0 8 0 0 0 4 0 0 0 8 1-4cylo.dat
  [1,16,0,-4,0,8,0,0,0,4,0,0,0,8, ldraw_lib__1_4cylo()],
// 1 16 0 -4 0 2 0 0 0 1 0 0 0 2 1-4ring3.dat
  [1,16,0,-4,0,2,0,0,0,1,0,0,0,2, ldraw_lib__1_4ring3()],
];
module ldraw_lib__1_4stud4(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__1_4stud4(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
