...
use <rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__peghole4(realsolid=false) = [
...
// 1 16 8 1 -4.5 0 1 0 1 0 0 0 0 -4.5 rect3.dat
  [1,16,8,1,-4.5,0,1,0,1,0,0,0,0,-4.5, ldraw_lib__rect3(realsolid)],
// 1 16 -8 1 -4.5 0 -1 0 1 0 0 0 0 -4.5 rect3.dat
  [1,16,-8,1,-4.5,0,-1,0,1,0,0,0,0,-4.5, ldraw_lib__rect3(realsolid)],
// 2 24 8 2 -9 -8 2 -9
  [2,24,8,2,-9,-8,2,-9],
...
module ldraw_lib__peghole4(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__peghole4(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
