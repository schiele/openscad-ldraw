use <../../lib.scad>
function ldraw_lib__48__1_4ring1() = [
// 0 Hi-Res Ring  1 x 0.25
// 0 Name: 48\1-4ring1.dat
...
// 0 !HISTORY 2024-01-06 [Holly-Wood] Complete regeneration, original by guyvivan
...
module ldraw_lib__48__1_4ring1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__1_4ring1(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__1_4ring1(line=0.2);