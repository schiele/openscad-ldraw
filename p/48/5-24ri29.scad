use <../../lib.scad>
use <5-24ring29.scad>
function ldraw_lib__48__5_24ri29() = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 48\5-24ring29.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__5_24ring29()],
];
module ldraw_lib__48__5_24ri29(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__5_24ri29(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
