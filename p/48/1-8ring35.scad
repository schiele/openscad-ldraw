use <../../lib.scad>
function ldraw_lib__48__1_8ring35() = [
// 0 Hi-Res Ring 35 x 0.125
// 0 Name: 48\1-8ring35.dat
...
// 0 !HISTORY 2024-03-23 [OrionP] Moved from 48\1-8rin35.dat
...
module ldraw_lib__48__1_8ring35(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__1_8ring35(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__1_8ring35(line=0.2);