use <../../lib.scad>
function ldraw_lib__48__3_16ring3() = [
// 0 Hi-Res Ring  3 x 0.1875
// 0 Name: 48\3-16ring3.dat
// 0 Author: Rene Rechthaler [Blechtaler]
// 0 !LDRAW_ORG 48_Primitive UPDATE 2026-04
...
module ldraw_lib__48__3_16ring3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__3_16ring3(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__3_16ring3(line=0.2);