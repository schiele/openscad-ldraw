use <../../lib.scad>
function ldraw_lib__48__1_8rin28() = [
// 0 ~Hi-Res Ring 28 x 0.125 (Obsolete)
...
// 0 !HISTORY 2024-03-23 [OrionP] Obsolete, use 48\1-8ring28.dat
...
module ldraw_lib__48__1_8rin28(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__1_8rin28(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
