use <../../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48__3_16cyli2(realsolid=false) = [
// 0 Hi-Res Cylinder 0.1875
// 0 Name: 48\3-16cyli2.dat
// 0 Author: Massimo Maso [Sirio]
// 0 !LDRAW_ORG 48_Primitive UPDATE 2022-06
...
module ldraw_lib__48__3_16cyli2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__3_16cyli2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__3_16cyli2(line=0.2);