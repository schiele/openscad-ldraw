...
use <1-24edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48__1_24cylo(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 48\1-24edge.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__1_24edge(realsolid)],
// 1 16 0 1 0 1 0 0 0 1 0 0 0 1 48\1-24edge.dat
  [1,16,0,1,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__1_24edge(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 48\1-24cyli.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__1_24cyli(realsolid)],
];
module ldraw_lib__48__1_24cylo(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__1_24cylo(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
