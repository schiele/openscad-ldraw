use <../../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48__11_48ring9(realsolid=false) = [
// 0 Hi-Res Ring  9 x 0.2292
// 0 Name: 48\11-48ring9.dat
...
module ldraw_lib__48__11_48ring9(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__11_48ring9(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__11_48ring9(line=0.2);