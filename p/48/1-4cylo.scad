...
use <1-4edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48__1_4cylo(realsolid=false) = [
...
// 1 16 0 1 0 1 0 0 0 1 0 0 0 1 48\1-4edge.dat
  [1,16,0,1,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__1_4edge(realsolid)],
...
module ldraw_lib__48__1_4cylo(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__1_4cylo(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
