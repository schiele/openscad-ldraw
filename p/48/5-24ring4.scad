use <../../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48__5_24ring4(realsolid=false) = [
// 0 Hi-Res Ring  4 x 0.2083
// 0 Name: 48\5-24ring4.dat
...
module ldraw_lib__48__5_24ring4(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__5_24ring4(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__5_24ring4(line=0.2);