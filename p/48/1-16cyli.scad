use <../../lib.scad>
function ldraw_lib__48__1_16cyli() = [
...
// 0 !HISTORY 2024-01-10 [Holly-Wood] Complete regeneration, original by guyvivan
...
// 5 24 0.9659 1 0.2588 0.9659 0 0.2588 0.9914 1 0.1305 0.9239 1 0.3827
  [5,24,0.9659,1,0.2588,0.9659,0,0.2588,0.9914,1,0.1305,0.9239,1,0.3827],
// 5 24 0.9239 1 0.3827 0.9239 0 0.3827 0.9659 1 0.2588 0.8735 1 0.5043
  [5,24,0.9239,1,0.3827,0.9239,0,0.3827,0.9659,1,0.2588,0.8735,1,0.5043],
// 0 // Build by LDPartEditor (PrimGen 2.X)
];
module ldraw_lib__48__1_16cyli(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__1_16cyli(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__1_16cyli(line=0.2);