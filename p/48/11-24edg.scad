...
use <11-24edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48__11_24edg(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 48\11-24edge.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__11_24edge(realsolid)],
];
module ldraw_lib__48__11_24edg(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__11_24edg(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
