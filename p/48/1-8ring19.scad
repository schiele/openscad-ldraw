use <../../lib.scad>
function ldraw_lib__48__1_8ring19() = [
// 0 Hi-Res Ring 19 x 0.125
// 0 Name: 48\1-8ring19.dat
...
// 0 !HISTORY 2024-03-07 [Holly-Wood] Complete regeneration, original by guyvivan
...
module ldraw_lib__48__1_8ring19(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__1_8ring19(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__1_8ring19(line=0.2);