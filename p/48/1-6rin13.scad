use <../../lib.scad>
function ldraw_lib__48__1_6rin13() = [
// 0 ~Hi-Res Ring 13 x 0.1667 (Obsolete)
...
module ldraw_lib__48__1_6rin13(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__1_6rin13(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
