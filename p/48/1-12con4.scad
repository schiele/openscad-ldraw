use <../../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48__1_12con4(realsolid=false) = [
// 0 Hi-Res Cone  4 x 0.0833
// 0 Name: 48\1-12con4.dat
...
module ldraw_lib__48__1_12con4(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__1_12con4(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__1_12con4(line=0.2);