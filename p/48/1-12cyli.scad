use <../../lib.scad>
function ldraw_lib__48__1_12cyli() = [
...
// 0 !HISTORY 2024-01-08 [Holly-Wood] Complete regeneration, original by westrate
...
// 5 24 0.9239 1 0.3827 0.9239 0 0.3827 0.9659 1 0.2588 0.866 1 0.5
  [5,24,0.9239,1,0.3827,0.9239,0,0.3827,0.9659,1,0.2588,0.866,1,0.5],
// 5 24 0.866 1 0.5 0.866 0 0.5 0.9239 1 0.3827 0.8002 1 0.614
  [5,24,0.866,1,0.5,0.866,0,0.5,0.9239,1,0.3827,0.8002,1,0.614],
// 0 // Build by LDPartEditor (PrimGen 2.X)
];
module ldraw_lib__48__1_12cyli(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__1_12cyli(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__1_12cyli(line=0.2);