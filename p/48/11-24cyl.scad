...
use <11-24cyli.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48__11_24cyl(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 48\11-24cyli.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__11_24cyli(realsolid)],
];
module ldraw_lib__48__11_24cyl(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__11_24cyl(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
