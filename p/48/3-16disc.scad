use <../../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48__3_16disc(realsolid=false) = [
...
module ldraw_lib__48__3_16disc(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__3_16disc(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__3_16disc(line=0.2);