use <../../lib.scad>
use <1-12con24.scad>
function ldraw_lib__48__1_12co24() = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 48\1-12con24.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__1_12con24()],
];
module ldraw_lib__48__1_12co24(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__1_12co24(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
