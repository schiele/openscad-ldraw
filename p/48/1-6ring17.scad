use <../../lib.scad>
function ldraw_lib__48__1_6ring17() = [
// 0 Hi-Res Ring 17 x 0.1667
// 0 Name: 48\1-6ring17.dat
...
// 0 !HISTORY 2024-02-17 [Holly-Wood] Complete re-write, original by Brickaneer
...
module ldraw_lib__48__1_6ring17(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__1_6ring17(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__1_6ring17(line=0.2);