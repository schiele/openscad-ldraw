use <../../lib.scad>
function ldraw_lib__48__5_48ring19() = [
// 0 Hi-Res Ring 19 x 0.1042
// 0 Name: 48\5-48ring19.dat
...
module ldraw_lib__48__5_48ring19(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__5_48ring19(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__5_48ring19(line=0.2);