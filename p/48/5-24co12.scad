use <../../lib.scad>
use <5-24con12.scad>
function ldraw_lib__48__5_24co12() = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 48\5-24con12.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__5_24con12()],
];
module ldraw_lib__48__5_24co12(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__5_24co12(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
