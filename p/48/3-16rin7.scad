use <../../lib.scad>
function ldraw_lib__48__3_16rin7() = [
// 0 ~Hi-Res Ring  7 x 0.1875 (Obsolete)
...
// 0 !HISTORY 2024-03-23 [OrionP] Obsolete, use 48\3-16ring7.dat
...
module ldraw_lib__48__3_16rin7(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__3_16rin7(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__3_16rin7(line=0.2);