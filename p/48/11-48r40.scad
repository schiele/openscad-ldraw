...
$fa=1; $fs=0.2;
function ldraw_lib__48__11_48r40(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 48\11-48ring40.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__11_48ring40(realsolid)],
];
module ldraw_lib__48__11_48r40(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__11_48r40(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
