use <../../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48__11_24edge(realsolid=false) = [
// 0 Hi-Res Circle 0.4583
// 0 Name: 48\11-24edge.dat
...
module ldraw_lib__48__11_24edge(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__11_24edge(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__11_24edge(line=0.2);