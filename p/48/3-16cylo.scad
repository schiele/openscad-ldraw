...
use <3-16edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48__3_16cylo(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 48\3-16edge.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__3_16edge(realsolid)],
// 1 16 0 1 0 1 0 0 0 1 0 0 0 1 48\3-16edge.dat
  [1,16,0,1,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__3_16edge(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 48\3-16cyli.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__3_16cyli(realsolid)],
];
module ldraw_lib__48__3_16cylo(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__3_16cylo(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
