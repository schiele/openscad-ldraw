...
use <7-48edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48__7_48cylo(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 48\7-48edge.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__7_48edge(realsolid)],
// 1 16 0 1 0 1 0 0 0 1 0 0 0 1 48\7-48edge.dat
  [1,16,0,1,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__7_48edge(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 48\7-48cyli.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48__7_48cyli(realsolid)],
];
module ldraw_lib__48__7_48cylo(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__7_48cylo(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
