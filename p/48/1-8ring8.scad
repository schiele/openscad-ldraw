use <../../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48__1_8ring8(realsolid=false) = [
// 0 Hi-Res Ring  8 x 0.125
// 0 Name: 48\1-8ring8.dat
...
module ldraw_lib__48__1_8ring8(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48__1_8ring8(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__48__1_8ring8(line=0.2);