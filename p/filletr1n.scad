...
use <box4-2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__filletr1n(realsolid=false) = [
...
// 1 16 0.625 0 0 8.375 0 0 0 -4 0 0 0 -1 box3u8p.dat
  [1,16,0.625,0,0,8.375,0,0,0,-4,0,0,0,-1, ldraw_lib__box3u8p(realsolid)],
// 1 16 10 -2 -1 -1 0 0 0 0 -2 0 -3 0 box4-2p.dat
  [1,16,10,-2,-1,-1,0,0,0,0,-2,0,-3,0, ldraw_lib__box4_2p(realsolid)],
// 4 16 9 -4 -1 11 -4 -1 11 -4 1 9 -4 1
  [4,16,9,-4,-1,11,-4,-1,11,-4,1,9,-4,1],
// 1 16 10 -2 1 1 0 0 0 0 -2 0 3 0 box4-2p.dat
  [1,16,10,-2,1,1,0,0,0,0,-2,0,3,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 13.5 0 0 -2.5 0 0 0 -4 0 0 0 1 box3u8p.dat
  [1,16,13.5,0,0,-2.5,0,0,0,-4,0,0,0,1, ldraw_lib__box3u8p(realsolid)],
];
module ldraw_lib__filletr1n(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__filletr1n(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
