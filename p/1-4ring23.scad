use <../lib.scad>
function ldraw_lib__1_4ring23() = [
// 0 Ring 23 x 0.25
// 0 Name: 1-4ring23.dat
...
module ldraw_lib__1_4ring23(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__1_4ring23(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__1_4ring23(line=0.2);