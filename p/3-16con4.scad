...
// 5 24 2.8284 1 2.8284 3.5355 0 3.5355 3.6956 1 1.5308 1.5308 1 3.6956
  [5,24,2.8284,1,2.8284,3.5355,0,3.5355,3.6956,1,1.5308,1.5308,1,3.6956],
// 5 24 1.5308 1 3.6956 1.9135 0 4.6195 2.8284 1 2.8284 0 1 4.3296
  [5,24,1.5308,1,3.6956,1.9135,0,4.6195,2.8284,1,2.8284,0,1,4.3296],
// 0 // Build by LDPartEditor (PrimGen 2.X)
];
module ldraw_lib__3_16con4(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3_16con4(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3_16con4(line=0.2);