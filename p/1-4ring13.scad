use <../lib.scad>
function ldraw_lib__1_4ring13() = [
// 0 Ring 13 x 0.25
// 0 Name: 1-4ring13.dat
...
module ldraw_lib__1_4ring13(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__1_4ring13(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__1_4ring13(line=0.2);