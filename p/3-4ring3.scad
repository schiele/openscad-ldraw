...
// 0 !HISTORY 2024-01-14 [Holly-Wood] Complete regeneration, original by cavehop
...
module ldraw_lib__3_4ring3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3_4ring3(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3_4ring3(line=0.2);