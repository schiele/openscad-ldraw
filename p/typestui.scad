...
use <2-4ndis.scad>
$fa=1; $fs=0.2;
function ldraw_lib__typestui(realsolid=false) = [
...
// 1 0 -1.915 0 4.58 0 0 -0.46 0 1 0 0.42 0 0 2-4disc.dat
  [1,0,-1.915,0,4.58,0,0,-0.46,0,1,0,0.42,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 0 -1.915 0 -4.58 0 0 -0.46 0 1 0 0.42 0 0 2-4disc.dat
  [1,0,-1.915,0,-4.58,0,0,-0.46,0,1,0,0.42,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 0 -1.915 0 3.67 0.288 0 0 0 1 0 0 0 0.49 1-4ndis.dat
  [1,0,-1.915,0,3.67,0.288,0,0,0,1,0,0,0,0.49, ldraw_lib__1_4ndis(realsolid)],
// 1 0 -1.915 0 -3.67 0.288 0 0 0 1 0 0 0 -0.49 1-4ndis.dat
  [1,0,-1.915,0,-3.67,0.288,0,0,0,1,0,0,0,-0.49, ldraw_lib__1_4ndis(realsolid)],
// 1 0 1.915 0 3.67 -0.288 0 0 0 1 0 0 0 0.49 1-4ndis.dat
  [1,0,1.915,0,3.67,-0.288,0,0,0,1,0,0,0,0.49, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 -1.915 0 4.58 0 0 -0.46 0 1 0 0.42 0 0 2-4ndis.dat
  [1,16,-1.915,0,4.58,0,0,-0.46,0,1,0,0.42,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -1.915 0 -4.58 0 0 -0.46 0 1 0 0.42 0 0 2-4ndis.dat
  [1,16,-1.915,0,-4.58,0,0,-0.46,0,1,0,0.42,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -1.915 0 3.67 0.288 0 0 0 1 0 0 0 0.49 1-4disc.dat
  [1,16,-1.915,0,3.67,0.288,0,0,0,1,0,0,0,0.49, ldraw_lib__1_4disc(realsolid)],
// 1 16 -1.915 0 -3.67 0.288 0 0 0 1 0 0 0 -0.49 1-4disc.dat
  [1,16,-1.915,0,-3.67,0.288,0,0,0,1,0,0,0,-0.49, ldraw_lib__1_4disc(realsolid)],
// 1 16 1.915 0 3.67 -0.288 0 0 0 1 0 0 0 0.49 1-4disc.dat
  [1,16,1.915,0,3.67,-0.288,0,0,0,1,0,0,0,0.49, ldraw_lib__1_4disc(realsolid)],
...
module ldraw_lib__typestui(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__typestui(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__typestui(line=0.2);