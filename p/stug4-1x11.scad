use <../lib.scad>
use <stud4.scad>
function ldraw_lib__stug4_1x11() = [
...
// 1 16 -100 0 0 1 0 0 0 1 0 0 0 1 stud4.dat
  [1,16,-100,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stud4()],
...
module ldraw_lib__stug4_1x11(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stug4_1x11(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
