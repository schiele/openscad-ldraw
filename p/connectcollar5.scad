...
use <rect2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__connectcollar5(realsolid=false) = [
...
// 1 16 0 0 0 0 0 -4 0 1 0 4 0 0 3-16edge.dat
  [1,16,0,0,0,0,0,-4,0,1,0,4,0,0, ldraw_lib__3_16edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 0 0 -4 0 7 0 4 0 0 3-16cyli.dat
  [1,16,0,0,0,0,0,-4,0,7,0,4,0,0, ldraw_lib__3_16cyli(realsolid)],
// 1 16 0 0 0 0 0 -4 0 1 0 4 0 0 3-16ndis.dat
  [1,16,0,0,0,0,0,-4,0,1,0,4,0,0, ldraw_lib__3_16ndis(realsolid)],
// 1 16 0 0 0 0 0 -6.5 0 1 0 6.5 0 0 1-8chrd.dat
  [1,16,0,0,0,0,0,-6.5,0,1,0,6.5,0,0, ldraw_lib__1_8chrd(realsolid)],
...
// 1 16 4 6 0 0 1 -0.199 1 0 0 0 0 1 8\1-4ndis.dat
  [1,16,4,6,0,0,1,-0.199,1,0,0,0,0,1, ldraw_lib__8__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 6 6 0 0 -2 -0.199 1 0 0 0 0 1 8\1-4cylo.dat
  [1,16,6,6,0,0,-2,-0.199,1,0,0,0,0,1, ldraw_lib__8__1_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 0 0 4 0 7 0 4 0 0 3-16cyli.dat
  [1,16,0,0,0,0,0,4,0,7,0,4,0,0, ldraw_lib__3_16cyli(realsolid)],
...
// 1 16 -4.801025 3 1 1 0 0 0 0 -3 0 1 0 rect2a.dat
  [1,16,-4.801025,3,1,1,0,0,0,0,-3,0,1,0, ldraw_lib__rect2a(realsolid)],
// 1 16 -3.748325 3.5 1.2654 0 -1 -0.0527 -3.5 0 0 0 0 -0.2654 rect1.dat
  [1,16,-3.748325,3.5,1.2654,0,-1,-0.0527,-3.5,0,0,0,0,-0.2654, ldraw_lib__rect1(realsolid)],
// 1 16 3.748325 3.5 1.2654 5e-005 1 -0.0527 -3.5 0 0 0 0 0.2654 rect1.dat
  [1,16,3.748325,3.5,1.2654,5e-005,1,-0.0527,-3.5,0,0,0,0,0.2654, ldraw_lib__rect1(realsolid)],
// 1 16 4.801025 3 1 0 0 -1 -3 0 0 0 1 0 rect2a.dat
  [1,16,4.801025,3,1,0,0,-1,-3,0,0,0,1,0, ldraw_lib__rect2a(realsolid)],
];
module ldraw_lib__connectcollar5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__connectcollar5(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
