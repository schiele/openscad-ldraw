...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 5-8edge.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__5_8edge()],
// 1 16 0 1 0 1 0 0 0 1 0 0 0 1 5-8edge.dat
  [1,16,0,1,0,1,0,0,0,1,0,0,0,1, ldraw_lib__5_8edge()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 5-8cyli.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__5_8cyli()],
];
module ldraw_lib__5_8cylo(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__5_8cylo(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
