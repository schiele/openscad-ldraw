...
use <rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__filletr2s(realsolid=false) = [
...
// 1 16 33.875 10 33.875 0 0 2.625 10 0 0 0 2.625 0 box2-7.dat
  [1,16,33.875,10,33.875,0,0,2.625,10,0,0,0,2.625,0, ldraw_lib__box2_7(realsolid)],
// 1 16 36.5 10 30 0 -0.5 0 0 0 10 -1.25 0 0 box4-2p.dat
  [1,16,36.5,10,30,0,-0.5,0,0,0,10,-1.25,0,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 36.5 10 20 0 1 0 0 0 10 8.75 0 0 rect2p.dat
  [1,16,36.5,10,20,0,1,0,0,0,10,8.75,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 36.5 10 10 0 -0.5 0 0 0 10 -1.25 0 0 box4-2p.dat
  [1,16,36.5,10,10,0,-0.5,0,0,0,10,-1.25,0,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 36.5 10 5.0625 0 1 0 0 0 10 -3.625 0 0 rect2p.dat
  [1,16,36.5,10,5.0625,0,1,0,0,0,10,-3.625,0,0, ldraw_lib__rect2p(realsolid)],
];
module ldraw_lib__filletr2s(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__filletr2s(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
