...
use <rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__confric2(realsolid=false) = [
// 0 Technic Friction Pin 1.0 without Base Collar
// 0 Name: confric2.dat
...
module ldraw_lib__confric2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__confric2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__confric2(line=0.2);