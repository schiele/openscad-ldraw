use <../lib.scad>
function ldraw_lib__3_8ring24() = [
// 0 Ring 24 x 0.375
// 0 Name: 3-8ring24.dat
...
// 0 !HISTORY 2024-03-23 [OrionP] Moved from 3-8rin24.dat
...
module ldraw_lib__3_8ring24(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3_8ring24(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3_8ring24(line=0.2);