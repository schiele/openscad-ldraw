use <../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3_16con5(realsolid=false) = [
// 0 Cone  5 x 0.1875
// 0 Name: 3-16con5.dat
...
// 5 24 3.5355 1 3.5355 4.2426 0 4.2426 4.6195 1 1.9135 1.9135 1 4.6195
  [5,24,3.5355,1,3.5355,4.2426,0,4.2426,4.6195,1,1.9135,1.9135,1,4.6195],
// 5 24 1.9135 1 4.6195 2.2962 0 5.5434 3.5355 1 3.5355 0 1 5.412
  [5,24,1.9135,1,4.6195,2.2962,0,5.5434,3.5355,1,3.5355,0,1,5.412],
// 0 // Build by LDPartEditor (PrimGen 2.X)
];
module ldraw_lib__3_16con5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3_16con5(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3_16con5(line=0.2);