...
// 0 !HISTORY 2024-01-11 [Holly-Wood] Complete regeneration, original by glbarnes
...
module ldraw_lib__2_4ring5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2_4ring5(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2_4ring5(line=0.2);