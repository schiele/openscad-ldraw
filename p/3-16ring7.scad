use <../lib.scad>
function ldraw_lib__3_16ring7() = [
// 0 Ring  7 x 0.1875
// 0 Name: 3-16ring7.dat
...
module ldraw_lib__3_16ring7(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3_16ring7(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3_16ring7(line=0.2);