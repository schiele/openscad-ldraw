...
use <1-8ring3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__1_8stud4(realsolid=false) = [
...
// 1 16 0 -4 0 8 0 0 0 4 0 0 0 8 1-8cylo.dat
  [1,16,0,-4,0,8,0,0,0,4,0,0,0,8, ldraw_lib__1_8cylo(realsolid)],
// 1 16 0 -4 0 2 0 0 0 1 0 0 0 2 1-8ring3.dat
  [1,16,0,-4,0,2,0,0,0,1,0,0,0,2, ldraw_lib__1_8ring3(realsolid)],
];
module ldraw_lib__1_8stud4(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__1_8stud4(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
