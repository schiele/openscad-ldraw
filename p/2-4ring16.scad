use <../lib.scad>
function ldraw_lib__2_4ring16() = [
// 0 Ring 16 x 0.5
// 0 Name: 2-4ring16.dat
...
// 0 !HISTORY 2024-03-23 [OrionP] Moved from 2-4rin16.dat
...
module ldraw_lib__2_4ring16(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2_4ring16(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2_4ring16(line=0.2);