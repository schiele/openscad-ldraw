use <../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__axl3hol8(realsolid=false) = [
// 0 Technic Axle Hole Semi-Reduced Perimeter
// 0 Name: axl3hol8.dat
...
// 
// 
// 2 24 -2.791 1 5.213 -2.791 0 5.213
  [2,24,-2.791,1,5.213,-2.791,0,5.213],
// 2 24 -2.5 1 2.5 -2.5 0 2.5
  [2,24,-2.5,1,2.5,-2.5,0,2.5],
// 2 24 -5.213 1 2.791 -5.213 0 2.791
  [2,24,-5.213,1,2.791,-5.213,0,2.791],
...
// 5 24 -6 1 0 -6 0 0 -5.543 1 2.296 -6 1 -6
  [5,24,-6,1,0,-6,0,0,-5.543,1,2.296,-6,1,-6],
// 4 16 -2.5 1 2.5 -2.5 0 2.5 -5.213 0 2.791 -5.213 1 2.791
  [4,16,-2.5,1,2.5,-2.5,0,2.5,-5.213,0,2.791,-5.213,1,2.791],
// 4 16 -2.791 1 5.213 -2.791 0 5.213 -2.5 0 2.5 -2.5 1 2.5
  [4,16,-2.791,1,5.213,-2.791,0,5.213,-2.5,0,2.5,-2.5,1,2.5],
// 4 16 0 1 6 0 0 6 -2.296 0 5.543 -2.296 1 5.543
  [4,16,0,1,6,0,0,6,-2.296,0,5.543,-2.296,1,5.543],
// 4 16 -2.296 1 5.543 -2.296 0 5.543 -2.791 0 5.213 -2.791 1 5.213
  [4,16,-2.296,1,5.543,-2.296,0,5.543,-2.791,0,5.213,-2.791,1,5.213],
// 4 16 -5.213 1 2.791 -5.213 0 2.791 -5.543 0 2.296 -5.543 1 2.296
  [4,16,-5.213,1,2.791,-5.213,0,2.791,-5.543,0,2.296,-5.543,1,2.296],
...
module ldraw_lib__axl3hol8(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__axl3hol8(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__axl3hol8(line=0.2);