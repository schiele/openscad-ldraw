...
use <stug4-2x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stug4_4x4(realsolid=false) = [
...
// 1 16 -20 0 -20 1 0 0 0 1 0 0 0 1 stug4-2x2.dat
  [1,16,-20,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4_2x2(realsolid)],
// 1 16 -20 0 20 1 0 0 0 1 0 0 0 1 stug4-2x2.dat
  [1,16,-20,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4_2x2(realsolid)],
// 1 16 20 0 20 1 0 0 0 1 0 0 0 1 stug4-2x2.dat
  [1,16,20,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4_2x2(realsolid)],
...
module ldraw_lib__stug4_4x4(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stug4_4x4(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
