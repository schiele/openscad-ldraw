...
use <rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__confric6(realsolid=false) = [
...
// 4 16 -2.296 -9.5 -5.543 -2.296 0 -5.543 -1 0 -5.801 -1 -9.5 -5.801
  [4,16,-2.296,-9.5,-5.543,-2.296,0,-5.543,-1,0,-5.801,-1,-9.5,-5.801],
// 1 16 0 0 0 -2.296 0 -5.543 0 -9.5 0 -5.543 0 2.296 3-8cyli.dat
  [1,16,0,0,0,-2.296,0,-5.543,0,-9.5,0,-5.543,0,2.296, ldraw_lib__3_8cyli(realsolid)],
...
// 1 16 -1 -4.25 -4.801 0 -1 0 -4.25 0 0 0 0 -1 rect2p.dat
  [1,16,-1,-4.25,-4.801,0,-1,0,-4.25,0,0,0,0,-1, ldraw_lib__rect2p(realsolid)],
// 1 16 -1 -4.25 4.801 0 -1 0 -4.25 0 0 0 0 -1 rect2p.dat
  [1,16,-1,-4.25,4.801,0,-1,0,-4.25,0,0,0,0,-1, ldraw_lib__rect2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 3.483 -3 -4.897 0 1 -0.088 3 0 0 0 0 0.088 rect2p.dat
  [1,16,3.483,-3,-4.897,0,1,-0.088,3,0,0,0,0,0.088, ldraw_lib__rect2p(realsolid)],
// 1 16 4.897 -3 -3.483 0 -1 -0.088 3 0 0 0 0 0.088 rect2p.dat
  [1,16,4.897,-3,-3.483,0,-1,-0.088,3,0,0,0,0,0.088, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__confric6(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__confric6(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__confric6(line=0.2);