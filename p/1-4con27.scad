use <../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__1_4con27(realsolid=false) = [
// 0 Cone 27 x 0.25
// 0 Name: 1-4con27.dat
...
module ldraw_lib__1_4con27(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__1_4con27(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__1_4con27(line=0.2);