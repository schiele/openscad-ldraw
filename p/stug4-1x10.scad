...
use <stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stug4_1x10(realsolid=false) = [
...
// 1 16 -90 0 0 1 0 0 0 1 0 0 0 1 stud4.dat
  [1,16,-90,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
module ldraw_lib__stug4_1x10(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stug4_1x10(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
