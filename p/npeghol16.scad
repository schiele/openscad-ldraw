...
use <rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__npeghol16(realsolid=false) = [
...
// 1 16 9.11395 .5 6.3639 .88605 0 0 0 0 -.5 0 1 0 rect2p.dat
  [1,16,9.11395,.5,6.3639,.88605,0,0,0,0,-.5,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 7.7247745 .5 5.8608195 -.5031255 -1 0 0 0 .5 -.5030805 0 0 rect.dat
  [1,16,7.7247745,.5,5.8608195,-.5031255,-1,0,0,0,.5,-.5030805,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 0 0 0 9 0 0 0 1 0 0 0 9 1-16cylo.dat
  [1,16,0,0,0,9,0,0,0,1,0,0,0,9, ldraw_lib__1_16cylo(realsolid)],
...
// 1 16 8.05455 .5 3.97215 -.26055 -1 0 0 0 -.5 .52785 0 0 rect2p.dat
  [1,16,8.05455,.5,3.97215,-.26055,-1,0,0,0,-.5,.52785,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 7.5078245 .5 4.9288695 .2861755 -1 0 0 0 .5 -.4288695 0 0 rect2p.dat
  [1,16,7.5078245,.5,4.9288695,.2861755,-1,0,0,0,.5,-.4288695,0,0, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__npeghol16(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__npeghol16(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
