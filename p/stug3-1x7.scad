...
use <stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stug3_1x7(realsolid=false) = [
...
// 1 16 -60 0 0 1 0 0 0 1 0 0 0 1 stud3.dat
  [1,16,-60,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stud3(realsolid)],
...
module ldraw_lib__stug3_1x7(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stug3_1x7(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__stug3_1x7(line=0.2);