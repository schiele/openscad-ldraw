use <../lib.scad>
function ldraw_lib__1_4ring15() = [
// 0 Ring 15 x 0.25
// 0 Name: 1-4ring15.dat
...
// 0 !HISTORY 2024-03-23 [OrionP] Moved from 1-4rin15.dat
...
module ldraw_lib__1_4ring15(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__1_4ring15(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__1_4ring15(line=0.2);