...
use <box4-7a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__studxa(realsolid=false) = [
...
// 1 16 0 0 2.75 1.5 0 0 0 -4 0 0 0 1.25 box4-5a.dat
  [1,16,0,0,2.75,1.5,0,0,0,-4,0,0,0,1.25, ldraw_lib__box4_5a(realsolid)],
// 1 16 -1.5 -2 0 0 -2.5 0 0 0 -2 -1.5 0 0 box4-7a.dat
  [1,16,-1.5,-2,0,0,-2.5,0,0,0,-2,-1.5,0,0, ldraw_lib__box4_7a(realsolid)],
// 1 16 1.5 -2 0 0 2.5 0 0 0 -2 -1.5 0 0 box4-7a.dat
  [1,16,1.5,-2,0,0,2.5,0,0,0,-2,-1.5,0,0, ldraw_lib__box4_7a(realsolid)],
// 1 16 0 0 -2.75 1.5 0 0 0 -4 0 0 0 -1.25 box4-5a.dat
  [1,16,0,0,-2.75,1.5,0,0,0,-4,0,0,0,-1.25, ldraw_lib__box4_5a(realsolid)],
...
module ldraw_lib__studxa(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__studxa(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
