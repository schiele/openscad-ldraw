...
use <rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__clip8(realsolid=false) = [
...
// 1 16 -4.8478 -8.7654 0 0 -0.1522 1 0 -1.2346 0 4 0 0 box2-7.dat
  [1,16,-4.8478,-8.7654,0,0,-0.1522,1,0,-1.2346,0,4,0,0, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -6 4 -3.6955 0 -1.5307 -1.5307 0 3.6955 0 -8 0 1-4cylo.dat
  [1,16,0,-6,4,-3.6955,0,-1.5307,-1.5307,0,3.6955,0,-8,0, ldraw_lib__1_4cylo(realsolid)],
// 2 24 -3.6956 -7.5308 -4 -3.6956 -7.5308 4
  [2,24,-3.6956,-7.5308,-4,-3.6956,-7.5308,4],
// 1 16 -1.5308 -1.9176 0 0 -8 0 0 0 -0.3868 4 0 0 rect3.dat
  [1,16,-1.5308,-1.9176,0,0,-8,0,0,0,-0.3868,4,0,0, ldraw_lib__rect3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -1.5308 -4 -1.5308 0 0 0 0 1.5308 0 8 0 2-4cylo.dat
  [1,16,0,-1.5308,-4,-1.5308,0,0,0,0,1.5308,0,8,0, ldraw_lib__2_4cylo(realsolid)],
// 1 16 1.5308 -1.9176 0 0 8 0 0 0 -0.3868 -4 0 0 rect3.dat
  [1,16,1.5308,-1.9176,0,0,8,0,0,0,-0.3868,-4,0,0, ldraw_lib__rect3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 -6 4 4 0 0 0 0 4 0 -1 0 3-16ndis.dat
  [1,16,0,-6,4,4,0,0,0,0,4,0,-1,0, ldraw_lib__3_16ndis(realsolid)],
// 1 16 0 -1.5308 4 -1.5308 0 0 0 0 1.5308 0 -1 0 2-4ndis.dat
  [1,16,0,-1.5308,4,-1.5308,0,0,0,0,1.5308,0,-1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 -6 4 -4 0 0 0 0 4 0 -1 0 3-16ndis.dat
  [1,16,0,-6,4,-4,0,0,0,0,4,0,-1,0, ldraw_lib__3_16ndis(realsolid)],
// 1 16 0 -6 4 -4 0 0 0 0 -4 0 -1 0 1-16ndis.dat
  [1,16,0,-6,4,-4,0,0,0,0,-4,0,-1,0, ldraw_lib__1_16ndis(realsolid)],
...
module ldraw_lib__clip8(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__clip8(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
