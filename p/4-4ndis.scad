use <../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4_4ndis(realsolid=false) = [
// 0 Disc Negative 1.0
// 0 Name: 4-4ndis.dat
...
module ldraw_lib__4_4ndis(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4_4ndis(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4_4ndis(line=0.2);