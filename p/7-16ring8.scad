use <../lib.scad>
function ldraw_lib__7_16ring8() = [
// 0 Ring  8 x 0.4375
// 0 Name: 7-16ring8.dat
...
module ldraw_lib__7_16ring8(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__7_16ring8(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__7_16ring8(line=0.2);