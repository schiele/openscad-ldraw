use <../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__1_4edge(realsolid=false) = [
// 0 Circle 0.25
// 0 Name: 1-4edge.dat
...
module ldraw_lib__1_4edge(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__1_4edge(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__1_4edge(line=0.2);