use <../lib.scad>
use <studp01.scad>
function ldraw_lib__stugp01_1x10() = [
...
// 1 16 -90 0 0 1 0 0 0 1 0 0 0 1 studp01.dat
  [1,16,-90,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__studp01()],
// 1 16 -70 0 0 1 0 0 0 1 0 0 0 1 studp01.dat
  [1,16,-70,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__studp01()],
...
module ldraw_lib__stugp01_1x10(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stugp01_1x10(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
