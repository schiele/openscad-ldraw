...
use <t01o0714.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stud_logo2(realsolid=false) = [
...
// 1 16 0 -3.8 0 1 0 0 0 1 0 0 0 1 logo2.dat
  [1,16,0,-3.8,0,1,0,0,0,1,0,0,0,1, ldraw_lib__logo2(realsolid)],
];
module ldraw_lib__stud_logo2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stud_logo2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
