use <../lib.scad>
function ldraw_lib__2_4ring13() = [
// 0 Ring 13 x 0.5
// 0 Name: 2-4ring13.dat
...
// 4 16 -5.3578 0 12.9346 -9.8994 0 9.8994 -9.1923 0 9.1923 -4.9751 0 12.0107
  [4,16,-5.3578,0,12.9346,-9.8994,0,9.8994,-9.1923,0,9.1923,-4.9751,0,12.0107],
// 4 16 -9.8994 0 9.8994 -12.9346 0 5.3578 -12.0107 0 4.9751 -9.1923 0 9.1923
  [4,16,-9.8994,0,9.8994,-12.9346,0,5.3578,-12.0107,0,4.9751,-9.1923,0,9.1923],
// 4 16 -12.9346 0 5.3578 -14 0 0 -13 0 0 -12.0107 0 4.9751
  [4,16,-12.9346,0,5.3578,-14,0,0,-13,0,0,-12.0107,0,4.9751],
// 0 // Build by LDPartEditor (PrimGen 2.X)
];
module ldraw_lib__2_4ring13(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2_4ring13(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2_4ring13(line=0.2);