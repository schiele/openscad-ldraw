use <../lib.scad>
function ldraw_lib__2_4ring17() = [
// 0 Ring 17 x 0.5
// 0 Name: 2-4ring17.dat
...
module ldraw_lib__2_4ring17(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2_4ring17(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2_4ring17(line=0.2);