...
// 0 !HISTORY 2024-01-20 [Holly-Wood] Complete re-write, original by DeannaEarley
// 0 !HISTORY 2024-01-29 [OrionP] Official Update 2024-01
// 
// 0 // Edges
// 1 16 0 1 0 4 0 0 -0.667 1 0 0 0 4 4-4edge.dat
  [1,16,0,1,0,4,0,0,-0.667,1,0,0,0,4, ldraw_lib__4_4edge()],
...
// 1 16 0 0 0 4 0 0 0 0.333 0 0 0 4 4-4cyli.dat
  [1,16,0,0,0,4,0,0,0,0.333,0,0,0,4, ldraw_lib__4_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0.333 0 4 0 0 0 0.667 0 0 0 4 4-4cyls.dat
  [1,16,0,0.333,0,4,0,0,0,0.667,0,0,0,4, ldraw_lib__4_4cyls()],
...
module ldraw_lib__stud2s(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stud2s(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
