use <../lib.scad>
use <stud.scad>
function ldraw_lib__stug_1x12() = [
// 0 Stud Group  1 x 12
// 0 Name: stug-1x12.dat
...
module ldraw_lib__stug_1x12(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stug_1x12(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__stug_1x12(line=0.2);