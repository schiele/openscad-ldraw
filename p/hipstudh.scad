...
use <recte4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__hipstudh(realsolid=false) = [
...
// 1 16 0 -11 0 -2.8 0 2.8 0 1 0 2.8 0 2.8 2-4ndis.dat
  [1,16,0,-11,0,-2.8,0,2.8,0,1,0,2.8,0,2.8, ldraw_lib__2_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -11 0 -2.8 0 2.8 0 11 0 2.8 0 2.8 2-4cylo.dat
  [1,16,0,-11,0,-2.8,0,2.8,0,11,0,2.8,0,2.8, ldraw_lib__2_4cylo(realsolid)],
// 1 16 -2.8 -5.5 0 0 -1 0 0 0 5.5 -2.8 0 0 rect.dat
  [1,16,-2.8,-5.5,0,0,-1,0,0,0,5.5,-2.8,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 0 -5.5 -2.8 -2 0 0 0 0 2 0 -1 0 4-4ndis.dat
  [1,16,0,-5.5,-2.8,-2,0,0,0,0,2,0,-1,0, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 0 -5.5 -6 -2 0 0 0 0 2 0 3.2 0 4-4cylo.dat
  [1,16,0,-5.5,-6,-2,0,0,0,0,2,0,3.2,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 -5.5 -6 -2 0 0 0 0 2 0 1 0 4-4ndis.dat
  [1,16,0,-5.5,-6,-2,0,0,0,0,2,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 -5.5 6 3.46 0 0 0 0 5.5 0 -1 0 rect.dat
  [1,16,0,-5.5,6,3.46,0,0,0,0,5.5,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 6 -5.5 0 0 -1 0 0 0 5.5 -3.46 0 0 rect.dat
  [1,16,6,-5.5,0,0,-1,0,0,0,5.5,-3.46,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 -6 -2 0 0 1 0 0 0 2 3.46 0 0 rect.dat
  [1,16,-6,-2,0,0,1,0,0,0,2,3.46,0,0, ldraw_lib__rect(realsolid)],
// 2 24 -4.48 0 4.48 -6 0 3.46
  [2,24,-4.48,0,4.48,-6,0,3.46],
// 2 24 -6 0 -3.46 -4.48 0 -4.48
  [2,24,-6,0,-3.46,-4.48,0,-4.48],
// 1 16 0 -5.5 -6 3.46 0 0 0 0 5.5 0 -1 0 recte4.dat
  [1,16,0,-5.5,-6,3.46,0,0,0,0,5.5,0,-1,0, ldraw_lib__recte4(realsolid)],
...
// 1 16 -3.97 -5.5 -5.24 -.51 1 0 0 0 -5.5 .76 0 0 rect2p.dat
  [1,16,-3.97,-5.5,-5.24,-.51,1,0,0,0,-5.5,.76,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 3.97 -5.5 -5.24 -.51 -1 0 0 0 -5.5 -.76 0 0 rect2p.dat
  [1,16,3.97,-5.5,-5.24,-.51,-1,0,0,0,-5.5,-.76,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 5.24 -5.5 -3.97 -.76 -1 0 0 0 -5.5 -.51 0 0 rect2p.dat
  [1,16,5.24,-5.5,-3.97,-.76,-1,0,0,0,-5.5,-.51,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 5.24 -5.5 3.97 .76 -1 0 0 0 -5.5 -.51 0 0 rect2p.dat
  [1,16,5.24,-5.5,3.97,.76,-1,0,0,0,-5.5,-.51,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 3.97 -5.5 5.24 .51 -1 0 0 0 -5.5 -.76 0 0 rect2p.dat
  [1,16,3.97,-5.5,5.24,.51,-1,0,0,0,-5.5,-.76,0,0, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__hipstudh(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__hipstudh(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
