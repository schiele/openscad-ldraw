...
use <rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__clh1(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 clh3q.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__clh3q(realsolid)],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 1 clh3q.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__clh3q(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 clh3q.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__clh3q(realsolid)],
...
// 1 16 0 -7.06425 -7.47575 -4 0 0 0 1 1.13575 0 0 -7.47575 rect.dat
  [1,16,0,-7.06425,-7.47575,-4,0,0,0,1,1.13575,0,0,-7.47575, ldraw_lib__rect(realsolid)],
...
// 1 16 -9 0 -3.15 0 5 0 -.25 0 0 0 0 .25 8\2-4cylo.dat
  [1,16,-9,0,-3.15,0,5,0,-.25,0,0,0,0,.25, ldraw_lib__8__2_4cylo(realsolid)],
// 1 16 -9 0 -3.15 0 1 0 -.25 0 0 0 0 .25 8\2-4ndis.dat
  [1,16,-9,0,-3.15,0,1,0,-.25,0,0,0,0,.25, ldraw_lib__8__2_4ndis(realsolid)],
// 1 16 -9 -1.133 -4.359 0 1 0 -.883 0 .117 -.176 0 -.589 8\2-4edge.dat
  [1,16,-9,-1.133,-4.359,0,1,0,-.883,0,.117,-.176,0,-.589, ldraw_lib__8__2_4edge(realsolid)],
// 1 16 -9 -1.133 -4.359 0 5 0 -.883 0 .117 -.176 0 -.589 8\2-4cyli.dat
  [1,16,-9,-1.133,-4.359,0,5,0,-.883,0,.117,-.176,0,-.589, ldraw_lib__8__2_4cyli(realsolid)],
...
// 1 16 -6.5 -2.73 -2.268 -2.5 0 0 0 1 -.714 0 0 2.267 rect3.dat
  [1,16,-6.5,-2.73,-2.268,-2.5,0,0,0,1,-.714,0,0,2.267, ldraw_lib__rect3(realsolid)],
// 1 16 -6.5 2.73 -2.268 -2.5 0 0 0 -1 .714 0 0 2.267 rect3.dat
  [1,16,-6.5,2.73,-2.268,-2.5,0,0,0,-1,.714,0,0,2.267, ldraw_lib__rect3(realsolid)],
...
// 1 16 -6.5 -.25 -3.667 0 0 -2.5 0 -1 0 .517 0 0 rect2p.dat
  [1,16,-6.5,-.25,-3.667,0,0,-2.5,0,-1,0,.517,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -6.5 .25 -3.667 0 0 -2.5 0 1 0 .517 0 0 rect2p.dat
  [1,16,-6.5,.25,-3.667,0,0,-2.5,0,1,0,.517,0,0, ldraw_lib__rect2p(realsolid)],
// 
// 0 BFC INVERTNEXT
...
module ldraw_lib__clh1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__clh1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
