...
use <axlehol6.scad>
$fa=1; $fs=0.2;
function ldraw_lib__axl4hole(realsolid=false) = [
...
// 1 16 0 0 0 0 0 6 0 1 0 6 0 0 1-4cyli.dat
  [1,16,0,0,0,0,0,6,0,1,0,6,0,0, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 axlehol6.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__axlehol6(realsolid)],
// 5 24 0 1 6 0 0 6 -2 1 5.602 2.296 1 5.543
  [5,24,0,1,6,0,0,6,-2,1,5.602,2.296,1,5.543],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__axl4hole(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__axl4hole(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
