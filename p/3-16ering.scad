...
use <1-16chrd.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3_16ering(realsolid=false) = [
...
// 1 16 0 0 0 .70711 0 -.70711 0 1 0 .70711 0 .70711 1-16chrd.dat
  [1,16,0,0,0,.70711,0,-.70711,0,1,0,.70711,0,.70711, ldraw_lib__1_16chrd(realsolid)],
// 1 16 0 0 0 .92388 0 -.38268 0 1 0 .38268 0 .92388 1-16chrd.dat
  [1,16,0,0,0,.92388,0,-.38268,0,1,0,.38268,0,.92388, ldraw_lib__1_16chrd(realsolid)],
];
module ldraw_lib__3_16ering(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3_16ering(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
