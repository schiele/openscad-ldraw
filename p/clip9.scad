...
use <rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__clip9(realsolid=false) = [
...
// 1 16 -4.3059 0 -4.1306 -0.30593 1 0 0 0 -4 -0.63062 0 0 rect2p.dat
  [1,16,-4.3059,0,-4.1306,-0.30593,1,0,0,0,-4,-0.63062,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 -4.408 0 -12.7655 0 0 0.712 -4 0 0 0 -1.2345 0 box2-5.dat
  [1,16,-4.408,0,-12.7655,0,0,0.712,-4,0,0,0,-1.2345,0, ldraw_lib__box2_5(realsolid)],
...
// 1 16 -3.8136 -4 -9.3806 -1.30644 0 -2.43543 0 8 0 -4.6194 0 1.91341 3-8chrd.dat
  [1,16,-3.8136,-4,-9.3806,-1.30644,0,-2.43543,0,8,0,-4.6194,0,1.91341, ldraw_lib__3_8chrd(realsolid)],
// 1 16 -3.8136 4 -9.3806 -1.30644 0 -2.43543 0 -8 0 -4.6194 0 1.91341 3-8chrd.dat
  [1,16,-3.8136,4,-9.3806,-1.30644,0,-2.43543,0,-8,0,-4.6194,0,1.91341, ldraw_lib__3_8chrd(realsolid)],
// 1 16 -3.8136 4 -9.3806 -1.30644 0 -2.43543 0 -8 0 -4.6194 0 1.91341 3-8cylo.dat
  [1,16,-3.8136,4,-9.3806,-1.30644,0,-2.43543,0,-8,0,-4.6194,0,1.91341, ldraw_lib__3_8cylo(realsolid)],
// 
// 1 16 4.408 0 -12.7655 0 0 -0.712 4 0 0 0 -1.2345 0 box2-5.dat
  [1,16,4.408,0,-12.7655,0,0,-0.712,4,0,0,0,-1.2345,0, ldraw_lib__box2_5(realsolid)],
// 4 16 4.6119 4 -4.7612 5.12 4 -14 4 4 -10 4 4 -6
...
module ldraw_lib__clip9(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__clip9(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
