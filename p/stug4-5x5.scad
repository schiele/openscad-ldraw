...
use <stug4-4x4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stug4_5x5(realsolid=false) = [
...
// 1 16 -10 0 -10 1 0 0 0 1 0 0 0 1 stug4-4x4.dat
  [1,16,-10,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4_4x4(realsolid)],
// 1 16 -10 0 40 1 0 0 0 1 0 0 0 1 stug4-1x4.dat
  [1,16,-10,0,40,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4_1x4(realsolid)],
// 1 16 40 0 0 0 0 -1 0 1 0 1 0 0 stug4-1x5.dat
  [1,16,40,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug4_1x5(realsolid)],
// 
];
module ldraw_lib__stug4_5x5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stug4_5x5(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
