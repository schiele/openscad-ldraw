use <../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3_8con10(realsolid=false) = [
// 0 Cone 10 x 0.375
// 0 Name: 3-8con10.dat
...
// 5 24 -3.827 1 9.239 -4.2097 0 10.1629 0 1 10 -7.071 1 7.071
  [5,24,-3.827,1,9.239,-4.2097,0,10.1629,0,1,10,-7.071,1,7.071],
// 5 24 -7.071 1 7.071 -7.7781 0 7.7781 -3.827 1 9.239 -10 1 4.142
  [5,24,-7.071,1,7.071,-7.7781,0,7.7781,-3.827,1,9.239,-10,1,4.142],
// 0 // Build by Primitive Generator 2
];
module ldraw_lib__3_8con10(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3_8con10(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3_8con10(line=0.2);