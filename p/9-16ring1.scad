use <../lib.scad>
function ldraw_lib__9_16ring1() = [
// 0 Ring  1 x 0.5625
// 0 Name: 9-16ring1.dat
...
module ldraw_lib__9_16ring1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__9_16ring1(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__9_16ring1(line=0.2);