...
use <logo.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stud2_logo(realsolid=false) = [
...
// 1 16 0 0 0 0.6 0 0 0 1 0 0 0 0.6 logo.dat
  [1,16,0,0,0,0.6,0,0,0,1,0,0,0,0.6, ldraw_lib__logo(realsolid)],
];
module ldraw_lib__stud2_logo(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stud2_logo(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
