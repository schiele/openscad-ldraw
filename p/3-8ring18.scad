use <../lib.scad>
function ldraw_lib__3_8ring18() = [
// 0 Ring 18 x 0.375
// 0 Name: 3-8ring18.dat
...
module ldraw_lib__3_8ring18(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3_8ring18(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3_8ring18(line=0.2);