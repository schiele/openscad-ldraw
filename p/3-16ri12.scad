...
use <3-16ring12.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3_16ri12(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3-16ring12.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3_16ring12(realsolid)],
];
module ldraw_lib__3_16ri12(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3_16ri12(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
