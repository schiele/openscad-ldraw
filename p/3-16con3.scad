use <../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3_16con3(realsolid=false) = [
// 0 Cone  3 x 0.1875
// 0 Name: 3-16con3.dat
...
// 5 24 2.1213 1 2.1213 2.8284 0 2.8284 2.7717 1 1.1481 1.1481 1 2.7717
  [5,24,2.1213,1,2.1213,2.8284,0,2.8284,2.7717,1,1.1481,1.1481,1,2.7717],
// 5 24 1.1481 1 2.7717 1.5308 0 3.6956 2.1213 1 2.1213 0 1 3.2472
  [5,24,1.1481,1,2.7717,1.5308,0,3.6956,2.1213,1,2.1213,0,1,3.2472],
// 0 // Build by LDPartEditor (PrimGen 2.X)
];
module ldraw_lib__3_16con3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3_16con3(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3_16con3(line=0.2);