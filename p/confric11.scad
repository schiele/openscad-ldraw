...
// 1 16 0 -20 0 1 0 0 0 1 0 0 0 1 connectcollar2.dat
  [1,16,0,-20,0,1,0,0,0,1,0,0,0,1, ldraw_lib__connectcollar2()],
// 1 16 0 -20 0 1 0 0 0 1 0 0 0 -1 connectcollar2.dat
  [1,16,0,-20,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__connectcollar2()],
...
// 1 16 0 -2 0 1 0 0 0 1 0 0 0 1 confricrib2.dat
  [1,16,0,-2,0,1,0,0,0,1,0,0,0,1, ldraw_lib__confricrib2()],
...
// 1 16 0 -13 .6 2.4 0 -2.4 0 13 0 2.4 0 2.4 1-4cyli.dat
  [1,16,0,-13,.6,2.4,0,-2.4,0,13,0,2.4,0,2.4, ldraw_lib__1_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -13 -.6 -2.4 0 2.4 0 13 0 -2.4 0 -2.4 1-4cyli.dat
  [1,16,0,-13,-.6,-2.4,0,2.4,0,13,0,-2.4,0,-2.4, ldraw_lib__1_4cyli()],
// 1 16 -2.4 -6.5 0 0 -1 0 -6.5 0 0 0 0 -3 rect2p.dat
  [1,16,-2.4,-6.5,0,0,-1,0,-6.5,0,0,0,0,-3, ldraw_lib__rect2p()],
// 1 16 2.4 -6.5 0 0 1 0 -6.5 0 0 0 0 -3 rect2p.dat
  [1,16,2.4,-6.5,0,0,1,0,-6.5,0,0,0,0,-3, ldraw_lib__rect2p()],
];
module ldraw_lib__confric11(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__confric11(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
