...
use <rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__hipstuda(realsolid=false) = [
...
// 1 16 0 -5.5 6 3.46 0 0 0 0 -5.5 0 -1 0 rect3.dat
  [1,16,0,-5.5,6,3.46,0,0,0,0,-5.5,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 -6 -5.5 0 0 1 0 0 0 -5.5 3.46 0 0 rect3.dat
  [1,16,-6,-5.5,0,0,1,0,0,0,-5.5,3.46,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 -5.5 -6 3.46 0 0 0 0 -5.5 0 1 0 rect3.dat
  [1,16,0,-5.5,-6,3.46,0,0,0,0,-5.5,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 6 -2 0 0 -1 0 0 0 -2 -3.46 0 0 rect3.dat
  [1,16,6,-2,0,0,-1,0,0,0,-2,-3.46,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 2.8 -5.5 0 0 1 0 0 0 -5.5 2.8 0 0 rect3.dat
  [1,16,2.8,-5.5,0,0,1,0,0,0,-5.5,2.8,0,0, ldraw_lib__rect3(realsolid)],
// 
// 1 16 3.97 -5.5 -5.24 0 -1 -.51 -5.5 0 0 0 0 -.76 rect1.dat
  [1,16,3.97,-5.5,-5.24,0,-1,-.51,-5.5,0,0,0,0,-.76, ldraw_lib__rect1(realsolid)],
// 1 16 -3.97 -5.5 -5.24 0 1 -.51 -5.5 0 0 0 0 .76 rect1.dat
  [1,16,-3.97,-5.5,-5.24,0,1,-.51,-5.5,0,0,0,0,.76, ldraw_lib__rect1(realsolid)],
// 1 16 -5.24 -5.5 -3.97 0 1 -.76 -5.5 0 0 0 0 .51 rect1.dat
  [1,16,-5.24,-5.5,-3.97,0,1,-.76,-5.5,0,0,0,0,.51, ldraw_lib__rect1(realsolid)],
// 1 16 -5.24 -5.5 3.97 0 1 .76 -5.5 0 0 0 0 .51 rect1.dat
  [1,16,-5.24,-5.5,3.97,0,1,.76,-5.5,0,0,0,0,.51, ldraw_lib__rect1(realsolid)],
// 1 16 -3.97 -5.5 5.24 0 1 .51 -5.5 0 0 0 0 .76 rect1.dat
  [1,16,-3.97,-5.5,5.24,0,1,.51,-5.5,0,0,0,0,.76, ldraw_lib__rect1(realsolid)],
...
// 1 16 0 -11 0 2.8 0 -2.8 0 11 0 -2.8 0 -2.8 3-4cyli.dat
  [1,16,0,-11,0,2.8,0,-2.8,0,11,0,-2.8,0,-2.8, ldraw_lib__3_4cyli(realsolid)],
// 1 16 0 -11 0 2.8 0 -2.8 0 1 0 -2.8 0 -2.8 3-4edge.dat
  [1,16,0,-11,0,2.8,0,-2.8,0,1,0,-2.8,0,-2.8, ldraw_lib__3_4edge(realsolid)],
...
module ldraw_lib__hipstuda(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__hipstuda(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
