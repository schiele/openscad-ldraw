...
use <1-8edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__znap6(realsolid=false) = [
// 0 Znap Beam End
// 0 Name: znap6.dat
...
// 1 16 -4.36 8 -5 0 0 2 2 0 0 0 -1 0 1-4edge.dat
  [1,16,-4.36,8,-5,0,0,2,2,0,0,0,-1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -4.36 8 -5 2 0 0 0 0 2 0 1 0 1-4disc.dat
  [1,16,-4.36,8,-5,2,0,0,0,0,2,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 -4.36 8 -1.5 0 0 2 2 0 0 0 -1 0 1-4edge.dat
  [1,16,-4.36,8,-1.5,0,0,2,2,0,0,0,-1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -4.36 8 -1.5 0 0 2 2 0 0 0 -1 0 1-4disc.dat
  [1,16,-4.36,8,-1.5,0,0,2,2,0,0,0,-1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 -4.36 8 -1.5 0 0 2 2 0 0 0 -3.5 0 1-4cyli.dat
  [1,16,-4.36,8,-1.5,0,0,2,2,0,0,0,-3.5,0, ldraw_lib__1_4cyli(realsolid)],
// 0 //
// 4 16 6.36 -10 -1.5 6.36 10 -1.5 4.36 10 -1.5 4.36 -10 -1.5
  [4,16,6.36,-10,-1.5,6.36,10,-1.5,4.36,10,-1.5,4.36,-10,-1.5],
// 4 16 4.36 -8 -1.5 4.36 -6 -1.5 2.36 -6 -1.5 2.36 -8 -1.5
...
// 1 16 0 10 20 3.442 0 -8.31 0 -1 0 -8.31 0 -3.442 1-8edge.dat
  [1,16,0,10,20,3.442,0,-8.31,0,-1,0,-8.31,0,-3.442, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 -10 20 3.442 0 -8.31 0 -1 0 -8.31 0 -3.442 1-8edge.dat
  [1,16,0,-10,20,3.442,0,-8.31,0,-1,0,-8.31,0,-3.442, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 10 20 3.442 0 -8.31 0 -20 0 -8.31 0 -3.442 1-8cyli.dat
  [1,16,0,10,20,3.442,0,-8.31,0,-20,0,-8.31,0,-3.442, ldraw_lib__1_8cyli(realsolid)],
// 0 //
...
// 1 16 -3.442 10 9.69 -2 0 0 0 -1 0 0 0 2 1-4edge.dat
  [1,16,-3.442,10,9.69,-2,0,0,0,-1,0,0,0,2, ldraw_lib__1_4edge(realsolid)],
// 1 16 -3.442 -10 9.69 -2 0 0 0 -1 0 0 0 2 1-4edge.dat
  [1,16,-3.442,-10,9.69,-2,0,0,0,-1,0,0,0,2, ldraw_lib__1_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -3.442 10 9.69 -2 0 0 0 -20 0 0 0 2 1-4cyli.dat
  [1,16,-3.442,10,9.69,-2,0,0,0,-20,0,0,0,2, ldraw_lib__1_4cyli(realsolid)],
...
module ldraw_lib__znap6(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__znap6(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
