...
use <st4jfil4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stud4f2w(realsolid=false) = [
...
// 1 16 0 -4 0 6 0 0 0 5 0 0 0 -6 4-4edge.dat
  [1,16,0,-4,0,6,0,0,0,5,0,0,0,-6, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 st4jfil4.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__st4jfil4(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 st4jfil4.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__st4jfil4(realsolid)],
];
module ldraw_lib__stud4f2w(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stud4f2w(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
