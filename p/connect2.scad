...
use <4-4cyli.scad>
$fa=1; $fs=0.2;
function ldraw_lib__connect2(realsolid=false) = [
...
// 1 16 0 -11.5 0 6 0 0 0 11.5 0 0 0 6 4-4cyli.dat
  [1,16,0,-11.5,0,6,0,0,0,11.5,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
...
module ldraw_lib__connect2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__connect2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__connect2(line=0.2);