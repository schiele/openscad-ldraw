use <../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4_4ring4(realsolid=false) = [
// 0 Ring  4 x 1.0
// 0 Name: 4-4ring4.dat
...
module ldraw_lib__4_4ring4(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4_4ring4(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4_4ring4(line=0.2);