...
use <rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__confric9(realsolid=false) = [
// 0 Technic Friction Pin Middle Slotted with Unsplit Base Collar
// 0 Name: confric9.dat
...
// 4 16 2.296 -8.5 5.543 2.296 -2 5.543 1 -2 5.801 1 -8.5 5.801
  [4,16,2.296,-8.5,5.543,2.296,-2,5.543,1,-2,5.801,1,-8.5,5.801],
...
// 4 16 2.296 -2 -5.543 2.296 -8.5 -5.543 1 -8.5 -5.801 1 -2 -5.801
  [4,16,2.296,-2,-5.543,2.296,-8.5,-5.543,1,-8.5,-5.801,1,-2,-5.801],
// 1 16 0 -7.5 -6 0 0 1 -1 0 0 0 1 0.199 1-4ndis.dat
  [1,16,0,-7.5,-6,0,0,1,-1,0,0,0,1,0.199, ldraw_lib__1_4ndis(realsolid)],
// 1 16 0 -7.5 -6 0 0 1 -1 0 0 0 1 0.199 1-4edge.dat
...
// 1 16 1 -3.751 4.801 0 1 0 0 0 3.75 1 0 0 rect3.dat
  [1,16,1,-3.751,4.801,0,1,0,0,0,3.75,1,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 1 -3.751 -4.801 0 1 0 0 0 3.75 1 0 0 rect3.dat
  [1,16,1,-3.751,-4.801,0,1,0,0,0,3.75,1,0,0, ldraw_lib__rect3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 -2 0 6 0 0 0 2 0 0 0 6 4-4cyli.dat
  [1,16,0,-2,0,6,0,0,0,2,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -1 -3.751 4.801 0 -1 0 0 0 3.75 1 0 0 rect3.dat
  [1,16,-1,-3.751,4.801,0,-1,0,0,0,3.75,1,0,0, ldraw_lib__rect3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__confric9(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__confric9(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__confric9(line=0.2);