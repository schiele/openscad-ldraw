...
use <stug3-1x6.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stug3_1x11(realsolid=false) = [
...
// 1 16 -50 0 0 1 0 0 0 1 0 0 0 1 stug3-1x6.dat
  [1,16,-50,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3_1x6(realsolid)],
// 1 16 60 0 0 1 0 0 0 1 0 0 0 1 stug3-1x5.dat
  [1,16,60,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3_1x5(realsolid)],
];
module ldraw_lib__stug3_1x11(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stug3_1x11(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
