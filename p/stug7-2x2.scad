...
use <stud7.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stug7_2x2(realsolid=false) = [
...
// 1 16 -20 0 20 1 0 0 0 1 0 0 0 1 stud7.dat
  [1,16,-20,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud7(realsolid)],
// 1 16 20 0 20 1 0 0 0 1 0 0 0 1 stud7.dat
  [1,16,20,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud7(realsolid)],
// 1 16 -20 0 -20 1 0 0 0 1 0 0 0 1 stud7.dat
  [1,16,-20,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud7(realsolid)],
...
module ldraw_lib__stug7_2x2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stug7_2x2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
