...
use <rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__confric(realsolid=false) = [
// 0 Technic Friction Pin 1.0 with Base Collar
// 0 Name: confric.dat
...
// 1 16 0 -2 0 6 0 0 0 -9.5 0 0 0 6 4-4cyli.dat
  [1,16,0,-2,0,6,0,0,0,-9.5,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
...
module ldraw_lib__confric(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__confric(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
