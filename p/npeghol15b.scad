...
use <rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__npeghol15b(realsolid=false) = [
...
// 1 16 8.50405 .5 5.4 -1.49595 0 0 0 0 .5 0 1 0 rect2p.dat
  [1,16,8.50405,.5,5.4,-1.49595,0,0,0,0,.5,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 9.321 .5 1.8 .679 0 0 0 0 .5 0 -1 0 rect2p.dat
  [1,16,9.321,.5,1.8,.679,0,0,0,0,.5,0,-1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 8.47855 .5 2.62215 0 -1 .16345 -.5 0 0 0 0 -.82215 rect3.dat
  [1,16,8.47855,.5,2.62215,0,-1,.16345,-.5,0,0,0,0,-.82215, ldraw_lib__rect3(realsolid)],
// 1 16 7.6616 .5 4.42215 0 -1 -.6535 .5 0 0 0 0 .97785 rect3.dat
  [1,16,7.6616,.5,4.42215,0,-1,-.6535,.5,0,0,0,0,.97785, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__npeghol15b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__npeghol15b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
