...
use <rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__clip16(realsolid=false) = [
...
// 1 16 -3.686 0 -2.794 0 -1 -0.06 -4 0 0 0 0 -1.206 rect3.dat
  [1,16,-3.686,0,-2.794,0,-1,-0.06,-4,0,0,0,0,-1.206, ldraw_lib__rect3(realsolid)],
// 1 16 -5.277 0 -4 0 0 -1.532 -4 0 0 0 1 0 rect3.dat
  [1,16,-5.277,0,-4,0,0,-1.532,-4,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 5.277 0 -4 0 0 -1.532 -4 0 0 0 1 0 rect3.dat
  [1,16,5.277,0,-4,0,0,-1.532,-4,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 3.686 0 -2.794 0 1 -0.06 -4 0 0 0 0 1.206 rect3.dat
  [1,16,3.686,0,-2.794,0,1,-0.06,-4,0,0,0,0,1.206, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__clip16(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__clip16(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
