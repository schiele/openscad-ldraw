...
function ldraw_lib__stu22_logo4() = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 8\stud2-logo4.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__8__stud2_logo4()],
];
module ldraw_lib__stu22_logo4(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stu22_logo4(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
