...
use <8/stud27.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stu227(realsolid=false) = [
// 0 ~Moved to 8\stud27
// 0 Name: stu227.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 8\stud27.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__8__stud27(realsolid)],
];
module ldraw_lib__stu227(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stu227(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
