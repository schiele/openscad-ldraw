use <../lib.scad>
function ldraw_lib__7_16ring4() = [
// 0 Ring  4 x 0.4375
// 0 Name: 7-16ring4.dat
...
// 0 !HISTORY 2024-03-23 [OrionP] Moved from 7-16rin4.dat
...
module ldraw_lib__7_16ring4(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__7_16ring4(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__7_16ring4(line=0.2);