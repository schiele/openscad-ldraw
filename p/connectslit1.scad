...
use <rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__connectslit1(realsolid=false) = [
...
// 1 16 6 8 0 0 -1 -0.199 1 0 0 0 0 1 8\1-4ndis.dat
  [1,16,6,8,0,0,-1,-0.199,1,0,0,0,0,1, ldraw_lib__8__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 6 8 0 0 -2 -0.199 1 0 0 0 0 1 8\1-4cylo.dat
  [1,16,6,8,0,0,-2,-0.199,1,0,0,0,0,1, ldraw_lib__8__1_4cylo(realsolid)],
// 1 16 4 8 0 0 1 -0.199 1 0 0 0 0 1 8\1-4ndis.dat
  [1,16,4,8,0,0,1,-0.199,1,0,0,0,0,1, ldraw_lib__8__1_4ndis(realsolid)],
// 1 16 6 -8 0 0 -1 -0.199 -1 0 0 0 0 1 8\1-4ndis.dat
  [1,16,6,-8,0,0,-1,-0.199,-1,0,0,0,0,1, ldraw_lib__8__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 9 0 2.82843 0 2.82843 0 -18 0 2.82843 0 -2.82843 1-16cyli.dat
  [1,16,0,9,0,2.82843,0,2.82843,0,-18,0,2.82843,0,-2.82843, ldraw_lib__1_16cyli(realsolid)],
// 1 16 0 -9 0 0 0 6 0 18 0 6 0 0 3-16cyli.dat
  [1,16,0,-9,0,0,0,6,0,18,0,6,0,0, ldraw_lib__3_16cyli(realsolid)],
...
// 1 16 4.801 0 1 0 0 1 8 0 0 0 1 0 rect2p.dat
  [1,16,4.801,0,1,0,0,1,8,0,0,0,1,0, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__connectslit1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__connectslit1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
