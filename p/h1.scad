...
use <rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__h1(realsolid=false) = [
...
// 1 16 0 2 -2 4 0 0 0 0 4 0 1 0 2-4edge.dat
  [1,16,0,2,-2,4,0,0,0,0,4,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 2 2 4 0 0 0 0 4 0 1 0 2-4edge.dat
  [1,16,0,2,2,4,0,0,0,0,4,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 
// 1 16 0 2 -10 4 0 0 0 0 4 0 4 0 2-4cylc.dat
  [1,16,0,2,-10,4,0,0,0,0,4,0,4,0, ldraw_lib__2_4cylc(realsolid)],
...
// 1 16 0 2 -2 4 0 0 0 0 4 0 4 0 2-4cyli.dat
  [1,16,0,2,-2,4,0,0,0,0,4,0,4,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 10 2 4 0 0 0 0 4 0 4 0 2-4cylc.dat
  [1,16,0,10,2,4,0,0,0,0,4,0,4,0, ldraw_lib__2_4cylc(realsolid)],
// 1 16 0 2 10 4 0 0 0 0 4 0 -4 0 2-4cylc.dat
  [1,16,0,2,10,4,0,0,0,0,4,0,-4,0, ldraw_lib__2_4cylc(realsolid)],
...
// 1 16 0 0 0 4 0 0 0 2 0 0 0 10 box4o8a.dat
  [1,16,0,0,0,4,0,0,0,2,0,0,0,10, ldraw_lib__box4o8a(realsolid)],
// 
// 1 16 4 6 -4 0 -1 0 -4 0 0 0 0 -2 rect2p.dat
  [1,16,4,6,-4,0,-1,0,-4,0,0,0,0,-2, ldraw_lib__rect2p(realsolid)],
// 1 16 -4 6 -4 0 1 0 -4 0 0 0 0 2 rect2p.dat
  [1,16,-4,6,-4,0,1,0,-4,0,0,0,0,2, ldraw_lib__rect2p(realsolid)],
// 1 16 4 6 4 0 -1 0 -4 0 0 0 0 -2 rect2p.dat
  [1,16,4,6,4,0,-1,0,-4,0,0,0,0,-2, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__h1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__h1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
