use <../lib.scad>
function ldraw_lib__2_4rin20() = [
// 0 ~Ring 20 x 0.5 (Obsolete)
// 0 Name: 2-4rin20.dat
...
// 0 !HISTORY 2024-03-23 [OrionP] Obsolete, use 2-4ring20.dat
...
module ldraw_lib__2_4rin20(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2_4rin20(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2_4rin20(line=0.2);