...
use <npeghol7a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__npeghol2(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 npeghol7a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__npeghol7a(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 npeghol7a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__npeghol7a(realsolid)],
];
module ldraw_lib__npeghol2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__npeghol2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
