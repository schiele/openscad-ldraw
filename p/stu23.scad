...
use <8/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stu23(realsolid=false) = [
// 0 ~Moved to 8\stud3
// 0 Name: stu23.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 8\stud3.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__8__stud3(realsolid)],
];
module ldraw_lib__stu23(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stu23(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
