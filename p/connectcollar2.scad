...
use <8/1-4ndis.scad>
use <rect2a.scad>
function ldraw_lib__connectcollar2() = [
...
// 1 16 2.4 6 0 0 1 0 1 0 0 0 0 1 8\1-4edge.dat
  [1,16,2.4,6,0,0,1,0,1,0,0,0,0,1, ldraw_lib__8__1_4edge()],
...
// 1 16 2.4 6 0 0 1 0 1 0 0 0 0 1 8\1-4ndis.dat
  [1,16,2.4,6,0,0,1,0,1,0,0,0,0,1, ldraw_lib__8__1_4ndis()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 6 6 0 0 -3.401 -0.199 1 0 0 0 0 1 8\1-4cyli.dat
  [1,16,6,6,0,0,-3.401,-0.199,1,0,0,0,0,1, ldraw_lib__8__1_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 2.4 6 0 0 0.199 0 0 0 1 1 0 0 8\1-4cyls.dat
  [1,16,2.4,6,0,0,0.199,0,0,0,1,1,0,0, ldraw_lib__8__1_4cyls()],
// 1 16 -6 6 0 0 1 0.199 1 0 0 0 0 1 8\1-4edge.dat
  [1,16,-6,6,0,0,1,0.199,1,0,0,0,0,1, ldraw_lib__8__1_4edge()],
// 1 16 -2.4 6 0 0 -1 0 1 0 0 0 0 1 8\1-4edge.dat
  [1,16,-2.4,6,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__8__1_4edge()],
...
// 1 16 4.1005 3 1 0 0 -1.7005 -3 0 0 0 1 0 rect2a.dat
  [1,16,4.1005,3,1,0,0,-1.7005,-3,0,0,0,1,0, ldraw_lib__rect2a()],
// 1 16 -4.1005 3 1 1.7005 0 0 0 0 -3 0 1 0 rect2a.dat
  [1,16,-4.1005,3,1,1.7005,0,0,0,0,-3,0,1,0, ldraw_lib__rect2a()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0.6 2.4 0 -2.4 0 7 0 2.4 0 2.4 1-4cyli.dat
  [1,16,0,0,0.6,2.4,0,-2.4,0,7,0,2.4,0,2.4, ldraw_lib__1_4cyli()],
...
// 1 16 2.4 3.5 2 0 1 0 -3.5 0 0 0 0 1 rect2a.dat
  [1,16,2.4,3.5,2,0,1,0,-3.5,0,0,0,0,1, ldraw_lib__rect2a()],
// 1 16 -2.4 3.5 2 0 -1 0 0 0 -3.5 1 0 0 rect2a.dat
  [1,16,-2.4,3.5,2,0,-1,0,0,0,-3.5,1,0,0, ldraw_lib__rect2a()],
];
module ldraw_lib__connectcollar2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__connectcollar2(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
