use <../lib.scad>
function ldraw_lib__4_4ring10() = [
// 0 Ring 10 x 1.0
// 0 Name: 4-4ring10.dat
...
// 0 !HISTORY 2024-03-23 [OrionP] Moved from 4-4rin10.dat
...
module ldraw_lib__4_4ring10(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4_4ring10(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4_4ring10(line=0.2);