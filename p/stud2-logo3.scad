...
use <t01o0714.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stud2_logo3(realsolid=false) = [
// 0 Stud Open with LEGO Logo - 3D with Sharp Top
// 0 Name: stud2-logo3.dat
...
// 
// 1 16 0 0 0 0.62 0 0 0 0.62 0 0 0 0.62 logo3.dat
  [1,16,0,0,0,0.62,0,0,0,0.62,0,0,0,0.62, ldraw_lib__logo3(realsolid)],
];
module ldraw_lib__stud2_logo3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stud2_logo3(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__stud2_logo3(line=0.2);