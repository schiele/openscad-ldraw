...
use <logo3.scad>
use <t01o0714.scad>
function ldraw_lib__stud2_logo3() = [
...
// 1 16 0 0 0 0.62 0 0 0 0.62 0 0 0 0.62 logo3.dat
  [1,16,0,0,0,0.62,0,0,0,0.62,0,0,0,0.62, ldraw_lib__logo3()],
];
module ldraw_lib__stud2_logo3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stud2_logo3(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
