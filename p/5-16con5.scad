...
// 5 24 0 1 5 0 0 6 1.9135 1 4.6195 -1.9135 1 4.6195
  [5,24,0,1,5,0,0,6,1.9135,1,4.6195,-1.9135,1,4.6195],
// 5 24 -1.9135 1 4.6195 -2.2962 0 5.5434 0 1 5 -3.827 1 3.827
  [5,24,-1.9135,1,4.6195,-2.2962,0,5.5434,0,1,5,-3.827,1,3.827],
// 0 // Build by LDPartEditor (PrimGen 2.X)
];
module ldraw_lib__5_16con5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__5_16con5(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__5_16con5(line=0.2);