...
$fa=1; $fs=0.2;
function ldraw_lib__stu2_logo(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 8\stud-logo.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__8__stud_logo(realsolid)],
];
module ldraw_lib__stu2_logo(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stu2_logo(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
