...
use <stug-6x6.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stug_7x7(realsolid=false) = [
// 0 Stud Group  7 x  7
// 0 Name: stug-7x7.dat
...
// 1 16 -10 0 10 1 0 0 0 1 0 0 0 1 stug-6x6.dat
  [1,16,-10,0,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_6x6(realsolid)],
// 1 16 60 0 -40 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,60,0,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 60 0 -20 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,60,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 60 0 0 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,60,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 60 0 20 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,60,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 60 0 40 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,60,0,40,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 60 0 60 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,60,0,60,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 -60 0 -60 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-60,0,-60,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 -40 0 -60 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-40,0,-60,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 -20 0 -60 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-20,0,-60,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
...
module ldraw_lib__stug_7x7(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stug_7x7(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
