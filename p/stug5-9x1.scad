use <../lib.scad>
use <stud5.scad>
function ldraw_lib__stug5_9x1() = [
// 0 Stud Scala Group  9 x  1
// 0 Name: stug5-9x1.dat
...
module ldraw_lib__stug5_9x1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stug5_9x1(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__stug5_9x1(line=0.2);