...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 8\stud4f4n.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__8__stud4f4n()],
];
module ldraw_lib__stu24f4n(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stu24f4n(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
