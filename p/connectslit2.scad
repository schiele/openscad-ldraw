...
use <8/1-4ndis.scad>
use <rect2p.scad>
function ldraw_lib__connectslit2() = [
...
module ldraw_lib__connectslit2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__connectslit2(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
