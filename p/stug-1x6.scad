...
use <stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stug_1x6(realsolid=false) = [
// 0 Stud Group  1 x  6
// 0 Name: stug-1x6.dat
...
module ldraw_lib__stug_1x6(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stug_1x6(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__stug_1x6(line=0.2);