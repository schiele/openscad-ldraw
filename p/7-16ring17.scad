use <../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__7_16ring17(realsolid=false) = [
// 0 Ring 17 x 0.4375
// 0 Name: 7-16ring17.dat
...
module ldraw_lib__7_16ring17(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__7_16ring17(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__7_16ring17(line=0.2);