...
use <logo2.scad>
use <t01o0714.scad>
function ldraw_lib__stud2_logo2() = [
...
// 1 16 0 0 0 0.62 0 0 0 0.62 0 0 0 0.62 logo2.dat
  [1,16,0,0,0,0.62,0,0,0,0.62,0,0,0,0.62, ldraw_lib__logo2()],
];
module ldraw_lib__stud2_logo2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stud2_logo2(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
