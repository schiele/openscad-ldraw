...
use <t04o2500.scad>
$fa=1; $fs=0.2;
function ldraw_lib__t04q2500(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 t04i2500.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__t04i2500(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 t04o2500.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__t04o2500(realsolid)],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 1 t04i2500.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__t04i2500(realsolid)],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 1 t04o2500.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__t04o2500(realsolid)],
...
module ldraw_lib__t04q2500(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t04q2500(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
