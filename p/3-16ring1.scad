...
// 0 !HISTORY 2024-03-23 [OrionP] Moved from 3-16rin1.dat
...
module ldraw_lib__3_16ring1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3_16ring1(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
