...
use <8/stud10.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stu210(realsolid=false) = [
// 0 ~Moved to 8\stud10
// 0 Name: stu210.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 8\stud10.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__8__stud10(realsolid)],
];
module ldraw_lib__stu210(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stu210(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
