...
use <t01o0714.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stud2_logo5(realsolid=false) = [
...
// 1 16 0 0 0 0.62 0 0 0 0.62 0 0 0 0.62 logo5.dat
  [1,16,0,0,0,0.62,0,0,0,0.62,0,0,0,0.62, ldraw_lib__logo5(realsolid)],
];
module ldraw_lib__stud2_logo5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stud2_logo5(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__stud2_logo5(line=0.2);