use <../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2_4rin11(realsolid=false) = [
// 0 Ring 11 x 0.5
// 0 Name: 2-4rin11.dat
...
module ldraw_lib__2_4rin11(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2_4rin11(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2_4rin11(line=0.2);