use <../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3_4ring1(realsolid=false) = [
// 0 Ring  1 x 0.75
// 0 Name: 3-4ring1.dat
...
module ldraw_lib__3_4ring1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3_4ring1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3_4ring1(line=0.2);