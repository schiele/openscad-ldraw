use <../lib.scad>
function ldraw_lib__1_4ring19() = [
// 0 Ring 19 x 0.25
// 0 Name: 1-4ring19.dat
...
// 0 !HISTORY 2024-03-23 [OrionP] Moved from 1-4rin19.dat
...
module ldraw_lib__1_4ring19(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__1_4ring19(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__1_4ring19(line=0.2);