...
use <rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__axlehol4(realsolid=false) = [
...
// 
// 1 16 5.80115 .5 1 0 0 -.19885 -.5 0 0 0 1 1 rect3.dat
  [1,16,5.80115,.5,1,0,0,-.19885,-.5,0,0,0,1,1, ldraw_lib__rect3(realsolid)],
// 1 16 -5.80115 .5 1 0 0 .19885 -.5 0 0 0 1 1 rect3.dat
  [1,16,-5.80115,.5,1,0,0,.19885,-.5,0,0,0,1,1, ldraw_lib__rect3(realsolid)],
// 1 16 -5.80115 .5 -1 0 0 .19885 -.5 0 0 0 -1 -1 rect3.dat
  [1,16,-5.80115,.5,-1,0,0,.19885,-.5,0,0,0,-1,-1, ldraw_lib__rect3(realsolid)],
// 1 16 -1 .5 -5.80115 0 -1 -1 -.5 0 0 0 0 .19885 rect3.dat
  [1,16,-1,.5,-5.80115,0,-1,-1,-.5,0,0,0,0,.19885, ldraw_lib__rect3(realsolid)],
// 1 16 1 .5 -5.80115 0 1 1 -.5 0 0 0 0 .19885 rect3.dat
  [1,16,1,.5,-5.80115,0,1,1,-.5,0,0,0,0,.19885, ldraw_lib__rect3(realsolid)],
// 1 16 5.80115 .5 -1 0 0 -.19885 -.5 0 0 0 -1 -1 rect3.dat
  [1,16,5.80115,.5,-1,0,0,-.19885,-.5,0,0,0,-1,-1, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__axlehol4(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__axlehol4(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__axlehol4(line=0.2);