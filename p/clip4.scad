...
use <box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__clip4(realsolid=false) = [
...
// 1 16 0 0 -6 1 0 0 0 0 -4 0 2 0 box5.dat
  [1,16,0,0,-6,1,0,0,0,0,-4,0,2,0, ldraw_lib__box5(realsolid)],
// 0
...
// 1 16 -5.069 -4 2.453 -1.41 0 0.513 0 8 0 0.513 0 1.41 2-4cyli.dat
  [1,16,-5.069,-4,2.453,-1.41,0,0.513,0,8,0,0.513,0,1.41, ldraw_lib__2_4cyli(realsolid)],
// 1 16 5.069 -4 2.453 1.41 0 -0.513 0 8 0 0.513 0 1.41 2-4cyli.dat
  [1,16,5.069,-4,2.453,1.41,0,-0.513,0,8,0,0.513,0,1.41, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -5.069 -4 2.453 -1.41 0 0.513 0 8 0 0.513 0 1.41 2-4disc.dat
  [1,16,-5.069,-4,2.453,-1.41,0,0.513,0,8,0,0.513,0,1.41, ldraw_lib__2_4disc(realsolid)],
// 1 16 5.069 4 2.453 1.41 0 -.513 0 -8 0 .513 0 1.41 2-4disc.dat
  [1,16,5.069,4,2.453,1.41,0,-.513,0,-8,0,.513,0,1.41, ldraw_lib__2_4disc(realsolid)],
// 
// 1 16 5.069 -4 2.453 1.41 0 -0.513 0 8 0 0.513 0 1.41 2-4disc.dat
  [1,16,5.069,-4,2.453,1.41,0,-0.513,0,8,0,0.513,0,1.41, ldraw_lib__2_4disc(realsolid)],
// 1 16 -5.069 4 2.453 -1.41 0 .513 0 -8 0 .513 0 1.41 2-4disc.dat
...
// 1 16 -5.069 -4 2.453 -1.41 0 0.513 0 8 0 0.513 0 1.41 2-4edge.dat
  [1,16,-5.069,-4,2.453,-1.41,0,0.513,0,8,0,0.513,0,1.41, ldraw_lib__2_4edge(realsolid)],
// 1 16 -5.069 4 2.453 -1.41 0 0.513 0 8 0 0.513 0 1.41 2-4edge.dat
  [1,16,-5.069,4,2.453,-1.41,0,0.513,0,8,0,0.513,0,1.41, ldraw_lib__2_4edge(realsolid)],
// 1 16 5.069 -4 2.453 1.41 0 -0.513 0 8 0 0.513 0 1.41 2-4edge.dat
  [1,16,5.069,-4,2.453,1.41,0,-0.513,0,8,0,0.513,0,1.41, ldraw_lib__2_4edge(realsolid)],
...
module ldraw_lib__clip4(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__clip4(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
