use <../lib.scad>
use <stug20-1x5.scad>
function ldraw_lib__stug20_5x5() = [
...
// 1 16 0 0 -40 1 0 0 0 1 0 0 0 1 stug20-1x5.dat
  [1,16,0,0,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x5()],
// 1 16 0 0 -80 1 0 0 0 1 0 0 0 1 stug20-1x5.dat
  [1,16,0,0,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x5()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 stug20-1x5.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x5()],
// 1 16 0 0 40 1 0 0 0 1 0 0 0 1 stug20-1x5.dat
  [1,16,0,0,40,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x5()],
// 1 16 0 0 80 1 0 0 0 1 0 0 0 1 stug20-1x5.dat
  [1,16,0,0,80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x5()],
...
module ldraw_lib__stug20_5x5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stug20_5x5(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
