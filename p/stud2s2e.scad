...
// 1 16 0 0 0 3.5 0 0 0 1 0 0 0 3.5 4-4cyli.dat
  [1,16,0,0,0,3.5,0,0,0,1,0,0,0,3.5, ldraw_lib__4_4cyli()],
...
module ldraw_lib__stud2s2e(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stud2s2e(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
