...
use <4-4ring2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__studp01(realsolid=false) = [
// 0 Stud with Dot Pattern
// 0 Name: studp01.dat
...
// 1 15 0 -4 0 4 0 0 0 1 0 0 0 4 4-4disc.dat
  [1,15,0,-4,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4disc(realsolid)],
// 0
];
module ldraw_lib__studp01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__studp01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__studp01(line=0.2);