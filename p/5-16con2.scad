use <../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__5_16con2(realsolid=false) = [
// 0 Cone  2 x 0.3125
// 0 Name: 5-16con2.dat
...
// 5 24 0 1 2 0 0 3 0.7654 1 1.8478 -0.7654 1 1.8478
  [5,24,0,1,2,0,0,3,0.7654,1,1.8478,-0.7654,1,1.8478],
// 5 24 -0.7654 1 1.8478 -1.1481 0 2.7717 0 1 2 -1.5308 1 1.5308
  [5,24,-0.7654,1,1.8478,-1.1481,0,2.7717,0,1,2,-1.5308,1,1.5308],
// 0 // Build by Primitive Generator 2
];
module ldraw_lib__5_16con2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__5_16con2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__5_16con2(line=0.2);