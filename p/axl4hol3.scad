...
use <1-8edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__axl4hol3(realsolid=false) = [
...
// 1 16 0 0 0 -2.296 0 -5.543 0 1 0 5.543 0 -2.296 1-8edge.dat
  [1,16,0,0,0,-2.296,0,-5.543,0,1,0,5.543,0,-2.296, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 0 0 2.296 0 5.543 0 1 0 -5.543 0 2.296 1-8edge.dat
  [1,16,0,0,0,2.296,0,5.543,0,1,0,-5.543,0,2.296, ldraw_lib__1_8edge(realsolid)],
];
module ldraw_lib__axl4hol3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__axl4hol3(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
