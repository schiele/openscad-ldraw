use <../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3_16cyli(realsolid=false) = [
// 0 Cylinder 0.1875
// 0 Name: 3-16cyli.dat
...
module ldraw_lib__3_16cyli(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3_16cyli(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3_16cyli(line=0.2);