...
use <2-4edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__finger1(realsolid=false) = [
...
// 1 16 0 0 4 4 0 0 0 1 0 0 0 4 2-4edge.dat
  [1,16,0,0,4,4,0,0,0,1,0,0,0,4, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -6 4 4 0 0 0 1 0 0 0 4 2-4edge.dat
  [1,16,0,-6,4,4,0,0,0,1,0,0,0,4, ldraw_lib__2_4edge(realsolid)],
// 2 24 4 0 4 4 0 -6
  [2,24,4,0,4,4,0,-6],
// 2 24 -4 0 4 -4 0 -6
  [2,24,-4,0,4,-4,0,-6],
...
// 1 16 0 0 4 -4 0 0 0 -1 0 0 0 4 2-4disc.dat
  [1,16,0,0,4,-4,0,0,0,-1,0,0,0,4, ldraw_lib__2_4disc(realsolid)],
// 1 16 0 -6 4 4 0 0 0 1 0 0 0 4 2-4disc.dat
  [1,16,0,-6,4,4,0,0,0,1,0,0,0,4, ldraw_lib__2_4disc(realsolid)],
// 1 16 0 -6 4 4 0 0 0 6 0 0 0 4 2-4cyli.dat
  [1,16,0,-6,4,4,0,0,0,6,0,0,0,4, ldraw_lib__2_4cyli(realsolid)],
...
module ldraw_lib__finger1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__finger1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
