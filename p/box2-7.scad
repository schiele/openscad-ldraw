...
// 0 !HISTORY 2024-01-02 [Holly-Wood] Complete re-write, original by guyvivan
...
module ldraw_lib__box2_7(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__box2_7(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
