...
use <../empty.scad>
$fa=1; $fs=0.2;
function ldraw_lib__8__logo5(realsolid=false) = [
// 0 LEGO Logo for Studs - 3D Flattened (Fast-Draw)
// 0 Name: 8\logo5.dat
...
module ldraw_lib__8__logo5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__8__logo5(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__8__logo5(line=0.2);