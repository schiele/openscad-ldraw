...
use <../empty.scad>
$fa=1; $fs=0.2;
function ldraw_lib__8__logo3(realsolid=false) = [
// 0 LEGO Logo for Studs - 3D with Sharp Top (Fast-Draw)
// 0 Name: 8\logo3.dat
...
module ldraw_lib__8__logo3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__8__logo3(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__8__logo3(line=0.2);