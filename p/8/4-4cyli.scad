use <../../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__8__4_4cyli(realsolid=false) = [
// 0 Cylinder 1.0
...
module ldraw_lib__8__4_4cyli(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__8__4_4cyli(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__8__4_4cyli(line=0.2);