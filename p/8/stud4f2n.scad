use <../../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__8__stud4f2n(realsolid=false) = [
// 0 Stud Tube Open with  2 Fillets Narrow Opposite (Fast-Draw)
// 0 Name: 8\stud4f2n.dat
...
module ldraw_lib__8__stud4f2n(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__8__stud4f2n(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__8__stud4f2n(line=0.2);