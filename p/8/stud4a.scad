...
use <4-4ring3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__8__stud4a(realsolid=false) = [
...
module ldraw_lib__8__stud4a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__8__stud4a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__8__stud4a(line=0.2);