...
use <stud8.scad>
$fa=1; $fs=0.2;
function ldraw_lib__8__stud14(realsolid=false) = [
...
// 1 16 0 0 0 1.5 0 0 0 4.75 0 0 0 1.5 8\stud8.dat
  [1,16,0,0,0,1.5,0,0,0,4.75,0,0,0,1.5, ldraw_lib__8__stud8(realsolid)],
];
module ldraw_lib__8__stud14(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__8__stud14(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
