...
use <4-4edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__8__stud2s2(realsolid=false) = [
...
// 1 16 0 1 0 3.5 0 0 -0.58333 1 0 0 0 3.5 8\4-4edge.dat
  [1,16,0,1,0,3.5,0,0,-0.58333,1,0,0,0,3.5, ldraw_lib__8__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0.41667 0 3.5 0 0 0 0.58333 0 0 0 3.5 8\4-4cyls.dat
  [1,16,0,0.41667,0,3.5,0,0,0,0.58333,0,0,0,3.5, ldraw_lib__8__4_4cyls(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 3.5 0 0 0 0.41667 0 0 0 3.5 8\4-4cyli.dat
  [1,16,0,0,0,3.5,0,0,0,0.41667,0,0,0,3.5, ldraw_lib__8__4_4cyli(realsolid)],
// 1 16 0 1 0 6 0 0 -1 1 0 0 0 6 8\4-4edge.dat
  [1,16,0,1,0,6,0,0,-1,1,0,0,0,6, ldraw_lib__8__4_4edge(realsolid)],
// 1 16 0 0 0 6 0 0 0 1 0 0 0 6 8\4-4cyls.dat
  [1,16,0,0,0,6,0,0,0,1,0,0,0,6, ldraw_lib__8__4_4cyls(realsolid)],
];
module ldraw_lib__8__stud2s2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__8__stud2s2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
