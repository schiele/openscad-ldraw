...
use <4-4edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__8__stud2s(realsolid=false) = [
...
// 1 16 0 0.3333 0 4 0 0 0 0.6667 0 0 0 4 8\4-4cyls.dat
  [1,16,0,0.3333,0,4,0,0,0,0.6667,0,0,0,4, ldraw_lib__8__4_4cyls(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 4 0 0 0 0.3333 0 0 0 4 8\4-4cyli.dat
  [1,16,0,0,0,4,0,0,0,0.3333,0,0,0,4, ldraw_lib__8__4_4cyli(realsolid)],
// 1 16 0 1 0 4 0 0 -0.6667 1 0 0 0 4 8\4-4edge.dat
  [1,16,0,1,0,4,0,0,-0.6667,1,0,0,0,4, ldraw_lib__8__4_4edge(realsolid)],
...
module ldraw_lib__8__stud2s(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__8__stud2s(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
