...
use <rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__connect8(realsolid=false) = [
...
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -11.5 0 4 0 0 0 9.5 0 0 0 4 4-4cyli.dat
  [1,16,0,-11.5,0,4,0,0,0,9.5,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
...
module ldraw_lib__connect8(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__connect8(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__connect8(line=0.2);