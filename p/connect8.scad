...
// 1 16 0 -11.5 0 4 0 0 0 9.5 0 0 0 4 4-4cyli.dat
  [1,16,0,-11.5,0,4,0,0,0,9.5,0,0,0,4, ldraw_lib__4_4cyli()],
...
// 1 16 0 -2 0 6 0 0 0 -9.5 0 0 0 6 4-4cyli.dat
  [1,16,0,-2,0,6,0,0,0,-9.5,0,0,0,6, ldraw_lib__4_4cyli()],
...
module ldraw_lib__connect8(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__connect8(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
