...
use <stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__stug_5x1(realsolid=false) = [
// 0 Stud Group  5 x  1
// 0 Name: stug-5x1.dat
...
module ldraw_lib__stug_5x1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__stug_5x1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__stug_5x1(line=0.2);