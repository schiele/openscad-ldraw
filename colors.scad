...
(id>=2*16^6) ? [str("#"
,"0123456789ABCDEF"[id/(16^5)%16]
,"0123456789ABCDEF"[id/(16^4)%16]
,"0123456789ABCDEF"[id/(16^3)%16]
,"0123456789ABCDEF"[id/(16^2)%16]
,"0123456789ABCDEF"[id/(16^1)%16]
,"0123456789ABCDEF"[id/(16^0)%16]
),str("#"
,"FEDCBA9876543210"[id/(16^5)%16]
,"FEDCBA9876543210"[id/(16^4)%16]
,"FEDCBA9876543210"[id/(16^3)%16]
,"FEDCBA9876543210"[id/(16^2)%16]
,"FEDCBA9876543210"[id/(16^1)%16]
,"FEDCBA9876543210"[id/(16^0)%16]
)] : ("UNKNOWN"))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))));
