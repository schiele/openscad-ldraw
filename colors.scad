...
(id==424) ? ["#DD9E47FF","#333333"] : (
(id==430) ? ["#F79B9BFF","#333333"] : (
(id==431) ? ["#665EA7FF","#333333"] : (
...
(id==510) ? ["#ACE35AFF","#333333"] : (
(id==10015) ? ["#FFF230FF","#333333"] : (
(id==10017) ? ["#FF9494FF","#333333"] : (
(id==10022) ? ["#D05098FF","#333333"] : (
(id==32) ? ["#000000F5","#333333"] : (
...
(id==11015) ? ["#F4F4F4AE","#C1C1C1"] : (
(id==11019) ? ["#D7BA8C80","#BC8D41"] : (
...
(id==296) ? ["#ADADADFF","#333333"] : (
(id==297) ? ["#AA7F2EFF","#333333"] : (
(id==315) ? ["#8C8C8CFF","#333333"] : (
(id==316) ? ["#3E3C39FF","#333333"] : (
(id==342) ? ["#3E3C39FF","#333333"] : (
(id==346) ? ["#803D07FF","#333333"] : (
...
(id==332) ? ["#D06D4FFF","#333333"] : (
(id==333) ? ["#DBEA7AFF","#333333"] : (
(id==21) ? ["#E0FFB0F5","#B8FF4D"] : (
(id==79) ? ["#EEEEEEF0","#BABABA"] : (
(id==294) ? ["#BDC6ADC8","#8D9D72"] : (
(id==329) ? ["#F5F3D7F5","#E0DA85"] : (
...
(id==367) ? ["#56E646C8","#27AF18"] : (
(id==376) ? ["#F5CD2FC8","#B49208"] : (
(id==10366) ? ["#0020A0C8","#000B38"] : (
(id==75) ? ["#000000FF","#AB6038"] : (
(id==76) ? ["#635F61FF","#898788"] : (
(id==132) ? ["#000000FF","#898788"] : (
(id==133) ? ["#000000FF","#DBAC34"] : (
(id==30000) ? ["#FCFCFC80","#C9C9C9"] : (
(id==30001) ? ["#F4F4F4FF","#333333"] : (
(id==30002) ? ["#8A928DFF","#333333"] : (
(id==30003) ? ["#34434DFF","#333333"] : (
(id==30004) ? ["#D27744FF","#333333"] : (
(id==30005) ? ["#D7BA8CFF","#333333"] : (
(id==30006) ? ["#FED557FF","#333333"] : (
(id==30007) ? ["#7C9051FF","#333333"] : (
(id==30008) ? ["#467083FF","#333333"] : (
(id==30009) ? ["#907450FF","#333333"] : (
(id==30010) ? ["#B40000FF","#333333"] : (
(id==30011) ? ["#ABD9FFFF","#333333"] : (
(id==30012) ? ["#D86D2CFF","#333333"] : (
(id==30013) ? ["#C65127FF","#333333"] : (
(id==30014) ? ["#78FC78FF","#333333"] : (
(id==30015) ? ["#FFF230FF","#333333"] : (
(id==30016) ? ["#F785B1FF","#333333"] : (
(id==30032) ? ["#AFB5C7FF","#333333"] : (
(id==30033) ? ["#F45C40FF","#333333"] : (
(id==30034) ? ["#27867EFF","#333333"] : (
(id==30035) ? ["#FFE371FF","#333333"] : (
(id==30037) ? ["#BD7D85FF","#333333"] : (
(id==30038) ? ["#61AFFFFF","#333333"] : (
(id==30039) ? ["#F7AD63FF","#333333"] : (
(id==30040) ? ["#595D60FF","#333333"] : (
(id==30054) ? ["#330000FF","#808080"] : (
(id==30080) ? ["#F4F4F4FF","#333333"] : (
(id==30081) ? ["#34434DFF","#333333"] : (
(id==30082) ? ["#595D60FF","#333333"] : (
(id==30083) ? ["#9C9C9CFF","#333333"] : (
(id==30084) ? ["#006400FF","#808080"] : (
(id==30085) ? ["#7DB538FF","#333333"] : (
(id==30086) ? ["#0057A6FF","#333333"] : (
(id==30087) ? ["#68AECEFF","#333333"] : (
(id==30088) ? ["#4B0082FF","#333333"] : (
(id==30089) ? ["#8B0000FF","#333333"] : (
(id==30090) ? ["#FED557FF","#333333"] : (
(id==30091) ? ["#F7AD63FF","#333333"] : (
(id==31000) ? ["#6B5A5AFF","#333333"] : (
(id==31001) ? ["#0057A6FF","#333333"] : (
(id==31002) ? ["#D9D5CCFF","#333333"] : (
...
(id==10003) ? ["#069D9FFF","#333333"] : (
(id==10005) ? ["#D3359DFF","#333333"] : (
(id==10008) ? ["#545955FF","#333333"] : (
(id==10010) ? ["#58AB41FF","#333333"] : (
(id==10019) ? ["#D7BA8CFF","#333333"] : (
(id==10026) ? ["#901F76FF","#333333"] : (
(id==10028) ? ["#897D62FF","#333333"] : (
...
(id==10084) ? ["#AA7D55FF","#333333"] : (
(id==10085) ? ["#441A91FF","#333333"] : (
(id==10092) ? ["#BB805AFF","#333333"] : (
(id==10135) ? ["#A0A0A0FF","#333333"] : (
(id==10137) ? ["#5B7590FF","#333333"] : (
(id==10147) ? ["#83724FFF","#333333"] : (
(id==10148) ? ["#484D48FF","#333333"] : (
(id==10150) ? ["#989B99FF","#333333"] : (
(id==10151) ? ["#C8C8C8FF","#333333"] : (
(id==10189) ? ["#AC8247FF","#333333"] : (
(id==10191) ? ["#FCAC00FF","#333333"] : (
(id==10200) ? ["#708224FF","#333333"] : (
(id==10212) ? ["#9DC3F7FF","#333333"] : (
(id==10226) ? ["#FFEC6CFF","#333333"] : (
(id==10288) ? ["#00451AFF","#808080"] : (
(id==10297) ? ["#AA7F2EFF","#333333"] : (
(id==10308) ? ["#352100FF","#808080"] : (
(id==10320) ? ["#720012FF","#333333"] : (
(id==10321) ? ["#469BC3FF","#333333"] : (
(id==10322) ? ["#68C3E2FF","#333333"] : (
(id==10323) ? ["#D3F2EAFF","#333333"] : (
(id==10326) ? ["#E2F99AFF","#333333"] : (
(id==10330) ? ["#77774EFF","#333333"] : (
...
(id==10057) ? ["#F08F1C80","#9E5C0A"] : (
(id==10079) ? ["#EEEEEEF0","#BABABA"] : (
(id==20000) ? ["#1B2A34FF","#808080"] : (
(id==20001) ? ["#1E5AA8FF","#333333"] : (
(id==20002) ? ["#00852BFF","#333333"] : (
(id==20004) ? ["#B40000FF","#333333"] : (
(id==20006) ? ["#543324FF","#1E1E1E"] : (
(id==20007) ? ["#8A928DFF","#333333"] : (
(id==20010) ? ["#58AB41FF","#333333"] : (
(id==20014) ? ["#FAC80AFF","#333333"] : (
(id==20015) ? ["#F4F4F4FF","#333333"] : (
(id==20019) ? ["#D7BA8CFF","#333333"] : (
(id==20022) ? ["#671F81FF","#333333"] : (
(id==20028) ? ["#897D62FF","#333333"] : (
(id==20070) ? ["#5F3109FF","#808080"] : (
(id==20071) ? ["#969696FF","#333333"] : (
(id==20072) ? ["#646464FF","#333333"] : (
(id==20086) ? ["#7B5D41FF","#333333"] : (
(id==20288) ? ["#00451AFF","#808080"] : (
(id==20320) ? ["#720012FF","#333333"] : (
(id==20335) ? ["#88605EFF","#333333"] : (
...
(id==424) ? ["#DD9E47FF","#CA8525"] : (
(id==430) ? ["#F79B9BFF","#F36C6C"] : (
(id==431) ? ["#665EA7FF","#514A86"] : (
...
(id==510) ? ["#ACE35AFF","#95DB2D"] : (
(id==10015) ? ["#FFF230FF","#F9E900"] : (
(id==10017) ? ["#FF9494FF","#FF6060"] : (
(id==10022) ? ["#D05098FF","#B9317E"] : (
(id==33) ? ["#0020A080","#000B38"] : (
(id==34) ? ["#23784180","#174F2B"] : (
(id==35) ? ["#56E64680","#27AF18"] : (
(id==36) ? ["#C91A0980","#660D05"] : (
...
(id==296) ? ["#ADADADFF","#C6C6C6"] : (
(id==297) ? ["#AA7F2EFF","#805F23"] : (
(id==315) ? ["#8C8C8CFF","#727272"] : (
(id==316) ? ["#3E3C39FF","#22211F"] : (
(id==342) ? ["#3E3C39FF","#575450"] : (
(id==346) ? ["#803D07FF","#4D2504"] : (
...
(id==332) ? ["#D06D4FFF","#DA8D76"] : (
(id==333) ? ["#DBEA7AFF","#E7F1A6"] : (
(id==79) ? ["#EEEEEEF0","#BABABA"] : (
(id==21) ? ["#E0FFB0F5","#B8FF4D"] : (
(id==294) ? ["#BDC6ADC8","#8D9D72"] : (
(id==329) ? ["#F5F3D7F5","#E0DA85"] : (
...
(id==133) ? ["#000000FF","#DBAC34"] : (
(id==30000) ? ["#FCFCFC80","#C9C9C9"] : (
(id==30001) ? ["#F4F4F4FF","#DBDBDB"] : (
(id==30002) ? ["#8A928DFF","#707974"] : (
(id==30003) ? ["#34434DFF","#1E272D"] : (
(id==30004) ? ["#D27744FF","#B8602C"] : (
(id==30005) ? ["#D7BA8CFF","#C9A468"] : (
(id==30006) ? ["#FED557FF","#FDC724"] : (
(id==30007) ? ["#7C9051FF","#5F6E3E"] : (
(id==30008) ? ["#467083FF","#335260"] : (
(id==30009) ? ["#907450FF","#6F5A3D"] : (
(id==30010) ? ["#B40000FF","#7F0000"] : (
(id==30011) ? ["#ABD9FFFF","#7AC3FF"] : (
(id==30012) ? ["#D86D2CFF","#B05720"] : (
(id==30013) ? ["#C65127FF","#993F1E"] : (
(id==30014) ? ["#78FC78FF","#46FB46"] : (
(id==30015) ? ["#FFF230FF","#F9E900"] : (
(id==30016) ? ["#F785B1FF","#F45793"] : (
(id==30032) ? ["#AFB5C7FF","#8F98B1"] : (
(id==30033) ? ["#F45C40FF","#F0300E"] : (
(id==30034) ? ["#27867EFF","#1B5E59"] : (
(id==30035) ? ["#FFE371FF","#FFD83D"] : (
(id==30037) ? ["#BD7D85FF","#AC5C65"] : (
(id==30038) ? ["#61AFFFFF","#2D96FF"] : (
(id==30039) ? ["#F7AD63FF","#F49333"] : (
(id==30040) ? ["#595D60FF","#3F4244"] : (
(id==30054) ? ["#330000FF","#660000"] : (
(id==30080) ? ["#F4F4F4FF","#C0C0C0"] : (
(id==30081) ? ["#34434DFF","#808080"] : (
(id==30082) ? ["#595D60FF","#808080"] : (
(id==30083) ? ["#9C9C9CFF","#C0C0C0"] : (
(id==30084) ? ["#006400FF","#808080"] : (
(id==30085) ? ["#7DB538FF","#C0C0C0"] : (
(id==30086) ? ["#0057A6FF","#808080"] : (
(id==30087) ? ["#68AECEFF","#C0C0C0"] : (
(id==30088) ? ["#4B0082FF","#808080"] : (
(id==30089) ? ["#8B0000FF","#808080"] : (
(id==30090) ? ["#FED557FF","#C0C0C0"] : (
(id==30091) ? ["#F7AD63FF","#C0C0C0"] : (
(id==31000) ? ["#6B5A5AFF","#504343"] : (
(id==31001) ? ["#0057A6FF","#003C75"] : (
(id==31002) ? ["#D9D5CCFF","#C4BEAF"] : (
...
(id==10003) ? ["#069D9FFF","#023A3B"] : (
(id==10005) ? ["#D3359DFF","#851D61"] : (
(id==10008) ? ["#545955FF","#222423"] : (
(id==10010) ? ["#58AB41FF","#316024"] : (
(id==10019) ? ["#D7BA8CFF","#BC8D42"] : (
(id==10026) ? ["#901F76FF","#3A0C30"] : (
(id==10028) ? ["#897D62FF","#4D4637"] : (
...
(id==10084) ? ["#AA7D55FF","#654A33"] : (
(id==10085) ? ["#441A91FF","#1C0A3C"] : (
(id==10092) ? ["#BB805AFF","#7B4F32"] : (
(id==10135) ? ["#A0A0A0FF","#6D6D6D"] : (
(id==10137) ? ["#5B7590FF","#334151"] : (
(id==10147) ? ["#83724FFF","#423A28"] : (
(id==10148) ? ["#484D48FF","#161716"] : (
(id==10150) ? ["#989B99FF","#B1B3B2"] : (
(id==10151) ? ["#C8C8C8FF","#E0E0E0"] : (
(id==10189) ? ["#AC8247FF","#654C29"] : (
(id==10191) ? ["#FCAC00FF","#936500"] : (
(id==10200) ? ["#708224FF","#2D340E"] : (
(id==10212) ? ["#9DC3F7FF","#3D87EF"] : (
(id==10226) ? ["#FFEC6CFF","#FFDD05"] : (
(id==10288) ? ["#00451AFF","#001407"] : (
(id==10297) ? ["#AA7F2EFF","#584118"] : (
(id==10308) ? ["#352100FF","#000000"] : (
(id==10320) ? ["#720012FF","#3D0009"] : (
(id==10321) ? ["#469BC3FF","#27607B"] : (
(id==10322) ? ["#68C3E2FF","#2499C0"] : (
(id==10323) ? ["#D3F2EAFF","#85DAC5"] : (
(id==10326) ? ["#E2F99AFF","#C4F339"] : (
(id==10330) ? ["#77774EFF","#59593A"] : (
...
(id==20006) ? ["#543324FF","#311E15"] : (
(id==20007) ? ["#8A928DFF","#707974"] : (
(id==20010) ? ["#58AB41FF","#448532"] : (
(id==20014) ? ["#FAC80AFF","#CCA404"] : (
(id==20015) ? ["#F4F4F4FF","#DBDBDB"] : (
(id==20019) ? ["#D7BA8CFF","#C9A468"] : (
(id==20022) ? ["#671F81FF","#441456"] : (
(id==20028) ? ["#897D62FF","#6B624C"] : (
(id==20070) ? ["#5F3109FF","#2E1804"] : (
(id==20071) ? ["#969696FF","#7C7C7C"] : (
(id==20072) ? ["#646464FF","#494949"] : (
(id==20086) ? ["#7B5D41FF","#5A442F"] : (
(id==20288) ? ["#00451AFF","#001407"] : (
(id==20320) ? ["#720012FF","#3D0009"] : (
(id==20335) ? ["#88605EFF","#694A49"] : (
