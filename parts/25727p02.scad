...
use <s/25727s01.scad>
use <s/25727s03.scad>
function ldraw_lib__25727p02() = [
// 0 Figure Friends Legs with Cargo Pants with Medium Nougat Legs and White Laces and Sole Sneakers Pattern
// 0 Name: 25727p02.dat
...
module ldraw_lib__25727p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__25727p02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__25727p02(line=0.2);