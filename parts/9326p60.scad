...
use <973p60.scad>
$fa=1; $fs=0.2;
function ldraw_lib__9326p60(realsolid=false) = [
// 0 ~Moved to 973p60
// 0 Name: 9326p60.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973p60.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973p60(realsolid)],
// 0
];
module ldraw_lib__9326p60(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__9326p60(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
