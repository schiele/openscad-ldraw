...
use <../p/box4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4252(realsolid=false) = [
...
// 1 16 0 0 0 77 0 0 0 0 63 0 -4 0 box4.dat
  [1,16,0,0,0,77,0,0,0,0,63,0,-4,0, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 55 0 0 0 0 48 0 -4 0 box4.dat
  [1,16,0,0,0,55,0,0,0,0,48,0,-4,0, ldraw_lib__box4(realsolid)],
...
module ldraw_lib__4252(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4252(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
