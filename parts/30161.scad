...
use <s/30161s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30161(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30161s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30161s01(realsolid)],
// 
// 4 16 40 -28 -2 -40 -28 -2 -40 -4 -2 40 -4 -2
  [4,16,40,-28,-2,-40,-28,-2,-40,-4,-2,40,-4,-2],
];
module ldraw_lib__30161(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30161(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
