...
use <2313a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__74656p03(realsolid=false) = [
...
// 1 0 -40 38 80 0 0 1 0 1 0 -1 0 0 2313a.dat
  [1,0,-40,38,80,0,0,1,0,1,0,-1,0,0, ldraw_lib__2313a(realsolid)],
// 1 0 -40 38 -80 0 0 1 0 1 0 -1 0 0 2313a.dat
  [1,0,-40,38,-80,0,0,1,0,1,0,-1,0,0, ldraw_lib__2313a(realsolid)],
// 1 0 40 38 -80 0 0 -1 0 1 0 1 0 0 2313a.dat
  [1,0,40,38,-80,0,0,-1,0,1,0,1,0,0, ldraw_lib__2313a(realsolid)],
...
module ldraw_lib__74656p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__74656p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
