...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9025(realsolid=false) = [
...
// 1 16 50 0 -100 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,50,0,-100,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -50 0 -100 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-50,0,-100,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 50 0 -80 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,50,0,-80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 30 0 -80 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,30,0,-80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 10 0 -80 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,10,0,-80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -10 0 -80 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-10,0,-80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -30 0 -80 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-30,0,-80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
...
// 1 16 50 0 -20 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,50,0,-20,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
...
// 1 16 30 0 100 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,30,0,100,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 10 0 100 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,10,0,100,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -10 0 100 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-10,0,100,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -30 0 100 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-30,0,100,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
...
// 1 16 0 0 -98 0 0 -32 0 12 0 -2 0 0 box4.dat
  [1,16,0,0,-98,0,0,-32,0,12,0,-2,0,0, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 40 16 -108 0 0 -8 0 -4 0 -2 0 0 box3u8p.dat
  [1,16,40,16,-108,0,0,-8,0,-4,0,-2,0,0, ldraw_lib__box3u8p(realsolid)],
...
// 1 16 0 16 108 0 0 -16 0 -2 0 -2 0 0 box3u2p.dat
  [1,16,0,16,108,0,0,-16,0,-2,0,-2,0,0, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 0 20 36 0 0 5 0 1 0 5 0 0 4-4edge.dat
  [1,16,0,20,36,0,0,5,0,1,0,5,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 16 36 0 0 5 0 1 0 5 0 0 4-4edge.dat
  [1,16,0,16,36,0,0,5,0,1,0,5,0,0, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 16 36 0 0 5 0 4 0 5 0 0 4-4cyli.dat
  [1,16,0,16,36,0,0,5,0,4,0,5,0,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 20 36 0 0 1 0 -1 0 1 0 0 4-4ring5.dat
  [1,16,0,20,36,0,0,1,0,-1,0,1,0,0, ldraw_lib__4_4ring5(realsolid)],
// 1 16 0 20 36 0 0 2 0 -1 0 2 0 0 4-4ring3.dat
  [1,16,0,20,36,0,0,2,0,-1,0,2,0,0, ldraw_lib__4_4ring3(realsolid)],
// 1 16 0 20 36 0 0 8 0 1 0 8 0 0 4-4edge.dat
  [1,16,0,20,36,0,0,8,0,1,0,8,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 12 36 0 0 2 0 8 0 2 0 0 4-4con4.dat
  [1,16,0,12,36,0,0,2,0,8,0,2,0,0, ldraw_lib__4_4con4(realsolid)],
// 1 16 0 12 36 0 0 10 0 1 0 10 0 0 4-4edge.dat
  [1,16,0,12,36,0,0,10,0,1,0,10,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 383 0 16 36 0 0 2.5 0 1 0 2.5 0 0 4-4edge.dat
  [1,383,0,16,36,0,0,2.5,0,1,0,2.5,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 383 0 16 36 0 0 2.5 0 -1 0 2.5 0 0 4-4ring1.dat
  [1,383,0,16,36,0,0,2.5,0,-1,0,2.5,0,0, ldraw_lib__4_4ring1(realsolid)],
// 1 383 0 12 36 0 0 2.5 0 1 0 2.5 0 0 4-4edge.dat
  [1,383,0,12,36,0,0,2.5,0,1,0,2.5,0,0, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 383 0 12 36 0 0 2.5 0 4 0 2.5 0 0 4-4cyli.dat
  [1,383,0,12,36,0,0,2.5,0,4,0,2.5,0,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 12 -26 0 0 1 0 4 0 46 0 0 box3u8p.dat
  [1,16,0,12,-26,0,0,1,0,4,0,46,0,0, ldraw_lib__box3u8p(realsolid)],
// 1 16 0 14 20 0 0 1 2 0 0 0 -1 0 rect.dat
  [1,16,0,14,20,0,0,1,2,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 -1 12 -72 0 2 0 4 0 0 0 0 -18 1-4cyli.dat
  [1,16,-1,12,-72,0,2,0,4,0,0,0,0,-18, ldraw_lib__1_4cyli(realsolid)],
// 1 16 1 12 -72 0 -1 0 4 0 0 0 0 -18 1-4edge.dat
  [1,16,1,12,-72,0,-1,0,4,0,0,0,0,-18, ldraw_lib__1_4edge(realsolid)],
// 1 16 -1 12 -72 0 -1 0 4 0 0 0 0 -18 1-4edge.dat
  [1,16,-1,12,-72,0,-1,0,4,0,0,0,0,-18, ldraw_lib__1_4edge(realsolid)],
// 1 16 -1 12 -72 0 1 0 4 0 0 0 0 -18 1-4disc.dat
  [1,16,-1,12,-72,0,1,0,4,0,0,0,0,-18, ldraw_lib__1_4disc(realsolid)],
// 1 16 1 12 -72 0 -1 0 4 0 0 0 0 -18 1-4disc.dat
  [1,16,1,12,-72,0,-1,0,4,0,0,0,0,-18, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 -62 12 74 0 124 0 0 0 -2 10 0 0 2-4cyli.dat
  [1,16,-62,12,74,0,124,0,0,0,-2,10,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -62 12 74 0 1 0 0 0 -2 10 0 0 2-4edge.dat
  [1,16,-62,12,74,0,1,0,0,0,-2,10,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 62 12 74 0 1 0 0 0 -2 10 0 0 2-4edge.dat
  [1,16,62,12,74,0,1,0,0,0,-2,10,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 62 12 74 0 1 0 0 0 -2 10 0 0 2-4disc.dat
  [1,16,62,12,74,0,1,0,0,0,-2,10,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 -62 12 74 0 -1 0 0 0 -2 10 0 0 2-4disc.dat
  [1,16,-62,12,74,0,-1,0,0,0,-2,10,0,0, ldraw_lib__2_4disc(realsolid)],
...
// 1 16 -31 12 -90 -10 0 0 0 0 -2 0 128 0 2-4cyli.dat
  [1,16,-31,12,-90,-10,0,0,0,0,-2,0,128,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -31 12 -90 -10 0 0 0 0 -2 0 1 0 2-4edge.dat
  [1,16,-31,12,-90,-10,0,0,0,0,-2,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -31 12 38 -10 0 0 0 0 -2 0 1 0 2-4edge.dat
  [1,16,-31,12,38,-10,0,0,0,0,-2,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -31 12 38 -10 0 0 0 0 -2 0 1 0 2-4disc.dat
  [1,16,-31,12,38,-10,0,0,0,0,-2,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 -31 12 -90 -10 0 0 0 0 -2 0 -1 0 2-4disc.dat
  [1,16,-31,12,-90,-10,0,0,0,0,-2,0,-1,0, ldraw_lib__2_4disc(realsolid)],
...
module ldraw_lib__u9025(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9025(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
