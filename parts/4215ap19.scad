...
// 1 16 0 36 10 0 0 -30 -30 0 0 0 -1 0 48\4-4ndis.dat
  [1,16,0,36,10,0,0,-30,-30,0,0,0,-1,0, ldraw_lib__48__4_4ndis()],
...
// 1 16 0 36 10 -0.866025 0 0.5 -0.5 0 -0.866025 0 -1 0 s\4215as19.dat
  [1,16,0,36,10,-0.866025,0,0.5,-0.5,0,-0.866025,0,-1,0, ldraw_lib__s__4215as19()],
// 1 16 0 36 10 0 0 1 -1 0 0 0 -1 0 s\4215as19.dat
  [1,16,0,36,10,0,0,1,-1,0,0,0,-1,0, ldraw_lib__s__4215as19()],
// 1 16 0 36 10 0.866025 0 0.5 -0.5 0 0.866025 0 -1 0 s\4215as19.dat
  [1,16,0,36,10,0.866025,0,0.5,-0.5,0,0.866025,0,-1,0, ldraw_lib__s__4215as19()],
// 1 16 0 36 10 0.866025 0 -0.5 0.5 0 0.866025 0 -1 0 s\4215as19.dat
  [1,16,0,36,10,0.866025,0,-0.5,0.5,0,0.866025,0,-1,0, ldraw_lib__s__4215as19()],
...
module ldraw_lib__4215ap19(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4215ap19(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
