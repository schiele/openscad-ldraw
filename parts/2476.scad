...
use <2476a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2476(realsolid=false) = [
// 0 ~Moved to 2476a
// 0 Name: 2476.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2476a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2476a(realsolid)],
];
module ldraw_lib__2476(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2476(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
