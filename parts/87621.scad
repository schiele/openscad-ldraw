...
use <s/87621s04.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87621(realsolid=false) = [
// 0 Animal Pig
// 0 Name: 87621.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\87621s03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87621s03(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\87621s03.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87621s03(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\87621s04.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87621s04(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\87621s04.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87621s04(realsolid)],
];
module ldraw_lib__87621(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87621(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
