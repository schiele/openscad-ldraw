...
use <../p/rect.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92713k02(realsolid=false) = [
...
// 1 16 0 -8.6022 0 1.25 0 0 0 1 0 0 0 16.5 rect.dat
  [1,16,0,-8.6022,0,1.25,0,0,0,1,0,0,0,16.5, ldraw_lib__rect(realsolid)],
// 0 // Edges
...
module ldraw_lib__92713k02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92713k02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
