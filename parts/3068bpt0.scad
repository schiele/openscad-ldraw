...
use <s/3068bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3068bpt0(realsolid=false) = [
...
// 1 4 0 0 4.8 1.3 0 0 0 1 0 0 0 1.3 s\170876s1.dat
  [1,4,0,0,4.8,1.3,0,0,0,1,0,0,0,1.3, ldraw_lib__s__170876s1(realsolid)],
// 1 4 0 0 4.8 1.3 0 0 0 1 0 0 0 1.3 s\170876s2.dat
  [1,4,0,0,4.8,1.3,0,0,0,1,0,0,0,1.3, ldraw_lib__s__170876s2(realsolid)],
// 1 2 0 0 4.8 -1.3 0 0 0 1 0 0 0 -1.3 s\170876s1.dat
  [1,2,0,0,4.8,-1.3,0,0,0,1,0,0,0,-1.3, ldraw_lib__s__170876s1(realsolid)],
// 1 2 0 0 4.8 -1.3 0 0 0 1 0 0 0 -1.3 s\170876s2.dat
  [1,2,0,0,4.8,-1.3,0,0,0,1,0,0,0,-1.3, ldraw_lib__s__170876s2(realsolid)],
// 1 16 0 0 4.8 1.3 0 0 0 1 0 0 0 1.3 s\170876s3.dat
  [1,16,0,0,4.8,1.3,0,0,0,1,0,0,0,1.3, ldraw_lib__s__170876s3(realsolid)],
// 1 16 0 0 -13.9 0.05 0 0 0 1 0 0 0 0.05 s\2431pt2a.dat
  [1,16,0,0,-13.9,0.05,0,0,0,1,0,0,0,0.05, ldraw_lib__s__2431pt2a(realsolid)],
// 1 16 0 0 -13.9 0.05 0 0 0 1 0 0 0 0.05 s\2431pt2b.dat
  [1,16,0,0,-13.9,0.05,0,0,0,1,0,0,0,0.05, ldraw_lib__s__2431pt2b(realsolid)],
// 1 16 0 0 -13.9 0.05 0 0 0 1 0 0 0 0.05 s\2431pt2c.dat
  [1,16,0,0,-13.9,0.05,0,0,0,1,0,0,0,0.05, ldraw_lib__s__2431pt2c(realsolid)],
...
module ldraw_lib__3068bpt0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068bpt0(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
