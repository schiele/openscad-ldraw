...
use <u9351-f2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__127c03_f2(realsolid=false) = [
...
// 1 0 0 -240 0 1 0 0 0 1 0 0 0 1 336.dat
  [1,0,0,-240,0,1,0,0,0,1,0,0,0,1, ldraw_lib__336(realsolid)],
...
// 1 494 0 -228 0 1 0 0 0 1 0 0 0 1 u9351-f2.dat
  [1,494,0,-228,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9351_f2(realsolid)],
];
module ldraw_lib__127c03_f2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__127c03_f2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
