...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3032(realsolid=false) = [
// 0 Plate  4 x  6
// 0 Name: 3032.dat
...
// 4 16 -60 8 40 -56 8 36 -56 8 -36 -60 8 -40
  [4,16,-60,8,40,-56,8,36,-56,8,-36,-60,8,-40],
// 
// 1 16 0 8 0 60 0 0 0 -8 0 0 0 40 box5.dat
  [1,16,0,8,0,60,0,0,0,-8,0,0,0,40, ldraw_lib__box5(realsolid)],
// 
...
module ldraw_lib__3032(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3032(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3032(line=0.2);