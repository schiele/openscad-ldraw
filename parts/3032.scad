...
// 1 16 0 8 0 60 0 0 0 -8 0 0 0 40 box5.dat
  [1,16,0,8,0,60,0,0,0,-8,0,0,0,40, ldraw_lib__box5()],
// 
...
module ldraw_lib__3032(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3032(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
