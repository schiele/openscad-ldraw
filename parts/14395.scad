...
use <../p/stug-1x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__14395(realsolid=false) = [
...
// 1 16 0 96 0 10 0 0 0 1 0 0 0 10 recte3.dat
  [1,16,0,96,0,10,0,0,0,1,0,0,0,10, ldraw_lib__recte3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 96 0 6 0 0 0 -44 0 0 0 6 box5.dat
  [1,16,0,96,0,6,0,0,0,-44,0,0,0,6, ldraw_lib__box5(realsolid)],
...
// 1 16 10 96 90 0 -3 0 0 0 -80 -80 0 0 48\1-4cylo.dat
  [1,16,10,96,90,0,-3,0,0,0,-80,-80,0,0, ldraw_lib__48__1_4cylo(realsolid)],
// 1 16 10 96 90 0 -1 0 0 0 -80 -80 0 0 48\1-4tang.dat
  [1,16,10,96,90,0,-1,0,0,0,-80,-80,0,0, ldraw_lib__48__1_4tang(realsolid)],
// 1 16 7 96 90 0 1 0 0 0 -80 -80 0 0 48\1-4tang.dat
  [1,16,7,96,90,0,1,0,0,0,-80,-80,0,0, ldraw_lib__48__1_4tang(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -10 96 90 0 3 0 0 0 -80 -80 0 0 48\1-4cylo.dat
  [1,16,-10,96,90,0,3,0,0,0,-80,-80,0,0, ldraw_lib__48__1_4cylo(realsolid)],
...
// 1 16 0 74 10 0 0 7 22 0 0 0 -1 0 rect2p.dat
  [1,16,0,74,10,0,0,7,22,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 40 12 7 0 0 0 0 12 0 2 0 box2-5.dat
  [1,16,0,40,12,7,0,0,0,0,12,0,2,0, ldraw_lib__box2_5(realsolid)],
// 1 16 0 28 20 0 0 7 0 -1 0 6 0 0 rect2p.dat
  [1,16,0,28,20,0,0,7,0,-1,0,6,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 28 28 7 0 0 0 12 0 0 0 2 box3u2p.dat
  [1,16,0,28,28,7,0,0,0,12,0,0,0,2, ldraw_lib__box3u2p(realsolid)],
// 1 16 0 16 32 7 0 0 0 0 12 0 2 0 box2-7.dat
  [1,16,0,16,32,7,0,0,0,0,12,0,2,0, ldraw_lib__box2_7(realsolid)],
// 1 16 0 4 40 7 0 0 0 -1 0 0 0 6 rect.dat
  [1,16,0,4,40,7,0,0,0,-1,0,0,0,6, ldraw_lib__rect(realsolid)],
// 1 16 0 8 48 7 0 0 0 0 4 0 -2 0 box2-7.dat
  [1,16,0,8,48,7,0,0,0,0,4,0,-2,0, ldraw_lib__box2_7(realsolid)],
// 1 16 0 12 52 7 0 0 0 8 0 0 0 2 box3u2p.dat
  [1,16,0,12,52,7,0,0,0,8,0,0,0,2, ldraw_lib__box3u2p(realsolid)],
// 1 16 0 12 70.5 -7 0 0 0 -1 0 0 0 16.5 rect3.dat
  [1,16,0,12,70.5,-7,0,0,0,-1,0,0,0,16.5, ldraw_lib__rect3(realsolid)],
// 1 16 0 14 88.5 7 0 0 0 0 2 0 -1.5 0 box2-7.dat
  [1,16,0,14,88.5,7,0,0,0,0,2,0,-1.5,0, ldraw_lib__box2_7(realsolid)],
// 
// 1 16 0 72 0 10 0 0 0 0 -24 0 -10 0 box2-5.dat
  [1,16,0,72,0,10,0,0,0,0,-24,0,-10,0, ldraw_lib__box2_5(realsolid)],
// 1 16 0 36 20 10 0 0 0 0 -12 0 -10 0 box2-7.dat
  [1,16,0,36,20,10,0,0,0,0,-12,0,-10,0, ldraw_lib__box2_7(realsolid)],
// 1 16 0 12 40 10 0 0 0 0 -12 0 -10 0 box2-5.dat
  [1,16,0,12,40,10,0,0,0,0,-12,0,-10,0, ldraw_lib__box2_5(realsolid)],
// 1 16 0 4 50 0 0 10 -4 0 0 0 -1 0 rect2p.dat
  [1,16,0,4,50,0,0,10,-4,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 12 70 10 0 0 0 0 -4 0 20 0 box2-5.dat
  [1,16,0,12,70,10,0,0,0,0,-4,0,20,0, ldraw_lib__box2_5(realsolid)],
// 
...
// 1 16 0 24 20 0 0 -1 0 1 0 1 0 0 stud.dat
  [1,16,0,24,20,0,0,-1,0,1,0,1,0,0, ldraw_lib__stud(realsolid)],
...
// 1 16 0 8 70 0 0 -1 0 1 0 1 0 0 stug-1x2.dat
  [1,16,0,8,70,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_1x2(realsolid)],
];
module ldraw_lib__14395(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__14395(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
