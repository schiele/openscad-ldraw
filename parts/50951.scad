...
// 1 16 0 0 8 -14 0 0 0 0 -14 0 -1 0 4-4edge.dat
  [1,16,0,0,8,-14,0,0,0,0,-14,0,-1,0, ldraw_lib__4_4edge()],
// 1 16 0 0 3 -14 0 0 0 0 -14 0 -1 0 4-4edge.dat
  [1,16,0,0,3,-14,0,0,0,0,-14,0,-1,0, ldraw_lib__4_4edge()],
// 1 16 0 0 -3 -14 0 0 0 0 -14 0 -1 0 4-4edge.dat
  [1,16,0,0,-3,-14,0,0,0,0,-14,0,-1,0, ldraw_lib__4_4edge()],
// 1 16 0 0 -1 -12 0 0 0 0 -12 0 -1 0 4-4edge.dat
  [1,16,0,0,-1,-12,0,0,0,0,-12,0,-1,0, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 3 -2 0 0 0 0 -2 0 -2 0 4-4con6.dat
  [1,16,0,0,3,-2,0,0,0,0,-2,0,-2,0, ldraw_lib__4_4con6()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -3 2 0 0 0 0 -2 0 2 0 4-4con6.dat
  [1,16,0,0,-3,2,0,0,0,0,-2,0,2,0, ldraw_lib__4_4con6()],
...
// 1 16 0 0 -8 2 0 0 0 0 -2 0 1 0 4-4ring7.dat
  [1,16,0,0,-8,2,0,0,0,0,-2,0,1,0, ldraw_lib__4_4ring7()],
...
// 1 16 0 0 -7 -18 0 0 0 0 -18 0 -18 0 t01o0556.dat
  [1,16,0,0,-7,-18,0,0,0,0,-18,0,-18,0, ldraw_lib__t01o0556()],
// 1 16 0 0 7 18 0 0 0 0 -18 0 18 0 t01o0556.dat
  [1,16,0,0,7,18,0,0,0,0,-18,0,18,0, ldraw_lib__t01o0556()],
// 1 16 0 0 -7 19 0 0 0 0 -19 0 14 0 4-4cyli.dat
  [1,16,0,0,-7,19,0,0,0,0,-19,0,14,0, ldraw_lib__4_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -1 12 0 0 0 0 -12 0 2 0 4-4cyli.dat
  [1,16,0,0,-1,12,0,0,0,0,-12,0,2,0, ldraw_lib__4_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 0 3 14 0 0 0 0 -14 0 5 0 4-4cyli.dat
  [1,16,0,0,3,14,0,0,0,0,-14,0,5,0, ldraw_lib__4_4cyli()],
// 0
];
module ldraw_lib__50951(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__50951(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
