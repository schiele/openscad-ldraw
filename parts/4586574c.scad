...
use <../p/4-4cylc3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4586574c(realsolid=false) = [
...
// 1 16 0 0 0 17.5 0 0 0 -.25 0 0 0 17.5 4-4cylc3.dat
  [1,16,0,0,0,17.5,0,0,0,-.25,0,0,0,17.5, ldraw_lib__4_4cylc3(realsolid)],
// 
...
// 1 0 0 -.25 0 .8 0 0 0 1 0 0 0 .8 1-4rin12.dat
  [1,0,0,-.25,0,.8,0,0,0,1,0,0,0,.8, ldraw_lib__1_4rin12(realsolid)],
...
// 1 0 0 -.25 0 .8 0 0 0 1 0 0 0 .8 1-4rin16.dat
  [1,0,0,-.25,0,.8,0,0,0,1,0,0,0,.8, ldraw_lib__1_4rin16(realsolid)],
// 
// 0 // One arrow head
...
// 1 15 0 -.25 0 10.4 0 0 0 1 0 0 0 10.4 1-4tang.dat
  [1,15,0,-.25,0,10.4,0,0,0,1,0,0,0,10.4, ldraw_lib__1_4tang(realsolid)],
// 1 15 0 -.25 0 12.8 0 0 0 1 0 0 0 12.8 1-8chrd.dat
  [1,15,0,-.25,0,12.8,0,0,0,1,0,0,0,12.8, ldraw_lib__1_8chrd(realsolid)],
// 1 15 0 -.25 0 0 0 12.8 0 1 0 12.8 0 0 1-8chrd.dat
  [1,15,0,-.25,0,0,0,12.8,0,1,0,12.8,0,0, ldraw_lib__1_8chrd(realsolid)],
...
// 1 14 0 -.25 0 -17.5 0 0 0 1 0 0 0 -17.5 3-8chrd.dat
  [1,14,0,-.25,0,-17.5,0,0,0,1,0,0,0,-17.5, ldraw_lib__3_8chrd(realsolid)],
// 1 14 0 -.25 0 -17.5 0 0 0 1 0 0 0 17.5 1-8chrd.dat
  [1,14,0,-.25,0,-17.5,0,0,0,1,0,0,0,17.5, ldraw_lib__1_8chrd(realsolid)],
...
// 1 14 0 -.25 0 0 0 -17.5 0 1 0 17.5 0 0 1-8chrd.dat
  [1,14,0,-.25,0,0,0,-17.5,0,1,0,17.5,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 14 0 -.25 0 0 0 17.5 0 1 0 17.5 0 0 1-8chrd.dat
  [1,14,0,-.25,0,0,0,17.5,0,1,0,17.5,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 14 0 -.25 0 9.6 0 0 0 1 0 0 0 9.6 1-4chrd.dat
  [1,14,0,-.25,0,9.6,0,0,0,1,0,0,0,9.6, ldraw_lib__1_4chrd(realsolid)],
// 1 14 0 -.25 0 13.6 0 0 0 1 0 0 0 13.6 1-4tang.dat
  [1,14,0,-.25,0,13.6,0,0,0,1,0,0,0,13.6, ldraw_lib__1_4tang(realsolid)],
...
module ldraw_lib__4586574c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4586574c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
