...
use <../p/2-4ndis.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6258203c(realsolid=false) = [
...
// 1 0 -18 -.25 -7.5 -.5 0 0 0 1 0 0 0 -.5 1-4chrd.dat
  [1,0,-18,-.25,-7.5,-.5,0,0,0,1,0,0,0,-.5, ldraw_lib__1_4chrd(realsolid)],
// 1 0 -18 -.25 7.5 -.5 0 0 0 1 0 0 0 .5 1-4chrd.dat
  [1,0,-18,-.25,7.5,-.5,0,0,0,1,0,0,0,.5, ldraw_lib__1_4chrd(realsolid)],
// 1 0 18 -.25 -7.5 .5 0 0 0 1 0 0 0 -.5 1-4chrd.dat
  [1,0,18,-.25,-7.5,.5,0,0,0,1,0,0,0,-.5, ldraw_lib__1_4chrd(realsolid)],
...
// 1 0 14.25 -.25 .7 0 0 2 0 1 0 -2 0 0 2-4disc.dat
  [1,0,14.25,-.25,.7,0,0,2,0,1,0,-2,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 0 -14.25 -.25 .7 0 0 -2 0 1 0 -2 0 0 2-4disc.dat
  [1,0,-14.25,-.25,.7,0,0,-2,0,1,0,-2,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 0 8.05 -.25 -.9 .4 0 0 0 1 0 0 0 -.4 1-4ring1.dat
  [1,0,8.05,-.25,-.9,.4,0,0,0,1,0,0,0,-.4, ldraw_lib__1_4ring1(realsolid)],
// 1 0 8.75 -.25 -1.5 .4 0 0 0 1 0 0 0 -.4 1-4ring2.dat
  [1,0,8.75,-.25,-1.5,.4,0,0,0,1,0,0,0,-.4, ldraw_lib__1_4ring2(realsolid)],
// 1 0 8.05 -.25 3.7 .4 0 0 0 1 0 0 0 .4 1-4ring1.dat
  [1,0,8.05,-.25,3.7,.4,0,0,0,1,0,0,0,.4, ldraw_lib__1_4ring1(realsolid)],
// 1 0 8.75 -.25 4.3 .4 0 0 0 1 0 0 0 .4 1-4ring2.dat
  [1,0,8.75,-.25,4.3,.4,0,0,0,1,0,0,0,.4, ldraw_lib__1_4ring2(realsolid)],
// 1 0 -8.05 -.25 -.9 -.4 0 0 0 1 0 0 0 -.4 1-4ring1.dat
  [1,0,-8.05,-.25,-.9,-.4,0,0,0,1,0,0,0,-.4, ldraw_lib__1_4ring1(realsolid)],
// 1 0 -8.75 -.25 -1.5 -.4 0 0 0 1 0 0 0 -.4 1-4ring2.dat
  [1,0,-8.75,-.25,-1.5,-.4,0,0,0,1,0,0,0,-.4, ldraw_lib__1_4ring2(realsolid)],
...
// 1 80 14.25 -.25 .7 0 0 2 0 1 0 -2 0 0 2-4ndis.dat
  [1,80,14.25,-.25,.7,0,0,2,0,1,0,-2,0,0, ldraw_lib__2_4ndis(realsolid)],
...
// 1 80 8.75 -.25 -1.5 1.2 0 0 0 1 0 0 0 -1.2 1-4ndis.dat
  [1,80,8.75,-.25,-1.5,1.2,0,0,0,1,0,0,0,-1.2, ldraw_lib__1_4ndis(realsolid)],
// 1 80 8.05 -.25 -.9 .8 0 0 0 1 0 0 0 -.8 1-4ndis.dat
  [1,80,8.05,-.25,-.9,.8,0,0,0,1,0,0,0,-.8, ldraw_lib__1_4ndis(realsolid)],
// 1 80 8.75 -.25 -1.5 .8 0 0 0 1 0 0 0 -.8 1-4chrd.dat
  [1,80,8.75,-.25,-1.5,.8,0,0,0,1,0,0,0,-.8, ldraw_lib__1_4chrd(realsolid)],
// 1 80 8.75 -.25 4.3 1.2 0 0 0 1 0 0 0 1.2 1-4ndis.dat
  [1,80,8.75,-.25,4.3,1.2,0,0,0,1,0,0,0,1.2, ldraw_lib__1_4ndis(realsolid)],
// 1 80 8.05 -.25 3.7 .8 0 0 0 1 0 0 0 .8 1-4ndis.dat
  [1,80,8.05,-.25,3.7,.8,0,0,0,1,0,0,0,.8, ldraw_lib__1_4ndis(realsolid)],
// 1 80 8.75 -.25 4.3 .8 0 0 0 1 0 0 0 .8 1-4chrd.dat
  [1,80,8.75,-.25,4.3,.8,0,0,0,1,0,0,0,.8, ldraw_lib__1_4chrd(realsolid)],
// 1 80 -8.75 -.25 -1.5 -1.2 0 0 0 1 0 0 0 -1.2 1-4ndis.dat
  [1,80,-8.75,-.25,-1.5,-1.2,0,0,0,1,0,0,0,-1.2, ldraw_lib__1_4ndis(realsolid)],
// 1 80 -8.75 -.25 4.3 -1.2 0 0 0 1 0 0 0 1.2 1-4ndis.dat
  [1,80,-8.75,-.25,4.3,-1.2,0,0,0,1,0,0,0,1.2, ldraw_lib__1_4ndis(realsolid)],
...
// 1 72 8.05 -.25 -.9 .4 0 0 0 1 0 0 0 -.4 1-4chrd.dat
  [1,72,8.05,-.25,-.9,.4,0,0,0,1,0,0,0,-.4, ldraw_lib__1_4chrd(realsolid)],
// 1 72 -8.05 -.25 -.9 -.4 0 0 0 1 0 0 0 -.4 1-4chrd.dat
  [1,72,-8.05,-.25,-.9,-.4,0,0,0,1,0,0,0,-.4, ldraw_lib__1_4chrd(realsolid)],
...
// 1 272 8.05 -.25 3.7 .4 0 0 0 1 0 0 0 .4 1-4chrd.dat
  [1,272,8.05,-.25,3.7,.4,0,0,0,1,0,0,0,.4, ldraw_lib__1_4chrd(realsolid)],
// 1 272 -8.05 -.25 3.7 -.4 0 0 0 1 0 0 0 .4 1-4chrd.dat
  [1,272,-8.05,-.25,3.7,-.4,0,0,0,1,0,0,0,.4, ldraw_lib__1_4chrd(realsolid)],
...
module ldraw_lib__6258203c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6258203c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
