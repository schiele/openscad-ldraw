...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 44343pb01, Rebrickable 44343pr0001, roadplate, Set 4111
// 0 !KEYWORDS X-road
// 
...
// 1 8 0 0 0 0 0 -1 0 1 0 1 0 0 s\44341s02.dat
  [1,8,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__44341s02()],
// 1 8 0 0 0 -1 0 0 0 1 0 0 0 -1 s\44341s02.dat
  [1,8,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__44341s02()],
// 1 8 0 0 0 0 0 1 0 1 0 -1 0 0 s\44341s02.dat
  [1,8,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__44341s02()],
// 1 16 -182 0 182 0 0 -1 0 1 0 1 0 0 s\44341s01.dat
  [1,16,-182,0,182,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__44341s01()],
...
module ldraw_lib__44343p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__44343p01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
