...
use <6141875j.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6141875l(realsolid=false) = [
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 6141875j.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__6141875j(realsolid)],
];
module ldraw_lib__6141875l(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6141875l(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
