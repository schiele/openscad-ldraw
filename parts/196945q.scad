...
use <s/196945snl.scad>
$fa=1; $fs=0.2;
function ldraw_lib__196945q(realsolid=false) = [
// 0 Sticker  2.4 x  2 with Black Netherlands Rail Logo and "7735"
// 0 Name: 196945q.dat
...
// 1 16 0 -0.25 7.328 0.34 0 0 0 1 0 0 0 0.34 s\196945snl.dat
  [1,16,0,-0.25,7.328,0.34,0,0,0,1,0,0,0,0.34, ldraw_lib__s__196945snl(realsolid)],
...
module ldraw_lib__196945q(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__196945q(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__196945q(line=0.2);