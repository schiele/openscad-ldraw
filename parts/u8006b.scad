...
// 
// 0 !CATEGORY Brick
// 0 !KEYWORDS Automatic Binding Brick, BrickLink bslot10, Lego Mursten
// 0 !KEYWORDS Rebrickable 3006b
// 
...
// 1 16 0 24 0 0 0 -96 0 -20 0 16 0 0 box4-1.dat
  [1,16,0,24,0,0,0,-96,0,-20,0,16,0,0, ldraw_lib__box4_1()],
// 1 16 100 12 0 0 -200 0 -12 0 0 0 0 20 box3u2p.dat
  [1,16,100,12,0,0,-200,0,-12,0,0,0,0,20, ldraw_lib__box3u2p()],
...
module ldraw_lib__u8006b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8006b(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
