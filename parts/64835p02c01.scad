...
use <64835p02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__64835p02c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 64835p02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__64835p02(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 64780p02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__64780p02(realsolid)],
];
module ldraw_lib__64835p02c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__64835p02c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
