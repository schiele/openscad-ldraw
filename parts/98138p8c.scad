...
use <s/98138s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98138p8c(realsolid=false) = [
...
// 1 92 0 0 0 1 0 0 0 1 0 0 0 1 s\98138p8bs02.dat
  [1,92,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__98138p8bs02(realsolid)],
// 1 84 0 0 0 1 0 0 0 1 0 0 0 1 s\98138p8bs03.dat
  [1,84,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__98138p8bs03(realsolid)],
];
module ldraw_lib__98138p8c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98138p8c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
