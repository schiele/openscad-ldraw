...
use <70450b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__328b(realsolid=false) = [
// 0 ~Moved to 70450b
// 0 Name: 328b.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 70450b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__70450b(realsolid)],
];
module ldraw_lib__328b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__328b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
