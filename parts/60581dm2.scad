...
use <60581.scad>
$fa=1; $fs=0.2;
function ldraw_lib__60581dm2(realsolid=false) = [
...
// 1 16 0 33.5 6.25 1 0 0 0 0 -1 0 1 0 6005724r.dat
  [1,16,0,33.5,6.25,1,0,0,0,0,-1,0,1,0, ldraw_lib__6005724r(realsolid)],
// 1 16 20 12 10 -1 0 0 0 0 -1 0 -1 0 6005724h1.dat
  [1,16,20,12,10,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__6005724h1(realsolid)],
];
module ldraw_lib__60581dm2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__60581dm2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
