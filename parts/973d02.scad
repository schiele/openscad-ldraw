...
use <973.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973d02(realsolid=false) = [
...
// 1 16 0 16 -10 1 0 0 0 0 -1 0 1 0 004315a.dat
  [1,16,0,16,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__004315a(realsolid)],
// 0
];
module ldraw_lib__973d02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973d02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
