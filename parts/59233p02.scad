...
use <s/59233s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__59233p02(realsolid=false) = [
...
// 1 35 0 0 0 1 0 0 0 1 0 0 0 1 s\59233s01.dat
  [1,35,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__59233s01(realsolid)],
...
module ldraw_lib__59233p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__59233p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
