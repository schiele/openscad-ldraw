...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3195p02(realsolid=false) = [
...
// 1 16 10 0 0 1 0 0 0 1 0 0 0 1 s\3195p02s02.dat
  [1,16,10,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3195p02s02(realsolid)],
];
module ldraw_lib__3195p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3195p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
