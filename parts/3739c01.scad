...
use <3740.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3739c01(realsolid=false) = [
...
// 1 16 0 0 -30 0 0 1 0 1 0 -1 0 0 3739.dat
  [1,16,0,0,-30,0,0,1,0,1,0,-1,0,0, ldraw_lib__3739(realsolid)],
// 1 256 0 0 0 1 0 0 0 1 0 0 0 1 3740.dat
  [1,256,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3740(realsolid)],
];
module ldraw_lib__3739c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3739c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
