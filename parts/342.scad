...
// 1 16 0 0 0 0 0 -2 0 -1 0 2 0 0 4-4disc.dat
  [1,16,0,0,0,0,0,-2,0,-1,0,2,0,0, ldraw_lib__4_4disc()],
...
// 1 16 0 -4 0 0 0 -2 0 1 0 2 0 0 4-4edge.dat
  [1,16,0,-4,0,0,0,-2,0,1,0,2,0,0, ldraw_lib__4_4edge()],
// 1 16 0 -4 0 0.667 0 0 0 -1.5 0 0 0 0.667 4-4con2.dat
  [1,16,0,-4,0,0.667,0,0,0,-1.5,0,0,0,0.667, ldraw_lib__4_4con2()],
// 1 16 0 -10.5 0 0.667 0 0 0 1.5 0 0 0 0.667 4-4con2.dat
  [1,16,0,-10.5,0,0.667,0,0,0,1.5,0,0,0,0.667, ldraw_lib__4_4con2()],
// 1 16 0 -5.5 0 0 0 -1.333 0 1 0 1.333 0 0 4-4edge.dat
  [1,16,0,-5.5,0,0,0,-1.333,0,1,0,1.333,0,0, ldraw_lib__4_4edge()],
// 1 16 0 -5.5 0 0 0 -1.333 0 -3.5 0 1.333 0 0 4-4cyli.dat
  [1,16,0,-5.5,0,0,0,-1.333,0,-3.5,0,1.333,0,0, ldraw_lib__4_4cyli()],
// 1 16 0 -9 0 0 0 -1.333 0 1 0 1.333 0 0 4-4edge.dat
  [1,16,0,-9,0,0,0,-1.333,0,1,0,1.333,0,0, ldraw_lib__4_4edge()],
// 1 16 0 -10.5 0 0 0 -2 0 1 0 2 0 0 4-4edge.dat
  [1,16,0,-10.5,0,0,0,-2,0,1,0,2,0,0, ldraw_lib__4_4edge()],
// 1 16 0 -10.5 0 0 0 -2 0 -9.5 0 2 0 0 4-4cyli.dat
  [1,16,0,-10.5,0,0,0,-2,0,-9.5,0,2,0,0, ldraw_lib__4_4cyli()],
// 0
];
module ldraw_lib__342(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__342(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
