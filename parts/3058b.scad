...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3058b(realsolid=false) = [
...
// 1 16 0 0 0 160 0 0 0 8 0 0 0 60 box4.dat
  [1,16,0,0,0,160,0,0,0,8,0,0,0,60, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 0 156 0 0 0 4 0 0 0 56 box4.dat
  [1,16,0,4,0,156,0,0,0,4,0,0,0,56, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 20 0 0 80 4 0 0 0 20 0 box3u2p.dat
  [1,16,0,4,20,0,0,80,4,0,0,0,20,0, ldraw_lib__box3u2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 -20 0 0 80 4 0 0 0 -20 0 box3u2p.dat
  [1,16,0,4,-20,0,0,80,4,0,0,0,-20,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 0 6 24 0 0 84 2 0 0 0 20 0 box3u2p.dat
  [1,16,0,6,24,0,0,84,2,0,0,0,20,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 0 6 -24 0 0 84 2 0 0 0 -20 0 box3u2p.dat
  [1,16,0,6,-24,0,0,84,2,0,0,0,-20,0, ldraw_lib__box3u2p(realsolid)],
// 
...
// 4 16 84 8 44 -84 8 44 -80 8 40 80 8 40
  [4,16,84,8,44,-84,8,44,-80,8,40,80,8,40],
// 4 16 -84 8 44 -84 8 24 -80 8 20 -80 8 40
  [4,16,-84,8,44,-84,8,24,-80,8,20,-80,8,40],
// 4 16 -84 8 24 -104 8 24 -100 8 20 -80 8 20
  [4,16,-84,8,24,-104,8,24,-100,8,20,-80,8,20],
...
// 4 16 160 0 -60 100 0 -20 100 0 20 160 0 60
  [4,16,160,0,-60,100,0,-20,100,0,20,160,0,60],
// 
// 4 16 -80 8 20 -100 8 20 -100 0 20 -80 0 20
  [4,16,-80,8,20,-100,8,20,-100,0,20,-80,0,20],
// 4 16 -100 8 20 -100 8 -20 -100 0 -20 -100 0 20
  [4,16,-100,8,20,-100,8,-20,-100,0,-20,-100,0,20],
// 4 16 -100 8 -20 -80 8 -20 -80 0 -20 -100 0 -20
  [4,16,-100,8,-20,-80,8,-20,-80,0,-20,-100,0,-20],
// 4 16 80 8 -20 100 8 -20 100 0 -20 80 0 -20
  [4,16,80,8,-20,100,8,-20,100,0,-20,80,0,-20],
// 4 16 100 8 -20 100 8 20 100 0 20 100 0 -20
...
// 4 16 100 8 20 80 8 20 80 0 20 100 0 20
  [4,16,100,8,20,80,8,20,80,0,20,100,0,20],
// 
// 4 16 -84 4 24 -104 4 24 -104 8 24 -84 8 24
  [4,16,-84,4,24,-104,4,24,-104,8,24,-84,8,24],
// 4 16 -104 4 24 -104 4 -24 -104 8 -24 -104 8 24
  [4,16,-104,4,24,-104,4,-24,-104,8,-24,-104,8,24],
// 4 16 -104 4 -24 -84 4 -24 -84 8 -24 -104 8 -24
  [4,16,-104,4,-24,-84,4,-24,-84,8,-24,-104,8,-24],
// 4 16 84 4 -24 104 4 -24 104 8 -24 84 8 -24
  [4,16,84,4,-24,104,4,-24,104,8,-24,84,8,-24],
// 4 16 104 4 -24 104 4 24 104 8 24 104 8 -24
...
module ldraw_lib__3058b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3058b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
