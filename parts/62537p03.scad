...
use <s/62537s05.scad>
$fa=1; $fs=0.2;
function ldraw_lib__62537p03(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\62537s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__62537s02(realsolid)],
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\62537s03.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__62537s03(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\62537s04.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__62537s04(realsolid)],
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\62537s05.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__62537s05(realsolid)],
// 0
];
module ldraw_lib__62537p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__62537p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
