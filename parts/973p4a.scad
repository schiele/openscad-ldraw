...
use <s/973s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973p4a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\973p4aa.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p4aa(realsolid)],
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\973p4ab.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p4ab(realsolid)],
];
module ldraw_lib__973p4a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p4a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
