...
use <s/65473s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__65473(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\65473s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__65473s01(realsolid)],
// 1 16 21.0883 -50.9117 0 .70711 .70711 0 .70711 -.70711 0 0 0 1 s\65473s01.dat
  [1,16,21.0883,-50.9117,0,.70711,.70711,0,.70711,-.70711,0,0,0,1, ldraw_lib__s__65473s01(realsolid)],
// 
// 1 16 72 0 0 -72 0 0 0 0 -72 0 72 0 48\tm08q2639.dat
  [1,16,72,0,0,-72,0,0,0,0,-72,0,72,0, ldraw_lib__48__tm08q2639(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 72 0 0 -72 0 0 0 0 -72 0 72 0 48\tm08q2111.dat
  [1,16,72,0,0,-72,0,0,0,0,-72,0,72,0, ldraw_lib__48__tm08q2111(realsolid)],
];
module ldraw_lib__65473(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__65473(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
