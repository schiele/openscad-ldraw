...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__t1057(realsolid=false) = [
...
// 1 494 0 0 0 15 0 0 0 0 17.67763 0 36 0 1-8cyli.dat
  [1,494,0,0,0,15,0,0,0,0,17.67763,0,36,0, ldraw_lib__1_8cyli(realsolid)],
// 1 494 0 0 0 15 0 0 0 0 17.67763 0 1 0 1-8chrd.dat
  [1,494,0,0,0,15,0,0,0,0,17.67763,0,1,0, ldraw_lib__1_8chrd(realsolid)],
// 1 16 0 0 38 15 0 0 0 0 17.67763 0 -1 0 1-8chrd.dat
  [1,16,0,0,38,15,0,0,0,0,17.67763,0,-1,0, ldraw_lib__1_8chrd(realsolid)],
// 1 494 0 0 0 -15 0 0 0 0 17.67763 0 36 0 1-8cyli.dat
  [1,494,0,0,0,-15,0,0,0,0,17.67763,0,36,0, ldraw_lib__1_8cyli(realsolid)],
// 1 494 0 0 0 -15 0 0 0 0 17.67763 0 1 0 1-8chrd.dat
  [1,494,0,0,0,-15,0,0,0,0,17.67763,0,1,0, ldraw_lib__1_8chrd(realsolid)],
...
// 1 494 0 12.4998 18 10.6065 0 0 0 -1 0 0 0 -18 rect3.dat
  [1,494,0,12.4998,18,10.6065,0,0,0,-1,0,0,0,-18, ldraw_lib__rect3(realsolid)],
// 1 494 0 0 0 15 0 0 0 0 17.67763 0 1 0 1-8edge.dat
  [1,494,0,0,0,15,0,0,0,0,17.67763,0,1,0, ldraw_lib__1_8edge(realsolid)],
// 1 494 0 0 0 -15 0 0 0 0 17.67763 0 1 0 1-8edge.dat
  [1,494,0,0,0,-15,0,0,0,0,17.67763,0,1,0, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 0 38 15 0 0 0 0 17.67763 0 -2 0 1-8cylo.dat
  [1,16,0,0,38,15,0,0,0,0,17.67763,0,-2,0, ldraw_lib__1_8cylo(realsolid)],
// 1 16 0 0 38 -15 0 0 0 0 17.67763 0 -2 0 1-8cylo.dat
  [1,16,0,0,38,-15,0,0,0,0,17.67763,0,-2,0, ldraw_lib__1_8cylo(realsolid)],
// 1 16 0 12.4998 37 -10.6065 0 0 0 -1 0 0 0 1 rect.dat
  [1,16,0,12.4998,37,-10.6065,0,0,0,-1,0,0,0,1, ldraw_lib__rect(realsolid)],
...
// 1 16 0 -12.4998 37 0 0 10.6065 0 1 0 -1 0 0 rect.dat
  [1,16,0,-12.4998,37,0,0,10.6065,0,1,0,-1,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 0 0 38 6.5 0 0 0 0 6.5 0 2 0 4-4cylo.dat
  [1,16,0,0,38,6.5,0,0,0,0,6.5,0,2,0, ldraw_lib__4_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 39 3.25 0 0 0 0 3.25 0 1 0 4-4cylo.dat
  [1,16,0,0,39,3.25,0,0,0,0,3.25,0,1,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 0 40 3.25 0 0 0 0 3.25 0 -1 0 4-4ring1.dat
  [1,16,0,0,40,3.25,0,0,0,0,3.25,0,-1,0, ldraw_lib__4_4ring1(realsolid)],
// 1 494 0 0 39 3.25 0 0 0 0 3.25 0 -1 0 4-4disc.dat
  [1,494,0,0,39,3.25,0,0,0,0,3.25,0,-1,0, ldraw_lib__4_4disc(realsolid)],
// 1 494 9 0 38 0.5 0 0 0 0 2 0 3 0 box5.dat
  [1,494,9,0,38,0.5,0,0,0,0,2,0,3,0, ldraw_lib__box5(realsolid)],
// 1 494 -9 0 38 0.5 0 0 0 0 2 0 3 0 box5.dat
  [1,494,-9,0,38,0.5,0,0,0,0,2,0,3,0, ldraw_lib__box5(realsolid)],
];
module ldraw_lib__t1057(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1057(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
