...
$fa=1; $fs=0.2;
function ldraw_lib__3626bp89(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 3626bpb0366, set 10210, Set 7079
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3626p89s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3626p89s01(realsolid)],
];
module ldraw_lib__3626bp89(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3626bp89(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
