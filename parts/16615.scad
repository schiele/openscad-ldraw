...
use <32524.scad>
$fa=1; $fs=0.2;
function ldraw_lib__16615(realsolid=false) = [
// 0 =Technic Beam  7
// 0 Name: 16615.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 32524.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32524(realsolid)],
// 0
];
module ldraw_lib__16615(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__16615(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
