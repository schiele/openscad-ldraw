...
use <s/3005s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3005pv3(realsolid=false) = [
...
// 1 16 0 16 -10 -2.1 0 0 0 0 1.75 0 1 0 3-4disc.dat
  [1,16,0,16,-10,-2.1,0,0,0,0,1.75,0,1,0, ldraw_lib__3_4disc(realsolid)],
// 1 1 0 16 -10 -2.1 0 0 0 0 1.75 0 1 0 3-4ndis.dat
  [1,1,0,16,-10,-2.1,0,0,0,0,1.75,0,1,0, ldraw_lib__3_4ndis(realsolid)],
// 1 1 0 16 -10 5.5 0 0 0 0 4 0 1 0 1-8chrd.dat
  [1,1,0,16,-10,5.5,0,0,0,0,4,0,1,0, ldraw_lib__1_8chrd(realsolid)],
// 1 1 0 16 -10 3.88905 0 -3.88905 2.8284 0 2.8284 0 1 0 1-8chrd.dat
  [1,1,0,16,-10,3.88905,0,-3.88905,2.8284,0,2.8284,0,1,0, ldraw_lib__1_8chrd(realsolid)],
...
// 1 1 0 10 -10 3.3587 0 -3.3587 -2.8284 0 -2.8284 0 1 0 1-8chrd.dat
  [1,1,0,10,-10,3.3587,0,-3.3587,-2.8284,0,-2.8284,0,1,0, ldraw_lib__1_8chrd(realsolid)],
...
// 1 16 0 10 -10 -1.75 0 0 0 0 -1.5 0 1 0 3-4disc.dat
  [1,16,0,10,-10,-1.75,0,0,0,0,-1.5,0,1,0, ldraw_lib__3_4disc(realsolid)],
// 1 1 0 10 -10 -1.75 0 0 0 0 -1.5 0 1 0 3-4ndis.dat
  [1,1,0,10,-10,-1.75,0,0,0,0,-1.5,0,1,0, ldraw_lib__3_4ndis(realsolid)],
// 1 1 0 10 -10 -4.75 0 0 0 0 -4 0 1 0 1-8chrd.dat
  [1,1,0,10,-10,-4.75,0,0,0,0,-4,0,1,0, ldraw_lib__1_8chrd(realsolid)],
// 1 1 0 10 -10 -3.3587 0 3.3587 -2.8284 0 -2.8284 0 1 0 1-8chrd.dat
  [1,1,0,10,-10,-3.3587,0,3.3587,-2.8284,0,-2.8284,0,1,0, ldraw_lib__1_8chrd(realsolid)],
...
module ldraw_lib__3005pv3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3005pv3(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
