...
use <s/973s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973p3r(realsolid=false) = [
// 0 Minifig Torso with Blue Imperial Guard Officer Pattern
// 0 Name: 973p3r.dat
...
// 1 1 0 0 0 1 0 0 0 1 0 0 0 1 s\973p37c.dat
  [1,1,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p37c(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\973p37d.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p37d(realsolid)],
];
module ldraw_lib__973p3r(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p3r(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__973p3r(line=0.2);