...
use <../p/empty.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6637b(realsolid=false) = [
// 0 ~Obsolete file
// 0 Name: 6637b.dat
...
module ldraw_lib__6637b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6637b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6637b(line=0.2);