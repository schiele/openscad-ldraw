...
// 1 16 0 -1 0 0 0 10 0 -5 0 -10 0 0 box4o4a.dat
  [1,16,0,-1,0,0,0,10,0,-5,0,-10,0,0, ldraw_lib__box4o4a()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 0 0 6 0 -6 0 -6 0 0 box4o4a.dat
  [1,16,0,0,0,0,0,6,0,-6,0,-6,0,0, ldraw_lib__box4o4a()],
...
// 1 16 -10 -6 0 0 20 0 0 0 -10 -10 0 0 2-4cylo.dat
  [1,16,-10,-6,0,0,20,0,0,0,-10,-10,0,0, ldraw_lib__2_4cylo()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -6 -6 0 0 12 0 0 0 -6 -6 0 0 2-4cylo.dat
  [1,16,-6,-6,0,0,12,0,0,0,-6,-6,0,0, ldraw_lib__2_4cylo()],
// 1 16 -10 -6 0 0 20 0 0 0 -10 -10 0 0 2-4chrd.dat
  [1,16,-10,-6,0,0,20,0,0,0,-10,-10,0,0, ldraw_lib__2_4chrd()],
// 1 16 -6 -6 0 0 -12 0 0 0 -6 -6 0 0 2-4chrd.dat
  [1,16,-6,-6,0,0,-12,0,0,0,-6,-6,0,0, ldraw_lib__2_4chrd()],
// 1 16 10 -6 0 0 -20 0 0 0 -10 -10 0 0 2-4chrd.dat
  [1,16,10,-6,0,0,-20,0,0,0,-10,-10,0,0, ldraw_lib__2_4chrd()],
// 1 16 6 -6 0 0 12 0 0 0 -6 -6 0 0 2-4chrd.dat
  [1,16,6,-6,0,0,12,0,0,0,-6,-6,0,0, ldraw_lib__2_4chrd()],
...
module ldraw_lib__49307(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__49307(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
