...
use <../p/bush0.scad>
$fa=1; $fs=0.2;
function ldraw_lib__53586(realsolid=false) = [
...
// 1 16 0 20 10 7 0 0 0 0 7 0 -20 0 4-4cyli.dat
  [1,16,0,20,10,7,0,0,0,0,7,0,-20,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 20 -90 1 0 0 0 0 1 0 12 0 axl3hol8.dat
  [1,16,0,20,-90,1,0,0,0,0,1,0,12,0, ldraw_lib__axl3hol8(realsolid)],
// 1 16 0 20 -78 1 0 0 0 0 1 0 1 0 axl3hol3.dat
  [1,16,0,20,-78,1,0,0,0,0,1,0,1,0, ldraw_lib__axl3hol3(realsolid)],
// 1 16 0 20 -90 1 0 0 0 0 1 0 1 0 axl3hol2.dat
  [1,16,0,20,-90,1,0,0,0,0,1,0,1,0, ldraw_lib__axl3hol2(realsolid)],
// 1 16 0 20 -90 1 0 0 0 0 1 0 1 0 axl3hol9.dat
  [1,16,0,20,-90,1,0,0,0,0,1,0,1,0, ldraw_lib__axl3hol9(realsolid)],
// 1 16 0 20 -90 1 0 0 0 0 1 0 1 0 axl3ho10.dat
  [1,16,0,20,-90,1,0,0,0,0,1,0,1,0, ldraw_lib__axl3ho10(realsolid)],
// 1 16 0 20 -78 1 0 0 0 0 1 0 -1 0 axl3ho10.dat
  [1,16,0,20,-78,1,0,0,0,0,1,0,-1,0, ldraw_lib__axl3ho10(realsolid)],
// 1 16 0 20 -78 1 0 0 0 0 1 0 1 0 axl3hol9.dat
  [1,16,0,20,-78,1,0,0,0,0,1,0,1,0, ldraw_lib__axl3hol9(realsolid)],
// 1 16 0 20 10 9 0 0 0 0 9 0 1 0 4-4edge.dat
  [1,16,0,20,10,9,0,0,0,0,9,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 20 10 7 0 0 0 0 7 0 1 0 4-4edge.dat
  [1,16,0,20,10,7,0,0,0,0,7,0,1,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 20 10 1 0 0 0 0 1 0 -1 0 2-4ring7.dat
  [1,16,0,20,10,1,0,0,0,0,1,0,-1,0, ldraw_lib__2_4ring7(realsolid)],
// 1 16 0 20 10 -1 0 0 0 0 -1 0 -1 0 2-4ring7.dat
  [1,16,0,20,10,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__2_4ring7(realsolid)],
// 1 16 0 20 -90 8 0 0 0 0 8 0 1 0 4-4edge.dat
  [1,16,0,20,-90,8,0,0,0,0,8,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 20 10 9 0 0 0 0 9 0 -20 0 4-4cyli.dat
  [1,16,0,20,10,9,0,0,0,0,9,0,-20,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 20 -10 1 0 0 0 0 1 0 -80 0 4-4con8.dat
  [1,16,0,20,-10,1,0,0,0,0,1,0,-80,0, ldraw_lib__4_4con8(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 20 -10 1 0 0 0 0 -1 0 -68 0 4-4con6.dat
  [1,16,0,20,-10,1,0,0,0,0,-1,0,-68,0, ldraw_lib__4_4con6(realsolid)],
// 2 24 9 0 9 9 20 9
  [2,24,9,0,9,9,20,9],
// 2 24 -9 0 9 -9 20 9
  [2,24,-9,0,9,-9,20,9],
...
// 1 16 0 20 2 6.36 0 -6.36 -6.36 0 -6.36 0 1 0 1-4edge.dat
  [1,16,0,20,2,6.36,0,-6.36,-6.36,0,-6.36,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 20 -2 6.36 0 -6.36 -6.36 0 -6.36 0 1 0 1-4edge.dat
  [1,16,0,20,-2,6.36,0,-6.36,-6.36,0,-6.36,0,1,0, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 -6.5 0 0 0 0.5 0 1 0 0 0 0 -1 4-4con7.dat
  [1,16,-6.5,0,0,0,0.5,0,1,0,0,0,0,-1, ldraw_lib__4_4con7(realsolid)],
// 1 16 6.5 0 0 0 -0.5 0 1 0 0 0 0 1 4-4con7.dat
  [1,16,6.5,0,0,0,-0.5,0,1,0,0,0,0,1, ldraw_lib__4_4con7(realsolid)],
...
// 1 16 0 20 -90 2 0 0 0 0 -2 0 1 0 2-4ring3.dat
  [1,16,0,20,-90,2,0,0,0,0,-2,0,1,0, ldraw_lib__2_4ring3(realsolid)],
// 1 16 0 20 -90 -2 0 0 0 0 2 0 1 0 2-4ring3.dat
  [1,16,0,20,-90,-2,0,0,0,0,2,0,1,0, ldraw_lib__2_4ring3(realsolid)],
...
module ldraw_lib__53586(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__53586(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
