...
use <6005724g.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3245cdm0(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3245c.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3245c(realsolid)],
// 1 16 0 12 -10 1 0 0 0 0 -1 0 1 0 6005724g.dat
  [1,16,0,12,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__6005724g(realsolid)],
];
module ldraw_lib__3245cdm0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3245cdm0(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
