...
use <s/4066bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4066bp1h(realsolid=false) = [
...
// 1 13 0 0 0 1 0 0 0 1 0 0 0 1 s\4066bp0ts01.dat
  [1,13,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4066bp0ts01(realsolid)],
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 s\4066bp0ts02.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4066bp0ts02(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\4066bp0ts03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4066bp0ts03(realsolid)],
];
module ldraw_lib__4066bp1h(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4066bp1h(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4066bp1h(line=0.2);