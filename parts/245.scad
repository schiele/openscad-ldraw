...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__245(realsolid=false) = [
...
// 1 16 0 0 -12 20.15 0 0 0 0 20.15 0 1 0 4-4edge.dat
  [1,16,0,0,-12,20.15,0,0,0,0,20.15,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 0 -12 20.15 0 0 0 0 20.15 0 1 0 4-4disc.dat
  [1,16,0,0,-12,20.15,0,0,0,0,20.15,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 
// 1 16 2 11.602 -0.25 0 -1 0 0 0 4 7.75 0 0 rect.dat
  [1,16,2,11.602,-0.25,0,-1,0,0,0,4,7.75,0,0, ldraw_lib__rect(realsolid)],
// 1 16 -2 11.602 -0.25 0 1 0 0 0 4 7.75 0 0 rect.dat
  [1,16,-2,11.602,-0.25,0,1,0,0,0,4,7.75,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 0 0 4.4 6 0 0 0 0 6 0 -2.4 0 4-4con3.dat
  [1,16,0,0,4.4,6,0,0,0,0,6,0,-2.4,0, ldraw_lib__4_4con3(realsolid)],
// 1 16 0 0 6 4 0 0 0 0 4 0 -1.6 0 4-4con6.dat
  [1,16,0,0,6,4,0,0,0,0,4,0,-1.6,0, ldraw_lib__4_4con6(realsolid)],
// 0 1 16 0 0 -12 2 0 0 0 0 2 0 14 0 4-4con9.dat
// 
// 1 16 0 0 -1.907 0 0 0.6 0.6 0 0 0 3.907 0 4-4con30.dat
  [1,16,0,0,-1.907,0,0,0.6,0.6,0,0,0,3.907,0, ldraw_lib__4_4con30(realsolid)],
// 1 16 0 0 -12 0 0 1.55 1.55 0 0 0 10.093 0 4-4con12.dat
  [1,16,0,0,-12,0,0,1.55,1.55,0,0,0,10.093,0, ldraw_lib__4_4con12(realsolid)],
// 
// 0
];
module ldraw_lib__245(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__245(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
