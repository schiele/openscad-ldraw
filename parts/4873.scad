...
// 1 16 30 8 0 4 0 0 0 -1 0 0 0 -4 4-4edge.dat
  [1,16,30,8,0,4,0,0,0,-1,0,0,0,-4, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 30 8 0 4 0 0 0 -8 0 0 0 -4 4-4cyli.dat
  [1,16,30,8,0,4,0,0,0,-8,0,0,0,-4, ldraw_lib__4_4cyli()],
...
module ldraw_lib__4873(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4873(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
