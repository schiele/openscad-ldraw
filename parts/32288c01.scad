...
// 1 8 0 0 0 1 0 0 0 1 0 0 0 1 32289a.dat
  [1,8,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32289a()],
// 1 8 0 0 40 1 0 0 0 1 0 0 0 1 32290.dat
  [1,8,0,0,40,1,0,0,0,1,0,0,0,1, ldraw_lib__32290()],
// 1 8 0 2 -80 1 0 0 0 1 0 0 0 1 913.dat
  [1,8,0,2,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__913()],
// 1 15 0 82 0 1 0 0 0 1 0 0 0 1 914.dat
  [1,15,0,82,0,1,0,0,0,1,0,0,0,1, ldraw_lib__914()],
...
module ldraw_lib__32288c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32288c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
