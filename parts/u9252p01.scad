...
use <191765.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9252p01(realsolid=false) = [
// 0 ~Moved to 191765
// 0 Name: u9252p01.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 191765.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__191765(realsolid)],
];
module ldraw_lib__u9252p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9252p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
