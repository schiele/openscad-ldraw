...
// 1 16 0 -1.5 0 4 0 0 0 -1 0 0 0 -4 48\4-4edge.dat
  [1,16,0,-1.5,0,4,0,0,0,-1,0,0,0,-4, ldraw_lib__48__4_4edge()],
// 1 16 0 -2 0 3.5 0 0 0 -1 0 0 0 -3.5 48\4-4edge.dat
  [1,16,0,-2,0,3.5,0,0,0,-1,0,0,0,-3.5, ldraw_lib__48__4_4edge()],
// 1 16 0 -2 0 0 0 -3.5 0 1 0 -3.5 0 0 48\1-3chrd.dat
  [1,16,0,-2,0,0,0,-3.5,0,1,0,-3.5,0,0, ldraw_lib__48__1_3chrd()],
// 1 16 0 -2 0 -3.03109 0 1.75 0 1 0 1.75 0 3.03109 48\1-3chrd.dat
  [1,16,0,-2,0,-3.03109,0,1.75,0,1,0,1.75,0,3.03109, ldraw_lib__48__1_3chrd()],
// 1 16 0 -2 0 3.03109 0 1.75 0 1 0 1.75 0 -3.03109 48\1-3chrd.dat
  [1,16,0,-2,0,3.03109,0,1.75,0,1,0,1.75,0,-3.03109, ldraw_lib__48__1_3chrd()],
// 1 16 0 -1.5 0 0.5 0 0 0 -0.5 0 0 0 -0.5 48\4-4con7.dat
  [1,16,0,-1.5,0,0.5,0,0,0,-0.5,0,0,0,-0.5, ldraw_lib__48__4_4con7()],
// 1 16 0 0 0 4 0 0 0 -1 0 0 0 -4 48\4-4edge.dat
  [1,16,0,0,0,4,0,0,0,-1,0,0,0,-4, ldraw_lib__48__4_4edge()],
// 1 16 0 0 0 4 0 0 0 -1.5 0 0 0 -4 48\4-4cyli.dat
  [1,16,0,0,0,4,0,0,0,-1.5,0,0,0,-4, ldraw_lib__48__4_4cyli()],
// 3 16 0 -1 -3.5 3.031 -1 1.75 -3.031 -1 1.75
  [3,16,0,-1,-3.5,3.031,-1,1.75,-3.031,-1,1.75],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -2 -3.5 3.031 0 -3.031 0 1 0 5.25 0 5.25 tri3.dat
  [1,16,0,-2,-3.5,3.031,0,-3.031,0,1,0,5.25,0,5.25, ldraw_lib__tri3()],
// 1 16 0 0 0 2 0 0 0 -1 0 0 0 -2 48\4-4edge.dat
  [1,16,0,0,0,2,0,0,0,-1,0,0,0,-2, ldraw_lib__48__4_4edge()],
// 1 16 0 0 0 2 0 0 0 -1 0 0 0 -2 48\4-4ring1.dat
  [1,16,0,0,0,2,0,0,0,-1,0,0,0,-2, ldraw_lib__48__4_4ring1()],
// 1 16 0 4 0 2 0 0 0 -1 0 0 0 -2 48\4-4edge.dat
  [1,16,0,4,0,2,0,0,0,-1,0,0,0,-2, ldraw_lib__48__4_4edge()],
// 1 16 0 4 0 2 0 0 0 -1 0 0 0 -2 48\4-4disc.dat
  [1,16,0,4,0,2,0,0,0,-1,0,0,0,-2, ldraw_lib__48__4_4disc()],
// 1 16 0 4 0 2 0 0 0 -4 0 0 0 -2 48\4-4cyli.dat
  [1,16,0,4,0,2,0,0,0,-4,0,0,0,-2, ldraw_lib__48__4_4cyli()],
];
module ldraw_lib__u9022(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9022(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
