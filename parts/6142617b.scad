...
use <../p/box3u12.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6142617b(realsolid=false) = [
...
// 1 15 -16.5 -.25 3.8 -1.5 0 0 0 1 0 0 0 1.5 1-4chrd.dat
  [1,15,-16.5,-.25,3.8,-1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 15 16.5 -.25 3.8 1.5 0 0 0 1 0 0 0 1.5 1-4chrd.dat
  [1,15,16.5,-.25,3.8,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 15 -16.5 -.25 -3.8 -1.5 0 0 0 1 0 0 0 -1.5 1-4chrd.dat
  [1,15,-16.5,-.25,-3.8,-1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__1_4chrd(realsolid)],
...
module ldraw_lib__6142617b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6142617b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
