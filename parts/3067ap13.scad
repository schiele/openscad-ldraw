...
// 1 1 0 0 0 1 0 0 0 1 0 0 0 1 s\3067ap13s01.dat
  [1,1,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3067ap13s01()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3067ap13s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3067ap13s02()],
// 
];
module ldraw_lib__3067ap13(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3067ap13(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
