...
use <s/76371s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__76371(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\76371s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__76371s01(realsolid)],
// 4 16 40 96 -20 40 0 -20 -40 0 -20 -40 96 -20
  [4,16,40,96,-20,40,0,-20,-40,0,-20,-40,96,-20],
];
module ldraw_lib__76371(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76371(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
