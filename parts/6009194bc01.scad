...
$fa=1; $fs=0.2;
function ldraw_lib__6009194bc01(realsolid=false) = [
...
// 1 16 0 1.0972 0.0201 1 0 0 0 .99933 -.0365 0 .0365 .99933 s\6009194bs01.dat
  [1,16,0,1.0972,0.0201,1,0,0,0,.99933,-.0365,0,.0365,.99933, ldraw_lib__s__6009194bs01(realsolid)],
// 1 16 0 2.4449 .1233 1 0 0 0 .9955 -.09477 0 .09477 .9955 s\6009194bs02.dat
  [1,16,0,2.4449,.1233,1,0,0,0,.9955,-.09477,0,.09477,.9955, ldraw_lib__s__6009194bs02(realsolid)],
// 1 16 0 3.7376 .3194 1 0 0 0 .98468 -.17435 0 .17435 .98468 s\6009194bs03.dat
  [1,16,0,3.7376,.3194,1,0,0,0,.98468,-.17435,0,.17435,.98468, ldraw_lib__s__6009194bs03(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\6009194bs05.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6009194bs05(realsolid)],
];
module ldraw_lib__6009194bc01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6009194bc01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
