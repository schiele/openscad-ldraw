...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__455(realsolid=false) = [
// 0 Baseplate 16 x 24 with Rounded Corners
// 0 Name: 455.dat
...
module ldraw_lib__455(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__455(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__455(line=0.2);