...
// 1 16 0 0 -30 1 0 0 0 1 0 0 0 1 u9476.dat
  [1,16,0,0,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__u9476()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 46490.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__46490()],
];
module ldraw_lib__46490c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__46490c02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
