...
use <32342.scad>
$fa=1; $fs=0.2;
function ldraw_lib__22011(realsolid=false) = [
...
// 1 47 0 0 0 1 0 0 0 1 0 0 0 1 32341.dat
  [1,47,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32341(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 32342.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32342(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 22579.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__22579(realsolid)],
// 0
];
module ldraw_lib__22011(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__22011(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
