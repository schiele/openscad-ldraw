...
use <../p/stud2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2476a(realsolid=false) = [
...
// 1 16 0 8 0 1 0 0 0 -1 0 0 0 1 connect.dat
  [1,16,0,8,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__connect(realsolid)],
...
// 1 16 0 8 0 11 0 0 0 1 0 0 0 11 4-4edge.dat
  [1,16,0,8,0,11,0,0,0,1,0,0,0,11, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 8 0 13 0 0 0 1 0 0 0 13 4-4edge.dat
  [1,16,0,8,0,13,0,0,0,1,0,0,0,13, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 4 0 11 0 0 0 1 0 0 0 11 4-4edge.dat
  [1,16,0,4,0,11,0,0,0,1,0,0,0,11, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 4 0 11 0 0 0 4 0 0 0 11 4-4cyli.dat
  [1,16,0,4,0,11,0,0,0,4,0,0,0,11, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 4 0 13 0 0 0 4 0 0 0 13 4-4cyli.dat
  [1,16,0,4,0,13,0,0,0,4,0,0,0,13, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 8 0 1 0 0 0 -1 0 0 0 -1 4-4rin11.dat
  [1,16,0,8,0,1,0,0,0,-1,0,0,0,-1, ldraw_lib__4_4rin11(realsolid)],
// 1 16 0 8 0 1 0 0 0 -1 0 0 0 -1 4-4rin12.dat
  [1,16,0,8,0,1,0,0,0,-1,0,0,0,-1, ldraw_lib__4_4rin12(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 8 0 20 0 0 0 -8 0 0 0 20 box5.dat
  [1,16,0,8,0,20,0,0,0,-8,0,0,0,20, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__2476a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2476a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
