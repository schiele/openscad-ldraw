...
use <s/4744s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4744p06(realsolid=false) = [
...
// 1 16 20 20 -20 20 0 0 0 0 -20 0 1 0 1-4ering.dat
  [1,16,20,20,-20,20,0,0,0,0,-20,0,1,0, ldraw_lib__1_4ering(realsolid)],
// 1 16 -20 20 -20 -20 0 0 0 0 -20 0 1 0 1-4ering.dat
  [1,16,-20,20,-20,-20,0,0,0,0,-20,0,1,0, ldraw_lib__1_4ering(realsolid)],
// 
// 1 14 -30 19 -20 6.5 0 0 0 0 -6.5 0 1 0 4-4disc.dat
  [1,14,-30,19,-20,6.5,0,0,0,0,-6.5,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 -30 19 -20 6.5 0 0 0 0 -6.5 0 1 0 4-4ndis.dat
  [1,16,-30,19,-20,6.5,0,0,0,0,-6.5,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 14 30 19 -20 6.5 0 0 0 0 -6.5 0 1 0 4-4disc.dat
  [1,14,30,19,-20,6.5,0,0,0,0,-6.5,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 30 19 -20 6.5 0 0 0 0 -6.5 0 1 0 4-4ndis.dat
  [1,16,30,19,-20,6.5,0,0,0,0,-6.5,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 14 -18 9 -20 0 0 -3 -3 0 0 0 1 0 2-4chrd.dat
  [1,14,-18,9,-20,0,0,-3,-3,0,0,0,1,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 -18 9 -20 0 0 -3 -3 0 0 0 1 0 2-4ndis.dat
  [1,16,-18,9,-20,0,0,-3,-3,0,0,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 14 -18 19 -20 0 0 -3 -3 0 0 0 1 0 2-4chrd.dat
  [1,14,-18,19,-20,0,0,-3,-3,0,0,0,1,0, ldraw_lib__2_4chrd(realsolid)],
// 1 14 -18 29 -20 0 0 -3 -3 0 0 0 1 0 2-4chrd.dat
  [1,14,-18,29,-20,0,0,-3,-3,0,0,0,1,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 -18 19 -20 0 0 -3 -3 0 0 0 1 0 2-4ndis.dat
  [1,16,-18,19,-20,0,0,-3,-3,0,0,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -18 29 -20 0 0 -3 -3 0 0 0 1 0 2-4ndis.dat
  [1,16,-18,29,-20,0,0,-3,-3,0,0,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 14 18 9 -20 0 0 3 3 0 0 0 1 0 2-4chrd.dat
  [1,14,18,9,-20,0,0,3,3,0,0,0,1,0, ldraw_lib__2_4chrd(realsolid)],
// 1 14 18 19 -20 0 0 3 3 0 0 0 1 0 2-4chrd.dat
  [1,14,18,19,-20,0,0,3,3,0,0,0,1,0, ldraw_lib__2_4chrd(realsolid)],
...
module ldraw_lib__4744p06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4744p06(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
