...
// 1 16 26 8 0 4 0 0 0 -4 0 0 0 2.5 box5.dat
  [1,16,26,8,0,4,0,0,0,-4,0,0,0,2.5, ldraw_lib__box5()],
// 
// 1 16 26 8 4.25 0 0 4 0 -1 0 1.75 0 0 rect1.dat
  [1,16,26,8,4.25,0,0,4,0,-1,0,1.75,0,0, ldraw_lib__rect1()],
// 1 16 26 8 -4.25 0 0 -4 0 -1 0 -1.75 0 0 rect1.dat
  [1,16,26,8,-4.25,0,0,-4,0,-1,0,-1.75,0,0, ldraw_lib__rect1()],
// 1 16 22 4 6 0 0 4 4 0 0 0 4 0 2-4cyli.dat
  [1,16,22,4,6,0,0,4,4,0,0,0,4,0, ldraw_lib__2_4cyli()],
// 1 16 22 4 10 0 0 4 4 0 0 0 -1 0 2-4disc.dat
  [1,16,22,4,10,0,0,4,4,0,0,0,-1,0, ldraw_lib__2_4disc()],
// 1 16 22 4 10 0 0 4 4 0 0 0 1 0 2-4edge.dat
  [1,16,22,4,10,0,0,4,4,0,0,0,1,0, ldraw_lib__2_4edge()],
...
// 1 16 22 4 -10 0 0 4 4 0 0 0 4 0 2-4cyli.dat
  [1,16,22,4,-10,0,0,4,4,0,0,0,4,0, ldraw_lib__2_4cyli()],
// 1 16 22 4 -10 0 0 4 4 0 0 0 1 0 2-4disc.dat
  [1,16,22,4,-10,0,0,4,4,0,0,0,1,0, ldraw_lib__2_4disc()],
// 1 16 22 4 -10 0 0 4 4 0 0 0 1 0 2-4edge.dat
  [1,16,22,4,-10,0,0,4,4,0,0,0,1,0, ldraw_lib__2_4edge()],
...
// 1 16 30 4 -6 0 0 4 4 0 0 0 12 0 2-4cyli.dat
  [1,16,30,4,-6,0,0,4,4,0,0,0,12,0, ldraw_lib__2_4cyli()],
// 
...
// 1 16 26 0 0 4 0 0 0 1 0 0 0 6 rect2p.dat
  [1,16,26,0,0,4,0,0,0,1,0,0,0,6, ldraw_lib__rect2p()],
];
module ldraw_lib__u1125(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u1125(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
