...
use <../p/box5-4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__76610(realsolid=false) = [
...
// 1 16 0 2 0 7 0 0 0 0 2 0 16 0 box5-4a.dat
  [1,16,0,2,0,7,0,0,0,0,2,0,16,0, ldraw_lib__box5_4a(realsolid)],
// 1 16 0 0 0 -7 0 0 0 4 0 0 0 -7 2-4cylc.dat
  [1,16,0,0,0,-7,0,0,0,4,0,0,0,-7, ldraw_lib__2_4cylc(realsolid)],
// 1 16 0 4 0 -7 0 0 0 -1 0 0 0 -7 2-4disc.dat
  [1,16,0,4,0,-7,0,0,0,-1,0,0,0,-7, ldraw_lib__2_4disc(realsolid)],
];
module ldraw_lib__76610(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76610(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
