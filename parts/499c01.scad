...
use <u9044.scad>
$fa=1; $fs=0.2;
function ldraw_lib__499c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 499.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__499(realsolid)],
// 1 493 28.5 -6 0 0 0 1 0 1 0 1 0 0 u9044.dat
  [1,493,28.5,-6,0,0,0,1,0,1,0,1,0,0, ldraw_lib__u9044(realsolid)],
];
module ldraw_lib__499c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__499c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
