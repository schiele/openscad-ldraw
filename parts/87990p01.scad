...
use <s/87990s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87990p01(realsolid=false) = [
...
// 1 22 0 0 0 1 0 0 0 1 0 0 0 1 s\87990s01.dat
  [1,22,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87990s01(realsolid)],
...
module ldraw_lib__87990p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87990p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
