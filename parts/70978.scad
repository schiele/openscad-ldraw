...
use <u9053.scad>
$fa=1; $fs=0.2;
function ldraw_lib__70978(realsolid=false) = [
...
// 1 16 0 1 0 1 0 0 0 418 0 0 0 1 77.dat
  [1,16,0,1,0,1,0,0,0,418,0,0,0,1, ldraw_lib__77(realsolid)],
// 1 16 0 420 0 -1 0 0 0 -1 0 0 0 1 u9053.dat
  [1,16,0,420,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__u9053(realsolid)],
];
module ldraw_lib__70978(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__70978(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
