...
use <30158c.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30158(realsolid=false) = [
...
// 1 16 0 56.75 13.125 -1 0 0 0 1 0 0 0 -1 30158b.dat
  [1,16,0,56.75,13.125,-1,0,0,0,1,0,0,0,-1, ldraw_lib__30158b(realsolid)],
// 1 16 0 49.25 13.125 1 0 0 0 1 0 0 0 1 30158c.dat
  [1,16,0,49.25,13.125,1,0,0,0,1,0,0,0,1, ldraw_lib__30158c(realsolid)],
// 0
];
module ldraw_lib__30158(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30158(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
