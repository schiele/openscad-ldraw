...
use <s/973s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973p26(realsolid=false) = [
...
// 1 15 0 2 -10 1.25 0 0 0 0 1.25 0 1 0 4-4disc.dat
  [1,15,0,2,-10,1.25,0,0,0,0,1.25,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 2 -10 1.25 0 0 0 0 1.25 0 1 0 2-4ndis.dat
  [1,16,0,2,-10,1.25,0,0,0,0,1.25,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 15 0 7 -10 1.25 0 0 0 0 1.25 0 1 0 4-4disc.dat
  [1,15,0,7,-10,1.25,0,0,0,0,1.25,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 7 -10 1.25 0 0 0 0 1.25 0 1 0 4-4ndis.dat
  [1,16,0,7,-10,1.25,0,0,0,0,1.25,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 15 0 12 -10 1.25 0 0 0 0 1.25 0 1 0 4-4disc.dat
  [1,15,0,12,-10,1.25,0,0,0,0,1.25,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 12 -10 1.25 0 0 0 0 1.25 0 1 0 4-4ndis.dat
  [1,16,0,12,-10,1.25,0,0,0,0,1.25,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 15 0 17 -10 1.25 0 0 0 0 1.25 0 1 0 4-4disc.dat
  [1,15,0,17,-10,1.25,0,0,0,0,1.25,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 17 -10 1.25 0 0 0 0 1.25 0 1 0 4-4ndis.dat
  [1,16,0,17,-10,1.25,0,0,0,0,1.25,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 15 0 22 -10 1.25 0 0 0 0 1.25 0 1 0 4-4disc.dat
  [1,15,0,22,-10,1.25,0,0,0,0,1.25,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 22 -10 1.25 0 0 0 0 1.25 0 1 0 4-4ndis.dat
  [1,16,0,22,-10,1.25,0,0,0,0,1.25,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 15 0 27 -10 1.25 0 0 0 0 1.25 0 1 0 4-4disc.dat
  [1,15,0,27,-10,1.25,0,0,0,0,1.25,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 27 -10 1.25 0 0 0 0 1.25 0 1 0 4-4ndis.dat
  [1,16,0,27,-10,1.25,0,0,0,0,1.25,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 15 0 32 -10 1.25 0 0 0 0 -1.25 0 1 0 2-4disc.dat
  [1,15,0,32,-10,1.25,0,0,0,0,-1.25,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 0 32 -10 1.25 0 0 0 0 -1.25 0 1 0 2-4ndis.dat
  [1,16,0,32,-10,1.25,0,0,0,0,-1.25,0,1,0, ldraw_lib__2_4ndis(realsolid)],
...
// 1 15 7.5 14.25 -10 1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,15,7.5,14.25,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 7.5 14.25 -10 1 0 0 0 0 1 0 1 0 4-4ndis.dat
  [1,16,7.5,14.25,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 7.5 17 -10 3 0 0 0 0 3 0 1 0 2-4disc.dat
  [1,16,7.5,17,-10,3,0,0,0,0,3,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 15 7.5 17 -10 1 0 0 0 0 1 0 1 0 2-4ring3.dat
  [1,15,7.5,17,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__2_4ring3(realsolid)],
// 1 16 7.5 17 -10 4 0 0 0 0 4 0 1 0 2-4ndis.dat
  [1,16,7.5,17,-10,4,0,0,0,0,4,0,1,0, ldraw_lib__2_4ndis(realsolid)],
...
module ldraw_lib__973p26(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p26(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
