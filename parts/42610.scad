...
use <../p/4-4ring8.scad>
$fa=1; $fs=0.2;
function ldraw_lib__42610(realsolid=false) = [
...
// 1 16 0 0 10 8 0 0 0 0 8 0 -20 0 4-4cyli.dat
  [1,16,0,0,10,8,0,0,0,0,8,0,-20,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 10 8 0 0 0 0 8 0 -20 0 4-4edge.dat
  [1,16,0,0,10,8,0,0,0,0,8,0,-20,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 8 8 0 0 0 0 8 0 -20 0 4-4edge.dat
  [1,16,0,0,8,8,0,0,0,0,8,0,-20,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -10 8 0 0 0 0 8 0 -20 0 4-4edge.dat
  [1,16,0,0,-10,8,0,0,0,0,8,0,-20,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -8 8 0 0 0 0 8 0 -20 0 4-4edge.dat
  [1,16,0,0,-8,8,0,0,0,0,8,0,-20,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 8 14 0 0 0 0 14 0 -5 0 4-4edge.dat
  [1,16,0,0,8,14,0,0,0,0,14,0,-5,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 3 14 0 0 0 0 14 0 -5 0 4-4edge.dat
  [1,16,0,0,3,14,0,0,0,0,14,0,-5,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -8 -14 0 0 0 0 14 0 5 0 4-4cyli.dat
  [1,16,0,0,-8,-14,0,0,0,0,14,0,5,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 0 -8 -12 0 0 0 0 12 0 5 0 4-4edge.dat
  [1,16,0,0,-8,-12,0,0,0,0,12,0,5,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -7 -12 0 0 0 0 12 0 5 0 4-4edge.dat
  [1,16,0,0,-7,-12,0,0,0,0,12,0,5,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 8 -12 0 0 0 0 12 0 5 0 4-4edge.dat
  [1,16,0,0,8,-12,0,0,0,0,12,0,5,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 7 -12 0 0 0 0 12 0 5 0 4-4edge.dat
  [1,16,0,0,7,-12,0,0,0,0,12,0,5,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 5 -9 0 0 0 0 9 0 5 0 4-4edge.dat
  [1,16,0,0,5,-9,0,0,0,0,9,0,5,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -3 -14 0 0 0 0 14 0 5 0 4-4edge.dat
  [1,16,0,0,-3,-14,0,0,0,0,14,0,5,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -1 -10 0 0 0 0 10 0 5 0 4-4edge.dat
  [1,16,0,0,-1,-10,0,0,0,0,10,0,5,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 1 -10 0 0 0 0 10 0 5 0 4-4edge.dat
  [1,16,0,0,1,-10,0,0,0,0,10,0,5,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 -2 -2 0 0 0 0 2 0 1 0 4-4con5.dat
  [1,16,0,0,-2,-2,0,0,0,0,2,0,1,0, ldraw_lib__4_4con5(realsolid)],
// 1 16 0 0 3 2 0 0 0 0 2 0 -1 0 4-4con6.dat
  [1,16,0,0,3,2,0,0,0,0,2,0,-1,0, ldraw_lib__4_4con6(realsolid)],
// 1 16 0 0 2 2 0 0 0 0 2 0 -1 0 4-4con5.dat
  [1,16,0,0,2,2,0,0,0,0,2,0,-1,0, ldraw_lib__4_4con5(realsolid)],
// 1 16 0 0 -1 -10 0 0 0 0 10 0 2 0 4-4cyli.dat
  [1,16,0,0,-1,-10,0,0,0,0,10,0,2,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 7 -12 0 0 0 0 12 0 1 0 4-4cyli.dat
  [1,16,0,0,7,-12,0,0,0,0,12,0,1,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 7 3 0 0 0 0 3 0 -2 0 4-4con3.dat
  [1,16,0,0,7,3,0,0,0,0,3,0,-2,0, ldraw_lib__4_4con3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -7 12 0 0 0 0 12 0 -1 0 4-4cyli.dat
  [1,16,0,0,-7,12,0,0,0,0,12,0,-1,0, ldraw_lib__4_4cyli(realsolid)],
...
module ldraw_lib__42610(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__42610(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__42610(line=0.2);