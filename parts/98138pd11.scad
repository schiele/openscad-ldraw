...
use <98138p80.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98138pd11(realsolid=false) = [
// 0 ~Moved to 98138p80
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 98138p80.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__98138p80(realsolid)],
];
module ldraw_lib__98138pd11(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98138pd11(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
