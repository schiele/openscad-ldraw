...
use <92254p01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92198p01c14(realsolid=false) = [
...
// 1 378 0 0 0 1 0 0 0 1 0 0 0 1 92253p02c01.dat
  [1,378,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__92253p02c01(realsolid)],
...
// 1 226 0 -110 0.9 1 0 0 0 1 0 0 0 1 92254p01.dat
  [1,226,0,-110,0.9,1,0,0,0,1,0,0,0,1, ldraw_lib__92254p01(realsolid)],
// 1 31 0 -101.98 21.8 -0.999 0 -0.0436 0.0436 0 -0.999 0 -1 0 11618.dat
  [1,31,0,-101.98,21.8,-0.999,0,-0.0436,0.0436,0,-0.999,0,-1,0, ldraw_lib__11618(realsolid)],
];
module ldraw_lib__92198p01c14(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92198p01c14(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
