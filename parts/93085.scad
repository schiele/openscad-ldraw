...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 93083.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__93083()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 93084.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__93084()],
];
module ldraw_lib__93085(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__93085(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
