...
use <../p/stud2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__59275a(realsolid=false) = [
...
// 1 16 0 0 0 0 0 1 0 2 0 -1 0 0 s\10190s01.dat
  [1,16,0,0,0,0,0,1,0,2,0,-1,0,0, ldraw_lib__s__10190s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 2 0 -1 0 0 s\10190s01.dat
  [1,16,0,0,0,0,0,-1,0,2,0,-1,0,0, ldraw_lib__s__10190s01(realsolid)],
// 
// 1 16 7e-15 0 -37.5 -1.25 -4e-15 0 0 0 -1.8 0 22.5 0 2-4cyli.dat
  [1,16,7e-15,0,-37.5,-1.25,-4e-15,0,0,0,-1.8,0,22.5,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 7e-15 0 -37.5 -1.25 0 0 0 0 -1.8 0 -1.25 0 2-8sphe.dat
  [1,16,7e-15,0,-37.5,-1.25,0,0,0,0,-1.8,0,-1.25,0, ldraw_lib__2_8sphe(realsolid)],
// 1 16 3e-15 0 -15 -1.25 0 0 0 0 -1.8 0 1.25 0 2-8sphe.dat
  [1,16,3e-15,0,-15,-1.25,0,0,0,0,-1.8,0,1.25,0, ldraw_lib__2_8sphe(realsolid)],
// 1 16 -11.28386 0 -32.90008 -1.24398 2.03386 0 0 0 -1.8 0.12252 20.65008 0 2-4cyli.dat
  [1,16,-11.28386,0,-32.90008,-1.24398,2.03386,0,0,0,-1.8,0.12252,20.65008,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -11.28386 0 -32.90008 -1.24398 -0.12252 0 0 0 -1.8 0.12252 -1.24398 0 2-8sphe.dat
  [1,16,-11.28386,0,-32.90008,-1.24398,-0.12252,0,0,0,-1.8,0.12252,-1.24398,0, ldraw_lib__2_8sphe(realsolid)],
// 1 16 -9.25 0 -12.25 -1.24398 0.12252 0 0 0 -1.8 0.12252 1.24398 0 2-8sphe.dat
  [1,16,-9.25,0,-12.25,-1.24398,0.12252,0,0,0,-1.8,0.12252,1.24398,0, ldraw_lib__2_8sphe(realsolid)],
// 1 16 11.28386 0 -32.90008 1.24398 -2.03386 0 0 0 -1.8 0.12252 20.65008 0 2-4cyli.dat
  [1,16,11.28386,0,-32.90008,1.24398,-2.03386,0,0,0,-1.8,0.12252,20.65008,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 11.28386 0 -32.90008 1.24398 0.12252 0 0 0 -1.8 0.12252 -1.24398 0 2-8sphe.dat
  [1,16,11.28386,0,-32.90008,1.24398,0.12252,0,0,0,-1.8,0.12252,-1.24398,0, ldraw_lib__2_8sphe(realsolid)],
...
module ldraw_lib__59275a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__59275a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
