...
use <../p/stud3a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30362(realsolid=false) = [
...
// 1 16 0 46 4 0 0 16 2 0 0 0 12 0 box3u5p.dat
  [1,16,0,46,4,0,0,16,2,0,0,0,12,0, ldraw_lib__box3u5p(realsolid)],
// 1 16 0 48 10 0 0 16 0 1 0 6 0 0 recte4.dat
  [1,16,0,48,10,0,0,16,0,1,0,6,0,0, ldraw_lib__recte4(realsolid)],
...
// 1 16 0 44 9.5 13 0 0 0 1 0 0 0 5.5 recte3.dat
  [1,16,0,44,9.5,13,0,0,0,1,0,0,0,5.5, ldraw_lib__recte3(realsolid)],
// 2 24 13 44 4 16 44 4
  [2,24,13,44,4,16,44,4],
// 2 24 -13 44 4 -16 44 4
  [2,24,-13,44,4,-16,44,4],
// 1 16 0 32 7 6 0 0 0 -1 0 0 0 -3 rect.dat
  [1,16,0,32,7,6,0,0,0,-1,0,0,0,-3, ldraw_lib__rect(realsolid)],
...
// 1 16 0 32 10 4 0 0 0 1 0 0 0 -4 2-4edge.dat
  [1,16,0,32,10,4,0,0,0,1,0,0,0,-4, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 41.5998 10 0 0 -4 0 -9.59981 0 4 0 0 1-4cyls.dat
  [1,16,0,41.5998,10,0,0,-4,0,-9.59981,0,4,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 0 41.5998 10 0 0 4 0 -9.59981 0 4 0 0 1-4cyls.dat
  [1,16,0,41.5998,10,0,0,4,0,-9.59981,0,4,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 0 32 10 4 0 0 0 9.59981 0 0 0 -4 2-4cyli.dat
  [1,16,0,32,10,4,0,0,0,9.59981,0,0,0,-4, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 41.5998 10 1 0 0 0 -1.6 0 0 0 1 stud3a.dat
  [1,16,0,41.5998,10,1,0,0,0,-1.6,0,0,0,1, ldraw_lib__stud3a(realsolid)],
// 1 16 0 32 10 4 0 0 0 1 9.59981 0 0 4 2-4edge.dat
  [1,16,0,32,10,4,0,0,0,1,9.59981,0,0,4, ldraw_lib__2_4edge(realsolid)],
// 
...
// 1 16 0 46 0 0 0 20 2 0 0 0 20 0 box3u2p.dat
  [1,16,0,46,0,0,0,20,2,0,0,0,20,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 0 46 0 0 0 20 2 0 0 0 1 0 rect1.dat
  [1,16,0,46,0,0,0,20,2,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
// 
...
// 1 16 0 33 7 0 0 10 0 1 0 7 0 0 recte4.dat
  [1,16,0,33,7,0,0,10,0,1,0,7,0,0, ldraw_lib__recte4(realsolid)],
// 1 16 0 28 5.5 0 0 7 0 1 0 4.5 0 0 recte4.dat
  [1,16,0,28,5.5,0,0,7,0,1,0,4.5,0,0, ldraw_lib__recte4(realsolid)],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 19 10 3 0 0 0 0 9 0 -1 0 box5-2p.dat
  [1,16,0,19,10,3,0,0,0,0,9,0,-1,0, ldraw_lib__box5_2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 19 1 3 0 0 0 0 -9 0 4 0 box5-2p.dat
  [1,16,0,19,1,3,0,0,0,0,-9,0,4,0, ldraw_lib__box5_2p(realsolid)],
// 1 16 -3 19 5.5 0 -4 0 9 0 0 0 0 4.5 box3u8p.dat
  [1,16,-3,19,5.5,0,-4,0,9,0,0,0,0,4.5, ldraw_lib__box3u8p(realsolid)],
// 1 16 3 19 5.5 0 4 0 9 0 0 0 0 -4.5 box3u8p.dat
  [1,16,3,19,5.5,0,4,0,9,0,0,0,0,-4.5, ldraw_lib__box3u8p(realsolid)],
// 
...
// 1 16 0 0 2 6 0 0 0 0 -6 0 8 0 4-4cylc.dat
  [1,16,0,0,2,6,0,0,0,0,-6,0,8,0, ldraw_lib__4_4cylc(realsolid)],
// 1 16 0 0 10 2 0 0 0 0 -2 0 -1 0 2-4ring3.dat
  [1,16,0,0,10,2,0,0,0,0,-2,0,-1,0, ldraw_lib__2_4ring3(realsolid)],
...
// 1 16 0 0 10 6 0 0 0 0 6 0 -1 0 2-4ndis.dat
  [1,16,0,0,10,6,0,0,0,0,6,0,-1,0, ldraw_lib__2_4ndis(realsolid)],
// 
...
module ldraw_lib__30362(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30362(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
