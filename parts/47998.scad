...
// 1 16 0 4 -40 -40 0 0 0 0 -4 0 80 0 box4-2p.dat
  [1,16,0,4,-40,-40,0,0,0,0,-4,0,80,0, ldraw_lib__box4_2p()],
// 
...
// 1 16 -30 0 -50 1 0 0 0 1 0 0 0 1 clip3.dat
  [1,16,-30,0,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__clip3()],
// 1 16 30 0 -50 1 0 0 0 1 0 0 0 1 clip3.dat
  [1,16,30,0,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__clip3()],
// 
...
module ldraw_lib__47998(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__47998(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
