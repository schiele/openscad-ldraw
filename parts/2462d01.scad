...
use <821430c.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2462d01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2462.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2462(realsolid)],
// 1 16 10 10 -10 .70711 -.70711 0 0 0 -1 .70711 .70711 0 821430c.dat
  [1,16,10,10,-10,.70711,-.70711,0,0,0,-1,.70711,.70711,0, ldraw_lib__821430c(realsolid)],
];
module ldraw_lib__2462d01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2462d01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
