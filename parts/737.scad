...
$fa=1; $fs=0.2;
function ldraw_lib__737(realsolid=false) = [
...
// 1 16 -30 4 -20 0 0 10 4 0 0 0 1 0 rect3.dat
  [1,16,-30,4,-20,0,0,10,4,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 30 4 -20 0 0 -10 4 0 0 0 1 0 rect3.dat
  [1,16,30,4,-20,0,0,-10,4,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 6 -20 0 0 -16 2 0 0 0 1 0 rect.dat
  [1,16,0,6,-20,0,0,-16,2,0,0,0,1,0, ldraw_lib__rect(realsolid)],
// 
...
// 1 16 0 0 -20 20 0 0 0 8 0 0 0 -20 2-4cylo.dat
  [1,16,0,0,-20,20,0,0,0,8,0,0,0,-20, ldraw_lib__2_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 -20 16 0 0 0 4 0 0 0 -16 1-8cylo.dat
  [1,16,0,4,-20,16,0,0,0,4,0,0,0,-16, ldraw_lib__1_8cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 -20 -16 0 0 0 4 0 0 0 -16 1-8cylo.dat
  [1,16,0,4,-20,-16,0,0,0,4,0,0,0,-16, ldraw_lib__1_8cylo(realsolid)],
...
// 1 16 9.6568 6 -30.656795 0 0 -1.6568 2 0 0 0 -1.764055 -1.107255 box2-7.dat
  [1,16,9.6568,6,-30.656795,0,0,-1.6568,2,0,0,0,-1.764055,-1.107255, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -9.6568 6 -30.656795 0 0 1.6568 2 0 0 0 -1.764055 -1.107255 box2-7.dat
  [1,16,-9.6568,6,-30.656795,0,0,1.6568,2,0,0,0,-1.764055,-1.107255, ldraw_lib__box2_7(realsolid)],
...
// 1 16 0 0 -30 6 0 0 0 8 0 0 0 6 4-4cylo.dat
  [1,16,0,0,-30,6,0,0,0,8,0,0,0,6, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 4 -30 8 0 0 0 4 0 0 0 8 2-4cylo.dat
  [1,16,0,4,-30,8,0,0,0,4,0,0,0,8, ldraw_lib__2_4cylo(realsolid)],
// 
...
// 1 16 0 0 -20 -20 0 0 0 1 0 0 0 -20 1-8chrd.dat
  [1,16,0,0,-20,-20,0,0,0,1,0,0,0,-20, ldraw_lib__1_8chrd(realsolid)],
// 1 16 0 0 -20 0 0 -20 0 1 0 -20 0 0 1-8chrd.dat
  [1,16,0,0,-20,0,0,-20,0,1,0,-20,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 16 0 0 -20 0 0 20 0 1 0 -20 0 0 1-8chrd.dat
  [1,16,0,0,-20,0,0,20,0,1,0,-20,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 16 0 0 -20 20 0 0 0 1 0 0 0 -20 1-8chrd.dat
  [1,16,0,0,-20,20,0,0,0,1,0,0,0,-20, ldraw_lib__1_8chrd(realsolid)],
...
// 1 16 0 8 -30 6 0 0 0 -1 0 0 0 -6 2-4ndis.dat
  [1,16,0,8,-30,6,0,0,0,-1,0,0,0,-6, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 8 -30 2 0 0 0 -1 0 0 0 2 2-4ring3.dat
  [1,16,0,8,-30,2,0,0,0,-1,0,0,0,2, ldraw_lib__2_4ring3(realsolid)],
// 1 16 0 8 -20 4 0 0 0 -1 0 0 0 -4 1-8ring4.dat
  [1,16,0,8,-20,4,0,0,0,-1,0,0,0,-4, ldraw_lib__1_8ring4(realsolid)],
// 1 16 0 8 -20 -4 0 0 0 -1 0 0 0 -4 1-8ring4.dat
  [1,16,0,8,-20,-4,0,0,0,-1,0,0,0,-4, ldraw_lib__1_8ring4(realsolid)],
// 1 16 0 8 -20 0 0 20 0 -1 0 -20 0 0 1-8chrd.dat
  [1,16,0,8,-20,0,0,20,0,-1,0,-20,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 16 0 8 -20 0 0 -20 0 -1 0 -20 0 0 1-8chrd.dat
  [1,16,0,8,-20,0,0,-20,0,-1,0,-20,0,0, ldraw_lib__1_8chrd(realsolid)],
...
// 1 16 0 4 -30 8 0 0 0 -1 0 0 0 8 2-4ndis.dat
  [1,16,0,4,-30,8,0,0,0,-1,0,0,0,8, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 4 -20 16 0 0 0 -1 0 0 0 -16 1-8chrd.dat
  [1,16,0,4,-20,16,0,0,0,-1,0,0,0,-16, ldraw_lib__1_8chrd(realsolid)],
// 1 16 0 4 -20 -16 0 0 0 -1 0 0 0 -16 1-8chrd.dat
  [1,16,0,4,-20,-16,0,0,0,-1,0,0,0,-16, ldraw_lib__1_8chrd(realsolid)],
...
module ldraw_lib__737(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__737(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
