...
// 0 Windscreen  2 x  6 x  2 with Integral Trans Brown Glass
// 0 Name: 6567c02.dat
...
// 0 !HISTORY 2025-03-30 [MagFors] Update description
...
// 1 40 0 0 0 1 0 0 0 1 0 0 0 1 s\6567s01.dat
  [1,40,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6567s01()],
];
module ldraw_lib__6567c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6567c02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
