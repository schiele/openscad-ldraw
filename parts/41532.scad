...
use <s/483s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__41532(realsolid=false) = [
...
// 1 16 0 0 -10 -9 0 0 0 0 9 0 1 0 4-4disc.dat
  [1,16,0,0,-10,-9,0,0,0,0,9,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 10 1 0 0 0 0 1 0 -1 0 confric.dat
  [1,16,0,0,10,1,0,0,0,0,1,0,-1,0, ldraw_lib__confric(realsolid)],
...
// 1 16 0 0 -1.425 9 0 0 0 0 9 0 -1 0 4-4disc.dat
  [1,16,0,0,-1.425,9,0,0,0,0,9,0,-1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 1.425 9 0 0 0 0 9 0 1 0 4-4disc.dat
  [1,16,0,0,1.425,9,0,0,0,0,9,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 -4.275 9 0 0 0 0 9 0 1 0 4-4disc.dat
  [1,16,0,0,-4.275,9,0,0,0,0,9,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 4.275 9 0 0 0 0 9 0 -1 0 4-4disc.dat
  [1,16,0,0,4.275,9,0,0,0,0,9,0,-1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 -7.125 9 0 0 0 0 9 0 -1 0 4-4disc.dat
  [1,16,0,0,-7.125,9,0,0,0,0,9,0,-1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 7.125 9 0 0 0 0 9 0 1 0 4-4disc.dat
  [1,16,0,0,7.125,9,0,0,0,0,9,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 0
// 1 16 0 0 -1.425 9 0 0 0 0 9 0 -2.850 0 4-4cyli.dat
  [1,16,0,0,-1.425,9,0,0,0,0,9,0,-2.850,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 1.425 9 0 0 0 0 9 0 2.850 0 4-4cyli.dat
  [1,16,0,0,1.425,9,0,0,0,0,9,0,2.850,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\483s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__483s01(realsolid)],
// 0
// 1 16 0 0 -5.7 1 0 0 0 1 0 0 0 1 s\483s01.dat
  [1,16,0,0,-5.7,1,0,0,0,1,0,0,0,1, ldraw_lib__s__483s01(realsolid)],
// 1 16 0 0 5.7 1 0 0 0 1 0 0 0 1 s\483s01.dat
  [1,16,0,0,5.7,1,0,0,0,1,0,0,0,1, ldraw_lib__s__483s01(realsolid)],
// 0
// 0 end of file
...
module ldraw_lib__41532(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__41532(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
