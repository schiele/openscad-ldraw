...
use <3820.scad>
use <973p8i.scad>
function ldraw_lib__76382p0048() = [
// 0 Minifig Torso with Arms and Light Bluish Grey Hands with Construction Safety Vest with Reflective Stripes Pattern
// 0 Name: 76382p0048.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 973pb1561c02, BrickOwl 918207, Brickset 76382
// 0 !KEYWORDS Mini Upper Part No 2726, Rebrickable 973c28h14pr2726, Robo Emmet
// 0 !KEYWORDS Set 70816, The LEGO Movie
// 
...
module ldraw_lib__76382p0048(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382p0048(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382p0048(line=0.2);