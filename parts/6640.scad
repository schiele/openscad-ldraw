...
use <6640b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6640(realsolid=false) = [
// 0 ~Moved to 6640b
// 0 Name: 6640.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6640b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6640b(realsolid)],
];
module ldraw_lib__6640(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6640(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
