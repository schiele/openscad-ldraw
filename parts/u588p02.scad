...
use <s/u588s05.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u588p02(realsolid=false) = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\u588s03.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u588s03(realsolid)],
// 1 15 0 0 0 -1 0 0 0 1 0 0 0 1 s\u588s03.dat
  [1,15,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u588s03(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u588s05.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u588s05(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u588s05.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u588s05(realsolid)],
...
module ldraw_lib__u588p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u588p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
