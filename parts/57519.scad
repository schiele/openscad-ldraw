...
use <s/57519s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__57519(realsolid=false) = [
...
// 1 16 0 0 -10 10 0 0 0 0 10 0 2 0 4-4cyli.dat
  [1,16,0,0,-10,10,0,0,0,0,10,0,2,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -4.4 10 0 0 0 0 10 0 14.4 0 4-4cyli.dat
  [1,16,0,0,-4.4,10,0,0,0,0,10,0,14.4,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 0 -4.4 10 0 0 0 0 10 0 1 0 4-4edge.dat
  [1,16,0,0,-4.4,10,0,0,0,0,10,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 10 10 0 0 0 0 10 0 1 0 4-4edge.dat
  [1,16,0,0,10,10,0,0,0,0,10,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\57519s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__57519s02(realsolid)],
// 1 16 0 0 0 0.5 -0.866 0 0.866 0.5 0 0 0 1 s\57519s02.dat
  [1,16,0,0,0,0.5,-0.866,0,0.866,0.5,0,0,0,1, ldraw_lib__s__57519s02(realsolid)],
// 1 16 0 0 0 -0.5 -0.866 0 0.866 -0.5 0 0 0 1 s\57519s02.dat
  [1,16,0,0,0,-0.5,-0.866,0,0.866,-0.5,0,0,0,1, ldraw_lib__s__57519s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 -1 0 0 0 1 s\57519s02.dat
  [1,16,0,0,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__s__57519s02(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\57519s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__57519s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\57519s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__57519s01(realsolid)],
// 1 16 0 0 0 0.809 -0.588 0 0.588 0.809 0 0 0 1 s\57519s01.dat
  [1,16,0,0,0,0.809,-0.588,0,0.588,0.809,0,0,0,1, ldraw_lib__s__57519s01(realsolid)],
// 1 16 0 0 0 -0.809 -0.588 0 -0.588 0.809 0 0 0 1 s\57519s01.dat
  [1,16,0,0,0,-0.809,-0.588,0,-0.588,0.809,0,0,0,1, ldraw_lib__s__57519s01(realsolid)],
// 1 16 0 0 0 0.309 -0.951 0 0.951 0.309 0 0 0 1 s\57519s01.dat
  [1,16,0,0,0,0.309,-0.951,0,0.951,0.309,0,0,0,1, ldraw_lib__s__57519s01(realsolid)],
// 1 16 0 0 0 -0.309 -0.951 0 -0.951 0.309 0 0 0 1 s\57519s01.dat
  [1,16,0,0,0,-0.309,-0.951,0,-0.951,0.309,0,0,0,1, ldraw_lib__s__57519s01(realsolid)],
// 1 16 0 0 0 -0.309 -0.951 0 0.951 -0.309 0 0 0 1 s\57519s01.dat
  [1,16,0,0,0,-0.309,-0.951,0,0.951,-0.309,0,0,0,1, ldraw_lib__s__57519s01(realsolid)],
...
module ldraw_lib__57519(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__57519(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
