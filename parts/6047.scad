...
use <../p/connect.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6047(realsolid=false) = [
...
// 1 16 0 0 -2 1 0 0 0 0 1 0 1 0 connect.dat
  [1,16,0,0,-2,1,0,0,0,0,1,0,1,0, ldraw_lib__connect(realsolid)],
...
module ldraw_lib__6047(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6047(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
