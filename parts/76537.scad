...
// 1 494 0 56 0 1 0 0 0 1 0 0 0 1 22977.dat
  [1,494,0,56,0,1,0,0,0,1,0,0,0,1, ldraw_lib__22977()],
// 0 //
];
module ldraw_lib__76537(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76537(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
