...
use <s/53984s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__53984(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\53984s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__53984s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\53984s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__53984s01(realsolid)],
// 0 //
];
module ldraw_lib__53984(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__53984(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
