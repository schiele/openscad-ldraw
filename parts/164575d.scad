...
use <s/4865p01c.scad>
$fa=1; $fs=0.2;
function ldraw_lib__164575d(realsolid=false) = [
...
// 1 15 0 -0.25 0 1.7 0 0 0 0 1 0 1.7 0 s\4865p01c.dat
  [1,15,0,-0.25,0,1.7,0,0,0,0,1,0,1.7,0, ldraw_lib__s__4865p01c(realsolid)],
// 
...
module ldraw_lib__164575d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__164575d(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
