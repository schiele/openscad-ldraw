...
use <s/93084s07.scad>
$fa=1; $fs=0.2;
function ldraw_lib__93084p01(realsolid=false) = [
...
// 1 19 0 0 0 1 0 0 0 1 0 0 0 1 s\93084s01.dat
  [1,19,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__93084s01(realsolid)],
...
module ldraw_lib__93084p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__93084p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
