...
use <3010p20c.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3010p20w(realsolid=false) = [
// 0 ~Moved to 3010p20c
// 0 Name: 3010p20w.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3010p20c.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3010p20c(realsolid)],
];
module ldraw_lib__3010p20w(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3010p20w(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
