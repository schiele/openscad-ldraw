...
// 1 16 0 0 8 0 0 10 10 0 0 0 1 0 4-4edge.dat
  [1,16,0,0,8,0,0,10,10,0,0,0,1,0, ldraw_lib__4_4edge()],
...
// 1 16 0 0 3 0 0 6 6 0 0 0 1 0 4-4edge.dat
  [1,16,0,0,3,0,0,6,6,0,0,0,1,0, ldraw_lib__4_4edge()],
// 1 16 0 0 -3 0 0 6 6 0 0 0 1 0 4-4edge.dat
  [1,16,0,0,-3,0,0,6,6,0,0,0,1,0, ldraw_lib__4_4edge()],
// 1 16 0 0 -5 0 0 10 10 0 0 0 1 0 4-4edge.dat
  [1,16,0,0,-5,0,0,10,10,0,0,0,1,0, ldraw_lib__4_4edge()],
...
// 1 16 0 0 8 0 0 4 4 0 0 0 -1 0 4-4ring1.dat
  [1,16,0,0,8,0,0,4,4,0,0,0,-1,0, ldraw_lib__4_4ring1()],
// 1 16 0 0 8 0 0 2 2 0 0 0 -1 0 4-4ring4.dat
  [1,16,0,0,8,0,0,2,2,0,0,0,-1,0, ldraw_lib__4_4ring4()],
// 1 16 0 0 -8 0 0 2 2 0 0 0 -1 0 4-4disc.dat
  [1,16,0,0,-8,0,0,2,2,0,0,0,-1,0, ldraw_lib__4_4disc()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 8 0 0 2 2 0 0 0 -16 0 4-4cyli.dat
  [1,16,0,0,8,0,0,2,2,0,0,0,-16,0, ldraw_lib__4_4cyli()],
// 1 16 0 0 5 0 0 10 10 0 0 0 3 0 4-4cyli.dat
  [1,16,0,0,5,0,0,10,10,0,0,0,3,0, ldraw_lib__4_4cyli()],
// 1 16 0 0 5 2 0 0 0 0 2 0 -1 0 4-4con4.dat
  [1,16,0,0,5,2,0,0,0,0,2,0,-1,0, ldraw_lib__4_4con4()],
// 1 16 0 0 4 2 0 0 0 0 2 0 -1 0 4-4con3.dat
  [1,16,0,0,4,2,0,0,0,0,2,0,-1,0, ldraw_lib__4_4con3()],
// 1 16 0 0 -3 0 0 6 6 0 0 0 6 0 4-4cyli.dat
  [1,16,0,0,-3,0,0,6,6,0,0,0,6,0, ldraw_lib__4_4cyli()],
// 1 16 0 0 -5 2 0 0 0 0 2 0 1 0 4-4con4.dat
  [1,16,0,0,-5,2,0,0,0,0,2,0,1,0, ldraw_lib__4_4con4()],
// 1 16 0 0 -4 2 0 0 0 0 2 0 1 0 4-4con3.dat
  [1,16,0,0,-4,2,0,0,0,0,2,0,1,0, ldraw_lib__4_4con3()],
// 1 16 0 0 -8 0 0 10 10 0 0 0 3 0 4-4cyli.dat
  [1,16,0,0,-8,0,0,10,10,0,0,0,3,0, ldraw_lib__4_4cyli()],
...
// 1 16 0 0 -8 1 0 0 0 0 -1 0 1 0 stud.dat
  [1,16,0,0,-8,1,0,0,0,0,-1,0,1,0, ldraw_lib__stud()],
];
module ldraw_lib__450(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__450(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
