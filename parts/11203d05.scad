...
// 1 16 0 8 0 -1 0 0 0 -1 0 0 0 1 6279911b.dat
  [1,16,0,8,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__6279911b()],
];
module ldraw_lib__11203d05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11203d05(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__11203d05(line=0.2);