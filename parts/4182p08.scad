...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 4182px1, Rebrickable 4182pr0008, set 4551
// 
...
module ldraw_lib__4182p08(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4182p08(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
