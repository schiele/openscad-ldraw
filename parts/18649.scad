...
use <../p/stug-1x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__18649(realsolid=false) = [
...
// 1 16 -30 2 4 0 0 -4 4 0 0 0 -8 0 4-4cylo.dat
  [1,16,-30,2,4,0,0,-4,4,0,0,0,-8,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 30 2 4 0 0 -4 4 0 0 0 -8 0 4-4cylo.dat
  [1,16,30,2,4,0,0,-4,4,0,0,0,-8,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 8 0 0 0 20 0 -8 0 -4 0 0 box3u4p.dat
  [1,16,0,8,0,0,0,20,0,-8,0,-4,0,0, ldraw_lib__box3u4p(realsolid)],
...
// 1 16 -30 0 7 0 0 1 0 1 0 -1 0 0 phandle1.dat
  [1,16,-30,0,7,0,0,1,0,1,0,-1,0,0, ldraw_lib__phandle1(realsolid)],
// 1 16 -30 0 -7 0 0 1 0 1 0 1 0 0 phandle1.dat
  [1,16,-30,0,-7,0,0,1,0,1,0,1,0,0, ldraw_lib__phandle1(realsolid)],
// 1 16 30 0 -7 0 0 -1 0 1 0 1 0 0 phandle1.dat
  [1,16,30,0,-7,0,0,-1,0,1,0,1,0,0, ldraw_lib__phandle1(realsolid)],
...
module ldraw_lib__18649(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__18649(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
