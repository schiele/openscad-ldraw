...
use <../p/stug4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__803(realsolid=false) = [
// 0 Car Base  4 x 12 with Hole and Steering Gear Slot
// 0 Name: 803.dat
...
// 1 16 30 4 20 2 0 0 0 4 0 0 0 1 box5.dat
  [1,16,30,4,20,2,0,0,0,4,0,0,0,1, ldraw_lib__box5(realsolid)],
// 1 16 20 4 20 6 0 0 0 4 0 0 0 1 box5.dat
  [1,16,20,4,20,6,0,0,0,4,0,0,0,1, ldraw_lib__box5(realsolid)],
...
// 1 16 8 4 20 4 0 0 0 4 0 0 0 1 box5.dat
  [1,16,8,4,20,4,0,0,0,4,0,0,0,1, ldraw_lib__box5(realsolid)],
// 1 16 0 4 12 1 0 0 0 4 0 0 0 4 box5.dat
  [1,16,0,4,12,1,0,0,0,4,0,0,0,4, ldraw_lib__box5(realsolid)],
...
// 1 16 -93 4 0 23 0 0 0 -4 0 0 0 -1.5 box4.dat
  [1,16,-93,4,0,23,0,0,0,-4,0,0,0,-1.5, ldraw_lib__box4(realsolid)],
// 1 16 0 4 -12 1 0 0 0 4 0 0 0 4 box5.dat
  [1,16,0,4,-12,1,0,0,0,4,0,0,0,4, ldraw_lib__box5(realsolid)],
// 1 16 -20 4 -12 1 0 0 0 4 0 0 0 4 box5.dat
  [1,16,-20,4,-12,1,0,0,0,4,0,0,0,4, ldraw_lib__box5(realsolid)],
...
// 1 16 8 4 -20 4 0 0 0 4 0 0 0 1 box5.dat
  [1,16,8,4,-20,4,0,0,0,4,0,0,0,1, ldraw_lib__box5(realsolid)],
// 4 16 120 8 40 116 8 36 4 8 36 0 8 40
  [4,16,120,8,40,116,8,36,4,8,36,0,8,40],
...
// 4 16 0 8 -20 4 8 -16 4 8 -36 0 8 -40
  [4,16,0,8,-20,4,8,-16,4,8,-36,0,8,-40],
// 4 16 0 8 -40 4 8 -36 116 8 -36 120 8 -40
  [4,16,0,8,-40,4,8,-36,116,8,-36,120,8,-40],
...
// 1 16 40 0 0 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,40,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4(realsolid)],
...
// 1 16 60 8 0 0 0 60 0 -8 0 40 0 0 box4-4a.dat
  [1,16,60,8,0,0,0,60,0,-8,0,40,0,0, ldraw_lib__box4_4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 60 8 0 0 0 56 0 -4 0 36 0 0 box4-4a.dat
  [1,16,60,8,0,0,0,56,0,-4,0,36,0,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 0 4 0 0 -120 0 -4 0 0 0 0 -20 box3u2p.dat
  [1,16,0,4,0,0,-120,0,-4,0,0,0,0,-20, ldraw_lib__box3u2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 4 6 0 0 -120 0 -2 0 0 0 0 -16 box3u2p.dat
  [1,16,4,6,0,0,-120,0,-2,0,0,0,0,-16, ldraw_lib__box3u2p(realsolid)],
// 1 16 0 4 30 0 1 0 4 0 0 0 0 10 rect3.dat
  [1,16,0,4,30,0,1,0,4,0,0,0,0,10, ldraw_lib__rect3(realsolid)],
// 1 16 0 4 -30 0 1 0 -4 0 0 0 0 -10 rect3.dat
  [1,16,0,4,-30,0,1,0,-4,0,0,0,0,-10, ldraw_lib__rect3(realsolid)],
// 1 16 4 6 -26 0 -1 0 -2 0 0 0 0 -10 rect3.dat
  [1,16,4,6,-26,0,-1,0,-2,0,0,0,0,-10, ldraw_lib__rect3(realsolid)],
// 1 16 4 6 26 0 -1 0 2 0 0 0 0 10 rect3.dat
  [1,16,4,6,26,0,-1,0,2,0,0,0,0,10, ldraw_lib__rect3(realsolid)],
// 0
];
module ldraw_lib__803(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__803(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__803(line=0.2);