...
use <../p/stud2s2e.scad>
$fa=1; $fs=0.2;
function ldraw_lib__24201(realsolid=false) = [
...
// 1 16 -10 -25.028 30 0 1 0 28.9719 0 28.9719 -40 0 40 48\1-8chrd.dat
  [1,16,-10,-25.028,30,0,1,0,28.9719,0,28.9719,-40,0,40, ldraw_lib__48__1_8chrd(realsolid)],
// 1 16 -10 -25.028 30 0 20 0 28.9719 0 28.9719 -40 0 40 48\1-8cylo.dat
  [1,16,-10,-25.028,30,0,20,0,28.9719,0,28.9719,-40,0,40, ldraw_lib__48__1_8cylo(realsolid)],
// 1 16 10 -25.028 30 0 -1 0 40.97 0 0 0 0 -56.57 48\1-8chrd.dat
  [1,16,10,-25.028,30,0,-1,0,40.97,0,0,0,0,-56.57, ldraw_lib__48__1_8chrd(realsolid)],
...
// 1 16 0 1.97195 -10 0 0 10 1.97195 0 0 0 1 0 rect.dat
  [1,16,0,1.97195,-10,0,0,10,1.97195,0,0,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 11.9715 30 0 0 10 -3.97205 0 0 0 -1 0 rect.dat
  [1,16,0,11.9715,30,0,0,10,-3.97205,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 4 16 7 10 10 7 8 10 7 8 27 7 13 27
  [4,16,7,10,10,7,8,10,7,8,27,7,13,27],
// 1 16 0 10.5 27 7 0 0 0 0 -2.5 0 1 0 rect.dat
  [1,16,0,10.5,27,7,0,0,0,0,-2.5,0,1,0, ldraw_lib__rect(realsolid)],
...
// 1 16 0 4.5 7 -7 0 0 0 0 4.5 0 1 0 rect.dat
  [1,16,0,4.5,7,-7,0,0,0,0,4.5,0,1,0, ldraw_lib__rect(realsolid)],
// 4 16 -7 3 -7 -7 9 7 -7 0 7 -7 0 -7
  [4,16,-7,3,-7,-7,9,7,-7,0,7,-7,0,-7],
// 4 16 7 0 7 7 9 7 7 3 -7 7 0 -7
  [4,16,7,0,7,7,9,7,7,3,-7,7,0,-7],
// 1 16 0 1.5 -7 0 0 -7 1.5 0 0 0 -1 0 rect.dat
  [1,16,0,1.5,-7,0,0,-7,1.5,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
...
// 1 16 0 8 20 1 0 0 0 1 0 0 0 1 stud2a.dat
  [1,16,0,8,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2a(realsolid)],
// 1 16 0 6 0 0 0 -7 3 1 0 7 0 0 rect2p.dat
  [1,16,0,6,0,0,0,-7,3,1,0,7,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 11.5 18.5 -7 0 0 0 1 -1.5 0 0 -8.5 rect3.dat
  [1,16,0,11.5,18.5,-7,0,0,0,1,-1.5,0,0,-8.5, ldraw_lib__rect3(realsolid)],
// 1 16 0 3.4286 0 0 0 1 0 2.57143 0 -1 0 0 stud2s2.dat
  [1,16,0,3.4286,0,0,0,1,0,2.57143,0,-1,0,0, ldraw_lib__stud2s2(realsolid)],
// 1 16 0 10.7059 20 0 0 1 0 1.05882 0 -1 0 0 stud2s2.dat
  [1,16,0,10.7059,20,0,0,1,0,1.05882,0,-1,0,0, ldraw_lib__stud2s2(realsolid)],
// 1 16 0 0 0 1 0 0 0 3.42857 0 0 0 1 stud2s2e.dat
  [1,16,0,0,0,1,0,0,0,3.42857,0,0,0,1, ldraw_lib__stud2s2e(realsolid)],
// 1 16 0 8 20 1 0 0 0 2.70589 0 0 0 1 stud2s2e.dat
  [1,16,0,8,20,1,0,0,0,2.70589,0,0,0,1, ldraw_lib__stud2s2e(realsolid)],
];
module ldraw_lib__24201(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__24201(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
