...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Alpha Team, Bricklink 32133ac03, Castle, cyberslam
// 0 !KEYWORDS Rebrickable 76110c03, Set 4770
// 
...
module ldraw_lib__76110p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76110p03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
