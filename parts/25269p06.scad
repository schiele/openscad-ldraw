...
use <s/25269s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__25269p06(realsolid=false) = [
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\25269p06s01.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__25269p06s01(realsolid)],
...
module ldraw_lib__25269p06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__25269p06(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
