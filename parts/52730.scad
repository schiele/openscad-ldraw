...
// 0 Technic Steering Constant Velocity 8mm Joint Female with 3L Axle
// 0 Name: 52730.dat
...
// 1 16 0 0 -20 1 0 0 0 0 1 0 -47.5 0 axlehol8.dat
  [1,16,0,0,-20,1,0,0,0,0,1,0,-47.5,0, ldraw_lib__axlehol8()],
...
// 1 16 0 0 -70 1 0 0 0 0 1 0 1 0 axleend2.dat
  [1,16,0,0,-70,1,0,0,0,0,1,0,1,0, ldraw_lib__axleend2()],
...
module ldraw_lib__52730(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__52730(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
