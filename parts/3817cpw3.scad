...
// 0 !HELP 1 16 0 0 1.25 1 0 0 0 1 0 0 0 1 3817cpw3.dat
...
// 1 3 0 0 0 1 0 0 0 1 0 0 0 1 s\3817cpw1s02.dat
  [1,3,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3817cpw1s02()],
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\3817cpw1s03.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3817cpw1s03()],
];
module ldraw_lib__3817cpw3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3817cpw3(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3817cpw3(line=0.2);