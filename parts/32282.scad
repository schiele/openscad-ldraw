...
// 1 16 0 42 70 1 0 0 0 1 0 0 0 1 s\32282s01.dat
  [1,16,0,42,70,1,0,0,0,1,0,0,0,1, ldraw_lib__s__32282s01()],
// 1 16 0 42 70 -1 0 0 0 1 0 0 0 1 s\32282s01.dat
  [1,16,0,42,70,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__32282s01()],
// 1 16 0 0 30 1 0 0 0 1 0 0 0 1 stug2-2x2.dat
  [1,16,0,0,30,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2_2x2()],
// 1 16 0 0 -30 1 0 0 0 1 0 0 0 1 stug2-2x2.dat
  [1,16,0,0,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2_2x2()],
...
module ldraw_lib__32282(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32282(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
