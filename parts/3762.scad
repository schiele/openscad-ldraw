...
// 1 16 0 -52 -2.5 49.25 0 0 0 0 -49.25 0 5 0 box5.dat
  [1,16,0,-52,-2.5,49.25,0,0,0,0,-49.25,0,5,0, ldraw_lib__box5()],
// 1 16 49.25 -52 0 0 1 0 -2.5 0 0 0 0 2.5 4-4edge.dat
  [1,16,49.25,-52,0,0,1,0,-2.5,0,0,0,0,2.5, ldraw_lib__4_4edge()],
// 1 16 49.25 -52 0 0 2 0 -2.5 0 0 0 0 2.5 4-8sphe.dat
  [1,16,49.25,-52,0,0,2,0,-2.5,0,0,0,0,2.5, ldraw_lib__4_8sphe()],
// 1 16 -49.25 -52 0 0 1 0 2.5 0 0 0 0 2.5 4-4edge.dat
  [1,16,-49.25,-52,0,0,1,0,2.5,0,0,0,0,2.5, ldraw_lib__4_4edge()],
// 1 16 -49.25 -52 0 0 -2 0 2.5 0 0 0 0 2.5 4-8sphe.dat
  [1,16,-49.25,-52,0,0,-2,0,2.5,0,0,0,0,2.5, ldraw_lib__4_8sphe()],
...
// 1 16 0 -9.75 1.5 4 0 0 0 0 4 0 -4 0 4-4cylc.dat
  [1,16,0,-9.75,1.5,4,0,0,0,0,4,0,-4,0, ldraw_lib__4_4cylc()],
// 1 16 0 -9.75 -2.5 4 0 0 0 0 4 0 1 0 4-4ndis.dat
  [1,16,0,-9.75,-2.5,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4ndis()],
...
module ldraw_lib__3762(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3762(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
