...
// 1 8 0 0 0 1 0 0 0 1 0 0 0 1 s\2552p04s02.dat
  [1,8,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2552p04s02()],
];
module ldraw_lib__2552p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2552p03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
