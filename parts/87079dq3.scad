...
use <87079.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87079dq3(realsolid=false) = [
...
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 4613906d.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__4613906d(realsolid)],
];
module ldraw_lib__87079dq3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87079dq3(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
