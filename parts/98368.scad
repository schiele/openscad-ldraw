...
use <s/98368s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98368(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\98368s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__98368s01(realsolid)],
...
module ldraw_lib__98368(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98368(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
