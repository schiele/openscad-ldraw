...
use <70450b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2797c01_f2(realsolid=false) = [
...
// 1 0 0 -200 0 1 0 0 0 1 0 0 0 1 2799c01.dat
  [1,0,0,-200,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2799c01(realsolid)],
// 1 494 0 -187 0 1 0 0 0 1 0 0 0 1 70450b.dat
  [1,494,0,-187,0,1,0,0,0,1,0,0,0,1, ldraw_lib__70450b(realsolid)],
];
module ldraw_lib__2797c01_f2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2797c01_f2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
