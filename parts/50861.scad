...
use <s/50861s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__50861(realsolid=false) = [
...
// 1 16 0 0 -7.5 18 0 0 0 0 -18 0 5 0 4-4cyli.dat
  [1,16,0,0,-7.5,18,0,0,0,0,-18,0,5,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 2.5 18 0 0 0 0 -18 0 5 0 4-4cyli.dat
  [1,16,0,0,2.5,18,0,0,0,0,-18,0,5,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -2.5 1 0 0 0 0 -1 0 1 0 4-4rin17.dat
  [1,16,0,0,-2.5,1,0,0,0,0,-1,0,1,0, ldraw_lib__4_4rin17(realsolid)],
// 1 16 0 0 2.5 1 0 0 0 0 -1 0 -1 0 4-4rin17.dat
  [1,16,0,0,2.5,1,0,0,0,0,-1,0,-1,0, ldraw_lib__4_4rin17(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -2.5 17 0 0 0 0 -17 0 5 0 4-4cyli.dat
  [1,16,0,0,-2.5,17,0,0,0,0,-17,0,5,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 7.5 18 0 0 0 0 -18 0 1 0 4-4edge.dat
  [1,16,0,0,7.5,18,0,0,0,0,-18,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -7.5 18 0 0 0 0 -18 0 1 0 4-4edge.dat
  [1,16,0,0,-7.5,18,0,0,0,0,-18,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 2.5 17 0 0 0 0 -17 0 1 0 4-4edge.dat
  [1,16,0,0,2.5,17,0,0,0,0,-17,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -2.5 17 0 0 0 0 -17 0 1 0 4-4edge.dat
  [1,16,0,0,-2.5,17,0,0,0,0,-17,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 2.5 18 0 0 0 0 -18 0 1 0 4-4edge.dat
  [1,16,0,0,2.5,18,0,0,0,0,-18,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -2.5 18 0 0 0 0 -18 0 1 0 4-4edge.dat
  [1,16,0,0,-2.5,18,0,0,0,0,-18,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 0 // Tread
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\50861s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__50861s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\50861s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__50861s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 -1 s\50861s01.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,-1, ldraw_lib__s__50861s01(realsolid)],
...
module ldraw_lib__50861(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__50861(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
