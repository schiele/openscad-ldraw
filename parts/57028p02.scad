...
$fa=1; $fs=0.2;
function ldraw_lib__57028p02(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 57028c03, Set 7713, Set 8892
// 
...
// 1 490 0 0 0 1 0 0 0 1 0 0 0 1 s\57028as02.dat
  [1,490,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__57028as02(realsolid)],
];
module ldraw_lib__57028p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__57028p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
