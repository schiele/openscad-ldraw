...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__64033(realsolid=false) = [
...
// 1 16 40 44 -20 0 0 -1 0 -1 0 1 0 0 stud4.dat
  [1,16,40,44,-20,0,0,-1,0,-1,0,1,0,0, ldraw_lib__stud4(realsolid)],
// 1 16 40 44 0 0 0 -1 0 -1 0 1 0 0 stud4.dat
  [1,16,40,44,0,0,0,-1,0,-1,0,1,0,0, ldraw_lib__stud4(realsolid)],
// 1 16 40 44 20 0 0 -1 0 -1 0 1 0 0 stud4.dat
  [1,16,40,44,20,0,0,-1,0,-1,0,1,0,0, ldraw_lib__stud4(realsolid)],
...
// 1 16 0 44 -20 0 0 -1 0 -1 0 1 0 0 stud4.dat
  [1,16,0,44,-20,0,0,-1,0,-1,0,1,0,0, ldraw_lib__stud4(realsolid)],
...
// 1 16 60 44 0 0 -1 0 0 0 4 -40 0 0 rect.dat
  [1,16,60,44,0,0,-1,0,0,0,4,-40,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 48 0 0 0 -46 0 -4 0 36 0 0 box5.dat
  [1,16,10,48,0,0,0,-46,0,-4,0,36,0,0, ldraw_lib__box5(realsolid)],
...
// 1 16 -30 34 -20 0 1 0 0 0 1 1 0 0 connhole.dat
  [1,16,-30,34,-20,0,1,0,0,0,1,1,0,0, ldraw_lib__connhole(realsolid)],
// 1 16 -40 34 -20 0 1 0 0 0 9 9 0 0 4-4ndis.dat
  [1,16,-40,34,-20,0,1,0,0,0,9,9,0,0, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 -36 32 0 0 -1 0 8 0 0 0 0 10 rect1.dat
  [1,16,-36,32,0,0,-1,0,8,0,0,0,0,10, ldraw_lib__rect1(realsolid)],
// 1 16 -36 32 -33 0 -1 0 0 0 8 -3 0 0 rect2a.dat
  [1,16,-36,32,-33,0,-1,0,0,0,8,-3,0,0, ldraw_lib__rect2a(realsolid)],
// 1 16 -36 32 33 0 -1 0 8 0 0 0 0 3 rect2a.dat
  [1,16,-36,32,33,0,-1,0,8,0,0,0,0,3, ldraw_lib__rect2a(realsolid)],
...
// 1 16 30 40 0 -30 0 0 0 1 0 0 0 -40 rect2p.dat
  [1,16,30,40,0,-30,0,0,0,1,0,0,0,-40, ldraw_lib__rect2p(realsolid)],
// 1 16 -30 34 20 0 1 0 0 0 1 -1 0 0 connhole.dat
  [1,16,-30,34,20,0,1,0,0,0,1,-1,0,0, ldraw_lib__connhole(realsolid)],
// 1 16 -40 34 20 0 1 0 0 0 9 -9 0 0 4-4ndis.dat
  [1,16,-40,34,20,0,1,0,0,0,9,-9,0,0, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 -20 34 -20 0 1 0 0 0 9 9 0 0 4-4disc.dat
  [1,16,-20,34,-20,0,1,0,0,0,9,9,0,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 -19 34 -20 0 -1 0 0 0 -10 10 0 0 2-4disc.dat
  [1,16,-19,34,-20,0,-1,0,0,0,-10,10,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 -19 34 -20 0 1 0 0 0 -10 -10 0 0 2-4edge.dat
  [1,16,-19,34,-20,0,1,0,0,0,-10,-10,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -36 34 -20 0 1 0 0 0 -10 -10 0 0 2-4edge.dat
  [1,16,-36,34,-20,0,1,0,0,0,-10,-10,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -36 34 -20 0 -1 0 0 0 -10 10 0 0 2-4ndis.dat
  [1,16,-36,34,-20,0,-1,0,0,0,-10,10,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -36 34 -20 0 17 0 0 0 -10 -10 0 0 2-4cyli.dat
  [1,16,-36,34,-20,0,17,0,0,0,-10,-10,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -36 37 -20 0 17 0 -3 0 0 0 0 10 box3u5p.dat
  [1,16,-36,37,-20,0,17,0,-3,0,0,0,0,10, ldraw_lib__box3u5p(realsolid)],
// 1 16 -20 34 20 0 1 0 0 0 9 9 0 0 4-4disc.dat
  [1,16,-20,34,20,0,1,0,0,0,9,9,0,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 -19 34 20 0 -1 0 0 0 -10 10 0 0 2-4disc.dat
  [1,16,-19,34,20,0,-1,0,0,0,-10,10,0,0, ldraw_lib__2_4disc(realsolid)],
...
module ldraw_lib__64033(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__64033(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
