...
use <s/3070bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3070bp10(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3070bp10s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3070bp10s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\3070bp10s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3070bp10s01(realsolid)],
...
// 1 0 0 0 -5 -1.5 0 0 0 1 0 0 0 -1.5 2-4ndis.dat
  [1,0,0,0,-5,-1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__2_4ndis(realsolid)],
// 
...
module ldraw_lib__3070bp10(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3070bp10(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
