...
function ldraw_lib__164795c() = [
// 0 Sticker  1.1 x  1.4 with Arla Dairy Logo Left
// 0 Name: 164795c.dat
...
module ldraw_lib__164795c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__164795c(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__164795c(line=0.2);