...
use <../p/stud2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__38583(realsolid=false) = [
...
// 1 16 0 21 -10 0 0 10 3 0 0 0 1 0 rect2p.dat
  [1,16,0,21,-10,0,0,10,3,0,0,0,1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 8 0 0 0 20 0 -8 0 -10 0 0 box3u2p.dat
  [1,16,0,8,0,0,0,20,0,-8,0,-10,0,0, ldraw_lib__box3u2p(realsolid)],
...
module ldraw_lib__38583(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__38583(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
