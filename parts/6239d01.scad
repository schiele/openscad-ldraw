...
use <6239.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6239d01(realsolid=false) = [
...
// 1 16 2 -40 30 0 -1 0 0 0 -1 1 0 0 4297014c.dat
  [1,16,2,-40,30,0,-1,0,0,0,-1,1,0,0, ldraw_lib__4297014c(realsolid)],
// 1 16 -2 -40 30 0 1 0 0 0 -1 -1 0 0 4297014d.dat
  [1,16,-2,-40,30,0,1,0,0,0,-1,-1,0,0, ldraw_lib__4297014d(realsolid)],
// 0
];
module ldraw_lib__6239d01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6239d01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
