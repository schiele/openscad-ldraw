...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\973p65b.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p65b()],
...
module ldraw_lib__973p6d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p6d(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
