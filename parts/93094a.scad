...
use <95109.scad>
$fa=1; $fs=0.2;
function ldraw_lib__93094a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 95108.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__95108(realsolid)],
];
module ldraw_lib__93094a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__93094a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
