...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3934(realsolid=false) = [
// 0 Wing  4 x  8 Right
// 0 Name: 3934.dat
...
// 0 !HISTORY 2004-10-15 [Steffen] all studs had mirrored logos
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\3933s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3933s01(realsolid)],
...
module ldraw_lib__3934(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3934(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3934(line=0.2);