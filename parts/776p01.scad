...
// 0 BFC CERTIFY CW
  ...
  [0,"BFC","CW"],
// 
// 0 !KEYWORDS classic, h0 scale, Rebrickable 776pr0001, Set 242.2
// 
...
module ldraw_lib__776p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__776p01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
