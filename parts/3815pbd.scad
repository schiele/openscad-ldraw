...
use <s/3815s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3815pbd(realsolid=false) = [
// 0 ~Minifig Hips with War Machine Armoured Suit Pattern (Obsolete)
// 0 Name: 3815pbd.dat
...
module ldraw_lib__3815pbd(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3815pbd(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3815pbd(line=0.2);