...
use <3820.scad>
use <973puk.scad>
function ldraw_lib__76382puk() = [
// 0 Minifig Torso with Arms and Hands with Sports Jacket with Orange "NB" and "SQUIDS" Pattern
// 0 Name: 76382puk.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973puk.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973puk()],
...
module ldraw_lib__76382puk(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382puk(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382puk(line=0.2);