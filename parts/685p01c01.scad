...
use <795.scad>
$fa=1; $fs=0.2;
function ldraw_lib__685p01c01(realsolid=false) = [
...
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 685p01.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__685p01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 792.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__792(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 793.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__793(realsolid)],
// 1 16 20 10 0 0 0 1 -1 0 0 0 -1 0 795.dat
  [1,16,20,10,0,0,0,1,-1,0,0,0,-1,0, ldraw_lib__795(realsolid)],
// 1 16 -20 10 0 0 0 -1 -1 0 0 0 -1 0 795.dat
  [1,16,-20,10,0,0,0,-1,-1,0,0,0,-1,0, ldraw_lib__795(realsolid)],
// 0
];
module ldraw_lib__685p01c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__685p01c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
