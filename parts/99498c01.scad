...
use <u9190c02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__99498c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 99498.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__99498(realsolid)],
// 1 0 0 -45.12 145 1 0 0 0 1 0 0 0 1 u9190c02.dat
  [1,0,0,-45.12,145,1,0,0,0,1,0,0,0,1, ldraw_lib__u9190c02(realsolid)],
];
module ldraw_lib__99498c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__99498c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
