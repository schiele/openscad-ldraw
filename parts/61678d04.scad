...
use <61678.scad>
$fa=1; $fs=0.2;
function ldraw_lib__61678d04(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6009254fc01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6009254fc01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6009254gc02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6009254gc02(realsolid)],
];
module ldraw_lib__61678d04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__61678d04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
