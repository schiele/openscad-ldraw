...
use <6142622g.scad>
$fa=1; $fs=0.2;
function ldraw_lib__54200dy0(realsolid=false) = [
// 0 Slope Brick 31  1 x  1 x 0.667 with Dark Gray Exhaust Pipe on Black and Yellow Background Right Sticker
// 0 Name: 54200dy0.dat
...
// 1 16 0 -10 0 1 0 0 0 0.857493 -0.514496 0 0.514496 0.857493 6142622g.dat
  [1,16,0,-10,0,1,0,0,0,0.857493,-0.514496,0,0.514496,0.857493, ldraw_lib__6142622g(realsolid)],
];
module ldraw_lib__54200dy0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__54200dy0(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
