...
use <s/4215as01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4215ap0a(realsolid=false) = [
...
// 1 16 0 34.5 10 0 0 -2 0 2 0 1 0 0 s\4209ap02s01.dat
  [1,16,0,34.5,10,0,0,-2,0,2,0,1,0,0, ldraw_lib__s__4209ap02s01(realsolid)],
...
module ldraw_lib__4215ap0a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4215ap0a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4215ap0a(line=0.2);