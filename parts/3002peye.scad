...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3003pe1.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3003pe1()],
];
module ldraw_lib__3002peye(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3002peye(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
