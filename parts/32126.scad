...
// 1 16 0 0 -20 0 1 -9 9 0 0 0 0 9 2-4edge.dat
  [1,16,0,0,-20,0,1,-9,9,0,0,0,0,9, ldraw_lib__2_4edge()],
// 1 16 0 0 -7 0 0 -9 -9 0 0 0 1 0 2-4edge.dat
  [1,16,0,0,-7,0,0,-9,-9,0,0,0,1,0, ldraw_lib__2_4edge()],
...
// 1 16 0 0 -7 -1 0 0 0 0 1 0 0.5 0 1-4con8.dat
  [1,16,0,0,-7,-1,0,0,0,0,1,0,0.5,0, ldraw_lib__1_4con8()],
// 1 16 0 0 -6.5 -1 0 0 0 0 1 0 0.5 0 1-4con7.dat
  [1,16,0,0,-6.5,-1,0,0,0,0,1,0,0.5,0, ldraw_lib__1_4con7()],
// 1 16 0 0 -6.5 0 0 -1 -1 0 0 0 0.5 0 1-4con7.dat
  [1,16,0,0,-6.5,0,0,-1,-1,0,0,0,0.5,0, ldraw_lib__1_4con7()],
// 1 16 0 0 -7 0 0 -1 -1 0 0 0 0.5 0 1-4con8.dat
  [1,16,0,0,-7,0,0,-1,-1,0,0,0,0.5,0, ldraw_lib__1_4con8()],
// 1 16 0 0 -20 0 -1 0 1 0 0 0 0 1 peghole.dat
  [1,16,0,0,-20,0,-1,0,1,0,0,0,0,1, ldraw_lib__peghole()],
...
// 1 16 0 0 -20 0 -1 0 1 0 0 0 0 1 4-4ring8.dat
  [1,16,0,0,-20,0,-1,0,1,0,0,0,0,1, ldraw_lib__4_4ring8()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -2 0 -20 0 -6 0 6 0 0 0 0 6 4-4cyli.dat
  [1,16,-2,0,-20,0,-6,0,6,0,0,0,0,6, ldraw_lib__4_4cyli()],
// 1 16 -10 0 -20 0 1 0 9 0 0 0 0 9 4-4cyli.dat
  [1,16,-10,0,-20,0,1,0,9,0,0,0,0,9, ldraw_lib__4_4cyli()],
...
// 1 16 0 0 -20 0 -10 0 9 0 0 0 0 -9 2-4cyli.dat
  [1,16,0,0,-20,0,-10,0,9,0,0,0,0,-9, ldraw_lib__2_4cyli()],
// 1 16 -9 0 -20 0 9 0 0 0 9 9 0 0 1-4cyls.dat
  [1,16,-9,0,-20,0,9,0,0,0,9,9,0,0, ldraw_lib__1_4cyls()],
// 1 16 -9 0 -20 0 9 0 0 0 -9 9 0 0 1-4cyls.dat
  [1,16,-9,0,-20,0,9,0,0,0,-9,9,0,0, ldraw_lib__1_4cyls()],
// 1 16 0 0 -11 -9 0 0 0 0 9 0 -9 0 1-4cyls.dat
  [1,16,0,0,-11,-9,0,0,0,0,9,0,-9,0, ldraw_lib__1_4cyls()],
// 1 16 0 0 -11 -9 0 0 0 0 -9 0 -9 0 1-4cyls.dat
  [1,16,0,0,-11,-9,0,0,0,0,-9,0,-9,0, ldraw_lib__1_4cyls()],
// 1 16 0 0 -10 0 0 -9 -9 0 0 0 3 0 2-4cyli.dat
  [1,16,0,0,-10,0,0,-9,-9,0,0,0,3,0, ldraw_lib__2_4cyli()],
// 1 16 0 0 -10 0 0 -6 -6 0 0 0 -1 0 2-4disc.dat
  [1,16,0,0,-10,0,0,-6,-6,0,0,0,-1,0, ldraw_lib__2_4disc()],
...
module ldraw_lib__32126(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32126(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
