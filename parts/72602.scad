...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 4119430a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4119430a()],
];
module ldraw_lib__72602(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__72602(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
