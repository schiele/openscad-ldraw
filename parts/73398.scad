...
use <s/73398s01.scad>
use <../p/stud2.scad>
function ldraw_lib__73398() = [
// 0 Wheel Rim 41 x 75 with  5 Spokes and  3 Pins #1 (Left)
// 0 Name: 73398.dat
...
module ldraw_lib__73398(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73398(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__73398(line=0.2);