...
use <s/15535s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__15535p01(realsolid=false) = [
...
// 1 25 0 0 0 1 0 0 0 1 0 0 0 1 s\15535p01s02.dat
  [1,25,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__15535p01s02(realsolid)],
// 1 25 0 0 0 -1 0 0 0 1 0 0 0 1 s\15535p01s02.dat
  [1,25,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__15535p01s02(realsolid)],
];
module ldraw_lib__15535p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__15535p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
