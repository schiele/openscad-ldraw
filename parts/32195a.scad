...
use <s/32195s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32195a(realsolid=false) = [
...
// 1 16 0 -3 -60 -7.391 0 3.061 0 10 0 -3.061 0 -7.391 3-8cyli.dat
  [1,16,0,-3,-60,-7.391,0,3.061,0,10,0,-3.061,0,-7.391, ldraw_lib__3_8cyli(realsolid)],
...
// 1 16 0 7 -60 8 0 0 0 -1 0 0 0 -8 2-4edge.dat
  [1,16,0,7,-60,8,0,0,0,-1,0,0,0,-8, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 7 -60 10 0 0 0 -1 0 0 0 -10 2-4edge.dat
  [1,16,0,7,-60,10,0,0,0,-1,0,0,0,-10, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 7 -60 2 0 0 0 -1 0 0 0 -2 2-4ring4.dat
  [1,16,0,7,-60,2,0,0,0,-1,0,0,0,-2, ldraw_lib__2_4ring4(realsolid)],
// 0 //
// 1 16 0 7 -60 10 0 0 0 -4 0 0 0 -10 2-4cyli.dat
  [1,16,0,7,-60,10,0,0,0,-4,0,0,0,-10, ldraw_lib__2_4cyli(realsolid)],
];
module ldraw_lib__32195a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32195a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
