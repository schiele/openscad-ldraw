...
use <s/98138s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98138p06(realsolid=false) = [
...
// 1 0 0 0 0 .8 0 0 0 1 0 0 0 .8 4-4ring9.dat
  [1,0,0,0,0,.8,0,0,0,1,0,0,0,.8, ldraw_lib__4_4ring9(realsolid)],
// 1 0 0 0 0 .55 0 0 0 1 0 0 0 .55 4-4ring8.dat
  [1,0,0,0,0,.55,0,0,0,1,0,0,0,.55, ldraw_lib__4_4ring8(realsolid)],
// 1 16 0 0 0 4.95 0 0 0 1 0 0 0 4.95 4-4ndis.dat
  [1,16,0,0,0,4.95,0,0,0,1,0,0,0,4.95, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 0 0 7.2 0 0 0 1 0 0 0 7.2 1-8chrd.dat
  [1,16,0,0,0,7.2,0,0,0,1,0,0,0,7.2, ldraw_lib__1_8chrd(realsolid)],
// 1 16 0 0 0 -7.2 0 0 0 1 0 0 0 7.2 1-8chrd.dat
  [1,16,0,0,0,-7.2,0,0,0,1,0,0,0,7.2, ldraw_lib__1_8chrd(realsolid)],
// 1 16 0 0 0 7.2 0 0 0 1 0 0 0 -7.2 1-8chrd.dat
  [1,16,0,0,0,7.2,0,0,0,1,0,0,0,-7.2, ldraw_lib__1_8chrd(realsolid)],
...
// 1 16 0 0 0 0 0 -7.2 0 1 0 7.2 0 0 1-8chrd.dat
  [1,16,0,0,0,0,0,-7.2,0,1,0,7.2,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 16 0 0 0 0 0 -7.2 0 1 0 -7.2 0 0 1-8chrd.dat
  [1,16,0,0,0,0,0,-7.2,0,1,0,-7.2,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 16 0 0 0 0 0 7.2 0 1 0 7.2 0 0 1-8chrd.dat
  [1,16,0,0,0,0,0,7.2,0,1,0,7.2,0,0, ldraw_lib__1_8chrd(realsolid)],
...
// 1 72 0 0 0 0 0 4.4 0 1 0 -4.4 0 0 3-16chrd.dat
  [1,72,0,0,0,0,0,4.4,0,1,0,-4.4,0,0, ldraw_lib__3_16chrd(realsolid)],
// 1 72 0 0 0 0 0 4.4 0 1 0 4.4 0 0 3-16chrd.dat
  [1,72,0,0,0,0,0,4.4,0,1,0,4.4,0,0, ldraw_lib__3_16chrd(realsolid)],
// 1 72 0 0 0 0 0 -4.4 0 1 0 -4.4 0 0 1-8chrd.dat
  [1,72,0,0,0,0,0,-4.4,0,1,0,-4.4,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 72 0 0 0 0 0 -.31427 0 1 0 .31427 0 0 3-8rin13.dat
  [1,72,0,0,0,0,0,-.31427,0,1,0,.31427,0,0, ldraw_lib__3_8rin13(realsolid)],
// 1 0 0 0 0 -4.08551 0 0 0 1 0 0 0 4.08551 1-4chrd.dat
  [1,0,0,0,0,-4.08551,0,0,0,1,0,0,0,4.08551, ldraw_lib__1_4chrd(realsolid)],
// 1 0 0 0 0 -4.08551 0 0 0 1 0 0 0 -4.08551 1-8chrd.dat
  [1,0,0,0,0,-4.08551,0,0,0,1,0,0,0,-4.08551, ldraw_lib__1_8chrd(realsolid)],
// 1 16 0 0 0 4.4 0 0 0 1 0 0 0 4.4 1-16chrd.dat
  [1,16,0,0,0,4.4,0,0,0,1,0,0,0,4.4, ldraw_lib__1_16chrd(realsolid)],
// 1 16 0 0 0 4.4 0 0 0 1 0 0 0 -4.4 1-16chrd.dat
  [1,16,0,0,0,4.4,0,0,0,1,0,0,0,-4.4, ldraw_lib__1_16chrd(realsolid)],
// 
...
module ldraw_lib__98138p06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98138p06(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
