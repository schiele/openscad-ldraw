...
use <../p/stud2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3751(realsolid=false) = [
...
// 1 16 0 14 0 6 0 0 0 -10 0 0 0 16 box5.dat
  [1,16,0,14,0,6,0,0,0,-10,0,0,0,16, ldraw_lib__box5(realsolid)],
...
// 1 16 0 14 0 10 0 0 0 -14 0 0 0 20 box5.dat
  [1,16,0,14,0,10,0,0,0,-14,0,0,0,20, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__3751(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3751(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
