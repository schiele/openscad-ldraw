...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3068p67, Rebrickable 3068bpr0073, set 308
// 
...
// 1 16 20 0 -20 0 0 -13.333 0 1 0 13.333 0 0 1-4disc.dat
  [1,16,20,0,-20,0,0,-13.333,0,1,0,13.333,0,0, ldraw_lib__1_4disc()],
// 1 4 20 0 -20 0 0 -13.333 0 1 0 13.333 0 0 1-4ring1.dat
  [1,4,20,0,-20,0,0,-13.333,0,1,0,13.333,0,0, ldraw_lib__1_4ring1()],
// 1 16 20 0 -20 0 0 -13.334 0 1 0 13.334 0 0 1-4ring2.dat
  [1,16,20,0,-20,0,0,-13.334,0,1,0,13.334,0,0, ldraw_lib__1_4ring2()],
// 1 4 20 0 -20 0 0 -40 0 1 0 40 0 0 1-4ndis.dat
  [1,4,20,0,-20,0,0,-40,0,1,0,40,0,0, ldraw_lib__1_4ndis()],
// 0
];
module ldraw_lib__3068bp67(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068bp67(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
