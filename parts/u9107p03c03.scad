...
$fa=1; $fs=0.2;
function ldraw_lib__u9107p03c03(realsolid=false) = [
// 0 _Figure Fabuland Panda with Body White/White/Black
// 0 Name: u9107p03c03.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Peter Panda, Set 3710
// 
// 0 !HISTORY 2010-12-31 [PTadmin] Official Update 2010-03
// 
// 
// 1 15 0 -67 4 1 0 0 0 1 0 0 0 1 u9107p03c01.dat
  [1,15,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u9107p03c01(realsolid)],
...
module ldraw_lib__u9107p03c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9107p03c03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9107p03c03(line=0.2);