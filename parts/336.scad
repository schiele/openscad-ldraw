...
// 1 16 0 12 0 1 0 0 0 134 0 0 0 1 axle.dat
  [1,16,0,12,0,1,0,0,0,134,0,0,0,1, ldraw_lib__axle()],
// 0
];
module ldraw_lib__336(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__336(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
