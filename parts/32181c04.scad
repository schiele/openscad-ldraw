...
use <32183c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32181c04(realsolid=false) = [
...
// 1 16 0 20 0 1 0 0 0 1 0 0 0 1 32181c03.dat
  [1,16,0,20,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32181c03(realsolid)],
// 1 16 0 76 0 1 0 0 0 1 0 0 0 1 32183c01.dat
  [1,16,0,76,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32183c01(realsolid)],
// 1 494 0 17 0 1 0 0 0 1 0 0 0 1 108.dat
  [1,494,0,17,0,1,0,0,0,1,0,0,0,1, ldraw_lib__108(realsolid)],
];
module ldraw_lib__32181c04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32181c04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
