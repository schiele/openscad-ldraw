...
$fa=1; $fs=0.2;
function ldraw_lib__13710d(realsolid=false) = [
// 0 Sticker Mindstorms EV3 #4 for Panel Smooth Medium (Needs Work)
// 0 Name: 13710d.dat
...
// 0 !TEXMAP START PLANAR 33.048 0 61.145 33.048 0 -66.3 -21.935 0 61.145 13710d.png
...
module ldraw_lib__13710d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__13710d(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__13710d(line=0.2);