...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3738(realsolid=false) = [
...
// 
// 
// 1 16 0 0 0 80 0 0 0 8 0 0 0 20 box4.dat
  [1,16,0,0,0,80,0,0,0,8,0,0,0,20, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 0 76 0 0 0 4 0 0 0 16 box4.dat
  [1,16,0,4,0,76,0,0,0,4,0,0,0,16, ldraw_lib__box4(realsolid)],
...
module ldraw_lib__3738(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3738(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3738(line=0.2);