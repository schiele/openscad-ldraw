...
// 1 16 0 0 0 80 0 0 0 8 0 0 0 20 box4.dat
  [1,16,0,0,0,80,0,0,0,8,0,0,0,20, ldraw_lib__box4()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 0 76 0 0 0 4 0 0 0 16 box4.dat
  [1,16,0,4,0,76,0,0,0,4,0,0,0,16, ldraw_lib__box4()],
...
module ldraw_lib__3738(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3738(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
