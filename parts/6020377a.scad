...
$fa=1; $fs=0.2;
function ldraw_lib__6020377a(realsolid=false) = [
...
// 1 19 0 -.25 0 1 0 0 0 1 0 0 0 1 s\6021257as01.dat
  [1,19,0,-.25,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6021257as01(realsolid)],
];
module ldraw_lib__6020377a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6020377a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
