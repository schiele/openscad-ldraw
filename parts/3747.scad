...
use <3747a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3747(realsolid=false) = [
// 0 ~Moved to 3747a
// 0 Name: 3747.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3747a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3747a(realsolid)],
];
module ldraw_lib__3747(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3747(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
