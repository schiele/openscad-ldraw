...
// 1 4 0 42 -100 1 0 0 0 1 0 0 0 1 u9550c01.dat
  [1,4,0,42,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__u9550c01()],
// 1 4 0 42 100 1 0 0 0 1 0 0 0 1 u9550c01.dat
  [1,4,0,42,100,1,0,0,0,1,0,0,0,1, ldraw_lib__u9550c01()],
];
module ldraw_lib__736c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__736c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
