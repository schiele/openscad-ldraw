...
use <s/3069p06c.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3068bp00(realsolid=false) = [
...
// 1 14 0 0 0 0 0 -1 0 1 0 1 0 0 s\3069p06b.dat
  [1,14,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3069p06b(realsolid)],
...
module ldraw_lib__3068bp00(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068bp00(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
