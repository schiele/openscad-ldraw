...
use <../p/stug2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2928(realsolid=false) = [
...
// 1 16 0 0 10 1 0 0 0 1 0 0 0 1 stug2a.dat
  [1,16,0,0,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2a(realsolid)],
...
// 1 16 40 12 0 0 -1 0 12 0 0 0 0 10 rect.dat
  [1,16,40,12,0,0,-1,0,12,0,0,0,0,10, ldraw_lib__rect(realsolid)],
// 1 16 -40 12 0 0 1 0 12 0 0 0 0 10 rect.dat
  [1,16,-40,12,0,0,1,0,12,0,0,0,0,10, ldraw_lib__rect(realsolid)],
...
// 1 16 0 9.5 -10 0 0 -20 6.5 0 0 0 1 0 rect2p.dat
  [1,16,0,9.5,-10,0,0,-20,6.5,0,0,0,1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 9.5 4 0 0 6 6.5 0 0 0 -10 0 box3u2p.dat
  [1,16,0,9.5,4,0,0,6,6.5,0,0,0,-10,0, ldraw_lib__box3u2p(realsolid)],
// 2 24 6 3 4 9 3 0
  [2,24,6,3,4,9,3,0],
// 2 24 6 16 4 9 16 0
  [2,24,6,16,4,9,16,0],
...
// 1 16 -13 9.5 -3 0 4 0 -6.5 0 0 0 0 -3 box2-5.dat
  [1,16,-13,9.5,-3,0,4,0,-6.5,0,0,0,0,-3, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 13 9.5 -3 0 -4 0 6.5 0 0 0 0 -3 box2-5.dat
  [1,16,13,9.5,-3,0,-4,0,6.5,0,0,0,0,-3, ldraw_lib__box2_5(realsolid)],
...
// 1 16 38 9.5 0 0 1 0 6.5 0 0 0 0 10 rect.dat
  [1,16,38,9.5,0,0,1,0,6.5,0,0,0,0,10, ldraw_lib__rect(realsolid)],
// 1 16 -38 9.5 0 0 -1 0 6.5 0 0 0 0 10 rect.dat
  [1,16,-38,9.5,0,0,-1,0,6.5,0,0,0,0,10, ldraw_lib__rect(realsolid)],
...
// 1 16 0 24 0 36 0 0 0 -4 0 0 0 -6 box4-4a.dat
  [1,16,0,24,0,36,0,0,0,-4,0,0,0,-6, ldraw_lib__box4_4a(realsolid)],
...
// 1 16 0 20 20 6 0 0 0 -1 0 0 0 -6 2-4ndis.dat
  [1,16,0,20,20,6,0,0,0,-1,0,0,0,-6, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 20 20 6 0 0 0 1 0 0 0 -6 2-4edge.dat
  [1,16,0,20,20,6,0,0,0,1,0,0,0,-6, ldraw_lib__2_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 16 20 6 0 0 0 4 0 0 0 -6 2-4cyli.dat
  [1,16,0,16,20,6,0,0,0,4,0,0,0,-6, ldraw_lib__2_4cyli(realsolid)],
...
// 1 16 -13 20 20 0 0 -7 -4 0 0 0 10 0 box2-5.dat
  [1,16,-13,20,20,0,0,-7,-4,0,0,0,10,0, ldraw_lib__box2_5(realsolid)],
// 1 16 13 20 20 0 0 7 4 0 0 0 10 0 box2-5.dat
  [1,16,13,20,20,0,0,7,4,0,0,0,10,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -11 22 16 0 0 -5 -2 0 0 0 10 0 box2-5.dat
  [1,16,-11,22,16,0,0,-5,-2,0,0,0,10,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 11 22 16 0 0 5 2 0 0 0 10 0 box2-5.dat
  [1,16,11,22,16,0,0,5,2,0,0,0,10,0, ldraw_lib__box2_5(realsolid)],
...
// 1 16 0 1.5 10 0 0 -20 1.5 0 0 0 20 0 box3u2p.dat
  [1,16,0,1.5,10,0,0,-20,1.5,0,0,0,20,0, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 0 16 20 6 0 0 0 1 0 0 0 -6 2-4ndis.dat
  [1,16,0,16,20,6,0,0,0,1,0,0,0,-6, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 16 20 6 0 0 0 1 0 0 0 -6 2-4edge.dat
  [1,16,0,16,20,6,0,0,0,1,0,0,0,-6, ldraw_lib__2_4edge(realsolid)],
// 2 24 6 16 20 6 16 30
  [2,24,6,16,20,6,16,30],
// 2 24 -6 16 20 -6 16 30
  [2,24,-6,16,20,-6,16,30],
// 1 16 0 24 10 1.41421 0 1.41421 0 -1 0 1.41421 0 -1.41421 3-4ring3.dat
  [1,16,0,24,10,1.41421,0,1.41421,0,-1,0,1.41421,0,-1.41421, ldraw_lib__3_4ring3(realsolid)],
// 1 16 0 20 10 5.656 0 5.656 0 4 0 5.656 0 -5.656 3-4cyli.dat
  [1,16,0,20,10,5.656,0,5.656,0,4,0,5.656,0,-5.656, ldraw_lib__3_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 20 10 4.242 0 4.242 0 4 0 4.242 0 -4.242 3-4cyli.dat
  [1,16,0,20,10,4.242,0,4.242,0,4,0,4.242,0,-4.242, ldraw_lib__3_4cyli(realsolid)],
// 1 16 0 24 10 5.656 0 5.656 0 1 0 5.656 0 -5.656 3-4edge.dat
  [1,16,0,24,10,5.656,0,5.656,0,1,0,5.656,0,-5.656, ldraw_lib__3_4edge(realsolid)],
// 1 16 0 24 10 4.242 0 4.242 0 1 0 4.242 0 -4.242 3-4edge.dat
  [1,16,0,24,10,4.242,0,4.242,0,1,0,4.242,0,-4.242, ldraw_lib__3_4edge(realsolid)],
// 1 16 0 20 10 5.656 0 5.656 0 1 0 5.656 0 -5.656 3-4edge.dat
  [1,16,0,20,10,5.656,0,5.656,0,1,0,5.656,0,-5.656, ldraw_lib__3_4edge(realsolid)],
// 1 16 0 20 10 4.242 0 4.242 0 1 0 4.242 0 -4.242 3-4edge.dat
  [1,16,0,20,10,4.242,0,4.242,0,1,0,4.242,0,-4.242, ldraw_lib__3_4edge(realsolid)],
...
module ldraw_lib__2928(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2928(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
