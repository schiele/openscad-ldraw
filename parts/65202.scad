...
use <../p/stug-1x6.scad>
$fa=1; $fs=0.2;
function ldraw_lib__65202(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\65202s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__65202s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\65202s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__65202s01(realsolid)],
// 1 16 30 0 80 0 0 1 0 1 0 -1 0 0 stug-1x2.dat
  [1,16,30,0,80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x2(realsolid)],
// 1 16 -30 0 80 0 0 1 0 1 0 -1 0 0 stug-1x2.dat
  [1,16,-30,0,80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x2(realsolid)],
// 1 16 30 0 -80 0 0 1 0 1 0 -1 0 0 stug-1x2.dat
  [1,16,30,0,-80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x2(realsolid)],
...
// 1 16 10 16 70 0 0 1 0 1 0 -1 0 0 stug-1x3.dat
  [1,16,10,16,70,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x3(realsolid)],
// 1 16 -10 16 70 0 0 1 0 1 0 -1 0 0 stug-1x3.dat
  [1,16,-10,16,70,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x3(realsolid)],
// 1 16 -50 16 0 0 0 1 0 1 0 -1 0 0 stug-1x4.dat
  [1,16,-50,16,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x4(realsolid)],
// 1 16 50 16 0 0 0 1 0 1 0 -1 0 0 stug-1x4.dat
  [1,16,50,16,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x4(realsolid)],
// 1 16 10 16 -70 0 0 1 0 1 0 -1 0 0 stug-1x3.dat
  [1,16,10,16,-70,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x3(realsolid)],
...
// 1 16 -30 16 0 0 0 1 0 1 0 -1 0 0 stug-1x6.dat
  [1,16,-30,16,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x6(realsolid)],
// 1 16 30 16 0 0 0 1 0 1 0 -1 0 0 stug-1x6.dat
  [1,16,30,16,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x6(realsolid)],
...
module ldraw_lib__65202(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__65202(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
