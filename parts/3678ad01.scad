...
use <4159998c.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3678ad01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3678a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3678a(realsolid)],
// 1 16 0 20.98 -19.6 1 0 0 0 0.4167 -0.9091 0 0.9091 0.4167 4159998c.dat
  [1,16,0,20.98,-19.6,1,0,0,0,0.4167,-0.9091,0,0.9091,0.4167, ldraw_lib__4159998c(realsolid)],
];
module ldraw_lib__3678ad01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3678ad01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
