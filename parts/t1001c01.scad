...
use <t1003.scad>
$fa=1; $fs=0.2;
function ldraw_lib__t1001c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 t1001.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__t1001(realsolid)],
// 1 16 0 72 0 1 0 0 0 1 0 0 0 1 t1000.dat
  [1,16,0,72,0,1,0,0,0,1,0,0,0,1, ldraw_lib__t1000(realsolid)],
// 1 15 0 2 -69 -1 0 0 0 1 0 0 0 -1 t1002.dat
  [1,15,0,2,-69,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1002(realsolid)],
// 1 494 0 0 -10 -1 0 0 0 1 0 0 0 -1 t1003.dat
  [1,494,0,0,-10,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1003(realsolid)],
...
module ldraw_lib__t1001c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1001c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
