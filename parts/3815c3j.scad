...
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3816p3j.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816p3j()],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3817p3j.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817p3j()],
// 0
];
module ldraw_lib__3815c3j(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3815c3j(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
