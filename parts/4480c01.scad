...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 4480.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4480()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 4481.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4481()],
// 1 16 0 30 -90 1 0 0 0 0.924 0.383 0 -0.383 0.924 4482.dat
  [1,16,0,30,-90,1,0,0,0,0.924,0.383,0,-0.383,0.924, ldraw_lib__4482()],
];
module ldraw_lib__4480c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4480c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
