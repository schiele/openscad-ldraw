...
use <../p/4-4ring4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2942(realsolid=false) = [
...
// 1 16 0 -20 0 10 0 0 0 -46 0 0 0 10 4-4cyli.dat
  [1,16,0,-20,0,10,0,0,0,-46,0,0,0,10, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -72 -8.5 -5 0 0 0 0 -5 0 -1.5 0 2-4cyli.dat
  [1,16,0,-72,-8.5,-5,0,0,0,0,-5,0,-1.5,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 -72 -8.5 -5 0 0 0 0 -5 0 1 0 2-4edge.dat
  [1,16,0,-72,-8.5,-5,0,0,0,0,-5,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -72 -8.5 -5 0 0 0 0 -5 0 1 0 2-4ndis.dat
  [1,16,0,-72,-8.5,-5,0,0,0,0,-5,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 -72 -10 -5 0 0 0 0 5 0 1 0 2-4ndis.dat
  [1,16,0,-72,-10,-5,0,0,0,0,5,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 -72 -10 -5 0 0 0 0 -5 0 1 0 2-4edge.dat
  [1,16,0,-72,-10,-5,0,0,0,0,-5,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -72 -10 5 0 0 0 0 5 0 1 0 4-4disc.dat
  [1,16,0,-72,-10,5,0,0,0,0,5,0,1,0, ldraw_lib__4_4disc(realsolid)],
...
// 1 16 0 -78 0 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,0,-78,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 -20 0 10 0 0 0 1 0 0 0 10 4-4edge.dat
  [1,16,0,-20,0,10,0,0,0,1,0,0,0,10, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -20 0 2 0 0 0 -1 0 0 0 2 4-4ring4.dat
  [1,16,0,-20,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -20 0 8 0 0 0 -58 0 0 0 8 4-4cyli.dat
  [1,16,0,-20,0,8,0,0,0,-58,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -78 0 0.5 0 0 0 1 0 0 0 0.5 4-4rin16.dat
  [1,16,0,-78,0,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4rin16(realsolid)],
// 1 16 0 -78 0 8.5 0 0 0 1 0 0 0 8.5 4-4ndis.dat
  [1,16,0,-78,0,8.5,0,0,0,1,0,0,0,8.5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 -66 0 10 0 0 0 1 0 0 0 10 4-4edge.dat
  [1,16,0,-66,0,10,0,0,0,1,0,0,0,10, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -66 0 9.2388 0 3.82683 0 1 0 -3.82683 0 9.2388 1-8chrd.dat
  [1,16,0,-66,0,9.2388,0,3.82683,0,1,0,-3.82683,0,9.2388, ldraw_lib__1_8chrd(realsolid)],
// 1 16 0 -66 0 3.82683 0 -9.2388 0 1 0 9.2388 0 3.82683 1-8chrd.dat
  [1,16,0,-66,0,3.82683,0,-9.2388,0,1,0,9.2388,0,3.82683, ldraw_lib__1_8chrd(realsolid)],
// 1 16 0 -66 0 -9.2388 0 -3.82683 0 1 0 3.82683 0 -9.2388 1-8chrd.dat
  [1,16,0,-66,0,-9.2388,0,-3.82683,0,1,0,3.82683,0,-9.2388, ldraw_lib__1_8chrd(realsolid)],
...
module ldraw_lib__2942(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2942(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
