...
// 1 16 30 12 0 0 -1 0 0 0 -1 1 0 0 6005724h1.dat
  [1,16,30,12,0,0,-1,0,0,0,-1,1,0,0, ldraw_lib__6005724h1()],
];
module ldraw_lib__3002dm0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3002dm0(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
