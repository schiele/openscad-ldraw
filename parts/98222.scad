...
$fa=1; $fs=0.2;
function ldraw_lib__98222(realsolid=false) = [
...
// 1 16 0 0 60 1 0 0 0 2.75 0 0 0 1 stug7-1x2.dat
  [1,16,0,0,60,1,0,0,0,2.75,0,0,0,1, ldraw_lib__stug7_1x2(realsolid)],
// 1 16 0 0 -60 1 0 0 0 2.75 0 0 0 1 stug7-1x2.dat
  [1,16,0,0,-60,1,0,0,0,2.75,0,0,0,1, ldraw_lib__stug7_1x2(realsolid)],
// 1 16 0 4 0 1 0 0 0 -5 0 0 0 1 stud8a.dat
  [1,16,0,4,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud8a(realsolid)],
...
// 1 16 0 24 0 1 0 0 0 1 0 0 0 1 dsnapridge.dat
  [1,16,0,24,0,1,0,0,0,1,0,0,0,1, ldraw_lib__dsnapridge(realsolid)],
...
// 1 16 0 0 0 14 0 0 0 4 0 0 0 14 4-4cyli.dat
  [1,16,0,0,0,14,0,0,0,4,0,0,0,14, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 0 9.89949 0 -9.89949 0 1 0 9.89949 0 9.89949 4-4ndis.dat
  [1,16,0,0,0,9.89949,0,-9.89949,0,1,0,9.89949,0,9.89949, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 0 0 80 0 0 0 1 0 0 0 80 48\1-4chrd.dat
  [1,16,0,0,0,80,0,0,0,1,0,0,0,80, ldraw_lib__48__1_4chrd(realsolid)],
// 4 16 0 0 19.799 19.799 0 0 80 0 0 0 0 80
  [4,16,0,0,19.799,19.799,0,0,80,0,0,0,0,80],
// 1 16 0 0 0 0 0 80 0 1 0 -80 0 0 48\1-4chrd.dat
  [1,16,0,0,0,0,0,80,0,1,0,-80,0,0, ldraw_lib__48__1_4chrd(realsolid)],
...
// 1 16 0 0 0 80 0 0 0 1 0 0 0 80 48\4-4edge.dat
  [1,16,0,0,0,80,0,0,0,1,0,0,0,80, ldraw_lib__48__4_4edge(realsolid)],
// 1 16 0 0 0 80 0 0 0 4 0 0 0 80 48\4-4cyli.dat
  [1,16,0,0,0,80,0,0,0,4,0,0,0,80, ldraw_lib__48__4_4cyli(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\98222s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__98222s01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 1 0 0 s\98222s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,1,0,0, ldraw_lib__s__98222s01(realsolid)],
// 1 16 0 4 0 63.46827 0 -48.70091 0 1 0 48.70091 0 63.46827 48\1-24edge.dat
  [1,16,0,4,0,63.46827,0,-48.70091,0,1,0,48.70091,0,63.46827, ldraw_lib__48__1_24edge(realsolid)],
// 1 16 0 4 0 63.46827 0 -48.70091 0 -1 0 48.70091 0 63.46827 48\1-24chrd.dat
  [1,16,0,4,0,63.46827,0,-48.70091,0,-1,0,48.70091,0,63.46827, ldraw_lib__48__1_24chrd(realsolid)],
...
// 1 16 0 4 0 48.70091 0 63.46827 0 1 0 -63.46827 0 48.70091 48\1-24edge.dat
  [1,16,0,4,0,48.70091,0,63.46827,0,1,0,-63.46827,0,48.70091, ldraw_lib__48__1_24edge(realsolid)],
// 1 16 0 4 0 48.70091 0 63.46827 0 -1 0 -63.46827 0 48.70091 48\1-24chrd.dat
  [1,16,0,4,0,48.70091,0,63.46827,0,-1,0,-63.46827,0,48.70091, ldraw_lib__48__1_24chrd(realsolid)],
...
module ldraw_lib__98222(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98222(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
