...
$fa=1; $fs=0.2;
function ldraw_lib__004757b(realsolid=false) = [
...
// 1 4 0 -0.25 0 0.21 0 0 0 1 0 0 0 0.21 s\191915sbe.dat
  [1,4,0,-0.25,0,0.21,0,0,0,1,0,0,0,0.21, ldraw_lib__s__191915sbe(realsolid)],
...
module ldraw_lib__004757b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__004757b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
