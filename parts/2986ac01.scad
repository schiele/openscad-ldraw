...
use <u9387.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2986ac01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2986a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2986a(realsolid)],
// 1 46 0 0 0 1 0 0 0 1 0 0 0 1 u9387.dat
  [1,46,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9387(realsolid)],
];
module ldraw_lib__2986ac01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2986ac01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
