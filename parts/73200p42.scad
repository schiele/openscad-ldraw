...
use <3817bp42.scad>
$fa=1; $fs=0.2;
function ldraw_lib__73200p42(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3815bp42.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3815bp42(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3816bp42.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816bp42(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3817bp42.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817bp42(realsolid)],
];
module ldraw_lib__73200p42(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73200p42(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
