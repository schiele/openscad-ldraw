...
use <../p/stxjcyl9.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32531a(realsolid=false) = [
...
// 1 16 -20 18 30 1 0 0 0 -1.5 0 0 0 1 studxa.dat
  [1,16,-20,18,30,1,0,0,0,-1.5,0,0,0,1, ldraw_lib__studxa(realsolid)],
// 1 16 0 18 30 1 0 0 0 -1.5 0 0 0 1 studxa.dat
  [1,16,0,18,30,1,0,0,0,-1.5,0,0,0,1, ldraw_lib__studxa(realsolid)],
// 1 16 20 18 30 1 0 0 0 -1.5 0 0 0 1 studxa.dat
  [1,16,20,18,30,1,0,0,0,-1.5,0,0,0,1, ldraw_lib__studxa(realsolid)],
// 1 16 -50 18 20 1 0 0 0 -1.5 0 0 0 1 studxa.dat
  [1,16,-50,18,20,1,0,0,0,-1.5,0,0,0,1, ldraw_lib__studxa(realsolid)],
// 1 16 50 18 20 1 0 0 0 -1.5 0 0 0 1 studxa.dat
  [1,16,50,18,20,1,0,0,0,-1.5,0,0,0,1, ldraw_lib__studxa(realsolid)],
// 1 16 -50 18 0 1 0 0 0 -1.5 0 0 0 1 studxa.dat
  [1,16,-50,18,0,1,0,0,0,-1.5,0,0,0,1, ldraw_lib__studxa(realsolid)],
// 1 16 50 18 0 1 0 0 0 -1.5 0 0 0 1 studxa.dat
  [1,16,50,18,0,1,0,0,0,-1.5,0,0,0,1, ldraw_lib__studxa(realsolid)],
// 1 16 -50 18 -20 1 0 0 0 -1.5 0 0 0 1 studxa.dat
  [1,16,-50,18,-20,1,0,0,0,-1.5,0,0,0,1, ldraw_lib__studxa(realsolid)],
...
// 1 16 -20 18 30 1 0 0 0 -1 0 0 0 1 stxjcyl9.dat
  [1,16,-20,18,30,1,0,0,0,-1,0,0,0,1, ldraw_lib__stxjcyl9(realsolid)],
// 1 16 0 18 30 1 0 0 0 -1 0 0 0 1 stxjcyl9.dat
  [1,16,0,18,30,1,0,0,0,-1,0,0,0,1, ldraw_lib__stxjcyl9(realsolid)],
// 1 16 20 18 30 1 0 0 0 -1 0 0 0 1 stxjcyl9.dat
  [1,16,20,18,30,1,0,0,0,-1,0,0,0,1, ldraw_lib__stxjcyl9(realsolid)],
// 1 16 -50 18 20 0 0 1 0 -1 0 -1 0 0 stxjcyl9.dat
  [1,16,-50,18,20,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stxjcyl9(realsolid)],
// 1 16 50 18 20 0 0 1 0 -1 0 -1 0 0 stxjcyl9.dat
  [1,16,50,18,20,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stxjcyl9(realsolid)],
// 1 16 -50 18 0 0 0 1 0 -1 0 -1 0 0 stxjcyl9.dat
  [1,16,-50,18,0,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stxjcyl9(realsolid)],
// 1 16 50 18 0 0 0 1 0 -1 0 -1 0 0 stxjcyl9.dat
  [1,16,50,18,0,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stxjcyl9(realsolid)],
// 1 16 -50 18 -20 0 0 1 0 -1 0 -1 0 0 stxjcyl9.dat
  [1,16,-50,18,-20,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stxjcyl9(realsolid)],
...
module ldraw_lib__32531a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32531a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
