...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__61190b(realsolid=false) = [
...
// 1 16 11.5 6 12.5 0 -16 -6.5 0 13 -8 0.5 0 0 rect3.dat
  [1,16,11.5,6,12.5,0,-16,-6.5,0,13,-8,0.5,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 -1 7.5 13.5 0 -19 -1 0 2 -9.5 0.5 0 0 rect3.dat
  [1,16,-1,7.5,13.5,0,-19,-1,0,2,-9.5,0.5,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 -8.5 6 13.5 0 16 3.5 0 7 -8 -0.5 0 0 rect3.dat
  [1,16,-8.5,6,13.5,0,16,3.5,0,7,-8,-0.5,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 -6 15.5 12 0 1 -6 0 -4 -1.5 -2 0 0 rect.dat
  [1,16,-6,15.5,12,0,1,-6,0,-4,-1.5,-2,0,0, ldraw_lib__rect(realsolid)],
// 1 16 9 15.5 11.5 0 -1 9 0 -6 -1.5 1.5 0 0 rect3.dat
  [1,16,9,15.5,11.5,0,-1,9,0,-6,-1.5,1.5,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 23 -1 12 0 0 1 -1 0 0 0 -24 0 5-16cyli.dat
  [1,16,23,-1,12,0,0,1,-1,0,0,0,-24,0, ldraw_lib__5_16cyli(realsolid)],
// 1 16 23 -1 12 0 0 1 -1 0 0 0 -1 0 5-16disc.dat
  [1,16,23,-1,12,0,0,1,-1,0,0,0,-1,0, ldraw_lib__5_16disc(realsolid)],
// 1 16 23 -1 12 0 0 1 -1 0 0 0 1 0 5-16edge.dat
  [1,16,23,-1,12,0,0,1,-1,0,0,0,1,0, ldraw_lib__5_16edge(realsolid)],
// 1 16 23 -1 -12 0 0 1 -1 0 0 0 1 0 5-16disc.dat
  [1,16,23,-1,-12,0,0,1,-1,0,0,0,1,0, ldraw_lib__5_16disc(realsolid)],
// 1 16 23 -1 -12 0 0 1 -1 0 0 0 1 0 5-16edge.dat
  [1,16,23,-1,-12,0,0,1,-1,0,0,0,1,0, ldraw_lib__5_16edge(realsolid)],
...
// 1 16 -17 -1 -13 0 0 -1 -1 0 0 0 26 0 5-16cyli.dat
  [1,16,-17,-1,-13,0,0,-1,-1,0,0,0,26,0, ldraw_lib__5_16cyli(realsolid)],
// 1 16 -17 -1 -13 0 0 -1 -1 0 0 0 1 0 5-16disc.dat
  [1,16,-17,-1,-13,0,0,-1,-1,0,0,0,1,0, ldraw_lib__5_16disc(realsolid)],
// 1 16 -17 -1 -13 0 0 -1 -1 0 0 0 -1 0 5-16edge.dat
  [1,16,-17,-1,-13,0,0,-1,-1,0,0,0,-1,0, ldraw_lib__5_16edge(realsolid)],
// 1 16 -17 -1 13 0 0 -1 -1 0 0 0 -1 0 5-16disc.dat
  [1,16,-17,-1,13,0,0,-1,-1,0,0,0,-1,0, ldraw_lib__5_16disc(realsolid)],
// 1 16 -17 -1 13 0 0 -1 -1 0 0 0 -1 0 5-16edge.dat
  [1,16,-17,-1,13,0,0,-1,-1,0,0,0,-1,0, ldraw_lib__5_16edge(realsolid)],
...
module ldraw_lib__61190b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__61190b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
