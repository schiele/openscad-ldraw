...
// 1 16 0 -70 0 1 0 0 0 1 0 0 0 1 u9393p02.dat
  [1,16,0,-70,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9393p02()],
...
module ldraw_lib__45601p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__45601p02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
