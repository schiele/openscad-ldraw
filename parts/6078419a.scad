...
use <6020377a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6078419a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6020377a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6020377a(realsolid)],
];
module ldraw_lib__6078419a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6078419a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
