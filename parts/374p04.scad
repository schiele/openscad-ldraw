...
use <../p/studp01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__374p04(realsolid=false) = [
// 0 Baseplate 16 x 32 with Rounded Corners + Set 540 Dots Pattern
// 0 Name: 374p04.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !HISTORY 2005-01-26 [Holly-Wood] Fixed L3p warnings, corrected BFC, regrouped
// 0 !HISTORY 2009-05-02 [PTadmin] Official Update 2009-01
// 
// 
// 1 16 280 4 120 40 0 0 0 1 0 0 0 40 1-4edge.dat
  [1,16,280,4,120,40,0,0,0,1,0,0,0,40, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 280 0 120 40 0 0 0 1 0 0 0 40 1-4edge.dat
  [1,16,280,0,120,40,0,0,0,1,0,0,0,40, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 280 4 120 0 0 40 0 -1 0 40 0 0 1-4disc.dat
  [1,16,280,4,120,0,0,40,0,-1,0,40,0,0, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 280 0 120 40 0 0 0 1 0 0 0 40 1-4disc.dat
  [1,16,280,0,120,40,0,0,0,1,0,0,0,40, ldraw_lib__1_4disc(realsolid)],
// 4 16 280 0 120 280 0 -120 320 0 -120 320 0 120
  [4,16,280,0,120,280,0,-120,320,0,-120,320,0,120],
// 1 16 280 0 -120 40 0 0 0 1 0 0 0 -40 1-4disc.dat
  [1,16,280,0,-120,40,0,0,0,1,0,0,0,-40, ldraw_lib__1_4disc(realsolid)],
...
module ldraw_lib__374p04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__374p04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__374p04(line=0.2);