...
// 1 16 -60 -35 8.5 5 0 0 0 0 5 0 -1 0 4-4disc.dat
  [1,16,-60,-35,8.5,5,0,0,0,0,5,0,-1,0, ldraw_lib__4_4disc()],
// 1 16 91 16 24 5 0 0 0 0 5 0 -1 0 4-4disc.dat
  [1,16,91,16,24,5,0,0,0,0,5,0,-1,0, ldraw_lib__4_4disc()],
// 1 16 -91 16 24 5 0 0 0 0 5 0 -1 0 4-4disc.dat
  [1,16,-91,16,24,5,0,0,0,0,5,0,-1,0, ldraw_lib__4_4disc()],
// 1 16 -91 16 20 3 0 0 0 0 3 0 1 0 4-4edge.dat
  [1,16,-91,16,20,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -91 16 20 3 0 0 0 0 3 0 -20 0 4-4cyli.dat
  [1,16,-91,16,20,3,0,0,0,0,3,0,-20,0, ldraw_lib__4_4cyli()],
// 1 16 -91 16 20 3 0 0 0 0 3 0 1 0 4-4disc.dat
  [1,16,-91,16,20,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4disc()],
// 1 16 91 16 20 3 0 0 0 0 3 0 1 0 4-4edge.dat
  [1,16,91,16,20,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 -60 -35 6.5 3 0 0 0 0 3 0 1 0 4-4edge.dat
  [1,16,-60,-35,6.5,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -60 -35 6.5 3 0 0 0 0 3 0 -6.5 0 4-4cyli.dat
  [1,16,-60,-35,6.5,3,0,0,0,0,3,0,-6.5,0, ldraw_lib__4_4cyli()],
// 1 16 -60 -35 6.5 3 0 0 0 0 3 0 1 0 4-4disc.dat
  [1,16,-60,-35,6.5,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4disc()],
...
// 1 16 -93 -20 12 -1 0 0 0 0 6.5 0 -24 0 box5.dat
  [1,16,-93,-20,12,-1,0,0,0,0,6.5,0,-24,0, ldraw_lib__box5()],
...
module ldraw_lib__43460(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__43460(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
