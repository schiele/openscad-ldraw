...
// 1 16 0 16 0 0 0 -1 0 -16 0 -1 0 0 axl3ho10.dat
  [1,16,0,16,0,0,0,-1,0,-16,0,-1,0,0, ldraw_lib__axl3ho10()],
// 1 16 0 16 0 1 0 0 0 16 0 0 0 1 axl3hol3.dat
  [1,16,0,16,0,1,0,0,0,16,0,0,0,1, ldraw_lib__axl3hol3()],
// 1 16 0 16 0 1 0 0 0 16 0 0 0 1 axl3hol9.dat
  [1,16,0,16,0,1,0,0,0,16,0,0,0,1, ldraw_lib__axl3hol9()],
...
// 1 16 0 0 0 1 0 0 0 16 0 0 0 1 axl3ho10.dat
  [1,16,0,0,0,1,0,0,0,16,0,0,0,1, ldraw_lib__axl3ho10()],
// 1 16 0 0 0 1 0 0 0 16 0 0 0 1 axl3hol9.dat
  [1,16,0,0,0,1,0,0,0,16,0,0,0,1, ldraw_lib__axl3hol9()],
// 1 16 0 0 0 1 0 0 0 16 0 0 0 1 axl3hol2.dat
  [1,16,0,0,0,1,0,0,0,16,0,0,0,1, ldraw_lib__axl3hol2()],
...
// 1 16 0 4 0 16 0 0 0 16 0 0 0 16 4-4cyli.dat
  [1,16,0,4,0,16,0,0,0,16,0,0,0,16, ldraw_lib__4_4cyli()],
// 1 16 0 0 0 0 0 -1 0 1 0 -1 0 0 s\92947s00.dat
  [1,16,0,0,0,0,0,-1,0,1,0,-1,0,0, ldraw_lib__s__92947s00()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\92947s00.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92947s00()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\92947s00.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__92947s00()],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\92947s00.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__92947s00()],
...
module ldraw_lib__92947(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92947(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
