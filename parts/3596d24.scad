...
// 1 16 2 -132 34 0 -1 0 0 0 -1 1 0 0 004511a.dat
  [1,16,2,-132,34,0,-1,0,0,0,-1,1,0,0, ldraw_lib__004511a()],
// 0 // Sticker Back
// 1 16 -2 -132 34 0 1 0 0 0 -1 -1 0 0 004511a.dat
  [1,16,-2,-132,34,0,1,0,0,0,-1,-1,0,0, ldraw_lib__004511a()],
// 0 //
...
module ldraw_lib__3596d24(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3596d24(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
