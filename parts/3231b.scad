...
use <s/3231s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3231b(realsolid=false) = [
...
// 1 16 -150 0 50 1 0 0 0 1 0 0 0 1 s\3231bs01.dat
  [1,16,-150,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3231bs01(realsolid)],
// 1 16 -150 0 -50 1 0 0 0 1 0 0 0 1 s\3231bs01.dat
  [1,16,-150,0,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3231bs01(realsolid)],
// 1 16 50 0 -150 0 0 -1 0 1 0 1 0 0 s\3231bs01.dat
  [1,16,50,0,-150,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3231bs01(realsolid)],
// 1 16 150 0 50 -1 0 0 0 1 0 0 0 -1 s\3231bs01.dat
  [1,16,150,0,50,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3231bs01(realsolid)],
// 1 16 -50 0 150 0 0 1 0 1 0 -1 0 0 s\3231bs01.dat
  [1,16,-50,0,150,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__3231bs01(realsolid)],
...
module ldraw_lib__3231b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3231b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
