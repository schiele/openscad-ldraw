...
use <u9113.scad>
$fa=1; $fs=0.2;
function ldraw_lib__19467c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 19467.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__19467(realsolid)],
// 1 494 0 19 0 1 0 0 0 1 0 0 0 1 u9113.dat
  [1,494,0,19,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9113(realsolid)],
];
module ldraw_lib__19467c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__19467c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
