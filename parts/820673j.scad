...
$fa=1; $fs=0.2;
function ldraw_lib__820673j(realsolid=false) = [
...
// 1 16 0 -0.25 0 1.3 0 0 0 1 0 0 0 1.3 s\169675as01.dat
  [1,16,0,-0.25,0,1.3,0,0,0,1,0,0,0,1.3, ldraw_lib__s__169675as01(realsolid)],
// 0 BFC CLIP
  [0,"BFC","CLIP"],
...
module ldraw_lib__820673j(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__820673j(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
