...
use <3820.scad>
use <973pg8.scad>
function ldraw_lib__76382pg8() = [
// 0 Minifig Torso with Arms and Hands with Soccer Team Red/Blue Stripes and Red #11 Pattern
// 0 Name: 76382pg8.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973pg8.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973pg8()],
...
module ldraw_lib__76382pg8(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382pg8(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382pg8(line=0.2);