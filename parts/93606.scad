...
use <s/93606s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__93606(realsolid=false) = [
...
// 1 16 20 149.253 40 0 -40 0 -149.253 0 0 0 0 -160 48\1-12cyli.dat
  [1,16,20,149.253,40,0,-40,0,-149.253,0,0,0,0,-160, ldraw_lib__48__1_12cyli(realsolid)],
// 
];
module ldraw_lib__93606(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__93606(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
