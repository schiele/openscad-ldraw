...
use <../p/t01i6000.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4874(realsolid=false) = [
...
// 1 16 0 16 0 20 0 0 0 -16 0 0 0 20 4-4cyli.dat
  [1,16,0,16,0,20,0,0,0,-16,0,0,0,20, ldraw_lib__4_4cyli(realsolid)],
// 
// 1 16 0 16 0 8 0 0 0 -12 0 0 0 8 4-4cylc.dat
  [1,16,0,16,0,8,0,0,0,-12,0,0,0,8, ldraw_lib__4_4cylc(realsolid)],
...
// 1 16 0 16 0 50 0 0 0 53.333 0 0 0 50 t01i6000.dat
  [1,16,0,16,0,50,0,0,0,53.333,0,0,0,50, ldraw_lib__t01i6000(realsolid)],
// 
// 1 16 0 52 0 45 0 0 0 1 0 0 0 45 4-4edge.dat
  [1,16,0,52,0,45,0,0,0,1,0,0,0,45, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 52 0 45 0 0 0 4 0 0 0 45 4-4cyli.dat
  [1,16,0,52,0,45,0,0,0,4,0,0,0,45, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 56 0 45 0 0 0 1 0 0 0 45 4-4edge.dat
  [1,16,0,56,0,45,0,0,0,1,0,0,0,45, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 56 0 1 0 0 0 -1 0 0 0 1 4-4rin45.dat
  [1,16,0,56,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4rin45(realsolid)],
// 1 16 0 56 0 2 0 0 0 -1 0 0 0 2 4-4rin23.dat
  [1,16,0,56,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4rin23(realsolid)],
// 1 16 0 56 0 1 0 0 0 -1 0 0 0 1 4-4rin48.dat
  [1,16,0,56,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4rin48(realsolid)],
// 1 16 0 56 0 49 0 0 0 1 0 0 0 49 4-4edge.dat
  [1,16,0,56,0,49,0,0,0,1,0,0,0,49, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 52 0 49 0 0 0 4 0 0 0 49 4-4cyli.dat
  [1,16,0,52,0,49,0,0,0,4,0,0,0,49, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 52 0 49 0 0 0 1 0 0 0 49 4-4edge.dat
  [1,16,0,52,0,49,0,0,0,1,0,0,0,49, ldraw_lib__4_4edge(realsolid)],
// 
// 1 16 0 26 0 45 0 0 0 46.796 0 0 0 45 t01i5556.dat
  [1,16,0,26,0,45,0,0,0,46.796,0,0,0,45, ldraw_lib__t01i5556(realsolid)],
// 
// 0 // rotation bush
// 1 16 0 26 0 20 0 0 0 1 0 0 0 20 4-4edge.dat
  [1,16,0,26,0,20,0,0,0,1,0,0,0,20, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 26 0 20 0 0 0 12 0 0 0 20 4-4cyli.dat
  [1,16,0,26,0,20,0,0,0,12,0,0,0,20, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 0 16 0 0 0 34 0 0 0 16 4-4cyli.dat
  [1,16,0,4,0,16,0,0,0,34,0,0,0,16, ldraw_lib__4_4cyli(realsolid)],
// 
// 1 16 0 48 80 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,0,48,80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 1 16 0 48 -80 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,0,48,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 1 16 80 48 0 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,80,48,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 1 16 -80 48 0 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,-80,48,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\4874s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4874s01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\4874s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__4874s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\4874s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__4874s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\4874s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__4874s01(realsolid)],
...
module ldraw_lib__4874(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4874(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
