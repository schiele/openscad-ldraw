...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\30459s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30459s01()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30459s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30459s01()],
];
module ldraw_lib__30459(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30459(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
