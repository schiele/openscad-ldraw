...
use <s/4066bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4066bp1f(realsolid=false) = [
...
// 
// 0 !CATEGORY Brick
// 0 !KEYWORDS bricklink 4066pb049, Girls, Grandma, Kitchen, Set 2551
// 
...
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 s\4066bp1bs01.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4066bp1bs01(realsolid)],
// 1 17 0 0 0 1 0 0 0 1 0 0 0 1 s\4066bp1bs02.dat
  [1,17,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4066bp1bs02(realsolid)],
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 s\4066bp1bs03.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4066bp1bs03(realsolid)],
...
module ldraw_lib__4066bp1f(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4066bp1f(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
