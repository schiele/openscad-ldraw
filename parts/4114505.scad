...
use <30153.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4114505(realsolid=false) = [
...
// 1 42 0 0 0 1 0 0 0 1 0 0 0 1 30153.dat
  [1,42,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30153(realsolid)],
];
module ldraw_lib__4114505(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4114505(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
