...
use <104.scad>
$fa=1; $fs=0.2;
function ldraw_lib__71185(realsolid=false) = [
...
// 1 383 0 0 0 1 0 0 0 1 0 0 0 1 104.dat
  [1,383,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__104(realsolid)],
];
module ldraw_lib__71185(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__71185(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
