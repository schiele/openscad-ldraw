...
use <s/4185as01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4185a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\4185as01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4185as01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\4185as01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__4185as01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\4185as01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__4185as01(realsolid)],
...
// 1 16 0 0 -1.625 27.5 0 0 0 0 -27.5 0 3.25 0 48\4-4cylo.dat
  [1,16,0,0,-1.625,27.5,0,0,0,0,-27.5,0,3.25,0, ldraw_lib__48__4_4cylo(realsolid)],
// 4 16 7.926081 -1 -3 5.80115 -1 -5 5.80115 -1 5 7.926081 -1 3
  [4,16,7.926081,-1,-3,5.80115,-1,-5,5.80115,-1,5,7.926081,-1,3],
// 1 16 9.463041 -1 0 1.53696 0 0 0 -1 0 0 0 -3 rect2p.dat
  [1,16,9.463041,-1,0,1.53696,0,0,0,-1,0,0,0,-3, ldraw_lib__rect2p(realsolid)],
// 4 16 7.926081 1 3 5.80115 1 5 5.80115 1 -5 7.926081 1 -3
  [4,16,7.926081,1,3,5.80115,1,5,5.80115,1,-5,7.926081,1,-3],
// 1 16 9.463041 1 0 1.53696 0 0 0 1 0 0 0 -3 rect2p.dat
  [1,16,9.463041,1,0,1.53696,0,0,0,1,0,0,0,-3, ldraw_lib__rect2p(realsolid)],
...
// 1 16 5.701575 -1.5 0 0 1 -0.099575 0 0 -0.5 -5 0 0 rect.dat
  [1,16,5.701575,-1.5,0,0,1,-0.099575,0,0,-0.5,-5,0,0, ldraw_lib__rect(realsolid)],
// 1 16 5.701575 1.5 0 0 1 0.099575 0 0 -0.5 -5 0 0 rect.dat
  [1,16,5.701575,1.5,0,0,1,0.099575,0,0,-0.5,-5,0,0, ldraw_lib__rect(realsolid)],
// 1 16 -5.701575 -1.5 0 0 -1 0.099575 0 0 -0.5 -5 0 0 rect.dat
  [1,16,-5.701575,-1.5,0,0,-1,0.099575,0,0,-0.5,-5,0,0, ldraw_lib__rect(realsolid)],
...
module ldraw_lib__4185a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4185a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
