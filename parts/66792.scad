...
use <../p/stug-2x1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__66792(realsolid=false) = [
...
// 1 16 30 0 -30 0 0 6 0 -1 0 -6 0 0 1-4chrd.dat
  [1,16,30,0,-30,0,0,6,0,-1,0,-6,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -30 0 -30 -6 0 0 0 -1 0 0 0 -6 1-4chrd.dat
  [1,16,-30,0,-30,-6,0,0,0,-1,0,0,0,-6, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -30 0 30 0 0 -6 0 -1 0 6 0 0 1-4chrd.dat
  [1,16,-30,0,30,0,0,-6,0,-1,0,6,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 68869.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__68869(realsolid)],
];
module ldraw_lib__66792(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__66792(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
