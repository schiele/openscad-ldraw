...
use <s/004158c1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__004158c(realsolid=false) = [
...
// 1 16 0 -0.25 0 1 0 0 0 1 0 0 0 1 s\004158c1.dat
  [1,16,0,-0.25,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__004158c1(realsolid)],
// 0 // www.holly-wood.it
// 
...
module ldraw_lib__004158c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__004158c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
