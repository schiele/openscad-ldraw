...
use <s/3817bs03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3817bpde(realsolid=false) = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\3817bs03.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3817bs03(realsolid)],
...
module ldraw_lib__3817bpde(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3817bpde(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
