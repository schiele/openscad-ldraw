...
use <../p/rect.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2412b(realsolid=false) = [
...
// 4 16 20 7 10 20 7 -10 19 7 -9 19 7 9
  [4,16,20,7,10,20,7,-10,19,7,-9,19,7,9],
// 1 16 0 3.5 10 20 0 0 0 0 3.5 0 -1 0 rect.dat
  [1,16,0,3.5,10,20,0,0,0,0,3.5,0,-1,0, ldraw_lib__rect(realsolid)],
...
// 4 16 20 4 6 20 0 6 -20 0 6 -20 4 6
  [4,16,20,4,6,20,0,6,-20,0,6,-20,4,6],
// 1 16 -18 4 4 2 0 0 0 1 0 0 0 2 rect.dat
  [1,16,-18,4,4,2,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 18 4 4 2 0 0 0 1 0 0 0 2 rect.dat
  [1,16,18,4,4,2,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 4 16 20 0 2 20 4 2 -20 4 2 -20 0 2
  [4,16,20,0,2,20,4,2,-20,4,2,-20,0,2],
// 1 16 0 0 0 20 0 0 0 1 0 0 0 2 rect.dat
  [1,16,0,0,0,20,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 4 16 20 4 -2 20 0 -2 -20 0 -2 -20 4 -2
  [4,16,20,4,-2,20,0,-2,-20,0,-2,-20,4,-2],
// 1 16 -18 4 -4 2 0 0 0 1 0 0 0 2 rect.dat
  [1,16,-18,4,-4,2,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
...
module ldraw_lib__2412b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2412b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2412b(line=0.2);