...
// 1 16 36 0 0 0 -72 0 0 0 6 6 0 0 4-4cylo.dat
  [1,16,36,0,0,0,-72,0,0,0,6,6,0,0, ldraw_lib__4_4cylo()],
// 1 16 36 0 0 0 -72 0 0 0 7 7 0 0 4-4cylo.dat
  [1,16,36,0,0,0,-72,0,0,0,7,7,0,0, ldraw_lib__4_4cylo()],
// 1 16 36 0 0 0 -1 0 0 0 1 1 0 0 4-4ring6.dat
  [1,16,36,0,0,0,-1,0,0,0,1,1,0,0, ldraw_lib__4_4ring6()],
// 1 16 -36 0 0 0 1 0 0 0 1 1 0 0 4-4ring6.dat
  [1,16,-36,0,0,0,1,0,0,0,1,1,0,0, ldraw_lib__4_4ring6()],
];
module ldraw_lib__u9290(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9290(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
