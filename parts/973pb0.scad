...
use <s/973s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973pb0(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\973pb0a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973pb0a(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\973pb0a.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__973pb0a(realsolid)],
];
module ldraw_lib__973pb0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973pb0(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__973pb0(line=0.2);