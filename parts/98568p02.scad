...
use <s/98568s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98568p02(realsolid=false) = [
...
// 1 179 0 0 0 1 0 0 0 0.99889 0.04711 0 -0.04711 0.99889 s\98568s02.dat
  [1,179,0,0,0,1,0,0,0,0.99889,0.04711,0,-0.04711,0.99889, ldraw_lib__s__98568s02(realsolid)],
...
module ldraw_lib__98568p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98568p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
