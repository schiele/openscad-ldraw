...
use <6258203l.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2431dt0(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6258203l.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6258203l(realsolid)],
];
module ldraw_lib__2431dt0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2431dt0(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
