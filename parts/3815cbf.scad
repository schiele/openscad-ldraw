...
use <3817pbf.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3815cbf(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3815pbf.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3815pbf(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3816pbf.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816pbf(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3817pbf.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817pbf(realsolid)],
];
module ldraw_lib__3815cbf(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3815cbf(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
