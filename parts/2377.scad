...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2377(realsolid=false) = [
...
// 1 16 8 28 -6 4 0 0 0 0 4 0 4 0 1-4edge.dat
  [1,16,8,28,-6,4,0,0,0,0,4,0,4,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -8 28 -6 -4 0 0 0 0 4 0 4 0 1-4edge.dat
  [1,16,-8,28,-6,-4,0,0,0,0,4,0,4,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 8 28 -10 4 0 0 0 0 4 0 4 0 1-4edge.dat
  [1,16,8,28,-10,4,0,0,0,0,4,0,4,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -8 28 -10 -4 0 0 0 0 4 0 4 0 1-4edge.dat
  [1,16,-8,28,-10,-4,0,0,0,0,4,0,4,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 8 8 -6 4 0 0 0 0 -4 0 4 0 1-4edge.dat
  [1,16,8,8,-6,4,0,0,0,0,-4,0,4,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -8 8 -6 -4 0 0 0 0 -4 0 4 0 1-4edge.dat
  [1,16,-8,8,-6,-4,0,0,0,0,-4,0,4,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 8 8 -10 4 0 0 0 0 -4 0 4 0 1-4edge.dat
  [1,16,8,8,-10,4,0,0,0,0,-4,0,4,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -8 8 -10 -4 0 0 0 0 -4 0 4 0 1-4edge.dat
  [1,16,-8,8,-10,-4,0,0,0,0,-4,0,4,0, ldraw_lib__1_4edge(realsolid)],
// 2 24 12 8 -6 12 28 -6
  [2,24,12,8,-6,12,28,-6],
...
// 1 16 8 28 -6 4 0 0 0 0 4 0 -4 0 1-4ndis.dat
  [1,16,8,28,-6,4,0,0,0,0,4,0,-4,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -8 28 -6 -4 0 0 0 0 4 0 -4 0 1-4ndis.dat
  [1,16,-8,28,-6,-4,0,0,0,0,4,0,-4,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 8 28 -10 4 0 0 0 0 4 0 4 0 1-4ndis.dat
  [1,16,8,28,-10,4,0,0,0,0,4,0,4,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -8 28 -10 -4 0 0 0 0 4 0 4 0 1-4ndis.dat
  [1,16,-8,28,-10,-4,0,0,0,0,4,0,4,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 8 8 -6 4 0 0 0 0 -4 0 -4 0 1-4ndis.dat
  [1,16,8,8,-6,4,0,0,0,0,-4,0,-4,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -8 8 -6 -4 0 0 0 0 -4 0 -4 0 1-4ndis.dat
  [1,16,-8,8,-6,-4,0,0,0,0,-4,0,-4,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 8 8 -10 4 0 0 0 0 -4 0 4 0 1-4ndis.dat
  [1,16,8,8,-10,4,0,0,0,0,-4,0,4,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -8 8 -10 -4 0 0 0 0 -4 0 4 0 1-4ndis.dat
  [1,16,-8,8,-10,-4,0,0,0,0,-4,0,4,0, ldraw_lib__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 8 28 -10 4 0 0 0 0 4 0 4 0 1-4cyli.dat
  [1,16,8,28,-10,4,0,0,0,0,4,0,4,0, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -8 28 -10 -4 0 0 0 0 4 0 4 0 1-4cyli.dat
  [1,16,-8,28,-10,-4,0,0,0,0,4,0,4,0, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 8 8 -10 4 0 0 0 0 -4 0 4 0 1-4cyli.dat
  [1,16,8,8,-10,4,0,0,0,0,-4,0,4,0, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -8 8 -10 -4 0 0 0 0 -4 0 4 0 1-4cyli.dat
  [1,16,-8,8,-10,-4,0,0,0,0,-4,0,4,0, ldraw_lib__1_4cyli(realsolid)],
...
module ldraw_lib__2377(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2377(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
