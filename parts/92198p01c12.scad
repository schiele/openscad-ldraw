...
use <92255.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92198p01c12(realsolid=false) = [
...
// 1 26 0 0 0 1 0 0 0 1 0 0 0 1 92250p01c01.dat
  [1,26,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__92250p01c01(realsolid)],
...
// 1 322 0 -121.9 0.9 1 0 0 0 1 0 0 0 1 24131.dat
  [1,322,0,-121.9,0.9,1,0,0,0,1,0,0,0,1, ldraw_lib__24131(realsolid)],
];
module ldraw_lib__92198p01c12(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92198p01c12(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
