...
use <3081cc01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__73594(realsolid=false) = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 3081cc01.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3081cc01(realsolid)],
];
module ldraw_lib__73594(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73594(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
