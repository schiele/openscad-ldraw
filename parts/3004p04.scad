...
use <3004p03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3004p04(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3004p03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3004p03(realsolid)],
// 0
];
module ldraw_lib__3004p04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3004p04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
