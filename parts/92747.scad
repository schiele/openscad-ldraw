...
// 1 16 0 0 -8 20 0 0 0 0 38.6 0 1 0 48\4-4disc.dat
  [1,16,0,0,-8,20,0,0,0,0,38.6,0,1,0, ldraw_lib__48__4_4disc()],
];
module ldraw_lib__92747(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92747(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
