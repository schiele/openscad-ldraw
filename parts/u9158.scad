...
use <54931.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9158(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 54929c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__54929c01(realsolid)],
// 1 71 38 18 0 0 0 -1 0 1 0 1 0 0 54931.dat
  [1,71,38,18,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__54931(realsolid)],
];
module ldraw_lib__u9158(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9158(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
