...
// 1 494 50 17 97 1 0 0 0 1 0 0 0 -1 u9652.dat
  [1,494,50,17,97,1,0,0,0,1,0,0,0,-1, ldraw_lib__u9652()],
...
// 1 16 0 0 80 1 0 0 0 1 0 0 0 1 4113b.dat
  [1,16,0,0,80,1,0,0,0,1,0,0,0,1, ldraw_lib__4113b()],
];
module ldraw_lib__4110c07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4110c07(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4110c07(line=0.2);