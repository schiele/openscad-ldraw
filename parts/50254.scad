...
use <../p/wpinhole.scad>
$fa=1; $fs=0.2;
function ldraw_lib__50254(realsolid=false) = [
...
// 1 16 0 0 8 1 0 0 0 0 1 0 10 0 wpinhole.dat
  [1,16,0,0,8,1,0,0,0,0,1,0,10,0, ldraw_lib__wpinhole(realsolid)],
...
module ldraw_lib__50254(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__50254(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
