...
use <54703.scad>
use <u9288.scad>
function ldraw_lib__54654c03() = [
// 0 Plane Aft Section  8 x 16 x  7 with Dark Bluish Grey Bottom and White Tip
// 0 Name: 54654c03.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 54701c02, Rebrickable 54701c02
// 
...
// 1 72 0 144 -10 1 0 0 0 1 0 0 0 1 54702.dat
  [1,72,0,144,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__54702()],
...
module ldraw_lib__54654c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__54654c03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__54654c03(line=0.2);