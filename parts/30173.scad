...
use <30173a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30173(realsolid=false) = [
// 0 ~Moved to 30173a
// 0 Name: 30173.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 30173a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30173a(realsolid)],
];
module ldraw_lib__30173(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30173(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
