...
use <../p/tri4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32026(realsolid=false) = [
...
// 1 16 10 8 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,10,8,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -10 8 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-10,8,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 
...
// 1 16 -25 10 -0.5 0 1 0 2 0 0 0 0.5 -5.5 box2-5.dat
  [1,16,-25,10,-0.5,0,1,0,2,0,0,0,0.5,-5.5, ldraw_lib__box2_5(realsolid)],
// 1 16 -25 10 -0.5 0 -1 0 2 0 0 0 0.5 6.5 box2-9.dat
  [1,16,-25,10,-0.5,0,-1,0,2,0,0,0,0.5,6.5, ldraw_lib__box2_9(realsolid)],
// 4 16 -16.5 12 16 -3.5 12 16 -4.5 12 14 -15.5 12 14
  [4,16,-16.5,12,16,-3.5,12,16,-4.5,12,14,-15.5,12,14],
// 2 24 -4.5 8 14 -3.5 8 16
  [2,24,-4.5,8,14,-3.5,8,16],
// 1 16 -10.5 10 15 0 0.5 -5.5 2 0 0 0 -1 0 box2-5.dat
  [1,16,-10.5,10,15,0,0.5,-5.5,2,0,0,0,-1,0, ldraw_lib__box2_5(realsolid)],
// 1 16 -10.5 10 15 0 0.5 6.5 2 0 0 0 1 0 box2-9.dat
  [1,16,-10.5,10,15,0,0.5,6.5,2,0,0,0,1,0, ldraw_lib__box2_9(realsolid)],
// 4 16 3.5 12 16 16.5 12 16 15.5 12 14 4.5 12 14
  [4,16,3.5,12,16,16.5,12,16,15.5,12,14,4.5,12,14],
// 2 24 15.5 8 14 16.5 8 16
  [2,24,15.5,8,14,16.5,8,16],
// 1 16 9.5 10 15 0 0.5 -5.5 2 0 0 0 -1 0 box2-5.dat
  [1,16,9.5,10,15,0,0.5,-5.5,2,0,0,0,-1,0, ldraw_lib__box2_5(realsolid)],
// 1 16 9.5 10 15 0 0.5 6.5 2 0 0 0 1 0 box2-9.dat
  [1,16,9.5,10,15,0,0.5,6.5,2,0,0,0,1,0, ldraw_lib__box2_9(realsolid)],
// 4 16 -3.5 12 -16 -16.5 12 -16 -15.5 12 -14 -4.5 12 -14
  [4,16,-3.5,12,-16,-16.5,12,-16,-15.5,12,-14,-4.5,12,-14],
// 2 24 -15.5 8 -14 -16.5 8 -16
  [2,24,-15.5,8,-14,-16.5,8,-16],
...
// 1 16 25 10 -6 0 0 1 2 0 0 0 1 -0.5 rect3.dat
  [1,16,25,10,-6,0,0,1,2,0,0,0,1,-0.5, ldraw_lib__rect3(realsolid)],
// 
// 1 16 -28 7 15 2 0 2 -2 0 0 0 -7 0 tri4.dat
  [1,16,-28,7,15,2,0,2,-2,0,0,0,-7,0, ldraw_lib__tri4(realsolid)],
// 1 16 -28 7 -8 2 0 2 -2 0 0 0 -7 0 tri4.dat
  [1,16,-28,7,-8,2,0,2,-2,0,0,0,-7,0, ldraw_lib__tri4(realsolid)],
// 1 16 -5 7 -18 0 7 0 -2 0 0 2 0 2 tri4.dat
  [1,16,-5,7,-18,0,7,0,-2,0,0,2,0,2, ldraw_lib__tri4(realsolid)],
// 1 16 18 7 -18 0 7 0 -2 0 0 2 0 2 tri4.dat
  [1,16,18,7,-18,0,7,0,-2,0,0,2,0,2, ldraw_lib__tri4(realsolid)],
// 1 16 25 7 18 0 -7 0 -2 0 0 -2 0 -2 tri4.dat
  [1,16,25,7,18,0,-7,0,-2,0,0,-2,0,-2, ldraw_lib__tri4(realsolid)],
// 1 16 2 7 18 0 -7 0 -2 0 0 -2 0 -2 tri4.dat
  [1,16,2,7,18,0,-7,0,-2,0,0,-2,0,-2, ldraw_lib__tri4(realsolid)],
// 
...
// 1 16 30 2 0 0 -1 0 0 0 5 7 0 0 2-4ndis.dat
  [1,16,30,2,0,0,-1,0,0,0,5,7,0,0, ldraw_lib__2_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 28 2 0 0 2 0 0 0 5 7 0 0 2-4cylo.dat
  [1,16,28,2,0,0,2,0,0,0,5,7,0,0, ldraw_lib__2_4cylo(realsolid)],
// 1 16 29 2 9 1 0 0 0 1 0 0 0 -2 rect.dat
  [1,16,29,2,9,1,0,0,0,1,0,0,0,-2, ldraw_lib__rect(realsolid)],
// 1 16 29 2 -9 1 0 0 0 1 0 0 0 -2 rect.dat
  [1,16,29,2,-9,1,0,0,0,1,0,0,0,-2, ldraw_lib__rect(realsolid)],
// 1 16 27 0 8.5 0 0 1 0 1 0 -2.5 0 0 rect.dat
  [1,16,27,0,8.5,0,0,1,0,1,0,-2.5,0,0, ldraw_lib__rect(realsolid)],
// 1 16 27 0 -8.5 0 0 1 0 1 0 -2.5 0 0 rect.dat
  [1,16,27,0,-8.5,0,0,1,0,1,0,-2.5,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 28 0 0 0 -1 0 0 0 5 6 0 0 2-4ndis.dat
  [1,16,28,0,0,0,-1,0,0,0,5,6,0,0, ldraw_lib__2_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 26 0 0 0 2 0 0 0 5 6 0 0 2-4cylo.dat
  [1,16,26,0,0,0,2,0,0,0,5,6,0,0, ldraw_lib__2_4cylo(realsolid)],
// 1 16 26 0 0 0 1 0 0 0 5 6 0 0 2-4ndis.dat
  [1,16,26,0,0,0,1,0,0,0,5,6,0,0, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 26 10 -8.75 0 1 0 2 0 0 0 0 -2.25 rect1.dat
  [1,16,26,10,-8.75,0,1,0,2,0,0,0,0,-2.25, ldraw_lib__rect1(realsolid)],
// 1 16 26 10 8.75 0 1 0 2 0 0 0 0 -2.25 rect1.dat
  [1,16,26,10,8.75,0,1,0,2,0,0,0,0,-2.25, ldraw_lib__rect1(realsolid)],
...
// 1 16 26 6.5 0 0 -52 0 0 0 -1.5 16 0 0 box4-4a.dat
  [1,16,26,6.5,0,0,-52,0,0,0,-1.5,16,0,0, ldraw_lib__box4_4a(realsolid)],
...
module ldraw_lib__32026(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32026(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
