...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32140(realsolid=false) = [
...
// 1 16 0 10 50 1 0 0 0 -8 0 0 0 1 npeghole.dat
  [1,16,0,10,50,1,0,0,0,-8,0,0,0,1, ldraw_lib__npeghole(realsolid)],
// 1 16 0 -10 50 1 0 0 0 8 0 0 0 1 npeghole.dat
  [1,16,0,-10,50,1,0,0,0,8,0,0,0,1, ldraw_lib__npeghole(realsolid)],
// 1 16 10 10 60 0 0 -1 0 -8 0 1 0 0 npeghole.dat
  [1,16,10,10,60,0,0,-1,0,-8,0,1,0,0, ldraw_lib__npeghole(realsolid)],
// 1 16 10 -10 60 0 0 -1 0 8 0 1 0 0 npeghole.dat
  [1,16,10,-10,60,0,0,-1,0,8,0,1,0,0, ldraw_lib__npeghole(realsolid)],
...
// 1 16 20 -10 60 0 0 9 0 1 0 9 0 0 2-4edge.dat
  [1,16,20,-10,60,0,0,9,0,1,0,9,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 20 10 60 0 0 9 0 1 0 9 0 0 2-4edge.dat
  [1,16,20,10,60,0,0,9,0,1,0,9,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 20 -10 60 0 0 9 0 20 0 9 0 0 2-4cyli.dat
  [1,16,20,-10,60,0,0,9,0,20,0,9,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 9 0 25.5 0 -1 0 0 0 -10 25.5 0 0 rect2p.dat
  [1,16,9,0,25.5,0,-1,0,0,0,-10,25.5,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 14.5 0 51 0 0 -5.5 -10 0 0 0 1 0 rect3.dat
  [1,16,14.5,0,51,0,0,-5.5,-10,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 10 0 69 -10 0 0 0 0 -10 0 -1 0 rect2p.dat
  [1,16,10,0,69,-10,0,0,0,0,-10,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -9 0 30 0 1 0 0 0 -10 -30 0 0 rect2p.dat
  [1,16,-9,0,30,0,1,0,0,0,-10,-30,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 -10 60 -9 0 0 0 20 0 0 0 9 1-4cyli.dat
  [1,16,0,-10,60,-9,0,0,0,20,0,0,0,9, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 20 -10 60 1 0 0 0 1 0 0 0 1 peghole.dat
  [1,16,20,-10,60,1,0,0,0,1,0,0,0,1, ldraw_lib__peghole(realsolid)],
// 1 16 20 10 60 1 0 0 0 -1 0 0 0 1 peghole.dat
  [1,16,20,10,60,1,0,0,0,-1,0,0,0,1, ldraw_lib__peghole(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 -10 20 1 0 0 0 1 0 0 0 1 4-4ring8.dat
  [1,16,0,-10,20,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4ring8(realsolid)],
// 1 16 0 10 20 1 0 0 0 -1 0 0 0 1 4-4ring8.dat
  [1,16,0,10,20,1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4ring8(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 20 -8 60 6 0 0 0 16 0 0 0 6 4-4cyli.dat
  [1,16,20,-8,60,6,0,0,0,16,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 20 -10 60 1 0 0 0 1 0 0 0 1 4-4ring8.dat
  [1,16,20,-10,60,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4ring8(realsolid)],
// 1 16 20 10 60 1 0 0 0 -1 0 0 0 1 4-4ring8.dat
  [1,16,20,10,60,1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4ring8(realsolid)],
...
module ldraw_lib__32140(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32140(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
