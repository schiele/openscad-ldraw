...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3456(realsolid=false) = [
// 0 Plate  6 x 14
// 0 Name: 3456.dat
...
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 136 0 0 0 -4 0 0 0 56 box5.dat
  [1,16,0,8,0,136,0,0,0,-4,0,0,0,56, ldraw_lib__box5(realsolid)],
...
// 4 16 -140 8 60 -136 8 56 -136 8 -56 -140 8 -60
  [4,16,-140,8,60,-136,8,56,-136,8,-56,-140,8,-60],
// 1 16 0 8 0 140 0 0 0 -8 0 0 0 60 box5.dat
  [1,16,0,8,0,140,0,0,0,-8,0,0,0,60, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__3456(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3456(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3456(line=0.2);