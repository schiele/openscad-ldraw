...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u8019(realsolid=false) = [
...
// 1 16 0 23 -10 15 0 0 0 0 16 0 4 0 box4.dat
  [1,16,0,23,-10,15,0,0,0,0,16,0,4,0, ldraw_lib__box4(realsolid)],
...
// 1 16 0 1 -10 20 0 0 0 0 -1 0 3 0 box4o4a.dat
  [1,16,0,1,-10,20,0,0,0,0,-1,0,3,0, ldraw_lib__box4o4a(realsolid)],
// 4 16 20 0 -10 20 2 -10 -20 2 -10 -20 0 -10
  [4,16,20,0,-10,20,2,-10,-20,2,-10,-20,0,-10],
// 
// 1 16 0 41.5 -7 -20 0 0 0 0 0.5 0 1 0 rect3.dat
  [1,16,0,41.5,-7,-20,0,0,0,0,0.5,0,1,0, ldraw_lib__rect3(realsolid)],
// 2 24 20 2 -7 -20 2 -7
  [2,24,20,2,-7,-20,2,-7],
...
// 1 16 0 48 -9.7 20 0 0 0 -1 0 0 0 -2.75 rect3.dat
  [1,16,0,48,-9.7,20,0,0,0,-1,0,0,0,-2.75, ldraw_lib__rect3(realsolid)],
...
// 1 16 -20 24 0.5 0 1 0 0 0 -24 -7.5 0 0 rect2p.dat
  [1,16,-20,24,0.5,0,1,0,0,0,-24,-7.5,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 20 24 0.5 0 -1 0 0 0 -24 7.5 0 0 rect2p.dat
  [1,16,20,24,0.5,0,-1,0,0,0,-24,7.5,0,0, ldraw_lib__rect2p(realsolid)],
// 
// 1 16 18 26 3 0 -2 0 0 0 22 -9 0 0 box2-11.dat
  [1,16,18,26,3,0,-2,0,0,0,22,-9,0,0, ldraw_lib__box2_11(realsolid)],
// 1 16 -18 26 3 0 2 0 0 0 22 9 0 0 box2-11.dat
  [1,16,-18,26,3,0,2,0,0,0,22,9,0,0, ldraw_lib__box2_11(realsolid)],
...
module ldraw_lib__u8019(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8019(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
