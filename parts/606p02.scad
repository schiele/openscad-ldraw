...
use <s/606p02a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__606p02(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\606p01a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__606p01a(realsolid)],
// 1 16 0 0 192 1 0 0 0 1 0 0 0 1 s\606p02a.dat
  [1,16,0,0,192,1,0,0,0,1,0,0,0,1, ldraw_lib__s__606p02a(realsolid)],
...
module ldraw_lib__606p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__606p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
