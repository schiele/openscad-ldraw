...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\93568s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__93568s01()],
// 
// 0 // Pie
...
module ldraw_lib__93568(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__93568(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
