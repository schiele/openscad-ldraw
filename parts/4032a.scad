...
$fa=1; $fs=0.2;
function ldraw_lib__4032a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 4 0 0 0 1 axl5hol8.dat
  [1,16,0,0,0,1,0,0,0,4,0,0,0,1, ldraw_lib__axl5hol8(realsolid)],
...
// 1 16 0 4 0 1 0 0 0 1 0 0 0 1 axl5hol9.dat
  [1,16,0,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl5hol9(realsolid)],
...
module ldraw_lib__4032a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4032a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
