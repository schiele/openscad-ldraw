...
use <../p/stud3a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32202(realsolid=false) = [
// 0 Technic Axle Flexible 16
// 0 Name: 32202.dat
...
// 
// 0 // Skinny Tip
// 1 16 -140 0 0 0 5 0 -1 0 0 0 0 1 stud3a.dat
  [1,16,-140,0,0,0,5,0,-1,0,0,0,0,1, ldraw_lib__stud3a(realsolid)],
// 0 // To flex the 'skinny tip', replace the above line with:
// 0 // 1 16 -156 0 0 0 1 0 -1 0 0 0 0 1 stud3a.dat
// 0 // 1 16 -152 0 0 0 -4 0 4 0 0 0 0 4 4-4cyli.dat
// 0 // 1 16 -148 0 0 0 -4 0 4 0 0 0 0 4 4-4cyli.dat
// 0 // 1 16 -144 0 0 0 -4 0 4 0 0 0 0 4 4-4cyli.dat
// 0 // 1 16 -140 0 0 0 -4 0 4 0 0 0 0 4 4-4cyli.dat
// 
// 0 // Mixed Cylinder & Cross-axle end section
// 1 16 -136 0 0 -1 0 0 0 1 0 0 0 -1 s\faxle1.dat
  [1,16,-136,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__faxle1(realsolid)],
// 1 16 -132 0 0 -1 0 0 0 1 0 0 0 -1 s\faxle2.dat
  [1,16,-132,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__faxle2(realsolid)],
// 1 16 -128 0 0 -1 0 0 0 1 0 0 0 -1 s\faxle3.dat
  [1,16,-128,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__faxle3(realsolid)],
// 1 16 -124 0 0 -1 0 0 0 1 0 0 0 -1 s\faxle4.dat
  [1,16,-124,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__faxle4(realsolid)],
// 1 16 -120 0 0 -1 0 0 0 1 0 0 0 -1 s\faxle5.dat
  [1,16,-120,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__faxle5(realsolid)],
// 
// 0 // Cross axle main section
// 1 16 -120 0 0 0 4 0 -1 0 0 0 0 1 axlehol8.dat
  [1,16,-120,0,0,0,4,0,-1,0,0,0,0,1, ldraw_lib__axlehol8(realsolid)],
// 1 16 -116 0 0 0 4 0 -1 0 0 0 0 1 axlehol8.dat
  [1,16,-116,0,0,0,4,0,-1,0,0,0,0,1, ldraw_lib__axlehol8(realsolid)],
// 1 16 -112 0 0 0 4 0 -1 0 0 0 0 1 axlehol8.dat
  [1,16,-112,0,0,0,4,0,-1,0,0,0,0,1, ldraw_lib__axlehol8(realsolid)],
// 1 16 -108 0 0 0 4 0 -1 0 0 0 0 1 axlehol8.dat
  [1,16,-108,0,0,0,4,0,-1,0,0,0,0,1, ldraw_lib__axlehol8(realsolid)],
// 1 16 -104 0 0 0 4 0 -1 0 0 0 0 1 axlehol8.dat
  [1,16,-104,0,0,0,4,0,-1,0,0,0,0,1, ldraw_lib__axlehol8(realsolid)],
...
module ldraw_lib__32202(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32202(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__32202(line=0.2);