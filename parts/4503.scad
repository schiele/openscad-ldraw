...
use <../p/stud4o.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4503(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\4503s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4503s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\4503s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__4503s01(realsolid)],
// 
...
// 1 16 0 0 0 0 0 13 0 1 0 13 0 0 4-4edge.dat
  [1,16,0,0,0,0,0,13,0,1,0,13,0,0, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -4.2 7 0 0 2 0 -7.8 0 2 0 0 4-4cylc.dat
  [1,16,0,-4.2,7,0,0,2,0,-7.8,0,2,0,0, ldraw_lib__4_4cylc(realsolid)],
// 
...
// 1 16 0 20.8 15.5 3 0 0 0 -1 0 0 0 0.5 rect3.dat
  [1,16,0,20.8,15.5,3,0,0,0,-1,0,0,0,0.5, ldraw_lib__rect3(realsolid)],
// 1 16 0 15.4135 18.1195 0 0 -3 -5.3865 0 0 2.1195 -1 0 rect2p.dat
  [1,16,0,15.4135,18.1195,0,0,-3,-5.3865,0,0,2.1195,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 8.1135 20.6195 0 0 -3 -1.9135 0 0 0.3805 -1 0 rect2p.dat
  [1,16,0,8.1135,20.6195,0,0,-3,-1.9135,0,0,0.3805,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 2.1 21 0 0 3 4.1 0 0 0 -1 0 rect2p.dat
  [1,16,0,2.1,21,0,0,3,4.1,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 3 -2 11 0 -6 0 -10 0 0 0 0 10 1-4cylo.dat
  [1,16,3,-2,11,0,-6,0,-10,0,0,0,0,10, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -2.4 0 -2.9 0 4.8 0 -12 0 0 0 0 -12 1-4cylo.dat
  [1,16,-2.4,0,-2.9,0,4.8,0,-12,0,0,0,0,-12, ldraw_lib__1_4cylo(realsolid)],
// 
...
module ldraw_lib__4503(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4503(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
