...
use <../p/box3u8p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4533(realsolid=false) = [
...
// 1 16 0 36 0 2 0 0 0 1 0 0 0 -2 4-4edge.dat
  [1,16,0,36,0,2,0,0,0,1,0,0,0,-2, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 2 14 44 0 1 0 0 0 -2 2 0 0 2-4edge.dat
  [1,16,2,14,44,0,1,0,0,0,-2,2,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 2 22 44 0 1 0 0 0 2 2 0 0 2-4edge.dat
  [1,16,2,22,44,0,1,0,0,0,2,2,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -2 14 44 0 1 0 2 0 0 0 0 2 4-4edge.dat
  [1,16,-2,14,44,0,1,0,2,0,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 -2 22 44 0 1 0 2 0 0 0 0 2 4-4edge.dat
  [1,16,-2,22,44,0,1,0,2,0,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 4 14 44 0 1 0 2 0 0 0 0 2 4-4disc.dat
  [1,16,4,14,44,0,1,0,2,0,0,0,0,2, ldraw_lib__4_4disc(realsolid)],
// 1 16 4 14 44 0 1 0 0 0 2 -2 0 0 2-4edge.dat
  [1,16,4,14,44,0,1,0,0,0,2,-2,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 4 22 44 0 1 0 2 0 0 0 0 2 4-4disc.dat
  [1,16,4,22,44,0,1,0,2,0,0,0,0,2, ldraw_lib__4_4disc(realsolid)],
// 1 16 4 22 44 0 1 0 0 0 -2 2 0 0 2-4edge.dat
  [1,16,4,22,44,0,1,0,0,0,-2,2,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 2 14 44 0 -1 0 0 0 -2 -2 0 0 2-4ndis.dat
  [1,16,2,14,44,0,-1,0,0,0,-2,-2,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 2 22 44 0 -1 0 0 0 2 2 0 0 2-4ndis.dat
  [1,16,2,22,44,0,-1,0,0,0,2,2,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -2 14 44 0 1 0 2 0 0 0 0 2 4-4ndis.dat
  [1,16,-2,14,44,0,1,0,2,0,0,0,0,2, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -2 22 44 0 1 0 2 0 0 0 0 2 4-4ndis.dat
  [1,16,-2,22,44,0,1,0,2,0,0,0,0,2, ldraw_lib__4_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 4 14 44 0 -6 0 0 0 2 2 0 0 2-4cyli.dat
  [1,16,4,14,44,0,-6,0,0,0,2,2,0,0, ldraw_lib__2_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 4 22 44 0 -6 0 0 0 -2 2 0 0 2-4cyli.dat
  [1,16,4,22,44,0,-6,0,0,0,-2,2,0,0, ldraw_lib__2_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 2 14 44 0 -4 0 0 0 -2 2 0 0 2-4cyli.dat
  [1,16,2,14,44,0,-4,0,0,0,-2,2,0,0, ldraw_lib__2_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 2 22 44 0 -4 0 0 0 2 2 0 0 2-4cyli.dat
  [1,16,2,22,44,0,-4,0,0,0,2,2,0,0, ldraw_lib__2_4cyli(realsolid)],
...
// 1 16 0 36 0 2 0 0 0 -1 0 0 0 2 2-4ndis.dat
  [1,16,0,36,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 0 36 0 -2 0 0 0 1 0 0 0 2 4-8sphe.dat
  [1,16,0,36,0,-2,0,0,0,1,0,0,0,2, ldraw_lib__4_8sphe(realsolid)],
...
// 1 16 0 0 0 2 0 0 0 36 0 0 0 -2 2-4cyli.dat
  [1,16,0,0,0,2,0,0,0,36,0,0,0,-2, ldraw_lib__2_4cyli(realsolid)],
// 1 16 2 18 44 0 4 0 -4 0 0 0 0 2 box3u8p.dat
  [1,16,2,18,44,0,4,0,-4,0,0,0,0,2, ldraw_lib__box3u8p(realsolid)],
...
// 1 16 6 14 44 0 -2 0 0 0 -2 2 0 0 2-4cylc.dat
  [1,16,6,14,44,0,-2,0,0,0,-2,2,0,0, ldraw_lib__2_4cylc(realsolid)],
// 1 16 6 22 44 0 -2 0 0 0 2 -2 0 0 2-4cylc.dat
  [1,16,6,22,44,0,-2,0,0,0,2,-2,0,0, ldraw_lib__2_4cylc(realsolid)],
// 1 16 0 18 2 -2 0 0 0 0 18 0 48 0 box3u4a.dat
  [1,16,0,18,2,-2,0,0,0,0,18,0,48,0, ldraw_lib__box3u4a(realsolid)],
// 2 24 2 0 0 2 0 2
  [2,24,2,0,0,2,0,2],
// 2 24 -2 0 0 -2 0 2
  [2,24,-2,0,0,-2,0,2],
...
module ldraw_lib__4533(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4533(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
