...
use <../p/stud2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__15(realsolid=false) = [
// 0 Minifig Legs Old
// 0 Name: 15.dat
...
// 
// 
// 4 16 -16 32 6 16 32 6 20 32 10 -20 32 10
  [4,16,-16,32,6,16,32,6,20,32,10,-20,32,10],
// 4 16 -16 32 -6 -16 32 6 -20 32 10 -20 32 -10
  [4,16,-16,32,-6,-16,32,6,-20,32,10,-20,32,-10],
// 4 16 16 32 -6 -16 32 -6 -20 32 -10 20 32 -10
...
// 1 16 0 32 0 20 0 0 0 -8 0 0 0 10 box4o4a.dat
  [1,16,0,32,0,20,0,0,0,-8,0,0,0,10, ldraw_lib__box4o4a(realsolid)],
// 1 16 14 28 0 2 0 0 0 -1 0 0 0 6 rect.dat
  [1,16,14,28,0,2,0,0,0,-1,0,0,0,6, ldraw_lib__rect(realsolid)],
// 1 16 -14 28 0 2 0 0 0 -1 0 0 0 6 rect.dat
  [1,16,-14,28,0,2,0,0,0,-1,0,0,0,6, ldraw_lib__rect(realsolid)],
// 1 16 18 24 0 0 0 2 0 1 0 10 0 0 rect3.dat
  [1,16,18,24,0,0,0,2,0,1,0,10,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 -18 24 0 0 0 -2 0 1 0 10 0 0 rect3.dat
  [1,16,-18,24,0,0,0,-2,0,1,0,10,0,0, ldraw_lib__rect3(realsolid)],
// 0
// 4 16 16 24 10 20 0 10 -20 0 10 -16 24 10
  [4,16,16,24,10,20,0,10,-20,0,10,-16,24,10],
// 4 16 -20 0 -10 20 0 -10 16 24 -10 -16 24 -10
  [4,16,-20,0,-10,20,0,-10,16,24,-10,-16,24,-10],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 32 0 16 0 0 0 -4 0 0 0 6 box4o4a.dat
  [1,16,0,32,0,16,0,0,0,-4,0,0,0,6, ldraw_lib__box4o4a(realsolid)],
// 1 16 18 12 0 -2 0 0 12 -1 0 0 0 10 rect.dat
  [1,16,18,12,0,-2,0,0,12,-1,0,0,0,10, ldraw_lib__rect(realsolid)],
// 1 16 -18 12 0 2 0 0 12 -1 0 0 0 10 rect.dat
  [1,16,-18,12,0,2,0,0,12,-1,0,0,0,10, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 0 12 0 0 0 24 0 0 0 6 box4o4a.dat
  [1,16,0,4,0,12,0,0,0,24,0,0,0,6, ldraw_lib__box4o4a(realsolid)],
// 1 16 0 4 0 12 0 0 0 -1 0 0 0 6 rect.dat
  [1,16,0,4,0,12,0,0,0,-1,0,0,0,6, ldraw_lib__rect(realsolid)],
// 0
// 1 16 0 0 0 20 0 0 0 1 0 0 0 10 rect2p.dat
  [1,16,0,0,0,20,0,0,0,1,0,0,0,10, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__15(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__15(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
