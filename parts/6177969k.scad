...
function ldraw_lib__6177969k() = [
// 0 Sticker  0.8 x  1.2 with Headlamp in Grey Trapezoid on Black Background Right
// 0 Name: 6177969k.dat
...
module ldraw_lib__6177969k(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6177969k(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6177969k(line=0.2);