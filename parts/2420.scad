...
// 1 16 20 4 0 0 10 0 4 0 0 0 0 10 box2-5.dat
  [1,16,20,4,0,0,10,0,4,0,0,0,0,10, ldraw_lib__box2_5()],
// 1 16 0 4 20 0 10 0 4 0 0 0 0 10 box2-5.dat
  [1,16,0,4,20,0,10,0,4,0,0,0,0,10, ldraw_lib__box2_5()],
// 1 16 10 4 10 0 -20 0 4 0 0 0 0 -20 box2-5.dat
  [1,16,10,4,10,0,-20,0,4,0,0,0,0,-20, ldraw_lib__box2_5()],
...
// 1 16 0 6 16 0 6 0 2 0 0 0 0 10 box2-5.dat
  [1,16,0,6,16,0,6,0,2,0,0,0,0,10, ldraw_lib__box2_5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 16 6 0 0 10 0 2 0 0 0 0 6 box2-5.dat
  [1,16,16,6,0,0,10,0,2,0,0,0,0,6, ldraw_lib__box2_5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 6 10 0 -16 0 2 0 0 0 0 -16 box2-5.dat
  [1,16,10,6,10,0,-16,0,2,0,0,0,0,-16, ldraw_lib__box2_5()],
// 0
];
module ldraw_lib__2420(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2420(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
