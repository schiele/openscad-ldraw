...
use <4215p05.scad>
$fa=1; $fs=0.2;
function ldraw_lib__80648(realsolid=false) = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 4215p05.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4215p05(realsolid)],
];
module ldraw_lib__80648(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__80648(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
