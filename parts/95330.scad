...
use <s/95330s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__95330(realsolid=false) = [
// 0 Minifig Axe
// 0 Name: 95330.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\95330s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__95330s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\95330s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__95330s02(realsolid)],
...
module ldraw_lib__95330(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__95330(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
