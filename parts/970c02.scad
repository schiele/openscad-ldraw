...
use <3815c02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__970c02(realsolid=false) = [
// 0 ~Moved to 3815c02
// 0 Name: 970c02.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3815c02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3815c02(realsolid)],
];
module ldraw_lib__970c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__970c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
