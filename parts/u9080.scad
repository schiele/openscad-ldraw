...
use <../p/t02o4286.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9080(realsolid=false) = [
// 0 Plant Flat Bush with Hollow Base
// 0 Name: u9080.dat
...
// 1 16 0 -10 0 0.97 0 0 0 0 -0.97 0 1 0 s\u9078s02.dat
  [1,16,0,-10,0,0.97,0,0,0,0,-0.97,0,1,0, ldraw_lib__s__u9078s02(realsolid)],
// 1 16 0 -10 0 0.97 0 0 0 0 -0.97 0 -1 0 s\u9078s01.dat
  [1,16,0,-10,0,0.97,0,0,0,0,-0.97,0,-1,0, ldraw_lib__s__u9078s01(realsolid)],
// 1 16 0 -10 0 0.97 0 0 0 0 -0.97 0 -1 0 s\u9078s02.dat
  [1,16,0,-10,0,0.97,0,0,0,0,-0.97,0,-1,0, ldraw_lib__s__u9078s02(realsolid)],
...
module ldraw_lib__u9080(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9080(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9080(line=0.2);