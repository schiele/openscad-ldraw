...
use <s/3069bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3069bpz5(realsolid=false) = [
...
// 1 4 -7.1 0 2.6 1.5 0 0 0 1 0 0 0 1.5 48\4-4disc.dat
  [1,4,-7.1,0,2.6,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__48__4_4disc(realsolid)],
// 1 4 7.1 0 -2.6 -1.5 0 0 0 1 0 0 0 1.5 48\4-4disc.dat
  [1,4,7.1,0,-2.6,-1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__48__4_4disc(realsolid)],
// 
// 0 // Metallic Gold
// 1 82 -7.1 0 -2.6 1.5 0 0 0 1 0 0 0 1.5 48\4-4disc.dat
  [1,82,-7.1,0,-2.6,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__48__4_4disc(realsolid)],
// 1 82 -12.3 0 2.6 1.5 0 0 0 1 0 0 0 1.5 48\4-4disc.dat
  [1,82,-12.3,0,2.6,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__48__4_4disc(realsolid)],
// 1 82 12.3 0 -2.6 -1.5 0 0 0 1 0 0 0 1.5 48\4-4disc.dat
  [1,82,12.3,0,-2.6,-1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__48__4_4disc(realsolid)],
// 1 82 7.1 0 2.6 -1.5 0 0 0 1 0 0 0 1.5 48\4-4disc.dat
  [1,82,7.1,0,2.6,-1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__48__4_4disc(realsolid)],
...
// 1 85 -12.3 0 -2.6 1.5 0 0 0 1 0 0 0 1.5 48\4-4disc.dat
  [1,85,-12.3,0,-2.6,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__48__4_4disc(realsolid)],
// 1 85 12.3 0 2.6 -1.5 0 0 0 1 0 0 0 1.5 48\4-4disc.dat
  [1,85,12.3,0,2.6,-1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__48__4_4disc(realsolid)],
// 
// 0 // Dark Nougat
...
// 1 128 -7.1 0 2.6 0 0 2 0 1 0 2 0 0 48\1-4ndis.dat
  [1,128,-7.1,0,2.6,0,0,2,0,1,0,2,0,0, ldraw_lib__48__1_4ndis(realsolid)],
// 1 128 -12.3 0 -2.6 0 0 -2 0 1 0 -2 0 0 48\1-4ndis.dat
  [1,128,-12.3,0,-2.6,0,0,-2,0,1,0,-2,0,0, ldraw_lib__48__1_4ndis(realsolid)],
// 1 128 -7.1 0 -2.6 0 0 2 0 1 0 -2 0 0 48\1-4ndis.dat
  [1,128,-7.1,0,-2.6,0,0,2,0,1,0,-2,0,0, ldraw_lib__48__1_4ndis(realsolid)],
// 1 128 -12.3 0 2.6 0 0 -2 0 1 0 2 0 0 48\1-4ndis.dat
  [1,128,-12.3,0,2.6,0,0,-2,0,1,0,2,0,0, ldraw_lib__48__1_4ndis(realsolid)],
// 1 128 -7.1 0 2.6 0 0 -2 0 1 0 2 0 0 48\1-12ndis.dat
  [1,128,-7.1,0,2.6,0,0,-2,0,1,0,2,0,0, ldraw_lib__48__1_12ndis(realsolid)],
// 1 128 -12.3 0 -2.6 0 0 2 0 1 0 -2 0 0 48\1-12ndis.dat
  [1,128,-12.3,0,-2.6,0,0,2,0,1,0,-2,0,0, ldraw_lib__48__1_12ndis(realsolid)],
// 1 128 -7.1 0 -2.6 0 0 -2 0 1 0 -2 0 0 48\1-12ndis.dat
  [1,128,-7.1,0,-2.6,0,0,-2,0,1,0,-2,0,0, ldraw_lib__48__1_12ndis(realsolid)],
// 1 128 -12.3 0 2.6 0 0 2 0 1 0 2 0 0 48\1-12ndis.dat
  [1,128,-12.3,0,2.6,0,0,2,0,1,0,2,0,0, ldraw_lib__48__1_12ndis(realsolid)],
// 1 128 -7.1 0 -2.6 2 0 0 0 1 0 0 0 2 48\1-12ndis.dat
  [1,128,-7.1,0,-2.6,2,0,0,0,1,0,0,0,2, ldraw_lib__48__1_12ndis(realsolid)],
// 1 128 -12.3 0 2.6 -2 0 0 0 1 0 0 0 -2 48\1-12ndis.dat
  [1,128,-12.3,0,2.6,-2,0,0,0,1,0,0,0,-2, ldraw_lib__48__1_12ndis(realsolid)],
// 1 128 -12.3 0 -2.6 -2 0 0 0 1 0 0 0 2 48\1-12ndis.dat
  [1,128,-12.3,0,-2.6,-2,0,0,0,1,0,0,0,2, ldraw_lib__48__1_12ndis(realsolid)],
// 1 128 -7.1 0 2.6 2 0 0 0 1 0 0 0 -2 48\1-12ndis.dat
  [1,128,-7.1,0,2.6,2,0,0,0,1,0,0,0,-2, ldraw_lib__48__1_12ndis(realsolid)],
...
// 1 0 -12.3 0 2.6 0 0 -2 0 1 0 -2 0 0 48\1-6ndis.dat
  [1,0,-12.3,0,2.6,0,0,-2,0,1,0,-2,0,0, ldraw_lib__48__1_6ndis(realsolid)],
// 1 0 -7.1 0 -2.6 0 0 2 0 1 0 2 0 0 48\1-6ndis.dat
  [1,0,-7.1,0,-2.6,0,0,2,0,1,0,2,0,0, ldraw_lib__48__1_6ndis(realsolid)],
// 1 0 -7.1 0 2.6 0 0 -2 0 1 0 -2 0 0 48\1-4ndis.dat
  [1,0,-7.1,0,2.6,0,0,-2,0,1,0,-2,0,0, ldraw_lib__48__1_4ndis(realsolid)],
// 1 0 -12.3 0 -2.6 0 0 2 0 1 0 2 0 0 48\1-4ndis.dat
  [1,0,-12.3,0,-2.6,0,0,2,0,1,0,2,0,0, ldraw_lib__48__1_4ndis(realsolid)],
// 1 0 -12.3 0 -2.6 0 0 -2 0 1 0 2 0 0 48\1-6ndis.dat
  [1,0,-12.3,0,-2.6,0,0,-2,0,1,0,2,0,0, ldraw_lib__48__1_6ndis(realsolid)],
// 1 0 -7.1 0 2.6 0 0 2 0 1 0 -2 0 0 48\1-6ndis.dat
  [1,0,-7.1,0,2.6,0,0,2,0,1,0,-2,0,0, ldraw_lib__48__1_6ndis(realsolid)],
...
// 1 0 -7.1 0 -2.6 -2 0 0 0 1 0 0 0 -2 48\1-6ndis.dat
  [1,0,-7.1,0,-2.6,-2,0,0,0,1,0,0,0,-2, ldraw_lib__48__1_6ndis(realsolid)],
// 1 0 -7.1 0 2.6 -2 0 0 0 1 0 0 0 2 48\1-6ndis.dat
  [1,0,-7.1,0,2.6,-2,0,0,0,1,0,0,0,2, ldraw_lib__48__1_6ndis(realsolid)],
// 1 0 -12.3 0 -2.6 2 0 0 0 1 0 0 0 -2 48\1-6ndis.dat
  [1,0,-12.3,0,-2.6,2,0,0,0,1,0,0,0,-2, ldraw_lib__48__1_6ndis(realsolid)],
// 1 0 -12.3 0 2.6 2 0 0 0 1 0 0 0 2 48\1-6ndis.dat
  [1,0,-12.3,0,2.6,2,0,0,0,1,0,0,0,2, ldraw_lib__48__1_6ndis(realsolid)],
// 1 0 -7.1 0 -2.6 .5 0 0 0 1 0 0 0 .5 48\4-4ring3.dat
  [1,0,-7.1,0,-2.6,.5,0,0,0,1,0,0,0,.5, ldraw_lib__48__4_4ring3(realsolid)],
// 1 0 -12.3 0 -2.6 .5 0 0 0 1 0 0 0 .5 48\4-4ring3.dat
  [1,0,-12.3,0,-2.6,.5,0,0,0,1,0,0,0,.5, ldraw_lib__48__4_4ring3(realsolid)],
// 1 0 -7.1 0 2.6 .5 0 0 0 1 0 0 0 .5 48\4-4ring3.dat
  [1,0,-7.1,0,2.6,.5,0,0,0,1,0,0,0,.5, ldraw_lib__48__4_4ring3(realsolid)],
// 1 0 -12.3 0 2.6 .5 0 0 0 1 0 0 0 .5 48\4-4ring3.dat
  [1,0,-12.3,0,2.6,.5,0,0,0,1,0,0,0,.5, ldraw_lib__48__4_4ring3(realsolid)],
...
module ldraw_lib__3069bpz5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3069bpz5(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3069bpz5(line=0.2);