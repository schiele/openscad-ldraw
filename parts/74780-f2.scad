...
use <2911.scad>
$fa=1; $fs=0.2;
function ldraw_lib__74780_f2(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2881a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2881a(realsolid)],
// 
...
// 1 16 0 0 69.5 1 0 0 0 1 0 0 0 1 2882.dat
  [1,16,0,0,69.5,1,0,0,0,1,0,0,0,1, ldraw_lib__2882(realsolid)],
// 
// 0 // Top
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2880a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2880a(realsolid)],
];
module ldraw_lib__74780_f2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__74780_f2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
