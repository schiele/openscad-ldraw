...
use <53933p01.scad>
use <53934p01.scad>
function ldraw_lib__53934p01c01() = [
...
// 1 16 0 64 0 1 0 0 0 1 0 0 0 1 53934p01.dat
  [1,16,0,64,0,1,0,0,0,1,0,0,0,1, ldraw_lib__53934p01()],
];
module ldraw_lib__53934p01c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__53934p01c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
