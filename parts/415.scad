...
use <6217.scad>
$fa=1; $fs=0.2;
function ldraw_lib__415(realsolid=false) = [
// 0 ~Moved to 6217
// 0 Name: 415.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6217.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6217(realsolid)],
];
module ldraw_lib__415(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__415(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
