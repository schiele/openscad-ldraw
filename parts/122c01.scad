...
use <422.scad>
use <u9132c01.scad>
function ldraw_lib__122c01() = [
// 0 Plate  2 x  2 with Red Wheels (Complete)
// 0 Name: 122c01.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 422.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__422()],
// 1 4 0 6 0 1 0 0 0 1 0 0 0 1 u9132c01.dat
  [1,4,0,6,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9132c01()],
// 0
];
module ldraw_lib__122c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__122c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__122c01(line=0.2);