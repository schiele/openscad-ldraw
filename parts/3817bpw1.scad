...
use <s/3817bs01.scad>
function ldraw_lib__3817bpw1() = [
// 0 ~Minifig Leg Left with Red/White Triangles Pattern (Obsolete)
// 0 Name: 3817bpw1.dat
...
// 0 !HISTORY 2023-02-03 [Holly-Wood] Obsoleted for bad geometry. Use 3817cpw1 instead.
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\3817bpw1s02.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3817bpw1s02()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3817bpw1s03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3817bpw1s03()],
];
module ldraw_lib__3817bpw1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3817bpw1(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3817bpw1(line=0.2);