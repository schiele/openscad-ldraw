...
use <u9103.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u595p01c05(realsolid=false) = [
// 0 _Figure Fabuland Monkey  1 with Body Blue/Red/Red
// 0 Name: u595p01c05.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Achille, Mark Affe, Mark Monkey, Marquitos el Mono, Set 3604
// 
...
// 1 508 0 -67 4 1 0 0 0 1 0 0 0 1 u595p01c01.dat
  [1,508,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u595p01c01(realsolid)],
...
module ldraw_lib__u595p01c05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u595p01c05(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u595p01c05(line=0.2);