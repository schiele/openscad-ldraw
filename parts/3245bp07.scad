...
$fa=1; $fs=0.2;
function ldraw_lib__3245bp07(realsolid=false) = [
...
// 1 16 0 20 -10 16.5 0 0 0 0 -16.5 0 1 0 4-4ndis.dat
  [1,16,0,20,-10,16.5,0,0,0,0,-16.5,0,1,0, ldraw_lib__4_4ndis(realsolid)],
...
// 1 15 0 20 -10 1 0 0 0 0 -1 0 1 0 s\4150p03s01.dat
  [1,15,0,20,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__s__4150p03s01(realsolid)],
];
module ldraw_lib__3245bp07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3245bp07(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
