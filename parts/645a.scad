...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__645a(realsolid=false) = [
// 0 ~Window  1 x  6 x  2 Classic with Solid Studs
// 0 Name: 645a.dat
...
// 1 16 40 0 -4 1 0 0 0 1 0 0 0 1 4-4edge.dat
  [1,16,40,0,-4,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4edge(realsolid)],
// 1 16 40 0 -4 1 0 0 0 1 0 0 0 1 4-4ndis.dat
  [1,16,40,0,-4,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 40 3 -4 1 0 0 0 -1 0 0 0 1 4-4ndis.dat
  [1,16,40,3,-4,1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 40 3 -4 1 0 0 0 -3 0 0 0 1 4-4cyli.dat
  [1,16,40,3,-4,1,0,0,0,-3,0,0,0,1, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -40 0 -4 1 0 0 0 1 0 0 0 1 4-4edge.dat
  [1,16,-40,0,-4,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4edge(realsolid)],
// 1 16 -40 0 -4 1 0 0 0 1 0 0 0 1 4-4ndis.dat
  [1,16,-40,0,-4,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4ndis(realsolid)],
...
module ldraw_lib__645a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__645a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__645a(line=0.2);