...
function ldraw_lib__6177970yc01() = [
// 0 Sticker  0.8 x  1.6 with Black and Grey Headlamp on Red Background Left (Formed)
// 0 Name: 6177970yc01.dat
...
module ldraw_lib__6177970yc01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6177970yc01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6177970yc01(line=0.2);