...
use <s/2335s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2335p42(realsolid=false) = [
...
// 1 16 2 20 10 0 0 -1 -1 0 0 0 1 0 s\2335p42s01.dat
  [1,16,2,20,10,0,0,-1,-1,0,0,0,1,0, ldraw_lib__s__2335p42s01(realsolid)],
// 1 16 -2 20 10 0 0 1 1 0 0 0 1 0 s\2335p42s01.dat
  [1,16,-2,20,10,0,0,1,1,0,0,0,1,0, ldraw_lib__s__2335p42s01(realsolid)],
];
module ldraw_lib__2335p42(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2335p42(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
