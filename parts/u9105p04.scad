...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9105s10.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9105s10()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9105s10.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9105s10()],
// 0 // Whiskers
...
module ldraw_lib__u9105p04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9105p04(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
