...
use <s/4873s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6140(realsolid=false) = [
...
// 1 16 30 4 0 4 0 0 0 -4 0 0 0 -4 4-4cyli.dat
  [1,16,30,4,0,4,0,0,0,-4,0,0,0,-4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 30 4 0 4 0 0 0 1 0 0 0 4 4-4disc.dat
  [1,16,30,4,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4disc(realsolid)],
// 1 16 30 8 0 6 0 0 0 -1 0 0 0 -6 4-4disc.dat
  [1,16,30,8,0,6,0,0,0,-1,0,0,0,-6, ldraw_lib__4_4disc(realsolid)],
...
// 1 16 10 4 0 4 0 0 0 -4 0 0 0 -4 4-4cyli.dat
  [1,16,10,4,0,4,0,0,0,-4,0,0,0,-4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 10 4 0 4 0 0 0 1 0 0 0 4 4-4disc.dat
  [1,16,10,4,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4disc(realsolid)],
// 1 16 10 8 0 6 0 0 0 -1 0 0 0 -6 4-4disc.dat
  [1,16,10,8,0,6,0,0,0,-1,0,0,0,-6, ldraw_lib__4_4disc(realsolid)],
// 1 16 -10 4 0 4 0 0 0 -1 0 0 0 -4 4-4edge.dat
  [1,16,-10,4,0,4,0,0,0,-1,0,0,0,-4, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__6140(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6140(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
