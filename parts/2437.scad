...
use <s/2437s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2437(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2437s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2437s01(realsolid)],
// 4 16 -30 24 -30 30 24 -30 30 0 -10 -30 0 -10
  [4,16,-30,24,-30,30,24,-30,30,0,-10,-30,0,-10],
// 
// 1 16 30 0 0 0 0 10 0 24 0 -10 -20 0 1-4cyli.dat
  [1,16,30,0,0,0,0,10,0,24,0,-10,-20,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 30 24 -20 0 0 10 0 8 0 -10 0 0 1-4cyli.dat
  [1,16,30,24,-20,0,0,10,0,8,0,-10,0,0, ldraw_lib__1_4cyli(realsolid)],
...
module ldraw_lib__2437(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2437(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
