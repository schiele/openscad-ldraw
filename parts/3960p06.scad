...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3960pb003, Radar Dish, Rebrickable 3960pr9986, Round
// 0 !KEYWORDS Set 10041, Space
// 
// 0 !CMDLINE -c15
// 
...
module ldraw_lib__3960p06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3960p06(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
