...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Brickheadz, BrickLink 3010pb207, Captain America
// 0 !KEYWORDS Rebrickable 3010pr0013, Set 41589
// 
...
// 1 16 0 0 -10 1 0 0 0 1 0 0 0 1 s\3010pz5s01.dat
  [1,16,0,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010pz5s01()],
// 1 16 0 0 -10 -1 0 0 0 1 0 0 0 1 s\3010pz5s01.dat
  [1,16,0,0,-10,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010pz5s01()],
];
module ldraw_lib__3010pz5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3010pz5(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
