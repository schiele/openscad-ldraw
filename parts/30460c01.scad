...
use <6029a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30460c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 30460.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30460(realsolid)],
// 1 15 0 -25.278 -27 1 0 0 0 1 0 0 0 1 6029a.dat
  [1,15,0,-25.278,-27,1,0,0,0,1,0,0,0,1, ldraw_lib__6029a(realsolid)],
// 
];
module ldraw_lib__30460c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30460c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
