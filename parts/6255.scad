...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6255(realsolid=false) = [
...
// 1 16 0 0 0 0 0 6 0 -1 0 -6 0 0 4-4disc.dat
  [1,16,0,0,0,0,0,6,0,-1,0,-6,0,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 0 0 0 1 0 -4 0 -1 0 0 stud4.dat
  [1,16,0,0,0,0,0,1,0,-4,0,-1,0,0, ldraw_lib__stud4(realsolid)],
// 1 16 12.56 -12.35 -7.25 -0.87 0 -0.5 0 1 0 0.5 0 -0.87 s\6255s01.dat
  [1,16,12.56,-12.35,-7.25,-0.87,0,-0.5,0,1,0,0.5,0,-0.87, ldraw_lib__s__6255s01(realsolid)],
// 1 16 12.56 -12.35 -7.25 -1.53 -4.29 -0.94 -0.64 13.63 0 0.88 2.48 -1.63 48\4-4cyli.dat
  [1,16,12.56,-12.35,-7.25,-1.53,-4.29,-0.94,-0.64,13.63,0,0.88,2.48,-1.63, ldraw_lib__48__4_4cyli(realsolid)],
// 1 16 -14.12 -17 -8.15 0.87 0 -0.5 0 1 0 0.5 0 0.87 s\6255s01.dat
  [1,16,-14.12,-17,-8.15,0.87,0,-0.5,0,1,0,0.5,0,0.87, ldraw_lib__s__6255s01(realsolid)],
// 1 16 -14.12 -17 -8.15 1.53 5.63 -0.94 -0.64 17.85 0 0.88 3.25 1.63 48\4-4cyli.dat
  [1,16,-14.12,-17,-8.15,1.53,5.63,-0.94,-0.64,17.85,0,0.88,3.25,1.63, ldraw_lib__48__4_4cyli(realsolid)],
// 1 16 0 -22 18 0 0 1 0 1 0 -1 0 0 s\6255s01.dat
  [1,16,0,-22,18,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__6255s01(realsolid)],
// 1 16 0 -22 18 0 0 1.88 -0.64 23.02 0 -1.77 -8.38 0 48\4-4cyli.dat
  [1,16,0,-22,18,0,0,1.88,-0.64,23.02,0,-1.77,-8.38,0, ldraw_lib__48__4_4cyli(realsolid)],
...
// 1 16 0 0 10 1.88 0 0 0 5 0 0 0 1.88 2-4cyli.dat
  [1,16,0,0,10,1.88,0,0,0,5,0,0,0,1.88, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 5 10 1.88 0 0 0 -1 0 0 0 1.88 2-4edge.dat
  [1,16,0,5,10,1.88,0,0,0,-1,0,0,0,1.88, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 0 10 -1.88 0 0 0 -1 0 0 0 -2 2-4edge.dat
  [1,16,0,0,10,-1.88,0,0,0,-1,0,0,0,-2, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 5 10 1.88 0 0 0 -1 0 0 0 1.88 2-4disc.dat
  [1,16,0,5,10,1.88,0,0,0,-1,0,0,0,1.88, ldraw_lib__2_4disc(realsolid)],
...
// 1 16 8.66 0 -5 -0.94 0 1.63 0 5 0 -1.63 0 -0.94 2-4cyli.dat
  [1,16,8.66,0,-5,-0.94,0,1.63,0,5,0,-1.63,0,-0.94, ldraw_lib__2_4cyli(realsolid)],
// 1 16 8.66 5 -5 -0.94 0 1.63 0 -1 0 -1.63 0 -0.94 2-4edge.dat
  [1,16,8.66,5,-5,-0.94,0,1.63,0,-1,0,-1.63,0,-0.94, ldraw_lib__2_4edge(realsolid)],
// 1 16 8.66 0 -5 0.94 0 -1.73 0 -1 0 1.63 0 1 2-4edge.dat
  [1,16,8.66,0,-5,0.94,0,-1.73,0,-1,0,1.63,0,1, ldraw_lib__2_4edge(realsolid)],
// 1 16 8.66 5 -5 -0.94 0 1.63 0 -1 0 -1.63 0 -0.94 2-4disc.dat
  [1,16,8.66,5,-5,-0.94,0,1.63,0,-1,0,-1.63,0,-0.94, ldraw_lib__2_4disc(realsolid)],
...
module ldraw_lib__6255(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6255(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
