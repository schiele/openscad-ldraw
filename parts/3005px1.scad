...
use <s/3005s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3005px1(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3005pb046, Mario, Nintendo, Set 71380
// 
...
module ldraw_lib__3005px1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3005px1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
