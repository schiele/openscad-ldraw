...
use <s/92252s04.scad>
$fa=1; $fs=0.2;
function ldraw_lib__20380p01(realsolid=false) = [
...
// 1 462 0 0 0 1 0 0 0 1 0 0 0 1 s\20380s02.dat
  [1,462,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__20380s02(realsolid)],
...
// 1 84 0 0 0 1 0 0 0 1 0 0 0 1 s\20380p01s01.dat
  [1,84,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__20380p01s01(realsolid)],
// 1 82 0 0 0 1 0 0 0 1 0 0 0 1 s\20380p01s02.dat
  [1,82,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__20380p01s02(realsolid)],
...
module ldraw_lib__20380p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__20380p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
