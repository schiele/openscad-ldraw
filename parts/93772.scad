...
use <92240p01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__93772(realsolid=false) = [
...
// 1 78 0 0 0 1 0 0 0 1 0 0 0 1 92240p01.dat
  [1,78,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__92240p01(realsolid)],
];
module ldraw_lib__93772(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__93772(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
