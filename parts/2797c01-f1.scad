...
use <2799c01.scad>
use <70450a.scad>
function ldraw_lib__2797c01_f1() = [
...
// 1 0 0 -140 0 1 0 0 0 1 0 0 0 1 2799c01.dat
  [1,0,0,-140,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2799c01()],
// 1 494 0 -127 0 1 0 0 0 1 0 0 0 1 70450a.dat
  [1,494,0,-127,0,1,0,0,0,1,0,0,0,1, ldraw_lib__70450a()],
];
module ldraw_lib__2797c01_f1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2797c01_f1(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
