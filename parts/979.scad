...
// 1 0 0 -28 0 1 0 0 0 1 0 0 0 1 3817.dat
  [1,0,0,-28,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817()],
// 1 0 0 -28 0 1 0 0 0 1 0 0 0 1 3816.dat
  [1,0,0,-28,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816()],
// 1 0 0 -40 0 1 0 0 0 1 0 0 0 1 3815.dat
  [1,0,0,-40,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3815()],
// 0 // torso
// 1 1 0 -72 0 1 0 0 0 1 0 0 0 1 973.dat
  [1,1,0,-72,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973()],
// 0 // head
// 1 14 0 -100 0 1 0 0 0 1 0 0 0 1 3626bp01.dat
  [1,14,0,-100,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3626bp01()],
// 0 // hat
// 1 4 0 -100 0 1 0 0 0 1 0 0 0 1 3624.dat
  [1,4,0,-100,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3624()],
// 0 // airtank
// 1 2 0 -74 0 1 0 0 0 1 0 0 0 1 3838.dat
  [1,2,0,-74,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3838()],
// 0 // arms
// 1 4 -15.552 -63 0 0.9855 -0.1699 0 0.1699 0.9855 0 0 0 1 3818.dat
  [1,4,-15.552,-63,0,0.9855,-0.1699,0,0.1699,0.9855,0,0,0,1, ldraw_lib__3818()],
// 1 4 15.552 -63 0 0.9855 0.1699 0 -0.1699 0.9855 0 0 0 1 3819.dat
  [1,4,15.552,-63,0,0.9855,0.1699,0,-0.1699,0.9855,0,0,0,1, ldraw_lib__3819()],
// 0 // Right Hand
// 1 14 -23.552 -46 -10 0.942 0.335 0.0072 -0.2404 0.6906 -0.6821 -0.2336 0.6409 0.7312 3820.dat
  [1,14,-23.552,-46,-10,0.942,0.335,0.0072,-0.2404,0.6906,-0.6821,-0.2336,0.6409,0.7312, ldraw_lib__3820()],
// 0 // Left Hand
// 1 14 23.552 -46 -10 0.942 -0.335 0.0072 0.2404 0.6906 -0.6821 0.2336 0.6409 0.7312 3820.dat
  [1,14,23.552,-46,-10,0.942,-0.335,0.0072,0.2404,0.6906,-0.6821,0.2336,0.6409,0.7312, ldraw_lib__3820()],
// 0
...
module ldraw_lib__979(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__979(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
