...
use <s/4181s02.scad>
use <../p/stud2.scad>
function ldraw_lib__4181p06() = [
// 0 Train Door  1 x  4 x  5 Left with Red/Blue Stripe Pattern
// 0 Name: 4181p06.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Rebrickable 4181pr0006, Set 5580
// 
...
module ldraw_lib__4181p06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4181p06(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4181p06(line=0.2);