...
use <s/92252s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92251(realsolid=false) = [
// 0 Figure Friends Legs with Cropped Trousers
// 0 Name: 92251.dat
...
module ldraw_lib__92251(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92251(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__92251(line=0.2);