...
use <s/4218s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4218b(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\4218s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4218s01(realsolid)],
// 
// 1 16 -80 0 0 0 1 0 3.69552 0 1.53073 -1.53073 0 3.69552 1-8ndis.dat
  [1,16,-80,0,0,0,1,0,3.69552,0,1.53073,-1.53073,0,3.69552, ldraw_lib__1_8ndis(realsolid)],
...
// 1 16 -77.5 9.523935 -2.5 0 0 -2.5 -6.476065 0 0 0 1 0 recte3.dat
  [1,16,-77.5,9.523935,-2.5,0,0,-2.5,-6.476065,0,0,0,1,0, ldraw_lib__recte3(realsolid)],
// 1 16 -77.5 9.523935 2.5 0 0 -2.5 -6.476065 0 0 0 1 0 recte3.dat
  [1,16,-77.5,9.523935,2.5,0,0,-2.5,-6.476065,0,0,0,1,0, ldraw_lib__recte3(realsolid)],
// 
// 1 16 -77.5 16 0 0 0 -2.5 0 -1 0 -2.5 0 0 rect2p.dat
  [1,16,-77.5,16,0,0,0,-2.5,0,-1,0,-2.5,0,0, ldraw_lib__rect2p(realsolid)],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -75 20 0 0 -1 0 2.5 0 0 0 0 2.5 bump5000.dat
  [1,16,-75,20,0,0,-1,0,2.5,0,0,0,0,2.5, ldraw_lib__bump5000(realsolid)],
// 1 16 -75 20 0 0 1 0 2.5 0 0 0 0 2.5 4-4ndis.dat
  [1,16,-75,20,0,0,1,0,2.5,0,0,0,0,2.5, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 0 4 0 0 0 75 0 1 0 2.5 0 0 rect2p.dat
  [1,16,0,4,0,0,0,75,0,1,0,2.5,0,0, ldraw_lib__rect2p(realsolid)],
// 
// 1 16 0 3.523935 2.5 75 0 0 0 0 0.476065 0 -1 0 recte3.dat
  [1,16,0,3.523935,2.5,75,0,0,0,0,0.476065,0,-1,0, ldraw_lib__recte3(realsolid)],
// 1 16 0 3.523935 -2.5 75 0 0 0 0 0.476065 0 -1 0 recte3.dat
  [1,16,0,3.523935,-2.5,75,0,0,0,0,0.476065,0,-1,0, ldraw_lib__recte3(realsolid)],
// 
...
// 1 16 -18.4375 14 -2.5 17.1875 0 0 0 0 -7.5 0 1.25 0 box5.dat
  [1,16,-18.4375,14,-2.5,17.1875,0,0,0,0,-7.5,0,1.25,0, ldraw_lib__box5(realsolid)],
...
// 1 16 75 23.25 0 0 -1 0 0 0 0.75 -2.5 0 0 2-4disc.dat
  [1,16,75,23.25,0,0,-1,0,0,0,0.75,-2.5,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 -75 23.25 0 0 150 0 0 0 0.75 -2.5 0 0 2-4cylc.dat
  [1,16,-75,23.25,0,0,150,0,0,0,0.75,-2.5,0,0, ldraw_lib__2_4cylc(realsolid)],
];
module ldraw_lib__4218b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4218b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
