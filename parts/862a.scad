...
$fa=1; $fs=0.2;
function ldraw_lib__862a(realsolid=false) = [
...
// 1 16 -18.5 0 0 3.3 0 0 0 1 0 0 0 1 s\3241s03.dat
  [1,16,-18.5,0,0,3.3,0,0,0,1,0,0,0,1, ldraw_lib__s__3241s03(realsolid)],
// 1 16 18.5 0 0 3.3 0 0 0 1 0 0 0 1 s\3241s03.dat
  [1,16,18.5,0,0,3.3,0,0,0,1,0,0,0,1, ldraw_lib__s__3241s03(realsolid)],
...
// 1 16 -148 12 0 2 0 0 0 4 0 0 0 -2 boxjcyl4.dat
  [1,16,-148,12,0,2,0,0,0,4,0,0,0,-2, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 -132 12 0 -2 0 0 0 4 0 0 0 2 boxjcyl4.dat
  [1,16,-132,12,0,-2,0,0,0,4,0,0,0,2, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 -108 12 0 2 0 0 0 4 0 0 0 -2 boxjcyl4.dat
  [1,16,-108,12,0,2,0,0,0,4,0,0,0,-2, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 -92 12 0 -2 0 0 0 4 0 0 0 2 boxjcyl4.dat
  [1,16,-92,12,0,-2,0,0,0,4,0,0,0,2, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 -88 12 0 2 0 0 0 4 0 0 0 -2 boxjcyl4.dat
  [1,16,-88,12,0,2,0,0,0,4,0,0,0,-2, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 -72 12 0 -2 0 0 0 4 0 0 0 2 boxjcyl4.dat
  [1,16,-72,12,0,-2,0,0,0,4,0,0,0,2, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 -28 12 0 2 0 0 0 4 0 0 0 -2 boxjcyl4.dat
  [1,16,-28,12,0,2,0,0,0,4,0,0,0,-2, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 -12 12 0 -2 0 0 0 4 0 0 0 2 boxjcyl4.dat
  [1,16,-12,12,0,-2,0,0,0,4,0,0,0,2, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 -8 12 0 2 0 0 0 4 0 0 0 -2 boxjcyl4.dat
  [1,16,-8,12,0,2,0,0,0,4,0,0,0,-2, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 8 12 0 -2 0 0 0 4 0 0 0 2 boxjcyl4.dat
  [1,16,8,12,0,-2,0,0,0,4,0,0,0,2, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 12 12 0 2 0 0 0 4 0 0 0 -2 boxjcyl4.dat
  [1,16,12,12,0,2,0,0,0,4,0,0,0,-2, ldraw_lib__boxjcyl4(realsolid)],
...
// 1 16 -152 12 0 4 0 0 0 4 0 0 0 -2 box3u5p.dat
  [1,16,-152,12,0,4,0,0,0,4,0,0,0,-2, ldraw_lib__box3u5p(realsolid)],
// 1 16 152 12 0 -4 0 0 0 4 0 0 0 2 box3u5p.dat
  [1,16,152,12,0,-4,0,0,0,4,0,0,0,2, ldraw_lib__box3u5p(realsolid)],
// 1 16 -10 12 0 2 0 0 0 4 0 0 0 -2 box3u8p.dat
  [1,16,-10,12,0,2,0,0,0,4,0,0,0,-2, ldraw_lib__box3u8p(realsolid)],
// 1 16 10 12 0 2 0 0 0 4 0 0 0 -2 box3u8p.dat
  [1,16,10,12,0,2,0,0,0,4,0,0,0,-2, ldraw_lib__box3u8p(realsolid)],
// 1 16 -50 12 0 22 0 0 0 4 0 0 0 -2 box3u8p.dat
  [1,16,-50,12,0,22,0,0,0,4,0,0,0,-2, ldraw_lib__box3u8p(realsolid)],
// 1 16 50 12 0 22 0 0 0 4 0 0 0 -2 box3u8p.dat
  [1,16,50,12,0,22,0,0,0,4,0,0,0,-2, ldraw_lib__box3u8p(realsolid)],
// 1 16 -90 12 0 2 0 0 0 4 0 0 0 -2 box3u8p.dat
  [1,16,-90,12,0,2,0,0,0,4,0,0,0,-2, ldraw_lib__box3u8p(realsolid)],
// 1 16 90 12 0 2 0 0 0 4 0 0 0 -2 box3u8p.dat
  [1,16,90,12,0,2,0,0,0,4,0,0,0,-2, ldraw_lib__box3u8p(realsolid)],
// 1 16 -120 12 0 12 0 0 0 4 0 0 0 -2 box3u8p.dat
  [1,16,-120,12,0,12,0,0,0,4,0,0,0,-2, ldraw_lib__box3u8p(realsolid)],
// 1 16 120 12 0 12 0 0 0 4 0 0 0 -2 box3u8p.dat
  [1,16,120,12,0,12,0,0,0,4,0,0,0,-2, ldraw_lib__box3u8p(realsolid)],
...
// 1 16 0 4 12 2 0 0 0 -4 0 0 0 4 box.dat
  [1,16,0,4,12,2,0,0,0,-4,0,0,0,4, ldraw_lib__box(realsolid)],
// 1 494 -2 4 -12 0 4 0 0 0 -4 4 0 0 box4o8a.dat
  [1,494,-2,4,-12,0,4,0,0,0,-4,4,0,0, ldraw_lib__box4o8a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 494 -2 4 -12 0 4 0 0 0 -3.75 3.75 0 0 box4o8a.dat
  [1,494,-2,4,-12,0,4,0,0,0,-3.75,3.75,0,0, ldraw_lib__box4o8a(realsolid)],
// 1 16 0 10 16 2 0 0 0 0 6 0 4 0 box3u8p.dat
  [1,16,0,10,16,2,0,0,0,0,6,0,4,0, ldraw_lib__box3u8p(realsolid)],
// 1 16 0 10 -16 2 0 0 0 0 -6 0 -4 0 box3u8p.dat
  [1,16,0,10,-16,2,0,0,0,0,-6,0,-4,0, ldraw_lib__box3u8p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 16 0 2 0 0 0 -4 0 0 0 16 box3u8p.dat
  [1,16,0,16,0,2,0,0,0,-4,0,0,0,16, ldraw_lib__box3u8p(realsolid)],
];
module ldraw_lib__862a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__862a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
