...
// 0 !KEYWORDS BrickLink 16497pb03, Rebrickable 16497pr0003, Set 75134
// 
...
module ldraw_lib__16497p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__16497p02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
