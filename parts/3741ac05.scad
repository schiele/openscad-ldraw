...
use <95831.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3741ac05(realsolid=false) = [
...
// 1 16 0 -15.696 14.456 1 0 0 0 0.96593 0.25882 0 -0.25882 0.96593 95831.dat
  [1,16,0,-15.696,14.456,1,0,0,0,0.96593,0.25882,0,-0.25882,0.96593, ldraw_lib__95831(realsolid)],
// 1 16 -13.64 -20.526 -7.875 -0.5 0.22414 -0.83652 0 0.96593 0.25882 0.86603 0.12941 -0.48296 95831.dat
  [1,16,-13.64,-20.526,-7.875,-0.5,0.22414,-0.83652,0,0.96593,0.25882,0.86603,0.12941,-0.48296, ldraw_lib__95831(realsolid)],
// 1 16 14.761 -25.356 -8.522 -0.5 -0.22414 0.83652 0 0.96593 0.25882 -0.86603 0.12941 -0.48296 95831.dat
  [1,16,14.761,-25.356,-8.522,-0.5,-0.22414,0.83652,0,0.96593,0.25882,-0.86603,0.12941,-0.48296, ldraw_lib__95831(realsolid)],
];
module ldraw_lib__3741ac05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3741ac05(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
