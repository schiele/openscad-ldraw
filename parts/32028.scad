...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32028(realsolid=false) = [
...
// 1 16 0 4 -16 20 0 0 0 0 4 0 -3 0 box5-4a.dat
  [1,16,0,4,-16,20,0,0,0,0,4,0,-3,0, ldraw_lib__box5_4a(realsolid)],
...
// 1 16 0 1.5 -10 20 0 0 0 0 -1.5 0 1 0 rect.dat
  [1,16,0,1.5,-10,20,0,0,0,0,-1.5,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 6.5 -10 -20 0 0 0 0 1.5 0 1 0 rect.dat
  [1,16,0,6.5,-10,-20,0,0,0,0,1.5,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 1.5 -16 -20 0 0 0 0 -1.5 0 -1 0 rect.dat
  [1,16,0,1.5,-16,-20,0,0,0,0,-1.5,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 6.5 -16 20 0 0 0 0 1.5 0 -1 0 rect.dat
  [1,16,0,6.5,-16,20,0,0,0,0,1.5,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 4 -16 20 0 0 0 0 -1 0 6 0 box4o8a.dat
  [1,16,0,4,-16,20,0,0,0,0,-1,0,6,0, ldraw_lib__box4o8a(realsolid)],
// 0
];
module ldraw_lib__32028(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32028(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
