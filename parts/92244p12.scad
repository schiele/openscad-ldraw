use <../lib.scad>
use <s/92244p12s02.scad>
use <s/92244s01.scad>
use <s/92244s03.scad>
use <s/92244s04.scad>
use <s/92244s05.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92244p12(realsolid=false) = [
// 0 Figure Friends Female Left Arm with Gold Flame and Swirls Tattoo Pattern
// 0 Name: 92244p12.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\92244p12s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92244p12s02(realsolid)],
...
module ldraw_lib__92244p12(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92244p12(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__92244p12(line=0.2);