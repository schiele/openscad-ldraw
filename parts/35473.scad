...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__35473(realsolid=false) = [
...
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\35473s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__35473s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 -1 0 0 s\35473s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,-1,0,0, ldraw_lib__s__35473s01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 1 0 0 s\35473s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,1,0,0, ldraw_lib__s__35473s01(realsolid)],
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\35473s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__35473s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\35473s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__35473s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\35473s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__35473s01(realsolid)],
...
// 1 16 0 3 0 1 0 0 0 -3.25 0 0 0 -1 stud4.dat
  [1,16,0,3,0,1,0,0,0,-3.25,0,0,0,-1, ldraw_lib__stud4(realsolid)],
...
module ldraw_lib__35473(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__35473(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
