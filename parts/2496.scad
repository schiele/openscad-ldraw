...
// 1 16 18 0 0 0 6 0 10 0 0 0 0 10 4-4cylc.dat
  [1,16,18,0,0,0,6,0,10,0,0,0,0,10, ldraw_lib__4_4cylc()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 22 0 0 0 2 0 5 0 0 0 0 5 4-4cylc.dat
  [1,16,22,0,0,0,2,0,5,0,0,0,0,5, ldraw_lib__4_4cylc()],
// 1 16 18 0 0 0 -11 0 2 0 0 0 0 2 4-4cylo.dat
  [1,16,18,0,0,0,-11,0,2,0,0,0,0,2, ldraw_lib__4_4cylo()],
// 1 16 7 0 0 0 -14 0 4 0 0 0 0 4 4-4cylc.dat
  [1,16,7,0,0,0,-14,0,4,0,0,0,0,4, ldraw_lib__4_4cylc()],
// 1 16 -18 0 0 0 11 0 2 0 0 0 0 2 4-4cylo.dat
  [1,16,-18,0,0,0,11,0,2,0,0,0,0,2, ldraw_lib__4_4cylo()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 -7 0 0 0 1 0 4 0 0 0 0 4 4-4disc.dat
  [1,16,-7,0,0,0,1,0,4,0,0,0,0,4, ldraw_lib__4_4disc()],
// 
// 1 16 24 0 0 0 -1 0 -5 0 0 0 0 5 4-4ring1.dat
  [1,16,24,0,0,0,-1,0,-5,0,0,0,0,5, ldraw_lib__4_4ring1()],
// 1 16 -24 0 0 0 1 0 -5 0 0 0 0 -5 4-4ring1.dat
  [1,16,-24,0,0,0,1,0,-5,0,0,0,0,-5, ldraw_lib__4_4ring1()],
];
module ldraw_lib__2496(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2496(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
