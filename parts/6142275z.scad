...
function ldraw_lib__6142275z() = [
// 0 Sticker  1.9 x  0.8 with Red "P1" and Grey Triangle on Black Background Right
// 0 Name: 6142275z.dat
...
// 1 16 0 0 13.8547 1 0 0 0 1 0 0 0 1 s\6142275zs02.dat
  [1,16,0,0,13.8547,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6142275zs02()],
...
module ldraw_lib__6142275z(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6142275z(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6142275z(line=0.2);