...
use <122c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__122(realsolid=false) = [
// 0 ~Moved to 122c01
// 0 Name: 122.dat
// 0 Author: [PTadmin]
...
module ldraw_lib__122(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__122(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__122(line=0.2);