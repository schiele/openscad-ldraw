...
use <32192.scad>
$fa=1; $fs=0.2;
function ldraw_lib__924(realsolid=false) = [
// 0 ~Moved to 32192
// 0 Name: 924.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 32192.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32192(realsolid)],
];
module ldraw_lib__924(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__924(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
