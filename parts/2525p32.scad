...
use <s/2525s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2525p32(realsolid=false) = [
...
// 1 16 2 48 70 0 -1 0 0 0 -1 1 0 0 s\2525p32a.dat
  [1,16,2,48,70,0,-1,0,0,0,-1,1,0,0, ldraw_lib__s__2525p32a(realsolid)],
// 1 16 -2 48 70 0 1 0 0 0 -1 1 0 0 s\2525p32a.dat
  [1,16,-2,48,70,0,1,0,0,0,-1,1,0,0, ldraw_lib__s__2525p32a(realsolid)],
];
module ldraw_lib__2525p32(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2525p32(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
