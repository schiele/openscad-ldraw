...
use <../p/stud3a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3703(realsolid=false) = [
...
// 1 16 -140 18 0 1 0 0 0 -1.5 0 0 0 1 stud3a.dat
  [1,16,-140,18,0,1,0,0,0,-1.5,0,0,0,1, ldraw_lib__stud3a(realsolid)],
// 1 16 -140 18 0 1 0 0 0 1 0 0 0 1 cylj4x8.dat
  [1,16,-140,18,0,1,0,0,0,1,0,0,0,1, ldraw_lib__cylj4x8(realsolid)],
...
// 1 16 140 10 10 1 0 0 0 0 1 0 -1 0 peghole.dat
  [1,16,140,10,10,1,0,0,0,0,1,0,-1,0, ldraw_lib__peghole(realsolid)],
// 1 16 140 10 -10 1 0 0 0 0 1 0 1 0 peghole.dat
  [1,16,140,10,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__peghole(realsolid)],
...
// 1 16 130 10 0 2 0 0 0 -6 0 0 0 6 box5-4a.dat
  [1,16,130,10,0,2,0,0,0,-6,0,0,0,6, ldraw_lib__box5_4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -10 10 0 2 0 0 0 -6 0 0 0 6 box5-4a.dat
  [1,16,-10,10,0,2,0,0,0,-6,0,0,0,6, ldraw_lib__box5_4a(realsolid)],
...
// 1 16 152 14 0 0 0 4 0 -10 0 -6 0 0 box2-5.dat
  [1,16,152,14,0,0,0,4,0,-10,0,-6,0,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -152 14 0 0 0 -4 0 -10 0 6 0 0 box2-5.dat
  [1,16,-152,14,0,0,0,-4,0,-10,0,6,0,0, ldraw_lib__box2_5(realsolid)],
...
// 1 16 140 10 6 8 0 0 0 0 8 0 -12 0 2-4cyli.dat
  [1,16,140,10,6,8,0,0,0,0,8,0,-12,0, ldraw_lib__2_4cyli(realsolid)],
...
// 1 16 148 7 0 0 -1 0 -3 0 0 0 0 -6 rect2p.dat
  [1,16,148,7,0,0,-1,0,-3,0,0,0,0,-6, ldraw_lib__rect2p(realsolid)],
// 1 16 -148 7 0 0 1 0 -3 0 0 0 0 6 rect2p.dat
  [1,16,-148,7,0,0,1,0,-3,0,0,0,0,6, ldraw_lib__rect2p(realsolid)],
...
// 1 16 140 10 6 8 0 0 0 0 8 0 1 0 2-4ndis.dat
  [1,16,140,10,6,8,0,0,0,0,8,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 140 10 -6 8 0 0 0 0 8 0 -1 0 2-4ndis.dat
  [1,16,140,10,-6,8,0,0,0,0,8,0,-1,0, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 140 10 8 6 0 0 0 0 6 0 -16 0 4-4cyli.dat
  [1,16,140,10,8,6,0,0,0,0,6,0,-16,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 140 10 6 8 0 0 0 0 8 0 -1 0 2-4edge.dat
  [1,16,140,10,6,8,0,0,0,0,8,0,-1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 140 10 -6 8 0 0 0 0 8 0 -1 0 2-4edge.dat
  [1,16,140,10,-6,8,0,0,0,0,8,0,-1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -60 10 6 8 0 0 0 0 8 0 -1 0 2-4edge.dat
  [1,16,-60,10,6,8,0,0,0,0,8,0,-1,0, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 0 24 0 0 0 -160 0 -24 0 -10 0 0 box3u2p.dat
  [1,16,0,24,0,0,0,-160,0,-24,0,-10,0,0, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 140 10 10 8 0 0 0 0 8 0 -1 0 4-4ndis.dat
  [1,16,140,10,10,8,0,0,0,0,8,0,-1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 140 10 -10 8 0 0 0 0 8 0 1 0 4-4ndis.dat
  [1,16,140,10,-10,8,0,0,0,0,8,0,1,0, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 150 0 0 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,150,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
...
module ldraw_lib__3703(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3703(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
