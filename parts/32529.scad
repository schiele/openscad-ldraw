...
// 1 16 0 26 10 -10 0 0 0 0 10 0 1 0 2-4edge.dat
  [1,16,0,26,10,-10,0,0,0,0,10,0,1,0, ldraw_lib__2_4edge()],
// 1 16 0 26 -10 -10 0 0 0 0 10 0 1 0 2-4edge.dat
  [1,16,0,26,-10,-10,0,0,0,0,10,0,1,0, ldraw_lib__2_4edge()],
// 1 16 0 26 -10 -2 0 0 0 0 2 0 1 0 2-4ring4.dat
  [1,16,0,26,-10,-2,0,0,0,0,2,0,1,0, ldraw_lib__2_4ring4()],
// 1 16 0 26 10 2 0 0 0 0 2 0 -1 0 2-4ring4.dat
  [1,16,0,26,10,2,0,0,0,0,2,0,-1,0, ldraw_lib__2_4ring4()],
// 1 16 0 26 10 -1 0 0 0 0 -1 0 -1 0 2-4ring8.dat
  [1,16,0,26,10,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__2_4ring8()],
// 1 16 0 26 -10 1 0 0 0 0 -1 0 1 0 2-4ring8.dat
  [1,16,0,26,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__2_4ring8()],
// 1 16 0 26 -10 -10 0 0 0 0 10 0 20 0 2-4cyli.dat
  [1,16,0,26,-10,-10,0,0,0,0,10,0,20,0, ldraw_lib__2_4cyli()],
// 1 16 10 15 0 0 -1 0 11 0 0 0 0 10 rect2p.dat
  [1,16,10,15,0,0,-1,0,11,0,0,0,0,10, ldraw_lib__rect2p()],
// 1 16 -10 15 0 0 1 0 11 0 0 0 0 -10 rect2p.dat
  [1,16,-10,15,0,0,1,0,11,0,0,0,0,-10, ldraw_lib__rect2p()],
...
// 1 16 0 26 -10 -1 0 0 0 0 1 0 1 0 peghole.dat
  [1,16,0,26,-10,-1,0,0,0,0,1,0,1,0, ldraw_lib__peghole()],
// 1 16 0 26 10 -1 0 0 0 0 1 0 -1 0 peghole.dat
  [1,16,0,26,10,-1,0,0,0,0,1,0,-1,0, ldraw_lib__peghole()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 26 -8 -6 0 0 0 0 6 0 16 0 4-4cyli.dat
  [1,16,0,26,-8,-6,0,0,0,0,6,0,16,0, ldraw_lib__4_4cyli()],
...
// 1 16 0 4 0 0 0 20 0 -4 0 10 0 0 box5-4a.dat
  [1,16,0,4,0,0,0,20,0,-4,0,10,0,0, ldraw_lib__box5_4a()],
// 1 16 18 4 0 0 0 -2 0 4 0 10 0 0 box5-4a.dat
  [1,16,18,4,0,0,0,-2,0,4,0,10,0,0, ldraw_lib__box5_4a()],
// 1 16 -18 4 0 0 0 2 0 4 0 -10 0 0 box5-4a.dat
  [1,16,-18,4,0,0,0,2,0,4,0,-10,0,0, ldraw_lib__box5_4a()],
// 1 16 13 4 0 3 0 0 0 -1 0 0 0 10 rect.dat
  [1,16,13,4,0,3,0,0,0,-1,0,0,0,10, ldraw_lib__rect()],
// 1 16 -13 4 0 3 0 0 0 -1 0 0 0 -10 rect.dat
  [1,16,-13,4,0,3,0,0,0,-1,0,0,0,-10, ldraw_lib__rect()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 10 -10 6.36 0 0 0 0 -6 0 12 0 box4-4a.dat
  [1,16,0,10,-10,6.36,0,0,0,0,-6,0,12,0, ldraw_lib__box4_4a()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 10 10 -6.36 0 0 0 0 -6 0 -4 0 box4-4a.dat
  [1,16,0,10,10,-6.36,0,0,0,0,-6,0,-4,0, ldraw_lib__box4_4a()],
...
// 1 16 0 16 10 -1 0 0 0 0 1 0 -4 0 npeghol7.dat
  [1,16,0,16,10,-1,0,0,0,0,1,0,-4,0, ldraw_lib__npeghol7()],
// 1 16 0 16 -10 1 0 0 0 0 1 0 12 0 npeghol7.dat
  [1,16,0,16,-10,1,0,0,0,0,1,0,12,0, ldraw_lib__npeghol7()],
// 0
];
module ldraw_lib__32529(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32529(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
