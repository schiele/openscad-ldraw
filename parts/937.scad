...
// 1 16 0 1 0 13 0 0 0 1 0 0 0 3.5 box.dat
  [1,16,0,1,0,13,0,0,0,1,0,0,0,3.5, ldraw_lib__box()],
// 1 16 1.75 -5 0 0 0 0.75 0 -5 0 2.5 0 0 box2-5.dat
  [1,16,1.75,-5,0,0,0,0.75,0,-5,0,2.5,0,0, ldraw_lib__box2_5()],
// 1 16 -1.75 -5 0 0 0 -0.75 0 -5 0 -2.5 0 0 box2-5.dat
  [1,16,-1.75,-5,0,0,0,-0.75,0,-5,0,-2.5,0,0, ldraw_lib__box2_5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -10 0 0 0.5 -0.5 0 0.5 0.5 2.5 0 0 box2-5.dat
  [1,16,0,-10,0,0,0.5,-0.5,0,0.5,0.5,2.5,0,0, ldraw_lib__box2_5()],
...
module ldraw_lib__937(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__937(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
