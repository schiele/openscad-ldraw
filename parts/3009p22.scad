...
use <s/3009s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3009p22(realsolid=false) = [
...
// 4 16 57.5 0 -10 57.5 8 -10 60 24 -10 60 0 -10
  [4,16,57.5,0,-10,57.5,8,-10,60,24,-10,60,0,-10],
// 4 16 -57.5 8 -10 -60 24 -10 60 24 -10 57.5 8 -10
  [4,16,-57.5,8,-10,-60,24,-10,60,24,-10,57.5,8,-10],
// 
...
module ldraw_lib__3009p22(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3009p22(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
