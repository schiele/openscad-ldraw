...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3660bp02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3660bp02()],
];
module ldraw_lib__3660p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3660p02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
