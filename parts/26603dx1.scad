...
use <6288456c.scad>
$fa=1; $fs=0.2;
function ldraw_lib__26603dx1(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 26603.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__26603(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6288456c.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6288456c(realsolid)],
];
module ldraw_lib__26603dx1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__26603dx1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
