...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 93081a, Friends
// 
...
// 1 16 0 -5 0 2 0 0 0 -1 0 0 0 2 4-4ring1.dat
  [1,16,0,-5,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring1()],
...
// 1 16 0 -5 0 2 0 0 0 -5.3 0 0 0 2 4-4cyli.dat
  [1,16,0,-5,0,2,0,0,0,-5.3,0,0,0,2, ldraw_lib__4_4cyli()],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\95828s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__95828s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\95828s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__95828s01()],
...
module ldraw_lib__95828(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__95828(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
