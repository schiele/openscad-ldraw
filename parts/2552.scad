...
use <../p/stug-6x1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2552(realsolid=false) = [
...
// 1 16 -140 -144 -80 1 0 0 0 1 0 0 0 1 stug-1x11.dat
  [1,16,-140,-144,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x11(realsolid)],
...
// 1 16 -150 -144 -240 1 0 0 0 1 0 0 0 1 stug-1x6.dat
  [1,16,-150,-144,-240,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x6(realsolid)],
// 1 16 -100 -144 -220 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-100,-144,-220,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 0 //
// 0 // Inside
...
// 1 16 306 0 -326 4 0 0 0 1 0 0 0 -4 1-4disc.dat
  [1,16,306,0,-326,4,0,0,0,1,0,0,0,-4, ldraw_lib__1_4disc(realsolid)],
// 0 //
// 0 // Bottom Perimeter
...
module ldraw_lib__2552(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2552(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2552(line=0.2);