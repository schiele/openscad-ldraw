...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__93219(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\93219s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__93219s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\93219s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__93219s01(realsolid)],
// 1 16 0 -8.5 0 -6 0 0 0 -1 0 0 0 6 4-4disc.dat
  [1,16,0,-8.5,0,-6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 -8.5 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,-8.5,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -8.5 0 6 0 0 0 4.5 0 0 0 6 4-4cyli.dat
  [1,16,0,-8.5,0,6,0,0,0,4.5,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 4 0 1 0 0 0 -4.5 0 0 0 1 2-4con12.dat
  [1,16,0,4,0,1,0,0,0,-4.5,0,0,0,1, ldraw_lib__2_4con12(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 0 1 0 0 0 -4.5 0 0 0 -1 3-16con12.dat
  [1,16,0,4,0,1,0,0,0,-4.5,0,0,0,-1, ldraw_lib__3_16con12(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 0 -1 0 0 0 -4.5 0 0 0 -1 3-16con12.dat
  [1,16,0,4,0,-1,0,0,0,-4.5,0,0,0,-1, ldraw_lib__3_16con12(realsolid)],
...
module ldraw_lib__93219(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__93219(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
