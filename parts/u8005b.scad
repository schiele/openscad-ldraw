...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u8005b(realsolid=false) = [
...
// 1 16 0 24 0 0 0 -76 0 -20 0 16 0 0 box4-1.dat
  [1,16,0,24,0,0,0,-76,0,-20,0,16,0,0, ldraw_lib__box4_1(realsolid)],
// 1 16 80 12 0 0 -160 0 -12 0 0 0 0 20 box3u2p.dat
  [1,16,80,12,0,0,-160,0,-12,0,0,0,0,20, ldraw_lib__box3u2p(realsolid)],
// 4 16 -80 0 20 76 0 20 76 0 -20 -80 0 -20
  [4,16,-80,0,20,76,0,20,76,0,-20,-80,0,-20],
// 1 16 60 0 0 0 0 -1 0 1 0 1 0 0 slotm.dat
  [1,16,60,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__slotm(realsolid)],
// 0
...
module ldraw_lib__u8005b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8005b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
