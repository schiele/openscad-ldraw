...
use <u9288.scad>
$fa=1; $fs=0.2;
function ldraw_lib__54654c04(realsolid=false) = [
...
// 1 25 0 144 -10 1 0 0 0 1 0 0 0 1 54702.dat
  [1,25,0,144,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__54702(realsolid)],
...
module ldraw_lib__54654c04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__54654c04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__54654c04(line=0.2);