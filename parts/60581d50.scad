...
use <6074343n.scad>
$fa=1; $fs=0.2;
function ldraw_lib__60581d50(realsolid=false) = [
...
// 1 16 0 36 10 -1 0 0 0 0 -1 0 -1 0 6074343n.dat
  [1,16,0,36,10,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__6074343n(realsolid)],
];
module ldraw_lib__60581d50(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__60581d50(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
