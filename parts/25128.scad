...
use <s/25128s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__25128(realsolid=false) = [
// 0 Minifig Baby Body
// 0 Name: 25128.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\25128s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__25128s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\25128s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__25128s02(realsolid)],
...
module ldraw_lib__25128(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__25128(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
