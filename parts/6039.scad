...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6039(realsolid=false) = [
...
// 1 16 0 38 16 12.28 0 0 0 0 2 0 1 0 rect3.dat
  [1,16,0,38,16,12.28,0,0,0,0,2,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 -16 38 0 0 -1 0 0 0 2 12.28 0 0 rect3.dat
  [1,16,-16,38,0,0,-1,0,0,0,2,12.28,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 38 -16 12.28 0 0 0 0 2 0 -1 0 rect3.dat
  [1,16,0,38,-16,12.28,0,0,0,0,2,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 16 38 0 0 1 0 0 0 2 12.28 0 0 rect3.dat
  [1,16,16,38,0,0,1,0,0,0,2,12.28,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 32 16 0 0 6.6 -4 0 0 0 1 0 rect1.dat
  [1,16,0,32,16,0,0,6.6,-4,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
// 1 16 -16 32 0 0 -1 0 -4 0 0 0 0 6.6 rect1.dat
  [1,16,-16,32,0,0,-1,0,-4,0,0,0,0,6.6, ldraw_lib__rect1(realsolid)],
// 1 16 0 32 -16 0 0 -6.6 -4 0 0 0 -1 0 rect1.dat
  [1,16,0,32,-16,0,0,-6.6,-4,0,0,0,-1,0, ldraw_lib__rect1(realsolid)],
// 1 16 16 32 0 0 1 0 -4 0 0 0 0 -6.6 rect1.dat
  [1,16,16,32,0,0,1,0,-4,0,0,0,0,-6.6, ldraw_lib__rect1(realsolid)],
...
// 1 16 0 36 20 8.28 0 0 0 0 4 0 -1 0 rect.dat
  [1,16,0,36,20,8.28,0,0,0,0,4,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 -20 36 0 0 1 0 0 0 4 8.28 0 0 rect.dat
  [1,16,-20,36,0,0,1,0,0,0,4,8.28,0,0, ldraw_lib__rect(realsolid)],
// 1 16 0 36 -20 -8.28 0 0 0 0 4 0 1 0 rect.dat
  [1,16,0,36,-20,-8.28,0,0,0,0,4,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 20 36 0 0 -1 0 0 0 4 -8.28 0 0 rect.dat
  [1,16,20,36,0,0,-1,0,0,0,4,-8.28,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 0 16 0 1 0 0 0 1 0 0 0 1 axlehol2.dat
  [1,16,0,16,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axlehol2(realsolid)],
// 1 16 0 32 0 1 0 0 0 16 0 0 0 1 axlehol3.dat
  [1,16,0,32,0,1,0,0,0,16,0,0,0,1, ldraw_lib__axlehol3(realsolid)],
...
// 1 16 0 16 0 1 0 0 0 16 0 0 0 1 axlehole.dat
  [1,16,0,16,0,1,0,0,0,16,0,0,0,1, ldraw_lib__axlehole(realsolid)],
// 1 16 0 10 0 8 0 0 0 22 0 0 0 8 4-4cyli.dat
  [1,16,0,10,0,8,0,0,0,22,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 32 0 1 0 0 0 -2 0 0 0 1 stud4a.dat
  [1,16,0,32,0,1,0,0,0,-2,0,0,0,1, ldraw_lib__stud4a(realsolid)],
...
// 1 16 -11.3 32 11.3 4.7 0 0 0 0 4 4.7 1 0 rect.dat
  [1,16,-11.3,32,11.3,4.7,0,0,0,0,4,4.7,1,0, ldraw_lib__rect(realsolid)],
// 1 16 -11.3 32 -11.3 -4.7 -1 0 0 0 4 4.7 0 0 rect.dat
  [1,16,-11.3,32,-11.3,-4.7,-1,0,0,0,4,4.7,0,0, ldraw_lib__rect(realsolid)],
// 1 16 11.3 32 -11.3 -4.7 0 0 0 0 4 -4.7 -1 0 rect.dat
  [1,16,11.3,32,-11.3,-4.7,0,0,0,0,4,-4.7,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 11.3 32 11.3 4.7 1 0 0 0 4 -4.7 0 0 rect.dat
  [1,16,11.3,32,11.3,4.7,1,0,0,0,4,-4.7,0,0, ldraw_lib__rect(realsolid)],
...
module ldraw_lib__6039(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6039(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6039(line=0.2);