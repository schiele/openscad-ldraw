...
// 1 16 0 -0.25 0 1 0 0 0 1 0 0 0 1 s\003238s6.dat
  [1,16,0,-0.25,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__003238s6()],
// 1 16 0 -0.25 0 -1 0 0 0 1 0 0 0 1 s\003238s6.dat
  [1,16,0,-0.25,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__003238s6()],
];
module ldraw_lib__003238c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__003238c(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
