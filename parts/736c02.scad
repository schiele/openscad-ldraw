...
use <736c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__736c02(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 736c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__736c01(realsolid)],
// 1 4 0 39 -140 0 0 -1 0 1 0 -1 0 0 735.dat
  [1,4,0,39,-140,0,0,-1,0,1,0,-1,0,0, ldraw_lib__735(realsolid)],
// 1 1 0 39 140 0 0 1 0 1 0 1 0 0 735.dat
  [1,1,0,39,140,0,0,1,0,1,0,1,0,0, ldraw_lib__735(realsolid)],
];
module ldraw_lib__736c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__736c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
