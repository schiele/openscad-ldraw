...
$fa=1; $fs=0.2;
function ldraw_lib__191925a(realsolid=false) = [
// 0 Sticker  2.4 x  2 with White German Railways Logo and "7750"
// 0 Name: 191925a.dat
...
// 1 16 0 -0.25 -20 0.415 0 0 0 1 0 0 0 0.415 s\191925s01.dat
  [1,16,0,-0.25,-20,0.415,0,0,0,1,0,0,0,0.415, ldraw_lib__s__191925s01(realsolid)],
...
module ldraw_lib__191925a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__191925a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__191925a(line=0.2);