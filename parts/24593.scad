...
use <s/24593s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__24593(realsolid=false) = [
...
// 1 16 0 44 0 40 0 0 0 -44 0 0 0 -40 48\2-4cyli.dat
  [1,16,0,44,0,40,0,0,0,-44,0,0,0,-40, ldraw_lib__48__2_4cyli(realsolid)],
// 1 16 0 44 0 -24.3504 0 31.7342 0 4 0 -31.7342 0 -24.3504 48\5-24cyli.dat
  [1,16,0,44,0,-24.3504,0,31.7342,0,4,0,-31.7342,0,-24.3504, ldraw_lib__48__5_24cyli(realsolid)],
];
module ldraw_lib__24593(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__24593(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
