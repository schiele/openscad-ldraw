...
use <s/4865p01c.scad>
$fa=1; $fs=0.2;
function ldraw_lib__168225d(realsolid=false) = [
...
// 1 16 0 -.25 0 3.6 0 0 0 0 1 0 3.6 0 s\4865p01b.dat
  [1,16,0,-.25,0,3.6,0,0,0,0,1,0,3.6,0, ldraw_lib__s__4865p01b(realsolid)],
// 1 0 0 -.25 0 3.6 0 0 0 0 1 0 3.6 0 s\4865p01c.dat
  [1,0,0,-.25,0,3.6,0,0,0,0,1,0,3.6,0, ldraw_lib__s__4865p01c(realsolid)],
// 
// 1 16 0 -.25 0 39 0 0 0 .25 0 0 0 16 box5-12.dat
  [1,16,0,-.25,0,39,0,0,0,.25,0,0,0,16, ldraw_lib__box5_12(realsolid)],
// 
...
module ldraw_lib__168225d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__168225d(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
