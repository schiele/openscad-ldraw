...
use <30218k02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30218_f1(realsolid=false) = [
...
// 1 16 32.5 -12 0 1 0 0 0 1 0 0 0 1 30218k02.dat
  [1,16,32.5,-12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30218k02(realsolid)],
];
module ldraw_lib__30218_f1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30218_f1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
