...
use <s/30180s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30180p01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30180s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30180s01(realsolid)],
// 1 16 10 0 -40 0 0 -1 0 1 0 1 0 0 s\30180p1s.dat
  [1,16,10,0,-40,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__30180p1s(realsolid)],
// 1 16 10 0 40 0 0 -1 0 1 0 1 0 0 s\30180p1s.dat
  [1,16,10,0,40,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__30180p1s(realsolid)],
...
module ldraw_lib__30180p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30180p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
