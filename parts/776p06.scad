...
use <s/777s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__776p06(realsolid=false) = [
// 0 Flag on Flagpole Type 1 with Austria Pattern
// 0 Name: 776p06.dat
...
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 4 0 32 0 1 0 0 0 1 0 0 0 1 s\777s01.dat
  [1,4,0,32,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__777s01(realsolid)],
// 1 4 0 32 -3 1 0 0 0 1 0 0 0 1 s\777s01.dat
  [1,4,0,32,-3,1,0,0,0,1,0,0,0,1, ldraw_lib__s__777s01(realsolid)],
// 0
];
module ldraw_lib__776p06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__776p06(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__776p06(line=0.2);