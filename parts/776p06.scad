...
// 0 BFC CERTIFY CW
  ...
  [0,"BFC","CW"],
// 
// 0 !KEYWORDS classic, h0 scale, Rebrickable 776pr0006, Set 1242
// 
...
// 1 4 0 32 0 1 0 0 0 1 0 0 0 1 s\777s01.dat
  [1,4,0,32,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__777s01()],
...
module ldraw_lib__776p06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__776p06(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
