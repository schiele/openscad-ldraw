...
use <s/32138s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32138(realsolid=false) = [
...
// 1 16 -10 10 0 0 1 0 0 0 1 1 0 0 confric.dat
  [1,16,-10,10,0,0,1,0,0,0,1,1,0,0, ldraw_lib__confric(realsolid)],
// 1 16 -10 -10 0 0 1 0 0 0 1 1 0 0 confric.dat
  [1,16,-10,-10,0,0,1,0,0,0,1,1,0,0, ldraw_lib__confric(realsolid)],
// 1 16 10 10 0 0 -1 0 0 0 1 1 0 0 confric.dat
  [1,16,10,10,0,0,-1,0,0,0,1,1,0,0, ldraw_lib__confric(realsolid)],
...
// 1 16 10 10 0 0 1 0 0 0 4 4 0 0 4-4edge.dat
  [1,16,10,10,0,0,1,0,0,0,4,4,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 -10 0 0 1 0 0 0 4 4 0 0 4-4edge.dat
  [1,16,10,-10,0,0,1,0,0,0,4,4,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 -10 10 0 0 1 0 0 0 4 4 0 0 4-4edge.dat
  [1,16,-10,10,0,0,1,0,0,0,4,4,0,0, ldraw_lib__4_4edge(realsolid)],
...
module ldraw_lib__32138(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32138(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
