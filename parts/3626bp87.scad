...
$fa=1; $fs=0.2;
function ldraw_lib__3626bp87(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 3626bpb0122, set 4511, set 7047
// 
...
module ldraw_lib__3626bp87(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3626bp87(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
