...
use <s/16175s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__16175(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\16175s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__16175s02(realsolid)],
];
module ldraw_lib__16175(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__16175(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
