...
// 1 0 0 -120 0 1 0 0 0 1 0 0 0 1 337.dat
  [1,0,0,-120,0,1,0,0,0,1,0,0,0,1, ldraw_lib__337()],
...
module ldraw_lib__127c01_f1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__127c01_f1(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
