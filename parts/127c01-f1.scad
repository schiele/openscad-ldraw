...
use <4701.scad>
$fa=1; $fs=0.2;
function ldraw_lib__127c01_f1(realsolid=false) = [
// 0 Technic Pneumatic Cylinder  2 x  2 x  5 with 1 Port (Retracted)
// 0 Name: 127c01-f1.dat
...
// 0 !HISTORY 2016-08-21 [PTadmin] Renamed from 127c01
// 0 !HISTORY 2017-12-30 [PTadmin] Official Update 2017-01
// 
// 
// 1 0 0 -120 0 1 0 0 0 1 0 0 0 1 337.dat
  [1,0,0,-120,0,1,0,0,0,1,0,0,0,1, ldraw_lib__337(realsolid)],
...
module ldraw_lib__127c01_f1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__127c01_f1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__127c01_f1(line=0.2);