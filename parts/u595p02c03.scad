...
use <u595p02c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u595p02c03(realsolid=false) = [
...
// 1 4 0 -52.661 4.663 1 0 0 0 0.961262 0.275637 0 -0.275637 0.961262 4792.dat
  [1,4,0,-52.661,4.663,1,0,0,0,0.961262,0.275637,0,-0.275637,0.961262, ldraw_lib__4792(realsolid)],
];
module ldraw_lib__u595p02c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u595p02c03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
