...
use <s/6309s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6309p16(realsolid=false) = [
// 0 Duplo Tile  2 x  2 with Yellow Disc Pattern
// 0 Name: 6309p16.dat
...
// 1 14 0 0 0 38 0 0 0 1 0 0 0 38 48\1-4disc.dat
  [1,14,0,0,0,38,0,0,0,1,0,0,0,38, ldraw_lib__48__1_4disc(realsolid)],
// 1 14 0 0 0 -38 0 0 0 1 0 0 0 38 48\1-4disc.dat
  [1,14,0,0,0,-38,0,0,0,1,0,0,0,38, ldraw_lib__48__1_4disc(realsolid)],
// 1 14 0 0 0 38 0 0 0 1 0 0 0 -38 48\1-4disc.dat
  [1,14,0,0,0,38,0,0,0,1,0,0,0,-38, ldraw_lib__48__1_4disc(realsolid)],
...
module ldraw_lib__6309p16(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6309p16(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6309p16(line=0.2);