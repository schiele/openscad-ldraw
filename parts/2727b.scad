...
use <s/2727s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2727b(realsolid=false) = [
...
// 1 16 0 -6 16 17 0 0 0 0 -1 0 1 0 recte3.dat
  [1,16,0,-6,16,17,0,0,0,0,-1,0,1,0, ldraw_lib__recte3(realsolid)],
...
// 1 16 0 -8.5 14.875 17 0 0 0 0 -1.5 0 -1 -1.125 rect3.dat
  [1,16,0,-8.5,14.875,17,0,0,0,0,-1.5,0,-1,-1.125, ldraw_lib__rect3(realsolid)],
// 1 16 0 -8.5 -14.875 17 0 0 0 0 -1.5 0 1 1.125 rect3.dat
  [1,16,0,-8.5,-14.875,17,0,0,0,0,-1.5,0,1,1.125, ldraw_lib__rect3(realsolid)],
// 
// 0 BFC INVERTNEXT
...
// 1 16 0 -11.5 10.25 -17 0 0 0 1.5 0 0 0 -3.5 box2-7.dat
  [1,16,0,-11.5,10.25,-17,0,0,0,1.5,0,0,0,-3.5, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -11.5 -10.25 -17 0 0 0 1.5 0 0 0 3.5 box2-7.dat
  [1,16,0,-11.5,-10.25,-17,0,0,0,1.5,0,0,0,3.5, ldraw_lib__box2_7(realsolid)],
...
module ldraw_lib__2727b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2727b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
