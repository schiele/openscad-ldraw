...
$fa=1; $fs=0.2;
function ldraw_lib__98138p2b(realsolid=false) = [
...
// 1 321 0 0 0 1 0 0 0 1 0 0 0 1 s\98138p1ds02.dat
  [1,321,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__98138p1ds02(realsolid)],
];
module ldraw_lib__98138p2b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98138p2b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
