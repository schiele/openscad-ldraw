...
use <s/3068bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3068bpfm(realsolid=false) = [
...
// 1 15 20 0 -20 0 0 -26.666666 0 1 0 26.666666 0 0 1-4disc.dat
  [1,15,20,0,-20,0,0,-26.666666,0,1,0,26.666666,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 22 20 0 -20 0 0 -13.333333 0 1 0 13.333333 0 0 1-4ring2.dat
  [1,22,20,0,-20,0,0,-13.333333,0,1,0,13.333333,0,0, ldraw_lib__1_4ring2(realsolid)],
// 1 15 20 0 -20 0 0 -40 0 1 0 40 0 0 1-4ndis.dat
  [1,15,20,0,-20,0,0,-40,0,1,0,40,0,0, ldraw_lib__1_4ndis(realsolid)],
];
module ldraw_lib__3068bpfm(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068bpfm(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
