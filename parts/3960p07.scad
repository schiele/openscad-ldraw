...
use <s/3960s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3960p07(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3960p07s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3960p07s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\3960p07s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3960p07s01(realsolid)],
// 1 16 0 0 0 0.70711 0 -0.70711 0 1 0 0.70711 0 0.70711 s\3960p07s01.dat
  [1,16,0,0,0,0.70711,0,-0.70711,0,1,0,0.70711,0,0.70711, ldraw_lib__s__3960p07s01(realsolid)],
// 1 16 0 0 0 0.70711 0 0.70711 0 1 0 0.70711 0 -0.70711 s\3960p07s01.dat
  [1,16,0,0,0,0.70711,0,0.70711,0,1,0,0.70711,0,-0.70711, ldraw_lib__s__3960p07s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\3960p07s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3960p07s01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 1 0 0 s\3960p07s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,1,0,0, ldraw_lib__s__3960p07s01(realsolid)],
// 1 16 0 0 0 -0.70711 0 -0.70711 0 1 0 0.70711 0 -0.70711 s\3960p07s01.dat
  [1,16,0,0,0,-0.70711,0,-0.70711,0,1,0,0.70711,0,-0.70711, ldraw_lib__s__3960p07s01(realsolid)],
...
module ldraw_lib__3960p07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3960p07(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
