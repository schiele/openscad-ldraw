...
use <../p/stud2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30231(realsolid=false) = [
// 0 Wing Insectoid Small with Arm Hinge
// 0 Name: 30231.dat
...
// 0 !HISTORY 2016-03-15 [legolijntje] Added BFC status
// 0 !HISTORY 2016-06-16 [Philo] BFCed, closed gaps
// 0 !HISTORY 2017-04-13 [Philo] Subparted arm hinge, grainy edge and shiny patternable areas. Removed internal surfaces
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30231s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30231s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30231s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30231s02(realsolid)],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 1 s\30231s01.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__30231s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 1 s\30231s02.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__30231s02(realsolid)],
...
// 1 16 15 -1 65 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,15,-1,65,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
// 1 16 15 1 65 1 0 0 0 -1 0 0 0 -1 stud2.dat
  [1,16,15,1,65,1,0,0,0,-1,0,0,0,-1, ldraw_lib__stud2(realsolid)],
// 1 16 15 1 65 4 0 0 0 -1 0 0 0 4 4-4disc.dat
  [1,16,15,1,65,4,0,0,0,-1,0,0,0,4, ldraw_lib__4_4disc(realsolid)],
// 1 16 -25 -1 145 1 0 0 0 1 0 0 0 1 stud2a.dat
  [1,16,-25,-1,145,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2a(realsolid)],
// 1 16 -25 -1 145 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-25,-1,145,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 -25 1 145 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-25,1,145,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 -25 1 145 1 0 0 0 -1 0 0 0 -1 stud2a.dat
  [1,16,-25,1,145,1,0,0,0,-1,0,0,0,-1, ldraw_lib__stud2a(realsolid)],
...
// 1 16 -25 1 145 4 0 0 0 -2 0 0 0 -4 4-4cyli.dat
  [1,16,-25,1,145,4,0,0,0,-2,0,0,0,-4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 25 0 53 0 -1 0 1 0 0 0 0 20 rect3.dat
  [1,16,25,0,53,0,-1,0,1,0,0,0,0,20, ldraw_lib__rect3(realsolid)],
// 1 16 7.5 0 112.5 0 -1 -17.5 1 0 0 0 0 39.5 rect3.dat
  [1,16,7.5,0,112.5,0,-1,-17.5,1,0,0,0,0,39.5, ldraw_lib__rect3(realsolid)],
// 1 16 -18.23 0 162.27 8.23 -1 0 0 0 1 -10.27 0 0 rect2p.dat
  [1,16,-18.23,0,162.27,8.23,-1,0,0,0,1,-10.27,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -30 -1 169 3.54 0 -3.54 0 2 0 3.54 0 3.54 3-8cylo.dat
  [1,16,-30,-1,169,3.54,0,-3.54,0,2,0,3.54,0,3.54, ldraw_lib__3_8cylo(realsolid)],
// 1 16 -35 0 121 0 1 0 1 0 0 0 0 -48 rect3.dat
  [1,16,-35,0,121,0,1,0,1,0,0,0,0,-48, ldraw_lib__rect3(realsolid)],
// 1 16 15 -1 65 4 0 0 0 1 0 0 0 4 4-4disc.dat
  [1,16,15,-1,65,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4disc(realsolid)],
// 
...
// 5 24 10 0 15 9.801 -1 15 10 0 11 9.979 0 15.211
  [5,24,10,0,15,9.801,-1,15,10,0,11,9.979,0,15.211],
// 5 24 -26.46 1 172.54 -26.46 -1 172.54 -10 -1 152 -28.0842 1 173.625
  [5,24,-26.46,1,172.54,-26.46,-1,172.54,-10,-1,152,-28.0842,1,173.625],
];
module ldraw_lib__30231(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30231(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__30231(line=0.2);