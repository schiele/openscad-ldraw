...
use <s/3622s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3622px1(realsolid=false) = [
...
// 1 0 -15 10.3 -10 2.1 0 0 0 0 -2.1 0 1 0 4-4disc.dat
  [1,0,-15,10.3,-10,2.1,0,0,0,0,-2.1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 0 15 10.3 -10 2.1 0 0 0 0 -2.1 0 1 0 4-4disc.dat
  [1,0,15,10.3,-10,2.1,0,0,0,0,-2.1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 -15 10.3 -10 2.1 0 0 0 0 -2.1 0 1 0 4-4ndis.dat
  [1,16,-15,10.3,-10,2.1,0,0,0,0,-2.1,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 15 10.3 -10 2.1 0 0 0 0 -2.1 0 1 0 4-4ndis.dat
  [1,16,15,10.3,-10,2.1,0,0,0,0,-2.1,0,1,0, ldraw_lib__4_4ndis(realsolid)],
...
module ldraw_lib__3622px1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3622px1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
