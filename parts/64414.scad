...
use <64420.scad>
$fa=1; $fs=0.2;
function ldraw_lib__64414(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 64415.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__64415(realsolid)],
// 1 16 0 16 -30 1 0 0 0 1 0 0 0 1 64417.dat
  [1,16,0,16,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__64417(realsolid)],
// 1 16 0 16 -30 -1 0 0 0 -1 0 0 0 1 64417.dat
  [1,16,0,16,-30,-1,0,0,0,-1,0,0,0,1, ldraw_lib__64417(realsolid)],
// 1 494 0 42 -30 -1 0 0 0 -1 0 0 0 1 64420.dat
  [1,494,0,42,-30,-1,0,0,0,-1,0,0,0,1, ldraw_lib__64420(realsolid)],
];
module ldraw_lib__64414(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__64414(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
