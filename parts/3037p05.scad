...
use <s/3037s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3037p05(realsolid=false) = [
...
// 1 16 0 20 -30 1 0 0 0 1 -0.9 0 0 0.9 s\2513p03s01.dat
  [1,16,0,20,-30,1,0,0,0,1,-0.9,0,0,0.9, ldraw_lib__s__2513p03s01(realsolid)],
];
module ldraw_lib__3037p05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3037p05(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
