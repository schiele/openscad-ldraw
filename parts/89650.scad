...
use <s/89650s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__89650(realsolid=false) = [
...
// 1 16 0 0 40 1 0 0 0 1 0 0 0 1 s\89650s01.dat
  [1,16,0,0,40,1,0,0,0,1,0,0,0,1, ldraw_lib__s__89650s01(realsolid)],
// 1 16 0 0 -40 -1 0 0 0 1 0 0 0 -1 s\89650s01.dat
  [1,16,0,0,-40,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__89650s01(realsolid)],
...
// 1 16 20 0 -20 0 -10 0 9 0 0 0 0 9 2-4cyli.dat
  [1,16,20,0,-20,0,-10,0,9,0,0,0,0,9, ldraw_lib__2_4cyli(realsolid)],
// 1 16 20 0 -20 0 -1 0 9 0 0 0 0 9 2-4edge.dat
  [1,16,20,0,-20,0,-1,0,9,0,0,0,0,9, ldraw_lib__2_4edge(realsolid)],
// 1 16 20 0 -20 0 -1 0 3 0 0 0 0 3 2-4ring2.dat
  [1,16,20,0,-20,0,-1,0,3,0,0,0,0,3, ldraw_lib__2_4ring2(realsolid)],
// 1 16 -20 0 -20 0 10 0 -9 0 0 0 0 9 2-4cyli.dat
  [1,16,-20,0,-20,0,10,0,-9,0,0,0,0,9, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -20 0 -20 0 1 0 -9 0 0 0 0 9 2-4edge.dat
  [1,16,-20,0,-20,0,1,0,-9,0,0,0,0,9, ldraw_lib__2_4edge(realsolid)],
...
module ldraw_lib__89650(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__89650(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
