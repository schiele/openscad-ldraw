...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 15068pb225, Chinese New Year, Lion Dance
// 0 !KEYWORDS Rebrickable 15068pr0039, Set 80104
// 
...
module ldraw_lib__15068p0c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__15068p0c(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
