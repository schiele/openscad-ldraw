...
use <../p/recte4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__12825(realsolid=false) = [
...
// 1 16 0 0 0 9.5 0 0 0 1 0 0 0 4 recte4.dat
  [1,16,0,0,0,9.5,0,0,0,1,0,0,0,4, ldraw_lib__recte4(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 clip11.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__clip11(realsolid)],
];
module ldraw_lib__12825(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__12825(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
