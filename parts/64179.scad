...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\64179s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__64179s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\64179s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__64179s01()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\64179s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__64179s01()],
...
// 1 16 0 0 70 -1 0 0 0 0 1 0 -1 0 peghole.dat
  [1,16,0,0,70,-1,0,0,0,0,1,0,-1,0, ldraw_lib__peghole()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 0 52 -6 0 0 0 0 6 0 16 0 4-4edge.dat
  [1,16,0,0,52,-6,0,0,0,0,6,0,16,0, ldraw_lib__4_4edge()],
// 1 16 0 0 70 -1 0 0 0 0 -1 0 -1 0 4-4ring8.dat
  [1,16,0,0,70,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__4_4ring8()],
...
// 1 16 34 0 0 0 -1 0 0 0 9 -9 0 0 2-4ndis.dat
  [1,16,34,0,0,0,-1,0,0,0,9,-9,0,0, ldraw_lib__2_4ndis()],
// 1 16 32 0 0 0 -1 0 0 0 -9 9 0 0 2-4ndis.dat
  [1,16,32,0,0,0,-1,0,0,0,-9,9,0,0, ldraw_lib__2_4ndis()],
// 1 16 48 0 0 0 1 0 0 0 9 -9 0 0 2-4ndis.dat
  [1,16,48,0,0,0,1,0,0,0,9,-9,0,0, ldraw_lib__2_4ndis()],
// 1 16 48 0 0 0 1 0 0 0 -9 9 0 0 2-4ndis.dat
  [1,16,48,0,0,0,1,0,0,0,-9,9,0,0, ldraw_lib__2_4ndis()],
// 1 16 -34 0 0 0 1 0 0 0 9 -9 0 0 2-4ndis.dat
  [1,16,-34,0,0,0,1,0,0,0,9,-9,0,0, ldraw_lib__2_4ndis()],
...
module ldraw_lib__64179(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__64179(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
