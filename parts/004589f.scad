...
$fa=1; $fs=0.2;
function ldraw_lib__004589f(realsolid=false) = [
...
// 1 15 0 -0.25 0 19.2 0 0 0 1 0 0 0 19.2 type-swiss721bt-bold-n2.dat
  [1,15,0,-0.25,0,19.2,0,0,0,1,0,0,0,19.2, ldraw_lib__type_swiss721bt_bold_n2(realsolid)],
...
module ldraw_lib__004589f(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__004589f(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
