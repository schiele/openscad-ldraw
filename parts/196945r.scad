...
// 1 16 0 -0.25 7.328 0.34 0 0 0 1 0 0 0 0.34 s\196945sat.dat
  [1,16,0,-0.25,7.328,0.34,0,0,0,1,0,0,0,0.34, ldraw_lib__s__196945sat()],
...
module ldraw_lib__196945r(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__196945r(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
