...
use <s/196945sat.scad>
$fa=1; $fs=0.2;
function ldraw_lib__196945r(realsolid=false) = [
// 0 Sticker  2.4 x  2 with Black Austrian Railways Logo and "7735"
// 0 Name: 196945r.dat
...
// 1 16 0 -0.25 -20 0.415 0 0 0 1 0 0 0 0.415 s\196945s02.dat
  [1,16,0,-0.25,-20,0.415,0,0,0,1,0,0,0,0.415, ldraw_lib__s__196945s02(realsolid)],
// 1 16 0 -0.25 7.328 0.34 0 0 0 1 0 0 0 0.34 s\196945sat.dat
  [1,16,0,-0.25,7.328,0.34,0,0,0,1,0,0,0,0.34, ldraw_lib__s__196945sat(realsolid)],
...
module ldraw_lib__196945r(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__196945r(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__196945r(line=0.2);