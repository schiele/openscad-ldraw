...
use <30378ps2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30375cs2(realsolid=false) = [
...
// 1 320 0 -38 0 1 0 0 0 1 0 0 0 1 30375ps2.dat
  [1,320,0,-38,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30375ps2(realsolid)],
// 1 16 0 -70 0 1 0 0 0 1 0 0 0 1 30378ps2.dat
  [1,16,0,-70,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30378ps2(realsolid)],
...
module ldraw_lib__30375cs2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30375cs2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
