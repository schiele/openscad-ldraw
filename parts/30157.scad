...
use <../p/stug2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30157(realsolid=false) = [
...
// 1 16 17 4 0 0 0 1 0 3.5 0 -16 0 0 box3u2p.dat
  [1,16,17,4,0,0,0,1,0,3.5,0,-16,0,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 -17 4 0 0 0 1 0 3.5 0 -16 0 0 box3u2p.dat
  [1,16,-17,4,0,0,0,1,0,3.5,0,-16,0,0, ldraw_lib__box3u2p(realsolid)],
// 0
...
// 1 16 0 8 0 40 0 0 0 -8 0 0 0 20 box3u8p.dat
  [1,16,0,8,0,40,0,0,0,-8,0,0,0,20, ldraw_lib__box3u8p(realsolid)],
// 0
...
// 1 16 36 10 0 0 -1 0 5.656 0 5.656 -5.656 0 5.656 1-4edge.dat
  [1,16,36,10,0,0,-1,0,5.656,0,5.656,-5.656,0,5.656, ldraw_lib__1_4edge(realsolid)],
// 1 16 36 10 0 0 1 0 5.656 0 5.656 -5.656 0 5.656 1-4chrd.dat
  [1,16,36,10,0,0,1,0,5.656,0,5.656,-5.656,0,5.656, ldraw_lib__1_4chrd(realsolid)],
// 1 16 40 10 0 0 -4 0 5.656 0 5.656 -5.656 0 5.656 1-4cyli.dat
  [1,16,40,10,0,0,-4,0,5.656,0,5.656,-5.656,0,5.656, ldraw_lib__1_4cyli(realsolid)],
// 0
// 2 24 -36 8 -12 -40 8 -12
  [2,24,-36,8,-12,-40,8,-12],
// 2 24 -36 8 12 -40 8 12
...
// 1 16 40 10 0 0 1 0 5.65685 0 -5.65685 5.65685 0 5.65685 3-4edge.dat
  [1,16,40,10,0,0,1,0,5.65685,0,-5.65685,5.65685,0,5.65685, ldraw_lib__3_4edge(realsolid)],
// 1 16 -40 10 0 0 1 0 5.65685 0 -5.65685 5.65685 0 5.65685 3-4edge.dat
  [1,16,-40,10,0,0,1,0,5.65685,0,-5.65685,5.65685,0,5.65685, ldraw_lib__3_4edge(realsolid)],
...
// 1 16 20 0 0 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,20,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 1 16 -20 0 0 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-20,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 0
];
module ldraw_lib__30157(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30157(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
