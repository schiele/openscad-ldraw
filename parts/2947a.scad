...
use <s/2947s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2947a(realsolid=false) = [
...
// 1 16 0 -60 -10 4 0 0 0 0 4 0 -15 0 4-4cyli.dat
  [1,16,0,-60,-10,4,0,0,0,0,4,0,-15,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -60 -10 4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,16,0,-60,-10,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -60 -25 4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,16,0,-60,-25,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -60 -26 3 0 0 0 0 3 0 1 0 4-4edge.dat
  [1,16,0,-60,-26,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -60 -26 1 0 0 0 0 1 0 1 0 4-4ring2.dat
  [1,16,0,-60,-26,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4ring2(realsolid)],
// 1 16 0 -60 -25 -1 0 0 0 0 1 0 -1 0 4-4con3.dat
  [1,16,0,-60,-25,-1,0,0,0,0,1,0,-1,0, ldraw_lib__4_4con3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__2947a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2947a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
