...
use <u9228c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9228c02(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 u9228c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9228c01(realsolid)],
// 1 16 -1.3852 5.5 21 1.5 0 0 0 1 0 0 0 1.5 4-4edge.dat
  [1,16,-1.3852,5.5,21,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__4_4edge(realsolid)],
// 1 16 1.3852 5.5 21 1.5 0 0 0 1 0 0 0 1.5 4-4edge.dat
  [1,16,1.3852,5.5,21,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__4_4edge(realsolid)],
// 1 511 0 5.5 21 0 0 1 0 0.5 0 -1 0 0 993.dat
  [1,511,0,5.5,21,0,0,1,0,0.5,0,-1,0,0, ldraw_lib__993(realsolid)],
];
module ldraw_lib__u9228c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9228c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
