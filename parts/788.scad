...
use <4323.scad>
$fa=1; $fs=0.2;
function ldraw_lib__788(realsolid=false) = [
// 0 ~Moved to 4323
// 0 Name: 788.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 4323.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4323(realsolid)],
];
module ldraw_lib__788(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__788(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
