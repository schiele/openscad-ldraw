...
// 1 16 0 9 0 1 0 0 0 -1.75 0 0 0 -1 stud4a.dat
  [1,16,0,9,0,1,0,0,0,-1.75,0,0,0,-1, ldraw_lib__stud4a()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\52494s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__52494s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\52494s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__52494s01()],
...
// 1 16 0 4.5 10 -5.5 0 0 0 0 -4.5 0 -1 0 rect2p.dat
  [1,16,0,4.5,10,-5.5,0,0,0,0,-4.5,0,-1,0, ldraw_lib__rect2p()],
...
module ldraw_lib__52494(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__52494(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
