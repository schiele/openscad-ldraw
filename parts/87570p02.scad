...
use <s/87570s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87570p02(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\87570s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87570s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\87570s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87570s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\87570p02s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87570p02s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\87570p02s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87570p02s01(realsolid)],
// 
// 0 BFC INVERTNEXT
...
// 1 16 0 -24.908 0 6 0 0 0 24.908 0 0 0 6 4-4cyli.dat
  [1,16,0,-24.908,0,6,0,0,0,24.908,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -24.908 0 6 0 0 0 -1 0 0 0 6 4-4disc.dat
  [1,16,0,-24.908,0,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 -24.908 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,-24.908,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
...
module ldraw_lib__87570p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87570p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
