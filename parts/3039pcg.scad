...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3039pcgs01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3039pcgs01()],
// 1 3 0 0 0 1 0 0 0 1 0 0 0 1 s\3039pcgs02.dat
  [1,3,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3039pcgs02()],
// 
];
module ldraw_lib__3039pcg(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3039pcg(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
