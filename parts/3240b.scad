...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3242, Rebrickable 3242
// 
// 0 !CMDLINE -c7
// 
...
// 1 16 0 0 0 7 0 0 0 1 0 0 0 1 s\3241s03.dat
  [1,16,0,0,0,7,0,0,0,1,0,0,0,1, ldraw_lib__s__3241s03()],
...
module ldraw_lib__3240b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3240b(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
