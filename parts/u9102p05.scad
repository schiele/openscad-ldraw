...
// 1 7 0 0 0 1 0 0 0 1 0 0 0 1 s\u9102p04s01.dat
  [1,7,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9102p04s01()],
...
module ldraw_lib__u9102p05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9102p05(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
