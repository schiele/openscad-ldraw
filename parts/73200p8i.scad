...
use <3817bp8i.scad>
$fa=1; $fs=0.2;
function ldraw_lib__73200p8i(realsolid=false) = [
...
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3816bp8i.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816bp8i(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3817bp8i.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817bp8i(realsolid)],
];
module ldraw_lib__73200p8i(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73200p8i(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
