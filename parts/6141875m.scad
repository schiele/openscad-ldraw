...
use <6141875k.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6141875m(realsolid=false) = [
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 6141875k.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__6141875k(realsolid)],
];
module ldraw_lib__6141875m(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6141875m(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
