...
use <61927-f2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__61927c01(realsolid=false) = [
// 0 ~Moved to 61927-f2
// 0 Name: 61927c01.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 61927-f2.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__61927_f2(realsolid)],
];
module ldraw_lib__61927c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__61927c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
