...
use <s/6142275zs02.scad>
use <s/6142275zs03.scad>
use <s/6142275zs04.scad>
use <s/6142275zs05.scad>
use <s/6142275zs06.scad>
use <s/6142275zs08.scad>
function ldraw_lib__6142275zc01() = [
// 0 Sticker  1.9 x  0.8 with Red "P1" and Grey Triangle on Black Background Right (Formed)
// 0 Name: 6142275zc01.dat
...
// 1 16 0 -15.6524 12.616 1 0 0 0 .989715 -.143056 0 .143056 .989715 s\6142275zs02.dat
  [1,16,0,-15.6524,12.616,1,0,0,0,.989715,-.143056,0,.143056,.989715, ldraw_lib__s__6142275zs02()],
...
module ldraw_lib__6142275zc01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6142275zc01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6142275zc01(line=0.2);