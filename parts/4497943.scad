...
use <58176.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4497943(realsolid=false) = [
...
// 1 36 0 0 0 1 0 0 0 1 0 0 0 1 58176.dat
  [1,36,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__58176(realsolid)],
];
module ldraw_lib__4497943(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4497943(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
