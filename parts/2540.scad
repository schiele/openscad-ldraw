...
use <../p/stug-2x1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2540(realsolid=false) = [
...
// 1 16 -9 8 -15 0 0 3 0 -1 0 5 0 0 rect2p.dat
  [1,16,-9,8,-15,0,0,3,0,-1,0,5,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 9 8 -15 0 0 -3 0 -1 0 -5 0 0 rect2p.dat
  [1,16,9,8,-15,0,0,-3,0,-1,0,-5,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 -16 4 -10 0 0 4 4 0 0 0 1 0 rect3.dat
  [1,16,-16,4,-10,0,0,4,4,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 -9 -.1481 -12.2283 -3 0 0 0 .1481 0 0 .0293 -2.199 box2-7.dat
  [1,16,-9,-.1481,-12.2283,-3,0,0,0,.1481,0,0,.0293,-2.199, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 9 -.1481 -12.2283 -3 0 0 0 .1481 0 0 .0293 -2.199 box2-7.dat
  [1,16,9,-.1481,-12.2283,-3,0,0,0,.1481,0,0,.0293,-2.199, ldraw_lib__box2_7(realsolid)],
// 1 16 -12 2 -20 0 6 0 6 0 0 0 0 -6 2-4cylo.dat
  [1,16,-12,2,-20,0,6,0,6,0,0,0,0,-6, ldraw_lib__2_4cylo(realsolid)],
// 1 16 12 2 -20 0 -6 0 6 0 0 0 0 -6 2-4cylo.dat
  [1,16,12,2,-20,0,-6,0,6,0,0,0,0,-6, ldraw_lib__2_4cylo(realsolid)],
// 1 16 -12 2 -20 0 1 0 2 0 0 0 0 -2 2-4ring2.dat
  [1,16,-12,2,-20,0,1,0,2,0,0,0,0,-2, ldraw_lib__2_4ring2(realsolid)],
// 1 16 -6 2 -20 0 -1 0 2 0 0 0 0 -2 2-4ring2.dat
  [1,16,-6,2,-20,0,-1,0,2,0,0,0,0,-2, ldraw_lib__2_4ring2(realsolid)],
// 1 16 6 2 -20 0 1 0 2 0 0 0 0 -2 2-4ring2.dat
  [1,16,6,2,-20,0,1,0,2,0,0,0,0,-2, ldraw_lib__2_4ring2(realsolid)],
// 1 16 12 2 -20 0 -1 0 2 0 0 0 0 -2 2-4ring2.dat
  [1,16,12,2,-20,0,-1,0,2,0,0,0,0,-2, ldraw_lib__2_4ring2(realsolid)],
// 1 16 -12 2 -20 0 6 0 -6 0 0 0 0 6 3-16cylo.dat
  [1,16,-12,2,-20,0,6,0,-6,0,0,0,0,6, ldraw_lib__3_16cylo(realsolid)],
// 1 16 12 2 -20 0 -6 0 -6 0 0 0 0 6 3-16cylo.dat
  [1,16,12,2,-20,0,-6,0,-6,0,0,0,0,6, ldraw_lib__3_16cylo(realsolid)],
// 1 16 -12 2 -20 0 1 0 -2 0 0 0 0 2 3-16rin2.dat
  [1,16,-12,2,-20,0,1,0,-2,0,0,0,0,2, ldraw_lib__3_16rin2(realsolid)],
// 1 16 -6 2 -20 0 -1 0 -2 0 0 0 0 2 3-16rin2.dat
  [1,16,-6,2,-20,0,-1,0,-2,0,0,0,0,2, ldraw_lib__3_16rin2(realsolid)],
// 1 16 6 2 -20 0 1 0 -2 0 0 0 0 2 3-16rin2.dat
  [1,16,6,2,-20,0,1,0,-2,0,0,0,0,2, ldraw_lib__3_16rin2(realsolid)],
// 1 16 12 2 -20 0 -1 0 -2 0 0 0 0 2 3-16rin2.dat
  [1,16,12,2,-20,0,-1,0,-2,0,0,0,0,2, ldraw_lib__3_16rin2(realsolid)],
// 1 16 -12 2 -20 0 1 0 4 0 0 0 0 4 4-4edge.dat
  [1,16,-12,2,-20,0,1,0,4,0,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 -6 2 -20 0 1 0 4 0 0 0 0 4 4-4edge.dat
  [1,16,-6,2,-20,0,1,0,4,0,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 6 2 -20 0 1 0 4 0 0 0 0 4 4-4edge.dat
  [1,16,6,2,-20,0,1,0,4,0,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 12 2 -20 0 1 0 4 0 0 0 0 4 4-4edge.dat
  [1,16,12,2,-20,0,1,0,4,0,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 20 2 -20 0 -40 0 4 0 0 0 0 4 4-4cylc.dat
  [1,16,20,2,-20,0,-40,0,4,0,0,0,0,4, ldraw_lib__4_4cylc(realsolid)],
// 1 16 -20 2 -20 0 1 0 4 0 0 0 0 4 4-4disc.dat
  [1,16,-20,2,-20,0,1,0,4,0,0,0,0,4, ldraw_lib__4_4disc(realsolid)],
// 0 // Faces
...
module ldraw_lib__2540(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2540(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
