...
use <u9409-f1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__110(realsolid=false) = [
// 0 ~Moved to u9409-f1
// 0 Name: 110.dat
// 0 Author: [PTadmin]
...
// 1 16 0 -2 0 -1 0 0 0 1 0 0 0 1 u9409-f1.dat
  [1,16,0,-2,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__u9409_f1(realsolid)],
];
module ldraw_lib__110(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__110(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
