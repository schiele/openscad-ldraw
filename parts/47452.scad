...
use <s/48170s05.scad>
$fa=1; $fs=0.2;
function ldraw_lib__47452(realsolid=false) = [
...
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\48170s05.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__48170s05(realsolid)],
// 0
];
module ldraw_lib__47452(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__47452(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__47452(line=0.2);