...
use <4824.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4823c02(realsolid=false) = [
...
// 1 14 0 36 -20 1 0 0 0 1 0 0 0 1 4824.dat
  [1,14,0,36,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__4824(realsolid)],
];
module ldraw_lib__4823c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4823c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
