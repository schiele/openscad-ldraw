...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__20(realsolid=false) = [
...
// 1 16 0 0 -4 0 0 10 10 0 0 0 1 0 4-4edge.dat
  [1,16,0,0,-4,0,0,10,10,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -2 0 0 6 6 0 0 0 1 0 4-4edge.dat
  [1,16,0,0,-2,0,0,6,6,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 2 0 0 6 6 0 0 0 1 0 4-4edge.dat
  [1,16,0,0,2,0,0,6,6,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 4 0 0 10 10 0 0 0 1 0 4-4edge.dat
  [1,16,0,0,4,0,0,10,10,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 8 0 0 6 6 0 0 0 1 0 4-4edge.dat
  [1,16,0,0,8,0,0,6,6,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 -5 0 0 2 2 0 0 0 1 0 4-4edge.dat
  [1,16,0,0,-5,0,0,2,2,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -5 0 0 2 2 0 0 0 1 0 4-4ring3.dat
  [1,16,0,0,-5,0,0,2,2,0,0,0,1,0, ldraw_lib__4_4ring3(realsolid)],
// 1 16 0 0 -5 0 0 2 2 0 0 0 1 0 4-4ring4.dat
  [1,16,0,0,-5,0,0,2,2,0,0,0,1,0, ldraw_lib__4_4ring4(realsolid)],
...
// 1 16 0 0 8 0 0 2 2 0 0 0 -1 0 4-4ring2.dat
  [1,16,0,0,8,0,0,2,2,0,0,0,-1,0, ldraw_lib__4_4ring2(realsolid)],
// 1 16 0 0 -5 0 0 2 2 0 0 0 -1 0 4-4disc.dat
  [1,16,0,0,-5,0,0,2,2,0,0,0,-1,0, ldraw_lib__4_4disc(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 8 0 0 2 2 0 0 0 -13 0 4-4cyli.dat
  [1,16,0,0,8,0,0,2,2,0,0,0,-13,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -5 0 0 10 10 0 0 0 1 0 4-4cyli.dat
  [1,16,0,0,-5,0,0,10,10,0,0,0,1,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -2 0 0 6 6 0 0 0 4 0 4-4cyli.dat
  [1,16,0,0,-2,0,0,6,6,0,0,0,4,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 5 0 0 10 10 0 0 0 -1 0 4-4cyli.dat
  [1,16,0,0,5,0,0,10,10,0,0,0,-1,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -4 2 0 0 0 0 2 0 1 0 4-4con4.dat
  [1,16,0,0,-4,2,0,0,0,0,2,0,1,0, ldraw_lib__4_4con4(realsolid)],
// 1 16 0 0 -3 2 0 0 0 0 2 0 1 0 4-4con3.dat
  [1,16,0,0,-3,2,0,0,0,0,2,0,1,0, ldraw_lib__4_4con3(realsolid)],
// 1 16 0 0 4 2 0 0 0 0 2 0 -1 0 4-4con4.dat
  [1,16,0,0,4,2,0,0,0,0,2,0,-1,0, ldraw_lib__4_4con4(realsolid)],
// 1 16 0 0 3 2 0 0 0 0 2 0 -1 0 4-4con3.dat
  [1,16,0,0,3,2,0,0,0,0,2,0,-1,0, ldraw_lib__4_4con3(realsolid)],
// 1 16 0 0 5 2 0 0 0 0 2 0 1.5 0 4-4con4.dat
  [1,16,0,0,5,2,0,0,0,0,2,0,1.5,0, ldraw_lib__4_4con4(realsolid)],
// 1 16 0 0 6.5 2 0 0 0 0 2 0 1.5 0 4-4con3.dat
  [1,16,0,0,6.5,2,0,0,0,0,2,0,1.5,0, ldraw_lib__4_4con3(realsolid)],
// 1 16 0 0 -5 1 0 0 0 0 -1 0 1 0 stud.dat
  [1,16,0,0,-5,1,0,0,0,0,-1,0,1,0, ldraw_lib__stud(realsolid)],
// 0
];
module ldraw_lib__20(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__20(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
