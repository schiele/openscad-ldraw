...
use <s/3349s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3349p02(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3349s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3349s01(realsolid)],
// 
// 1 1 2 -102 -2 0 0 4 4 0 0 0 2 0 2-4disc.dat
  [1,1,2,-102,-2,0,0,4,4,0,0,0,2,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 2 -102 -2 0 0 4 4 0 0 0 2 0 2-4ring1.dat
  [1,16,2,-102,-2,0,0,4,4,0,0,0,2,0, ldraw_lib__2_4ring1(realsolid)],
// 1 1 2 -102 -2 0 0 8 8 0 0 0 2 0 2-4ndis.dat
  [1,1,2,-102,-2,0,0,8,8,0,0,0,2,0, ldraw_lib__2_4ndis(realsolid)],
...
module ldraw_lib__3349p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3349p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
