...
use <004402a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__004402b(realsolid=false) = [
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 004402a.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__004402a(realsolid)],
];
module ldraw_lib__004402b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__004402b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
