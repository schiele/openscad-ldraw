...
use <13733.scad>
use <14396p02.scad>
function ldraw_lib__14397p02c01() = [
...
// 0 !KEYWORDS Rebrickable 14379pr0005, Set 10267
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 14396p02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__14396p02()],
];
module ldraw_lib__14397p02c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__14397p02c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
