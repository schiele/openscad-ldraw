...
$fa=1; $fs=0.2;
function ldraw_lib__61345(realsolid=false) = [
...
// 1 16 0 48 0 -4 0 0 0 -4 0 0 0 6 box3u8p.dat
  [1,16,0,48,0,-4,0,0,0,-4,0,0,0,6, ldraw_lib__box3u8p(realsolid)],
// 3 16 -4 48 -6 4 48 -6 0 48 -10
  [3,16,-4,48,-6,4,48,-6,0,48,-10],
// 3 16 0 48 10 4 48 6 -4 48 6
  [3,16,0,48,10,4,48,6,-4,48,6],
// 1 16 -2 21.5 -6 0 0 -1 18.5 0 0 0 1 0 box2-5.dat
  [1,16,-2,21.5,-6,0,0,-1,18.5,0,0,0,1,0, ldraw_lib__box2_5(realsolid)],
// 1 16 2 21.5 -6 0 0 1 -18.5 0 0 0 1 0 box2-5.dat
  [1,16,2,21.5,-6,0,0,1,-18.5,0,0,0,1,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 21.5 -5 1 0 0 0 0 18.5 0 -2 0 box5-4a.dat
  [1,16,0,21.5,-5,1,0,0,0,0,18.5,0,-2,0, ldraw_lib__box5_4a(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\61345s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__61345s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\61345s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__61345s01(realsolid)],
...
module ldraw_lib__61345(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__61345(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
