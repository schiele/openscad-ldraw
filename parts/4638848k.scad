...
use <4638848j.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4638848k(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 4638848j.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__4638848j(realsolid)],
];
module ldraw_lib__4638848k(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4638848k(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
