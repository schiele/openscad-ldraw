...
use <../p/4-8sphe.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32134(realsolid=false) = [
...
// 1 16 0 0 14 22 0 0 0 0 22 0 -1 0 4-4edge.dat
  [1,16,0,0,14,22,0,0,0,0,22,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 0 22 0 0 0 0 22 0 -1 0 4-4edge.dat
  [1,16,0,0,0,22,0,0,0,0,22,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 14 22 0 0 0 0 22 0 -14 0 4-4cyli.dat
  [1,16,0,0,14,22,0,0,0,0,22,0,-14,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 16 26 0 0 0 0 26 0 -16 0 4-4cyli.dat
  [1,16,0,0,16,26,0,0,0,0,26,0,-16,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 0 26 0 0 0 0 26 0 -1 0 4-4edge.dat
  [1,16,0,0,0,26,0,0,0,0,26,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 16 26 0 0 0 0 26 0 26 0 4-8sphe.dat
  [1,16,0,0,16,26,0,0,0,0,26,0,26,0, ldraw_lib__4_8sphe(realsolid)],
// 1 16 0 0 14 22 0 0 0 0 22 0 1 0 4-4disc.dat
  [1,16,0,0,14,22,0,0,0,0,22,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 0 2 0 0 0 0 2 0 1 0 4-4rin11.dat
  [1,16,0,0,0,2,0,0,0,0,2,0,1,0, ldraw_lib__4_4rin11(realsolid)],
// 1 16 0 0 0 2 0 0 0 0 2 0 1 0 4-4rin12.dat
  [1,16,0,0,0,2,0,0,0,0,2,0,1,0, ldraw_lib__4_4rin12(realsolid)],
// 
];
module ldraw_lib__32134(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32134(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
