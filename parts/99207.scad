...
$fa=1; $fs=0.2;
function ldraw_lib__99207(realsolid=false) = [
...
// 1 16 0 -15 0 -20 0 0 0 15 0 0 0 -10 box2-7.dat
  [1,16,0,-15,0,-20,0,0,0,15,0,0,0,-10, ldraw_lib__box2_7(realsolid)],
// 2 24 -18 -32 -10 18 -32 -10
  [2,24,-18,-32,-10,18,-32,-10],
// 4 16 -20 -30 -10 -18 -32 -10 18 -32 -10 20 -30 -10
  [4,16,-20,-30,-10,-18,-32,-10,18,-32,-10,20,-30,-10],
// 1 16 -18 -30 -10 -2 0 0 0 0 -2 0 -1 0 1-4chrd.dat
  [1,16,-18,-30,-10,-2,0,0,0,0,-2,0,-1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 18 -30 -10 0 0 2 -2 0 0 0 -1 0 1-4chrd.dat
  [1,16,18,-30,-10,0,0,2,-2,0,0,0,-1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 18 -30 -14 2 0 0 0 0 -2 0 4 0 1-4cylc.dat
  [1,16,18,-30,-14,2,0,0,0,0,-2,0,4,0, ldraw_lib__1_4cylc(realsolid)],
// 1 16 -18 -30 -14 0 0 -2 -2 0 0 0 4 0 1-4cylc.dat
  [1,16,-18,-30,-14,0,0,-2,-2,0,0,0,4,0, ldraw_lib__1_4cylc(realsolid)],
// 1 16 0 -31 -12 -18 0 0 0 0 -1 0 -2 0 box2-11.dat
  [1,16,0,-31,-12,-18,0,0,0,0,-1,0,-2,0, ldraw_lib__box2_11(realsolid)],
...
// 1 16 0 -22 -14 -1 0 0 0 0 1 0 1 0 stug2-1x2.dat
  [1,16,0,-22,-14,-1,0,0,0,0,1,0,1,0, ldraw_lib__stug2_1x2(realsolid)],
];
module ldraw_lib__99207(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__99207(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
