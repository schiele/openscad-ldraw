...
use <../p/stug-8x1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3585(realsolid=false) = [
// 0 Wing  7 x 12 Right
// 0 Name: 3585.dat
...
module ldraw_lib__3585(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3585(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3585(line=0.2);