...
$fa=1; $fs=0.2;
function ldraw_lib__31043(realsolid=false) = [
...
// 1 16 168 0 88 72 0 0 0 1 0 0 0 72 48\1-4disc.dat
  [1,16,168,0,88,72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 -168 0 88 -72 0 0 0 1 0 0 0 72 48\1-4disc.dat
  [1,16,-168,0,88,-72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 -168 0 -88 -72 0 0 0 1 0 0 0 -72 48\1-4disc.dat
  [1,16,-168,0,-88,-72,0,0,0,1,0,0,0,-72, ldraw_lib__48__1_4disc(realsolid)],
...
// 1 16 168 4 88 72 0 0 0 -1 0 0 0 72 48\1-4disc.dat
  [1,16,168,4,88,72,0,0,0,-1,0,0,0,72, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 -168 4 88 -72 0 0 0 -1 0 0 0 72 48\1-4disc.dat
  [1,16,-168,4,88,-72,0,0,0,-1,0,0,0,72, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 -168 4 -88 -72 0 0 0 -1 0 0 0 -72 48\1-4disc.dat
  [1,16,-168,4,-88,-72,0,0,0,-1,0,0,0,-72, ldraw_lib__48__1_4disc(realsolid)],
...
// 1 16 168 0 88 72 0 0 0 4 0 0 0 72 48\1-4cyli.dat
  [1,16,168,0,88,72,0,0,0,4,0,0,0,72, ldraw_lib__48__1_4cyli(realsolid)],
// 1 16 -168 0 88 -72 0 0 0 4 0 0 0 72 48\1-4cyli.dat
  [1,16,-168,0,88,-72,0,0,0,4,0,0,0,72, ldraw_lib__48__1_4cyli(realsolid)],
// 1 16 -168 0 -88 -72 0 0 0 4 0 0 0 -72 48\1-4cyli.dat
  [1,16,-168,0,-88,-72,0,0,0,4,0,0,0,-72, ldraw_lib__48__1_4cyli(realsolid)],
...
// 1 16 168 0 88 72 0 0 0 1 0 0 0 72 48\1-4edge.dat
  [1,16,168,0,88,72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 -168 0 88 -72 0 0 0 1 0 0 0 72 48\1-4edge.dat
  [1,16,-168,0,88,-72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 -168 0 -88 -72 0 0 0 1 0 0 0 -72 48\1-4edge.dat
  [1,16,-168,0,-88,-72,0,0,0,1,0,0,0,-72, ldraw_lib__48__1_4edge(realsolid)],
...
// 1 16 168 4 88 72 0 0 0 1 0 0 0 72 48\1-4edge.dat
  [1,16,168,4,88,72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 -168 4 88 -72 0 0 0 1 0 0 0 72 48\1-4edge.dat
  [1,16,-168,4,88,-72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 -168 4 -88 -72 0 0 0 1 0 0 0 -72 48\1-4edge.dat
  [1,16,-168,4,-88,-72,0,0,0,1,0,0,0,-72, ldraw_lib__48__1_4edge(realsolid)],
...
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 stug20-8x8.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug20_8x8(realsolid)],
// 1 16 180 0 0 0 0 1 0 1 0 -1 0 0 stug20-1x8.dat
  [1,16,180,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug20_1x8(realsolid)],
// 1 16 -180 0 0 0 0 1 0 1 0 -1 0 0 stug20-1x8.dat
  [1,16,-180,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug20_1x8(realsolid)],
// 1 16 220 0 0 0 0 1 0 1 0 -1 0 0 stug20-1x6.dat
  [1,16,220,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug20_1x6(realsolid)],
// 1 16 -220 0 0 0 0 1 0 1 0 -1 0 0 stug20-1x6.dat
  [1,16,-220,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug20_1x6(realsolid)],
];
module ldraw_lib__31043(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__31043(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
