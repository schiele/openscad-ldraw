...
// 
// 0 !CATEGORY Brick
// 0 !KEYWORDS Automatic Binding Brick, BrickLink bslot03bR, Lego Mursten
// 0 !KEYWORDS Rebrickable 3002f
// 
...
module ldraw_lib__u8003d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8003d(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
