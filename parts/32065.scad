...
use <../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32065(realsolid=false) = [
...
// 1 16 9 0 0 0 -1 0 0 0 -5 60 0 0 rect2p.dat
  [1,16,9,0,0,0,-1,0,0,0,-5,60,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -9 0 0 0 1 0 0 0 -5 -60 0 0 rect2p.dat
  [1,16,-9,0,0,0,1,0,0,0,-5,-60,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 5 50 1 0 0 0 -3 0 0 0 1 npeghol2.dat
  [1,16,0,5,50,1,0,0,0,-3,0,0,0,1, ldraw_lib__npeghol2(realsolid)],
// 1 16 0 -5 50 1 0 0 0 3 0 0 0 1 npeghol2.dat
  [1,16,0,-5,50,1,0,0,0,3,0,0,0,1, ldraw_lib__npeghol2(realsolid)],
// 1 16 0 5 30 1 0 0 0 -3 0 0 0 1 npeghol2.dat
  [1,16,0,5,30,1,0,0,0,-3,0,0,0,1, ldraw_lib__npeghol2(realsolid)],
// 1 16 0 -5 30 1 0 0 0 3 0 0 0 1 npeghol2.dat
  [1,16,0,-5,30,1,0,0,0,3,0,0,0,1, ldraw_lib__npeghol2(realsolid)],
...
module ldraw_lib__32065(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32065(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
