...
$fa=1; $fs=0.2;
function ldraw_lib__6327015a(realsolid=false) = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\6327015as04.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6327015as04(realsolid)],
];
module ldraw_lib__6327015a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6327015a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
