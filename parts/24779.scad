...
use <s/24779s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__24779(realsolid=false) = [
// 0 Minifig Tail Duck
// 0 Name: 24779.dat
...
// 1 16 0 -1.5 10 0 0 -18 1.5 0 0 0 -20 0 box3u2p.dat
  [1,16,0,-1.5,10,0,0,-18,1.5,0,0,0,-20,0, ldraw_lib__box3u2p(realsolid)],
];
module ldraw_lib__24779(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__24779(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
