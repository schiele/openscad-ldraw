...
use <30187c02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30187c03(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 30187c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30187c01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 30187c02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30187c02(realsolid)],
// 0
];
module ldraw_lib__30187c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30187c03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
