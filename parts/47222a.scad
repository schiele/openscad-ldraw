...
// 1 16 10 11 -30 0 13 0 0 0 4 4 0 0 4-4cylo.dat
  [1,16,10,11,-30,0,13,0,0,0,4,4,0,0, ldraw_lib__4_4cylo()],
// 1 16 24 11 -30 0 1 0 0 0 3 3 0 0 4-4edge.dat
  [1,16,24,11,-30,0,1,0,0,0,3,3,0,0, ldraw_lib__4_4edge()],
// 1 16 23 11 -30 0 1 0 0 0 1 -1 0 0 4-4con3.dat
  [1,16,23,11,-30,0,1,0,0,0,1,-1,0,0, ldraw_lib__4_4con3()],
// 1 16 24 11 -30 0 -1 0 0 0 1 1 0 0 4-4ring2.dat
  [1,16,24,11,-30,0,-1,0,0,0,1,1,0,0, ldraw_lib__4_4ring2()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 7 11 -30 0 17 0 0 0 2 2 0 0 4-4cylo.dat
  [1,16,7,11,-30,0,17,0,0,0,2,2,0,0, ldraw_lib__4_4cylo()],
// 1 16 10 0 -24 0 13 0 0 0 4 4 0 0 4-4cylo.dat
  [1,16,10,0,-24,0,13,0,0,0,4,4,0,0, ldraw_lib__4_4cylo()],
// 1 16 24 0 -24 0 1 0 0 0 3 3 0 0 4-4edge.dat
  [1,16,24,0,-24,0,1,0,0,0,3,3,0,0, ldraw_lib__4_4edge()],
// 1 16 23 0 -24 0 1 0 0 0 1 -1 0 0 4-4con3.dat
  [1,16,23,0,-24,0,1,0,0,0,1,-1,0,0, ldraw_lib__4_4con3()],
// 1 16 24 0 -24 0 -1 0 0 0 1 1 0 0 4-4ring2.dat
  [1,16,24,0,-24,0,-1,0,0,0,1,1,0,0, ldraw_lib__4_4ring2()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 7 0 -24 0 17 0 0 0 2 2 0 0 4-4cylo.dat
  [1,16,7,0,-24,0,17,0,0,0,2,2,0,0, ldraw_lib__4_4cylo()],
// 1 16 10 -11 -30 0 13 0 0 0 4 4 0 0 4-4cylo.dat
  [1,16,10,-11,-30,0,13,0,0,0,4,4,0,0, ldraw_lib__4_4cylo()],
// 1 16 24 -11 -30 0 1 0 0 0 3 3 0 0 4-4edge.dat
  [1,16,24,-11,-30,0,1,0,0,0,3,3,0,0, ldraw_lib__4_4edge()],
...
module ldraw_lib__47222a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__47222a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
