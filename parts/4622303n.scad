...
use <4622303m.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4622303n(realsolid=false) = [
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 4622303m.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__4622303m(realsolid)],
];
module ldraw_lib__4622303n(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4622303n(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
