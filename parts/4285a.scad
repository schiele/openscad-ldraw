...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4285a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\4285s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4285s01(realsolid)],
// 1 16 0 0 0 0.707 0 -0.707 0 1 0 0.707 0 0.707 s\4285s01.dat
  [1,16,0,0,0,0.707,0,-0.707,0,1,0,0.707,0,0.707, ldraw_lib__s__4285s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\4285s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__4285s01(realsolid)],
// 1 16 0 0 0 -0.707 0 -0.707 0 1 0 0.707 0 -0.707 s\4285s01.dat
  [1,16,0,0,0,-0.707,0,-0.707,0,1,0,0.707,0,-0.707, ldraw_lib__s__4285s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\4285s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__4285s01(realsolid)],
...
// 1 16 0 0 0 6 0 0 0 1 0 0 0 6 4-4ring3.dat
  [1,16,0,0,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4ring3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 2 0 24 0 0 0 6 0 0 0 24 4-4cyli.dat
  [1,16,0,2,0,24,0,0,0,6,0,0,0,24, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 0 21 0 0 0 4 0 0 0 21 4-4cyli.dat
  [1,16,0,4,0,21,0,0,0,4,0,0,0,21, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 8 0 21 0 0 0 1 0 0 0 21 4-4edge.dat
  [1,16,0,8,0,21,0,0,0,1,0,0,0,21, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 4 0 21 0 0 0 1 0 0 0 21 4-4edge.dat
  [1,16,0,4,0,21,0,0,0,1,0,0,0,21, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 4 0 6 0 0 0 -1 0 0 0 6 4-4ring1.dat
  [1,16,0,4,0,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4ring1(realsolid)],
// 1 16 0 4 0 6 0 0 0 -1 0 0 0 6 4-4ring2.dat
  [1,16,0,4,0,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4ring2(realsolid)],
// 1 16 0 4 0 3 0 0 0 -1 0 0 0 3 4-4ring6.dat
  [1,16,0,4,0,3,0,0,0,-1,0,0,0,3, ldraw_lib__4_4ring6(realsolid)],
...
module ldraw_lib__4285a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4285a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
