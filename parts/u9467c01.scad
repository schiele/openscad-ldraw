...
// 1 0 0 0 -9 1 0 0 0 1 0 0 0 1 u9466.dat
  [1,0,0,0,-9,1,0,0,0,1,0,0,0,1, ldraw_lib__u9466()],
// 1 494 -40 0 6 1 0 0 0 1 0 0 0 1 u9464.dat
  [1,494,-40,0,6,1,0,0,0,1,0,0,0,1, ldraw_lib__u9464()],
// 1 47 -40 0 -8 1 0 0 0 1 0 0 0 1 u9465.dat
  [1,47,-40,0,-8,1,0,0,0,1,0,0,0,1, ldraw_lib__u9465()],
// 1 494 40 0 6 1 0 0 0 1 0 0 0 1 u9464.dat
  [1,494,40,0,6,1,0,0,0,1,0,0,0,1, ldraw_lib__u9464()],
// 1 47 40 0 -8 1 0 0 0 1 0 0 0 1 u9465.dat
  [1,47,40,0,-8,1,0,0,0,1,0,0,0,1, ldraw_lib__u9465()],
// 1 16 0 0 -9 1 0 0 0 1 0 0 0 1 u9467.dat
  [1,16,0,0,-9,1,0,0,0,1,0,0,0,1, ldraw_lib__u9467()],
// 1 16 0 0 30 1 0 0 0 1 0 0 0 1 u9468.dat
  [1,16,0,0,30,1,0,0,0,1,0,0,0,1, ldraw_lib__u9468()],
// 0 // See-through blockers
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 15 -40 0 -5 5 0 0 0 0 5 0 14 0 4-4con3.dat
  [1,15,-40,0,-5,5,0,0,0,0,5,0,14,0, ldraw_lib__4_4con3()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 15 40 0 -5 5 0 0 0 0 5 0 14 0 4-4con3.dat
  [1,15,40,0,-5,5,0,0,0,0,5,0,14,0, ldraw_lib__4_4con3()],
...
module ldraw_lib__u9467c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9467c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
