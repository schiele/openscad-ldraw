...
use <s/3817bs01.scad>
use <s/3817bs03.scad>
function ldraw_lib__3816bp8h() = [
// 0 ~Minifig Leg Right with Reflective Stripe Pattern (Obsolete)
// 0 Name: 3816bp8h.dat
...
module ldraw_lib__3816bp8h(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3816bp8h(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
