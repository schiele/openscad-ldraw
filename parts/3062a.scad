...
// 1 16 0 0 0 10 0 0 0 19 0 0 0 10 4-4cylc.dat
  [1,16,0,0,0,10,0,0,0,19,0,0,0,10, ldraw_lib__4_4cylc()],
...
module ldraw_lib__3062a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3062a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
