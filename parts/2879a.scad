...
use <2895.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2879a(realsolid=false) = [
// 0 ~Moved to 2895
// 0 Name: 2879a.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 11 1 0 0 0 1 0 0 0 1 2895.dat
  [1,16,0,0,11,1,0,0,0,1,0,0,0,1, ldraw_lib__2895(realsolid)],
];
module ldraw_lib__2879a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2879a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
