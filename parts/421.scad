...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__421(realsolid=false) = [
...
// 1 16 92 -18 -14 0 0 -2 0 3 0 2 0 0 2-4cylo.dat
  [1,16,92,-18,-14,0,0,-2,0,3,0,2,0,0, ldraw_lib__2_4cylo(realsolid)],
// 1 16 92 -18 -14 0 0 -2 0 1 0 2 0 0 2-4chrd.dat
  [1,16,92,-18,-14,0,0,-2,0,1,0,2,0,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 92 -15 -14 0 0 -2 0 1 0 2 0 0 2-4ndis.dat
  [1,16,92,-15,-14,0,0,-2,0,1,0,2,0,0, ldraw_lib__2_4ndis(realsolid)],
// 
// 1 16 93 -15 -14 -1 0 0 0 -3 0 0 0 2 box3u10p.dat
  [1,16,93,-15,-14,-1,0,0,0,-3,0,0,0,2, ldraw_lib__box3u10p(realsolid)],
// 
// 1 16 94 -18 -14 0 0 2 0 3 0 -2 0 0 2-4cylo.dat
  [1,16,94,-18,-14,0,0,2,0,3,0,-2,0,0, ldraw_lib__2_4cylo(realsolid)],
// 1 16 94 -18 -14 0 0 2 0 1 0 -2 0 0 2-4chrd.dat
  [1,16,94,-18,-14,0,0,2,0,1,0,-2,0,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 94 -15 -14 0 0 2 0 1 0 -2 0 0 2-4ndis.dat
  [1,16,94,-15,-14,0,0,2,0,1,0,-2,0,0, ldraw_lib__2_4ndis(realsolid)],
// 
// 1 16 108 -15 -14 0 0 12 0 1 0 -2 0 0 rect3.dat
  [1,16,108,-15,-14,0,0,12,0,1,0,-2,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 -15 -15 -14 0 0 -105 0 1 0 2 0 0 rect3.dat
  [1,16,-15,-15,-14,0,0,-105,0,1,0,2,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 -5 -14 120 0 0 0 -1 0 0 0 -2 rect3.dat
  [1,16,0,-5,-14,120,0,0,0,-1,0,0,0,-2, ldraw_lib__rect3(realsolid)],
// 1 16 0 -10 -12 0 0 120 -5 0 0 0 -4 0 box3u10p.dat
  [1,16,0,-10,-12,0,0,120,-5,0,0,0,-4,0, ldraw_lib__box3u10p(realsolid)],
// 
// 1 16 0 -12.5 -12 0 0 120 2.5 0 0 0 -1 0 rect2p.dat
  [1,16,0,-12.5,-12,0,0,120,2.5,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 
// 1 16 0 -5 14 -120 0 0 0 -1 0 0 0 2 rect3.dat
  [1,16,0,-5,14,-120,0,0,0,-1,0,0,0,2, ldraw_lib__rect3(realsolid)],
// 1 16 0 -10 12 0 0 120 -5 0 0 0 4 0 box3u10p.dat
...
// 1 16 120 -7.5 0 0 -17.5 0 -2.5 0 0 0 0 -12 box3u5p.dat
  [1,16,120,-7.5,0,0,-17.5,0,-2.5,0,0,0,0,-12, ldraw_lib__box3u5p(realsolid)],
// 1 16 100 -10 0 0 0 -2.5 0 1 0 12 0 0 rect.dat
  [1,16,100,-10,0,0,0,-2.5,0,1,0,12,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 90 -5 0 -7.5 0 0 0 -5 0 0 0 -12 box4o4a.dat
  [1,16,90,-5,0,-7.5,0,0,0,-5,0,0,0,-12, ldraw_lib__box4o4a(realsolid)],
// 1 16 80 -10 0 0 0 -2.5 0 1 0 12 0 0 rect.dat
  [1,16,80,-10,0,0,0,-2.5,0,1,0,12,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 70 -5 0 -7.5 0 0 0 -5 0 0 0 -12 box4o4a.dat
  [1,16,70,-5,0,-7.5,0,0,0,-5,0,0,0,-12, ldraw_lib__box4o4a(realsolid)],
// 1 16 60 -10 0 0 0 -2.5 0 1 0 12 0 0 rect.dat
  [1,16,60,-10,0,0,0,-2.5,0,1,0,12,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 50 -5 0 -7.5 0 0 0 -5 0 0 0 -12 box4o4a.dat
  [1,16,50,-5,0,-7.5,0,0,0,-5,0,0,0,-12, ldraw_lib__box4o4a(realsolid)],
// 1 16 40 -10 0 0 0 -2.5 0 1 0 12 0 0 rect.dat
  [1,16,40,-10,0,0,0,-2.5,0,1,0,12,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 29.75 -5 0 -7.75 0 0 0 -5 0 0 0 -12 box4o4a.dat
  [1,16,29.75,-5,0,-7.75,0,0,0,-5,0,0,0,-12, ldraw_lib__box4o4a(realsolid)],
// 1 16 19.5 -10 0 0 0 -2.5 0 1 0 12 0 0 rect.dat
  [1,16,19.5,-10,0,0,0,-2.5,0,1,0,12,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 9.75 -5 0 -7.25 0 0 0 -5 0 0 0 -12 box4o4a.dat
  [1,16,9.75,-5,0,-7.25,0,0,0,-5,0,0,0,-12, ldraw_lib__box4o4a(realsolid)],
// 1 16 0 -10 0 0 0 -2.5 0 1 0 12 0 0 rect.dat
  [1,16,0,-10,0,0,0,-2.5,0,1,0,12,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -10 -5 0 -7.5 0 0 0 -5 0 0 0 -12 box4o4a.dat
  [1,16,-10,-5,0,-7.5,0,0,0,-5,0,0,0,-12, ldraw_lib__box4o4a(realsolid)],
// 1 16 -20 -10 0 0 0 -2.5 0 1 0 12 0 0 rect.dat
  [1,16,-20,-10,0,0,0,-2.5,0,1,0,12,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -30 -5 0 -7.5 0 0 0 -5 0 0 0 -12 box4o4a.dat
  [1,16,-30,-5,0,-7.5,0,0,0,-5,0,0,0,-12, ldraw_lib__box4o4a(realsolid)],
// 1 16 -40 -10 0 0 0 -2.5 0 1 0 12 0 0 rect.dat
  [1,16,-40,-10,0,0,0,-2.5,0,1,0,12,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 -102.5 -5 0 0 -2 0 -2.5 0 0 0 0 -6.5 box5.dat
  [1,16,-102.5,-5,0,0,-2,0,-2.5,0,0,0,0,-6.5, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__421(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__421(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
