...
use <../p/stug-1x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__33909(realsolid=false) = [
...
// 1 16 0 0 10 -1 0 0 0 1 0 0 0 -1 stug-1x2.dat
  [1,16,0,0,10,-1,0,0,0,1,0,0,0,-1, ldraw_lib__stug_1x2(realsolid)],
];
module ldraw_lib__33909(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__33909(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
