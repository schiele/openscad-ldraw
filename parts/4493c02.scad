...
use <4494c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4493c02(realsolid=false) = [
...
// 1 16 0 -19.5 -33.5 1 0 0 0 0.984808 -0.173648 0 0.173648 0.984808 4492p02.dat
  [1,16,0,-19.5,-33.5,1,0,0,0,0.984808,-0.173648,0,0.173648,0.984808, ldraw_lib__4492p02(realsolid)],
...
module ldraw_lib__4493c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4493c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
