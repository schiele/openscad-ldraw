...
use <u9190c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__99499c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 99499.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__99499(realsolid)],
// 1 0 0 0 130 1 0 0 0 1 0 0 0 1 u9190c01.dat
  [1,0,0,0,130,1,0,0,0,1,0,0,0,1, ldraw_lib__u9190c01(realsolid)],
];
module ldraw_lib__99499c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__99499c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
