...
use <32004b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32004bc01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 32004b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32004b(realsolid)],
// 1 256 0 0 -1.5 1 0 0 0 1 0 0 0 1 32003.dat
  [1,256,0,0,-1.5,1,0,0,0,1,0,0,0,1, ldraw_lib__32003(realsolid)],
];
module ldraw_lib__32004bc01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32004bc01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
