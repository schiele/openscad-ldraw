...
use <s/67100s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__67100p01k01(realsolid=false) = [
...
// 1 16 0 -15 0 1 0 0 0 1 0 0 0 1 s\67100s01.dat
  [1,16,0,-15,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__67100s01(realsolid)],
// 
// 1 0 0 15 0 4 0 0 0 -30 0 0 0 4 4-4cylc.dat
  [1,0,0,15,0,4,0,0,0,-30,0,0,0,4, ldraw_lib__4_4cylc(realsolid)],
];
module ldraw_lib__67100p01k01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__67100p01k01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
