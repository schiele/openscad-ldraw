...
$fa=1; $fs=0.2;
function ldraw_lib__4162pt1(realsolid=false) = [
...
// 1 16 0 0 0 2.5 0 0 0 1 0 0 0 2.5 s\logolambt01.dat
  [1,16,0,0,0,2.5,0,0,0,1,0,0,0,2.5, ldraw_lib__s__logolambt01(realsolid)],
...
module ldraw_lib__4162pt1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4162pt1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
