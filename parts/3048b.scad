...
use <../p/tri3u1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3048b(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3048a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3048a(realsolid)],
// 
// 1 16 2.5 14 0 0 0 1.5 -1.5 0.707 0 1.5 0.707 0 2-4edge.dat
  [1,16,2.5,14,0,0,0,1.5,-1.5,0.707,0,1.5,0.707,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -2.5 14 0 0 0 -1.5 -1.5 0.707 0 1.5 0.707 0 2-4edge.dat
  [1,16,-2.5,14,0,0,0,-1.5,-1.5,0.707,0,1.5,0.707,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 2.5 15.5 0 0 0 1.5 0 -1.5 0 -1.5 0 0 2-4cyls.dat
  [1,16,2.5,15.5,0,0,0,1.5,0,-1.5,0,-1.5,0,0, ldraw_lib__2_4cyls(realsolid)],
// 1 16 -2.5 15.5 0 0 0 -1.5 0 -1.5 0 -1.5 0 0 2-4cyls.dat
  [1,16,-2.5,15.5,0,0,0,-1.5,0,-1.5,0,-1.5,0,0, ldraw_lib__2_4cyls(realsolid)],
// 1 16 -2.5 24 0 0 0 -1.5 0 -8.5 0 -1.5 0 0 2-4cyli.dat
  [1,16,-2.5,24,0,0,0,-1.5,0,-8.5,0,-1.5,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -2.5 24 0 0 0 -1.5 0 -1 0 -1.5 0 0 2-4edge.dat
  [1,16,-2.5,24,0,0,0,-1.5,0,-1,0,-1.5,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -2.5 24 0 0 0 -1.5 0 -1 0 -1.5 0 0 2-4chrd.dat
  [1,16,-2.5,24,0,0,0,-1.5,0,-1,0,-1.5,0,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 2.5 24 0 0 0 1.5 0 -8.5 0 1.5 0 0 2-4cyli.dat
  [1,16,2.5,24,0,0,0,1.5,0,-8.5,0,1.5,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 2.5 24 0 0 0 1.5 0 -1 0 1.5 0 0 2-4edge.dat
  [1,16,2.5,24,0,0,0,1.5,0,-1,0,1.5,0,0, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 -1 8 6 0 2 0 11 0 11 -11 0 0 tri3u1.dat
  [1,16,-1,8,6,0,2,0,11,0,11,-11,0,0, ldraw_lib__tri3u1(realsolid)],
// 1 16 0 15.75 1.5 1 0 0 0 0 3.25 0 1 0 recte3.dat
  [1,16,0,15.75,1.5,1,0,0,0,0,3.25,0,1,0, ldraw_lib__recte3(realsolid)],
// 1 16 0 17.25 -1.5 1 0 0 0 0 1.75 0 1 0 recte3.dat
  [1,16,0,17.25,-1.5,1,0,0,0,0,1.75,0,1,0, ldraw_lib__recte3(realsolid)],
// 
// 1 16 0 18.25 0 2.5 0 0 0 5.75 0 0 0 1.5 box2-9p.dat
  [1,16,0,18.25,0,2.5,0,0,0,5.75,0,0,0,1.5, ldraw_lib__box2_9p(realsolid)],
// 1 16 0 19.75 -1.5 0 0 -2.5 -4.25 0 0 0 1 0 rect1.dat
  [1,16,0,19.75,-1.5,0,0,-2.5,-4.25,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
];
module ldraw_lib__3048b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3048b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
