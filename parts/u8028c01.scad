...
use <u8039.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u8028c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 u8028.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u8028(realsolid)],
// 1 47 0 4 -5.5 1 0 0 0 1 0 0 0 1 u8039.dat
  [1,47,0,4,-5.5,1,0,0,0,1,0,0,0,1, ldraw_lib__u8039(realsolid)],
];
module ldraw_lib__u8028c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8028c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
