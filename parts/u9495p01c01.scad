...
$fa=1; $fs=0.2;
function ldraw_lib__u9495p01c01(realsolid=false) = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\u9495c01s02.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9495c01s02(realsolid)],
// 1 15 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9495c01s02.dat
  [1,15,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9495c01s02(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 15 0 0 0.25 1 0 0 0 1 0 0 0 1 s\u9495c01s02.dat
  [1,15,0,0,0.25,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9495c01s02(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 15 0 0 0.25 -1 0 0 0 1 0 0 0 1 s\u9495c01s02.dat
  [1,15,0,0,0.25,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9495c01s02(realsolid)],
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\u9495c01s04.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9495c01s04(realsolid)],
// 1 15 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9495c01s04.dat
  [1,15,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9495c01s04(realsolid)],
];
module ldraw_lib__u9495p01c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9495p01c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
