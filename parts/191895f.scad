...
// 1 16 0 -0.25 -20 0.415 0 0 0 1 0 0 0 0.415 s\191895s01.dat
  [1,16,0,-0.25,-20,0.415,0,0,0,1,0,0,0,0.415, ldraw_lib__s__191895s01()],
// 1 16 0 -0.25 7.328 0.34 0 0 0 1 0 0 0 0.34 s\191915sat.dat
  [1,16,0,-0.25,7.328,0.34,0,0,0,1,0,0,0,0.34, ldraw_lib__s__191915sat()],
...
module ldraw_lib__191895f(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__191895f(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
