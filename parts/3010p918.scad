...
use <s/3010s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3010p918(realsolid=false) = [
...
// 1 16 7 13 -10 .5 0 -1 0 0 .5 0 1 0 1-4ndis.dat
  [1,16,7,13,-10,.5,0,-1,0,0,.5,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 15 7 13 -10 .5 0 -1 0 0 .5 0 1 0 1-4disc.dat
  [1,15,7,13,-10,.5,0,-1,0,0,.5,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 1 9 -10 -4 0 0 0 0 -3 0 1 0 1-4ndis.dat
  [1,16,1,9,-10,-4,0,0,0,0,-3,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 15 1 9 -10 -4 0 0 0 0 -3 0 1 0 1-4disc.dat
  [1,15,1,9,-10,-4,0,0,0,0,-3,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 7 9 -10 4 0 0 0 0 -3 0 1 0 1-4ndis.dat
  [1,16,7,9,-10,4,0,0,0,0,-3,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 15 7 9 -10 4 0 0 0 0 -3 0 1 0 1-4disc.dat
  [1,15,7,9,-10,4,0,0,0,0,-3,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 4 15 1 6 -10 7 6 -10 7 9 -10 1 9 -10
  [4,15,1,6,-10,7,6,-10,7,9,-10,1,9,-10],
// 1 15 2 9.75 -10 0 0 -1.5 .75 0 0 0 1 0 2-4ndis.dat
  [1,15,2,9.75,-10,0,0,-1.5,.75,0,0,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 2 9.75 -10 0 0 -1.5 .75 0 0 0 1 0 2-4disc.dat
  [1,16,2,9.75,-10,0,0,-1.5,.75,0,0,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 15 6 9.75 -10 0 0 1.5 .75 0 0 0 1 0 2-4ndis.dat
  [1,15,6,9.75,-10,0,0,1.5,.75,0,0,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 6 9.75 -10 0 0 1.5 .75 0 0 0 1 0 2-4disc.dat
  [1,16,6,9.75,-10,0,0,1.5,.75,0,0,0,1,0, ldraw_lib__2_4disc(realsolid)],
...
// 1 16 1 10.5 -10 -4 0 0 0 0 3 0 1 0 1-4ndis.dat
  [1,16,1,10.5,-10,-4,0,0,0,0,3,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 15 1 10.5 -10 -4 0 0 0 0 3 0 1 0 1-4disc.dat
  [1,15,1,10.5,-10,-4,0,0,0,0,3,0,1,0, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 1 15 -10 -4 0 0 0 0 3 0 1 0 1-4ndis.dat
  [1,16,1,15,-10,-4,0,0,0,0,3,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 15 1 15 -10 -4 0 0 0 0 3 0 1 0 1-4disc.dat
  [1,15,1,15,-10,-4,0,0,0,0,3,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 7 15 -10 4 0 0 0 0 3 0 1 0 1-4ndis.dat
  [1,16,7,15,-10,4,0,0,0,0,3,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 15 7 15 -10 4 0 0 0 0 3 0 1 0 1-4disc.dat
  [1,15,7,15,-10,4,0,0,0,0,3,0,1,0, ldraw_lib__1_4disc(realsolid)],
...
// 1 15 2 14.5 -10 -1.5 0 0 0 0 .5 0 1 0 1-4ndis.dat
  [1,15,2,14.5,-10,-1.5,0,0,0,0,.5,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 2 14.5 -10 -1.5 0 0 0 0 .5 0 1 0 1-4disc.dat
  [1,16,2,14.5,-10,-1.5,0,0,0,0,.5,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 15 6 14.5 -10 1.5 0 0 0 0 .5 0 1 0 1-4ndis.dat
  [1,15,6,14.5,-10,1.5,0,0,0,0,.5,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 6 14.5 -10 1.5 0 0 0 0 .5 0 1 0 1-4disc.dat
  [1,16,6,14.5,-10,1.5,0,0,0,0,.5,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 
// 0 "1"
...
module ldraw_lib__3010p918(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3010p918(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
