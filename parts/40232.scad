...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__40232(realsolid=false) = [
// 0 Animal Owl
// 0 Name: 40232.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\40232s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__40232s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\40232s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__40232s01(realsolid)],
// 
...
// 1 16 0 -4 0 6 0 0 0 -37 0 0 0 6 4-4cyli.dat
  [1,16,0,-4,0,6,0,0,0,-37,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 -41 0 6 0 0 0 -1 0 0 0 6 4-4disc.dat
  [1,16,0,-41,0,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4disc(realsolid)],
// 0
];
module ldraw_lib__40232(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__40232(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__40232(line=0.2);