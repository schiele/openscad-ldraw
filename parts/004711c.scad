...
use <s/3069bs18.scad>
$fa=1; $fs=0.2;
function ldraw_lib__004711c(realsolid=false) = [
...
// 1 15 0 -0.25 0 .98 0 0 0 1 0 0 0 .7 s\3069bs18.dat
  [1,15,0,-0.25,0,.98,0,0,0,1,0,0,0,.7, ldraw_lib__s__3069bs18(realsolid)],
// 1 16 0 -0.25 0 24 0 0 0 0.25 0 0 0 4 box5-12.dat
  [1,16,0,-0.25,0,24,0,0,0,0.25,0,0,0,4, ldraw_lib__box5_12(realsolid)],
...
module ldraw_lib__004711c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__004711c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
