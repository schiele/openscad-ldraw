...
use <../p/stug-2x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__17114(realsolid=false) = [
...
// 1 16 20 10 0 0 1 0 1 0 0 0 0 -1 axlehol9.dat
  [1,16,20,10,0,0,1,0,1,0,0,0,0,-1, ldraw_lib__axlehol9(realsolid)],
// 1 16 20 10 0 0 1 0 1 0 0 0 0 -1 axlehol2.dat
  [1,16,20,10,0,0,1,0,1,0,0,0,0,-1, ldraw_lib__axlehol2(realsolid)],
...
module ldraw_lib__17114(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__17114(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
