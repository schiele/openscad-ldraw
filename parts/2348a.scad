...
use <../p/recte3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2348a(realsolid=false) = [
...
// 1 16 0 -3 18.5 30 0 0 0 -1 0 0 0 18.5 box2-7.dat
  [1,16,0,-3,18.5,30,0,0,0,-1,0,0,0,18.5, ldraw_lib__box2_7(realsolid)],
// 
// 1 16 -30 0 0 0 60 0 0 0 -4 -4 0 0 1-4cylo.dat
  [1,16,-30,0,0,0,60,0,0,0,-4,-4,0,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 0 0 -3 27 0 0 0 -1 0 0 0 1 rect.dat
  [1,16,0,0,-3,27,0,0,0,-1,0,0,0,1, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -27 0 0 0 54 0 0 0 -2 -2 0 0 1-4cylc.dat
  [1,16,-27,0,0,0,54,0,0,0,-2,-2,0,0, ldraw_lib__1_4cylc(realsolid)],
// 1 16 27 0 0 0 1 0 0 0 -2 -2 0 0 1-4disc.dat
  [1,16,27,0,0,0,1,0,0,0,-2,-2,0,0, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 0 -2 20.5 30 0 0 0 1 0 0 0 16.5 recte3.dat
  [1,16,0,-2,20.5,30,0,0,0,1,0,0,0,16.5, ldraw_lib__recte3(realsolid)],
// 
// 1 16 28.5 -1 2 0 0 -1.5 -1 0 0 0 2 0 box2-9.dat
  [1,16,28.5,-1,2,0,0,-1.5,-1,0,0,0,2,0, ldraw_lib__box2_9(realsolid)],
// 1 16 -28.5 -1 2 0 0 1.5 -1 0 0 0 2 0 box2-9.dat
  [1,16,-28.5,-1,2,0,0,1.5,-1,0,0,0,2,0, ldraw_lib__box2_9(realsolid)],
// 
// 1 16 27 0 0 0 3 0 0 0 4 4 0 0 2-4cylc.dat
  [1,16,27,0,0,0,3,0,0,0,4,4,0,0, ldraw_lib__2_4cylc(realsolid)],
// 1 16 -27 0 0 0 -3 0 0 0 4 4 0 0 2-4cylc.dat
  [1,16,-27,0,0,0,-3,0,0,0,4,4,0,0, ldraw_lib__2_4cylc(realsolid)],
// 
// 1 16 30 0 0 0 -1 0 -2 0 0 0 0 -2 3-4ring1.dat
  [1,16,30,0,0,0,-1,0,-2,0,0,0,0,-2, ldraw_lib__3_4ring1(realsolid)],
// 1 16 30 0 0 0 -1 0 0 0 -2 2 0 0 1-4ndis.dat
  [1,16,30,0,0,0,-1,0,0,0,-2,2,0,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 30 -1 3 0 -1 0 0 0 -1 1 0 0 rect1.dat
  [1,16,30,-1,3,0,-1,0,0,0,-1,1,0,0, ldraw_lib__rect1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 30 0 0 0 1 0 -2 0 0 0 0 2 bump5000.dat
  [1,16,30,0,0,0,1,0,-2,0,0,0,0,2, ldraw_lib__bump5000(realsolid)],
// 
// 1 16 -30 0 0 0 1 0 0 0 2 2 0 0 3-4ring1.dat
  [1,16,-30,0,0,0,1,0,0,0,2,2,0,0, ldraw_lib__3_4ring1(realsolid)],
// 1 16 -30 0 0 0 1 0 -2 0 0 0 0 2 1-4ndis.dat
  [1,16,-30,0,0,0,1,0,-2,0,0,0,0,2, ldraw_lib__1_4ndis(realsolid)],
...
module ldraw_lib__2348a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2348a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
