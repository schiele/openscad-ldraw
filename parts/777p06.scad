...
use <s/777s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__777p06(realsolid=false) = [
// 0 Flag on Flagpole Type 2 with Austria Pattern
// 0 Name: 777p06.dat
...
module ldraw_lib__777p06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__777p06(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__777p06(line=0.2);