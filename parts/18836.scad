...
use <s/18836s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__18836(realsolid=false) = [
...
// 1 16 31.1247 -6.5 -12 -51.1247 0 0 0 0 46.00455 0 1 0 48\7-48chrd.dat
  [1,16,31.1247,-6.5,-12,-51.1247,0,0,0,0,46.00455,0,1,0, ldraw_lib__48__7_48chrd(realsolid)],
// 1 16 -31.1247 -6.5 -12 51.1247 0 0 0 0 46.00455 0 1 0 48\7-48chrd.dat
  [1,16,-31.1247,-6.5,-12,51.1247,0,0,0,0,46.00455,0,1,0, ldraw_lib__48__7_48chrd(realsolid)],
...
module ldraw_lib__18836(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__18836(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
