...
function ldraw_lib__101777() = [
// 0 Minifig Top Hat with Band
// 0 Name: 101777.dat
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\101777s05.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__101777s05()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\101777s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__101777s02()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\101777s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__101777s02()],
];
module ldraw_lib__101777(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__101777(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__101777(line=0.2);