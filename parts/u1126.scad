...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u1126(realsolid=false) = [
...
// 1 16 2.25 8 0 0 0 -18.25 0 -4 0 -6 0 0 box4-1.dat
  [1,16,2.25,8,0,0,0,-18.25,0,-4,0,-6,0,0, ldraw_lib__box4_1(realsolid)],
// 
...
// 1 16 18.25 4 0 0 0 -2.25 0 4 0 2.25 0 0 box4-4a.dat
  [1,16,18.25,4,0,0,0,-2.25,0,4,0,2.25,0,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 20.5 6 -4.125 0 1 0 0 0 2 1.875 0 0 rect2a.dat
  [1,16,20.5,6,-4.125,0,1,0,0,0,2,1.875,0,0, ldraw_lib__rect2a(realsolid)],
// 1 16 20.5 6 4.125 0 1 0 2 0 0 0 0 -1.875 rect2a.dat
  [1,16,20.5,6,4.125,0,1,0,2,0,0,0,0,-1.875, ldraw_lib__rect2a(realsolid)],
// 1 16 21.25 8 0 0.75 0 0 0 -1 0 0 0 -6 rect2p.dat
  [1,16,21.25,8,0,0.75,0,0,0,-1,0,0,0,-6, ldraw_lib__rect2p(realsolid)],
// 
...
// 1 16 22 4 -6 0 0 4 4 0 0 0 12 0 2-4cyli.dat
  [1,16,22,4,-6,0,0,4,4,0,0,0,12,0, ldraw_lib__2_4cyli(realsolid)],
...
// 1 16 30 4 -10 0 0 4 4 0 0 0 1 0 2-4edge.dat
  [1,16,30,4,-10,0,0,4,4,0,0,0,1,0, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 30 4 -10 0 0 4 4 0 0 0 1 0 2-4disc.dat
  [1,16,30,4,-10,0,0,4,4,0,0,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 30 4 10 0 0 4 4 0 0 0 -1 0 2-4disc.dat
  [1,16,30,4,10,0,0,4,4,0,0,0,-1,0, ldraw_lib__2_4disc(realsolid)],
// 
// 1 16 30 4 -10 0 0 4 4 0 0 0 4 0 2-4cyli.dat
  [1,16,30,4,-10,0,0,4,4,0,0,0,4,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 30 4 6 0 0 4 4 0 0 0 4 0 2-4cyli.dat
  [1,16,30,4,6,0,0,4,4,0,0,0,4,0, ldraw_lib__2_4cyli(realsolid)],
// 
// 1 16 26 4 6 4 0 0 0 0 4 0 4 0 box3u8p.dat
  [1,16,26,4,6,4,0,0,0,0,4,0,4,0, ldraw_lib__box3u8p(realsolid)],
...
module ldraw_lib__u1126(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u1126(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
