...
use <s/35860s05.scad>
$fa=1; $fs=0.2;
function ldraw_lib__35860(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\35860s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__35860s02(realsolid)],
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\35860s05.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__35860s05(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\35860s05.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__35860s05(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\35860s05.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__35860s05(realsolid)],
...
// 1 16 0 -20 0 .725 0 0 0 1 0 0 0 .725 s\35860s05.dat
  [1,16,0,-20,0,.725,0,0,0,1,0,0,0,.725, ldraw_lib__s__35860s05(realsolid)],
// 1 16 0 -20 0 .725 0 0 0 1 0 0 0 -.725 s\35860s05.dat
  [1,16,0,-20,0,.725,0,0,0,1,0,0,0,-.725, ldraw_lib__s__35860s05(realsolid)],
// 1 16 0 -20 0 -.725 0 0 0 1 0 0 0 .725 s\35860s05.dat
  [1,16,0,-20,0,-.725,0,0,0,1,0,0,0,.725, ldraw_lib__s__35860s05(realsolid)],
...
module ldraw_lib__35860(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__35860(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
