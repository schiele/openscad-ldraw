...
use <s/98138s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98138pxh(realsolid=false) = [
...
// 1 2 2 0 0 .70711 0 -.70711 0 1 0 .70711 0 .70711 s\98138pxcs01.dat
  [1,2,2,0,0,.70711,0,-.70711,0,1,0,.70711,0,.70711, ldraw_lib__s__98138pxcs01(realsolid)],
...
module ldraw_lib__98138pxh(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98138pxh(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
