...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4445(realsolid=false) = [
...
// 1 16 60 20 -10 1 0 0 0 -1 0 0 0 1 stud4a.dat
  [1,16,60,20,-10,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 60 4 -10 6 0 0 0 1 0 0 0 6 2-4edge.dat
  [1,16,60,4,-10,6,0,0,0,1,0,0,0,6, ldraw_lib__2_4edge(realsolid)],
// 1 16 60 4 -10 6 0 0 0 0.707 6 0 0.707 -6 2-4edge.dat
  [1,16,60,4,-10,6,0,0,0,0.707,6,0,0.707,-6, ldraw_lib__2_4edge(realsolid)],
// 1 16 60 4 -10 8 0 0 0 1 0 0 0 8 2-4edge.dat
  [1,16,60,4,-10,8,0,0,0,1,0,0,0,8, ldraw_lib__2_4edge(realsolid)],
// 1 16 60 4 -10 8 0 0 0 0.707 8 0 0.707 -8 2-4edge.dat
  [1,16,60,4,-10,8,0,0,0,0.707,8,0,0.707,-8, ldraw_lib__2_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 60 10 -10 0 0 6 0 -6 0 -6 0 0 1-4cyls.dat
  [1,16,60,10,-10,0,0,6,0,-6,0,-6,0,0, ldraw_lib__1_4cyls(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 60 10 -10 0 0 -6 0 -6 0 -6 0 0 1-4cyls.dat
  [1,16,60,10,-10,0,0,-6,0,-6,0,-6,0,0, ldraw_lib__1_4cyls(realsolid)],
...
// 1 16 60 4 -10 6 0 0 0 16 0 0 0 6 2-4cyli.dat
  [1,16,60,4,-10,6,0,0,0,16,0,0,0,6, ldraw_lib__2_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 60 10 -10 6 0 0 0 10 0 0 0 -6 2-4cyli.dat
  [1,16,60,10,-10,6,0,0,0,10,0,0,0,-6, ldraw_lib__2_4cyli(realsolid)],
// 1 16 60 12 -10 0 0 8 0 -8 0 -8 0 0 1-4cyls.dat
  [1,16,60,12,-10,0,0,8,0,-8,0,-8,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 60 12 -10 0 0 -8 0 -8 0 -8 0 0 1-4cyls.dat
  [1,16,60,12,-10,0,0,-8,0,-8,0,-8,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 60 4 -10 8 0 0 0 16 0 0 0 8 2-4cyli.dat
  [1,16,60,4,-10,8,0,0,0,16,0,0,0,8, ldraw_lib__2_4cyli(realsolid)],
// 1 16 60 12 -10 8 0 0 0 8 0 0 0 -8 2-4cyli.dat
  [1,16,60,12,-10,8,0,0,0,8,0,0,0,-8, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -60 20 -10 1 0 0 0 -1 0 0 0 1 stud4a.dat
  [1,16,-60,20,-10,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 -60 4 -10 6 0 0 0 1 0 0 0 6 2-4edge.dat
  [1,16,-60,4,-10,6,0,0,0,1,0,0,0,6, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 40 20 -10 1 0 0 0 -1 0 0 0 1 stud4a.dat
  [1,16,40,20,-10,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 40 4 -10 6 0 0 0 1 0 0 0 6 2-4edge.dat
  [1,16,40,4,-10,6,0,0,0,1,0,0,0,6, ldraw_lib__2_4edge(realsolid)],
// 1 16 40 4 -10 6 0 0 0 0.707 6 0 0.707 -6 2-4edge.dat
  [1,16,40,4,-10,6,0,0,0,0.707,6,0,0.707,-6, ldraw_lib__2_4edge(realsolid)],
// 1 16 40 4 -10 8 0 0 0 1 0 0 0 8 2-4edge.dat
  [1,16,40,4,-10,8,0,0,0,1,0,0,0,8, ldraw_lib__2_4edge(realsolid)],
// 1 16 40 4 -10 8 0 0 0 0.707 8 0 0.707 -8 2-4edge.dat
  [1,16,40,4,-10,8,0,0,0,0.707,8,0,0.707,-8, ldraw_lib__2_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 40 10 -10 0 0 6 0 -6 0 -6 0 0 1-4cyls.dat
  [1,16,40,10,-10,0,0,6,0,-6,0,-6,0,0, ldraw_lib__1_4cyls(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 40 10 -10 0 0 -6 0 -6 0 -6 0 0 1-4cyls.dat
  [1,16,40,10,-10,0,0,-6,0,-6,0,-6,0,0, ldraw_lib__1_4cyls(realsolid)],
...
// 1 16 40 4 -10 6 0 0 0 16 0 0 0 6 2-4cyli.dat
  [1,16,40,4,-10,6,0,0,0,16,0,0,0,6, ldraw_lib__2_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 40 10 -10 6 0 0 0 10 0 0 0 -6 2-4cyli.dat
  [1,16,40,10,-10,6,0,0,0,10,0,0,0,-6, ldraw_lib__2_4cyli(realsolid)],
// 1 16 40 12 -10 0 0 8 0 -8 0 -8 0 0 1-4cyls.dat
  [1,16,40,12,-10,0,0,8,0,-8,0,-8,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 40 12 -10 0 0 -8 0 -8 0 -8 0 0 1-4cyls.dat
  [1,16,40,12,-10,0,0,-8,0,-8,0,-8,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 40 4 -10 8 0 0 0 16 0 0 0 8 2-4cyli.dat
  [1,16,40,4,-10,8,0,0,0,16,0,0,0,8, ldraw_lib__2_4cyli(realsolid)],
// 1 16 40 12 -10 8 0 0 0 8 0 0 0 -8 2-4cyli.dat
  [1,16,40,12,-10,8,0,0,0,8,0,0,0,-8, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -40 20 -10 1 0 0 0 -1 0 0 0 1 stud4a.dat
  [1,16,-40,20,-10,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 -40 4 -10 6 0 0 0 1 0 0 0 6 2-4edge.dat
  [1,16,-40,4,-10,6,0,0,0,1,0,0,0,6, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 20 4 -10 6 0 0 0 0.707 6 0 0.707 -6 2-4edge.dat
  [1,16,20,4,-10,6,0,0,0,0.707,6,0,0.707,-6, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 20 4 -10 8 0 0 0 0.707 8 0 0.707 -8 2-4edge.dat
  [1,16,20,4,-10,8,0,0,0,0.707,8,0,0.707,-8, ldraw_lib__2_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 4 -10 6 0 0 0 0.707 6 0 0.707 -6 2-4edge.dat
  [1,16,0,4,-10,6,0,0,0,0.707,6,0,0.707,-6, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 0 4 -10 8 0 0 0 0.707 8 0 0.707 -8 2-4edge.dat
  [1,16,0,4,-10,8,0,0,0,0.707,8,0,0.707,-8, ldraw_lib__2_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__4445(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4445(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
