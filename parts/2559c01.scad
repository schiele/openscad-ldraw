...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Armada, BrickLink 2558c02, Pirate, Pirates, Rebrickable 2559c02
...
// 1 6 0 0 0 1 0 0 0 1 0 0 0 1 2558.dat
  [1,6,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2558()],
];
module ldraw_lib__2559c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2559c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
