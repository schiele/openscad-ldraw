...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 3626bpx123, Brickowl 126459, Rebrickable 3626bpr0029
// 0 !KEYWORDS Set 6261, set 6268, set 6289
// 
...
module ldraw_lib__3626bp46(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3626bp46(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
