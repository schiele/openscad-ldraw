...
use <../p/t16o6250.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3626bp46(realsolid=false) = [
// 0 Minifig Head with Eye Patch, Dark Orange Moustache, Beard and Messy Hair Pattern
// 0 Name: 3626bp46.dat
...
// 1 484 0 0 0 -1 0 0 0 1 0 0 0 1 s\3626bp42s03.dat
  [1,484,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3626bp42s03(realsolid)],
// 1 484 0 0 0 1 0 0 0 1 0 0 0 1 s\3626bp42s03.dat
  [1,484,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3626bp42s03(realsolid)],
...
module ldraw_lib__3626bp46(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3626bp46(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3626bp46(line=0.2);