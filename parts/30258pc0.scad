...
use <s/30258s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30258pc0(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS bricklink 30258pb018
// 
...
// 1 16 0 0 -9 1 0 0 0 1 0 0 0 1 s\15210pc0s01.dat
  [1,16,0,0,-9,1,0,0,0,1,0,0,0,1, ldraw_lib__s__15210pc0s01(realsolid)],
];
module ldraw_lib__30258pc0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30258pc0(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
