...
$fa=1; $fs=0.2;
function ldraw_lib__6199(realsolid=false) = [
// 0 Belville Swing
// 0 Name: 6199.dat
...
// 1 16 -87 0 0 0 174 0 4 0 0 0 0 4 4-4cyli.dat
  [1,16,-87,0,0,0,174,0,4,0,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 87 0 0 0 4 0 4 0 0 0 0 4 4-8sphe.dat
  [1,16,87,0,0,0,4,0,4,0,0,0,0,4, ldraw_lib__4_8sphe(realsolid)],
// 1 16 -87 0 0 0 -4 0 4 0 0 0 0 4 4-8sphe.dat
  [1,16,-87,0,0,0,-4,0,4,0,0,0,0,4, ldraw_lib__4_8sphe(realsolid)],
// 1 16 77 0 0 0 -1 0 4 0 0 0 0 4 4-4edge.dat
  [1,16,77,0,0,0,-1,0,4,0,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 -77 0 0 0 -1 0 4 0 0 0 0 4 4-4edge.dat
  [1,16,-77,0,0,0,-1,0,4,0,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 77 0 0 0 -1 0 2 0 0 0 0 2 4-4ring2.dat
  [1,16,77,0,0,0,-1,0,2,0,0,0,0,2, ldraw_lib__4_4ring2(realsolid)],
// 1 16 -77 0 0 0 1 0 2 0 0 0 0 -2 4-4ring2.dat
  [1,16,-77,0,0,0,1,0,2,0,0,0,0,-2, ldraw_lib__4_4ring2(realsolid)],
// 1 16 69 0 0 0 8 0 6 0 0 0 0 6 4-4cylo.dat
  [1,16,69,0,0,0,8,0,6,0,0,0,0,6, ldraw_lib__4_4cylo(realsolid)],
// 1 16 -69 0 0 0 -8 0 6 0 0 0 0 6 4-4cylo.dat
  [1,16,-69,0,0,0,-8,0,6,0,0,0,0,6, ldraw_lib__4_4cylo(realsolid)],
// 1 16 69 0 0 0 1 0 2 0 0 0 0 -2 4-4ring2.dat
  [1,16,69,0,0,0,1,0,2,0,0,0,0,-2, ldraw_lib__4_4ring2(realsolid)],
// 1 16 -69 0 0 0 -1 0 2 0 0 0 0 2 4-4ring2.dat
  [1,16,-69,0,0,0,-1,0,2,0,0,0,0,2, ldraw_lib__4_4ring2(realsolid)],
// 1 16 69 0 0 0 -1 0 4 0 0 0 0 4 4-4edge.dat
  [1,16,69,0,0,0,-1,0,4,0,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 -69 0 0 0 -1 0 4 0 0 0 0 4 4-4edge.dat
  [1,16,-69,0,0,0,-1,0,4,0,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 56 4 0 4 0 0 0 172 0 0 0 4 4-4cyli.dat
  [1,16,56,4,0,4,0,0,0,172,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -56 4 0 -4 0 0 0 172 0 0 0 4 4-4cyli.dat
  [1,16,-56,4,0,-4,0,0,0,172,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 56 176 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,56,176,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 -56 176 0 -4 0 0 0 -1 0 0 0 4 4-4edge.dat
  [1,16,-56,176,0,-4,0,0,0,-1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 56 4 0 4 0 0 0 -4 0 0 0 4 2-4cylj1x1e.dat
  [1,16,56,4,0,4,0,0,0,-4,0,0,0,4, ldraw_lib__2_4cylj1x1e(realsolid)],
// 1 16 56 4 0 4 0 0 0 -4 0 0 0 -4 2-4cylj1x1e.dat
  [1,16,56,4,0,4,0,0,0,-4,0,0,0,-4, ldraw_lib__2_4cylj1x1e(realsolid)],
// 1 16 -56 4 0 4 0 0 0 -4 0 0 0 4 2-4cylj1x1e.dat
  [1,16,-56,4,0,4,0,0,0,-4,0,0,0,4, ldraw_lib__2_4cylj1x1e(realsolid)],
...
// 1 16 0 180 0 1 0 0 0 -1 0 0 0 1 stug4-1x5.dat
  [1,16,0,180,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stug4_1x5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 184 0 56 0 0 0 -4 0 0 0 16 box5.dat
  [1,16,0,184,0,56,0,0,0,-4,0,0,0,16, ldraw_lib__box5(realsolid)],
...
// 1 16 0 184 0 60 0 0 0 -8 0 0 0 20 box5.dat
  [1,16,0,184,0,60,0,0,0,-8,0,0,0,20, ldraw_lib__box5(realsolid)],
];
module ldraw_lib__6199(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6199(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
