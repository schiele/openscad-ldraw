...
// 0 !KEYWORDS Rebrickable 98138pr0165, Set 41913
// 
...
// 1 31 0 0 0 1 0 0 0 1 0 0 0 1 s\98138p1ds02.dat
  [1,31,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__98138p1ds02()],
];
module ldraw_lib__98138p1g(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98138p1g(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
