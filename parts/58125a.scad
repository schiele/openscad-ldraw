...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__58125a(realsolid=false) = [
...
// 1 494 6 14 -2 0 -1.5 0 0 0 2 -2 0 0 box4-1.dat
  [1,494,6,14,-2,0,-1.5,0,0,0,2,-2,0,0, ldraw_lib__box4_1(realsolid)],
// 1 494 6 14 6 0 -1.5 0 0 0 2 -2 0 0 box4-1.dat
  [1,494,6,14,6,0,-1.5,0,0,0,2,-2,0,0, ldraw_lib__box4_1(realsolid)],
// 1 494 11 14 2 0 1.5 0 0 0 2 2 0 0 box4-1.dat
  [1,494,11,14,2,0,1.5,0,0,0,2,2,0,0, ldraw_lib__box4_1(realsolid)],
// 1 494 11 14 -6 0 1.5 0 0 0 2 2 0 0 box4-1.dat
  [1,494,11,14,-6,0,1.5,0,0,0,2,2,0,0, ldraw_lib__box4_1(realsolid)],
// 1 16 -10 12 0 0 0 1 0 -1 0 -1 0 0 stud3.dat
  [1,16,-10,12,0,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stud3(realsolid)],
// 1 16 -2 12 0 0 0 -2 0 4 0 -16 0 0 box5-4a.dat
  [1,16,-2,12,0,0,0,-2,0,4,0,-16,0,0, ldraw_lib__box5_4a(realsolid)],
...
// 1 16 10 12 -10 0 0 2 0 4 0 -2 0 0 1-4cyli.dat
  [1,16,10,12,-10,0,0,2,0,4,0,-2,0,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 10 12 -10 0 0 2 0 4 0 -2 0 0 1-4edge.dat
  [1,16,10,12,-10,0,0,2,0,4,0,-2,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 10 16 -10 0 0 2 0 4 0 -2 0 0 1-4edge.dat
  [1,16,10,16,-10,0,0,2,0,4,0,-2,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 7 12 -10 -2 0 0 0 4 0 0 0 -2 1-4cyli.dat
  [1,16,7,12,-10,-2,0,0,0,4,0,0,0,-2, ldraw_lib__1_4cyli(realsolid)],
// 1 16 7 12 -10 -2 0 0 0 4 0 0 0 -2 1-4edge.dat
  [1,16,7,12,-10,-2,0,0,0,4,0,0,0,-2, ldraw_lib__1_4edge(realsolid)],
// 1 16 7 16 -10 -2 0 0 0 4 0 0 0 -2 1-4edge.dat
  [1,16,7,16,-10,-2,0,0,0,4,0,0,0,-2, ldraw_lib__1_4edge(realsolid)],
// 1 16 7 12 10 0 0 -2 0 4 0 2 0 0 1-4cyli.dat
  [1,16,7,12,10,0,0,-2,0,4,0,2,0,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 7 12 10 0 0 -2 0 4 0 2 0 0 1-4edge.dat
  [1,16,7,12,10,0,0,-2,0,4,0,2,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 7 16 10 0 0 -2 0 4 0 2 0 0 1-4edge.dat
  [1,16,7,16,10,0,0,-2,0,4,0,2,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 10 12 10 2 0 0 0 4 0 0 0 2 1-4cyli.dat
  [1,16,10,12,10,2,0,0,0,4,0,0,0,2, ldraw_lib__1_4cyli(realsolid)],
// 1 16 10 12 10 2 0 0 0 4 0 0 0 2 1-4edge.dat
  [1,16,10,12,10,2,0,0,0,4,0,0,0,2, ldraw_lib__1_4edge(realsolid)],
// 1 16 10 16 10 2 0 0 0 4 0 0 0 2 1-4edge.dat
  [1,16,10,16,10,2,0,0,0,4,0,0,0,2, ldraw_lib__1_4edge(realsolid)],
// 1 16 10 16 10 2 0 0 0 -1 0 0 0 2 1-4disc.dat
  [1,16,10,16,10,2,0,0,0,-1,0,0,0,2, ldraw_lib__1_4disc(realsolid)],
// 1 16 7 16 10 0 0 -2 0 -1 0 2 0 0 1-4disc.dat
  [1,16,7,16,10,0,0,-2,0,-1,0,2,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 7 16 -10 -2 0 0 0 -1 0 0 0 -2 1-4disc.dat
  [1,16,7,16,-10,-2,0,0,0,-1,0,0,0,-2, ldraw_lib__1_4disc(realsolid)],
// 1 16 10 16 -10 0 0 2 0 -1 0 -2 0 0 1-4disc.dat
  [1,16,10,16,-10,0,0,2,0,-1,0,-2,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 8.5 14 -12 -1.5 0 0 0 0 -2 0 1 0 rect2p.dat
  [1,16,8.5,14,-12,-1.5,0,0,0,0,-2,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 8.5 14 12 1.5 0 0 0 0 -2 0 -1 0 rect2p.dat
  [1,16,8.5,14,12,1.5,0,0,0,0,-2,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 5 14 2 0 1 0 0 0 -2 -2 0 0 rect.dat
  [1,16,5,14,2,0,1,0,0,0,-2,-2,0,0, ldraw_lib__rect(realsolid)],
// 1 16 12 14 -2 0 -1 0 0 0 -2 2 0 0 rect.dat
  [1,16,12,14,-2,0,-1,0,0,0,-2,2,0,0, ldraw_lib__rect(realsolid)],
// 1 16 5 14 -7 0 1 0 -2 0 0 0 0 3 rect3.dat
  [1,16,5,14,-7,0,1,0,-2,0,0,0,0,3, ldraw_lib__rect3(realsolid)],
// 1 16 12 14 -9 0 -1 0 -2 0 0 0 0 1 rect3.dat
  [1,16,12,14,-9,0,-1,0,-2,0,0,0,0,1, ldraw_lib__rect3(realsolid)],
// 1 16 12 14 7 0 -1 0 -2 0 0 0 0 -3 rect3.dat
  [1,16,12,14,7,0,-1,0,-2,0,0,0,0,-3, ldraw_lib__rect3(realsolid)],
// 1 16 5 14 9 0 1 0 -2 0 0 0 0 -1 rect3.dat
  [1,16,5,14,9,0,1,0,-2,0,0,0,0,-1, ldraw_lib__rect3(realsolid)],
];
module ldraw_lib__58125a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__58125a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
