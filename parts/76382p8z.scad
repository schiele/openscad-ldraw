...
use <3820.scad>
use <973p8z.scad>
function ldraw_lib__76382p8z() = [
// 0 Minifig Torso with Arms and Hands with T-Shirt, Blue Dungarees and Tools Pattern
// 0 Name: 76382p8z.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973p8z.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973p8z()],
...
module ldraw_lib__76382p8z(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382p8z(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382p8z(line=0.2);