...
use <s/3004s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3004pz6(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Brickheadz, bricklink 3004pb166, Frozone, Incredibles, Set 41613
// 
...
module ldraw_lib__3004pz6(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3004pz6(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
