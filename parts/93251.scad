...
// 1 16 0 28.268 0 -1 0 0 0 1 0 0 0 -1 s\93251s01.dat
  [1,16,0,28.268,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__93251s01()],
// 1 16 0 28.268 0 1 0 0 0 1 0 0 0 -1 s\93251s01.dat
  [1,16,0,28.268,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__93251s01()],
// 1 16 0 0 5 -1 0 0 0 1 0 0 0 1 handle.dat
  [1,16,0,0,5,-1,0,0,0,1,0,0,0,1, ldraw_lib__handle()],
];
module ldraw_lib__93251(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__93251(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
