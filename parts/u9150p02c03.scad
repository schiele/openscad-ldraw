...
$fa=1; $fs=0.2;
function ldraw_lib__u9150p02c03(realsolid=false) = [
...
// 1 84 0 -67 4 1 0 0 0 1 0 0 0 1 u9150p02c01.dat
  [1,84,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u9150p02c01(realsolid)],
// 1 0 0 -37 4 1 0 0 0 1 0 0 0 1 u9102p10.dat
  [1,0,0,-37,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u9102p10(realsolid)],
...
module ldraw_lib__u9150p02c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9150p02c03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
