...
use <s/3070bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3070bpub(realsolid=false) = [
...
// 1 80 0 0 0 1 0 0 0 1 0 0 0 1 s\3070baub.dat
  [1,80,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3070baub(realsolid)],
...
// 1 16 0 0 0 2.1048 0 -5.0813 0 1 0 5.0813 0 2.1048 3-8chrd.dat
  [1,16,0,0,0,2.1048,0,-5.0813,0,1,0,5.0813,0,2.1048, ldraw_lib__3_8chrd(realsolid)],
...
module ldraw_lib__3070bpub(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3070bpub(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
