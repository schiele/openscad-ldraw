...
function ldraw_lib__28884c01() = [
// 0 Cardboard Ramp 16 x 14 with Yellow Curbs and Chevrons Pattern (Formed)
// 0 Name: 28884c01.dat
...
// 0 !TEXMAP START PLANAR -160 0 139.243 160 0 139.243 -160 0 -100.947 28884c01a.png
...
module ldraw_lib__28884c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__28884c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__28884c01(line=0.2);