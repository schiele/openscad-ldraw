...
// 1 16 80 8 0 0 0 80 0 -8 0 40 0 0 box4-4a.dat
  [1,16,80,8,0,0,0,80,0,-8,0,40,0,0, ldraw_lib__box4_4a()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 80 8 0 0 0 76 0 -4 0 36 0 0 box4-4a.dat
  [1,16,80,8,0,0,0,76,0,-4,0,36,0,0, ldraw_lib__box4_4a()],
...
module ldraw_lib__804(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__804(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
