...
use <../p/stug4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__804(realsolid=false) = [
// 0 Car Base  4 x 14 with Hole and Steering Gear Slot
// 0 Name: 804.dat
...
// 1 16 8 4 -20 4 0 0 0 4 0 0 0 1 box5.dat
  [1,16,8,4,-20,4,0,0,0,4,0,0,0,1, ldraw_lib__box5(realsolid)],
// 4 16 160 8 40 156 8 36 4 8 36 0 8 40
  [4,16,160,8,40,156,8,36,4,8,36,0,8,40],
...
// 4 16 0 8 -20 4 8 -16 4 8 -36 0 8 -40
  [4,16,0,8,-20,4,8,-16,4,8,-36,0,8,-40],
// 4 16 0 8 -40 4 8 -36 156 8 -36 160 8 -40
  [4,16,0,8,-40,4,8,-36,156,8,-36,160,8,-40],
// 4 16 160 8 -40 156 8 -36 156 8 36 160 8 40
  [4,16,160,8,-40,156,8,-36,156,8,36,160,8,40],
...
// 1 16 120 0 0 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,120,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4(realsolid)],
...
// 1 16 80 8 0 0 0 80 0 -8 0 40 0 0 box4-4a.dat
  [1,16,80,8,0,0,0,80,0,-8,0,40,0,0, ldraw_lib__box4_4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 80 8 0 0 0 76 0 -4 0 36 0 0 box4-4a.dat
  [1,16,80,8,0,0,0,76,0,-4,0,36,0,0, ldraw_lib__box4_4a(realsolid)],
...
module ldraw_lib__804(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__804(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__804(line=0.2);