...
use <u9102.scad>
use <u9103.scad>
function ldraw_lib__u600p01c02() = [
...
// 1 15 0 -67 4 1 0 0 0 1 0 0 0 1 u600p01c01.dat
  [1,15,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u600p01c01()],
...
module ldraw_lib__u600p01c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u600p01c02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
