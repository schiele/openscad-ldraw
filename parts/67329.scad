...
// 1 16 20 20 0 0 -1 0 1 0 0 0 0 1 stug2-1x2.dat
  [1,16,20,20,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__stug2_1x2()],
// 1 16 -20 20 0 0 1 0 1 0 0 0 0 -1 stug2-1x2.dat
  [1,16,-20,20,0,0,1,0,1,0,0,0,0,-1, ldraw_lib__stug2_1x2()],
];
module ldraw_lib__67329(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__67329(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
