...
use <165485e.scad>
$fa=1; $fs=0.2;
function ldraw_lib__165485d(realsolid=false) = [
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 165485e.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__165485e(realsolid)],
];
module ldraw_lib__165485d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__165485d(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
