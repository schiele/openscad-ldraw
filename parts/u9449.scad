...
use <71645p02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9449(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 32374p01c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32374p01c01(realsolid)],
// 0 // Curcuit board
...
module ldraw_lib__u9449(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9449(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
