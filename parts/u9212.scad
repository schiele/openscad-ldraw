...
$fa=1; $fs=0.2;
function ldraw_lib__u9212(realsolid=false) = [
...
// 1 16 0 4 0 24.6 0 0 0 4 0 0 0 24.6 48\4-4cylo.dat
  [1,16,0,4,0,24.6,0,0,0,4,0,0,0,24.6, ldraw_lib__48__4_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 0 20.5 0 0 0 4 0 0 0 20.5 48\4-4cylo.dat
  [1,16,0,4,0,20.5,0,0,0,4,0,0,0,20.5, ldraw_lib__48__4_4cylo(realsolid)],
// 1 16 0 4 0 20.5 0 0 0 -1 0 0 0 20.5 48\4-4disc.dat
  [1,16,0,4,0,20.5,0,0,0,-1,0,0,0,20.5, ldraw_lib__48__4_4disc(realsolid)],
// 1 16 0 8 0 4.1 0 0 0 -1 0 0 0 4.1 48\4-4ring5.dat
  [1,16,0,8,0,4.1,0,0,0,-1,0,0,0,4.1, ldraw_lib__48__4_4ring5(realsolid)],
// 1 16 0 4 0 3.075 0 0 0 -1 0 0 0 3.075 48\4-4ring8.dat
  [1,16,0,4,0,3.075,0,0,0,-1,0,0,0,3.075, ldraw_lib__48__4_4ring8(realsolid)],
// 1 16 0 4 0 27.675 0 0 0 -1 0 0 0 27.675 48\4-4edge.dat
  [1,16,0,4,0,27.675,0,0,0,-1,0,0,0,27.675, ldraw_lib__48__4_4edge(realsolid)],
// 1 16 0 -16 0 29.9812 0 0 0 -1 0 0 0 29.9812 48\4-4edge.dat
  [1,16,0,-16,0,29.9812,0,0,0,-1,0,0,0,29.9812, ldraw_lib__48__4_4edge(realsolid)],
// 1 16 0 -16 0 2.30625 0 0 0 20 0 0 0 2.30625 48\4-4con12.dat
  [1,16,0,-16,0,2.30625,0,0,0,20,0,0,0,2.30625, ldraw_lib__48__4_4con12(realsolid)],
// 1 16 0 -16 0 3.74766 0 0 0 1 0 0 0 3.74766 48\4-4ring7.dat
  [1,16,0,-16,0,3.74766,0,0,0,1,0,0,0,3.74766, ldraw_lib__48__4_4ring7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -16 0 26.2336 0 0 0 4 0 0 0 26.2336 48\4-4cylo.dat
  [1,16,0,-16,0,26.2336,0,0,0,4,0,0,0,26.2336, ldraw_lib__48__4_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -12 0 2.01797 0 0 0 12 0 0 0 2.01797 48\4-4con12.dat
  [1,16,0,-12,0,2.01797,0,0,0,12,0,0,0,2.01797, ldraw_lib__48__4_4con12(realsolid)],
// 1 16 0 0 0 24.2156 0 0 0 1 0 0 0 24.2156 48\4-4disc.dat
  [1,16,0,0,0,24.2156,0,0,0,1,0,0,0,24.2156, ldraw_lib__48__4_4disc(realsolid)],
// 1 16 0 0 0 24.2156 0 0 0 1 0 0 0 24.2156 48\4-4edge.dat
  [1,16,0,0,0,24.2156,0,0,0,1,0,0,0,24.2156, ldraw_lib__48__4_4edge(realsolid)],
// 1 16 0 -12 29.9812 4 0 0 0 0 -4 0 56.0188 0 4-4cyli.dat
  [1,16,0,-12,29.9812,4,0,0,0,0,-4,0,56.0188,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -12 29.9812 0 0 -4 -4 0 0 0 -2 0 4-4cyls.dat
  [1,16,0,-12,29.9812,0,0,-4,-4,0,0,0,-2,0, ldraw_lib__4_4cyls(realsolid)],
// 1 16 0 -12 86 4 0 0 0 0 -4 0 4 0 4-8sphe.dat
  [1,16,0,-12,86,4,0,0,0,0,-4,0,4,0, ldraw_lib__4_8sphe(realsolid)],
...
module ldraw_lib__u9212(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9212(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
