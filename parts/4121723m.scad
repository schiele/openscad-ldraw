...
use <../p/box3u12.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4121723m(realsolid=false) = [
...
// 1 16 -19 0 29 -1 0 0 0 -1 0 0 0 1 1-4chrd.dat
  [1,16,-19,0,29,-1,0,0,0,-1,0,0,0,1, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -19 0 -29 -1 0 0 0 -1 0 0 0 -1 1-4chrd.dat
  [1,16,-19,0,-29,-1,0,0,0,-1,0,0,0,-1, ldraw_lib__1_4chrd(realsolid)],
// 1 16 19 0 -29 1 0 0 0 -1 0 0 0 -1 1-4chrd.dat
  [1,16,19,0,-29,1,0,0,0,-1,0,0,0,-1, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 -19 0 29 -1 0 0 0 -.25 0 0 0 1 1-4cyli.dat
  [1,16,-19,0,29,-1,0,0,0,-.25,0,0,0,1, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -19 0 -29 -1 0 0 0 -.25 0 0 0 -1 1-4cyli.dat
  [1,16,-19,0,-29,-1,0,0,0,-.25,0,0,0,-1, ldraw_lib__1_4cyli(realsolid)],
// 1 16 19 0 -29 1 0 0 0 -.25 0 0 0 -1 1-4cyli.dat
  [1,16,19,0,-29,1,0,0,0,-.25,0,0,0,-1, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 0 -.25 0 0 0 20 0 .25 0 -29 0 0 box3u12.dat
  [1,16,0,-.25,0,0,0,20,0,.25,0,-29,0,0, ldraw_lib__box3u12(realsolid)],
// 
// 0 // Frontface Cutout
// 1 4 -19 -.25 29 -1 0 0 0 1 0 0 0 1 1-4chrd.dat
  [1,4,-19,-.25,29,-1,0,0,0,1,0,0,0,1, ldraw_lib__1_4chrd(realsolid)],
// 1 4 -19 -.25 -29 -1 0 0 0 1 0 0 0 -1 1-4chrd.dat
  [1,4,-19,-.25,-29,-1,0,0,0,1,0,0,0,-1, ldraw_lib__1_4chrd(realsolid)],
// 1 4 19 -.25 -29 1 0 0 0 1 0 0 0 -1 1-4chrd.dat
  [1,4,19,-.25,-29,1,0,0,0,1,0,0,0,-1, ldraw_lib__1_4chrd(realsolid)],
...
module ldraw_lib__4121723m(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4121723m(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
