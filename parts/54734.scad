...
use <923.scad>
$fa=1; $fs=0.2;
function ldraw_lib__54734(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 923.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__923(realsolid)],
// 1 16 5 0 -40 1 0 0 0 1 0 0 0 1 921.dat
  [1,16,5,0,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__921(realsolid)],
// 1 16 -5 0 40 -1 0 0 0 1 0 0 0 -1 921.dat
  [1,16,-5,0,40,-1,0,0,0,1,0,0,0,-1, ldraw_lib__921(realsolid)],
// 1 4 20 -70 -10 0 0 1 0 1 0 -1 0 0 922.dat
  [1,4,20,-70,-10,0,0,1,0,1,0,-1,0,0, ldraw_lib__922(realsolid)],
];
module ldraw_lib__54734(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__54734(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
