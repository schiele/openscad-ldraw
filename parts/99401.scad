...
use <../p/4-4ring8.scad>
$fa=1; $fs=0.2;
function ldraw_lib__99401(realsolid=false) = [
...
// 1 16 0 0 -2 -19 0 0 0 0 19 0 24 0 4-4cylo.dat
  [1,16,0,0,-2,-19,0,0,0,0,19,0,24,0, ldraw_lib__4_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 -16 0 0 0 0 16 0 22 0 4-4cylo.dat
  [1,16,0,0,0,-16,0,0,0,0,16,0,22,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 0 22 2 0 0 0 0 2 0 -1 0 4-4ring8.dat
  [1,16,0,0,22,2,0,0,0,0,2,0,-1,0, ldraw_lib__4_4ring8(realsolid)],
// 1 16 0 0 -2 -6 0 0 0 0 6 0 1 0 4-4ring2.dat
  [1,16,0,0,-2,-6,0,0,0,0,6,0,1,0, ldraw_lib__4_4ring2(realsolid)],
...
// 1 16 0 0 22 1 0 0 0 0 1 0 -1 0 4-4rin18.dat
  [1,16,0,0,22,1,0,0,0,0,1,0,-1,0, ldraw_lib__4_4rin18(realsolid)],
// 1 16 0 0 -2 -1 0 0 0 0 1 0 1 0 4-4rin18.dat
  [1,16,0,0,-2,-1,0,0,0,0,1,0,1,0, ldraw_lib__4_4rin18(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__99401(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__99401(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
