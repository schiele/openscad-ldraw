...
// 1 16 0 12 -10 1 0 0 0 1 0 0 0 1 s\3622p01s.dat
  [1,16,0,12,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3622p01s()],
// 1 16 0 12 10 -1 0 0 0 1 0 0 0 -1 s\3622p01s.dat
  [1,16,0,12,10,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3622p01s()],
...
// 1 16 0 24 0 0 0 30 0 -24 0 -10 0 0 box3u2p.dat
  [1,16,0,24,0,0,0,30,0,-24,0,-10,0,0, ldraw_lib__box3u2p()],
...
module ldraw_lib__3622p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3622p01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
