...
use <85984.scad>
$fa=1; $fs=0.2;
function ldraw_lib__85984d03(realsolid=false) = [
...
// 1 16 0 -10 0 1 0 0 0 0.857493 -0.514496 0 0.514496 0.857493 6138629w.dat
  [1,16,0,-10,0,1,0,0,0,0.857493,-0.514496,0,0.514496,0.857493, ldraw_lib__6138629w(realsolid)],
];
module ldraw_lib__85984d03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__85984d03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
