...
$fa=1; $fs=0.2;
function ldraw_lib__u9496p01c02(realsolid=false) = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\u9496c02s02.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9496c02s02(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 15 -.25 0 0 1 0 0 0 1 0 0 0 1 s\u9496c02s02.dat
  [1,15,-.25,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9496c02s02(realsolid)],
// 
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\u9496c02s04.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9496c02s04(realsolid)],
];
module ldraw_lib__u9496p01c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9496p01c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
