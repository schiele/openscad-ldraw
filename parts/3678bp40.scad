...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 3678bpb011, Castle, maiden, Princess
// 0 !KEYWORDS Rebrickable 3678bpr0080, Set 7093
// 
...
// 1 16 0 0 10 -1 0 0 0 1 0 0 0 -1 s\3678bp40s01.dat
  [1,16,0,0,10,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3678bp40s01()],
// 1 16 0 0 10 1 0 0 0 1 0 0 0 -1 s\3678bp40s01.dat
  [1,16,0,0,10,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3678bp40s01()],
];
module ldraw_lib__3678bp40(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3678bp40(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
