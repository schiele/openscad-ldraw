use <../lib.scad>
use <s/50955p03s02.scad>
use <s/50956p03s01.scad>
use <s/50956s02.scad>
use <../p/stug-1x2.scad>
function ldraw_lib__50955p03() = [
// 0 Wedge 10 x  3 x  1 Double Rounded Left with Black 'Concorde' and Red Triangle Pattern
// 0 Name: 50955p03.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\50955p03s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__50955p03s02()],
];
module ldraw_lib__50955p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__50955p03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__50955p03(line=0.2);