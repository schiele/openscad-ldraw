...
use <s/30375s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30375ps5(realsolid=false) = [
...
// 1 14 0 -22 -8.725 2 0 0 0 0.062442 -1.996097 0 0.998049 0.124884 4-4disc.dat
  [1,14,0,-22,-8.725,2,0,0,0,0.062442,-1.996097,0,0.998049,0.124884, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 -22 -8.725 2 0 0 0 0.062442 -1.996097 0 0.998049 0.124884 4-4ndis.dat
  [1,16,0,-22,-8.725,2,0,0,0,0.062442,-1.996097,0,0.998049,0.124884, ldraw_lib__4_4ndis(realsolid)],
// 4 16 -6 -20 -8.85 -2 -20 -8.85 -2 -24 -8.6 -6 -24 -8.6
  [4,16,-6,-20,-8.85,-2,-20,-8.85,-2,-24,-8.6,-6,-24,-8.6],
// 4 16 2 -20 -8.85 6 -20 -8.85 6 -24 -8.6 2 -24 -8.6
  [4,16,2,-20,-8.85,6,-20,-8.85,6,-24,-8.6,2,-24,-8.6],
];
module ldraw_lib__30375ps5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30375ps5(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__30375ps5(line=0.2);