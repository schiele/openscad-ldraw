...
use <../p/stug-1x7.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30348(realsolid=false) = [
...
// 1 16 0 14 120 20 0 0 0 0 14 0 -1 0 rect3.dat
  [1,16,0,14,120,20,0,0,0,0,14,0,-1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 0 50 20 0 0 0 1 0 0 0 70 rect.dat
  [1,16,0,0,50,20,0,0,0,1,0,0,0,70, ldraw_lib__rect(realsolid)],
// 1 16 10 0 50 0 0 -1 0 1 0 1 0 0 stug-1x7.dat
  [1,16,10,0,50,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_1x7(realsolid)],
// 1 16 -10 0 50 0 0 -1 0 1 0 1 0 0 stug-1x7.dat
  [1,16,-10,0,50,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_1x7(realsolid)],
// 
...
// 1 16 36 18 -18 -2 0 2 0 -1 2 0 0 2 rect.dat
  [1,16,36,18,-18,-2,0,2,0,-1,2,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 -36 18 -18 2 0 2 0 -1 -2 0 0 -2 rect.dat
  [1,16,-36,18,-18,2,0,2,0,-1,-2,0,0,-2, ldraw_lib__rect(realsolid)],
...
// 1 16 38 24 96 -2 0 0 0 -1 4 0 0 4 rect.dat
  [1,16,38,24,96,-2,0,0,0,-1,4,0,0,4, ldraw_lib__rect(realsolid)],
// 1 16 -38 24 96 2 0 0 0 -1 -4 0 0 -4 rect.dat
  [1,16,-38,24,96,2,0,0,0,-1,-4,0,0,-4, ldraw_lib__rect(realsolid)],
...
// 1 16 0 16 116 20 0 0 0 0 12 0 1 0 rect3.dat
  [1,16,0,16,116,20,0,0,0,0,12,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 4 48 20 0 0 0 -1 0 0 0 68 rect.dat
  [1,16,0,4,48,20,0,0,0,-1,0,0,0,68, ldraw_lib__rect(realsolid)],
...
module ldraw_lib__30348(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30348(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
