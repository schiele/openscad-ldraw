...
use <../p/t04q3529.scad>
$fa=1; $fs=0.2;
function ldraw_lib__994(realsolid=false) = [
...
// 1 16 0 -1 0 1 0 0 0 1 0 0 0 1 993.dat
  [1,16,0,-1,0,1,0,0,0,1,0,0,0,1, ldraw_lib__993(realsolid)],
// 
// 1 16 0 -1 -5.6352 0 4.25 0 -4.25 0 0 0 0 4.25 t04q3529.dat
  [1,16,0,-1,-5.6352,0,4.25,0,-4.25,0,0,0,0,4.25, ldraw_lib__t04q3529(realsolid)],
// 1 16 0 -5.25 -5.6352 1.5 0 0 0 -0.002944 1.5 0 -0.0148 0 4-4cyli.dat
  [1,16,0,-5.25,-5.6352,1.5,0,0,0,-0.002944,1.5,0,-0.0148,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -9.502944 -5.65 0 -4.25 0 0 0 4.25 -4.25 0 0 t04q3529.dat
  [1,16,0,-9.502944,-5.65,0,-4.25,0,0,0,4.25,-4.25,0,0, ldraw_lib__t04q3529(realsolid)],
// 1 16 0 -9.502944 -9.9 1.5 0 0 0 -3.997056 0 0 0 -1.5 4-4cyli.dat
  [1,16,0,-9.502944,-9.9,1.5,0,0,0,-3.997056,0,0,0,-1.5, ldraw_lib__4_4cyli(realsolid)],
// 
// 1 16 0 -1 5.6352 0 4.25 0 -4.25 0 0 0 0 -4.25 t04q3529.dat
  [1,16,0,-1,5.6352,0,4.25,0,-4.25,0,0,0,0,-4.25, ldraw_lib__t04q3529(realsolid)],
// 1 16 0 -5.25 5.6352 1.5 0 0 0 -0.002944 1.5 0 0.0148 0 4-4cyli.dat
...
module ldraw_lib__994(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__994(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
