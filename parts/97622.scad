...
// 1 16 0 2 0 60 0 0 0 2 0 0 0 50 box.dat
  [1,16,0,2,0,60,0,0,0,2,0,0,0,50, ldraw_lib__box()],
];
module ldraw_lib__97622(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__97622(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
