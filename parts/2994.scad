...
use <s/2994s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2994(realsolid=false) = [
...
// 1 16 0 0 20 10 0 0 0 0 10 0 -20 0 4-4cyli.dat
  [1,16,0,0,20,10,0,0,0,0,10,0,-20,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 0 0.5 10 0 0 0 0 10 0 -1 0 4-4edge.dat
  [1,16,0,0,0.5,10,0,0,0,0,10,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 20 6 0 0 0 0 6 0 -20 0 4-4cyli.dat
  [1,16,0,0,20,6,0,0,0,0,6,0,-20,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 0 -12.5 25 0 0 0 0 25 0 -2.5 0 4-4cyli.dat
  [1,16,0,0,-12.5,25,0,0,0,0,25,0,-2.5,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -12.5 25 0 0 0 0 25 0 1 0 4-4edge.dat
  [1,16,0,0,-12.5,25,0,0,0,0,25,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -12.5 23 0 0 0 0 23 0 1 0 4-4edge.dat
  [1,16,0,0,-12.5,23,0,0,0,0,23,0,1,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 -4 30 0 0 0 0 30 0 -3.5 0 4-4cyli.dat
  [1,16,0,0,-4,30,0,0,0,0,30,0,-3.5,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -4 7.5 0 0 0 0 7.5 0 -1 0 4-4ring3.dat
  [1,16,0,0,-4,7.5,0,0,0,0,7.5,0,-1,0, ldraw_lib__4_4ring3(realsolid)],
// 1 16 0 0 -4 23 0 0 0 0 23 0 1 0 4-4edge.dat
  [1,16,0,0,-4,23,0,0,0,0,23,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -4 30 0 0 0 0 30 0 1 0 4-4edge.dat
  [1,16,0,0,-4,30,0,0,0,0,30,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -7.5 -7.5 0 0 0 0 7.5 0 1 0 4-4ring3.dat
  [1,16,0,0,-7.5,-7.5,0,0,0,0,7.5,0,1,0, ldraw_lib__4_4ring3(realsolid)],
...
// 1 16 0 0 -7.5 30 0 0 0 0 30 0 1 0 4-4edge.dat
  [1,16,0,0,-7.5,30,0,0,0,0,30,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 7.5 30 0 0 0 0 30 0 -3.5 0 4-4cyli.dat
  [1,16,0,0,7.5,30,0,0,0,0,30,0,-3.5,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 7.5 23 0 0 0 0 23 0 1 0 4-4edge.dat
  [1,16,0,0,7.5,23,0,0,0,0,23,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 7.5 30 0 0 0 0 30 0 1 0 4-4edge.dat
  [1,16,0,0,7.5,30,0,0,0,0,30,0,1,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 12.5 -2.083 0 0 0 0 2.083 0 1 0 4-4rin11.dat
  [1,16,0,0,12.5,-2.083,0,0,0,0,2.083,0,1,0, ldraw_lib__4_4rin11(realsolid)],
// 1 16 0 0 -12.5 2.083 0 0 0 0 2.083 0 -1 0 4-4rin11.dat
  [1,16,0,0,-12.5,2.083,0,0,0,0,2.083,0,-1,0, ldraw_lib__4_4rin11(realsolid)],
// 1 16 0 0 -7.5 23 0 0 0 0 23 0 -5 0 4-4cyli.dat
  [1,16,0,0,-7.5,23,0,0,0,0,23,0,-5,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 0 4 23 0 0 0 0 23 0 -8 0 4-4cyli.dat
  [1,16,0,0,4,23,0,0,0,0,23,0,-8,0, ldraw_lib__4_4cyli(realsolid)],
// 0 Ring front
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2994s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2994s01(realsolid)],
// 1 16 0 0 0 0.5 0.866 0 -0.866 0.5 0 0 0 1 s\2994s01.dat
  [1,16,0,0,0,0.5,0.866,0,-0.866,0.5,0,0,0,1, ldraw_lib__s__2994s01(realsolid)],
// 1 16 0 0 0 -0.5 0.866 0 -0.866 -0.5 0 0 0 1 s\2994s01.dat
  [1,16,0,0,0,-0.5,0.866,0,-0.866,-0.5,0,0,0,1, ldraw_lib__s__2994s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 -1 0 0 0 1 s\2994s01.dat
  [1,16,0,0,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__s__2994s01(realsolid)],
...
module ldraw_lib__2994(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2994(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
