...
use <../p/box5-12.scad>
$fa=1; $fs=0.2;
function ldraw_lib__004587a(realsolid=false) = [
...
// 1 15 -12.9 -0.25 7 0 0 2.2 0 1 0 -2.2 0 0 1-4ndis.dat
  [1,15,-12.9,-0.25,7,0,0,2.2,0,1,0,-2.2,0,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 15 -11 -0.25 0 0 0 -1.5 0 1 0 1.5 0 0 48\2-4ring6.dat
  [1,15,-11,-0.25,0,0,0,-1.5,0,1,0,1.5,0,0, ldraw_lib__48__2_4ring6(realsolid)],
// 1 15 11 -0.25 0 0 0 1.5 0 1 0 1.5 0 0 48\2-4ring6.dat
  [1,15,11,-0.25,0,0,0,1.5,0,1,0,1.5,0,0, ldraw_lib__48__2_4ring6(realsolid)],
// 
// 0 // Black
...
// 1 0 -12.9 -0.25 7 0 0 2.2 0 1 0 -2.2 0 0 1-4chrd.dat
  [1,0,-12.9,-0.25,7,0,0,2.2,0,1,0,-2.2,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 0 -11 -0.25 0 0 0 -9 0 1 0 9 0 0 48\1-4chrd.dat
  [1,0,-11,-0.25,0,0,0,-9,0,1,0,9,0,0, ldraw_lib__48__1_4chrd(realsolid)],
// 1 0 -11 -0.25 0 0 0 -9 0 1 0 -9 0 0 48\1-4chrd.dat
  [1,0,-11,-0.25,0,0,0,-9,0,1,0,-9,0,0, ldraw_lib__48__1_4chrd(realsolid)],
// 1 0 11 -0.25 0 0 0 9 0 1 0 9 0 0 48\1-4chrd.dat
  [1,0,11,-0.25,0,0,0,9,0,1,0,9,0,0, ldraw_lib__48__1_4chrd(realsolid)],
...
// 1 0 -11 -0.25 0 0 0 -10.5 0 1 0 10.5 0 0 48\2-4ndis.dat
  [1,0,-11,-0.25,0,0,0,-10.5,0,1,0,10.5,0,0, ldraw_lib__48__2_4ndis(realsolid)],
// 1 0 11 -0.25 0 0 0 10.5 0 1 0 10.5 0 0 48\2-4ndis.dat
  [1,0,11,-0.25,0,0,0,10.5,0,1,0,10.5,0,0, ldraw_lib__48__2_4ndis(realsolid)],
...
// 1 16 0 -0.25 0 25 0 0 0 0.25 0 0 0 12.5 box5-12.dat
  [1,16,0,-0.25,0,25,0,0,0,0.25,0,0,0,12.5, ldraw_lib__box5_12(realsolid)],
];
module ldraw_lib__004587a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__004587a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
