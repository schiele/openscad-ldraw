...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4469(realsolid=false) = [
...
// 1 16 -38 -48 0 0 0 2 0 1 0 -10 0 0 rect.dat
  [1,16,-38,-48,0,0,0,2,0,1,0,-10,0,0, ldraw_lib__rect(realsolid)],
// 1 16 38 -48 0 0 0 2 0 1 0 -10 0 0 rect.dat
  [1,16,38,-48,0,0,0,2,0,1,0,-10,0,0, ldraw_lib__rect(realsolid)],
// 1 16 40 -24 0 0 -1 0 0 0 24 -10 0 0 rect3.dat
  [1,16,40,-24,0,0,-1,0,0,0,24,-10,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 -40 -24 0 0 1 0 0 0 24 10 0 0 rect3.dat
  [1,16,-40,-24,0,0,1,0,0,0,24,10,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 -36 -58 0 0 72 0 0 0 -10 -10 0 0 2-4cylo.dat
  [1,16,-36,-58,0,0,72,0,0,0,-10,-10,0,0, ldraw_lib__2_4cylo(realsolid)],
// 1 16 -36 -58 0 0 1 0 0 0 -10 -10 0 0 2-4chrd.dat
  [1,16,-36,-58,0,0,1,0,0,0,-10,-10,0,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 -36 -53 0 0 1 0 5 0 0 0 0 -10 rect2p.dat
  [1,16,-36,-53,0,0,1,0,5,0,0,0,0,-10, ldraw_lib__rect2p(realsolid)],
// 3 16 -36 -48 -10 -40 -48 -10 -40 0 -10
  [3,16,-36,-48,-10,-40,-48,-10,-40,0,-10],
// 3 16 -40 -48 10 -36 -48 10 -40 0 10
  [3,16,-40,-48,10,-36,-48,10,-40,0,10],
// 1 16 -37 -58 0 0 1 0 0 0 3.5 3.5 0 0 4-4cylc.dat
  [1,16,-37,-58,0,0,1,0,0,0,3.5,3.5,0,0, ldraw_lib__4_4cylc(realsolid)],
// 1 16 36 -58 0 0 -1 0 0 0 -10 -10 0 0 2-4chrd.dat
  [1,16,36,-58,0,0,-1,0,0,0,-10,-10,0,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 36 -53 0 0 -1 0 -5 0 0 0 0 -10 rect2p.dat
  [1,16,36,-53,0,0,-1,0,-5,0,0,0,0,-10, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 0 0 36 0 0 0 -44 0 0 0 6 box4o4a.dat
  [1,16,0,0,0,36,0,0,0,-44,0,0,0,6, ldraw_lib__box4o4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -44 0 32 0 0 0 -20 0 0 0 6 box5-2p.dat
  [1,16,0,-44,0,32,0,0,0,-20,0,0,0,6, ldraw_lib__box5_2p(realsolid)],
// 1 16 0 -64 0 0 0 1.5 0 55 0 6 0 0 box3u2p.dat
  [1,16,0,-64,0,0,0,1.5,0,55,0,6,0,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 -34 -44 0 0 0 -2 0 -1 0 -6 0 0 rect3.dat
  [1,16,-34,-44,0,0,0,-2,0,-1,0,-6,0,0, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__4469(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4469(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
