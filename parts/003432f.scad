...
use <s/003432s1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__003432f(realsolid=false) = [
...
// 1 4 0 -0.25 0 1 0 0 0 0 1 0 -1 0 s\003432s1.dat
  [1,4,0,-0.25,0,1,0,0,0,0,1,0,-1,0, ldraw_lib__s__003432s1(realsolid)],
...
// 1 4 0 -0.25 0 30 0 0 0 0.25 0 0 0 24 box5-12.dat
  [1,4,0,-0.25,0,30,0,0,0,0.25,0,0,0,24, ldraw_lib__box5_12(realsolid)],
// 0
];
module ldraw_lib__003432f(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__003432f(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
