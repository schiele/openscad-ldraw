...
use <s/3039s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3039pch(realsolid=false) = [
...
// 1 11 0 0 0 1 0 0 0 1 0 0 0 1 s\3039pcgs01.dat
  [1,11,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3039pcgs01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3039pcgs02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3039pcgs02(realsolid)],
];
module ldraw_lib__3039pch(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3039pch(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
