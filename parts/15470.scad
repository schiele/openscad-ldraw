...
// 1 16 0 -5.5 0 8 0 0 0 1.5 0 0 0 8 4-4cyli.dat
  [1,16,0,-5.5,0,8,0,0,0,1.5,0,0,0,8, ldraw_lib__4_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 -5.5 0 5 0 0 0 -5.5 0 0 0 5 4-4cyli.dat
  [1,16,0,-5.5,0,5,0,0,0,-5.5,0,0,0,5, ldraw_lib__4_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -11 0 2.5 0 0 0 -4 0 0 0 2.5 4-4con1.dat
  [1,16,0,-11,0,2.5,0,0,0,-4,0,0,0,2.5, ldraw_lib__4_4con1()],
// 1 16 0 -15 0 2.5 0 0 0 -1 0 0 0 2.5 4-4disc.dat
  [1,16,0,-15,0,2.5,0,0,0,-1,0,0,0,2.5, ldraw_lib__4_4disc()],
...
// 1 16 0 -5.5 0 5 0 0 0 1 0 0 0 5 4-4edge.dat
  [1,16,0,-5.5,0,5,0,0,0,1,0,0,0,5, ldraw_lib__4_4edge()],
// 1 16 0 -5.5 0 1 0 0 0 -1 0 0 0 1 4-4ring5.dat
  [1,16,0,-5.5,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4ring5()],
// 1 16 0 -5.5 0 2 0 0 0 -1 0 0 0 2 4-4ring4.dat
  [1,16,0,-5.5,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring4()],
...
// 1 16 0 -8 0 10 0 0 0 2.5 0 0 0 10 4-4cylo.dat
  [1,16,0,-8,0,10,0,0,0,2.5,0,0,0,10, ldraw_lib__4_4cylo()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\15470s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__15470s01()],
// 1 16 0 0 0 0.70711 0 0.70711 0 1 0 -0.70711 0 0.70711 s\15470s01.dat
  [1,16,0,0,0,0.70711,0,0.70711,0,1,0,-0.70711,0,0.70711, ldraw_lib__s__15470s01()],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\15470s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__15470s01()],
// 1 16 0 0 0 -0.70711 0 0.70711 0 1 0 -0.70711 0 -0.70711 s\15470s01.dat
  [1,16,0,0,0,-0.70711,0,0.70711,0,1,0,-0.70711,0,-0.70711, ldraw_lib__s__15470s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\15470s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__15470s01()],
...
module ldraw_lib__15470(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__15470(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
