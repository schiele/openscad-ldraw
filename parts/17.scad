...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__17(realsolid=false) = [
...
// 1 16 14 18 0 0 7 2 0 -1 14 6 0 0 rect3.dat
  [1,16,14,18,0,0,7,2,0,-1,14,6,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 -14 18 0 0 -7 -2 0 -1 14 -6 0 0 rect3.dat
  [1,16,-14,18,0,0,-7,-2,0,-1,14,-6,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 18 16 0 0 -8 2 0 1 16 -10 0 0 rect3.dat
  [1,16,18,16,0,0,-8,2,0,1,16,-10,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 -18 16 0 0 8 -2 0 1 16 10 0 0 rect3.dat
  [1,16,-18,16,0,0,8,-2,0,1,16,10,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 0 0 16 0 0 0 1 0 0 0 10 rect.dat
  [1,16,0,0,0,16,0,0,0,1,0,0,0,10, ldraw_lib__rect(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 0 //
// 1 16 -16 0 2 -4 0 0 32 1 0 0 0 4 3-16edge.dat
  [1,16,-16,0,2,-4,0,0,32,1,0,0,0,4, ldraw_lib__3_16edge(realsolid)],
// 1 16 -16 0 -2 -4 0 0 32 1 0 0 0 -4 3-16edge.dat
  [1,16,-16,0,-2,-4,0,0,32,1,0,0,0,-4, ldraw_lib__3_16edge(realsolid)],
...
// 1 16 -16 6 0 0 -2 0 0 0 -2 2 0 0 r04o2000.dat
  [1,16,-16,6,0,0,-2,0,0,0,-2,2,0,0, ldraw_lib__r04o2000(realsolid)],
// 1 16 -16 6 0 0 -2 0 0 0 -2 -2 0 0 r04o2000.dat
  [1,16,-16,6,0,0,-2,0,0,0,-2,-2,0,0, ldraw_lib__r04o2000(realsolid)],
// 1 16 -20 6 0 0 1 0 0 0 -2 2 0 0 2-4disc.dat
  [1,16,-20,6,0,0,1,0,0,0,-2,2,0,0, ldraw_lib__2_4disc(realsolid)],
// 4 16 -20 6 -2 -20 6 2 -20 32 2 -20 32 -2
  [4,16,-20,6,-2,-20,6,2,-20,32,2,-20,32,-2],
// 1 16 -16 6 -2 4 0 0 0 26 0 0 0 -4 1-4cyls2.dat
  [1,16,-16,6,-2,4,0,0,0,26,0,0,0,-4, ldraw_lib__1_4cyls2(realsolid)],
// 1 16 -16 6 2 4 0 0 0 26 0 0 0 4 1-4cyls2.dat
  [1,16,-16,6,2,4,0,0,0,26,0,0,0,4, ldraw_lib__1_4cyls2(realsolid)],
// 0 //
// 1 16 16 0 -2 4 0 0 32 1 0 0 0 -4 3-16edge.dat
...
module ldraw_lib__17(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__17(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
