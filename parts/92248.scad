...
use <../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92248(realsolid=false) = [
...
// 1 16 4 -11.4 0.2 0 0 4 0 -9 0 4 0 0 2-4cylo.dat
  [1,16,4,-11.4,0.2,0,0,4,0,-9,0,4,0,0, ldraw_lib__2_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 4 -11.4 0.2 0 0 2 0 -9 0 2 0 0 2-4cylc.dat
  [1,16,4,-11.4,0.2,0,0,2,0,-9,0,2,0,0, ldraw_lib__2_4cylc(realsolid)],
// 1 16 4 -20.4 0.2 0 0 2 0 9 0 -2 0 0 2-4ring1.dat
  [1,16,4,-20.4,0.2,0,0,2,0,9,0,-2,0,0, ldraw_lib__2_4ring1(realsolid)],
// 1 16 -4 -20.4 0.2 0 0 -2 0 9 0 2 0 0 2-4ring1.dat
  [1,16,-4,-20.4,0.2,0,0,-2,0,9,0,2,0,0, ldraw_lib__2_4ring1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 -15.9 4.2 4 0 0 0 0 -4.5 0 -1 0 rect2p.dat
  [1,16,0,-15.9,4.2,4,0,0,0,0,-4.5,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -20.4 0.2 4 0 0 0 9 0 0 0 -2 box3u8p.dat
  [1,16,0,-20.4,0.2,4,0,0,0,9,0,0,0,-2, ldraw_lib__box3u8p(realsolid)],
// 1 16 -4 -11.4 0.2 0 0 -4 0 -9 0 -4 0 0 2-4cylo.dat
  [1,16,-4,-11.4,0.2,0,0,-4,0,-9,0,-4,0,0, ldraw_lib__2_4cylo(realsolid)],
// 1 16 0 -15.9 -3.8 -4 0 0 0 0 -4.5 0 1 0 rect2p.dat
  [1,16,0,-15.9,-3.8,-4,0,0,0,0,-4.5,0,1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 3.5 0 0 0 -1 0 0 0 3 -3 0 0 2-4ndis.dat
  [1,16,3.5,0,0,0,-1,0,0,0,3,-3,0,0, ldraw_lib__2_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 3.5 0 0 0 -7 0 0 0 3 -3 0 0 4-4cylo.dat
  [1,16,3.5,0,0,0,-7,0,0,0,3,-3,0,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 3.5 0 0 0 -1 0 0 0 -0.5 0.5 0 0 2-4ring6.dat
  [1,16,3.5,0,0,0,-1,0,0,0,-0.5,0.5,0,0, ldraw_lib__2_4ring6(realsolid)],
// 1 16 4 0 0 0 -1 0 0 0 -3.5 3.5 0 0 2-4ndis.dat
  [1,16,4,0,0,0,-1,0,0,0,-3.5,3.5,0,0, ldraw_lib__2_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 4 0 0 0 -0.5 0 0 0 -3.5 3.5 0 0 2-4cylo.dat
  [1,16,4,0,0,0,-0.5,0,0,0,-3.5,3.5,0,0, ldraw_lib__2_4cylo(realsolid)],
...
module ldraw_lib__92248(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92248(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
