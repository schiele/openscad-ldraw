...
use <s/43967s01.scad>
use <../p/stud2.scad>
function ldraw_lib__43967() = [
// 0 Train Door  1 x  4 x  5 Left with Thick Bottom Support
// 0 Name: 43967.dat
...
module ldraw_lib__43967(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__43967(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__43967(line=0.2);