...
$fa=1; $fs=0.2;
function ldraw_lib__3068bp10(realsolid=false) = [
...
// 1 16 0 0 0 0 0 -20 0 1 0 20 0 0 48\4-4ndis.dat
  [1,16,0,0,0,0,0,-20,0,1,0,20,0,0, ldraw_lib__48__4_4ndis(realsolid)],
// 1 1 0 0 0 1 0 0 0 1 0 0 0 1 s\973p55s01.dat
  [1,1,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p55s01(realsolid)],
];
module ldraw_lib__3068bp10(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068bp10(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
