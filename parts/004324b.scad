...
use <s/3069bs18.scad>
$fa=1; $fs=0.2;
function ldraw_lib__004324b(realsolid=false) = [
...
// 1 15 0 -0.25 0 1.4 0 0 0 1 0 0 0 1 s\3069bs18.dat
  [1,15,0,-0.25,0,1.4,0,0,0,1,0,0,0,1, ldraw_lib__s__3069bs18(realsolid)],
...
module ldraw_lib__004324b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__004324b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
