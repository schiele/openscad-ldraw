...
use <../p/stud2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__42446(realsolid=false) = [
...
// 1 16 0 10 -13 1 0 0 0 0 -1 0 1 0 stud2.dat
  [1,16,0,10,-13,1,0,0,0,0,-1,0,1,0, ldraw_lib__stud2(realsolid)],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__42446(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__42446(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
