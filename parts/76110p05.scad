...
use <32134.scad>
$fa=1; $fs=0.2;
function ldraw_lib__76110p05(realsolid=false) = [
...
// 1 490 0 0 -61 0 1 0 1 0 0 0 0 -1 32134.dat
  [1,490,0,0,-61,0,1,0,1,0,0,0,0,-1, ldraw_lib__32134(realsolid)],
// 
];
module ldraw_lib__76110p05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76110p05(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
