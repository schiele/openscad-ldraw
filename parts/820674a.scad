...
$fa=1; $fs=0.2;
function ldraw_lib__820674a(realsolid=false) = [
...
// 1 16 -10 -0.25 0 1 0 0 0 1 0 0 0 1 s\820674s01.dat
  [1,16,-10,-0.25,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__820674s01(realsolid)],
// 1 16 10 -0.25 0 -1 0 0 0 1 0 0 0 1 s\820674s01.dat
  [1,16,10,-0.25,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__820674s01(realsolid)],
];
module ldraw_lib__820674a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__820674a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
