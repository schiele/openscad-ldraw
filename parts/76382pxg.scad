...
use <3820.scad>
use <973pxg.scad>
function ldraw_lib__76382pxg() = [
// 0 Minifig Torso with Arms and Hands with Tan Oval and Black Spines and Tail Pattern
// 0 Name: 76382pxg.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973pxg.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973pxg()],
...
module ldraw_lib__76382pxg(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382pxg(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382pxg(line=0.2);