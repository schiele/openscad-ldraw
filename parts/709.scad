...
$fa=1; $fs=0.2;
function ldraw_lib__709(realsolid=false) = [
...
// 1 16 0 8 0 60 0 0 0 -8 0 0 0 40 box4.dat
  [1,16,0,8,0,60,0,0,0,-8,0,0,0,40, ldraw_lib__box4(realsolid)],
// 1 16 -20 0 0 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,-20,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4(realsolid)],
// 1 16 40 0 20 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,40,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 1 16 40 0 -20 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,40,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
...
module ldraw_lib__709(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__709(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
