...
use <u9013.scad>
$fa=1; $fs=0.2;
function ldraw_lib__64227(realsolid=false) = [
...
// 1 72 0 0 0 1 0 0 0 1 0 0 0 1 84748.dat
  [1,72,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__84748(realsolid)],
// 1 72 0 0 0 1 0 0 0 1 0 0 0 1 84747.dat
  [1,72,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__84747(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 84746.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__84746(realsolid)],
// 1 0 51.52 45.722 -60 0.83333 0 0 0 -1 0 0 0 -0.83333 u9013.dat
  [1,0,51.52,45.722,-60,0.83333,0,0,0,-1,0,0,0,-0.83333, ldraw_lib__u9013(realsolid)],
// 1 4 60 -5 -30 1 0 0 0 1 0 0 0 1 84751.dat
  [1,4,60,-5,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__84751(realsolid)],
// 1 4 -60 -5 -30 1 0 0 0 1 0 0 0 1 84751.dat
  [1,4,-60,-5,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__84751(realsolid)],
// 1 25 60 -12 -90 1 0 0 0 1 0 0 0 1 84752.dat
  [1,25,60,-12,-90,1,0,0,0,1,0,0,0,1, ldraw_lib__84752(realsolid)],
// 1 25 -60 -12 -90 1 0 0 0 1 0 0 0 1 84752.dat
  [1,25,-60,-12,-90,1,0,0,0,1,0,0,0,1, ldraw_lib__84752(realsolid)],
// 1 0 30 5 -35 0 0 -1 0 1 0 1 0 0 937.dat
  [1,0,30,5,-35,0,0,-1,0,1,0,1,0,0, ldraw_lib__937(realsolid)],
// 1 0 -30 5 -35 0 0 -1 0 1 0 1 0 0 937.dat
  [1,0,-30,5,-35,0,0,-1,0,1,0,1,0,0, ldraw_lib__937(realsolid)],
// 1 25 0 2 -77.8 0 0 1 0 1 0 -1 0 0 59365.dat
  [1,25,0,2,-77.8,0,0,1,0,1,0,-1,0,0, ldraw_lib__59365(realsolid)],
// 1 32 0 0 0 1 0 0 0 1 0 0 0 1 84750.dat
  [1,32,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__84750(realsolid)],
...
module ldraw_lib__64227(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__64227(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
