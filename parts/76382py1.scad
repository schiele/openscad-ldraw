...
use <3820.scad>
use <973py1.scad>
function ldraw_lib__76382py1() = [
// 0 Minifig Torso with Arms and Hands with Race Suit with Chevrolet Racing Logos and Blue Stripes Pattern
// 0 Name: 76382py1.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973py1.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973py1()],
...
module ldraw_lib__76382py1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382py1(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382py1(line=0.2);