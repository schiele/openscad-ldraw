...
use <../p/t04q4000.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2583(realsolid=false) = [
// 0 Bar  1 x  8 x  3
// 0 Name: 2583.dat
...
// 1 16 50 64 0 1 0 0 0 1 0 0 0 1 3070a.dat
  [1,16,50,64,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3070a(realsolid)],
// 1 16 -50 64 0 1 0 0 0 1 0 0 0 1 3070a.dat
  [1,16,-50,64,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3070a(realsolid)],
// 1 16 50 64 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,50,64,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 -50 64 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-50,64,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 50 60 0 6 0 0 0 4 0 0 0 6 4-4cyli.dat
  [1,16,50,60,0,6,0,0,0,4,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -50 60 0 6 0 0 0 4 0 0 0 6 4-4cyli.dat
  [1,16,-50,60,0,6,0,0,0,4,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 50 60 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,50,60,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 -50 60 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-50,60,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 50 60 0 6 0 0 0 -2 0 0 0 6 4-8sphe.dat
  [1,16,50,60,0,6,0,0,0,-2,0,0,0,6, ldraw_lib__4_8sphe(realsolid)],
// 1 16 -50 60 0 6 0 0 0 -2 0 0 0 6 4-8sphe.dat
  [1,16,-50,60,0,6,0,0,0,-2,0,0,0,6, ldraw_lib__4_8sphe(realsolid)],
// 1 16 60 46 0 10 0 0 0 0 10 0 10 0 t04q4000.dat
  [1,16,60,46,0,10,0,0,0,0,10,0,10,0, ldraw_lib__t04q4000(realsolid)],
// 1 16 -60 46 0 -10 0 0 0 0 10 0 10 0 t04q4000.dat
  [1,16,-60,46,0,-10,0,0,0,0,10,0,10,0, ldraw_lib__t04q4000(realsolid)],
// 1 16 70 14 0 4 0 0 0 32 0 0 0 4 4-4cyli.dat
  [1,16,70,14,0,4,0,0,0,32,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -70 14 0 4 0 0 0 32 0 0 0 4 4-4cyli.dat
  [1,16,-70,14,0,4,0,0,0,32,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 60 14 0 10 0 0 0 0 -10 0 10 0 t04q4000.dat
  [1,16,60,14,0,10,0,0,0,0,-10,0,10,0, ldraw_lib__t04q4000(realsolid)],
// 1 16 -60 14 0 -10 0 0 0 0 -10 0 10 0 t04q4000.dat
  [1,16,-60,14,0,-10,0,0,0,0,-10,0,10,0, ldraw_lib__t04q4000(realsolid)],
// 
// 1 16 60 56 0 0 -120 0 4 0 0 0 0 4 4-4cyli.dat
  [1,16,60,56,0,0,-120,0,4,0,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 60 4 0 0 -120 0 4 0 0 0 0 4 4-4cyli.dat
  [1,16,60,4,0,0,-120,0,4,0,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 50 8 0 2 0 0 0 44 0 0 0 2 4-4cyli.dat
  [1,16,50,8,0,2,0,0,0,44,0,0,0,2, ldraw_lib__4_4cyli(realsolid)],
// 1 16 30 8 0 2 0 0 0 44 0 0 0 2 4-4cyli.dat
  [1,16,30,8,0,2,0,0,0,44,0,0,0,2, ldraw_lib__4_4cyli(realsolid)],
// 1 16 10 8 0 2 0 0 0 44 0 0 0 2 4-4cyli.dat
  [1,16,10,8,0,2,0,0,0,44,0,0,0,2, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -10 8 0 2 0 0 0 44 0 0 0 2 4-4cyli.dat
  [1,16,-10,8,0,2,0,0,0,44,0,0,0,2, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -30 8 0 2 0 0 0 44 0 0 0 2 4-4cyli.dat
  [1,16,-30,8,0,2,0,0,0,44,0,0,0,2, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -50 7 0 2 0 0 0 46 0 0 0 2 4-4cyli.dat
  [1,16,-50,7,0,2,0,0,0,46,0,0,0,2, ldraw_lib__4_4cyli(realsolid)],
// 
// 1 16 50 52 0 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,50,52,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 30 52 0 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,30,52,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 52 0 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,10,52,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 -10 52 0 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,-10,52,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 -30 52 0 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,-30,52,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 50 8 0 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,50,8,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 30 8 0 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,30,8,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 8 0 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,10,8,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 -10 8 0 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,-10,8,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 -30 8 0 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,-30,8,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 50 0 0 6 0 0 0 2 0 0 0 6 4-8sphe.dat
  [1,16,50,0,0,6,0,0,0,2,0,0,0,6, ldraw_lib__4_8sphe(realsolid)],
// 1 16 -50 0 0 6 0 0 0 2 0 0 0 6 4-8sphe.dat
  [1,16,-50,0,0,6,0,0,0,2,0,0,0,6, ldraw_lib__4_8sphe(realsolid)],
// 1 16 50 0 0 6 0 0 0 6 0 0 0 6 4-4disc.dat
  [1,16,50,0,0,6,0,0,0,6,0,0,0,6, ldraw_lib__4_4disc(realsolid)],
// 1 16 -50 0 0 6 0 0 0 6 0 0 0 6 4-4disc.dat
  [1,16,-50,0,0,6,0,0,0,6,0,0,0,6, ldraw_lib__4_4disc(realsolid)],
...
module ldraw_lib__2583(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2583(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
