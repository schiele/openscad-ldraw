...
function ldraw_lib__6177954c() = [
// 0 Sticker  1.8 x  2.2 with Logos on Red Background Left
// 0 Name: 6177954c.dat
...
module ldraw_lib__6177954c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6177954c(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6177954c(line=0.2);