...
use <../p/stud4o.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4599b(realsolid=false) = [
...
// 1 16 0 4 16 1 0 0 0 0 1 0 1 0 4-4ring3.dat
  [1,16,0,4,16,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4ring3(realsolid)],
// 1 16 0 4 20 4 0 0 0 0 4 0 -4 0 4-4cylc.dat
  [1,16,0,4,20,4,0,0,0,0,4,0,-4,0, ldraw_lib__4_4cylc(realsolid)],
];
module ldraw_lib__4599b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4599b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
