...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2719(realsolid=false) = [
...
// 1 16 0 8 0 80 0 0 0 -8 0 0 0 10 box3u8p.dat
  [1,16,0,8,0,80,0,0,0,-8,0,0,0,10, ldraw_lib__box3u8p(realsolid)],
...
// 1 16 80 7 0 0 -1 0 1 0 0 0 0 10 rect.dat
  [1,16,80,7,0,0,-1,0,1,0,0,0,0,10, ldraw_lib__rect(realsolid)],
// 1 16 -80 7 0 0 1 0 1 0 0 0 0 10 rect.dat
  [1,16,-80,7,0,0,1,0,1,0,0,0,0,10, ldraw_lib__rect(realsolid)],
// 1 16 90 0 0 0 0 1 0 1 0 -1 0 0 steerend.dat
  [1,16,90,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__steerend(realsolid)],
// 1 16 -90 0 0 0 0 -1 0 1 0 1 0 0 steerend.dat
  [1,16,-90,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__steerend(realsolid)],
...
module ldraw_lib__2719(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2719(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2719(line=0.2);