...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__0904(realsolid=false) = [
// 0 Baseplate 16 x 24 with Set 080 Large White House Studs
// 0 Name: 0904.dat
...
module ldraw_lib__0904(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__0904(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__0904(line=0.2);