...
$fa=1; $fs=0.2;
function ldraw_lib__2425(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2425s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2425s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\2425s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__2425s01(realsolid)],
// 
// 1 16 0 0 0 40 0 0 0 1 0 0 0 20 recte3.dat
  [1,16,0,0,0,40,0,0,0,1,0,0,0,20, ldraw_lib__recte3(realsolid)],
// 1 16 0 0 -13.75 10 0 0 0 1 0 0 0 6.25 recte3.dat
  [1,16,0,0,-13.75,10,0,0,0,1,0,0,0,6.25, ldraw_lib__recte3(realsolid)],
// 4 16 40 0 20 -40 0 20 -10 0 -7.5 10 0 -7.5
  [4,16,40,0,20,-40,0,20,-10,0,-7.5,10,0,-7.5],
// 1 16 0 9.743 -7.5 5 0 0 0 0 -5.743 0 1 0 recte3.dat
  [1,16,0,9.743,-7.5,5,0,0,0,0,-5.743,0,1,0, ldraw_lib__recte3(realsolid)],
// 4 16 -5 4 -7.5 5 4 -7.5 10 0 -7.5 -10 0 -7.5
  [4,16,-5,4,-7.5,5,4,-7.5,10,0,-7.5,-10,0,-7.5],
// 1 16 0 3.5 -5.5 5 0 0 0 0.5 0 0 0 2 box2-7.dat
  [1,16,0,3.5,-5.5,5,0,0,0,0.5,0,0,0,2, ldraw_lib__box2_7(realsolid)],
// 1 16 0 3 6.25 10 0 0 0 -1 0 0 0 -9.75 rect3.dat
  [1,16,0,3,6.25,10,0,0,0,-1,0,0,0,-9.75, ldraw_lib__rect3(realsolid)],
// 1 16 0 14 18 10 0 0 0 11 0 0 0 -2 box2-5.dat
  [1,16,0,14,18,10,0,0,0,11,0,0,0,-2, ldraw_lib__box2_5(realsolid)],
...
module ldraw_lib__2425(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2425(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
