...
use <s/u9153s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9153(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9153s00.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9153s00(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9153s00.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9153s00(realsolid)],
// 
// 0 BFC INVERTNEXT
...
module ldraw_lib__u9153(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9153(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9153(line=0.2);