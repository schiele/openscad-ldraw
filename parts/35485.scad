...
// 1 16 7.5 0 0 0 -15 0 -4 0 0 0 0 4 4-4cylc.dat
  [1,16,7.5,0,0,0,-15,0,-4,0,0,0,0,4, ldraw_lib__4_4cylc()],
// 1 16 -7.5 0 0 0 1 0 -4 0 0 0 0 4 4-4disc.dat
  [1,16,-7.5,0,0,0,1,0,-4,0,0,0,0,4, ldraw_lib__4_4disc()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\35485s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__35485s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\35485s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__35485s01()],
...
module ldraw_lib__35485(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__35485(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
