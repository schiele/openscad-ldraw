...
use <973.scad>
$fa=1; $fs=0.2;
function ldraw_lib__84638p01(realsolid=false) = [
...
// 1 179 23.6904 26.774 -9.8982 -0.985 -0.1202 -0.1202 0.17 -0.6964 -0.6964 0 -0.707 0.707 2531.dat
  [1,179,23.6904,26.774,-9.8982,-0.985,-0.1202,-0.1202,0.17,-0.6964,-0.6964,0,-0.707,0.707, ldraw_lib__2531(realsolid)],
];
module ldraw_lib__84638p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__84638p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
