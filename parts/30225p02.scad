...
use <51595p02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30225p02(realsolid=false) = [
// 0 ~Moved to 51595p02
// 0 Name: 30225p02.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 51595p02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__51595p02(realsolid)],
];
module ldraw_lib__30225p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30225p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
