...
// 1 16 142.851 12 188.248 0.970296 0 -0.241922 0 -1 0 0.241922 0 0.970296 stud3.dat
  [1,16,142.851,12,188.248,0.970296,0,-0.241922,0,-1,0,0.241922,0,0.970296, ldraw_lib__stud3()],
// 1 16 167.045 12 91.221 0.970296 0 -0.241922 0 -1 0 0.241922 0 0.970296 stud3.dat
  [1,16,167.045,12,91.221,0.970296,0,-0.241922,0,-1,0,0.241922,0,0.970296, ldraw_lib__stud3()],
// 1 16 160 12 50 0 0 1 0 -1 0 -1 0 0 stud3.dat
  [1,16,160,12,50,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stud3()],
// 1 16 160 12 -50 0 0 1 0 -1 0 -1 0 0 stud3.dat
  [1,16,160,12,-50,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stud3()],
// 1 16 310 0 -50 1 0 0 0 1 0 0 0 1 s\948cs02.dat
  [1,16,310,0,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__s__948cs02()],
// 1 16 310 0 50 1 0 0 0 1 0 0 0 1 s\948cs02.dat
  [1,16,310,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__s__948cs02()],
// 1 16 310 0 210 1 0 0 0 1 0 0 0 1 s\948cs02.dat
  [1,16,310,0,210,1,0,0,0,1,0,0,0,1, ldraw_lib__s__948cs02()],
// 1 16 -310 0 -50 -1 0 0 0 1 0 0 0 -1 s\948cs02.dat
  [1,16,-310,0,-50,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__948cs02()],
// 1 16 310 0 110 1 0 0 0 1 0 0 0 1 s\948cs01.dat
  [1,16,310,0,110,1,0,0,0,1,0,0,0,1, ldraw_lib__s__948cs01()],
// 1 16 -310 0 50 -1 0 0 0 1 0 0 0 -1 s\948cs01.dat
  [1,16,-310,0,50,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__948cs01()],
];
module ldraw_lib__948c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__948c(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
