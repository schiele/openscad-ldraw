...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4085a(realsolid=false) = [
// 0 Plate  1 x  1 with Clip Vertical (Thin C-Clip)
// 0 Name: 4085a.dat
...
// 0 !HISTORY 2013-08-07 [C3POwen] Utilised clip9.dat primitive
...
// 1 16 0 4 -10 1 0 0 0 1 0 0 0 1 clip9.dat
  [1,16,0,4,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__clip9(realsolid)],
// 1 16 7 4 -10 0 0 -3 -4 0 0 0 1 0 rect3.dat
  [1,16,7,4,-10,0,0,-3,-4,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 stud.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__stud(realsolid)],
];
module ldraw_lib__4085a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4085a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4085a(line=0.2);