...
use <s/2546s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2546p01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2546s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2546s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2546p01s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2546p01s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\2546s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__2546s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\2546p01s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__2546p01s01(realsolid)],
...
// 1 16 0 -32 0 4 0 0 0 28 0 0 0 4 4-4cylc.dat
  [1,16,0,-32,0,4,0,0,0,28,0,0,0,4, ldraw_lib__4_4cylc(realsolid)],
...
module ldraw_lib__2546p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2546p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
