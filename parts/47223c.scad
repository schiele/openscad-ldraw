...
use <47223a-f3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__47223c(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 47223a-f3.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__47223a_f3(realsolid)],
];
module ldraw_lib__47223c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__47223c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
