...
use <../p/stud16.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87610(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\87610s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87610s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\87610s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87610s02(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\87610s03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87610s03(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\87610s03.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87610s03(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\87610s07.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87610s07(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\87610s07.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87610s07(realsolid)],
...
module ldraw_lib__87610(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87610(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
