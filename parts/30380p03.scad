...
// 0 !KEYWORDS BrickLink x50px1, Rebrickable 30380pr0001, set 10123
// 
...
// 1 308 0 0 0 1 0 0 0 1 0 0 0 1 s\30380s02.dat
  [1,308,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30380s02()],
// 1 308 0 0 0 -1 0 0 0 1 0 0 0 1 s\30380s02.dat
  [1,308,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30380s02()],
...
module ldraw_lib__30380p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30380p03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
