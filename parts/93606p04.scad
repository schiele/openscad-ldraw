...
use <s/93606s01.scad>
function ldraw_lib__93606p04() = [
// 0 Slope Brick Curved  4 x  2 with Bright Light Orange Stripe Left Pattern
// 0 Name: 93606p04.dat
...
module ldraw_lib__93606p04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__93606p04(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__93606p04(line=0.2);