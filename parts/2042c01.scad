...
use <2043.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2042c01(realsolid=false) = [
...
// 1 1 -52 135 -16 1 0 0 0 1 0 0 0 1 2043.dat
  [1,1,-52,135,-16,1,0,0,0,1,0,0,0,1, ldraw_lib__2043(realsolid)],
// 1 1 52 135 -16 -1 0 0 0 -1 0 0 0 1 2043.dat
  [1,1,52,135,-16,-1,0,0,0,-1,0,0,0,1, ldraw_lib__2043(realsolid)],
];
module ldraw_lib__2042c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2042c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
