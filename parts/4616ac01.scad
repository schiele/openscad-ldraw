...
use <4617a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4616ac01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 4616a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4616a(realsolid)],
// 1 14 0 24 -50 1 0 0 0 1 0 0 0 1 4617a.dat
  [1,14,0,24,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__4617a(realsolid)],
// 1 0 0 24 -52 1 0 0 0 1 0 0 0 1 2344.dat
  [1,0,0,24,-52,1,0,0,0,1,0,0,0,1, ldraw_lib__2344(realsolid)],
];
module ldraw_lib__4616ac01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4616ac01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
