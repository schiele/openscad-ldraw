...
use <3062b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4212454(realsolid=false) = [
...
// 1 27 0 0 0 1 0 0 0 1 0 0 0 1 3062b.dat
  [1,27,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3062b(realsolid)],
];
module ldraw_lib__4212454(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4212454(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
