...
use <40620.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4144485(realsolid=false) = [
...
// 1 383 0 0 0 1 0 0 0 1 0 0 0 1 40620.dat
  [1,383,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__40620(realsolid)],
];
module ldraw_lib__4144485(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4144485(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
