...
use <s/92252s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92251p06(realsolid=false) = [
...
// 1 6 0 0 0 1 0 0 0 1 0 0 0 1 s\92251p06s01.dat
  [1,6,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92251p06s01(realsolid)],
// 1 78 0 0 0 1 0 0 0 1 0 0 0 1 s\92251p06s02.dat
  [1,78,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92251p06s02(realsolid)],
// 1 84 0 0 0 1 0 0 0 1 0 0 0 1 s\92251p06s03.dat
  [1,84,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92251p06s03(realsolid)],
// 1 84 0 0 0 1 0 0 0 1 0 0 0 1 s\92251p06s04.dat
  [1,84,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92251p06s04(realsolid)],
// 1 6 0 0 0 -1 0 0 0 1 0 0 0 1 s\92251p06s01.dat
  [1,6,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__92251p06s01(realsolid)],
// 1 78 0 0 0 -1 0 0 0 1 0 0 0 1 s\92251p06s02.dat
  [1,78,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__92251p06s02(realsolid)],
...
module ldraw_lib__92251p06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92251p06(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
