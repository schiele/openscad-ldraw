...
use <s/55981s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__55982(realsolid=false) = [
...
// 1 16 0 0 -7 10 0 0 0 0 -10 0 7 0 4-4cyli.dat
  [1,16,0,0,-7,10,0,0,0,0,-10,0,7,0, ldraw_lib__4_4cyli(realsolid)],
...
module ldraw_lib__55982(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__55982(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
