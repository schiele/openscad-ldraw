...
use <76019.scad>
$fa=1; $fs=0.2;
function ldraw_lib__60c01(realsolid=false) = [
// 0 ~Moved to 76019
// 0 Name: 60c01.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 76019.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__76019(realsolid)],
];
module ldraw_lib__60c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__60c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
