...
use <3622.scad>
$fa=1; $fs=0.2;
function ldraw_lib__45505(realsolid=false) = [
// 0 =Brick  1 x  3
// 0 Name: 45505.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3622.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3622(realsolid)],
];
module ldraw_lib__45505(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__45505(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
