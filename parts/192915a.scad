...
$fa=1; $fs=0.2;
function ldraw_lib__192915a(realsolid=false) = [
...
// 1 15 19.3 -0.25 11 2.3 0 0 0 1 0 0 0 -1.5 1-4ndis.dat
  [1,15,19.3,-0.25,11,2.3,0,0,0,1,0,0,0,-1.5, ldraw_lib__1_4ndis(realsolid)],
...
// 1 0 19.3 -0.25 11 2.3 0 0 0 1 0 0 0 -1.5 1-4disc.dat
  [1,0,19.3,-0.25,11,2.3,0,0,0,1,0,0,0,-1.5, ldraw_lib__1_4disc(realsolid)],
...
module ldraw_lib__192915a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__192915a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
