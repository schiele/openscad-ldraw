...
$fa=1; $fs=0.2;
function ldraw_lib__6062886c(realsolid=false) = [
...
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 s\6062886cs01.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6062886cs01(realsolid)],
];
module ldraw_lib__6062886c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6062886c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
