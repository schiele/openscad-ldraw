...
use <s/56904s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__56904(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\56904s00.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__56904s00(realsolid)],
// 1 16 0 0 0 -0.5 0.866 0 0.866 0.5 0 0 0 -1 s\56904s01.dat
  [1,16,0,0,0,-0.5,0.866,0,0.866,0.5,0,0,0,-1, ldraw_lib__s__56904s01(realsolid)],
// 1 16 0 0 0 0.5 0.866 0 -0.866 0.5 0 0 0 -1 s\56904s01.dat
  [1,16,0,0,0,0.5,0.866,0,-0.866,0.5,0,0,0,-1, ldraw_lib__s__56904s01(realsolid)],
// 1 16 0 0 0 0.5 0.866 0 0.866 -0.5 0 0 0 -1 s\56904s01.dat
  [1,16,0,0,0,0.5,0.866,0,0.866,-0.5,0,0,0,-1, ldraw_lib__s__56904s01(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 -1 s\56904s01.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,-1, ldraw_lib__s__56904s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 -1 0 0 0 -1 s\56904s01.dat
  [1,16,0,0,0,-1,0,0,0,-1,0,0,0,-1, ldraw_lib__s__56904s01(realsolid)],
// 1 16 0 0 0 0.5 -0.866 0 -0.866 -0.5 0 0 0 -1 s\56904s01.dat
  [1,16,0,0,0,0.5,-0.866,0,-0.866,-0.5,0,0,0,-1, ldraw_lib__s__56904s01(realsolid)],
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\56904s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__56904s02(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\56904s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__56904s02(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\54087s09.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__54087s09(realsolid)],
];
module ldraw_lib__56904(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__56904(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
