...
use <../p/stug-8x8.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4187(realsolid=false) = [
// 0 Baseplate  8 x 32
// 0 Name: 4187.dat
...
// 1 16 240 0 0 1 0 0 0 1 0 0 0 1 stug-8x8.dat
  [1,16,240,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_8x8(realsolid)],
...
// 1 16 316 4 76 4 0 0 0 1 0 0 0 4 1-4edge.dat
  [1,16,316,4,76,4,0,0,0,1,0,0,0,4, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 316 0 76 4 0 0 0 1 0 0 0 4 1-4edge.dat
  [1,16,316,0,76,4,0,0,0,1,0,0,0,4, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 316 4 76 4 0 0 0 -1 0 0 0 4 1-4disc.dat
  [1,16,316,4,76,4,0,0,0,-1,0,0,0,4, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 316 0 76 4 0 0 0 1 0 0 0 4 1-4disc.dat
  [1,16,316,0,76,4,0,0,0,1,0,0,0,4, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 316 0 76 4 0 0 0 4 0 0 0 4 1-4cyli.dat
  [1,16,316,0,76,4,0,0,0,4,0,0,0,4, ldraw_lib__1_4cyli(realsolid)],
...
module ldraw_lib__4187(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4187(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
