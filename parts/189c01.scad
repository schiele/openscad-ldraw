...
use <u9067.scad>
$fa=1; $fs=0.2;
function ldraw_lib__189c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 189.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__189(realsolid)],
// 1 47 0 20 0 1 0 0 0 1 0 0 0 1 u9065.dat
  [1,47,0,20,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9065(realsolid)],
// 1 4 0 24 0 1 0 0 0 -1 0 0 0 -1 u9066.dat
  [1,4,0,24,0,1,0,0,0,-1,0,0,0,-1, ldraw_lib__u9066(realsolid)],
// 1 494 -10 4 10 1 0 0 0 1 0 0 0 1 u9067.dat
  [1,494,-10,4,10,1,0,0,0,1,0,0,0,1, ldraw_lib__u9067(realsolid)],
// 1 494 -10 4 -10 1 0 0 0 1 0 0 0 1 u9067.dat
  [1,494,-10,4,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__u9067(realsolid)],
];
module ldraw_lib__189c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__189c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
