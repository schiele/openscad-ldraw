...
use <s/309p03a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__309p04(realsolid=false) = [
...
// 1 2 142 0 -38 10 0 0 0 1 0 0 0 10 48\1-4ring2.dat
  [1,2,142,0,-38,10,0,0,0,1,0,0,0,10, ldraw_lib__48__1_4ring2(realsolid)],
// 1 2 142 0 -42 0 0 10 0 1 0 -10 0 0 48\1-4ring2.dat
  [1,2,142,0,-42,0,0,10,0,1,0,-10,0,0, ldraw_lib__48__1_4ring2(realsolid)],
// 1 2 -142 0 -42 -10 0 0 0 1 0 0 0 -10 48\1-4ring2.dat
  [1,2,-142,0,-42,-10,0,0,0,1,0,0,0,-10, ldraw_lib__48__1_4ring2(realsolid)],
// 1 2 -142 0 -38 0 0 -10 0 1 0 10 0 0 48\1-4ring2.dat
  [1,2,-142,0,-38,0,0,-10,0,1,0,10,0,0, ldraw_lib__48__1_4ring2(realsolid)],
// 0
];
module ldraw_lib__309p04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__309p04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
