...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2377p01(realsolid=false) = [
...
// 1 16 0 40 -10 1 0 0 0 0 -0.7 0 1 0 s\3069bs18.dat
  [1,16,0,40,-10,1,0,0,0,0,-0.7,0,1,0, ldraw_lib__s__3069bs18(realsolid)],
// 0
];
module ldraw_lib__2377p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2377p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
