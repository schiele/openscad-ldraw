...
use <s/u9494s04.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9494p01(realsolid=false) = [
...
// 1 16 0 -0.25 0 1 0 0 0 1 0 0 0 1 s\u9494s01.dat
  [1,16,0,-0.25,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9494s01(realsolid)],
// 1 16 0 -0.25 0 -1 0 0 0 1 0 0 0 1 s\u9494s01.dat
  [1,16,0,-0.25,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9494s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 1 s\u9494s01.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__u9494s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 -1 0 0 0 1 s\u9494s01.dat
  [1,16,0,0,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__s__u9494s01(realsolid)],
// 
// 1 15 0 -0.25 0 1 0 0 0 1 0 0 0 1 s\u9494s02.dat
  [1,15,0,-0.25,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9494s02(realsolid)],
// 1 15 0 -0.25 0 -1 0 0 0 1 0 0 0 1 s\u9494s02.dat
  [1,15,0,-0.25,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9494s02(realsolid)],
// 1 15 0 0 0 1 0 0 0 -1 0 0 0 1 s\u9494s02.dat
  [1,15,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__u9494s02(realsolid)],
// 1 15 0 0 0 -1 0 0 0 -1 0 0 0 1 s\u9494s02.dat
  [1,15,0,0,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__s__u9494s02(realsolid)],
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9494s03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9494s03(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9494s03.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9494s03(realsolid)],
// 
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\u9494s04.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9494s04(realsolid)],
// 1 15 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9494s04.dat
  [1,15,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9494s04(realsolid)],
];
module ldraw_lib__u9494p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9494p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
