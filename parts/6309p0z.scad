...
use <s/6309s01.scad>
function ldraw_lib__6309p0z() = [
// 0 Duplo Tile  2 x  2 with Red Inverse Arch Pattern
// 0 Name: 6309p0z.dat
...
// 0 BFC CERTIFY CW
  ...
  [0,"BFC","CW"],
// 
// 0 !KEYWORDS Rebrickable 6309pr0102, Set 9518
// 
...
// 1 16 0 0 0 -38 0 0 0 1 0 0 0 38 48\1-4ndis.dat
  [1,16,0,0,0,-38,0,0,0,1,0,0,0,38, ldraw_lib__48__1_4ndis()],
// 4 4 -38 0 -38 -38 0 0 38 0 0 38 0 -38
  [4,4,-38,0,-38,-38,0,0,38,0,0,38,0,-38],
// 0
];
module ldraw_lib__6309p0z(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6309p0z(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6309p0z(line=0.2);