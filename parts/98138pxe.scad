...
use <s/98138s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98138pxe(realsolid=false) = [
...
// 1 2 2 0 0 -2.47487 0 2.47487 0 1 0 -2.47487 0 -2.47487 1-4chrd.dat
  [1,2,2,0,0,-2.47487,0,2.47487,0,1,0,-2.47487,0,-2.47487, ldraw_lib__1_4chrd(realsolid)],
...
module ldraw_lib__98138pxe(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98138pxe(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
