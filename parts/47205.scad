...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\47205s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__47205s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\47205s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__47205s01()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\47205s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__47205s02()],
...
// 1 16 0 -37 2 0 0 6 -4 0 0 0 -1 0 rect1.dat
  [1,16,0,-37,2,0,0,6,-4,0,0,0,-1,0, ldraw_lib__rect1()],
// 1 16 0 -41 4 0 0 6 0 -1 0 2 0 0 rect1.dat
  [1,16,0,-41,4,0,0,6,0,-1,0,2,0,0, ldraw_lib__rect1()],
// 1 16 0 -45.5 6 0 0 6 -4.5 0 0 0 -1 0 rect1.dat
  [1,16,0,-45.5,6,0,0,6,-4.5,0,0,0,-1,0, ldraw_lib__rect1()],
];
module ldraw_lib__47205(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__47205(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
