...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__851a(realsolid=false) = [
...
// 1 16 0 -5 -16.5 130 0 0 0 -1 0 0 0 -2.5 rect3.dat
  [1,16,0,-5,-16.5,130,0,0,0,-1,0,0,0,-2.5, ldraw_lib__rect3(realsolid)],
// 1 16 0 -12.5 -14 0 0 130 -7.5 0 0 0 -5 0 box3u10p.dat
  [1,16,0,-12.5,-14,0,0,130,-7.5,0,0,0,-5,0, ldraw_lib__box3u10p(realsolid)],
// 
// 1 16 0 -15 -14 0 0 130 5 0 0 0 -1 0 rect2p.dat
  [1,16,0,-15,-14,0,0,130,5,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -118.75 -20 -16.5 -11.25 0 0 0 1 0 0 0 -2.5 rect.dat
  [1,16,-118.75,-20,-16.5,-11.25,0,0,0,1,0,0,0,-2.5, ldraw_lib__rect(realsolid)],
// 
// 1 16 118.75 -20 -16.5 0 0 11.25 0 1 0 -2.5 0 0 rect3.dat
  [1,16,118.75,-20,-16.5,0,0,11.25,0,1,0,-2.5,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 3.75 -20 -16.5 96.25 0 0 0 1 0 0 0 2.5 rect.dat
  [1,16,3.75,-20,-16.5,96.25,0,0,0,1,0,0,0,2.5, ldraw_lib__rect(realsolid)],
// 
// 1 16 0 -5 16.5 -130 0 0 0 -1 0 0 0 2.5 rect3.dat
  [1,16,0,-5,16.5,-130,0,0,0,-1,0,0,0,2.5, ldraw_lib__rect3(realsolid)],
// 1 16 0 -12.5 14 0 0 130 -7.5 0 0 0 5 0 box3u10p.dat
...
// 1 16 130 -7.5 0 0 -17.5 0 -2.5 0 0 0 0 -14 box3u5p.dat
  [1,16,130,-7.5,0,0,-17.5,0,-2.5,0,0,0,0,-14, ldraw_lib__box3u5p(realsolid)],
// 1 16 110 -10 0 0 0 -2.5 0 1 0 14 0 0 rect.dat
  [1,16,110,-10,0,0,0,-2.5,0,1,0,14,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 100 -5 0 -7.5 0 0 0 -5 0 0 0 -14 box4o4a.dat
  [1,16,100,-5,0,-7.5,0,0,0,-5,0,0,0,-14, ldraw_lib__box4o4a(realsolid)],
// 1 16 90 -10 0 0 0 -2.5 0 1 0 14 0 0 rect.dat
  [1,16,90,-10,0,0,0,-2.5,0,1,0,14,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 80 -5 0 -7.5 0 0 0 -5 0 0 0 -14 box4o4a.dat
  [1,16,80,-5,0,-7.5,0,0,0,-5,0,0,0,-14, ldraw_lib__box4o4a(realsolid)],
// 1 16 70 -10 0 0 0 -2.5 0 1 0 14 0 0 rect.dat
  [1,16,70,-10,0,0,0,-2.5,0,1,0,14,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 60 -5 0 -7.5 0 0 0 -5 0 0 0 -14 box4o4a.dat
  [1,16,60,-5,0,-7.5,0,0,0,-5,0,0,0,-14, ldraw_lib__box4o4a(realsolid)],
// 1 16 50 -10 0 0 0 -2.5 0 1 0 14 0 0 rect.dat
  [1,16,50,-10,0,0,0,-2.5,0,1,0,14,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 40 -5 0 -7.5 0 0 0 -5 0 0 0 -14 box4o4a.dat
  [1,16,40,-5,0,-7.5,0,0,0,-5,0,0,0,-14, ldraw_lib__box4o4a(realsolid)],
// 1 16 30 -10 0 0 0 -2.5 0 1 0 14 0 0 rect.dat
  [1,16,30,-10,0,0,0,-2.5,0,1,0,14,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 -5 0 -7.5 0 0 0 -5 0 0 0 -14 box4o4a.dat
  [1,16,20,-5,0,-7.5,0,0,0,-5,0,0,0,-14, ldraw_lib__box4o4a(realsolid)],
// 1 16 10 -10 0 0 0 -2.5 0 1 0 14 0 0 rect.dat
  [1,16,10,-10,0,0,0,-2.5,0,1,0,14,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -5 0 -7.5 0 0 0 -5 0 0 0 -14 box4o4a.dat
  [1,16,0,-5,0,-7.5,0,0,0,-5,0,0,0,-14, ldraw_lib__box4o4a(realsolid)],
// 1 16 -10 -10 0 0 0 -2.5 0 1 0 14 0 0 rect.dat
  [1,16,-10,-10,0,0,0,-2.5,0,1,0,14,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 -100 -20 -16.5 7.5 0 0 0 -3 0 0 0 -2.5 box4-7a.dat
  [1,16,-100,-20,-16.5,7.5,0,0,0,-3,0,0,0,-2.5, ldraw_lib__box4_7a(realsolid)],
// 1 16 -103.75 -21.5 -14 -3.75 0 0 0 0 1.5 0 1.5 0 box5-4a.dat
  [1,16,-103.75,-21.5,-14,-3.75,0,0,0,0,1.5,0,1.5,0, ldraw_lib__box5_4a(realsolid)],
// 1 16 -96.25 -21.5 -14 -3.75 0 0 0 0 -1.5 0 -1 0 rect3.dat
  [1,16,-96.25,-21.5,-14,-3.75,0,0,0,0,-1.5,0,-1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 102.5 -20 -16.5 0 0 -2.5 0 -3 0 -2.5 0 0 box4-7a.dat
  [1,16,102.5,-20,-16.5,0,0,-2.5,0,-3,0,-2.5,0,0, ldraw_lib__box4_7a(realsolid)],
// 1 16 105 -23 -16.5 0 0 2.5 0 3 0 -2.5 0 0 2-4cylc.dat
  [1,16,105,-23,-16.5,0,0,2.5,0,3,0,-2.5,0,0, ldraw_lib__2_4cylc(realsolid)],
// 1 16 105 -20 -16.5 0 0 2.5 0 1 0 -2.5 0 0 2-4ndis.dat
  [1,16,105,-20,-16.5,0,0,2.5,0,1,0,-2.5,0,0, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 -112.5 -5 0 0 -2 0 -2.5 0 0 0 0 -6.5 box5.dat
  [1,16,-112.5,-5,0,0,-2,0,-2.5,0,0,0,0,-6.5, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__851a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__851a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
