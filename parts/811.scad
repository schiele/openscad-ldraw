...
use <../p/stug-8x1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__811(realsolid=false) = [
...
// 1 16 -260 0 -60 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,-260,0,-60,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 1 16 -160 0 -20 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,-160,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 1 16 -160 0 -100 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,-160,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
...
// 1 16 0 0 -100 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,0,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 1 16 160 0 -20 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,160,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 1 16 160 0 -100 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,160,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
...
// 1 16 250 0 -150 1 0 0 0 1 0 0 0 1 stug-1x5.dat
  [1,16,250,0,-150,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x5(realsolid)],
// 1 16 -250 0 -150 1 0 0 0 1 0 0 0 1 stug-1x5.dat
  [1,16,-250,0,-150,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x5(realsolid)],
// 
...
module ldraw_lib__811(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__811(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
