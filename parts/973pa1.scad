...
use <s/973s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973pa1(realsolid=false) = [
...
// 1 4 0 3.5 -10 2.25 0 0 0 0 2.25 0 1 0 4-4disc.dat
  [1,4,0,3.5,-10,2.25,0,0,0,0,2.25,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 0 0 3.5 -10 -0.25 0 0 0 0 -0.25 0 1 0 4-4ring9.dat
  [1,0,0,3.5,-10,-0.25,0,0,0,0,-0.25,0,1,0, ldraw_lib__4_4ring9(realsolid)],
// 1 16 0 3.5 -10 0 0 -2.5 -2.5 0 0 0 1 0 1-8ndis.dat
  [1,16,0,3.5,-10,0,0,-2.5,-2.5,0,0,0,1,0, ldraw_lib__1_8ndis(realsolid)],
// 1 16 0 3.5 -10 0 0 2.5 -2.5 0 0 0 1 0 1-8ndis.dat
  [1,16,0,3.5,-10,0,0,2.5,-2.5,0,0,0,1,0, ldraw_lib__1_8ndis(realsolid)],
// 1 16 0 3.5 -10 0 0 -2.5 2.5 0 0 0 1 0 1-8ndis.dat
  [1,16,0,3.5,-10,0,0,-2.5,2.5,0,0,0,1,0, ldraw_lib__1_8ndis(realsolid)],
...
// 1 0 0 8.5 -10 1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,0,0,8.5,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 0 0 11.5 -10 1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,0,0,11.5,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 0 0 14.5 -10 1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,0,0,14.5,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 0 0 17.5 -10 1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,0,0,17.5,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 0 0 20.5 -10 1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,0,0,20.5,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 0 0 23.5 -10 1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,0,0,23.5,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 0 0 26.5 -10 1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,0,0,26.5,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 8.5 -10 1 0 0 0 0 1 0 1 0 4-4ndis.dat
  [1,16,0,8.5,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 11.5 -10 1 0 0 0 0 1 0 1 0 4-4ndis.dat
  [1,16,0,11.5,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 14.5 -10 1 0 0 0 0 1 0 1 0 4-4ndis.dat
  [1,16,0,14.5,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 17.5 -10 1 0 0 0 0 1 0 1 0 4-4ndis.dat
  [1,16,0,17.5,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 20.5 -10 1 0 0 0 0 1 0 1 0 4-4ndis.dat
  [1,16,0,20.5,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 23.5 -10 1 0 0 0 0 1 0 1 0 4-4ndis.dat
  [1,16,0,23.5,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 26.5 -10 1 0 0 0 0 1 0 1 0 4-4ndis.dat
  [1,16,0,26.5,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4ndis(realsolid)],
...
module ldraw_lib__973pa1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973pa1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
