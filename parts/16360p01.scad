...
use <973.scad>
$fa=1; $fs=0.2;
function ldraw_lib__16360p01(realsolid=false) = [
...
// 1 16 -15.552 9 0 0.985 -0.17 0 0.17 0.985 0 0 0 1 16000p01.dat
  [1,16,-15.552,9,0,0.985,-0.17,0,0.17,0.985,0,0,0,1, ldraw_lib__16000p01(realsolid)],
// 1 16 15.552 9 0 0.985 0.17 0 -0.17 0.985 0 0 0 1 16001p01.dat
  [1,16,15.552,9,0,0.985,0.17,0,-0.17,0.985,0,0,0,1, ldraw_lib__16001p01(realsolid)],
...
module ldraw_lib__16360p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__16360p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
