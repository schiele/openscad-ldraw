...
use <4518a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4518(realsolid=false) = [
// 0 ~Moved to 4518a
// 0 Name: 4518.dat
// 0 Author: [PTadmin]
...
// 1 16 0 4 20 1 0 0 0 1 0 0 0 1 4518a.dat
  [1,16,0,4,20,1,0,0,0,1,0,0,0,1, ldraw_lib__4518a(realsolid)],
];
module ldraw_lib__4518(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4518(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
