...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30477(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30477s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30477s01(realsolid)],
...
// 1 16 0 288 -300 -1 0 0 0 1 0 0 0 -1 s\30402s01.dat
  [1,16,0,288,-300,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__30402s01(realsolid)],
// 1 16 -150 288 -310 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-150,288,-310,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -150 288 -290 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-150,288,-290,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 150 288 -310 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,150,288,-310,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 150 288 -290 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,150,288,-290,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
...
module ldraw_lib__30477(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30477(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
