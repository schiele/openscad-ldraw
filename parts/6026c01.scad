...
use <6028.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6026c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6026.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6026(realsolid)],
// 1 16 0 14 -40 1 0 0 0 0.999048 0.0436194 0 -0.0436194 0.999048 6027.dat
  [1,16,0,14,-40,1,0,0,0,0.999048,0.0436194,0,-0.0436194,0.999048, ldraw_lib__6027(realsolid)],
// 1 16 0 5 55 1 0 0 0 1 0 0 0 1 6028.dat
  [1,16,0,5,55,1,0,0,0,1,0,0,0,1, ldraw_lib__6028(realsolid)],
// 0
];
module ldraw_lib__6026c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6026c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
