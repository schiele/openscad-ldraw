...
$fa=1; $fs=0.2;
function ldraw_lib__2694(realsolid=false) = [
...
// 1 16 -90 68 0 0 0 -1 0 -1 0 1 0 0 stug3-1x2.dat
  [1,16,-90,68,0,0,0,-1,0,-1,0,1,0,0, ldraw_lib__stug3_1x2(realsolid)],
...
// 1 16 0 68 30 0 0 -80 4 0 0 0 -40 0 box3u2p.dat
  [1,16,0,68,30,0,0,-80,4,0,0,0,-40,0, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 0 70 26 0 0 -84 2 0 0 0 -40 0 box3u2p.dat
  [1,16,0,70,26,0,0,-84,2,0,0,0,-40,0, ldraw_lib__box3u2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 90 70 3 0 0 6 2 0 0 0 23 0 box2-7.dat
  [1,16,90,70,3,0,0,6,2,0,0,0,23,0, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -90 70 3 0 0 -6 -2 0 0 0 23 0 box2-7.dat
  [1,16,-90,70,3,0,0,-6,-2,0,0,0,23,0, ldraw_lib__box2_7(realsolid)],
...
// 1 16 90 4 20 -10 0 0 0 -4 0 0 0 10 1-4cylo.dat
  [1,16,90,4,20,-10,0,0,0,-4,0,0,0,10, ldraw_lib__1_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 2 20 0 0 -80 2 0 0 0 -10 0 box3u4a.dat
  [1,16,0,2,20,0,0,-80,2,0,0,0,-10,0, ldraw_lib__box3u4a(realsolid)],
// 1 16 -90 4 20 10 0 0 0 -4 0 0 0 10 1-4cylo.dat
  [1,16,-90,4,20,10,0,0,0,-4,0,0,0,10, ldraw_lib__1_4cylo(realsolid)],
...
// 1 16 90 4 20 -10 0 0 0 -1 0 0 0 10 1-4chrd.dat
  [1,16,90,4,20,-10,0,0,0,-1,0,0,0,10, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -90 4 20 10 0 0 0 -1 0 0 0 10 1-4chrd.dat
  [1,16,-90,4,20,10,0,0,0,-1,0,0,0,10, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 90 0 20 -10 0 0 0 1 0 0 0 10 1-4chrd.dat
  [1,16,90,0,20,-10,0,0,0,1,0,0,0,10, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -90 0 20 10 0 0 0 1 0 0 0 10 1-4chrd.dat
  [1,16,-90,0,20,10,0,0,0,1,0,0,0,10, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 90 0 20 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,90,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
...
module ldraw_lib__2694(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2694(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
