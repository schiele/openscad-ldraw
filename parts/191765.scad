...
// 1 383 -52 0 52 0 0 -8 0 1 0 8 0 0 1-4disc.dat
  [1,383,-52,0,52,0,0,-8,0,1,0,8,0,0, ldraw_lib__1_4disc()],
// 1 383 52 0 52 8 0 0 0 1 0 0 0 8 1-4disc.dat
  [1,383,52,0,52,8,0,0,0,1,0,0,0,8, ldraw_lib__1_4disc()],
// 1 383 52 0 -52 0 0 8 0 1 0 -8 0 0 1-4disc.dat
  [1,383,52,0,-52,0,0,8,0,1,0,-8,0,0, ldraw_lib__1_4disc()],
// 1 383 -52 0 -52 -8 0 0 0 1 0 0 0 -8 1-4disc.dat
  [1,383,-52,0,-52,-8,0,0,0,1,0,0,0,-8, ldraw_lib__1_4disc()],
...
module ldraw_lib__191765(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__191765(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
