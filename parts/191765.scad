...
use <../p/1-4disc.scad>
$fa=1; $fs=0.2;
function ldraw_lib__191765(realsolid=false) = [
...
// 0 !HISTORY 2020-07-08 [PTadmin] Renamed from u9252p01
// 0 !HISTORY 2020-09-05 [PTadmin] Official Update 2020-02
// 
// 
// 1 383 -52 0 52 0 0 -8 0 1 0 8 0 0 1-4disc.dat
  [1,383,-52,0,52,0,0,-8,0,1,0,8,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 383 52 0 52 8 0 0 0 1 0 0 0 8 1-4disc.dat
  [1,383,52,0,52,8,0,0,0,1,0,0,0,8, ldraw_lib__1_4disc(realsolid)],
// 1 383 52 0 -52 0 0 8 0 1 0 -8 0 0 1-4disc.dat
  [1,383,52,0,-52,0,0,8,0,1,0,-8,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 383 -52 0 -52 -8 0 0 0 1 0 0 0 -8 1-4disc.dat
  [1,383,-52,0,-52,-8,0,0,0,1,0,0,0,-8, ldraw_lib__1_4disc(realsolid)],
// 4 383 -52 0 -52 52 0 -52 52 0 52 -52 0 52
  [4,383,-52,0,-52,52,0,-52,52,0,52,-52,0,52],
// 4 383 -52 0 52 52 0 52 52 0 60 -52 0 60
  [4,383,-52,0,52,52,0,52,52,0,60,-52,0,60],
// 4 383 -52 0 -60 52 0 -60 52 0 -52 -52 0 -52
  [4,383,-52,0,-60,52,0,-60,52,0,-52,-52,0,-52],
// 4 383 -52 0 -52 -52 0 52 -60 0 52 -60 0 -52
  [4,383,-52,0,-52,-52,0,52,-60,0,52,-60,0,-52],
// 4 383 60 0 -52 60 0 52 52 0 52 52 0 -52
  [4,383,60,0,-52,60,0,52,52,0,52,52,0,-52],
// 
...
module ldraw_lib__191765(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__191765(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__191765(line=0.2);