...
use <s/87082s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__44874(realsolid=false) = [
...
// 1 16 10 0 0 0 -1 0 -1 0 0 0 0 -1 confric11.dat
  [1,16,10,0,0,0,-1,0,-1,0,0,0,0,-1, ldraw_lib__confric11(realsolid)],
// 1 16 -10 0 0 0 1 0 -1 0 0 0 0 1 confric11.dat
  [1,16,-10,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__confric11(realsolid)],
...
// 1 16 10 0 .6 0 -1 0 2.4 0 -2.4 2.4 0 2.4 1-4edge.dat
  [1,16,10,0,.6,0,-1,0,2.4,0,-2.4,2.4,0,2.4, ldraw_lib__1_4edge(realsolid)],
// 1 16 10 0 -.6 0 -1 0 -2.4 0 2.4 -2.4 0 -2.4 1-4edge.dat
  [1,16,10,0,-.6,0,-1,0,-2.4,0,2.4,-2.4,0,-2.4, ldraw_lib__1_4edge(realsolid)],
...
module ldraw_lib__44874(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__44874(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
