...
$fa=1; $fs=0.2;
function ldraw_lib__u9038(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2841s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2841s02(realsolid)],
// 1 16 -180 0 60 -1 0 0 0 1 0 0 0 -1 stug2-2x2.dat
  [1,16,-180,0,60,-1,0,0,0,1,0,0,0,-1, ldraw_lib__stug2_2x2(realsolid)],
// 1 16 -180 0 20 -1 0 0 0 1 0 0 0 -1 stug2-2x2.dat
  [1,16,-180,0,20,-1,0,0,0,1,0,0,0,-1, ldraw_lib__stug2_2x2(realsolid)],
// 1 16 -180 2 0 -13 0 0 0 0 2 0 1 0 rect.dat
  [1,16,-180,2,0,-13,0,0,0,0,2,0,1,0, ldraw_lib__rect(realsolid)],
...
module ldraw_lib__u9038(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9038(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
