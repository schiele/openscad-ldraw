...
use <s/11568s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__11568(realsolid=false) = [
// 0 Animal Squirrel
// 0 Name: 11568.dat
...
// 1 16 0 -30.2 15 2 0 0 0 -13.3 -0.3 0 0 2 4-4cylc.dat
  [1,16,0,-30.2,15,2,0,0,0,-13.3,-0.3,0,0,2, ldraw_lib__4_4cylc(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\11568s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__11568s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\11568s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__11568s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\11568s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__11568s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\11568s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__11568s02(realsolid)],
];
module ldraw_lib__11568(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11568(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
