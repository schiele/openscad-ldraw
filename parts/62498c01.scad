...
// 1 0 0 14.792 7 0 0 1 -1 0 0 0 4 0 u9028.dat
  [1,0,0,14.792,7,0,0,1,-1,0,0,0,4,0, ldraw_lib__u9028()],
...
// 1 0 0 20 14.208 0 0 1 0 -2 0 -1 0 0 u9028.dat
  [1,0,0,20,14.208,0,0,1,0,-2,0,-1,0,0, ldraw_lib__u9028()],
// 1 0 -1.237 20 14.208 0 0 1.75 0 -1 0 -1.75 0 0 4-4disc.dat
  [1,0,-1.237,20,14.208,0,0,1.75,0,-1,0,-1.75,0,0, ldraw_lib__4_4disc()],
// 1 0 1.237 20 14.208 0 0 1.75 0 -4 0 -1.75 0 0 4-4disc.dat
  [1,0,1.237,20,14.208,0,0,1.75,0,-4,0,-1.75,0,0, ldraw_lib__4_4disc()],
...
// 1 0 1.237 18 11 0 -3.208 0 0 0 -3.208 3.208 0 0 t04q5455.dat
  [1,0,1.237,18,11,0,-3.208,0,0,0,-3.208,3.208,0,0, ldraw_lib__t04q5455()],
// 1 0 -1.237 18 11 0 -3.208 0 0 0 -3.208 3.208 0 0 t04q5455.dat
  [1,0,-1.237,18,11,0,-3.208,0,0,0,-3.208,3.208,0,0, ldraw_lib__t04q5455()],
// 1 0 0 18 11 0 1 0 0 0 -4.45 4.45 0 0 1-4edge.dat
  [1,0,0,18,11,0,1,0,0,0,-4.45,4.45,0,0, ldraw_lib__1_4edge()],
// 1 0 0 18 11 0 1 0 0 0 -1.95 1.95 0 0 1-4edge.dat
  [1,0,0,18,11,0,1,0,0,0,-1.95,1.95,0,0, ldraw_lib__1_4edge()],
];
module ldraw_lib__62498c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__62498c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
