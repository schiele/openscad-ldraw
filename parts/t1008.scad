...
// 1 0 0 -1 0 5 0 0 0 1 0 0 0 5 4-4cylc.dat
  [1,0,0,-1,0,5,0,0,0,1,0,0,0,5, ldraw_lib__4_4cylc()],
// 1 0 0 0 0 5 0 0 0 -1 0 0 0 5 4-4disc.dat
  [1,0,0,0,0,5,0,0,0,-1,0,0,0,5, ldraw_lib__4_4disc()],
// 1 16 0 -1 0 1.5 0 0 0 -2.2 0 0 0 2 box5.dat
  [1,16,0,-1,0,1.5,0,0,0,-2.2,0,0,0,2, ldraw_lib__box5()],
// 1 494 3 0 0 1.5 0 0 0 .6 0 0 0 2 box5.dat
  [1,494,3,0,0,1.5,0,0,0,.6,0,0,0,2, ldraw_lib__box5()],
// 1 494 -3 0 0 1.5 0 0 0 .6 0 0 0 2 box5.dat
  [1,494,-3,0,0,1.5,0,0,0,.6,0,0,0,2, ldraw_lib__box5()],
// 1 4 -2.5 .6 0 -.4 0 0 0 0 .4 0 -.4 0 8\r04q1000.dat
  [1,4,-2.5,.6,0,-.4,0,0,0,0,.4,0,-.4,0, ldraw_lib__8__r04q1000()],
// 1 4 -2.9 .6 0 -.4 0 0 0 1 0 0 0 .4 8\4-4edge.dat
  [1,4,-2.9,.6,0,-.4,0,0,0,1,0,0,0,.4, ldraw_lib__8__4_4edge()],
// 1 4 -.4 1 0 0 .4 0 0 0 .4 -.4 0 0 8\4-8sphe.dat
  [1,4,-.4,1,0,0,.4,0,0,0,.4,-.4,0,0, ldraw_lib__8__4_8sphe()],
// 1 4 -.4 1 0 0 -2.1 0 0 0 .4 -.4 0 0 8\4-4cyli.dat
  [1,4,-.4,1,0,0,-2.1,0,0,0,.4,-.4,0,0, ldraw_lib__8__4_4cyli()],
// 1 0 2.5 .6 0 .4 0 0 0 0 .4 0 -.4 0 8\r04q1000.dat
  [1,0,2.5,.6,0,.4,0,0,0,0,.4,0,-.4,0, ldraw_lib__8__r04q1000()],
// 1 0 2.9 .6 0 .4 0 0 0 1 0 0 0 .4 8\4-4edge.dat
  [1,0,2.9,.6,0,.4,0,0,0,1,0,0,0,.4, ldraw_lib__8__4_4edge()],
// 1 0 .4 1 0 0 -.4 0 0 0 .4 -.4 0 0 8\4-8sphe.dat
  [1,0,.4,1,0,0,-.4,0,0,0,.4,-.4,0,0, ldraw_lib__8__4_8sphe()],
// 1 0 .4 1 0 0 2.1 0 0 0 .4 -.4 0 0 8\4-4cyli.dat
  [1,0,.4,1,0,0,2.1,0,0,0,.4,-.4,0,0, ldraw_lib__8__4_4cyli()],
];
module ldraw_lib__t1008(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1008(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
