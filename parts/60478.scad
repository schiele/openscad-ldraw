...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__60478(realsolid=false) = [
...
// 1 16 30 2 10 0 0 6 6 0 0 0 1 0 2-4edge.dat
  [1,16,30,2,10,0,0,6,6,0,0,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 30 2 10 0 0 -6 -6 0 0 0 1 0 3-16edge.dat
  [1,16,30,2,10,0,0,-6,-6,0,0,0,1,0, ldraw_lib__3_16edge(realsolid)],
// 2 24 24.456 -0.298 10 24.397 0 10
  [2,24,24.456,-0.298,10,24.397,0,10],
// 2 24 20 8 4 30 8 4
  [2,24,20,8,4,30,8,4],
// 1 16 30 2 4 0 0 6 6 0 0 0 1 0 2-4edge.dat
  [1,16,30,2,4,0,0,6,6,0,0,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 30 2 4 0 0 -6 -6 0 0 0 1 0 3-16edge.dat
  [1,16,30,2,4,0,0,-6,-6,0,0,0,1,0, ldraw_lib__3_16edge(realsolid)],
...
// 1 16 30 2 4 0 0 -4 4 0 0 0 1 0 4-4edge.dat
  [1,16,30,2,4,0,0,-4,4,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 30 2 -4 0 0 -4 4 0 0 0 1 0 4-4edge.dat
  [1,16,30,2,-4,0,0,-4,4,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 20 4 0 0 -1 0 4 0 0 0 0 -4 rect.dat
  [1,16,20,4,0,0,-1,0,4,0,0,0,0,-4, ldraw_lib__rect(realsolid)],
// 1 16 -20 4 0 0 1 0 4 0 0 0 0 10 rect.dat
  [1,16,-20,4,0,0,1,0,4,0,0,0,0,10, ldraw_lib__rect(realsolid)],
// 4 16 20 0 10 -20 0 10 -20 0 -10 20 0 -10
  [4,16,20,0,10,-20,0,10,-20,0,-10,20,0,-10],
// 1 16 30 2 10 0 0 6 6 0 0 0 -1 0 4-4disc.dat
  [1,16,30,2,10,0,0,6,6,0,0,0,-1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 30 2 -10 0 0 -6 6 0 0 0 1 0 4-4disc.dat
  [1,16,30,2,-10,0,0,-6,6,0,0,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 30 2 -10 0 0 -6 6 0 0 0 1 0 1-4ndis.dat
  [1,16,30,2,-10,0,0,-6,6,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 30 2 -4 0 0 -6 6 0 0 0 -1 0 1-4ndis.dat
  [1,16,30,2,-4,0,0,-6,6,0,0,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 30 2 4 0 0 -6 6 0 0 0 1 0 1-4ndis.dat
  [1,16,30,2,4,0,0,-6,6,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 30 2 10 0 0 -6 6 0 0 0 -1 0 1-4ndis.dat
  [1,16,30,2,10,0,0,-6,6,0,0,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 30 2 4 0 0 -2 2 0 0 0 1 0 4-4ring2.dat
  [1,16,30,2,4,0,0,-2,2,0,0,0,1,0, ldraw_lib__4_4ring2(realsolid)],
// 1 16 30 2 -4 0 0 2 2 0 0 0 -1 0 4-4ring2.dat
  [1,16,30,2,-4,0,0,2,2,0,0,0,-1,0, ldraw_lib__4_4ring2(realsolid)],
...
// 1 16 30 2 10 0 0 6 6 0 0 0 -6 0 2-4cyli.dat
  [1,16,30,2,10,0,0,6,6,0,0,0,-6,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 30 2 10 0 0 -6 -6 0 0 0 -6 0 3-16cyli.dat
  [1,16,30,2,10,0,0,-6,-6,0,0,0,-6,0, ldraw_lib__3_16cyli(realsolid)],
...
// 1 16 30 2 -4 0 0 -6 -6 0 0 0 -6 0 3-16cyli.dat
  [1,16,30,2,-4,0,0,-6,-6,0,0,0,-6,0, ldraw_lib__3_16cyli(realsolid)],
...
// 1 16 30 2 4 0 0 -4 4 0 0 0 -8 0 4-4cyli.dat
  [1,16,30,2,4,0,0,-4,4,0,0,0,-8,0, ldraw_lib__4_4cyli(realsolid)],
...
module ldraw_lib__60478(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__60478(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
