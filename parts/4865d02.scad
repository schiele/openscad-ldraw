...
use <821430a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4865d02(realsolid=false) = [
...
// 1 16 0 12 10 1 0 0 0 0 1 0 -1 0 821430a.dat
  [1,16,0,12,10,1,0,0,0,0,1,0,-1,0, ldraw_lib__821430a(realsolid)],
];
module ldraw_lib__4865d02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4865d02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
