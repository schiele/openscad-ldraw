...
use <../p/stud2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__43888(realsolid=false) = [
...
// 1 16 0 120 0 10 0 0 0 24 0 0 0 10 box4.dat
  [1,16,0,120,0,10,0,0,0,24,0,0,0,10, ldraw_lib__box4(realsolid)],
// 1 16 0 120 0 10 0 0 0 1 0 0 0 10 4-4ndis.dat
  [1,16,0,120,0,10,0,0,0,1,0,0,0,10, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 120 0 10 0 0 0 1 0 0 0 10 4-4edge.dat
  [1,16,0,120,0,10,0,0,0,1,0,0,0,10, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 124 0 6 0 0 0 20 0 0 0 6 box4.dat
  [1,16,0,124,0,6,0,0,0,20,0,0,0,6, ldraw_lib__box4(realsolid)],
// 1 16 0 124 0 6 0 0 0 -1 0 0 0 -6 4-4ndis.dat
  [1,16,0,124,0,6,0,0,0,-1,0,0,0,-6, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 124 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,124,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 0 6 0 0 0 120 0 0 0 6 4-4cyli.dat
  [1,16,0,4,0,6,0,0,0,120,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 0 0 10 0 0 0 120 0 0 0 10 4-4cyli.dat
  [1,16,0,0,0,10,0,0,0,120,0,0,0,10, ldraw_lib__4_4cyli(realsolid)],
...
module ldraw_lib__43888(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__43888(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__43888(line=0.2);