...
use <2870.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2869c02(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2869c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2869c01(realsolid)],
// 1 14 120 58.75 -145.12129 1 0 0 0 0.866026 -0.5 0 0.5 0.866026 2870.dat
  [1,14,120,58.75,-145.12129,1,0,0,0,0.866026,-0.5,0,0.5,0.866026, ldraw_lib__2870(realsolid)],
];
module ldraw_lib__2869c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2869c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
