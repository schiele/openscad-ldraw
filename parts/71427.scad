...
use <u9346c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__71427(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 u9346c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9346c01(realsolid)],
// 1 0 0 42 -40 1 0 0 0 1 0 0 0 1 u9345.dat
  [1,0,0,42,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__u9345(realsolid)],
];
module ldraw_lib__71427(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__71427(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
