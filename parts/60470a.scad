...
// 1 16 -10 0 -20 1 0 0 0 1 0 0 0 1 clip3.dat
  [1,16,-10,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__clip3()],
// 1 16 10 0 -20 1 0 0 0 1 0 0 0 1 clip3.dat
  [1,16,10,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__clip3()],
...
module ldraw_lib__60470a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__60470a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
