...
$fa=1; $fs=0.2;
function ldraw_lib__6142622i(realsolid=false) = [
...
// 1 16 -13.8789 0 0 0 0 -1 0 1 0 1 0 0 s\6142622is01.dat
  [1,16,-13.8789,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__6142622is01(realsolid)],
// 1 16 -13.8547 0 0 0 0 -1 0 1 0 1 0 0 s\6142622is02.dat
  [1,16,-13.8547,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__6142622is02(realsolid)],
// 1 16 .7172 0 0 0 0 -1 0 1 0 1 0 0 s\6142622is03.dat
  [1,16,.7172,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__6142622is03(realsolid)],
// 1 16 .7428 0 0 0 0 -1 0 1 0 1 0 0 s\6142622is04.dat
  [1,16,.7428,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__6142622is04(realsolid)],
// 1 16 14.6522 0 0 0 0 -1 0 1 0 1 0 0 s\6142622is05.dat
  [1,16,14.6522,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__6142622is05(realsolid)],
// 1 16 14.681 0 0 0 0 -1 0 1 0 1 0 0 s\6142622is06.dat
  [1,16,14.681,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__6142622is06(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\6142622is07.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__6142622is07(realsolid)],
];
module ldraw_lib__6142622i(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6142622i(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
