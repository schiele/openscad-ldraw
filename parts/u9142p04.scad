...
use <s/u9142s09.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9142p04(realsolid=false) = [
// 0 ~Figure Fabuland Bulldog Head  4
// 0 Name: u9142p04.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9142s04.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9142s04(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9142s04.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9142s04(realsolid)],
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9142s05.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9142s05(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9142s09.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9142s09(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9142s08.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9142s08(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__u9142p04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9142p04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9142p04(line=0.2);