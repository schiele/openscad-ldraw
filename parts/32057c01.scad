...
use <32076.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32057c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 32057.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32057(realsolid)],
// 1 256 0 0 0 1 0 0 0 1 0 0 0 1 32076.dat
  [1,256,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32076(realsolid)],
];
module ldraw_lib__32057c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32057c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
