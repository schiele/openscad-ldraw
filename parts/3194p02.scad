...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3194p02(realsolid=false) = [
...
// 1 16 0 0 0 0 0 -10 0 96 0 -10 0 0 1-4cyli.dat
  [1,16,0,0,0,0,0,-10,0,96,0,-10,0,0, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 -10 0 0 -1 0 0 0 1 0 0 0 1 s\3195p02s01.dat
  [1,16,-10,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3195p02s01(realsolid)],
// 1 16 -10 0 68 -1 0 0 0 1 0 0 0 -1 s\3195p02s02.dat
  [1,16,-10,0,68,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3195p02s02(realsolid)],
];
module ldraw_lib__3194p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3194p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
