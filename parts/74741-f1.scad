...
use <u9409-f1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__74741_f1(realsolid=false) = [
...
// 1 494 0 40 0 -1 0 0 0 1 0 0 0 1 u9409-f1.dat
  [1,494,0,40,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__u9409_f1(realsolid)],
];
module ldraw_lib__74741_f1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__74741_f1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
