...
// 1 31 0 0 0 1 0 0 0 1 0 0 0 1 s\92244s03.dat
  [1,31,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92244s03()],
// 1 31 0 0 0 1 0 0 0 1 0 0 0 1 s\92244s04.dat
  [1,31,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92244s04()],
...
module ldraw_lib__92244p10(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92244p10(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
