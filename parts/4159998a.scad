...
use <s/4865p01c.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4159998a(realsolid=false) = [
...
// 1 16 0 -0.25 0 16 0 0 0 0.25 0 0 0 28 box5-12.dat
  [1,16,0,-0.25,0,16,0,0,0,0.25,0,0,0,28, ldraw_lib__box5_12(realsolid)],
// 
// 1 0 -13 -0.25 22.5 2 0 0 0 1 0 0 0 -2.4 1-4disc.dat
  [1,0,-13,-0.25,22.5,2,0,0,0,1,0,0,0,-2.4, ldraw_lib__1_4disc(realsolid)],
// 1 80 -13 -0.25 22.5 1 0 0 0 1 0 0 0 -1.2 1-4ring2.dat
  [1,80,-13,-0.25,22.5,1,0,0,0,1,0,0,0,-1.2, ldraw_lib__1_4ring2(realsolid)],
// 1 0 -13 -0.25 22.5 3 0 0 0 1 0 0 0 -3.6 1-4ndis.dat
  [1,0,-13,-0.25,22.5,3,0,0,0,1,0,0,0,-3.6, ldraw_lib__1_4ndis(realsolid)],
// 1 0 13 -0.25 22.5 -2 0 0 0 1 0 0 0 -2.4 1-4disc.dat
  [1,0,13,-0.25,22.5,-2,0,0,0,1,0,0,0,-2.4, ldraw_lib__1_4disc(realsolid)],
// 1 80 13 -0.25 22.5 -1 0 0 0 1 0 0 0 -1.2 1-4ring2.dat
  [1,80,13,-0.25,22.5,-1,0,0,0,1,0,0,0,-1.2, ldraw_lib__1_4ring2(realsolid)],
...
// 1 0 -13 -0.25 -24.3 2 0 0 0 1 0 0 0 2.4 1-4disc.dat
  [1,0,-13,-0.25,-24.3,2,0,0,0,1,0,0,0,2.4, ldraw_lib__1_4disc(realsolid)],
// 1 80 -13 -0.25 -24.3 1 0 0 0 1 0 0 0 1.2 1-4ring2.dat
  [1,80,-13,-0.25,-24.3,1,0,0,0,1,0,0,0,1.2, ldraw_lib__1_4ring2(realsolid)],
// 1 0 -13 -0.25 -24.3 3 0 0 0 1 0 0 0 3.6 1-4ndis.dat
  [1,0,-13,-0.25,-24.3,3,0,0,0,1,0,0,0,3.6, ldraw_lib__1_4ndis(realsolid)],
// 1 0 13 -0.25 -24.3 -2 0 0 0 1 0 0 0 2.4 1-4disc.dat
  [1,0,13,-0.25,-24.3,-2,0,0,0,1,0,0,0,2.4, ldraw_lib__1_4disc(realsolid)],
// 1 80 13 -0.25 -24.3 -1 0 0 0 1 0 0 0 1.2 1-4ring2.dat
  [1,80,13,-0.25,-24.3,-1,0,0,0,1,0,0,0,1.2, ldraw_lib__1_4ring2(realsolid)],
...
// 1 0 0 -0.25 0 1.2 0 0 0 0 1 0 1.2 0 s\4865p01b.dat
  [1,0,0,-0.25,0,1.2,0,0,0,0,1,0,1.2,0, ldraw_lib__s__4865p01b(realsolid)],
// 1 80 0 -0.25 0 1.2 0 0 0 0 1 0 1.2 0 s\4865p01c.dat
  [1,80,0,-0.25,0,1.2,0,0,0,0,1,0,1.2,0, ldraw_lib__s__4865p01c(realsolid)],
// 
...
module ldraw_lib__4159998a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4159998a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
