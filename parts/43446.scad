...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\43446s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__43446s01()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\43446s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__43446s01()],
// 1 8 70 -48 0 0 0 -1 0 1 0 1 0 0 45907.dat
  [1,8,70,-48,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__45907()],
// 1 4 130 -40 0 0 0 -1 0 1 0 1 0 0 45907.dat
  [1,4,130,-40,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__45907()],
// 0
];
module ldraw_lib__43446(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__43446(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
