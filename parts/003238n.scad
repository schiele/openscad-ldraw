...
use <s/3238s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__003238n(realsolid=false) = [
...
// 1 22 11 -0.25 -16 2 0 0 0 1 0 0 0 -2 1-4chrd.dat
  [1,22,11,-0.25,-16,2,0,0,0,1,0,0,0,-2, ldraw_lib__1_4chrd(realsolid)],
// 1 22 -11 -0.25 -16 -2 0 0 0 1 0 0 0 -2 1-4chrd.dat
  [1,22,-11,-0.25,-16,-2,0,0,0,1,0,0,0,-2, ldraw_lib__1_4chrd(realsolid)],
// 4 22 -11 -.25 -18 11 -.25 -18 13 -.25 -16 -13 -.25 -16
  [4,22,-11,-.25,-18,11,-.25,-18,13,-.25,-16,-13,-.25,-16],
// 1 7 0 -0.25 -4 0.06 0 0 0 1 0 0 0 0.06 s\003238s1.dat
  [1,7,0,-0.25,-4,0.06,0,0,0,1,0,0,0,0.06, ldraw_lib__s__003238s1(realsolid)],
// 1 22 0 -0.25 -4 0.06 0 0 0 1 0 0 0 0.06 s\003238s2.dat
  [1,22,0,-0.25,-4,0.06,0,0,0,1,0,0,0,0.06, ldraw_lib__s__003238s2(realsolid)],
// 1 7 0 -0.25 -4 -0.06 0 0 0 1 0 0 0 0.06 s\003238s1.dat
  [1,7,0,-0.25,-4,-0.06,0,0,0,1,0,0,0,0.06, ldraw_lib__s__003238s1(realsolid)],
// 1 22 0 -0.25 -4 -0.06 0 0 0 1 0 0 0 0.06 s\003238s2.dat
  [1,22,0,-0.25,-4,-0.06,0,0,0,1,0,0,0,0.06, ldraw_lib__s__003238s2(realsolid)],
...
module ldraw_lib__003238n(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__003238n(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
