...
function ldraw_lib__6148328u() = [
// 0 Sticker  0.8 x  4 with White Stripes and Black Air Vent on Red Background (Needs Work)
// 0 Name: 6148328u.dat
...
// 1 16 -20.9783 0 0 0 0 1 0 1 0 -1 0 0 s\6148328us03.dat
  [1,16,-20.9783,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__6148328us03()],
...
module ldraw_lib__6148328u(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6148328u(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6148328u(line=0.2);