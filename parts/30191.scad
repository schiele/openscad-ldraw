...
use <../p/4-4cyli.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30191(realsolid=false) = [
...
// 1 16 0 0 14 -1 0 0 0 -1 0 0 0 1 30191k03.dat
  [1,16,0,0,14,-1,0,0,0,-1,0,0,0,1, ldraw_lib__30191k03(realsolid)],
// 1 16 0 0 -14 1 0 0 0 -1 0 0 0 -1 30191k03.dat
  [1,16,0,0,-14,1,0,0,0,-1,0,0,0,-1, ldraw_lib__30191k03(realsolid)],
// 
// 1 16 -4 0 -14 1 0 0 0 -1 0 0 0 -1 30191k02.dat
  [1,16,-4,0,-14,1,0,0,0,-1,0,0,0,-1, ldraw_lib__30191k02(realsolid)],
// 1 16 4 0 -14 -1 0 0 0 1 0 0 0 -1 30191k02.dat
  [1,16,4,0,-14,-1,0,0,0,1,0,0,0,-1, ldraw_lib__30191k02(realsolid)],
// 1 16 4 0 14 -1 0 0 0 -1 0 0 0 1 30191k02.dat
  [1,16,4,0,14,-1,0,0,0,-1,0,0,0,1, ldraw_lib__30191k02(realsolid)],
...
// 1 16 -18 0 14 0 -72 0 -2.5 0 0 0 0 2.5 4-4cyli.dat
  [1,16,-18,0,14,0,-72,0,-2.5,0,0,0,0,2.5, ldraw_lib__4_4cyli(realsolid)],
// 1 16 18 0 14 0 72 0 2.5 0 0 0 0 2.5 4-4cyli.dat
  [1,16,18,0,14,0,72,0,2.5,0,0,0,0,2.5, ldraw_lib__4_4cyli(realsolid)],
// 1 16 18 0 -14 0 72 0 -2.5 0 0 0 0 -2.5 4-4cyli.dat
  [1,16,18,0,-14,0,72,0,-2.5,0,0,0,0,-2.5, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 -110 0 14 1 0 0 0 1 0 0 0 1 30191k01.dat
  [1,16,-110,0,14,1,0,0,0,1,0,0,0,1, ldraw_lib__30191k01(realsolid)],
// 1 16 110 0 14 -1 0 0 0 1 0 0 0 -1 30191k01.dat
  [1,16,110,0,14,-1,0,0,0,1,0,0,0,-1, ldraw_lib__30191k01(realsolid)],
// 1 16 -110 0 -14 1 0 0 0 1 0 0 0 1 30191k01.dat
  [1,16,-110,0,-14,1,0,0,0,1,0,0,0,1, ldraw_lib__30191k01(realsolid)],
...
module ldraw_lib__30191(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30191(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
