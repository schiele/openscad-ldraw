...
use <85984.scad>
$fa=1; $fs=0.2;
function ldraw_lib__85984dya(realsolid=false) = [
...
// 1 16 0 -9.8 -.3334 -1 0 0 0 .85749 .5145 0 .5145 -.85749 6141875l.dat
  [1,16,0,-9.8,-.3334,-1,0,0,0,.85749,.5145,0,.5145,-.85749, ldraw_lib__6141875l(realsolid)],
];
module ldraw_lib__85984dya(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__85984dya(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
