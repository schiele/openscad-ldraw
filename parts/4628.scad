...
use <../p/box4o8a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4628(realsolid=false) = [
// 0 Jack Handle
// 0 Name: 4628.dat
...
// 1 16 -4 0 6 0 0 -2.5 -2.5 0 0 0 -1 0 2-4disc.dat
  [1,16,-4,0,6,0,0,-2.5,-2.5,0,0,0,-1,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 -4 0 -6 0 0 -2.5 2.5 0 0 0 12 0 2-4cylc.dat
  [1,16,-4,0,-6,0,0,-2.5,2.5,0,0,0,12,0, ldraw_lib__2_4cylc(realsolid)],
// 1 16 4 0 6 0 0 2.5 2.5 0 0 0 -1 0 2-4disc.dat
  [1,16,4,0,6,0,0,2.5,2.5,0,0,0,-1,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 4 0 -6 0 0 2.5 2.5 0 0 0 12 0 2-4cylc.dat
  [1,16,4,0,-6,0,0,2.5,2.5,0,0,0,12,0, ldraw_lib__2_4cylc(realsolid)],
// 1 16 0 -2.5 0 4 0 0 0 -32 0 0 0 4 4-4cyli.dat
  [1,16,0,-2.5,0,4,0,0,0,-32,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -34.5 0 -4 0 0 0 0.707 4 0 0.707 -4 2-4edge.dat
  [1,16,0,-34.5,0,-4,0,0,0,0.707,4,0,0.707,-4, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -34.5 0 4 0 0 0 0.707 4 0 -0.707 4 2-4edge.dat
  [1,16,0,-34.5,0,4,0,0,0,0.707,4,0,-0.707,4, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -2.5 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,0,-2.5,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -34.5 -10 4 0 0 0 0 4 0 20 0 4-4cylc.dat
  [1,16,0,-34.5,-10,4,0,0,0,0,4,0,20,0, ldraw_lib__4_4cylc(realsolid)],
// 1 16 0 -34.5 10 -4 0 0 0 0 4 0 -1 0 4-4disc.dat
  [1,16,0,-34.5,10,-4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 -4 0 0 0 8 0 -2.5 0 0 0 0 6 box4o8a.dat
  [1,16,-4,0,0,0,8,0,-2.5,0,0,0,0,6, ldraw_lib__box4o8a(realsolid)],
// 0
];
module ldraw_lib__4628(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4628(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
