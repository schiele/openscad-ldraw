...
// 1 28 0 -.25 0 1 0 0 0 1 0 0 0 1 s\6021257as01.dat
  [1,28,0,-.25,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6021257as01()],
];
module ldraw_lib__6021257a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6021257a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
