...
use <s/44938s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__44938(realsolid=false) = [
...
// 1 16 0 -20 40 9 0 0 0 0.5 0 0 0 9 4-4cylo.dat
  [1,16,0,-20,40,9,0,0,0,0.5,0,0,0,9, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 -20 40 1 0 0 0 1 0 0 0 1 4-4ring8.dat
  [1,16,0,-20,40,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4ring8(realsolid)],
...
// 1 16 0 -18 40 6 0 0 0 16 0 0 0 6 4-4cyli.dat
  [1,16,0,-18,40,6,0,0,0,16,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 0 40 2 0 0 0 -1 0 0 0 2 4-4ring4.dat
  [1,16,0,0,40,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring4(realsolid)],
// 1 16 0 0 40 10 0 0 0 -15.864 0 0 0 10 4-4cylo.dat
  [1,16,0,0,40,10,0,0,0,-15.864,0,0,0,10, ldraw_lib__4_4cylo(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 1 axleho10.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__axleho10(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\44938s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__44938s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\44938s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__44938s01(realsolid)],
// 1 16 30.311 0 22.5 0.5 0 -0.866 0 1 0 0.866 0 0.5 s\44938s02.dat
  [1,16,30.311,0,22.5,0.5,0,-0.866,0,1,0,0.866,0,0.5, ldraw_lib__s__44938s02(realsolid)],
// 1 16 30.311 0 57.5 -0.5 0 -0.866 0 1 0 0.866 0 -0.5 s\44938s02.dat
  [1,16,30.311,0,57.5,-0.5,0,-0.866,0,1,0,0.866,0,-0.5, ldraw_lib__s__44938s02(realsolid)],
// 1 16 0 0 75 -1 0 0 0 1 0 0 0 -1 s\44938s02.dat
  [1,16,0,0,75,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__44938s02(realsolid)],
// 1 16 -30.311 0 57.5 -0.5 0 0.866 0 1 0 -0.866 0 -0.5 s\44938s02.dat
  [1,16,-30.311,0,57.5,-0.5,0,0.866,0,1,0,-0.866,0,-0.5, ldraw_lib__s__44938s02(realsolid)],
// 1 16 -30.311 0 22.5 0.5 0 0.866 0 1 0 -0.866 0 0.5 s\44938s02.dat
  [1,16,-30.311,0,22.5,0.5,0,0.866,0,1,0,-0.866,0,0.5, ldraw_lib__s__44938s02(realsolid)],
...
module ldraw_lib__44938(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__44938(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
