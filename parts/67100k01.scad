...
use <s/67100s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__67100k01(realsolid=false) = [
...
// 1 16 0 15 0 4 0 0 0 -30 0 0 0 4 4-4cylc.dat
  [1,16,0,15,0,4,0,0,0,-30,0,0,0,4, ldraw_lib__4_4cylc(realsolid)],
];
module ldraw_lib__67100k01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__67100k01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
