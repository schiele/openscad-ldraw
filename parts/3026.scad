...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3026(realsolid=false) = [
// 0 Plate  6 x 24
// 0 Name: 3026.dat
...
// 1 16 200 4 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,200,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 180 4 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,180,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 160 4 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,160,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 236 0 0 0 -4 0 0 0 56 box5.dat
  [1,16,0,8,0,236,0,0,0,-4,0,0,0,56, ldraw_lib__box5(realsolid)],
// 
// 4 16 240 8 60 236 8 56 -236 8 56 -240 8 60
  [4,16,240,8,60,236,8,56,-236,8,56,-240,8,60],
// 0 Next Line was 4 16 240 8 -60 236 8 -56 -236 8 -56 -240 8 -60
// 4 16 -240 8 -60 -236 8 -56 236 8 -56 240 8 -60
  [4,16,-240,8,-60,-236,8,-56,236,8,-56,240,8,-60],
// 0 Next Line was 4 16 240 8 60 236 8 56 236 8 -56 240 8 -60
// 4 16 240 8 -60 236 8 -56 236 8 56 240 8 60
...
// 4 16 -240 8 60 -236 8 56 -236 8 -56 -240 8 -60
  [4,16,-240,8,60,-236,8,56,-236,8,-56,-240,8,-60],
// 
// 1 16 0 8 0 240 0 0 0 -8 0 0 0 60 box5.dat
  [1,16,0,8,0,240,0,0,0,-8,0,0,0,60, ldraw_lib__box5(realsolid)],
// 
...
module ldraw_lib__3026(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3026(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3026(line=0.2);