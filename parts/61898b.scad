...
use <s/61898s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__61898b(realsolid=false) = [
...
// 1 16 -56 0 182 81 0 0 0 1 0 0 0 81 48\3-16chrd.dat
  [1,16,-56,0,182,81,0,0,0,1,0,0,0,81, ldraw_lib__48__3_16chrd(realsolid)],
// 1 16 -56 0 182 -81 0 0 0 1 0 0 0 81 48\5-16chrd.dat
  [1,16,-56,0,182,-81,0,0,0,1,0,0,0,81, ldraw_lib__48__5_16chrd(realsolid)],
...
// 1 16 -50.0013 0 -10 25 0 0 0 1 0 0 0 25 1-8ndis.dat
  [1,16,-50.0013,0,-10,25,0,0,0,1,0,0,0,25, ldraw_lib__1_8ndis(realsolid)],
// 1 16 -112 0 122.7087 -25 0 0 0 1 0 0 0 -25 1-8chrd.dat
  [1,16,-112,0,122.7087,-25,0,0,0,1,0,0,0,-25, ldraw_lib__1_8chrd(realsolid)],
...
// 1 16 -56 0 182 81 0 0 0 1 0 0 0 81 48\3-16cylo.dat
  [1,16,-56,0,182,81,0,0,0,1,0,0,0,81, ldraw_lib__48__3_16cylo(realsolid)],
// 1 16 -56 0 182 -81 0 0 0 1 0 0 0 81 48\5-16cyli.dat
  [1,16,-56,0,182,-81,0,0,0,1,0,0,0,81, ldraw_lib__48__5_16cyli(realsolid)],
// 1 16 -56 0 182 -81 0 0 0 1 0 0 0 81 48\5-16edge.dat
  [1,16,-56,0,182,-81,0,0,0,1,0,0,0,81, ldraw_lib__48__5_16edge(realsolid)],
// 1 16 -56 1 182 -81 0 0 0 1 0 0 0 81 48\5-16edge.dat
  [1,16,-56,1,182,-81,0,0,0,1,0,0,0,81, ldraw_lib__48__5_16edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 -112 0 122.7087 -25 0 0 0 1 0 0 0 -25 1-8cylo.dat
  [1,16,-112,0,122.7087,-25,0,0,0,1,0,0,0,-25, ldraw_lib__1_8cylo(realsolid)],
// 1 16 56 0 -182 -81 0 0 0 1 0 0 0 -81 48\3-16cylo.dat
  [1,16,56,0,-182,-81,0,0,0,1,0,0,0,-81, ldraw_lib__48__3_16cylo(realsolid)],
// 1 16 56 0 -182 81 0 0 0 1 0 0 0 -81 48\5-16cyli.dat
  [1,16,56,0,-182,81,0,0,0,1,0,0,0,-81, ldraw_lib__48__5_16cyli(realsolid)],
...
// 1 16 81.00065 0.5 -56.35435 48.67685 -1 0 0 0 0.5 -48.67685 0 0 rect2p.dat
  [1,16,81.00065,0.5,-56.35435,48.67685,-1,0,0,0,0.5,-48.67685,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -25.00065 0.5 -96 -0.00065 1 0 0 0 0.5 86 0 0 rect2p.dat
  [1,16,-25.00065,0.5,-96,-0.00065,1,0,0,0,0.5,86,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 137 0.5 -152.3544 0 -1 0 0 0 0.5 -29.64565 0 0 rect2p.dat
  [1,16,137,0.5,-152.3544,0,-1,0,0,0,0.5,-29.64565,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -56 1 182 81 0 0 0 -1 0 0 0 81 48\3-16chrd.dat
  [1,16,-56,1,182,81,0,0,0,-1,0,0,0,81, ldraw_lib__48__3_16chrd(realsolid)],
// 1 16 -56 1 182 -81 0 0 0 -1 0 0 0 81 48\5-16chrd.dat
  [1,16,-56,1,182,-81,0,0,0,-1,0,0,0,81, ldraw_lib__48__5_16chrd(realsolid)],
...
// 1 16 -50.0013 1 -10 25 0 0 0 -1 0 0 0 25 1-8ndis.dat
  [1,16,-50.0013,1,-10,25,0,0,0,-1,0,0,0,25, ldraw_lib__1_8ndis(realsolid)],
// 1 16 -112 1 122.7087 -25 0 0 0 -1 0 0 0 -25 1-8chrd.dat
  [1,16,-112,1,122.7087,-25,0,0,0,-1,0,0,0,-25, ldraw_lib__1_8chrd(realsolid)],
...
module ldraw_lib__61898b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__61898b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
