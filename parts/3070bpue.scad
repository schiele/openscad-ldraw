...
use <s/3070bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3070bpue(realsolid=false) = [
...
// 1 80 0 0 0 1 0 0 0 1 0 0 0 1 s\3070baue.dat
  [1,80,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3070baue(realsolid)],
// 1 16 0 0 -2.4 -5.4 0 0 0 1 0 0 0 -5.1 2-4ndis.dat
  [1,16,0,0,-2.4,-5.4,0,0,0,1,0,0,0,-5.1, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 0 -2.4 -3.6 0 0 0 1 0 0 0 -3.4 2-4disc.dat
  [1,16,0,0,-2.4,-3.6,0,0,0,1,0,0,0,-3.4, ldraw_lib__2_4disc(realsolid)],
...
module ldraw_lib__3070bpue(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3070bpue(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
