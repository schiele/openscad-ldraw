...
use <../p/stug2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6026(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\6026s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6026s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\6026s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__6026s01(realsolid)],
// 
// 0 // studs
...
// 1 16 0 28 -20 1 0 0 0 -1 0 0 0 1 stud4a.dat
  [1,16,0,28,-20,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4a(realsolid)],
...
// 1 16 0 4 -20 8 0 0 0 24 0 0 0 8 4-4cyli.dat
  [1,16,0,4,-20,8,0,0,0,24,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 4 0 8 0 0 0 24 0 0 0 8 4-4cyli.dat
  [1,16,0,4,0,8,0,0,0,24,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 4 20 8 0 0 0 24 0 0 0 8 4-4cyli.dat
  [1,16,0,4,20,8,0,0,0,24,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 -20 6 0 0 0 24 0 0 0 6 4-4cyli.dat
  [1,16,0,4,-20,6,0,0,0,24,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 0 6 0 0 0 24 0 0 0 6 4-4cyli.dat
  [1,16,0,4,0,6,0,0,0,24,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 20 6 0 0 0 24 0 0 0 6 4-4cyli.dat
  [1,16,0,4,20,6,0,0,0,24,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 4 20 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,4,20,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 
// 0 // tail hinge - upper
// 1 16 0 5 55 3.5 0 0 0 -1 0 0 0 3.5 4-4ndis.dat
  [1,16,0,5,55,3.5,0,0,0,-1,0,0,0,3.5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 5 55 3.5 0 0 0 -1 0 0 0 3.5 4-4edge.dat
  [1,16,0,5,55,3.5,0,0,0,-1,0,0,0,3.5, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 5 55 3.5 0 0 0 -1.5 0 0 0 3.5 4-8sphe.dat
  [1,16,0,5,55,3.5,0,0,0,-1.5,0,0,0,3.5, ldraw_lib__4_8sphe(realsolid)],
// 
// 0 // tail hinge - lower
// 1 16 0 27 55 3.5 0 0 0 1 0 0 0 3.5 4-4ndis.dat
  [1,16,0,27,55,3.5,0,0,0,1,0,0,0,3.5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 27 55 3.5 0 0 0 1 0 0 0 3.5 4-4edge.dat
  [1,16,0,27,55,3.5,0,0,0,1,0,0,0,3.5, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 32 55 3.5 0 0 0 -1 0 0 0 3.5 4-4ndis.dat
  [1,16,0,32,55,3.5,0,0,0,-1,0,0,0,3.5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 32 55 3.5 0 0 0 -1 0 0 0 3.5 4-4edge.dat
  [1,16,0,32,55,3.5,0,0,0,-1,0,0,0,3.5, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 27 55 3.5 0 0 0 5 0 0 0 3.5 4-4cyli.dat
  [1,16,0,27,55,3.5,0,0,0,5,0,0,0,3.5, ldraw_lib__4_4cyli(realsolid)],
// 
// 0 // jaw hinge
// 1 16 11 14 -40 0 -1 0 -2 0 0 0 0 2 4-4ndis.dat
  [1,16,11,14,-40,0,-1,0,-2,0,0,0,0,2, ldraw_lib__4_4ndis(realsolid)],
// 1 16 11 14 -40 0 -1 0 -2 0 0 0 0 2 4-4edge.dat
  [1,16,11,14,-40,0,-1,0,-2,0,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 11 14 -40 0 -1 0 -2 0 0 0 0 2 4-8sphe.dat
  [1,16,11,14,-40,0,-1,0,-2,0,0,0,0,2, ldraw_lib__4_8sphe(realsolid)],
// 1 16 -11 14 -40 0 1 0 -2 0 0 0 0 2 4-4ndis.dat
  [1,16,-11,14,-40,0,1,0,-2,0,0,0,0,2, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -11 14 -40 0 1 0 -2 0 0 0 0 2 4-4edge.dat
  [1,16,-11,14,-40,0,1,0,-2,0,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
...
module ldraw_lib__6026(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6026(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
