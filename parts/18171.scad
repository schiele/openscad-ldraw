...
use <48496.scad>
$fa=1; $fs=0.2;
function ldraw_lib__18171(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 48496.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48496(realsolid)],
];
module ldraw_lib__18171(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__18171(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
