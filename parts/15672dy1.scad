...
use <6142275j.scad>
$fa=1; $fs=0.2;
function ldraw_lib__15672dy1(realsolid=false) = [
...
// 1 16 0 -6 -10 1 0 0 0 .707107 -.707107 0 .707107 .707107 6142275j.dat
  [1,16,0,-6,-10,1,0,0,0,.707107,-.707107,0,.707107,.707107, ldraw_lib__6142275j(realsolid)],
];
module ldraw_lib__15672dy1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__15672dy1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
