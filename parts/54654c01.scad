...
use <54703.scad>
use <u9288.scad>
function ldraw_lib__54654c01() = [
// 0 Plane Aft Section  8 x 16 x  7
// 0 Name: 54654c01.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 54701c04, Rebrickable 54701c04
// 
...
module ldraw_lib__54654c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__54654c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__54654c01(line=0.2);