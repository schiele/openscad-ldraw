...
use <32064a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32064(realsolid=false) = [
// 0 ~Moved to 32064a
// 0 Name: 32064.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 32064a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32064a(realsolid)],
];
module ldraw_lib__32064(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32064(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
