...
// 1 16 0 44 0 40 0 0 0 -44 0 0 0 -40 48\7-48cyli.dat
  [1,16,0,44,0,40,0,0,0,-44,0,0,0,-40, ldraw_lib__48__7_48cyli()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\24593p01s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__24593p01s01()],
// 1 16 0 44 0 -40 0 0 0 -44 0 0 0 -40 48\7-48cyli.dat
  [1,16,0,44,0,-40,0,0,0,-44,0,0,0,-40, ldraw_lib__48__7_48cyli()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\24593p01s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__24593p01s01()],
...
module ldraw_lib__24593p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__24593p01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
