...
use <u9102.scad>
use <u9103.scad>
function ldraw_lib__u595p01c09() = [
...
// 1 462 0 -67 4 1 0 0 0 1 0 0 0 1 u595p01c02.dat
  [1,462,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u595p01c02()],
...
module ldraw_lib__u595p01c09(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u595p01c09(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
