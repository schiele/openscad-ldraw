...
use <s/30372s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30372p79(realsolid=false) = [
...
// 1 7 0 0 0 1 0 0 0 1 0 0 0 1 s\30372p79s02.dat
  [1,7,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30372p79s02(realsolid)],
// 1 7 0 0 0 -1 0 0 0 1 0 0 0 1 s\30372p79s02.dat
  [1,7,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30372p79s02(realsolid)],
// 1 8 0 0 0 1 0 0 0 1 0 0 0 1 s\30372p79s03.dat
  [1,8,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30372p79s03(realsolid)],
// 1 8 0 0 0 -1 0 0 0 1 0 0 0 1 s\30372p79s03.dat
  [1,8,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30372p79s03(realsolid)],
];
module ldraw_lib__30372p79(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30372p79(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
