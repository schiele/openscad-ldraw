...
use <../p/stud2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__577a(realsolid=false) = [
...
// 1 16 0 12 0 4 0 0 0 20 0 0 0 4 4-4cylo.dat
  [1,16,0,12,0,4,0,0,0,20,0,0,0,4, ldraw_lib__4_4cylo(realsolid)],
// 
...
// 1 16 0 32 0 6 0 0 0 4 0 0 0 6 4-4edge.dat
  [1,16,0,32,0,6,0,0,0,4,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 
// 1 16 0 32 0 6 0 0 0 4 0 0 0 6 4-4cyli.dat
  [1,16,0,32,0,6,0,0,0,4,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 33 0 4 0 0 0 3 0 0 0 4 4-4cyli.dat
  [1,16,0,33,0,4,0,0,0,3,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 36 0 1 0 0 0 -1 0 0 0 1 stud2a.dat
  [1,16,0,36,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud2a(realsolid)],
// 1 16 0 33 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,0,33,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 33 0 4 0 0 0 -1 0 0 0 4 4-4disc.dat
  [1,16,0,33,0,4,0,0,0,-1,0,0,0,4, ldraw_lib__4_4disc(realsolid)],
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\577s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__577s01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\577s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__577s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\577s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__577s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\577s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__577s01(realsolid)],
...
module ldraw_lib__577a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__577a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
