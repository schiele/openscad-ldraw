...
use <s/3067s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3067ap14(realsolid=false) = [
...
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 s\3067ap13s01.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3067ap13s01(realsolid)],
// 1 321 0 0 0 1 0 0 0 1 0 0 0 1 s\3067ap13s02.dat
  [1,321,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3067ap13s02(realsolid)],
// 
];
module ldraw_lib__3067ap14(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3067ap14(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
