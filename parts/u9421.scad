...
use <../p/axlehol9.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9421(realsolid=false) = [
...
// 1 16 24 0 0 0 -1 0 0 0 1 1 0 0 axleend.dat
  [1,16,24,0,0,0,-1,0,0,0,1,1,0,0, ldraw_lib__axleend(realsolid)],
// 1 16 24 0 0 0 1 0 0 0 1 1 0 0 axlehol2.dat
  [1,16,24,0,0,0,1,0,0,0,1,1,0,0, ldraw_lib__axlehol2(realsolid)],
// 1 16 24 0 0 0 -1 0 0 0 1 1 0 0 axlehol9.dat
  [1,16,24,0,0,0,-1,0,0,0,1,1,0,0, ldraw_lib__axlehol9(realsolid)],
...
// 1 16 0 0 0 0 24 0 0 0 1 1 0 0 axlehol8.dat
  [1,16,0,0,0,0,24,0,0,0,1,1,0,0, ldraw_lib__axlehol8(realsolid)],
...
module ldraw_lib__u9421(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9421(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
