...
use <318.scad>
$fa=1; $fs=0.2;
function ldraw_lib__304c01(realsolid=false) = [
...
// 1 4 0 4 0 1 0 0 0 1 0 0 0 1 316.dat
  [1,4,0,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__316(realsolid)],
// 1 4 30 -19 0 0 0 1 0 1 0 1 0 0 318.dat
  [1,4,30,-19,0,0,0,1,0,1,0,1,0,0, ldraw_lib__318(realsolid)],
// 0 // Blade: White (15)
// 1 15 -95 -280.27 0 1 0 0 0 1 0 0 0 1 308.dat
  [1,15,-95,-280.27,0,1,0,0,0,1,0,0,0,1, ldraw_lib__308(realsolid)],
// 0 // Bar: Metal (494)
// 1 494 -80 -147 0 1 0 0 0 1 0 0 0 1 129.dat
  [1,494,-80,-147,0,1,0,0,0,1,0,0,0,1, ldraw_lib__129(realsolid)],
// 
];
module ldraw_lib__304c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__304c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__304c01(line=0.2);