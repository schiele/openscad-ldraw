...
$fa=1; $fs=0.2;
function ldraw_lib__3958(realsolid=false) = [
// 0 Plate  6 x  6
// 0 Name: 3958.dat
...
// 1 16 0 8 0 60 0 0 0 -8 0 0 0 60 box5.dat
  [1,16,0,8,0,60,0,0,0,-8,0,0,0,60, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__3958(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3958(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
