...
use <92697.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92693c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 92694.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__92694(realsolid)],
// 1 16 0 0 30 1 0 0 0 1 0 0 0 1 92697.dat
  [1,16,0,0,30,1,0,0,0,1,0,0,0,1, ldraw_lib__92697(realsolid)],
];
module ldraw_lib__92693c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92693c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
