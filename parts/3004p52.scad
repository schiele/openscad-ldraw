...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 3004pb010, Rebrickable 3004pr9965, Set 3067
// 
...
// 1 16 0 11.5 -10 10.5 0 0 0 0 -10.5 0 1 0 48\4-4ndis.dat
  [1,16,0,11.5,-10,10.5,0,0,0,0,-10.5,0,1,0, ldraw_lib__48__4_4ndis()],
// 1 16 0 11.5 -10 0.525 0 0 0 0 -0.525 0 1 0 s\3068bp53s01.dat
  [1,16,0,11.5,-10,0.525,0,0,0,0,-0.525,0,1,0, ldraw_lib__s__3068bp53s01()],
// 
...
module ldraw_lib__3004p52(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3004p52(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
