...
use <s/24633p02s04.scad>
use <s/24633s00.scad>
use <s/24633s02.scad>
function ldraw_lib__24633p02() = [
// 0 Minifig Head Duck with Bright Light Orange Bill, Eyelashes and Lavender Eye Shadow Pattern
// 0 Name: 24633p02.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 24633pb02, daisy, Disney, Rebrickable 24633pr0002
// 0 !KEYWORDS Set 10773, set 71040
// 
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\24633p01s03.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__24633p01s03()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\24633p02s04.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__24633p02s04()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\24633p02s04.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__24633p02s04()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\24633p01s05.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__24633p01s05()],
];
module ldraw_lib__24633p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__24633p02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__24633p02(line=0.2);