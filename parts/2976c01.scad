...
// 1 256 -34 38.5 0 0 -2 0 -1 0 0 0 0 1 993.dat
  [1,256,-34,38.5,0,0,-2,0,-1,0,0,0,0,1, ldraw_lib__993()],
// 1 256 -36 38.5 1.3858 0 1 0 -.574025 0 -1.385819 -1.385819 0 .574025 7-8chrd.dat
  [1,256,-36,38.5,1.3858,0,1,0,-.574025,0,-1.385819,-1.385819,0,.574025, ldraw_lib__7_8chrd()],
// 1 256 -36 38.5 -1.3858 0 1 0 .574025 0 1.385819 1.385819 0 -.574025 7-8chrd.dat
  [1,256,-36,38.5,-1.3858,0,1,0,.574025,0,1.385819,1.385819,0,-.574025, ldraw_lib__7_8chrd()],
// 1 0 -34 38 0 0 1 0 -2 0 0 0 0 4.5 rect.dat
  [1,0,-34,38,0,0,1,0,-2,0,0,0,0,4.5, ldraw_lib__rect()],
];
module ldraw_lib__2976c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2976c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
