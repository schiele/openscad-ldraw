...
use <../p/stug-8x8.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u1454p01(realsolid=false) = [
...
// 1 16 100 0 -60 0 0 1 0 1 0 -1 0 0 stug-8x8.dat
  [1,16,100,0,-60,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_8x8(realsolid)],
// 1 16 -150 0 -20 0 0 1 0 1 0 -1 0 0 stug-1x12.dat
  [1,16,-150,0,-20,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x12(realsolid)],
// 1 16 -170 0 -20 0 0 1 0 1 0 -1 0 0 stug-1x12.dat
  [1,16,-170,0,-20,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x12(realsolid)],
// 1 16 -190 0 -20 0 0 1 0 1 0 -1 0 0 stug-1x12.dat
  [1,16,-190,0,-20,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x12(realsolid)],
// 1 16 190 0 -20 0 0 1 0 1 0 -1 0 0 stug-1x12.dat
  [1,16,190,0,-20,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x12(realsolid)],
// 1 16 100 0 110 0 0 1 0 1 0 -1 0 0 stug-10x1.dat
  [1,16,100,0,110,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_10x1(realsolid)],
// 1 16 100 0 130 0 0 1 0 1 0 -1 0 0 stug-10x1.dat
  [1,16,100,0,130,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_10x1(realsolid)],
// 1 16 -100 0 110 0 0 1 0 1 0 -1 0 0 stug-10x1.dat
  [1,16,-100,0,110,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_10x1(realsolid)],
// 1 16 -100 0 130 0 0 1 0 1 0 -1 0 0 stug-10x1.dat
  [1,16,-100,0,130,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_10x1(realsolid)],
// 1 16 -100 0 -100 0 0 1 0 1 0 -1 0 0 stug-4x4.dat
  [1,16,-100,0,-100,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_4x4(realsolid)],
...
// 1 16 -20 0 -100 0 0 1 0 1 0 -1 0 0 stug-4x4.dat
  [1,16,-20,0,-100,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_4x4(realsolid)],
...
// 1 16 -60 0 20 0 0 1 0 1 0 -1 0 0 stug-6x6.dat
  [1,16,-60,0,20,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_6x6(realsolid)],
// 1 16 20 0 60 0 0 1 0 1 0 -1 0 0 stug-2x2.dat
  [1,16,20,0,60,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_2x2(realsolid)],
// 1 16 60 0 60 0 0 1 0 1 0 -1 0 0 stug-2x2.dat
  [1,16,60,0,60,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_2x2(realsolid)],
// 
// 1 16 -196 2 0 0 392 0 0 0 2 140 0 0 box4o8a.dat
  [1,16,-196,2,0,0,392,0,0,0,2,140,0,0, ldraw_lib__box4o8a(realsolid)],
// 
// 1 16 196 0 136 4 0 0 0 4 0 0 0 4 1-4cylo.dat
  [1,16,196,0,136,4,0,0,0,4,0,0,0,4, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -196 0 -136 -4 0 0 0 4 0 0 0 -4 1-4cylo.dat
  [1,16,-196,0,-136,-4,0,0,0,4,0,0,0,-4, ldraw_lib__1_4cylo(realsolid)],
// 1 16 196 0 -136 4 0 0 0 4 0 0 0 -4 1-4cylo.dat
  [1,16,196,0,-136,4,0,0,0,4,0,0,0,-4, ldraw_lib__1_4cylo(realsolid)],
...
// 1 16 -196 0 136 -4 0 0 0 1 0 0 0 4 1-4chrd.dat
  [1,16,-196,0,136,-4,0,0,0,1,0,0,0,4, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -196 4 -136 -4 0 0 0 -1 0 0 0 -4 1-4chrd.dat
  [1,16,-196,4,-136,-4,0,0,0,-1,0,0,0,-4, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -196 0 -136 -4 0 0 0 1 0 0 0 -4 1-4chrd.dat
  [1,16,-196,0,-136,-4,0,0,0,1,0,0,0,-4, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -196 4 136 -4 0 0 0 -1 0 0 0 4 1-4chrd.dat
  [1,16,-196,4,136,-4,0,0,0,-1,0,0,0,4, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 200 2 0 0 -1 0 0 0 2 -136 0 0 rect2p.dat
  [1,16,200,2,0,0,-1,0,0,0,2,-136,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -200 2 0 0 1 0 0 0 2 136 0 0 rect2p.dat
  [1,16,-200,2,0,0,1,0,0,0,2,136,0,0, ldraw_lib__rect2p(realsolid)],
// 
...
module ldraw_lib__u1454p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u1454p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
