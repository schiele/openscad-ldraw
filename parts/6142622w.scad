...
use <6142622v.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6142622w(realsolid=false) = [
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 6142622v.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__6142622v(realsolid)],
];
module ldraw_lib__6142622w(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6142622w(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
