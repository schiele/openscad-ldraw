...
use <s/64178s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__64178(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\64178s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__64178s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\64178s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__64178s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\64178s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__64178s01(realsolid)],
...
// 1 16 0 0 70 0 0 1 1 0 0 0 -1 0 peghole.dat
  [1,16,0,0,70,0,0,1,1,0,0,0,-1,0, ldraw_lib__peghole(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 52 0 0 6 6 0 0 0 16 0 4-4cyli.dat
  [1,16,0,0,52,0,0,6,6,0,0,0,16,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 52 0 0 6 6 0 0 0 16 0 4-4edge.dat
  [1,16,0,0,52,0,0,6,6,0,0,0,16,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 70 0 0 -1 1 0 0 0 -1 0 4-4ring8.dat
  [1,16,0,0,70,0,0,-1,1,0,0,0,-1,0, ldraw_lib__4_4ring8(realsolid)],
...
module ldraw_lib__64178(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__64178(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
