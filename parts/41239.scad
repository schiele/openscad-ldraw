...
use <../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__41239(realsolid=false) = [
// 0 Technic Beam 13
// 0 Name: 41239.dat
...
// 1 16 0 -10 -120 9 0 0 0 1 0 0 0 -9 2-4edge.dat
  [1,16,0,-10,-120,9,0,0,0,1,0,0,0,-9, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 10 -120 9 0 0 0 1 0 0 0 -9 2-4edge.dat
  [1,16,0,10,-120,9,0,0,0,1,0,0,0,-9, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -10 -120 9 0 0 0 20 0 0 0 -9 2-4cyli.dat
  [1,16,0,-10,-120,9,0,0,0,20,0,0,0,-9, ldraw_lib__2_4cyli(realsolid)],
// 1 16 9 0 0 0 -1 0 0 0 10 120 0 0 rect2p.dat
  [1,16,9,0,0,0,-1,0,0,0,10,120,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -9 0 0 0 1 0 0 0 10 -120 0 0 rect2p.dat
  [1,16,-9,0,0,0,1,0,0,0,10,-120,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 -10 120 -9 0 0 0 1 0 0 0 9 2-4edge.dat
  [1,16,0,-10,120,-9,0,0,0,1,0,0,0,9, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 0 -8 120 6 0 0 0 16 0 0 0 6 4-4cyli.dat
  [1,16,0,-8,120,6,0,0,0,16,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -10 120 1 0 0 0 1 0 0 0 1 4-4ring8.dat
  [1,16,0,-10,120,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4ring8(realsolid)],
// 1 16 0 10 120 -1 0 0 0 -1 0 0 0 1 4-4ring8.dat
  [1,16,0,10,120,-1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4ring8(realsolid)],
// 1 16 0 -10 120 1 0 0 0 1 0 0 0 1 peghole.dat
  [1,16,0,-10,120,1,0,0,0,1,0,0,0,1, ldraw_lib__peghole(realsolid)],
// 1 16 0 10 120 1 0 0 0 -1 0 0 0 1 peghole.dat
  [1,16,0,10,120,1,0,0,0,-1,0,0,0,1, ldraw_lib__peghole(realsolid)],
...
module ldraw_lib__41239(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__41239(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
