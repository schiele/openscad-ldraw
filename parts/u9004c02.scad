...
use <u9005.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9004c02(realsolid=false) = [
...
// 1 16 -40 31 60 1 0 0 0 1 0 0 0 1 u9001p02.dat
  [1,16,-40,31,60,1,0,0,0,1,0,0,0,1, ldraw_lib__u9001p02(realsolid)],
// 1 16 40 31 60 1 0 0 0 0.997185 -0.0749787 0 0.0749787 0.997185 u9002p02.dat
  [1,16,40,31,60,1,0,0,0,0.997185,-0.0749787,0,0.0749787,0.997185, ldraw_lib__u9002p02(realsolid)],
];
module ldraw_lib__u9004c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9004c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
