...
use <92851.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4719c03(realsolid=false) = [
...
// 1 47 0 30 0 0 0 -1 0 1 0 1 0 0 92851.dat
  [1,47,0,30,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__92851(realsolid)],
// 0 // bicycle front wheel
// 1 47 0 30 -86 0 0 -1 0 1 0 1 0 0 92851.dat
  [1,47,0,30,-86,0,0,-1,0,1,0,1,0,0, ldraw_lib__92851(realsolid)],
];
module ldraw_lib__4719c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4719c03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
