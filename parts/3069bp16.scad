...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3069px29, Rebrickable 3069bpr0016, Set 1298
// 
...
// 1 16 0 10 7 0.6032 0 0 0 0 1 0 -0.6032 0 s\3009p17a.dat
  [1,16,0,10,7,0.6032,0,0,0,0,1,0,-0.6032,0, ldraw_lib__s__3009p17a()],
...
module ldraw_lib__3069bp16(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3069bp16(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
