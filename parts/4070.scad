...
use <../p/stud2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4070(realsolid=false) = [
...
// 1 16 0 20 -8 10 0 0 0 1 0 0 0 2 rect.dat
  [1,16,0,20,-8,10,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 2 24 6 20 -2 -6 20 -2
  [2,24,6,20,-2,-6,20,-2],
// 2 24 -6 20 -2 -6 20 -6
  [2,24,-6,20,-2,-6,20,-6],
...
// 1 16 0 16 8 6 0 0 0 1 0 0 0 2 rect.dat
  [1,16,0,16,8,6,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 0 4 4 -6 0 0 0 -1 0 0 0 6 rect.dat
  [1,16,0,4,4,-6,0,0,0,-1,0,0,0,6, ldraw_lib__rect(realsolid)],
// 1 16 0 0 2 10 0 0 0 1 0 0 0 8 rect.dat
  [1,16,0,0,2,10,0,0,0,1,0,0,0,8, ldraw_lib__rect(realsolid)],
// 
// 2 24 6 16 10 6 4 10
  [2,24,6,16,10,6,4,10],
// 2 24 -6 16 10 -6 4 10
...
// 1 16 0 10 -2 4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,16,0,10,-2,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 10 -2 4 0 0 0 0 -4 0 -1 0 4-4ndis.dat
  [1,16,0,10,-2,4,0,0,0,0,-4,0,-1,0, ldraw_lib__4_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 10 -2 4 0 0 0 0 4 0 -4 0 4-4cyli.dat
  [1,16,0,10,-2,4,0,0,0,0,4,0,-4,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 10 -6 6 0 0 0 0 6 0 1 0 4-4ndis.dat
  [1,16,0,10,-6,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 
...
// 1 16 0 10 -6 1 0 0 0 0 1 0 1 0 stud2a.dat
  [1,16,0,10,-6,1,0,0,0,0,1,0,1,0, ldraw_lib__stud2a(realsolid)],
// 0
// 
];
module ldraw_lib__4070(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4070(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4070(line=0.2);