...
use <s/973s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973p6e(realsolid=false) = [
...
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 s\973p65b.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p65b(realsolid)],
...
module ldraw_lib__973p6e(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p6e(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
