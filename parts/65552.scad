...
use <s/3001s02.scad>
use <../p/stud.scad>
function ldraw_lib__65552() = [
// 0 Brick Braille 2 x 4 with 1 Stud (DOTS-2)
// 0 Name: 65552.dat
...
module ldraw_lib__65552(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__65552(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__65552(line=0.2);