...
use <../p/stug-2x1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9034(realsolid=false) = [
...
// 1 16 106.164 0 -14.692 -0.8819 0 -0.4714 0 1 0 0.4714 0 -0.8819 stug-2x1.dat
  [1,16,106.164,0,-14.692,-0.8819,0,-0.4714,0,1,0,0.4714,0,-0.8819, ldraw_lib__stug_2x1(realsolid)],
// 1 16 141.441 0 -33.547 -0.8819 0 -0.4714 0 1 0 0.4714 0 -0.8819 stug-2x1.dat
  [1,16,141.441,0,-33.547,-0.8819,0,-0.4714,0,1,0,0.4714,0,-0.8819, ldraw_lib__stug_2x1(realsolid)],
];
module ldraw_lib__u9034(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9034(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
