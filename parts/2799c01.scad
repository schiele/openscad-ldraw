...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2799.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2799()],
// 1 79 0 112 0 1 0 0 0 1 0 0 0 1 2805.dat
  [1,79,0,112,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2805()],
];
module ldraw_lib__2799c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2799c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
