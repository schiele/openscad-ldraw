...
$fa=1; $fs=0.2;
function ldraw_lib__4215bp01(realsolid=false) = [
...
// 1 16 0 36 10 -0.275 0 0 0 0 -0.275 0 -1 0 s\6205p01s01.dat
  [1,16,0,36,10,-0.275,0,0,0,0,-0.275,0,-1,0, ldraw_lib__s__6205p01s01(realsolid)],
];
module ldraw_lib__4215bp01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4215bp01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
