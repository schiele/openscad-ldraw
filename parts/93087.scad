...
use <93087k02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__93087(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 93087k01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__93087k01(realsolid)],
// 1 16 0 0 11 1 0 0 0 1 0 0 0 1 93087k02.dat
  [1,16,0,0,11,1,0,0,0,1,0,0,0,1, ldraw_lib__93087k02(realsolid)],
];
module ldraw_lib__93087(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__93087(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
