...
use <u9102p15.scad>
use <u9103.scad>
function ldraw_lib__u588p02c03() = [
...
// 1 7 0 -67 4 1 0 0 0 1 0 0 0 1 u588p02c01.dat
  [1,7,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u588p02c01()],
// 1 4 0 -37 4 1 0 0 0 1 0 0 0 1 u9102p15.dat
  [1,4,0,-37,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u9102p15()],
...
module ldraw_lib__u588p02c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u588p02c03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
