...
// 0 BFC CERTIFY CW
  ...
  [0,"BFC","CW"],
// 
// 0 !KEYWORDS Bricklink 132old, classic, Rebrickable 132a, Smooth
// 
...
// 1 16 0 0 -6 0 0 2 2 0 0 0 2 0 4-4ring10.dat
  [1,16,0,0,-6,0,0,2,2,0,0,0,2,0, ldraw_lib__4_4ring10()],
// 1 16 0 0 6 0 0 -2 2 0 0 0 -2 0 4-4ring10.dat
  [1,16,0,0,6,0,0,-2,2,0,0,0,-2,0, ldraw_lib__4_4ring10()],
// 1 16 0 0 -9 -2 0 0 0 0 2 0 1 0 4-4ring11.dat
  [1,16,0,0,-9,-2,0,0,0,0,2,0,1,0, ldraw_lib__4_4ring11()],
...
module ldraw_lib__u9131(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9131(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
