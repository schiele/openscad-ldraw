...
$fa=1; $fs=0.2;
function ldraw_lib__14417(realsolid=false) = [
...
// 1 16 0 4 -20 1 0 0 0 1 0 0 0 1 joint8ball.dat
  [1,16,0,4,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__joint8ball(realsolid)],
];
module ldraw_lib__14417(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__14417(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
