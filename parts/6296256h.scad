...
$fa=1; $fs=0.2;
function ldraw_lib__6296256h(realsolid=false) = [
...
// 1 16 0 -0.25 0 77.5 0 0 0 0.25 0 0 0 7.5 box5-12.dat
  [1,16,0,-0.25,0,77.5,0,0,0,0.25,0,0,0,7.5, ldraw_lib__box5_12(realsolid)],
// 1 0 0 -.25 4.6 1.4 0 0 0 1 0 0 0 1.4 2-4chrd.dat
  [1,0,0,-.25,4.6,1.4,0,0,0,1,0,0,0,1.4, ldraw_lib__2_4chrd(realsolid)],
// 1 0 0 -.25 -4.6 1.4 0 0 0 1 0 0 0 -1.4 2-4chrd.dat
  [1,0,0,-.25,-4.6,1.4,0,0,0,1,0,0,0,-1.4, ldraw_lib__2_4chrd(realsolid)],
// 4 0 1.4 -.25 -4.6 1.4 -.25 4.6 -1.4 -.25 4.6 -1.4 -.25 -4.6
  [4,0,1.4,-.25,-4.6,1.4,-.25,4.6,-1.4,-.25,4.6,-1.4,-.25,-4.6],
// 1 226 0 -.25 4.6 1.4 0 0 0 1 0 0 0 1.4 2-4ndis.dat
  [1,226,0,-.25,4.6,1.4,0,0,0,1,0,0,0,1.4, ldraw_lib__2_4ndis(realsolid)],
// 1 226 0 -.25 -4.6 1.4 0 0 0 1 0 0 0 -1.4 2-4ndis.dat
  [1,226,0,-.25,-4.6,1.4,0,0,0,1,0,0,0,-1.4, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\6296256hs01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6296256hs01(realsolid)],
// 1 16 -22.96 0 0 1 0 0 0 1 0 0 0 1 s\6296256hs01.dat
  [1,16,-22.96,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6296256hs01(realsolid)],
// 1 16 -45.92 0 0 1 0 0 0 1 0 0 0 1 s\6296256hs01.dat
  [1,16,-45.92,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6296256hs01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\6296256hs01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__6296256hs01(realsolid)],
// 1 16 22.96 0 0 -1 0 0 0 1 0 0 0 1 s\6296256hs01.dat
  [1,16,22.96,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__6296256hs01(realsolid)],
...
// 1 0 -74.62 -.25 4.6 1.4 0 0 0 1 0 0 0 1.4 2-4chrd.dat
  [1,0,-74.62,-.25,4.6,1.4,0,0,0,1,0,0,0,1.4, ldraw_lib__2_4chrd(realsolid)],
// 1 0 -74.62 -.25 -4.6 1.4 0 0 0 1 0 0 0 -1.4 2-4chrd.dat
  [1,0,-74.62,-.25,-4.6,1.4,0,0,0,1,0,0,0,-1.4, ldraw_lib__2_4chrd(realsolid)],
// 4 0 -73.22 -.25 -4.6 -73.22 -.25 4.6 -76.02 -.25 4.6 -76.02 -.25 -4.6
  [4,0,-73.22,-.25,-4.6,-73.22,-.25,4.6,-76.02,-.25,4.6,-76.02,-.25,-4.6],
// 1 226 -74.62 -.25 4.6 1.4 0 0 0 1 0 0 0 1.4 2-4ndis.dat
  [1,226,-74.62,-.25,4.6,1.4,0,0,0,1,0,0,0,1.4, ldraw_lib__2_4ndis(realsolid)],
// 1 226 -74.62 -.25 -4.6 1.4 0 0 0 1 0 0 0 -1.4 2-4ndis.dat
  [1,226,-74.62,-.25,-4.6,1.4,0,0,0,1,0,0,0,-1.4, ldraw_lib__2_4ndis(realsolid)],
...
module ldraw_lib__6296256h(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6296256h(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
