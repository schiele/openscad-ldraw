...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 87576.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__87576()],
// 1 72 0 0 -140 1 0 0 0 1 0 0 0 1 89668.dat
  [1,72,0,0,-140,1,0,0,0,1,0,0,0,1, ldraw_lib__89668()],
];
module ldraw_lib__87576c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87576c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
