...
// 0 !KEYWORDS BrickLink 2586pb007, Rebrickable 2586pr0008, set 70402, set 70403
// 0 !KEYWORDS set 850889
// 
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\2586p4ns01.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2586p4ns01()],
// 1 4 0 0 0 -1 0 0 0 1 0 0 0 1 s\2586p4ns01.dat
  [1,4,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__2586p4ns01()],
];
module ldraw_lib__2586p4n(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2586p4n(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
