...
use <../p/connect.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48724(realsolid=false) = [
...
// 1 16 0 10 -13 1 0 0 0 0 -1 0 1 0 connect.dat
  [1,16,0,10,-13,1,0,0,0,0,-1,0,1,0, ldraw_lib__connect(realsolid)],
// 1 16 0 10 -13 8 0 0 0 0 -8 0 1 0 4-4edge.dat
  [1,16,0,10,-13,8,0,0,0,0,-8,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 10 -13 4 0 0 0 0 -4 0 1 0 4-4edge.dat
  [1,16,0,10,-13,4,0,0,0,0,-4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 -8 22 -10 0 0 -2 2 0 0 0 -1 0 1-4disc.dat
  [1,16,-8,22,-10,0,0,-2,2,0,0,0,-1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 8 22 -13 0 0 2 2 0 0 0 1 0 1-4disc.dat
  [1,16,8,22,-13,0,0,2,2,0,0,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 8 22 -10 2 0 0 0 0 2 0 -1 0 1-4disc.dat
  [1,16,8,22,-10,2,0,0,0,0,2,0,-1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 -8 22 -13 -2 0 0 0 0 2 0 1 0 1-4disc.dat
  [1,16,-8,22,-13,-2,0,0,0,0,2,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 8 -3 8 2 0 0 0 1 0 0 0 2 1-4disc.dat
  [1,16,8,-3,8,2,0,0,0,1,0,0,0,2, ldraw_lib__1_4disc(realsolid)],
// 1 16 -8 -3 8 0 0 -2 0 1 0 2 0 0 1-4disc.dat
  [1,16,-8,-3,8,0,0,-2,0,1,0,2,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 -8 0 8 -2 0 0 0 -1 0 0 0 2 1-4disc.dat
  [1,16,-8,0,8,-2,0,0,0,-1,0,0,0,2, ldraw_lib__1_4disc(realsolid)],
// 1 16 8 0 8 0 0 2 0 -1 0 2 0 0 1-4disc.dat
  [1,16,8,0,8,0,0,2,0,-1,0,2,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 -8 22 -10 0 0 -2 2 0 0 0 -3 0 1-4cyli.dat
  [1,16,-8,22,-10,0,0,-2,2,0,0,0,-3,0, ldraw_lib__1_4cyli(realsolid)],
// 4 16 -10 22 -13 -10 -3 -13 -10 0 -10 -10 22 -10
  [4,16,-10,22,-13,-10,-3,-13,-10,0,-10,-10,22,-10],
// 4 16 -10 -3 -13 -10 -3 8 -10 0 8 -10 0 -10
  [4,16,-10,-3,-13,-10,-3,8,-10,0,8,-10,0,-10],
// 1 16 -8 -3 8 0 0 -2 0 3 0 2 0 0 1-4cyli.dat
  [1,16,-8,-3,8,0,0,-2,0,3,0,2,0,0, ldraw_lib__1_4cyli(realsolid)],
// 4 16 8 -3 10 8 0 10 -8 0 10 -8 -3 10
  [4,16,8,-3,10,8,0,10,-8,0,10,-8,-3,10],
// 1 16 8 -3 8 2 0 0 0 3 0 0 0 2 1-4cyli.dat
  [1,16,8,-3,8,2,0,0,0,3,0,0,0,2, ldraw_lib__1_4cyli(realsolid)],
// 4 16 10 -3 8 10 -3 -13 10 0 -10 10 0 8
  [4,16,10,-3,8,10,-3,-13,10,0,-10,10,0,8],
// 4 16 10 22 -13 10 22 -10 10 0 -10 10 -3 -13
  [4,16,10,22,-13,10,22,-10,10,0,-10,10,-3,-13],
// 1 16 8 22 -10 2 0 0 0 0 2 0 -3 0 1-4cyli.dat
  [1,16,8,22,-10,2,0,0,0,0,2,0,-3,0, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 -8 22 -10 0 0 -2 2 0 0 0 -1 0 1-4edge.dat
  [1,16,-8,22,-10,0,0,-2,2,0,0,0,-1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -8 22 -13 0 0 -2 2 0 0 0 -1 0 1-4edge.dat
  [1,16,-8,22,-13,0,0,-2,2,0,0,0,-1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 8 22 -10 2 0 0 0 0 2 0 -1 0 1-4edge.dat
  [1,16,8,22,-10,2,0,0,0,0,2,0,-1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 8 22 -13 2 0 0 0 0 2 0 -1 0 1-4edge.dat
  [1,16,8,22,-13,2,0,0,0,0,2,0,-1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 8 -3 8 2 0 0 0 1 0 0 0 2 1-4edge.dat
  [1,16,8,-3,8,2,0,0,0,1,0,0,0,2, ldraw_lib__1_4edge(realsolid)],
// 1 16 -8 -3 8 0 0 -2 0 1 0 2 0 0 1-4edge.dat
  [1,16,-8,-3,8,0,0,-2,0,1,0,2,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 8 0 8 2 0 0 0 1 0 0 0 2 1-4edge.dat
  [1,16,8,0,8,2,0,0,0,1,0,0,0,2, ldraw_lib__1_4edge(realsolid)],
// 1 16 -8 0 8 0 0 -2 0 1 0 2 0 0 1-4edge.dat
  [1,16,-8,0,8,0,0,-2,0,1,0,2,0,0, ldraw_lib__1_4edge(realsolid)],
...
module ldraw_lib__48724(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48724(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
