...
use <s/4066as01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4066a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\4066as01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4066as01(realsolid)],
// 0 // Front face
...
module ldraw_lib__4066a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4066a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
