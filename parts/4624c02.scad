...
use <87414.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4624c02(realsolid=false) = [
...
// 1 256 0 0 0 1 0 0 0 1 0 0 0 1 87414.dat
  [1,256,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__87414(realsolid)],
];
module ldraw_lib__4624c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4624c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
