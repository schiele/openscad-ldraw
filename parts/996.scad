...
// 1 16 0 12 -2 1 0 0 0 0 4 0 10 0 box5.dat
  [1,16,0,12,-2,1,0,0,0,0,4,0,10,0, ldraw_lib__box5()],
// 1 16 -12 0 -2 0 0 -4 1 0 0 0 10 0 box5.dat
  [1,16,-12,0,-2,0,0,-4,1,0,0,0,10,0, ldraw_lib__box5()],
// 1 16 0 -12 -2 -1 0 0 0 0 -4 0 10 0 box5.dat
  [1,16,0,-12,-2,-1,0,0,0,0,-4,0,10,0, ldraw_lib__box5()],
// 1 16 12 0 -2 0 0 4 -1 0 0 0 10 0 box5.dat
  [1,16,12,0,-2,0,0,4,-1,0,0,0,10,0, ldraw_lib__box5()],
// 1 16 0 -11 -6 -1 0 0 0 0 -5 0 -2 0 box5.dat
  [1,16,0,-11,-6,-1,0,0,0,0,-5,0,-2,0, ldraw_lib__box5()],
// 1 16 0 11 -6 1 0 0 0 0 5 0 -2 0 box5.dat
  [1,16,0,11,-6,1,0,0,0,0,5,0,-2,0, ldraw_lib__box5()],
// 1 16 -6.466 -8.899 -6 -0.809017 0 -2.93893 0.587785 0 -4.04508 0 -2 0 box5.dat
  [1,16,-6.466,-8.899,-6,-0.809017,0,-2.93893,0.587785,0,-4.04508,0,-2,0, ldraw_lib__box5()],
// 1 16 -10.462 -3.399 -6 -0.309017 0 -4.75528 0.951057 0 -1.54508 0 -2 0 box5.dat
  [1,16,-10.462,-3.399,-6,-0.309017,0,-4.75528,0.951057,0,-1.54508,0,-2,0, ldraw_lib__box5()],
// 1 16 -10.462 3.4 -6 0.309017 0 -4.75528 0.951057 0 1.54508 0 -2 0 box5.dat
  [1,16,-10.462,3.4,-6,0.309017,0,-4.75528,0.951057,0,1.54508,0,-2,0, ldraw_lib__box5()],
// 1 16 -6.465 8.9 -6 0.809017 0 -2.93893 0.587785 0 4.04508 0 -2 0 box5.dat
  [1,16,-6.465,8.9,-6,0.809017,0,-2.93893,0.587785,0,4.04508,0,-2,0, ldraw_lib__box5()],
// 1 16 6.466 8.899 -6 0.809017 0 2.93893 -0.587785 0 4.04508 0 -2 0 box5.dat
  [1,16,6.466,8.899,-6,0.809017,0,2.93893,-0.587785,0,4.04508,0,-2,0, ldraw_lib__box5()],
// 1 16 10.462 3.399 -6 0.309017 0 4.75528 -0.951057 0 1.54508 0 -2 0 box5.dat
  [1,16,10.462,3.399,-6,0.309017,0,4.75528,-0.951057,0,1.54508,0,-2,0, ldraw_lib__box5()],
...
// 1 16 0 0 -2 16 0 0 0 0 16 0 1 0 4-4edge.dat
  [1,16,0,0,-2,16,0,0,0,0,16,0,1,0, ldraw_lib__4_4edge()],
...
// 1 16 0 0 2 20 0 0 0 0 20 0 1 0 4-4edge.dat
  [1,16,0,0,2,20,0,0,0,0,20,0,1,0, ldraw_lib__4_4edge()],
...
// 1 16 0 0 -10 0 0 2 -2 0 0 0 2 0 1-4ring9.dat
  [1,16,0,0,-10,0,0,2,-2,0,0,0,2,0, ldraw_lib__1_4ring9()],
// 1 16 0 0 -10 -2 0 0 0 0 -2 0 2 0 1-4ring9.dat
  [1,16,0,0,-10,-2,0,0,0,0,-2,0,2,0, ldraw_lib__1_4ring9()],
// 1 16 0 0 -10 0 0 -2 2 0 0 0 2 0 1-4ring9.dat
  [1,16,0,0,-10,0,0,-2,2,0,0,0,2,0, ldraw_lib__1_4ring9()],
// 1 16 0 0 -10 2 0 0 0 0 2 0 2 0 1-4ring9.dat
  [1,16,0,0,-10,2,0,0,0,0,2,0,2,0, ldraw_lib__1_4ring9()],
// 1 16 0 0 -10 18 0 0 0 0 18 0 1 0 4-4edge.dat
  [1,16,0,0,-10,18,0,0,0,0,18,0,1,0, ldraw_lib__4_4edge()],
...
// 1 16 0 0 -10 2 0 0 0 0 2 0 2 0 4-4con8.dat
  [1,16,0,0,-10,2,0,0,0,0,2,0,2,0, ldraw_lib__4_4con8()],
// 1 16 0 0 -6 16 0 0 0 0 16 0 1 0 4-4edge.dat
  [1,16,0,0,-6,16,0,0,0,0,16,0,1,0, ldraw_lib__4_4edge()],
...
// 1 16 0 0 -8 16 0 0 0 0 16 0 2 0 4-4cyli.dat
  [1,16,0,0,-8,16,0,0,0,0,16,0,2,0, ldraw_lib__4_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -2 16 0 0 0 0 16 0 10 0 4-4cyli.dat
  [1,16,0,0,-2,16,0,0,0,0,16,0,10,0, ldraw_lib__4_4cyli()],
// 1 16 0 0 8 16 0 0 0 0 16 0 1 0 4-4edge.dat
  [1,16,0,0,8,16,0,0,0,0,16,0,1,0, ldraw_lib__4_4edge()],
// 1 16 0 0 -10 20 0 0 0 0 20 0 12 0 4-4cyli.dat
  [1,16,0,0,-10,20,0,0,0,0,20,0,12,0, ldraw_lib__4_4cyli()],
...
// 1 16 0 0 -6 2 0 0 0 0 2 0 2 0 4-4ring3.dat
  [1,16,0,0,-6,2,0,0,0,0,2,0,2,0, ldraw_lib__4_4ring3()],
// 1 16 0 0 -6 8 0 0 0 0 8 0 8 0 4-4ring1.dat
  [1,16,0,0,-6,8,0,0,0,0,8,0,8,0, ldraw_lib__4_4ring1()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 0 4.5 5 0 0 0 0 5 0 -2.5 0 1-4con4.dat
  [1,16,0,0,4.5,5,0,0,0,0,5,0,-2.5,0, ldraw_lib__1_4con4()],
// 1 16 0 0 4.5 0 0 -5 5 0 0 0 -2.5 0 1-4con4.dat
  [1,16,0,0,4.5,0,0,-5,5,0,0,0,-2.5,0, ldraw_lib__1_4con4()],
// 1 16 0 0 4.5 -5 0 0 0 0 -5 0 -2.5 0 1-4con4.dat
  [1,16,0,0,4.5,-5,0,0,0,0,-5,0,-2.5,0, ldraw_lib__1_4con4()],
// 1 16 0 0 4.5 0 0 5 -5 0 0 0 -2.5 0 1-4con4.dat
  [1,16,0,0,4.5,0,0,5,-5,0,0,0,-2.5,0, ldraw_lib__1_4con4()],
...
// 1 16 0 0 -6 6 0 0 0 0 6 0 -2 0 4-4cyli.dat
  [1,16,0,0,-6,6,0,0,0,0,6,0,-2,0, ldraw_lib__4_4cyli()],
...
// 1 16 0 0 -8 4 0 0 0 0 4 0 -4 0 4-4edge.dat
  [1,16,0,0,-8,4,0,0,0,0,4,0,-4,0, ldraw_lib__4_4edge()],
// 1 16 0 0 -8 6 0 0 0 0 6 0 -6 0 4-4edge.dat
  [1,16,0,0,-8,6,0,0,0,0,6,0,-6,0, ldraw_lib__4_4edge()],
// 0
];
module ldraw_lib__996(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__996(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
