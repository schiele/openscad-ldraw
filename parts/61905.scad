...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\61905s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__61905s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\61905s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__61905s01()],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 1 s\61905s01.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__61905s01()],
...
// 1 16 -10 0 0 0 0 -1 -1 0 0 0 -8 0 npeghole.dat
  [1,16,-10,0,0,0,0,-1,-1,0,0,0,-8,0, ldraw_lib__npeghole()],
// 1 16 10 0 0 0 0 -1 -1 0 0 0 -8 0 npeghole.dat
  [1,16,10,0,0,0,0,-1,-1,0,0,0,-8,0, ldraw_lib__npeghole()],
// 1 16 -10 0 -20 0 0 -1 -1 0 0 0 8 0 npeghol2.dat
  [1,16,-10,0,-20,0,0,-1,-1,0,0,0,8,0, ldraw_lib__npeghol2()],
// 1 16 -20 0 -20 1 0 0 0 0 -1 0 1 0 peghole.dat
  [1,16,-20,0,-20,1,0,0,0,0,-1,0,1,0, ldraw_lib__peghole()],
// 1 16 20 0 -20 1 0 0 0 0 -1 0 1 0 peghole.dat
  [1,16,20,0,-20,1,0,0,0,0,-1,0,1,0, ldraw_lib__peghole()],
// 1 16 20 0 -20 0 0 -9 -9 0 0 0 1 0 2-4ndis.dat
  [1,16,20,0,-20,0,0,-9,-9,0,0,0,1,0, ldraw_lib__2_4ndis()],
// 1 16 0 0 -20 0 0 9 -9 0 0 0 1 0 2-4ndis.dat
  [1,16,0,0,-20,0,0,9,-9,0,0,0,1,0, ldraw_lib__2_4ndis()],
...
// 1 16 0 -10 -10 10 0 0 0 1 0 0 0 10 rect3.dat
  [1,16,0,-10,-10,10,0,0,0,1,0,0,0,10, ldraw_lib__rect3()],
// 1 16 0 10 -10 -10 0 0 0 -1 0 0 0 10 rect3.dat
  [1,16,0,10,-10,-10,0,0,0,-1,0,0,0,10, ldraw_lib__rect3()],
// 0
];
module ldraw_lib__61905(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__61905(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
