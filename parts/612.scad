...
use <s/612s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__612(realsolid=false) = [
// 0 Baseplate 32 x 32 Road 8-Stud T-Junction
// 0 Name: 612.dat
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\612s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__612s01(realsolid)],
// 
...
module ldraw_lib__612(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__612(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__612(line=0.2);