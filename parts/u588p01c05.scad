...
use <u9102.scad>
use <u9103.scad>
function ldraw_lib__u588p01c05() = [
...
// 1 7 0 -67 4 1 0 0 0 1 0 0 0 1 u588p01c02.dat
  [1,7,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u588p01c02()],
...
module ldraw_lib__u588p01c05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u588p01c05(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
