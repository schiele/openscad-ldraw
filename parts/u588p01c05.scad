...
use <u9103.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u588p01c05(realsolid=false) = [
...
// 0 !KEYWORDS Pirouette l'éléphant, Set 3660
// 
// 0 !HISTORY 2011-07-25 [PTadmin] Official Update 2011-01
// 
// 
// 1 7 0 -67 4 1 0 0 0 1 0 0 0 1 u588p01c02.dat
  [1,7,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u588p01c02(realsolid)],
...
module ldraw_lib__u588p01c05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u588p01c05(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u588p01c05(line=0.2);