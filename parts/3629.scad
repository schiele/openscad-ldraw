...
use <s/3629s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3629(realsolid=false) = [
...
// 0 !KEYWORDS cavalry, cowboy, minifig hat, stetson, ten-gallon hat, western
...
module ldraw_lib__3629(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3629(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
