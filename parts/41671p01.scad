...
use <s/41671s04.scad>
$fa=1; $fs=0.2;
function ldraw_lib__41671p01(realsolid=false) = [
...
// 1 47 0 0 0 1 0 0 0 1 0 0 0 1 s\41671s03.dat
  [1,47,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__41671s03(realsolid)],
// 1 47 0 0 0 -1 0 0 0 1 0 0 0 1 s\41671s03.dat
  [1,47,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__41671s03(realsolid)],
// 1 47 0 0 0 1 0 0 0 1 0 0 0 1 s\41671s04.dat
  [1,47,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__41671s04(realsolid)],
// 1 47 0 0 0 -1 0 0 0 1 0 0 0 1 s\41671s04.dat
  [1,47,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__41671s04(realsolid)],
];
module ldraw_lib__41671p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__41671p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
