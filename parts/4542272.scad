...
// 1 72 0 0 0 1 0 0 0 1 0 0 0 1 61406p02.dat
  [1,72,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__61406p02()],
];
module ldraw_lib__4542272(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4542272(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
