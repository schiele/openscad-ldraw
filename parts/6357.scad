...
use <../p/4-4ring7.scad>
use <../p/t01o3750.scad>
function ldraw_lib__6357() = [
// 0 ~Wheel  6.8 x 18 Solid for Duplo Vehicle Base
// 0 Name: 6357.dat
...
// 0 !HISTORY 2025-02-17 [OrionP] Moved from u9032.dat
...
module ldraw_lib__6357(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6357(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6357(line=0.2);