...
use <973.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973d01(realsolid=false) = [
...
// 1 16 0 16 -10 1 0 0 0 0 -1 0 1 0 22587b.dat
  [1,16,0,16,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__22587b(realsolid)],
// 1 16 0 16 10 -1 0 0 0 0 -1 0 -1 0 22587c.dat
  [1,16,0,16,10,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__22587c(realsolid)],
];
module ldraw_lib__973d01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973d01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
