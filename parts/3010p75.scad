...
use <s/3010s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3010p75(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3010pb021, set 4609, Set 6548, set 9305
// 
...
// 1 16 0 12 -10 1.2 0 0 0 0 -1.2 0 1 0 logo-octantext.dat
  [1,16,0,12,-10,1.2,0,0,0,0,-1.2,0,1,0, ldraw_lib__logo_octantext(realsolid)],
...
module ldraw_lib__3010p75(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3010p75(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
