...
use <s/95050s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__95050(realsolid=false) = [
...
// 1 16 0 25 0 4 0 0 0 -5 0 0 0 4 4-4cylc.dat
  [1,16,0,25,0,4,0,0,0,-5,0,0,0,4, ldraw_lib__4_4cylc(realsolid)],
...
// 1 16 0 20 0 2.5 0 0 0 -12.5 0 0 0 2.5 4-4cylo.dat
  [1,16,0,20,0,2.5,0,0,0,-12.5,0,0,0,2.5, ldraw_lib__4_4cylo(realsolid)],
...
// 1 16 0 -7.5 0 2.5 0 0 0 1 0 0 0 2.5 4-4edge.dat
  [1,16,0,-7.5,0,2.5,0,0,0,1,0,0,0,2.5, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -7.5 0 2.5 0 0 0 -2.5 0 0 0 2.5 4-4cyli.dat
  [1,16,0,-7.5,0,2.5,0,0,0,-2.5,0,0,0,2.5, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -10 0 0 0 -2.5 0 -0.5 0 2.5 0 0 4-4cyls.dat
  [1,16,0,-10,0,0,0,-2.5,0,-0.5,0,2.5,0,0, ldraw_lib__4_4cyls(realsolid)],
// 1 16 0 -10.5 0 0 0 -2.5 0.5 -2 0 2.5 0.5 0 4-4cylo.dat
  [1,16,0,-10.5,0,0,0,-2.5,0.5,-2,0,2.5,0.5,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 -13 0.5 0 0 2.5 0 0.5 0 -2.5 0 0 4-4cyls.dat
  [1,16,0,-13,0.5,0,0,2.5,0,0.5,0,-2.5,0,0, ldraw_lib__4_4cyls(realsolid)],
// 1 16 0 -13 0.5 2.5 0 0 0 -1.5 0 0 0 2.5 4-4cyli.dat
  [1,16,0,-13,0.5,2.5,0,0,0,-1.5,0,0,0,2.5, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -14.5 0.5 0 0 2.5 0 -0.5 0 -2.5 0 0 4-4cyls.dat
  [1,16,0,-14.5,0.5,0,0,2.5,0,-0.5,0,-2.5,0,0, ldraw_lib__4_4cyls(realsolid)],
// 1 16 0 -17 0 2.5 0 0 0 2 -0.5 0 0.5 2.5 4-4cylo.dat
  [1,16,0,-17,0,2.5,0,0,0,2,-0.5,0,0.5,2.5, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 -17.5 0 0 0 -2.5 0 0.5 0 2.5 0 0 4-4cyls.dat
  [1,16,0,-17.5,0,0,0,-2.5,0,0.5,0,2.5,0,0, ldraw_lib__4_4cyls(realsolid)],
// 1 16 0 -17.5 0 2.5 0 0 0 -3.25 0 0 0 2.5 4-4cyli.dat
  [1,16,0,-17.5,0,2.5,0,0,0,-3.25,0,0,0,2.5, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -20.75 0 0 0 2.5 0 -0.2 0 -2.5 0 0 4-4cylse.dat
  [1,16,0,-20.75,0,0,0,2.5,0,-0.2,0,-2.5,0,0, ldraw_lib__4_4cylse(realsolid)],
// 0 // top
// 1 16 0 -20.95 0 5 0 0 0 -3 -0.4 0 -0.4 5 4-4cylc.dat
  [1,16,0,-20.95,0,5,0,0,0,-3,-0.4,0,-0.4,5, ldraw_lib__4_4cylc(realsolid)],
// 1 16 0 -23.95 -0.4 5 0 0 0 1 -0.4 0 -0.3 5 4-4disc.dat
  [1,16,0,-23.95,-0.4,5,0,0,0,1,-0.4,0,-0.3,5, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 -23.95 0 1 0 0 0 1 0 0 0 1 s\95050s01.dat
  [1,16,0,-23.95,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__95050s01(realsolid)],
// 1 16 0 -23.95 0 -1 0 0 0 1 0 0 0 1 s\95050s01.dat
  [1,16,0,-23.95,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__95050s01(realsolid)],
...
// 1 16 2.625 14.5 0 0 -5.25 0 -2.5 0 0 0 0 2.5 4-4cylc.dat
  [1,16,2.625,14.5,0,0,-5.25,0,-2.5,0,0,0,0,2.5, ldraw_lib__4_4cylc(realsolid)],
// 1 16 -2.625 14.5 0 0 1 0 -2.5 0 0 0 0 2.5 4-4disc.dat
  [1,16,-2.625,14.5,0,0,1,0,-2.5,0,0,0,0,2.5, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 14.5 0 2.5 -1 0 2.5 1 0 0 0 2.5 4-4edge.dat
  [1,16,0,14.5,0,2.5,-1,0,2.5,1,0,0,0,2.5, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 14.5 0 2.5 1 0 -2.5 1 0 0 0 2.5 4-4edge.dat
  [1,16,0,14.5,0,2.5,1,0,-2.5,1,0,0,0,2.5, ldraw_lib__4_4edge(realsolid)],
// 
// 1 16 2.625 -17.5 0 0 -2.625 0 -2.5 0 0 0 0 2.5 4-4cylc.dat
  [1,16,2.625,-17.5,0,0,-2.625,0,-2.5,0,0,0,0,2.5, ldraw_lib__4_4cylc(realsolid)],
// 1 16 0 -17.5 0 0 2.5 2.5 0 2.5 -2.5 -2.5 0 0 2-4edge.dat
  [1,16,0,-17.5,0,0,2.5,2.5,0,2.5,-2.5,-2.5,0,0, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 0 -12 -4 2 0 0 0 2.4 -1.4 0 2.7 1.2 4-4cylc.dat
  [1,16,0,-12,-4,2,0,0,0,2.4,-1.4,0,2.7,1.2, ldraw_lib__4_4cylc(realsolid)],
...
module ldraw_lib__95050(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__95050(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
