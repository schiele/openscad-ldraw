...
use <s/23816s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__41014c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 41014.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__41014(realsolid)],
// 1 72 0 0 120 1 0 0 0 1 0 0 0 1 41041.dat
  [1,72,0,0,120,1,0,0,0,1,0,0,0,1, ldraw_lib__41041(realsolid)],
// 1 72 0 0 130 1 0 0 0 1 0 0 0 1 41089.dat
  [1,72,0,0,130,1,0,0,0,1,0,0,0,1, ldraw_lib__41089(realsolid)],
...
module ldraw_lib__41014c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__41014c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
