...
$fa=1; $fs=0.2;
function ldraw_lib__92198p01c02(realsolid=false) = [
...
// 1 73 0 0 0 1 0 0 0 1 0 0 0 1 15680p01c01.dat
  [1,73,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__15680p01c01(realsolid)],
// 1 78 0 -64 0 1 0 0 0 1 0 0 0 1 92241p08c01.dat
  [1,78,0,-64,0,1,0,0,0,1,0,0,0,1, ldraw_lib__92241p08c01(realsolid)],
...
// 1 226 0 -110 0.9 1 0 0 0 1 0 0 0 1 15673p01.dat
  [1,226,0,-110,0.9,1,0,0,0,1,0,0,0,1, ldraw_lib__15673p01(realsolid)],
];
module ldraw_lib__92198p01c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92198p01c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
