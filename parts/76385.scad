...
use <30472.scad>
$fa=1; $fs=0.2;
function ldraw_lib__76385(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 30472.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30472(realsolid)],
// 1 16 10 0 0 1 0 0 0 1 0 0 0 1 30345.dat
  [1,16,10,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30345(realsolid)],
// 0 //
];
module ldraw_lib__76385(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76385(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
