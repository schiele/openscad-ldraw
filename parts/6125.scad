...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\6125s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6125s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\6125s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__6125s01()],
// 1 16 -11 0 0 0 22 0 0 0 4 4 0 0 4-4cyli.dat
  [1,16,-11,0,0,0,22,0,0,0,4,4,0,0, ldraw_lib__4_4cyli()],
];
module ldraw_lib__6125(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6125(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
