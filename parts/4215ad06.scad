...
use <821421a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4215ad06(realsolid=false) = [
...
// 1 16 0 36 10 -1 0 0 0 0 -1 0 -1 0 821421a.dat
  [1,16,0,36,10,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__821421a(realsolid)],
];
module ldraw_lib__4215ad06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4215ad06(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
