...
use <s/636s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__635(realsolid=false) = [
...
// 1 16 45 0 0 0 -17 0 0 0 4 4 0 0 4-4cylc.dat
  [1,16,45,0,0,0,-17,0,0,0,4,4,0,0, ldraw_lib__4_4cylc(realsolid)],
// 1 16 -45 0 0 0 17 0 0 0 4 4 0 0 4-4cylo.dat
  [1,16,-45,0,0,0,17,0,0,0,4,4,0,0, ldraw_lib__4_4cylo(realsolid)],
...
// 1 16 -45 0 0 0 -1 0 8 0 0 0 0 8 2-4disc.dat
  [1,16,-45,0,0,0,-1,0,8,0,0,0,0,8, ldraw_lib__2_4disc(realsolid)],
// 1 16 -49 0 0 0 4 0 8 0 0 0 0 8 2-4cylc.dat
  [1,16,-49,0,0,0,4,0,8,0,0,0,0,8, ldraw_lib__2_4cylc(realsolid)],
// 1 16 -45 0 -20 0 -1 0 5 0 0 0 0 -5 2-4disc.dat
  [1,16,-45,0,-20,0,-1,0,5,0,0,0,0,-5, ldraw_lib__2_4disc(realsolid)],
// 1 16 -49 0 -20 0 4 0 5 0 0 0 0 -5 2-4cylc.dat
  [1,16,-49,0,-20,0,4,0,5,0,0,0,0,-5, ldraw_lib__2_4cylc(realsolid)],
// 1 16 -73 0 -20 0 24 0 4 0 0 0 0 4 4-4cylc.dat
  [1,16,-73,0,-20,0,24,0,4,0,0,0,0,4, ldraw_lib__4_4cylc(realsolid)],
// 
...
// 1 16 -47 6.5 -10 0 0 2 1.5 -1 0 10 0 0 rect2p.dat
  [1,16,-47,6.5,-10,0,0,2,1.5,-1,0,10,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -47 -6.5 -10 0 0 2 -1.5 1 0 10 0 0 rect2p.dat
  [1,16,-47,-6.5,-10,0,0,2,-1.5,1,0,10,0,0, ldraw_lib__rect2p(realsolid)],
// 
...
module ldraw_lib__635(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__635(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
