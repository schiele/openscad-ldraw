...
use <30259p01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4116859(realsolid=false) = [
...
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 30259p01.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30259p01(realsolid)],
];
module ldraw_lib__4116859(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4116859(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
