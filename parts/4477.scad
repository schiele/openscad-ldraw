...
// 1 16 80 4 0 1 0 0 0 -1 0 0 0 1 stud3.dat
  [1,16,80,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud3()],
...
// 1 16 0 8 0 96 0 0 0 -4 0 0 0 6 box5.dat
  [1,16,0,8,0,96,0,0,0,-4,0,0,0,6, ldraw_lib__box5()],
...
// 1 16 0 8 0 100 0 0 0 -8 0 0 0 10 box5.dat
  [1,16,0,8,0,100,0,0,0,-8,0,0,0,10, ldraw_lib__box5()],
...
module ldraw_lib__4477(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4477(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
