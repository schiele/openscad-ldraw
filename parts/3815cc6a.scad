...
use <3817pc6a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3815cc6a(realsolid=false) = [
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 3815pc6a.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3815pc6a(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3816pc6a.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816pc6a(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3817pc6a.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817pc6a(realsolid)],
];
module ldraw_lib__3815cc6a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3815cc6a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
