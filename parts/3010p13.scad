...
// 1 16 21.5 0 0 1 0 0 0 1 0 0 0 1 s\3010p12a.dat
  [1,16,21.5,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010p12a()],
...
module ldraw_lib__3010p13(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3010p13(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
