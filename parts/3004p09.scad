...
use <s/3004s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3004p09(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 3004pb144L, Car, Caterham, Cuusoo, Ideas, Set 21307
// 
...
module ldraw_lib__3004p09(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3004p09(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
