...
use <s/3001s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3001p04(realsolid=false) = [
...
// 1 4 0 -8 -20 1 0 0 0 1 0 0 0 1 s\3001p03s.dat
  [1,4,0,-8,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3001p03s(realsolid)],
// 1 4 0 -8 20 -1 0 0 0 1 0 0 0 -1 s\3001p03s.dat
  [1,4,0,-8,20,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3001p03s(realsolid)],
...
module ldraw_lib__3001p04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3001p04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
