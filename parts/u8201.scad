...
use <../p/stug-2x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u8201(realsolid=false) = [
...
// 1 16 0 8 0 76 0 0 0 -1 0 0 0 16 box4o4a.dat
  [1,16,0,8,0,76,0,0,0,-1,0,0,0,16, ldraw_lib__box4o4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -70 5.5 -10 6 0 0 0 -1.5 0 0 0 6 box3-3.dat
  [1,16,-70,5.5,-10,6,0,0,0,-1.5,0,0,0,6, ldraw_lib__box3_3(realsolid)],
...
// 1 16 -50 7 -10 6 0 0 0 -3 0 0 0 6 box4-1.dat
  [1,16,-50,7,-10,6,0,0,0,-3,0,0,0,6, ldraw_lib__box4_1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -50 7 10 6 0 0 0 -3 0 0 0 -6 box4-1.dat
  [1,16,-50,7,10,6,0,0,0,-3,0,0,0,-6, ldraw_lib__box4_1(realsolid)],
...
// 1 16 -30 7 -10 6 0 0 0 -3 0 0 0 6 box4-1.dat
  [1,16,-30,7,-10,6,0,0,0,-3,0,0,0,6, ldraw_lib__box4_1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -30 7 10 6 0 0 0 -3 0 0 0 -6 box4-1.dat
  [1,16,-30,7,10,6,0,0,0,-3,0,0,0,-6, ldraw_lib__box4_1(realsolid)],
...
// 1 16 -60 7 -10 0 0 4 0 -1 0 -6 0 0 rect1.dat
  [1,16,-60,7,-10,0,0,4,0,-1,0,-6,0,0, ldraw_lib__rect1(realsolid)],
// 1 16 -60 7 10 0 0 4 0 -1 0 6 0 0 rect1.dat
  [1,16,-60,7,10,0,0,4,0,-1,0,6,0,0, ldraw_lib__rect1(realsolid)],
// 1 16 -40 7 -10 0 0 4 0 -1 0 -6 0 0 rect1.dat
  [1,16,-40,7,-10,0,0,4,0,-1,0,-6,0,0, ldraw_lib__rect1(realsolid)],
// 1 16 -40 7 10 0 0 4 0 -1 0 6 0 0 rect1.dat
  [1,16,-40,7,10,0,0,4,0,-1,0,6,0,0, ldraw_lib__rect1(realsolid)],
...
module ldraw_lib__u8201(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8201(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
