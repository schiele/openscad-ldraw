...
// 1 16 0 -8 0 6 0 0 0 10 0 0 0 6 4-4cyli.dat
  [1,16,0,-8,0,6,0,0,0,10,0,0,0,6, ldraw_lib__4_4cyli()],
...
// 1 16 0 -8 0 4.5 0 0 0 11.5 0 0 0 4.5 4-4cyli.dat
  [1,16,0,-8,0,4.5,0,0,0,11.5,0,0,0,4.5, ldraw_lib__4_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -8 0 4.5 0 0 0 -4.5 0 0 0 4.5 4-8sphe.dat
  [1,16,0,-8,0,4.5,0,0,0,-4.5,0,0,0,4.5, ldraw_lib__4_8sphe()],
...
// 1 16 0 3.5 0 1.5 0 0 0 -1 0 0 0 1.5 4-4ring3.dat
  [1,16,0,3.5,0,1.5,0,0,0,-1,0,0,0,1.5, ldraw_lib__4_4ring3()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 3.5 0 6 0 0 0 3 0 0 0 6 4-4cyli.dat
  [1,16,0,3.5,0,6,0,0,0,3,0,0,0,6, ldraw_lib__4_4cyli()],
// 1 16 0 6.5 0 6 0 0 0 -1 0 0 0 6 4-4ndis.dat
  [1,16,0,6.5,0,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4ndis()],
...
// 1 16 0 2 0 8 0 0 0 4.5 0 0 0 8 box4.dat
  [1,16,0,2,0,8,0,0,0,4.5,0,0,0,8, ldraw_lib__box4()],
// 
...
// 1 16 0 3.5 0 4.5 0 0 0 1 0 0 0 4.5 4-4edge.dat
  [1,16,0,3.5,0,4.5,0,0,0,1,0,0,0,4.5, ldraw_lib__4_4edge()],
// 1 16 0 3.5 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,3.5,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 0 6.5 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,6.5,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
];
module ldraw_lib__4769(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4769(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
