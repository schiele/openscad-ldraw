...
use <s/u9147s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9147p02(realsolid=false) = [
// 0 ~Figure Fabuland Pig Head  2
// 0 Name: u9147p02.dat
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9147s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9147s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9147s03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9147s03(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9147s03.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9147s03(realsolid)],
// 
// 0 BFC INVERTNEXT
...
module ldraw_lib__u9147p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9147p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9147p02(line=0.2);