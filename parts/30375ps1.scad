...
use <s/30375s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30375ps1(realsolid=false) = [
...
// 0 !KEYWORDS minifig-scale, Star Wars, Trade Federation
// 
// 0 !CMDLINE -c487
// 
...
// 1 25 0 0 0 1 0 0 0 1 0 0 0 1 s\30375s02.dat
  [1,25,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30375s02(realsolid)],
...
module ldraw_lib__30375ps1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30375ps1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
