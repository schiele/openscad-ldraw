...
use <3820.scad>
use <973pc44.scad>
function ldraw_lib__76382pc44() = [
// 0 Minifig Torso with Arms and Hands with Skull and Red Roses Pattern
// 0 Name: 76382pc44.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973pc44.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973pc44()],
...
module ldraw_lib__76382pc44(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382pc44(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382pc44(line=0.2);