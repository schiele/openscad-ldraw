...
use <s/2525s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2525p40(realsolid=false) = [
...
// 1 16 2 0 140 1 0 0 0 1 0 0 0 -1 s\2525p40s03.dat
  [1,16,2,0,140,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__2525p40s03(realsolid)],
// 1 16 -2 0 140 -1 0 0 0 1 0 0 0 -1 s\2525p40s03.dat
  [1,16,-2,0,140,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__2525p40s03(realsolid)],
];
module ldraw_lib__2525p40(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2525p40(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
