...
use <../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__11032(realsolid=false) = [
...
// 1 494 0 -8.5 0 18 0 0 0 0 -8.5 0 38 0 box5.dat
  [1,494,0,-8.5,0,18,0,0,0,0,-8.5,0,38,0, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -8.5 0 15 0 0 0 0 -6.5 0 36 0 box5.dat
  [1,16,0,-8.5,0,15,0,0,0,0,-6.5,0,36,0, ldraw_lib__box5(realsolid)],
// 1 16 0 -10 36 12 0 0 0 0 2 0 -34 0 box5.dat
  [1,16,0,-10,36,12,0,0,0,0,2,0,-34,0, ldraw_lib__box5(realsolid)],
// 1 494 -3 -8 16 0 0 -2 0 0.2 0 12 0 0 box5.dat
  [1,494,-3,-8,16,0,0,-2,0,0.2,0,12,0,0, ldraw_lib__box5(realsolid)],
// 1 494 -9 -8 16 0 0 -2 0 0.2 0 12 0 0 box5.dat
  [1,494,-9,-8,16,0,0,-2,0,0.2,0,12,0,0, ldraw_lib__box5(realsolid)],
// 1 494 9 -8 16 0 0 -2 0 0.2 0 12 0 0 box5.dat
  [1,494,9,-8,16,0,0,-2,0,0.2,0,12,0,0, ldraw_lib__box5(realsolid)],
// 1 494 3 -8 16 0 0 -2 0 0.2 0 12 0 0 box5.dat
  [1,494,3,-8,16,0,0,-2,0,0.2,0,12,0,0, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__11032(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11032(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
