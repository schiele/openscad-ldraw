...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6005(realsolid=false) = [
...
// 1 16 0 12 -8 2 0 0 0 4 0 0 0 2 box5.dat
  [1,16,0,12,-8,2,0,0,0,4,0,0,0,2, ldraw_lib__box5(realsolid)],
...
// 1 16 10 36 -10 0 1 0 -20 0 0 0 0 -20 1-4edge.dat
  [1,16,10,36,-10,0,1,0,-20,0,0,0,0,-20, ldraw_lib__1_4edge(realsolid)],
// 1 16 6 36 -10 0 1 0 -20 0 0 0 0 -20 1-4edge.dat
  [1,16,6,36,-10,0,1,0,-20,0,0,0,0,-20, ldraw_lib__1_4edge(realsolid)],
// 1 16 -6 36 -10 0 1 0 -20 0 0 0 0 -20 1-4edge.dat
  [1,16,-6,36,-10,0,1,0,-20,0,0,0,0,-20, ldraw_lib__1_4edge(realsolid)],
// 1 16 -10 36 -10 0 1 0 -20 0 0 0 0 -20 1-4edge.dat
  [1,16,-10,36,-10,0,1,0,-20,0,0,0,0,-20, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 16 -12 -6 0 0 0 -1 0 0 0 -2 rect3.dat
  [1,16,0,16,-12,-6,0,0,0,-1,0,0,0,-2, ldraw_lib__rect3(realsolid)],
// 1 16 0 10.195 -14 -6 0 0 0 0 -5.805 0 1 0 rect3.dat
  [1,16,0,10.195,-14,-6,0,0,0,0,-5.805,0,1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 16 -2 6 0 0 0 -4 0 0 0 8 box5.dat
  [1,16,0,16,-2,6,0,0,0,-4,0,0,0,8, ldraw_lib__box5(realsolid)],
// 1 16 0 12 0 -10 0 0 0 -4 0 0 0 10 box2-5.dat
  [1,16,0,12,0,-10,0,0,0,-4,0,0,0,10, ldraw_lib__box2_5(realsolid)],
...
// 1 16 0 42 -30 10 0 0 0 0 6 0 -1 0 rect3.dat
  [1,16,0,42,-30,10,0,0,0,0,6,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 23.035 -30 -6 0 0 0 0 -12.965 0 -1 0 rect3.dat
  [1,16,0,23.035,-30,-6,0,0,0,0,-12.965,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 30.67 -34 6 0 0 0 0 -17.33 0 1 0 rect.dat
  [1,16,0,30.67,-34,6,0,0,0,0,-17.33,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 44 -46 6 0 0 0 0 4 0 -1 0 rect3.dat
  [1,16,0,44,-46,6,0,0,0,0,4,0,-1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 10 36 -10 0 -4 0 -20 0 0 0 0 -20 1-4cyli.dat
  [1,16,10,36,-10,0,-4,0,-20,0,0,0,0,-20, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -10 36 -10 0 4 0 -20 0 0 0 0 -20 1-4cyli.dat
  [1,16,-10,36,-10,0,4,0,-20,0,0,0,0,-20, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 10 12 0 0 -1 0 4 0 0 0 0 -10 rect1.dat
  [1,16,10,12,0,0,-1,0,4,0,0,0,0,-10, ldraw_lib__rect1(realsolid)],
// 1 16 -10 12 0 0 1 0 4 0 0 0 0 10 rect1.dat
  [1,16,-10,12,0,0,1,0,4,0,0,0,0,10, ldraw_lib__rect1(realsolid)],
...
// 1 16 10 36 -10 0 -1 0 -20 0 0 0 0 -20 1-4ndis.dat
  [1,16,10,36,-10,0,-1,0,-20,0,0,0,0,-20, ldraw_lib__1_4ndis(realsolid)],
// 1 16 6 36 -10 0 1 0 -20 0 0 0 0 -20 1-4ndis.dat
  [1,16,6,36,-10,0,1,0,-20,0,0,0,0,-20, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -6 36 -10 0 -1 0 -20 0 0 0 0 -20 1-4ndis.dat
  [1,16,-6,36,-10,0,-1,0,-20,0,0,0,0,-20, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -10 36 -10 0 1 0 -20 0 0 0 0 -20 1-4ndis.dat
  [1,16,-10,36,-10,0,1,0,-20,0,0,0,0,-20, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 10 40 -10 0 -1 0 -4 0 0 0 0 -4 48\1-4ring9.dat
  [1,16,10,40,-10,0,-1,0,-4,0,0,0,0,-4, ldraw_lib__48__1_4ring9(realsolid)],
// 1 16 -10 40 -10 0 1 0 -4 0 0 0 0 -4 48\1-4ring9.dat
  [1,16,-10,40,-10,0,1,0,-4,0,0,0,0,-4, ldraw_lib__48__1_4ring9(realsolid)],
...
module ldraw_lib__6005(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6005(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
