...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3009pb107, Rebrickable 3009pr0068, Set 113-2-DBASE
// 
...
// 1 15 0 0.4 0 1.025 0 0 0 0.98 0 0 0 1 s\3009pt5a.dat
  [1,15,0,0.4,0,1.025,0,0,0,0.98,0,0,0,1, ldraw_lib__s__3009pt5a()],
// 1 16 0 0.4 0 1.025 0 0 0 0.98 0 0 0 1 s\3009pt5b.dat
  [1,16,0,0.4,0,1.025,0,0,0,0.98,0,0,0,1, ldraw_lib__s__3009pt5b()],
];
module ldraw_lib__3009pt6(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3009pt6(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
