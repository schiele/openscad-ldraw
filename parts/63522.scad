...
use <s/58124s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__63522(realsolid=false) = [
...
// 1 72 0 0 0 1 0 0 0 1 0 0 0 1 64051.dat
  [1,72,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__64051(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 64053.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__64053(realsolid)],
...
module ldraw_lib__63522(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__63522(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
