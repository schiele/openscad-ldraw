...
use <s/71682s02.scad>
function ldraw_lib__71682pt1() = [
// 0 Technic Panel Curved  3 x  2 x  1 with Ferrari Logo Right Pattern
// 0 Name: 71682pt1.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 71682pb005L, Daytona, Ferrari, Rebrickable 71682pr0007
...
module ldraw_lib__71682pt1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__71682pt1(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__71682pt1(line=0.2);