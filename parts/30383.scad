...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30383(realsolid=false) = [
...
// 1 16 -10 8 0 0 0 -10 0 -8 0 10 0 0 box4-4a.dat
  [1,16,-10,8,0,0,0,-10,0,-8,0,10,0,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 0 0.5 0 0 -1 0 0 0 -0.5 10 0 0 rect.dat
  [1,16,0,0.5,0,0,-1,0,0,0,-0.5,10,0,0, ldraw_lib__rect(realsolid)],
// 1 16 10 8 0 0 0 10 0 -7 0 -10 0 0 box4-4a.dat
  [1,16,10,8,0,0,0,10,0,-7,0,-10,0,0, ldraw_lib__box4_4a(realsolid)],
...
// 1 16 10 1 0 0 0 1 0 1 0 -1 0 0 clh2.dat
  [1,16,10,1,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__clh2(realsolid)],
// 1 16 -10 0 0 -1 0 0 0 1 0 0 0 -1 stud.dat
  [1,16,-10,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__stud(realsolid)],
// 0
];
module ldraw_lib__30383(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30383(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__30383(line=0.2);