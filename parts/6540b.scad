...
use <s/6540s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6540b(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\6540s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6540s01(realsolid)],
// 1 16 70 0 20 1 0 0 0 -1 0 0 0 1 connhole.dat
  [1,16,70,0,20,1,0,0,0,-1,0,0,0,1, ldraw_lib__connhole(realsolid)],
// 1 16 70 10 20 9 0 0 0 -20 0 0 0 9 4-4cylo.dat
  [1,16,70,10,20,9,0,0,0,-20,0,0,0,9, ldraw_lib__4_4cylo(realsolid)],
// 1 16 70 4 20 0 0 -9 0 -1 0 9 0 0 1-8edge.dat
  [1,16,70,4,20,0,0,-9,0,-1,0,9,0,0, ldraw_lib__1_8edge(realsolid)],
// 1 16 70 -4 20 0 0 -9 0 -1 0 9 0 0 1-8edge.dat
  [1,16,70,-4,20,0,0,-9,0,-1,0,9,0,0, ldraw_lib__1_8edge(realsolid)],
// 1 16 70 2 20 -6.36396 0 -6.36396 0 -1 0 6.36396 0 -6.36396 3-16edge.dat
  [1,16,70,2,20,-6.36396,0,-6.36396,0,-1,0,6.36396,0,-6.36396, ldraw_lib__3_16edge(realsolid)],
// 1 16 70 -2 20 -6.36396 0 -6.36396 0 -1 0 6.36396 0 -6.36396 3-16edge.dat
  [1,16,70,-2,20,-6.36396,0,-6.36396,0,-1,0,6.36396,0,-6.36396, ldraw_lib__3_16edge(realsolid)],
// 1 16 70 4 20 0 0 -9 0 -1 0 -9 0 0 3-16edge.dat
  [1,16,70,4,20,0,0,-9,0,-1,0,-9,0,0, ldraw_lib__3_16edge(realsolid)],
// 1 16 70 -4 20 0 0 -9 0 -1 0 -9 0 0 3-16edge.dat
  [1,16,70,-4,20,0,0,-9,0,-1,0,-9,0,0, ldraw_lib__3_16edge(realsolid)],
...
module ldraw_lib__6540b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6540b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
