...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__11236(realsolid=false) = [
...
// 1 16 23.5 2 4.5 -3.5 -1 0 0 0 -2 3.5 -1 0 rect.dat
  [1,16,23.5,2,4.5,-3.5,-1,0,0,0,-2,3.5,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 2 8 0 0 -20 2 0 0 0 -1 0 rect3.dat
  [1,16,0,2,8,0,0,-20,2,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 -23.5 2 4.5 0 1 -3.5 2 0 0 0 -1 -3.5 rect3.dat
  [1,16,-23.5,2,4.5,0,1,-3.5,2,0,0,0,-1,-3.5, ldraw_lib__rect3(realsolid)],
// 4 16 20 0 8 -20 0 8 -27 0 1 27 0 1
  [4,16,20,0,8,-20,0,8,-27,0,1,27,0,1],
// 4 16 27 4 1 -27 4 1 -20 4 8 20 4 8
  [4,16,27,4,1,-27,4,1,-20,4,8,20,4,8],
// 1 16 0 2 1 -27 0 0 0 0 2 0 -11 0 box5-4a.dat
  [1,16,0,2,1,-27,0,0,0,0,2,0,-11,0, ldraw_lib__box5_4a(realsolid)],
];
module ldraw_lib__11236(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11236(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
