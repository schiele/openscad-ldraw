...
use <s/2641s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2641a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2641s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2641s01(realsolid)],
// 0 // moved from 2641a
...
// 1 16 45.07 6 30.93 0 0 10.93 -2 0 0 0 -10.93 0 box2-5.dat
  [1,16,45.07,6,30.93,0,0,10.93,-2,0,0,0,-10.93,0, ldraw_lib__box2_5(realsolid)],
...
// 1 16 49 8 10 0 0 7 0 -4 0 6 0 0 box4-4a.dat
  [1,16,49,8,10,0,0,7,0,-4,0,6,0,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 42 6 13.75 0 -1 0 2 0 0 0 0 2.25 rect.dat
  [1,16,42,6,13.75,0,-1,0,2,0,0,0,0,2.25, ldraw_lib__rect(realsolid)],
// 1 16 43 4 10 0 0 1 0 4 0 -1.5 0 0 box4-4a.dat
  [1,16,43,4,10,0,0,1,0,4,0,-1.5,0,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 42 6 6.25 0 -1 0 2 0 0 0 0 2.25 rect.dat
  [1,16,42,6,6.25,0,-1,0,2,0,0,0,0,2.25, ldraw_lib__rect(realsolid)],
// 
// 1 16 38 6 13.75 0 1 0 2 0 0 0 0 -2.25 rect3.dat
  [1,16,38,6,13.75,0,1,0,2,0,0,0,0,-2.25, ldraw_lib__rect3(realsolid)],
// 1 16 37 4 10 0 0 -1 0 4 0 1.5 0 0 box4-4a.dat
  [1,16,37,4,10,0,0,-1,0,4,0,1.5,0,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 38 6 6.25 0 1 0 2 0 0 0 0 2.25 rect3.dat
  [1,16,38,6,6.25,0,1,0,2,0,0,0,0,2.25, ldraw_lib__rect3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 30 8 10 8 0 0 0 -4 0 0 0 -6 box3u4p.dat
  [1,16,30,8,10,8,0,0,0,-4,0,0,0,-6, ldraw_lib__box3u4p(realsolid)],
// 1 16 22 6 13.75 0 -1 0 2 0 0 0 0 -2.25 rect3.dat
  [1,16,22,6,13.75,0,-1,0,2,0,0,0,0,-2.25, ldraw_lib__rect3(realsolid)],
// 1 16 23 4 10 0 0 1 0 4 0 -1.5 0 0 box4-4a.dat
  [1,16,23,4,10,0,0,1,0,4,0,-1.5,0,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 22 6 6.25 0 -1 0 2 0 0 0 0 2.25 rect3.dat
  [1,16,22,6,6.25,0,-1,0,2,0,0,0,0,2.25, ldraw_lib__rect3(realsolid)],
// 
// 1 16 18 6 13.75 0 1 0 2 0 0 0 0 -2.25 rect3.dat
  [1,16,18,6,13.75,0,1,0,2,0,0,0,0,-2.25, ldraw_lib__rect3(realsolid)],
// 1 16 17 4 10 0 0 -1 0 4 0 1.5 0 0 box4-4a.dat
  [1,16,17,4,10,0,0,-1,0,4,0,1.5,0,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 18 6 6.25 0 1 0 2 0 0 0 0 2.25 rect3.dat
  [1,16,18,6,6.25,0,1,0,2,0,0,0,0,2.25, ldraw_lib__rect3(realsolid)],
// 
// 1 16 17 6 17 0 0 -1 2 0 0 0 -1 0 box2-5.dat
  [1,16,17,6,17,0,0,-1,2,0,0,0,-1,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 11 6 11 0 0 -7 2 0 0 0 -7 0 box2-5.dat
  [1,16,11,6,11,0,0,-7,2,0,0,0,-7,0, ldraw_lib__box2_5(realsolid)],
...
// 1 16 30.93 6 45.07 0 0 -10.93 -2 0 0 0 10.93 0 box2-5.dat
  [1,16,30.93,6,45.07,0,0,-10.93,-2,0,0,0,10.93,0, ldraw_lib__box2_5(realsolid)],
...
// 1 16 10 8 49 6 0 0 0 -4 0 0 0 7 box4-4a.dat
  [1,16,10,8,49,6,0,0,0,-4,0,0,0,7, ldraw_lib__box4_4a(realsolid)],
// 1 16 13.75 6 42 0 0 2.25 -2 0 0 0 -1 0 rect.dat
  [1,16,13.75,6,42,0,0,2.25,-2,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 10 4 43 1.5 0 0 0 4 0 0 0 1 box4-4a.dat
  [1,16,10,4,43,1.5,0,0,0,4,0,0,0,1, ldraw_lib__box4_4a(realsolid)],
// 1 16 6.25 6 42 0 0 2.25 2 0 0 0 -1 0 rect.dat
  [1,16,6.25,6,42,0,0,2.25,2,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 
// 1 16 13.75 6 38 0 0 -2.25 -2 0 0 0 1 0 rect3.dat
  [1,16,13.75,6,38,0,0,-2.25,-2,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 10 4 37 -1.5 0 0 0 4 0 0 0 -1 box4-4a.dat
  [1,16,10,4,37,-1.5,0,0,0,4,0,0,0,-1, ldraw_lib__box4_4a(realsolid)],
// 1 16 6.25 6 38 0 0 2.25 2 0 0 0 1 0 rect3.dat
  [1,16,6.25,6,38,0,0,2.25,2,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 8 30 0 0 6 0 -4 0 8 0 0 box3u4p.dat
  [1,16,10,8,30,0,0,6,0,-4,0,8,0,0, ldraw_lib__box3u4p(realsolid)],
// 1 16 13.75 6 22 0 0 -2.25 2 0 0 0 -1 0 rect3.dat
  [1,16,13.75,6,22,0,0,-2.25,2,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 10 4 23 1.5 0 0 0 4 0 0 0 1 box4-4a.dat
  [1,16,10,4,23,1.5,0,0,0,4,0,0,0,1, ldraw_lib__box4_4a(realsolid)],
// 1 16 6.25 6 22 0 0 2.25 2 0 0 0 -1 0 rect3.dat
  [1,16,6.25,6,22,0,0,2.25,2,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
// 
// 1 16 13.75 6 18 0 0 -2.25 2 0 0 0 1 0 rect3.dat
  [1,16,13.75,6,18,0,0,-2.25,2,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 10 4 17 -1.5 0 0 0 4 0 0 0 -1 box4-4a.dat
  [1,16,10,4,17,-1.5,0,0,0,4,0,0,0,-1, ldraw_lib__box4_4a(realsolid)],
// 1 16 6.25 6 18 0 0 2.25 2 0 0 0 1 0 rect3.dat
  [1,16,6.25,6,18,0,0,2.25,2,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 
...
// 1 16 24.24 6 24.24 0 0 -4.24 -2 0 0 0 -4.24 0 box2-5.dat
  [1,16,24.24,6,24.24,0,0,-4.24,-2,0,0,0,-4.24,0, ldraw_lib__box2_5(realsolid)],
...
module ldraw_lib__2641a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2641a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
