...
$fa=1; $fs=0.2;
function ldraw_lib__2574a(realsolid=false) = [
...
// 1 16 0 16 10 1 0 0 0 -1 0 0 0 1 stug4-3x3.dat
  [1,16,0,16,10,1,0,0,0,-1,0,0,0,1, ldraw_lib__stug4_3x3(realsolid)],
// 1 16 0 16 50 1 0 0 0 -1 0 0 0 1 stug4-1x3.dat
  [1,16,0,16,50,1,0,0,0,-1,0,0,0,1, ldraw_lib__stug4_1x3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 20 20 0 0 36 0 -4 0 -46 0 0 box5.dat
  [1,16,0,20,20,0,0,36,0,-4,0,-46,0,0, ldraw_lib__box5(realsolid)],
// 1 16 0 10 20 40 0 0 0 10 0 0 0 50 box0.dat
  [1,16,0,10,20,40,0,0,0,10,0,0,0,50, ldraw_lib__box0(realsolid)],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 40 6 50 0 -4 0 4 0 0 0 0 4 4-4cylo.dat
  [1,16,40,6,50,0,-4,0,4,0,0,0,0,4, ldraw_lib__4_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -40 6 50 0 4 0 4 0 0 0 0 4 4-4cylo.dat
  [1,16,-40,6,50,0,4,0,4,0,0,0,0,4, ldraw_lib__4_4cylo(realsolid)],
...
// 1 16 0 0 20 36 0 0 0 12 0 0 0 46 box3u2p.dat
  [1,16,0,0,20,36,0,0,0,12,0,0,0,46, ldraw_lib__box3u2p(realsolid)],
// 
...
// 1 16 40 6 50 0 -1 0 4 0 0 0 0 4 4-4ndis.dat
  [1,16,40,6,50,0,-1,0,4,0,0,0,0,4, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 36 6 50 0 1 0 4 0 0 0 0 4 4-4ndis.dat
  [1,16,36,6,50,0,1,0,4,0,0,0,0,4, ldraw_lib__4_4ndis(realsolid)],
...
module ldraw_lib__2574a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2574a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
