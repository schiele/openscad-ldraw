...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__60808(realsolid=false) = [
...
// 1 16 0 120 0 0 0 40 0 -120 0 10 0 0 box3u4a.dat
  [1,16,0,120,0,0,0,40,0,-120,0,10,0,0, ldraw_lib__box3u4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 58 10 -36 0 0 0 0 -54 0 -18 0 box4.dat
  [1,16,0,58,10,-36,0,0,0,0,-54,0,-18,0, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 34 -9 0 0 -10 0 30 0 1 0 0 box3u4a.dat
  [1,16,0,34,-9,0,0,-10,0,30,0,1,0,0, ldraw_lib__box3u4a(realsolid)],
// 
...
// 1 16 0 34 -10 10 0 0 0 0 -10 0 2 0 2-4cyli.dat
  [1,16,0,34,-10,10,0,0,0,0,-10,0,2,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 34 -10 10 0 0 0 0 -10 0 2 0 2-4ndis.dat
  [1,16,0,34,-10,10,0,0,0,0,-10,0,2,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 34 -8 -10 0 0 0 0 -10 0 -2 0 2-4ndis.dat
  [1,16,0,34,-8,-10,0,0,0,0,-10,0,-2,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 34 -8 10 0 0 0 0 -10 0 2 0 2-4edge.dat
  [1,16,0,34,-8,10,0,0,0,0,-10,0,2,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 34 -10 10 0 0 0 0 -10 0 2 0 2-4edge.dat
  [1,16,0,34,-10,10,0,0,0,0,-10,0,2,0, ldraw_lib__2_4edge(realsolid)],
];
module ldraw_lib__60808(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__60808(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
