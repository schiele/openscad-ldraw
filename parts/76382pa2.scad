...
use <3820.scad>
use <973pa2.scad>
function ldraw_lib__76382pa2() = [
// 0 Minifig Torso with Arms and Hands with Pharaoh Breastplate Pattern
// 0 Name: 76382pa2.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973pa2.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973pa2()],
...
module ldraw_lib__76382pa2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382pa2(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382pa2(line=0.2);