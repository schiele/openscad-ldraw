...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__1(realsolid=false) = [
...
// 1 16 0 96 0 40 0 0 0 -96 0 0 0 20 box4-1.dat
  [1,16,0,96,0,40,0,0,0,-96,0,0,0,20, ldraw_lib__box4_1(realsolid)],
// 1 16 20 92 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,20,92,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
// 1 16 0 96 0 36 0 0 0 -4 0 0 0 16 box5.dat
  [1,16,0,96,0,36,0,0,0,-4,0,0,0,16, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 24 -20 36 0 0 0 0 20 0 36 0 box5.dat
  [1,16,0,24,-20,36,0,0,0,0,20,0,36,0, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 68 -20 36 0 0 0 0 20 0 36 0 box5.dat
  [1,16,0,68,-20,36,0,0,0,0,20,0,36,0, ldraw_lib__box5(realsolid)],
// 0
];
module ldraw_lib__1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
