...
use <4215a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4215ad03(realsolid=false) = [
...
// 1 16 0 36 10 -1 0 0 0 0 -1 0 -1 0 195075b.dat
  [1,16,0,36,10,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__195075b(realsolid)],
];
module ldraw_lib__4215ad03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4215ad03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
