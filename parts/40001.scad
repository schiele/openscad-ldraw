...
use <../p/stud2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__40001(realsolid=false) = [
...
// 1 16 0 2 0 1 0 0 0 17 0 0 0 -1 axl2hol8.dat
  [1,16,0,2,0,1,0,0,0,17,0,0,0,-1, ldraw_lib__axl2hol8(realsolid)],
// 1 16 0 2 0 1 0 0 0 1 0 0 0 -1 axl2ho10.dat
  [1,16,0,2,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__axl2ho10(realsolid)],
// 1 16 0 19 0 1 0 0 0 -1 0 0 0 -1 axl2hol3.dat
  [1,16,0,19,0,1,0,0,0,-1,0,0,0,-1, ldraw_lib__axl2hol3(realsolid)],
...
// 1 16 0 19 0 1 0 0 0 -1 0 0 0 -1 axl2ho10.dat
  [1,16,0,19,0,1,0,0,0,-1,0,0,0,-1, ldraw_lib__axl2ho10(realsolid)],
// 1 16 0 2 0 1 0 0 0 -1 0 0 0 -1 axl2hol9.dat
  [1,16,0,2,0,1,0,0,0,-1,0,0,0,-1, ldraw_lib__axl2hol9(realsolid)],
...
module ldraw_lib__40001(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__40001(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
