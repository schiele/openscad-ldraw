...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 4347, Rebrickable 4347
// 
// 0 !HISTORY 2010-07-05 [PTadmin] Official Update 2010-02
// 
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 4347.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4347()],
// 1 47 0 58 -4 1 0 0 0 1 0 0 0 1 954.dat
  [1,47,0,58,-4,1,0,0,0,1,0,0,0,1, ldraw_lib__954()],
// 0
];
module ldraw_lib__4347c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4347c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
