...
use <3817phb.scad>
$fa=1; $fs=0.2;
function ldraw_lib__972phb(realsolid=false) = [
// 0 ~Moved to 3817phb
// 0 Name: 972phb.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3817phb.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817phb(realsolid)],
];
module ldraw_lib__972phb(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__972phb(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
