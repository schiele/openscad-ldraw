...
function ldraw_lib__u9142p01c10() = [
...
// 1 15 0 -67 4 1 0 0 0 1 0 0 0 1 u9142p01c01.dat
  [1,15,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u9142p01c01()],
...
module ldraw_lib__u9142p01c10(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9142p01c10(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
