...
use <318.scad>
$fa=1; $fs=0.2;
function ldraw_lib__304c06(realsolid=false) = [
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 304.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__304(realsolid)],
// 1 1 -80 0 0 1 0 0 0 1 0 0 0 1 317.dat
  [1,1,-80,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__317(realsolid)],
// 1 1 -80 0 0 1 0 0 0 1 0 0 0 -1 317.dat
  [1,1,-80,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__317(realsolid)],
// 1 1 0 4 0 1 0 0 0 0.707107 0.707107 0 -0.707107 0.707107 316.dat
  [1,1,0,4,0,1,0,0,0,0.707107,0.707107,0,-0.707107,0.707107, ldraw_lib__316(realsolid)],
// 1 1 30 -14 0 0 0 1 0 1 0 1 0 0 318.dat
  [1,1,30,-14,0,0,0,1,0,1,0,1,0,0, ldraw_lib__318(realsolid)],
...
module ldraw_lib__304c06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__304c06(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__304c06(line=0.2);