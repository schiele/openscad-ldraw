...
use <../p/stud4o.scad>
$fa=1; $fs=0.2;
function ldraw_lib__25971p01(realsolid=false) = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\25971p01s01.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__25971p01s01(realsolid)],
// 1 15 0 0 0 -1 0 0 0 1 0 0 0 1 s\25971p01s01.dat
  [1,15,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__25971p01s01(realsolid)],
// 1 25 0 0 0 1 0 0 0 1 0 0 0 1 s\25971s04.dat
  [1,25,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__25971s04(realsolid)],
// 1 25 0 0 0 -1 0 0 0 1 0 0 0 1 s\25971s04.dat
  [1,25,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__25971s04(realsolid)],
];
module ldraw_lib__25971p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__25971p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
