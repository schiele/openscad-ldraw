...
// 1 16 0 0 -4.3848 1 0 0 0 1 0 0 0 1 s\6009254as01.dat
  [1,16,0,0,-4.3848,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6009254as01()],
// 1 16 0 0 -4.3848 1 0 0 0 1 0 0 0 1 s\6009254as02.dat
  [1,16,0,0,-4.3848,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6009254as02()],
...
module ldraw_lib__6009254a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6009254a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
