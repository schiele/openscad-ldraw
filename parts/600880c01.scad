...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\600880c01s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__600880c01s02()],
// 1 16 -14.5 22 5.75 0 -4.5 -6 0 -22 0 6 4.5 0 1-4con0.dat
  [1,16,-14.5,22,5.75,0,-4.5,-6,0,-22,0,6,4.5,0, ldraw_lib__1_4con0()],
...
module ldraw_lib__600880c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__600880c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
