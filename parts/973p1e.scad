...
use <s/973s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973p1e(realsolid=false) = [
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\973p15a.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p15a(realsolid)],
// 0 Pattern background in default colour
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\973p15b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p15b(realsolid)],
// 0
];
module ldraw_lib__973p1e(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p1e(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
