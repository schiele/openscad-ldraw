...
use <../p/stug-9x9.scad>
$fa=1; $fs=0.2;
function ldraw_lib__10p0b(realsolid=false) = [
...
// 1 16 -230 0 180 1 0 0 0 1 0 0 0 1 stug-4x1.dat
  [1,16,-230,0,180,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x1(realsolid)],
// 1 16 -280 0 100 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,-280,0,100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4(realsolid)],
// 1 16 -280 0 180 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,-280,0,180,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4(realsolid)],
...
// 1 16 -60 0 200 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,-60,0,200,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4(realsolid)],
// 1 16 20 0 200 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,20,0,200,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4(realsolid)],
// 1 16 100 0 200 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,100,0,200,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4(realsolid)],
...
// 1 16 270 0 230 1 0 0 0 1 0 0 0 1 stug-1x3.dat
  [1,16,270,0,230,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x3(realsolid)],
// 1 16 280 0 180 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,280,0,180,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4(realsolid)],
// 1 16 280 0 100 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,280,0,100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4(realsolid)],
// 1 16 220 0 130 1 0 0 0 1 0 0 0 1 stug-1x2.dat
  [1,16,220,0,130,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x2(realsolid)],
// 1 16 220 0 70 1 0 0 0 1 0 0 0 1 stug-1x2.dat
  [1,16,220,0,70,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x2(realsolid)],
...
// 1 16 -210 0 50 1 0 0 0 1 0 0 0 1 stug-1x11.dat
  [1,16,-210,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x11(realsolid)],
...
// 1 16 270 0 -90 1 0 0 0 1 0 0 0 1 stug-5x5.dat
  [1,16,270,0,-90,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_5x5(realsolid)],
// 1 16 180 0 50 1 0 0 0 1 0 0 0 1 stug-1x4.dat
  [1,16,180,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x4(realsolid)],
// 1 16 -40 0 100 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,-40,0,100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4(realsolid)],
...
// 1 16 60 0 130 1 0 0 0 1 0 0 0 1 stug-1x6.dat
  [1,16,60,0,130,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x6(realsolid)],
// 1 16 120 0 110 1 0 0 0 1 0 0 0 1 stug-1x6.dat
  [1,16,120,0,110,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x6(realsolid)],
// 1 16 150 0 90 1 0 0 0 1 0 0 0 1 stug-1x3.dat
  [1,16,150,0,90,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x3(realsolid)],
...
// 1 16 -50 0 150 1 0 0 0 1 0 0 0 1 studp01.dat
  [1,16,-50,0,150,1,0,0,0,1,0,0,0,1, ldraw_lib__studp01(realsolid)],
...
module ldraw_lib__10p0b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__10p0b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
