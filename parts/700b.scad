...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__700b(realsolid=false) = [
...
// 0 !HISTORY 2008-07-07 [PTadmin] Renamed from 700 (2004-07-26)
// 0 !HISTORY 2010-04-05 [PTadmin] Official Update 2010-01
// 
// 
// 1 16 -180 4 -80 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-180,4,-80,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -160 4 -80 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-160,4,-80,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -140 4 -80 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-140,4,-80,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -120 4 -80 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-120,4,-80,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -100 4 -80 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-100,4,-80,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -80 4 -80 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-80,4,-80,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -60 4 -80 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-60,4,-80,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -40 4 -80 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-40,4,-80,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -20 4 -80 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-20,4,-80,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 0 4 -80 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,0,4,-80,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 20 4 -80 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,20,4,-80,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 40 4 -80 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,40,4,-80,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
// 1 16 -180 4 -60 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-180,4,-60,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 180 4 -60 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,180,4,-60,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -180 4 -40 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-180,4,-40,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 180 4 -40 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,180,4,-40,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -180 4 -20 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-180,4,-20,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 180 4 -20 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,180,4,-20,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -180 4 0 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-180,4,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 180 4 0 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,180,4,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -180 4 20 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-180,4,20,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
module ldraw_lib__700b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__700b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__700b(line=0.2);