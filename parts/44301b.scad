...
use <s/44301s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__44301b(realsolid=false) = [
...
// 1 16 20 4 0 0 -40 0 -4 0 0 0 0 -10 box3u7a.dat
  [1,16,20,4,0,0,-40,0,-4,0,0,0,0,-10, ldraw_lib__box3u7a(realsolid)],
...
module ldraw_lib__44301b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__44301b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
