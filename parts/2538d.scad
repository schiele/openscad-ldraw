...
use <../p/4-8sphe.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2538d(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2538c.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2538c(realsolid)],
// 0 // added knobs in c version
// 1 16 -16 -6 0 0 -2 0 0 0 -2 2 0 0 4-8sphe.dat
  [1,16,-16,-6,0,0,-2,0,0,0,-2,2,0,0, ldraw_lib__4_8sphe(realsolid)],
// 1 16 -16 -6 0 0 2.5 0 0 0 -2 2 0 0 4-4cyli.dat
  [1,16,-16,-6,0,0,2.5,0,0,0,-2,2,0,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -13.945 -6 0 -.02 -1 .4 2 0 0 0 0 -2 2-4edge.dat
  [1,16,-13.945,-6,0,-.02,-1,.4,2,0,0,0,0,-2, ldraw_lib__2_4edge(realsolid)],
// 1 16 -13.945 -6 0 -.02 -1 .4 2 0 0 0 0 2 2-4edge.dat
  [1,16,-13.945,-6,0,-.02,-1,.4,2,0,0,0,0,2, ldraw_lib__2_4edge(realsolid)],
// 1 16 16 -6 0 0 -2.5 0 0 0 -2 -2 0 0 4-4cyli.dat
  [1,16,16,-6,0,0,-2.5,0,0,0,-2,-2,0,0, ldraw_lib__4_4cyli(realsolid)],
...
module ldraw_lib__2538d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2538d(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
