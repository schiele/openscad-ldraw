...
use <../p/stug4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__710(realsolid=false) = [
...
// 1 16 -110 0 0 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,-110,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4(realsolid)],
// 1 16 -30 0 20 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,-30,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4(realsolid)],
// 1 16 50 0 0 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,50,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4(realsolid)],
// 1 16 130 0 0 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,130,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4(realsolid)],
// 1 16 -50 0 -40 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-50,0,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2(realsolid)],
// 1 16 -10 0 -40 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-10,0,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2(realsolid)],
// 1 16 -160 0 -50 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-160,0,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 20 0 -50 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,20,0,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 40 0 -50 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,40,0,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 140 0 -50 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,140,0,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 160 0 -50 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,160,0,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 -160 0 50 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-160,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 -160 0 30 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-160,0,30,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 -160 0 10 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-160,0,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 -160 0 -10 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-160,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 -160 0 -30 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-160,0,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
...
// 1 16 -50 4 -40 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-50,4,-40,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -30 4 -40 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-30,4,-40,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
// 1 16 150 4 -40 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,150,4,-40,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -150 4 -20 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-150,4,-20,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -130 4 -20 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-130,4,-20,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -110 4 -20 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-110,4,-20,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -90 4 -20 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-90,4,-20,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
// 1 16 -150 4 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-150,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -130 4 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-130,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -110 4 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-110,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -90 4 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-90,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -70 4 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-70,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -50 4 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-50,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -30 4 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-30,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
// 1 16 -10 0 0 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,-10,0,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge(realsolid)],
// 1 16 -10 0 0 8 0 0 0 1 0 0 0 8 4-4ndis.dat
  [1,16,-10,0,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -10 0 0 8 0 0 0 4 0 0 0 8 4-4cyli.dat
  [1,16,-10,0,0,8,0,0,0,4,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 -10 4 0 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,-10,4,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge(realsolid)],
// 1 16 -10 4 0 8 0 0 0 -1 0 0 0 8 4-4ndis.dat
  [1,16,-10,4,0,8,0,0,0,-1,0,0,0,8, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 90 4 -60 0 0 -40 4 0 0 0 20 0 box3u2p.dat
  [1,16,90,4,-60,0,0,-40,4,0,0,0,20,0, ldraw_lib__box3u2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 90 4 60 0 0 40 4 0 0 0 -20 0 box3u2p.dat
  [1,16,90,4,60,0,0,40,4,0,0,0,-20,0, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 -110 4 -60 0 0 -40 4 0 0 0 20 0 box3u2p.dat
  [1,16,-110,4,-60,0,0,-40,4,0,0,0,20,0, ldraw_lib__box3u2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -110 4 60 0 0 40 4 0 0 0 -20 0 box3u2p.dat
  [1,16,-110,4,60,0,0,40,4,0,0,0,-20,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 -110 6 56 0 0 44 2 0 0 0 -20 0 box3u2p.dat
  [1,16,-110,6,56,0,0,44,2,0,0,0,-20,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 -110 6 -56 0 0 -44 2 0 0 0 20 0 box3u2p.dat
  [1,16,-110,6,-56,0,0,-44,2,0,0,0,20,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 90 6 56 0 0 44 2 0 0 0 -20 0 box3u2p.dat
  [1,16,90,6,56,0,0,44,2,0,0,0,-20,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 90 6 -56 0 0 -44 2 0 0 0 20 0 box3u2p.dat
  [1,16,90,6,-56,0,0,-44,2,0,0,0,20,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 150 8 0 0 0 20 0 -8 0 -60 0 0 box4-4a.dat
  [1,16,150,8,0,0,0,20,0,-8,0,-60,0,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 -160 8 0 0 0 -10 0 -8 0 60 0 0 box4-4a.dat
  [1,16,-160,8,0,0,0,-10,0,-8,0,60,0,0, ldraw_lib__box4_4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -160 8 0 0 0 -6 0 -4 0 56 0 0 box4-4a.dat
  [1,16,-160,8,0,0,0,-6,0,-4,0,56,0,0, ldraw_lib__box4_4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 150 8 0 0 0 16 0 -4 0 -56 0 0 box4-4a.dat
  [1,16,150,8,0,0,0,16,0,-4,0,-56,0,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 -10 4 60 -60 0 0 0 0 -4 0 -1 0 rect2p.dat
  [1,16,-10,4,60,-60,0,0,0,0,-4,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -10 4 -60 -60 0 0 0 0 4 0 1 0 rect2p.dat
  [1,16,-10,4,-60,-60,0,0,0,0,4,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -10 6 -56 -56 0 0 0 0 -2 0 -1 0 rect2p.dat
  [1,16,-10,6,-56,-56,0,0,0,0,-2,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -10 6 56 -56 0 0 0 0 2 0 1 0 rect2p.dat
  [1,16,-10,6,56,-56,0,0,0,0,2,0,1,0, ldraw_lib__rect2p(realsolid)],
// 0
];
module ldraw_lib__710(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__710(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
