...
$fa=1; $fs=0.2;
function ldraw_lib__3817bp71(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3817bp70s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3817bp70s01(realsolid)],
// 1 19 0 0 0 1 0 0 0 1 0 0 0 1 s\3817bp70s02.dat
  [1,19,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3817bp70s02(realsolid)],
];
module ldraw_lib__3817bp71(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3817bp71(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
