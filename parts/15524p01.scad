...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 15524pb01, Rebrickable 15524pr0001, Set 71006
// 
...
module ldraw_lib__15524p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__15524p01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
