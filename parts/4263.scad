...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4263(realsolid=false) = [
...
// 1 16 20 7 0 0 -1 0 1 0 0 0 0 10 rect.dat
  [1,16,20,7,0,0,-1,0,1,0,0,0,0,10, ldraw_lib__rect(realsolid)],
// 1 16 -20 7 0 0 1 0 1 0 0 0 0 10 rect.dat
  [1,16,-20,7,0,0,1,0,1,0,0,0,0,10, ldraw_lib__rect(realsolid)],
...
// 1 16 30 0 0 0 0 1 0 1 0 -1 0 0 steerend.dat
  [1,16,30,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__steerend(realsolid)],
// 1 16 -30 0 0 0 0 -1 0 1 0 1 0 0 steerend.dat
  [1,16,-30,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__steerend(realsolid)],
...
module ldraw_lib__4263(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4263(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
