...
use <2978.scad>
$fa=1; $fs=0.2;
function ldraw_lib__885(realsolid=false) = [
// 0 ~Moved to 2978
// 0 Name: 885.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2978.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2978(realsolid)],
];
module ldraw_lib__885(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__885(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
