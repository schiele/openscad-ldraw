...
use <3817paw.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3815caw(realsolid=false) = [
...
// 1 320 0 0 0 1 0 0 0 1 0 0 0 1 3815paw.dat
  [1,320,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3815paw(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3816paw.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816paw(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3817paw.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817paw(realsolid)],
];
module ldraw_lib__3815caw(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3815caw(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
