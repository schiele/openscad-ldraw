...
use <4000.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4000c01(realsolid=false) = [
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 3999.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3999(realsolid)],
// 1 16 16 -52 0 1 0 0 0 1 0 0 0 1 4000.dat
  [1,16,16,-52,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4000(realsolid)],
];
module ldraw_lib__4000c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4000c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
