...
use <30389a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30389(realsolid=false) = [
// 0 ~Moved to 30389a
// 0 Name: 30389.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 30389a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30389a(realsolid)],
];
module ldraw_lib__30389(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30389(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
