...
// 1 16 0 0.5 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,0.5,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0.5 0 6 0 0 0 2.5 0 0 0 6 4-4cyli.dat
  [1,16,0,0.5,0,6,0,0,0,2.5,0,0,0,6, ldraw_lib__4_4cyli()],
...
// 1 16 0 3 0 6 0 0 0 -1 0 0 0 6 4-4ring1.dat
  [1,16,0,3,0,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4ring1()],
// 1 16 0 3 0 10 0 0 0 -1 0 0 0 10 4-4ring1.dat
  [1,16,0,3,0,10,0,0,0,-1,0,0,0,10, ldraw_lib__4_4ring1()],
// 1 16 0 0.5 0 2 0 0 0 1 0 0 0 2 4-4ring3.dat
  [1,16,0,0.5,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4ring3()],
...
// 1 16 0 0.5 0 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,0,0.5,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 3 0 20 0 0 0 5 0 0 0 20 4-4cyli.dat
  [1,16,0,3,0,20,0,0,0,5,0,0,0,20, ldraw_lib__4_4cyli()],
// 1 16 0 3 0 20 0 0 0 1 0 0 0 20 4-4edge.dat
  [1,16,0,3,0,20,0,0,0,1,0,0,0,20, ldraw_lib__4_4edge()],
...
// 1 16 0 3 0 24 0 0 0 5 0 0 0 24 4-4cyli.dat
  [1,16,0,3,0,24,0,0,0,5,0,0,0,24, ldraw_lib__4_4cyli()],
// 1 16 0 3.3 0 24 0 0 0 1 0 0 0 24 4-4edge.dat
  [1,16,0,3.3,0,24,0,0,0,1,0,0,0,24, ldraw_lib__4_4edge()],
...
// 1 16 0 8 0 4 0 0 0 -1 0 0 0 4 4-4ring5.dat
  [1,16,0,8,0,4,0,0,0,-1,0,0,0,4, ldraw_lib__4_4ring5()],
// 0 // Leaves
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30339s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30339s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\30339s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30339s01()],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\30339s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__30339s01()],
// 1 16 0 0 0 0 0 -1 0 1 0 -1 0 0 s\30339s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,-1,0,0, ldraw_lib__s__30339s01()],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\30339s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__30339s01()],
...
module ldraw_lib__30339(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30339(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
