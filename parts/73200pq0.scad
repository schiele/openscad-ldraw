...
use <3817bpq0.scad>
$fa=1; $fs=0.2;
function ldraw_lib__73200pq0(realsolid=false) = [
// 0 Minifig Hips and Legs with DarkBlue Loincloth Pattern
// 0 Name: 73200pq0.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3815bpq0.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3815bpq0(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3816bpq0.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816bpq0(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3817bpq0.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817bpq0(realsolid)],
];
module ldraw_lib__73200pq0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73200pq0(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
