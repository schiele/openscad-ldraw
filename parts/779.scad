...
use <../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__779(realsolid=false) = [
...
// 1 16 0 -16 0 2 0 0 0 -2 0 0 0 2 4-4con2.dat
  [1,16,0,-16,0,2,0,0,0,-2,0,0,0,2, ldraw_lib__4_4con2(realsolid)],
...
// 1 16 0 2 0 -10 0 0 0 -2 0 0 0 10 box2-5.dat
  [1,16,0,2,0,-10,0,0,0,-2,0,0,0,10, ldraw_lib__box2_5(realsolid)],
// 1 16 0 10 -8 10 0 0 0 0 10 0 -2 0 box2-7.dat
  [1,16,0,10,-8,10,0,0,0,0,10,0,-2,0, ldraw_lib__box2_7(realsolid)],
// 2 24 10 20 -6 -10 20 -6
  [2,24,10,20,-6,-10,20,-6],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -6 12 2 4 0 0 0 -8 0 0 0 -8 box2-7.dat
  [1,16,-6,12,2,4,0,0,0,-8,0,0,0,-8, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 6 12 2 4 0 0 0 -8 0 0 0 -8 box2-7.dat
  [1,16,6,12,2,4,0,0,0,-8,0,0,0,-8, ldraw_lib__box2_7(realsolid)],
// 1 16 0 12 2 0 0 -2 8 -8 0 -8 0 0 rect2p.dat
  [1,16,0,12,2,0,0,-2,8,-8,0,-8,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 12 -10 0 0 3 3 0 0 0 1 0 4-4edge.dat
  [1,16,0,12,-10,0,0,3,3,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 12 -11.326 0 0 3 3 0 0 0 1 0 4-4edge.dat
  [1,16,0,12,-11.326,0,0,3,3,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 12 -10 0 0 3 3 0 0 0 -1.326 0 4-4cyli.dat
  [1,16,0,12,-10,0,0,3,3,0,0,0,-1.326,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 12 -18 7.5 0 0 0 7.5 0 0 0 7.5 8-8sphe.dat
  [1,16,0,12,-18,7.5,0,0,0,7.5,0,0,0,7.5, ldraw_lib__8_8sphe(realsolid)],
// 0
];
module ldraw_lib__779(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__779(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
