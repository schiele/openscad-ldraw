...
$fa=1; $fs=0.2;
function ldraw_lib__004488a(realsolid=false) = [
...
// 1 0 0 -.25 -.6 1 0 0 0 1 0 0 0 1 s\004488as01.dat
  [1,0,0,-.25,-.6,1,0,0,0,1,0,0,0,1, ldraw_lib__s__004488as01(realsolid)],
// 
// 0 // Background
// 1 14 0 -.25 -.6 1 0 0 0 1 0 0 0 1 s\004488as02.dat
  [1,14,0,-.25,-.6,1,0,0,0,1,0,0,0,1, ldraw_lib__s__004488as02(realsolid)],
// 
// 0 // Small Box
// 1 16 0 -0.25 0 45 0 0 0 0.25 0 0 0 10 box5-12.dat
  [1,16,0,-0.25,0,45,0,0,0,0.25,0,0,0,10, ldraw_lib__box5_12(realsolid)],
];
module ldraw_lib__004488a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__004488a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
