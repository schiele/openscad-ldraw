...
use <u9102p16.scad>
use <u9103.scad>
function ldraw_lib__u595p02c04() = [
...
// 1 462 0 -67 4 1 0 0 0 1 0 0 0 1 u595p02c02.dat
  [1,462,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u595p02c02()],
...
module ldraw_lib__u595p02c04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u595p02c04(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
