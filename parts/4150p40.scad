...
use <s/4150s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4150p40(realsolid=false) = [
...
// 1 4 0 0 0 4 0 0 0 1 0 0 0 4 4-4disc.dat
  [1,4,0,0,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4disc(realsolid)],
...
// 1 1 0 0 0 2.296 0 -5.543 0 1 0 5.543 0 2.296 1-8ring2.dat
  [1,1,0,0,0,2.296,0,-5.543,0,1,0,5.543,0,2.296, ldraw_lib__1_8ring2(realsolid)],
...
// 1 1 0 0 0 -5.543 0 -2.296 0 1 0 2.296 0 -5.543 1-8ring2.dat
  [1,1,0,0,0,-5.543,0,-2.296,0,1,0,2.296,0,-5.543, ldraw_lib__1_8ring2(realsolid)],
...
module ldraw_lib__4150p40(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4150p40(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
