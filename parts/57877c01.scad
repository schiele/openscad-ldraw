...
use <57878.scad>
$fa=1; $fs=0.2;
function ldraw_lib__57877c01(realsolid=false) = [
...
// 1 494 0 0 0 1 0 0 0 1 0 0 0 1 57877.dat
  [1,494,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__57877(realsolid)],
// 1 16 50 0 0 0 0 -1 0 1 0 1 0 0 57878.dat
  [1,16,50,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__57878(realsolid)],
// 1 16 -50 0 0 0 0 1 0 1 0 1 0 0 57878.dat
  [1,16,-50,0,0,0,0,1,0,1,0,1,0,0, ldraw_lib__57878(realsolid)],
];
module ldraw_lib__57877c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__57877c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
