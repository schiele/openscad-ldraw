...
use <s/35477s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__35477(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\35477s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__35477s01(realsolid)],
// 
// 0 // Front
// 1 16 -12.2 16 -10 -17.8 0 0 0 0 17.8 0 1 0 48\1-6chrd.dat
  [1,16,-12.2,16,-10,-17.8,0,0,0,0,17.8,0,1,0, ldraw_lib__48__1_6chrd(realsolid)],
// 1 16 -12.2 16 -10 -17.8 0 0 0 0 -17.8 0 1 0 48\1-6chrd.dat
  [1,16,-12.2,16,-10,-17.8,0,0,0,0,-17.8,0,1,0, ldraw_lib__48__1_6chrd(realsolid)],
...
module ldraw_lib__35477(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__35477(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
