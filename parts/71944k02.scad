...
// 0 !HISTORY 2020-04-03 [PTadmin] Renamed from 80
...
module ldraw_lib__71944k02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__71944k02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__71944k02(line=0.2);