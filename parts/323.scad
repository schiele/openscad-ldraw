...
// 1 16 17 0 0 0 1 0 7 0 0 0 0 7 4-4edge.dat
  [1,16,17,0,0,0,1,0,7,0,0,0,0,7, ldraw_lib__4_4edge()],
// 1 16 24.5 0 0 0 1 0 7 0 0 0 0 7 4-4edge.dat
  [1,16,24.5,0,0,0,1,0,7,0,0,0,0,7, ldraw_lib__4_4edge()],
// 1 16 31 0 0 0 1 0 2 0 0 0 0 2 4-4edge.dat
  [1,16,31,0,0,0,1,0,2,0,0,0,0,2, ldraw_lib__4_4edge()],
// 1 16 32 0 0 0 1 0 1 0 0 0 0 1 4-4edge.dat
  [1,16,32,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__4_4edge()],
// 1 16 18 0 0 0 1 0 6 0 0 0 0 6 4-4edge.dat
  [1,16,18,0,0,0,1,0,6,0,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 24.5 0 0 0 1 0 6 0 0 0 0 6 4-4edge.dat
  [1,16,24.5,0,0,0,1,0,6,0,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 31 0 0 0 1 0 1 0 0 0 0 1 4-4edge.dat
  [1,16,31,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__4_4edge()],
// 1 16 17 0 0 0 7.5 0 7 0 0 0 0 7 4-4cyli.dat
  [1,16,17,0,0,0,7.5,0,7,0,0,0,0,7, ldraw_lib__4_4cyli()],
// 1 16 24.5 0 0 0 1.3 0 1 0 0 0 0 1 4-4con6.dat
  [1,16,24.5,0,0,0,1.3,0,1,0,0,0,0,1, ldraw_lib__4_4con6()],
// 1 16 25.8 0 0 0 2.6 0 2 0 0 0 0 2 4-4con2.dat
  [1,16,25.8,0,0,0,2.6,0,2,0,0,0,0,2, ldraw_lib__4_4con2()],
// 1 16 28.4 0 0 0 2.6 0 2 0 0 0 0 2 4-4con1.dat
  [1,16,28.4,0,0,0,2.6,0,2,0,0,0,0,2, ldraw_lib__4_4con1()],
// 1 16 31 0 0 0 1 0 1 0 0 0 0 1 4-4con1.dat
  [1,16,31,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__4_4con1()],
// 1 16 32 0 0 0 -1 0 1 0 0 0 0 1 4-4disc.dat
  [1,16,32,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__4_4disc()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 17 0 0 0 1 0 1 0 0 0 0 1 4-4con6.dat
  [1,16,17,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__4_4con6()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 18 0 0 0 6.5 0 6 0 0 0 0 6 4-4cyli.dat
  [1,16,18,0,0,0,6.5,0,6,0,0,0,0,6, ldraw_lib__4_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 24.5 0 0 0 2.6 0 2 0 0 0 0 2 4-4con2.dat
  [1,16,24.5,0,0,0,2.6,0,2,0,0,0,0,2, ldraw_lib__4_4con2()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 27.1 0 0 0 2.6 0 2 0 0 0 0 2 4-4con1.dat
  [1,16,27.1,0,0,0,2.6,0,2,0,0,0,0,2, ldraw_lib__4_4con1()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 29.7 0 0 0 1.3 0 1 0 0 0 0 1 4-4con1.dat
  [1,16,29.7,0,0,0,1.3,0,1,0,0,0,0,1, ldraw_lib__4_4con1()],
// 1 16 31 0 0 0 1 0 1 0 0 0 0 1 4-4disc.dat
  [1,16,31,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__4_4disc()],
// 0 --Left connector
// 1 16 -13.5 0 0 0 1 0 7 0 0 0 0 7 4-4edge.dat
  [1,16,-13.5,0,0,0,1,0,7,0,0,0,0,7, ldraw_lib__4_4edge()],
// 1 16 -26 0 0 0 1 0 7 0 0 0 0 7 4-4edge.dat
  [1,16,-26,0,0,0,1,0,7,0,0,0,0,7, ldraw_lib__4_4edge()],
// 1 16 -31 0 0 0 1 0 2 0 0 0 0 2 4-4edge.dat
  [1,16,-31,0,0,0,1,0,2,0,0,0,0,2, ldraw_lib__4_4edge()],
// 1 16 -32 0 0 0 1 0 1 0 0 0 0 1 4-4edge.dat
  [1,16,-32,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__4_4edge()],
// 1 16 -14.5 0 0 0 1 0 6 0 0 0 0 6 4-4edge.dat
  [1,16,-14.5,0,0,0,1,0,6,0,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 -26 0 0 0 1 0 6 0 0 0 0 6 4-4edge.dat
  [1,16,-26,0,0,0,1,0,6,0,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 -31 0 0 0 1 0 1 0 0 0 0 1 4-4edge.dat
  [1,16,-31,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__4_4edge()],
// 1 16 -13.5 0 0 0 -12.5 0 7 0 0 0 0 7 4-4cyli.dat
  [1,16,-13.5,0,0,0,-12.5,0,7,0,0,0,0,7, ldraw_lib__4_4cyli()],
// 1 16 -26 0 0 0 -1 0 1 0 0 0 0 1 4-4con6.dat
  [1,16,-26,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__4_4con6()],
// 1 16 -27 0 0 0 -2 0 2 0 0 0 0 2 4-4con2.dat
  [1,16,-27,0,0,0,-2,0,2,0,0,0,0,2, ldraw_lib__4_4con2()],
// 1 16 -29 0 0 0 -2 0 2 0 0 0 0 2 4-4con1.dat
  [1,16,-29,0,0,0,-2,0,2,0,0,0,0,2, ldraw_lib__4_4con1()],
// 1 16 -31 0 0 0 -1 0 1 0 0 0 0 1 4-4con1.dat
  [1,16,-31,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__4_4con1()],
// 1 16 -32 0 0 0 1 0 1 0 0 0 0 1 4-4disc.dat
  [1,16,-32,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__4_4disc()],
...
// 1 16 -13.5 0 0 0 -1 0 1 0 0 0 0 1 4-4con6.dat
  [1,16,-13.5,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__4_4con6()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -14.5 0 0 0 -11.5 0 6 0 0 0 0 6 4-4cyli.dat
  [1,16,-14.5,0,0,0,-11.5,0,6,0,0,0,0,6, ldraw_lib__4_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -26 0 0 0 -2 0 2 0 0 0 0 2 4-4con2.dat
  [1,16,-26,0,0,0,-2,0,2,0,0,0,0,2, ldraw_lib__4_4con2()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -28 0 0 0 -2 0 2 0 0 0 0 2 4-4con1.dat
  [1,16,-28,0,0,0,-2,0,2,0,0,0,0,2, ldraw_lib__4_4con1()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -30 0 0 0 -1 0 1 0 0 0 0 1 4-4con1.dat
  [1,16,-30,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__4_4con1()],
// 1 16 -31 0 0 0 -1 0 1 0 0 0 0 1 4-4disc.dat
  [1,16,-31,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__4_4disc()],
// 0 --Bulb Edges
// 1 47 -26 0 0 0 1 0 5 0 0 0 0 5 4-4edge.dat
  [1,47,-26,0,0,0,1,0,5,0,0,0,0,5, ldraw_lib__4_4edge()],
// 1 47 -12.5 0 0 0 1 0 8 0 0 0 0 8 4-4edge.dat
  [1,47,-12.5,0,0,0,1,0,8,0,0,0,0,8, ldraw_lib__4_4edge()],
// 1 47 16 0 0 0 1 0 8 0 0 0 0 8 4-4edge.dat
  [1,47,16,0,0,0,1,0,8,0,0,0,0,8, ldraw_lib__4_4edge()],
// 1 47 24.5 0 0 0 1 0 5 0 0 0 0 5 4-4edge.dat
  [1,47,24.5,0,0,0,1,0,5,0,0,0,0,5, ldraw_lib__4_4edge()],
// 1 47 17.5 0 0 0 1 0 5 0 0 0 0 5 4-4edge.dat
  [1,47,17.5,0,0,0,1,0,5,0,0,0,0,5, ldraw_lib__4_4edge()],
// 1 47 15.5 0 0 0 1 0 7 0 0 0 0 7 4-4edge.dat
  [1,47,15.5,0,0,0,1,0,7,0,0,0,0,7, ldraw_lib__4_4edge()],
// 1 47 -12 0 0 0 1 0 7 0 0 0 0 7 4-4edge.dat
  [1,47,-12,0,0,0,1,0,7,0,0,0,0,7, ldraw_lib__4_4edge()],
// 1 47 -14 0 0 0 1 0 5 0 0 0 0 5 4-4edge.dat
  [1,47,-14,0,0,0,1,0,5,0,0,0,0,5, ldraw_lib__4_4edge()],
...
// 1 47 -26 0 0 0 1 0 1 0 0 0 0 1 4-4ring5.dat
  [1,47,-26,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__4_4ring5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 47 -26 0 0 0 12 0 5 0 0 0 0 5 4-4cyli.dat
  [1,47,-26,0,0,0,12,0,5,0,0,0,0,5, ldraw_lib__4_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 47 -13 0 0 0 -1 0 1 0 0 0 0 1 4-4con5.dat
  [1,47,-13,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__4_4con5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 47 -12 0 0 0 -1 0 1 0 0 0 0 1 4-4con6.dat
  [1,47,-12,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__4_4con6()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 47 -12 0 0 0 27.5 0 7 0 0 0 0 7 4-4cyli.dat
  [1,47,-12,0,0,0,27.5,0,7,0,0,0,0,7, ldraw_lib__4_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 47 15.5 0 0 0 1 0 1 0 0 0 0 1 4-4con6.dat
  [1,47,15.5,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__4_4con6()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 47 16.5 0 0 0 1 0 1 0 0 0 0 1 4-4con5.dat
  [1,47,16.5,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__4_4con5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 47 17.5 0 0 0 7 0 5 0 0 0 0 5 4-4cyli.dat
  [1,47,17.5,0,0,0,7,0,5,0,0,0,0,5, ldraw_lib__4_4cyli()],
// 1 47 24.5 0 0 0 -1 0 1 0 0 0 0 1 4-4ring5.dat
  [1,47,24.5,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__4_4ring5()],
// 1 47 16 0 0 0 1 0 1 0 0 0 0 1 4-4con7.dat
  [1,47,16,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__4_4con7()],
// 1 47 -12.5 0 0 0 28.5 0 8 0 0 0 0 8 4-4cyli.dat
  [1,47,-12.5,0,0,0,28.5,0,8,0,0,0,0,8, ldraw_lib__4_4cyli()],
// 1 47 -12.5 0 0 0 -1 0 1 0 0 0 0 1 4-4con7.dat
  [1,47,-12.5,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__4_4con7()],
...
makepoly(ldraw_lib__323(), line=0.2);