...
use <../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9202(realsolid=false) = [
...
// 1 16 0 0 0 -8 0 0 0 0 -8 0 -20 0 4-4cyli.dat
  [1,16,0,0,0,-8,0,0,0,0,-8,0,-20,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 494 0 0 -2 -2 0 0 0 0 -2 0 -18 0 4-4cyli.dat
  [1,494,0,0,-2,-2,0,0,0,0,-2,0,-18,0, ldraw_lib__4_4cyli(realsolid)],
// 1 494 0 0 -20 -2 0 0 0 0 -2 0 -1 0 4-4edge.dat
  [1,494,0,0,-20,-2,0,0,0,0,-2,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 1 494 0 0 -20 -2 0 0 0 0 -2 0 -1 0 4-4ring1.dat
  [1,494,0,0,-20,-2,0,0,0,0,-2,0,-1,0, ldraw_lib__4_4ring1(realsolid)],
...
// 1 494 0 0 -2 -2 0 0 0 0 -2 0 1 0 4-8sphe.dat
  [1,494,0,0,-2,-2,0,0,0,0,-2,0,1,0, ldraw_lib__4_8sphe(realsolid)],
...
// 1 16 0 0 0 13 0 0 0 0 12 0 -22 0 box5.dat
  [1,16,0,0,0,13,0,0,0,0,12,0,-22,0, ldraw_lib__box5(realsolid)],
];
module ldraw_lib__u9202(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9202(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
