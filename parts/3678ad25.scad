...
use <191485g.scad>
use <3678a.scad>
function ldraw_lib__3678ad25() = [
// 0 Slope Brick 65  2 x  2 x  2 without Centre Tube with Black Stripes Back Sticker
// 0 Name: 3678ad25.dat
...
module ldraw_lib__3678ad25(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3678ad25(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3678ad25(line=0.2);