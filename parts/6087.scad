...
// 1 16 0 4 0 0 0 2 0 26 0 -6 0 0 box3u2p.dat
  [1,16,0,4,0,0,0,2,0,26,0,-6,0,0, ldraw_lib__box3u2p()],
...
// 1 16 0 4 17.5 0 0 -1.5 0 4 0 4.5 0 0 box3u8p.dat
  [1,16,0,4,17.5,0,0,-1.5,0,4,0,4.5,0,0, ldraw_lib__box3u8p()],
...
// 1 16 -4.5 4 13 0 0 3 0 4 0 -3 0 0 1-4cylo.dat
  [1,16,-4.5,4,13,0,0,3,0,4,0,-3,0,0, ldraw_lib__1_4cylo()],
// 1 16 -4.5 8 13 0 0 3 0 -1 0 -3 0 0 1-4ndis.dat
  [1,16,-4.5,8,13,0,0,3,0,-1,0,-3,0,0, ldraw_lib__1_4ndis()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 4.5 4 13 -3 0 0 0 4 0 0 0 -3 1-4cylo.dat
  [1,16,4.5,4,13,-3,0,0,0,4,0,0,0,-3, ldraw_lib__1_4cylo()],
// 1 16 4.5 8 13 -3 0 0 0 -1 0 0 0 -3 1-4ndis.dat
  [1,16,4.5,8,13,-3,0,0,0,-1,0,0,0,-3, ldraw_lib__1_4ndis()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 56 0 16 0 0 0 -52 0 0 0 6 box5.dat
  [1,16,0,56,0,16,0,0,0,-52,0,0,0,6, ldraw_lib__box5()],
// 
// 1 16 -6.625 6 10 0 0 2.125 -2 0 0 0 -1 0 rect1.dat
  [1,16,-6.625,6,10,0,0,2.125,-2,0,0,0,-1,0, ldraw_lib__rect1()],
// 1 16 6.625 6 10 0 0 2.125 -2 0 0 0 -1 0 rect1.dat
  [1,16,6.625,6,10,0,0,2.125,-2,0,0,0,-1,0, ldraw_lib__rect1()],
...
// 1 16 8.75 6 46 -7.25 0 0 0 0 2 0 1 0 rect2p.dat
  [1,16,8.75,6,46,-7.25,0,0,0,0,2,0,1,0, ldraw_lib__rect2p()],
// 1 16 -8.75 6 46 -7.25 0 0 0 0 2 0 1 0 rect2p.dat
  [1,16,-8.75,6,46,-7.25,0,0,0,0,2,0,1,0, ldraw_lib__rect2p()],
// 1 16 0 8 11.5 0 0 -1.5 0 -1 0 -1.5 0 0 rect1.dat
  [1,16,0,8,11.5,0,0,-1.5,0,-1,0,-1.5,0,0, ldraw_lib__rect1()],
...
module ldraw_lib__6087(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6087(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
