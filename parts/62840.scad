...
use <932.scad>
$fa=1; $fs=0.2;
function ldraw_lib__62840(realsolid=false) = [
...
// 1 72 0 0 0 1 0 0 0 1 0 0 0 1 62838.dat
  [1,72,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__62838(realsolid)],
...
// 1 72 0 -40 -39 1 0 0 0 1 0 0 0 1 62837.dat
  [1,72,0,-40,-39,1,0,0,0,1,0,0,0,1, ldraw_lib__62837(realsolid)],
// 0 // Probe - silver
// 1 494 0 -40 -73 1 0 0 0 1 0 0 0 1 62836.dat
  [1,494,0,-40,-73,1,0,0,0,1,0,0,0,1, ldraw_lib__62836(realsolid)],
...
// 1 0 0 -25 24 0 0 1 1 0 0 0 8 0 932.dat
  [1,0,0,-25,24,0,0,1,1,0,0,0,8,0, ldraw_lib__932(realsolid)],
// 1 0 5 -25 32 0 0 3 3 0 0 0 -1 0 2-4disc.dat
  [1,0,5,-25,32,0,0,3,3,0,0,0,-1,0, ldraw_lib__2_4disc(realsolid)],
// 1 0 -5 -25 32 0 0 -3 -3 0 0 0 -1 0 2-4disc.dat
  [1,0,-5,-25,32,0,0,-3,-3,0,0,0,-1,0, ldraw_lib__2_4disc(realsolid)],
...
module ldraw_lib__62840(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__62840(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__62840(line=0.2);