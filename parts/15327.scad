...
// 1 16 0 -8 0 6 0 0 0 -162 0 0 0 6 4-4cyli.dat
  [1,16,0,-8,0,6,0,0,0,-162,0,0,0,6, ldraw_lib__4_4cyli()],
...
module ldraw_lib__15327(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__15327(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
