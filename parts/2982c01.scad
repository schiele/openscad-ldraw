...
use <880.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2982c01(realsolid=false) = [
...
// 1 8 0 0 0 1 0 0 0 1 0 0 0 1 2982.dat
  [1,8,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2982(realsolid)],
// 1 16 0 -24 0 1 0 0 0 1 0 0 0 1 880.dat
  [1,16,0,-24,0,1,0,0,0,1,0,0,0,1, ldraw_lib__880(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 70839.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__70839(realsolid)],
];
module ldraw_lib__2982c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2982c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
