...
use <3067p12.scad>
$fa=1; $fs=0.2;
function ldraw_lib__9358(realsolid=false) = [
...
// 1 33 0 0 0 1 0 0 0 1 0 0 0 1 3067p12.dat
  [1,33,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3067p12(realsolid)],
];
module ldraw_lib__9358(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__9358(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
