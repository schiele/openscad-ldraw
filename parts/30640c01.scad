...
use <30663.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30640c01(realsolid=false) = [
...
// 1 0 0 -19.799 11.515 1 0 0 0 0.707107 0.707107 0 -0.707107 0.707107 30663.dat
  [1,0,0,-19.799,11.515,1,0,0,0,0.707107,0.707107,0,-0.707107,0.707107, ldraw_lib__30663(realsolid)],
];
module ldraw_lib__30640c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30640c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
