...
use <3144.scad>
$fa=1; $fs=0.2;
function ldraw_lib__513(realsolid=false) = [
// 0 ~Moved to 3144
// 0 Name: 513.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3144.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3144(realsolid)],
];
module ldraw_lib__513(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__513(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
