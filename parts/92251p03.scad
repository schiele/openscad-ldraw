...
use <s/92252s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92251p03(realsolid=false) = [
...
// 1 212 0 0 0 1 0 0 0 1 0 0 0 1 s\92250p01s04.dat
  [1,212,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92250p01s04(realsolid)],
// 1 212 0 0 0 -1 0 0 0 1 0 0 0 1 s\92250p01s04.dat
  [1,212,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__92250p01s04(realsolid)],
// 
];
module ldraw_lib__92251p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92251p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
