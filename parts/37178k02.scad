...
use <../p/tri3u1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__37178k02(realsolid=false) = [
...
// 1 16 0 0 0 0 0 -23 0 7 0 -14.25 0 0 box4t.dat
  [1,16,0,0,0,0,0,-23,0,7,0,-14.25,0,0, ldraw_lib__box4t(realsolid)],
// 1 16 10 3.75 -16.25 0 0 3.5 3.5 0 0 0 -3.5 0 4-8sphe.dat
  [1,16,10,3.75,-16.25,0,0,3.5,3.5,0,0,0,-3.5,0, ldraw_lib__4_8sphe(realsolid)],
// 1 16 -10 3.75 -16.25 0 0 3.5 3.5 0 0 0 -3.5 0 4-8sphe.dat
  [1,16,-10,3.75,-16.25,0,0,3.5,3.5,0,0,0,-3.5,0, ldraw_lib__4_8sphe(realsolid)],
// 1 16 -10 3.75 -16.25 0 0 3.5 3.5 0 0 0 1 0 4-4edge.dat
  [1,16,-10,3.75,-16.25,0,0,3.5,3.5,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 3.75 -16.25 0 0 3.5 3.5 0 0 0 1 0 4-4edge.dat
  [1,16,10,3.75,-16.25,0,0,3.5,3.5,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 25 4.5 0 0 2 0 1.5 0 0 0 0 -10 box5.dat
  [1,16,25,4.5,0,0,2,0,1.5,0,0,0,0,-10, ldraw_lib__box5(realsolid)],
// 1 16 22 0 13.25 3 0 0 0 7.5 0 0 0 3 1-4cyli.dat
  [1,16,22,0,13.25,3,0,0,0,7.5,0,0,0,3, ldraw_lib__1_4cyli(realsolid)],
// 1 16 22 7.5 13.25 2 0 0 0 2 0 0 0 2 t04o5000.dat
  [1,16,22,7.5,13.25,2,0,0,0,2,0,0,0,2, ldraw_lib__t04o5000(realsolid)],
// 1 16 -22 7.5 15.25 0 44 0 1 0 0 0 0 1 1-4cyli.dat
  [1,16,-22,7.5,15.25,0,44,0,1,0,0,0,0,1, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -22 0 13.25 -3 0 0 0 7.5 0 0 0 3 1-4cyli.dat
  [1,16,-22,0,13.25,-3,0,0,0,7.5,0,0,0,3, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -22 7.5 13.25 -2 0 0 0 2 0 0 0 2 t04o5000.dat
  [1,16,-22,7.5,13.25,-2,0,0,0,2,0,0,0,2, ldraw_lib__t04o5000(realsolid)],
// 1 16 -24 7.5 -13.25 0 0 -1 1 0 0 0 26.5 0 1-4cyli.dat
  [1,16,-24,7.5,-13.25,0,0,-1,1,0,0,0,26.5,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 24 7.5 -13.25 0 0 1 1 0 0 0 26.5 0 1-4cyli.dat
  [1,16,24,7.5,-13.25,0,0,1,1,0,0,0,26.5,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 22 0 -13.25 3 0 0 0 7.5 0 0 0 -3 1-4cyli.dat
  [1,16,22,0,-13.25,3,0,0,0,7.5,0,0,0,-3, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 -22 8.5 -13.25 -2 0 0 0 -1 0 0 0 -2 1-4chrd.dat
  [1,16,-22,8.5,-13.25,-2,0,0,0,-1,0,0,0,-2, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -22 8.5 13.25 -2 0 0 0 -1 0 0 0 2 1-4chrd.dat
  [1,16,-22,8.5,13.25,-2,0,0,0,-1,0,0,0,2, ldraw_lib__1_4chrd(realsolid)],
// 1 16 22 8.5 -13.25 2 0 0 0 -1 0 0 0 -2 1-4chrd.dat
  [1,16,22,8.5,-13.25,2,0,0,0,-1,0,0,0,-2, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 22 0 13.25 3 0 0 0 1 0 0 0 3 1-4edge.dat
  [1,16,22,0,13.25,3,0,0,0,1,0,0,0,3, ldraw_lib__1_4edge(realsolid)],
// 1 16 -22 0 13.25 -3 0 0 0 1 0 0 0 3 1-4edge.dat
  [1,16,-22,0,13.25,-3,0,0,0,1,0,0,0,3, ldraw_lib__1_4edge(realsolid)],
// 1 16 22 0 -13.25 3 0 0 0 1 0 0 0 -3 1-4edge.dat
  [1,16,22,0,-13.25,3,0,0,0,1,0,0,0,-3, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 22 0 13.25 3 0 0 0 1 0 0 0 3 1-4chrd.dat
  [1,16,22,0,13.25,3,0,0,0,1,0,0,0,3, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -22 0 13.25 -3 0 0 0 1 0 0 0 3 1-4chrd.dat
  [1,16,-22,0,13.25,-3,0,0,0,1,0,0,0,3, ldraw_lib__1_4chrd(realsolid)],
// 1 16 22 0 -13.25 3 0 0 0 1 0 0 0 -3 1-4chrd.dat
  [1,16,22,0,-13.25,3,0,0,0,1,0,0,0,-3, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 -20.5 8.5 12.5 -1.5 0 0 0 .5 0 0 0 1.5 1-4cylo.dat
  [1,16,-20.5,8.5,12.5,-1.5,0,0,0,.5,0,0,0,1.5, ldraw_lib__1_4cylo(realsolid)],
// 1 16 20.5 8.5 12.5 1.5 0 0 0 .5 0 0 0 1.5 1-4cylo.dat
  [1,16,20.5,8.5,12.5,1.5,0,0,0,.5,0,0,0,1.5, ldraw_lib__1_4cylo(realsolid)],
// 1 16 0 8.75 14 -20.5 0 0 0 0 .25 0 -1 0 rect2p.dat
  [1,16,0,8.75,14,-20.5,0,0,0,0,.25,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -22 8.75 10.75 0 1 0 0 0 .25 -1.75 0 0 rect2p.dat
  [1,16,-22,8.75,10.75,0,1,0,0,0,.25,-1.75,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -20.5 8.75 7.5 1.5 1 0 0 0 .25 -1.5 0 0 rect2p.dat
  [1,16,-20.5,8.75,7.5,1.5,1,0,0,0,.25,-1.5,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -17 8.75 5.25 2 1 0 0 0 .25 -.75 0 0 rect2p.dat
  [1,16,-17,8.75,5.25,2,1,0,0,0,.25,-.75,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 22 8.75 10.75 0 -1 0 0 0 .25 -1.75 0 0 rect2p.dat
  [1,16,22,8.75,10.75,0,-1,0,0,0,.25,-1.75,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 20.5 8.75 7.5 -1.5 -1 0 0 0 .25 -1.5 0 0 rect2p.dat
  [1,16,20.5,8.75,7.5,-1.5,-1,0,0,0,.25,-1.5,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 8.75 4.5 15 0 0 0 0 .25 0 1 0 rect2p.dat
  [1,16,0,8.75,4.5,15,0,0,0,0,.25,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -20.5 9 12.5 -1.5 0 0 0 -1 0 0 0 1.5 1-4chrd.dat
  [1,16,-20.5,9,12.5,-1.5,0,0,0,-1,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 16 20.5 9 12.5 1.5 0 0 0 -1 0 0 0 1.5 1-4chrd.dat
  [1,16,20.5,9,12.5,1.5,0,0,0,-1,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 0 9 9.5 0 0 17 0 .5 0 -.5 0 0 box5.dat
  [1,16,0,9,9.5,0,0,17,0,.5,0,-.5,0,0, ldraw_lib__box5(realsolid)],
// 1 16 -15 9 7.5 0 0 .75 0 .75 0 -2 0 0 box5.dat
  [1,16,-15,9,7.5,0,0,.75,0,.75,0,-2,0,0, ldraw_lib__box5(realsolid)],
...
// 1 16 23 2.4 0 0 1 0 -.5 0 0 0 0 5 box5.dat
  [1,16,23,2.4,0,0,1,0,-.5,0,0,0,0,5, ldraw_lib__box5(realsolid)],
...
// 1 16 -25 .45 -9.5 -.8 0 0 0 0 .4 0 19 0 tri3u1.dat
  [1,16,-25,.45,-9.5,-.8,0,0,0,0,.4,0,19,0, ldraw_lib__tri3u1(realsolid)],
// 1 16 -25.4 .45 0 .4 0 0 0 1 0 0 0 9.5 rect1.dat
  [1,16,-25.4,.45,0,.4,0,0,0,1,0,0,0,9.5, ldraw_lib__rect1(realsolid)],
];
module ldraw_lib__37178k02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__37178k02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
