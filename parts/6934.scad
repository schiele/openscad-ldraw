...
use <../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6934(realsolid=false) = [
// 0 Tile  3 x  6
// 0 Name: 6934.dat
...
// 1 16 0 8 0 60 0 0 0 -8 0 0 0 30 box5.dat
  [1,16,0,8,0,60,0,0,0,-8,0,0,0,30, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 56 0 0 0 -4 0 0 0 26 box5.dat
  [1,16,0,8,0,56,0,0,0,-4,0,0,0,26, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__6934(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6934(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
