...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Rebrickable 4182pr0007, Set 5581
// 
...
module ldraw_lib__4182p07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4182p07(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
