...
function ldraw_lib__4121723f() = [
// 0 Sticker  2.6 x  3.6 with Octan Logo and Text and Red "DIESEL POWER" - Right Aligned
// 0 Name: 4121723f.dat
...
module ldraw_lib__4121723f(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4121723f(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4121723f(line=0.2);