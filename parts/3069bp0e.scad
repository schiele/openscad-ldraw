...
$fa=1; $fs=0.2;
function ldraw_lib__3069bp0e(realsolid=false) = [
...
// 1 72 0 0 0 1 0 0 0 1 0 0 0 1 s\3069p0fs01.dat
  [1,72,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3069p0fs01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3069p0fs02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3069p0fs02(realsolid)],
];
module ldraw_lib__3069bp0e(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3069bp0e(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
