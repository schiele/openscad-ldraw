...
use <s/24299s01.scad>
use <../p/stug-1x2.scad>
function ldraw_lib__24307p01() = [
// 0 Wing  2 x  2 Right with 3 Black Stripes Pattern
// 0 Name: 24307p01.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 24307pb01, Captain Rex Helmet, Helmet Collection
// 0 !KEYWORDS Rebrickable 24307pr0001, Set 75349
// 
...
module ldraw_lib__24307p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__24307p01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__24307p01(line=0.2);