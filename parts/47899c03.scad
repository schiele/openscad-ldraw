...
use <4344.scad>
$fa=1; $fs=0.2;
function ldraw_lib__47899c03(realsolid=false) = [
// 0 Door  1 x  4 x  5 Left with Trans Black Glass
// 0 Name: 47899c03.dat
...
module ldraw_lib__47899c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__47899c03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
