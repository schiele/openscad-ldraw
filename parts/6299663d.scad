...
use <../p/box5-12.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6299663d(realsolid=false) = [
...
// 1 16 0 -0.25 0 152.5 0 0 0 0.25 0 0 0 72.5 box5-12.dat
  [1,16,0,-0.25,0,152.5,0,0,0,0.25,0,0,0,72.5, ldraw_lib__box5_12(realsolid)],
// 
...
module ldraw_lib__6299663d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6299663d(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
