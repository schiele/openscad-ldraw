...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 32374p02c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32374p02c01()],
// 0 // Curcuit board
...
module ldraw_lib__u9450(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9450(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
