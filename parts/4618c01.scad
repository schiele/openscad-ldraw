...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 4618.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4618()],
// 1 0 29 54 0 1 0 0 0 1 0 0 0 1 4619.dat
  [1,0,29,54,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4619()],
];
module ldraw_lib__4618c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4618c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
