...
use <s/u9180s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__93549(realsolid=false) = [
...
// 1 47 0 0 0 1 0 0 0 1 0 0 0 1 s\u9180s01.dat
  [1,47,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9180s01(realsolid)],
// 1 35 0 0 0 1 0 0 0 1 0 0 0 1 s\u9180s02.dat
  [1,35,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9180s02(realsolid)],
];
module ldraw_lib__93549(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__93549(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
