...
use <../p/stug-9x9.scad>
$fa=1; $fs=0.2;
function ldraw_lib__10p05(realsolid=false) = [
...
// 1 16 -70 0 10 1 0 0 0 1 0 0 0 1 stug-7x7.dat
  [1,16,-70,0,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_7x7(realsolid)],
// 1 16 -70 0 -70 1 0 0 0 1 0 0 0 1 stug-1x7.dat
  [1,16,-70,0,-70,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x7(realsolid)],
// 1 16 -280 0 0 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,-280,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
...
// 1 16 -150 0 0 1 0 0 0 1 0 0 0 1 stug-4x1.dat
  [1,16,-150,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x1(realsolid)],
...
// 1 16 230 0 70 1 0 0 0 1 0 0 0 1 stug-5x5.dat
  [1,16,230,0,70,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_5x5(realsolid)],
// 1 16 230 0 -70 1 0 0 0 1 0 0 0 1 stug-5x5.dat
  [1,16,230,0,-70,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_5x5(realsolid)],
// 1 16 60 0 40 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,60,0,40,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4(realsolid)],
// 1 16 60 0 -40 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,60,0,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4(realsolid)],
// 1 16 140 0 0 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,140,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4(realsolid)],
...
// 1 16 170 0 60 1 0 0 0 1 0 0 0 1 stug-2x1.dat
  [1,16,170,0,60,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x1(realsolid)],
// 1 16 170 0 -60 1 0 0 0 1 0 0 0 1 stug-2x1.dat
  [1,16,170,0,-60,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x1(realsolid)],
// 1 16 230 0 10 1 0 0 0 1 0 0 0 1 stug-1x5.dat
  [1,16,230,0,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x5(realsolid)],
// 1 16 230 0 -10 1 0 0 0 1 0 0 0 1 stug-1x5.dat
  [1,16,230,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x5(realsolid)],
// 1 16 290 0 100 1 0 0 0 1 0 0 0 1 stug-2x1.dat
  [1,16,290,0,100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x1(realsolid)],
// 1 16 290 0 0 1 0 0 0 1 0 0 0 1 stug-4x1.dat
  [1,16,290,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x1(realsolid)],
// 1 16 290 0 -100 1 0 0 0 1 0 0 0 1 stug-2x1.dat
  [1,16,290,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x1(realsolid)],
...
// 1 16 -310 0 30 1 0 0 0 1 0 0 0 1 studp01.dat
  [1,16,-310,0,30,1,0,0,0,1,0,0,0,1, ldraw_lib__studp01(realsolid)],
...
module ldraw_lib__10p05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__10p05(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
