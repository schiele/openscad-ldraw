...
use <u9516c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__737c01_f1(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 737.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__737(realsolid)],
// 1 16 0 9.5 -29.5 1 0 0 0 1 0 0 0 1 u9516c01.dat
  [1,16,0,9.5,-29.5,1,0,0,0,1,0,0,0,1, ldraw_lib__u9516c01(realsolid)],
];
module ldraw_lib__737c01_f1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__737c01_f1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
