...
use <004656a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__004113a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 004656a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__004656a(realsolid)],
];
module ldraw_lib__004113a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__004113a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
