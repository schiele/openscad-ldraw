...
use <s/3437s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3437(realsolid=false) = [
// 0 Duplo Brick  2 x  2
// 0 Name: 3437.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3437s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3437s01(realsolid)],
...
module ldraw_lib__3437(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3437(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
