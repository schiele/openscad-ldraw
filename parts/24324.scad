...
$fa=1; $fs=0.2;
function ldraw_lib__24324(realsolid=false) = [
...
// 1 16 11 -18 -30 1 0 0 0 -1 0 0 0 1 s\24324s01.dat
  [1,16,11,-18,-30,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__24324s01(realsolid)],
// 1 16 11 18 -30 1 0 0 0 1 0 0 0 1 s\24324s01.dat
  [1,16,11,18,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__s__24324s01(realsolid)],
// 
// 0 // Minifig Handle
// 1 16 0 -24 0 0 0 4 0 48 0 -4 0 0 3-4cylc.dat
  [1,16,0,-24,0,0,0,4,0,48,0,-4,0,0, ldraw_lib__3_4cylc(realsolid)],
// 1 16 0 24 0 0 0 4 0 -1 0 -4 0 0 3-4disc.dat
  [1,16,0,24,0,0,0,4,0,-1,0,-4,0,0, ldraw_lib__3_4disc(realsolid)],
...
// 1 16 -3.45 0 -1.3125 0 1 -.55 -24 0 0 0 0 1.3125 rect.dat
  [1,16,-3.45,0,-1.3125,0,1,-.55,-24,0,0,0,0,1.3125, ldraw_lib__rect(realsolid)],
// 1 16 -3.45 0 -4.3125 0 1 .55 -24 0 0 0 0 1.6875 rect.dat
  [1,16,-3.45,0,-4.3125,0,1,.55,-24,0,0,0,0,1.6875, ldraw_lib__rect(realsolid)],
// 0 // Back Cover
...
// 1 16 0 0 -17.16316 0 -1 0 -24 0 0 0 0 13.16316 rect.dat
  [1,16,0,0,-17.16316,0,-1,0,-24,0,0,0,0,13.16316, ldraw_lib__rect(realsolid)],
// 1 16 -3.6 0 -28 .4 1 0 0 0 24 .5 0 0 rect.dat
  [1,16,-3.6,0,-28,.4,1,0,0,0,24,.5,0,0, ldraw_lib__rect(realsolid)],
// 1 16 -3.6 0 -27 -.4 1 0 0 0 24 .5 0 0 rect2p.dat
  [1,16,-3.6,0,-27,-.4,1,0,0,0,24,.5,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -4 0 -16.25 0 1 0 -24 0 0 0 0 -10.25 rect3.dat
  [1,16,-4,0,-16.25,0,1,0,-24,0,0,0,0,-10.25, ldraw_lib__rect3(realsolid)],
// 1 16 -4 0 -29.4285 0 1 0 0 0 24 .9285 0 0 rect2p.dat
  [1,16,-4,0,-29.4285,0,1,0,0,0,24,.9285,0,0, ldraw_lib__rect2p(realsolid)],
// 
// 1 16 0 0 -16 0 -1 0 1 0 0 0 0 1 stug2-1x2.dat
  [1,16,0,0,-16,0,-1,0,1,0,0,0,0,1, ldraw_lib__stug2_1x2(realsolid)],
// 1 16 0 0 -27 0 2.5 0 16 0 0 0 0 1 box3u8p.dat
  [1,16,0,0,-27,0,2.5,0,16,0,0,0,0,1, ldraw_lib__box3u8p(realsolid)],
// 
// 0 // Spine
// 1 16 -1 24 -30.3567 -3 0 0 0 -48 0 0 0 -3 3-16cyli.dat
  [1,16,-1,24,-30.3567,-3,0,0,0,-48,0,0,0,-3, ldraw_lib__3_16cyli(realsolid)],
// 1 16 -1 24 -30.3567 -3 0 0 0 -1 0 0 0 -3 3-16disc.dat
  [1,16,-1,24,-30.3567,-3,0,0,0,-1,0,0,0,-3, ldraw_lib__3_16disc(realsolid)],
// 1 16 -1 24 -30.3567 -3 0 0 0 1 0 0 0 -3 3-16edge.dat
  [1,16,-1,24,-30.3567,-3,0,0,0,1,0,0,0,-3, ldraw_lib__3_16edge(realsolid)],
// 1 16 -1 -24 -30.3567 -3 0 0 0 1 0 0 0 -3 3-16disc.dat
  [1,16,-1,-24,-30.3567,-3,0,0,0,1,0,0,0,-3, ldraw_lib__3_16disc(realsolid)],
// 1 16 -1 -24 -30.3567 -3 0 0 0 1 0 0 0 -3 3-16edge.dat
  [1,16,-1,-24,-30.3567,-3,0,0,0,1,0,0,0,-3, ldraw_lib__3_16edge(realsolid)],
// 1 16 6 24 -30.3 0 0 -11.52489 0 -48 0 -4 0 0 48\1-8cylo.dat
  [1,16,6,24,-30.3,0,0,-11.52489,0,-48,0,-4,0,0, ldraw_lib__48__1_8cylo(realsolid)],
// 1 16 6 24 -30.3 0 0 -11.52489 0 -1 0 -4 0 0 48\1-8chrd.dat
  [1,16,6,24,-30.3,0,0,-11.52489,0,-1,0,-4,0,0, ldraw_lib__48__1_8chrd(realsolid)],
// 1 16 6 -24 -30.3 0 0 -11.52489 0 1 0 -4 0 0 48\1-8chrd.dat
  [1,16,6,-24,-30.3,0,0,-11.52489,0,1,0,-4,0,0, ldraw_lib__48__1_8chrd(realsolid)],
// 1 16 6 24 -33.6 0 0 .7 0 -48 0 -.7 0 0 5-16cyli.dat
  [1,16,6,24,-33.6,0,0,.7,0,-48,0,-.7,0,0, ldraw_lib__5_16cyli(realsolid)],
// 1 16 6 24 -33.6 0 0 .7 0 -1 0 -.7 0 0 5-16disc.dat
  [1,16,6,24,-33.6,0,0,.7,0,-1,0,-.7,0,0, ldraw_lib__5_16disc(realsolid)],
// 1 16 6 24 -33.6 0 0 .7 0 1 0 -.7 0 0 5-16edge.dat
  [1,16,6,24,-33.6,0,0,.7,0,1,0,-.7,0,0, ldraw_lib__5_16edge(realsolid)],
// 1 16 6 -24 -33.6 0 0 .7 0 1 0 -.7 0 0 5-16disc.dat
  [1,16,6,-24,-33.6,0,0,.7,0,1,0,-.7,0,0, ldraw_lib__5_16disc(realsolid)],
// 1 16 6 -24 -33.6 0 0 .7 0 1 0 -.7 0 0 5-16edge.dat
  [1,16,6,-24,-33.6,0,0,.7,0,1,0,-.7,0,0, ldraw_lib__5_16edge(realsolid)],
// 1 16 6.32337 0 -32.166 0 -1 -.32337 -24 0 0 0 0 1.166 rect3.dat
  [1,16,6.32337,0,-32.166,0,-1,-.32337,-24,0,0,0,0,1.166, ldraw_lib__rect3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 6 24 -28.7 0 0 -8.4865 0 -48 0 -2.3 0 0 48\1-8cylo.dat
  [1,16,6,24,-28.7,0,0,-8.4865,0,-48,0,-2.3,0,0, ldraw_lib__48__1_8cylo(realsolid)],
// 
...
module ldraw_lib__24324(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__24324(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
