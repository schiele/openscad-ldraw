...
use <2362ap53.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2362p53(realsolid=false) = [
// 0 ~Moved to 2362ap53
// 0 Name: 2362p53.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2362ap53.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2362ap53(realsolid)],
];
module ldraw_lib__2362p53(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2362p53(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
