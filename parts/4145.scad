...
use <s/4145s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4145(realsolid=false) = [
...
// 1 16 0 72 -20 5 0 0 0 0 5 0 1 0 4-4ndis.dat
  [1,16,0,72,-20,5,0,0,0,0,5,0,1,0, ldraw_lib__4_4ndis(realsolid)],
...
module ldraw_lib__4145(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4145(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
