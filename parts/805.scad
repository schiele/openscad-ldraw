...
use <../p/stug4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__805(realsolid=false) = [
...
// 1 16 180 0 20 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,180,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2(realsolid)],
// 1 16 180 0 -20 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,180,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2(realsolid)],
...
// 1 16 100 8 0 0 0 100 0 -8 0 40 0 0 box4-4a.dat
  [1,16,100,8,0,0,0,100,0,-8,0,40,0,0, ldraw_lib__box4_4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 100 8 0 0 0 96 0 -4 0 36 0 0 box4-4a.dat
  [1,16,100,8,0,0,0,96,0,-4,0,36,0,0, ldraw_lib__box4_4a(realsolid)],
...
module ldraw_lib__805(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__805(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
