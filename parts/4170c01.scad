...
use <4171.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4170c01(realsolid=false) = [
...
// 1 47 -50 10 -8 1 0 0 0 1 0 0 0 1 4171.dat
  [1,47,-50,10,-8,1,0,0,0,1,0,0,0,1, ldraw_lib__4171(realsolid)],
// 1 47 50 10 -8 -1 0 0 0 -1 0 0 0 1 4171.dat
  [1,47,50,10,-8,-1,0,0,0,-1,0,0,0,1, ldraw_lib__4171(realsolid)],
// 0
];
module ldraw_lib__4170c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4170c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
