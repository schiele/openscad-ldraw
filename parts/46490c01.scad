...
use <u9477.scad>
$fa=1; $fs=0.2;
function ldraw_lib__46490c01(realsolid=false) = [
...
// 1 72 0 0 -30 1 0 0 0 1 0 0 0 1 46434.dat
  [1,72,0,0,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__46434(realsolid)],
// 1 72 0 0 0 1 0 0 0 1 0 0 0 1 u9477.dat
  [1,72,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9477(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 46490c02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__46490c02(realsolid)],
];
module ldraw_lib__46490c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__46490c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
