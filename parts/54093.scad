...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\54093s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__54093s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\54093s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__54093s01()],
// 1 16 -120 8 -100 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-120,8,-100,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -120 8 -60 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-120,8,-60,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -220 8 -60 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-220,8,-60,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -220 8 -20 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-220,8,-20,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -220 8 20 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-220,8,20,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -380 8 -140 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-380,8,-140,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -380 8 -100 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-380,8,-100,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -380 8 -60 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-380,8,-60,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -540 8 -180 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-540,8,-180,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -540 8 -140 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-540,8,-140,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 120 8 -100 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,120,8,-100,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 120 8 -60 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,120,8,-60,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
...
// 1 16 70 0 130 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,70,0,130,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
...
// 1 16 0 4 140 1 0 0 0 -3 0 0 0 -1 stud4.dat
  [1,16,0,4,140,1,0,0,0,-3,0,0,0,-1, ldraw_lib__stud4()],
// 1 16 0 4 120 1 0 0 0 -3 0 0 0 -1 stud4.dat
  [1,16,0,4,120,1,0,0,0,-3,0,0,0,-1, ldraw_lib__stud4()],
// 1 16 0 4 -120 1 0 0 0 -3 0 0 0 -1 stud4.dat
  [1,16,0,4,-120,1,0,0,0,-3,0,0,0,-1, ldraw_lib__stud4()],
// 1 16 0 4 -140 1 0 0 0 -3 0 0 0 -1 stud4.dat
  [1,16,0,4,-140,1,0,0,0,-3,0,0,0,-1, ldraw_lib__stud4()],
...
module ldraw_lib__54093(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__54093(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
