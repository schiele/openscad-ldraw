...
use <s/2431s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2431p00(realsolid=false) = [
...
// 1 0 18.7 0 3.6 7 0 0 0 1 0 0 0 5 1-4disc.dat
  [1,0,18.7,0,3.6,7,0,0,0,1,0,0,0,5, ldraw_lib__1_4disc(realsolid)],
// 1 16 18.7 0 3.6 7 0 0 0 1 0 0 0 5 1-4ndis.dat
  [1,16,18.7,0,3.6,7,0,0,0,1,0,0,0,5, ldraw_lib__1_4ndis(realsolid)],
// 1 0 23.7 0 3.6 0 0 2 0 1 0 -3.5 0 0 1-4disc.dat
  [1,0,23.7,0,3.6,0,0,2,0,1,0,-3.5,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 23.7 0 3.6 0 0 2 0 1 0 -3.5 0 0 1-4ndis.dat
  [1,16,23.7,0,3.6,0,0,2,0,1,0,-3.5,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 0 15.6 0 -5.1 3 0 0 0 1 0 0 0 -2 1-4disc.dat
  [1,0,15.6,0,-5.1,3,0,0,0,1,0,0,0,-2, ldraw_lib__1_4disc(realsolid)],
// 1 16 15.6 0 -5.1 3 0 0 0 1 0 0 0 -2 1-4ndis.dat
  [1,16,15.6,0,-5.1,3,0,0,0,1,0,0,0,-2, ldraw_lib__1_4ndis(realsolid)],
// 1 0 15.6 0 -5.1 -1.414 0 1.414 0 1 0 -1.414 0 -1.414 1-8disc.dat
  [1,0,15.6,0,-5.1,-1.414,0,1.414,0,1,0,-1.414,0,-1.414, ldraw_lib__1_8disc(realsolid)],
// 1 16 15.6 0 -5.1 0 0 -2 0 1 0 -2 0 0 1-8ndis.dat
  [1,16,15.6,0,-5.1,0,0,-2,0,1,0,-2,0,0, ldraw_lib__1_8ndis(realsolid)],
// 1 0 18.7 0 3.6 0 0 -6 0 1 0 5 0 0 1-8disc.dat
  [1,0,18.7,0,3.6,0,0,-6,0,1,0,5,0,0, ldraw_lib__1_8disc(realsolid)],
// 1 16 18.7 0 3.6 0 0 -6 0 1 0 5 0 0 1-8ndis.dat
  [1,16,18.7,0,3.6,0,0,-6,0,1,0,5,0,0, ldraw_lib__1_8ndis(realsolid)],
// 1 0 4.8 0 12.6 0 0 12 0 1 0 -9 0 0 1-8ndis.dat
  [1,0,4.8,0,12.6,0,0,12,0,1,0,-9,0,0, ldraw_lib__1_8ndis(realsolid)],
// 1 16 4.8 0 12.6 0 0 12 0 1 0 -9 0 0 1-8chrd.dat
  [1,16,4.8,0,12.6,0,0,12,0,1,0,-9,0,0, ldraw_lib__1_8chrd(realsolid)],
// 4 0 16.8 0 3.6 18.7 0 3.6 14.457 0 7.136 13.285 0 6.236
  [4,0,16.8,0,3.6,18.7,0,3.6,14.457,0,7.136,13.285,0,6.236],
// 1 0 4.2 0 -11.6 0 0 12 0 1 0 9 0 0 1-8ndis.dat
  [1,0,4.2,0,-11.6,0,0,12,0,1,0,9,0,0, ldraw_lib__1_8ndis(realsolid)],
// 1 16 4.2 0 -11.6 0 0 12 0 1 0 9 0 0 1-8chrd.dat
  [1,16,4.2,0,-11.6,0,0,12,0,1,0,9,0,0, ldraw_lib__1_8chrd(realsolid)],
...
// 1 16 20 0 -1.3 3.511 0 -1.454 0 1 0 1.454 0 3.511 2-4disc.dat
  [1,16,20,0,-1.3,3.511,0,-1.454,0,1,0,1.454,0,3.511, ldraw_lib__2_4disc(realsolid)],
...
// 1 16 20 0 -1.3 -3.511 0 1.454 0 1 0 -1.454 0 -3.511 1-8disc.dat
  [1,16,20,0,-1.3,-3.511,0,1.454,0,1,0,-1.454,0,-3.511, ldraw_lib__1_8disc(realsolid)],
// 1 0 20 0 -1.3 0 0 -3.8 0 1 0 3.8 0 0 1-4ndis.dat
  [1,0,20,0,-1.3,0,0,-3.8,0,1,0,3.8,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 0 20 0 -1.3 0 0 3.8 0 1 0 3.8 0 0 3-16ndis.dat
  [1,0,20,0,-1.3,0,0,3.8,0,1,0,3.8,0,0, ldraw_lib__3_16ndis(realsolid)],
// 1 0 20 0 -1.3 -3.8 0 0 0 1 0 0 0 -3.8 3-16ndis.dat
  [1,0,20,0,-1.3,-3.8,0,0,0,1,0,0,0,-3.8, ldraw_lib__3_16ndis(realsolid)],
...
// 1 0 -23.6 0 2.1 0 0 -1.5 0 1 0 1.5 0 0 1-4disc.dat
  [1,0,-23.6,0,2.1,0,0,-1.5,0,1,0,1.5,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 -23.6 0 2.1 0 0 -1.5 0 1 0 1.5 0 0 1-4ndis.dat
  [1,16,-23.6,0,2.1,0,0,-1.5,0,1,0,1.5,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 0 -23.6 0 -1.1 -1.5 0 0 0 1 0 0 0 -1.5 1-4disc.dat
  [1,0,-23.6,0,-1.1,-1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__1_4disc(realsolid)],
// 1 16 -23.6 0 -1.1 -1.5 0 0 0 1 0 0 0 -1.5 1-4ndis.dat
  [1,16,-23.6,0,-1.1,-1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__1_4ndis(realsolid)],
// 0
];
module ldraw_lib__2431p00(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2431p00(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
