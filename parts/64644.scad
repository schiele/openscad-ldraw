...
use <../p/stud2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__64644(realsolid=false) = [
// 0 Minifig Telescope
// 0 Name: 64644.dat
...
// 1 16 0 2 0 2 0 0 0 -1 0 0 0 -2 4-4ring2.dat
  [1,16,0,2,0,2,0,0,0,-1,0,0,0,-2, ldraw_lib__4_4ring2(realsolid)],
...
// 1 16 0 32 0 2 0 0 0 1 0 0 0 2 4-4ring3.dat
  [1,16,0,32,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4ring3(realsolid)],
// 1 16 0 40 0 -2 0 0 0 -1 0 0 0 2 4-4ring3.dat
  [1,16,0,40,0,-2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring3(realsolid)],
...
// 1 16 0 34 0 2 0 0 0 -1 0 0 0 -2 4-4ring2.dat
  [1,16,0,34,0,2,0,0,0,-1,0,0,0,-2, ldraw_lib__4_4ring2(realsolid)],
...
// 1 16 0 20 0 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,0,20,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 34 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,0,34,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 40 0 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,0,40,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 32 0 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,0,32,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 32 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,32,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 18 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,18,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 2 0 7 0 0 0 1 0 0 0 7 4-4edge.dat
  [1,16,0,2,0,7,0,0,0,1,0,0,0,7, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 0 2 0 0 0 20 0 0 0 2 4-4cyli.dat
  [1,16,0,0,0,2,0,0,0,20,0,0,0,2, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 2 0 4 0 0 0 16 0 0 0 4 4-4cyli.dat
  [1,16,0,2,0,4,0,0,0,16,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 0 7 0 0 0 2 0 0 0 7 4-4cyli.dat
  [1,16,0,0,0,7,0,0,0,2,0,0,0,7, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 18 0 6 0 0 0 14 0 0 0 6 4-4cyli.dat
  [1,16,0,18,0,6,0,0,0,14,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 32 0 8 0 0 0 8 0 0 0 8 4-4cyli.dat
  [1,16,0,32,0,8,0,0,0,8,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 34 0 6 0 0 0 6 0 0 0 6 4-4cyli.dat
  [1,16,0,34,0,6,0,0,0,6,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 20 0 4 0 0 0 14 0 0 0 4 4-4cyli.dat
  [1,16,0,20,0,4,0,0,0,14,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 0
];
module ldraw_lib__64644(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__64644(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
