...
use <u9130.scad>
$fa=1; $fs=0.2;
function ldraw_lib__433c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 433.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__433(realsolid)],
...
// 1 494 10 0 10 1 0 0 0 1 0 0 0 1 u9057.dat
  [1,494,10,0,10,1,0,0,0,1,0,0,0,1, ldraw_lib__u9057(realsolid)],
// 1 494 -10 0 10 1 0 0 0 1 0 0 0 1 u9057.dat
  [1,494,-10,0,10,1,0,0,0,1,0,0,0,1, ldraw_lib__u9057(realsolid)],
// 1 494 -11.5 20 0 1 0 0 0 1 0 0 0 1 u9130.dat
  [1,494,-11.5,20,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9130(realsolid)],
// 1 494 11.5 20 0 1 0 0 0 1 0 0 0 1 u9130.dat
  [1,494,11.5,20,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9130(realsolid)],
];
module ldraw_lib__433c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__433c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
