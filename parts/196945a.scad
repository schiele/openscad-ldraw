...
// 1 16 0 -0.25 -20 0.415 0 0 0 1 0 0 0 0.415 s\196945s01.dat
  [1,16,0,-0.25,-20,0.415,0,0,0,1,0,0,0,0.415, ldraw_lib__s__196945s01()],
...
module ldraw_lib__196945a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__196945a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
