...
$fa=1; $fs=0.2;
function ldraw_lib__4107582e(realsolid=false) = [
...
// 1 16 0 -0.25 0 1 0 0 0 1 0 0 0 1 s\4107582es01.dat
  [1,16,0,-0.25,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4107582es01(realsolid)],
// 1 16 0 -0.25 0 -1 0 0 0 1 0 0 0 1 s\4107582es01.dat
  [1,16,0,-0.25,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__4107582es01(realsolid)],
// 1 16 0 -0.25 0 -1 0 0 0 1 0 0 0 -1 s\4107582es01.dat
  [1,16,0,-0.25,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__4107582es01(realsolid)],
...
// 1 16 9 -0.125 9.75 0 0 9 0 0.125 0 9.75 0 0 box3-12.dat
  [1,16,9,-0.125,9.75,0,0,9,0,0.125,0,9.75,0,0, ldraw_lib__box3_12(realsolid)],
// 1 16 9 -0.125 -9.75 0 0 9 0 0.125 0 -9.75 0 0 box3-12.dat
  [1,16,9,-0.125,-9.75,0,0,9,0,0.125,0,-9.75,0,0, ldraw_lib__box3_12(realsolid)],
// 1 16 -9 -0.125 9.75 0 0 -9 0 0.125 0 9.75 0 0 box3-12.dat
  [1,16,-9,-0.125,9.75,0,0,-9,0,0.125,0,9.75,0,0, ldraw_lib__box3_12(realsolid)],
...
module ldraw_lib__4107582e(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4107582e(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
