...
// 1 16 0 12 -10 1 0 0 0 0 -1 0 1 0 6005724q.dat
  [1,16,0,12,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__6005724q()],
];
module ldraw_lib__2465dm0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2465dm0(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
