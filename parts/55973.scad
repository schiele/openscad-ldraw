...
// 1 7 0 0 0 4 0 0 0 0 4 0 1 0 4-4disc.dat
  [1,7,0,0,0,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4disc()],
];
module ldraw_lib__55973(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__55973(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
