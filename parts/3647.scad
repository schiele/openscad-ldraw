...
use <../p/tooth8.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3647(realsolid=false) = [
...
// 1 16 0 -7 0 1 0 0 0 -1 0 0 0 1 tooth8.dat
  [1,16,0,-7,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__tooth8(realsolid)],
// 1 16 -4.95 -4.95 0 0.707 -0.707 0 -0.707 -0.707 0 0 0 1 tooth8.dat
  [1,16,-4.95,-4.95,0,0.707,-0.707,0,-0.707,-0.707,0,0,0,1, ldraw_lib__tooth8(realsolid)],
// 1 16 -7 0 0 0 -1 0 -1 0 0 0 0 1 tooth8.dat
  [1,16,-7,0,0,0,-1,0,-1,0,0,0,0,1, ldraw_lib__tooth8(realsolid)],
// 1 16 -4.95 4.95 0 -0.707 -0.707 0 -0.707 0.707 0 0 0 1 tooth8.dat
  [1,16,-4.95,4.95,0,-0.707,-0.707,0,-0.707,0.707,0,0,0,1, ldraw_lib__tooth8(realsolid)],
// 1 16 0 7 0 -1 0 0 0 1 0 0 0 1 tooth8.dat
  [1,16,0,7,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__tooth8(realsolid)],
...
module ldraw_lib__3647(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3647(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
