...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\4490s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4490s01()],
// 0 // backside
// 1 16 0 18 10 10 0 0 0 0 -10 0 -1 0 2-4ndis.dat
  [1,16,0,18,10,10,0,0,0,0,-10,0,-1,0, ldraw_lib__2_4ndis()],
...
module ldraw_lib__4490(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4490(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
