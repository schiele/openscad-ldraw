...
use <3464c02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2415c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2415.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2415(realsolid)],
// 1 47 0 21 20 0 0 -1 1 0 0 0 -1 0 3464c02.dat
  [1,47,0,21,20,0,0,-1,1,0,0,0,-1,0, ldraw_lib__3464c02(realsolid)],
];
module ldraw_lib__2415c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2415c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
