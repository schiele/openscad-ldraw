...
use <2586p4c.scad>
$fa=1; $fs=0.2;
function ldraw_lib__770p4c(realsolid=false) = [
// 0 ~Moved to 2586p4c
// 0 Name: 770p4c.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2586p4c.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2586p4c(realsolid)],
];
module ldraw_lib__770p4c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__770p4c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
