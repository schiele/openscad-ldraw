...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2434(realsolid=false) = [
...
// 1 16 20 4 0 1 0 0 0 -11 0 0 0 1 stud4.dat
  [1,16,20,4,0,1,0,0,0,-11,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
// 1 16 0 48 0 36 0 0 0 -44 0 0 0 16 box5.dat
  [1,16,0,48,0,36,0,0,0,-44,0,0,0,16, ldraw_lib__box5(realsolid)],
...
// 1 16 0 48 0 40 0 0 0 -48 0 0 0 20 box5.dat
  [1,16,0,48,0,40,0,0,0,-48,0,0,0,20, ldraw_lib__box5(realsolid)],
...
// 1 16 30 10 20 1 0 0 0 0 1 0 -1 0 stud2.dat
  [1,16,30,10,20,1,0,0,0,0,1,0,-1,0, ldraw_lib__stud2(realsolid)],
// 1 16 10 10 20 1 0 0 0 0 1 0 -1 0 stud2.dat
  [1,16,10,10,20,1,0,0,0,0,1,0,-1,0, ldraw_lib__stud2(realsolid)],
// 1 16 -10 10 20 1 0 0 0 0 1 0 -1 0 stud2.dat
  [1,16,-10,10,20,1,0,0,0,0,1,0,-1,0, ldraw_lib__stud2(realsolid)],
// 1 16 -30 10 20 1 0 0 0 0 1 0 -1 0 stud2.dat
  [1,16,-30,10,20,1,0,0,0,0,1,0,-1,0, ldraw_lib__stud2(realsolid)],
...
// 1 16 30 30 20 1 0 0 0 0 1 0 -1 0 stud2.dat
  [1,16,30,30,20,1,0,0,0,0,1,0,-1,0, ldraw_lib__stud2(realsolid)],
// 1 16 10 30 20 1 0 0 0 0 1 0 -1 0 stud2.dat
  [1,16,10,30,20,1,0,0,0,0,1,0,-1,0, ldraw_lib__stud2(realsolid)],
// 1 16 -10 30 20 1 0 0 0 0 1 0 -1 0 stud2.dat
  [1,16,-10,30,20,1,0,0,0,0,1,0,-1,0, ldraw_lib__stud2(realsolid)],
// 1 16 -30 30 20 1 0 0 0 0 1 0 -1 0 stud2.dat
  [1,16,-30,30,20,1,0,0,0,0,1,0,-1,0, ldraw_lib__stud2(realsolid)],
...
module ldraw_lib__2434(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2434(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
