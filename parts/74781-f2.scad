...
use <2911.scad>
$fa=1; $fs=0.2;
function ldraw_lib__74781_f2(realsolid=false) = [
// 0 Monorail Track Point Left (Curved)
// 0 Name: 74781-f2.dat
...
// 0 !HELP 1 16 98.62 1 -70 1 0 0 0 1 0 0 0 1 3023.dat
// 0 !HELP 1 16 98.62 -7 -70 1 0 0 0 1 0 0 0 1 3069bp14.dat
// 
// 0 BFC CERTIFY CCW
  [0,"BFC","CERTIFY"],
  [0,"BFC","CCW"],
...
// 1 47 -133.99 13 0 .70058 0 -.71431 0 -1 0 -.71431 0 -.70046 2884.dat
  [1,47,-133.99,13,0,.70058,0,-.71431,0,-1,0,-.71431,0,-.70046, ldraw_lib__2884(realsolid)],
// 
// 0 // Track Points Interior Shover Straight
// 1 16 -27.423 13 -16.055 -.20962 0 -.97778 0 1 0 .97778 0 -.20962 2911.dat
  [1,16,-27.423,13,-16.055,-.20962,0,-.97778,0,1,0,.97778,0,-.20962, ldraw_lib__2911(realsolid)],
// 
// 0 // Points Shover Straight
// 1 16 98.62 9 -35 1 0 0 0 1 0 0 0 1 2883.dat
  [1,16,98.62,9,-35,1,0,0,0,1,0,0,0,1, ldraw_lib__2883(realsolid)],
// 
// 0 // Points Rack Shover Straight
// 1 16 168.62 5 0 1 0 0 0 1 0 0 0 1 2890.dat
  [1,16,168.62,5,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2890(realsolid)],
// 
// 0 // Track Points Interior Shover Curve
// 1 16 -113.094 13 29.508 .55049 0 .83485 0 1 0 -.83485 0 .55049 2911.dat
  [1,16,-113.094,13,29.508,.55049,0,.83485,0,1,0,-.83485,0,.55049, ldraw_lib__2911(realsolid)],
// 
// 0 // Points Rack Shover Curve
// 1 16 -32.408 7.367 80.699 .87458 -.10177 -.47409 .12254 .99238 .01303 .46915 -.06949 .88038 2890.dat
  [1,16,-32.408,7.367,80.699,.87458,-.10177,-.47409,.12254,.99238,.01303,.46915,-.06949,.88038, ldraw_lib__2890(realsolid)],
// 
// 0 // Switch Rack
// 1 16 0 0 -69.5 1 0 0 0 1 0 0 0 1 2887.dat
  [1,16,0,0,-69.5,1,0,0,0,1,0,0,0,1, ldraw_lib__2887(realsolid)],
// 
// 0 // Top
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2885.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2885(realsolid)],
];
module ldraw_lib__74781_f2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__74781_f2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__74781_f2(line=0.2);