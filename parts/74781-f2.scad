...
// 1 16 0 0 -69.5 1 0 0 0 1 0 0 0 1 2887.dat
  [1,16,0,0,-69.5,1,0,0,0,1,0,0,0,1, ldraw_lib__2887()],
// 
// 0 // Top
...
module ldraw_lib__74781_f2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__74781_f2(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
