...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87913(realsolid=false) = [
...
// 1 16 58 5.5 -24.5 -2 0 0 0 -1 2.5 0 1 2.5 rect3.dat
  [1,16,58,5.5,-24.5,-2,0,0,0,-1,2.5,0,1,2.5, ldraw_lib__rect3(realsolid)],
...
// 1 16 40 8 -21 2 0 0 0 -1 0 0 0 -1 rect3.dat
  [1,16,40,8,-21,2,0,0,0,-1,0,0,0,-1, ldraw_lib__rect3(realsolid)],
// 1 16 40 5.5 -24.5 0 0 -2 -2.5 -1 0 -2.5 1 0 rect2p.dat
  [1,16,40,5.5,-24.5,0,0,-2,-2.5,-1,0,-2.5,1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 20 8 -21 2 0 0 0 -1 0 0 0 -1 rect3.dat
  [1,16,20,8,-21,2,0,0,0,-1,0,0,0,-1, ldraw_lib__rect3(realsolid)],
// 1 16 20 5.5 -24.5 0 0 -2 -2.5 -1 0 -2.5 1 0 rect2p.dat
  [1,16,20,5.5,-24.5,0,0,-2,-2.5,-1,0,-2.5,1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 8 -21 2 0 0 0 -1 0 0 0 -1 rect3.dat
  [1,16,0,8,-21,2,0,0,0,-1,0,0,0,-1, ldraw_lib__rect3(realsolid)],
// 1 16 0 5.5 -24.5 0 0 -2 -2.5 -1 0 -2.5 1 0 rect2p.dat
  [1,16,0,5.5,-24.5,0,0,-2,-2.5,-1,0,-2.5,1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 5.5 -23.5 56 0 0 0 0 -2.5 0 3.5 0 box2-7.dat
  [1,16,0,5.5,-23.5,56,0,0,0,0,-2.5,0,3.5,0, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 5.5 23.5 -56 0 0 0 0 -2.5 0 -3.5 0 box2-7.dat
  [1,16,0,5.5,23.5,-56,0,0,0,0,-2.5,0,-3.5,0, ldraw_lib__box2_7(realsolid)],
...
// 1 16 0 0 0 60 0 0 0 1 0 0 0 23.3 rect.dat
  [1,16,0,0,0,60,0,0,0,1,0,0,0,23.3, ldraw_lib__rect(realsolid)],
// 0 // ladderholder
...
// 1 16 0 -4 -23.3 -50 0 0 0 0 1.33 0 2.66 0 box4-4a.dat
  [1,16,0,-4,-23.3,-50,0,0,0,0,1.33,0,2.66,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 0 -5.33 -21.97 50 0 0 0 1 0 0 0 1.33 rect3.dat
  [1,16,0,-5.33,-21.97,50,0,0,0,1,0,0,0,1.33, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 -1.165 -27 60 0 0 0 0 -4.165 0 1 0 rect.dat
  [1,16,0,-1.165,-27,60,0,0,0,0,-4.165,0,1,0, ldraw_lib__rect(realsolid)],
// 2 24 50 -2.67 23.3 -50 -2.67 23.3
  [2,24,50,-2.67,23.3,-50,-2.67,23.3],
// 4 16 60 0 23.3 50 -2.67 23.3 -50 -2.67 23.3 -60 0 23.3
  [4,16,60,0,23.3,50,-2.67,23.3,-50,-2.67,23.3,-60,0,23.3],
...
// 1 16 30 0 0 -6 0 0 0 -1 0 0 0 6 4-8sphe.dat
  [1,16,30,0,0,-6,0,0,0,-1,0,0,0,6, ldraw_lib__4_8sphe(realsolid)],
// 1 16 -30 0 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-30,0,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 -30 0 0 -6 0 0 0 -1 0 0 0 6 4-8sphe.dat
  [1,16,-30,0,0,-6,0,0,0,-1,0,0,0,6, ldraw_lib__4_8sphe(realsolid)],
...
module ldraw_lib__87913(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87913(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
