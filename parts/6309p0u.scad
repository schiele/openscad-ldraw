...
use <s/6309s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6309p0u(realsolid=false) = [
// 0 Duplo Tile  2 x  2 with Red Inverse Isosceles Triangle Pattern
// 0 Name: 6309p0u.dat
...
module ldraw_lib__6309p0u(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6309p0u(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
