...
use <820673i.scad>
$fa=1; $fs=0.2;
function ldraw_lib__820673h(realsolid=false) = [
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 820673i.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__820673i(realsolid)],
];
module ldraw_lib__820673h(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__820673h(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
