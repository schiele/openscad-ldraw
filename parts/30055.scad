...
// 1 16 -10 0 0 4 0 0 0 2 0 0 0 4 4-4edge.dat
  [1,16,-10,0,0,4,0,0,0,2,0,0,0,4, ldraw_lib__4_4edge()],
// 1 16 10 0 0 4 0 0 0 2 0 0 0 4 4-4edge.dat
  [1,16,10,0,0,4,0,0,0,2,0,0,0,4, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -10 0 0 4 0 0 0 2 0 0 0 4 4-8sphe.dat
  [1,16,-10,0,0,4,0,0,0,2,0,0,0,4, ldraw_lib__4_8sphe()],
// 1 16 -10 0 0 4 0 0 0 2 0 0 0 4 4-4ndis.dat
  [1,16,-10,0,0,4,0,0,0,2,0,0,0,4, ldraw_lib__4_4ndis()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 0 0 4 0 0 0 2 0 0 0 4 4-8sphe.dat
  [1,16,10,0,0,4,0,0,0,2,0,0,0,4, ldraw_lib__4_8sphe()],
...
// 1 16 0 0 0 40 0 0 0 4 0 0 0 10 box5.dat
  [1,16,0,0,0,40,0,0,0,4,0,0,0,10, ldraw_lib__box5()],
// 
// 1 16 -30 4 0 4 0 0 0 32 0 0 0 4 4-4cyli.dat
  [1,16,-30,4,0,4,0,0,0,32,0,0,0,4, ldraw_lib__4_4cyli()],
// 1 16 -10 4 0 4 0 0 0 32 0 0 0 4 4-4cyli.dat
  [1,16,-10,4,0,4,0,0,0,32,0,0,0,4, ldraw_lib__4_4cyli()],
// 1 16 10 4 0 4 0 0 0 32 0 0 0 4 4-4cyli.dat
  [1,16,10,4,0,4,0,0,0,32,0,0,0,4, ldraw_lib__4_4cyli()],
// 1 16 30 4 0 4 0 0 0 32 0 0 0 4 4-4cyli.dat
  [1,16,30,4,0,4,0,0,0,32,0,0,0,4, ldraw_lib__4_4cyli()],
...
// 1 16 -30 36 0 6 0 0 0 4 0 0 0 6 4-4cyli.dat
  [1,16,-30,36,0,6,0,0,0,4,0,0,0,6, ldraw_lib__4_4cyli()],
// 1 16 -30 36 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-30,36,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 -30 36 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,-30,36,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge()],
// 1 16 -30 36 0 6 0 0 0 1 0 0 0 6 4-4disc.dat
  [1,16,-30,36,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4disc()],
// 1 16 -10 36 0 6 0 0 0 4 0 0 0 6 4-4cyli.dat
  [1,16,-10,36,0,6,0,0,0,4,0,0,0,6, ldraw_lib__4_4cyli()],
// 1 16 -10 36 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-10,36,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 -10 36 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,-10,36,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge()],
// 1 16 -10 36 0 6 0 0 0 1 0 0 0 6 4-4disc.dat
  [1,16,-10,36,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4disc()],
// 1 16 10 36 0 6 0 0 0 4 0 0 0 6 4-4cyli.dat
  [1,16,10,36,0,6,0,0,0,4,0,0,0,6, ldraw_lib__4_4cyli()],
// 1 16 10 36 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,10,36,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
...
// 1 16 -30 40 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-30,40,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 -10 40 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-10,40,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 10 40 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,10,40,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 30 40 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,30,40,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
...
module ldraw_lib__30055(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30055(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
