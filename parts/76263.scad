...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS bar, BrickLink 75c03, Rebrickable 75c03, tube
// 
...
// 1 16 0 1 0 1 0 0 0 58 0 0 0 1 77.dat
  [1,16,0,1,0,1,0,0,0,58,0,0,0,1, ldraw_lib__77()],
// 1 16 0 60 0 -1 0 0 0 -1 0 0 0 1 u9053.dat
  [1,16,0,60,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__u9053()],
];
module ldraw_lib__76263(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76263(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
