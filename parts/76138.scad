...
// 1 494 0 56 0 1 0 0 0 1 0 0 0 1 71953.dat
  [1,494,0,56,0,1,0,0,0,1,0,0,0,1, ldraw_lib__71953()],
];
module ldraw_lib__76138(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76138(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
