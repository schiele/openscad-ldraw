...
use <s/87079s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87079(realsolid=false) = [
// 0 Tile  2 x  4 with Groove
// 0 Name: 87079.dat
...
module ldraw_lib__87079(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87079(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
