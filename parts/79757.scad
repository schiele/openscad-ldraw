...
use <../p/stud3a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__79757(realsolid=false) = [
...
// 1 16 0 -3 10 0 -6 0 3 0 0 0 0 16 box2-9.dat
  [1,16,0,-3,10,0,-6,0,3,0,0,0,0,16, ldraw_lib__box2_9(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 -3 0 0 16 0 3 0 0 0 0 -6 box2-9.dat
  [1,16,10,-3,0,0,16,0,3,0,0,0,0,-6, ldraw_lib__box2_9(realsolid)],
// 1 16 16 -3 16 0 -10 0 3 0 0 0 0 -10 box2-9.dat
  [1,16,16,-3,16,0,-10,0,3,0,0,0,0,-10, ldraw_lib__box2_9(realsolid)],
// 2 24 6 -6 26 6 0 26
  [2,24,6,-6,26,6,0,26],
// 2 24 26 -6 6 26 0 6
  [2,24,26,-6,6,26,0,6],
...
// 1 16 0 -6 26 -6 0 0 0 0 -6 0 -20 0 2-4cyli.dat
  [1,16,0,-6,26,-6,0,0,0,0,-6,0,-20,0, ldraw_lib__2_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -6 6 6 0 0 0 0 -6 0 -6 0 2-4cyls.dat
  [1,16,0,-6,6,6,0,0,0,0,-6,0,-6,0, ldraw_lib__2_4cyls(realsolid)],
// 1 16 0 -6 26 6 0 0 0 0 -6 0 -1 0 2-4edge.dat
  [1,16,0,-6,26,6,0,0,0,0,-6,0,-1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -6 26 -6 0 0 0 0 -6 0 1 0 2-4chrd.dat
  [1,16,0,-6,26,-6,0,0,0,0,-6,0,1,0, ldraw_lib__2_4chrd(realsolid)],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 26 -6 0 0 -20 0 0 0 -6 -6 0 0 2-4cyli.dat
  [1,16,26,-6,0,0,-20,0,0,0,-6,-6,0,0, ldraw_lib__2_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 6 -6 0 0 -6 0 0 0 -6 6 0 0 2-4cyls.dat
  [1,16,6,-6,0,0,-6,0,0,0,-6,6,0,0, ldraw_lib__2_4cyls(realsolid)],
// 1 16 26 -6 0 0 -1 0 0 0 -6 6 0 0 2-4edge.dat
  [1,16,26,-6,0,0,-1,0,0,0,-6,6,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 26 -6 0 0 1 0 0 0 -6 -6 0 0 2-4chrd.dat
  [1,16,26,-6,0,0,1,0,0,0,-6,-6,0,0, ldraw_lib__2_4chrd(realsolid)],
// 
// 1 16 0 -6 0 6 1 0 0 0 -6 6 0 0 2-4edge.dat
  [1,16,0,-6,0,6,1,0,0,0,-6,6,0,0, ldraw_lib__2_4edge(realsolid)],
// 
// 0 // Stud3
// 1 16 0 -12 10 0 0 1 0 -3 0 -1 0 0 stud3a.dat
  [1,16,0,-12,10,0,0,1,0,-3,0,-1,0,0, ldraw_lib__stud3a(realsolid)],
...
// 1 16 10 -12 0 1 0 0 0 -3 0 0 0 1 stud3a.dat
  [1,16,10,-12,0,1,0,0,0,-3,0,0,0,1, ldraw_lib__stud3a(realsolid)],
...
// 1 16 6.7071 -5.7 6.7071 0 -2.464479 .707107 -5.2 0 0 0 -2.464479 -.707107 box3u2p.dat
  [1,16,6.7071,-5.7,6.7071,0,-2.464479,.707107,-5.2,0,0,0,-2.464479,-.707107, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 0 -.5 10 0 -9 0 .5 0 0 0 0 19 box2-7.dat
  [1,16,0,-.5,10,0,-9,0,.5,0,0,0,0,19, ldraw_lib__box2_7(realsolid)],
// 1 16 10 -.5 0 0 19 0 .5 0 0 0 0 -9 box2-7.dat
  [1,16,10,-.5,0,0,19,0,.5,0,0,0,0,-9, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 19 -.5 19 0 -10 0 .5 0 0 0 0 -10 box2-5.dat
  [1,16,19,-.5,19,0,-10,0,.5,0,0,0,0,-10, ldraw_lib__box2_5(realsolid)],
// 2 24 -9 -1 -9 -9 0 -9
  [2,24,-9,-1,-9,-9,0,-9],
...
// 1 16 0 -3.5 20 0 -10 0 2.5 0 0 0 0 10 box2-9.dat
  [1,16,0,-3.5,20,0,-10,0,2.5,0,0,0,0,10, ldraw_lib__box2_9(realsolid)],
// 1 16 20 -3.5 0 0 10 0 2.5 0 0 0 0 -10 box2-9.dat
  [1,16,20,-3.5,0,0,10,0,2.5,0,0,0,0,-10, ldraw_lib__box2_9(realsolid)],
// 1 16 0 -3.5 0 0 -10 0 2.5 0 0 0 0 -10 box2-9.dat
  [1,16,0,-3.5,0,0,-10,0,2.5,0,0,0,0,-10, ldraw_lib__box2_9(realsolid)],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 -3.5 20 0 -10 0 2.5 0 0 0 0 -10 box2-9.dat
  [1,16,20,-3.5,20,0,-10,0,2.5,0,0,0,0,-10, ldraw_lib__box2_9(realsolid)],
...
// 1 16 0 -6 30 -10 0 0 0 0 -10 0 -20 0 2-4cyli.dat
  [1,16,0,-6,30,-10,0,0,0,0,-10,0,-20,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 -6 30 -10 0 0 0 0 -10 0 -1 0 2-4edge.dat
  [1,16,0,-6,30,-10,0,0,0,0,-10,0,-1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -6 30 -10 0 0 0 0 -10 0 -1 0 2-4chrd.dat
  [1,16,0,-6,30,-10,0,0,0,0,-10,0,-1,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 0 -6 10 10 0 0 0 0 -10 0 -10 0 2-4cyls.dat
  [1,16,0,-6,10,10,0,0,0,0,-10,0,-10,0, ldraw_lib__2_4cyls(realsolid)],
// 
// 1 16 30 -6 0 0 -20 0 0 0 -10 -10 0 0 2-4cyli.dat
  [1,16,30,-6,0,0,-20,0,0,0,-10,-10,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 30 -6 0 0 -1 0 0 0 -10 -10 0 0 2-4edge.dat
  [1,16,30,-6,0,0,-1,0,0,0,-10,-10,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 30 -6 0 0 -1 0 0 0 -10 -10 0 0 2-4chrd.dat
  [1,16,30,-6,0,0,-1,0,0,0,-10,-10,0,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 10 -6 0 0 -10 0 0 0 -10 10 0 0 2-4cyls.dat
  [1,16,10,-6,0,0,-10,0,0,0,-10,10,0,0, ldraw_lib__2_4cyls(realsolid)],
// 
// 1 16 0 -6 0 10 0 0 0 0 -10 10 -1 0 2-4edge.dat
  [1,16,0,-6,0,10,0,0,0,0,-10,10,-1,0, ldraw_lib__2_4edge(realsolid)],
];
module ldraw_lib__79757(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__79757(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
