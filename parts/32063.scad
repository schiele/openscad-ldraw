...
// 1 16 0 5 -50 9 0 0 0 1 0 0 0 -9 2-4edge.dat
  [1,16,0,5,-50,9,0,0,0,1,0,0,0,-9, ldraw_lib__2_4edge()],
// 1 16 0 -5 -50 9 0 0 0 1 0 0 0 -9 2-4edge.dat
  [1,16,0,-5,-50,9,0,0,0,1,0,0,0,-9, ldraw_lib__2_4edge()],
// 1 16 0 -5 -50 9 0 0 0 10 0 0 0 -9 2-4cyli.dat
  [1,16,0,-5,-50,9,0,0,0,10,0,0,0,-9, ldraw_lib__2_4cyli()],
// 1 16 0 5 50 9 0 0 0 1 0 0 0 9 2-4edge.dat
  [1,16,0,5,50,9,0,0,0,1,0,0,0,9, ldraw_lib__2_4edge()],
// 1 16 0 -5 50 9 0 0 0 1 0 0 0 9 2-4edge.dat
  [1,16,0,-5,50,9,0,0,0,1,0,0,0,9, ldraw_lib__2_4edge()],
...
// 1 16 0 -5 50 1 0 0 0 1 0 0 0 1 peghole.dat
  [1,16,0,-5,50,1,0,0,0,1,0,0,0,1, ldraw_lib__peghole()],
// 1 16 0 5 50 1 0 0 0 -1 0 0 0 1 peghole.dat
  [1,16,0,5,50,1,0,0,0,-1,0,0,0,1, ldraw_lib__peghole()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -3 50 6 0 0 0 6 0 0 0 6 4-4cyli.dat
  [1,16,0,-3,50,6,0,0,0,6,0,0,0,6, ldraw_lib__4_4cyli()],
// 1 16 0 -5 30 1 0 0 0 1 0 0 0 1 peghole.dat
  [1,16,0,-5,30,1,0,0,0,1,0,0,0,1, ldraw_lib__peghole()],
// 1 16 0 5 30 1 0 0 0 -1 0 0 0 1 peghole.dat
  [1,16,0,5,30,1,0,0,0,-1,0,0,0,1, ldraw_lib__peghole()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -3 30 6 0 0 0 6 0 0 0 6 4-4cyli.dat
  [1,16,0,-3,30,6,0,0,0,6,0,0,0,6, ldraw_lib__4_4cyli()],
...
// 1 16 -9 0 0 0 1 0 0 0 -5 -50 0 0 rect2p.dat
  [1,16,-9,0,0,0,1,0,0,0,-5,-50,0,0, ldraw_lib__rect2p()],
// 1 16 9 0 0 0 -1 0 0 0 -5 50 0 0 rect2p.dat
  [1,16,9,0,0,0,-1,0,0,0,-5,50,0,0, ldraw_lib__rect2p()],
// 1 16 0 -5 40 1 0 0 0 3 0 0 0 1 npeghol2.dat
  [1,16,0,-5,40,1,0,0,0,3,0,0,0,1, ldraw_lib__npeghol2()],
// 1 16 0 5 40 1 0 0 0 -3 0 0 0 1 npeghol2.dat
  [1,16,0,5,40,1,0,0,0,-3,0,0,0,1, ldraw_lib__npeghol2()],
// 1 16 0 -5 20 1 0 0 0 3 0 0 0 1 npeghol2.dat
  [1,16,0,-5,20,1,0,0,0,3,0,0,0,1, ldraw_lib__npeghol2()],
// 1 16 0 5 20 1 0 0 0 -3 0 0 0 1 npeghol2.dat
  [1,16,0,5,20,1,0,0,0,-3,0,0,0,1, ldraw_lib__npeghol2()],
// 1 16 0 -5 0 1 0 0 0 3 0 0 0 1 npeghol2.dat
  [1,16,0,-5,0,1,0,0,0,3,0,0,0,1, ldraw_lib__npeghol2()],
// 1 16 0 5 0 1 0 0 0 -3 0 0 0 1 npeghol2.dat
  [1,16,0,5,0,1,0,0,0,-3,0,0,0,1, ldraw_lib__npeghol2()],
// 1 16 0 -5 -20 1 0 0 0 3 0 0 0 1 npeghol2.dat
  [1,16,0,-5,-20,1,0,0,0,3,0,0,0,1, ldraw_lib__npeghol2()],
...
// 1 16 0 -5 30 1 0 0 0 1 0 0 0 1 4-4ring8.dat
  [1,16,0,-5,30,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4ring8()],
// 1 16 0 5 30 1 0 0 0 -1 0 0 0 1 4-4ring8.dat
  [1,16,0,5,30,1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4ring8()],
