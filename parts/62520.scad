...
use <../p/bush.scad>
$fa=1; $fs=0.2;
function ldraw_lib__62520(realsolid=false) = [
...
// 1 16 0 0 20 1 0 0 0 1 0 0 0 1 bush.dat
  [1,16,0,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__bush(realsolid)],
// 1 16 0 0 13.5 1 0 0 0 0 -1 0 0.5 0 4-4con7.dat
  [1,16,0,0,13.5,1,0,0,0,0,-1,0,0.5,0, ldraw_lib__4_4con7(realsolid)],
// 1 16 0 0 13 1 0 0 0 0 -1 0 0.5 0 4-4con8.dat
  [1,16,0,0,13,1,0,0,0,0,-1,0,0.5,0, ldraw_lib__4_4con8(realsolid)],
// 1 16 0 0 13 9 0 0 0 0 -9 0 1 0 4-4edge.dat
  [1,16,0,0,13,9,0,0,0,0,-9,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 9 0 0 9 9 0 0 0 4 0 4-4cyli.dat
  [1,16,0,0,9,0,0,9,9,0,0,0,4,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 0 9 3 0 0 0 0 -3 0 1 0 4-4cyli.dat
  [1,16,0,0,9,3,0,0,0,0,-3,0,1,0, ldraw_lib__4_4cyli(realsolid)],
// 0 // First half
...
// 1 16 6.36 0 0 0 1 0 -5 0 0 0 0 -5 2-4edge.dat
  [1,16,6.36,0,0,0,1,0,-5,0,0,0,0,-5, ldraw_lib__2_4edge(realsolid)],
// 1 16 6.36 0 0 0 1 0 -2 0 0 0 0 -2 2-4ring1.dat
  [1,16,6.36,0,0,0,1,0,-2,0,0,0,0,-2, ldraw_lib__2_4ring1(realsolid)],
// 1 16 6.36 0 0 0 1 0 -1 0 0 0 0 -1 2-4ring4.dat
  [1,16,6.36,0,0,0,1,0,-1,0,0,0,0,-1, ldraw_lib__2_4ring4(realsolid)],
...
// 1 16 7.276 0 0 0 1 0 -5 0 0 0 0 -5 2-4edge.dat
  [1,16,7.276,0,0,0,1,0,-5,0,0,0,0,-5, ldraw_lib__2_4edge(realsolid)],
// 1 16 9 0 0 -0.61 1 0 -2 0 0 0 0 2 1-4edge.dat
  [1,16,9,0,0,-0.61,1,0,-2,0,0,0,0,2, ldraw_lib__1_4edge(realsolid)],
// 1 16 8.39 0 0 0 1 0 -2 0 0 0 0 -2 2-4edge.dat
  [1,16,8.39,0,0,0,1,0,-2,0,0,0,0,-2, ldraw_lib__2_4edge(realsolid)],
// 1 16 7.276 0 0 0 0.371 0 -1 0 0 0 0 -1 2-4con4.dat
  [1,16,7.276,0,0,0,0.371,0,-1,0,0,0,0,-1, ldraw_lib__2_4con4(realsolid)],
// 1 16 7.647 0 0 0 0.743 0 -2 0 0 0 0 -2 2-4con1.dat
  [1,16,7.647,0,0,0,0.743,0,-2,0,0,0,0,-2, ldraw_lib__2_4con1(realsolid)],
// 1 16 6.36 0 0 0 1 0 0 0 -2 -2 0 0 4-4edge.dat
  [1,16,6.36,0,0,0,1,0,0,0,-2,-2,0,0, ldraw_lib__4_4edge(realsolid)],
// 2 24 0 9 9 3.44 8.32 8.46
  [2,24,0,9,9,3.44,8.32,8.46],
// 2 24 3.44 8.32 8.46 4.9 7.34 7.73
  [2,24,3.44,8.32,8.46,4.9,7.34,7.73],
...
// 1 16 0 0 9 0 0 3 3 0 0 0 0.5 -0.47 2-4edge.dat
  [1,16,0,0,9,0,0,3,3,0,0,0,0.5,-0.47, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 0 9 0 0 3 -3 0 0 0 0.5 -0.47 2-4ndis.dat
  [1,16,0,0,9,0,0,3,-3,0,0,0,0.5,-0.47, ldraw_lib__2_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 9 -3 0 0 0 0 3 0 -0.47 0 1-4cyls2.dat
  [1,16,0,0,9,-3,0,0,0,0,3,0,-0.47,0, ldraw_lib__1_4cyls2(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 9 -3 0 0 0 0 -3 0 -0.47 0 1-4cyls2.dat
  [1,16,0,0,9,-3,0,0,0,0,-3,0,-0.47,0, ldraw_lib__1_4cyls2(realsolid)],
// 1 16 6.36 0 0 0 1 0 -2 0 0 0 0 2 2-4ndis.dat
  [1,16,6.36,0,0,0,1,0,-2,0,0,0,0,2, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 7.276 0 0 0 -0.916 0 -5 0 0 0 0 -5 2-4cyli.dat
  [1,16,7.276,0,0,0,-0.916,0,-5,0,0,0,0,-5, ldraw_lib__2_4cyli(realsolid)],
...
// 1 16 8.39 0 0 0 -2.03 0 0 0 -2 2 0 0 4-4cyli.dat
  [1,16,8.39,0,0,0,-2.03,0,0,0,-2,2,0,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 8.39 0 0 0 0.61 0 -2 0 0 0 0 2 1-4cyls.dat
  [1,16,8.39,0,0,0,0.61,0,-2,0,0,0,0,2, ldraw_lib__1_4cyls(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 8.39 0 0 0 0.61 0 2 0 0 0 0 2 1-4cyls.dat
  [1,16,8.39,0,0,0,0.61,0,2,0,0,0,0,2, ldraw_lib__1_4cyls(realsolid)],
...
// 1 16 9 0 0 -0.61 -1 0 -2 0 0 0 0 2 1-4ndis.dat
  [1,16,9,0,0,-0.61,-1,0,-2,0,0,0,0,2, ldraw_lib__1_4ndis(realsolid)],
...
module ldraw_lib__62520(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__62520(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
