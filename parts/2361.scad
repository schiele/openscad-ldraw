...
use <s/2361s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2361(realsolid=false) = [
// 0 Baseplate 32 x 32 Road 7-Stud Crossroads
// 0 Name: 2361.dat
...
// 
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2361s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2361s01(realsolid)],
...
module ldraw_lib__2361(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2361(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2361(line=0.2);