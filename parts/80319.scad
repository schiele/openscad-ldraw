...
use <u9445.scad>
$fa=1; $fs=0.2;
function ldraw_lib__80319(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 79759.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__79759(realsolid)],
// 1 47 0 4 0 1 0 0 0 -1 0 0 0 -1 u9445.dat
  [1,47,0,4,0,1,0,0,0,-1,0,0,0,-1, ldraw_lib__u9445(realsolid)],
];
module ldraw_lib__80319(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__80319(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
