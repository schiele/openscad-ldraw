...
use <s/64991s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__64991(realsolid=false) = [
// 0 Sheet Fabric 28 x 17 Trapezoidal Sail
// 0 Name: 64991.dat
...
// 1 16 0 -0.25 0 1 0 0 0 1 0 0 0 1 s\64991s01.dat
  [1,16,0,-0.25,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__64991s01(realsolid)],
// 1 16 0 -0.25 0 -1 0 0 0 1 0 0 0 1 s\64991s01.dat
  [1,16,0,-0.25,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__64991s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 1 s\64991s01.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__64991s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 -1 0 0 0 1 s\64991s01.dat
  [1,16,0,0,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__s__64991s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\64991s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__64991s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\64991s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__64991s02(realsolid)],
];
module ldraw_lib__64991(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__64991(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
