...
use <s/34172s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__34172(realsolid=false) = [
// 0 Minifig Rice Bowl
// 0 Name: 34172.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\34172s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__34172s01(realsolid)],
// 
// 1 16 0 -16 0 7.25 0 0 0 11.231 0 0 0 7.25 r04o1000.dat
  [1,16,0,-16,0,7.25,0,0,0,11.231,0,0,0,7.25, ldraw_lib__r04o1000(realsolid)],
// 1 16 0 -16 0 7.25 0 0 0 11.231 0 0 0 -7.25 r04o1000.dat
  [1,16,0,-16,0,7.25,0,0,0,11.231,0,0,0,-7.25, ldraw_lib__r04o1000(realsolid)],
// 1 16 0 -16 0 -7.25 0 0 0 11.231 0 0 0 7.25 r04o1000.dat
  [1,16,0,-16,0,-7.25,0,0,0,11.231,0,0,0,7.25, ldraw_lib__r04o1000(realsolid)],
...
module ldraw_lib__34172(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__34172(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
