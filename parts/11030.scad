...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__11030(realsolid=false) = [
...
// 1 16 -15.1 0.3 -5.3 0 0 -4 0 12.7 0 -4 0 0 1-4cylo.dat
  [1,16,-15.1,0.3,-5.3,0,0,-4,0,12.7,0,-4,0,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -15.1 0 -5.3 0 0 -3.5 0 0.3 0 -3.5 0 0 1-4edge.dat
  [1,16,-15.1,0,-5.3,0,0,-3.5,0,0.3,0,-3.5,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -15.1 0.3 -5.3 0 0 -0.5 0 -0.3 0 -0.5 0 0 1-4con7.dat
  [1,16,-15.1,0.3,-5.3,0,0,-0.5,0,-0.3,0,-0.5,0,0, ldraw_lib__1_4con7(realsolid)],
// 1 16 -15.1 0 -5.3 0 0 -3.5 0 0.3 0 -3.5 0 0 1-4chrd.dat
  [1,16,-15.1,0,-5.3,0,0,-3.5,0,0.3,0,-3.5,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -15.1 13 -5.3 0 0 -4 0 -1 0 -4 0 0 1-4chrd.dat
  [1,16,-15.1,13,-5.3,0,0,-4,0,-1,0,-4,0,0, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 0 6.65 9.3 19.1 0 0 0 0 6.35 0 -1 0 rect.dat
  [1,16,0,6.65,9.3,19.1,0,0,0,0,6.35,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 -19.1 6.65 2 0 1 0 0 0 6.35 -7.3 0 0 rect2p.dat
  [1,16,-19.1,6.65,2,0,1,0,0,0,6.35,-7.3,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 19.1 6.65 4.55 0 -1 0 -6.35 0 0 0 0 -4.75 rect3.dat
  [1,16,19.1,6.65,4.55,0,-1,0,-6.35,0,0,0,0,-4.75, ldraw_lib__rect3(realsolid)],
// 1 16 14.55 6.65 -4.75 0 -1 -4.55 -6.35 0 0 0 1 -4.55 rect3.dat
  [1,16,14.55,6.65,-4.75,0,-1,-4.55,-6.35,0,0,0,1,-4.55, ldraw_lib__rect3(realsolid)],
// 1 16 -2.55 6.65 -9.3 -12.55 0 0 0 0 6.35 0 1 0 rect2p.dat
  [1,16,-2.55,6.65,-9.3,-12.55,0,0,0,0,6.35,0,1,0, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__11030(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11030(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
