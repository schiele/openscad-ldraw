...
use <4297014f.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4215bd01(realsolid=false) = [
...
// 1 16 0 34 6 1 0 0 0 0 -1 0 1 0 4297014f.dat
  [1,16,0,34,6,1,0,0,0,0,-1,0,1,0, ldraw_lib__4297014f(realsolid)],
// 0 //
];
module ldraw_lib__4215bd01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4215bd01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
