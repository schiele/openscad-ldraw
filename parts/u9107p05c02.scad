...
$fa=1; $fs=0.2;
function ldraw_lib__u9107p05c02(realsolid=false) = [
// 0 _Figure Fabuland Raccoon  2 with Body Red/Red/Black
// 0 Name: u9107p05c02.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bear, Racoon, Roger Raccoon, Set 3626
// 
...
module ldraw_lib__u9107p05c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9107p05c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9107p05c02(line=0.2);