...
$fa=1; $fs=0.2;
function ldraw_lib__44572(realsolid=false) = [
...
// 1 16 8.75 66 -20 0 -17.5 0 0 0 6 -6 0 0 7-16cyli.dat
  [1,16,8.75,66,-20,0,-17.5,0,0,0,6,-6,0,0, ldraw_lib__7_16cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 60.8981 -18.4783 6.25 0 0 0 0 7.3981 0 -4.0217 0 box2-5.dat
  [1,16,0,60.8981,-18.4783,6.25,0,0,0,0,7.3981,0,-4.0217,0, ldraw_lib__box2_5(realsolid)],
// 1 16 0 60.75 -26 8.75 0 0 0 0 -5.25 0 1 0 rect3.dat
  [1,16,0,60.75,-26,8.75,0,0,0,0,-5.25,0,1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 37.15 -26.25 0 0 36.25 -16.35 0 0 0 -1 0 rect.dat
  [1,16,0,37.15,-26.25,0,0,36.25,-16.35,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
...
// 1 16 0 5.375 -1.46 1.25 0 0 0 -2.625 0 0 2.735 -8.725 box2-7.dat
  [1,16,0,5.375,-1.46,1.25,0,0,0,-2.625,0,0,2.735,-8.725, ldraw_lib__box2_7(realsolid)],
// 3 16 1.25 2.75 10 -1.25 2.75 10 0 0 10
  [3,16,1.25,2.75,10,-1.25,2.75,10,0,0,10],
// 2 24 -1.25 2.75 10 1.25 2.75 10
  [2,24,-1.25,2.75,10,1.25,2.75,10],
// 1 16 0 0 0 0 0 40 0 4 0 10 0 0 rect.dat
  [1,16,0,0,0,0,0,40,0,4,0,10,0,0, ldraw_lib__rect(realsolid)],
// 0 // Front Face
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\44572s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__44572s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\44572s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__44572s01(realsolid)],
// 0 // Studs
...
module ldraw_lib__44572(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__44572(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
