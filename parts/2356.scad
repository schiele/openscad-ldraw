...
use <../p/stug-4x4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2356(realsolid=false) = [
// 0 Brick  4 x  6
// 0 Name: 2356.dat
...
// 1 16 -20 4 0 -1 0 0 0 1 0 0 0 -1 filletp2s.dat
  [1,16,-20,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletp2s(realsolid)],
// 1 16 -20 4 0 0 0 -1 0 1 0 1 0 0 filletp2s.dat
  [1,16,-20,4,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__filletp2s(realsolid)],
...
// 1 16 0 24 0 60 0 0 0 -24 0 0 0 40 box5.dat
  [1,16,0,24,0,60,0,0,0,-24,0,0,0,40, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__2356(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2356(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2356(line=0.2);