...
// 1 16 0 24 0 56 0 0 0 -20 0 0 0 16 box5.dat
  [1,16,0,24,0,56,0,0,0,-20,0,0,0,16, ldraw_lib__box5()],
// 
...
// 1 16 0 24 0 60 0 0 0 -24 0 0 0 20 box5.dat
  [1,16,0,24,0,60,0,0,0,-24,0,0,0,20, ldraw_lib__box5()],
// 
...
module ldraw_lib__2456(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2456(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
