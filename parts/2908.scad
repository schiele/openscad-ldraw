...
use <../p/8-8sphe.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2908(realsolid=false) = [
...
// 1 16 0 -2 0 18 0 0 0 10 0 0 0 18 4-4cylo.dat
  [1,16,0,-2,0,18,0,0,0,10,0,0,0,18, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 8 0 -2 0 0 0 -1 0 0 0 2 4-4ring9.dat
  [1,16,0,8,0,-2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring9(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 20 0 0 0 4 0 0 0 20 4-4cylo.dat
  [1,16,0,8,0,20,0,0,0,4,0,0,0,20, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 12 0 -2 0 0 0 -1 0 0 0 2 4-4rin10.dat
  [1,16,0,12,0,-2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4rin10(realsolid)],
// 1 16 0 0 0 22 0 0 0 12 0 0 0 22 4-4cylo.dat
  [1,16,0,0,0,22,0,0,0,12,0,0,0,22, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 0 0 -2 0 0 0 -1 0 0 0 2 4-4rin11.dat
  [1,16,0,0,0,-2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4rin11(realsolid)],
// 1 16 0 0 0 -1 0 0 0 -1 0 0 0 1 4-4rin24.dat
  [1,16,0,0,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4rin24(realsolid)],
// 1 16 0 -4 0 25 0 0 0 4 0 0 0 25 4-4cylo.dat
  [1,16,0,-4,0,25,0,0,0,4,0,0,0,25, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 -4 0 5 0 0 0 1 0 0 0 5 4-4ring4.dat
  [1,16,0,-4,0,5,0,0,0,1,0,0,0,5, ldraw_lib__4_4ring4(realsolid)],
...
// 1 16 0 -4 0 2 0 0 0 2 0 0 0 2 4-4con9.dat
  [1,16,0,-4,0,2,0,0,0,2,0,0,0,2, ldraw_lib__4_4con9(realsolid)],
// 
// 1 16 40 0 0 0 4 0 4 0 0 0 0 4 4-4cyl1sph2.dat
  [1,16,40,0,0,0,4,0,4,0,0,0,0,4, ldraw_lib__4_4cyl1sph2(realsolid)],
// 1 16 25 0 0 0 1 -0.8 -4 0 0 0 0 -4 1-4edge.dat
  [1,16,25,0,0,0,1,-0.8,-4,0,0,0,0,-4, ldraw_lib__1_4edge(realsolid)],
// 1 16 25 0 0 0 1 -0.8 -4 0 0 0 0 4 1-4edge.dat
  [1,16,25,0,0,0,1,-0.8,-4,0,0,0,0,4, ldraw_lib__1_4edge(realsolid)],
// 1 16 25 0 0 0 -0.8 0 0 0 -4 4 0 0 1-4cyls2.dat
  [1,16,25,0,0,0,-0.8,0,0,0,-4,4,0,0, ldraw_lib__1_4cyls2(realsolid)],
// 1 16 25 0 0 0 -0.8 0 0 0 -4 -4 0 0 1-4cyls2.dat
  [1,16,25,0,0,0,-0.8,0,0,0,-4,-4,0,0, ldraw_lib__1_4cyls2(realsolid)],
// 1 16 22 0 0 -0.8 1 0 0 0 4 4 0 0 1-4edge.dat
  [1,16,22,0,0,-0.8,1,0,0,0,4,4,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 22 0 0 -0.8 1 0 0 0 4 -4 0 0 1-4edge.dat
  [1,16,22,0,0,-0.8,1,0,0,0,4,-4,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 22 0 0 0 -0.8 0 0 0 4 -4 0 0 1-4cyls2.dat
  [1,16,22,0,0,0,-0.8,0,0,0,4,-4,0,0, ldraw_lib__1_4cyls2(realsolid)],
// 1 16 22 0 0 0 -0.8 0 0 0 4 4 0 0 1-4cyls2.dat
  [1,16,22,0,0,0,-0.8,0,0,0,4,4,0,0, ldraw_lib__1_4cyls2(realsolid)],
...
// 1 16 25 0 0 0 7 0 0 0 -4 4 0 0 4-4cyli.dat
  [1,16,25,0,0,0,7,0,0,0,-4,4,0,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 22 0 0 0 3 0 0 0 4 -4 0 0 2-4cyli.dat
  [1,16,22,0,0,0,3,0,0,0,4,-4,0,0, ldraw_lib__2_4cyli(realsolid)],
// 
// 1 16 -40 0 0 0 -4 0 4 0 0 0 0 -4 4-4cyl1sph2.dat
  [1,16,-40,0,0,0,-4,0,4,0,0,0,0,-4, ldraw_lib__4_4cyl1sph2(realsolid)],
// 1 16 -25 0 0 0 -1 0.8 -4 0 0 0 0 4 1-4edge.dat
...
// 1 16 0 0 25 0 0 4 -4 0 0 0 1 -0.8 1-4edge.dat
  [1,16,0,0,25,0,0,4,-4,0,0,0,1,-0.8, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 0 25 0 0 -4 -4 0 0 0 1 -0.8 1-4edge.dat
  [1,16,0,0,25,0,0,-4,-4,0,0,0,1,-0.8, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 0 25 -4 0 0 0 0 -4 0 -0.8 0 1-4cyls2.dat
  [1,16,0,0,25,-4,0,0,0,0,-4,0,-0.8,0, ldraw_lib__1_4cyls2(realsolid)],
// 1 16 0 0 25 4 0 0 0 0 -4 0 -0.8 0 1-4cyls2.dat
  [1,16,0,0,25,4,0,0,0,0,-4,0,-0.8,0, ldraw_lib__1_4cyls2(realsolid)],
// 1 16 0 0 22 -4 0 0 0 0 4 -0.8 1 0 1-4edge.dat
  [1,16,0,0,22,-4,0,0,0,0,4,-0.8,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 0 22 4 0 0 0 0 4 -0.8 1 0 1-4edge.dat
  [1,16,0,0,22,4,0,0,0,0,4,-0.8,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 0 22 4 0 0 0 0 4 0 -0.8 0 1-4cyls2.dat
  [1,16,0,0,22,4,0,0,0,0,4,0,-0.8,0, ldraw_lib__1_4cyls2(realsolid)],
// 1 16 0 0 22 -4 0 0 0 0 4 0 -0.8 0 1-4cyls2.dat
  [1,16,0,0,22,-4,0,0,0,0,4,0,-0.8,0, ldraw_lib__1_4cyls2(realsolid)],
...
// 1 16 0 0 25 -4 0 0 0 0 -4 0 7 0 4-4cyli.dat
  [1,16,0,0,25,-4,0,0,0,0,-4,0,7,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 22 4 0 0 0 0 4 0 3 0 2-4cyli.dat
  [1,16,0,0,22,4,0,0,0,0,4,0,3,0, ldraw_lib__2_4cyli(realsolid)],
// 
// 1 16 0 0 -40 0 0 4 4 0 0 0 -4 0 4-4cyl1sph2.dat
  [1,16,0,0,-40,0,0,4,4,0,0,0,-4,0, ldraw_lib__4_4cyl1sph2(realsolid)],
// 1 16 0 0 -25 0 0 -4 -4 0 0 0 -1 0.8 1-4edge.dat
...
// 1 16 40 0 0 8 0 0 0 8 0 0 0 8 8-8sphe.dat
  [1,16,40,0,0,8,0,0,0,8,0,0,0,8, ldraw_lib__8_8sphe(realsolid)],
// 1 16 -40 0 0 8 0 0 0 8 0 0 0 8 8-8sphe.dat
  [1,16,-40,0,0,8,0,0,0,8,0,0,0,8, ldraw_lib__8_8sphe(realsolid)],
...
module ldraw_lib__2908(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2908(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
