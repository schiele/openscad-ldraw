...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__11476(realsolid=false) = [
...
// 1 16 0 4 -10 0 0 -20 4 0 0 0 20 0 box3u4a.dat
  [1,16,0,4,-10,0,0,-20,4,0,0,0,20,0, ldraw_lib__box3u4a(realsolid)],
// 1 16 -12 4 -10 0 0 -8 -4 0 0 0 1 0 rect.dat
  [1,16,-12,4,-10,0,0,-8,-4,0,0,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 12 4 -10 0 0 -8 -4 0 0 0 1 0 rect.dat
  [1,16,12,4,-10,0,0,-8,-4,0,0,0,1,0, ldraw_lib__rect(realsolid)],
// 
...
module ldraw_lib__11476(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11476(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
