...
$fa=1; $fs=0.2;
function ldraw_lib__13710ac01(realsolid=false) = [
// 0 Sticker Mindstorms EV3 #1 for Panel Smooth Medium (Formed) (Needs Work)
// 0 Name: 13710ac01.dat
...
// 0 !TEXMAP START PLANAR -40.5287 11.1905 -6.3 -40.5287 11.1905 121.145 8.2407 -9 -6.3 13710a.png
...
module ldraw_lib__13710ac01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__13710ac01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__13710ac01(line=0.2);