...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6111(realsolid=false) = [
// 0 Brick  1 x 10
// 0 Name: 6111.dat
...
// 1 16 0 24 0 96 0 0 0 -20 0 0 0 6 box5.dat
  [1,16,0,24,0,96,0,0,0,-20,0,0,0,6, ldraw_lib__box5(realsolid)],
// 
...
// 1 16 0 24 0 100 0 0 0 -24 0 0 0 10 box5.dat
  [1,16,0,24,0,100,0,0,0,-24,0,0,0,10, ldraw_lib__box5(realsolid)],
// 
...
module ldraw_lib__6111(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6111(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
