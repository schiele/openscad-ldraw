...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\57910s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__57910s01()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\57910s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__57910s01()],
// 
...
// 1 16 22.5 19.75 0 0 0 2.5 0 -15.75 0 16 0 0 box4-1.dat
  [1,16,22.5,19.75,0,0,0,2.5,0,-15.75,0,16,0,0, ldraw_lib__box4_1()],
// 4 16 20 19.75 -16 20 19.75 16 20 4 16 20 4 -16
  [4,16,20,19.75,-16,20,19.75,16,20,4,16,20,4,-16],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 28.5714 10 0 0 2.7 0 -6.5 0 0 0 0 6.5 bump5000.dat
  [1,16,28.5714,10,0,0,2.7,0,-6.5,0,0,0,0,6.5, ldraw_lib__bump5000()],
...
module ldraw_lib__57910(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__57910(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
