...
use <s/19201s04.scad>
$fa=1; $fs=0.2;
function ldraw_lib__19201(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\19201s03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__19201s03(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\19201s04.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__19201s04(realsolid)],
];
module ldraw_lib__19201(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__19201(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
