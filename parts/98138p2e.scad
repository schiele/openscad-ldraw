...
use <s/98138s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98138p2e(realsolid=false) = [
...
// 1 0 4.5 0 0 4.5 0 0 0 1 0 0 0 4.5 4-4disc.dat
  [1,0,4.5,0,0,4.5,0,0,0,1,0,0,0,4.5, ldraw_lib__4_4disc(realsolid)],
// 1 16 4.5 0 0 0 0 -4.5 0 1 0 4.5 0 0 2-4ndis.dat
  [1,16,4.5,0,0,0,0,-4.5,0,1,0,4.5,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 4.5 0 0 4.5 0 0 0 1 0 0 0 4.5 1-4tang.dat
  [1,16,4.5,0,0,4.5,0,0,0,1,0,0,0,4.5, ldraw_lib__1_4tang(realsolid)],
// 1 16 4.5 0 0 4.5 0 0 0 1 0 0 0 -4.5 1-4tang.dat
  [1,16,4.5,0,0,4.5,0,0,0,1,0,0,0,-4.5, ldraw_lib__1_4tang(realsolid)],
// 
...
module ldraw_lib__98138p2e(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98138p2e(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__98138p2e(line=0.2);