...
// 1 16 0 -56 -4 60 0 0 0 0 60 0 -60 0 48\4-8sphe.dat
  [1,16,0,-56,-4,60,0,0,0,0,60,0,-60,0, ldraw_lib__48__4_8sphe()],
// 1 16 0 -56 4 0 0 60 -60 0 0 0 -8 0 48\3-8cyli.dat
  [1,16,0,-56,4,0,0,60,-60,0,0,0,-8,0, ldraw_lib__48__3_8cyli()],
// 1 16 0 -56 4 0 0 -60 -60 0 0 0 -8 0 48\3-8cyli.dat
  [1,16,0,-56,4,0,0,-60,-60,0,0,0,-8,0, ldraw_lib__48__3_8cyli()],
];
module ldraw_lib__30083(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30083(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
