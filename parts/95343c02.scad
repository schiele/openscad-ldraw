...
use <95344.scad>
$fa=1; $fs=0.2;
function ldraw_lib__95343c02(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 95343.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__95343(realsolid)],
// 1 16 0 -20.685 0 1 0 0 0 -0.469472 -0.882948 0 0.882948 -0.469472 95344.dat
  [1,16,0,-20.685,0,1,0,0,0,-0.469472,-0.882948,0,0.882948,-0.469472, ldraw_lib__95344(realsolid)],
];
module ldraw_lib__95343c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__95343c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
