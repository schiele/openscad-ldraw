...
use <29124.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9355(realsolid=false) = [
// 0 ~Moved to 29124
// 0 Name: u9355.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 29124.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__29124(realsolid)],
];
module ldraw_lib__u9355(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9355(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
