...
use <u9216.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48085(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 48083c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__48083c01(realsolid)],
// 1 4 0 55.6 138 1 0 0 0 1 0 0 0 1 48093.dat
  [1,4,0,55.6,138,1,0,0,0,1,0,0,0,1, ldraw_lib__48093(realsolid)],
// 1 4 0 55.5 117.5 1 0 0 0 1 0 0 0 1 u9216.dat
  [1,4,0,55.5,117.5,1,0,0,0,1,0,0,0,1, ldraw_lib__u9216(realsolid)],
];
module ldraw_lib__48085(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48085(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
