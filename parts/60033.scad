...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 4202, Rebrickable 4202
// 
...
// 1 16 -80 4 0 -1 0 0 0 1 0 0 0 -1 filletr2s.dat
  [1,16,-80,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletr2s()],
// 1 16 -40 4 0 -1 0 0 0 1 0 0 0 -1 filletr1s.dat
  [1,16,-40,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletr1s()],
// 1 16 0 4 0 -1 0 0 0 1 0 0 0 -1 filletr1s.dat
  [1,16,0,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletr1s()],
// 1 16 40 4 0 -1 0 0 0 1 0 0 0 -1 filletr1s.dat
  [1,16,40,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletr1s()],
// 1 16 80 4 0 -1 0 0 0 1 0 0 0 -1 filletr1s.dat
  [1,16,80,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletr1s()],
// 1 16 80 4 0 0 0 1 0 1 0 -1 0 0 filletr2s.dat
  [1,16,80,4,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__filletr2s()],
// 1 16 80 4 0 1 0 0 0 1 0 0 0 1 filletr2s.dat
  [1,16,80,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__filletr2s()],
// 1 16 40 4 0 1 0 0 0 1 0 0 0 1 filletr1s.dat
  [1,16,40,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__filletr1s()],
...
// 4 16 116.5 4 36.5 116.5 4 -36.5 -116.5 4 -36.5 -116.5 4 36.5
  [4,16,116.5,4,36.5,116.5,4,-36.5,-116.5,4,-36.5,-116.5,4,36.5],
// 4 16 116.5 24 36.5 -116.5 24 36.5 -120 24 40 120 24 40
  [4,16,116.5,24,36.5,-116.5,24,36.5,-120,24,40,120,24,40],
...
module ldraw_lib__60033(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__60033(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
