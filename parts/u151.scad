...
use <../p/4-4ring6.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u151(realsolid=false) = [
...
// 1 16 0 0 -1.5 0 0 17.25 17.25 0 0 0 3 0 4-4cylo.dat
  [1,16,0,0,-1.5,0,0,17.25,17.25,0,0,0,3,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 0 -1.5 0 0 20.125 20.125 0 0 0 3 0 4-4cylo.dat
  [1,16,0,0,-1.5,0,0,20.125,20.125,0,0,0,3,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 0 -1.5 2.875 0 0 0 0 2.875 0 1 0 4-4ring6.dat
  [1,16,0,0,-1.5,2.875,0,0,0,0,2.875,0,1,0, ldraw_lib__4_4ring6(realsolid)],
// 1 16 0 0 1.5 2.875 0 0 0 0 2.875 0 -1 0 4-4ring6.dat
  [1,16,0,0,1.5,2.875,0,0,0,0,2.875,0,-1,0, ldraw_lib__4_4ring6(realsolid)],
];
module ldraw_lib__u151(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u151(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
