...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 40931c01
// 
// 0 !HISTORY 2022-09-15 [PTadmin] Official Update 2022-05
// 
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 40930.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__40930()],
// 1 179 0 0 0 1 0 0 0 1 0 0 0 1 41852.dat
  [1,179,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__41852()],
// 1 0 0 24 0 1 0 0 0 1 0 0 0 1 40931.dat
  [1,0,0,24,0,1,0,0,0,1,0,0,0,1, ldraw_lib__40931()],
// 1 0 33 17 0 1 0 0 0 -1 0 0 0 -1 u9013.dat
  [1,0,33,17,0,1,0,0,0,-1,0,0,0,-1, ldraw_lib__u9013()],
// 1 0 -33 17 0 1 0 0 0 -1 0 0 0 -1 u9013.dat
  [1,0,-33,17,0,1,0,0,0,-1,0,0,0,-1, ldraw_lib__u9013()],
];
module ldraw_lib__46524(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__46524(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
