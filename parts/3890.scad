...
$fa=1; $fs=0.2;
function ldraw_lib__3890(realsolid=false) = [
...
// 1 16 31 27 -16 3 0 0 0 0 -3 0 -1 0 1-4ndis.dat
  [1,16,31,27,-16,3,0,0,0,0,-3,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 31 97 -16 3 0 0 0 0 3 0 -1 0 1-4ndis.dat
  [1,16,31,97,-16,3,0,0,0,0,3,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 0 24 -18 0 0 -1.5 0 -4 0 -2 0 0 box3u2p.dat
  [1,16,0,24,-18,0,0,-1.5,0,-4,0,-2,0,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 0 100 -18 31 0 0 0 1 0 0 0 2 rect2p.dat
  [1,16,0,100,-18,31,0,0,0,1,0,0,0,2, ldraw_lib__rect2p(realsolid)],
// 1 16 34 62 -18 0 1 0 35 0 0 0 0 2 rect2p.dat
  [1,16,34,62,-18,0,1,0,35,0,0,0,0,2, ldraw_lib__rect2p(realsolid)],
// 1 16 -34 62 -18 0 -1 0 35 0 0 0 0 2 rect2p.dat
  [1,16,-34,62,-18,0,-1,0,35,0,0,0,0,2, ldraw_lib__rect2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 31 27 -16 3 0 0 0 0 -3 0 -4 0 1-4cylo.dat
  [1,16,31,27,-16,3,0,0,0,0,-3,0,-4,0, ldraw_lib__1_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -31 27 -16 -3 0 0 0 0 -3 0 -4 0 1-4cylo.dat
  [1,16,-31,27,-16,-3,0,0,0,0,-3,0,-4,0, ldraw_lib__1_4cylo(realsolid)],
...
// 1 16 31 97 -16 3 0 0 0 0 3 0 -4 0 1-4cylo.dat
  [1,16,31,97,-16,3,0,0,0,0,3,0,-4,0, ldraw_lib__1_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -31 97 -16 -3 0 0 0 0 3 0 -4 0 1-4cylo.dat
  [1,16,-31,97,-16,-3,0,0,0,0,3,0,-4,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -16.25 24 -18 14.75 0 0 0 -1 0 0 0 2 rect2p.dat
  [1,16,-16.25,24,-18,14.75,0,0,0,-1,0,0,0,2, ldraw_lib__rect2p(realsolid)],
// 1 16 16.25 24 -18 14.75 0 0 0 -1 0 0 0 2 rect2p.dat
  [1,16,16.25,24,-18,14.75,0,0,0,-1,0,0,0,2, ldraw_lib__rect2p(realsolid)],
...
// 1 16 31 27 -20 3 0 0 0 0 -3 0 1 0 1-4ndis.dat
  [1,16,31,27,-20,3,0,0,0,0,-3,0,1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 31 97 -20 3 0 0 0 0 3 0 1 0 1-4ndis.dat
  [1,16,31,97,-20,3,0,0,0,0,3,0,1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 0 58 -16 56 0 0 0 0 -54 0 36 0 box4.dat
  [1,16,0,58,-16,56,0,0,0,0,-54,0,36,0, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 138 20 -56 0 0 0 0 -22 0 -36 0 box5.dat
  [1,16,0,138,20,-56,0,0,0,0,-22,0,-36,0, ldraw_lib__box5(realsolid)],
// 1 16 0 168 0 0 0 -60 0 -168 0 -20 0 0 box3u2p.dat
  [1,16,0,168,0,0,0,-60,0,-168,0,-20,0,0, ldraw_lib__box3u2p(realsolid)],
...
module ldraw_lib__3890(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3890(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
