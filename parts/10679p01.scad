...
use <3817b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__10679p01(realsolid=false) = [
// 0 Minifig Hips and Legs with Flat Silver Robotic Leg Right
// 0 Name: 10679p01.dat
...
// 1 179 0 12 0 1 0 0 0 1 0 0 0 1 10177.dat
  [1,179,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__10177(realsolid)],
...
module ldraw_lib__10679p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__10679p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
