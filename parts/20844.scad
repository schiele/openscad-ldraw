...
use <u9323.scad>
$fa=1; $fs=0.2;
function ldraw_lib__20844(realsolid=false) = [
...
// 1 71 0 0 0 1 0 0 0 1 0 0 0 1 u9323.dat
  [1,71,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9323(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 20842.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__20842(realsolid)],
...
// 1 32 28 10 -10 0 0 -1 0 1 0 1 0 0 62503.dat
  [1,32,28,10,-10,0,0,-1,0,1,0,1,0,0, ldraw_lib__62503(realsolid)],
...
module ldraw_lib__20844(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__20844(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
