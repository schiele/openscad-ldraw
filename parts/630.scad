...
use <637.scad>
$fa=1; $fs=0.2;
function ldraw_lib__630(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 631.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__631(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 632.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__632(realsolid)],
// 1 16 0 -87.95 156.54 1 0 0 0 0.8457 -0.5336 0 0.5336 0.8457 633.dat
  [1,16,0,-87.95,156.54,1,0,0,0,0.8457,-0.5336,0,0.5336,0.8457, ldraw_lib__633(realsolid)],
// 1 256 0 -116.71 138.4 1 0 0 0 0.8457 -0.5336 0 0.5336 0.8457 634.dat
  [1,256,0,-116.71,138.4,1,0,0,0,0.8457,-0.5336,0,0.5336,0.8457, ldraw_lib__634(realsolid)],
// 1 16 0 -42 20 -1 0 0 0 0.98 -0.17 0 0.17 0.98 635.dat
  [1,16,0,-42,20,-1,0,0,0,0.98,-0.17,0,0.17,0.98, ldraw_lib__635(realsolid)],
// 1 16 0 -191.41 256.8 1 0 0 0 0.8457 -0.5336 0 0.5336 0.8457 636.dat
  [1,16,0,-191.41,256.8,1,0,0,0,0.8457,-0.5336,0,0.5336,0.8457, ldraw_lib__636(realsolid)],
// 1 16 0 -7.95 164.54 -1 0 0 0 1 0 0 0 1 637.dat
  [1,16,0,-7.95,164.54,-1,0,0,0,1,0,0,0,1, ldraw_lib__637(realsolid)],
];
module ldraw_lib__630(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__630(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
