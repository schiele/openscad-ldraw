...
use <../p/stug-2x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30159(realsolid=false) = [
...
// 1 16 0 0 0 20 0 0 0 8 0 0 0 20 box4o4a.dat
  [1,16,0,0,0,20,0,0,0,8,0,0,0,20, ldraw_lib__box4o4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 6 8 0 0 16 2 0 0 0 8 0 box3u2p.dat
  [1,16,0,6,8,0,0,16,2,0,0,0,8,0, ldraw_lib__box3u2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 6 -8 0 0 -16 2 0 0 0 -8 0 box3u2p.dat
  [1,16,0,6,-8,0,0,-16,2,0,0,0,-8,0, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 17.5 16.5 -6 -2.5 0 0 0 -1 3.5 0 0 2 rect.dat
  [1,16,17.5,16.5,-6,-2.5,0,0,0,-1,3.5,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 17.5 20 -3.25 -2.5 0 0 0 -1 0 0 0 .75 rect3.dat
  [1,16,17.5,20,-3.25,-2.5,0,0,0,-1,0,0,0,.75, ldraw_lib__rect3(realsolid)],
// 1 16 17.5 18 -1.955 -2.5 0 0 0 -1 -2 0 0 .545 rect3.dat
  [1,16,17.5,18,-1.955,-2.5,0,0,0,-1,-2,0,0,.545, ldraw_lib__rect3(realsolid)],
// 4 16 15 13 8 16 8 8 20 8 8 20 13 8
  [4,16,15,13,8,16,8,8,20,8,8,20,13,8],
// 1 16 17.5 16.5 6 0 0 2.5 -3.5 -1 0 2 0 0 rect.dat
  [1,16,17.5,16.5,6,0,0,2.5,-3.5,-1,0,2,0,0, ldraw_lib__rect(realsolid)],
// 1 16 17.5 20 3.25 0 0 2.5 0 -1 0 .75 0 0 rect.dat
  [1,16,17.5,20,3.25,0,0,2.5,0,-1,0,.75,0,0, ldraw_lib__rect(realsolid)],
// 1 16 17.5 18 1.955 2.5 0 0 0 -1 -2 0 0 -.545 rect3.dat
  [1,16,17.5,18,1.955,2.5,0,0,0,-1,-2,0,0,-.545, ldraw_lib__rect3(realsolid)],
// 1 16 20 14.59 0 0 -1 0 1.41 0 -1.41 -1.41 0 -1.41 3-4ndis.dat
  [1,16,20,14.59,0,0,-1,0,1.41,0,-1.41,-1.41,0,-1.41, ldraw_lib__3_4ndis(realsolid)],
// 1 16 15 14.59 0 0 1 0 1.41 0 -1.41 -1.41 0 -1.41 3-4ndis.dat
  [1,16,15,14.59,0,0,1,0,1.41,0,-1.41,-1.41,0,-1.41, ldraw_lib__3_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 15 14.59 0 0 5 0 1.41 0 -1.41 -1.41 0 -1.41 3-4cylo.dat
  [1,16,15,14.59,0,0,5,0,1.41,0,-1.41,-1.41,0,-1.41, ldraw_lib__3_4cylo(realsolid)],
...
// 1 16 -17.5 20 3.25 2.5 0 0 0 -1 0 0 0 -.75 rect.dat
  [1,16,-17.5,20,3.25,2.5,0,0,0,-1,0,0,0,-.75, ldraw_lib__rect(realsolid)],
// 1 16 -17.5 18 1.955 2.5 0 0 0 -1 -2 0 0 -.545 rect3.dat
  [1,16,-17.5,18,1.955,2.5,0,0,0,-1,-2,0,0,-.545, ldraw_lib__rect3(realsolid)],
// 4 16 -15 13 -8 -16 8 -8 -20 8 -8 -20 13 -8
  [4,16,-15,13,-8,-16,8,-8,-20,8,-8,-20,13,-8],
...
module ldraw_lib__30159(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30159(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
