...
$fa=1; $fs=0.2;
function ldraw_lib__3298p10(realsolid=false) = [
...
// 1 16 0 10.0001 -30.0003 20 0 0 0 .8944 -8.9443 0 .4472 17.8885 48\1-4ndis.dat
  [1,16,0,10.0001,-30.0003,20,0,0,0,.8944,-8.9443,0,.4472,17.8885, ldraw_lib__48__1_4ndis(realsolid)],
// 1 16 0 10.0001 -30.0003 0 0 20 8.9443 .8944 0 -17.8885 .4472 0 48\1-4ndis.dat
  [1,16,0,10.0001,-30.0003,0,0,20,8.9443,.8944,0,-17.8885,.4472,0, ldraw_lib__48__1_4ndis(realsolid)],
// 1 16 0 10.0001 -30.0003 -20 0 0 0 .8944 8.9443 0 .4472 -17.8885 48\1-4ndis.dat
  [1,16,0,10.0001,-30.0003,-20,0,0,0,.8944,8.9443,0,.4472,-17.8885, ldraw_lib__48__1_4ndis(realsolid)],
// 1 16 0 10.0001 -30.0003 0 0 -20 -8.9443 .8944 0 17.8885 .4472 0 48\1-4ndis.dat
  [1,16,0,10.0001,-30.0003,0,0,-20,-8.9443,.8944,0,17.8885,.4472,0, ldraw_lib__48__1_4ndis(realsolid)],
...
// 1 1 0 10.0001 -30.0003 1 0 0 0 .8944 -.4472 0 .4472 .8944 s\973p55s01.dat
  [1,1,0,10.0001,-30.0003,1,0,0,0,.8944,-.4472,0,.4472,.8944, ldraw_lib__s__973p55s01(realsolid)],
];
module ldraw_lib__3298p10(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3298p10(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
