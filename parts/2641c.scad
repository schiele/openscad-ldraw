...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2641c(realsolid=false) = [
...
// 1 16 42 4 10 0 0 2 0 4 0 -1.5 0 0 box4-4a.dat
  [1,16,42,4,10,0,0,2,0,4,0,-1.5,0,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 10 4 42 1.5 0 0 0 4 0 0 0 2 box4-4a.dat
  [1,16,10,4,42,1.5,0,0,0,4,0,0,0,2, ldraw_lib__box4_4a(realsolid)],
...
// 1 16 40 6 6.25 0 -1 0 2 0 0 0 0 2.25 rect.dat
  [1,16,40,6,6.25,0,-1,0,2,0,0,0,0,2.25, ldraw_lib__rect(realsolid)],
// 1 16 13.75 6 40 2.25 0 0 0 0 -2 0 -1 0 rect.dat
  [1,16,13.75,6,40,2.25,0,0,0,0,-2,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 6.25 6 40 2.25 0 0 0 0 -2 0 -1 0 rect.dat
  [1,16,6.25,6,40,2.25,0,0,0,0,-2,0,-1,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 6 40 0 0 6 2 0 0 0 16 0 box3u2p.dat
  [1,16,10,6,40,0,0,6,2,0,0,0,16,0, ldraw_lib__box3u2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 40 6 10 0 16 0 2 0 0 0 0 -6 box3u2p.dat
  [1,16,40,6,10,0,16,0,2,0,0,0,0,-6, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 20 8 20 16 0 0 0 -4 0 0 0 16 box5.dat
  [1,16,20,8,20,16,0,0,0,-4,0,0,0,16, ldraw_lib__box5(realsolid)],
// 
// 1 16 28 6 40 0 0 8 2 0 0 0 -1 0 rect3.dat
  [1,16,28,6,40,0,0,8,2,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 40 6 28 0 -1 0 -2 0 0 0 0 8 rect3.dat
  [1,16,40,6,28,0,-1,0,-2,0,0,0,0,8, ldraw_lib__rect3(realsolid)],
...
// 1 16 34.34475 13.572 45.65525 1.415 1 0 0 0 -9.572 -1.415 0 0 rect.dat
  [1,16,34.34475,13.572,45.65525,1.415,1,0,0,0,-9.572,-1.415,0,0, ldraw_lib__rect(realsolid)],
// 1 16 45.65525 13.572 34.34475 1.415 1 0 0 0 -9.572 -1.415 0 0 rect.dat
  [1,16,45.65525,13.572,34.34475,1.415,1,0,0,0,-9.572,-1.415,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 40 6 44.24125 0 -1 0 0 0 2 -4.2415 0 0 rect.dat
  [1,16,40,6,44.24125,0,-1,0,0,0,2,-4.2415,0,0, ldraw_lib__rect(realsolid)],
// 1 16 44.24125 6 40 0 0 4.241 -2 0 0 0 -1 0 rect3.dat
  [1,16,44.24125,6,40,0,0,4.241,-2,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 42.24125 6 36 0 0 2.2415 2 0 0 0 1 0 rect3.dat
  [1,16,42.24125,6,36,0,0,2.2415,2,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 36 6 42.24125 0 1 0 -2 0 0 0 0 2.241 rect3.dat
  [1,16,36,6,42.24125,0,1,0,-2,0,0,0,0,2.241, ldraw_lib__rect3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 48 6 30.93 0 8 0 2 0 0 0 0 -10.93 box2-5.dat
  [1,16,48,6,30.93,0,8,0,2,0,0,0,0,-10.93, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 30.93 6 48 0 -10.93 0 2 0 0 0 0 8 box2-5.dat
  [1,16,30.93,6,48,0,-10.93,0,2,0,0,0,0,8, ldraw_lib__box2_5(realsolid)],
...
// 1 16 52.22375 4 52.22375 -7.983 0 -4.243 0 -1 0 -7.9815 0 4.243 rect2p.dat
  [1,16,52.22375,4,52.22375,-7.983,0,-4.243,0,-1,0,-7.9815,0,4.243, ldraw_lib__rect2p(realsolid)],
...
// 1 16 18 8 48 2 0 0 0 -1 0 0 0 -8 rect1.dat
  [1,16,18,8,48,2,0,0,0,-1,0,0,0,-8, ldraw_lib__rect1(realsolid)],
// 1 16 48 8 18 0 0 -8 0 -1 0 -2 0 0 rect1.dat
  [1,16,48,8,18,0,0,-8,0,-1,0,-2,0,0, ldraw_lib__rect1(realsolid)],
...
module ldraw_lib__2641c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2641c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
