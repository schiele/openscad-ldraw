...
use <../p/stug-2x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92580(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\92580s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92580s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\92580s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__92580s01(realsolid)],
// 
// 0 // Inside
...
// 1 16 0 44.3523 -106 0 0 7.5044 -1.6477 0 0 0 -1 0 rect.dat
  [1,16,0,44.3523,-106,0,0,7.5044,-1.6477,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
...
// 1 16 38.3431 60.8737 -50 0 -76.6862 0 -58.8737 0 0 0 0 -58.8737 48\3-16cylo.dat
  [1,16,38.3431,60.8737,-50,0,-76.6862,0,-58.8737,0,0,0,0,-58.8737, ldraw_lib__48__3_16cylo(realsolid)],
// 4 16 -4 2 -26 4 2 -26 38.3431 2 -50 -38.3431 2 -50
  [4,16,-4,2,-26,4,2,-26,38.3431,2,-50,-38.3431,2,-50],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 2 -20 4 0 0 0 -.5 0 0 0 6 box3u8p.dat
  [1,16,0,2,-20,4,0,0,0,-.5,0,0,0,6, ldraw_lib__box3u8p(realsolid)],
...
// 1 16 0 44 -110 40 0 0 0 0 -2 0 1 0 rect2p.dat
  [1,16,0,44,-110,40,0,0,0,0,-2,0,1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 40 60.909 -50 0 -80 0 -62.909 0 0 0 0 -62.909 48\3-16cylo.dat
  [1,16,40,60.909,-50,0,-80,0,-62.909,0,0,0,0,-62.909, ldraw_lib__48__3_16cylo(realsolid)],
...
module ldraw_lib__92580(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92580(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
