...
use <20461p05.scad>
use <3815b.scad>
function ldraw_lib__21019p05() = [
// 0 ~Minifig Hips and Legs with Black Lower Leg Pattern (Obsolete)
// 0 Name: 21019p05.dat
...
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 20460p05.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__20460p05()],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 20461p05.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__20461p05()],
];
module ldraw_lib__21019p05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__21019p05(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
