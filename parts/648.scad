...
// 1 16 260 0 -100 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,260,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2()],
...
// 1 16 -270 0 0 1 0 0 0 1 0 0 0 1 stug-4x1.dat
  [1,16,-270,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x1()],
// 1 16 -250 0 -50 1 0 0 0 1 0 0 0 1 stug-3x1.dat
  [1,16,-250,0,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_3x1()],
// 1 16 -250 0 50 1 0 0 0 1 0 0 0 1 stug-3x1.dat
  [1,16,-250,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_3x1()],
// 1 16 -210 0 50 1 0 0 0 1 0 0 0 1 stug-3x3.dat
  [1,16,-210,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_3x3()],
// 1 16 -210 0 -50 1 0 0 0 1 0 0 0 1 stug-3x3.dat
  [1,16,-210,0,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_3x3()],
...
// 1 16 150 0 50 1 0 0 0 1 0 0 0 1 stug-3x3.dat
  [1,16,150,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_3x3()],
// 1 16 90 0 -50 1 0 0 0 1 0 0 0 1 stug-3x3.dat
  [1,16,90,0,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_3x3()],
// 1 16 150 0 -50 1 0 0 0 1 0 0 0 1 stug-3x3.dat
  [1,16,150,0,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_3x3()],
...
// 1 16 220 0 30 1 0 0 0 1 0 0 0 1 stug-1x4.dat
  [1,16,220,0,30,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x4()],
// 1 16 220 0 -30 1 0 0 0 1 0 0 0 1 stug-1x4.dat
  [1,16,220,0,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x4()],
// 1 16 270 0 0 1 0 0 0 1 0 0 0 1 stug-4x1.dat
  [1,16,270,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x1()],
...
module ldraw_lib__648(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__648(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
