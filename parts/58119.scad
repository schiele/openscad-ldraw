...
use <920.scad>
$fa=1; $fs=0.2;
function ldraw_lib__58119(realsolid=false) = [
...
// 1 25 20 -70 -10 0 0 -1 0 1 0 1 0 0 920.dat
  [1,25,20,-70,-10,0,0,-1,0,1,0,1,0,0, ldraw_lib__920(realsolid)],
// 0
];
module ldraw_lib__58119(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__58119(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
