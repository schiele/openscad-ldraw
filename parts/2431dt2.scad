...
use <6258203h.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2431dt2(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6258203h.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6258203h(realsolid)],
];
module ldraw_lib__2431dt2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2431dt2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
