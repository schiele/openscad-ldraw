...
use <87544.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87544dq1(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 87544.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__87544(realsolid)],
// 1 16 0 36 10 -1 0 0 0 0 -1 0 -1 0 4613907b.dat
  [1,16,0,36,10,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__4613907b(realsolid)],
];
module ldraw_lib__87544dq1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87544dq1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
