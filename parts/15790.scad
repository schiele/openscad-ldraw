...
use <s/30332s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__15790(realsolid=false) = [
...
// 1 16 0 0 -10 10 0 0 0 0 10 0 20 0 48\4-4cylo.dat
  [1,16,0,0,-10,10,0,0,0,0,10,0,20,0, ldraw_lib__48__4_4cylo(realsolid)],
...
// 1 16 0 0 -10 -10 0 0 0 0 10 0 1 0 48\4-4aring.dat
  [1,16,0,0,-10,-10,0,0,0,0,10,0,1,0, ldraw_lib__48__4_4aring(realsolid)],
// 1 16 0 0 10 1 0 0 0 0 1 0 -1 0 4-4ring9.dat
  [1,16,0,0,10,1,0,0,0,0,1,0,-1,0, ldraw_lib__4_4ring9(realsolid)],
// 1 16 0 0 10 10 0 0 0 0 10 0 -1 0 48\4-4aring.dat
  [1,16,0,0,10,10,0,0,0,0,10,0,-1,0, ldraw_lib__48__4_4aring(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30332s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30332s01(realsolid)],
// 1 16 0 0 0 -0.5 0.86603 0 -0.86603 -0.5 0 0 0 1 s\30332s01.dat
  [1,16,0,0,0,-0.5,0.86603,0,-0.86603,-0.5,0,0,0,1, ldraw_lib__s__30332s01(realsolid)],
// 1 16 0 0 0 -0.5 -0.86603 0 0.86603 -0.5 0 0 0 1 s\30332s01.dat
  [1,16,0,0,0,-0.5,-0.86603,0,0.86603,-0.5,0,0,0,1, ldraw_lib__s__30332s01(realsolid)],
];
module ldraw_lib__15790(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__15790(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
