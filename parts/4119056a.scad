...
use <../p/1-4disc.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4119056a(realsolid=false) = [
...
// 1 1 16.5 -0.25 -6.5 0 0 3 0 3 0 -3 0 0 1-4disc.dat
  [1,1,16.5,-0.25,-6.5,0,0,3,0,3,0,-3,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 1 -16.5 -0.25 -6.5 -3 0 0 0 3 0 0 0 -3 1-4disc.dat
  [1,1,-16.5,-0.25,-6.5,-3,0,0,0,3,0,0,0,-3, ldraw_lib__1_4disc(realsolid)],
// 1 15 -16.5 -0.25 6.5 0 0 -3 0 3 0 3 0 0 1-4disc.dat
  [1,15,-16.5,-0.25,6.5,0,0,-3,0,3,0,3,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 15 16.5 -0.25 6.5 3 0 0 0 3 0 0 0 3 1-4disc.dat
  [1,15,16.5,-0.25,6.5,3,0,0,0,3,0,0,0,3, ldraw_lib__1_4disc(realsolid)],
...
// 1 15 -16.5 0 6.5 -3 0 0 0 -3 0 0 0 3 1-4disc.dat
  [1,15,-16.5,0,6.5,-3,0,0,0,-3,0,0,0,3, ldraw_lib__1_4disc(realsolid)],
// 1 15 -16.5 0 6.5 -3 0 0 0 -0.25 0 0 0 3 1-4cyli.dat
  [1,15,-16.5,0,6.5,-3,0,0,0,-0.25,0,0,0,3, ldraw_lib__1_4cyli(realsolid)],
// 1 15 16.5 0 6.5 0 0 3 0 -3 0 3 0 0 1-4disc.dat
  [1,15,16.5,0,6.5,0,0,3,0,-3,0,3,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 15 16.5 0 6.5 0 0 3 0 -0.25 0 3 0 0 1-4cyli.dat
  [1,15,16.5,0,6.5,0,0,3,0,-0.25,0,3,0,0, ldraw_lib__1_4cyli(realsolid)],
// 1 15 16.5 0 -6.5 3 0 0 0 -3 0 0 0 -3 1-4disc.dat
  [1,15,16.5,0,-6.5,3,0,0,0,-3,0,0,0,-3, ldraw_lib__1_4disc(realsolid)],
// 1 15 16.5 0 -6.5 3 0 0 0 -0.25 0 0 0 -3 1-4cyli.dat
  [1,15,16.5,0,-6.5,3,0,0,0,-0.25,0,0,0,-3, ldraw_lib__1_4cyli(realsolid)],
...
module ldraw_lib__4119056a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4119056a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4119056a(line=0.2);