...
use <191936d.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s7(realsolid=false) = [
// 0 ~Moved to 191936d
// 0 Name: s7.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 191936d.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__191936d(realsolid)],
];
module ldraw_lib__s7(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s7(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
