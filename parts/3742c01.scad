...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3742sprue
// 
...
// 1 16 0 3 0 -1 0 0 0 -1 0 0 0 1 4-4ring4.dat
  [1,16,0,3,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4ring4()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 3 0 4 0 0 0 1 0 0 0 4 bump5000.dat
  [1,16,0,3,0,4,0,0,0,1,0,0,0,4, ldraw_lib__bump5000()],
...
// 1 16 6.5 0 1.25 2.5 0 0 0 0 2.5 0 -2.5 0 tri3u3.dat
  [1,16,6.5,0,1.25,2.5,0,0,0,0,2.5,0,-2.5,0, ldraw_lib__tri3u3()],
// 1 16 5.625 0 0 -0.875 0 0 0 2.5 0 0 0 -1.25 box3u6.dat
  [1,16,5.625,0,0,-0.875,0,0,0,2.5,0,0,0,-1.25, ldraw_lib__box3u6()],
// 1 16 1.7338 2.5 0 3.01776 0 1.25 0 -1 0 -1.25 0 3.01776 1-8edge.dat
  [1,16,1.7338,2.5,0,3.01776,0,1.25,0,-1,0,-1.25,0,3.01776, ldraw_lib__1_8edge()],
// 4 16 8.75 0 1.25 8.75 0 -1.25 9 0 -1.25 9 0 1.25
  [4,16,8.75,0,1.25,8.75,0,-1.25,9,0,-1.25,9,0,1.25],
// 1 16 1.25 0 -6.5 0 -2.5 0 0 0 2.5 -2.5 0 0 tri3u3.dat
  [1,16,1.25,0,-6.5,0,-2.5,0,0,0,2.5,-2.5,0,0, ldraw_lib__tri3u3()],
// 1 16 0 0 -5.625 0 0 -1.25 0 2.5 0 0.875 0 0 box3u6.dat
  [1,16,0,0,-5.625,0,0,-1.25,0,2.5,0,0.875,0,0, ldraw_lib__box3u6()],
// 1 16 0 2.5 -1.7338 -1.25 0 3.01776 0 -1 0 -3.01776 0 -1.25 1-8edge.dat
  [1,16,0,2.5,-1.7338,-1.25,0,3.01776,0,-1,0,-3.01776,0,-1.25, ldraw_lib__1_8edge()],
...
// 1 16 0 0 0 -1 0 0 0 -5 0 0 0 1 4-4con8.dat
  [1,16,0,0,0,-1,0,0,0,-5,0,0,0,1, ldraw_lib__4_4con8()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -5 0 -8 0 0 0 -1 0 0 0 8 bump5000.dat
  [1,16,0,-5,0,-8,0,0,0,-1,0,0,0,8, ldraw_lib__bump5000()],
// 1 16 20.9 0 0 0 0 -1 0 1 0 1 0 0 3742.dat
  [1,16,20.9,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__3742()],
// 1 16 0 0 20.9 -1 0 0 0 1 0 0 0 -1 3742.dat
  [1,16,0,0,20.9,-1,0,0,0,1,0,0,0,-1, ldraw_lib__3742()],
// 1 16 -20.9 0 0 0 0 1 0 1 0 -1 0 0 3742.dat
  [1,16,-20.9,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__3742()],
// 1 16 0 0 -20.9 1 0 0 0 1 0 0 0 1 3742.dat
  [1,16,0,0,-20.9,1,0,0,0,1,0,0,0,1, ldraw_lib__3742()],
...
module ldraw_lib__3742c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3742c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
