...
use <3820.scad>
use <973p4q.scad>
function ldraw_lib__76382p4q() = [
// 0 Minifig Torso with Arms and Hands with Green Castle Bodice Pattern
// 0 Name: 76382p4q.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973p4q.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973p4q()],
...
module ldraw_lib__76382p4q(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382p4q(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382p4q(line=0.2);