...
use <s/37702s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__37702p01(realsolid=false) = [
...
// 1 82 18 8 0 4 0 0 0 -2 0 0 0 -2.5 box5.dat
  [1,82,18,8,0,4,0,0,0,-2,0,0,0,-2.5, ldraw_lib__box5(realsolid)],
// 1 82 -18 8 0 4 0 0 0 -2 0 0 0 -2.5 box5.dat
  [1,82,-18,8,0,4,0,0,0,-2,0,0,0,-2.5, ldraw_lib__box5(realsolid)],
];
module ldraw_lib__37702p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__37702p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
