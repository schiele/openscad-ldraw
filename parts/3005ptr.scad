...
use <s/3005s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3005ptr(realsolid=false) = [
...
// 1 1 2 9 -10 0 0 2 2 0 0 0 1 0 2-4ndis.dat
  [1,1,2,9,-10,0,0,2,2,0,0,0,1,0, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 2 9 -10 0 0 2 2 0 0 0 1 0 2-4disc.dat
  [1,16,2,9,-10,0,0,2,2,0,0,0,1,0, ldraw_lib__2_4disc(realsolid)],
...
module ldraw_lib__3005ptr(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3005ptr(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
