...
use <../p/confric.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6048(realsolid=false) = [
// 0 Arm Piece with Pin and 2 Fingers
// 0 Name: 6048.dat
...
// 1 16 0 0 -2 10 0 0 0 0 10 0 -1 0 4-4edge.dat
  [1,16,0,0,-2,10,0,0,0,0,10,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -2 -10 0 0 0 0 10 0 1 0 4-4disc.dat
  [1,16,0,0,-2,-10,0,0,0,0,10,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 -2 1 0 0 0 0 1 0 1 0 confric.dat
  [1,16,0,0,-2,1,0,0,0,0,1,0,1,0, ldraw_lib__confric(realsolid)],
// 1 16 0 0 2 1 0 0 0 1 0 0 0 -1 arm1.dat
  [1,16,0,0,2,1,0,0,0,1,0,0,0,-1, ldraw_lib__arm1(realsolid)],
];
module ldraw_lib__6048(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6048(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6048(line=0.2);