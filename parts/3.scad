...
use <../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3(realsolid=false) = [
...
// 1 16 0 0 -2 36 0 0 0 40 0 0 0 38 box5.dat
  [1,16,0,0,-2,36,0,0,0,40,0,0,0,38, ldraw_lib__box5(realsolid)],
// 0
// 1 16 0 20 -44 5.5 0 0 0 0 1 0 4 0 box4.dat
  [1,16,0,20,-44,5.5,0,0,0,0,1,0,4,0, ldraw_lib__box4(realsolid)],
// 1 16 -3 20 -45 0 6 0 3 0 0 0 0 1 box4o8a.dat
  [1,16,-3,20,-45,0,6,0,3,0,0,0,0,1, ldraw_lib__box4o8a(realsolid)],
// 0
// 1 16 3 20 -44 0 0 3 3 0 0 0 1 0 2-4edge.dat
  [1,16,3,20,-44,0,0,3,3,0,0,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -3 20 -44 0 0 -3 3 0 0 0 1 0 2-4edge.dat
  [1,16,-3,20,-44,0,0,-3,3,0,0,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 3 20 -46 0 0 3 3 0 0 0 1 0 2-4edge.dat
  [1,16,3,20,-46,0,0,3,3,0,0,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -3 20 -46 0 0 -3 3 0 0 0 1 0 2-4edge.dat
  [1,16,-3,20,-46,0,0,-3,3,0,0,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 3 20 -44 0 0 3 3 0 0 0 -1 0 2-4disc.dat
  [1,16,3,20,-44,0,0,3,3,0,0,0,-1,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 -3 20 -44 0 0 -3 3 0 0 0 -1 0 2-4disc.dat
  [1,16,-3,20,-44,0,0,-3,3,0,0,0,-1,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 3 20 -46 0 0 3 3 0 0 0 1 0 2-4disc.dat
  [1,16,3,20,-46,0,0,3,3,0,0,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 -3 20 -46 0 0 -3 3 0 0 0 1 0 2-4disc.dat
  [1,16,-3,20,-46,0,0,-3,3,0,0,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 3 20 -46 0 0 3 3 0 0 0 2 0 2-4cyli.dat
  [1,16,3,20,-46,0,0,3,3,0,0,0,2,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -3 20 -46 0 0 -3 3 0 0 0 2 0 2-4cyli.dat
  [1,16,-3,20,-46,0,0,-3,3,0,0,0,2,0, ldraw_lib__2_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -2 32 0 0 0 36 0 0 0 34 box5.dat
  [1,16,0,0,-2,32,0,0,0,36,0,0,0,34, ldraw_lib__box5(realsolid)],
// 0
];
module ldraw_lib__3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
