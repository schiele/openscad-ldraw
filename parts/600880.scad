...
use <s/16820s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__600880(realsolid=false) = [
...
// 1 16 0 -0.125 -10 55.1 0 0 0 0 0.125 0 -22 0 box5-4a.dat
  [1,16,0,-0.125,-10,55.1,0,0,0,0,0.125,0,-22,0, ldraw_lib__box5_4a(realsolid)],
];
module ldraw_lib__600880(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__600880(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
