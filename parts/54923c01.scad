...
use <54760.scad>
use <u9288.scad>
function ldraw_lib__54923c01() = [
// 0 Plane Front  8 x 16 x  5 with Trans Brown Windshield
// 0 Name: 54923c01.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 54092c01, Rebrickable 54092c01
// 
...
module ldraw_lib__54923c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__54923c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
