...
use <u9288.scad>
$fa=1; $fs=0.2;
function ldraw_lib__54923c01(realsolid=false) = [
// 0 Plane Front  8 x 16 x  5 with Trans Black Windshield
// 0 Name: 54923c01.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 54092.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__54092(realsolid)],
...
module ldraw_lib__54923c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__54923c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__54923c01(line=0.2);