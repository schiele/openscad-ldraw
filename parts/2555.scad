...
use <../p/rect.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2555(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3070a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3070a(realsolid)],
// 
// 2 24 10 0 4 -10 0 4
  [2,24,10,0,4,-10,0,4],
// 2 24 10 0 -4 -10 0 -4
...
// 1 16 0 -6 4 0 0 -4 4 0 0 0 -1 0 5-16ndis.dat
  [1,16,0,-6,4,0,0,-4,4,0,0,0,-1,0, ldraw_lib__5_16ndis(realsolid)],
// 1 16 0 -6 4 0 0 4 4 0 0 0 -1 0 5-16ndis.dat
  [1,16,0,-6,4,0,0,4,4,0,0,0,-1,0, ldraw_lib__5_16ndis(realsolid)],
// 1 16 0 -6 -4 0 0 -4 4 0 0 0 1 0 5-16ndis.dat
  [1,16,0,-6,-4,0,0,-4,4,0,0,0,1,0, ldraw_lib__5_16ndis(realsolid)],
...
// 1 16 0 -6 4 0 0 -4 4 0 0 0 -8 0 5-16cylo.dat
  [1,16,0,-6,4,0,0,-4,4,0,0,0,-8,0, ldraw_lib__5_16cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -6 4 0 0 4 4 0 0 0 -8 0 5-16cylo.dat
  [1,16,0,-6,4,0,0,4,4,0,0,0,-8,0, ldraw_lib__5_16cylo(realsolid)],
// 1 16 -3.8478 -8.7654 0 0 -1 -0.1522 0 0 -1.2346 -4 0 0 rect.dat
  [1,16,-3.8478,-8.7654,0,0,-1,-0.1522,0,0,-1.2346,-4,0,0, ldraw_lib__rect(realsolid)],
// 1 16 3.8478 -8.7654 0 0 1 0.1522 0 0 -1.2346 4 0 0 rect.dat
  [1,16,3.8478,-8.7654,0,0,1,0.1522,0,0,-1.2346,4,0,0, ldraw_lib__rect(realsolid)],
// 1 16 7 -5 0 0 2 -1 0 0 -5 -4 0 0 box2-7.dat
  [1,16,7,-5,0,0,2,-1,0,0,-5,-4,0,0, ldraw_lib__box2_7(realsolid)],
// 1 16 -7 -5 0 0 -2 1 0 0 -5 4 0 0 box2-7.dat
  [1,16,-7,-5,0,0,-2,1,0,0,-5,4,0,0, ldraw_lib__box2_7(realsolid)],
...
module ldraw_lib__2555(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2555(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
