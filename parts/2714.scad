...
// 1 16 -82 0 0 0 -1 0 1 0 0 0 0 1 2714a.dat
  [1,16,-82,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__2714a()],
];
module ldraw_lib__2714(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2714(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
