...
use <s/98585s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98585(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\98585s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__98585s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\98585s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__98585s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 1 s\98585s01.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__98585s01(realsolid)],
...
// 1 16 0 20 -10 0 0 -1 -1 0 0 0 20 0 axlehol5.dat
  [1,16,0,20,-10,0,0,-1,-1,0,0,0,20,0, ldraw_lib__axlehol5(realsolid)],
// 1 16 0 -20 -10 0 0 -1 -1 0 0 0 20 0 axlehol5.dat
  [1,16,0,-20,-10,0,0,-1,-1,0,0,0,20,0, ldraw_lib__axlehol5(realsolid)],
...
module ldraw_lib__98585(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98585(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
