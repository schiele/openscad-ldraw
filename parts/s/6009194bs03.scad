...
use <../../p/1-4chrd.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__6009194bs03(realsolid=false) = [
...
// 1 0 -16 -0.25 9.75 -2 0 0 0 1 0 0 0 -2 1-4chrd.dat
  [1,0,-16,-0.25,9.75,-2,0,0,0,1,0,0,0,-2, ldraw_lib__1_4chrd(realsolid)],
// 1 0 16 -0.25 9.75 0 0 2 0 1 0 -2 0 0 1-4chrd.dat
  [1,0,16,-0.25,9.75,0,0,2,0,1,0,-2,0,0, ldraw_lib__1_4chrd(realsolid)],
// 0 // Black top faces
...
module ldraw_lib__s__6009194bs03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6009194bs03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
