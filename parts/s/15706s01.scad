...
$fa=1; $fs=0.2;
function ldraw_lib__s__15706s01(realsolid=false) = [
...
// 1 16 -40 8 -10 40 0 0 0 1 0 0 0 -10 recte3.dat
  [1,16,-40,8,-10,40,0,0,0,1,0,0,0,-10, ldraw_lib__recte3(realsolid)],
// 2 24 -80 8 0 -44 8 0
  [2,24,-80,8,0,-44,8,0],
// 2 24 -40 8 0 -4 8 0
  [2,24,-40,8,0,-4,8,0],
...
// 1 16 -40 4 -10 1 0 0 0 -1 0 0 0 -1 stug3-1x3.dat
  [1,16,-40,4,-10,1,0,0,0,-1,0,0,0,-1, ldraw_lib__stug3_1x3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -40 8 -10 36 0 0 0 -4 0 0 0 6 box5.dat
  [1,16,-40,8,-10,36,0,0,0,-4,0,0,0,6, ldraw_lib__box5(realsolid)],
...
// 1 16 -40 4 0 0 0 -40 4 0 0 0 -20 0 box3u7a.dat
  [1,16,-40,4,0,0,0,-40,4,0,0,0,-20,0, ldraw_lib__box3u7a(realsolid)],
...
module ldraw_lib__s__15706s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__15706s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
