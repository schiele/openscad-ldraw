...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__18787s02(realsolid=false) = [
...
// 1 16 16.201 -0.2 0 0 2 0 0 0 -2 -2 0 0 box2-5.dat
  [1,16,16.201,-0.2,0,0,2,0,0,0,-2,-2,0,0, ldraw_lib__box2_5(realsolid)],
// 1 16 20.2 5.8 0 0 2 0 0 0 -4 -2 0 0 box2-7.dat
  [1,16,20.2,5.8,0,0,2,0,0,0,-4,-2,0,0, ldraw_lib__box2_7(realsolid)],
// 1 16 18.2 7.8 0 0 -4 0 0 0 2 -2 0 0 box2-5.dat
  [1,16,18.2,7.8,0,0,-4,0,0,0,2,-2,0,0, ldraw_lib__box2_5(realsolid)],
// 1 16 12.2 3.8 0 0 -2 0 0 0 2 -2 0 0 box2-7.dat
  [1,16,12.2,3.8,0,0,-2,0,0,0,2,-2,0,0, ldraw_lib__box2_7(realsolid)],
// 1 16 40.2 -40.2 -2 2 0 0 0 0 2 0 -0.25 0 box5.dat
  [1,16,40.2,-40.2,-2,2,0,0,0,0,2,0,-0.25,0, ldraw_lib__box5(realsolid)],
// 1 16 36.2 -32.2 -2 2 0 0 0 0 2 0 -0.25 0 box5.dat
  [1,16,36.2,-32.2,-2,2,0,0,0,0,2,0,-0.25,0, ldraw_lib__box5(realsolid)],
// 1 16 32.2 -28.2 -2 2 0 0 0 0 2 0 -0.25 0 box5.dat
  [1,16,32.2,-28.2,-2,2,0,0,0,0,2,0,-0.25,0, ldraw_lib__box5(realsolid)],
// 1 16 28.199 -24.2 -2 2 0 0 0 0 2 0 -0.25 0 box5.dat
  [1,16,28.199,-24.2,-2,2,0,0,0,0,2,0,-0.25,0, ldraw_lib__box5(realsolid)],
// 1 16 24.2 -20.201 -2 2 0 0 0 0 2 0 -0.25 0 box5.dat
  [1,16,24.2,-20.201,-2,2,0,0,0,0,2,0,-0.25,0, ldraw_lib__box5(realsolid)],
// 1 16 20.2 -16.201 -2 2 0 0 0 0 2 0 -0.25 0 box5.dat
  [1,16,20.2,-16.201,-2,2,0,0,0,0,2,0,-0.25,0, ldraw_lib__box5(realsolid)],
// 1 16 16.2 -12.2 -2 2 0 0 0 0 2 0 -0.25 0 box5.dat
  [1,16,16.2,-12.2,-2,2,0,0,0,0,2,0,-0.25,0, ldraw_lib__box5(realsolid)],
// 1 16 12.2 -8.2 -2 2 0 0 0 0 2 0 -0.25 0 box5.dat
  [1,16,12.2,-8.2,-2,2,0,0,0,0,2,0,-0.25,0, ldraw_lib__box5(realsolid)],
// 1 16 12.2 -0.2 -2 2 0 0 0 0 2 0 -0.25 0 box5.dat
  [1,16,12.2,-0.2,-2,2,0,0,0,0,2,0,-0.25,0, ldraw_lib__box5(realsolid)],
// 1 16 8.2 -4.2 -2 2 0 0 0 0 2 0 -0.25 0 box5.dat
  [1,16,8.2,-4.2,-2,2,0,0,0,0,2,0,-0.25,0, ldraw_lib__box5(realsolid)],
// 1 16 16.2 3.8 -2 2 0 0 0 0 2 0 -0.25 0 box5.dat
  [1,16,16.2,3.8,-2,2,0,0,0,0,2,0,-0.25,0, ldraw_lib__box5(realsolid)],
// 1 16 36.2 -32.2 2 2 0 0 0 0 2 0 0.25 0 box5.dat
  [1,16,36.2,-32.2,2,2,0,0,0,0,2,0,0.25,0, ldraw_lib__box5(realsolid)],
// 1 16 32.2 -28.2 2 2 0 0 0 0 2 0 0.25 0 box5.dat
  [1,16,32.2,-28.2,2,2,0,0,0,0,2,0,0.25,0, ldraw_lib__box5(realsolid)],
...
// 1 16 44.2 -32.2 0 0 0 -2 0 -2 0 -2 0 0 box2-5.dat
  [1,16,44.2,-32.2,0,0,0,-2,0,-2,0,-2,0,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 40.2 -28.2 0 0 0 -2 0 -2 0 -2 0 0 box2-7.dat
  [1,16,40.2,-28.2,0,0,0,-2,0,-2,0,-2,0,0, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 36.2 -24.2 0 0 0 -2 0 -2 0 -2 0 0 box2-5.dat
  [1,16,36.2,-24.2,0,0,0,-2,0,-2,0,-2,0,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 32.2 -20.2 0 0 0 -2 0 -2 0 -2 0 0 box2-7.dat
  [1,16,32.2,-20.2,0,0,0,-2,0,-2,0,-2,0,0, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 28.2 -16.201 0 0 0 -2 0 -2 0 -2 0 0 box2-5.dat
  [1,16,28.2,-16.201,0,0,0,-2,0,-2,0,-2,0,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 24.2 -12.2 0 0 0 -2 0 -2 0 -2 0 0 box2-7.dat
  [1,16,24.2,-12.2,0,0,0,-2,0,-2,0,-2,0,0, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20.2 -8.2 0 0 0 -2 0 -2 0 -2 0 0 box2-5.dat
  [1,16,20.2,-8.2,0,0,0,-2,0,-2,0,-2,0,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 16.2 -4.2 0 0 0 -2 0 -2 0 -2 0 0 box2-7.dat
  [1,16,16.2,-4.2,0,0,0,-2,0,-2,0,-2,0,0, ldraw_lib__box2_7(realsolid)],
// 1 16 6.6 1.8 0 0 0 -3.6 0 -1 0 -2 0 0 rect.dat
  [1,16,6.6,1.8,0,0,0,-3.6,0,-1,0,-2,0,0, ldraw_lib__rect(realsolid)],
// 1 16 46.2 -40.2 0 0 -1 0 0 0 -6 2 0 0 rect3.dat
  [1,16,46.2,-40.2,0,0,-1,0,0,0,-6,2,0,0, ldraw_lib__rect3(realsolid)],
// 
...
module ldraw_lib__s__18787s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__18787s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
