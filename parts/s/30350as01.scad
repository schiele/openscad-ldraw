...
use <../../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__30350as01(realsolid=false) = [
...
// 1 16 -10 -2.5 38.5 4 0 0 0 -3 -0.5 0 2.5 -5 box2-5.dat
  [1,16,-10,-2.5,38.5,4,0,0,0,-3,-0.5,0,2.5,-5, ldraw_lib__box2_5(realsolid)],
// 1 16 -10 -2.9142 44.4142 4 0 0 0 -0.0858 2 0 1.5858 0 box2-7.dat
  [1,16,-10,-2.9142,44.4142,4,0,0,0,-0.0858,2,0,1.5858,0, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -14 2 40 0 8 0 -4 0 0 0 0 4 1-8cylo.dat
  [1,16,-14,2,40,0,8,0,-4,0,0,0,0,4, ldraw_lib__1_8cylo(realsolid)],
// 1 16 -14 2 40 0 1 0 -4 0 0 0 0 4 1-8ndis.dat
  [1,16,-14,2,40,0,1,0,-4,0,0,0,0,4, ldraw_lib__1_8ndis(realsolid)],
// 1 16 -6 2 40 0 -1 0 -4 0 0 0 0 4 1-8ndis.dat
  [1,16,-6,2,40,0,-1,0,-4,0,0,0,0,4, ldraw_lib__1_8ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -14 2 40 0 8 0 4 0 0 0 0 -4 2-4cylo.dat
  [1,16,-14,2,40,0,8,0,4,0,0,0,0,-4, ldraw_lib__2_4cylo(realsolid)],
// 1 16 -14 2 40 0 1 0 -4 0 0 0 0 -4 2-4ndis.dat
  [1,16,-14,2,40,0,1,0,-4,0,0,0,0,-4, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 -6 2 40 0 -8 0 4 0 0 0 0 4 1-8cylo.dat
  [1,16,-6,2,40,0,-8,0,4,0,0,0,0,4, ldraw_lib__1_8cylo(realsolid)],
// 1 16 -14 2 40 0 1 0 4 0 0 0 0 4 1-8ndis.dat
  [1,16,-14,2,40,0,1,0,4,0,0,0,0,4, ldraw_lib__1_8ndis(realsolid)],
// 1 16 -6 2 40 0 -1 0 4 0 0 0 0 4 1-8ndis.dat
  [1,16,-6,2,40,0,-1,0,4,0,0,0,0,4, ldraw_lib__1_8ndis(realsolid)],
// 1 16 -10 6.9142 44.4142 -4 0 0 0 0.0858 -2 0 1.5858 0 box2-7.dat
  [1,16,-10,6.9142,44.4142,-4,0,0,0,0.0858,-2,0,1.5858,0, ldraw_lib__box2_7(realsolid)],
// 1 16 -10 8.5 38 -4 0 0 0 1 0.5 0 2 -6 box2-5.dat
  [1,16,-10,8.5,38,-4,0,0,0,1,0.5,0,2,-6, ldraw_lib__box2_5(realsolid)],
...
// 1 16 6 2 40 0 8 0 4 0 0 0 0 -4 2-4cylo.dat
  [1,16,6,2,40,0,8,0,4,0,0,0,0,-4, ldraw_lib__2_4cylo(realsolid)],
// 1 16 6 2 40 0 1 0 -4 0 0 0 0 -4 2-4ndis.dat
  [1,16,6,2,40,0,1,0,-4,0,0,0,0,-4, ldraw_lib__2_4ndis(realsolid)],
// 1 16 14 2 40 0 -1 0 4 0 0 0 0 -4 2-4ndis.dat
  [1,16,14,2,40,0,-1,0,4,0,0,0,0,-4, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 -16 1 31.5 0 0 -2 0 1 0 1.5 0 0 box3-3.dat
  [1,16,-16,1,31.5,0,0,-2,0,1,0,1.5,0,0, ldraw_lib__box3_3(realsolid)],
// 1 16 0 1 31.5 6 0 0 0 1 0 0 0 1.5 box2-5.dat
  [1,16,0,1,31.5,6,0,0,0,1,0,0,0,1.5, ldraw_lib__box2_5(realsolid)],
...
// 1 16 0 0 32 0 0 -6 0 1 0 1 0 0 rect2p.dat
  [1,16,0,0,32,0,0,-6,0,1,0,1,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 5 30 6 0 0 0 0 3 0 -1 0 rect3.dat
  [1,16,0,5,30,6,0,0,0,0,3,0,-1,0, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__s__30350as01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__30350as01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
