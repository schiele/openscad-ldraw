...
use <../../p/stug6.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__44336s01(realsolid=false) = [
...
// 1 16 260 0 20 1 0 0 0 1 0 0 0 1 stug6.dat
  [1,16,260,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug6(realsolid)],
// 1 16 260 0 -100 1 0 0 0 1 0 0 0 1 stug6.dat
  [1,16,260,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug6(realsolid)],
// 1 16 260 0 -220 1 0 0 0 1 0 0 0 1 stug6.dat
  [1,16,260,0,-220,1,0,0,0,1,0,0,0,1, ldraw_lib__stug6(realsolid)],
...
module ldraw_lib__s__44336s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__44336s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
