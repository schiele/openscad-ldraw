...
use <../../p/stug-1x3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__4490s01(realsolid=false) = [
...
// 1 16 20 24 0 10 0 0 0 1 0 0 0 10 recte4.dat
  [1,16,20,24,0,10,0,0,0,1,0,0,0,10, ldraw_lib__recte4(realsolid)],
// 1 16 -20 24 0 10 0 0 0 1 0 0 0 10 recte4.dat
  [1,16,-20,24,0,10,0,0,0,1,0,0,0,10, ldraw_lib__recte4(realsolid)],
...
// 1 16 20 24 0 6 0 0 0 -20 0 0 0 6 box5.dat
  [1,16,20,24,0,6,0,0,0,-20,0,0,0,6, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -20 24 0 6 0 0 0 -20 0 0 0 6 box5.dat
  [1,16,-20,24,0,6,0,0,0,-20,0,0,0,6, ldraw_lib__box5(realsolid)],
// 1 16 -10 21 0 0 -1 0 3 0 0 0 0 10 rect2p.dat
  [1,16,-10,21,0,0,-1,0,3,0,0,0,0,10, ldraw_lib__rect2p(realsolid)],
// 1 16 10 21 0 0 1 0 3 0 0 0 0 -10 rect2p.dat
  [1,16,10,21,0,0,1,0,3,0,0,0,0,-10, ldraw_lib__rect2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 18 10 10 0 0 0 0 -10 0 -4 0 2-4cylo.dat
  [1,16,0,18,10,10,0,0,0,0,-10,0,-4,0, ldraw_lib__2_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 18 -10 10 0 0 0 0 -10 0 4 0 2-4cylo.dat
  [1,16,0,18,-10,10,0,0,0,0,-10,0,4,0, ldraw_lib__2_4cylo(realsolid)],
// 1 16 0 18 6 10 0 0 0 0 -10 0 1 0 2-4ndis.dat
  [1,16,0,18,6,10,0,0,0,0,-10,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 18 -6 10 0 0 0 0 -10 0 -1 0 2-4ndis.dat
  [1,16,0,18,-6,10,0,0,0,0,-10,0,-1,0, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 0 8 0 0 0 -10 0 -4 0 -6 0 0 box5-4a.dat
  [1,16,0,8,0,0,0,-10,0,-4,0,-6,0,0, ldraw_lib__box5_4a(realsolid)],
// 1 16 30 12 0 0 1 0 0 0 -12 -10 0 0 recte3.dat
  [1,16,30,12,0,0,1,0,0,0,-12,-10,0,0, ldraw_lib__recte3(realsolid)],
// 1 16 -30 12 0 0 1 0 0 0 -12 -10 0 0 recte3.dat
  [1,16,-30,12,0,0,1,0,0,0,-12,-10,0,0, ldraw_lib__recte3(realsolid)],
// 1 16 0 0 0 -30 0 0 0 1 0 0 0 -10 rect2p.dat
  [1,16,0,0,0,-30,0,0,0,1,0,0,0,-10, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__s__4490s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__4490s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
