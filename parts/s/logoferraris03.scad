...
$fa=1; $fs=0.2;
function ldraw_lib__s__logoferraris03(realsolid=false) = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\logoferraris03a.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__logoferraris03a(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\logoferraris03b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__logoferraris03b(realsolid)],
...
module ldraw_lib__s__logoferraris03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__logoferraris03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
