...
$fa=1; $fs=0.2;
function ldraw_lib__s__26603s01(realsolid=false) = [
...
// 1 16 0 0 0 30 0 0 0 7 0 0 0 20 box4.dat
  [1,16,0,0,0,30,0,0,0,7,0,0,0,20, ldraw_lib__box4(realsolid)],
// 1 16 0 7 0 29 0 0 0 1 0 0 0 19 box4.dat
  [1,16,0,7,0,29,0,0,0,1,0,0,0,19, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 -26 0 0 0 -4 0 0 0 16 box5.dat
  [1,16,0,8,0,-26,0,0,0,-4,0,0,0,16, ldraw_lib__box5(realsolid)],
...
// 1 16 0 4 0 1 0 0 0 -1 0 0 0 1 stug4-1x2.dat
  [1,16,0,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stug4_1x2(realsolid)],
];
module ldraw_lib__s__26603s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__26603s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
