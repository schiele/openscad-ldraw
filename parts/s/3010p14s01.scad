...
use <../../p/2-4ndis.scad>
use <../../p/2-4ring1.scad>
function ldraw_lib__s__3010p14s01() = [
...
// 1 16 0 10 0 1.5 0 0 0 0 -1.5 0 1 0 2-4chrd.dat
  [1,16,0,10,0,1.5,0,0,0,0,-1.5,0,1,0, ldraw_lib__2_4chrd()],
// 1 16 0 14 0 -1.5 0 0 0 0 1.5 0 1 0 2-4chrd.dat
  [1,16,0,14,0,-1.5,0,0,0,0,1.5,0,1,0, ldraw_lib__2_4chrd()],
// 1 0 0 10 0 1.5 0 0 0 0 -1.5 0 1 0 2-4ring1.dat
  [1,0,0,10,0,1.5,0,0,0,0,-1.5,0,1,0, ldraw_lib__2_4ring1()],
// 1 0 0 14 0 -1.5 0 0 0 0 1.5 0 1 0 2-4ring1.dat
  [1,0,0,14,0,-1.5,0,0,0,0,1.5,0,1,0, ldraw_lib__2_4ring1()],
// 1 16 0 10 0 3 0 0 0 0 -3 0 1 0 2-4ndis.dat
  [1,16,0,10,0,3,0,0,0,0,-3,0,1,0, ldraw_lib__2_4ndis()],
// 1 16 0 14 0 -3 0 0 0 0 3 0 1 0 2-4ndis.dat
  [1,16,0,14,0,-3,0,0,0,0,3,0,1,0, ldraw_lib__2_4ndis()],
...
module ldraw_lib__s__3010p14s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3010p14s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
