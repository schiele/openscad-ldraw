...
use <../../p/1-4disc.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__973p8qs02(realsolid=false) = [
// 0 ~ID Badge Pattern
...
// 1 0 3.6 10.52 0 0 0 0.64 0.64 0 0 0 1 0 1-4disc.dat
  [1,0,3.6,10.52,0,0,0,0.64,0.64,0,0,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 0 3.6 3.62 0 0.64 0 0 0 0 -0.64 0 1 0 1-4disc.dat
  [1,0,3.6,3.62,0,0.64,0,0,0,0,-0.64,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 0 -3.6 10.52 0 -0.64 0 0 0 0 0.64 0 1 0 1-4disc.dat
  [1,0,-3.6,10.52,0,-0.64,0,0,0,0,0.64,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 0 -3.6 3.62 0 0 0 -0.64 -0.64 0 0 0 1 0 1-4disc.dat
  [1,0,-3.6,3.62,0,0,0,-0.64,-0.64,0,0,0,1,0, ldraw_lib__1_4disc(realsolid)],
...
module ldraw_lib__s__973p8qs02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__973p8qs02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
