...
use <../../p/box3u8p.scad>
use <u9513s01.scad>
function ldraw_lib__s__u9513s02() = [
...
// 1 16 0 3 0 -1.41421 0 -1.41421 0 -1 0 1.41421 0 -1.41421 3-4ndis.dat
  [1,16,0,3,0,-1.41421,0,-1.41421,0,-1,0,1.41421,0,-1.41421, ldraw_lib__3_4ndis()],
// 1 16 0 0 0 -1.41421 0 -1.41421 0 1 0 1.41421 0 -1.41421 3-4ndis.dat
  [1,16,0,0,0,-1.41421,0,-1.41421,0,1,0,1.41421,0,-1.41421, ldraw_lib__3_4ndis()],
// 1 16 0 0 0 3.181981 0 -3.181981 0 1 0 3.181981 0 3.181981 1-4edge.dat
  [1,16,0,0,0,3.181981,0,-3.181981,0,1,0,3.181981,0,3.181981, ldraw_lib__1_4edge()],
// 1 16 0 0 0 0 0 2 0 1 0 2 0 0 1-8ring1.dat
  [1,16,0,0,0,0,0,2,0,1,0,2,0,0, ldraw_lib__1_8ring1()],
// 1 16 0 0 0 0 0 .5 0 1 0 .5 0 0 1-8ring8.dat
  [1,16,0,0,0,0,0,.5,0,1,0,.5,0,0, ldraw_lib__1_8ring8()],
// 1 16 0 0 0 0 0 -2 0 1 0 2 0 0 1-8ring1.dat
  [1,16,0,0,0,0,0,-2,0,1,0,2,0,0, ldraw_lib__1_8ring1()],
// 1 16 0 0 0 0 0 -.5 0 1 0 .5 0 0 1-8ring8.dat
  [1,16,0,0,0,0,0,-.5,0,1,0,.5,0,0, ldraw_lib__1_8ring8()],
...
// 1 16 0 0 0 0 0 2 0 3 0 -2 0 0 4-4cylo.dat
  [1,16,0,0,0,0,0,2,0,3,0,-2,0,0, ldraw_lib__4_4cylo()],
// 1 16 0 -5 -16 2 0 0 0 5 0 0 0 2 2-4cylc.dat
  [1,16,0,-5,-16,2,0,0,0,5,0,0,0,2, ldraw_lib__2_4cylc()],
// 1 16 0 -5 -20 -2 0 0 0 5 0 0 0 -2 2-4cylc.dat
  [1,16,0,-5,-20,-2,0,0,0,5,0,0,0,-2, ldraw_lib__2_4cylc()],
// 1 16 0 0 -18 0 0 2 0 -5 0 2 0 0 box3u8p.dat
  [1,16,0,0,-18,0,0,2,0,-5,0,2,0,0, ldraw_lib__box3u8p()],
];
module ldraw_lib__s__u9513s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u9513s02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
