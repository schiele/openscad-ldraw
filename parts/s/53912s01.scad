...
use <../../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__53912s01(realsolid=false) = [
...
// 1 16 0 3 10 0 0 2 -3 0 0 0 1 0 rect2p.dat
  [1,16,0,3,10,0,0,2,-3,0,0,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 48 10 0 0 2 -30 0 0 0 1 0 rect2p.dat
  [1,16,0,48,10,0,0,2,-30,0,0,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 93 10 0 0 2 -3 0 0 0 1 0 rect2p.dat
  [1,16,0,93,10,0,0,2,-3,0,0,0,1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 clip13.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__clip13(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 1 6 8 0 -4 1 2 0 0 0 0 2 1-4cyli.dat
  [1,16,1,6,8,0,-4,1,2,0,0,0,0,2, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 1 6 8 1 2 0 0 0 2 2 0 0 1-4cyls.dat
  [1,16,1,6,8,1,2,0,0,0,2,2,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 3 6 8 -1 1 0 0 0 2 2 0 0 1-4edge.dat
  [1,16,3,6,8,-1,1,0,0,0,2,2,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -3 6 8 1 1 0 0 0 2 2 0 0 1-4edge.dat
  [1,16,-3,6,8,1,1,0,0,0,2,2,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 3 6 8 -1 -1 0 0 0 2 2 0 0 1-4ndis.dat
  [1,16,3,6,8,-1,-1,0,0,0,2,2,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -3 6 8 1 1 0 0 0 2 2 0 0 1-4ndis.dat
  [1,16,-3,6,8,1,1,0,0,0,2,2,0,0, ldraw_lib__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 1 18 8 0 -4 1 -2 0 0 0 0 2 1-4cyli.dat
  [1,16,1,18,8,0,-4,1,-2,0,0,0,0,2, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 1 18 8 1 2 0 0 0 -2 2 0 0 1-4cyls.dat
  [1,16,1,18,8,1,2,0,0,0,-2,2,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 3 18 8 -1 1 0 0 0 -2 2 0 0 1-4edge.dat
  [1,16,3,18,8,-1,1,0,0,0,-2,2,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -3 18 8 1 1 0 0 0 -2 2 0 0 1-4edge.dat
  [1,16,-3,18,8,1,1,0,0,0,-2,2,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 3 18 8 -1 -1 0 0 0 -2 2 0 0 1-4ndis.dat
  [1,16,3,18,8,-1,-1,0,0,0,-2,2,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -3 18 8 1 1 0 0 0 -2 2 0 0 1-4ndis.dat
  [1,16,-3,18,8,1,1,0,0,0,-2,2,0,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 5.27605 12 5.2141 -1.04955 -1 0 0 0 4 1.0176 0 0 rect2p.dat
  [1,16,5.27605,12,5.2141,-1.04955,-1,0,0,0,4,1.0176,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 3.61325 12 7.11585 .61325 -1 0 0 0 -4 -.88415 0 0 rect2p.dat
  [1,16,3.61325,12,7.11585,.61325,-1,0,0,0,-4,-.88415,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 84 0 1 0 0 0 1 0 0 0 1 clip13.dat
  [1,16,0,84,0,1,0,0,0,1,0,0,0,1, ldraw_lib__clip13(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 1 78 8 0 -4 1 2 0 0 0 0 2 1-4cyli.dat
  [1,16,1,78,8,0,-4,1,2,0,0,0,0,2, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 1 78 8 1 2 0 0 0 2 2 0 0 1-4cyls.dat
  [1,16,1,78,8,1,2,0,0,0,2,2,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 3 78 8 -1 1 0 0 0 2 2 0 0 1-4edge.dat
  [1,16,3,78,8,-1,1,0,0,0,2,2,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -3 78 8 1 1 0 0 0 2 2 0 0 1-4edge.dat
  [1,16,-3,78,8,1,1,0,0,0,2,2,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 3 78 8 -1 -1 0 0 0 2 2 0 0 1-4ndis.dat
  [1,16,3,78,8,-1,-1,0,0,0,2,2,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -3 78 8 1 1 0 0 0 2 2 0 0 1-4ndis.dat
  [1,16,-3,78,8,1,1,0,0,0,2,2,0,0, ldraw_lib__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 1 90 8 0 -4 1 -2 0 0 0 0 2 1-4cyli.dat
  [1,16,1,90,8,0,-4,1,-2,0,0,0,0,2, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 1 90 8 1 2 0 0 0 -2 2 0 0 1-4cyls.dat
  [1,16,1,90,8,1,2,0,0,0,-2,2,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 3 90 8 -1 1 0 0 0 -2 2 0 0 1-4edge.dat
  [1,16,3,90,8,-1,1,0,0,0,-2,2,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -3 90 8 1 1 0 0 0 -2 2 0 0 1-4edge.dat
  [1,16,-3,90,8,1,1,0,0,0,-2,2,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 3 90 8 -1 -1 0 0 0 -2 2 0 0 1-4ndis.dat
  [1,16,3,90,8,-1,-1,0,0,0,-2,2,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -3 90 8 1 1 0 0 0 -2 2 0 0 1-4ndis.dat
  [1,16,-3,90,8,1,1,0,0,0,-2,2,0,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 5.27605 84 5.2141 -1.04955 -1 0 0 0 -4 1.0176 0 0 rect2p.dat
  [1,16,5.27605,84,5.2141,-1.04955,-1,0,0,0,-4,1.0176,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 3.61325 84 7.11585 .61325 -1 0 0 0 4 -.88415 0 0 rect2p.dat
  [1,16,3.61325,84,7.11585,.61325,-1,0,0,0,4,-.88415,0,0, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__s__53912s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__53912s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
