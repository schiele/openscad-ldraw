...
use <../../p/stud4a.scad>
use <../../p/stug-1x2.scad>
function ldraw_lib__s__3678bs01() = [
...
// 1 16 0 26 -1 16 0 0 0 0 -22 0 7 0 box2-5.dat
  [1,16,0,26,-1,16,0,0,0,0,-22,0,7,0, ldraw_lib__box2_5()],
// 1 16 0 46 -30 20 0 0 0 0 2 0 1 0 rect3.dat
  [1,16,0,46,-30,20,0,0,0,0,2,0,1,0, ldraw_lib__rect3()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 26 -17 16 0 0 0 20 -2 0 -9 0 box2-7.dat
  [1,16,0,26,-17,16,0,0,0,20,-2,0,-9,0, ldraw_lib__box2_7()],
// 1 16 0 48 -10 16 0 0 0 1 0 0 0 -16 recte3.dat
  [1,16,0,48,-10,16,0,0,0,1,0,0,0,-16, ldraw_lib__recte3()],
// 1 16 0 48 -10 20 0 0 0 1 0 0 0 20 recte3.dat
  [1,16,0,48,-10,20,0,0,0,1,0,0,0,20, ldraw_lib__recte3()],
// 1 16 0 22 -20 -20 0 0 0 1 -22 0 0 10 recte4.dat
  [1,16,0,22,-20,-20,0,0,0,1,-22,0,0,10, ldraw_lib__recte4()],
// 1 16 0 24 10 20 0 0 0 0 -24 0 1 0 recte3.dat
  [1,16,0,24,10,20,0,0,0,0,-24,0,1,0, ldraw_lib__recte3()],
...
// 1 16 0 44 -10 1 0 0 0 -1 0 0 0 1 stud4a.dat
  [1,16,0,44,-10,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4a()],
// 1 16 0 8.44444 -10 8 0 0 0 -4.44444 0 0 0 8 2-4cyli.dat
  [1,16,0,8.44444,-10,8,0,0,0,-4.44444,0,0,0,8, ldraw_lib__2_4cyli()],
// 1 16 0 26.22222 -10 8 0 0 0 -17.77778 0 0 0 8 2-4cyli.dat
  [1,16,0,26.22222,-10,8,0,0,0,-17.77778,0,0,0,8, ldraw_lib__2_4cyli()],
// 1 16 0 44 -10 -8 0 0 0 -17.77778 0 0 0 -8 4-4cyli.dat
  [1,16,0,44,-10,-8,0,0,0,-17.77778,0,0,0,-8, ldraw_lib__4_4cyli()],
// 1 16 0 26.22222 -10 0 0 -8 0 -17.77778 0 -8 0 0 1-4cyls.dat
  [1,16,0,26.22222,-10,0,0,-8,0,-17.77778,0,-8,0,0, ldraw_lib__1_4cyls()],
// 1 16 0 26.22222 -10 0 0 8 0 -17.77778 0 -8 0 0 1-4cyls.dat
  [1,16,0,26.22222,-10,0,0,8,0,-17.77778,0,-8,0,0, ldraw_lib__1_4cyls()],
// 1 16 0 8.44444 -10 -8 0 0 0 1 17.77778 0 0 -8 2-4edge.dat
  [1,16,0,8.44444,-10,-8,0,0,0,1,17.77778,0,0,-8, ldraw_lib__2_4edge()],
...
// 1 16 0 8.44444 -10 6 0 0 0 -4.44444 0 0 0 6 2-4cyli.dat
  [1,16,0,8.44444,-10,6,0,0,0,-4.44444,0,0,0,6, ldraw_lib__2_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 21.77778 -10 6 0 0 0 -13.33333 0 0 0 6 2-4cyli.dat
  [1,16,0,21.77778,-10,6,0,0,0,-13.33333,0,0,0,6, ldraw_lib__2_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 44 -10 -6 0 0 0 -22.22222 0 0 0 -6 4-4cyli.dat
  [1,16,0,44,-10,-6,0,0,0,-22.22222,0,0,0,-6, ldraw_lib__4_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 21.77778 -10 0 0 -6 0 -13.33333 0 -6 0 0 1-4cyls.dat
  [1,16,0,21.77778,-10,0,0,-6,0,-13.33333,0,-6,0,0, ldraw_lib__1_4cyls()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 21.77778 -10 0 0 6 0 -13.33333 0 -6 0 0 1-4cyls.dat
  [1,16,0,21.77778,-10,0,0,6,0,-13.33333,0,-6,0,0, ldraw_lib__1_4cyls()],
// 1 16 0 8.44444 -10 -6 0 0 0 1 13.33333 0 0 -6 2-4edge.dat
  [1,16,0,8.44444,-10,-6,0,0,0,1,13.33333,0,0,-6, ldraw_lib__2_4edge()],
...
module ldraw_lib__s__3678bs01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3678bs01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
