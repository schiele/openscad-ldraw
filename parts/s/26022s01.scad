...
use <../../p/tri3a1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__26022s01(realsolid=false) = [
...
// 1 16 12.25 -8 0 0 0 2.25 0 1 0 -24.149 0 0 rect.dat
  [1,16,12.25,-8,0,0,0,2.25,0,1,0,-24.149,0,0, ldraw_lib__rect(realsolid)],
// 
...
module ldraw_lib__s__26022s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__26022s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__26022s01(line=0.2);