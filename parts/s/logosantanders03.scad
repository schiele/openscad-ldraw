...
function ldraw_lib__s__logosantanders03() = [
...
// 1 15 -0.15 0 0.05 1 0 0 0 1 0 0 0 1 s\logosantanders02a.dat
  [1,15,-0.15,0,0.05,1,0,0,0,1,0,0,0,1, ldraw_lib__s__logosantanders02a()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\logosantanders03b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__logosantanders03b()],
];
module ldraw_lib__s__logosantanders03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__logosantanders03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
