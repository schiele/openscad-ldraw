...
use <../../p/tri3u1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__50898s02(realsolid=false) = [
...
// 1 16 20 0 -10 0 -4 0 1 0 0 0 0 1 npeghol7.dat
  [1,16,20,0,-10,0,-4,0,1,0,0,0,0,1, ldraw_lib__npeghol7(realsolid)],
// 1 16 20 0 -10 0 -4 -0.1444 1 0 0 0 0 -1 npeghol7.dat
  [1,16,20,0,-10,0,-4,-0.1444,1,0,0,0,0,-1, ldraw_lib__npeghol7(realsolid)],
...
// 1 16 11.3 0 -20 0 1 0 -6 0 0 0 0 6 4-4edge.dat
  [1,16,11.3,0,-20,0,1,0,-6,0,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 11.3 0 -20 0 6.41 0 6 0 0 0 0 6 4-4cyli.dat
  [1,16,11.3,0,-20,0,6.41,0,6,0,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 17.71 0 -20 0 0.859 0 0 0 -6 -6 0 0 4-4cylse.dat
  [1,16,17.71,0,-20,0,0.859,0,0,0,-6,-6,0,0, ldraw_lib__4_4cylse(realsolid)],
// 
...
// 1 16 20 0 0 0 -1 0 9 0 0 0 0 -9 1-8tndis.dat
  [1,16,20,0,0,0,-1,0,9,0,0,0,0,-9, ldraw_lib__1_8tndis(realsolid)],
// 1 16 20 0 0 0 -1 0 -9 0 0 0 0 -9 1-8tndis.dat
  [1,16,20,0,0,0,-1,0,-9,0,0,0,0,-9, ldraw_lib__1_8tndis(realsolid)],
...
// 1 16 18.57 0 -20 0 -1 -0.427 3 0 0 0 0 -3 4-4ring2.dat
  [1,16,18.57,0,-20,0,-1,-0.427,3,0,0,0,0,-3, ldraw_lib__4_4ring2(realsolid)],
// 1 16 18.57 0 -20 0 1 -1.28 9 0 0 0 0 -9 2-4edge.dat
  [1,16,18.57,0,-20,0,1,-1.28,9,0,0,0,0,-9, ldraw_lib__2_4edge(realsolid)],
// 1 16 18.57 0 -20 0 -1 1.28 9 0 0 0 0 9 1-8tndis.dat
  [1,16,18.57,0,-20,0,-1,1.28,9,0,0,0,0,9, ldraw_lib__1_8tndis(realsolid)],
// 1 16 18.57 0 -20 0 -1 1.28 -9 0 0 0 0 9 1-8tndis.dat
  [1,16,18.57,0,-20,0,-1,1.28,-9,0,0,0,0,9, ldraw_lib__1_8tndis(realsolid)],
// 
// 1 16 0 -9 -20 10.17 0 0 0 1 0 0 0 10.17 1-4edge.dat
  [1,16,0,-9,-20,10.17,0,0,0,1,0,0,0,10.17, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 -9 -20 10.17 0 0 0 1 0 0 0 10.17 1-4ndis.dat
  [1,16,0,-9,-20,10.17,0,0,0,1,0,0,0,10.17, ldraw_lib__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -7 -20 1.13 0 0 0 -2 0 0 0 1.13 1-4con9.dat
  [1,16,0,-7,-20,1.13,0,0,0,-2,0,0,0,1.13, ldraw_lib__1_4con9(realsolid)],
// 1 16 0 -7 -20 11.3 0 0 0 1 0 0 0 11.3 1-4edge.dat
  [1,16,0,-7,-20,11.3,0,0,0,1,0,0,0,11.3, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 -7 -20 11.3 0 0 0 -1 0 0 0 11.3 1-4ndis.dat
  [1,16,0,-7,-20,11.3,0,0,0,-1,0,0,0,11.3, ldraw_lib__1_4ndis(realsolid)],
// 1 16 0 9 -20 10.17 0 0 0 -1 0 0 0 10.17 1-4edge.dat
  [1,16,0,9,-20,10.17,0,0,0,-1,0,0,0,10.17, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 9 -20 10.17 0 0 0 -1 0 0 0 10.17 1-4ndis.dat
  [1,16,0,9,-20,10.17,0,0,0,-1,0,0,0,10.17, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 11.3 0 -20 0 5.99 0 9 0 0 0 0 -9 2-4cyli.dat
  [1,16,11.3,0,-20,0,5.99,0,9,0,0,0,0,-9, ldraw_lib__2_4cyli(realsolid)],
// 1 16 11.3 0 -20 0 1 0 0 0 -9 -9 0 0 3-16edge.dat
  [1,16,11.3,0,-20,0,1,0,0,0,-9,-9,0,0, ldraw_lib__3_16edge(realsolid)],
// 1 16 11.3 0 -20 0 1 0 0 0 9 -9 0 0 3-16edge.dat
  [1,16,11.3,0,-20,0,1,0,0,0,9,-9,0,0, ldraw_lib__3_16edge(realsolid)],
// 1 16 17.29 0 -20 0 1.28 0 0 0 9 -9 0 0 1-4cyls.dat
  [1,16,17.29,0,-20,0,1.28,0,0,0,9,-9,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 17.29 0 -20 0 1.28 0 0 0 -9 -9 0 0 1-4cyls.dat
  [1,16,17.29,0,-20,0,1.28,0,0,0,-9,-9,0,0, ldraw_lib__1_4cyls(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -8.7 0 0 7 -7 0 0 0 1.8 0 2-4con0.dat
  [1,16,0,0,-8.7,0,0,7,-7,0,0,0,1.8,0, ldraw_lib__2_4con0(realsolid)],
// 1 16 0 0 -8.7 0 0 7 7 0 0 0 1 0 2-4edge.dat
  [1,16,0,0,-8.7,0,0,7,7,0,0,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 0 -8.7 0 0 7 7 0 0 0 1 0 2-4ndis.dat
  [1,16,0,0,-8.7,0,0,7,7,0,0,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 
// 1 16 11.3 0 -20 0 1 0 2 0 0 0 0 -2 2-4ring3.dat
  [1,16,11.3,0,-20,0,1,0,2,0,0,0,0,-2, ldraw_lib__2_4ring3(realsolid)],
// 1 16 11.3 0 -20 0 1 0 0 0 -1 -1 0 0 3-16rin8.dat
  [1,16,11.3,0,-20,0,1,0,0,0,-1,-1,0,0, ldraw_lib__3_16rin8(realsolid)],
// 1 16 11.3 0 -20 0 1 0 0 0 1 -1 0 0 3-16rin8.dat
  [1,16,11.3,0,-20,0,1,0,0,0,1,-1,0,0, ldraw_lib__3_16rin8(realsolid)],
// 1 16 11.3 0 -20 0 1 0 6 0 0 0 0 6 2-4ndis.dat
  [1,16,11.3,0,-20,0,1,0,6,0,0,0,0,6, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 11.3 -1.5 -8.7 -4 0 0 0 3 0 0 0 -4 tri3u1.dat
  [1,16,11.3,-1.5,-8.7,-4,0,0,0,3,0,0,0,-4, ldraw_lib__tri3u1(realsolid)],
...
module ldraw_lib__s__50898s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__50898s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
