...
use <../../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__65635s01(realsolid=false) = [
...
// 1 16 50 20 0 0 0 -1 0 -3 0 1 0 0 stud3.dat
  [1,16,50,20,0,0,0,-1,0,-3,0,1,0,0, ldraw_lib__stud3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 50 32 0 0 0 -6 0 -12 0 16 0 0 box5.dat
  [1,16,50,32,0,0,0,-6,0,-12,0,16,0,0, ldraw_lib__box5(realsolid)],
...
// 1 16 40 28 0 0 0 -1 0 -1 0 1 0 0 2-4stud4.dat
  [1,16,40,28,0,0,0,-1,0,-1,0,1,0,0, ldraw_lib__2_4stud4(realsolid)],
// 1 16 40 30 -12 0 1 0 0 0 2 4 0 0 rect2a.dat
  [1,16,40,30,-12,0,1,0,0,0,2,4,0,0, ldraw_lib__rect2a(realsolid)],
// 1 16 40 30 0 0 1 0 0 0 2 6 0 0 rect3.dat
  [1,16,40,30,0,0,1,0,0,0,2,6,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 40 30 12 0 1 0 2 0 0 0 0 -4 rect2a.dat
  [1,16,40,30,12,0,1,0,2,0,0,0,0,-4, ldraw_lib__rect2a(realsolid)],
// 
// 1 16 40 10 0 1 0 0 0 1 0 0 0 1 s\65635s02.dat
  [1,16,40,10,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__65635s02(realsolid)],
// 1 16 40 10 0 1 0 0 0 -1 0 0 0 1 s\65635s02.dat
  [1,16,40,10,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__65635s02(realsolid)],
// 1 16 40 10 0 1 0 0 0 1 0 0 0 -1 s\65635s02.dat
  [1,16,40,10,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__65635s02(realsolid)],
...
// 1 16 40 10 0 0 20 0 -1 0 0 0 0 1 axlehol5.dat
  [1,16,40,10,0,0,20,0,-1,0,0,0,0,1, ldraw_lib__axlehol5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 60 10 9 0 -20 0 1 0 0 0 0 1 8\2-4cylo.dat
  [1,16,60,10,9,0,-20,0,1,0,0,0,0,1, ldraw_lib__8__2_4cylo(realsolid)],
// 1 16 60 10 9 0 -1 0 1 0 0 0 0 1 8\2-4ndis.dat
  [1,16,60,10,9,0,-1,0,1,0,0,0,0,1, ldraw_lib__8__2_4ndis(realsolid)],
// 1 16 40 10 9 0 1 0 1 0 0 0 0 1 8\2-4ndis.dat
  [1,16,40,10,9,0,1,0,1,0,0,0,0,1, ldraw_lib__8__2_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 60 10 -9 0 -20 0 1 0 0 0 0 -1 8\2-4cylo.dat
  [1,16,60,10,-9,0,-20,0,1,0,0,0,0,-1, ldraw_lib__8__2_4cylo(realsolid)],
...
// 1 16 50 0 0 0 0 10 0 1 0 -20 0 0 rect.dat
  [1,16,50,0,0,0,0,10,0,1,0,-20,0,0, ldraw_lib__rect(realsolid)],
...
module ldraw_lib__s__65635s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__65635s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
