...
use <../../p/stud4a.scad>
use <../../p/stud4s.scad>
function ldraw_lib__s__41751s01() = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\41751s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__41751s02()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\41751s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__41751s02()],
...
// 1 16 0 10 20 -1 0 0 0 0 -1 0 -1 0 peghole.dat
  [1,16,0,10,20,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__peghole()],
...
// 1 16 0 39.0422 -120 1 0 0 0 -2.23945 0 0 0 -1 stud4a.dat
  [1,16,0,39.0422,-120,1,0,0,0,-2.23945,0,0,0,-1, ldraw_lib__stud4a()],
// 1 16 0 39.042 -120 0 0 -1 0 4.9577 0 -1 0 0 stud4s.dat
  [1,16,0,39.042,-120,0,0,-1,0,4.9577,0,-1,0,0, ldraw_lib__stud4s()],
// 0
];
module ldraw_lib__s__41751s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__41751s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
