...
use <../../p/stud3.scad>
use <../../p/tri3a1.scad>
function ldraw_lib__s__34738s01() = [
...
// 1 16 -10 -14 -30 0 1 0 4 0 0 0 0 -4 2-4edge.dat
  [1,16,-10,-14,-30,0,1,0,4,0,0,0,0,-4, ldraw_lib__2_4edge()],
// 1 16 -10 -14 -30 0 1 0 -4 0 0 0 0 4 3-16edge.dat
  [1,16,-10,-14,-30,0,1,0,-4,0,0,0,0,4, ldraw_lib__3_16edge()],
...
module ldraw_lib__s__34738s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__34738s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
