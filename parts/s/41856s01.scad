...
use <../../p/4-4edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__41856s01(realsolid=false) = [
...
// 1 16 -10 8 5.5 4 0 0 0 0 4 0 -1 0 4-4edge.dat
  [1,16,-10,8,5.5,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 8 5.5 4 0 0 0 0 4 0 -1 0 4-4edge.dat
  [1,16,10,8,5.5,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 8 5.5 4 0 0 0 0 4 0 -1 0 4-4disc.dat
  [1,16,10,8,5.5,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 -10 8 5.5 4 0 0 0 0 4 0 -1 0 4-4disc.dat
  [1,16,-10,8,5.5,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 10 8 5.5 4 0 0 0 0 4 0 -0.5 0 4-4cyli.dat
  [1,16,10,8,5.5,4,0,0,0,0,4,0,-0.5,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -10 8 5.5 4 0 0 0 0 4 0 -0.5 0 4-4cyli.dat
  [1,16,-10,8,5.5,4,0,0,0,0,4,0,-0.5,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -10 8 5 4 0 0 0 0 4 0 -1 0 4-4edge.dat
  [1,16,-10,8,5,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 8 5 4 0 0 0 0 4 0 -1 0 4-4edge.dat
  [1,16,10,8,5,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 -10 8 0 6 0 0 0 0 6 0 -1 0 4-4edge.dat
  [1,16,-10,8,0,6,0,0,0,0,6,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 8 0 6 0 0 0 0 6 0 -1 0 4-4edge.dat
  [1,16,10,8,0,6,0,0,0,0,6,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 8 0 2 0 0 0 0 -2 0 5 0 4-4con2.dat
  [1,16,10,8,0,2,0,0,0,0,-2,0,5,0, ldraw_lib__4_4con2(realsolid)],
// 1 16 -10 8 0 2 0 0 0 0 -2 0 5 0 4-4con2.dat
  [1,16,-10,8,0,2,0,0,0,0,-2,0,5,0, ldraw_lib__4_4con2(realsolid)],
...
// 1 16 0 9.5 -2 4.24264 0 -4.24264 0 14.5 0 4.24264 0 4.24264 1-4cyli.dat
  [1,16,0,9.5,-2,4.24264,0,-4.24264,0,14.5,0,4.24264,0,4.24264, ldraw_lib__1_4cyli(realsolid)],
// 1 16 0 24 -2 4.24264 0 -4.24264 0 14.5 0 4.24264 0 4.24264 1-4edge.dat
  [1,16,0,24,-2,4.24264,0,-4.24264,0,14.5,0,4.24264,0,4.24264, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 -8 8 -3 2.2961 0 -5.54328 0 16 0 5.54328 0 2.2961 1-16cyli.dat
  [1,16,-8,8,-3,2.2961,0,-5.54328,0,16,0,5.54328,0,2.2961, ldraw_lib__1_16cyli(realsolid)],
// 1 16 8 8 -3 0 0 -6 0 16 0 6 0 0 1-16cyli.dat
  [1,16,8,8,-3,0,0,-6,0,16,0,6,0,0, ldraw_lib__1_16cyli(realsolid)],
// 2 24 8 24 5 8 11 5
  [2,24,8,24,5,8,11,5],
// 2 24 12 24 5 12 11 5
  [2,24,12,24,5,12,11,5],
...
// 1 16 -2 4 0 0 -1 0 0 0 -4 4.5 0 0 1-4edge.dat
  [1,16,-2,4,0,0,-1,0,0,0,-4,4.5,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 2 4 0 0 -1 0 0 0 -4 4.5 0 0 1-4edge.dat
  [1,16,2,4,0,0,-1,0,0,0,-4,4.5,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 2 4 0 0 -1 0 0 0 -4 4.5 0 0 1-4disc.dat
  [1,16,2,4,0,0,-1,0,0,0,-4,4.5,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 -2 4 0 0 1 0 0 0 -4 4.5 0 0 1-4disc.dat
  [1,16,-2,4,0,0,1,0,0,0,-4,4.5,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 -2 4 0 0 4 0 0 0 -4 4.5 0 0 1-4cyli.dat
  [1,16,-2,4,0,0,4,0,0,0,-4,4.5,0,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -12 4.5 0 0 -1 0 0 0 -4.5 4.5 0 0 1-4edge.dat
  [1,16,-12,4.5,0,0,-1,0,0,0,-4.5,4.5,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -8 4.5 0 0 -1 0 0 0 -4.5 4.5 0 0 1-4edge.dat
  [1,16,-8,4.5,0,0,-1,0,0,0,-4.5,4.5,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -8 4.5 0 0 -1 0 0 0 -4.5 4.5 0 0 1-4disc.dat
  [1,16,-8,4.5,0,0,-1,0,0,0,-4.5,4.5,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 -12 4.5 0 0 1 0 0 0 -4.5 4.5 0 0 1-4disc.dat
  [1,16,-12,4.5,0,0,1,0,0,0,-4.5,4.5,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 8 4.5 0 0 -1 0 0 0 -4.5 4.5 0 0 1-4edge.dat
  [1,16,8,4.5,0,0,-1,0,0,0,-4.5,4.5,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 12 4.5 0 0 -1 0 0 0 -4.5 4.5 0 0 1-4edge.dat
  [1,16,12,4.5,0,0,-1,0,0,0,-4.5,4.5,0,0, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 -12 4.5 0 0 4 0 0 0 -4.5 4.5 0 0 1-4cyli.dat
  [1,16,-12,4.5,0,0,4,0,0,0,-4.5,4.5,0,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 8 4.5 0 0 4 0 0 0 -4.5 4.5 0 0 1-4cyli.dat
  [1,16,8,4.5,0,0,4,0,0,0,-4.5,4.5,0,0, ldraw_lib__1_4cyli(realsolid)],
...
module ldraw_lib__s__41856s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__41856s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
