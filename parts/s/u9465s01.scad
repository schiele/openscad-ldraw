...
use <../../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__u9465s01(realsolid=false) = [
...
// 1 16 0 0 2 -11.08655 0 4.5922 -4.5922 0 -11.08655 0 12 0 3-8cylo.dat
  [1,16,0,0,2,-11.08655,0,4.5922,-4.5922,0,-11.08655,0,12,0, ldraw_lib__3_8cylo(realsolid)],
// 1 16 0 0 0 -14.78207 0 6.12293 -6.12293 0 -14.78207 0 14 0 3-8cylo.dat
  [1,16,0,0,0,-14.78207,0,6.12293,-6.12293,0,-14.78207,0,14,0, ldraw_lib__3_8cylo(realsolid)],
// 1 16 0 0 14 -3.69552 0 1.53073 -1.53073 0 -3.69552 0 -1 0 3-8ring3.dat
  [1,16,0,0,14,-3.69552,0,1.53073,-1.53073,0,-3.69552,0,-1,0, ldraw_lib__3_8ring3(realsolid)],
...
// 1 16 0 0 0 0 0 -4 -4 0 0 0 2 0 3-16con3.dat
  [1,16,0,0,0,0,0,-4,-4,0,0,0,2,0, ldraw_lib__3_16con3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 0 0 4 -4 0 0 0 2 0 3-16con3.dat
  [1,16,0,0,0,0,0,4,-4,0,0,0,2,0, ldraw_lib__3_16con3(realsolid)],
...
// 1 16 11.2449 -3.7961 8 -0.1585 1 0 -0.7961 0 0 0 0 6 rect2p.dat
  [1,16,11.2449,-3.7961,8,-0.1585,1,0,-0.7961,0,0,0,0,6, ldraw_lib__rect2p(realsolid)],
// 1 16 -11.2449 -3.7961 8 -0.1585 -1 0 0.7961 0 0 0 0 6 rect2p.dat
  [1,16,-11.2449,-3.7961,8,-0.1585,-1,0,0.7961,0,0,0,0,6, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__s__u9465s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u9465s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
