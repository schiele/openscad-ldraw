...
use <../../p/box4o8a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3241s07(realsolid=false) = [
...
// 1 494 -5 4 -12 0 10 0 -4 0 0 0 0 -4 box4o8a.dat
  [1,494,-5,4,-12,0,10,0,-4,0,0,0,0,-4, ldraw_lib__box4o8a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 494 -5 4 -12 0 10 0 -3.75 0 0 0 0 -3.75 box4o8a.dat
  [1,494,-5,4,-12,0,10,0,-3.75,0,0,0,0,-3.75, ldraw_lib__box4o8a(realsolid)],
];
module ldraw_lib__s__3241s07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3241s07(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
