...
use <../../p/box3u12.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__6142617ls01(realsolid=false) = [
...
// 1 16 -16.5 0 3.8 -1.5 0 0 0 -1 0 0 0 1.5 1-4chrd.dat
  [1,16,-16.5,0,3.8,-1.5,0,0,0,-1,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 16 16.5 0 3.8 1.5 0 0 0 -1 0 0 0 1.5 1-4chrd.dat
  [1,16,16.5,0,3.8,1.5,0,0,0,-1,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 16 0 -.25 0 0 0 18 0 .25 0 3.8 0 0 box3u12.dat
  [1,16,0,-.25,0,0,0,18,0,.25,0,3.8,0,0, ldraw_lib__box3u12(realsolid)],
// 1 16 -16.5 0 -3.8 -1.5 0 0 0 -1 0 0 0 -1.5 1-4chrd.dat
  [1,16,-16.5,0,-3.8,-1.5,0,0,0,-1,0,0,0,-1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 16 16.5 0 -3.8 1.5 0 0 0 -1 0 0 0 -1.5 1-4chrd.dat
  [1,16,16.5,0,-3.8,1.5,0,0,0,-1,0,0,0,-1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -16.5 0 3.8 -1.5 0 0 0 -.25 0 0 0 1.5 1-4cyli.dat
  [1,16,-16.5,0,3.8,-1.5,0,0,0,-.25,0,0,0,1.5, ldraw_lib__1_4cyli(realsolid)],
// 1 16 16.5 0 3.8 1.5 0 0 0 -.25 0 0 0 1.5 1-4cyli.dat
  [1,16,16.5,0,3.8,1.5,0,0,0,-.25,0,0,0,1.5, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -16.5 0 -3.8 -1.5 0 0 0 -.25 0 0 0 -1.5 1-4cyli.dat
  [1,16,-16.5,0,-3.8,-1.5,0,0,0,-.25,0,0,0,-1.5, ldraw_lib__1_4cyli(realsolid)],
...
// 1 0 -16.5 -.25 3.8 -1.5 0 0 0 1 0 0 0 1.5 1-4chrd.dat
  [1,0,-16.5,-.25,3.8,-1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 0 16.5 -.25 3.8 1.5 0 0 0 1 0 0 0 1.5 1-4chrd.dat
  [1,0,16.5,-.25,3.8,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 0 -10.5 -.25 0 4 0 0 0 1 0 0 0 4 4-4ndis.dat
  [1,0,-10.5,-.25,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4ndis(realsolid)],
// 1 0 -16.5 -.25 -3.8 -1.5 0 0 0 1 0 0 0 -1.5 1-4chrd.dat
  [1,0,-16.5,-.25,-3.8,-1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 0 16.5 -.25 -3.8 1.5 0 0 0 1 0 0 0 -1.5 1-4chrd.dat
  [1,0,16.5,-.25,-3.8,1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__1_4chrd(realsolid)],
...
module ldraw_lib__s__6142617ls01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6142617ls01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
