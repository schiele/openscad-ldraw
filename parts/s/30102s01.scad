...
use <../../p/stug-1x4.scad>
use <../../p/tri3u1.scad>
function ldraw_lib__s__30102s01() = [
...
// 1 16 0 1 0 49 0 0 0 -1 0 0 0 1 box3u10p.dat
  [1,16,0,1,0,49,0,0,0,-1,0,0,0,1, ldraw_lib__box3u10p()],
...
// 1 16 35 121.5 1 0 0 -14 0.5 0 0 0 -1 0 rect1.dat
  [1,16,35,121.5,1,0,0,-14,0.5,0,0,0,-1,0, ldraw_lib__rect1()],
// 1 16 10 121.5 1 0 0 -9 0.5 0 0 0 -1 0 rect1.dat
  [1,16,10,121.5,1,0,0,-9,0.5,0,0,0,-1,0, ldraw_lib__rect1()],
// 1 16 -25 121.5 1 0 0 -24 0.5 0 0 0 -1 0 rect1.dat
  [1,16,-25,121.5,1,0,0,-24,0.5,0,0,0,-1,0, ldraw_lib__rect1()],
// 1 16 -35 121.5 -1 0 0 14 0.5 0 0 0 1 0 rect1.dat
  [1,16,-35,121.5,-1,0,0,14,0.5,0,0,0,1,0, ldraw_lib__rect1()],
// 1 16 -10 121.5 -1 0 0 9 0.5 0 0 0 1 0 rect1.dat
  [1,16,-10,121.5,-1,0,0,9,0.5,0,0,0,1,0, ldraw_lib__rect1()],
...
// 1 16 -49 61 0 0 -1 0 -60 0 0 0 0 1 box3u10p.dat
  [1,16,-49,61,0,0,-1,0,-60,0,0,0,0,1, ldraw_lib__box3u10p()],
// 1 16 49 61 0 0 1 0 -60 0 0 0 0 1 box3u10p.dat
  [1,16,49,61,0,0,1,0,-60,0,0,0,0,1, ldraw_lib__box3u10p()],
// 
// 1 16 -49 1 -1 -1 0 0 0 0 -1 0 2 0 1-4cylc.dat
  [1,16,-49,1,-1,-1,0,0,0,0,-1,0,2,0, ldraw_lib__1_4cylc()],
// 1 16 49 1 -1 1 0 0 0 0 -1 0 2 0 1-4cylc.dat
  [1,16,49,1,-1,1,0,0,0,0,-1,0,2,0, ldraw_lib__1_4cylc()],
// 1 16 -49 121 -1 -1 0 0 0 0 1 0 2 0 1-4cylc.dat
  [1,16,-49,121,-1,-1,0,0,0,0,1,0,2,0, ldraw_lib__1_4cylc()],
// 1 16 49 121 -1 1 0 0 0 0 1 0 2 0 1-4cylc.dat
  [1,16,49,121,-1,1,0,0,0,0,1,0,2,0, ldraw_lib__1_4cylc()],
// 1 16 -49 1 1 -1 0 0 0 0 -1 0 -1 0 1-4disc.dat
  [1,16,-49,1,1,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__1_4disc()],
// 1 16 49 1 1 1 0 0 0 0 -1 0 -1 0 1-4disc.dat
  [1,16,49,1,1,1,0,0,0,0,-1,0,-1,0, ldraw_lib__1_4disc()],
// 1 16 -49 121 1 -1 0 0 0 0 1 0 -1 0 1-4disc.dat
  [1,16,-49,121,1,-1,0,0,0,0,1,0,-1,0, ldraw_lib__1_4disc()],
// 1 16 49 121 1 1 0 0 0 0 1 0 -1 0 1-4disc.dat
  [1,16,49,121,1,1,0,0,0,0,1,0,-1,0, ldraw_lib__1_4disc()],
// 
// 0 BFC INVERTNEXT
...
// 1 16 -38 118 -1 0 76 0 -2 0 -2 -20 0 0 tri3u1.dat
  [1,16,-38,118,-1,0,76,0,-2,0,-2,-20,0,0, ldraw_lib__tri3u1()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 38 118 1 0 -76 0 -2 0 -2 20 0 0 tri3u1.dat
  [1,16,38,118,1,0,-76,0,-2,0,-2,20,0,0, ldraw_lib__tri3u1()],
// 1 16 -39 117 -11 0 0 -1 -1 -1 0 -10 0 0 rect3.dat
  [1,16,-39,117,-11,0,0,-1,-1,-1,0,-10,0,0, ldraw_lib__rect3()],
// 1 16 39 117 -11 0 0 1 1 -1 0 10 0 0 rect3.dat
  [1,16,39,117,-11,0,0,1,1,-1,0,10,0,0, ldraw_lib__rect3()],
// 1 16 -39 117 11 0 0 -1 1 -1 0 -10 0 0 rect3.dat
  [1,16,-39,117,11,0,0,-1,1,-1,0,-10,0,0, ldraw_lib__rect3()],
...
// 1 16 0 116 -1 -40 0 0 0 0 -2 0 -1 0 recte3.dat
  [1,16,0,116,-1,-40,0,0,0,0,-2,0,-1,0, ldraw_lib__recte3()],
// 1 16 0 116 1 -40 0 0 0 0 -2 0 -1 0 recte3.dat
  [1,16,0,116,1,-40,0,0,0,0,-2,0,-1,0, ldraw_lib__recte3()],
...
// 1 16 0 115 -11 -40 0 0 0 0 -1 0 -10 0 box2-7.dat
  [1,16,0,115,-11,-40,0,0,0,0,-1,0,-10,0, ldraw_lib__box2_7()],
// 1 16 0 115 11 -40 0 0 0 0 -1 0 10 0 box2-7.dat
  [1,16,0,115,11,-40,0,0,0,0,-1,0,10,0, ldraw_lib__box2_7()],
// 1 16 0 114 -11 1 0 0 0 1 0 0 0 1 stug-1x4.dat
  [1,16,0,114,-11,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x4()],
// 1 16 0 114 11 1 0 0 0 1 0 0 0 1 stug-1x4.dat
  [1,16,0,114,11,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x4()],
// 
// 1 16 0 119 -1 1 0 0 0 0 3 0 -4 0 box4-2p.dat
  [1,16,0,119,-1,1,0,0,0,0,3,0,-4,0, ldraw_lib__box4_2p()],
// 1 16 0 119 1 -1 0 0 0 0 3 0 4 0 box4-2p.dat
  [1,16,0,119,1,-1,0,0,0,0,3,0,4,0, ldraw_lib__box4_2p()],
// 
// 1 16 20 116 4.5 0 0 -1 0 6 0 -3.5 0 0 box3u6.dat
  [1,16,20,116,4.5,0,0,-1,0,6,0,-3.5,0,0, ldraw_lib__box3u6()],
// 1 16 -20 116 -4.5 0 0 -1 0 6 0 3.5 0 0 box3u6.dat
  [1,16,-20,116,-4.5,0,0,-1,0,6,0,3.5,0,0, ldraw_lib__box3u6()],
// 1 16 -20 116 -8 1 0 0 0 1 0 0 0 -1 2-4edge.dat
  [1,16,-20,116,-8,1,0,0,0,1,0,0,0,-1, ldraw_lib__2_4edge()],
// 1 16 20 116 8 1 0 0 0 1 0 0 0 1 2-4edge.dat
  [1,16,20,116,8,1,0,0,0,1,0,0,0,1, ldraw_lib__2_4edge()],
// 1 16 -20 122 -8 1 0 0 0 -6 0 0 0 -1 2-4cyli.dat
  [1,16,-20,122,-8,1,0,0,0,-6,0,0,0,-1, ldraw_lib__2_4cyli()],
// 1 16 20 122 8 1 0 0 0 -6 0 0 0 1 2-4cyli.dat
  [1,16,20,122,8,1,0,0,0,-6,0,0,0,1, ldraw_lib__2_4cyli()],
...
module ldraw_lib__s__30102s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__30102s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
