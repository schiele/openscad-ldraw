use <../../lib.scad>
use <../../p/1-4chrd.scad>
function ldraw_lib__s__6009194bs01() = [
...
// 1 0 -16 -0.25 26 0 0 -2 0 1 0 2 0 0 1-4chrd.dat
  [1,0,-16,-0.25,26,0,0,-2,0,1,0,2,0,0, ldraw_lib__1_4chrd()],
// 1 0 16 -0.25 26 2 0 0 0 1 0 0 0 2 1-4chrd.dat
  [1,0,16,-0.25,26,2,0,0,0,1,0,0,0,2, ldraw_lib__1_4chrd()],
// 0 // Black top faces
...
module ldraw_lib__s__6009194bs01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6009194bs01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
