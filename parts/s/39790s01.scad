...
use <../../p/rect1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__39790s01(realsolid=false) = [
...
// 1 16 0 0 10 -1 0 0 0 1 0 0 0 -1 npeghol9.dat
  [1,16,0,0,10,-1,0,0,0,1,0,0,0,-1, ldraw_lib__npeghol9(realsolid)],
...
// 1 16 -10 0 20 0 1 0 0 0 -1 1 0 0 peghole5.dat
  [1,16,-10,0,20,0,1,0,0,0,-1,1,0,0, ldraw_lib__peghole5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 8 0 20 0 -16 0 -6 0 0 0 0 6 4-4cyli.dat
  [1,16,8,0,20,0,-16,0,-6,0,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -10 -1 0 0 0 1 0 0 0 1 npeghol9.dat
  [1,16,0,0,-10,-1,0,0,0,1,0,0,0,1, ldraw_lib__npeghol9(realsolid)],
...
// 1 16 10 9 0 0 -1 0 1 0 0 0 0 20 rect1.dat
  [1,16,10,9,0,0,-1,0,1,0,0,0,0,20, ldraw_lib__rect1(realsolid)],
// 1 16 10 -9 0 0 -1 0 -1 0 0 0 0 -20 rect1.dat
  [1,16,10,-9,0,0,-1,0,-1,0,0,0,0,-20, ldraw_lib__rect1(realsolid)],
...
// 1 16 -10 1 0 0 1 0 9 0 0 0 0 -12 rect1.dat
  [1,16,-10,1,0,0,1,0,9,0,0,0,0,-12, ldraw_lib__rect1(realsolid)],
];
module ldraw_lib__s__39790s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__39790s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
