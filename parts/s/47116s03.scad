...
use <../../p/stud4f4n.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__47116s03(realsolid=false) = [
// 0 ~Brick 12 x 24 with Pegs - Edge Stud Tubes and Flush H-Ribs
// 0 Name: s\47116s03.dat
...
// 1 16 -20 0 20 1 0 0 0 1 0 0 0 1 stud4.dat
  [1,16,-20,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 36 -2 20 0 1 0 0 0 -2 -19 0 0 rect.dat
  [1,16,36,-2,20,0,1,0,0,0,-2,-19,0,0, ldraw_lib__rect(realsolid)],
// 0 // rib to edge +x
...
module ldraw_lib__s__47116s03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__47116s03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__47116s03(line=0.2);