use <../../lib.scad>
use <../../p/1-4chrd.scad>
function ldraw_lib__s__6009194ds01() = [
...
// 1 0 -15.5585 -0.25 16 0 0 -2 0 1 0 2 0 0 1-4chrd.dat
  [1,0,-15.5585,-0.25,16,0,0,-2,0,1,0,2,0,0, ldraw_lib__1_4chrd()],
// 1 0 15.5585 -0.25 16 2 0 0 0 1 0 0 0 2 1-4chrd.dat
  [1,0,15.5585,-0.25,16,2,0,0,0,1,0,0,0,2, ldraw_lib__1_4chrd()],
// 0 // Black top faces
...
module ldraw_lib__s__6009194ds01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6009194ds01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
