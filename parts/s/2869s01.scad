...
use <../../p/recte3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2869s01(realsolid=false) = [
...
// 1 16 0 0.625 0 8.75 0 0 0 0.625 0 0 0 8.75 box2-7.dat
  [1,16,0,0.625,0,8.75,0,0,0,0.625,0,0,0,8.75, ldraw_lib__box2_7(realsolid)],
// 1 16 0 0.625 -9.375 -8.75 0 0 0 -1 0.625 0 0 0.625 rect3.dat
  [1,16,0,0.625,-9.375,-8.75,0,0,0,-1,0.625,0,0,0.625, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 0 -0.625 8.75 0 0 0 1 0 0 0 9.375 recte3.dat
  [1,16,0,0,-0.625,8.75,0,0,0,1,0,0,0,9.375, ldraw_lib__recte3(realsolid)],
];
module ldraw_lib__s__2869s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2869s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
