...
use <../../p/bump5000.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__42509s01(realsolid=false) = [
...
// 1 16 52.5 0 0 2 0 0 0 2 0 0 0 2 bump5000.dat
  [1,16,52.5,0,0,2,0,0,0,2,0,0,0,2, ldraw_lib__bump5000(realsolid)],
// 1 16 -52.5 0 0 2 0 0 0 2 0 0 0 2 bump5000.dat
  [1,16,-52.5,0,0,2,0,0,0,2,0,0,0,2, ldraw_lib__bump5000(realsolid)],
// 1 16 52.5 131.5 0 2 0 0 0 -2 0 0 0 2 bump5000.dat
  [1,16,52.5,131.5,0,2,0,0,0,-2,0,0,0,2, ldraw_lib__bump5000(realsolid)],
// 1 16 -52.5 131.5 0 2 0 0 0 -2 0 0 0 2 bump5000.dat
  [1,16,-52.5,131.5,0,2,0,0,0,-2,0,0,0,2, ldraw_lib__bump5000(realsolid)],
// 1 16 52.5 0 0 2 0 0 0 1 0 0 0 2 4-4ndis.dat
  [1,16,52.5,0,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -52.5 0 0 2 0 0 0 1 0 0 0 2 4-4ndis.dat
  [1,16,-52.5,0,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4ndis(realsolid)],
// 1 16 52.5 131.5 0 2 0 0 0 -1 0 0 0 -2 4-4ndis.dat
  [1,16,52.5,131.5,0,2,0,0,0,-1,0,0,0,-2, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -52.5 131.5 0 2 0 0 0 -1 0 0 0 -2 4-4ndis.dat
  [1,16,-52.5,131.5,0,2,0,0,0,-1,0,0,0,-2, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 0 65.75 -2 0 0 56 65.75 0 0 0 4 0 box3u2p.dat
  [1,16,0,65.75,-2,0,0,56,65.75,0,0,0,4,0, ldraw_lib__box3u2p(realsolid)],
// 2 24 56 0 -2 -56 0 -2
  [2,24,56,0,-2,-56,0,-2],
...
module ldraw_lib__s__42509s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__42509s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
