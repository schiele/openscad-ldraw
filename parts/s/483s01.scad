...
use <../../p/box2-5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__483s01(realsolid=false) = [
...
// 1 16 -4.9 -4.9 0 0 3.9 0 0 0 3.9 1.425 0 0 box2-5.dat
  [1,16,-4.9,-4.9,0,0,3.9,0,0,0,3.9,1.425,0,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 4.9 -4.9 0 0 0 -3.9 0 3.9 0 1.425 0 0 box2-5.dat
  [1,16,4.9,-4.9,0,0,0,-3.9,0,3.9,0,1.425,0,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 4.9 4.9 0 0 -3.9 0 0 0 -3.9 1.425 0 0 box2-5.dat
  [1,16,4.9,4.9,0,0,-3.9,0,0,0,-3.9,1.425,0,0, ldraw_lib__box2_5(realsolid)],
...
module ldraw_lib__s__483s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__483s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
