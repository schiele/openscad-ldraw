...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__32090s01(realsolid=false) = [
...
// 1 16 -22.925 -3.84 -10 -0.5 0 1.325 2.52 0 0 0 1 0 rect2p.dat
  [1,16,-22.925,-3.84,-10,-0.5,0,1.325,2.52,0,0,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -21.6 -3.84 -7 0 -5.04 0.5 0 -1 -2.52 3 0 0 rect2a.dat
  [1,16,-21.6,-3.84,-7,0,-5.04,0.5,0,-1,-2.52,3,0,0, ldraw_lib__rect2a(realsolid)],
// 1 16 -24.25 -3.84 -6 0.5 1.26 0 -2.52 0.25 0 0 0 4 rect2a.dat
  [1,16,-24.25,-3.84,-6,0.5,1.26,0,-2.52,0.25,0,0,0,4, ldraw_lib__rect2a(realsolid)],
// 1 16 -22.925 3.84 -10 -0.5 0 -1.325 -2.52 0 0 0 1 0 rect2p.dat
  [1,16,-22.925,3.84,-10,-0.5,0,-1.325,-2.52,0,0,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -21.6 3.84 -7 0.5 -5.04 0 2.52 1 0 0 0 3 rect2a.dat
  [1,16,-21.6,3.84,-7,0.5,-5.04,0,2.52,1,0,0,0,3, ldraw_lib__rect2a(realsolid)],
// 1 16 -24.25 3.84 -6 0 1.26 0.5 0 -0.25 2.52 4 0 0 rect2a.dat
  [1,16,-24.25,3.84,-6,0,1.26,0.5,0,-0.25,2.52,4,0,0, ldraw_lib__rect2a(realsolid)],
// 0 //
// 1 16 -28 0 -2 3.25 0 0 0 0 -1.32 0 -8 0 box3u4p.dat
  [1,16,-28,0,-2,3.25,0,0,0,0,-1.32,0,-8,0, ldraw_lib__box3u4p(realsolid)],
// 1 16 -15.4 0 -4 6.7 0 0 0 0 -1.32 0 -6 0 box3u4p.dat
  [1,16,-15.4,0,-4,6.7,0,0,0,0,-1.32,0,-6,0, ldraw_lib__box3u4p(realsolid)],
...
// 1 16 -26.875 -6.36 -6 3.125 0 0 0 -1 0 0 0 -4 rect2p.dat
  [1,16,-26.875,-6.36,-6,3.125,0,0,0,-1,0,0,0,-4, ldraw_lib__rect2p(realsolid)],
...
// 1 16 -17.5 -6.36 -7 0 0 3.6 0 -1.01053 0 3 0 0 rect3.dat
  [1,16,-17.5,-6.36,-7,0,0,3.6,0,-1.01053,0,3,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 -17.5 6.36 -7 0 0 3.6 0 1 0 -3 0 0 rect3.dat
  [1,16,-17.5,6.36,-7,0,0,3.6,0,1,0,-3,0,0, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__s__32090s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__32090s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
