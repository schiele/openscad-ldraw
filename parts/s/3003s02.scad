...
use <../../p/stug-2x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3003s02(realsolid=false) = [
...
// 1 16 0 24 0 0 0 20 0 -24 0 -20 0 0 box3u2p.dat
  [1,16,0,24,0,0,0,20,0,-24,0,-20,0,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
];
module ldraw_lib__s__3003s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3003s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__3003s02(line=0.2);