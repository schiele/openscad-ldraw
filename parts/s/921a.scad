...
// 1 16 -10 0 0 0 1 0 -2 0 0 0 0 2 ring4.dat
  [1,16,-10,0,0,0,1,0,-2,0,0,0,0,2, ldraw_lib__ring4()],
// 1 16 10 0 0 0 -1 0 -2 0 0 0 0 -2 ring4.dat
  [1,16,10,0,0,0,-1,0,-2,0,0,0,0,-2, ldraw_lib__ring4()],
// 0
// 
...
module ldraw_lib__s__921a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__921a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
