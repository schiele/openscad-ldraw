...
use <../../p/boxjcyl4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__48138s03(realsolid=false) = [
...
// 1 16 23.75 3 0 1.5 0 0 0 92 0 0 0 -1.5 boxjcyl4.dat
  [1,16,23.75,3,0,1.5,0,0,0,92,0,0,0,-1.5, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 0 3 -23.75 0 0 -1.5 0 92 0 -1.5 0 0 boxjcyl4.dat
  [1,16,0,3,-23.75,0,0,-1.5,0,92,0,-1.5,0,0, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 -23.75 3 0 -1.5 0 0 0 92 0 0 0 1.5 boxjcyl4.dat
  [1,16,-23.75,3,0,-1.5,0,0,0,92,0,0,0,1.5, ldraw_lib__boxjcyl4(realsolid)],
...
// 1 16 12.625 49 -12.625 0 -11.125 0 46 0 0 0 0 11.125 box2-7.dat
  [1,16,12.625,49,-12.625,0,-11.125,0,46,0,0,0,0,11.125, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -12.625 49 -12.625 0 0 11.125 46 0 0 0 11.125 0 box2-7.dat
  [1,16,-12.625,49,-12.625,0,0,11.125,46,0,0,0,11.125,0, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -12.625 49 12.625 0 11.125 0 46 0 0 0 0 -11.125 box2-7.dat
  [1,16,-12.625,49,12.625,0,11.125,0,46,0,0,0,0,-11.125, ldraw_lib__box2_7(realsolid)],
...
module ldraw_lib__s__48138s03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__48138s03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
