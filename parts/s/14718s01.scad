...
$fa=1; $fs=0.2;
function ldraw_lib__s__14718s01(realsolid=false) = [
...
// 1 16 0 48 0 40 0 0 0 1 0 0 0 10 recte4.dat
  [1,16,0,48,0,40,0,0,0,1,0,0,0,10, ldraw_lib__recte4(realsolid)],
...
// 1 16 0 44 -10 40 0 0 0 0 -4 0 1 0 rect3.dat
  [1,16,0,44,-10,40,0,0,0,0,-4,0,1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 22 4 -36 0 0 0 0 18 0 2 0 box2-7.dat
  [1,16,0,22,4,-36,0,0,0,0,18,0,2,0, ldraw_lib__box2_7(realsolid)],
// 4 16 -36 40 2 -36 40 6 -36 4 6 -36 6 2
  [4,16,-36,40,2,-36,40,6,-36,4,6,-36,6,2],
// 4 16 36 6 2 36 4 6 36 40 6 36 40 2
  [4,16,36,6,2,36,4,6,36,40,6,36,40,2],
// 1 16 -38 23 2 -2 0 0 0 0 17 0 1 0 rect3.dat
  [1,16,-38,23,2,-2,0,0,0,0,17,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 38 23 2 -2 0 0 0 0 17 0 1 0 rect3.dat
  [1,16,38,23,2,-2,0,0,0,0,17,0,1,0, ldraw_lib__rect3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -40 6 0 0 4 0 -2 0 0 0 0 2 1-4cylo.dat
  [1,16,-40,6,0,0,4,0,-2,0,0,0,0,2, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -40 6 0 0 1 0 -2 0 0 0 0 2 1-4ndis.dat
  [1,16,-40,6,0,0,1,0,-2,0,0,0,0,2, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -36 6 0 0 -1 0 0 0 -2 2 0 0 1-4ndis.dat
  [1,16,-36,6,0,0,-1,0,0,0,-2,2,0,0, ldraw_lib__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 36 6 0 0 4 0 -2 0 0 0 0 2 1-4cylo.dat
  [1,16,36,6,0,0,4,0,-2,0,0,0,0,2, ldraw_lib__1_4cylo(realsolid)],
// 1 16 36 6 0 0 1 0 -2 0 0 0 0 2 1-4ndis.dat
  [1,16,36,6,0,0,1,0,-2,0,0,0,0,2, ldraw_lib__1_4ndis(realsolid)],
// 1 16 40 6 0 0 -1 0 0 0 -2 2 0 0 1-4ndis.dat
  [1,16,40,6,0,0,-1,0,0,0,-2,2,0,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 0 4 3 -36 0 0 0 -1 0 0 0 3 rect3.dat
  [1,16,0,4,3,-36,0,0,0,-1,0,0,0,3, ldraw_lib__rect3(realsolid)],
...
// 1 16 -38 4 -8 0 0 -2 0 -4 0 -2 0 0 1-4cylc.dat
  [1,16,-38,4,-8,0,0,-2,0,-4,0,-2,0,0, ldraw_lib__1_4cylc(realsolid)],
...
// 1 16 0 2 -8 38 0 0 0 0 2 0 -2 0 box3u10p.dat
  [1,16,0,2,-8,38,0,0,0,0,2,0,-2,0, ldraw_lib__box3u10p(realsolid)],
// 1 16 38 4 -8 2 0 0 0 -4 0 0 0 -2 1-4cylc.dat
  [1,16,38,4,-8,2,0,0,0,-4,0,0,0,-2, ldraw_lib__1_4cylc(realsolid)],
...
module ldraw_lib__s__14718s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__14718s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
