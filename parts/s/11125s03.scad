...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__11125s03(realsolid=false) = [
...
// 1 16 -35.5 8.5 -1.5 0 -1 0 1.5 0 0 0 0 -1.5 rect3.dat
  [1,16,-35.5,8.5,-1.5,0,-1,0,1.5,0,0,0,0,-1.5, ldraw_lib__rect3(realsolid)],
// 1 16 -33 6.25 -1.5 0 0 -2.5 0 -1 0.75 -1.5 0 0 rect1.dat
  [1,16,-33,6.25,-1.5,0,0,-2.5,0,-1,0.75,-1.5,0,0, ldraw_lib__rect1(realsolid)],
// 1 16 -30.1591 4.25 -1.5 -0.3409 0 0 1.25 -1 0 0 0 -1.5 rect3.dat
  [1,16,-30.1591,4.25,-1.5,-0.3409,0,0,1.25,-1,0,0,0,-1.5, ldraw_lib__rect3(realsolid)],
// 2 24 -25 10 -3 -25 0 -3
  [2,24,-25,10,-3,-25,0,-3],
...
// 1 16 -29 0 0 0 4 0 0 0 -3 -3 0 0 1-4cylo.dat
  [1,16,-29,0,0,0,4,0,0,0,-3,-3,0,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -29 0 0 0 1 0 0 0 -3 -3 0 0 1-4ndis.dat
  [1,16,-29,0,0,0,1,0,0,0,-3,-3,0,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 -25 0 0 0 -1 0 0 0 -3 -3 0 0 1-4ndis.dat
  [1,16,-25,0,0,0,-1,0,0,0,-3,-3,0,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 -33.875 -3.5 -4 0 0 1.625 6.5 0 0 0 -1 -0.5 rect.dat
  [1,16,-33.875,-3.5,-4,0,0,1.625,6.5,0,0,0,-1,-0.5, ldraw_lib__rect(realsolid)],
// 1 16 -35.5 -3.5 -1.75 0 -1 0 0 0 -6.5 1.75 0 0 rect2p.dat
  [1,16,-35.5,-3.5,-1.75,0,-1,0,0,0,-6.5,1.75,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 -29.4091 1.5 -3.75 0 0 -0.4091 0 1 1.5 -0.75 0 0 rect.dat
  [1,16,-29.4091,1.5,-3.75,0,0,-0.4091,0,1,1.5,-0.75,0,0, ldraw_lib__rect(realsolid)],
// 
// 0 // top at y=-10
...
// 1 16 -27 -10 -1.5 0 0 -2 0 1 0 -1.5 0 0 rect2p.dat
  [1,16,-27,-10,-1.5,0,0,-2,0,1,0,-1.5,0,0, ldraw_lib__rect2p(realsolid)],
];
module ldraw_lib__s__11125s03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__11125s03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
