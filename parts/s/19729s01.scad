...
use <../../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__19729s01(realsolid=false) = [
...
// 1 16 0 4 0 1 0 0 0 -7.25 0 0 0 1 stud4.dat
  [1,16,0,4,0,1,0,0,0,-7.25,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 0 30 0 15 0 0 0 -30 0 0 0 15 box4t.dat
  [1,16,0,30,0,15,0,0,0,-30,0,0,0,15, ldraw_lib__box4t(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 30 0 12 0 0 0 -26 0 0 0 12 box5.dat
  [1,16,0,30,0,12,0,0,0,-26,0,0,0,12, ldraw_lib__box5(realsolid)],
// 
];
module ldraw_lib__s__19729s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__19729s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
