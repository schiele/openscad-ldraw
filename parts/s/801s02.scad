...
use <../../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__801s02(realsolid=false) = [
...
// 1 16 0 72 0 10 0 0 0 -1 0 0 0 -10 3-4edge.dat
  [1,16,0,72,0,10,0,0,0,-1,0,0,0,-10, ldraw_lib__3_4edge(realsolid)],
...
// 1 16 10 32 42 0 4 0 -4 0 0 0 0 1 box5.dat
  [1,16,10,32,42,0,4,0,-4,0,0,0,0,1, ldraw_lib__box5(realsolid)],
// 1 16 0 24 0 10 0 0 0 48 0 0 0 -10 3-4cyli.dat
  [1,16,0,24,0,10,0,0,0,48,0,0,0,-10, ldraw_lib__3_4cyli(realsolid)],
];
module ldraw_lib__s__801s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__801s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
