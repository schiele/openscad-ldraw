...
use <../../p/connhol3.scad>
function ldraw_lib__s__23801s03() = [
// 0 ~Technic Steering Wheel Bearing with 2 Pegholes and 2 Axleholes Arms Centre
// 0 Name: s\23801s03.dat
...
// 0 !HISTORY 2023-10-05 [jb70] subfiled from 23801.dat by Philippe Hurbain [Philo]
// 0 !HISTORY 2023-11-13 [jb70] Using Hi-Res Primitives on outer Ring
// 0 !HISTORY 2026-07-30 [OrionP] Official Update 2026-07
// 
// 5 24 0 12 -19 0 14 -22 4.592 11.087 -19 -4.592 11.087 -19
  [5,24,0,12,-19,0,14,-22,4.592,11.087,-19,-4.592,11.087,-19],
// 5 24 0 -12 -19 0 -14 -22 4.592 -11.087 -19 -4.592 -11.087 -19
  [5,24,0,-12,-19,0,-14,-22,4.592,-11.087,-19,-4.592,-11.087,-19],
// 5 24 0 28 -18 0 28.587 -9 3.731 28.341 -9 -3.731 28.341 -9
  [5,24,0,28,-18,0,28.587,-9,3.731,28.341,-9,-3.731,28.341,-9],
// 5 24 0 -28.588 -9 0 -28.001 -18 3.654 -27.759 -18 -3.655 -27.76 -18
  [5,24,0,-28.588,-9,0,-28.001,-18,3.654,-27.759,-18,-3.655,-27.76,-18],
// 5 24 0 -25 -30 0 -25 -9 -9.568 -23.098 -30 9.567 -23.097 -30
  [5,24,0,-25,-30,0,-25,-9,-9.568,-23.098,-30,9.567,-23.097,-30],
// 5 24 0 14 -22 0 14 -30 -5.358 12.934 -30 5.358 12.934 -30
  [5,24,0,14,-22,0,14,-30,-5.358,12.934,-30,5.358,12.934,-30],
// 5 24 0 -14 -30 0 -14 -22 -5.358 -12.934 -30 5.358 -12.934 -30
  [5,24,0,-14,-30,0,-14,-22,-5.358,-12.934,-30,5.358,-12.934,-30],
// 
// 1 16 0 0 -30 16.8 0 0 0 0 16.8 0 15 0 4-4cyli.dat
  [1,16,0,0,-30,16.8,0,0,0,0,16.8,0,15,0, ldraw_lib__4_4cyli()],
// 1 16 0 0 -30 28 0 0 0 0 28 0 12 0 48\4-4cyli.dat
  [1,16,0,0,-30,28,0,0,0,0,28,0,12,0, ldraw_lib__48__4_4cyli()],
...
// 1 16 0 0 -30 28 0 0 0 0 28 0 1 0 48\4-4aring.dat
  [1,16,0,0,-30,28,0,0,0,0,28,0,1,0, ldraw_lib__48__4_4aring()],
// 1 16 0 0 -30 28 0 0 0 0 28 0 1 0 48\4-4edge.dat
  [1,16,0,0,-30,28,0,0,0,0,28,0,1,0, ldraw_lib__48__4_4edge()],
...
// 1 16 0 29.5 0 9 0 0 0 .5 0 0 0 9 4-4cyli.dat
  [1,16,0,29.5,0,9,0,0,0,.5,0,0,0,9, ldraw_lib__4_4cyli()],
...
// 1 16 0 12 0 .92388 0 -.38268 0 1 0 .38268 0 .92388 3-8ring8.dat
  [1,16,0,12,0,.92388,0,-.38268,0,1,0,.38268,0,.92388, ldraw_lib__3_8ring8()],
...
module ldraw_lib__s__23801s03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__23801s03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__23801s03(line=0.2);