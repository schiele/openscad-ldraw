...
// 1 16 0 -4 0 2 0 0 0 -150 0 0 0 2 4-4cylo.dat
  [1,16,0,-4,0,2,0,0,0,-150,0,0,0,2, ldraw_lib__4_4cylo()],
...
// 1 16 0 -154 0 2 0 0 0 -1 0 0 0 2 4-4ring1.dat
  [1,16,0,-154,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring1()],
// 1 16 0 -154 0 4 0 0 0 -4 0 0 0 4 4-8sphe.dat
  [1,16,0,-154,0,4,0,0,0,-4,0,0,0,4, ldraw_lib__4_8sphe()],
// 
// 1 16 1.5 -130 0 0 1 0 24 0 0 0 0 -1.5 rect2p.dat
  [1,16,1.5,-130,0,0,1,0,24,0,0,0,0,-1.5, ldraw_lib__rect2p()],
...
// 1 16 11.5 -150 0 10 0 0 4 1 0 0 0 1.5 rect2p.dat
  [1,16,11.5,-150,0,10,0,0,4,1,0,0,0,1.5, ldraw_lib__rect2p()],
// 1 16 11.5 -102 0 -10 0 0 -4 -1 0 0 0 1.5 rect2p.dat
  [1,16,11.5,-102,0,-10,0,0,-4,-1,0,0,0,1.5, ldraw_lib__rect2p()],
// 1 16 26.5 -145 0 5 0 0 1 1 0 0 0 1.5 rect2p.dat
  [1,16,26.5,-145,0,5,0,0,1,1,0,0,0,1.5, ldraw_lib__rect2p()],
// 1 16 26.5 -97 0 -5 0 0 -1 -1 0 0 0 1.5 rect2p.dat
  [1,16,26.5,-97,0,-5,0,0,-1,-1,0,0,0,1.5, ldraw_lib__rect2p()],
// 1 16 36.5 -143 0 5 0 0 1 1 0 0 0 1.5 rect2p.dat
  [1,16,36.5,-143,0,5,0,0,1,1,0,0,0,1.5, ldraw_lib__rect2p()],
// 1 16 36.5 -95 0 -5 0 0 -1 -1 0 0 0 1.5 rect2p.dat
  [1,16,36.5,-95,0,-5,0,0,-1,-1,0,0,0,1.5, ldraw_lib__rect2p()],
// 1 16 44 -141.5 0 2.5 0 0 0.5 1 0 0 0 1.5 rect2p.dat
  [1,16,44,-141.5,0,2.5,0,0,0.5,1,0,0,0,1.5, ldraw_lib__rect2p()],
// 1 16 44 -93.5 0 -2.5 0 0 -0.5 -1 0 0 0 1.5 rect2p.dat
  [1,16,44,-93.5,0,-2.5,0,0,-0.5,-1,0,0,0,1.5, ldraw_lib__rect2p()],
// 1 16 49 -140 0 2.5 0 0 1 1 0 0 0 1.5 rect2p.dat
  [1,16,49,-140,0,2.5,0,0,1,1,0,0,0,1.5, ldraw_lib__rect2p()],
// 1 16 49 -92 0 -2.5 0 0 -1 -1 0 0 0 1.5 rect2p.dat
  [1,16,49,-92,0,-2.5,0,0,-1,-1,0,0,0,1.5, ldraw_lib__rect2p()],
// 1 16 54 -138 0 2.5 0 0 1 1 0 0 0 1.5 rect2p.dat
  [1,16,54,-138,0,2.5,0,0,1,1,0,0,0,1.5, ldraw_lib__rect2p()],
// 1 16 54 -90 0 -2.5 0 0 -1 -1 0 0 0 1.5 rect2p.dat
  [1,16,54,-90,0,-2.5,0,0,-1,-1,0,0,0,1.5, ldraw_lib__rect2p()],
// 1 16 59 -135.5 0 2.5 0 0 1.5 1 0 0 0 1.5 rect2p.dat
  [1,16,59,-135.5,0,2.5,0,0,1.5,1,0,0,0,1.5, ldraw_lib__rect2p()],
// 1 16 59 -87.5 0 -2.5 0 0 -1.5 -1 0 0 0 1.5 rect2p.dat
  [1,16,59,-87.5,0,-2.5,0,0,-1.5,-1,0,0,0,1.5, ldraw_lib__rect2p()],
// 
...
module ldraw_lib__s__777s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__777s02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
