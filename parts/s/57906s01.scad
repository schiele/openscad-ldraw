...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__57906s01(realsolid=false) = [
...
// 1 16 10 5.25 7 1 0 0 0 0 2.25 0 -1 0 box4-1.dat
  [1,16,10,5.25,7,1,0,0,0,0,2.25,0,-1,0, ldraw_lib__box4_1(realsolid)],
// 1 16 30 5.25 7 1 0 0 0 0 2.25 0 -1 0 box4-1.dat
  [1,16,30,5.25,7,1,0,0,0,0,2.25,0,-1,0, ldraw_lib__box4_1(realsolid)],
// 1 16 50 5.25 7 1 0 0 0 0 2.25 0 -1 0 box4-1.dat
  [1,16,50,5.25,7,1,0,0,0,0,2.25,0,-1,0, ldraw_lib__box4_1(realsolid)],
// 1 16 70 5.25 7 1 0 0 0 0 2.25 0 -1 0 box4-1.dat
  [1,16,70,5.25,7,1,0,0,0,0,2.25,0,-1,0, ldraw_lib__box4_1(realsolid)],
// 1 16 90 5.25 7 1 0 0 0 0 2.25 0 -1 0 box4-1.dat
  [1,16,90,5.25,7,1,0,0,0,0,2.25,0,-1,0, ldraw_lib__box4_1(realsolid)],
// 1 16 110 5.25 7 1 0 0 0 0 2.25 0 -1 0 box4-1.dat
  [1,16,110,5.25,7,1,0,0,0,0,2.25,0,-1,0, ldraw_lib__box4_1(realsolid)],
// 0 // geometry generated by teft.greg.dxftodat.DxfToDat
// 1 16 60 5.73 10 0 0 -60 2.27 0 0 0 -1 0 rect3.dat
  [1,16,60,5.73,10,0,0,-60,2.27,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 120 4 9.25 0 -1 0 0 0 4 -.75 0 0 rect3.dat
  [1,16,120,4,9.25,0,-1,0,0,0,4,-.75,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 122 -2 6.25 0 1 2 0 1 -2 -2.25 0 0 rect3.dat
  [1,16,122,-2,6.25,0,1,2,0,1,-2,-2.25,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 -60 3.23 9.6 0 0 60 .23 -1 0 .4 .575 0 rect2p.dat
  [1,16,-60,3.23,9.6,0,0,60,.23,-1,0,.4,.575,0, ldraw_lib__rect2p(realsolid)],
// 1 16 40.63 13.225 29.92 .63 -.126984 0 -.045 0 1.73 -.08 -1 0 rect2p.dat
  [1,16,40.63,13.225,29.92,.63,-.126984,0,-.045,0,1.73,-.08,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 80.63 7.455 19.92 39.37 -.251969 0 -5.725 0 1.73 -9.92 -1 0 rect2p.dat
  [1,16,80.63,7.455,19.92,39.37,-.251969,0,-5.725,0,1.73,-9.92,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 123 8 6.25 3 0 0 0 -1 0 0 0 -2.25 rect2p.dat
  [1,16,123,8,6.25,3,0,0,0,-1,0,0,0,-2.25, ldraw_lib__rect2p(realsolid)],
// 1 16 125 -4 6.25 1 0 0 0 1 0 0 0 2.25 rect2p.dat
  [1,16,125,-4,6.25,1,0,0,0,1,0,0,0,2.25, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__s__57906s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__57906s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
