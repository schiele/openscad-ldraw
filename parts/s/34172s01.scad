...
use <../../p/r04o1000.scad>
use <../../p/stud4.scad>
function ldraw_lib__s__34172s01() = [
...
// 1 16 0 -6.75 0 2.0139 0 0 0 1 0 0 0 2.0139 4-4disc.dat
  [1,16,0,-6.75,0,2.0139,0,0,0,1,0,0,0,2.0139, ldraw_lib__4_4disc()],
// 1 16 0 -7 0 3.020833 0 0 0 1 0 0 0 3.020833 4-4ring1.dat
  [1,16,0,-7,0,3.020833,0,0,0,1,0,0,0,3.020833, ldraw_lib__4_4ring1()],
// 1 16 0 -7 0 .503472 0 0 0 1 0 0 0 .503472 4-4ring5.dat
  [1,16,0,-7,0,.503472,0,0,0,1,0,0,0,.503472, ldraw_lib__4_4ring5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -7 0 .503472 0 0 0 .25 0 0 0 .503472 4-4con4.dat
  [1,16,0,-7,0,.503472,0,0,0,.25,0,0,0,.503472, ldraw_lib__4_4con4()],
// 1 16 0 -6.75 0 2.0139 0 0 0 1 0 0 0 2.0139 4-4edge.dat
  [1,16,0,-6.75,0,2.0139,0,0,0,1,0,0,0,2.0139, ldraw_lib__4_4edge()],
// 1 16 0 -7 0 2.5174 0 0 0 1 0 0 0 2.5174 4-4edge.dat
  [1,16,0,-7,0,2.5174,0,0,0,1,0,0,0,2.5174, ldraw_lib__4_4edge()],
// 1 16 0 -16 0 14.5 0 0 0 1 0 0 0 14.5 4-4edge.dat
  [1,16,0,-16,0,14.5,0,0,0,1,0,0,0,14.5, ldraw_lib__4_4edge()],
// 1 16 0 -16 0 12.083333 0 0 0 1 0 0 0 12.083333 4-4edge.dat
  [1,16,0,-16,0,12.083333,0,0,0,1,0,0,0,12.083333, ldraw_lib__4_4edge()],
// 1 16 0 -16 0 2.416666 0 0 0 1 0 0 0 2.416666 4-4ring5.dat
  [1,16,0,-16,0,2.416666,0,0,0,1,0,0,0,2.416666, ldraw_lib__4_4ring5()],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -16 0 6.041666 0 0 0 9 0 0 0 6.041666 r04o1000.dat
  [1,16,0,-16,0,6.041666,0,0,0,9,0,0,0,6.041666, ldraw_lib__r04o1000()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -16 0 6.041666 0 0 0 9 0 0 0 -6.041666 r04o1000.dat
  [1,16,0,-16,0,6.041666,0,0,0,9,0,0,0,-6.041666, ldraw_lib__r04o1000()],
...
module ldraw_lib__s__34172s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__34172s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
