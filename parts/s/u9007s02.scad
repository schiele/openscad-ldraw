...
use <../../p/t01o4000.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__u9007s02(realsolid=false) = [
...
// 1 16 0 -4 0 10 0 0 0 -10 0 0 0 10 t01o4000.dat
  [1,16,0,-4,0,10,0,0,0,-10,0,0,0,10, ldraw_lib__t01o4000(realsolid)],
// 1 16 0 -8 0 10 0 0 0 10 0 0 0 10 4-4disc.dat
  [1,16,0,-8,0,10,0,0,0,10,0,0,0,10, ldraw_lib__4_4disc(realsolid)],
// 0 //
// 
];
module ldraw_lib__s__u9007s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u9007s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
