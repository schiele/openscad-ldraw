...
use <../../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3002s01(realsolid=false) = [
...
// 1 16 10 4 0 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,10,4,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -10 4 0 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-10,4,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__s__3002s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3002s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
