...
use <../../p/tri4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2727s01(realsolid=false) = [
...
// 1 16 0 -6.5 -4.25 5 0 0 0 0 -6.5 0 1 0 recte3.dat
  [1,16,0,-6.5,-4.25,5,0,0,0,0,-6.5,0,1,0, ldraw_lib__recte3(realsolid)],
// 1 16 0 -6.5 4.25 5 0 0 0 0 -6.5 0 1 0 recte3.dat
  [1,16,0,-6.5,4.25,5,0,0,0,0,-6.5,0,1,0, ldraw_lib__recte3(realsolid)],
// 1 16 5 -11.5 0 0 1 0 0 0 1.5 -3.25 0 0 recte3.dat
  [1,16,5,-11.5,0,0,1,0,0,0,1.5,-3.25,0,0, ldraw_lib__recte3(realsolid)],
// 1 16 -5 -11.5 0 0 1 0 0 0 1.5 -3.25 0 0 recte3.dat
  [1,16,-5,-11.5,0,0,1,0,0,0,1.5,-3.25,0,0, ldraw_lib__recte3(realsolid)],
...
// 1 16 0 0 -5.25 2.5 0 0 0 -3.5 0 0 0 -1 box4-1.dat
  [1,16,0,0,-5.25,2.5,0,0,0,-3.5,0,0,0,-1, ldraw_lib__box4_1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 5.25 2.5 0 0 0 -3.5 0 0 0 1 box4-1.dat
  [1,16,0,0,5.25,2.5,0,0,0,-3.5,0,0,0,1, ldraw_lib__box4_1(realsolid)],
...
// 1 16 3.75 0 0 0 0 1.25 0 1 0 -4.25 0 0 recte3.dat
  [1,16,3.75,0,0,0,0,1.25,0,1,0,-4.25,0,0, ldraw_lib__recte3(realsolid)],
// 1 16 -3.75 0 0 0 0 -1.25 0 1 0 -4.25 0 0 recte3.dat
  [1,16,-3.75,0,0,0,0,-1.25,0,1,0,-4.25,0,0, ldraw_lib__recte3(realsolid)],
// 
...
// 1 16 0 0 0 7.391 0 -3.0615 0 -5 0 3.0615 0 7.391 1-8cylo.dat
  [1,16,0,0,0,7.391,0,-3.0615,0,-5,0,3.0615,0,7.391, ldraw_lib__1_8cylo(realsolid)],
...
// 1 16 7.6331 -2.5 1.8451 -0.2419 -1 0 0 0 -2.5 1.2165 0 0 rect2p.dat
  [1,16,7.6331,-2.5,1.8451,-0.2419,-1,0,0,0,-2.5,1.2165,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 7.8125 -2.5 0.3143 0.0625 -1 0 0 0 -2.5 0.3143 0 0 rect2p.dat
  [1,16,7.8125,-2.5,0.3143,0.0625,-1,0,0,0,-2.5,0.3143,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 0 0 7.391 0 -3.0615 0 -4 0 -3.0615 0 -7.391 1-8chrd.dat
  [1,16,0,0,0,7.391,0,-3.0615,0,-4,0,-3.0615,0,-7.391, ldraw_lib__1_8chrd(realsolid)],
...
// 1 16 15 -2.5 -3.3488 0 1 0 0 0 -2.5 -1.1512 0 0 rect2p.dat
  [1,16,15,-2.5,-3.3488,0,1,0,0,0,-2.5,-1.1512,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 15.2228 -2.5 -1.8642 0 1 -0.2228 2.5 0 0 0 0 -0.3334 rect3.dat
  [1,16,15.2228,-2.5,-1.8642,0,1,-0.2228,2.5,0,0,0,0,-0.3334, ldraw_lib__rect3(realsolid)],
...
// 1 16 11.75 0 0 3.6955 0 1.5307 0 -5 0 -1.5307 0 3.6955 1-8cylo.dat
  [1,16,11.75,0,0,3.6955,0,1.5307,0,-5,0,-1.5307,0,3.6955, ldraw_lib__1_8cylo(realsolid)],
// 5 24 15.4456 0 1.5308 15.4456 -5 1.5308 15.75 0 0 14.5784 0 2.8284
  [5,24,15.4456,0,1.5308,15.4456,-5,1.5308,15.75,0,0,14.5784,0,2.8284],
// 1 16 15.2228 -2.5 1.8642 0 1 -0.2228 2.5 0 0 0 0 0.3334 rect3.dat
  [1,16,15.2228,-2.5,1.8642,0,1,-0.2228,2.5,0,0,0,0,0.3334, ldraw_lib__rect3(realsolid)],
...
// 1 16 11.75 0 0 4 0 0 0 -4 0 0 0 4 1-16ndis.dat
  [1,16,11.75,0,0,4,0,0,0,-4,0,0,0,4, ldraw_lib__1_16ndis(realsolid)],
// 1 16 11.75 0 0 4 0 0 0 -4 0 0 0 -4 1-16ndis.dat
  [1,16,11.75,0,0,4,0,0,0,-4,0,0,0,-4, ldraw_lib__1_16ndis(realsolid)],
// 
// 1 16 -17 0 -4.5 2 0 0 0 -5 0 0 0 -2.25 1-4cylc.dat
...
// 1 16 11.75 -5 0 3.6955 0 1.5307 0 -1 0 -1.5307 0 3.6955 1-8chrd.dat
  [1,16,11.75,-5,0,3.6955,0,1.5307,0,-1,0,-1.5307,0,3.6955, ldraw_lib__1_8chrd(realsolid)],
...
// 1 16 17.5 -7 10.25 0.5 -1 0 1 0 0 0 0 3.5 rect.dat
  [1,16,17.5,-7,10.25,0.5,-1,0,1,0,0,0,0,3.5, ldraw_lib__rect(realsolid)],
...
// 1 16 17 -11.5 5 0 -1 0 0 0 -1.5 -1.75 0 0 rect2a.dat
  [1,16,17,-11.5,5,0,-1,0,0,0,-1.5,-1.75,0,0, ldraw_lib__rect2a(realsolid)],
...
// 1 16 17 -4 0 0 -1 0 0 0 4 6.75 0 0 rect3.dat
  [1,16,17,-4,0,0,-1,0,0,0,4,6.75,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 11 -11.5 -3.25 0 0 6 -1.5 0 0 0 -1 0 rect1.dat
  [1,16,11,-11.5,-3.25,0,0,6,-1.5,0,0,0,-1,0, ldraw_lib__rect1(realsolid)],
// 1 16 11 -11.5 3.25 0 0 6 -1.5 0 0 0 1 0 rect1.dat
  [1,16,11,-11.5,3.25,0,0,6,-1.5,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
// 1 16 -11 -11.5 -3.25 0 0 6 -1.5 0 0 0 -1 0 rect1.dat
  [1,16,-11,-11.5,-3.25,0,0,6,-1.5,0,0,0,-1,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 11 -10 0 0 0 6 0 1 0 3.25 0 0 recte3.dat
  [1,16,11,-10,0,0,0,6,0,1,0,3.25,0,0, ldraw_lib__recte3(realsolid)],
// 1 16 -11 -10 0 0 0 -6 0 1 0 3.25 0 0 recte3.dat
  [1,16,-11,-10,0,0,0,-6,0,1,0,3.25,0,0, ldraw_lib__recte3(realsolid)],
// 
...
// 1 16 11.75 -5 1.5 3 0 0 0 -5 0 0 0 0.5 box4.dat
  [1,16,11.75,-5,1.5,3,0,0,0,-5,0,0,0,0.5, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 11.75 -5 -1.5 3 0 0 0 -5 0 0 0 0.5 box4.dat
  [1,16,11.75,-5,-1.5,3,0,0,0,-5,0,0,0,0.5, ldraw_lib__box4(realsolid)],
...
// 1 16 -6 -10.75 0 0 -10 0 0.75 0 0.75 -0.5 0 0.5 tri4.dat
  [1,16,-6,-10.75,0,0,-10,0,0.75,0,0.75,-0.5,0,0.5, ldraw_lib__tri4(realsolid)],
// 1 16 6 -10.75 0 0 10 0 0.75 0 0.75 -0.5 0 0.5 tri4.dat
  [1,16,6,-10.75,0,0,10,0,0.75,0,0.75,-0.5,0,0.5, ldraw_lib__tri4(realsolid)],
];
module ldraw_lib__s__2727s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2727s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
