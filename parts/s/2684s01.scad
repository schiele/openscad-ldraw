...
use <../u9075.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2684s01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 u9075.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9075(realsolid)],
// 1 494 0 -0.5 0 -2.5 0 0 0 -6.5 0 0 0 2.5 4-4cylc.dat
  [1,494,0,-0.5,0,-2.5,0,0,0,-6.5,0,0,0,2.5, ldraw_lib__4_4cylc(realsolid)],
];
module ldraw_lib__s__2684s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2684s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
