...
use <../../p/2-4chrd.scad>
use <35446s02.scad>
function ldraw_lib__s__35446s01() = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\35446s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__35446s02()],
// 1 16 0 0.5 70 5.625 0 0 0 1 0 0 0 5.625 2-4chrd.dat
  [1,16,0,0.5,70,5.625,0,0,0,1,0,0,0,5.625, ldraw_lib__2_4chrd()],
...
module ldraw_lib__s__35446s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__35446s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
