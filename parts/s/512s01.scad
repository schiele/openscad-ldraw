...
use <../../p/tri3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__512s01(realsolid=false) = [
...
// 1 16 -22 -12 0 0 0 -2 0 -12 0 24 0 0 box2-5.dat
  [1,16,-22,-12,0,0,0,-2,0,-12,0,24,0,0, ldraw_lib__box2_5(realsolid)],
// 1 16 24 -2.5 17 0 -1 0 0 0 2.5 7 0 0 rect.dat
  [1,16,24,-2.5,17,0,-1,0,0,0,2.5,7,0,0, ldraw_lib__rect(realsolid)],
// 1 16 24 -2.5 -17 0 -1 0 0 0 2.5 7 0 0 rect.dat
  [1,16,24,-2.5,-17,0,-1,0,0,0,2.5,7,0,0, ldraw_lib__rect(realsolid)],
// 1 16 20 -2.5 13 0 1 0 0 0 2.5 7 0 0 rect.dat
  [1,16,20,-2.5,13,0,1,0,0,0,2.5,7,0,0, ldraw_lib__rect(realsolid)],
// 1 16 20 -2.5 -13 0 1 0 0 0 2.5 7 0 0 rect.dat
  [1,16,20,-2.5,-13,0,1,0,0,0,2.5,7,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 25.5 2 0 0 -51 0 2 0 0 0 0 30 box3u2p.dat
  [1,16,25.5,2,0,0,-51,0,2,0,0,0,0,30, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 0 11.5 0 0 0 -8 0 1 3.5 8 0 0 4-4edge.dat
  [1,16,0,11.5,0,0,0,-8,0,1,3.5,8,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 11.5 0 0 0 -6 0 1 2.625 6 0 0 4-4edge.dat
  [1,16,0,11.5,0,0,0,-6,0,1,2.625,6,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 4 0 0 0 -8 0 4 0 8 0 0 4-4cyli.dat
  [1,16,0,4,0,0,0,-8,0,4,0,8,0,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 8 0 8 0 0 0 3.5 0 0 0 8 2-4cyls.dat
  [1,16,0,8,0,8,0,0,0,3.5,0,0,0,8, ldraw_lib__2_4cyls(realsolid)],
// 1 16 0 8 0 8 0 0 0 3.5 0 0 0 -8 2-4cyls.dat
  [1,16,0,8,0,8,0,0,0,3.5,0,0,0,-8, ldraw_lib__2_4cyls(realsolid)],
// 1 16 0 11.5 0 0 0 -2 0 -1 .875 2 0 0 4-4ring3.dat
  [1,16,0,11.5,0,0,0,-2,0,-1,.875,2,0,0, ldraw_lib__4_4ring3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 0 0 -6 0 8.875 0 6 0 0 4-4cyli.dat
  [1,16,0,0,0,0,0,-6,0,8.875,0,6,0,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8.875 0 6 0 0 0 2.625 0 0 0 6 2-4cyls.dat
  [1,16,0,8.875,0,6,0,0,0,2.625,0,0,0,6, ldraw_lib__2_4cyls(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8.875 0 6 0 0 0 2.625 0 0 0 -6 2-4cyls.dat
  [1,16,0,8.875,0,6,0,0,0,2.625,0,0,0,-6, ldraw_lib__2_4cyls(realsolid)],
...
// 1 16 118 -1 0 0 -1 0 0 0 4 10 0 0 rect.dat
  [1,16,118,-1,0,0,-1,0,0,0,4,10,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 106 -1 0 0 8 0 4 0 0 0 0 6 box3u2p.dat
  [1,16,106,-1,0,0,8,0,4,0,0,0,0,6, ldraw_lib__box3u2p(realsolid)],
// 1 16 103 -1 -3 0 -1 -3 4 0 0 0 0 3 rect3.dat
  [1,16,103,-1,-3,0,-1,-3,4,0,0,0,0,3, ldraw_lib__rect3(realsolid)],
// 1 16 103 -1 3 3 -1 0 0 0 4 3 0 0 rect2p.dat
  [1,16,103,-1,3,3,-1,0,0,0,4,3,0,0, ldraw_lib__rect2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 98 -5 2 -4 0 4 0 8 0 4 0 4 tri3.dat
  [1,16,98,-5,2,-4,0,4,0,8,0,4,0,4, ldraw_lib__tri3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 98 -5 -2 4 0 -4 0 8 0 -4 0 -4 tri3.dat
  [1,16,98,-5,-2,4,0,-4,0,8,0,-4,0,-4, ldraw_lib__tri3(realsolid)],
// 1 16 93 -1 -3 0 1 3 4 0 0 0 0 3 rect3.dat
  [1,16,93,-1,-3,0,1,3,4,0,0,0,0,3, ldraw_lib__rect3(realsolid)],
// 1 16 93 -1 3 -3 1 0 0 0 4 3 0 0 rect2p.dat
  [1,16,93,-1,3,-3,1,0,0,0,4,3,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 88 -1 -6 0 0 -2 4 0 0 0 -1 0 rect.dat
  [1,16,88,-1,-6,0,0,-2,4,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 88 -1 6 0 0 -2 4 0 0 0 1 0 rect.dat
  [1,16,88,-1,6,0,0,-2,4,0,0,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 83 -1 -3 0 -1 -3 4 0 0 0 0 3 rect3.dat
  [1,16,83,-1,-3,0,-1,-3,4,0,0,0,0,3, ldraw_lib__rect3(realsolid)],
// 1 16 83 -1 3 3 -1 0 0 0 4 3 0 0 rect2p.dat
  [1,16,83,-1,3,3,-1,0,0,0,4,3,0,0, ldraw_lib__rect2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 78 -5 2 -4 0 4 0 8 0 4 0 4 tri3.dat
  [1,16,78,-5,2,-4,0,4,0,8,0,4,0,4, ldraw_lib__tri3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 78 -5 -2 4 0 -4 0 8 0 -4 0 -4 tri3.dat
  [1,16,78,-5,-2,4,0,-4,0,8,0,-4,0,-4, ldraw_lib__tri3(realsolid)],
...
// 1 16 68 -2.5 -6 0 0 -2 2.5 0 0 0 -1 0 rect.dat
  [1,16,68,-2.5,-6,0,0,-2,2.5,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 68 -2.5 6 0 0 -2 2.5 0 0 0 1 0 rect.dat
  [1,16,68,-2.5,6,0,0,-2,2.5,0,0,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 63 -2.5 -3 0 -1 -3 2.5 0 0 0 0 3 rect3.dat
  [1,16,63,-2.5,-3,0,-1,-3,2.5,0,0,0,0,3, ldraw_lib__rect3(realsolid)],
// 1 16 63 -2.5 3 3 -1 0 0 0 2.5 3 0 0 rect2p.dat
  [1,16,63,-2.5,3,3,-1,0,0,0,2.5,3,0,0, ldraw_lib__rect2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 58 -5 2 -4 0 4 0 5 0 4 0 4 tri3.dat
  [1,16,58,-5,2,-4,0,4,0,5,0,4,0,4, ldraw_lib__tri3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 58 -5 -2 4 0 -4 0 5 0 -4 0 -4 tri3.dat
  [1,16,58,-5,-2,4,0,-4,0,5,0,-4,0,-4, ldraw_lib__tri3(realsolid)],
// 1 16 53 -2.5 -3 0 1 3 2.5 0 0 0 0 3 rect3.dat
  [1,16,53,-2.5,-3,0,1,3,2.5,0,0,0,0,3, ldraw_lib__rect3(realsolid)],
// 1 16 53 -2.5 3 -3 1 0 0 0 2.5 3 0 0 rect2p.dat
  [1,16,53,-2.5,3,-3,1,0,0,0,2.5,3,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 48 -2.5 -6 0 0 -2 2.5 0 0 0 -1 0 rect.dat
  [1,16,48,-2.5,-6,0,0,-2,2.5,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 48 -2.5 6 0 0 -2 2.5 0 0 0 1 0 rect.dat
  [1,16,48,-2.5,6,0,0,-2,2.5,0,0,0,1,0, ldraw_lib__rect(realsolid)],
...
// 1 16 38 -5 2 -4 0 4 0 8 0 4 0 4 tri3.dat
  [1,16,38,-5,2,-4,0,4,0,8,0,4,0,4, ldraw_lib__tri3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 38 -5 -2 4 0 -4 0 8 0 -4 0 -4 tri3.dat
  [1,16,38,-5,-2,4,0,-4,0,8,0,-4,0,-4, ldraw_lib__tri3(realsolid)],
// 1 16 33 -1 -3 0 1 3 4 0 0 0 0 3 rect.dat
  [1,16,33,-1,-3,0,1,3,4,0,0,0,0,3, ldraw_lib__rect(realsolid)],
// 1 16 33 -1 3 0 1 -3 4 0 0 0 0 3 rect3.dat
  [1,16,33,-1,3,0,1,-3,4,0,0,0,0,3, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__s__512s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__512s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
