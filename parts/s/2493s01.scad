...
use <../../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2493s01(realsolid=false) = [
...
// 1 16 40 60 0 0 -1 0 60 0 0 0 0 10 rect.dat
  [1,16,40,60,0,0,-1,0,60,0,0,0,0,10, ldraw_lib__rect(realsolid)],
// 1 16 -40 60 0 0 1 0 60 0 0 0 0 -10 rect.dat
  [1,16,-40,60,0,0,1,0,60,0,0,0,0,-10, ldraw_lib__rect(realsolid)],
// 1 16 36 58 2 0 1 0 54 0 0 0 0 -8 rect.dat
  [1,16,36,58,2,0,1,0,54,0,0,0,0,-8, ldraw_lib__rect(realsolid)],
// 1 16 -36 58 2 0 -1 0 54 0 0 0 0 8 rect.dat
  [1,16,-36,58,2,0,-1,0,54,0,0,0,0,8, ldraw_lib__rect(realsolid)],
// 1 16 -20 0 -4 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,-20,0,-4,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 20 0 -4 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,20,0,-4,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 20 0 -4 2 0 0 0 1 0 0 0 2 4-4ndis.dat
  [1,16,20,0,-4,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -20 0 -4 2 0 0 0 1 0 0 0 2 4-4ndis.dat
  [1,16,-20,0,-4,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 20 4 -4 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,20,4,-4,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 -20 4 -4 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,-20,4,-4,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -20 0 -4 2 0 0 0 4 0 0 0 2 4-4cyli.dat
  [1,16,-20,0,-4,2,0,0,0,4,0,0,0,2, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 0 -4 2 0 0 0 4 0 0 0 2 4-4cyli.dat
  [1,16,20,0,-4,2,0,0,0,4,0,0,0,2, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -20 112 -4 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,-20,112,-4,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 20 112 -4 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,20,112,-4,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 -20 116 -4 2 0 0 0 -1 0 0 0 -2 4-4ndis.dat
  [1,16,-20,116,-4,2,0,0,0,-1,0,0,0,-2, ldraw_lib__4_4ndis(realsolid)],
// 1 16 20 116 -4 2 0 0 0 -1 0 0 0 -2 4-4ndis.dat
  [1,16,20,116,-4,2,0,0,0,-1,0,0,0,-2, ldraw_lib__4_4ndis(realsolid)],
// 1 16 20 116 -4 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,20,116,-4,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 -20 116 -4 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,-20,116,-4,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -20 112 -4 2 0 0 0 4 0 0 0 2 4-4cyli.dat
  [1,16,-20,112,-4,2,0,0,0,4,0,0,0,2, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 112 -4 2 0 0 0 4 0 0 0 2 4-4cyli.dat
  [1,16,20,112,-4,2,0,0,0,4,0,0,0,2, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 116 0 0 0 -36 0 4 0 6 0 0 box4o4a.dat
  [1,16,0,116,0,0,0,-36,0,4,0,6,0,0, ldraw_lib__box4o4a(realsolid)],
// 1 16 -24 118 4.5 0 -1 0 -2 0 0 0 0 -1.5 rect.dat
  [1,16,-24,118,4.5,0,-1,0,-2,0,0,0,0,-1.5, ldraw_lib__rect(realsolid)],
// 1 16 -25.5 118 4.5 0 0.707107 -1.50013 -2 0 0 0 0.707107 1.50013 rect.dat
  [1,16,-25.5,118,4.5,0,0.707107,-1.50013,-2,0,0,0,0.707107,1.50013, ldraw_lib__rect(realsolid)],
// 3 16 -27 120 6 -24 120 6 -24 120 3
  [3,16,-27,120,6,-24,120,6,-24,120,3],
// 1 16 16 118 4.5 0 -1 0 -2 0 0 0 0 -1.5 rect.dat
  [1,16,16,118,4.5,0,-1,0,-2,0,0,0,0,-1.5, ldraw_lib__rect(realsolid)],
// 1 16 14.5 118 4.5 0 0.707107 -1.50013 -2 0 0 0 0.707107 1.50013 rect.dat
  [1,16,14.5,118,4.5,0,0.707107,-1.50013,-2,0,0,0,0.707107,1.50013, ldraw_lib__rect(realsolid)],
...
module ldraw_lib__s__2493s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2493s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
