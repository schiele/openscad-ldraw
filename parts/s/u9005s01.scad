...
use <../../p/box4-7a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__u9005s01(realsolid=false) = [
...
// 1 494 -30 12.5 -2 25 0 0 0 0 2.5 0 -20 0 box4-7a.dat
  [1,494,-30,12.5,-2,25,0,0,0,0,2.5,0,-20,0, ldraw_lib__box4_7a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 494 -30 7.5 -2 25 0 0 0 0 -2.5 0 -20 0 box4-7a.dat
  [1,494,-30,7.5,-2,25,0,0,0,0,-2.5,0,-20,0, ldraw_lib__box4_7a(realsolid)],
...
module ldraw_lib__s__u9005s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u9005s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
