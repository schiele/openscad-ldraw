...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3815s01(realsolid=false) = [
...
// 1 16 0 3 0 18 0 0 0 -3 0 0 0 10 box2-5.dat
  [1,16,0,3,0,18,0,0,0,-3,0,0,0,10, ldraw_lib__box2_5(realsolid)],
...
// 1 16 -2 12 0 0 4 0 8.3149 0 3.4441 -3.4441 0 8.3149 7-16cyli.dat
  [1,16,-2,12,0,0,4,0,8.3149,0,3.4441,-3.4441,0,8.3149, ldraw_lib__7_16cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -18 12 0 0 36 0 -6.364 0 -6.364 6.364 0 -6.364 1-4cylo.dat
  [1,16,-18,12,0,0,36,0,-6.364,0,-6.364,6.364,0,-6.364, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -18 12 0 0 1 0 -9 0 0 0 0 -9 1-8ndis.dat
  [1,16,-18,12,0,0,1,0,-9,0,0,0,0,-9, ldraw_lib__1_8ndis(realsolid)],
// 1 16 -18 12 0 0 1 0 -9 0 0 0 0 9 1-8ndis.dat
  [1,16,-18,12,0,0,1,0,-9,0,0,0,0,9, ldraw_lib__1_8ndis(realsolid)],
// 1 16 18 12 0 0 -1 0 -9 0 0 0 0 -9 1-8ndis.dat
  [1,16,18,12,0,0,-1,0,-9,0,0,0,0,-9, ldraw_lib__1_8ndis(realsolid)],
...
// 1 16 -2 12 0 0 1 0 9 0 0 0 0 9 4-4edge.dat
  [1,16,-2,12,0,0,1,0,9,0,0,0,0,9, ldraw_lib__4_4edge(realsolid)],
// 1 16 2 12 0 0 1 0 9 0 0 0 0 9 4-4edge.dat
  [1,16,2,12,0,0,1,0,9,0,0,0,0,9, ldraw_lib__4_4edge(realsolid)],
// 1 16 -2 12 0 0 1 0 9 0 0 0 0 -9 4-4disc.dat
  [1,16,-2,12,0,0,1,0,9,0,0,0,0,-9, ldraw_lib__4_4disc(realsolid)],
// 1 16 2 12 0 0 -1 0 9 0 0 0 0 9 4-4disc.dat
  [1,16,2,12,0,0,-1,0,9,0,0,0,0,9, ldraw_lib__4_4disc(realsolid)],
// 1 16 -9.92 12 0 0 19.84 0 3 0 0 0 0 3 4-4cylc.dat
  [1,16,-9.92,12,0,0,19.84,0,3,0,0,0,0,3, ldraw_lib__4_4cylc(realsolid)],
// 1 16 9.92 12 0 0 -1 0 3 0 0 0 0 3 4-4disc.dat
  [1,16,9.92,12,0,0,-1,0,3,0,0,0,0,3, ldraw_lib__4_4disc(realsolid)],
// 1 16 -2 12 0 0 1 0 3 0 0 0 0 3 4-4edge.dat
  [1,16,-2,12,0,0,1,0,3,0,0,0,0,3, ldraw_lib__4_4edge(realsolid)],
// 1 16 2 12 0 0 1 0 3 0 0 0 0 3 4-4edge.dat
  [1,16,2,12,0,0,1,0,3,0,0,0,0,3, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 6 -8.3035 0 0 18 0 -1 0 1.6965 0 0 rect.dat
  [1,16,0,6,-8.3035,0,0,18,0,-1,0,1.6965,0,0, ldraw_lib__rect(realsolid)],
// 1 16 0 5.818 -6.4855 0 0 18 -.182 -1 0 .1215 0 0 rect2p.dat
  [1,16,0,5.818,-6.4855,0,0,18,-.182,-1,0,.1215,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 6 8.3035 18 0 0 0 -1 0 0 0 -1.6965 rect3.dat
  [1,16,0,6,8.3035,18,0,0,0,-1,0,0,0,-1.6965, ldraw_lib__rect3(realsolid)],
// 1 16 0 5.818 6.4855 0 0 -18 -.182 -1 0 -.1215 0 0 rect2p.dat
  [1,16,0,5.818,6.4855,0,0,-18,-.182,-1,0,-.1215,0,0, ldraw_lib__rect2p(realsolid)],
// 
...
module ldraw_lib__s__3815s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3815s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
