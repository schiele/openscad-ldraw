...
use <../../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__16709s02(realsolid=false) = [
...
// 1 16 18.5209 12.5 3 -0.10415 -1 0 -2.5 0 0 0 0 -7 rect2p.dat
  [1,16,18.5209,12.5,3,-0.10415,-1,0,-2.5,0,0,0,0,-7, ldraw_lib__rect2p(realsolid)],
// 4 16 18.6253 15 -4 18.4168 10 -4 1 10 -4 1 15 -4
  [4,16,18.6253,15,-4,18.4168,10,-4,1,10,-4,1,15,-4],
// 1 16 1 12.5 3 0 1 0 -2.5 0 0 0 0 7 rect2p.dat
  [1,16,1,12.5,3,0,1,0,-2.5,0,0,0,0,7, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__s__16709s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__16709s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
