...
use <../../p/stud4f4n.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__30072s01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 -5 0 0 0 1 stud4f4n.dat
  [1,16,0,0,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4f4n(realsolid)],
// 1 16 0 0 0 6 0 0 0 -5 0 0 0 6 4-4edge.dat
  [1,16,0,0,0,6,0,0,0,-5,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 14 0 0 6 0 0 0 20 0 0 0 1 box3u8p.dat
  [1,16,14,0,0,6,0,0,0,20,0,0,0,1, ldraw_lib__box3u8p(realsolid)],
// 1 16 0 0 14 0 0 -1 0 20 0 6 0 0 box3u8p.dat
  [1,16,0,0,14,0,0,-1,0,20,0,6,0,0, ldraw_lib__box3u8p(realsolid)],
// 1 16 -14 0 0 -6 0 0 0 20 0 0 0 -1 box3u8p.dat
  [1,16,-14,0,0,-6,0,0,0,20,0,0,0,-1, ldraw_lib__box3u8p(realsolid)],
// 1 16 0 0 -14 0 0 1 0 20 0 -6 0 0 box3u8p.dat
  [1,16,0,0,-14,0,0,1,0,20,0,-6,0,0, ldraw_lib__box3u8p(realsolid)],
...
module ldraw_lib__s__30072s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__30072s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
