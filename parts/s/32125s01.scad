...
$fa=1; $fs=0.2;
function ldraw_lib__s__32125s01(realsolid=false) = [
...
// 1 16 0 0 30 0 0 -1 0 1 0 1 0 0 stug2-1x2.dat
  [1,16,0,0,30,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug2_1x2(realsolid)],
// 1 16 0 3 30 1 0 0 0 -1.25 0 0 0 1 stud3.dat
  [1,16,0,3,30,1,0,0,0,-1.25,0,0,0,1, ldraw_lib__stud3(realsolid)],
// 1 16 0 8 26 0 0 10 0 -8 0 14 0 0 box3u8p.dat
  [1,16,0,8,26,0,0,10,0,-8,0,14,0,0, ldraw_lib__box3u8p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 27 0 0 6 0 -5 0 13 0 0 box3u8p.dat
  [1,16,0,8,27,0,0,6,0,-5,0,13,0,0, ldraw_lib__box3u8p(realsolid)],
// 1 16 0 3 12.5 6 0 0 0 5 0 0 0 1.5 box3u4p.dat
  [1,16,0,3,12.5,6,0,0,0,5,0,0,0,1.5, ldraw_lib__box3u4p(realsolid)],
// 1 16 0 0 40 10 0 0 0 8 0 0 0 10 2-4cylc.dat
  [1,16,0,0,40,10,0,0,0,8,0,0,0,10, ldraw_lib__2_4cylc(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 3 40 6 0 0 0 5 0 0 0 6 2-4cylc.dat
  [1,16,0,3,40,6,0,0,0,5,0,0,0,6, ldraw_lib__2_4cylc(realsolid)],
// 1 16 0 8 40 2 0 0 0 -1 0 0 0 2 2-4ring3.dat
  [1,16,0,8,40,2,0,0,0,-1,0,0,0,2, ldraw_lib__2_4ring3(realsolid)],
// 1 16 0 8 40 2 0 0 0 -1 0 0 0 2 2-4ring4.dat
  [1,16,0,8,40,2,0,0,0,-1,0,0,0,2, ldraw_lib__2_4ring4(realsolid)],
// 1 16 10 4 8.88675 0 -1 0 -4 0 0 0 0 -3.11325 rect3.dat
  [1,16,10,4,8.88675,0,-1,0,-4,0,0,0,0,-3.11325, ldraw_lib__rect3(realsolid)],
// 1 16 -10 4 8.88675 0 1 0 0 0 -4 -3.11325 0 0 rect2p.dat
  [1,16,-10,4,8.88675,0,1,0,0,0,-4,-3.11325,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 6 5.5 8.5104 0 1 0 2.5 0 0 0 0 -2.4896 rect3.dat
  [1,16,6,5.5,8.5104,0,1,0,2.5,0,0,0,0,-2.4896, ldraw_lib__rect3(realsolid)],
// 1 16 -6 5.5 8.5104 0 -1 0 -2.5 0 0 0 0 -2.4896 rect3.dat
  [1,16,-6,5.5,8.5104,0,-1,0,-2.5,0,0,0,0,-2.4896, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__s__32125s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__32125s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
