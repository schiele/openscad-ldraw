...
use <../../p/1-4cyli.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__6009254es03(realsolid=false) = [
...
// 1 16 -6 0 15 0 0 -2 0 -1 0 2 0 0 1-4chrd.dat
  [1,16,-6,0,15,0,0,-2,0,-1,0,2,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 6 0 15 2 0 0 0 -1 0 0 0 2 1-4chrd.dat
  [1,16,6,0,15,2,0,0,0,-1,0,0,0,2, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -6 0 -15 -2 0 0 0 -1 0 0 0 -2 1-4chrd.dat
  [1,16,-6,0,-15,-2,0,0,0,-1,0,0,0,-2, ldraw_lib__1_4chrd(realsolid)],
// 1 16 6 0 -15 0 0 2 0 -1 0 -2 0 0 1-4chrd.dat
  [1,16,6,0,-15,0,0,2,0,-1,0,-2,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -6 -0.25 15 0 0 -2 0 0.25 0 2 0 0 1-4cyli.dat
  [1,16,-6,-0.25,15,0,0,-2,0,0.25,0,2,0,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 6 -0.25 15 2 0 0 0 0.25 0 0 0 2 1-4cyli.dat
  [1,16,6,-0.25,15,2,0,0,0,0.25,0,0,0,2, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -6 -0.25 -15 -2 0 0 0 0.25 0 0 0 -2 1-4cyli.dat
  [1,16,-6,-0.25,-15,-2,0,0,0,0.25,0,0,0,-2, ldraw_lib__1_4cyli(realsolid)],
// 1 16 6 -0.25 -15 0 0 2 0 0.25 0 -2 0 0 1-4cyli.dat
  [1,16,6,-0.25,-15,0,0,2,0,0.25,0,-2,0,0, ldraw_lib__1_4cyli(realsolid)],
...
module ldraw_lib__s__6009254es03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6009254es03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
