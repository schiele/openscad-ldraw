use <../../lib.scad>
use <../../p/3-8chrd.scad>
function ldraw_lib__s__4186p01l() = [
...
// 1 16 0 -4 0 2.298 0 5.545 0 1 0 -5.545 0 2.298 3-8chrd.dat
  [1,16,0,-4,0,2.298,0,5.545,0,1,0,-5.545,0,2.298, ldraw_lib__3_8chrd()],
...
module ldraw_lib__s__4186p01l(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__4186p01l(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
