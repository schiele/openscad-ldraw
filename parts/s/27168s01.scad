...
use <../../p/recte3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__27168s01(realsolid=false) = [
...
// 1 16 10 12 -20 4 0 0 0 0 -4 0 1 0 recte3.dat
  [1,16,10,12,-20,4,0,0,0,0,-4,0,1,0, ldraw_lib__recte3(realsolid)],
// 4 16 20 16 -20 20 4 -20 14 8 -20 14 16 -20
  [4,16,20,16,-20,20,4,-20,14,8,-20,14,16,-20],
// 1 16 10 8 -30 1 0 0 0 1 0 0 0 1 clip6.dat
  [1,16,10,8,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__clip6(realsolid)],
// 
// 1 16 40 -44 0 0 -1 0 0 0 -4 4 0 0 4-4edge.dat
  [1,16,40,-44,0,0,-1,0,0,0,-4,4,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 40 -44 0 0 2 0 0 0 -4 4 0 0 4-4cyli.dat
  [1,16,40,-44,0,0,2,0,0,0,-4,4,0,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 50 -44 0 0 4 0 0 0 4 4 0 0 4-4cyl1sph2.dat
  [1,16,50,-44,0,0,4,0,0,0,4,4,0,0, ldraw_lib__4_4cyl1sph2(realsolid)],
// 1 16 50 -44 0 0 0 -8 0 8 0 8 0 0 8-8sphe.dat
  [1,16,50,-44,0,0,0,-8,0,8,0,8,0,0, ldraw_lib__8_8sphe(realsolid)],
// 
...
// 1 16 20 0 24 0 0 4 4 0 0 0 -1 0 8\1-4chrd.dat
  [1,16,20,0,24,0,0,4,4,0,0,0,-1,0, ldraw_lib__8__1_4chrd(realsolid)],
...
// 1 16 20 0 -20 0 0 4 4 0 0 0 1 0 8\1-4disc.dat
  [1,16,20,0,-20,0,0,4,4,0,0,0,1,0, ldraw_lib__8__1_4disc(realsolid)],
...
// 1 16 20 0 24 0 0 4 4 0 0 0 -20 0 8\1-4cylo.dat
  [1,16,20,0,24,0,0,4,4,0,0,0,-20,0, ldraw_lib__8__1_4cylo(realsolid)],
// 1 16 20 0 -4 0 0 4 4 0 0 0 -16 0 8\1-4cylo.dat
  [1,16,20,0,-4,0,0,4,4,0,0,0,-16,0, ldraw_lib__8__1_4cylo(realsolid)],
...
// 1 16 24 8 0 0 0 4 0 -8 0 4 0 0 2-4cylc.dat
  [1,16,24,8,0,0,0,4,0,-8,0,4,0,0, ldraw_lib__2_4cylc(realsolid)],
// 1 16 24 0 0 0 0 8 0 -6 0 8 0 0 2-4cyli.dat
  [1,16,24,0,0,0,0,8,0,-6,0,8,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 24 0 0 0 0 4 0 -1 0 4 0 0 2-4ring1.dat
  [1,16,24,0,0,0,0,4,0,-1,0,4,0,0, ldraw_lib__2_4ring1(realsolid)],
// 1 16 24 0 0 0 0 8 0 -1 0 8 0 0 2-4edge.dat
  [1,16,24,0,0,0,0,8,0,-1,0,8,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 24 -6 0 0 0 8 0 -1 -10 8 0 0 2-4edge.dat
  [1,16,24,-6,0,0,0,8,0,-1,-10,8,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 24 -6 0 -8 0 0 0 -10 0 0 0 8 1-4cyls2.dat
  [1,16,24,-6,0,-8,0,0,0,-10,0,0,0,8, ldraw_lib__1_4cyls2(realsolid)],
// 1 16 24 -6 0 -8 0 0 0 -10 0 0 0 -8 1-4cyls2.dat
  [1,16,24,-6,0,-8,0,0,0,-10,0,0,0,-8, ldraw_lib__1_4cyls2(realsolid)],
// 1 16 20 0 4 0 0 4 4 0 0 0 -1 0 8\1-4ndis.dat
  [1,16,20,0,4,0,0,4,4,0,0,0,-1,0, ldraw_lib__8__1_4ndis(realsolid)],
// 1 16 20 0 -4 0 0 4 4 0 0 0 1 0 8\1-4ndis.dat
  [1,16,20,0,-4,0,0,4,4,0,0,0,1,0, ldraw_lib__8__1_4ndis(realsolid)],
// 1 16 22 4 0 2 0 0 0 4 0 0 0 4 box3u7a.dat
  [1,16,22,4,0,2,0,0,0,4,0,0,0,4, ldraw_lib__box3u7a(realsolid)],
// 2 24 24 -6 -8 24 0 -8
  [2,24,24,-6,-8,24,0,-8],
// 2 24 24 0 -8 24 0 -4
  [2,24,24,0,-8,24,0,-4],
...
// 1 16 24 -4 0 0 0 4 0 1 0 3 0 0 2-4edge.dat
  [1,16,24,-4,0,0,0,4,0,1,0,3,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 24 -13 0 0 0 4 0 -1 -5 3 0 0 2-4edge.dat
  [1,16,24,-13,0,0,0,4,0,-1,-5,3,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 24 -13 0 0 0 4 0 1 -5 3 0 0 2-4ndis.dat
  [1,16,24,-13,0,0,0,4,0,1,-5,3,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 24 -4 0 0 0 4 0 1 0 3 0 0 2-4chrd.dat
  [1,16,24,-4,0,0,0,4,0,1,0,3,0,0, ldraw_lib__2_4chrd(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 24 -4 0 0 0 4 0 -9 0 3 0 0 2-4cyli.dat
  [1,16,24,-4,0,0,0,4,0,-9,0,3,0,0, ldraw_lib__2_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 24 -13 0 -4 0 0 0 -5 0 0 0 3 1-4cyls2.dat
  [1,16,24,-13,0,-4,0,0,0,-5,0,0,0,3, ldraw_lib__1_4cyls2(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 24 -13 0 -4 0 0 0 -5 0 0 0 -3 1-4cyls2.dat
  [1,16,24,-13,0,-4,0,0,0,-5,0,0,0,-3, ldraw_lib__1_4cyls2(realsolid)],
...
// 1 16 22 -4 0 0 0 -2 0 1 0 3 0 0 rect3.dat
  [1,16,22,-4,0,0,0,-2,0,1,0,3,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 13.5 20 0 0 -1 -3.5 0 0 4 -2 0 0 rect.dat
  [1,16,13.5,20,0,0,-1,-3.5,0,0,4,-2,0,0, ldraw_lib__rect(realsolid)],
// 1 16 9.305 24 0 -0.695 0 0 0 -1 0 0 0 2 rect2p.dat
  [1,16,9.305,24,0,-0.695,0,0,0,-1,0,0,0,2, ldraw_lib__rect2p(realsolid)],
...
// 1 16 38.129284 -23.654399 12 -0.629321 0 0.777146 0.777146 0 0.629321 0 -24 0 8\2-4cyli.dat
  [1,16,38.129284,-23.654399,12,-0.629321,0,0.777146,0.777146,0,0.629321,0,-24,0, ldraw_lib__8__2_4cyli(realsolid)],
// 1 16 38.129284 -23.654399 12 -0.629321 0 0.777146 0.777146 0 0.629321 0 1 0 8\2-8sphe.dat
  [1,16,38.129284,-23.654399,12,-0.629321,0,0.777146,0.777146,0,0.629321,0,1,0, ldraw_lib__8__2_8sphe(realsolid)],
// 1 16 38.129284 -23.654399 -12 -0.629321 0 0.777146 0.777146 0 0.629321 0 -1 0 8\2-8sphe.dat
  [1,16,38.129284,-23.654399,-12,-0.629321,0,0.777146,0.777146,0,0.629321,0,-1,0, ldraw_lib__8__2_8sphe(realsolid)],
// 1 16 38.129284 -23.654399 12 -0.629321 -0.777146 0 0.777146 -0.629321 0 0 0 1 8\2-4edge.dat
  [1,16,38.129284,-23.654399,12,-0.629321,-0.777146,0,0.777146,-0.629321,0,0,0,1, ldraw_lib__8__2_4edge(realsolid)],
// 1 16 38.129284 -23.654399 -12 -0.629321 -0.777146 0 0.777146 -0.629321 0 0 0 -1 8\2-4edge.dat
  [1,16,38.129284,-23.654399,-12,-0.629321,-0.777146,0,0.777146,-0.629321,0,0,0,-1, ldraw_lib__8__2_4edge(realsolid)],
...
module ldraw_lib__s__27168s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__27168s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
