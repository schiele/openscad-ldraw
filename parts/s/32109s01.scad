...
use <../../p/3-8edge.scad>
use <../../p/3-8ring2.scad>
function ldraw_lib__s__32109s01() = [
...
// 1 16 0 2.09 0 6 0 0 0 1 0 0 0 6 2-4edge.dat
  [1,16,0,2.09,0,6,0,0,0,1,0,0,0,6, ldraw_lib__2_4edge()],
// 1 16 0 2.09 0 -9 0 0 0 1 0 0 0 9 3-8edge.dat
  [1,16,0,2.09,0,-9,0,0,0,1,0,0,0,9, ldraw_lib__3_8edge()],
// 1 16 0 .5 0 6 0 0 1.5 1 0 0 0 6 2-4edge.dat
  [1,16,0,.5,0,6,0,0,1.5,1,0,0,0,6, ldraw_lib__2_4edge()],
// 1 16 0 .5 0 -9 0 0 -2.25 1 0 0 0 9 3-8edge.dat
  [1,16,0,.5,0,-9,0,0,-2.25,1,0,0,0,9, ldraw_lib__3_8edge()],
// 1 16 0 .5 0 -3 0 0 -.75 1 0 0 0 3 3-8ring2.dat
  [1,16,0,.5,0,-3,0,0,-.75,1,0,0,0,3, ldraw_lib__3_8ring2()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 2 0 6 0 0 0 -1.5 0 0 0 6 2-4cyls.dat
  [1,16,0,2,0,6,0,0,0,-1.5,0,0,0,6, ldraw_lib__2_4cyls()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 2.09 0 6 0 0 0 -.09 0 0 0 6 2-4cyli.dat
  [1,16,0,2.09,0,6,0,0,0,-.09,0,0,0,6, ldraw_lib__2_4cyli()],
// 1 16 0 .5 0 6 0 0 1.5 1 0 0 0 6 1-8tndis.dat
  [1,16,0,.5,0,6,0,0,1.5,1,0,0,0,6, ldraw_lib__1_8tndis()],
...
// 1 16 0 2.09 0 9 0 0 0 -2.25 0 0 0 9 1-4cyls2.dat
  [1,16,0,2.09,0,9,0,0,0,-2.25,0,0,0,9, ldraw_lib__1_4cyls2()],
// 1 16 0 2.09 0 -9 0 0 -2.25 -1.59 0 0 0 9 3-8cyli.dat
  [1,16,0,2.09,0,-9,0,0,-2.25,-1.59,0,0,0,9, ldraw_lib__3_8cyli()],
];
module ldraw_lib__s__32109s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__32109s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
