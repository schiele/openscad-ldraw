...
use <47325s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__47325s03(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\47325s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__47325s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\47325s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__47325s02(realsolid)],
// 1 16 -20 0 0 0 40 0 -9 0 0 0 0 9 2-4cyli.dat
  [1,16,-20,0,0,0,40,0,-9,0,0,0,0,9, ldraw_lib__2_4cyli(realsolid)],
...
// 1 16 -17 0 0 0 34 0 -1 0 0 0 0 1 axl3hol8.dat
  [1,16,-17,0,0,0,34,0,-1,0,0,0,0,1, ldraw_lib__axl3hol8(realsolid)],
...
// 1 16 -0.5 0 0 0 1 0 -1 0 0 0 0 1 axl3hol9.dat
  [1,16,-0.5,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__axl3hol9(realsolid)],
// 1 16 0.5 0 0 0 1 0 -1 0 0 0 0 1 axl3hol9.dat
  [1,16,0.5,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__axl3hol9(realsolid)],
// 1 16 -0.5 0 0 0 1 0 -1 0 0 0 0 1 axl3hol2.dat
  [1,16,-0.5,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__axl3hol2(realsolid)],
// 1 16 0.5 0 0 0 1 0 -1 0 0 0 0 1 axl3hol2.dat
  [1,16,0.5,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__axl3hol2(realsolid)],
...
// 1 16 20 0 0 0 -1 0 -1 0 0 0 0 -1 4-4ring6.dat
  [1,16,20,0,0,0,-1,0,-1,0,0,0,0,-1, ldraw_lib__4_4ring6(realsolid)],
// 1 16 -20 0 0 0 1 0 -1 0 0 0 0 1 4-4ring6.dat
  [1,16,-20,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__4_4ring6(realsolid)],
// 1 16 20 0 0 0 -1 0 -0.5 0 0 0 0 -0.5 2-4rin14.dat
  [1,16,20,0,0,0,-1,0,-0.5,0,0,0,0,-0.5, ldraw_lib__2_4rin14(realsolid)],
// 1 16 -20 0 0 0 1 0 0.5 0 0 0 0 -0.5 2-4rin14.dat
  [1,16,-20,0,0,0,1,0,0.5,0,0,0,0,-0.5, ldraw_lib__2_4rin14(realsolid)],
// 1 16 20 0 0 0 -1 0 1 0 0 0 0 1 2-4ring8.dat
  [1,16,20,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__2_4ring8(realsolid)],
// 1 16 -20 0 0 0 1 0 -1 0 0 0 0 1 2-4ring8.dat
  [1,16,-20,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__2_4ring8(realsolid)],
// 1 16 20 0 0 0 -1 0 1 0 0 0 0 1 2-4ring7.dat
  [1,16,20,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__2_4ring7(realsolid)],
// 1 16 -20 0 0 0 1 0 -1 0 0 0 0 1 2-4ring7.dat
  [1,16,-20,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__2_4ring7(realsolid)],
// 1 16 17 0 0 0 1 0 -1 0 0 0 0 1 axl3hol3.dat
  [1,16,17,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__axl3hol3(realsolid)],
// 1 16 -17 0 0 0 1 0 -1 0 0 0 0 1 axl3hol3.dat
  [1,16,-17,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__axl3hol3(realsolid)],
// 1 16 17 0 0 0 1 0 -1 0 0 0 0 1 axl3hol9.dat
  [1,16,17,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__axl3hol9(realsolid)],
// 1 16 -17 0 0 0 1 0 -1 0 0 0 0 1 axl3hol9.dat
  [1,16,-17,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__axl3hol9(realsolid)],
// 1 16 17 0 0 0 -1 0 -1 0 0 0 0 1 axl3ho10.dat
  [1,16,17,0,0,0,-1,0,-1,0,0,0,0,1, ldraw_lib__axl3ho10(realsolid)],
// 1 16 -17 0 0 0 1 0 -1 0 0 0 0 1 axl3ho10.dat
  [1,16,-17,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__axl3ho10(realsolid)],
// 
// 0 BFC INVERTNEXT
...
module ldraw_lib__s__47325s03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__47325s03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
