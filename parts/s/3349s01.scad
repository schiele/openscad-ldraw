...
use <3351bs02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3349s01(realsolid=false) = [
...
// 1 16 0 -92 -2 -18 0 0 0 0 -24 0 4 0 box4-4a.dat
  [1,16,0,-92,-2,-18,0,0,0,0,-24,0,4,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 -12 -68 0 0 0 -6 0 -4 0 2 0 0 rect3.dat
  [1,16,-12,-68,0,0,0,-6,0,-4,0,2,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 12 -68 0 0 0 6 0 -4 0 -2 0 0 rect3.dat
  [1,16,12,-68,0,0,0,6,0,-4,0,-2,0,0, ldraw_lib__rect3(realsolid)],
// 0 //
];
module ldraw_lib__s__3349s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3349s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
