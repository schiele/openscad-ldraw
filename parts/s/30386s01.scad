...
use <../../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__30386s01(realsolid=false) = [
...
// 1 16 0 20 0 0 0 20 0 -20 0 -10 0 0 box3u2p.dat
  [1,16,0,20,0,0,0,20,0,-20,0,-10,0,0, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 0 23 0 0 0 16 0 -19 0 -6 0 0 box3u2p.dat
  [1,16,0,23,0,0,0,16,0,-19,0,-6,0,0, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 0 24 -8 16 0 0 0 -1 0 0 0 -2 rect.dat
  [1,16,0,24,-8,16,0,0,0,-1,0,0,0,-2, ldraw_lib__rect(realsolid)],
// 2 24 16 24 -6 17 23 -6
  [2,24,16,24,-6,17,23,-6],
// 2 24 20 20 -10 16 24 -10
  [2,24,20,20,-10,16,24,-10],
...
// 1 16 -16.5 23 0 0 0 -0.5 0 -1 0 -6 0 0 rect3.dat
  [1,16,-16.5,23,0,0,0,-0.5,0,-1,0,-6,0,0, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__s__30386s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__30386s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
