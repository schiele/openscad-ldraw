...
function ldraw_lib__s__31111s01() = [
...
// 1 16 0 96 0 80 0 0 0 -96 0 0 0 40 box4-1.dat
  [1,16,0,96,0,80,0,0,0,-96,0,0,0,40, ldraw_lib__box4_1()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 96 0 76 0 0 0 -92 0 0 0 36 box5.dat
  [1,16,0,96,0,76,0,0,0,-92,0,0,0,36, ldraw_lib__box5()],
...
// 1 16 0 4 0 1 0 0 0 -22 0 0 0 1 stug8-1x3.dat
  [1,16,0,4,0,1,0,0,0,-22,0,0,0,1, ldraw_lib__stug8_1x3()],
...
module ldraw_lib__s__31111s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__31111s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
