...
$fa=1; $fs=0.2;
function ldraw_lib__s__3069bpccs01(realsolid=false) = [
...
// 1 16 3 0 3.5 .25 0 0 0 1 0 0 0 .25 8\1-4chrd.dat
  [1,16,3,0,3.5,.25,0,0,0,1,0,0,0,.25, ldraw_lib__8__1_4chrd(realsolid)],
// 1 72 3 0 3.5 .25 0 0 0 1 0 0 0 .25 8\1-4ndis.dat
  [1,72,3,0,3.5,.25,0,0,0,1,0,0,0,.25, ldraw_lib__8__1_4ndis(realsolid)],
// 1 16 .25 0 3.5 -.25 0 0 0 1 0 0 0 .25 8\1-4chrd.dat
  [1,16,.25,0,3.5,-.25,0,0,0,1,0,0,0,.25, ldraw_lib__8__1_4chrd(realsolid)],
// 1 72 .25 0 3.5 -.25 0 0 0 1 0 0 0 .25 8\1-4ndis.dat
  [1,72,.25,0,3.5,-.25,0,0,0,1,0,0,0,.25, ldraw_lib__8__1_4ndis(realsolid)],
// 1 16 .25 0 .25 -.25 0 0 0 1 0 0 0 -.25 8\1-4chrd.dat
  [1,16,.25,0,.25,-.25,0,0,0,1,0,0,0,-.25, ldraw_lib__8__1_4chrd(realsolid)],
// 1 72 .25 0 .25 -.25 0 0 0 1 0 0 0 -.25 8\1-4ndis.dat
  [1,72,.25,0,.25,-.25,0,0,0,1,0,0,0,-.25, ldraw_lib__8__1_4ndis(realsolid)],
// 1 16 3 0 .25 .25 0 0 0 1 0 0 0 -.25 8\1-4chrd.dat
  [1,16,3,0,.25,.25,0,0,0,1,0,0,0,-.25, ldraw_lib__8__1_4chrd(realsolid)],
// 1 72 3 0 .25 .25 0 0 0 1 0 0 0 -.25 8\1-4ndis.dat
  [1,72,3,0,.25,.25,0,0,0,1,0,0,0,-.25, ldraw_lib__8__1_4ndis(realsolid)],
...
module ldraw_lib__s__3069bpccs01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3069bpccs01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
