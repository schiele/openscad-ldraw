...
use <../../p/rect2p.scad>
use <../../p/rect3.scad>
function ldraw_lib__s__38585s01() = [
// 0 ~Half Arch  1 x  1
...
// 1 16 13.0865 8 0 0 0 3.0865 0 -4 0 6 0 0 box5-4a.dat
  [1,16,13.0865,8,0,0,0,3.0865,0,-4,0,6,0,0, ldraw_lib__box5_4a()],
// 
// 1 16 20 18 10 0 0 -10 -10 0 0 0 -1 0 1-4ndis.dat
  [1,16,20,18,10,0,0,-10,-10,0,0,0,-1,0, ldraw_lib__1_4ndis()],
// 1 16 20 18 -10 0 0 -10 -10 0 0 0 1 0 1-4ndis.dat
  [1,16,20,18,-10,0,0,-10,-10,0,0,0,1,0, ldraw_lib__1_4ndis()],
// 1 16 20 18 6 -10 0 0 0 0 -10 0 1 0 1-4ndis.dat
  [1,16,20,18,6,-10,0,0,0,0,-10,0,1,0, ldraw_lib__1_4ndis()],
// 1 16 20 18 -6 -10 0 0 0 0 -10 0 -1 0 1-4ndis.dat
  [1,16,20,18,-6,-10,0,0,0,0,-10,0,-1,0, ldraw_lib__1_4ndis()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 18 10 -10 0 0 0 0 -10 0 -4 0 1-4cylo.dat
  [1,16,20,18,10,-10,0,0,0,0,-10,0,-4,0, ldraw_lib__1_4cylo()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 18 -10 -10 0 0 0 0 -10 0 4 0 1-4cylo.dat
  [1,16,20,18,-10,-10,0,0,0,0,-10,0,4,0, ldraw_lib__1_4cylo()],
...
// 1 16 18.0865 8 0 0 0 -1.9135 0 -1 0 -6 0 0 rect3.dat
  [1,16,18.0865,8,0,0,0,-1.9135,0,-1,0,-6,0,0, ldraw_lib__rect3()],
];
module ldraw_lib__s__38585s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__38585s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
