...
use <35442s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__35442s01(realsolid=false) = [
...
// 1 16 0 0.5 30 5.625 0 0 0 1 0 0 0 5.625 2-4chrd.dat
  [1,16,0,0.5,30,5.625,0,0,0,1,0,0,0,5.625, ldraw_lib__2_4chrd(realsolid)],
...
module ldraw_lib__s__35442s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__35442s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
