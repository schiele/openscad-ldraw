use <../../lib.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2431ps3b(realsolid=false) = [
...
// 
// 
// 3 16 20 0 2.25 20 0 -2.25 18 0 0
  [3,16,20,0,2.25,20,0,-2.25,18,0,0],
...
module ldraw_lib__s__2431ps3b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2431ps3b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
