...
use <../../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3067s01(realsolid=false) = [
...
// 1 16 0 24 0 56 0 0 0 -20 0 0 0 6 box5.dat
  [1,16,0,24,0,56,0,0,0,-20,0,0,0,6, ldraw_lib__box5(realsolid)],
...
// 1 16 0 24 0 60 0 0 0 -24 0 0 0 10 box4t.dat
  [1,16,0,24,0,60,0,0,0,-24,0,0,0,10, ldraw_lib__box4t(realsolid)],
...
module ldraw_lib__s__3067s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3067s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
