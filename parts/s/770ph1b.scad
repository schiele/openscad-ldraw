...
use <2586ph1b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__770ph1b(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2586ph1b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2586ph1b(realsolid)],
];
module ldraw_lib__s__770ph1b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__770ph1b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
