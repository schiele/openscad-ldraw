...
use <3228s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3231s01(realsolid=false) = [
...
// 1 16 0 16 0 6 0 0 0 -4 0 0 0 -6 box5.dat
  [1,16,0,16,0,6,0,0,0,-4,0,0,0,-6, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -48 16 0 0 0 38 0 -4 0 6 0 0 box4-4a.dat
  [1,16,-48,16,0,0,0,38,0,-4,0,6,0,0, ldraw_lib__box4_4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 16 48 6 0 0 0 -4 0 0 0 -38 box4-4a.dat
  [1,16,0,16,48,6,0,0,0,-4,0,0,0,-38, ldraw_lib__box4_4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 30 16 0 0 0 -20 0 -4 0 -6 0 0 box4-4a.dat
  [1,16,30,16,0,0,0,-20,0,-4,0,-6,0,0, ldraw_lib__box4_4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 16 -30 -6 0 0 0 -4 0 0 0 20 box4-4a.dat
  [1,16,0,16,-30,-6,0,0,0,-4,0,0,0,20, ldraw_lib__box4_4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -50 12 -30 0 40 0 -4 0 0 0 0 20 box2-7.dat
  [1,16,-50,12,-30,0,40,0,-4,0,0,0,0,20, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 30 12 50 0 0 -20 4 0 0 0 -40 0 box2-7.dat
  [1,16,30,12,50,0,0,-20,4,0,0,0,-40,0, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 30 12 -30 0 -20 0 4 0 0 0 0 20 box2-7.dat
  [1,16,30,12,-30,0,-20,0,4,0,0,0,0,20, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -50 12 50 0 0 40 -4 0 0 0 -40 0 box2-7.dat
  [1,16,-50,12,50,0,0,40,-4,0,0,0,-40,0, ldraw_lib__box2_7(realsolid)],
// 1 16 50 4.5 0 0 -35 0 -3.5 0 0 0 0 -2 box3u7a.dat
  [1,16,50,4.5,0,0,-35,0,-3.5,0,0,0,0,-2, ldraw_lib__box3u7a(realsolid)],
// 1 16 20 0 0 1 0 0 0 1 0 0 0 1 s\3228s01.dat
  [1,16,20,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3228s01(realsolid)],
// 1 16 0 0 100 0 0 -1 0 1 0 1 0 0 s\3228s01.dat
  [1,16,0,0,100,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3228s01(realsolid)],
// 1 16 0 0 90 0 0 -1 0 1 0 1 0 0 s\3228s01.dat
  [1,16,0,0,90,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3228s01(realsolid)],
// 1 16 0 0 80 0 0 -1 0 1 0 1 0 0 s\3228s01.dat
  [1,16,0,0,80,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3228s01(realsolid)],
// 1 16 0 0 70 0 0 -1 0 1 0 1 0 0 s\3228s01.dat
  [1,16,0,0,70,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3228s01(realsolid)],
// 1 16 0 0 60 0 0 -1 0 1 0 1 0 0 s\3228s01.dat
  [1,16,0,0,60,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3228s01(realsolid)],
// 1 16 0 0 50 0 0 -1 0 1 0 1 0 0 s\3228s01.dat
  [1,16,0,0,50,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3228s01(realsolid)],
// 1 16 0 0 40 0 0 -1 0 1 0 1 0 0 s\3228s01.dat
  [1,16,0,0,40,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3228s01(realsolid)],
// 1 16 0 0 30 0 0 -1 0 1 0 1 0 0 s\3228s01.dat
  [1,16,0,0,30,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3228s01(realsolid)],
// 1 16 0 0 20 0 0 -1 0 1 0 1 0 0 s\3228s01.dat
  [1,16,0,0,20,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3228s01(realsolid)],
// 1 16 0 0 10 0 0 -1 0 1 0 1 0 0 s\3228s01.dat
  [1,16,0,0,10,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3228s01(realsolid)],
...
// 1 16 0 1.001 1.25 -2 0 0 0 -0.5 -0.5 0 -0.625 0.625 box2-5.dat
  [1,16,0,1.001,1.25,-2,0,0,0,-0.5,-0.5,0,-0.625,0.625, ldraw_lib__box2_5(realsolid)],
// 1 16 0 1.001 3.75 -2 0 0 0 -0.5 -0.5 0 -0.625 0.625 box2-5.dat
  [1,16,0,1.001,3.75,-2,0,0,0,-0.5,-0.5,0,-0.625,0.625, ldraw_lib__box2_5(realsolid)],
...
// 1 16 -100 0 0 1 0 0 0 1 0 0 0 1 s\3228s01.dat
  [1,16,-100,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3228s01(realsolid)],
// 1 16 -90 0 0 1 0 0 0 1 0 0 0 1 s\3228s01.dat
  [1,16,-90,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3228s01(realsolid)],
// 1 16 -80 0 0 1 0 0 0 1 0 0 0 1 s\3228s01.dat
  [1,16,-80,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3228s01(realsolid)],
// 1 16 -70 0 0 1 0 0 0 1 0 0 0 1 s\3228s01.dat
  [1,16,-70,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3228s01(realsolid)],
// 1 16 -60 0 0 1 0 0 0 1 0 0 0 1 s\3228s01.dat
  [1,16,-60,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3228s01(realsolid)],
// 1 16 -50 0 0 1 0 0 0 1 0 0 0 1 s\3228s01.dat
  [1,16,-50,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3228s01(realsolid)],
// 1 16 -40 0 0 1 0 0 0 1 0 0 0 1 s\3228s01.dat
  [1,16,-40,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3228s01(realsolid)],
// 1 16 -30 0 0 1 0 0 0 1 0 0 0 1 s\3228s01.dat
  [1,16,-30,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3228s01(realsolid)],
// 1 16 -20 0 0 1 0 0 0 1 0 0 0 1 s\3228s01.dat
  [1,16,-20,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3228s01(realsolid)],
// 1 16 -10 0 0 1 0 0 0 1 0 0 0 1 s\3228s01.dat
  [1,16,-10,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3228s01(realsolid)],
...
// 1 16 0 4.5 -50 0 0 -2 -3.5 0 0 0 35 0 box3u7a.dat
  [1,16,0,4.5,-50,0,0,-2,-3.5,0,0,0,35,0, ldraw_lib__box3u7a(realsolid)],
// 1 16 0 0 -20 0 0 1 0 1 0 -1 0 0 s\3228s01.dat
  [1,16,0,0,-20,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__3228s01(realsolid)],
// 1 16 0 0 -30 0 0 1 0 1 0 -1 0 0 s\3228s01.dat
  [1,16,0,0,-30,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__3228s01(realsolid)],
...
// 1 16 -44 4.5 44 0 46 0 3.5 0 0 0 0 -46 box2-9.dat
  [1,16,-44,4.5,44,0,46,0,3.5,0,0,0,0,-46, ldraw_lib__box2_9(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -46 4.5 46 0 44 0 3.5 0 0 0 0 -44 box2-9.dat
  [1,16,-46,4.5,46,0,44,0,3.5,0,0,0,0,-44, ldraw_lib__box2_9(realsolid)],
...
module ldraw_lib__s__3231s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3231s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
