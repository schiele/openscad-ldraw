...
$fa=1; $fs=0.2;
function ldraw_lib__s__11198s01(realsolid=false) = [
...
// 1 16 -60 0 0 0 0 1 0 1 0 -1 0 0 s\76371s02.dat
  [1,16,-60,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__76371s02(realsolid)],
// 1 16 60 0 0 0 0 1 0 1 0 -1 0 0 s\76371s02.dat
  [1,16,60,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__76371s02(realsolid)],
// 1 16 0 0 0 0 0 80 0 1 0 40 0 0 rect.dat
  [1,16,0,0,0,0,0,80,0,1,0,40,0,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 72 0 0 0 40 0 -68 0 36 0 0 box3u4a.dat
  [1,16,0,72,0,0,0,40,0,-68,0,36,0,0, ldraw_lib__box3u4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 72 -40 40 0 0 0 0 -40 0 4 0 48\2-4cylo.dat
  [1,16,0,72,-40,40,0,0,0,0,-40,0,4,0, ldraw_lib__48__2_4cylo(realsolid)],
// 1 16 0 72 -36 40 0 0 0 0 -40 0 -1 0 48\2-4ndis.dat
  [1,16,0,72,-36,40,0,0,0,0,-40,0,-1,0, ldraw_lib__48__2_4ndis(realsolid)],
...
// 1 16 0 72 40 40 0 0 0 0 -40 0 -1 0 48\2-4ndis.dat
  [1,16,0,72,40,40,0,0,0,0,-40,0,-1,0, ldraw_lib__48__2_4ndis(realsolid)],
// 1 16 40 84 0 0 1 0 -12 0 0 0 0 40 rect2p.dat
  [1,16,40,84,0,0,1,0,-12,0,0,0,0,40, ldraw_lib__rect2p(realsolid)],
// 1 16 -40 84 0 0 -1 0 12 0 0 0 0 40 rect2p.dat
  [1,16,-40,84,0,0,-1,0,12,0,0,0,0,40, ldraw_lib__rect2p(realsolid)],
...
// 1 16 60 96 0 20 0 0 0 1 0 0 0 40 recte4.dat
  [1,16,60,96,0,20,0,0,0,1,0,0,0,40, ldraw_lib__recte4(realsolid)],
// 1 16 -60 96 0 20 0 0 0 1 0 0 0 40 recte4.dat
  [1,16,-60,96,0,20,0,0,0,1,0,0,0,40, ldraw_lib__recte4(realsolid)],
...
module ldraw_lib__s__11198s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__11198s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
