use <../../lib.scad>
use <90640s04.scad>
function ldraw_lib__s__90640s03() = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\90640s04.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__90640s04()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\90640s04.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__90640s04()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\90640s04.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__90640s04()],
...
module ldraw_lib__s__90640s03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__90640s03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
