...
use <../../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__94318s01(realsolid=false) = [
...
// 1 16 40 5.5 0 14 0 0 0 -5.5 0 0 0 -.4 box3u10p.dat
  [1,16,40,5.5,0,14,0,0,0,-5.5,0,0,0,-.4, ldraw_lib__box3u10p(realsolid)],
// 1 16 40 80.5 0 14 0 0 0 5.5 0 0 0 .4 box3u10p.dat
  [1,16,40,80.5,0,14,0,0,0,5.5,0,0,0,.4, ldraw_lib__box3u10p(realsolid)],
// 
// 0 // holes
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 47 7 -.4 7 0 0 0 0 -1.5 0 .8 0 1-4cylo.dat
  [1,16,47,7,-.4,7,0,0,0,0,-1.5,0,.8,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 47 7 -.4 7 0 0 0 0 -1.5 0 1 0 1-4ndis.dat
  [1,16,47,7,-.4,7,0,0,0,0,-1.5,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 47 7 .4 7 0 0 0 0 -1.5 0 -1 0 1-4ndis.dat
  [1,16,47,7,.4,7,0,0,0,0,-1.5,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 33 7 -.4 -7 0 0 0 0 -1.5 0 .8 0 1-4cylo.dat
  [1,16,33,7,-.4,-7,0,0,0,0,-1.5,0,.8,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 33 7 -.4 -7 0 0 0 0 -1.5 0 1 0 1-4ndis.dat
  [1,16,33,7,-.4,-7,0,0,0,0,-1.5,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 33 7 .4 -7 0 0 0 0 -1.5 0 -1 0 1-4ndis.dat
  [1,16,33,7,.4,-7,0,0,0,0,-1.5,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 47 13 -.4 7 0 0 0 0 1.5 0 .8 0 1-4cylo.dat
  [1,16,47,13,-.4,7,0,0,0,0,1.5,0,.8,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 47 13 -.4 7 0 0 0 0 1.5 0 1 0 1-4ndis.dat
  [1,16,47,13,-.4,7,0,0,0,0,1.5,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 47 13 .4 7 0 0 0 0 1.5 0 -1 0 1-4ndis.dat
  [1,16,47,13,.4,7,0,0,0,0,1.5,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 33 13 -.4 -7 0 0 0 0 1.5 0 .8 0 1-4cylo.dat
  [1,16,33,13,-.4,-7,0,0,0,0,1.5,0,.8,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 33 13 -.4 -7 0 0 0 0 1.5 0 1 0 1-4ndis.dat
  [1,16,33,13,-.4,-7,0,0,0,0,1.5,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 33 13 .4 -7 0 0 0 0 1.5 0 -1 0 1-4ndis.dat
  [1,16,33,13,.4,-7,0,0,0,0,1.5,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 
// 1 16 26 10 0 0 -1 0 3 0 0 0 0 .4 rect2p.dat
  [1,16,26,10,0,0,-1,0,3,0,0,0,0,.4, ldraw_lib__rect2p(realsolid)],
// 1 16 54 10 0 0 1 0 3 0 0 0 0 -.4 rect2p.dat
  [1,16,54,10,0,0,1,0,3,0,0,0,0,-.4, ldraw_lib__rect2p(realsolid)],
// 1 16 40 5.5 0 7 0 0 0 -1 0 0 0 -.4 rect2p.dat
  [1,16,40,5.5,0,7,0,0,0,-1,0,0,0,-.4, ldraw_lib__rect2p(realsolid)],
// 1 16 40 14.5 0 -7 0 0 0 1 0 0 0 -.4 rect2p.dat
  [1,16,40,14.5,0,-7,0,0,0,1,0,0,0,-.4, ldraw_lib__rect2p(realsolid)],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 47 73 -.4 7 0 0 0 0 -1.5 0 .8 0 1-4cylo.dat
  [1,16,47,73,-.4,7,0,0,0,0,-1.5,0,.8,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 47 73 -.4 7 0 0 0 0 -1.5 0 1 0 1-4ndis.dat
  [1,16,47,73,-.4,7,0,0,0,0,-1.5,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 47 73 .4 7 0 0 0 0 -1.5 0 -1 0 1-4ndis.dat
  [1,16,47,73,.4,7,0,0,0,0,-1.5,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 33 73 -.4 -7 0 0 0 0 -1.5 0 .8 0 1-4cylo.dat
  [1,16,33,73,-.4,-7,0,0,0,0,-1.5,0,.8,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 33 73 -.4 -7 0 0 0 0 -1.5 0 1 0 1-4ndis.dat
  [1,16,33,73,-.4,-7,0,0,0,0,-1.5,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 33 73 .4 -7 0 0 0 0 -1.5 0 -1 0 1-4ndis.dat
  [1,16,33,73,.4,-7,0,0,0,0,-1.5,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 47 79 -.4 7 0 0 0 0 1.5 0 .8 0 1-4cylo.dat
  [1,16,47,79,-.4,7,0,0,0,0,1.5,0,.8,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 47 79 -.4 7 0 0 0 0 1.5 0 1 0 1-4ndis.dat
  [1,16,47,79,-.4,7,0,0,0,0,1.5,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 47 79 .4 7 0 0 0 0 1.5 0 -1 0 1-4ndis.dat
  [1,16,47,79,.4,7,0,0,0,0,1.5,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 33 79 -.4 -7 0 0 0 0 1.5 0 .8 0 1-4cylo.dat
  [1,16,33,79,-.4,-7,0,0,0,0,1.5,0,.8,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 33 79 -.4 -7 0 0 0 0 1.5 0 1 0 1-4ndis.dat
  [1,16,33,79,-.4,-7,0,0,0,0,1.5,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 33 79 .4 -7 0 0 0 0 1.5 0 -1 0 1-4ndis.dat
  [1,16,33,79,.4,-7,0,0,0,0,1.5,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 
// 1 16 54 76 0 0 1 0 3 0 0 0 0 -.4 rect2p.dat
  [1,16,54,76,0,0,1,0,3,0,0,0,0,-.4, ldraw_lib__rect2p(realsolid)],
// 1 16 26 76 0 0 -1 0 3 0 0 0 0 .4 rect2p.dat
  [1,16,26,76,0,0,-1,0,3,0,0,0,0,.4, ldraw_lib__rect2p(realsolid)],
// 1 16 40 71.5 0 7 0 0 0 -1 0 0 0 -.4 rect2p.dat
  [1,16,40,71.5,0,7,0,0,0,-1,0,0,0,-.4, ldraw_lib__rect2p(realsolid)],
// 1 16 40 80.5 0 -7 0 0 0 1 0 0 0 -.4 rect2p.dat
  [1,16,40,80.5,0,-7,0,0,0,1,0,0,0,-.4, ldraw_lib__rect2p(realsolid)],
];
module ldraw_lib__s__94318s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__94318s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
