...
use <../../p/1-4cyli.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__57783s02(realsolid=false) = [
...
// 1 16 -30 0 20 0 0 -10 0 28 0 -10 -40 0 1-4cyli.dat
  [1,16,-30,0,20,0,0,-10,0,28,0,-10,-40,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 30 0 20 0 0 10 0 28 0 -10 -40 0 1-4cyli.dat
  [1,16,30,0,20,0,0,10,0,28,0,-10,-40,0, ldraw_lib__1_4cyli(realsolid)],
];
module ldraw_lib__s__57783s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__57783s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
