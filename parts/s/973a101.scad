use <../../lib.scad>
use <973as1.scad>
function ldraw_lib__s__973a101() = [
// 0 ~Moved to 973as1
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\973as1.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973as1()],
];
module ldraw_lib__s__973a101(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__973a101(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
