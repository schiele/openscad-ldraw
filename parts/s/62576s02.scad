use <../../lib.scad>
use <../../p/rect2p.scad>
function ldraw_lib__s__62576s02() = [
...
// 1 16 60 22 -10 0 0 -20 -22 1 0 20 0 -20 rect2p.dat
  [1,16,60,22,-10,0,0,-20,-22,1,0,20,0,-20, ldraw_lib__rect2p()],
// 1 16 -60 22 -10 0 0 -20 -22 1 0 20 0 20 rect2p.dat
  [1,16,-60,22,-10,0,0,-20,-22,1,0,20,0,20, ldraw_lib__rect2p()],
...
module ldraw_lib__s__62576s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__62576s02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
