...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__64178s01(realsolid=false) = [
...
// 1 16 40 10 60 -1 0 0 0 -.75 0 0 0 1 peghole.dat
  [1,16,40,10,60,-1,0,0,0,-.75,0,0,0,1, ldraw_lib__peghole(realsolid)],
// 1 16 40 -10 60 -1 0 0 0 .75 0 0 0 1 peghole.dat
  [1,16,40,-10,60,-1,0,0,0,.75,0,0,0,1, ldraw_lib__peghole(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 40 8.5 60 -6 0 0 0 -17 0 0 0 6 4-4cyli.dat
  [1,16,40,8.5,60,-6,0,0,0,-17,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 40 10 60 -2 0 0 0 -1 0 0 0 2 4-4ring4.dat
  [1,16,40,10,60,-2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring4(realsolid)],
// 1 16 40 10 20 -1 0 0 0 -.75 0 0 0 1 peghole.dat
  [1,16,40,10,20,-1,0,0,0,-.75,0,0,0,1, ldraw_lib__peghole(realsolid)],
// 1 16 40 -10 20 -1 0 0 0 .75 0 0 0 1 peghole.dat
  [1,16,40,-10,20,-1,0,0,0,.75,0,0,0,1, ldraw_lib__peghole(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 40 8.5 20 -6 0 0 0 -17 0 0 0 6 4-4cyli.dat
  [1,16,40,8.5,20,-6,0,0,0,-17,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 40 -10 10 1 0 0 0 1 0 0 0 1 npeghol8.dat
  [1,16,40,-10,10,1,0,0,0,1,0,0,0,1, ldraw_lib__npeghol8(realsolid)],
// 1 16 40 10 10 1 0 0 0 -1 0 0 0 1 npeghol8.dat
  [1,16,40,10,10,1,0,0,0,-1,0,0,0,1, ldraw_lib__npeghol8(realsolid)],
// 1 16 40 10 20 -2 0 0 0 -1 0 0 0 2 4-4ring4.dat
  [1,16,40,10,20,-2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring4(realsolid)],
// 1 16 40 -10 60 -2 0 0 0 1 0 0 0 2 4-4ring4.dat
  [1,16,40,-10,60,-2,0,0,0,1,0,0,0,2, ldraw_lib__4_4ring4(realsolid)],
// 1 16 40 -10 20 -2 0 0 0 1 0 0 0 2 4-4ring4.dat
  [1,16,40,-10,20,-2,0,0,0,1,0,0,0,2, ldraw_lib__4_4ring4(realsolid)],
// 1 16 40 -10 20 10 0 0 0 1 0 0 0 10 1-8ndis.dat
  [1,16,40,-10,20,10,0,0,0,1,0,0,0,10, ldraw_lib__1_8ndis(realsolid)],
// 1 16 40 -10 20 10 0 0 0 1 0 0 0 -10 1-8ndis.dat
  [1,16,40,-10,20,10,0,0,0,1,0,0,0,-10, ldraw_lib__1_8ndis(realsolid)],
// 1 16 40 10 20 10 0 0 0 -1 0 0 0 10 1-8ndis.dat
  [1,16,40,10,20,10,0,0,0,-1,0,0,0,10, ldraw_lib__1_8ndis(realsolid)],
...
// 1 16 40 -10 60 10 0 0 0 1 0 0 0 -10 1-8ndis.dat
  [1,16,40,-10,60,10,0,0,0,1,0,0,0,-10, ldraw_lib__1_8ndis(realsolid)],
// 1 16 40 -10 60 -10 0 0 0 1 0 0 0 -10 1-8ndis.dat
  [1,16,40,-10,60,-10,0,0,0,1,0,0,0,-10, ldraw_lib__1_8ndis(realsolid)],
// 1 16 40 10 60 10 0 0 0 -1 0 0 0 -10 1-8ndis.dat
  [1,16,40,10,60,10,0,0,0,-1,0,0,0,-10, ldraw_lib__1_8ndis(realsolid)],
...
// 1 16 40 -10 30 1 0 0 0 1 0 0 0 -1 npeghol8.dat
  [1,16,40,-10,30,1,0,0,0,1,0,0,0,-1, ldraw_lib__npeghol8(realsolid)],
// 1 16 40 10 30 1 0 0 0 -1 0 0 0 -1 npeghol8.dat
  [1,16,40,10,30,1,0,0,0,-1,0,0,0,-1, ldraw_lib__npeghol8(realsolid)],
// 1 16 40 -10 50 1 0 0 0 1 0 0 0 1 npeghol8.dat
  [1,16,40,-10,50,1,0,0,0,1,0,0,0,1, ldraw_lib__npeghol8(realsolid)],
// 1 16 40 10 50 1 0 0 0 -1 0 0 0 1 npeghol8.dat
  [1,16,40,10,50,1,0,0,0,-1,0,0,0,1, ldraw_lib__npeghol8(realsolid)],
// 0 //
...
// 1 16 40 0 80 0 1 0 1 0 0 0 0 1 connhol2.dat
  [1,16,40,0,80,0,1,0,1,0,0,0,0,1, ldraw_lib__connhol2(realsolid)],
...
// 1 16 50 0 100 0 -1 0 -1 0 0 0 0 -1 4-4ring8.dat
  [1,16,50,0,100,0,-1,0,-1,0,0,0,0,-1, ldraw_lib__4_4ring8(realsolid)],
// 1 16 40 0 40 0 1 0 0 0 1 1 0 0 connhol2.dat
  [1,16,40,0,40,0,1,0,0,0,1,1,0,0, ldraw_lib__connhol2(realsolid)],
// 1 16 32 0 100 0 1 0 -2 0 0 0 0 2 4-4ring3.dat
  [1,16,32,0,100,0,1,0,-2,0,0,0,0,2, ldraw_lib__4_4ring3(realsolid)],
// 1 16 32 0 100 0 1 0 8 0 0 0 0 -8 2-4ndis.dat
  [1,16,32,0,100,0,1,0,8,0,0,0,0,-8, ldraw_lib__2_4ndis(realsolid)],
// 1 16 50 0 100 0 -18 0 -9 0 0 0 0 9 2-4cyli.dat
  [1,16,50,0,100,0,-18,0,-9,0,0,0,0,9, ldraw_lib__2_4cyli(realsolid)],
// 1 16 50 0 100 0 -1 0 -9 0 0 0 0 9 2-4edge.dat
  [1,16,50,0,100,0,-1,0,-9,0,0,0,0,9, ldraw_lib__2_4edge(realsolid)],
// 1 16 32 0 100 0 -1 0 -9 0 0 0 0 9 2-4edge.dat
  [1,16,32,0,100,0,-1,0,-9,0,0,0,0,9, ldraw_lib__2_4edge(realsolid)],
// 4 16 32 8 88 32 -8 88 32 -8 92 32 8 92
  [4,16,32,8,88,32,-8,88,32,-8,92,32,8,92],
// 1 16 30 0 80 0 -1 0 8 0 0 0 0 -8 2-4edge.dat
  [1,16,30,0,80,0,-1,0,8,0,0,0,0,-8, ldraw_lib__2_4edge(realsolid)],
// 1 16 30 0 80 0 1 0 -8 0 0 0 0 -8 2-4ndis.dat
  [1,16,30,0,80,0,1,0,-8,0,0,0,0,-8, ldraw_lib__2_4ndis(realsolid)],
// 4 16 30 8 70 30 -8 70 30 -8 72 30 8 72
  [4,16,30,8,70,30,-8,70,30,-8,72,30,8,72],
// 1 16 31 8 94 1 0 0 0 1 0 0 0 6 rect2a.dat
  [1,16,31,8,94,1,0,0,0,1,0,0,0,6, ldraw_lib__rect2a(realsolid)],
// 1 16 31 -8 94 0 0 1 0 -1 0 6 0 0 rect2a.dat
  [1,16,31,-8,94,0,0,1,0,-1,0,6,0,0, ldraw_lib__rect2a(realsolid)],
// 1 16 50 0 90 0 -8 0 1 0 0 0 0 1 npeghol2.dat
  [1,16,50,0,90,0,-8,0,1,0,0,0,0,1, ldraw_lib__npeghol2(realsolid)],
// 1 16 10 0 70 0 0 -1 1 0 0 0 -8 0 npeghol2.dat
  [1,16,10,0,70,0,0,-1,1,0,0,0,-8,0, ldraw_lib__npeghol2(realsolid)],
// 1 16 20 0 70 0 0 9 -9 0 0 0 -1 0 2-4ndis.dat
  [1,16,20,0,70,0,0,9,-9,0,0,0,-1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 50 0 80 0 -1 0 -9 0 0 0 0 -9 2-4ndis.dat
  [1,16,50,0,80,0,-1,0,-9,0,0,0,0,-9, ldraw_lib__2_4ndis(realsolid)],
// 1 16 50 0 40 0 -1 0 -9 0 0 0 0 -9 4-4ndis.dat
  [1,16,50,0,40,0,-1,0,-9,0,0,0,0,-9, ldraw_lib__4_4ndis(realsolid)],
// 4 16 50 9 71 50 -9 71 50 -9 60 50 9 60
  [4,16,50,9,71,50,-9,71,50,-9,60,50,9,60],
// 1 16 32 0 100 0 1 0 -1 0 0 0 0 1 2-4ring8.dat
  [1,16,32,0,100,0,1,0,-1,0,0,0,0,1, ldraw_lib__2_4ring8(realsolid)],
// 1 16 29.5 0 70 .5 0 0 0 0 9 0 -1 0 rect1.dat
  [1,16,29.5,0,70,.5,0,0,0,0,9,0,-1,0, ldraw_lib__rect1(realsolid)],
// 1 16 20 0 60 1 0 0 0 0 1 0 1 0 connhol2.dat
  [1,16,20,0,60,1,0,0,0,0,1,0,1,0, ldraw_lib__connhol2(realsolid)],
// 1 16 20 0 50 8 0 0 0 0 -8 0 1 0 2-4ndis.dat
  [1,16,20,0,50,8,0,0,0,0,-8,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 20 8.5 52 0 0 8 .5 0 0 0 1 0 rect1.dat
  [1,16,20,8.5,52,0,0,8,.5,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
// 1 16 28 8.5 51 0 1 0 -.5 0 0 0 0 1 rect2p.dat
  [1,16,28,8.5,51,0,1,0,-.5,0,0,0,0,1, ldraw_lib__rect2p(realsolid)],
// 1 16 12 8.5 51 0 -1 0 -.5 0 0 0 0 1 rect2p.dat
  [1,16,12,8.5,51,0,-1,0,-.5,0,0,0,0,1, ldraw_lib__rect2p(realsolid)],
// 1 16 30 0 40 0 1 0 0 0 -8 -8 0 0 2-4ndis.dat
  [1,16,30,0,40,0,1,0,0,0,-8,-8,0,0, ldraw_lib__2_4ndis(realsolid)],
// 4 16 32 8 32 32 8 48 32 9 48 32 9 32
  [4,16,32,8,32,32,8,48,32,9,48,32,9,32],
// 1 16 31 9 32 0 0 1 -1 0 0 0 -1 0 rect2p.dat
  [1,16,31,9,32,0,0,1,-1,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 31 9 48 0 0 1 -1 0 0 0 1 0 rect2p.dat
  [1,16,31,9,48,0,0,1,-1,0,0,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 10 0 50 0 0 2 9 0 0 0 1 0 rect1.dat
  [1,16,10,0,50,0,0,2,9,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 10 9 51 0 0 2 0 -1 0 1 0 0 rect2p.dat
  [1,16,10,9,51,0,0,2,0,-1,0,1,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 31 8.5 100 1 0 0 0 0 .5 0 -1 0 rect3.dat
  [1,16,31,8.5,100,1,0,0,0,0,.5,0,-1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 25 9 68.5 0 0 -5 0 -1 0 -1.5 0 0 rect1.dat
  [1,16,25,9,68.5,0,0,-5,0,-1,0,-1.5,0,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 20 0 67 0 0 9 -9 0 0 0 -14 0 3-16cyli.dat
  [1,16,20,0,67,0,0,9,-9,0,0,0,-14,0, ldraw_lib__3_16cyli(realsolid)],
// 1 16 20 0 67 0 0 9 -9 0 0 0 1 0 3-16ndis.dat
  [1,16,20,0,67,0,0,9,-9,0,0,0,1,0, ldraw_lib__3_16ndis(realsolid)],
// 1 16 20 0 53 0 0 9 -9 0 0 0 -1 0 3-16ndis.dat
  [1,16,20,0,53,0,0,9,-9,0,0,0,-1,0, ldraw_lib__3_16ndis(realsolid)],
// 1 16 20 0 53 0 0 9 -9 0 0 0 -1 0 1-4edge.dat
  [1,16,20,0,53,0,0,9,-9,0,0,0,-1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 20 0 67 0 0 9 9 0 0 0 -12 0 3-16cyli.dat
  [1,16,20,0,67,0,0,9,9,0,0,0,-12,0, ldraw_lib__3_16cyli(realsolid)],
// 1 16 20 0 67 0 0 9 9 0 0 0 1 0 3-16ndis.dat
  [1,16,20,0,67,0,0,9,9,0,0,0,1,0, ldraw_lib__3_16ndis(realsolid)],
// 1 16 20 0 55 0 0 9 9 0 0 0 -1 0 3-16ndis.dat
  [1,16,20,0,55,0,0,9,9,0,0,0,-1,0, ldraw_lib__3_16ndis(realsolid)],
// 1 16 20 0 55 0 0 9 9 0 0 0 -1 0 1-4edge.dat
  [1,16,20,0,55,0,0,9,9,0,0,0,-1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 40 10 60 -10 0 0 0 1 0 0 0 10 2-4edge.dat
  [1,16,40,10,60,-10,0,0,0,1,0,0,0,10, ldraw_lib__2_4edge(realsolid)],
// 1 16 40 -10 60 -10 0 0 0 1 0 0 0 10 2-4edge.dat
  [1,16,40,-10,60,-10,0,0,0,1,0,0,0,10, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 30 9.5 54 0 1 0 .5 0 0 0 0 -6 rect1.dat
  [1,16,30,9.5,54,0,1,0,.5,0,0,0,0,-6, ldraw_lib__rect1(realsolid)],
// 
// 0 // LOOK
// 1 16 29 9 52.5 1 0 0 0 -1 0 0 0 -2.5 rect1.dat
  [1,16,29,9,52.5,1,0,0,0,-1,0,0,0,-2.5, ldraw_lib__rect1(realsolid)],
// 
// 1 16 20 0 67 0 0 9 -9 0 0 0 1 0 2-4edge.dat
  [1,16,20,0,67,0,0,9,-9,0,0,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 4 16 29 9 55 28.315 3.444 55 28.801 1 55 29 1 55
  [4,16,29,9,55,28.315,3.444,55,28.801,1,55,29,1,55],
// 
// 1 16 29.401 1 60 0 0 .6 0 -1 0 7 0 0 rect1.dat
  [1,16,29.401,1,60,0,0,.6,0,-1,0,7,0,0, ldraw_lib__rect1(realsolid)],
// 1 16 29.5 5 67 .5 0 0 0 0 -4 0 1 0 rect1.dat
  [1,16,29.5,5,67,.5,0,0,0,0,-4,0,1,0, ldraw_lib__rect1(realsolid)],
// 1 16 29.5 5 55 .5 0 0 0 0 4 0 -1 0 rect1.dat
  [1,16,29.5,5,55,.5,0,0,0,0,4,0,-1,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 29.401 -1 60 .6 0 0 0 1 0 0 0 7 rect.dat
  [1,16,29.401,-1,60,.6,0,0,0,1,0,0,0,7, ldraw_lib__rect(realsolid)],
// 1 16 32 9.5 4 0 1 0 .5 0 0 0 0 -4 rect1.dat
  [1,16,32,9.5,4,0,1,0,.5,0,0,0,0,-4, ldraw_lib__rect1(realsolid)],
...
// 1 16 40 9 70 1 0 0 0 -1 0 0 0 -1 npeghol19.dat
  [1,16,40,9,70,1,0,0,0,-1,0,0,0,-1, ldraw_lib__npeghol19(realsolid)],
// 1 16 40 10 60 10 0 0 0 -1 0 0 0 10 2-4cyli.dat
  [1,16,40,10,60,10,0,0,0,-1,0,0,0,10, ldraw_lib__2_4cyli(realsolid)],
// 1 16 40 9 60 10 0 0 0 -1 0 0 0 10 3-16edge.dat
  [1,16,40,9,60,10,0,0,0,-1,0,0,0,10, ldraw_lib__3_16edge(realsolid)],
// 1 16 40 9 60 -10 0 0 0 -1 0 0 0 10 3-16edge.dat
  [1,16,40,9,60,-10,0,0,0,-1,0,0,0,10, ldraw_lib__3_16edge(realsolid)],
// 1 16 40 9 60 10 0 0 0 -1 0 0 0 10 1-8ndis.dat
  [1,16,40,9,60,10,0,0,0,-1,0,0,0,10, ldraw_lib__1_8ndis(realsolid)],
...
module ldraw_lib__s__64178s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__64178s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
