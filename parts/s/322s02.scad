...
use <../u9073.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__322s02(realsolid=false) = [
// 0 ~Moved to u9073
// 0 Name: s\322s02.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 u9073.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9073(realsolid)],
];
module ldraw_lib__s__322s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__322s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
