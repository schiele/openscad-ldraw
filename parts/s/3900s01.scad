...
use <../../p/stud2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3900s01(realsolid=false) = [
...
// 1 16 0 0 0 14 0 0 0 1 0 0 0 -14 4-4disc.dat
  [1,16,0,0,0,14,0,0,0,1,0,0,0,-14, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 0 9.899 0 9.899 0 4 0 -9.899 0 9.899 3-4edge.dat
  [1,16,0,0,0,9.899,0,9.899,0,4,0,-9.899,0,9.899, ldraw_lib__3_4edge(realsolid)],
...
// 1 16 0 4 0 9.899 0 9.899 0 4 0 -9.899 0 9.899 3-4edge.dat
  [1,16,0,4,0,9.899,0,9.899,0,4,0,-9.899,0,9.899, ldraw_lib__3_4edge(realsolid)],
...
// 1 16 0 2 -50 4 0 0 0 0 -4 0 22 0 4-4cyli.dat
  [1,16,0,2,-50,4,0,0,0,0,-4,0,22,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 2 -50 4 0 0 0 0 4 0 1 0 4-4disc.dat
  [1,16,0,2,-50,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 2 -50 4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,16,0,2,-50,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 2 -28 0 0 -4 4 0 0 0 29.25 0 1-4cyls.dat
  [1,16,0,2,-28,0,0,-4,4,0,0,0,29.25,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 0 2 -28 0 0 4 4 0 0 0 29.25 0 1-4cyls.dat
  [1,16,0,2,-28,0,0,4,4,0,0,0,29.25,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 0 2 -28 0 0 -4 -4 0 0 0 29.25 0 1-4cyls.dat
  [1,16,0,2,-28,0,0,-4,-4,0,0,0,29.25,0, ldraw_lib__1_4cyls(realsolid)],
...
// 1 16 0 2 1.25 -4 0 0 0 -1 4 0 0 -29.25 2-4disc.dat
  [1,16,0,2,1.25,-4,0,0,0,-1,4,0,0,-29.25, ldraw_lib__2_4disc(realsolid)],
...
module ldraw_lib__s__3900s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3900s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
