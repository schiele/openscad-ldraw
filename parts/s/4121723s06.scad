...
use <../../p/5-16chrd.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__4121723s06(realsolid=false) = [
...
// 1 16 -14 0 2.5 -.8 0 0 0 1 0 0 0 .8 1-4chrd.dat
  [1,16,-14,0,2.5,-.8,0,0,0,1,0,0,0,.8, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -14 0 -2.5 .8 0 0 0 1 0 0 0 -.8 2-4chrd.dat
  [1,16,-14,0,-2.5,.8,0,0,0,1,0,0,0,-.8, ldraw_lib__2_4chrd(realsolid)],
// 1 16 -12.08 0 1.1 2.2 0 0 0 1 0 0 0 2.2 1-4chrd.dat
  [1,16,-12.08,0,1.1,2.2,0,0,0,1,0,0,0,2.2, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -12.08 0 1.1 2.2 0 0 0 1 0 0 0 -2.2 1-4chrd.dat
  [1,16,-12.08,0,1.1,2.2,0,0,0,1,0,0,0,-2.2, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -12.4 0 1.2 0 0 .75 0 1 0 .65 0 0 2-4ndis.dat
  [1,16,-12.4,0,1.2,0,0,.75,0,1,0,.65,0,0, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 -6.58 0 0 1.4 0 0 0 1 0 0 0 1.9 4-4ndis.dat
  [1,16,-6.58,0,0,1.4,0,0,0,1,0,0,0,1.9, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -6.58 0 0 3.1 0 0 0 1 0 0 0 3.3 1-8chrd.dat
  [1,16,-6.58,0,0,3.1,0,0,0,1,0,0,0,3.3, ldraw_lib__1_8chrd(realsolid)],
// 1 16 -6.58 0 0 3.1 0 0 0 1 0 0 0 -3.3 1-8chrd.dat
  [1,16,-6.58,0,0,3.1,0,0,0,1,0,0,0,-3.3, ldraw_lib__1_8chrd(realsolid)],
// 1 16 -6.58 0 0 0 0 -3.1 0 1 0 -3.3 0 0 1-8chrd.dat
  [1,16,-6.58,0,0,0,0,-3.1,0,1,0,-3.3,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 16 -6.58 0 0 0 0 3.1 0 1 0 3.3 0 0 1-8chrd.dat
  [1,16,-6.58,0,0,0,0,3.1,0,1,0,3.3,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 16 -6.58 0 0 0 0 3.1 0 1 0 -3.3 0 0 1-8chrd.dat
  [1,16,-6.58,0,0,0,0,3.1,0,1,0,-3.3,0,0, ldraw_lib__1_8chrd(realsolid)],
...
// 1 16 -2.6 0 2.5 0 0 .8 0 1 0 .8 0 0 3-16chrd.dat
  [1,16,-2.6,0,2.5,0,0,.8,0,1,0,.8,0,0, ldraw_lib__3_16chrd(realsolid)],
// 1 16 -2.6 0 2.5 0 0 -.8 0 1 0 .8 0 0 5-16chrd.dat
  [1,16,-2.6,0,2.5,0,0,-.8,0,1,0,.8,0,0, ldraw_lib__5_16chrd(realsolid)],
// 1 16 3.7 0 2.5 0 0 -.8 0 1 0 .8 0 0 3-16chrd.dat
  [1,16,3.7,0,2.5,0,0,-.8,0,1,0,.8,0,0, ldraw_lib__3_16chrd(realsolid)],
// 1 16 3.7 0 2.5 0 0 .8 0 1 0 .8 0 0 5-16chrd.dat
  [1,16,3.7,0,2.5,0,0,.8,0,1,0,.8,0,0, ldraw_lib__5_16chrd(realsolid)],
// 1 16 .55 0 2.3 0 0 -1 0 1 0 1 0 0 3-16chrd.dat
  [1,16,.55,0,2.3,0,0,-1,0,1,0,1,0,0, ldraw_lib__3_16chrd(realsolid)],
// 1 16 .55 0 2.3 0 0 1 0 1 0 1 0 0 3-16chrd.dat
  [1,16,.55,0,2.3,0,0,1,0,1,0,1,0,0, ldraw_lib__3_16chrd(realsolid)],
// 1 16 -1.25 0 -2.3 0 0 1 0 1 0 -1 0 0 3-16chrd.dat
  [1,16,-1.25,0,-2.3,0,0,1,0,1,0,-1,0,0, ldraw_lib__3_16chrd(realsolid)],
// 1 16 -1.25 0 -2.3 0 0 -1 0 1 0 -1 0 0 3-16chrd.dat
  [1,16,-1.25,0,-2.3,0,0,-1,0,1,0,-1,0,0, ldraw_lib__3_16chrd(realsolid)],
// 1 16 2.35 0 -2.3 0 0 1 0 1 0 -1 0 0 3-16chrd.dat
  [1,16,2.35,0,-2.3,0,0,1,0,1,0,-1,0,0, ldraw_lib__3_16chrd(realsolid)],
// 1 16 2.35 0 -2.3 0 0 -1 0 1 0 -1 0 0 3-16chrd.dat
  [1,16,2.35,0,-2.3,0,0,-1,0,1,0,-1,0,0, ldraw_lib__3_16chrd(realsolid)],
...
// 1 16 8.9 0 2.5 0 0 .8 0 1 0 -.8 0 0 2-4chrd.dat
  [1,16,8.9,0,2.5,0,0,.8,0,1,0,-.8,0,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 8.7 0 .1 0 0 .8 0 1 0 -.8 0 0 2-4chrd.dat
  [1,16,8.7,0,.1,0,0,.8,0,1,0,-.8,0,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 8.9 0 -2.5 0 0 .8 0 1 0 -.8 0 0 2-4chrd.dat
  [1,16,8.9,0,-2.5,0,0,.8,0,1,0,-.8,0,0, ldraw_lib__2_4chrd(realsolid)],
...
// 1 16 11.1 0 2.5 -.8 0 0 0 1 0 0 0 .8 1-4chrd.dat
  [1,16,11.1,0,2.5,-.8,0,0,0,1,0,0,0,.8, ldraw_lib__1_4chrd(realsolid)],
// 1 16 11.1 0 -2.5 .8 0 0 0 1 0 0 0 -.8 2-4chrd.dat
  [1,16,11.1,0,-2.5,.8,0,0,0,1,0,0,0,-.8, ldraw_lib__2_4chrd(realsolid)],
// 1 16 13 0 1.4 0 0 .75 0 1 0 .65 0 0 2-4ndis.dat
  [1,16,13,0,1.4,0,0,.75,0,1,0,.65,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 13.52 0 1.3 2 0 0 0 1 0 0 0 2 1-4chrd.dat
  [1,16,13.52,0,1.3,2,0,0,0,1,0,0,0,2, ldraw_lib__1_4chrd(realsolid)],
// 1 16 13.77 0 1.3 1.75 0 0 0 1 0 0 0 -1.75 3-16chrd.dat
  [1,16,13.77,0,1.3,1.75,0,0,0,1,0,0,0,-1.75, ldraw_lib__3_16chrd(realsolid)],
// 1 16 14.81 0 -2.5 0 0 .8 0 1 0 -.8 0 0 5-16chrd.dat
  [1,16,14.81,0,-2.5,0,0,.8,0,1,0,-.8,0,0, ldraw_lib__5_16chrd(realsolid)],
// 1 16 14.81 0 -2.5 0 0 -.8 0 1 0 -.8 0 0 3-16chrd.dat
  [1,16,14.81,0,-2.5,0,0,-.8,0,1,0,-.8,0,0, ldraw_lib__3_16chrd(realsolid)],
...
module ldraw_lib__s__4121723s06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__4121723s06(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
