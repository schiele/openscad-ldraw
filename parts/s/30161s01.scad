...
use <../../p/bump5000.scad>
use <../../p/recte4.scad>
function ldraw_lib__s__30161s01() = [
...
// 1 16 0 -4 0 -40 0 0 0 -24 0 0 0 2 box4t.dat
  [1,16,0,-4,0,-40,0,0,0,-24,0,0,0,2, ldraw_lib__box4t()],
// 
...
// 1 16 -36 -2 0 0 14 0 2 0 0 0 0 -4 box3u8p.dat
  [1,16,-36,-2,0,0,14,0,2,0,0,0,0,-4, ldraw_lib__box3u8p()],
// 1 16 -29 -4 0 7 0 0 0 1 0 0 0 4 recte4.dat
  [1,16,-29,-4,0,7,0,0,0,1,0,0,0,4, ldraw_lib__recte4()],
// 1 16 -10 -4 0 8 0 0 0 4 0 0 0 4 box4o4a.dat
  [1,16,-10,-4,0,8,0,0,0,4,0,0,0,4, ldraw_lib__box4o4a()],
// 1 16 10 -4 0 8 0 0 0 4 0 0 0 4 box4o4a.dat
  [1,16,10,-4,0,8,0,0,0,4,0,0,0,4, ldraw_lib__box4o4a()],
// 1 16 29 -4 0 7 0 0 0 1 0 0 0 4 recte4.dat
  [1,16,29,-4,0,7,0,0,0,1,0,0,0,4, ldraw_lib__recte4()],
...
// 1 16 -36 0 0 0 -1.5 0 3.5 0 0 0 0 3.5 bump5000.dat
  [1,16,-36,0,0,0,-1.5,0,3.5,0,0,0,0,3.5, ldraw_lib__bump5000()],
// 1 16 -36 0 0 0 1 0 0 0 0.5 0.5 0 0 4-4ring7.dat
  [1,16,-36,0,0,0,1,0,0,0,0.5,0.5,0,0, ldraw_lib__4_4ring7()],
...
// 1 16 -22 0 0 0 -14 0 0 0 4 4 0 0 2-4cylc.dat
  [1,16,-22,0,0,0,-14,0,0,0,4,4,0,0, ldraw_lib__2_4cylc()],
// 1 16 -2 0 0 0 -1 0 0 0 4 -4 0 0 2-4disc.dat
  [1,16,-2,0,0,0,-1,0,0,0,4,-4,0,0, ldraw_lib__2_4disc()],
// 1 16 -18 0 0 0 16 0 0 0 4 4 0 0 2-4cylc.dat
  [1,16,-18,0,0,0,16,0,0,0,4,4,0,0, ldraw_lib__2_4cylc()],
// 1 16 2 0 0 0 1 0 0 0 4 4 0 0 2-4disc.dat
  [1,16,2,0,0,0,1,0,0,0,4,4,0,0, ldraw_lib__2_4disc()],
// 1 16 18 0 0 0 -16 0 0 0 4 4 0 0 2-4cylc.dat
  [1,16,18,0,0,0,-16,0,0,0,4,4,0,0, ldraw_lib__2_4cylc()],
...
module ldraw_lib__s__30161s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__30161s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
