...
use <../../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__u1850s01(realsolid=false) = [
...
// 1 16 0 -60 -2.1 9 0 9 9 0 -9 0 2.1 0 box5.dat
  [1,16,0,-60,-2.1,9,0,9,9,0,-9,0,2.1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 0 -42 0 -2 0 0 -2 1 0 0 0 -2 1-4edge.dat
  [1,16,0,-42,0,-2,0,0,-2,1,0,0,0,-2, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 -42 0 2 0 0 -2 1 0 0 0 -2 1-4edge.dat
  [1,16,0,-42,0,2,0,0,-2,1,0,0,0,-2, ldraw_lib__1_4edge(realsolid)],
// 0 //
...
module ldraw_lib__s__u1850s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u1850s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
