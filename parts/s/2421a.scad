...
use <../../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2421a(realsolid=false) = [
...
// 1 16 0 -2 34 6 0 0 0 4 0 0 0 6 2-4cyli.dat
  [1,16,0,-2,34,6,0,0,0,4,0,0,0,6, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 2 34 6 0 0 0 1 0 0 0 6 2-4edge.dat
  [1,16,0,2,34,6,0,0,0,1,0,0,0,6, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -2 34 6 0 0 0 1 0 0 0 6 2-4edge.dat
  [1,16,0,-2,34,6,0,0,0,1,0,0,0,6, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 2 34 6 0 0 0 -1 0 0 0 6 2-4disc.dat
  [1,16,0,2,34,6,0,0,0,-1,0,0,0,6, ldraw_lib__2_4disc(realsolid)],
// 1 16 0 -2 34 6 0 0 0 1 0 0 0 6 2-4disc.dat
  [1,16,0,-2,34,6,0,0,0,1,0,0,0,6, ldraw_lib__2_4disc(realsolid)],
// 1 16 0 0 34 0 0 6 2 0 0 0 -26.5 0 box4o8a.dat
  [1,16,0,0,34,0,0,6,2,0,0,0,-26.5,0, ldraw_lib__box4o8a(realsolid)],
// 1 16 6 0 5.75 0 -1 0 0 0 -2 1.75 0 0 rect2p.dat
  [1,16,6,0,5.75,0,-1,0,0,0,-2,1.75,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -6 0 5.75 0 1 0 0 0 -2 1.75 0 0 rect2p.dat
  [1,16,-6,0,5.75,0,1,0,0,0,-2,1.75,0,0, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__s__2421a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2421a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
