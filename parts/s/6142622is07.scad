...
use <../../p/1-4cyli.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__6142622is07(realsolid=false) = [
// 0 ~Sticker  0.8 x  1.9 with Red and White Taillamp on Yellow Background Right - Underside Flat
// 0 Name: s\6142622is07.dat
...
module ldraw_lib__s__6142622is07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6142622is07(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__6142622is07(line=0.2);