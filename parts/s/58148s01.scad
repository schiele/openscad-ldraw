...
$fa=1; $fs=0.2;
function ldraw_lib__s__58148s01(realsolid=false) = [
...
// 1 16 0 20 0 1 0 0 0 -1 0 0 0 1 stug4-3x3.dat
  [1,16,0,20,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stug4_3x3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 24 0 36 0 0 0 -4 0 0 0 36 box5.dat
  [1,16,0,24,0,36,0,0,0,-4,0,0,0,36, ldraw_lib__box5(realsolid)],
...
// 1 16 40 10 0 0 -4 0 2 0 0 0 0 6 box5.dat
  [1,16,40,10,0,0,-4,0,2,0,0,0,0,6, ldraw_lib__box5(realsolid)],
...
// 1 16 -40 10 20 0 1 0 -1 0 0 0 0 1 peghole.dat
  [1,16,-40,10,20,0,1,0,-1,0,0,0,0,1, ldraw_lib__peghole(realsolid)],
// 1 16 -40 10 -20 0 1 0 -1 0 0 0 0 1 peghole.dat
  [1,16,-40,10,-20,0,1,0,-1,0,0,0,0,1, ldraw_lib__peghole(realsolid)],
// 1 16 -20 10 -20 0 1 0 -8 0 0 0 0 8 4-4disc.dat
  [1,16,-20,10,-20,0,1,0,-8,0,0,0,0,8, ldraw_lib__4_4disc(realsolid)],
// 1 16 -20 10 20 0 1 0 -8 0 0 0 0 8 4-4disc.dat
  [1,16,-20,10,20,0,1,0,-8,0,0,0,0,8, ldraw_lib__4_4disc(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -38 10 20 0 16 0 -6 0 0 0 0 6 4-4cyli.dat
  [1,16,-38,10,20,0,16,0,-6,0,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -38 10 -20 0 16 0 -6 0 0 0 0 6 4-4cyli.dat
  [1,16,-38,10,-20,0,16,0,-6,0,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -20 10 -20 0 -1 0 -1 0 0 0 0 -1 peghole.dat
  [1,16,-20,10,-20,0,-1,0,-1,0,0,0,0,-1, ldraw_lib__peghole(realsolid)],
// 1 16 -20 10 20 0 -1 0 -1 0 0 0 0 -1 peghole.dat
  [1,16,-20,10,20,0,-1,0,-1,0,0,0,0,-1, ldraw_lib__peghole(realsolid)],
// 1 16 -40 10 20 0 1 0 -8 0 0 0 0 8 3-4ndis.dat
  [1,16,-40,10,20,0,1,0,-8,0,0,0,0,8, ldraw_lib__3_4ndis(realsolid)],
// 1 16 -40 10 -20 0 1 0 0 0 8 8 0 0 3-4ndis.dat
  [1,16,-40,10,-20,0,1,0,0,0,8,8,0,0, ldraw_lib__3_4ndis(realsolid)],
...
// 1 16 -40 -18 0 0 1 0 18 0 18 18 0 -18 1-4edge.dat
  [1,16,-40,-18,0,0,1,0,18,0,18,18,0,-18, ldraw_lib__1_4edge(realsolid)],
...
module ldraw_lib__s__58148s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__58148s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
