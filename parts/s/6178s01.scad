...
$fa=1; $fs=0.2;
function ldraw_lib__s__6178s01(realsolid=false) = [
...
// 1 16 0 8 0 116 0 0 0 -4 0 0 0 56 box5.dat
  [1,16,0,8,0,116,0,0,0,-4,0,0,0,56, ldraw_lib__box5(realsolid)],
...
// 1 16 0 8 0 120 0 0 0 -8 0 0 0 60 box4.dat
  [1,16,0,8,0,120,0,0,0,-8,0,0,0,60, ldraw_lib__box4(realsolid)],
// 0 // Underside studs
// 1 16 -60 4 0 1 0 0 0 -1 0 0 0 1 stug4-5x5.dat
  [1,16,-60,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stug4_5x5(realsolid)],
// 1 16 0 4 0 0 0 1 0 -1 0 -1 0 0 stug4-1x5.dat
  [1,16,0,4,0,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stug4_1x5(realsolid)],
// 1 16 60 4 0 1 0 0 0 -1 0 0 0 1 stug4-5x5.dat
  [1,16,60,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stug4_5x5(realsolid)],
// 0 // Studs
// 1 16 -50 0 50 1 0 0 0 1 0 0 0 1 stug-1x5.dat
  [1,16,-50,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x5(realsolid)],
// 1 16 50 0 50 1 0 0 0 1 0 0 0 1 stug-1x5.dat
  [1,16,50,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x5(realsolid)],
// 1 16 -110 0 0 1 0 0 0 1 0 0 0 1 stug-6x1.dat
  [1,16,-110,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_6x1(realsolid)],
// 1 16 110 0 0 1 0 0 0 1 0 0 0 1 stug-6x1.dat
  [1,16,110,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_6x1(realsolid)],
];
module ldraw_lib__s__6178s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6178s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
