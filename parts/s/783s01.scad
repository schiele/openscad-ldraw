...
use <../../p/rect.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__783s01(realsolid=false) = [
...
// 1 16 0 -158 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,0,-158,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -158 0 4 0 0 0 1 0 0 0 4 4-4disc.dat
  [1,16,0,-158,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 -154 0 4 0 0 0 -4 0 0 0 4 4-4cyli.dat
  [1,16,0,-154,0,4,0,0,0,-4,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 0 //
...
module ldraw_lib__s__783s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__783s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
