...
use <../70926.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__889s01(realsolid=false) = [
// 0 ~Moved to 70926
// 0 Name: s\889s01.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 70926.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__70926(realsolid)],
];
module ldraw_lib__s__889s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__889s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
