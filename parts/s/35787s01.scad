...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__35787s01(realsolid=false) = [
...
// 1 16 0 8 0 -2 0 0 0 -1 0 0 0 -2 1-4ring3.dat
  [1,16,0,8,0,-2,0,0,0,-1,0,0,0,-2, ldraw_lib__1_4ring3(realsolid)],
...
// 1 16 -2.121 6 -2.121 -3.5874 1 0 0 0 2 3.5874 0 0 rect.dat
  [1,16,-2.121,6,-2.121,-3.5874,1,0,0,0,2,3.5874,0,0, ldraw_lib__rect(realsolid)],
// 1 16 .7332 6 -5.8542 .7332 1 0 0 0 2 .1458 0 0 rect2p.dat
  [1,16,.7332,6,-5.8542,.7332,1,0,0,0,2,.1458,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -5.8542 6 .7332 -.1458 -1 0 0 0 2 -.7332 0 0 rect2p.dat
  [1,16,-5.8542,6,.7332,-.1458,-1,0,0,0,2,-.7332,0,0, ldraw_lib__rect2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 -6 0 0 0 -4 0 0 0 -6 1-4cylo.dat
  [1,16,0,8,0,-6,0,0,0,-4,0,0,0,-6, ldraw_lib__1_4cylo(realsolid)],
...
// 1 16 -.707107 7.5 -.707107 -5.516215 -1 0 0 0 -.5 5.516215 0 0 rect.dat
  [1,16,-.707107,7.5,-.707107,-5.516215,-1,0,0,0,-.5,5.516215,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 -7.6956 6 1.5308 .3044 1 0 0 0 2 1.5308 0 0 rect2p.dat
  [1,16,-7.6956,6,1.5308,.3044,1,0,0,0,2,1.5308,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 1.5308 6 -7.6956 -1.5308 -1 0 0 0 2 -.3044 0 0 rect2p.dat
  [1,16,1.5308,6,-7.6956,-1.5308,-1,0,0,0,2,-.3044,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 8 0 -8 0 0 0 -4 0 0 0 -8 1-4cylo.dat
  [1,16,0,8,0,-8,0,0,0,-4,0,0,0,-8, ldraw_lib__1_4cylo(realsolid)],
// 1 16 0 5.5 0 5.657 -1 0 0 0 1.5 -5.657 0 0 rect3.dat
  [1,16,0,5.5,0,5.657,-1,0,0,0,1.5,-5.657,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 15 8 -17.5 0 0 1.5 0 -1 0 -1.5 0 0 8\2-4chrd.dat
  [1,16,15,8,-17.5,0,0,1.5,0,-1,0,-1.5,0,0, ldraw_lib__8__2_4chrd(realsolid)],
// 1 16 -17.5 8 15 1.5 0 0 0 -1 0 0 0 1.5 8\2-4chrd.dat
  [1,16,-17.5,8,15,1.5,0,0,0,-1,0,0,0,1.5, ldraw_lib__8__2_4chrd(realsolid)],
// 4 16 -19 8 -19 -19 8 15 -16 8 15 -16 8 -16
  [4,16,-19,8,-19,-19,8,15,-16,8,15,-16,8,-16],
// 
// 1 16 -2 7.5 -2 0 0 -17 .5 0 0 0 -17 0 box2-7.dat
  [1,16,-2,7.5,-2,0,0,-17,.5,0,0,0,-17,0, ldraw_lib__box2_7(realsolid)],
// 1 16 15 8 -17.5 0 0 1.5 0 -1 0 -1.5 0 0 8\2-4cylo.dat
  [1,16,15,8,-17.5,0,0,1.5,0,-1,0,-1.5,0,0, ldraw_lib__8__2_4cylo(realsolid)],
// 1 16 -17.5 8 15 1.5 0 0 0 -1 0 0 0 1.5 8\2-4cylo.dat
  [1,16,-17.5,8,15,1.5,0,0,0,-1,0,0,0,1.5, ldraw_lib__8__2_4cylo(realsolid)],
// 
...
// 1 16 -1.5 3.5 -1.5 0 0 -18.5 3.5 0 0 0 -18.5 0 box2-5.dat
  [1,16,-1.5,3.5,-1.5,0,0,-18.5,3.5,0,0,0,-18.5,0, ldraw_lib__box2_5(realsolid)],
...
// 1 16 17 3.5 -18.5 0 -1 0 3.5 0 0 0 0 1.5 rect3.dat
  [1,16,17,3.5,-18.5,0,-1,0,3.5,0,0,0,0,1.5, ldraw_lib__rect3(realsolid)],
// 1 16 -18.5 3.5 17 0 0 1.5 -3.5 0 0 0 -1 0 rect3.dat
  [1,16,-18.5,3.5,17,0,0,1.5,-3.5,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__s__35787s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__35787s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
