...
use <../../p/4-4ndis.scad>
use <../../p/box4-7a.scad>
function ldraw_lib__s__u9004s01() = [
// 0 ~Electric Switch: Front with 2 Twin Plug Sockets (Obsolete)
// 0 Name: s\u9004s01.dat
...
module ldraw_lib__s__u9004s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u9004s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
