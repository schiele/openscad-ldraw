...
use <../../p/1-4cyli.scad>
use <../../p/box3u12.scad>
function ldraw_lib__s__6142617ss07() = [
// 0 ~Sticker  1.9 x  1.8 with Silver Air Vents on Black Background Left - Bottom Face
// 0 Name: s\6142617ss07.dat
...
module ldraw_lib__s__6142617ss07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6142617ss07(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__6142617ss07(line=0.2);