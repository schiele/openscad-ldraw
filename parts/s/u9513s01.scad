...
use <../../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__u9513s01(realsolid=false) = [
...
// 1 16 5 1.5 -36 5 0 0 0 0 -1.5 0 1 0 rect2p.dat
  [1,16,5,1.5,-36,5,0,0,0,0,-1.5,0,1,0, ldraw_lib__rect2p(realsolid)],
// 3 16 0 3 -36 10 3 -26 10 3 -36
  [3,16,0,3,-36,10,3,-26,10,3,-36],
// 3 16 10 0 -26 0 0 -36 10 0 -36
  [3,16,10,0,-26,0,0,-36,10,0,-36],
// 1 16 10 3 -26 0 0 10 0 -1 0 -10 0 0 48\1-4disc.dat
  [1,16,10,3,-26,0,0,10,0,-1,0,-10,0,0, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 10 0 -26 0 0 10 0 3 0 -10 0 0 48\1-4cylo.dat
  [1,16,10,0,-26,0,0,10,0,3,0,-10,0,0, ldraw_lib__48__1_4cylo(realsolid)],
// 1 16 10 0 -26 0 0 10 0 1 0 -10 0 0 48\1-4disc.dat
  [1,16,10,0,-26,0,0,10,0,1,0,-10,0,0, ldraw_lib__48__1_4disc(realsolid)],
// 4 16 20 0 -16 14 0 -16 10 0 -26 20 0 -26
  [4,16,20,0,-16,14,0,-16,10,0,-26,20,0,-26],
// 4 16 10 3 -26 14 3 -16 20 3 -16 20 3 -26
  [4,16,10,3,-26,14,3,-16,20,3,-16,20,3,-26],
// 1 16 20 1.5 -21 0 -1 0 0 0 1.5 -5 0 0 rect2p.dat
  [1,16,20,1.5,-21,0,-1,0,0,0,1.5,-5,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 14 0 -16 6 0 0 0 1 0 0 0 6 48\1-8disc.dat
  [1,16,14,0,-16,6,0,0,0,1,0,0,0,6, ldraw_lib__48__1_8disc(realsolid)],
// 1 16 14 3 -16 6 0 0 0 -3 0 0 0 6 48\1-8cylo.dat
  [1,16,14,3,-16,6,0,0,0,-3,0,0,0,6, ldraw_lib__48__1_8cylo(realsolid)],
// 1 16 14 3 -16 6 0 0 0 -1 0 0 0 6 48\1-8disc.dat
  [1,16,14,3,-16,6,0,0,0,-1,0,0,0,6, ldraw_lib__48__1_8disc(realsolid)],
// 1 16 10.71225 1.5 -4.28775 7.5303 -1 0 0 0 1.5 -7.4697 0 0 rect2p.dat
  [1,16,10.71225,1.5,-4.28775,7.5303,-1,0,0,0,1.5,-7.4697,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 0 0 0 0 4.5 0 3 0 4.5 0 0 1-8cyli.dat
  [1,16,0,0,0,0,0,4.5,0,3,0,4.5,0,0, ldraw_lib__1_8cyli(realsolid)],
// 1 16 0 3 0 0 0 4.5 0 1 0 4.5 0 0 1-8edge.dat
  [1,16,0,3,0,0,0,4.5,0,1,0,4.5,0,0, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 3 0 0 0 2 0 -1 0 2 0 0 1-8ring1.dat
  [1,16,0,3,0,0,0,2,0,-1,0,2,0,0, ldraw_lib__1_8ring1(realsolid)],
// 1 16 0 3 0 0 0 0.5 0 -1 0 0.5 0 0 1-8ring8.dat
  [1,16,0,3,0,0,0,0.5,0,-1,0,0.5,0,0, ldraw_lib__1_8ring8(realsolid)],
// 
...
module ldraw_lib__s__u9513s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u9513s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
