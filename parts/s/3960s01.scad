...
use <../../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3960s01(realsolid=false) = [
...
// 1 16 0 4 0 -9 0 0 0 -0.9 0 0 0 9 48\1-4disc.dat
  [1,16,0,4,0,-9,0,0,0,-0.9,0,0,0,9, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 0 4 0 0 0 9 0 -0.9 0 9 0 0 48\1-4disc.dat
  [1,16,0,4,0,0,0,9,0,-0.9,0,9,0,0, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 0 4 0 9 0 0 0 -0.9 0 0 0 -9 48\1-4disc.dat
  [1,16,0,4,0,9,0,0,0,-0.9,0,0,0,-9, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 0 4 0 0 0 -9 0 -0.9 0 -9 0 0 48\1-4disc.dat
  [1,16,0,4,0,0,0,-9,0,-0.9,0,-9,0,0, ldraw_lib__48__1_4disc(realsolid)],
...
// 1 16 0 4 0 0.9 0 0 0 0.9 0 0 0 0.9 s\3960s03.dat
  [1,16,0,4,0,0.9,0,0,0,0.9,0,0,0,0.9, ldraw_lib__s__3960s03(realsolid)],
...
// 1 16 0 11 0 8 0 0 0 5 0 0 0 8 4-4cyli.dat
  [1,16,0,11,0,8,0,0,0,5,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 11 0 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,0,11,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 11 0 2 0 0 0 -1 0 0 0 2 4-4ring4.dat
  [1,16,0,11,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring4(realsolid)],
// 1 16 0 4.15 0 10 0 0 0 6.85 0 0 0 10 4-4cyli.dat
  [1,16,0,4.15,0,10,0,0,0,6.85,0,0,0,10, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 4.15 0 10 0 0 0 1 0 0 0 10 4-4edge.dat
  [1,16,0,4.15,0,10,0,0,0,1,0,0,0,10, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 11 0 10 0 0 0 1 0 0 0 10 4-4edge.dat
  [1,16,0,11,0,10,0,0,0,1,0,0,0,10, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 0 -10 0 0 0 1 0 0 0 -10 48\1-4disc.dat
  [1,16,0,0,0,-10,0,0,0,1,0,0,0,-10, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 0 0 0 10 0 0 0 1 0 0 0 -10 48\1-4disc.dat
  [1,16,0,0,0,10,0,0,0,1,0,0,0,-10, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 0 0 0 -10 0 0 0 1 0 0 0 10 48\1-4disc.dat
  [1,16,0,0,0,-10,0,0,0,1,0,0,0,10, ldraw_lib__48__1_4disc(realsolid)],
...
// 1 16 0 11 0 -36 0 0 0 5 0 0 0 -36 48\1-4cyli.dat
  [1,16,0,11,0,-36,0,0,0,5,0,0,0,-36, ldraw_lib__48__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 11 0 36 0 0 0 5 0 0 0 -36 48\1-4cyli.dat
  [1,16,0,11,0,36,0,0,0,5,0,0,0,-36, ldraw_lib__48__1_4cyli(realsolid)],
...
// 1 16 0 11 0 -36 0 0 0 1 0 0 0 -36 48\1-4edge.dat
  [1,16,0,11,0,-36,0,0,0,1,0,0,0,-36, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 0 11 0 36 0 0 0 1 0 0 0 -36 48\1-4edge.dat
  [1,16,0,11,0,36,0,0,0,1,0,0,0,-36, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 0 11 0 -36 0 0 0 1 0 0 0 36 48\1-4edge.dat
  [1,16,0,11,0,-36,0,0,0,1,0,0,0,36, ldraw_lib__48__1_4edge(realsolid)],
...
// 1 16 0 16 0 -36 0 0 0 1 0 0 0 -36 48\1-4edge.dat
  [1,16,0,16,0,-36,0,0,0,1,0,0,0,-36, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 0 16 0 36 0 0 0 1 0 0 0 -36 48\1-4edge.dat
  [1,16,0,16,0,36,0,0,0,1,0,0,0,-36, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 0 16 0 4 0 0 0 -4 0 0 0 -4 48\1-4ring9.dat
  [1,16,0,16,0,4,0,0,0,-4,0,0,0,-4, ldraw_lib__48__1_4ring9(realsolid)],
// 1 16 0 16 0 0 0 -4 0 -4 0 -4 0 0 48\1-4ring9.dat
  [1,16,0,16,0,0,0,-4,0,-4,0,-4,0,0, ldraw_lib__48__1_4ring9(realsolid)],
// 1 16 0 16 0 -4 0 0 0 -4 0 0 0 4 48\1-4ring9.dat
  [1,16,0,16,0,-4,0,0,0,-4,0,0,0,4, ldraw_lib__48__1_4ring9(realsolid)],
// 1 16 0 16 0 0 0 4 0 -4 0 4 0 0 48\1-4ring9.dat
  [1,16,0,16,0,0,0,4,0,-4,0,4,0,0, ldraw_lib__48__1_4ring9(realsolid)],
...
// 1 16 0 8 0 -40 0 0 0 8 0 0 0 -40 48\1-4cyli.dat
  [1,16,0,8,0,-40,0,0,0,8,0,0,0,-40, ldraw_lib__48__1_4cyli(realsolid)],
// 1 16 0 8 0 40 0 0 0 8 0 0 0 -40 48\1-4cyli.dat
  [1,16,0,8,0,40,0,0,0,8,0,0,0,-40, ldraw_lib__48__1_4cyli(realsolid)],
// 1 16 0 8 0 -40 0 0 0 8 0 0 0 40 48\1-4cyli.dat
  [1,16,0,8,0,-40,0,0,0,8,0,0,0,40, ldraw_lib__48__1_4cyli(realsolid)],
...
// 1 16 0 8 0 -40 0 0 0 1 0 0 0 -40 48\1-4edge.dat
  [1,16,0,8,0,-40,0,0,0,1,0,0,0,-40, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 0 8 0 40 0 0 0 1 0 0 0 -40 48\1-4edge.dat
  [1,16,0,8,0,40,0,0,0,1,0,0,0,-40, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 0 8 0 -40 0 0 0 1 0 0 0 40 48\1-4edge.dat
  [1,16,0,8,0,-40,0,0,0,1,0,0,0,40, ldraw_lib__48__1_4edge(realsolid)],
...
// 1 16 0 16 0 -40 0 0 0 1 0 0 0 -40 48\1-4edge.dat
  [1,16,0,16,0,-40,0,0,0,1,0,0,0,-40, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 0 16 0 40 0 0 0 1 0 0 0 -40 48\1-4edge.dat
  [1,16,0,16,0,40,0,0,0,1,0,0,0,-40, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 0 16 0 -40 0 0 0 1 0 0 0 40 48\1-4edge.dat
  [1,16,0,16,0,-40,0,0,0,1,0,0,0,40, ldraw_lib__48__1_4edge(realsolid)],
...
module ldraw_lib__s__3960s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3960s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
