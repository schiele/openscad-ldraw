...
use <../../p/stug-2x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__40902s01(realsolid=false) = [
...
// 1 16 16.5 13.5 0 0 -.5 0 0 0 9.5 -16 0 0 box2-7.dat
  [1,16,16.5,13.5,0,0,-.5,0,0,0,9.5,-16,0,0, ldraw_lib__box2_7(realsolid)],
...
// 1 16 -16 14 0 0 -1 0 -10 0 0 0 0 -16 rect2p.dat
  [1,16,-16,14,0,0,-1,0,-10,0,0,0,0,-16, ldraw_lib__rect2p(realsolid)],
// 1 16 0 24 0 0 0 -16 0 -1 0 -16 0 0 recte3.dat
  [1,16,0,24,0,0,0,-16,0,-1,0,-16,0,0, ldraw_lib__recte3(realsolid)],
// 1 16 0 4 0 0 0 -16 0 -1 0 -16 0 0 recte4.dat
  [1,16,0,4,0,0,0,-16,0,-1,0,-16,0,0, ldraw_lib__recte4(realsolid)],
// 
...
// 1 16 0 16 0 8 0 0 0 -12 0 0 0 8 4-4cyli.dat
  [1,16,0,16,0,8,0,0,0,-12,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
// 
// 0 // Fillets
// 1 16 11.9 4 0 4.1 0 0 0 10 0 0 0 1 box3u4p.dat
  [1,16,11.9,4,0,4.1,0,0,0,10,0,0,0,1, ldraw_lib__box3u4p(realsolid)],
// 1 16 0 4 -11.9 0 0 1 0 10 0 -4.1 0 0 box3u4p.dat
  [1,16,0,4,-11.9,0,0,1,0,10,0,-4.1,0,0, ldraw_lib__box3u4p(realsolid)],
// 1 16 -11.9 4 0 -4.1 0 0 0 10 0 0 0 -1 box3u4p.dat
  [1,16,-11.9,4,0,-4.1,0,0,0,10,0,0,0,-1, ldraw_lib__box3u4p(realsolid)],
// 1 16 0 4 11.9 0 0 -1 0 10 0 4.1 0 0 box3u4p.dat
  [1,16,0,4,11.9,0,0,-1,0,10,0,4.1,0,0, ldraw_lib__box3u4p(realsolid)],
...
// 1 16 -2 24 0 0 0 -18 0 -1 0 -20 0 0 recte3.dat
  [1,16,-2,24,0,0,0,-18,0,-1,0,-20,0,0, ldraw_lib__recte3(realsolid)],
// 1 16 -20 12 0 0 1 0 12 0 0 0 0 -20 rect2p.dat
  [1,16,-20,12,0,0,1,0,12,0,0,0,0,-20, ldraw_lib__rect2p(realsolid)],
// 4 16 20 0 -20 -20 0 -20 -20 24 -20 20 20 -20
  [4,16,20,0,-20,-20,0,-20,-20,24,-20,20,20,-20],
// 1 16 18 22 0 0 0 2 0 -1 -2 20 0 0 recte3.dat
  [1,16,18,22,0,0,0,2,0,-1,-2,20,0,0, ldraw_lib__recte3(realsolid)],
// 1 16 16.5 23.5 0 0 0 .5 0 -1 -.5 16 0 0 recte3.dat
  [1,16,16.5,23.5,0,0,0,.5,0,-1,-.5,16,0,0, ldraw_lib__recte3(realsolid)],
...
// 1 16 0 0 0 0 0 -20 0 -1 0 -20 0 0 recte4.dat
  [1,16,0,0,0,0,0,-20,0,-1,0,-20,0,0, ldraw_lib__recte4(realsolid)],
...
module ldraw_lib__s__40902s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__40902s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
