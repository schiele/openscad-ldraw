...
$fa=1; $fs=0.2;
function ldraw_lib__s__42607s01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\42607s03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__42607s03(realsolid)],
// 
// 0 // 2 x 4 Brick
...
// 1 16 -4 6 -48 0 1 0 0 0 2 8 0 0 rect.dat
  [1,16,-4,6,-48,0,1,0,0,0,2,8,0,0, ldraw_lib__rect(realsolid)],
// 2 24 -4 8 -40 0 8 -40
  [2,24,-4,8,-40,0,8,-40],
// 2 24 0 8 -60 0 8 -40
  [2,24,0,8,-60,0,8,-40],
...
// 1 16 -81.75865 6 -56 0 0 -77.75865 2 0 0 0 -1 0 rect3.dat
  [1,16,-81.75865,6,-56,0,0,-77.75865,2,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
// 
// 1 16 -30 4 -50 1 0 0 0 -1 0 0 0 1 stug3-1x2.dat
  [1,16,-30,4,-50,1,0,0,0,-1,0,0,0,1, ldraw_lib__stug3_1x2(realsolid)],
// 
// 0 // Slanted Part
// 1 16 -160 0 -40 1 0 0 0 1 0 0 0 1 s\42607s04.dat
  [1,16,-160,0,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__s__42607s04(realsolid)],
// 1 16 -231.96 6 -37.887 0 -1 -4.04 2 0 0 0 0 1.01 rect3.dat
  [1,16,-231.96,6,-37.887,0,-1,-4.04,2,0,0,0,0,1.01, ldraw_lib__rect3(realsolid)],
// 1 16 -80 4 -60 0 0 -80 -4 0 0 0 1 0 rect3.dat
  [1,16,-80,4,-60,0,0,-80,-4,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__s__42607s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__42607s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
