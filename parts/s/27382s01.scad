...
use <27382s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__27382s01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\27382s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__27382s02(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -133.5 0 -2.5 0 0 22 20 0 0 0 5 0 48\2-4cylo.dat
  [1,16,-133.5,0,-2.5,0,0,22,20,0,0,0,5,0, ldraw_lib__48__2_4cylo(realsolid)],
...
// 1 16 -133.5 -36 0 0 1 0 0 0 16 2.5 0 0 rect3.dat
  [1,16,-133.5,-36,0,0,1,0,0,0,16,2.5,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 -133.5 36 0 0 1 0 0 0 -16 -2.5 0 0 rect3.dat
  [1,16,-133.5,36,0,0,1,0,0,0,-16,-2.5,0,0, ldraw_lib__rect3(realsolid)],
];
module ldraw_lib__s__27382s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__27382s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
