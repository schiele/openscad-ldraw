...
use <3350bs02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3350s01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3350bs02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3350bs02(realsolid)],
// 0 //
// 1 16 0 -88 2 -20 0 0 0 0 20 0 -20 0 4-4disc.dat
  [1,16,0,-88,2,-20,0,0,0,0,20,0,-20,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 -88 -2 20 0 0 0 0 20 0 4 0 4-4cyli.dat
  [1,16,0,-88,-2,20,0,0,0,0,20,0,4,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -88 2 -7.6536 0 -18.4774 18.4774 0 -7.6536 0 20 0 7-8edge.dat
  [1,16,0,-88,2,-7.6536,0,-18.4774,18.4774,0,-7.6536,0,20,0, ldraw_lib__7_8edge(realsolid)],
...
module ldraw_lib__s__3350s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3350s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__3350s01(line=0.2);