...
// 1 16 0 2 240 -280 0 0 0 0 2 0 -1 0 rect2p.dat
  [1,16,0,2,240,-280,0,0,0,0,2,0,-1,0, ldraw_lib__rect2p()],
// 1 16 0 2 -240 -280 0 0 0 0 2 0 1 0 rect2p.dat
  [1,16,0,2,-240,-280,0,0,0,0,2,0,1,0, ldraw_lib__rect2p()],
// 1 16 -320 2 0 0 1 0 0 0 2 -200 0 0 rect2p.dat
  [1,16,-320,2,0,0,1,0,0,0,2,-200,0,0, ldraw_lib__rect2p()],
...
module ldraw_lib__s__10s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__10s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
