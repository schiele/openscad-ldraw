...
use <../../p/rect1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__95673s01(realsolid=false) = [
...
// 1 16 4 -6 4 1.75 0 0 0 2 0 0 0 3 1-4edge.dat
  [1,16,4,-6,4,1.75,0,0,0,2,0,0,0,3, ldraw_lib__1_4edge(realsolid)],
// 1 16 -4 -6 4 -1.75 0 0 0 2 0 0 0 3 1-4edge.dat
  [1,16,-4,-6,4,-1.75,0,0,0,2,0,0,0,3, ldraw_lib__1_4edge(realsolid)],
// 4 16 5.75 -6 0 5.75 -6 4 4 -6 4 2 -6 0
  [4,16,5.75,-6,0,5.75,-6,4,4,-6,4,2,-6,0],
// 1 16 4 -6 4 1.75 0 0 0 2 0 0 0 3 1-4disc.dat
  [1,16,4,-6,4,1.75,0,0,0,2,0,0,0,3, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 5.75 -5 2 0 -1 0 -1 0 0 0 0 2 rect1.dat
  [1,16,5.75,-5,2,0,-1,0,-1,0,0,0,0,2, ldraw_lib__rect1(realsolid)],
// 1 16 4 -6 4 1.75 0 0 0 2 0 0 0 3 1-4cyli.dat
  [1,16,4,-6,4,1.75,0,0,0,2,0,0,0,3, ldraw_lib__1_4cyli(realsolid)],
// 1 16 0 -5 7 0 0 -4 -1 0 0 0 -1 0 rect1.dat
  [1,16,0,-5,7,0,0,-4,-1,0,0,0,-1,0, ldraw_lib__rect1(realsolid)],
// 1 16 -4 -6 4 -1.75 0 0 0 2 0 0 0 3 1-4cyli.dat
  [1,16,-4,-6,4,-1.75,0,0,0,2,0,0,0,3, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -5.75 -5 2 0 1 0 -1 0 0 0 0 2 rect1.dat
  [1,16,-5.75,-5,2,0,1,0,-1,0,0,0,0,2, ldraw_lib__rect1(realsolid)],
// 1 16 4 -4 0 0 0 1.75 4 0 0 0 4 0 1-4cyli.dat
  [1,16,4,-4,0,0,0,1.75,4,0,0,0,4,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 4 -4 4 1.75 0 0 0 4 0 0 0 3 1-8sphe.dat
  [1,16,4,-4,4,1.75,0,0,0,4,0,0,0,3, ldraw_lib__1_8sphe(realsolid)],
// 1 16 4 -4 4 0 -8 0 4 0 0 0 0 3 1-4cyli.dat
  [1,16,4,-4,4,0,-8,0,4,0,0,0,0,3, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -4 -4 4 -1.75 0 0 0 4 0 0 0 3 1-8sphe.dat
  [1,16,-4,-4,4,-1.75,0,0,0,4,0,0,0,3, ldraw_lib__1_8sphe(realsolid)],
// 1 16 -4 -4 0 0 0 -1.75 4 0 0 0 4 0 1-4cyli.dat
  [1,16,-4,-4,0,0,0,-1.75,4,0,0,0,4,0, ldraw_lib__1_4cyli(realsolid)],
...
module ldraw_lib__s__95673s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__95673s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
