...
use <../../p/triangle.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__4080s01(realsolid=false) = [
...
// 1 16 19.5 -.9 71 2.5 0 0 0 8.9 0 0 -9 2 box2-7.dat
  [1,16,19.5,-.9,71,2.5,0,0,0,8.9,0,0,-9,2, ldraw_lib__box2_7(realsolid)],
// 1 16 -19.5 -.9 71 2.5 0 0 0 8.9 0 0 -9 2 box2-7.dat
  [1,16,-19.5,-.9,71,2.5,0,0,0,8.9,0,0,-9,2, ldraw_lib__box2_7(realsolid)],
...
// 1 16 10 4 -30 1 0 0 0 -1 0 0 0 1 stug4-2x2.dat
  [1,16,10,4,-30,1,0,0,0,-1,0,0,0,1, ldraw_lib__stug4_2x2(realsolid)],
// 1 16 -20 4 -30 0 0 1 0 -1 0 -1 0 0 stug4-1x2.dat
  [1,16,-20,4,-30,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stug4_1x2(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 36 0 0 0 -4 0 0 0 56 box5.dat
  [1,16,0,8,0,36,0,0,0,-4,0,0,0,56, ldraw_lib__box5(realsolid)],
// 
// 0 // Front underside
...
// 1 16 0 6 -70.454545 36 0 0 0 0 -2 0 1 -.454545 recte3.dat
  [1,16,0,6,-70.454545,36,0,0,0,0,-2,0,1,-.454545, ldraw_lib__recte3(realsolid)],
// 1 16 0 8 -65 36 0 0 0 -1 0 0 0 5 recte3.dat
  [1,16,0,8,-65,36,0,0,0,-1,0,0,0,5, ldraw_lib__recte3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 6 -65.454545 36 0 0 0 -2 0 0 0 5.454545 box2-7.dat
  [1,16,0,6,-65.454545,36,0,0,0,-2,0,0,0,5.454545, ldraw_lib__box2_7(realsolid)],
// 
// 0 // Rear underside left
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 22 3 60 0 14 0 5 0 0 0 0 5 tri3a1.dat
  [1,16,22,3,60,0,14,0,5,0,0,0,0,5, ldraw_lib__tri3a1(realsolid)],
...
// 1 16 0 5.5 62.5 17 0 0 0 -2.5 0 0 0 -2.5 box2-5.dat
  [1,16,0,5.5,62.5,17,0,0,0,-2.5,0,0,0,-2.5, ldraw_lib__box2_5(realsolid)],
...
// 1 16 44 -14 -57.5 0 2 -4 0 0 22 -2.5 0 0 box4-2p.dat
  [1,16,44,-14,-57.5,0,2,-4,0,0,22,-2.5,0,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 44 -14 -20.5 0 2 -4 0 0 22 -2.5 0 0 box4-2p.dat
  [1,16,44,-14,-20.5,0,2,-4,0,0,22,-2.5,0,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 44 -14 20.5 0 2 -4 0 0 22 -2.5 0 0 box4-2p.dat
  [1,16,44,-14,20.5,0,2,-4,0,0,22,-2.5,0,0, ldraw_lib__box4_2p(realsolid)],
...
// 1 16 41 8 57.5 1 0 0 0 -1 0 0 0 2.5 rect2a.dat
  [1,16,41,8,57.5,1,0,0,0,-1,0,0,0,2.5, ldraw_lib__rect2a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 45 -14 -39 0 -1 4 0 0 -22 -16 0 0 box2-9p.dat
  [1,16,45,-14,-39,0,-1,4,0,0,-22,-16,0,0, ldraw_lib__box2_9p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 45 -14 0 0 -1 4 0 0 -22 -18 0 0 box2-9p.dat
  [1,16,45,-14,0,0,-1,4,0,0,-22,-18,0,0, ldraw_lib__box2_9p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 45 -14 39 -1 4 0 0 -22 0 0 0 16 box3-5a.dat
  [1,16,45,-14,39,-1,4,0,0,-22,0,0,0,16, ldraw_lib__box3_5a(realsolid)],
// 2 24 49.597364 -34 60 42 8 60
  [2,24,49.597364,-34,60,42,8,60],
// 2 24 49.597364 -34 60 48 -34 60
  [2,24,49.597364,-34,60,48,-34,60],
// 1 16 48 -34 60 -4 -1 -8 22 0 42 20 0 0 triangle.dat
  [1,16,48,-34,60,-4,-1,-8,22,0,42,20,0,0, ldraw_lib__triangle(realsolid)],
// 1 16 49 -36 -70 -1 0 0 0 -1 0 0 0 -10 rect3.dat
  [1,16,49,-36,-70,-1,0,0,0,-1,0,0,0,-10, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 -3.4 73.5 17 0 0 0 -7.5 -1.1 0 7.5 -1 box2-7.dat
  [1,16,0,-3.4,73.5,17,0,0,0,-7.5,-1.1,0,7.5,-1, ldraw_lib__box2_7(realsolid)],
...
// 1 16 0 0 -3 39 0 0 0 1 0 0 0 -65 rect.dat
  [1,16,0,0,-3,39,0,0,0,1,0,0,0,-65, ldraw_lib__rect(realsolid)],
// 0 // rear inside
...
// 1 16 0 -40 -10 46 0 0 0 1 0 0 0 -70 recte3.dat
  [1,16,0,-40,-10,46,0,0,0,1,0,0,0,-70, ldraw_lib__recte3(realsolid)],
// 
...
// 1 16 0 -32 -89.545454 40 0 0 0 1 0 0 0 10.454545 recte4.dat
  [1,16,0,-32,-89.545454,40,0,0,0,1,0,0,0,10.454545, ldraw_lib__recte4(realsolid)],
...
// 1 16 0 -36 -90 1 0 0 0 -1 0 0 0 1 stug3-1x3.dat
  [1,16,0,-36,-90,1,0,0,0,-1,0,0,0,1, ldraw_lib__stug3_1x3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -36 -90 36 0 0 0 4 0 0 0 6 box4.dat
  [1,16,0,-36,-90,36,0,0,0,4,0,0,0,6, ldraw_lib__box4(realsolid)],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 45 -35 -90 0 -5 0 0 0 -3 -6 0 0 box2-11.dat
  [1,16,45,-35,-90,0,-5,0,0,0,-3,-6,0,0, ldraw_lib__box2_11(realsolid)],
// 1 16 40 -38 -96 0 0 10 6 0 0 0 -1 0 triangle.dat
  [1,16,40,-38,-96,0,0,10,6,0,0,0,-1,0, ldraw_lib__triangle(realsolid)],
// 1 16 40 -38 -84 0 0 10 6 0 0 0 1 0 triangle.dat
  [1,16,40,-38,-84,0,0,10,6,0,0,0,1,0, ldraw_lib__triangle(realsolid)],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -45 -35 -90 0 5 0 0 0 -3 -6 0 0 box2-11.dat
...
// 1 16 45 -35 -98 0 0 5 0 -1 -3 -2 0 0 rect1.dat
  [1,16,45,-35,-98,0,0,5,0,-1,-3,-2,0,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 0 -39 -100 -50 0 0 0 0 -1 0 1 0 rect3.dat
  [1,16,0,-39,-100,-50,0,0,0,0,-1,0,1,0, ldraw_lib__rect3(realsolid)],
// 
...
module ldraw_lib__s__4080s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__4080s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__4080s01(line=0.2);