...
use <../../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__6881s01(realsolid=false) = [
...
// 1 16 0 8 0 56 0 0 0 -4 0 0 0 56 box5.dat
  [1,16,0,8,0,56,0,0,0,-4,0,0,0,56, ldraw_lib__box5(realsolid)],
...
// 1 16 0 8 0 59 0 0 0 -1 0 0 0 59 box4.dat
  [1,16,0,8,0,59,0,0,0,-1,0,0,0,59, ldraw_lib__box4(realsolid)],
...
// 1 16 0 7 0 60 0 0 0 -7 0 0 0 60 box4.dat
  [1,16,0,7,0,60,0,0,0,-7,0,0,0,60, ldraw_lib__box4(realsolid)],
// 0
];
module ldraw_lib__s__6881s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6881s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
