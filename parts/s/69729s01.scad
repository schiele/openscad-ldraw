...
$fa=1; $fs=0.2;
function ldraw_lib__s__69729s01(realsolid=false) = [
...
// 1 16 0 0 0 60 0 0 0 7 0 0 0 20 box4.dat
  [1,16,0,0,0,60,0,0,0,7,0,0,0,20, ldraw_lib__box4(realsolid)],
// 1 16 0 7 0 59 0 0 0 1 0 0 0 19 box4.dat
  [1,16,0,7,0,59,0,0,0,1,0,0,0,19, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__s__69729s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__69729s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
