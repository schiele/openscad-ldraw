...
// 1 16 90 0 90 0 0 1 0 1 0 -1 0 0 stug7.dat
  [1,16,90,0,90,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug7()],
// 1 16 120 0 -20 0 0 1 0 1 0 -1 0 0 stug4.dat
  [1,16,120,0,-20,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug4()],
// 1 16 -20 0 120 0 0 1 0 1 0 -1 0 0 stug4.dat
  [1,16,-20,0,120,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug4()],
// 1 16 -80 0 140 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-80,0,140,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 140 0 -80 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,140,0,-80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 150 0 -170 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,150,0,-170,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
...
// 1 16 150 0 -110 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,150,0,-110,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 130 0 -110 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,130,0,-110,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 150 0 -150 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,150,0,-150,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 110 0 -70 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,110,0,-70,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
...
// 1 16 -110 0 150 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-110,0,150,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 -110 0 130 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-110,0,130,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 -70 0 110 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-70,0,110,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 -170 0 150 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-170,0,150,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 80 0 240 0 0 1 0 1 0 -1 0 0 stug8.dat
  [1,16,80,0,240,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug8()],
// 1 16 -80 0 240 0 0 1 0 1 0 -1 0 0 stug8.dat
  [1,16,-80,0,240,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug8()],
// 1 16 -240 0 240 0 0 1 0 1 0 -1 0 0 stug8.dat
  [1,16,-240,0,240,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug8()],
...
// 1 16 -200 0 -300 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-200,0,-300,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -200 0 -260 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-200,0,-260,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -260 0 -200 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-260,0,-200,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -300 0 -200 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-300,0,-200,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
...
// 1 16 -210 0 -230 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-210,0,-230,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
...
module ldraw_lib__s__613s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__613s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
