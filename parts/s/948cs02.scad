...
use <../../p/rect.scad>
use <3228s01.scad>
function ldraw_lib__s__948cs02() = [
// 0 ~Train Track  4.5V Point Left - Slotted Ridged Rail End
// 0 Name: s\948cs02.dat
...
// 2 24 6.25 0 -2 5 1 -2
  [2,24,6.25,0,-2,5,1,-2],
// 4 16 10 1 -2 10 1 2 6.25 0 2 6.25 0 -2
  [4,16,10,1,-2,10,1,2,6.25,0,2,6.25,0,-2],
// 3 16 5 1 -2 10 1 -2 6.25 0 -2
  [3,16,5,1,-2,10,1,-2,6.25,0,-2],
...
// 2 24 6.25 0 2 10 1 2
  [2,24,6.25,0,2,10,1,2],
// 4 16 6.25 0 -2 6.25 0 2 5 1 2 5 1 -2
  [4,16,6.25,0,-2,6.25,0,2,5,1,2,5,1,-2],
// 3 16 6.25 0 2 10 1 2 5 1 2
  [3,16,6.25,0,2,10,1,2,5,1,2],
...
module ldraw_lib__s__948cs02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__948cs02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__948cs02(line=0.2);