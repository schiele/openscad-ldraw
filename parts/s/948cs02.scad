...
use <3228s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__948cs02(realsolid=false) = [
...
// 2 24 6.25 0 -2 5 1 -2
  [2,24,6.25,0,-2,5,1,-2],
// 4 16 6.25 0 -2 6.25 0 2 10 1 2 10 1 -2
  [4,16,6.25,0,-2,6.25,0,2,10,1,2,10,1,-2],
...
// 2 24 6.25 0 2 10 1 2
  [2,24,6.25,0,2,10,1,2],
// 4 16 5 1 -2 5 1 2 6.25 0 2 6.25 0 -2
  [4,16,5,1,-2,5,1,2,6.25,0,2,6.25,0,-2],
...
module ldraw_lib__s__948cs02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__948cs02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
