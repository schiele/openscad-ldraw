...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__15118s03(realsolid=false) = [
...
// 1 16 0 -5 0 0 0 4 0 1 0 18.75 0 0 rect2p.dat
  [1,16,0,-5,0,0,0,4,0,1,0,18.75,0,0, ldraw_lib__rect2p(realsolid)],
// 
// 1 16 0 0 11.68187 4 0 0 0 -1 0 0 0 -7.06813 rect3.dat
  [1,16,0,0,11.68187,4,0,0,0,-1,0,0,0,-7.06813, ldraw_lib__rect3(realsolid)],
// 1 16 0 0 -11.68187 4 0 0 0 -1 0 0 0 7.06813 rect3.dat
  [1,16,0,0,-11.68187,4,0,0,0,-1,0,0,0,7.06813, ldraw_lib__rect3(realsolid)],
// 
// 1 16 0 -0.25888 4.44075 0 0 -4 0.25888 0 0 0.17298 1 0 rect2p.dat
  [1,16,0,-0.25888,4.44075,0,0,-4,0.25888,0,0,0.17298,1,0, ldraw_lib__rect2p(realsolid)],
// 5 24 4 -0.51777 4.26777 -4 -0.51777 4.26777 -4 0 4.61373 -4 -1.0597 3.45671
  [5,24,4,-0.51777,4.26777,-4,-0.51777,4.26777,-4,0,4.61373,-4,-1.0597,3.45671],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -4 1.25 2.5 0 8 0 -2.5 0 0 0 0 2.5 1-8cylo.dat
  [1,16,-4,1.25,2.5,0,8,0,-2.5,0,0,0,0,2.5, ldraw_lib__1_8cylo(realsolid)],
// 1 16 0 -1.25 0 0 0 4 0 -1 0 -2.5 0 0 rect2p.dat
  [1,16,0,-1.25,0,0,0,4,0,-1,0,-2.5,0,0, ldraw_lib__rect2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -4 1.25 -2.5 0 8 0 -2.5 0 0 0 0 -2.5 1-8cylo.dat
  [1,16,-4,1.25,-2.5,0,8,0,-2.5,0,0,0,0,-2.5, ldraw_lib__1_8cylo(realsolid)],
...
// 1 16 4 1.25 2.5 0 -1 0 -2.5 0 0 0 0 2.5 1-8ndis.dat
  [1,16,4,1.25,2.5,0,-1,0,-2.5,0,0,0,0,2.5, ldraw_lib__1_8ndis(realsolid)],
...
module ldraw_lib__s__15118s03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__15118s03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
