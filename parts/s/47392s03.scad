...
use <../../p/1-4cyli.scad>
use <../../p/1-8sphe.scad>
function ldraw_lib__s__47392s03() = [
...
// 1 16 20 -14 15 0 -2 5 0 -28 0 5 0 0 1-4cyli.dat
  [1,16,20,-14,15,0,-2,5,0,-28,0,5,0,0, ldraw_lib__1_4cyli()],
// 1 16 18 -42 15 0 0 5 0 -5 0 5 0 0 1-8sphe.dat
  [1,16,18,-42,15,0,0,5,0,-5,0,5,0,0, ldraw_lib__1_8sphe()],
// 1 16 -20 -14 15 0 2 -5 0 -28 0 5 0 0 1-4cyli.dat
  [1,16,-20,-14,15,0,2,-5,0,-28,0,5,0,0, ldraw_lib__1_4cyli()],
// 1 16 -18 -42 15 0 0 -5 0 -5 0 5 0 0 1-8sphe.dat
  [1,16,-18,-42,15,0,0,-5,0,-5,0,5,0,0, ldraw_lib__1_8sphe()],
// 1 16 -18 -42 15 0 36 0 -5 0 0 0 0 5 1-4cyli.dat
  [1,16,-18,-42,15,0,36,0,-5,0,0,0,0,5, ldraw_lib__1_4cyli()],
...
module ldraw_lib__s__47392s03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__47392s03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
