...
use <191915sbea.scad>
use <191915sbeb.scad>
function ldraw_lib__s__191915sbe() = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\191915sbea.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__191915sbea()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\191915sbeb.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__191915sbeb()],
];
module ldraw_lib__s__191915sbe(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__191915sbe(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
