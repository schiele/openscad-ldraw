...
use <../../p/3-16cyls.scad>
use <../../p/5-16cyli.scad>
function ldraw_lib__s__47205s02() = [
...
// 1 16 16 -37 6 0 -11.5 0 -13 0 0 0 0 -13 5-16cyli.dat
  [1,16,16,-37,6,0,-11.5,0,-13,0,0,0,0,-13, ldraw_lib__5_16cyli()],
// 1 16 4.5 -37 6 0 18.62952 0 13 0 0 0 0 -13 3-16cyls.dat
  [1,16,4.5,-37,6,0,18.62952,0,13,0,0,0,0,-13, ldraw_lib__3_16cyls()],
// 1 16 -16 -37 6 0 11.5 0 -13 0 0 0 0 -13 5-16cyli.dat
  [1,16,-16,-37,6,0,11.5,0,-13,0,0,0,0,-13, ldraw_lib__5_16cyli()],
// 1 16 -4.5 -37 6 0 -18.62952 0 13 0 0 0 0 -13 3-16cyls.dat
  [1,16,-4.5,-37,6,0,-18.62952,0,13,0,0,0,0,-13, ldraw_lib__3_16cyls()],
// 1 16 4.5 -37 6 0 -9 0 -13 0 0 0 0 -13 2-4cyli.dat
  [1,16,4.5,-37,6,0,-9,0,-13,0,0,0,0,-13, ldraw_lib__2_4cyli()],
];
module ldraw_lib__s__47205s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__47205s02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
