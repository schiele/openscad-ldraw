...
use <../../p/2-4ndis.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__41752s01(realsolid=false) = [
...
// 1 16 4.875 -30 -2.625 1.625 0 0 0 -3 0 0 0 1.625 2-4edge.dat
  [1,16,4.875,-30,-2.625,1.625,0,0,0,-3,0,0,0,1.625, ldraw_lib__2_4edge(realsolid)],
// 1 16 4.875 -30 2.625 1.625 0 0 0 -3 0 0 0 -1.625 2-4edge.dat
  [1,16,4.875,-30,2.625,1.625,0,0,0,-3,0,0,0,-1.625, ldraw_lib__2_4edge(realsolid)],
// 1 16 4.875 -29.5 2.625 1.625 0 0 0 1 0 0 0 -1.625 2-4disc.dat
  [1,16,4.875,-29.5,2.625,1.625,0,0,0,1,0,0,0,-1.625, ldraw_lib__2_4disc(realsolid)],
// 1 16 4.875 -29.5 -2.625 1.625 0 0 0 1 0 0 0 1.625 2-4disc.dat
  [1,16,4.875,-29.5,-2.625,1.625,0,0,0,1,0,0,0,1.625, ldraw_lib__2_4disc(realsolid)],
...
// 1 16 4.875 -30 2.625 1.625 0 0 0 1 0 0 0 -1.625 2-4ndis.dat
  [1,16,4.875,-30,2.625,1.625,0,0,0,1,0,0,0,-1.625, ldraw_lib__2_4ndis(realsolid)],
// 1 16 4.875 -30 -2.625 1.625 0 0 0 1 0 0 0 1.625 2-4ndis.dat
  [1,16,4.875,-30,-2.625,1.625,0,0,0,1,0,0,0,1.625, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 4.875 -30 -2.625 1.625 0 0 0 0.5 0 0 0 1.625 2-4cyli.dat
  [1,16,4.875,-30,-2.625,1.625,0,0,0,0.5,0,0,0,1.625, ldraw_lib__2_4cyli(realsolid)],
// 1 16 4.875 -29.5 -2.625 1.625 0 0 0 -3 0 0 0 1.625 2-4edge.dat
  [1,16,4.875,-29.5,-2.625,1.625,0,0,0,-3,0,0,0,1.625, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 4.875 -29.5 2.625 1.625 0 0 0 1 0 0 0 -1.625 2-4edge.dat
  [1,16,4.875,-29.5,2.625,1.625,0,0,0,1,0,0,0,-1.625, ldraw_lib__2_4edge(realsolid)],
// 2 24 3.25 -29.5 20 3.25 -29.5 2.625
  [2,24,3.25,-29.5,20,3.25,-29.5,2.625],
// 2 24 6.5 -29.5 20 6.5 -29.5 2.625
  [2,24,6.5,-29.5,20,6.5,-29.5,2.625],
...
module ldraw_lib__s__41752s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__41752s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
