...
use <../../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2582s01(realsolid=false) = [
...
// 1 16 36 68 -26 0 1 0 0 0 4 4 0 0 2-4edge.dat
  [1,16,36,68,-26,0,1,0,0,0,4,4,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 22 68 -26 0 1 0 0 0 4 4 0 0 2-4edge.dat
  [1,16,22,68,-26,0,1,0,0,0,4,4,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 18 68 -26 0 1 0 0 0 4 4 0 0 2-4edge.dat
  [1,16,18,68,-26,0,1,0,0,0,4,4,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 2 68 -26 0 1 0 0 0 4 4 0 0 2-4edge.dat
  [1,16,2,68,-26,0,1,0,0,0,4,4,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -2 68 -26 0 1 0 0 0 4 4 0 0 2-4edge.dat
  [1,16,-2,68,-26,0,1,0,0,0,4,4,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -18 68 -26 0 1 0 0 0 4 4 0 0 2-4edge.dat
  [1,16,-18,68,-26,0,1,0,0,0,4,4,0,0, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 29 68 -24 3 0 0 0 1 0 0 0 2 rect.dat
  [1,16,29,68,-24,3,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 10 68 -24 4 0 0 0 1 0 0 0 2 rect.dat
  [1,16,10,68,-24,4,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 -10 68 -24 4 0 0 0 1 0 0 0 2 rect.dat
  [1,16,-10,68,-24,4,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 -29 68 -24 3 0 0 0 1 0 0 0 2 rect.dat
  [1,16,-29,68,-24,3,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 -38 64 -26 -2 0 0 0 -1 0 0 0 4 rect.dat
  [1,16,-38,64,-26,-2,0,0,0,-1,0,0,0,4, ldraw_lib__rect(realsolid)],
// 1 16 -20 64 -26 -2 0 0 0 -1 0 0 0 4 rect.dat
  [1,16,-20,64,-26,-2,0,0,0,-1,0,0,0,4, ldraw_lib__rect(realsolid)],
// 1 16 0 64 -26 -2 0 0 0 -1 0 0 0 4 rect.dat
  [1,16,0,64,-26,-2,0,0,0,-1,0,0,0,4, ldraw_lib__rect(realsolid)],
// 1 16 20 64 -26 -2 0 0 0 -1 0 0 0 4 rect.dat
  [1,16,20,64,-26,-2,0,0,0,-1,0,0,0,4, ldraw_lib__rect(realsolid)],
// 1 16 38 64 -26 -2 0 0 0 -1 0 0 0 4 rect.dat
  [1,16,38,64,-26,-2,0,0,0,-1,0,0,0,4, ldraw_lib__rect(realsolid)],
// 1 16 34 60 -24 2 0 0 0 1 0 0 0 2 rect.dat
  [1,16,34,60,-24,2,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 20 60 -24 6 0 0 0 1 0 0 0 2 rect.dat
  [1,16,20,60,-24,6,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 0 60 -24 6 0 0 0 1 0 0 0 2 rect.dat
  [1,16,0,60,-24,6,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 -20 60 -24 6 0 0 0 1 0 0 0 2 rect.dat
  [1,16,-20,60,-24,6,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 -34 60 -24 2 0 0 0 1 0 0 0 2 rect.dat
  [1,16,-34,60,-24,2,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 38 8 0 -2 0 0 0 -1 0 0 0 10 rect.dat
  [1,16,38,8,0,-2,0,0,0,-1,0,0,0,10, ldraw_lib__rect(realsolid)],
// 1 16 30 8 -10 -1.5 0 0 0 -1 0 0 0 4 rect.dat
  [1,16,30,8,-10,-1.5,0,0,0,-1,0,0,0,4, ldraw_lib__rect(realsolid)],
// 1 16 22.5 8 -2 -1.5 0 0 0 -1 0 0 0 12 rect.dat
  [1,16,22.5,8,-2,-1.5,0,0,0,-1,0,0,0,12, ldraw_lib__rect(realsolid)],
// 1 16 17.5 8 -2 -1.5 0 0 0 -1 0 0 0 12 rect.dat
  [1,16,17.5,8,-2,-1.5,0,0,0,-1,0,0,0,12, ldraw_lib__rect(realsolid)],
// 1 16 10 8 -10 -1.5 0 0 0 -1 0 0 0 4 rect.dat
  [1,16,10,8,-10,-1.5,0,0,0,-1,0,0,0,4, ldraw_lib__rect(realsolid)],
// 1 16 2.5 8 -2 -1.5 0 0 0 -1 0 0 0 12 rect.dat
  [1,16,2.5,8,-2,-1.5,0,0,0,-1,0,0,0,12, ldraw_lib__rect(realsolid)],
// 1 16 -2.5 8 -2 -1.5 0 0 0 -1 0 0 0 12 rect.dat
  [1,16,-2.5,8,-2,-1.5,0,0,0,-1,0,0,0,12, ldraw_lib__rect(realsolid)],
// 1 16 -10 8 -10 -1.5 0 0 0 -1 0 0 0 4 rect.dat
  [1,16,-10,8,-10,-1.5,0,0,0,-1,0,0,0,4, ldraw_lib__rect(realsolid)],
...
// 1 16 20 4 0 -1 0 0 0 -1 0 0 0 10 rect.dat
  [1,16,20,4,0,-1,0,0,0,-1,0,0,0,10, ldraw_lib__rect(realsolid)],
// 1 16 0 4 0 -1 0 0 0 -1 0 0 0 10 rect.dat
  [1,16,0,4,0,-1,0,0,0,-1,0,0,0,10, ldraw_lib__rect(realsolid)],
// 1 16 -20 4 0 -1 0 0 0 -1 0 0 0 10 rect.dat
  [1,16,-20,4,0,-1,0,0,0,-1,0,0,0,10, ldraw_lib__rect(realsolid)],
...
// 1 16 22 68 -26 0 1 0 0 0 4 4 0 0 2-4disc.dat
  [1,16,22,68,-26,0,1,0,0,0,4,4,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 18 68 -26 0 -1 0 0 0 4 -4 0 0 2-4disc.dat
  [1,16,18,68,-26,0,-1,0,0,0,4,-4,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 2 68 -26 0 1 0 0 0 4 4 0 0 2-4disc.dat
  [1,16,2,68,-26,0,1,0,0,0,4,4,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 -2 68 -26 0 -1 0 0 0 4 -4 0 0 2-4disc.dat
  [1,16,-2,68,-26,0,-1,0,0,0,4,-4,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 -18 68 -26 0 1 0 0 0 4 4 0 0 2-4disc.dat
  [1,16,-18,68,-26,0,1,0,0,0,4,4,0,0, ldraw_lib__2_4disc(realsolid)],
...
// 1 16 22 68 -26 0 14 0 0 0 4 4 0 0 2-4cyli.dat
  [1,16,22,68,-26,0,14,0,0,0,4,4,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 2 68 -26 0 16 0 0 0 4 4 0 0 2-4cyli.dat
  [1,16,2,68,-26,0,16,0,0,0,4,4,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -2 68 -26 0 -16 0 0 0 4 4 0 0 2-4cyli.dat
  [1,16,-2,68,-26,0,-16,0,0,0,4,4,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -22 68 -26 0 -14 0 0 0 4 4 0 0 2-4cyli.dat
  [1,16,-22,68,-26,0,-14,0,0,0,4,4,0,0, ldraw_lib__2_4cyli(realsolid)],
...
// 1 16 36 68 -26 0 1.5 0 3.5 0 0 0 0 -3.5 bump5000.dat
  [1,16,36,68,-26,0,1.5,0,3.5,0,0,0,0,-3.5, ldraw_lib__bump5000(realsolid)],
// 1 16 36 68 -26 0 -1 0 0 0 .5 -.5 0 0 4-4ring7.dat
  [1,16,36,68,-26,0,-1,0,0,0,.5,-.5,0,0, ldraw_lib__4_4ring7(realsolid)],
// 1 16 36 68 -26 0 -1 0 0 0 -4 -4 0 0 2-4ndis.dat
  [1,16,36,68,-26,0,-1,0,0,0,-4,-4,0,0, ldraw_lib__2_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -36 68 -26 0 -1.5 0 3.5 0 0 0 0 -3.5 bump5000.dat
  [1,16,-36,68,-26,0,-1.5,0,3.5,0,0,0,0,-3.5, ldraw_lib__bump5000(realsolid)],
...
module ldraw_lib__s__2582s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2582s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
