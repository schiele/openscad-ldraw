...
use <../../p/stug7.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2358s01(realsolid=false) = [
...
// 1 16 -210 0 -270 0 0 1 0 1 0 -1 0 0 stug3.dat
  [1,16,-210,0,-270,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug3(realsolid)],
// 1 16 -230 0 -310 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-230,0,-310,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
...
module ldraw_lib__s__2358s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2358s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
