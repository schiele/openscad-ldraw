...
use <../../p/tri3a4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2454as01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2454as02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2454as02(realsolid)],
// 
// 1 16 -6.75 62 -6 0 0 .25 58 0 0 0 -1 0 rect3.dat
  [1,16,-6.75,62,-6,0,0,.25,58,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 6.75 62 -6 0 0 -.25 -58 0 0 0 -1 0 rect3.dat
  [1,16,6.75,62,-6,0,0,-.25,-58,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 -6.75 62 6 0 0 .25 58 0 0 0 1 0 rect3.dat
  [1,16,-6.75,62,6,0,0,.25,58,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 4 4 -3.75 0 0 2.5 0 116 0 -2.25 0 -2.25 tri3a4.dat
  [1,16,4,4,-3.75,0,0,2.5,0,116,0,-2.25,0,-2.25, ldraw_lib__tri3a4(realsolid)],
// 1 16 -4 4 -3.75 0 0 -2.5 0 116 0 -2.25 0 -2.25 tri3a4.dat
  [1,16,-4,4,-3.75,0,0,-2.5,0,116,0,-2.25,0,-2.25, ldraw_lib__tri3a4(realsolid)],
// 1 16 4 4 3.75 0 0 2.5 0 116 0 2.25 0 2.25 tri3a4.dat
  [1,16,4,4,3.75,0,0,2.5,0,116,0,2.25,0,2.25, ldraw_lib__tri3a4(realsolid)],
...
// 1 16 0 62 -6 -4 0 0 0 0 -58 0 -1 0 rect.dat
  [1,16,0,62,-6,-4,0,0,0,0,-58,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 62 6 4 0 0 0 0 -58 0 1 0 rect.dat
  [1,16,0,62,6,4,0,0,0,0,-58,0,1,0, ldraw_lib__rect(realsolid)],
];
module ldraw_lib__s__2454as01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2454as01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
