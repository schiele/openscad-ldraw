...
use <../../p/recte3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2470s02(realsolid=false) = [
...
// 1 16 3 -18.10285 -3 0 -1 0 8.69945 0 0 3.5 0 2 rect2p.dat
  [1,16,3,-18.10285,-3,0,-1,0,8.69945,0,0,3.5,0,2, ldraw_lib__rect2p(realsolid)],
// 1 16 1.5 -9.7017 0.38 0 0 1.5 0 1 0.2983 -2 0 0.12 recte3.dat
  [1,16,1.5,-9.7017,0.38,0,0,1.5,0,1,0.2983,-2,0,0.12, ldraw_lib__recte3(realsolid)],
// 1 16 1.5 -26.90115 -6.53975 0 0 1.5 0 -1 0.09885 2 0 0.03975 recte3.dat
  [1,16,1.5,-26.90115,-6.53975,0,0,1.5,0,-1,0.09885,2,0,0.03975, ldraw_lib__recte3(realsolid)],
];
module ldraw_lib__s__2470s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2470s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
