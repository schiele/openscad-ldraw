...
use <../../p/rect.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3231bs01(realsolid=false) = [
...
// 1 16 14 14 0 0 -1 0 0 0 -2 6 0 0 rect.dat
  [1,16,14,14,0,0,-1,0,0,0,-2,6,0,0, ldraw_lib__rect(realsolid)],
...
module ldraw_lib__s__3231bs01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3231bs01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
