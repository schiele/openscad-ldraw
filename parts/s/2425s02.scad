...
use <../../p/recte3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2425s02(realsolid=false) = [
...
// 1 16 -14 26.5 -18 0 0 -1.5 -1.5 0 0 0 2 0 1-4cylo.dat
  [1,16,-14,26.5,-18,0,0,-1.5,-1.5,0,0,0,2,0, ldraw_lib__1_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -30.5 26.5 -18 0 0 1.5 -1.5 0 0 0 2 0 1-4cylo.dat
  [1,16,-30.5,26.5,-18,0,0,1.5,-1.5,0,0,0,2,0, ldraw_lib__1_4cylo(realsolid)],
...
// 1 16 -22.25 36 -17.375 4.75 0 0 0 -2 2 0 0 0.625 box2-5.dat
  [1,16,-22.25,36,-17.375,4.75,0,0,0,-2,2,0,0,0.625, ldraw_lib__box2_5(realsolid)],
// 1 16 -22.25 40 -17.375 4.75 0 0 0 1 0 0 0 -0.625 rect3.dat
  [1,16,-22.25,40,-17.375,4.75,0,0,0,1,0,0,0,-0.625, ldraw_lib__rect3(realsolid)],
...
// 1 16 -37 21.5 -14 0 0 -1 3.5 0 0 0 4 0 box2-5.dat
  [1,16,-37,21.5,-14,0,0,-1,3.5,0,0,0,4,0, ldraw_lib__box2_5(realsolid)],
// 
...
// 1 16 -14 26.5 -18 0 0 -1.5 -1.5 0 0 0 1 0 1-4ndis.dat
  [1,16,-14,26.5,-18,0,0,-1.5,-1.5,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -30.5 26.5 -18 0 0 1.5 -1.5 0 0 0 1 0 1-4ndis.dat
  [1,16,-30.5,26.5,-18,0,0,1.5,-1.5,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 
...
// 1 16 -29 41.25 -16.25 0 13.5 0 0 0 1.75 -1.75 0 0 2-4cylc.dat
  [1,16,-29,41.25,-16.25,0,13.5,0,0,0,1.75,-1.75,0,0, ldraw_lib__2_4cylc(realsolid)],
// 1 16 -15.5 41.25 -16.25 0 -1 0 0 0 1.75 -1.75 0 0 2-4disc.dat
  [1,16,-15.5,41.25,-16.25,0,-1,0,0,0,1.75,-1.75,0,0, ldraw_lib__2_4disc(realsolid)],
// 
// 1 16 -22.25 22.125 -14.5 0 0 -6.75 19.125 0 0 0 -1 0 rect2p.dat
  [1,16,-22.25,22.125,-14.5,0,0,-6.75,19.125,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -22.25 3 -15.25 6.75 0 0 0 1 0 0 0 0.75 recte3.dat
  [1,16,-22.25,3,-15.25,6.75,0,0,0,1,0,0,0,0.75, ldraw_lib__recte3(realsolid)],
// 
...
// 1 16 -30.5 26.5 -16 0 0 1.5 -1.5 0 0 0 -1 0 1-4ndis.dat
  [1,16,-30.5,26.5,-16,0,0,1.5,-1.5,0,0,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 -14 26.5 -16 0 0 -1.5 -1.5 0 0 0 -1 0 1-4ndis.dat
  [1,16,-14,26.5,-16,0,0,-1.5,-1.5,0,0,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -14.75 14 -16 0 0 0.75 -11 0 0 0 -1 0 rect2a.dat
  [1,16,-14.75,14,-16,0,0,0.75,-11,0,0,0,-1,0, ldraw_lib__rect2a(realsolid)],
...
module ldraw_lib__s__2425s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2425s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
