...
use <../../p/box3u12.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__4121723ds01(realsolid=false) = [
...
// 1 16 51.5 0 7 1.5 0 0 0 -1 0 0 0 1.5 1-4chrd.dat
  [1,16,51.5,0,7,1.5,0,0,0,-1,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 16 51.5 0 -7 1.5 0 0 0 -1 0 0 0 -1.5 1-4chrd.dat
  [1,16,51.5,0,-7,1.5,0,0,0,-1,0,0,0,-1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -51.5 0 -7 -1.5 0 0 0 -1 0 0 0 -1.5 1-4chrd.dat
  [1,16,-51.5,0,-7,-1.5,0,0,0,-1,0,0,0,-1.5, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 51.5 0 7 1.5 0 0 0 -.25 0 0 0 1.5 1-4cyli.dat
  [1,16,51.5,0,7,1.5,0,0,0,-.25,0,0,0,1.5, ldraw_lib__1_4cyli(realsolid)],
// 1 16 51.5 0 -7 1.5 0 0 0 -.25 0 0 0 -1.5 1-4cyli.dat
  [1,16,51.5,0,-7,1.5,0,0,0,-.25,0,0,0,-1.5, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -51.5 0 -7 -1.5 0 0 0 -.25 0 0 0 -1.5 1-4cyli.dat
  [1,16,-51.5,0,-7,-1.5,0,0,0,-.25,0,0,0,-1.5, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 0 -0.25 0 51.5 0 0 0 0.25 0 0 0 8.5 box3u12.dat
  [1,16,0,-0.25,0,51.5,0,0,0,0.25,0,0,0,8.5, ldraw_lib__box3u12(realsolid)],
...
// 1 16 51.5 -.25 7 1.5 0 0 0 1 0 0 0 1.5 1-4chrd.dat
  [1,16,51.5,-.25,7,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 16 51.5 -.25 -7 1.5 0 0 0 1 0 0 0 -1.5 1-4chrd.dat
  [1,16,51.5,-.25,-7,1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__1_4chrd(realsolid)],
...
module ldraw_lib__s__4121723ds01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__4121723ds01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
