...
use <../../p/stud4s.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3297s01(realsolid=false) = [
...
// 1 16 0 4 -10 6 0 0 0 6 0 0 0 6 2-4edge.dat
  [1,16,0,4,-10,6,0,0,0,6,0,0,0,6, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 4 -10 6 0 0 0 99 3 0 0 -6 2-4edge.dat
  [1,16,0,4,-10,6,0,0,0,99,3,0,0,-6, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 4 -10 8 0 0 0 8 0 0 0 8 2-4edge.dat
  [1,16,0,4,-10,8,0,0,0,8,0,0,0,8, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 4 -10 8 0 0 0 99 4 0 0 -8 2-4edge.dat
  [1,16,0,4,-10,8,0,0,0,99,4,0,0,-8, ldraw_lib__2_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 4 -10 6 0 0 0 4 0 0 0 6 2-4cyli.dat
  [1,16,0,4,-10,6,0,0,0,4,0,0,0,6, ldraw_lib__2_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 7 -10 6 0 0 0 1 0 0 0 -6 2-4cyli.dat
  [1,16,0,7,-10,6,0,0,0,1,0,0,0,-6, ldraw_lib__2_4cyli(realsolid)],
...
// 1 16 20 8 -10 1 0 0 0 -4 0 0 0 1 stud4a.dat
  [1,16,20,8,-10,1,0,0,0,-4,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 20 4 -10 6 0 0 0 6 0 0 0 6 2-4edge.dat
  [1,16,20,4,-10,6,0,0,0,6,0,0,0,6, ldraw_lib__2_4edge(realsolid)],
// 1 16 20 4 -10 6 0 0 0 99 3 0 0 -6 2-4edge.dat
  [1,16,20,4,-10,6,0,0,0,99,3,0,0,-6, ldraw_lib__2_4edge(realsolid)],
// 1 16 20 4 -10 8 0 0 0 8 0 0 0 8 2-4edge.dat
  [1,16,20,4,-10,8,0,0,0,8,0,0,0,8, ldraw_lib__2_4edge(realsolid)],
// 1 16 20 4 -10 8 0 0 0 99 4 0 0 -8 2-4edge.dat
  [1,16,20,4,-10,8,0,0,0,99,4,0,0,-8, ldraw_lib__2_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 7 -10 0 0 6 0 -3 0 -6 0 0 1-4cyls.dat
  [1,16,20,7,-10,0,0,6,0,-3,0,-6,0,0, ldraw_lib__1_4cyls(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 7 -10 0 0 -6 0 -3 0 -6 0 0 1-4cyls.dat
  [1,16,20,7,-10,0,0,-6,0,-3,0,-6,0,0, ldraw_lib__1_4cyls(realsolid)],
...
// 1 16 20 4 -10 6 0 0 0 4 0 0 0 6 2-4cyli.dat
  [1,16,20,4,-10,6,0,0,0,4,0,0,0,6, ldraw_lib__2_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 7 -10 6 0 0 0 1 0 0 0 -6 2-4cyli.dat
  [1,16,20,7,-10,6,0,0,0,1,0,0,0,-6, ldraw_lib__2_4cyli(realsolid)],
// 1 16 20 8 -10 0 0 8 0 -4 0 -8 0 0 1-4cyls.dat
  [1,16,20,8,-10,0,0,8,0,-4,0,-8,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 20 8 -10 0 0 -8 0 -4 0 -8 0 0 1-4cyls.dat
  [1,16,20,8,-10,0,0,-8,0,-4,0,-8,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 20 4 -10 8 0 0 0 4 0 0 0 8 2-4cyli.dat
  [1,16,20,4,-10,8,0,0,0,4,0,0,0,8, ldraw_lib__2_4cyli(realsolid)],
// 0
// 1 16 -20 8 -10 1 0 0 0 -4 0 0 0 1 stud4a.dat
  [1,16,-20,8,-10,1,0,0,0,-4,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 -20 4 -10 6 0 0 0 6 0 0 0 6 2-4edge.dat
...
// 1 16 20 18 -30 1 0 0 0 -1.50 0 0 0 1 stud4a.dat
  [1,16,20,18,-30,1,0,0,0,-1.50,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 20 18 -30 0 0 1 0 4 0 -1 0 0 stud4s.dat
  [1,16,20,18,-30,0,0,1,0,4,0,-1,0,0, ldraw_lib__stud4s(realsolid)],
// 1 16 -20 18 -30 1 0 0 0 -1.50 0 0 0 1 stud4a.dat
  [1,16,-20,18,-30,1,0,0,0,-1.50,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 -20 18 -30 0 0 1 0 4 0 -1 0 0 stud4s.dat
  [1,16,-20,18,-30,0,0,1,0,4,0,-1,0,0, ldraw_lib__stud4s(realsolid)],
...
// 1 16 0 14 -2 36 0 0 0 -10 0 0 0 8 box2-5.dat
  [1,16,0,14,-2,36,0,0,0,-10,0,0,0,8, ldraw_lib__box2_5(realsolid)],
// 1 16 0 12 -28 36 0 0 0 8 0 0 -16 2 box2-7.dat
  [1,16,0,12,-28,36,0,0,0,8,0,0,-16,2, ldraw_lib__box2_7(realsolid)],
// 1 16 0 22 -46 36 0 0 0 0 2 0 -1 0 rect.dat
  [1,16,0,22,-46,36,0,0,0,0,2,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 12 0 40 0 0 0 -12 0 0 0 10 box2-5.dat
  [1,16,0,12,0,40,0,0,0,-12,0,0,0,10, ldraw_lib__box2_5(realsolid)],
// 1 16 0 22 -50 40 0 0 0 1 2 0 1 0 rect.dat
  [1,16,0,22,-50,40,0,0,0,1,2,0,1,0, ldraw_lib__rect(realsolid)],
// 0
];
module ldraw_lib__s__3297s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3297s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
