...
use <../../p/1-4chrd.scad>
use <../../p/1-4cyli.scad>
function ldraw_lib__s__6142275qs07() = [
// 0 ~Sticker  1.9 x  0.8 with Black and Dark Grey Face - Bottom Face
// 0 Name: s\6142275qs07.dat
...
// 3 16 8 0 17.7711 8 -.25 17.7711 8 -.25 13.8668
  [3,16,8,0,17.7711,8,-.25,17.7711,8,-.25,13.8668],
// 3 16 -8 0 17.7711 -8 -.25 10.5 -8 -.25 13.8668
  [3,16,-8,0,17.7711,-8,-.25,10.5,-8,-.25,13.8668],
// 3 16 8 0 17.7711 8 -.25 13.8668 8 -.25 10.5
  [3,16,8,0,17.7711,8,-.25,13.8668,8,-.25,10.5],
// 3 16 -8 0 17.7711 -8 -.25 6.5112 -8 -.25 10.5
  [3,16,-8,0,17.7711,-8,-.25,6.5112,-8,-.25,10.5],
// 3 16 8 0 17.7711 8 -.25 10.5 8 -.25 6.5112
  [3,16,8,0,17.7711,8,-.25,10.5,8,-.25,6.5112],
...
// 3 16 8 0 -17.7711 8 -.25 -7.8038 8 -.25 -14.6666
  [3,16,8,0,-17.7711,8,-.25,-7.8038,8,-.25,-14.6666],
// 3 16 -8 0 -17.7711 -8 -.25 -15 -8 -.25 -14.6666
  [3,16,-8,0,-17.7711,-8,-.25,-15,-8,-.25,-14.6666],
// 3 16 8 0 -17.7711 8 -.25 -14.6666 8 -.25 -15
  [3,16,8,0,-17.7711,8,-.25,-14.6666,8,-.25,-15],
// 3 16 -8 0 -17.7711 -8 -.25 -17.7711 -8 -.25 -15
  [3,16,-8,0,-17.7711,-8,-.25,-17.7711,-8,-.25,-15],
// 3 16 8 0 -17.7711 8 -.25 -15 8 -.25 -17.7711
  [3,16,8,0,-17.7711,8,-.25,-15,8,-.25,-17.7711],
// 4 16 -6.5 0 -19.2711 6.5 0 -19.2711 6.5 -.25 -19.2711 -6.5 -.25 -19.2711
  [4,16,-6.5,0,-19.2711,6.5,0,-19.2711,6.5,-.25,-19.2711,-6.5,-.25,-19.2711],
];
module ldraw_lib__s__6142275qs07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6142275qs07(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__6142275qs07(line=0.2);