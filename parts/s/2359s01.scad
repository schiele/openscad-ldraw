...
use <../../p/stug5.scad>
use <../../p/stug7.scad>
function ldraw_lib__s__2359s01() = [
...
// 1 16 160 0 -120 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,160,0,-120,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 80 0 20 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,80,0,20,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 20 0 80 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,20,0,80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -120 0 160 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-120,0,160,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 150 0 -70 0 0 1 0 1 0 -1 0 0 stug3.dat
  [1,16,150,0,-70,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug3()],
// 1 16 -70 0 150 0 0 1 0 1 0 -1 0 0 stug3.dat
  [1,16,-70,0,150,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug3()],
// 1 16 140 0 0 0 0 1 0 1 0 -1 0 0 stug4.dat
  [1,16,140,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug4()],
// 1 16 0 0 140 0 0 1 0 1 0 -1 0 0 stug4.dat
  [1,16,0,0,140,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug4()],
// 1 16 -210 0 -270 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-210,0,-270,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
...
// 1 16 -270 0 -210 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-270,0,-210,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
...
// 1 16 110 0 110 0 0 1 0 1 0 -1 0 0 stug7.dat
  [1,16,110,0,110,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug7()],
...
// 1 16 170 0 -190 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,170,0,-190,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 170 0 -170 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,170,0,-170,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
...
// 1 16 -190 0 170 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-190,0,170,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 -170 0 170 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-170,0,170,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
...
module ldraw_lib__s__2359s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2359s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
