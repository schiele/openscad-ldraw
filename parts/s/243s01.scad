...
use <../../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__243s01(realsolid=false) = [
...
// 1 16 0 0 8 28 0 0 0 0 28 0 -2 0 4-4cylo.dat
  [1,16,0,0,8,28,0,0,0,0,28,0,-2,0, ldraw_lib__4_4cylo(realsolid)],
// 
// 0 // Wheel 'flens' cone
// 1 16 0 0 4.5 4 0 0 0 0 4 0 -1.5 0 4-4con5.dat
  [1,16,0,0,4.5,4,0,0,0,0,4,0,-1.5,0, ldraw_lib__4_4con5(realsolid)],
// 1 16 0 0 6 4 0 0 0 0 4 0 -1.5 0 4-4con6.dat
  [1,16,0,0,6,4,0,0,0,0,4,0,-1.5,0, ldraw_lib__4_4con6(realsolid)],
// 
// 0 // Wheel edge 'loopvlak'
// 1 16 0 0 3 20 0 0 0 0 20 0 -15 0 4-4cylo.dat
  [1,16,0,0,3,20,0,0,0,0,20,0,-15,0, ldraw_lib__4_4cylo(realsolid)],
// 
// 0 // Wheel front
// 1 16 0 0 -12 0 0 1 -1 0 0 0 1 0 1-4rin19.dat
  [1,16,0,0,-12,0,0,1,-1,0,0,0,1,0, ldraw_lib__1_4rin19(realsolid)],
// 1 16 0 0 -12 -1 0 0 0 0 -1 0 1 0 1-4rin19.dat
  [1,16,0,0,-12,-1,0,0,0,0,-1,0,1,0, ldraw_lib__1_4rin19(realsolid)],
// 1 16 0 0 -12 0 0 -1 1 0 0 0 1 0 1-4rin19.dat
  [1,16,0,0,-12,0,0,-1,1,0,0,0,1,0, ldraw_lib__1_4rin19(realsolid)],
// 1 16 0 0 -12 1 0 0 0 0 1 0 1 0 1-4rin19.dat
  [1,16,0,0,-12,1,0,0,0,0,1,0,1,0, ldraw_lib__1_4rin19(realsolid)],
// 1 16 0 0 -12 19 0 0 0 0 19 0 1 0 4-4edge.dat
  [1,16,0,0,-12,19,0,0,0,0,19,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 
// 0 // Wheel front Cone
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -10.6667 2 0 0 0 0 2 0 2.6667 0 4-4con8.dat
  [1,16,0,0,-10.6667,2,0,0,0,0,2,0,2.6667,0, ldraw_lib__4_4con8(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -12 1 0 0 0 0 1 0 1.3333 0 4-4con18.dat
  [1,16,0,0,-12,1,0,0,0,0,1,0,1.3333,0, ldraw_lib__4_4con18(realsolid)],
// 
// 0 // Wheel inside
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 3 16 0 0 0 0 16 0 -11 0 4-4cylo.dat
  [1,16,0,0,3,16,0,0,0,0,16,0,-11,0, ldraw_lib__4_4cylo(realsolid)],
...
// 1 16 0 0 3 8 0 0 0 0 8 0 -15 0 4-4cylo.dat
  [1,16,0,0,3,8,0,0,0,0,8,0,-15,0, ldraw_lib__4_4cylo(realsolid)],
...
module ldraw_lib__s__243s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__243s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
