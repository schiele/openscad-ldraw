...
use <../../p/recte3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__33031s02(realsolid=false) = [
...
// 1 16 0 -5 1 0 0 35 -5 0 0 0 -70 0 box3u2p.dat
  [1,16,0,-5,1,0,0,35,-5,0,0,0,-70,0, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 0 -7 -34 32 0 0 0 7 0 0 0 32 box4.dat
  [1,16,0,-7,-34,32,0,0,0,7,0,0,0,32, ldraw_lib__box4(realsolid)],
// 1 16 0 -7 -64 10 0 0 0 10 0 0 0 1 box5.dat
  [1,16,0,-7,-64,10,0,0,0,10,0,0,0,1, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -7 -34 4 0 0 0 -3 0 0 0 4 4-4cylo.dat
  [1,16,0,-7,-34,4,0,0,0,-3,0,0,0,4, ldraw_lib__4_4cylo(realsolid)],
// 4 16 -4 -7 -30 -32 -7 -2 32 -7 -2 4 -7 -30
  [4,16,-4,-7,-30,-32,-7,-2,32,-7,-2,4,-7,-30],
// 4 16 4 -10 -30 35 -10 1 -35 -10 1 -4 -10 -30
  [4,16,4,-10,-30,35,-10,1,-35,-10,1,-4,-10,-30],
// 1 16 0 -7 -34 4 0 0 0 -1 0 0 0 4 4-4ndis.dat
  [1,16,0,-7,-34,4,0,0,0,-1,0,0,0,4, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 -10 -34 4 0 0 0 1 0 0 0 4 4-4ndis.dat
  [1,16,0,-10,-34,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 -23 0 0 0 1 0 1 0 0 0 0 1 3-16edge.dat
  [1,16,-23,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__3_16edge(realsolid)],
// 1 16 23 0 0 0 1 0 1 0 0 0 0 1 3-16edge.dat
  [1,16,23,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__3_16edge(realsolid)],
// 1 16 -23 0 0 0 46 0 1 0 0 0 0 1 3-16cyli.dat
  [1,16,-23,0,0,0,46,0,1,0,0,0,0,1, ldraw_lib__3_16cyli(realsolid)],
// 1 16 -23 0 0 0 1 0 1 0 0 0 0 1 3-16disc.dat
  [1,16,-23,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__3_16disc(realsolid)],
// 1 16 23 0 0 0 -1 0 1 0 0 0 0 1 3-16disc.dat
  [1,16,23,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__3_16disc(realsolid)],
...
// 1 16 -23 -3 1 0 46 0 -2 0 0 0 0 1 1-4cylc.dat
  [1,16,-23,-3,1,0,46,0,-2,0,0,0,0,1, ldraw_lib__1_4cylc(realsolid)],
// 1 16 23 -3 1 0 -1 0 -2 0 0 0 0 1 1-4disc.dat
  [1,16,23,-3,1,0,-1,0,-2,0,0,0,0,1, ldraw_lib__1_4disc(realsolid)],
// 1 16 0 -2.5 1 23 0 0 0 0 -2.5 0 1 0 recte3.dat
  [1,16,0,-2.5,1,23,0,0,0,0,-2.5,0,1,0, ldraw_lib__recte3(realsolid)],
...
module ldraw_lib__s__33031s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__33031s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
