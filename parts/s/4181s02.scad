...
use <../../p/1-4cyli.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__4181s02(realsolid=false) = [
...
// 1 16 0 0 0 10 0 0 0 8 0 0 0 -10 1-4cyli.dat
  [1,16,0,0,0,10,0,0,0,8,0,0,0,-10, ldraw_lib__1_4cyli(realsolid)],
// 1 16 0 0 60 10 0 0 0 8 0 0 0 10 1-4cyli.dat
  [1,16,0,0,60,10,0,0,0,8,0,0,0,10, ldraw_lib__1_4cyli(realsolid)],
// 0
];
module ldraw_lib__s__4181s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__4181s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
