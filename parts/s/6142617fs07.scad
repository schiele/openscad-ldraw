...
use <../../p/1-4chrd.scad>
use <../../p/1-4cyli.scad>
function ldraw_lib__s__6142617fs07() = [
// 0 ~Sticker  0.8 x  1.9 with Black Arc on Red Background Left - Bottom Face
// 0 Name: s\6142617fs07.dat
...
// 4 16 6.5 0 19.2711 8 0 17.7711 8 0 -17.7711 6.5 0 -19.2711
  [4,16,6.5,0,19.2711,8,0,17.7711,8,0,-17.7711,6.5,0,-19.2711],
// 0 // Lateral face
// 3 16 -6.5 0 19.2711 -6.5 -.25 19.2711 -3.5 -.25 19.2711
  [3,16,-6.5,0,19.2711,-6.5,-.25,19.2711,-3.5,-.25,19.2711],
// 4 16 -6.5 0 19.2711 -3.5 -.25 19.2711 0 -.25 19.2711 6.5 0 19.2711
  [4,16,-6.5,0,19.2711,-3.5,-.25,19.2711,0,-.25,19.2711,6.5,0,19.2711],
// 3 16 6.5 0 19.2711 0 -.25 19.2711 6.5 -.25 19.2711
  [3,16,6.5,0,19.2711,0,-.25,19.2711,6.5,-.25,19.2711],
...
module ldraw_lib__s__6142617fs07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6142617fs07(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__6142617fs07(line=0.2);