...
use <../../p/box3u7a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__32283s03(realsolid=false) = [
...
// 1 16 0 -10 -16 2 0 0 0 1 0 0 0 -2 1-4ndis.dat
  [1,16,0,-10,-16,2,0,0,0,1,0,0,0,-2, ldraw_lib__1_4ndis(realsolid)],
// 1 16 0 10 -16 2 0 0 0 -1 0 0 0 -2 1-4ndis.dat
  [1,16,0,10,-16,2,0,0,0,-1,0,0,0,-2, ldraw_lib__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 10 -16 2 0 0 0 -4 0 0 0 -2 1-4cyli.dat
  [1,16,0,10,-16,2,0,0,0,-4,0,0,0,-2, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -6 -16 2 0 0 0 -4 0 0 0 -2 1-4cyli.dat
  [1,16,0,-6,-16,2,0,0,0,-4,0,0,0,-2, ldraw_lib__1_4cyli(realsolid)],
// 1 16 0 -10 -16 2 0 0 0 -1 0 0 0 -2 1-4edge.dat
  [1,16,0,-10,-16,2,0,0,0,-1,0,0,0,-2, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 10 -16 2 0 0 0 -1 0 0 0 -2 1-4edge.dat
  [1,16,0,10,-16,2,0,0,0,-1,0,0,0,-2, ldraw_lib__1_4edge(realsolid)],
// 1 16 2 0 0 0 18 0 1 0 0 0 0 -1 axlehol4.dat
  [1,16,2,0,0,0,18,0,1,0,0,0,0,-1, ldraw_lib__axlehol4(realsolid)],
...
// 1 16 20 0 0 0 -1 0 6 0 0 0 0 -6 1-8ndis.dat
  [1,16,20,0,0,0,-1,0,6,0,0,0,0,-6, ldraw_lib__1_8ndis(realsolid)],
// 1 16 20 0 0 0 -1 0 -6 0 0 0 0 -6 1-8ndis.dat
  [1,16,20,0,0,0,-1,0,-6,0,0,0,0,-6, ldraw_lib__1_8ndis(realsolid)],
// 1 16 2 0 0 0 1 0 6 0 0 0 0 -6 1-8ndis.dat
  [1,16,2,0,0,0,1,0,6,0,0,0,0,-6, ldraw_lib__1_8ndis(realsolid)],
// 1 16 2 0 0 0 1 0 -6 0 0 0 0 -6 1-8ndis.dat
  [1,16,2,0,0,0,1,0,-6,0,0,0,0,-6, ldraw_lib__1_8ndis(realsolid)],
...
// 1 16 20 0 -16 0 -16 0 -2 0 0 0 0 2 2-4cyli.dat
  [1,16,20,0,-16,0,-16,0,-2,0,0,0,0,2, ldraw_lib__2_4cyli(realsolid)],
// 1 16 20 0 -16 0 -1 0 -2 0 0 0 0 2 2-4disc.dat
  [1,16,20,0,-16,0,-1,0,-2,0,0,0,0,2, ldraw_lib__2_4disc(realsolid)],
// 1 16 4 0 -16 0 1 0 -2 0 0 0 0 2 2-4disc.dat
  [1,16,4,0,-16,0,1,0,-2,0,0,0,0,2, ldraw_lib__2_4disc(realsolid)],
// 1 16 20 0 -16 0 1 0 -2 0 0 0 0 2 2-4edge.dat
  [1,16,20,0,-16,0,1,0,-2,0,0,0,0,2, ldraw_lib__2_4edge(realsolid)],
// 1 16 4 0 -16 0 1 0 -2 0 0 0 0 2 2-4edge.dat
  [1,16,4,0,-16,0,1,0,-2,0,0,0,0,2, ldraw_lib__2_4edge(realsolid)],
// 2 24 2 -2 -16 20 -2 -16
  [2,24,2,-2,-16,20,-2,-16],
// 2 24 2 2 -16 20 2 -16
  [2,24,2,2,-16,20,2,-16],
...
// 1 16 11 0 -6 9 0 0 0 0 6 0 -10 0 box3u7a.dat
  [1,16,11,0,-6,9,0,0,0,0,6,0,-10,0, ldraw_lib__box3u7a(realsolid)],
...
// 1 16 0 -6 -16 2 0 0 0 1 0 0 0 -2 1-4disc.dat
  [1,16,0,-6,-16,2,0,0,0,1,0,0,0,-2, ldraw_lib__1_4disc(realsolid)],
// 1 16 0 6 -16 2 0 0 0 -1 0 0 0 -2 1-4disc.dat
  [1,16,0,6,-16,2,0,0,0,-1,0,0,0,-2, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 0 -6 -16 2 0 0 0 -1 0 0 0 -2 1-4edge.dat
  [1,16,0,-6,-16,2,0,0,0,-1,0,0,0,-2, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 6 -16 2 0 0 0 -1 0 0 0 -2 1-4edge.dat
  [1,16,0,6,-16,2,0,0,0,-1,0,0,0,-2, ldraw_lib__1_4edge(realsolid)],
...
module ldraw_lib__s__32283s03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__32283s03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__32283s03(line=0.2);