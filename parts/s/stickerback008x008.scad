...
use <../../p/1-4cyli.scad>
use <../../p/box3u12.scad>
function ldraw_lib__s__stickerback008x008() = [
// 0 ~Sticker Back  0.8 x  0.8
// 0 Name: s\stickerback008x008.dat
...
// 1 16 6.5 0 -6.5 1.5 0 0 0 -.25 0 0 0 -1.5 1-4cyli.dat
  [1,16,6.5,0,-6.5,1.5,0,0,0,-.25,0,0,0,-1.5, ldraw_lib__1_4cyli()],
// 0 // Bottom faces
// 4 16 -8 0 6.5 -6.5 0 8 6.5 0 8 8 0 6.5
  [4,16,-8,0,6.5,-6.5,0,8,6.5,0,8,8,0,6.5],
// 4 16 -8 0 -6.5 8 0 -6.5 6.5 0 -8 -6.5 0 -8
  [4,16,-8,0,-6.5,8,0,-6.5,6.5,0,-8,-6.5,0,-8],
// 0 // Lateral faces
...
module ldraw_lib__s__stickerback008x008(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__stickerback008x008(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__stickerback008x008(line=0.2);