...
$fa=1; $fs=0.2;
function ldraw_lib__s__2924bs01(realsolid=false) = [
...
// 1 16 0 -42 0 40 0 0 0 0 10 0 -16 0 box5.dat
  [1,16,0,-42,0,40,0,0,0,0,10,0,-16,0, ldraw_lib__box5(realsolid)],
// 
...
// 1 16 0 -28 0 0 0 -40 4 0 0 0 -1 0 rect1.dat
  [1,16,0,-28,0,0,0,-40,4,0,0,0,-1,0, ldraw_lib__rect1(realsolid)],
// 
// 1 16 0 -24 -2 0 0 -40 0 -1 0 -2 0 0 rect2p.dat
  [1,16,0,-24,-2,0,0,-40,0,-1,0,-2,0,0, ldraw_lib__rect2p(realsolid)],
// 
// 1 16 0 -24 -18 40 0 0 0 -1 0 0 0 -2 rect3.dat
  [1,16,0,-24,-18,40,0,0,0,-1,0,0,0,-2, ldraw_lib__rect3(realsolid)],
// 
// 1 16 38 -28 -10 0 0 -2 0 4 0 1.5 0 0 box4-1.dat
  [1,16,38,-28,-10,0,0,-2,0,4,0,1.5,0,0, ldraw_lib__box4_1(realsolid)],
// 1 16 -38 -28 -10 0 0 2 0 4 0 1.5 0 0 box4-1.dat
  [1,16,-38,-28,-10,0,0,2,0,4,0,1.5,0,0, ldraw_lib__box4_1(realsolid)],
// 
// 1 16 0 -28 -10 1 0 0 0 -1 0 0 0 1 stug3-1x3.dat
  [1,16,0,-28,-10,1,0,0,0,-1,0,0,0,1, ldraw_lib__stug3_1x3(realsolid)],
...
module ldraw_lib__s__2924bs01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2924bs01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__2924bs01(line=0.2);