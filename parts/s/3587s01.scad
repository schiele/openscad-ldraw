...
use <../../p/stug-1x3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3587s01(realsolid=false) = [
...
// 1 16 0 4 -22 0 0 2 0 4 0 -4 0 0 box3u6.dat
  [1,16,0,4,-22,0,0,2,0,4,0,-4,0,0, ldraw_lib__box3u6(realsolid)],
...
// 1 16 0 4 -10 0 0 1 0 -1 0 -1 0 0 stud4f1w.dat
  [1,16,0,4,-10,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stud4f1w(realsolid)],
...
// 1 16 0 8 0 16 0 0 0 -4 0 0 0 26 box4-1.dat
  [1,16,0,8,0,16,0,0,0,-4,0,0,0,26, ldraw_lib__box4_1(realsolid)],
// 1 16 -9 6 -26 0 0 -7 2 0 0 0 -1 0 rect1.dat
  [1,16,-9,6,-26,0,0,-7,2,0,0,0,-1,0, ldraw_lib__rect1(realsolid)],
// 1 16 9 6 -26 0 0 -7 2 0 0 0 -1 0 rect1.dat
  [1,16,9,6,-26,0,0,-7,2,0,0,0,-1,0, ldraw_lib__rect1(realsolid)],
// 
...
// 1 16 11 4 0 0 0 9 0 -4 0 -30 0 0 box2-5.dat
  [1,16,11,4,0,0,0,9,0,-4,0,-30,0,0, ldraw_lib__box2_5(realsolid)],
// 1 16 -11 4 0 0 0 -9 0 -4 0 -30 0 0 box2-5.dat
  [1,16,-11,4,0,0,0,-9,0,-4,0,-30,0,0, ldraw_lib__box2_5(realsolid)],
// 
...
// 1 16 0 -8 30 -2 0 0 0 0 -8 0 -1 0 rect3.dat
  [1,16,0,-8,30,-2,0,0,0,0,-8,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 -43 52 2 0 0 0 27 0 0 -2 20 box2-7.dat
  [1,16,0,-43,52,2,0,0,0,27,0,0,-2,20, ldraw_lib__box2_7(realsolid)],
// 1 16 2 -70 64 0 -4 0 -10 0 0 0 0 10 1-4cylo.dat
  [1,16,2,-70,64,0,-4,0,-10,0,0,0,0,10, ldraw_lib__1_4cylo(realsolid)],
// 1 16 2 -50 64 0 -4 0 -30 0 0 0 0 -30 1-8cylo.dat
  [1,16,2,-50,64,0,-4,0,-30,0,0,0,0,-30, ldraw_lib__1_8cylo(realsolid)],
// 1 16 0 -35.6065 6.3935 -2 0 0 0 1 35.6065 0 0 -36.3935 rect3.dat
  [1,16,0,-35.6065,6.3935,-2,0,0,0,1,35.6065,0,0,-36.3935, ldraw_lib__rect3(realsolid)],
// 5 24 2 -70 74 -2 -70 74 2 -73.827 73.239 2 -16 70
  [5,24,2,-70,74,-2,-70,74,2,-73.827,73.239,2,-16,70],
// 
// 1 16 10 0 0 0 0 1 0 1 0 -1 0 0 stug-1x3.dat
  [1,16,10,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x3(realsolid)],
// 1 16 -10 0 0 0 0 1 0 1 0 -1 0 0 stug-1x3.dat
  [1,16,-10,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x3(realsolid)],
];
module ldraw_lib__s__3587s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3587s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
