...
use <15535s02.scad>
use <../../p/stud12.scad>
function ldraw_lib__s__4150s01() = [
...
// 1 16 0 4 0 1 0 0 0 -1 0 0 0 1 stud12.dat
  [1,16,0,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud12()],
];
module ldraw_lib__s__4150s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__4150s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
