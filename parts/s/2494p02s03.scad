...
use <../../p/5-16chrd.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2494p02s03(realsolid=false) = [
...
// 1 0 0 6.95 0 3.4 0 0 0 0 1 0 1 0 1-8chrd.dat
  [1,0,0,6.95,0,3.4,0,0,0,0,1,0,1,0, ldraw_lib__1_8chrd(realsolid)],
// 1 0 0 6.95 0 0 0 3.4 1 0 0 0 1 0 1-8chrd.dat
  [1,0,0,6.95,0,0,0,3.4,1,0,0,0,1,0, ldraw_lib__1_8chrd(realsolid)],
// 1 0 0 -6.75 0 0 0 -3.4 -1.2 0 0 0 1 0 1-4chrd.dat
  [1,0,0,-6.75,0,0,0,-3.4,-1.2,0,0,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 0 0 -6.75 0 0 0 3.4 -1.2 0 0 0 1 0 1-4chrd.dat
  [1,0,0,-6.75,0,0,0,3.4,-1.2,0,0,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 0 .4 -5.55 0 0 0 -1.7 -1.2 0 0 0 1 0 1-4ndis.dat
  [1,0,.4,-5.55,0,0,0,-1.7,-1.2,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 0 1.9 -6.2 0 0 0 1 -.6 0 0 0 1 0 1-4ndis.dat
  [1,0,1.9,-6.2,0,0,0,1,-.6,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 0 0 6.75 0 -3.4 0 0 0 0 1.2 0 1 0 1-4chrd.dat
  [1,0,0,6.75,0,-3.4,0,0,0,0,1.2,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 0 .8 6.75 0 -2.1 0 0 0 0 .5 0 1 0 2-4ndis.dat
  [1,0,.8,6.75,0,-2.1,0,0,0,0,.5,0,1,0, ldraw_lib__2_4ndis(realsolid)],
...
// 1 484 0 6.95 0 3.4 0 0 0 0 1 0 1 0 1-4ndis.dat
  [1,484,0,6.95,0,3.4,0,0,0,0,1,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 484 0 -6.75 0 0 0 -3.4 -1.2 0 0 0 1 0 1-4ndis.dat
  [1,484,0,-6.75,0,0,0,-3.4,-1.2,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 484 0 -6.75 0 0 0 3.4 -1.2 0 0 0 1 0 1-4ndis.dat
  [1,484,0,-6.75,0,0,0,3.4,-1.2,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 484 0 6.75 0 -3.4 0 0 0 0 1.2 0 1 0 1-4ndis.dat
  [1,484,0,6.75,0,-3.4,0,0,0,0,1.2,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 484 .4 -5.55 0 0 0 -1.7 -1.2 0 0 0 1 0 1-4chrd.dat
  [1,484,.4,-5.55,0,0,0,-1.7,-1.2,0,0,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 484 .8 6.75 0 -2.1 0 0 0 0 .5 0 1 0 5-16chrd.dat
  [1,484,.8,6.75,0,-2.1,0,0,0,0,.5,0,1,0, ldraw_lib__5_16chrd(realsolid)],
...
// 1 151 1.9 -6.2 0 0 0 1 -.6 0 0 0 1 0 1-4chrd.dat
  [1,151,1.9,-6.2,0,0,0,1,-.6,0,0,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 151 .8 6.75 0 2.1 0 0 0 0 .5 0 1 0 3-16chrd.dat
  [1,151,.8,6.75,0,2.1,0,0,0,0,.5,0,1,0, ldraw_lib__3_16chrd(realsolid)],
...
module ldraw_lib__s__2494p02s03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2494p02s03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
