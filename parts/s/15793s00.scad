...
use <../../p/2-4ndis.scad>
use <51725s02.scad>
function ldraw_lib__s__15793s00() = [
...
// 1 16 0 -28 0 6 0 0 0 57 0 0 0 -6 2-4cylo.dat
  [1,16,0,-28,0,6,0,0,0,57,0,0,0,-6, ldraw_lib__2_4cylo()],
// 1 16 0 29 0 -11 0 0 0 -57 0 0 0 -11 2-4cylo.dat
  [1,16,0,29,0,-11,0,0,0,-57,0,0,0,-11, ldraw_lib__2_4cylo()],
// 
...
module ldraw_lib__s__15793s00(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__15793s00(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
