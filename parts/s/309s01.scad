...
use <../../p/stug9.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__309s01(realsolid=false) = [
...
// 1 16 270 0 170 0 0 1 0 1 0 -1 0 0 stug5.dat
  [1,16,270,0,170,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug5(realsolid)],
// 1 16 270 0 70 0 0 1 0 1 0 -1 0 0 stug5.dat
  [1,16,270,0,70,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug5(realsolid)],
// 1 16 -230 0 190 0 0 1 0 1 0 -1 0 0 stug9.dat
  [1,16,-230,0,190,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug9(realsolid)],
// 1 16 -230 0 -190 0 0 1 0 1 0 -1 0 0 stug9.dat
  [1,16,-230,0,-190,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug9(realsolid)],
// 1 16 -230 0 10 0 0 1 0 1 0 -1 0 0 stug9.dat
  [1,16,-230,0,10,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug9(realsolid)],
// 1 16 270 0 -30 0 0 1 0 1 0 -1 0 0 stug5.dat
  [1,16,270,0,-30,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug5(realsolid)],
// 1 16 270 0 -130 0 0 1 0 1 0 -1 0 0 stug5.dat
  [1,16,270,0,-130,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug5(realsolid)],
// 1 16 270 0 -230 0 0 1 0 1 0 -1 0 0 stug5.dat
  [1,16,270,0,-230,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug5(realsolid)],
...
// 1 16 260 0 -300 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,260,0,-300,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
...
// 1 16 -310 0 -90 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-310,0,-90,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -290 0 -90 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-290,0,-90,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -270 0 -90 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-270,0,-90,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -250 0 -90 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-250,0,-90,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -230 0 -90 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-230,0,-90,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -210 0 -90 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-210,0,-90,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -190 0 -90 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-190,0,-90,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -170 0 -90 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-170,0,-90,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -150 0 -90 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-150,0,-90,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -190 0 -310 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-190,0,-310,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -190 0 -290 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-190,0,-290,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -170 0 -290 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-170,0,-290,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -170 0 290 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-170,0,290,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -190 0 290 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-190,0,290,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
...
// 1 16 -220 0 -300 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-220,0,-300,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 1 16 40 0 -120 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,40,0,-120,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 1 16 40 0 -80 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,40,0,-80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 1 16 40 0 -40 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,40,0,-40,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 1 16 40 0 0 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,40,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 1 16 40 0 40 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,40,0,40,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 1 16 40 0 80 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,40,0,80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
...
// 1 16 210 0 290 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,210,0,290,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 220 0 -300 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,220,0,-300,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 0 //
];
module ldraw_lib__s__309s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__309s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
