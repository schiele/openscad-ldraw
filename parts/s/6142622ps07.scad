...
use <../../p/1-4cyli.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__6142622ps07(realsolid=false) = [
// 0 ~Sticker  0.8 x  1.9 with Red Stripe on Black and Yellow Background Left - Underside Flat
// 0 Name: s\6142622ps07.dat
...
// 4 16 8 0 -17.7711 6.5 0 -19.2711 -6.5 0 -19.2711 -8 0 -17.7711
  [4,16,8,0,-17.7711,6.5,0,-19.2711,-6.5,0,-19.2711,-8,0,-17.7711],
// 0 // Lateral face
// 3 16 -6.5 0 19.2711 -6.5 -.25 19.2711 -1.125 -.25 19.2711
  [3,16,-6.5,0,19.2711,-6.5,-.25,19.2711,-1.125,-.25,19.2711],
// 4 16 -6.5 0 19.2711 -1.125 -.25 19.2711 6.5 -.25 19.2711 6.5 0 19.2711
  [4,16,-6.5,0,19.2711,-1.125,-.25,19.2711,6.5,-.25,19.2711,6.5,0,19.2711],
...
// 3 16 -8 0 -17.7711 -8 -.25 -17.7711 -8 -.25 -14.6666
  [3,16,-8,0,-17.7711,-8,-.25,-17.7711,-8,-.25,-14.6666],
// 3 16 8 0 -17.7711 8 -.25 -14.6666 8 -.25 -15.6918
  [3,16,8,0,-17.7711,8,-.25,-14.6666,8,-.25,-15.6918],
// 3 16 8 0 -17.7711 8 -.25 -15.6918 8 -.25 -17.7711
  [3,16,8,0,-17.7711,8,-.25,-15.6918,8,-.25,-17.7711],
// 4 16 -6.5 0 -19.2711 6.5 0 -19.2711 6.5 -.25 -19.2711 -6.5 -.25 -19.2711
  [4,16,-6.5,0,-19.2711,6.5,0,-19.2711,6.5,-.25,-19.2711,-6.5,-.25,-19.2711],
];
module ldraw_lib__s__6142622ps07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6142622ps07(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__6142622ps07(line=0.2);