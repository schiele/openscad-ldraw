...
use <90640s03.scad>
use <90640s05.scad>
function ldraw_lib__s__90638s01() = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\90638s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__90638s02()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\90638s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__90638s02()],
// 
// 0 // double connector
// 1 16 0 -30 -23.5 0 0 -1 -1 0 0 0 1 0 s\90640s05.dat
  [1,16,0,-30,-23.5,0,0,-1,-1,0,0,0,1,0, ldraw_lib__s__90640s05()],
// 0 // ball clip
...
// 1 16 0 -49.25 -21.75 0 0 10 0 1 0 -1.75 0 0 rect.dat
  [1,16,0,-49.25,-21.75,0,0,10,0,1,0,-1.75,0,0, ldraw_lib__rect()],
...
module ldraw_lib__s__90638s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__90638s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
