...
use <../../p/stug2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__30366s01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30366s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30366s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\30366s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30366s02(realsolid)],
...
// 1 16 50 24 10 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,50,24,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
// 1 16 -50 24 10 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,-50,24,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 120 0 36 0 0 0 -4 0 0 0 16 box5.dat
  [1,16,0,120,0,36,0,0,0,-4,0,0,0,16, ldraw_lib__box5(realsolid)],
// 1 16 -20 116 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-20,116,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 0 116 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,116,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 20 116 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,20,116,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -30 106 -40 1 0 0 0 0 -1 0 1 0 stud2.dat
  [1,16,-30,106,-40,1,0,0,0,0,-1,0,1,0, ldraw_lib__stud2(realsolid)],
// 1 16 30 106 -40 1 0 0 0 0 -1 0 1 0 stud2.dat
  [1,16,30,106,-40,1,0,0,0,0,-1,0,1,0, ldraw_lib__stud2(realsolid)],
// 0
];
module ldraw_lib__s__30366s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__30366s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
