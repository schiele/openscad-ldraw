...
$fa=1; $fs=0.2;
function ldraw_lib__s__logosantanders05(realsolid=false) = [
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\logosantanders02a.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__logosantanders02a(realsolid)],
...
module ldraw_lib__s__logosantanders05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__logosantanders05(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
