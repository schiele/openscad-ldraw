...
use <32532s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__32531s01(realsolid=false) = [
...
// 1 16 -20 0 30 1 0 0 0 1 0 0 0 1 s\32532s02.dat
  [1,16,-20,0,30,1,0,0,0,1,0,0,0,1, ldraw_lib__s__32532s02(realsolid)],
// 1 16 0 0 30 1 0 0 0 1 0 0 0 1 s\32532s02.dat
  [1,16,0,0,30,1,0,0,0,1,0,0,0,1, ldraw_lib__s__32532s02(realsolid)],
// 1 16 20 0 30 1 0 0 0 1 0 0 0 1 s\32532s02.dat
  [1,16,20,0,30,1,0,0,0,1,0,0,0,1, ldraw_lib__s__32532s02(realsolid)],
// 1 16 50 0 0 0 0 1 0 1 0 -1 0 0 s\32532s02.dat
  [1,16,50,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__32532s02(realsolid)],
// 0 // Straight zones
// 0 // Primitives
// 1 16 -10 13 37 .5 0 0 0 0 11 0 -1 0 box4-2p.dat
  [1,16,-10,13,37,.5,0,0,0,0,11,0,-1,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 10 13 37 .5 0 0 0 0 11 0 -1 0 box4-2p.dat
  [1,16,10,13,37,.5,0,0,0,0,11,0,-1,0, ldraw_lib__box4_2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -10 6 30.5 2 0 0 0 -4 0 0 0 -6.5 box2-11.dat
  [1,16,-10,6,30.5,2,0,0,0,-4,0,0,0,-6.5, ldraw_lib__box2_11(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 6 30.5 2 0 0 0 -4 0 0 0 -6.5 box2-11.dat
  [1,16,10,6,30.5,2,0,0,0,-4,0,0,0,-6.5, ldraw_lib__box2_11(realsolid)],
// 1 16 -10 21 23 2 0 0 0 3 0 0 0 1 box2-11.dat
  [1,16,-10,21,23,2,0,0,0,3,0,0,0,1, ldraw_lib__box2_11(realsolid)],
// 1 16 10 21 23 2 0 0 0 3 0 0 0 1 box2-11.dat
  [1,16,10,21,23,2,0,0,0,3,0,0,0,1, ldraw_lib__box2_11(realsolid)],
// 1 16 -10 17 21 2 0 0 0 7 0 0 0 -1 box2-11.dat
  [1,16,-10,17,21,2,0,0,0,7,0,0,0,-1, ldraw_lib__box2_11(realsolid)],
// 1 16 10 17 21 2 0 0 0 7 0 0 0 -1 box2-11.dat
  [1,16,10,17,21,2,0,0,0,7,0,0,0,-1, ldraw_lib__box2_11(realsolid)],
// 0 // Vertical faces
...
// 1 16 -40 10 20 0 -1 0 0 0 -1 -1 0 0 peghole3.dat
  [1,16,-40,10,20,0,-1,0,0,0,-1,-1,0,0, ldraw_lib__peghole3(realsolid)],
// 1 16 -40 10 20 0 -1 0 0 0 -8 -8 0 0 1-4ndis.dat
  [1,16,-40,10,20,0,-1,0,0,0,-8,-8,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -57 10 20 0 -1 0 0 0 8 8 0 0 2-4ndis.dat
  [1,16,-57,10,20,0,-1,0,0,0,8,8,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -50.5 6 28 6.5 0 0 0 0 -4 0 -1 0 rect3.dat
  [1,16,-50.5,6,28,6.5,0,0,0,0,-4,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 -44 10 20 0 -13 0 0 0 8 8 0 0 2-4cylo.dat
  [1,16,-44,10,20,0,-13,0,0,0,8,8,0,0, ldraw_lib__2_4cylo(realsolid)],
// 1 16 -50.5 6 12 -6.5 0 0 0 0 -4 0 1 0 rect3.dat
  [1,16,-50.5,6,12,-6.5,0,0,0,0,-4,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 -44 10 20 0 1 0 0 0 8 -8 0 0 2-4ndis.dat
  [1,16,-44,10,20,0,1,0,0,0,8,-8,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -32 2 28 -4 0 0 0 -1 0 0 0 -4 1-4chrd.dat
  [1,16,-32,2,28,-4,0,0,0,-1,0,0,0,-4, ldraw_lib__1_4chrd(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -32 24 28 -4 0 0 0 -22 0 0 0 -4 1-4cylo.dat
  [1,16,-32,24,28,-4,0,0,0,-22,0,0,0,-4, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -32 24 28 -4 0 0 0 -1 0 0 0 -4 1-4ring1.dat
  [1,16,-32,24,28,-4,0,0,0,-1,0,0,0,-4, ldraw_lib__1_4ring1(realsolid)],
// 1 16 -32 24 28 -8 0 0 0 -22 0 0 0 -8 1-4cylo.dat
  [1,16,-32,24,28,-8,0,0,0,-22,0,0,0,-8, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -32 2 28 -8 0 0 0 -1 0 0 0 -8 1-4ndis.dat
  [1,16,-32,2,28,-8,0,0,0,-1,0,0,0,-8, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -41 2 24 0 0 -1 0 -1 0 4 0 0 rect1.dat
  [1,16,-41,2,24,0,0,-1,0,-1,0,4,0,0, ldraw_lib__rect1(realsolid)],
// 1 16 -57 13 10 0 1 0 0 0 11 -.5 0 0 box4-2p.dat
  [1,16,-57,13,10,0,1,0,0,0,11,-.5,0,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 -57 13 30 0 1 0 0 0 11 -.5 0 0 box4-2p.dat
  [1,16,-57,13,30,0,1,0,0,0,11,-.5,0,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 -50 13 37 -.5 0 0 0 0 11 0 -1 0 box4-2p.dat
  [1,16,-50,13,37,-.5,0,0,0,0,11,0,-1,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 -40 13 37 -.5 0 0 0 0 11 0 -1 0 box4-2p.dat
  [1,16,-40,13,37,-.5,0,0,0,0,11,0,-1,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 -30 13 37 -.5 0 0 0 0 11 0 -1 0 box4-2p.dat
  [1,16,-30,13,37,-.5,0,0,0,0,11,0,-1,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 -35 13 37 -4.5 0 0 0 0 -11 0 1 0 rect2p.dat
  [1,16,-35,13,37,-4.5,0,0,0,0,-11,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -45 13 37 -4.5 0 0 0 0 -11 0 1 0 rect2p.dat
  [1,16,-45,13,37,-4.5,0,0,0,0,-11,0,1,0, ldraw_lib__rect2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -53.75 13 33.75 0 -3.25 0 11 0 0 0 0 3.25 box2-7.dat
  [1,16,-53.75,13,33.75,0,-3.25,0,11,0,0,0,0,3.25, ldraw_lib__box2_7(realsolid)],
// 1 16 -40 13 29.5 0 4 0 11 0 0 0 0 1.5 box2-7.dat
  [1,16,-40,13,29.5,0,4,0,11,0,0,0,0,1.5, ldraw_lib__box2_7(realsolid)],
// 1 16 -41 17 10 0 0 1 0 7 0 -2 0 0 box2-11.dat
  [1,16,-41,17,10,0,0,1,0,7,0,-2,0,0, ldraw_lib__box2_11(realsolid)],
// 1 16 -43 21 10 0 0 -1 0 3 0 -2 0 0 box2-11.dat
  [1,16,-43,21,10,0,0,-1,0,3,0,-2,0,0, ldraw_lib__box2_11(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -50.5 6 10 0 0 6.5 0 -4 0 -2 0 0 box2-11.dat
  [1,16,-50.5,6,10,0,0,6.5,0,-4,0,-2,0,0, ldraw_lib__box2_11(realsolid)],
// 1 16 -57 20.9503 20 0 1 0 -3.0497 0 0 0 0 -.5 box3u5p.dat
  [1,16,-57,20.9503,20,0,1,0,-3.0497,0,0,0,0,-.5, ldraw_lib__box3u5p(realsolid)],
// 0 // Vertical faces
...
module ldraw_lib__s__32531s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__32531s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
