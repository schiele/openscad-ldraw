...
use <../../p/stug-4x1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__69958s01(realsolid=false) = [
...
// 1 16 0 16 0 160 0 0 0 1 0 0 0 160 recte4.dat
  [1,16,0,16,0,160,0,0,0,1,0,0,0,160, ldraw_lib__recte4(realsolid)],
// 1 16 0 16 0 156 0 0 0 1 0 0 0 156 recte4.dat
  [1,16,0,16,0,156,0,0,0,1,0,0,0,156, ldraw_lib__recte4(realsolid)],
// 
// 1 16 0 0 -140 1 0 0 0 1 0 0 0 1 s\71772s02.dat
  [1,16,0,0,-140,1,0,0,0,1,0,0,0,1, ldraw_lib__s__71772s02(realsolid)],
// 1 16 0 0 140 -1 0 0 0 1 0 0 0 -1 s\71772s02.dat
  [1,16,0,0,140,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__71772s02(realsolid)],
// 1 16 140 0 0 0 0 -1 0 1 0 1 0 0 s\71772s02.dat
  [1,16,140,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__71772s02(realsolid)],
// 1 16 -140 0 0 0 0 1 0 1 0 -1 0 0 s\71772s02.dat
  [1,16,-140,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__71772s02(realsolid)],
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\69958s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__69958s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\69958s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__69958s02(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\69958s02.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__69958s02(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\69958s02.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__69958s02(realsolid)],
// 
// 1 16 -150 8 -80 1 0 0 0 1 0 0 0 1 stug-4x1.dat
  [1,16,-150,8,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x1(realsolid)],
// 1 16 -10 8 -80 1 0 0 0 1 0 0 0 1 stug-4x1.dat
  [1,16,-10,8,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x1(realsolid)],
// 1 16 10 8 -80 1 0 0 0 1 0 0 0 1 stug-4x1.dat
  [1,16,10,8,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x1(realsolid)],
// 1 16 150 8 -80 1 0 0 0 1 0 0 0 1 stug-4x1.dat
  [1,16,150,8,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x1(realsolid)],
// 1 16 80 8 -10 1 0 0 0 1 0 0 0 1 stug-1x4.dat
  [1,16,80,8,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x4(realsolid)],
// 1 16 80 8 -150 1 0 0 0 1 0 0 0 1 stug-1x4.dat
  [1,16,80,8,-150,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x4(realsolid)],
// 1 16 -80 8 -10 1 0 0 0 1 0 0 0 1 stug-1x4.dat
  [1,16,-80,8,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x4(realsolid)],
// 1 16 -80 8 -150 1 0 0 0 1 0 0 0 1 stug-1x4.dat
  [1,16,-80,8,-150,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x4(realsolid)],
...
// 1 16 0 0 80 20 0 0 0 8 0 0 0 40 box4.dat
  [1,16,0,0,80,20,0,0,0,8,0,0,0,40, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -80 20 0 0 0 8 0 0 0 40 box4.dat
  [1,16,0,0,-80,20,0,0,0,8,0,0,0,40, ldraw_lib__box4(realsolid)],
...
// 1 16 80 0 0 0 0 40 0 8 0 -20 0 0 box4.dat
  [1,16,80,0,0,0,0,40,0,8,0,-20,0,0, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -80 0 0 0 0 40 0 8 0 -20 0 0 box4.dat
  [1,16,-80,0,0,0,0,40,0,8,0,-20,0,0, ldraw_lib__box4(realsolid)],
...
module ldraw_lib__s__69958s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__69958s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
