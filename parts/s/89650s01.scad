...
use <../../p/axlehol4.scad>
use <89650s02.scad>
function ldraw_lib__s__89650s01() = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\89650s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__89650s02()],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 1 s\89650s02.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__89650s02()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\89650s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__89650s02()],
...
// 1 16 10.85 0 0 0 1 0 0 0 -6 -6 0 0 4-4edge.dat
  [1,16,10.85,0,0,0,1,0,0,0,-6,-6,0,0, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10.85 0 0 0 2.675 0 0 0 -6 -6 0 0 4-4cyli.dat
  [1,16,10.85,0,0,0,2.675,0,0,0,-6,-6,0,0, ldraw_lib__4_4cyli()],
// 1 16 13.525 0 0 0 1 0 6 0 0 0 0 -6 2-4edge.dat
  [1,16,13.525,0,0,0,1,0,6,0,0,0,0,-6, ldraw_lib__2_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 13.525 0 0 0 3.15 0 -6 0 0 0 0 6 2-4cyli.dat
  [1,16,13.525,0,0,0,3.15,0,-6,0,0,0,0,6, ldraw_lib__2_4cyli()],
// 1 16 16.675 0 0 0 1 0 -4.24264 0 4.24264 4.24264 0 4.24264 1-4edge.dat
  [1,16,16.675,0,0,0,1,0,-4.24264,0,4.24264,4.24264,0,4.24264, ldraw_lib__1_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 16.675 0 0 0 .85 0 4.24264 0 -4.24264 4.24264 0 4.24264 1-8cyls2.dat
  [1,16,16.675,0,0,0,.85,0,4.24264,0,-4.24264,4.24264,0,4.24264, ldraw_lib__1_8cyls2()],
// 1 16 16.675 0 0 0 1 .85 -4.24264 0 -4.24264 4.24264 0 -4.24264 1-8edge.dat
  [1,16,16.675,0,0,0,1,.85,-4.24264,0,-4.24264,4.24264,0,-4.24264, ldraw_lib__1_8edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 16.675 0 0 0 .85 0 -4.24264 0 4.24264 4.24264 0 4.24264 1-8cyls2.dat
  [1,16,16.675,0,0,0,.85,0,-4.24264,0,4.24264,4.24264,0,4.24264, ldraw_lib__1_8cyls2()],
...
// 1 16 20 0 -20 0 -19.5 0 1 0 0 0 0 1 axlehol4.dat
  [1,16,20,0,-20,0,-19.5,0,1,0,0,0,0,1, ldraw_lib__axlehol4()],
// 1 16 .5 0 -20 0 -1 0 0 0 -2 2 0 0 4-4ring2.dat
  [1,16,.5,0,-20,0,-1,0,0,0,-2,2,0,0, ldraw_lib__4_4ring2()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 .5 0 -20 0 -1 0 4 0 0 0 0 4 4-4cylo.dat
  [1,16,.5,0,-20,0,-1,0,4,0,0,0,0,4, ldraw_lib__4_4cylo()],
// 1 16 -.5 0 -20 0 1 0 0 0 -2 2 0 0 4-4ring2.dat
  [1,16,-.5,0,-20,0,1,0,0,0,-2,2,0,0, ldraw_lib__4_4ring2()],
// 1 16 -20 0 -20 0 19.5 0 -1 0 0 0 0 1 axlehol4.dat
  [1,16,-20,0,-20,0,19.5,0,-1,0,0,0,0,1, ldraw_lib__axlehol4()],
...
module ldraw_lib__s__89650s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__89650s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
