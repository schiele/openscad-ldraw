...
use <../../p/rect.scad>
use <../../p/rect2p.scad>
function ldraw_lib__s__32060s01() = [
...
// 1 16 -2 -18.5 -10 0 0 -1.5 -1.5 0 0 0 20 0 2-4cyli.dat
  [1,16,-2,-18.5,-10,0,0,-1.5,-1.5,0,0,0,20,0, ldraw_lib__2_4cyli()],
// 1 16 2 -18.5 -10 0 0 1.5 -1.5 0 0 0 20 0 2-4cyli.dat
  [1,16,2,-18.5,-10,0,0,1.5,-1.5,0,0,0,20,0, ldraw_lib__2_4cyli()],
// 1 16 0 -20 0 2 0 0 0 1 0 0 0 10 rect2p.dat
  [1,16,0,-20,0,2,0,0,0,1,0,0,0,10, ldraw_lib__rect2p()],
// 1 16 2 -18.5 10 0 0 1.5 -1.5 0 0 0 1 0 2-4edge.dat
  [1,16,2,-18.5,10,0,0,1.5,-1.5,0,0,0,1,0, ldraw_lib__2_4edge()],
// 1 16 2 -18.5 -10 0 0 1.5 -1.5 0 0 0 -1 0 2-4edge.dat
  [1,16,2,-18.5,-10,0,0,1.5,-1.5,0,0,0,-1,0, ldraw_lib__2_4edge()],
// 1 16 2 -18.5 10 0 0 1.5 1.5 0 0 0 -1 0 2-4disc.dat
  [1,16,2,-18.5,10,0,0,1.5,1.5,0,0,0,-1,0, ldraw_lib__2_4disc()],
// 1 16 2 -18.5 -10 0 0 1.5 1.5 0 0 0 1 0 2-4disc.dat
  [1,16,2,-18.5,-10,0,0,1.5,1.5,0,0,0,1,0, ldraw_lib__2_4disc()],
// 1 16 -2 -18.5 10 0 0 -1.5 -1.5 0 0 0 1 0 2-4edge.dat
  [1,16,-2,-18.5,10,0,0,-1.5,-1.5,0,0,0,1,0, ldraw_lib__2_4edge()],
...
// 1 16 -2 -12.551 0 0 1 0 0 0 -4.449 -10 0 0 rect.dat
  [1,16,-2,-12.551,0,0,1,0,0,0,-4.449,-10,0,0, ldraw_lib__rect()],
// 1 16 2 -12.551 0 0 -1.0054 0 0 0 -4.449 10 0 0 rect.dat
  [1,16,2,-12.551,0,0,-1.0054,0,0,0,-4.449,10,0,0, ldraw_lib__rect()],
// 1 16 -2.627 -7.977 0 -0.6265 2.49 0 0.1245 12.53 0 0 0 -10 rect2p.dat
  [1,16,-2.627,-7.977,0,-0.6265,2.49,0,0.1245,12.53,0,0,0,-10, ldraw_lib__rect2p()],
// 1 16 2.627 -7.977 0 -0.6265 -2.49 0 -0.1245 12.53 0 0 0 -10 rect2p.dat
  [1,16,2.627,-7.977,0,-0.6265,-2.49,0,-0.1245,12.53,0,0,0,-10, ldraw_lib__rect2p()],
...
module ldraw_lib__s__32060s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__32060s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
