...
use <58381s04.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__58381s01(realsolid=false) = [
...
// 1 16 0 96 0 1 0 0 0 1 0 0 0 1 s\58381s02.dat
  [1,16,0,96,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__58381s02(realsolid)],
...
// 1 16 0 48 40 1 0 0 0 1 0 0 0 1 s\58381s04.dat
  [1,16,0,48,40,1,0,0,0,1,0,0,0,1, ldraw_lib__s__58381s04(realsolid)],
// 
...
// 1 16 8 48 50 -2 0 0 0 0 -48 0 -1 0 rect3.dat
  [1,16,8,48,50,-2,0,0,0,0,-48,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 -1.33 46 -4.4135 -7.33 0.0798 0 0 0 -42 -0.5865 -1 0 rect.dat
  [1,16,-1.33,46,-4.4135,-7.33,0.0798,0,0,0,-42,-0.5865,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 6 46 3.0865 0 1 0 0 0 42 6.9135 0 0 rect2p.dat
  [1,16,6,46,3.0865,0,1,0,0,0,42,6.9135,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 4 0 -8.6603 0 5 0 84 0 -5 0 -8.6603 48\1-6cyli.dat
  [1,16,0,4,0,-8.6603,0,5,0,84,0,-5,0,-8.6603, ldraw_lib__48__1_6cyli(realsolid)],
// 1 16 0 4 0 0 0 10 0 84 0 -10 0 0 48\1-4cyli.dat
  [1,16,0,4,0,0,0,10,0,84,0,-10,0,0, ldraw_lib__48__1_4cyli(realsolid)],
];
module ldraw_lib__s__58381s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__58381s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
