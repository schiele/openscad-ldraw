...
use <../../p/stug2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__48170s03(realsolid=false) = [
// 0 ~Technic Brick  2 x  2 with Hole Type 2 without End Faces
// 0 Name: s\48170s03.dat
...
// 4 16 -20 24 20 -20 24 -20 -20 18 -8 -20 18 8
  [4,16,-20,24,20,-20,24,-20,-20,18,-8,-20,18,8],
// 4 16 -20 24 -20 -20 24 20 -16 24 18 -16 24 -18
  [4,16,-20,24,-20,-20,24,20,-16,24,18,-16,24,-18],
// 4 16 20 24 20 20 24 -20 16 24 -18 16 24 18
  [4,16,20,24,20,20,24,-20,16,24,-18,16,24,18],
// 4 16 -16 24 -18 -16 24 18 -16 19 9 -16 19 -9
  [4,16,-16,24,-18,-16,24,18,-16,19,9,-16,19,-9],
// 4 16 16 24 18 16 24 -18 16 19 -9 16 19 9
  [4,16,16,24,18,16,24,-18,16,19,-9,16,19,9],
// 0
];
module ldraw_lib__s__48170s03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__48170s03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__48170s03(line=0.2);