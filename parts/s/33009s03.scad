...
use <../../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__33009s03(realsolid=false) = [
...
// 1 16 -17 0 -1 17 0 0 0 0 27 0 3 0 box5.dat
  [1,16,-17,0,-1,17,0,0,0,0,27,0,3,0, ldraw_lib__box5(realsolid)],
// 1 16 -17 0 2 16 0 0 0 0 26 0 6 0 box4.dat
  [1,16,-17,0,2,16,0,0,0,0,26,0,6,0, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -31 0 5 0 28 0 0 0 24 -3 0 0 box3u2p.dat
  [1,16,-31,0,5,0,28,0,0,0,24,-3,0,0, ldraw_lib__box3u2p(realsolid)],
// 
...
// 1 16 -31 0 5 0 -1 0 -4 0 0 0 0 1 4-4ndis.dat
  [1,16,-31,0,5,0,-1,0,-4,0,0,0,0,1, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -31 0 5 0 1 0 -4 0 0 0 0 1 4-4edge.dat
  [1,16,-31,0,5,0,1,0,-4,0,0,0,0,1, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -31 0 5 0 -0.5 0 -4 0 0 0 0 1 4-8sphe.dat
  [1,16,-31,0,5,0,-0.5,0,-4,0,0,0,0,1, ldraw_lib__4_8sphe(realsolid)],
// 
...
module ldraw_lib__s__33009s03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__33009s03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
