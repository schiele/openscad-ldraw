...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2525s01(realsolid=false) = [
...
// 1 16 0 48 10 2 0 0 0 0 -48 0 120 0 box3u2p.dat
  [1,16,0,48,10,2,0,0,0,0,-48,0,120,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 0 4 10 2 0 0 0 0 4 0 1 0 rect3.dat
  [1,16,0,4,10,2,0,0,0,0,4,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 48 10 2 0 0 0 0 32 0 1 0 rect.dat
  [1,16,0,48,10,2,0,0,0,0,32,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 92 10 2 0 0 0 0 -4 0 1 0 rect3.dat
  [1,16,0,92,10,2,0,0,0,0,-4,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 84 0 1 0 0 0 1 0 0 0 1 clip1.dat
  [1,16,0,84,0,1,0,0,0,1,0,0,0,1, ldraw_lib__clip1(realsolid)],
// 2 24 2 80 10 2 88 10
  [2,24,2,80,10,2,88,10],
// 2 24 -2 80 10 -2 88 10
  [2,24,-2,80,10,-2,88,10],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 clip1.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__clip1(realsolid)],
// 2 24 2 8 10 2 16 10
  [2,24,2,8,10,2,16,10],
// 2 24 -2 8 10 -2 16 10
  [2,24,-2,8,10,-2,16,10],
...
module ldraw_lib__s__2525s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2525s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
