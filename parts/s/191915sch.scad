...
use <191915scha.scad>
use <191915schb.scad>
function ldraw_lib__s__191915sch() = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\191915scha.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__191915scha()],
...
module ldraw_lib__s__191915sch(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__191915sch(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
