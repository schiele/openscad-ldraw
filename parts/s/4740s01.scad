...
use <../../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__4740s01(realsolid=false) = [
...
// 1 16 0 5.6 0 20 0 0 0 2.4 0 0 0 20 4-4cylo.dat
  [1,16,0,5.6,0,20,0,0,0,2.4,0,0,0,20, ldraw_lib__4_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 4 0 0 0 2.7 0 0 0 4 4-4cyli.dat
  [1,16,0,0,0,4,0,0,0,2.7,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 0 6 0 0 0 -1.3 0 0 0 6 4-4cyli.dat
  [1,16,0,4,0,6,0,0,0,-1.3,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 4 0 8 0 0 0 -1.3 0 0 0 8 4-4cyli.dat
  [1,16,0,4,0,8,0,0,0,-1.3,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 2.7 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,2.7,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 2.7 0 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,0,2.7,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 2.7 0 2 0 0 0 -1 0 0 0 2 4-4ring2.dat
  [1,16,0,2.7,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring2(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 5.8 0 8 0 0 0 -3.1 0 0 0 8 4-4con1.dat
  [1,16,0,5.8,0,8,0,0,0,-3.1,0,0,0,8, ldraw_lib__4_4con1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 4 0 0 0 -2.2 0 0 0 4 4-4con4.dat
  [1,16,0,8,0,4,0,0,0,-2.2,0,0,0,4, ldraw_lib__4_4con4(realsolid)],
...
module ldraw_lib__s__4740s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__4740s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
