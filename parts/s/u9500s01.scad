...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__u9500s01(realsolid=false) = [
...
// 1 16 10 12 25 0 -1 0 12 0 0 0 0 25 rect3.dat
  [1,16,10,12,25,0,-1,0,12,0,0,0,0,25, ldraw_lib__rect3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 0 6 0 0 0 20 0 0 0 6 4-4cylo.dat
  [1,16,0,4,0,6,0,0,0,20,0,0,0,6, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 4 0 6 0 0 0 -1 0 0 0 6 4-4disc.dat
  [1,16,0,4,0,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 0 10 0 0 0 24 0 0 0 -10 3-4cylo.dat
  [1,16,0,0,0,10,0,0,0,24,0,0,0,-10, ldraw_lib__3_4cylo(realsolid)],
...
// 1 16 3 12 30 0 0 3 -12 0 0 0 -20 0 box2-7.dat
  [1,16,3,12,30,0,0,3,-12,0,0,0,-20,0, ldraw_lib__box2_7(realsolid)],
...
// 1 16 8 12 50 0 0 -2 12 0 0 0 -1 0 rect3.dat
  [1,16,8,12,50,0,0,-2,12,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__s__u9500s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u9500s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
