...
$fa=1; $fs=0.2;
function ldraw_lib__s__87079pt3s01(realsolid=false) = [
...
// 1 16 20.5 0 13.2 1 0 0 0 1 0 0 0 1 s\87079pt3s02.dat
  [1,16,20.5,0,13.2,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87079pt3s02(realsolid)],
// 1 16 20.5 0 1 1 0 0 0 1 0 0 0 1 s\87079pt3s02.dat
  [1,16,20.5,0,1,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87079pt3s02(realsolid)],
// 1 16 20.5 0 -11.2 1 0 0 0 1 0 0 0 1 s\87079pt3s02.dat
  [1,16,20.5,0,-11.2,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87079pt3s02(realsolid)],
// 1 16 10.6 0 .3 1 0 0 0 1 0 0 0 1 1-4ndis.dat
  [1,16,10.6,0,.3,1,0,0,0,1,0,0,0,1, ldraw_lib__1_4ndis(realsolid)],
// 1 16 10.6 0 -7.05 1 0 0 0 1 0 0 0 -1 1-4ndis.dat
  [1,16,10.6,0,-7.05,1,0,0,0,1,0,0,0,-1, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 13.3 0 13.5 .8 0 0 0 1 0 0 0 .8 1-4ndis.dat
  [1,16,13.3,0,13.5,.8,0,0,0,1,0,0,0,.8, ldraw_lib__1_4ndis(realsolid)],
// 1 16 13.3 0 4.7 .8 0 0 0 1 0 0 0 -.8 1-4ndis.dat
  [1,16,13.3,0,4.7,.8,0,0,0,1,0,0,0,-.8, ldraw_lib__1_4ndis(realsolid)],
...
// 1 0 13.3 0 13.5 .8 0 0 0 1 0 0 0 .8 1-4chrd.dat
  [1,0,13.3,0,13.5,.8,0,0,0,1,0,0,0,.8, ldraw_lib__1_4chrd(realsolid)],
// 1 0 13.3 0 4.7 .8 0 0 0 1 0 0 0 -.8 1-4chrd.dat
  [1,0,13.3,0,4.7,.8,0,0,0,1,0,0,0,-.8, ldraw_lib__1_4chrd(realsolid)],
// 1 0 10.5 0 .2 .4 0 0 0 1 0 0 0 .4 1-4chrd.dat
  [1,0,10.5,0,.2,.4,0,0,0,1,0,0,0,.4, ldraw_lib__1_4chrd(realsolid)],
// 1 0 10.5 0 -6.95 .4 0 0 0 1 0 0 0 -.4 1-4chrd.dat
  [1,0,10.5,0,-6.95,.4,0,0,0,1,0,0,0,-.4, ldraw_lib__1_4chrd(realsolid)],
// 
// 1 82 10.6 0 .3 1 0 0 0 1 0 0 0 1 1-4chrd.dat
  [1,82,10.6,0,.3,1,0,0,0,1,0,0,0,1, ldraw_lib__1_4chrd(realsolid)],
// 1 82 10.5 0 .2 .4 0 0 0 1 0 0 0 .4 1-4ndis.dat
  [1,82,10.5,0,.2,.4,0,0,0,1,0,0,0,.4, ldraw_lib__1_4ndis(realsolid)],
// 1 82 10.6 0 -7.05 1 0 0 0 1 0 0 0 -1 1-4chrd.dat
  [1,82,10.6,0,-7.05,1,0,0,0,1,0,0,0,-1, ldraw_lib__1_4chrd(realsolid)],
// 1 82 10.5 0 -6.95 .4 0 0 0 1 0 0 0 -.4 1-4ndis.dat
  [1,82,10.5,0,-6.95,.4,0,0,0,1,0,0,0,-.4, ldraw_lib__1_4ndis(realsolid)],
...
module ldraw_lib__s__87079pt3s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__87079pt3s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
