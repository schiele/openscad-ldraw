...
use <../../p/5-8edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__32170s01(realsolid=false) = [
...
// 1 16 0 0 0 5 0 0 0 1 0 0 0 5 2-4edge.dat
  [1,16,0,0,0,5,0,0,0,1,0,0,0,5, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 0 0 5 0 0 0 1 0 0 0 5 2-4ndis.dat
  [1,16,0,0,0,5,0,0,0,1,0,0,0,5, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 0 0 0 5 0 0 0 8 0 0 0 5 2-4cyli.dat
  [1,16,0,0,0,5,0,0,0,8,0,0,0,5, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 0 -65 -5 0 0 0 1 0 0 0 -5 2-4edge.dat
  [1,16,0,0,-65,-5,0,0,0,1,0,0,0,-5, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 0 -65 -1 0 0 0 1 0 0 0 -1 2-4ring5.dat
  [1,16,0,0,-65,-1,0,0,0,1,0,0,0,-1, ldraw_lib__2_4ring5(realsolid)],
// 1 16 0 0 -65 -1 0 0 0 1 0 0 0 -1 2-4ring6.dat
  [1,16,0,0,-65,-1,0,0,0,1,0,0,0,-1, ldraw_lib__2_4ring6(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -65 -5 0 0 0 8 0 0 0 -5 2-4cyli.dat
  [1,16,0,0,-65,-5,0,0,0,8,0,0,0,-5, ldraw_lib__2_4cyli(realsolid)],
// 2 24 5 0 0 5 0 -65
  [2,24,5,0,0,5,0,-65],
// 2 24 -5 0 0 -5 0 -65
  [2,24,-5,0,0,-5,0,-65],
...
// 1 16 0 8 0 5 0 0 0 1 0 0 0 5 2-4edge.dat
  [1,16,0,8,0,5,0,0,0,1,0,0,0,5, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 8 0 5 0 0 0 1 0 0 0 5 2-4disc.dat
  [1,16,0,8,0,5,0,0,0,1,0,0,0,5, ldraw_lib__2_4disc(realsolid)],
// 1 16 0 8 -65 -5 0 0 0 1 0 0 0 -5 2-4edge.dat
  [1,16,0,8,-65,-5,0,0,0,1,0,0,0,-5, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 8 -65 -5 0 0 0 1 0 0 0 -5 2-4disc.dat
  [1,16,0,8,-65,-5,0,0,0,1,0,0,0,-5, ldraw_lib__2_4disc(realsolid)],
// 2 24 5 8 0 5 8 -65
  [2,24,5,8,0,5,8,-65],
// 2 24 -5 8 0 -5 8 -65
  [2,24,-5,8,0,-5,8,-65],
...
// 1 16 0 3 0 -3 0 0 0 1 0 0 0 -3 4-4cyli.dat
  [1,16,0,3,0,-3,0,0,0,1,0,0,0,-3, ldraw_lib__4_4cyli(realsolid)],
// 2 24 5 4 -2 3 4 -2
  [2,24,5,4,-2,3,4,-2],
...
// 1 16 0 4 0 5 0 0 0 1 0 0 0 5 2-4edge.dat
  [1,16,0,4,0,5,0,0,0,1,0,0,0,5, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 3 0 -1 0 0 0 1 0 0 0 -1 4-4ring3.dat
  [1,16,0,3,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__4_4ring3(realsolid)],
// 1 16 0 4 0 1 0 0 0 1 0 0 0 1 2-4ring4.dat
  [1,16,0,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2_4ring4(realsolid)],
...
// 1 16 0 8 0 -4 0 0 0 1 0 0 0 -4 2-4edge.dat
  [1,16,0,8,0,-4,0,0,0,1,0,0,0,-4, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 3 0 -4 0 0 0 5 0 0 0 -4 2-4cyli.dat
  [1,16,0,3,0,-4,0,0,0,5,0,0,0,-4, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 3 0 4 0 0 0 1 0 0 0 4 2-4cyli.dat
  [1,16,0,3,0,4,0,0,0,1,0,0,0,4, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 4 0 3.69552 0 1.53073 0 1 0 -1.53073 0 3.69552 5-8edge.dat
  [1,16,0,4,0,3.69552,0,1.53073,0,1,0,-1.53073,0,3.69552, ldraw_lib__5_8edge(realsolid)],
// 0 Ende
// 1 16 0 3 -65 3 0 0 0 1 0 0 0 3 4-4edge.dat
  [1,16,0,3,-65,3,0,0,0,1,0,0,0,3, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 4 -65 3 0 0 0 1 0 0 0 3 4-4edge.dat
  [1,16,0,4,-65,3,0,0,0,1,0,0,0,3, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 4 -65 3 0 0 0 1 0 0 0 3 4-4disc.dat
  [1,16,0,4,-65,3,0,0,0,1,0,0,0,3, ldraw_lib__4_4disc(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 3 -65 3 0 0 0 1 0 0 0 3 4-4cyli.dat
  [1,16,0,3,-65,3,0,0,0,1,0,0,0,3, ldraw_lib__4_4cyli(realsolid)],
// 2 24 3 4 -63 5 4 -63
  [2,24,3,4,-63,5,4,-63],
// 2 24 -5 4 -63 -3 4 -63
  [2,24,-5,4,-63,-3,4,-63],
...
// 1 16 0 4 -65 -5 0 0 0 1 0 0 0 -5 2-4edge.dat
  [1,16,0,4,-65,-5,0,0,0,1,0,0,0,-5, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 4 -65 -3.69552 0 -1.53073 0 1 0 1.53073 0 -3.69552 5-8edge.dat
  [1,16,0,4,-65,-3.69552,0,-1.53073,0,1,0,1.53073,0,-3.69552, ldraw_lib__5_8edge(realsolid)],
// 1 16 0 3 -65 1 0 0 0 1 0 0 0 1 4-4ring3.dat
  [1,16,0,3,-65,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4ring3(realsolid)],
// 1 16 0 3 -65 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,0,3,-65,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 8 -65 4 0 0 0 1 0 0 0 4 2-4edge.dat
  [1,16,0,8,-65,4,0,0,0,1,0,0,0,4, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 3 -65 4 0 0 0 5 0 0 0 4 2-4cyli.dat
  [1,16,0,3,-65,4,0,0,0,5,0,0,0,4, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 3 -65 -4 0 0 0 1 0 0 0 -4 2-4cyli.dat
  [1,16,0,3,-65,-4,0,0,0,1,0,0,0,-4, ldraw_lib__2_4cyli(realsolid)],
// 0 Mittelcylinder
// 1 16 0 8 -4 -4 0 0 0 0 -4 0 -4 0 2-4cyli.dat
  [1,16,0,8,-4,-4,0,0,0,0,-4,0,-4,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 8 -4 -4 0 0 0 0 -4 0 -4 0 2-4edge.dat
  [1,16,0,8,-4,-4,0,0,0,0,-4,0,-4,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 8 -4 -1 0 0 0 0 -1 0 -1 0 2-4ring3.dat
  [1,16,0,8,-4,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__2_4ring3(realsolid)],
// 1 16 0 8 -8 1 0 0 0 0 -1 0 1 0 2-4ring3.dat
  [1,16,0,8,-8,1,0,0,0,0,-1,0,1,0, ldraw_lib__2_4ring3(realsolid)],
// 1 16 0 8 -34 -1 0 0 0 0 -1 0 -1 0 2-4ring3.dat
  [1,16,0,8,-34,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__2_4ring3(realsolid)],
// 1 16 0 8 -38 2 0 0 0 0 -2 0 1 0 2-4ring1.dat
  [1,16,0,8,-38,2,0,0,0,0,-2,0,1,0, ldraw_lib__2_4ring1(realsolid)],
// 1 16 0 8 -8 -4 0 0 0 0 -4 0 -4 0 2-4edge.dat
  [1,16,0,8,-8,-4,0,0,0,0,-4,0,-4,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 8 -34 -4 0 0 0 0 -4 0 -4 0 2-4cyli.dat
  [1,16,0,8,-34,-4,0,0,0,0,-4,0,-4,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 8 -34 -4 0 0 0 0 -4 0 -4 0 2-4edge.dat
  [1,16,0,8,-34,-4,0,0,0,0,-4,0,-4,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 8 -38 -4 0 0 0 0 -4 0 -4 0 2-4edge.dat
  [1,16,0,8,-38,-4,0,0,0,0,-4,0,-4,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 8 -2 -3 0 0 0 0 -3 0 -32 0 2-4cyli.dat
  [1,16,0,8,-2,-3,0,0,0,0,-3,0,-32,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 8 -8 -3 0 0 0 0 -3 0 -26 0 2-4edge.dat
  [1,16,0,8,-8,-3,0,0,0,0,-3,0,-26,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 8 -4 -3 0 0 0 0 -3 0 -26 0 2-4edge.dat
  [1,16,0,8,-4,-3,0,0,0,0,-3,0,-26,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 8 -34 -3 0 0 0 0 -3 0 -26 0 2-4edge.dat
  [1,16,0,8,-34,-3,0,0,0,0,-3,0,-26,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 8 -38 -2 0 0 0 0 -2 0 -24 0 2-4cyli.dat
  [1,16,0,8,-38,-2,0,0,0,0,-2,0,-24,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 8 -38 -2 0 0 0 0 -2 0 -26 0 2-4edge.dat
  [1,16,0,8,-38,-2,0,0,0,0,-2,0,-26,0, ldraw_lib__2_4edge(realsolid)],
// 2 24 -3 8 -4 -3 8 -2
  [2,24,-3,8,-4,-3,8,-2],
// 2 24 3 8 -4 3 8 -2
  [2,24,3,8,-4,3,8,-2],
...
// 1 16 0 4 -65 -1 0 0 0 1 0 0 0 -1 2-4ring4.dat
  [1,16,0,4,-65,-1,0,0,0,1,0,0,0,-1, ldraw_lib__2_4ring4(realsolid)],
...
module ldraw_lib__s__32170s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__32170s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
