...
use <93220s04.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__93220s01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\93220s04.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__93220s04(realsolid)],
// 1 16 0 -10 0 5.25 0 0 0 -12 0 0 0 -5.25 2-4cyli.dat
  [1,16,0,-10,0,5.25,0,0,0,-12,0,0,0,-5.25, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 -51 0 .875 0 0 0 29 0 0 0 -.875 2-4con6.dat
  [1,16,0,-51,0,.875,0,0,0,29,0,0,0,-.875, ldraw_lib__2_4con6(realsolid)],
// 1 16 0 -51 0 6.125 0 0 0 -10 0 0 0 -6.125 2-4cyli.dat
  [1,16,0,-51,0,6.125,0,0,0,-10,0,0,0,-6.125, ldraw_lib__2_4cyli(realsolid)],
];
module ldraw_lib__s__93220s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__93220s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
