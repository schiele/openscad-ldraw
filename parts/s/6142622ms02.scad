...
use <../../p/1-4ndis.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__6142622ms02(realsolid=false) = [
...
// 1 0 -5.45 -.25 .7172 -.7 0 0 0 1 0 0 0 .7 1-4ndis.dat
  [1,0,-5.45,-.25,.7172,-.7,0,0,0,1,0,0,0,.7, ldraw_lib__1_4ndis(realsolid)],
// 1 7 -5.45 -.25 .7172 -.7 0 0 0 1 0 0 0 .7 1-4chrd.dat
  [1,7,-5.45,-.25,.7172,-.7,0,0,0,1,0,0,0,.7, ldraw_lib__1_4chrd(realsolid)],
// 1 7 -4.35 -.25 .7172 .7 0 0 0 1 0 0 0 .7 1-4chrd.dat
  [1,7,-4.35,-.25,.7172,.7,0,0,0,1,0,0,0,.7, ldraw_lib__1_4chrd(realsolid)],
// 1 0 -4.35 -.25 .7172 .7 0 0 0 1 0 0 0 .7 1-4ndis.dat
  [1,0,-4.35,-.25,.7172,.7,0,0,0,1,0,0,0,.7, ldraw_lib__1_4ndis(realsolid)],
// 0 // Yellow faces
...
module ldraw_lib__s__6142622ms02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6142622ms02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
