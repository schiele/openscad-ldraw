...
$fa=1; $fs=0.2;
function ldraw_lib__s__4162s01(realsolid=false) = [
...
// 1 16 0 7 0 80 0 0 0 -7 0 0 0 10 box4.dat
  [1,16,0,7,0,80,0,0,0,-7,0,0,0,10, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 8 0 79 0 0 0 -1 0 0 0 9 box4.dat
  [1,16,0,8,0,79,0,0,0,-1,0,0,0,9, ldraw_lib__box4(realsolid)],
...
// 1 16 0 4 0 1 0 0 0 -1 0 0 0 1 stug3-1x7.dat
  [1,16,0,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stug3_1x7(realsolid)],
];
module ldraw_lib__s__4162s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__4162s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
