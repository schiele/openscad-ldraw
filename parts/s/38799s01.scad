...
use <../../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__38799s01(realsolid=false) = [
...
// 1 16 0 3 0 -4 0 0 0 -1 0 0 0 4 4-4ring2.dat
  [1,16,0,3,0,-4,0,0,0,-1,0,0,0,4, ldraw_lib__4_4ring2(realsolid)],
// 1 16 0 3 0 2 0 0 0 -1 0 0 0 2 4-4ring6.dat
  [1,16,0,3,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring6(realsolid)],
// 1 16 0 0 0 14 0 0 0 3 0 0 0 14 4-4cylo.dat
  [1,16,0,0,0,14,0,0,0,3,0,0,0,14, ldraw_lib__4_4cylo(realsolid)],
...
module ldraw_lib__s__38799s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__38799s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
