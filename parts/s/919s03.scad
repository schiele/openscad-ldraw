...
use <../../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__919s03(realsolid=false) = [
...
// 1 16 77 50 20 0 -154 0 20 0 0 0 0 20 1-16cyli.dat
  [1,16,77,50,20,0,-154,0,20,0,0,0,0,20, ldraw_lib__1_16cyli(realsolid)],
// 1 16 77 50 -20 0 -154 0 20 0 0 0 0 -20 1-16cyli.dat
  [1,16,77,50,-20,0,-154,0,20,0,0,0,0,-20, ldraw_lib__1_16cyli(realsolid)],
// 1 16 0 70 0 0 0 77 0 -1 0 20 0 0 rect2p.dat
  [1,16,0,70,0,0,0,77,0,-1,0,20,0,0, ldraw_lib__rect2p(realsolid)],
// 2 24 -77 68.47 27.65 77 68.47 27.65
  [2,24,-77,68.47,27.65,77,68.47,27.65],
// 2 24 -77 68.47 -27.65 77 68.47 -27.65
  [2,24,-77,68.47,-27.65,77,68.47,-27.65],
// 1 16 0 68.47 0 -77 0 0 0 -2.53 0 0 0 27.65 box5-4a.dat
  [1,16,0,68.47,0,-77,0,0,0,-2.53,0,0,0,27.65, ldraw_lib__box5_4a(realsolid)],
// 1 16 77 50 20 0 -154 0 20 0 0 0 0 20 1-16edge.dat
  [1,16,77,50,20,0,-154,0,20,0,0,0,0,20, ldraw_lib__1_16edge(realsolid)],
// 1 16 77 50 -20 0 -154 0 20 0 0 0 0 -20 1-16edge.dat
  [1,16,77,50,-20,0,-154,0,20,0,0,0,0,-20, ldraw_lib__1_16edge(realsolid)],
// 1 16 -77 50 20 0 -154 0 20 0 0 0 0 20 1-16edge.dat
  [1,16,-77,50,20,0,-154,0,20,0,0,0,0,20, ldraw_lib__1_16edge(realsolid)],
...
// 1 16 0 66 0 -77 0 0 0 -134 0 0 0 1 box5.dat
  [1,16,0,66,0,-77,0,0,0,-134,0,0,0,1, ldraw_lib__box5(realsolid)],
// 0
];
module ldraw_lib__s__919s03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__919s03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
