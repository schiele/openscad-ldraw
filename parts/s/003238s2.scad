...
use <../../p/1-4ndis.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__003238s2(realsolid=false) = [
...
// 1 16 0 0 -5 -135 0 0 0 1 0 0 0 -47 1-4ndis.dat
  [1,16,0,0,-5,-135,0,0,0,1,0,0,0,-47, ldraw_lib__1_4ndis(realsolid)],
...
module ldraw_lib__s__003238s2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__003238s2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
