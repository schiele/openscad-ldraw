...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__61345s01(realsolid=false) = [
...
// 1 16 12 28 -7 -4 0 0 0 0 4 0 -1 0 1-4ndis.dat
  [1,16,12,28,-7,-4,0,0,0,0,4,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 28 28 -7 4 0 0 0 0 4 0 -1 0 1-4ndis.dat
  [1,16,28,28,-7,4,0,0,0,0,4,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 12 8 -7 -4 0 0 0 0 -4 0 -1 0 1-4ndis.dat
  [1,16,12,8,-7,-4,0,0,0,0,-4,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 28 8 -7 4 0 0 0 0 -4 0 -1 0 1-4ndis.dat
  [1,16,28,8,-7,4,0,0,0,0,-4,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 12 28 -10 -4 0 0 0 0 4 0 3 0 1-4cylo.dat
  [1,16,12,28,-10,-4,0,0,0,0,4,0,3,0, ldraw_lib__1_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 28 28 -10 4 0 0 0 0 4 0 3 0 1-4cylo.dat
  [1,16,28,28,-10,4,0,0,0,0,4,0,3,0, ldraw_lib__1_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 12 8 -10 -4 0 0 0 0 -4 0 3 0 1-4cylo.dat
  [1,16,12,8,-10,-4,0,0,0,0,-4,0,3,0, ldraw_lib__1_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 28 8 -10 4 0 0 0 0 -4 0 3 0 1-4cylo.dat
  [1,16,28,8,-10,4,0,0,0,0,-4,0,3,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 20 32 -8.5 8 0 0 0 1 0 0 0 1.5 rect2p.dat
  [1,16,20,32,-8.5,8,0,0,0,1,0,0,0,1.5, ldraw_lib__rect2p(realsolid)],
// 1 16 20 4 -8.5 -8 0 0 0 -1 0 0 0 1.5 rect2p.dat
  [1,16,20,4,-8.5,-8,0,0,0,-1,0,0,0,1.5, ldraw_lib__rect2p(realsolid)],
// 1 16 8 18 -8.5 0 -1 0 10 0 0 0 0 1.5 rect2p.dat
  [1,16,8,18,-8.5,0,-1,0,10,0,0,0,0,1.5, ldraw_lib__rect2p(realsolid)],
// 1 16 32 18 -8.5 0 1 0 -10 0 0 0 0 1.5 rect2p.dat
  [1,16,32,18,-8.5,0,1,0,-10,0,0,0,0,1.5, ldraw_lib__rect2p(realsolid)],
// 
// 0 // tophole
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 0 -4.7 -2.3 0 0 0 3 0 0 0 -2.3 4-4cylo.dat
  [1,16,20,0,-4.7,-2.3,0,0,0,3,0,0,0,-2.3, ldraw_lib__4_4cylo(realsolid)],
// 1 16 20 0 -4.7 -2.3 0 0 0 1 0 0 0 -2.3 4-4ndis.dat
  [1,16,20,0,-4.7,-2.3,0,0,0,1,0,0,0,-2.3, ldraw_lib__4_4ndis(realsolid)],
// 1 16 20 3 -4.7 -2.3 0 0 0 -1 0 0 0 2.3 4-4ndis.dat
  [1,16,20,3,-4.7,-2.3,0,0,0,-1,0,0,0,2.3, ldraw_lib__4_4ndis(realsolid)],
// 0 // bottomhole
// 1 16 20 40 -4.7 -2.3 0 0 0 1 0 0 0 -2.3 4-4edge.dat
  [1,16,20,40,-4.7,-2.3,0,0,0,1,0,0,0,-2.3, ldraw_lib__4_4edge(realsolid)],
// 1 16 20 44 -4.7 2.1249 0 0.8802 0 1 0 -0.8802 0 2.1249 5-8edge.dat
  [1,16,20,44,-4.7,2.1249,0,0.8802,0,1,0,-0.8802,0,2.1249, ldraw_lib__5_8edge(realsolid)],
// 1 16 20 44 -4.7 -2.3 0 0 0 -1 0 0 0 2.3 2-4ndis.dat
  [1,16,20,44,-4.7,-2.3,0,0,0,-1,0,0,0,2.3, ldraw_lib__2_4ndis(realsolid)],
// 1 16 20 48 -4.7 -1.6264 0 1.6264 0 1 0 -1.6264 0 -1.6264 1-4edge.dat
  [1,16,20,48,-4.7,-1.6264,0,1.6264,0,1,0,-1.6264,0,-1.6264, ldraw_lib__1_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 48 -4.7 -1.6264 0 1.6264 0 -4 0 -1.6264 0 -1.6264 1-4cyli.dat
  [1,16,20,48,-4.7,-1.6264,0,1.6264,0,-4,0,-1.6264,0,-1.6264, ldraw_lib__1_4cyli(realsolid)],
// 1 16 20 40 -4.7 -2.3 0 0 0 1 0 0 0 -2.3 4-4ndis.dat
  [1,16,20,40,-4.7,-2.3,0,0,0,1,0,0,0,-2.3, ldraw_lib__4_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 40 -4.7 -2.3 0 0 0 4 0 0 0 -2.3 4-4cyli.dat
  [1,16,20,40,-4.7,-2.3,0,0,0,4,0,0,0,-2.3, ldraw_lib__4_4cyli(realsolid)],
// 
// 0 // inner structure
// 2 24 37 3 -7 3 3 -7
  [2,24,37,3,-7,3,3,-7],
...
// 1 16 20 1.5 10 0 0 20 -1.5 0 0 0 -1 0 rect3.dat
  [1,16,20,1.5,10,0,0,20,-1.5,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 38.5 21.5 -5 0 0 -1.5 18.5 0 0 0 2 0 box2-5.dat
  [1,16,38.5,21.5,-5,0,0,-1.5,18.5,0,0,0,2,0, ldraw_lib__box2_5(realsolid)],
// 2 24 40 40 -3 40 40 10
  [2,24,40,40,-3,40,40,10],
// 1 16 20 44 10 0 0 20 -4 0 0 0 -1 0 rect3.dat
  [1,16,20,44,10,0,0,20,-4,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 8.25 48 0 4.25 0 0 0 -4 0 0 0 6 box3u6.dat
  [1,16,8.25,48,0,4.25,0,0,0,-4,0,0,0,6, ldraw_lib__box3u6(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 27.5 46 0 0 8.5 0 0 0 -2 6 0 0 box4-2p.dat
  [1,16,27.5,46,0,0,8.5,0,0,0,-2,6,0,0, ldraw_lib__box4_2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 48 5.75 -3.5 0 0 0 -4 0 0 0 0.25 box4-4a.dat
  [1,16,20,48,5.75,-3.5,0,0,0,-4,0,0,0,0.25, ldraw_lib__box4_4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 17.328 46 -5.75 0 0 -0.8278 2 0 0 0 -0.25 0 box2-7.dat
  [1,16,17.328,46,-5.75,0,0,-0.8278,2,0,0,0,-0.25,0, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 22.672 46 -5.75 0 0 0.8278 2 0 0 0 -0.25 0 box2-7.dat
  [1,16,22.672,46,-5.75,0,0,0.8278,2,0,0,0,-0.25,0, ldraw_lib__box2_7(realsolid)],
// 
// 2 24 21.844 44 -6 22.125 44 -5.58
  [2,24,21.844,44,-6,22.125,44,-5.58],
// 1 16 21.735 46 -6.163 0.109 1 0 0 0 2 0.1632 0 0 rect2a.dat
  [1,16,21.735,46,-6.163,0.109,1,0,0,0,2,0.1632,0,0, ldraw_lib__rect2a(realsolid)],
...
// 1 16 18.265 46 -6.163 0 -1 -0.109 2 0 0 0 0 0.1632 rect2a.dat
  [1,16,18.265,46,-6.163,0,-1,-0.109,2,0,0,0,0,0.1632, ldraw_lib__rect2a(realsolid)],
// 5 24 18.374 44 -6.326 18.374 48 -6.326 18.156 48 -6 19.12 48 -6.825
  [5,24,18.374,44,-6.326,18.374,48,-6.326,18.156,48,-6,19.12,48,-6.825],
// 
// 1 16 25 44 -5.501 -1.5 0 0 0 -1 0 0 0 1.5 3-8ndis.dat
  [1,16,25,44,-5.501,-1.5,0,0,0,-1,0,0,0,1.5, ldraw_lib__3_8ndis(realsolid)],
// 1 16 15 44 -5.501 1.5 0 0 0 -1 0 0 0 1.5 3-8ndis.dat
  [1,16,15,44,-5.501,1.5,0,0,0,-1,0,0,0,1.5, ldraw_lib__3_8ndis(realsolid)],
// 1 16 15 44 5.501 1.5 0 0 0 -1 0 0 0 -1.5 3-8ndis.dat
  [1,16,15,44,5.501,1.5,0,0,0,-1,0,0,0,-1.5, ldraw_lib__3_8ndis(realsolid)],
// 1 16 25 44 5.501 -1.5 0 0 0 -1 0 0 0 -1.5 3-8ndis.dat
  [1,16,25,44,5.501,-1.5,0,0,0,-1,0,0,0,-1.5, ldraw_lib__3_8ndis(realsolid)],
// 1 16 15 44 -5.5 1.5 0 0 0 1 0 0 0 1.5 3-8edge.dat
  [1,16,15,44,-5.5,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__3_8edge(realsolid)],
// 1 16 25 44 5.501 -1.5 0 0 0 1 0 0 0 -1.5 3-8edge.dat
  [1,16,25,44,5.501,-1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__3_8edge(realsolid)],
// 1 16 15 44 5.5 1.5 0 0 0 -1 0 0 0 -1.5 3-8edge.dat
  [1,16,15,44,5.5,1.5,0,0,0,-1,0,0,0,-1.5, ldraw_lib__3_8edge(realsolid)],
// 1 16 25 44 -5.501 -1.5 0 0 0 -1 0 0 0 1.5 3-8edge.dat
  [1,16,25,44,-5.501,-1.5,0,0,0,-1,0,0,0,1.5, ldraw_lib__3_8edge(realsolid)],
// 1 16 20 48 -4.7 0 0 2.3 0 -1 0 -2.3 0 0 1-8ndis.dat
  [1,16,20,48,-4.7,0,0,2.3,0,-1,0,-2.3,0,0, ldraw_lib__1_8ndis(realsolid)],
// 1 16 20 48 -4.7 0 0 -2.3 0 -1 0 -2.3 0 0 1-8ndis.dat
  [1,16,20,48,-4.7,0,0,-2.3,0,-1,0,-2.3,0,0, ldraw_lib__1_8ndis(realsolid)],
// 1 16 15 44 -5.5 1.5 0 0 0 4 0 0 0 1.5 3-8cyli.dat
  [1,16,15,44,-5.5,1.5,0,0,0,4,0,0,0,1.5, ldraw_lib__3_8cyli(realsolid)],
// 1 16 25 44 5.501 -1.5 0 0 0 4 0 0 0 -1.5 3-8cyli.dat
  [1,16,25,44,5.501,-1.5,0,0,0,4,0,0,0,-1.5, ldraw_lib__3_8cyli(realsolid)],
// 1 16 15 48 5.5 1.5 0 0 0 -4 0 0 0 -1.5 3-8cyli.dat
  [1,16,15,48,5.5,1.5,0,0,0,-4,0,0,0,-1.5, ldraw_lib__3_8cyli(realsolid)],
// 1 16 25 48 -5.501 -1.5 0 0 0 -4 0 0 0 1.5 3-8cyli.dat
  [1,16,25,48,-5.501,-1.5,0,0,0,-4,0,0,0,1.5, ldraw_lib__3_8cyli(realsolid)],
// 1 16 13.22 46 5.22 0 1 -0.72 2 0 0 0 0 0.78 rect3.dat
  [1,16,13.22,46,5.22,0,1,-0.72,2,0,0,0,0,0.78, ldraw_lib__rect3(realsolid)],
// 1 16 26.78 46 5.22 0 -1 0.72 2 0 0 0 0 0.78 rect3.dat
  [1,16,26.78,46,5.22,0,-1,0.72,2,0,0,0,0,0.78, ldraw_lib__rect3(realsolid)],
// 1 16 26.78 46 -5.22 0 -1 0.72 2 0 0 0 0 -0.78 rect3.dat
  [1,16,26.78,46,-5.22,0,-1,0.72,2,0,0,0,0,-0.78, ldraw_lib__rect3(realsolid)],
// 1 16 13.22 46 -5.22 0 1 -0.72 2 0 0 0 0 -0.78 rect3.dat
  [1,16,13.22,46,-5.22,0,1,-0.72,2,0,0,0,0,-0.78, ldraw_lib__rect3(realsolid)],
// 1 16 15 48 -5.5 1.5 0 0 0 1 0 0 0 1.5 3-8edge.dat
  [1,16,15,48,-5.5,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__3_8edge(realsolid)],
// 1 16 25 48 5.501 -1.5 0 0 0 1 0 0 0 -1.5 3-8edge.dat
  [1,16,25,48,5.501,-1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__3_8edge(realsolid)],
// 1 16 15 48 5.5 1.5 0 0 0 -1 0 0 0 -1.5 3-8edge.dat
  [1,16,15,48,5.5,1.5,0,0,0,-1,0,0,0,-1.5, ldraw_lib__3_8edge(realsolid)],
// 1 16 25 48 -5.501 -1.5 0 0 0 -1 0 0 0 1.5 3-8edge.dat
  [1,16,25,48,-5.501,-1.5,0,0,0,-1,0,0,0,1.5, ldraw_lib__3_8edge(realsolid)],
// 1 16 25 48 -5.501 -1.5 0 0 0 -1 0 0 0 1.5 3-8chrd.dat
  [1,16,25,48,-5.501,-1.5,0,0,0,-1,0,0,0,1.5, ldraw_lib__3_8chrd(realsolid)],
// 1 16 15 48 -5.501 1.5 0 0 0 -1 0 0 0 1.5 3-8chrd.dat
  [1,16,15,48,-5.501,1.5,0,0,0,-1,0,0,0,1.5, ldraw_lib__3_8chrd(realsolid)],
// 1 16 15 48 5.501 1.5 0 0 0 -1 0 0 0 -1.5 3-8chrd.dat
  [1,16,15,48,5.501,1.5,0,0,0,-1,0,0,0,-1.5, ldraw_lib__3_8chrd(realsolid)],
// 1 16 25 48 5.501 -1.5 0 0 0 -1 0 0 0 -1.5 3-8chrd.dat
  [1,16,25,48,5.501,-1.5,0,0,0,-1,0,0,0,-1.5, ldraw_lib__3_8chrd(realsolid)],
...
module ldraw_lib__s__61345s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__61345s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
