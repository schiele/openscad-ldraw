...
// 1 16 190 0 -270 0 0 1 0 1 0 -1 0 0 stug5.dat
  [1,16,190,0,-270,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug5()],
// 1 16 280 0 -260 0 0 1 0 1 0 -1 0 0 stug4.dat
  [1,16,280,0,-260,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug4()],
// 1 16 250 0 -310 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,250,0,-310,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
...
module ldraw_lib__s__606s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__606s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
