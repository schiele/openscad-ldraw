...
use <../../p/4-4disc.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__973p2fa(realsolid=false) = [
...
// 1 16 5 2 -10 -1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,16,5,2,-10,-1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 4.5 4 -10 -1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,16,4.5,4,-10,-1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 3.5 6 -10 -1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,16,3.5,6,-10,-1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 2 7.5 -10 -1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,16,2,7.5,-10,-1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 -5 2 -10 -1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,16,-5,2,-10,-1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 -4.5 4 -10 -1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,16,-4.5,4,-10,-1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
...
// 1 16 0 8 -10 -1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,16,0,8,-10,-1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 0
];
module ldraw_lib__s__973p2fa(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__973p2fa(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
