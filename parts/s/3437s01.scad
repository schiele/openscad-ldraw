...
$fa=1; $fs=0.2;
function ldraw_lib__s__3437s01(realsolid=false) = [
...
// 1 16 0 48 0 36 0 0 0 -44 0 0 0 36 box5.dat
  [1,16,0,48,0,36,0,0,0,-44,0,0,0,36, ldraw_lib__box5(realsolid)],
...
// 1 16 0 48 0 0 0 40 0 -48 0 -40 0 0 box3u2p.dat
  [1,16,0,48,0,0,0,40,0,-48,0,-40,0,0, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 -34 4 -20 0 0 2 0 43 0 -1.5 0 0 box4-1.dat
  [1,16,-34,4,-20,0,0,2,0,43,0,-1.5,0,0, ldraw_lib__box4_1(realsolid)],
// 1 16 34 4 -20 0 0 -2 0 43 0 1.5 0 0 box4-1.dat
  [1,16,34,4,-20,0,0,-2,0,43,0,1.5,0,0, ldraw_lib__box4_1(realsolid)],
// 1 16 -34 4 20 0 0 2 0 43 0 -1.5 0 0 box4-1.dat
  [1,16,-34,4,20,0,0,2,0,43,0,-1.5,0,0, ldraw_lib__box4_1(realsolid)],
...
module ldraw_lib__s__3437s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3437s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
