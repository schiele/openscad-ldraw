...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__u9422s01(realsolid=false) = [
...
// 1 16 10 0 30 0 0 9 -9 0 0 0 -60 0 1-4cylc.dat
  [1,16,10,0,30,0,0,9,-9,0,0,0,-60,0, ldraw_lib__1_4cylc(realsolid)],
// 1 16 10 0 -30 0 0 9 -9 0 0 0 60 0 1-4disc.dat
  [1,16,10,0,-30,0,0,9,-9,0,0,0,60,0, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 10 -5.1 -22.8 0 -20 0 0 0 3 -3 0 0 1-4cylo.dat
  [1,16,10,-5.1,-22.8,0,-20,0,0,0,3,-3,0,0, ldraw_lib__1_4cylo(realsolid)],
...
// 1 16 0 -7.05 -25.8 10 0 0 0 0 -1.95 0 1 0 rect3.dat
  [1,16,0,-7.05,-25.8,10,0,0,0,0,-1.95,0,1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 14.5 -3 0 -1.5 1 0 -3 0 0 0 0 27 rect.dat
  [1,16,14.5,-3,0,-1.5,1,0,-3,0,0,0,0,27, ldraw_lib__rect(realsolid)],
// 1 16 13 -3 -24.9 0 -1 0 0 0 3 -2.1 0 0 rect3.dat
  [1,16,13,-3,-24.9,0,-1,0,0,0,3,-2.1,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 13 -3 24.9 0 -1 0 0 0 3 -2.1 0 0 rect3.dat
  [1,16,13,-3,24.9,0,-1,0,0,0,3,-2.1,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 -10 0 0 0 9 0 1 0 -9 0 0 2-4cylo.dat
  [1,16,0,-10,0,0,0,9,0,1,0,-9,0,0, ldraw_lib__2_4cylo(realsolid)],
// 1 16 0 -9 0 0 0 9 0 1 0 -9 0 0 2-4ndis.dat
  [1,16,0,-9,0,0,0,9,0,1,0,-9,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 -6 0 0 0 9 0 -1 0 9 0 0 2-4ndis.dat
  [1,16,0,-6,0,0,0,9,0,-1,0,9,0,0, ldraw_lib__2_4ndis(realsolid)],
...
module ldraw_lib__s__u9422s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u9422s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
