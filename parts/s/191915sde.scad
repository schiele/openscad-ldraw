...
use <191915sdea.scad>
use <191915sdeb.scad>
function ldraw_lib__s__191915sde() = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\191915sdea.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__191915sdea()],
...
module ldraw_lib__s__191915sde(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__191915sde(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
