...
use <../../p/4-8sphe.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__u1851s01(realsolid=false) = [
...
// 1 16 0 -60 0 16 0 0 0 0 -16 0 -2.1 0 4-4cylc.dat
  [1,16,0,-60,0,16,0,0,0,0,-16,0,-2.1,0, ldraw_lib__4_4cylc(realsolid)],
// 0 //
...
// 1 15 0 -44 0 -2 0 0 -0.4 1 0 0 0 -2 1-4edge.dat
  [1,15,0,-44,0,-2,0,0,-0.4,1,0,0,0,-2, ldraw_lib__1_4edge(realsolid)],
// 1 15 0 -44 0 2 0 0 -0.4 1 0 0 0 -2 1-4edge.dat
  [1,15,0,-44,0,2,0,0,-0.4,1,0,0,0,-2, ldraw_lib__1_4edge(realsolid)],
// 0 //
...
module ldraw_lib__s__u1851s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u1851s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
