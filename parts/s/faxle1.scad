...
use <../../p/axlehol9.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__faxle1(realsolid=false) = [
...
// 1 16 4 0 0 0 -1 0 2 0 0 0 0 2 4-4ring2.dat
  [1,16,4,0,0,0,-1,0,2,0,0,0,0,2, ldraw_lib__4_4ring2(realsolid)],
// 1 16 0.4 0 0 0 1 0 1 0 0 0 0 1 axlehol3.dat
  [1,16,0.4,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__axlehol3(realsolid)],
// 1 16 0.4 0 0 0 3.6 0 6 0 0 0 0 6 4-4cyli.dat
  [1,16,0.4,0,0,0,3.6,0,6,0,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0.4 0 0 0 1 0 -1 0 0 0 0 1 axleho10.dat
  [1,16,0.4,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__axleho10(realsolid)],
// 1 16 0.4 0 0 0 1 0 -1 0 0 0 0 1 axlehol9.dat
  [1,16,0.4,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__axlehol9(realsolid)],
// 1 16 0.4 0 0 0 -0.4 0 -1 0 0 0 0 1 axlehol8.dat
  [1,16,0.4,0,0,0,-0.4,0,-1,0,0,0,0,1, ldraw_lib__axlehol8(realsolid)],
];
module ldraw_lib__s__faxle1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__faxle1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
