...
$fa=1; $fs=0.2;
function ldraw_lib__s__92851s02(realsolid=false) = [
...
// 1 16 0 0 0 19.5 0 0 0 0 19.5 0 26.45 0 48\tm04o0870.dat
  [1,16,0,0,0,19.5,0,0,0,0,19.5,0,26.45,0, ldraw_lib__48__tm04o0870(realsolid)],
// 1 16 0 0 0 0 0 -19.5 19.5 0 0 0 26.45 0 48\tm04o0870.dat
  [1,16,0,0,0,0,0,-19.5,19.5,0,0,0,26.45,0, ldraw_lib__48__tm04o0870(realsolid)],
// 1 16 0 0 0 0 0 -19.5 19.5 0 0 0 -26.45 0 48\tm04o0870.dat
  [1,16,0,0,0,0,0,-19.5,19.5,0,0,0,-26.45,0, ldraw_lib__48__tm04o0870(realsolid)],
// 1 16 0 0 0 -19.5 0 0 0 0 -19.5 0 26.45 0 48\tm04o0870.dat
  [1,16,0,0,0,-19.5,0,0,0,0,-19.5,0,26.45,0, ldraw_lib__48__tm04o0870(realsolid)],
...
// 1 16 0 0 2.3 1.95 0 0 0 0 1.95 0 -1 0 48\4-4ring9.dat
  [1,16,0,0,2.3,1.95,0,0,0,0,1.95,0,-1,0, ldraw_lib__48__4_4ring9(realsolid)],
// 1 16 0 0 -2.3 1.95 0 0 0 0 1.95 0 1 0 48\4-4ring9.dat
  [1,16,0,0,-2.3,1.95,0,0,0,0,1.95,0,1,0, ldraw_lib__48__4_4ring9(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 2.3 17.55 0 0 0 0 17.55 0 -4.6 0 48\4-4cylo.dat
  [1,16,0,0,2.3,17.55,0,0,0,0,17.55,0,-4.6,0, ldraw_lib__48__4_4cylo(realsolid)],
];
module ldraw_lib__s__92851s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__92851s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
