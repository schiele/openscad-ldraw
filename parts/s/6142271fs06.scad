...
use <../../p/1-4cyli.scad>
use <../../p/box3u12.scad>
function ldraw_lib__s__6142271fs06() = [
// 0 ~Sticker  1.9 x  .8 with Red and White R8 Logo on Black Background - Bottom Face
// 0 Name: s\6142271fs06.dat
...
// 3 16 18 0 -17.7711 18 -.25 -14.6666 18 -.25 -17.7711
  [3,16,18,0,-17.7711,18,-.25,-14.6666,18,-.25,-17.7711],
// 4 16 16.5 0 -19.2711 16.5 -.25 -19.2711 -16.5 -.25 -19.2711 -16.5 0 -19.2711
  [4,16,16.5,0,-19.2711,16.5,-.25,-19.2711,-16.5,-.25,-19.2711,-16.5,0,-19.2711],
];
module ldraw_lib__s__6142271fs06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6142271fs06(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__6142271fs06(line=0.2);