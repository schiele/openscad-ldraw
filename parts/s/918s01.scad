...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__918s01(realsolid=false) = [
...
// 1 16 -68.5 50 1 0 0 -8.5 0 1 0 1 0 0 rect3.dat
  [1,16,-68.5,50,1,0,0,-8.5,0,1,0,1,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 8.5 -50 1 48.5 0 0 0 1 0 0 0 1 rect2p.dat
  [1,16,8.5,-50,1,48.5,0,0,0,1,0,0,0,1, ldraw_lib__rect2p(realsolid)],
// 1 16 -50 0 1 0 1 0 -40 0 0 0 0 -1 rect2p.dat
  [1,16,-50,0,1,0,1,0,-40,0,0,0,0,-1, ldraw_lib__rect2p(realsolid)],
// 1 16 67 0 1 0 -1 0 40 0 0 0 0 -1 rect2p.dat
  [1,16,67,0,1,0,-1,0,40,0,0,0,0,-1, ldraw_lib__rect2p(realsolid)],
// 1 16 77 40 0 0 0 -10 10 0 0 0 1 0 1-4edge.dat
  [1,16,77,40,0,0,0,-10,10,0,0,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -40 -40 0 0 0 -10 -10 0 0 0 1 0 1-4edge.dat
  [1,16,-40,-40,0,0,0,-10,-10,0,0,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -40 -40 0 0 0 -10 -10 0 0 0 1 0 1-4disc.dat
  [1,16,-40,-40,0,0,0,-10,-10,0,0,0,1,0, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 -40 -40 2 0 0 -2 -2 0 0 0 1 0 1-4ring5.dat
  [1,16,-40,-40,2,0,0,-2,-2,0,0,0,1,0, ldraw_lib__1_4ring5(realsolid)],
// 1 16 57 -40 0 0 0 10 -10 0 0 0 1 0 1-4edge.dat
  [1,16,57,-40,0,0,0,10,-10,0,0,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -60 40 0 0 0 10 10 0 0 0 1 0 1-4edge.dat
  [1,16,-60,40,0,0,0,10,10,0,0,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 77 40 0 0 0 -10 10 0 0 0 2 0 1-4cyli.dat
  [1,16,77,40,0,0,0,-10,10,0,0,0,2,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 57 -40 0 0 0 10 -10 0 0 0 2 0 1-4cyli.dat
  [1,16,57,-40,0,0,0,10,-10,0,0,0,2,0, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -60 40 0 0 0 10 10 0 0 0 2 0 1-4cyli.dat
  [1,16,-60,40,0,0,0,10,10,0,0,0,2,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -40 -40 0 0 0 -10 -10 0 0 0 2 0 1-4cyli.dat
  [1,16,-40,-40,0,0,0,-10,-10,0,0,0,2,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 77 40 2 0 0 -10 10 0 0 0 1 0 1-4edge.dat
  [1,16,77,40,2,0,0,-10,10,0,0,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -40 -40 2 0 0 -10 -10 0 0 0 1 0 1-4edge.dat
  [1,16,-40,-40,2,0,0,-10,-10,0,0,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 57 -40 2 0 0 10 -10 0 0 0 1 0 1-4edge.dat
  [1,16,57,-40,2,0,0,10,-10,0,0,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -60 40 2 0 0 10 10 0 0 0 1 0 1-4edge.dat
  [1,16,-60,40,2,0,0,10,10,0,0,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 0 // lip
// 1 16 -68.5 48 2.5 0 0 -8.5 0 1 0 0.5 0 0 rect3.dat
  [1,16,-68.5,48,2.5,0,0,-8.5,0,1,0,0.5,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 8.5 -54 2.5 46.5 0 0 0 1 0 0 0 0.5 rect2p.dat
  [1,16,8.5,-54,2.5,46.5,0,0,0,1,0,0,0,0.5, ldraw_lib__rect2p(realsolid)],
// 1 16 -39 -53 2.5 1 0.1 0 -1 0.1 0 0 0 0.5 rect.dat
  [1,16,-39,-53,2.5,1,0.1,0,-1,0.1,0,0,0,0.5, ldraw_lib__rect(realsolid)],
// 1 16 56 -53 2.5 1 -0.1 0 1 0.1 0 0 0 0.5 rect.dat
  [1,16,56,-53,2.5,1,-0.1,0,1,0.1,0,0,0,0.5, ldraw_lib__rect(realsolid)],
// 1 16 -52 0 2.5 0 1 0 -40 0 0 0 0 -0.5 rect2p.dat
  [1,16,-52,0,2.5,0,1,0,-40,0,0,0,0,-0.5, ldraw_lib__rect2p(realsolid)],
// 1 16 69 0 2.5 0 -1 0 40 0 0 0 0 -0.5 rect2p.dat
  [1,16,69,0,2.5,0,-1,0,40,0,0,0,0,-0.5, ldraw_lib__rect2p(realsolid)],
// 1 16 -40 -40 2 0 0 -12 -12 0 0 0 0.5 0 1-4edge.dat
  [1,16,-40,-40,2,0,0,-12,-12,0,0,0,0.5,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -40 -40 3 0 0 -12 -12 0 0 0 -1 0 1-4disc.dat
  [1,16,-40,-40,3,0,0,-12,-12,0,0,0,-1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 57 -40 0 0 0 10 -10 0 0 0 1 0 1-4disc.dat
  [1,16,57,-40,0,0,0,10,-10,0,0,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 57 -40 2 0 0 2 -2 0 0 0 1 0 1-4ring5.dat
  [1,16,57,-40,2,0,0,2,-2,0,0,0,1,0, ldraw_lib__1_4ring5(realsolid)],
// 1 16 57 -40 3 0 0 12 -12 0 0 0 -1 0 1-4disc.dat
  [1,16,57,-40,3,0,0,12,-12,0,0,0,-1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 57 -40 2 0 0 12 -12 0 0 0 0.5 0 1-4edge.dat
  [1,16,57,-40,2,0,0,12,-12,0,0,0,0.5,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -60 40 2 0 0 8 8 0 0 0 0.5 0 1-4edge.dat
  [1,16,-60,40,2,0,0,8,8,0,0,0,0.5,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 57 -40 2 0 0 12 -12 0 0 0 1 0 1-4cyli.dat
  [1,16,57,-40,2,0,0,12,-12,0,0,0,1,0, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -60 40 2 0 0 8 8 0 0 0 1 0 1-4cyli.dat
  [1,16,-60,40,2,0,0,8,8,0,0,0,1,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -40 -40 2 0 0 -12 -12 0 0 0 1 0 1-4cyli.dat
  [1,16,-40,-40,2,0,0,-12,-12,0,0,0,1,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -40 -40 3 0 0 -12 -12 0 0 0 0.5 0 1-4edge.dat
  [1,16,-40,-40,3,0,0,-12,-12,0,0,0,0.5,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 57 -40 3 0 0 12 -12 0 0 0 0.5 0 1-4edge.dat
  [1,16,57,-40,3,0,0,12,-12,0,0,0,0.5,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -60 40 3 0 0 8 8 0 0 0 0.5 0 1-4edge.dat
  [1,16,-60,40,3,0,0,8,8,0,0,0,0.5,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 77 40 2 0 0 -8 8 0 0 0 0.5 0 1-4edge.dat
  [1,16,77,40,2,0,0,-8,8,0,0,0,0.5,0, ldraw_lib__1_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 77 40 2 0 0 -8 8 0 0 0 1 0 1-4cyli.dat
  [1,16,77,40,2,0,0,-8,8,0,0,0,1,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 77 40 3 0 0 -8 8 0 0 0 0.5 0 1-4edge.dat
  [1,16,77,40,3,0,0,-8,8,0,0,0,0.5,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 77 40 0 0 0 -10 10 0 0 0 1 0 1-4ndis.dat
  [1,16,77,40,0,0,0,-10,10,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 77 40 3 0 0 -8 8 0 0 0 -1 0 1-4ndis.dat
  [1,16,77,40,3,0,0,-8,8,0,0,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 77 40 2 0 0 -2 2 0 0 0 1 0 1-4ring4.dat
  [1,16,77,40,2,0,0,-2,2,0,0,0,1,0, ldraw_lib__1_4ring4(realsolid)],
// 1 16 -60 40 0 0 0 10 10 0 0 0 1 0 1-4ndis.dat
  [1,16,-60,40,0,0,0,10,10,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -60 40 3 0 0 8 8 0 0 0 -1 0 1-4ndis.dat
  [1,16,-60,40,3,0,0,8,8,0,0,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -60 40 2 0 0 2 2 0 0 0 1 0 1-4ring4.dat
  [1,16,-60,40,2,0,0,2,2,0,0,0,1,0, ldraw_lib__1_4ring4(realsolid)],
// 1 16 77 50 20 0 -1 0 0 0 20 -20 0 0 3-16edge.dat
  [1,16,77,50,20,0,-1,0,0,0,20,-20,0,0, ldraw_lib__3_16edge(realsolid)],
// 1 16 -77 50 20 0 -1 0 0 0 20 -20 0 0 3-16edge.dat
  [1,16,-77,50,20,0,-1,0,0,0,20,-20,0,0, ldraw_lib__3_16edge(realsolid)],
// 1 16 77 50 20 0 -154 0 0 0 20 -20 0 0 3-16cyli.dat
  [1,16,77,50,20,0,-154,0,0,0,20,-20,0,0, ldraw_lib__3_16cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 74 50 18.14 0 -148 0 0 0 17 -15.14 0 0 3-16cyli.dat
  [1,16,74,50,18.14,0,-148,0,0,0,17,-15.14,0,0, ldraw_lib__3_16cyli(realsolid)],
...
module ldraw_lib__s__918s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__918s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
