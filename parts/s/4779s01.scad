...
use <../../p/rect.scad>
function ldraw_lib__s__4779s01() = [
...
// 1 16 0 -70 0 18 0 0 0 -20 0 0 0 18 48\1-48cyli.dat
  [1,16,0,-70,0,18,0,0,0,-20,0,0,0,18, ldraw_lib__48__1_48cyli()],
// 1 16 0 -90 0 18 0 0 0 -1 0 0 0 18 48\1-48edge.dat
  [1,16,0,-90,0,18,0,0,0,-1,0,0,0,18, ldraw_lib__48__1_48edge()],
// 1 16 0 -70 0 16.85456 0 2.21895 0 -20 0 -2.21895 0 16.85456 48\1-48cylo.dat
  [1,16,0,-70,0,16.85456,0,2.21895,0,-20,0,-2.21895,0,16.85456, ldraw_lib__48__1_48cylo()],
// 1 16 17.4996 -80 -0.00015 -0.5004 0 0 0 0 10 -0.00015 1 0 rect.dat
  [1,16,17.4996,-80,-0.00015,-0.5004,0,0,0,0,10,-0.00015,1,0, ldraw_lib__rect()],
// 1 16 17.3499 -80 2.28395 0 0 0.4953 -10 0 0 0 -1 0.06505 rect.dat
  [1,16,17.3499,-80,2.28395,0,0,0.4953,-10,0,0,0,-1,0.06505, ldraw_lib__rect()],
...
// 1 16 0 -70 0 17.84601 0 2.34947 0 -1 0 -2.34947 0 17.84601 48\1-48edge.dat
  [1,16,0,-70,0,17.84601,0,2.34947,0,-1,0,-2.34947,0,17.84601, ldraw_lib__48__1_48edge()],
];
module ldraw_lib__s__4779s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__4779s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
