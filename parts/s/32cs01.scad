...
use <../../p/stud3a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__32cs01(realsolid=false) = [
...
// 1 16 10 40.5 -9 2.7716 0 1.1481 -1.1481 0 2.7716 0 1 0 1-8edge.dat
  [1,16,10,40.5,-9,2.7716,0,1.1481,-1.1481,0,2.7716,0,1,0, ldraw_lib__1_8edge(realsolid)],
// 1 16 10 40.5 -9 -2.7716 0 -1.1481 1.1481 0 -2.7716 0 1 0 1-8edge.dat
  [1,16,10,40.5,-9,-2.7716,0,-1.1481,1.1481,0,-2.7716,0,1,0, ldraw_lib__1_8edge(realsolid)],
...
// 1 16 0 68 4 4 0 0 0 4 0 0 0 4 2-4cylc.dat
  [1,16,0,68,4,4,0,0,0,4,0,0,0,4, ldraw_lib__2_4cylc(realsolid)],
...
// 1 16 12.34 42.31 -8 0 0 0.21 0 -1 -0.31 1 0 0 rect2a.dat
  [1,16,12.34,42.31,-8,0,0,0.21,0,-1,-0.31,1,0,0, ldraw_lib__rect2a(realsolid)],
// 1 16 7.67 42.31 -8 0 0 -0.21 0 -1 -0.31 1 0 0 rect2a.dat
  [1,16,7.67,42.31,-8,0,0,-0.21,0,-1,-0.31,1,0,0, ldraw_lib__rect2a(realsolid)],
// 1 16 12.34 38.69 -8 0 0 0.21 0 1 0.31 1 0 0 rect2a.dat
  [1,16,12.34,38.69,-8,0,0,0.21,0,1,0.31,1,0,0, ldraw_lib__rect2a(realsolid)],
// 1 16 7.67 38.69 -8 0 0 -0.21 0 1 0.31 1 0 0 rect2a.dat
  [1,16,7.67,38.69,-8,0,0,-0.21,0,1,0.31,1,0,0, ldraw_lib__rect2a(realsolid)],
// 0
...
// 1 16 13.75 40.5 -7 -1.25 0 0 0 0 1.5 0 -2 0 box3u5p.dat
  [1,16,13.75,40.5,-7,-1.25,0,0,0,0,1.5,0,-2,0, ldraw_lib__box3u5p(realsolid)],
// 1 16 -3.75 40.5 -7 11.25 0 0 0 0 1.5 0 -2 0 box3u5p.dat
  [1,16,-3.75,40.5,-7,11.25,0,0,0,0,1.5,0,-2,0, ldraw_lib__box3u5p(realsolid)],
// 1 16 0 40.5 -7 0 0 15 1.5 0 0 0 -1 0 rect2p.dat
  [1,16,0,40.5,-7,0,0,15,1.5,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 0
...
// 1 16 0 72 2 0 0 16 0 -68 0 8 0 0 box3u2p.dat
  [1,16,0,72,2,0,0,16,0,-68,0,8,0,0, ldraw_lib__box3u2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 1.5 0 20 0 0 0 -1.5 0 0 0 -10 box2-5.dat
  [1,16,0,1.5,0,20,0,0,0,-1.5,0,0,0,-10, ldraw_lib__box2_5(realsolid)],
// 0
...
module ldraw_lib__s__32cs01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__32cs01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
