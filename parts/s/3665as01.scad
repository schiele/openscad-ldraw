...
use <../../p/stud2a.scad>
use <../../p/stud2s.scad>
function ldraw_lib__s__3665as01() = [
...
module ldraw_lib__s__3665as01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3665as01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__3665as01(line=0.2);