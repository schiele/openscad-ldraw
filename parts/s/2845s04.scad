...
use <../../p/box4-1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2845s04(realsolid=false) = [
...
// 1 16 0 0 5 -11 0 0 0 6 0 0 0 -4 box4-1.dat
  [1,16,0,0,5,-11,0,0,0,6,0,0,0,-4, ldraw_lib__box4_1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -4.5 0 6 -2.5 0 0 0 2 0 0 0 -3 box4-1.dat
  [1,16,-4.5,0,6,-2.5,0,0,0,2,0,0,0,-3, ldraw_lib__box4_1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 4.5 0 6 -2.5 0 0 0 2 0 0 0 -3 box4-1.dat
  [1,16,4.5,0,6,-2.5,0,0,0,2,0,0,0,-3, ldraw_lib__box4_1(realsolid)],
...
module ldraw_lib__s__2845s04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2845s04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
