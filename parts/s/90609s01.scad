...
use <../../p/axlesphe.scad>
use <../../p/rect2p.scad>
function ldraw_lib__s__90609s01() = [
...
// 1 16 0 0 0 12.81 0 0 0 0 12.81 0 -12.81 0 8-8sphe.dat
  [1,16,0,0,0,12.81,0,0,0,0,12.81,0,-12.81,0, ldraw_lib__8_8sphe()],
...
// 1 16 0 0 27.5 1 0 0 0 0 1 0 -1 0 axlehol2.dat
  [1,16,0,0,27.5,1,0,0,0,0,1,0,-1,0, ldraw_lib__axlehol2()],
// 1 16 0 0 27.5 1 0 0 0 0 1 0 -1 0 axlehol9.dat
  [1,16,0,0,27.5,1,0,0,0,0,1,0,-1,0, ldraw_lib__axlehol9()],
// 1 16 0 0 27.5 1 0 0 0 0 1 0 -14.69 0 axlehol8.dat
  [1,16,0,0,27.5,1,0,0,0,0,1,0,-14.69,0, ldraw_lib__axlehol8()],
// 
// 1 16 0 10 28.75 -7 0 0 0 -1 0 0 0 1.25 rect2p.dat
  [1,16,0,10,28.75,-7,0,0,0,-1,0,0,0,1.25, ldraw_lib__rect2p()],
// 1 16 0 -10 28.75 -7 0 0 0 1 0 0 0 -1.25 rect2p.dat
  [1,16,0,-10,28.75,-7,0,0,0,1,0,0,0,-1.25, ldraw_lib__rect2p()],
// 1 16 -10 0 28.75 0 1 0 -7 0 0 0 0 1.25 rect2p.dat
  [1,16,-10,0,28.75,0,1,0,-7,0,0,0,0,1.25, ldraw_lib__rect2p()],
// 1 16 10 0 28.75 0 -1 0 -7 0 0 0 0 -1.25 rect2p.dat
  [1,16,10,0,28.75,0,-1,0,-7,0,0,0,0,-1.25, ldraw_lib__rect2p()],
// 1 16 7 7 27.5 0 0 3 3 0 0 0 2.5 0 1-4cylo.dat
  [1,16,7,7,27.5,0,0,3,3,0,0,0,2.5,0, ldraw_lib__1_4cylo()],
// 1 16 -7 7 27.5 -3 0 0 0 0 3 0 2.5 0 1-4cylo.dat
  [1,16,-7,7,27.5,-3,0,0,0,0,3,0,2.5,0, ldraw_lib__1_4cylo()],
// 1 16 7 -7 27.5 3 0 0 0 0 -3 0 2.5 0 1-4cylo.dat
  [1,16,7,-7,27.5,3,0,0,0,0,-3,0,2.5,0, ldraw_lib__1_4cylo()],
// 1 16 -7 -7 27.5 0 0 -3 -3 0 0 0 2.5 0 1-4cylo.dat
  [1,16,-7,-7,27.5,0,0,-3,-3,0,0,0,2.5,0, ldraw_lib__1_4cylo()],
// 1 16 7 -7 27.5 3 0 0 0 0 -3 0 1 0 1-4chrd.dat
  [1,16,7,-7,27.5,3,0,0,0,0,-3,0,1,0, ldraw_lib__1_4chrd()],
// 1 16 7 -7 30 3 0 0 0 0 -3 0 -1 0 1-4chrd.dat
  [1,16,7,-7,30,3,0,0,0,0,-3,0,-1,0, ldraw_lib__1_4chrd()],
// 1 16 -7 -7 27.5 -3 0 0 0 0 -3 0 1 0 1-4chrd.dat
  [1,16,-7,-7,27.5,-3,0,0,0,0,-3,0,1,0, ldraw_lib__1_4chrd()],
// 1 16 -7 -7 30 -3 0 0 0 0 -3 0 -1 0 1-4chrd.dat
  [1,16,-7,-7,30,-3,0,0,0,0,-3,0,-1,0, ldraw_lib__1_4chrd()],
...
module ldraw_lib__s__90609s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__90609s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
