...
use <../../p/4-4ndis.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__u9349s01(realsolid=false) = [
...
// 1 16 0 -9 0 15 0 0 0 -1 0 0 0 15 4-4cylo.dat
  [1,16,0,-9,0,15,0,0,0,-1,0,0,0,15, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 -9 0 2.12132 0 2.12132 0 -1 0 -2.12132 0 2.12132 4-4ndis.dat
  [1,16,0,-9,0,2.12132,0,2.12132,0,-1,0,-2.12132,0,2.12132, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 -9 0 15 0 0 0 -1 0 0 0 15 1-4chrd.dat
  [1,16,0,-9,0,15,0,0,0,-1,0,0,0,15, ldraw_lib__1_4chrd(realsolid)],
// 1 16 0 -9 0 0 0 15 0 -1 0 -15 0 0 1-4chrd.dat
  [1,16,0,-9,0,0,0,15,0,-1,0,-15,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 0 -9 0 -15 0 0 0 -1 0 0 0 -15 1-4chrd.dat
  [1,16,0,-9,0,-15,0,0,0,-1,0,0,0,-15, ldraw_lib__1_4chrd(realsolid)],
// 1 16 0 -9 0 0 0 -15 0 -1 0 15 0 0 1-4chrd.dat
  [1,16,0,-9,0,0,0,-15,0,-1,0,15,0,0, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 0 -9 0 1 0 0 0 -5.5 0 0 0 1 4-4con2.dat
  [1,16,0,-9,0,1,0,0,0,-5.5,0,0,0,1, ldraw_lib__4_4con2(realsolid)],
// 1 16 0 -9 0 3 0 0 0 -1 0 0 0 3 4-4edge.dat
  [1,16,0,-9,0,3,0,0,0,-1,0,0,0,3, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -14.5 0 2 0 0 0 -1 0 0 0 2 4-4edge.dat
  [1,16,0,-14.5,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -14.5 0 2 0 0 0 -.5 0 0 0 2 4-4con0.dat
  [1,16,0,-14.5,0,2,0,0,0,-.5,0,0,0,2, ldraw_lib__4_4con0(realsolid)],
];
module ldraw_lib__s__u9349s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u9349s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
