...
use <../../p/box3u8p.scad>
use <../../p/box4o8a.scad>
function ldraw_lib__s__3241s02() = [
...
// 1 16 0 16 0 -5 0 0 0 -4 0 0 0 -16 box3u8p.dat
  [1,16,0,16,0,-5,0,0,0,-4,0,0,0,-16, ldraw_lib__box3u8p()],
// 1 494 5 4 12 0 -10 0 0 0 4 4 0 0 box4o8a.dat
  [1,494,5,4,12,0,-10,0,0,0,4,4,0,0, ldraw_lib__box4o8a()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 494 5 4 12 0 -10 0 0 0 3.75 3.75 0 0 box4o8a.dat
  [1,494,5,4,12,0,-10,0,0,0,3.75,3.75,0,0, ldraw_lib__box4o8a()],
// 1 494 5 4 -12 0 -10 0 0 0 4 4 0 0 box4o8a.dat
  [1,494,5,4,-12,0,-10,0,0,0,4,4,0,0, ldraw_lib__box4o8a()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__s__3241s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3241s02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
