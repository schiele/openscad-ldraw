use <../../lib.scad>
use <../../p/1-4chrd.scad>
function ldraw_lib__s__6142617es06() = [
...
// 1 15 -36.5 -.25 -3.0797 -1.5 0 0 0 1 0 0 0 -1.5 1-4chrd.dat
  [1,15,-36.5,-.25,-3.0797,-1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__1_4chrd()],
// 1 15 36.5 -.25 -3.0797 1.5 0 0 0 1 0 0 0 -1.5 1-4chrd.dat
  [1,15,36.5,-.25,-3.0797,1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__1_4chrd()],
// 0 // Blue face
...
module ldraw_lib__s__6142617es06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6142617es06(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
