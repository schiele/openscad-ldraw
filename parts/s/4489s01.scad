...
use <../../p/rect2p.scad>
use <../../p/recte3.scad>
function ldraw_lib__s__4489s01() = [
...
// 1 16 3 -22.10285 -3 0 -1 0 12.69945 0 0 3.5 0 2 rect2p.dat
  [1,16,3,-22.10285,-3,0,-1,0,12.69945,0,0,3.5,0,2, ldraw_lib__rect2p()],
// 1 16 1.5 -34.90115 -6.52725 0 0 1.5 0 -1 0.09885 2 0 0.02725 recte3.dat
  [1,16,1.5,-34.90115,-6.52725,0,0,1.5,0,-1,0.09885,2,0,0.02725, ldraw_lib__recte3()],
// 1 16 1.5 -9.7017 0.4178 0 0 1.5 0 1 0.2983 -2 0 0.0822 recte3.dat
  [1,16,1.5,-9.7017,0.4178,0,0,1.5,0,1,0.2983,-2,0,0.0822, ldraw_lib__recte3()],
];
module ldraw_lib__s__4489s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__4489s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
