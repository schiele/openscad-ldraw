...
use <../../p/t04i1538.scad>
use <../../p/t04o1538.scad>
function ldraw_lib__s__6256s01() = [
...
// 1 16 0 3 0 18.538 0 0 0 -1 0 0 0 18.538 4-4disc.dat
  [1,16,0,3,0,18.538,0,0,0,-1,0,0,0,18.538, ldraw_lib__4_4disc()],
// 1 16 0 3 0 18.538 0 0 0 -1 0 0 0 18.538 4-4edge.dat
  [1,16,0,3,0,18.538,0,0,0,-1,0,0,0,18.538, ldraw_lib__4_4edge()],
// 
...
// 1 16 0 -7 0 26 0 0 0 26 0 0 0 26 t04o1538.dat
  [1,16,0,-7,0,26,0,0,0,26,0,0,0,26, ldraw_lib__t04o1538()],
// 1 16 0 -7 0 26 0 0 0 26 0 0 0 -26 t04o1538.dat
  [1,16,0,-7,0,26,0,0,0,26,0,0,0,-26, ldraw_lib__t04o1538()],
// 1 16 0 -7 0 -26 0 0 0 26 0 0 0 26 t04o1538.dat
  [1,16,0,-7,0,-26,0,0,0,26,0,0,0,26, ldraw_lib__t04o1538()],
...
// 1 16 0 -4.1724 0 4.6345 0 0 0 7.1724 0 0 0 4.6345 4-4con4.dat
  [1,16,0,-4.1724,0,4.6345,0,0,0,7.1724,0,0,0,4.6345, ldraw_lib__4_4con4()],
// 1 16 0 -4.1724 0 23.1725 0 0 0 -1 0 0 0 23.1725 4-4edge.dat
  [1,16,0,-4.1724,0,23.1725,0,0,0,-1,0,0,0,23.1725, ldraw_lib__4_4edge()],
];
module ldraw_lib__s__6256s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6256s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
