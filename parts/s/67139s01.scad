...
use <../../p/npeghol2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__67139s01(realsolid=false) = [
...
// 1 16 -40 6.5 0 0 0 9 0 1 0 9 0 0 1-4ndis.dat
  [1,16,-40,6.5,0,0,0,9,0,1,0,9,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -40 6.5 0 0 0 9 0 1 0 9 0 0 1-4edge.dat
  [1,16,-40,6.5,0,0,0,9,0,1,0,9,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -40 9 0 0 0 9 0 -1 0 9 0 0 1-4ndis.dat
  [1,16,-40,9,0,0,0,9,0,-1,0,9,0,0, ldraw_lib__1_4ndis(realsolid)],
// 
...
// 1 16 -40 0 20 1 0 0 0 0 -1 0 -1 0 connhol3.dat
  [1,16,-40,0,20,1,0,0,0,0,-1,0,-1,0, ldraw_lib__connhol3(realsolid)],
...
// 1 16 -20 0 12 6 0 0 0 0 6 0 1 0 4-4ndis.dat
  [1,16,-20,0,12,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -40 0 12 0 0 6 -6 0 0 0 1 0 2-4ndis.dat
  [1,16,-40,0,12,0,0,6,-6,0,0,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 4 16 -26 -6 12 -34 -6 12 -34 0 12 -26 0 12
  [4,16,-26,-6,12,-34,-6,12,-34,0,12,-26,0,12],
// 4 16 -26 0 12 -34 0 12 -34 6 12 -26 6 12
  [4,16,-26,0,12,-34,0,12,-34,6,12,-26,6,12],
// 1 16 -40 0 12 0 0 -0.5 0.5 0 0 0 1 0 1-4rin12.dat
  [1,16,-40,0,12,0,0,-0.5,0.5,0,0,0,1,0, ldraw_lib__1_4rin12(realsolid)],
// 1 16 -40 0 12 0 0 -3 -3 0 0 0 1 0 1-4ring2.dat
  [1,16,-40,0,12,0,0,-3,-3,0,0,0,1,0, ldraw_lib__1_4ring2(realsolid)],
// 1 16 -40 0 12 0 0 -9 -9 0 0 0 1 0 1-4edge.dat
  [1,16,-40,0,12,0,0,-9,-9,0,0,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -40 0 12 0 0 -6.5 6.5 0 0 0 1 0 1-4edge.dat
  [1,16,-40,0,12,0,0,-6.5,6.5,0,0,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -40 0 12 0 0 -6.5 6.5 0 0 0 -3 0 1-4cyli.dat
  [1,16,-40,0,12,0,0,-6.5,6.5,0,0,0,-3,0, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 -40 0 9 6.5 0 0 0 0 6.5 0 -2.8397 0 1-4cyls2.dat
  [1,16,-40,0,9,6.5,0,0,0,0,6.5,0,-2.8397,0, ldraw_lib__1_4cyls2(realsolid)],
...
// 1 16 -40 0 12 0 0 -9 9 0 0 0 18 0 2-4cyli.dat
  [1,16,-40,0,12,0,0,-9,9,0,0,0,18,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -40 0 12 0 0 -9 9 0 0 0 -3 0 1-4cyli.dat
  [1,16,-40,0,12,0,0,-9,9,0,0,0,-3,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -40 0 30 0 0 -9 9 0 0 0 1 0 2-4edge.dat
  [1,16,-40,0,30,0,0,-9,9,0,0,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -40 0 9 0 0 -9 9 0 0 0 -9 0 1-4cyls.dat
  [1,16,-40,0,9,0,0,-9,9,0,0,0,-9,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 -40 9 0 0 0 -9 0 -9 0 9 0 0 1-4cyls.dat
  [1,16,-40,9,0,0,0,-9,0,-9,0,9,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 -40 0 0 0 0 -9 9 -1 0 9 0 0 1-4edge.dat
  [1,16,-40,0,0,0,0,-9,9,-1,0,9,0,0, ldraw_lib__1_4edge(realsolid)],
// 2 24 -40 9 30 -31 9 30
  [2,24,-40,9,30,-31,9,30],
...
module ldraw_lib__s__67139s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__67139s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
