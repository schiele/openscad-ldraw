...
use <../../p/t04o5000.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__90391s02(realsolid=false) = [
...
// 1 16 0 60 0 4 0 0 0 -105.7 0 0 0 4 4-4cylc.dat
  [1,16,0,60,0,4,0,0,0,-105.7,0,0,0,4, ldraw_lib__4_4cylc(realsolid)],
// 1 16 0 -53.8 0 0.48 0 0 0 8.1 0 0 0 0.48 4-4con10.dat
  [1,16,0,-53.8,0,0.48,0,0,0,8.1,0,0,0,0.48, ldraw_lib__4_4con10(realsolid)],
// 1 16 0 -53.8 0 1.32 0 0 0 -0.4 0 0 0 1.32 4-4con3.dat
  [1,16,0,-53.8,0,1.32,0,0,0,-0.4,0,0,0,1.32, ldraw_lib__4_4con3(realsolid)],
// 1 16 0 -54.2 0 3.96 0 0 0 -0.7 0 0 0 3.96 4-4cylo.dat
  [1,16,0,-54.2,0,3.96,0,0,0,-0.7,0,0,0,3.96, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 -57.2 0 4.8 0 0 0 -10 0 0 0 4.8 t01o2500.dat
  [1,16,0,-57.2,0,4.8,0,0,0,-10,0,0,0,4.8, ldraw_lib__t01o2500(realsolid)],
// 1 16 0 -59.7 0 4.8 0 0 0 1 0 0 0 4.8 4-4disc.dat
  [1,16,0,-59.7,0,4.8,0,0,0,1,0,0,0,4.8, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 -57.2 0 4 0 0 0 4.6 0 0 0 4 t04o5000.dat
  [1,16,0,-57.2,0,4,0,0,0,4.6,0,0,0,4, ldraw_lib__t04o5000(realsolid)],
// 1 16 0 -57.2 0 0 0 -4 0 4.6 0 4 0 0 t04o5000.dat
  [1,16,0,-57.2,0,0,0,-4,0,4.6,0,4,0,0, ldraw_lib__t04o5000(realsolid)],
// 1 16 0 -57.2 0 -4 0 0 0 4.6 0 0 0 -4 t04o5000.dat
  [1,16,0,-57.2,0,-4,0,0,0,4.6,0,0,0,-4, ldraw_lib__t04o5000(realsolid)],
// 1 16 0 -57.2 0 0 0 4 0 4.6 0 -4 0 0 t04o5000.dat
  [1,16,0,-57.2,0,0,0,4,0,4.6,0,-4,0,0, ldraw_lib__t04o5000(realsolid)],
// 1 16 0 -45.7 0 4.8 0 0 0 1 0 0 0 4.8 4-4edge.dat
  [1,16,0,-45.7,0,4.8,0,0,0,1,0,0,0,4.8, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -45.7 0 4.8 0 0 0 -1 0 0 0 4.8 4-4disc.dat
  [1,16,0,-45.7,0,4.8,0,0,0,-1,0,0,0,4.8, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 -53.8 0 5.28 0 0 0 1 0 0 0 5.28 4-4edge.dat
  [1,16,0,-53.8,0,5.28,0,0,0,1,0,0,0,5.28, ldraw_lib__4_4edge(realsolid)],
];
module ldraw_lib__s__90391s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__90391s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
