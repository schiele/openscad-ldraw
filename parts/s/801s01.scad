...
// 1 16 0 4 0 6 0 0 0 68 0 0 0 6 4-4cylc.dat
  [1,16,0,4,0,6,0,0,0,68,0,0,0,6, ldraw_lib__4_4cylc()],
// 
// 1 16 6 36 30 0 1 0 -36 0 0 0 0 20 rect.dat
  [1,16,6,36,30,0,1,0,-36,0,0,0,0,20, ldraw_lib__rect()],
// 1 16 8 36 50 2 0 0 0 0 36 0 -1 0 rect2p.dat
  [1,16,8,36,50,2,0,0,0,0,36,0,-1,0, ldraw_lib__rect2p()],
// 1 16 10 12 25 0 -1 0 0 0 -12 25 0 0 rect2a.dat
  [1,16,10,12,25,0,-1,0,0,0,-12,25,0,0, ldraw_lib__rect2a()],
// 1 16 0 0 0 10 0 0 0 24 0 0 0 -10 3-4cyli.dat
  [1,16,0,0,0,10,0,0,0,24,0,0,0,-10, ldraw_lib__3_4cyli()],
...
// 1 16 0 72 0 2 0 0 0 -1 0 0 0 -2 4-4ring4.dat
  [1,16,0,72,0,2,0,0,0,-1,0,0,0,-2, ldraw_lib__4_4ring4()],
// 1 16 0 72 0 0 0 10 0 -1 0 10 0 0 1-4ndis.dat
  [1,16,0,72,0,0,0,10,0,-1,0,10,0,0, ldraw_lib__1_4ndis()],
// 4 16 6 72 50 10 72 50 10 72 10 6 72 10
  [4,16,6,72,50,10,72,50,10,72,10,6,72,10],
// 1 16 3 36 10 3 0 0 0 0 36 0 -1 0 rect2p.dat
  [1,16,3,36,10,3,0,0,0,0,36,0,-1,0, ldraw_lib__rect2p()],
];
module ldraw_lib__s__801s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__801s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
