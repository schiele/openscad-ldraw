...
use <../../p/bump5000.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__24324s01(realsolid=false) = [
...
// 1 16 -12 2 -.357 -2.77164 0 1.14805 0 -1 0 -1.14805 0 -2.77164 1-8edge.dat
  [1,16,-12,2,-.357,-2.77164,0,1.14805,0,-1,0,-1.14805,0,-2.77164, ldraw_lib__1_8edge(realsolid)],
// 1 16 -5 2 -.3 0 0 -11.52489 0 -1 0 -4 0 0 48\1-8edge.dat
  [1,16,-5,2,-.3,0,0,-11.52489,0,-1,0,-4,0,0, ldraw_lib__48__1_8edge(realsolid)],
// 1 16 -5 2 -3.6 0 0 .7 0 -1 0 -.7 0 0 5-16edge.dat
  [1,16,-5,2,-3.6,0,0,.7,0,-1,0,-.7,0,0, ldraw_lib__5_16edge(realsolid)],
// 2 24 -4.353 2 -3.332 -5 2 -1
  [2,24,-4.353,2,-3.332,-5,2,-1],
// 1 16 -5 2 1.3 0 0 -8.4865 0 -1 0 -2.3 0 0 48\1-8edge.dat
  [1,16,-5,2,1.3,0,0,-8.4865,0,-1,0,-2.3,0,0, ldraw_lib__48__1_8edge(realsolid)],
...
// 1 16 0 2 0 4 0 0 0 1 0 0 0 4 bump5000.dat
  [1,16,0,2,0,4,0,0,0,1,0,0,0,4, ldraw_lib__bump5000(realsolid)],
// 1 16 0 2 0 0 0 -4 0 -1 0 4 0 0 2-4ndis.dat
  [1,16,0,2,0,0,0,-4,0,-1,0,4,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 -2 0 1.53074 0 3.69552 0 1 0 -3.69552 0 1.53074 7-16disc.dat
  [1,16,0,-2,0,1.53074,0,3.69552,0,1,0,-3.69552,0,1.53074, ldraw_lib__7_16disc(realsolid)],
// 1 16 0 -2 0 0 0 4 0 1 0 4 0 0 7-16edge.dat
  [1,16,0,-2,0,0,0,4,0,1,0,4,0,0, ldraw_lib__7_16edge(realsolid)],
// 1 16 0 -2 0 1.530734 0 3.69552 0 4 0 -3.69552 0 1.53074 7-16cyli.dat
  [1,16,0,-2,0,1.530734,0,3.69552,0,4,0,-3.69552,0,1.53074, ldraw_lib__7_16cyli(realsolid)],
...
// 1 16 -5 2 -.548 0 0 9.2361 0 -4 0 -4.4519 0 0.0005 48\1-8cylo.dat
  [1,16,-5,2,-.548,0,0,9.2361,0,-4,0,-4.4519,0,0.0005, ldraw_lib__48__1_8cylo(realsolid)],
...
// 1 16 -5 -2 -.548 0 0 9.2361 0 1 0 -4.4519 0 0.0005 48\1-8chrd.dat
  [1,16,-5,-2,-.548,0,0,9.2361,0,1,0,-4.4519,0,0.0005, ldraw_lib__48__1_8chrd(realsolid)],
// 4 16 -5 -2 -1 -5 -2 -5 1.5308 -2 -3.6956 0 -2 0
  [4,16,-5,-2,-1,-5,-2,-5,1.5308,-2,-3.6956,0,-2,0],
// 
// 1 16 -5 2 -1 0 0 -11.52327 0 -4 0 -4 0 0 48\1-8cylo.dat
  [1,16,-5,2,-1,0,0,-11.52327,0,-4,0,-4,0,0, ldraw_lib__48__1_8cylo(realsolid)],
// 1 16 -5 2 -1 0 0 -11.52327 0 -1 0 -4 0 0 48\1-8disc.dat
  [1,16,-5,2,-1,0,0,-11.52327,0,-1,0,-4,0,0, ldraw_lib__48__1_8disc(realsolid)],
// 1 16 -5 -2 -1 0 0 -11.52327 0 1 0 -4 0 0 48\1-8disc.dat
  [1,16,-5,-2,-1,0,0,-11.52327,0,1,0,-4,0,0, ldraw_lib__48__1_8disc(realsolid)],
// 
...
// 1 16 -12 2 -1.0567 -3 0 0 0 -4 0 0 0 -3 3-16cylo.dat
  [1,16,-12,2,-1.0567,-3,0,0,0,-4,0,0,0,-3, ldraw_lib__3_16cylo(realsolid)],
// 1 16 -12 2 -1.0567 -3 0 0 0 -1 0 0 0 -3 3-16disc.dat
  [1,16,-12,2,-1.0567,-3,0,0,0,-1,0,0,0,-3, ldraw_lib__3_16disc(realsolid)],
// 1 16 -12 -2 -1.0567 -3 0 0 0 1 0 0 0 -3 3-16disc.dat
  [1,16,-12,-2,-1.0567,-3,0,0,0,1,0,0,0,-3, ldraw_lib__3_16disc(realsolid)],
...
module ldraw_lib__s__24324s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__24324s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
