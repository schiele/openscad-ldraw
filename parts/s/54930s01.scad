...
use <../../p/5-8edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__54930s01(realsolid=false) = [
...
// 1 16 0 -4 -10 -3.061 0 7.391 0 -1 0 7.391 0 3.061 1-8edge.dat
  [1,16,0,-4,-10,-3.061,0,7.391,0,-1,0,7.391,0,3.061, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 0 -10 -3.061 0 7.391 0 -1 0 7.391 0 3.061 1-8edge.dat
  [1,16,0,0,-10,-3.061,0,7.391,0,-1,0,7.391,0,3.061, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 -4 -10 -3.061 0 7.391 0 4 0 7.391 0 3.061 1-8cyli.dat
  [1,16,0,-4,-10,-3.061,0,7.391,0,4,0,7.391,0,3.061, ldraw_lib__1_8cyli(realsolid)],
// 1 16 0 -4 -10 -4.243 0 4.243 0 -1 0 4.243 0 4.243 1-4edge.dat
  [1,16,0,-4,-10,-4.243,0,4.243,0,-1,0,4.243,0,4.243, ldraw_lib__1_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -4 -10 -4.243 0 4.243 0 4 0 4.243 0 4.243 1-4cyli.dat
  [1,16,0,-4,-10,-4.243,0,4.243,0,4,0,4.243,0,4.243, ldraw_lib__1_4cyli(realsolid)],
// 1 16 0 -4 -10 -1.414 0 1.414 0 1 0 1.414 0 1.414 1-4ring3.dat
  [1,16,0,-4,-10,-1.414,0,1.414,0,1,0,1.414,0,1.414, ldraw_lib__1_4ring3(realsolid)],
// 1 16 0 -4 0 -1.414 0 -1.414 0 1 0 -1.414 0 1.414 3-4ring3.dat
  [1,16,0,-4,0,-1.414,0,-1.414,0,1,0,-1.414,0,1.414, ldraw_lib__3_4ring3(realsolid)],
// 1 16 0 -4 0 -5.543 0 -2.296 0 -1 0 -2.296 0 5.543 5-8edge.dat
  [1,16,0,-4,0,-5.543,0,-2.296,0,-1,0,-2.296,0,5.543, ldraw_lib__5_8edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -4 0 -5.543 0 -2.296 0 4 0 -2.296 0 5.543 5-8cyli.dat
  [1,16,0,-4,0,-5.543,0,-2.296,0,4,0,-2.296,0,5.543, ldraw_lib__5_8cyli(realsolid)],
// 1 16 0 0 0 -5.543 0 -2.296 0 -1 0 -2.296 0 5.543 5-8edge.dat
  [1,16,0,0,0,-5.543,0,-2.296,0,-1,0,-2.296,0,5.543, ldraw_lib__5_8edge(realsolid)],
// 1 16 0 -4 0 -5.657 0 -5.657 0 -1 0 -5.657 0 5.657 3-4edge.dat
  [1,16,0,-4,0,-5.657,0,-5.657,0,-1,0,-5.657,0,5.657, ldraw_lib__3_4edge(realsolid)],
// 1 16 0 -4 0 -5.657 0 -5.657 0 4 0 -5.657 0 5.657 3-4cyli.dat
  [1,16,0,-4,0,-5.657,0,-5.657,0,4,0,-5.657,0,5.657, ldraw_lib__3_4cyli(realsolid)],
// 1 16 0 0 0 -5.657 0 -5.657 0 -1 0 -5.657 0 5.657 3-4edge.dat
  [1,16,0,0,0,-5.657,0,-5.657,0,-1,0,-5.657,0,5.657, ldraw_lib__3_4edge(realsolid)],
// 0 //
];
module ldraw_lib__s__54930s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__54930s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
