...
use <../../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__4865bs01(realsolid=false) = [
...
// 1 16 18 2 6 2 0 0 0 0 -2 0 4 0 1-4cylo.dat
  [1,16,18,2,6,2,0,0,0,0,-2,0,4,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -18 2 10 -2 0 0 0 0 -2 0 -4 0 1-4cylo.dat
  [1,16,-18,2,10,-2,0,0,0,0,-2,0,-4,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 0 20 -2 -20 0 0 0 -4 0 0 0 -8 box2-5.dat
  [1,16,0,20,-2,-20,0,0,0,-4,0,0,0,-8, ldraw_lib__box2_5(realsolid)],
// 1 16 -18 2 6 0 0 -2 -2 0 0 0 1 0 1-4chrd.dat
  [1,16,-18,2,6,0,0,-2,-2,0,0,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 18 2 6 2 0 0 0 0 -2 0 1 0 1-4chrd.dat
  [1,16,18,2,6,2,0,0,0,0,-2,0,1,0, ldraw_lib__1_4chrd(realsolid)],
];
module ldraw_lib__s__4865bs01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__4865bs01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
