...
use <../../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__6475s01(realsolid=false) = [
...
// 1 16 0 0 0 0 0 480 0 4 0 -248 0 0 box3u8p.dat
  [1,16,0,0,0,0,0,480,0,4,0,-248,0,0, ldraw_lib__box3u8p(realsolid)],
// 1 16 408 4 248 72 0 0 0 -1 0 0 0 72 48\1-4chrd.dat
  [1,16,408,4,248,72,0,0,0,-1,0,0,0,72, ldraw_lib__48__1_4chrd(realsolid)],
// 1 16 -408 4 248 -72 0 0 0 -1 0 0 0 72 48\1-4chrd.dat
  [1,16,-408,4,248,-72,0,0,0,-1,0,0,0,72, ldraw_lib__48__1_4chrd(realsolid)],
// 1 16 -408 4 -248 -72 0 0 0 -1 0 0 0 -72 48\1-4chrd.dat
  [1,16,-408,4,-248,-72,0,0,0,-1,0,0,0,-72, ldraw_lib__48__1_4chrd(realsolid)],
...
// 1 16 408 0 248 72 0 0 0 4 0 0 0 72 48\1-4cylo.dat
  [1,16,408,0,248,72,0,0,0,4,0,0,0,72, ldraw_lib__48__1_4cylo(realsolid)],
// 1 16 -408 0 248 -72 0 0 0 4 0 0 0 72 48\1-4cylo.dat
  [1,16,-408,0,248,-72,0,0,0,4,0,0,0,72, ldraw_lib__48__1_4cylo(realsolid)],
// 1 16 -408 0 -248 -72 0 0 0 4 0 0 0 -72 48\1-4cylo.dat
  [1,16,-408,0,-248,-72,0,0,0,4,0,0,0,-72, ldraw_lib__48__1_4cylo(realsolid)],
...
// 1 16 0 2 -320 408 0 0 0 0 -2 0 1 0 rect2p.dat
  [1,16,0,2,-320,408,0,0,0,0,-2,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 2 320 -408 0 0 0 0 -2 0 -1 0 rect2p.dat
  [1,16,0,2,320,-408,0,0,0,0,-2,0,-1,0, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__s__6475s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6475s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
