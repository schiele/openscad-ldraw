...
use <../../p/4-4rin12.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__30152s02(realsolid=false) = [
...
// 1 16 0 -10 0 4 0 0 0 20 0 0 0 4 4-4cyli.dat
  [1,16,0,-10,0,4,0,0,0,20,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -22 -4 13 0 0 0 0 -13 0 8 0 4-4cyli.dat
  [1,16,0,-22,-4,13,0,0,0,0,-13,0,8,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -22 -4 12 0 0 0 0 -12 0 8 0 4-4cyli.dat
  [1,16,0,-22,-4,12,0,0,0,0,-12,0,8,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -22 4 12 0 0 0 0 12 0 1 0 4-4edge.dat
  [1,16,0,-22,4,12,0,0,0,0,12,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -22 -4 12 0 0 0 0 12 0 1 0 4-4edge.dat
  [1,16,0,-22,-4,12,0,0,0,0,12,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -22 -4 -1 0 0 0 0 1 0 1 0 4-4rin12.dat
  [1,16,0,-22,-4,-1,0,0,0,0,1,0,1,0, ldraw_lib__4_4rin12(realsolid)],
// 1 16 0 -22 4 1 0 0 0 0 1 0 -1 0 4-4rin12.dat
  [1,16,0,-22,4,1,0,0,0,0,1,0,-1,0, ldraw_lib__4_4rin12(realsolid)],
// 1 16 0 -22 4 13 0 0 0 0 13 0 1 0 4-4edge.dat
  [1,16,0,-22,4,13,0,0,0,0,13,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -22 -4 13 0 0 0 0 13 0 1 0 4-4edge.dat
  [1,16,0,-22,-4,13,0,0,0,0,13,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -9 0 0 0 4 0 1 -0.78 -4 0 0 2-4edge.dat
  [1,16,0,-9,0,0,0,4,0,1,-0.78,-4,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -9 0 0 0 -4 0 1 -0.78 4 0 0 2-4edge.dat
  [1,16,0,-9,0,0,0,-4,0,1,-0.78,4,0,0, ldraw_lib__2_4edge(realsolid)],
];
module ldraw_lib__s__30152s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__30152s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
