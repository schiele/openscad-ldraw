...
use <../../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__44301s01(realsolid=false) = [
...
// 1 16 20 2 0 0 0 -1 0 1 0 1 0 0 clh6.dat
  [1,16,20,2,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__clh6(realsolid)],
];
module ldraw_lib__s__44301s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__44301s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
