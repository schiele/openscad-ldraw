...
$fa=1; $fs=0.2;
function ldraw_lib__s__30837s02(realsolid=false) = [
...
// 1 16 0 30 -12 0 0 -20 -2 0 0 0 -4 0 box3u2p.dat
  [1,16,0,30,-12,0,0,-20,-2,0,0,0,-4,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 20 30 0 0 1 0 0 0 -2 -8 0 0 rect.dat
  [1,16,20,30,0,0,1,0,0,0,-2,-8,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 40 12 0 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,40,12,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 60 12 0 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,60,12,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 50 32 0 26 0 0 0 -20 0 0 0 16 box5.dat
  [1,16,50,32,0,26,0,0,0,-20,0,0,0,16, ldraw_lib__box5(realsolid)],
// 4 16 76 32 -16 76 32 16 80 32 22 80 32 -22
  [4,16,76,32,-16,76,32,16,80,32,22,80,32,-22],
// 4 16 20 32 -8 20 32 8 24 32 16 24 32 -16
  [4,16,20,32,-8,20,32,8,24,32,16,24,32,-16],
// 1 16 50 8 0 0 0 30 0 1 0 -20 0 0 rect.dat
  [1,16,50,8,0,0,0,30,0,1,0,-20,0,0, ldraw_lib__rect(realsolid)],
// 1 16 80 12 0 0 -1 0 4 0 0 0 0 20 rect2p.dat
  [1,16,80,12,0,0,-1,0,4,0,0,0,0,20, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 16 -30 -40 0 0 0 -16 0 0 0 -10 box2-5.dat
  [1,16,0,16,-30,-40,0,0,0,-16,0,0,0,-10, ldraw_lib__box2_5(realsolid)],
// 1 16 0 4 -30 36 0 0 0 -1 0 0 0 -6 rect.dat
  [1,16,0,4,-30,36,0,0,0,-1,0,0,0,-6, ldraw_lib__rect(realsolid)],
// 1 16 0 18 -36 36 0 0 0 0 14 0 -1 0 rect3.dat
  [1,16,0,18,-36,36,0,0,0,0,14,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 22 -40 0 0 1 1 0 0 0 1 0 stug2-4x1.dat
  [1,16,0,22,-40,0,0,1,1,0,0,0,1,0, ldraw_lib__stug2_4x1(realsolid)],
...
// 1 16 0 4 -30 0 0 1 0 16 0 -6 0 0 box3u2p.dat
  [1,16,0,4,-30,0,0,1,0,16,0,-6,0,0, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 0 20 -24 0 0 20 8 0 0 0 1 0 rect1.dat
  [1,16,0,20,-24,0,0,20,8,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
...
module ldraw_lib__s__30837s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__30837s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
