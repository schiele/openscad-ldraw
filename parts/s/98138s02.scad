...
use <../../p/4-4ring9.scad>
use <../../p/stud4o.scad>
function ldraw_lib__s__98138s02() = [
...
// 1 16 0 8 0 -1 0 0 0 -1 0 0 0 1 4-4ring8.dat
  [1,16,0,8,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4ring8()],
// 1 16 0 7 0 9 0 0 0 1 0 0 0 9 4-4cylo.dat
  [1,16,0,7,0,9,0,0,0,1,0,0,0,9, ldraw_lib__4_4cylo()],
// 1 16 0 7 0 -1 0 0 0 -1 0 0 0 1 4-4ring9.dat
  [1,16,0,7,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4ring9()],
// 1 16 0 0 0 10 0 0 0 7 0 0 0 10 4-4cylo.dat
  [1,16,0,0,0,10,0,0,0,7,0,0,0,10, ldraw_lib__4_4cylo()],
];
module ldraw_lib__s__98138s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__98138s02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
