...
use <../../p/4-4ring3.scad>
use <../../p/recte3.scad>
function ldraw_lib__s__2351s01() = [
...
// 1 16 7 0 0 0 -5 0 7.391036 0 -3.061467 3.061467 0 7.391036 3-8cylo.dat
  [1,16,7,0,0,0,-5,0,7.391036,0,-3.061467,3.061467,0,7.391036, ldraw_lib__3_8cylo()],
// 1 16 7 0 0 0 -5 0 -7.391036 0 3.061467 -3.061467 0 -7.391036 3-8cylo.dat
  [1,16,7,0,0,0,-5,0,-7.391036,0,3.061467,-3.061467,0,-7.391036, ldraw_lib__3_8cylo()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 7 0 0 0 -14 0 6 0 0 0 0 6 4-4cylo.dat
  [1,16,7,0,0,0,-14,0,6,0,0,0,0,6, ldraw_lib__4_4cylo()],
// 1 16 7 0 0 0 -1 0 2 0 0 0 0 2 4-4ring3.dat
  [1,16,7,0,0,0,-1,0,2,0,0,0,0,2, ldraw_lib__4_4ring3()],
// 1 16 -7 0 0 0 5 0 7.391036 0 -3.061467 -3.061467 0 -7.391036 3-8cylo.dat
  [1,16,-7,0,0,0,5,0,7.391036,0,-3.061467,-3.061467,0,-7.391036, ldraw_lib__3_8cylo()],
// 1 16 -7 0 0 0 5 0 -7.391036 0 3.061467 3.061467 0 7.391036 3-8cylo.dat
  [1,16,-7,0,0,0,5,0,-7.391036,0,3.061467,3.061467,0,7.391036, ldraw_lib__3_8cylo()],
...
// 1 16 2 0 0 0 -1 0 0 0 8 -8 0 0 3-16ndis.dat
  [1,16,2,0,0,0,-1,0,0,0,8,-8,0,0, ldraw_lib__3_16ndis()],
// 1 16 2 0 0 0 -1 0 0 0 8 8 0 0 3-16ndis.dat
  [1,16,2,0,0,0,-1,0,0,0,8,8,0,0, ldraw_lib__3_16ndis()],
// 1 16 2 0 0 0 -1 0 0 0 -8 8 0 0 3-16ndis.dat
  [1,16,2,0,0,0,-1,0,0,0,-8,8,0,0, ldraw_lib__3_16ndis()],
...
// 1 16 4.5 7 0 0 0 2.5 0 1 0 -3.647 0 0 recte3.dat
  [1,16,4.5,7,0,0,0,2.5,0,1,0,-3.647,0,0, ldraw_lib__recte3()],
// 1 16 4.5 -7 0 0 0 2.5 0 1 0 -3.647 0 0 recte3.dat
  [1,16,4.5,-7,0,0,0,2.5,0,1,0,-3.647,0,0, ldraw_lib__recte3()],
// 1 16 -4.5 7 0 0 0 -2.5 0 1 0 3.647 0 0 recte3.dat
  [1,16,-4.5,7,0,0,0,-2.5,0,1,0,3.647,0,0, ldraw_lib__recte3()],
...
module ldraw_lib__s__2351s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2351s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
