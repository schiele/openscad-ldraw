...
use <../../p/4-4ring5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__564s01(realsolid=false) = [
// 0 ~Electric Socket
// 0 Name: s\564s01.dat
...
// 1 494 0 -3 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,494,0,-3,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
...
// 1 494 0 -4 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,494,0,-4,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 494 0 0 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,494,0,0,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 494 0 4 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,494,0,4,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 494 0 4 0 5 0 0 0 1 0 0 0 5 4-4edge.dat
  [1,494,0,4,0,5,0,0,0,1,0,0,0,5, ldraw_lib__4_4edge(realsolid)],
...
// 1 494 0 -3 0 4 0 0 0 7 0 0 0 4 4-4cyli.dat
  [1,494,0,-3,0,4,0,0,0,7,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 494 0 -4 0 6 0 0 0 4 0 0 0 6 4-4cyli.dat
  [1,494,0,-4,0,6,0,0,0,4,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 4 0 1 0 0 0 -1 0 0 0 1 4-4ring5.dat
  [1,16,0,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4ring5(realsolid)],
...
module ldraw_lib__s__564s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__564s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
