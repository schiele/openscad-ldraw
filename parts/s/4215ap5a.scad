...
use <../../p/1-4ndis.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__4215ap5a(realsolid=false) = [
...
// 1 4 35 11 0 0 0 5 5 0 0 0 1 0 1-4disc.dat
  [1,4,35,11,0,0,0,5,5,0,0,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 4 17.5 5.5 0 0 0 2.5 2.5 0 0 0 1 0 1-4ndis.dat
  [1,4,17.5,5.5,0,0,0,2.5,2.5,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 17.5 5.5 0 0 0 2.5 2.5 0 0 0 1 0 1-4disc.dat
  [1,16,17.5,5.5,0,0,0,2.5,2.5,0,0,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 35 11 0 0 0 5 5 0 0 0 1 0 1-4ndis.dat
  [1,16,35,11,0,0,0,5,5,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
...
module ldraw_lib__s__4215ap5a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__4215ap5a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
