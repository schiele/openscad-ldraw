...
use <../../p/4-4ring4.scad>
use <../../p/t04i2000.scad>
function ldraw_lib__s__2470s01() = [
...
// 1 16 0 0 -3 6 0 0 0 0 6 0 1 0 4-4edge.dat
  [1,16,0,0,-3,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4edge()],
...
// 1 16 0 0 8 4 0 0 0 0 4 0 -11 0 4-4cyli.dat
  [1,16,0,0,8,4,0,0,0,0,4,0,-11,0, ldraw_lib__4_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -3 6 0 0 0 0 6 0 -2 0 4-4cyli.dat
  [1,16,0,0,-3,6,0,0,0,0,6,0,-2,0, ldraw_lib__4_4cyli()],
// 1 16 0 0 4 10 0 0 0 0 10 0 -11 0 4-4cyli.dat
  [1,16,0,0,4,10,0,0,0,0,10,0,-11,0, ldraw_lib__4_4cyli()],
...
module ldraw_lib__s__2470s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2470s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
