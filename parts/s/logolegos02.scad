...
$fa=1; $fs=0.2;
function ldraw_lib__s__logolegos02(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 logo-lego-2.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__logo_lego_2(realsolid)],
];
module ldraw_lib__s__logolegos02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__logolegos02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
