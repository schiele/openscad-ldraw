...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3996s01(realsolid=false) = [
...
// 1 16 8 24 110 2 0 0 0 0 24 0 -1 0 rect.dat
  [1,16,8,24,110,2,0,0,0,0,24,0,-1,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 48 0 6 0 0 0 -44 0 0 0 6 4-4cyli.dat
  [1,16,0,48,0,6,0,0,0,-44,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 4 0 6 0 0 0 -1 0 0 0 6 4-4disc.dat
  [1,16,0,4,0,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 28 0 10 0 0 0 -28 0 0 0 -10 3-4cyli.dat
  [1,16,0,28,0,10,0,0,0,-28,0,0,0,-10, ldraw_lib__3_4cyli(realsolid)],
// 1 16 0 28 0 10 0 0 0 20 0 0 0 10 4-4cyli.dat
  [1,16,0,28,0,10,0,0,0,20,0,0,0,10, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 28 0 10 0 0 0 1 0 0 0 10 1-4edge.dat
  [1,16,0,28,0,10,0,0,0,1,0,0,0,10, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 28 0 0 0 10 0 -1 0 10 0 0 1-4ndis.dat
  [1,16,0,28,0,0,0,10,0,-1,0,10,0,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 0 0 0 10 0 0 0 1 0 0 0 10 1-4ndis.dat
  [1,16,0,0,0,10,0,0,0,1,0,0,0,10, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 6 14 110 0 1 0 -14 0 0 0 0 -22 1-4edge.dat
  [1,16,6,14,110,0,1,0,-14,0,0,0,0,-22, ldraw_lib__1_4edge(realsolid)],
// 1 16 10 14 110 0 1 0 -14 0 0 0 0 -22 1-4edge.dat
  [1,16,10,14,110,0,1,0,-14,0,0,0,0,-22, ldraw_lib__1_4edge(realsolid)],
// 1 16 10 14 110 0 -4 0 -14 0 0 0 0 -22 1-4cyli.dat
  [1,16,10,14,110,0,-4,0,-14,0,0,0,0,-22, ldraw_lib__1_4cyli(realsolid)],
// 1 16 6 14 110 0 1 0 0 0 -14 -22 0 0 1-4disc.dat
  [1,16,6,14,110,0,1,0,0,0,-14,-22,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 10 14 110 0 -1 0 -14 0 0 0 0 -22 1-4disc.dat
  [1,16,10,14,110,0,-1,0,-14,0,0,0,0,-22, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 3 14 10 0 0 3 -14 0 0 0 -1 0 rect3.dat
  [1,16,3,14,10,0,0,3,-14,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__s__3996s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3996s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
