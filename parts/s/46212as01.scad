...
use <2454as02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__46212as01(realsolid=false) = [
...
// 1 16 0 120 0 0 0 16 0 -116 0 6 0 0 box4.dat
  [1,16,0,120,0,0,0,16,0,-116,0,6,0,0, ldraw_lib__box4(realsolid)],
...
module ldraw_lib__s__46212as01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__46212as01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
