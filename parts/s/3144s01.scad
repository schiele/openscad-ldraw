...
use <../../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3144s01(realsolid=false) = [
...
// 1 16 0 0 0 10 0 0 0 19 0 0 0 10 4-4cyli.dat
  [1,16,0,0,0,10,0,0,0,19,0,0,0,10, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 -4 0 4 0 0 0 -89 0 0 0 4 4-4cyli.dat
  [1,16,0,-4,0,4,0,0,0,-89,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 0
];
module ldraw_lib__s__3144s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3144s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
