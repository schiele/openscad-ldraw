...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__67139s02(realsolid=false) = [
...
// 1 16 -20 0 30 0 0 9 -9 0 0 0 -1 0 1-8ndis.dat
  [1,16,-20,0,30,0,0,9,-9,0,0,0,-1,0, ldraw_lib__1_8ndis(realsolid)],
// 2 24 -20 -9 30 -11 -9 30
  [2,24,-20,-9,30,-11,-9,30],
// 
// 0 // Open Side
// 1 16 -20 0 -28 -2 0 0 0 0 -2 0 1 0 5-16rin3.dat
  [1,16,-20,0,-28,-2,0,0,0,0,-2,0,1,0, ldraw_lib__5_16rin3(realsolid)],
// 1 16 -20 0 -28 6 0 0 0 0 -6 0 1 0 3-16ndis.dat
  [1,16,-20,0,-28,6,0,0,0,0,-6,0,1,0, ldraw_lib__3_16ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -20 0 -30 -8 0 0 0 0 -8 0 2 0 5-16cylo.dat
  [1,16,-20,0,-30,-8,0,0,0,0,-8,0,2,0, ldraw_lib__5_16cylo(realsolid)],
// 1 16 -20 0 -30 -1 0 0 0 0 -1 0 1 0 5-16ring8.dat
  [1,16,-20,0,-30,-1,0,0,0,0,-1,0,1,0, ldraw_lib__5_16ring8(realsolid)],
...
// 1 16 -16.1698 -6.8756 -29 0 0 .7686 0 -1 .5156 1 0 0 rect3.dat
  [1,16,-16.1698,-6.8756,-29,0,0,.7686,0,-1,.5156,1,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 -8.5 -10 -7.5 -.5 0 0 0 1 0 0 0 -7.5 rect3.dat
  [1,16,-8.5,-10,-7.5,-.5,0,0,0,1,0,0,0,-7.5, ldraw_lib__rect3(realsolid)],
// 1 16 -8.5 -9.5 -17 -.5 0 0 0 1 .5 0 0 -2 rect3.dat
  [1,16,-8.5,-9.5,-17,-.5,0,0,0,1,.5,0,0,-2, ldraw_lib__rect3(realsolid)],
...
// 1 16 -6 -7.18 -5.5 0 -1 0 -.82 0 0 0 0 -5.5 rect3.dat
  [1,16,-6,-7.18,-5.5,0,-1,0,-.82,0,0,0,0,-5.5, ldraw_lib__rect3(realsolid)],
// 2 24 -8 -8 -19 -6 -8 -11
  [2,24,-8,-8,-19,-6,-8,-11],
...
module ldraw_lib__s__67139s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__67139s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
