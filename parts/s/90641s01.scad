...
use <90640s05.scad>
use <90641s02.scad>
function ldraw_lib__s__90641s01() = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\90641s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__90641s02()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\90641s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__90641s02()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 -29.25 -21.75 -10.352 0 0 0 1 0 0 0 -1.75 rect2p.dat
  [1,16,0,-29.25,-21.75,-10.352,0,0,0,1,0,0,0,-1.75, ldraw_lib__rect2p()],
...
module ldraw_lib__s__90641s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__90641s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
