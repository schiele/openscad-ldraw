...
use <../../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2845s01(realsolid=false) = [
...
// 1 16 0 -5 0 16 0 0 0 5 0 0 0 16 box4.dat
  [1,16,0,-5,0,16,0,0,0,5,0,0,0,16, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -5 0 12 0 0 0 3 0 0 0 12 box5.dat
  [1,16,0,-5,0,12,0,0,0,3,0,0,0,12, ldraw_lib__box5(realsolid)],
...
// 1 511 0 -9.6 0 1 0 0 0 1 0 0 0 1 70591.dat
  [1,511,0,-9.6,0,1,0,0,0,1,0,0,0,1, ldraw_lib__70591(realsolid)],
];
module ldraw_lib__s__2845s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2845s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
