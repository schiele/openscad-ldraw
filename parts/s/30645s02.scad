...
use <../../p/stud3a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__30645s02(realsolid=false) = [
...
// 1 16 -90 4 0 6 0 0 0 20 0 0 0 36 box4.dat
  [1,16,-90,4,0,6,0,0,0,20,0,0,0,36, ldraw_lib__box4(realsolid)],
// 1 16 -90 4 -20 1 0 0 0 -5 0 0 0 1 stud3.dat
  [1,16,-90,4,-20,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud3(realsolid)],
// 1 16 -90 4 0 1 0 0 0 -5 0 0 0 1 stud3.dat
  [1,16,-90,4,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud3(realsolid)],
// 1 16 -90 4 20 1 0 0 0 -5 0 0 0 1 stud3.dat
  [1,16,-90,4,20,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud3(realsolid)],
// 1 16 -80 14 0 0 -1 0 0 0 10 40 0 0 rect.dat
  [1,16,-80,14,0,0,-1,0,0,0,10,40,0,0, ldraw_lib__rect(realsolid)],
// 1 16 -100 12 0 0 1 0 0 0 12 86 0 0 rect.dat
  [1,16,-100,12,0,0,1,0,0,0,12,86,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 -96 14 60 0 -1 0 0 0 10 20 0 0 rect.dat
  [1,16,-96,14,60,0,-1,0,0,0,10,20,0,0, ldraw_lib__rect(realsolid)],
// 1 16 -96 14 -60 0 -1 0 0 0 10 -20 0 0 rect.dat
  [1,16,-96,14,-60,0,-1,0,0,0,10,-20,0,0, ldraw_lib__rect(realsolid)],
// 1 16 -88 14 -40 -8 0 0 0 0 10 0 1 0 rect2p.dat
  [1,16,-88,14,-40,-8,0,0,0,0,10,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -88 14 40 -8 0 0 0 0 10 0 -1 0 rect2p.dat
  [1,16,-88,14,40,-8,0,0,0,0,10,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -20 10 98 6 0 0 0 0 6 0 -16 0 4-4cyli.dat
  [1,16,-20,10,98,6,0,0,0,0,6,0,-16,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 10 98 6 0 0 0 0 6 0 -16 0 4-4cyli.dat
  [1,16,0,10,98,6,0,0,0,0,6,0,-16,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 10 98 6 0 0 0 0 6 0 -16 0 4-4cyli.dat
  [1,16,20,10,98,6,0,0,0,0,6,0,-16,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -20 18 90 1 0 0 0 -1.5 0 0 0 1 stud3a.dat
  [1,16,-20,18,90,1,0,0,0,-1.5,0,0,0,1, ldraw_lib__stud3a(realsolid)],
// 1 16 -20 10 96 8 0 0 0 0 8 0 -12 0 2-4cyli.dat
  [1,16,-20,10,96,8,0,0,0,0,8,0,-12,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -20 10 100 1 0 0 0 0 1 0 -1 0 peghole.dat
  [1,16,-20,10,100,1,0,0,0,0,1,0,-1,0, ldraw_lib__peghole(realsolid)],
// 1 16 -20 10 100 8 0 0 0 0 8 0 -1 0 4-4ndis.dat
  [1,16,-20,10,100,8,0,0,0,0,8,0,-1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -20 10 80 1 0 0 0 0 -1 0 1 0 peghole2.dat
  [1,16,-20,10,80,1,0,0,0,0,-1,0,1,0, ldraw_lib__peghole2(realsolid)],
// 1 16 -20 10 84 8 0 0 0 0 8 0 -1 0 2-4ndis.dat
  [1,16,-20,10,84,8,0,0,0,0,8,0,-1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -20 10 96 8 0 0 0 0 8 0 1 0 2-4ndis.dat
  [1,16,-20,10,96,8,0,0,0,0,8,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -20 10 84 8 0 0 0 0 8 0 1 0 2-4edge.dat
  [1,16,-20,10,84,8,0,0,0,0,8,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -20 10 96 8 0 0 0 0 8 0 1 0 2-4edge.dat
  [1,16,-20,10,96,8,0,0,0,0,8,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -20 10 80 8 0 0 0 0 -8 0 1 0 2-4ndis.dat
  [1,16,-20,10,80,8,0,0,0,0,-8,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -28 7 90 0 1 0 0 0 -3 6 0 0 rect3.dat
  [1,16,-28,7,90,0,1,0,0,0,-3,6,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 -12 7 90 0 -1 0 0 0 -3 6 0 0 rect3.dat
  [1,16,-12,7,90,0,-1,0,0,0,-3,6,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 18 90 1 0 0 0 1 0 0 0 1 cylj4x8.dat
  [1,16,0,18,90,1,0,0,0,1,0,0,0,1, ldraw_lib__cylj4x8(realsolid)],
// 1 16 -20 18 90 1 0 0 0 1 0 0 0 1 cylj4x8.dat
  [1,16,-20,18,90,1,0,0,0,1,0,0,0,1, ldraw_lib__cylj4x8(realsolid)],
// 1 16 20 18 90 1 0 0 0 1 0 0 0 1 cylj4x8.dat
  [1,16,20,18,90,1,0,0,0,1,0,0,0,1, ldraw_lib__cylj4x8(realsolid)],
// 1 16 0 18 90 1 0 0 0 -1.5 0 0 0 -1 stud3a.dat
  [1,16,0,18,90,1,0,0,0,-1.5,0,0,0,-1, ldraw_lib__stud3a(realsolid)],
// 1 16 0 10 84 8 0 0 0 0 8 0 12 0 2-4cyli.dat
  [1,16,0,10,84,8,0,0,0,0,8,0,12,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 10 96 8 0 0 0 0 8 0 -12 0 2-4cyli.dat
  [1,16,0,10,96,8,0,0,0,0,8,0,-12,0, ldraw_lib__2_4cyli(realsolid)],
...
// 1 16 0 10 100 8 0 0 0 0 8 0 -1 0 4-4ndis.dat
  [1,16,0,10,100,8,0,0,0,0,8,0,-1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 10 80 1 0 0 0 0 -1 0 1 0 peghole2.dat
  [1,16,0,10,80,1,0,0,0,0,-1,0,1,0, ldraw_lib__peghole2(realsolid)],
// 1 16 0 10 84 8 0 0 0 0 8 0 -1 0 2-4ndis.dat
  [1,16,0,10,84,8,0,0,0,0,8,0,-1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 10 96 8 0 0 0 0 8 0 1 0 2-4ndis.dat
  [1,16,0,10,96,8,0,0,0,0,8,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 10 84 8 0 0 0 0 8 0 1 0 2-4edge.dat
  [1,16,0,10,84,8,0,0,0,0,8,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 10 96 8 0 0 0 0 8 0 1 0 2-4edge.dat
  [1,16,0,10,96,8,0,0,0,0,8,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 10 80 8 0 0 0 0 -8 0 1 0 2-4ndis.dat
  [1,16,0,10,80,8,0,0,0,0,-8,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -8 7 90 0 1 0 0 0 -3 6 0 0 rect3.dat
  [1,16,-8,7,90,0,1,0,0,0,-3,6,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 8 7 90 0 -1 0 0 0 -3 6 0 0 rect3.dat
  [1,16,8,7,90,0,-1,0,0,0,-3,6,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 20 18 90 1 0 0 0 -1.5 0 0 0 -1 stud3a.dat
  [1,16,20,18,90,1,0,0,0,-1.5,0,0,0,-1, ldraw_lib__stud3a(realsolid)],
// 1 16 20 10 84 8 0 0 0 0 8 0 12 0 2-4cyli.dat
  [1,16,20,10,84,8,0,0,0,0,8,0,12,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 20 10 96 8 0 0 0 0 8 0 -12 0 2-4cyli.dat
  [1,16,20,10,96,8,0,0,0,0,8,0,-12,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 20 10 100 1 0 0 0 0 1 0 -1 0 peghole.dat
  [1,16,20,10,100,1,0,0,0,0,1,0,-1,0, ldraw_lib__peghole(realsolid)],
...
// 1 16 36 14 90 0 1 0 10 0 0 0 0 6 rect.dat
  [1,16,36,14,90,0,1,0,10,0,0,0,0,6, ldraw_lib__rect(realsolid)],
// 1 16 -36 14 90 0 -1 0 10 0 0 0 0 6 rect.dat
  [1,16,-36,14,90,0,-1,0,10,0,0,0,0,6, ldraw_lib__rect(realsolid)],
...
// 1 16 60 14 96 20 0 0 0 0 10 0 1 0 rect.dat
  [1,16,60,14,96,20,0,0,0,0,10,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 -60 14 96 -20 0 0 0 0 10 0 1 0 rect.dat
  [1,16,-60,14,96,-20,0,0,0,0,10,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 -40 14 88 0 1 0 0 0 10 8 0 0 rect2p.dat
  [1,16,-40,14,88,0,1,0,0,0,10,8,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 40 14 88 0 -1 0 0 0 10 8 0 0 rect2p.dat
  [1,16,40,14,88,0,-1,0,0,0,10,8,0,0, ldraw_lib__rect2p(realsolid)],
// 0
];
module ldraw_lib__s__30645s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__30645s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
