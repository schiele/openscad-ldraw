...
use <../../p/2-4ring4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__973pd0b(realsolid=false) = [
...
// 1 4 5 1 0 1 0 0 0 0 -1 0 1 0 1-4disc.dat
  [1,4,5,1,0,1,0,0,0,0,-1,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 4 -5 1 0 -1 0 0 0 0 -1 0 1 0 1-4disc.dat
  [1,4,-5,1,0,-1,0,0,0,0,-1,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 4 5 7 0 1 0 0 0 0 1 0 1 0 1-4disc.dat
  [1,4,5,7,0,1,0,0,0,0,1,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 4 -5 7 0 -1 0 0 0 0 1 0 1 0 1-4disc.dat
  [1,4,-5,7,0,-1,0,0,0,0,1,0,1,0, ldraw_lib__1_4disc(realsolid)],
...
// 1 80 0 -2.75 0 1 0 0 0 0 1 0 1 0 2-4disc.dat
  [1,80,0,-2.75,0,1,0,0,0,0,1,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 0 0 -2.75 0 0.25 0 0 0 0 0.25 0 1 0 2-4ring4.dat
  [1,0,0,-2.75,0,0.25,0,0,0,0,0.25,0,1,0, ldraw_lib__2_4ring4(realsolid)],
...
// 1 80 0 -4.25 0 1 0 0 0 0 -1 0 1 0 1-4disc.dat
  [1,80,0,-4.25,0,1,0,0,0,0,-1,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 80 0 -4.25 0 -0.75 0 0 0 0 -0.75 0 1 0 1-4disc.dat
  [1,80,0,-4.25,0,-0.75,0,0,0,0,-0.75,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 0 -4.25 0 -0.25 0 0 0 0 -0.25 0 1 0 1-4ring3.dat
  [1,16,0,-4.25,0,-0.25,0,0,0,0,-0.25,0,1,0, ldraw_lib__1_4ring3(realsolid)],
// 1 0 0 -4.25 0 0.25 0 0 0 0 -0.25 0 1 0 2-4ring4.dat
  [1,0,0,-4.25,0,0.25,0,0,0,0,-0.25,0,1,0, ldraw_lib__2_4ring4(realsolid)],
...
module ldraw_lib__s__973pd0b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__973pd0b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
