...
use <../../p/2-4cylo.scad>
use <../../p/box4-4a.scad>
function ldraw_lib__s__60601s01() = [
...
// 1 16 9.25 21.5 -7 0 0 7.25 17.5 0 0 0 4 0 box4-4a.dat
  [1,16,9.25,21.5,-7,0,0,7.25,17.5,0,0,0,4,0, ldraw_lib__box4_4a()],
// 1 16 -9.25 21.5 -7 0 0 -7.25 17.5 0 0 0 4 0 box4-4a.dat
  [1,16,-9.25,21.5,-7,0,0,-7.25,17.5,0,0,0,4,0, ldraw_lib__box4_4a()],
...
// 1 16 0 4 -7 2 0 0 0 0 -2 0 1 0 2-4chrd.dat
  [1,16,0,4,-7,2,0,0,0,0,-2,0,1,0, ldraw_lib__2_4chrd()],
// 1 16 0 4 -3 -2 0 0 0 0 -2 0 -1 0 2-4chrd.dat
  [1,16,0,4,-3,-2,0,0,0,0,-2,0,-1,0, ldraw_lib__2_4chrd()],
// 1 16 0 39 -7 -2 0 0 0 0 2 0 4 0 2-4cylo.dat
  [1,16,0,39,-7,-2,0,0,0,0,2,0,4,0, ldraw_lib__2_4cylo()],
// 1 16 0 39 -7 -2 0 0 0 0 2 0 1 0 2-4chrd.dat
  [1,16,0,39,-7,-2,0,0,0,0,2,0,1,0, ldraw_lib__2_4chrd()],
// 1 16 0 39 -3 2 0 0 0 0 2 0 -1 0 2-4chrd.dat
  [1,16,0,39,-3,2,0,0,0,0,2,0,-1,0, ldraw_lib__2_4chrd()],
...
module ldraw_lib__s__60601s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__60601s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
