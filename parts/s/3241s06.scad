...
use <../../p/2-4ndis.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3241s06(realsolid=false) = [
...
// 1 16 0 9.5 8 -3.5 0 0 0 0 -3.5 0 1 0 2-4ndis.dat
  [1,16,0,9.5,8,-3.5,0,0,0,0,-3.5,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 4 16 -3.5 0 16 -3.5 6 16 3.5 6 16 3.5 0 16
  [4,16,-3.5,0,16,-3.5,6,16,3.5,6,16,3.5,0,16],
// 4 16 -3.5 0 8 -3.5 8 8 -4 8 8 -4 0 8
  [4,16,-3.5,0,8,-3.5,8,8,-4,8,8,-4,0,8],
// 1 16 0 9.5 8 3.5 0 0 0 0 -3.5 0 -1 0 2-4edge.dat
  [1,16,0,9.5,8,3.5,0,0,0,0,-3.5,0,-1,0, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 0 9.5 16 3.5 0 0 0 0 -3.5 0 -8 0 2-4cyli.dat
  [1,16,0,9.5,16,3.5,0,0,0,0,-3.5,0,-8,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 7.75 15.75 3.5 0 0 0 0 -2.25 0 -7.5 0 2-4cyli.dat
  [1,16,0,7.75,15.75,3.5,0,0,0,0,-2.25,0,-7.5,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 7.75 15.75 3.5 0 0 0 0 -2.25 0 1 0 2-4ndis.dat
  [1,16,0,7.75,15.75,3.5,0,0,0,0,-2.25,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 7.75 15.75 3.5 0 0 0 0 -2.25 0 1 0 2-4edge.dat
  [1,16,0,7.75,15.75,3.5,0,0,0,0,-2.25,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 7.75 8.25 -3.5 0 0 0 0 -2.25 0 -1 0 2-4ndis.dat
  [1,16,0,7.75,8.25,-3.5,0,0,0,0,-2.25,0,-1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 7.75 8.25 -3.5 0 0 0 0 -2.25 0 -1 0 2-4edge.dat
  [1,16,0,7.75,8.25,-3.5,0,0,0,0,-2.25,0,-1,0, ldraw_lib__2_4edge(realsolid)],
...
module ldraw_lib__s__3241s06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3241s06(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
