...
use <../../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__53790s03(realsolid=false) = [
...
// 1 16 11 0 11 0 0 2 0 2 0 2 0 0 1-4cylc.dat
  [1,16,11,0,11,0,0,2,0,2,0,2,0,0, ldraw_lib__1_4cylc(realsolid)],
// 1 16 13 1 0 0 -1 0 0 0 1 11 0 0 rect2p.dat
  [1,16,13,1,0,0,-1,0,0,0,1,11,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -11 0 11 -2 0 0 0 2 0 0 0 2 1-4cylc.dat
  [1,16,-11,0,11,-2,0,0,0,2,0,0,0,2, ldraw_lib__1_4cylc(realsolid)],
// 1 16 0 1 13 -11 0 0 0 0 1 0 -1 0 rect2p.dat
  [1,16,0,1,13,-11,0,0,0,0,1,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -11 0 -11 0 0 -2 0 2 0 -2 0 0 1-4cylc.dat
  [1,16,-11,0,-11,0,0,-2,0,2,0,-2,0,0, ldraw_lib__1_4cylc(realsolid)],
// 1 16 -13 1 0 0 1 0 0 0 1 -11 0 0 rect2p.dat
  [1,16,-13,1,0,0,1,0,0,0,1,-11,0,0, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__s__53790s03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__53790s03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
