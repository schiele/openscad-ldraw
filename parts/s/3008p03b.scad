...
use <../../p/2-4ndis.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3008p03b(realsolid=false) = [
...
// 1 16 -44 15.8 -10 2 0 0 0 0 2 0 1 0 2-4ndis.dat
  [1,16,-44,15.8,-10,2,0,0,0,0,2,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -44 11.2 -10 2 0 0 0 0 -2 0 1 0 2-4ndis.dat
  [1,16,-44,11.2,-10,2,0,0,0,0,-2,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -44 13.5 -10 -7.2 0 0 0 0 -5.5 0 1 0 1-4chrd.dat
  [1,16,-44,13.5,-10,-7.2,0,0,0,0,-5.5,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -44 13.5 -10 0 0 -7.2 5.5 0 0 0 1 0 1-4chrd.dat
  [1,16,-44,13.5,-10,0,0,-7.2,5.5,0,0,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -44 13.5 -10 0 0 7.2 5.5 0 0 0 1 0 1-8chrd.dat
  [1,16,-44,13.5,-10,0,0,7.2,5.5,0,0,0,1,0, ldraw_lib__1_8chrd(realsolid)],
// 1 16 -44 13.5 -10 0 0 7.2 -5.5 0 0 0 1 0 1-8chrd.dat
  [1,16,-44,13.5,-10,0,0,7.2,-5.5,0,0,0,1,0, ldraw_lib__1_8chrd(realsolid)],
...
// 1 16 -2.4 11.2 -10 0 0 2.4 3.2 0 0 0 1 0 2-4disc.dat
  [1,16,-2.4,11.2,-10,0,0,2.4,3.2,0,0,0,1,0, ldraw_lib__2_4disc(realsolid)],
...
// 1 16 -6 11.5 -10 0 0 1.6 1.5 0 0 0 1 0 2-4ndis.dat
  [1,16,-6,11.5,-10,0,0,1.6,1.5,0,0,0,1,0, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 28.8 15.8 -10 2 0 0 0 0 2 0 1 0 2-4ndis.dat
  [1,16,28.8,15.8,-10,2,0,0,0,0,2,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 28.8 11.2 -10 2 0 0 0 0 -2 0 1 0 2-4ndis.dat
  [1,16,28.8,11.2,-10,2,0,0,0,0,-2,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 28.8 13.5 -10 -7.2 0 0 0 0 -5.5 0 1 0 1-4chrd.dat
  [1,16,28.8,13.5,-10,-7.2,0,0,0,0,-5.5,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 28.8 13.5 -10 0 0 -7.2 5.5 0 0 0 1 0 1-4chrd.dat
  [1,16,28.8,13.5,-10,0,0,-7.2,5.5,0,0,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 28.8 13.5 -10 0 0 7.2 5.5 0 0 0 1 0 1-8chrd.dat
  [1,16,28.8,13.5,-10,0,0,7.2,5.5,0,0,0,1,0, ldraw_lib__1_8chrd(realsolid)],
// 1 16 28.8 13.5 -10 0 0 7.2 -5.5 0 0 0 1 0 1-8chrd.dat
  [1,16,28.8,13.5,-10,0,0,7.2,-5.5,0,0,0,1,0, ldraw_lib__1_8chrd(realsolid)],
...
module ldraw_lib__s__3008p03b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3008p03b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
