...
use <../../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__30367bs01(realsolid=false) = [
...
// 1 16 0 4 0 0 0 -1 0 1 0 -1 0 0 axl3ho10.dat
  [1,16,0,4,0,0,0,-1,0,1,0,-1,0,0, ldraw_lib__axl3ho10(realsolid)],
...
module ldraw_lib__s__30367bs01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__30367bs01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__30367bs01(line=0.2);