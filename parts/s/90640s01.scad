...
use <90640s05.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__90640s01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\90640s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__90640s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\90640s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__90640s02(realsolid)],
// 
// 0 // double connector
...
// 1 16 0 -29.178 -21.75 10.5 0 0 0 1 -.072 0 0 1.75 rect.dat
  [1,16,0,-29.178,-21.75,10.5,0,0,0,1,-.072,0,0,1.75, ldraw_lib__rect(realsolid)],
...
module ldraw_lib__s__90640s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__90640s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
