...
use <../../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__u1853s01(realsolid=false) = [
...
// 1 16 0 -50 0 2 0 0 0 -2 0 0 0 2 2-8sphe.dat
  [1,16,0,-50,0,2,0,0,0,-2,0,0,0,2, ldraw_lib__2_8sphe(realsolid)],
// 1 16 0 -50 0 2 0 0 0 42 0 0 0 2 4-4cyli.dat
  [1,16,0,-50,0,2,0,0,0,42,0,0,0,2, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 -50 0 2 0 0 0 0 -2 0 1 0 2-4edge.dat
  [1,16,0,-50,0,2,0,0,0,0,-2,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -50 0 2 0 0 0 1 0 0 0 -2 2-4edge.dat
  [1,16,0,-50,0,2,0,0,0,1,0,0,0,-2, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -62 -2.1 12 0 0 0 0 -12 0 2.1 0 box5.dat
  [1,16,0,-62,-2.1,12,0,0,0,0,-12,0,2.1,0, ldraw_lib__box5(realsolid)],
// 0 //
];
module ldraw_lib__s__u1853s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u1853s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
