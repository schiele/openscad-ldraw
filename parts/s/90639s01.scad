...
use <90640s03.scad>
use <90640s05.scad>
function ldraw_lib__s__90639s01() = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\90639s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__90639s02()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\90639s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__90639s02()],
// 
// 0 // double connector
...
module ldraw_lib__s__90639s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__90639s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
