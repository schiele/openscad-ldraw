...
use <../../p/1-4chrd.scad>
use <../../p/1-4cyli.scad>
function ldraw_lib__s__6148328acs07() = [
// 0 ~Sticker  0.8 x  1.9 with White Stripes and Black Headlamp on Red Background Right - Underside Flat
// 0 Name: s\6148328acs07.dat
...
module ldraw_lib__s__6148328acs07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6148328acs07(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__6148328acs07(line=0.2);