...
use <../../p/rect.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2335s01(realsolid=false) = [
...
// 1 16 0 20 10 2 0 0 0 0 20 0 40 0 box3u4a.dat
  [1,16,0,20,10,2,0,0,0,0,20,0,40,0, ldraw_lib__box3u4a(realsolid)],
...
module ldraw_lib__s__2335s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2335s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
