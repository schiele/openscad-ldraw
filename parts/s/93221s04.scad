...
$fa=1; $fs=0.2;
function ldraw_lib__s__93221s04(realsolid=false) = [
...
// 1 16 18.5 13.25 -10 10 0 0 0 0 -10 0 1 0 48\4-4ndis.dat
  [1,16,18.5,13.25,-10,10,0,0,0,0,-10,0,1,0, ldraw_lib__48__4_4ndis(realsolid)],
...
module ldraw_lib__s__93221s04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__93221s04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
