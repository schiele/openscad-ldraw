...
// 1 16 -130 0 230 0 0 1 0 1 0 -1 0 0 stug9.dat
  [1,16,-130,0,230,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug9()],
...
// 1 16 80 0 80 0 0 1 0 1 0 -1 0 0 stug6.dat
  [1,16,80,0,80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug6()],
// 1 16 -260 0 -260 0 0 1 0 1 0 -1 0 0 stug6.dat
  [1,16,-260,0,-260,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug6()],
...
// 1 16 -260 0 180 0 0 1 0 1 0 -1 0 0 stug4.dat
  [1,16,-260,0,180,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug4()],
// 1 16 110 0 -10 0 0 1 0 1 0 -1 0 0 stug3.dat
  [1,16,110,0,-10,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug3()],
// 1 16 110 0 -70 0 0 1 0 1 0 -1 0 0 stug3.dat
  [1,16,110,0,-70,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug3()],
// 1 16 -10 0 110 0 0 1 0 1 0 -1 0 0 stug3.dat
  [1,16,-10,0,110,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug3()],
// 1 16 -70 0 110 0 0 1 0 1 0 -1 0 0 stug3.dat
  [1,16,-70,0,110,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug3()],
...
// 1 16 -260 0 -180 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-260,0,-180,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -180 0 -260 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-180,0,-260,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -180 0 -300 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-180,0,-300,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 120 0 -120 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,120,0,-120,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 60 0 0 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,60,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
// 1 16 -120 0 120 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-120,0,120,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2()],
...
// 1 16 -190 0 -230 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-190,0,-230,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 -190 0 -210 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-190,0,-210,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 -210 0 -190 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-210,0,-190,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 -230 0 -190 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-230,0,-190,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 -290 0 -150 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-290,0,-150,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 -310 0 -150 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-310,0,-150,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
...
// 1 16 130 0 -170 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,130,0,-170,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 130 0 -150 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,130,0,-150,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
...
// 1 16 50 0 -30 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,50,0,-30,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
...
// 1 16 -190 0 130 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-190,0,130,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 -170 0 130 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-170,0,130,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 -150 0 130 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-150,0,130,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
...
// 1 16 -310 0 210 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-310,0,210,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 -310 0 190 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-310,0,190,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 -310 0 150 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-310,0,150,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 -310 0 170 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-310,0,170,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
];
module ldraw_lib__s__609s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__609s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
