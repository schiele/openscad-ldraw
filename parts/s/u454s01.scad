...
use <../../p/t04q2500.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__u454s01(realsolid=false) = [
...
// 1 16 0 -14 0 6 0 0 1.8 1 0 0 0 6 1-8edge.dat
  [1,16,0,-14,0,6,0,0,1.8,1,0,0,0,6, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 -14 0 -6 0 0 1.8 1 0 0 0 6 1-8edge.dat
  [1,16,0,-14,0,-6,0,0,1.8,1,0,0,0,6, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 -14 0 6 0 0 1.8 1 0 0 0 -6 1-8edge.dat
  [1,16,0,-14,0,6,0,0,1.8,1,0,0,0,-6, ldraw_lib__1_8edge(realsolid)],
...
// 1 16 0 -14 0 0 0 6 1.8 1 0 6 0 0 1-8edge.dat
  [1,16,0,-14,0,0,0,6,1.8,1,0,6,0,0, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 -14 0 0 0 -6 1.8 1 0 6 0 0 1-8edge.dat
  [1,16,0,-14,0,0,0,-6,1.8,1,0,6,0,0, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 -14 0 0 0 6 1.8 1 0 -6 0 0 1-8edge.dat
  [1,16,0,-14,0,0,0,6,1.8,1,0,-6,0,0, ldraw_lib__1_8edge(realsolid)],
...
// 1 16 0 -18 0 2 0 0 0 -140 0 0 -20 2 4-4con1.dat
  [1,16,0,-18,0,2,0,0,0,-140,0,0,-20,2, ldraw_lib__4_4con1(realsolid)],
// 1 16 0 -158 -28 0 -8 0 0 0 -8 8 0 0 t04q2500.dat
  [1,16,0,-158,-28,0,-8,0,0,0,-8,8,0,0, ldraw_lib__t04q2500(realsolid)],
// 1 16 0 -166 -62 2 0 0 0 0 -2 0 34 0 4-4cyli.dat
  [1,16,0,-166,-62,2,0,0,0,0,-2,0,34,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -166 -62 2 0 0 0 0 -2 0 1 0 4-4disc.dat
  [1,16,0,-166,-62,2,0,0,0,0,-2,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 -166 -62 2 0 0 0 0 -2 0 1 0 4-4edge.dat
  [1,16,0,-166,-62,2,0,0,0,0,-2,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 
// 1 16 0 -164 -53 1 0 0 0 2.3521 0 0 0 1 4-4cyli.dat
  [1,16,0,-164,-53,1,0,0,0,2.3521,0,0,0,1, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -164 -35 1 0 0 0 2.3521 0 0 0 1 4-4cyli.dat
  [1,16,0,-164,-35,1,0,0,0,2.3521,0,0,0,1, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -164 -53 .25 0 0 0 .25 0 0 0 .25 cylj4x8.dat
  [1,16,0,-164,-53,.25,0,0,0,.25,0,0,0,.25, ldraw_lib__cylj4x8(realsolid)],
// 1 16 0 -164 -35 .25 0 0 0 .25 0 0 0 .25 cylj4x8.dat
  [1,16,0,-164,-35,.25,0,0,0,.25,0,0,0,.25, ldraw_lib__cylj4x8(realsolid)],
// 1 16 0 -161.6479 -53 0 0 -1 0 .1114 0 1 0 0 4-4cylse.dat
  [1,16,0,-161.6479,-53,0,0,-1,0,.1114,0,1,0,0, ldraw_lib__4_4cylse(realsolid)],
// 1 16 0 -161.6479 -35 0 0 1 0 .1114 0 -1 0 0 4-4cylse.dat
  [1,16,0,-161.6479,-35,0,0,1,0,.1114,0,-1,0,0, ldraw_lib__4_4cylse(realsolid)],
// 1 16 0 -136 -18 .6 0 0 0 0 -.6 0 -8 0 4-4cylo.dat
  [1,16,0,-136,-18,.6,0,0,0,0,-.6,0,-8,0, ldraw_lib__4_4cylo(realsolid)],
// 
// 1 16 0 -145 -62 0 0 1 14 0 0 0 1 0 rect2p.dat
  [1,16,0,-145,-62,0,0,1,14,0,0,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 -145 -26 0 0 1 14 0 0 0 -1 0 rect2p.dat
  [1,16,0,-145,-26,0,0,1,14,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -1 -159 -44 0 2 0 0 0 -3 -18 0 0 2-4cyli.dat
  [1,16,-1,-159,-44,0,2,0,0,0,-3,-18,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -1 -159 -44 0 1 0 0 0 -3 -18 0 0 2-4edge.dat
  [1,16,-1,-159,-44,0,1,0,0,0,-3,-18,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 1 -159 -44 0 1 0 0 0 -3 -18 0 0 2-4edge.dat
  [1,16,1,-159,-44,0,1,0,0,0,-3,-18,0,0, ldraw_lib__2_4edge(realsolid)],
// 
// 1 16 -1 -131 -44 0 2 0 0 0 3 18 0 0 2-4cyli.dat
  [1,16,-1,-131,-44,0,2,0,0,0,3,18,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -1 -131 -44 0 1 0 0 0 3 18 0 0 2-4edge.dat
  [1,16,-1,-131,-44,0,1,0,0,0,3,18,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 1 -131 -44 0 1 0 0 0 3 18 0 0 2-4edge.dat
  [1,16,1,-131,-44,0,1,0,0,0,3,18,0,0, ldraw_lib__2_4edge(realsolid)],
...
module ldraw_lib__s__u454s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u454s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__u454s01(line=0.2);