...
use <../../p/stud2s2e.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3660bs01(realsolid=false) = [
...
// 1 16 0 24 -.5 16 0 0 0 -20 0 0 0 6.5 box4-1.dat
  [1,16,0,24,-.5,16,0,0,0,-20,0,0,0,6.5, ldraw_lib__box4_1(realsolid)],
...
// 1 16 10 0 -20 1 0 0 0 1 0 0 0 1 stud2a.dat
  [1,16,10,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2a(realsolid)],
// 1 16 10 0 -20 1 0 0 0 4 0 0 0 1 stud2s2e.dat
  [1,16,10,0,-20,1,0,0,0,4,0,0,0,1, ldraw_lib__stud2s2e(realsolid)],
// 1 16 10 4 -20 0 0 1 0 6 0 -1 0 0 stud2s2.dat
  [1,16,10,4,-20,0,0,1,0,6,0,-1,0,0, ldraw_lib__stud2s2(realsolid)],
// 
// 1 16 -10 0 0 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-10,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -10 0 -20 1 0 0 0 1 0 0 0 1 stud2a.dat
...
// 1 16 -2.5 23 0 0 0 -1.5 0 -1 0 -1.5 0 0 2-4chrd.dat
  [1,16,-2.5,23,0,0,0,-1.5,0,-1,0,-1.5,0,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 2.5 23 0 0 0 1.5 0 -1 0 1.5 0 0 2-4chrd.dat
  [1,16,2.5,23,0,0,0,1.5,0,-1,0,1.5,0,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 0 4 0 2.5 0 0 0 19 0 0 0 -1.5 box3u8p.dat
  [1,16,0,4,0,2.5,0,0,0,19,0,0,0,-1.5, ldraw_lib__box3u8p(realsolid)],
// 1 16 -2.5 23 0 0 0 -1.5 0 -19 0 -1.5 0 0 2-4cylo.dat
  [1,16,-2.5,23,0,0,0,-1.5,0,-19,0,-1.5,0,0, ldraw_lib__2_4cylo(realsolid)],
// 1 16 2.5 23 0 0 0 1.5 0 -19 0 -1.5 0 0 2-4cylo.dat
  [1,16,2.5,23,0,0,0,1.5,0,-19,0,-1.5,0,0, ldraw_lib__2_4cylo(realsolid)],
// 1 16 0 4 -4.25 0 0 1 0 14 0 2.75 0 0 box3u2p.dat
  [1,16,0,4,-4.25,0,0,1,0,14,0,2.75,0,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 0 4 3.75 0 0 1 0 14 0 -2.25 0 0 box3u2p.dat
  [1,16,0,4,3.75,0,0,1,0,14,0,-2.25,0,0, ldraw_lib__box3u2p(realsolid)],
// 
// 1 16 10 14 -7 -1 0 0 0 0 10 0 1 0 box4-2p.dat
  [1,16,10,14,-7,-1,0,0,0,0,10,0,1,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 13.5 14 -7 0 0 -2.5 10 0 0 0 -1 0 rect1.dat
  [1,16,13.5,14,-7,0,0,-2.5,10,0,0,0,-1,0, ldraw_lib__rect1(realsolid)],
// 1 16 -10 14 -7 1 0 0 0 0 10 0 1 0 box4-2p.dat
  [1,16,-10,14,-7,1,0,0,0,0,10,0,1,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 -13.5 14 -7 0 0 -2.5 10 0 0 0 -1 0 rect1.dat
  [1,16,-13.5,14,-7,0,0,-2.5,10,0,0,0,-1,0, ldraw_lib__rect1(realsolid)],
// 1 16 0 14 -7 0 0 -9 10 0 0 0 -1 0 rect1.dat
  [1,16,0,14,-7,0,0,-9,10,0,0,0,-1,0, ldraw_lib__rect1(realsolid)],
...
module ldraw_lib__s__3660bs01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3660bs01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
