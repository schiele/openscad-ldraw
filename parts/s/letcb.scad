use <../../lib.scad>
use <../../p/empty.scad>
function ldraw_lib__s__letcb() = [
// 0 ~Mindstorms RCX Letter "C" Background (Obsolete)
// 0 Name: s\letcb.dat
...
module ldraw_lib__s__letcb(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__letcb(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__letcb(line=0.2);