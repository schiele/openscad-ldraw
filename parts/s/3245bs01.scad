...
use <3245bs02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3245bs01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3245bs02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3245bs02(realsolid)],
// 1 16 0 24 -10 0 0 -20 24 0 0 0 20 0 box3u12.dat
  [1,16,0,24,-10,0,0,-20,24,0,0,0,20,0, ldraw_lib__box3u12(realsolid)],
];
module ldraw_lib__s__3245bs01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3245bs01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
