...
use <../../p/1-4chrd.scad>
use <../../p/1-4cyli.scad>
function ldraw_lib__s__6142275ads06() = [
// 0 ~Sticker  1.9 x  0.8 with Black Airscoope on White Background - Bottom Face
// 0 Name: s\6142275ads06.dat
...
module ldraw_lib__s__6142275ads06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6142275ads06(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__6142275ads06(line=0.2);