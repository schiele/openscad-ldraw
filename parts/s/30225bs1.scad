...
use <../../p/stug7.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__30225bs1(realsolid=false) = [
...
// 1 16 0 0 260 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,0,0,260,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2(realsolid)],
// 1 16 0 0 220 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,0,0,220,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2(realsolid)],
...
// 1 16 0 0 60 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,0,0,60,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2(realsolid)],
...
module ldraw_lib__s__30225bs1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__30225bs1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
