...
use <../../p/triangle.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__41765s01(realsolid=false) = [
...
// 1 16 20 2 40 0 -1 0 2 0 0 0 0 20 rect3.dat
  [1,16,20,2,40,0,-1,0,2,0,0,0,0,20, ldraw_lib__rect3(realsolid)],
// 1 16 0 2 -20 0 10 -10 2 0 0 0 0 -40 box2-5.dat
  [1,16,0,2,-20,0,10,-10,2,0,0,0,0,-40, ldraw_lib__box2_5(realsolid)],
// 
...
// 1 16 -10 24 40 6 0 0 0 -20 0 0 0 16 box5.dat
  [1,16,-10,24,40,6,0,0,0,-20,0,0,0,16, ldraw_lib__box5(realsolid)],
// 1 16 -10 4 40 1 0 0 0 -5 0 0 0 1 stud3.dat
  [1,16,-10,4,40,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud3(realsolid)],
// 
// 1 16 -10 24 40 10 0 0 0 1 0 0 0 20 recte3.dat
  [1,16,-10,24,40,10,0,0,0,1,0,0,0,20, ldraw_lib__recte3(realsolid)],
...
// 1 16 -10 14 2 6 0 0 0 0 -10 0 18 0 box2-7.dat
  [1,16,-10,14,2,6,0,0,0,0,-10,0,18,0, ldraw_lib__box2_7(realsolid)],
// 1 16 -10 11.4 -16 6 0 0 0 0 -7.4 0 -1 0 rect3.dat
  [1,16,-10,11.4,-16,6,0,0,0,0,-7.4,0,-1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 -10 23 10 6 0 0 0 1 1 0 0 10 recte3.dat
  [1,16,-10,23,10,6,0,0,0,1,1,0,0,10, ldraw_lib__recte3(realsolid)],
// 1 16 -10 20.4 -8 6 0 0 0 1 -1.6 0 0 -8 recte3.dat
  [1,16,-10,20.4,-8,6,0,0,0,1,-1.6,0,0,-8, ldraw_lib__recte3(realsolid)],
// 
// 1 16 -2 23 10 2 0 0 0 -1 -1 0 0 -10 rect1.dat
  [1,16,-2,23,10,2,0,0,0,-1,-1,0,0,-10, ldraw_lib__rect1(realsolid)],
// 1 16 -18 23 10 -2 0 0 0 -1 1 0 0 10 rect1.dat
  [1,16,-18,23,10,-2,0,0,0,-1,1,0,0,10, ldraw_lib__rect1(realsolid)],
...
// 1 16 0 0 58 0 0 18 20 0 0 0 1 0 triangle.dat
  [1,16,0,0,58,0,0,18,20,0,0,0,1,0, ldraw_lib__triangle(realsolid)],
// 1 16 0 0 -18 0 0 8 14 0 0 0 -1 0 triangle.dat
  [1,16,0,0,-18,0,0,8,14,0,0,0,-1,0, ldraw_lib__triangle(realsolid)],
// 1 16 9 10 40 0 0 9 0 1 -10 18 0 0 rect2p.dat
  [1,16,9,10,40,0,0,9,0,1,-10,18,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 -10 7 -38 -8 0 0 0 1 -6 0 0 -18 box2-5.dat
  [1,16,-10,7,-38,-8,0,0,0,1,-6,0,0,-18, ldraw_lib__box2_5(realsolid)],
...
// 1 16 10 2.2222 30 1 0 0 0 6.6666 0 0 0 1 stud2s.dat
  [1,16,10,2.2222,30,1,0,0,0,6.6666,0,0,0,1, ldraw_lib__stud2s(realsolid)],
// 1 16 10 2.2222 50 1 0 0 0 6.6666 0 0 0 1 stud2s.dat
  [1,16,10,2.2222,50,1,0,0,0,6.6666,0,0,0,1, ldraw_lib__stud2s(realsolid)],
// 1 16 10 2.2222 30 1 0 0 0 1.55555 0 0 0 1 stud2a.dat
  [1,16,10,2.2222,30,1,0,0,0,1.55555,0,0,0,1, ldraw_lib__stud2a(realsolid)],
// 1 16 10 2.2222 50 1 0 0 0 1.55555 0 0 0 1 stud2a.dat
  [1,16,10,2.2222,50,1,0,0,0,1.55555,0,0,0,1, ldraw_lib__stud2a(realsolid)],
// 
// 1 16 -10 8.66667 -30 0 0 1 0 2 0 -1 0 0 stud2s.dat
  [1,16,-10,8.66667,-30,0,0,1,0,2,0,-1,0,0, ldraw_lib__stud2s(realsolid)],
// 1 16 -10 8.66667 -30 1 0 0 0 3.166667 0 0 0 1 stud2a.dat
  [1,16,-10,8.66667,-30,1,0,0,0,3.166667,0,0,0,1, ldraw_lib__stud2a(realsolid)],
// 1 16 -10 2 -50 0 0 1 0 2 0 -1 0 0 stud2s.dat
  [1,16,-10,2,-50,0,0,1,0,2,0,-1,0,0, ldraw_lib__stud2s(realsolid)],
// 1 16 -10 2 -50 1 0 0 0 1.5 0 0 0 1 stud2a.dat
  [1,16,-10,2,-50,1,0,0,0,1.5,0,0,0,1, ldraw_lib__stud2a(realsolid)],
];
module ldraw_lib__s__41765s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__41765s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
