...
$fa=1; $fs=0.2;
function ldraw_lib__s__65202s01(realsolid=false) = [
...
// 1 16 22 24 0 0 0 2 0 -1 0 -36 0 0 rect.dat
  [1,16,22,24,0,0,0,2,0,-1,0,-36,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 0 18 42 0 0 20 2 1 0 -2 0 0 rect.dat
  [1,16,0,18,42,0,0,20,2,1,0,-2,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 0 16 80 0 0 20 0 1 0 20 0 0 rect1.dat
  [1,16,0,16,80,0,0,20,0,1,0,20,0,0, ldraw_lib__rect1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 22 71.5 -16 0 0 0 -2 0 0 0 24.5 box2-5.dat
  [1,16,0,22,71.5,-16,0,0,0,-2,0,0,0,24.5, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 24 45.5 16 0 0 0 -2.5 1.5 0 0 -1.5 box2-7.dat
  [1,16,0,24,45.5,16,0,0,0,-2.5,1.5,0,0,-1.5, ldraw_lib__box2_7(realsolid)],
// 1 16 0 28 42 0 0 16 0 -1 0 2 0 0 rect1.dat
  [1,16,0,28,42,0,0,16,0,-1,0,2,0,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 32 24 0 0 0 -8 0 -4 0 -36 0 0 box3u2p.dat
  [1,16,32,24,0,0,0,-8,0,-4,0,-36,0,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 50 20 0 0 0 1 0 -1 0 -1 0 0 stug3-1x3.dat
  [1,16,50,20,0,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stug3_1x3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 50 24 0 0 0 6 0 -4 0 -36 0 0 box5.dat
  [1,16,50,24,0,0,0,6,0,-4,0,-36,0,0, ldraw_lib__box5(realsolid)],
...
// 1 16 40 20 0 0 20 0 0 0 -4 40 0 0 box4-2p.dat
  [1,16,40,20,0,0,20,0,0,0,-4,40,0,0, ldraw_lib__box4_2p(realsolid)],
// 4 16 40 16 -40 40 16 40 20 16 44 20 16 -44
  [4,16,40,16,-40,40,16,40,20,16,44,20,16,-44],
// 1 16 16 26 0 0 -1 0 0 0 -2 40 0 0 rect2p.dat
  [1,16,16,26,0,0,-1,0,0,0,-2,40,0,0, ldraw_lib__rect2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 24 20 6 0 0 0 4 0 0 0 6 4-4cylo.dat
  [1,16,0,24,20,6,0,0,0,4,0,0,0,6, ldraw_lib__4_4cylo(realsolid)],
...
// 1 16 0 28 20 6 0 0 0 -1 0 0 0 6 4-4ndis.dat
  [1,16,0,28,20,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\65202s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__65202s02(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\65202s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__65202s02(realsolid)],
];
module ldraw_lib__s__65202s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__65202s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
