...
use <../../p/recte4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__6196s01(realsolid=false) = [
...
// 1 16 -12 0 -9 0 1 0 4 0 0 0 0 -4 2-4chrd.dat
  [1,16,-12,0,-9,0,1,0,4,0,0,0,0,-4, ldraw_lib__2_4chrd(realsolid)],
// 1 16 -12 0 -9 0 1 0 4 0 0 0 0 -4 2-4edge.dat
  [1,16,-12,0,-9,0,1,0,4,0,0,0,0,-4, ldraw_lib__2_4edge(realsolid)],
// 1 16 -12 0 -9 0 4 0 4 0 0 0 0 -4 2-4cyli.dat
  [1,16,-12,0,-9,0,4,0,4,0,0,0,0,-4, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -8 0 -9 0 16 0 4 0 0 0 0 -4 2-4cyli.dat
  [1,16,-8,0,-9,0,16,0,4,0,0,0,0,-4, ldraw_lib__2_4cyli(realsolid)],
// 1 16 8 0 -9 0 4 0 4 0 0 0 0 -4 2-4cyli.dat
  [1,16,8,0,-9,0,4,0,4,0,0,0,0,-4, ldraw_lib__2_4cyli(realsolid)],
// 1 16 12 0 -9 0 -1 0 4 0 0 0 0 -4 2-4edge.dat
  [1,16,12,0,-9,0,-1,0,4,0,0,0,0,-4, ldraw_lib__2_4edge(realsolid)],
// 1 16 12 0 -9 0 -1 0 4 0 0 0 0 -4 2-4chrd.dat
  [1,16,12,0,-9,0,-1,0,4,0,0,0,0,-4, ldraw_lib__2_4chrd(realsolid)],
...
// 1 16 10.5 0 0 0 0 1.5 4 0 0 0 -1 0 recte4.dat
  [1,16,10.5,0,0,0,0,1.5,4,0,0,0,-1,0, ldraw_lib__recte4(realsolid)],
// 1 16 12 0 -4.5 0 -1 0 0 0 -4 4.5 0 0 rect2p.dat
  [1,16,12,0,-4.5,0,-1,0,0,0,-4,4.5,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 8.5 0 -4.5 .5 1 0 0 0 -4 4.5 0 0 rect2p.dat
  [1,16,8.5,0,-4.5,.5,1,0,0,0,-4,4.5,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 0 -9 0 0 8 -4 0 0 0 -1 0 rect.dat
  [1,16,0,0,-9,0,0,8,-4,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 
// 1 16 -10.5 0 0 0 0 -1.5 4 0 0 0 -1 0 recte4.dat
  [1,16,-10.5,0,0,0,0,-1.5,4,0,0,0,-1,0, ldraw_lib__recte4(realsolid)],
// 1 16 -12 0 -4.5 0 1 0 0 0 -4 4.5 0 0 rect2p.dat
...
module ldraw_lib__s__6196s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6196s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
