...
use <../../p/2-4chrd.scad>
use <3009p27a.scad>
function ldraw_lib__s__u454p03s01() = [
...
// 1 16 0 -14 0 0 -1 0 0 0 -3 18 0 0 2-4chrd.dat
  [1,16,0,-14,0,0,-1,0,0,0,-3,18,0,0, ldraw_lib__2_4chrd()],
// 1 16 0 14 0 0 -1 0 0 0 3 -18 0 0 2-4chrd.dat
  [1,16,0,14,0,0,-1,0,0,0,3,-18,0,0, ldraw_lib__2_4chrd()],
// 1 16 0 0 0 0 -1 0 0 0 -.45 .35 0 0 s\3009p27a.dat
  [1,16,0,0,0,0,-1,0,0,0,-.45,.35,0,0, ldraw_lib__s__3009p27a()],
// 
...
module ldraw_lib__s__u454p03s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u454p03s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
