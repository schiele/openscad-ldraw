...
$fa=1; $fs=0.2;
function ldraw_lib__s__3007s01(realsolid=false) = [
...
// 1 16 0 24 0 80 0 0 0 -24 0 0 0 20 box4t.dat
  [1,16,0,24,0,80,0,0,0,-24,0,0,0,20, ldraw_lib__box4t(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 24 0 76 0 0 0 -20 0 0 0 16 box5.dat
  [1,16,0,24,0,76,0,0,0,-20,0,0,0,16, ldraw_lib__box5(realsolid)],
...
// 1 16 0 0 10 1 0 0 0 1 0 0 0 1 stug-1x8.dat
  [1,16,0,0,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x8(realsolid)],
// 1 16 0 0 -10 1 0 0 0 1 0 0 0 1 stug-1x8.dat
  [1,16,0,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x8(realsolid)],
// 1 16 0 4 0 1 0 0 0 -5 0 0 0 1 stug4-1x7.dat
  [1,16,0,4,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stug4_1x7(realsolid)],
// 
// 1 16 -40 4 8 0 0 1 0 14.5 0 -1 0 0 boxjcyl4.dat
  [1,16,-40,4,8,0,0,1,0,14.5,0,-1,0,0, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 -40 4 12 0 0 1 0 14.5 0 -4 0 0 box3u5p.dat
  [1,16,-40,4,12,0,0,1,0,14.5,0,-4,0,0, ldraw_lib__box3u5p(realsolid)],
// 1 16 -40 4 -8 0 0 -1 0 14.5 0 1 0 0 boxjcyl4.dat
  [1,16,-40,4,-8,0,0,-1,0,14.5,0,1,0,0, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 -40 4 -12 0 0 -1 0 14.5 0 4 0 0 box3u5p.dat
  [1,16,-40,4,-12,0,0,-1,0,14.5,0,4,0,0, ldraw_lib__box3u5p(realsolid)],
...
// 1 16 0 4 8 0 0 1 0 14.5 0 -1 0 0 boxjcyl4.dat
  [1,16,0,4,8,0,0,1,0,14.5,0,-1,0,0, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 0 4 12 0 0 1 0 14.5 0 -4 0 0 box3u5p.dat
  [1,16,0,4,12,0,0,1,0,14.5,0,-4,0,0, ldraw_lib__box3u5p(realsolid)],
// 1 16 0 4 -8 0 0 -1 0 14.5 0 1 0 0 boxjcyl4.dat
  [1,16,0,4,-8,0,0,-1,0,14.5,0,1,0,0, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 0 4 -12 0 0 -1 0 14.5 0 4 0 0 box3u5p.dat
  [1,16,0,4,-12,0,0,-1,0,14.5,0,4,0,0, ldraw_lib__box3u5p(realsolid)],
...
module ldraw_lib__s__3007s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3007s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
