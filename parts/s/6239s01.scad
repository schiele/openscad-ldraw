...
use <../../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__6239s01(realsolid=false) = [
...
// 1 16 0 4 10 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,4,10,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 0 4 -10 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,4,-10,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 16 0 0 0 -4 0 0 0 26 box5.dat
  [1,16,0,8,0,16,0,0,0,-4,0,0,0,26, ldraw_lib__box5(realsolid)],
// 
...
// 1 16 0 8 0 20 0 0 0 -8 0 0 0 30 box5.dat
  [1,16,0,8,0,20,0,0,0,-8,0,0,0,30, ldraw_lib__box5(realsolid)],
// 
// 2 24 2 0 -30 2 0 30
  [2,24,2,0,-30,2,0,30],
// 2 24 -2 0 -30 -2 0 30
...
// 1 16 0 -4 40 -2 0 0 0 -1 -4 0 0 10 rect3.dat
  [1,16,0,-4,40,-2,0,0,0,-1,-4,0,0,10, ldraw_lib__rect3(realsolid)],
// 1 16 0 -44 70 -2 0 0 0 -1 -36 0 0 20 rect3.dat
  [1,16,0,-44,70,-2,0,0,0,-1,-36,0,0,20, ldraw_lib__rect3(realsolid)],
// 1 16 0 -80 70 -2 0 0 0 1 0 0 0 -20 rect3.dat
  [1,16,0,-80,70,-2,0,0,0,1,0,0,0,-20, ldraw_lib__rect3(realsolid)],
// 1 16 0 -40 10 0 0 2 40 1 0 -40 0 0 rect2p.dat
  [1,16,0,-40,10,0,0,2,40,1,0,-40,0,0, ldraw_lib__rect2p(realsolid)],
];
module ldraw_lib__s__6239s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6239s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
