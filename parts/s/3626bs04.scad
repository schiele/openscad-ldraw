...
use <../../p/t04o6250.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3626bs04(realsolid=false) = [
// 0 ~Minifig Head - Half Back Face
// 0 Name: s\3626bs04.dat
...
module ldraw_lib__s__3626bs04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3626bs04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__3626bs04(line=0.2);