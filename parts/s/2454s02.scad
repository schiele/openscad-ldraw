...
use <../../p/box3u4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2454s02(realsolid=false) = [
...
// 1 16 7 62 0 0 9 0 58 0 0 0 0 6 box3u4a.dat
  [1,16,7,62,0,0,9,0,58,0,0,0,0,6, ldraw_lib__box3u4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -7 62 0 0 -9 0 58 0 0 0 0 6 box3u4a.dat
  [1,16,-7,62,0,0,-9,0,58,0,0,0,0,6, ldraw_lib__box3u4a(realsolid)],
...
module ldraw_lib__s__2454s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2454s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
