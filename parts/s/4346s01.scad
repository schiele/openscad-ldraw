...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__4346s01(realsolid=false) = [
...
// 1 16 16 44 -26 0 1.5 0 0 0 3 3 0 0 bump5000.dat
  [1,16,16,44,-26,0,1.5,0,0,0,3,3,0,0, ldraw_lib__bump5000(realsolid)],
// 1 16 16 44 -26 0 1 0 1 0 0 0 0 -1 3-4ring3.dat
  [1,16,16,44,-26,0,1,0,1,0,0,0,0,-1, ldraw_lib__3_4ring3(realsolid)],
// 1 16 16 44 -26 0 1 0 0 0 -4 -4 0 0 2-4ndis.dat
  [1,16,16,44,-26,0,1,0,0,0,-4,-4,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 16 44 -26 0 1 0 0 0 3 3 0 0 1-4ndis.dat
  [1,16,16,44,-26,0,1,0,0,0,3,3,0,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 -16 44 -26 0 -1 0 3 0 0 0 0 3 1-4ndis.dat
  [1,16,-16,44,-26,0,-1,0,3,0,0,0,0,3, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -16 44 -26 0 -1 0 0 0 -4 4 0 0 2-4ndis.dat
  [1,16,-16,44,-26,0,-1,0,0,0,-4,4,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -16 44 -26 0 -1 0 0 0 -1 1 0 0 3-4ring3.dat
  [1,16,-16,44,-26,0,-1,0,0,0,-1,1,0,0, ldraw_lib__3_4ring3(realsolid)],
...
// 1 16 16 44 -24 0 1 0 0 0 4 4 0 0 1-8chrd.dat
  [1,16,16,44,-24,0,1,0,0,0,4,4,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 16 16 44 -24 0 1 0 2.82843 0 2.82843 2.82843 0 -2.82843 1-8chrd.dat
  [1,16,16,44,-24,0,1,0,2.82843,0,2.82843,2.82843,0,-2.82843, ldraw_lib__1_8chrd(realsolid)],
// 1 16 -16 44 -24 0 -1 0 4 0 0 0 0 4 1-8chrd.dat
  [1,16,-16,44,-24,0,-1,0,4,0,0,0,0,4, ldraw_lib__1_8chrd(realsolid)],
// 1 16 -16 44 -24 0 -1 0 2.82843 0 -2.82843 2.82843 0 2.82843 1-8chrd.dat
  [1,16,-16,44,-24,0,-1,0,2.82843,0,-2.82843,2.82843,0,2.82843, ldraw_lib__1_8chrd(realsolid)],
...
// 1 16 18 48 -25 0 0 2 0 -1 0 1 0 0 rect2p.dat
  [1,16,18,48,-25,0,0,2,0,-1,0,1,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -18 48 -25 0 0 -2 0 -1 0 -1 0 0 rect2p.dat
  [1,16,-18,48,-25,0,0,-2,0,-1,0,-1,0,0, ldraw_lib__rect2p(realsolid)],
// 2 24 -12 40 -26 12 40 -26
  [2,24,-12,40,-26,12,40,-26],
// 1 16 0 44 -22 0 0 12 -4 0 0 0 -4 0 box4o4a.dat
  [1,16,0,44,-22,0,0,12,-4,0,0,0,-4,0, ldraw_lib__box4o4a(realsolid)],
// 1 16 14 40 -28 -2 0 0 0 -1 0 0 0 2 rect.dat
  [1,16,14,40,-28,-2,0,0,0,-1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 -14 40 -28 2 0 0 0 -1 0 0 0 -2 rect.dat
  [1,16,-14,40,-28,2,0,0,0,-1,0,0,0,-2, ldraw_lib__rect(realsolid)],
...
// 1 16 0 12 -28 0 0 10 0 1 0 -2 0 0 rect.dat
  [1,16,0,12,-28,0,0,10,0,1,0,-2,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 0 4 -25 0 0 -10 0 -1 0 -5 0 0 rect.dat
  [1,16,0,4,-25,0,0,-10,0,-1,0,-5,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 -14.5 4 -23 -1.5 0 0 0 -1 0 0 0 3 rect.dat
  [1,16,-14.5,4,-23,-1.5,0,0,0,-1,0,0,0,3, ldraw_lib__rect(realsolid)],
// 1 16 -11.5 4.5 -18 -1.5 0 0 0 1 -0.5 0 0 -2 rect3.dat
  [1,16,-11.5,4.5,-18,-1.5,0,0,0,1,-0.5,0,0,-2, ldraw_lib__rect3(realsolid)],
// 1 16 11.5 4.5 -18 -1.5 0 0 0 1 -0.5 0 0 -2 rect3.dat
  [1,16,11.5,4.5,-18,-1.5,0,0,0,1,-0.5,0,0,-2, ldraw_lib__rect3(realsolid)],
// 1 16 14.5 4 -23 -1.5 0 0 0 -1 0 0 0 3 rect.dat
  [1,16,14.5,4,-23,-1.5,0,0,0,-1,0,0,0,3, ldraw_lib__rect(realsolid)],
// 1 16 -11.5 8.5 -21 1.5 0 0 0 3.5 0 0 0 5 box2-5.dat
  [1,16,-11.5,8.5,-21,1.5,0,0,0,3.5,0,0,0,5, ldraw_lib__box2_5(realsolid)],
// 1 16 11.5 8.5 -21 1.5 0 0 0 3.5 0 0 0 5 box2-5.dat
  [1,16,11.5,8.5,-21,1.5,0,0,0,3.5,0,0,0,5, ldraw_lib__box2_5(realsolid)],
// 1 16 0 44 -25 0 0 20 0 -44 0 5 0 0 box3u4a.dat
  [1,16,0,44,-25,0,0,20,0,-44,0,5,0,0, ldraw_lib__box3u4a(realsolid)],
...
// 1 16 0 44 -22 0 0 9.5 -1.5 0 0 0 -4 0 box5.dat
  [1,16,0,44,-22,0,0,9.5,-1.5,0,0,0,-4,0, ldraw_lib__box5(realsolid)],
...
// 1 16 20 44 -26 0 -1 0 0 0 4 -4 0 0 1-4chrd.dat
  [1,16,20,44,-26,0,-1,0,0,0,4,-4,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -20 44 -26 0 1 0 4 0 0 0 0 -4 1-4chrd.dat
  [1,16,-20,44,-26,0,1,0,4,0,0,0,0,-4, ldraw_lib__1_4chrd(realsolid)],
// 4 16 -20 48 -26 -20 44 -30 -20 44 -20 -20 48 -24
  [4,16,-20,48,-26,-20,44,-30,-20,44,-20,-20,48,-24],
// 1 16 -20 44 -24 0 1 0 0 0 4 4 0 0 1-4chrd.dat
  [1,16,-20,44,-24,0,1,0,0,0,4,4,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 20 44 -24 0 -1 0 4 0 0 0 0 4 1-4chrd.dat
  [1,16,20,44,-24,0,-1,0,4,0,0,0,0,4, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -20 44 -26 0 4 0 4 0 0 0 0 -4 1-4cylo.dat
  [1,16,-20,44,-26,0,4,0,4,0,0,0,0,-4, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -16 44 -24 0 -4 0 4 0 0 0 0 4 1-4cylo.dat
  [1,16,-16,44,-24,0,-4,0,4,0,0,0,0,4, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -12 44 -26 0 24 0 4 0 0 0 0 -4 1-4cylo.dat
  [1,16,-12,44,-26,0,24,0,4,0,0,0,0,-4, ldraw_lib__1_4cylo(realsolid)],
// 1 16 16 44 -26 0 4 0 4 0 0 0 0 -4 1-4cylo.dat
  [1,16,16,44,-26,0,4,0,4,0,0,0,0,-4, ldraw_lib__1_4cylo(realsolid)],
// 1 16 20 44 -24 0 -4 0 4 0 0 0 0 4 1-4cylo.dat
  [1,16,20,44,-24,0,-4,0,4,0,0,0,0,4, ldraw_lib__1_4cylo(realsolid)],
...
// 1 16 12 44 -26 0 -1 0 0 0 4 -4 0 0 1-4chrd.dat
  [1,16,12,44,-26,0,-1,0,0,0,4,-4,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -12 44 -26 0 1 0 4 0 0 0 0 -4 1-4chrd.dat
  [1,16,-12,44,-26,0,1,0,4,0,0,0,0,-4, ldraw_lib__1_4chrd(realsolid)],
];
module ldraw_lib__s__4346s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__4346s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
