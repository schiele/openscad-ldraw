...
// 1 16 2 0 0 0 2 0 6 0 0 0 0 6 4-4cyli.dat
  [1,16,2,0,0,0,2,0,6,0,0,0,0,6, ldraw_lib__4_4cyli()],
// 1 16 2 0 0 0 1 0 1 0 0 0 0 1 axlehol3.dat
  [1,16,2,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__axlehol3()],
// 1 16 2 0 0 0 1 0 -1 0 0 0 0 1 axleho10.dat
  [1,16,2,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__axleho10()],
// 1 16 2 0 0 0 1 0 -1 0 0 0 0 1 axlehol9.dat
  [1,16,2,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__axlehol9()],
// 1 16 2 0 0 0 -2 0 -1 0 0 0 0 1 axlehol8.dat
  [1,16,2,0,0,0,-2,0,-1,0,0,0,0,1, ldraw_lib__axlehol8()],
];
module ldraw_lib__s__faxle5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__faxle5(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
