...
use <../../p/recte4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2507s01(realsolid=false) = [
...
// 1 16 29 2 -8 -3 0 0 0 0 -2 0 8 0 box4-2p.dat
  [1,16,29,2,-8,-3,0,0,0,0,-2,0,8,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 34 2 -4 2 0 0 0 2 0 0 0 -4 box2-9.dat
  [1,16,34,2,-4,2,0,0,0,2,0,0,0,-4, ldraw_lib__box2_9(realsolid)],
// 2 24 36 0 -8 32 0 -8
  [2,24,36,0,-8,32,0,-8],
// 
// 0 BFC INVERTNEXT
...
// 1 16 38 4 0 2 0 0 0 1 0 0 0 4 rect2a.dat
  [1,16,38,4,0,2,0,0,0,1,0,0,0,4, ldraw_lib__rect2a(realsolid)],
// 1 16 38 0 -4 2 0 0 0 0 -4 0 -1 0 rect.dat
  [1,16,38,0,-4,2,0,0,0,0,-4,0,-1,0, ldraw_lib__rect(realsolid)],
// 2 24 36 4 0 36 4 4
  [2,24,36,4,0,36,4,4],
// 1 16 -38 4 0 -2 0 0 0 1 0 0 0 4 rect2a.dat
  [1,16,-38,4,0,-2,0,0,0,1,0,0,0,4, ldraw_lib__rect2a(realsolid)],
...
// 1 16 38 28 4 2 0 0 0 0 24 0 -1 0 rect3.dat
  [1,16,38,28,4,2,0,0,0,0,24,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 -38 28 4 2 0 0 0 0 24 0 -1 0 rect3.dat
  [1,16,-38,28,4,2,0,0,0,0,24,0,-1,0, ldraw_lib__rect3(realsolid)],
// 
...
// 1 16 37.5 49 -137 -2 0 -0.5 0 3 0 0.5 0 -1.5 box2-9.dat
  [1,16,37.5,49,-137,-2,0,-0.5,0,3,0,0.5,0,-1.5, ldraw_lib__box2_9(realsolid)],
// 1 16 34.5 46 -146 2.5 0 2 0 -1 0 7.5 0 -0.5 rect1.dat
  [1,16,34.5,46,-146,2.5,0,2,0,-1,0,7.5,0,-0.5, ldraw_lib__rect1(realsolid)],
// 1 16 31.15 46 -156 -0.85 0 -2 0 6 0 -2.5 0 0.5 box4-2p.dat
  [1,16,31.15,46,-156,-0.85,0,-2,0,6,0,-2.5,0,0.5, ldraw_lib__box4_2p(realsolid)],
// 1 16 27.8 46 -166 -2.5 0 2 0 -1 0 -7.5 0 -0.5 rect1.dat
  [1,16,27.8,46,-166,-2.5,0,2,0,-1,0,-7.5,0,-0.5, ldraw_lib__rect1(realsolid)],
// 1 16 22.15 49 -183 0 3.15 -2 3 0 0 0 9.5 0.5 box2-9.dat
  [1,16,22.15,49,-183,0,3.15,-2,3,0,0,0,9.5,0.5, ldraw_lib__box2_9(realsolid)],
// 
...
// 1 16 0 49 -192 17 0 0 0 0 3 0 -1 0 rect2p.dat
  [1,16,0,49,-192,17,0,0,0,0,3,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 
// 1 16 28 23 -105.5 -8 1 0 0 0 -23 -24 0 53.5 rect3.dat
  [1,16,28,23,-105.5,-8,1,0,0,0,-23,-24,0,53.5, ldraw_lib__rect3(realsolid)],
// 1 16 0 23 -129.5 20 0 0 0 -1 23 0 0 -53.5 rect2p.dat
  [1,16,0,23,-129.5,20,0,0,0,-1,23,0,0,-53.5, ldraw_lib__rect2p(realsolid)],
// 1 16 -28 23 -105.5 8 -1 0 0 0 -23 -24 0 53.5 rect3.dat
  [1,16,-28,23,-105.5,8,-1,0,0,0,-23,-24,0,53.5, ldraw_lib__rect3(realsolid)],
// 
...
// 1 16 26.5 49 -163.5 -9.5 1 0 0 0 -3 -28.5 0 0 recte3.dat
  [1,16,26.5,49,-163.5,-9.5,1,0,0,0,-3,-28.5,0,0, ldraw_lib__recte3(realsolid)],
// 1 16 -26.5 49 -163.5 9.5 1 0 0 0 -3 -28.5 0 0 recte3.dat
  [1,16,-26.5,49,-163.5,9.5,1,0,0,0,-3,-28.5,0,0, ldraw_lib__recte3(realsolid)],
// 
...
// 1 16 -23.65 49 -185 -3.65 -1 0 0 0 3 11 0 0 recte3.dat
  [1,16,-23.65,49,-185,-3.65,-1,0,0,0,3,11,0,0, ldraw_lib__recte3(realsolid)],
// 1 16 23.65 49 -185 3.65 -1 0 0 0 3 11 0 0 recte3.dat
  [1,16,23.65,49,-185,3.65,-1,0,0,0,3,11,0,0, ldraw_lib__recte3(realsolid)],
// 
// 1 16 -39.5 49 -137.5 0.5 -1 0 0 0 3 -1.5 0 0 recte3.dat
  [1,16,-39.5,49,-137.5,0.5,-1,0,0,0,3,-1.5,0,0, ldraw_lib__recte3(realsolid)],
// 1 16 39.5 49 -137.5 -0.5 -1 0 0 0 3 -1.5 0 0 recte3.dat
  [1,16,39.5,49,-137.5,-0.5,-1,0,0,0,3,-1.5,0,0, ldraw_lib__recte3(realsolid)],
// 
// 1 16 30 21 -106 0 1 10 -25 0 0 60 0 30 recte3.dat
  [1,16,30,21,-106,0,1,10,-25,0,0,60,0,30, ldraw_lib__recte3(realsolid)],
// 1 16 0 21 -136 20 0 0 0 1 -25 0 0 60 recte4.dat
  [1,16,0,21,-136,20,0,0,0,1,-25,0,0,60, ldraw_lib__recte4(realsolid)],
// 1 16 -30 21 -106 0 1 -10 -25 0 0 60 0 30 recte3.dat
  [1,16,-30,21,-106,0,1,-10,-25,0,0,60,0,30, ldraw_lib__recte3(realsolid)],
// 
...
module ldraw_lib__s__2507s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2507s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
