...
$fa=1; $fs=0.2;
function ldraw_lib__s__46212aph1s01(realsolid=false) = [
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\46212aph1s02.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__46212aph1s02(realsolid)],
// 1 320 0 0 0 1 0 0 0 1 0 0 0 1 s\46212aph1s03.dat
  [1,320,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__46212aph1s03(realsolid)],
];
module ldraw_lib__s__46212aph1s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__46212aph1s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
