...
use <../../p/recte3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__u9371s01(realsolid=false) = [
...
// 1 16 0 0 0 2.5 0 0 0 1 0 0 0 2.5 2-4chrd.dat
  [1,16,0,0,0,2.5,0,0,0,1,0,0,0,2.5, ldraw_lib__2_4chrd(realsolid)],
// 1 16 0 0 0 2.5 0 0 0 4 0 0 0 2.5 2-4cylo.dat
  [1,16,0,0,0,2.5,0,0,0,4,0,0,0,2.5, ldraw_lib__2_4cylo(realsolid)],
// 1 16 0 4 0 2.5 0 0 0 -1 0 0 0 2.5 2-4chrd.dat
  [1,16,0,4,0,2.5,0,0,0,-1,0,0,0,2.5, ldraw_lib__2_4chrd(realsolid)],
// 1 16 0 2 0 0 0 2.5 2 0 0 0 -3 0 box4o8a.dat
  [1,16,0,2,0,0,0,2.5,2,0,0,0,-3,0, ldraw_lib__box4o8a(realsolid)],
// 1 16 0 2 -3 -2.5 0 0 0 0 2 0 -1 0 recte3.dat
  [1,16,0,2,-3,-2.5,0,0,0,0,2,0,-1,0, ldraw_lib__recte3(realsolid)],
// 
// 2 24 -6 0 -3 -2.5 0 -3
  [2,24,-6,0,-3,-2.5,0,-3],
// 2 24 2.5 0 -3 96 0 -3
...
// 1 16 0 0 -3 -6 0 0 0 1 0 0 0 -4 1-4edge.dat
  [1,16,0,0,-3,-6,0,0,0,1,0,0,0,-4, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 0 -3 -6 0 0 0 1 0 0 0 -4 1-4chrd.dat
  [1,16,0,0,-3,-6,0,0,0,1,0,0,0,-4, ldraw_lib__1_4chrd(realsolid)],
// 4 16 0 0 -7 96 0 -7 96 0 -3 -6 0 -3
  [4,16,0,0,-7,96,0,-7,96,0,-3,-6,0,-3],
// 0 // Front - hinge
// 1 16 0 0 -3 -6 0 0 0 92 0 0 0 -4 1-4cyli.dat
  [1,16,0,0,-3,-6,0,0,0,92,0,0,0,-4, ldraw_lib__1_4cyli(realsolid)],
// 2 24 -6 0 -3 -6 92 -3
  [2,24,-6,0,-3,-6,92,-3],
// 2 24 96 0 -3 96 92 -3
  [2,24,96,0,-3,96,92,-3],
...
// 1 16 24 15 -7 2 0 0 0 0 -2 0 1 0 1-4edge.dat
  [1,16,24,15,-7,2,0,0,0,0,-2,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 2 24 24 13 -7 23 13.484 -7
  [2,24,24,13,-7,23,13.484,-7],
// 1 16 36 36 -7 -13 0 -22.517 22.517 0 -13 0 1 0 48\1-3edge.dat
  [1,16,36,36,-7,-13,0,-22.517,22.517,0,-13,0,1,0, ldraw_lib__48__1_3edge(realsolid)],
// 2 24 23 58.517 -7 24 59 -7
  [2,24,23,58.517,-7,24,59,-7],
// 1 16 24 57 -7 2 0 0 0 0 2 0 1 0 1-4edge.dat
  [1,16,24,57,-7,2,0,0,0,0,2,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 2 24 26 57 -7 26 15 -7
  [2,24,26,57,-7,26,15,-7],
// 0 // Front - middle pane
// 1 16 58 14 -7 2 0 0 0 0 -2 0 1 0 1-4edge.dat
  [1,16,58,14,-7,2,0,0,0,0,-2,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 34 14 -7 -2 0 0 0 0 -2 0 1 0 1-4edge.dat
  [1,16,34,14,-7,-2,0,0,0,0,-2,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 58 58 -7 2 0 0 0 0 2 0 1 0 1-4edge.dat
  [1,16,58,58,-7,2,0,0,0,0,2,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 34 58 -7 -2 0 0 0 0 2 0 1 0 1-4edge.dat
  [1,16,34,58,-7,-2,0,0,0,0,2,0,1,0, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 68 15 -7 -2 0 0 0 0 -2 0 1 0 1-4edge.dat
  [1,16,68,15,-7,-2,0,0,0,0,-2,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 2 24 68 13 -7 69 13.484 -7
  [2,24,68,13,-7,69,13.484,-7],
// 1 16 56 36 -7 13 0 22.517 22.517 0 -13 0 1 0 48\1-3edge.dat
  [1,16,56,36,-7,13,0,22.517,22.517,0,-13,0,1,0, ldraw_lib__48__1_3edge(realsolid)],
// 2 24 69 58.517 -7 68 59 -7
  [2,24,69,58.517,-7,68,59,-7],
// 1 16 68 57 -7 -2 0 0 0 0 2 0 1 0 1-4edge.dat
  [1,16,68,57,-7,-2,0,0,0,0,2,0,1,0, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 24 57 -3 2 0 0 0 0 2 0 -1 0 1-4ndis.dat
  [1,16,24,57,-3,2,0,0,0,0,2,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 36 36 -3 -13 0 -22.517 -22.517 0 13 0 -1 0 48\1-6ndis.dat
  [1,16,36,36,-3,-13,0,-22.517,-22.517,0,13,0,-1,0, ldraw_lib__48__1_6ndis(realsolid)],
...
// 1 16 24 15 -3 2 0 0 0 0 -2 0 -1 0 1-4ndis.dat
  [1,16,24,15,-3,2,0,0,0,0,-2,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 68 57 -3 -2 0 0 0 0 2 0 -1 0 1-4ndis.dat
  [1,16,68,57,-3,-2,0,0,0,0,2,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 56 36 -3 13 0 22.517 -22.517 0 13 0 -1 0 48\1-6ndis.dat
  [1,16,56,36,-3,13,0,22.517,-22.517,0,13,0,-1,0, ldraw_lib__48__1_6ndis(realsolid)],
...
// 1 16 68 15 -3 -2 0 0 0 0 -2 0 -1 0 1-4ndis.dat
  [1,16,68,15,-3,-2,0,0,0,0,-2,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 24 15 -3 2 0 0 0 0 -2 0 1 0 1-4edge.dat
  [1,16,24,15,-3,2,0,0,0,0,-2,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 2 24 24 13 -3 23 13.484 -3
  [2,24,24,13,-3,23,13.484,-3],
// 1 16 36 36 -3 -13 0 -22.517 22.517 0 -13 0 1 0 48\1-3edge.dat
  [1,16,36,36,-3,-13,0,-22.517,22.517,0,-13,0,1,0, ldraw_lib__48__1_3edge(realsolid)],
// 2 24 23 58.517 -3 24 59 -3
  [2,24,23,58.517,-3,24,59,-3],
// 1 16 24 57 -3 2 0 0 0 0 2 0 1 0 1-4edge.dat
  [1,16,24,57,-3,2,0,0,0,0,2,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 2 24 26 57 -3 26 15 -3
  [2,24,26,57,-3,26,15,-3],
// 0 // Back - middle pane
// 1 16 58 14 -3 2 0 0 0 0 -2 0 1 0 1-4edge.dat
  [1,16,58,14,-3,2,0,0,0,0,-2,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 34 14 -3 -2 0 0 0 0 -2 0 1 0 1-4edge.dat
  [1,16,34,14,-3,-2,0,0,0,0,-2,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 58 58 -3 2 0 0 0 0 2 0 1 0 1-4edge.dat
  [1,16,58,58,-3,2,0,0,0,0,2,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 34 58 -3 -2 0 0 0 0 2 0 1 0 1-4edge.dat
  [1,16,34,58,-3,-2,0,0,0,0,2,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 58 14 -3 2 0 0 0 0 -2 0 -1 0 1-4ndis.dat
  [1,16,58,14,-3,2,0,0,0,0,-2,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 34 14 -3 -2 0 0 0 0 -2 0 -1 0 1-4ndis.dat
  [1,16,34,14,-3,-2,0,0,0,0,-2,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 58 58 -3 2 0 0 0 0 2 0 -1 0 1-4ndis.dat
  [1,16,58,58,-3,2,0,0,0,0,2,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 34 58 -3 -2 0 0 0 0 2 0 -1 0 1-4ndis.dat
  [1,16,34,58,-3,-2,0,0,0,0,2,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 68 15 -3 -2 0 0 0 0 -2 0 1 0 1-4edge.dat
  [1,16,68,15,-3,-2,0,0,0,0,-2,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 2 24 68 13 -3 69 13.484 -3
  [2,24,68,13,-3,69,13.484,-3],
// 1 16 56 36 -3 13 0 22.517 22.517 0 -13 0 1 0 48\1-3edge.dat
  [1,16,56,36,-3,13,0,22.517,22.517,0,-13,0,1,0, ldraw_lib__48__1_3edge(realsolid)],
// 2 24 69 58.517 -3 68 59 -3
  [2,24,69,58.517,-3,68,59,-3],
// 1 16 68 57 -3 -2 0 0 0 0 2 0 1 0 1-4edge.dat
  [1,16,68,57,-3,-2,0,0,0,0,2,0,1,0, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 24 15 -3 2 0 0 0 0 -2 0 -4 0 1-4cyli.dat
  [1,16,24,15,-3,2,0,0,0,0,-2,0,-4,0, ldraw_lib__1_4cyli(realsolid)],
// 4 16 24 13 -7 23 13.484 -7 23 13.484 -3 24 13 -3
  [4,16,24,13,-7,23,13.484,-7,23,13.484,-3,24,13,-3],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 36 36 -3 -13 0 -22.517 22.517 0 -13 0 -4 0 48\1-3cyli.dat
  [1,16,36,36,-3,-13,0,-22.517,22.517,0,-13,0,-4,0, ldraw_lib__48__1_3cyli(realsolid)],
// 4 16 23 58.517 -7 24 59 -7 24 59 -3 23 58.517 -3
  [4,16,23,58.517,-7,24,59,-7,24,59,-3,23,58.517,-3],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 24 57 -3 2 0 0 0 0 2 0 -4 0 1-4cyli.dat
  [1,16,24,57,-3,2,0,0,0,0,2,0,-4,0, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 58 14 -3 2 0 0 0 0 -2 0 -4 0 1-4cyli.dat
  [1,16,58,14,-3,2,0,0,0,0,-2,0,-4,0, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 34 14 -3 -2 0 0 0 0 -2 0 -4 0 1-4cyli.dat
  [1,16,34,14,-3,-2,0,0,0,0,-2,0,-4,0, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 58 58 -3 2 0 0 0 0 2 0 -4 0 1-4cyli.dat
  [1,16,58,58,-3,2,0,0,0,0,2,0,-4,0, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 34 58 -3 -2 0 0 0 0 2 0 -4 0 1-4cyli.dat
  [1,16,34,58,-3,-2,0,0,0,0,2,0,-4,0, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 68 15 -3 -2 0 0 0 0 -2 0 -4 0 1-4cyli.dat
  [1,16,68,15,-3,-2,0,0,0,0,-2,0,-4,0, ldraw_lib__1_4cyli(realsolid)],
// 4 16 68 13 -3 69 13.484 -3 69 13.484 -7 68 13 -7
  [4,16,68,13,-3,69,13.484,-3,69,13.484,-7,68,13,-7],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 56 36 -3 13 0 22.517 22.517 0 -13 0 -4 0 48\1-3cyli.dat
  [1,16,56,36,-3,13,0,22.517,22.517,0,-13,0,-4,0, ldraw_lib__48__1_3cyli(realsolid)],
// 4 16 69 58.517 -3 68 59 -3 68 59 -7 69 58.517 -7
  [4,16,69,58.517,-3,68,59,-3,68,59,-7,69,58.517,-7],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 68 57 -3 -2 0 0 0 0 2 0 -4 0 1-4cyli.dat
  [1,16,68,57,-3,-2,0,0,0,0,2,0,-4,0, ldraw_lib__1_4cyli(realsolid)],
// 4 16 66 57 -3 66 15 -3 66 15 -7 66 57 -7
  [4,16,66,57,-3,66,15,-3,66,15,-7,66,57,-7],
// 0 // Lower edge
// 1 16 0 92 0 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,0,92,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 92 0 2 0 0 0 1 0 0 0 2 4-8sphe.dat
  [1,16,0,92,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_8sphe(realsolid)],
// 1 16 0 92 0 2.5 0 0 0 -1 0 0 0 2.5 2-4chrd.dat
  [1,16,0,92,0,2.5,0,0,0,-1,0,0,0,2.5, ldraw_lib__2_4chrd(realsolid)],
// 1 16 0 92 0 2.5 0 0 0 -4 0 0 0 2.5 2-4cylo.dat
  [1,16,0,92,0,2.5,0,0,0,-4,0,0,0,2.5, ldraw_lib__2_4cylo(realsolid)],
// 1 16 0 88 0 2.5 0 0 0 1 0 0 0 2.5 2-4chrd.dat
  [1,16,0,88,0,2.5,0,0,0,1,0,0,0,2.5, ldraw_lib__2_4chrd(realsolid)],
// 1 16 0 90 0 0 0 2.5 2 0 0 0 -3 0 box4o8a.dat
  [1,16,0,90,0,0,0,2.5,2,0,0,0,-3,0, ldraw_lib__box4o8a(realsolid)],
// 1 16 0 90 -3 -2.5 0 0 0 0 -2 0 -1 0 recte3.dat
  [1,16,0,90,-3,-2.5,0,0,0,0,-2,0,-1,0, ldraw_lib__recte3(realsolid)],
// 
...
// 1 16 0 92 -3 -6 0 0 0 -1 0 0 0 -4 1-4edge.dat
  [1,16,0,92,-3,-6,0,0,0,-1,0,0,0,-4, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 92 -3 -6 0 0 0 -1 0 0 0 -4 1-4chrd.dat
  [1,16,0,92,-3,-6,0,0,0,-1,0,0,0,-4, ldraw_lib__1_4chrd(realsolid)],
// 4 16 -6 92 -3 96 92 -3 96 92 -7 0 92 -7
  [4,16,-6,92,-3,96,92,-3,96,92,-7,0,92,-7],
// 
// 0 // Handle
// 1 16 96 46 -11 6 0 0 0 0 6 0 1 0 4-4disc.dat
  [1,16,96,46,-11,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 96 46 -11 6 0 0 0 0 6 0 1 0 4-4edge.dat
  [1,16,96,46,-11,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 96 46 -9 4.243 0 -4.243 4.243 0 4.243 0 2 0 3-4cyli.dat
  [1,16,96,46,-9,4.243,0,-4.243,4.243,0,4.243,0,2,0, ldraw_lib__3_4cyli(realsolid)],
// 1 16 96 46 -7 4.243 0 -4.243 4.243 0 4.243 0 1 0 3-4edge.dat
  [1,16,96,46,-7,4.243,0,-4.243,4.243,0,4.243,0,1,0, ldraw_lib__3_4edge(realsolid)],
// 1 16 96 46 -11 6 0 0 0 0 6 0 2 0 4-4cyli.dat
  [1,16,96,46,-11,6,0,0,0,0,6,0,2,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 96 46 -9 4.243 0 4.243 4.243 0 -4.243 0 1 0 1-4edge.dat
  [1,16,96,46,-9,4.243,0,4.243,4.243,0,-4.243,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 96 46 -9 4.243 0 4.243 4.243 0 -4.243 0 -1 0 1-4chrd.dat
  [1,16,96,46,-9,4.243,0,4.243,4.243,0,-4.243,0,-1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 96 46 -7 0 0 6 6 0 0 0 -1 0 1-8chrd.dat
  [1,16,96,46,-7,0,0,6,6,0,0,0,-1,0, ldraw_lib__1_8chrd(realsolid)],
// 1 16 96 46 -7 0 0 6 -6 0 0 0 -1 0 1-8chrd.dat
  [1,16,96,46,-7,0,0,6,-6,0,0,0,-1,0, ldraw_lib__1_8chrd(realsolid)],
// 4 16 96 40 -7 100.2426 41.7574 -7 100.2426 50.2426 -7 96 52 -7
  [4,16,96,40,-7,100.2426,41.7574,-7,100.2426,50.2426,-7,96,52,-7],
// 1 16 100.243 46 -8 0 -1 0 4.243 0 0 0 0 1 rect.dat
  [1,16,100.243,46,-8,0,-1,0,4.243,0,0,0,0,1, ldraw_lib__rect(realsolid)],
// 
...
module ldraw_lib__s__u9371s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u9371s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
