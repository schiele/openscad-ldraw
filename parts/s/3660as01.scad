...
use <../../p/stud2s.scad>
use <../../p/stud3.scad>
function ldraw_lib__s__3660as01() = [
...
// 1 16 10 4 -20 1 0 0 0 2 0 0 0 1 stud2a.dat
  [1,16,10,4,-20,1,0,0,0,2,0,0,0,1, ldraw_lib__stud2a()],
// 1 16 10 4 -20 0 0 1 0 6 0 -1 0 0 stud2s.dat
  [1,16,10,4,-20,0,0,1,0,6,0,-1,0,0, ldraw_lib__stud2s()],
// 1 16 -10 0 0 0 0 1 0 1 0 -1 0 0 stud.dat
  [1,16,-10,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud()],
// 1 16 -10 4 -20 1 0 0 0 2 0 0 0 1 stud2a.dat
  [1,16,-10,4,-20,1,0,0,0,2,0,0,0,1, ldraw_lib__stud2a()],
...
module ldraw_lib__s__3660as01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3660as01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
