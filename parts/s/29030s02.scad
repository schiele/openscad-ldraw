...
use <../../p/stud2a.scad>
use <../../p/stud4od.scad>
function ldraw_lib__s__29030s02() = [
...
// 1 16 0 3 0 1 0 0 0 -7.25 0 0 0 1 stud4od.dat
  [1,16,0,3,0,1,0,0,0,-7.25,0,0,0,1, ldraw_lib__stud4od()],
...
module ldraw_lib__s__29030s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__29030s02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
