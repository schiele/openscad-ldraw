...
use <../../p/stug4.scad>
use <../../p/stug7.scad>
function ldraw_lib__s__30030s1() = [
...
// 1 16 -300 0 -180 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-300,0,-180,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 -300 0 -140 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-300,0,-140,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 -300 0 -100 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-300,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 -300 0 -60 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-300,0,-60,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 -300 0 -20 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-300,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 -300 0 20 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-300,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 -300 0 60 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-300,0,60,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
...
module ldraw_lib__s__30030s1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__30030s1(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
