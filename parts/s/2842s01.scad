use <../../lib.scad>
use <../../p/box4-4a.scad>
function ldraw_lib__s__2842s01() = [
...
// 1 16 0 0 0 2 0 0 0 28 0 0 0 6 box4-4a.dat
  [1,16,0,0,0,2,0,0,0,28,0,0,0,6, ldraw_lib__box4_4a()],
// 1 16 0 4 -7.5 -2 0 0 0 24 0 0 0 -1.5 box4-4a.dat
  [1,16,0,4,-7.5,-2,0,0,0,24,0,0,0,-1.5, ldraw_lib__box4_4a()],
...
module ldraw_lib__s__2842s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2842s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
