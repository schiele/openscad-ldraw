...
use <../../p/4-4ndis.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__87079pz0s01(realsolid=false) = [
...
// 1 0 -33.5 0 -13 -0.5 0 0 0 1 0 0 0 -0.5 1-4ring2.dat
  [1,0,-33.5,0,-13,-0.5,0,0,0,1,0,0,0,-0.5, ldraw_lib__1_4ring2(realsolid)],
// 1 0 -33.5 0 -13 -0.5 0 0 0 1 0 0 0 -0.5 1-4ring1.dat
  [1,0,-33.5,0,-13,-0.5,0,0,0,1,0,0,0,-0.5, ldraw_lib__1_4ring1(realsolid)],
// 1 0 -33.5 0 13 0 0 -0.5 0 1 0 0.5 0 0 1-4ring1.dat
  [1,0,-33.5,0,13,0,0,-0.5,0,1,0,0.5,0,0, ldraw_lib__1_4ring1(realsolid)],
// 1 0 -33.5 0 13 0 0 -0.5 0 1 0 0.5 0 0 1-4ring2.dat
  [1,0,-33.5,0,13,0,0,-0.5,0,1,0,0.5,0,0, ldraw_lib__1_4ring2(realsolid)],
// 1 0 -30.3 0 -2.975 -3 0 0 0 1 0 0 0 3 4-4ering.dat
  [1,0,-30.3,0,-2.975,-3,0,0,0,1,0,0,0,3, ldraw_lib__4_4ering(realsolid)],
// 1 0 -8.2 0 -2.975 -3 0 0 0 1 0 0 0 3 4-4ering.dat
  [1,0,-8.2,0,-2.975,-3,0,0,0,1,0,0,0,3, ldraw_lib__4_4ering(realsolid)],
// 1 0 -5 0 -13 0 0 0.5 0 1 0 -0.5 0 0 1-4ring2.dat
  [1,0,-5,0,-13,0,0,0.5,0,1,0,-0.5,0,0, ldraw_lib__1_4ring2(realsolid)],
// 1 0 -5 0 -13 0 0 0.5 0 1 0 -0.5 0 0 1-4ring1.dat
  [1,0,-5,0,-13,0,0,0.5,0,1,0,-0.5,0,0, ldraw_lib__1_4ring1(realsolid)],
// 1 0 -5 0 13 0.5 0 0 0 1 0 0 0 0.5 1-4ring1.dat
  [1,0,-5,0,13,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__1_4ring1(realsolid)],
// 1 0 -5 0 13 0.5 0 0 0 1 0 0 0 0.5 1-4ring2.dat
  [1,0,-5,0,13,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__1_4ring2(realsolid)],
// 1 0 0 0 -13 0 0 -0.5 0 1 0 -0.5 0 0 3-8ring2.dat
  [1,0,0,0,-13,0,0,-0.5,0,1,0,-0.5,0,0, ldraw_lib__3_8ring2(realsolid)],
// 1 0 0 0 -13 0 0 -0.5 0 1 0 -0.5 0 0 3-8ring1.dat
  [1,0,0,0,-13,0,0,-0.5,0,1,0,-0.5,0,0, ldraw_lib__3_8ring1(realsolid)],
// 1 0 3 0 -7.17 0.5 0 0 0 1 0 0 0 -0.5 1-8ring2.dat
  [1,0,3,0,-7.17,0.5,0,0,0,1,0,0,0,-0.5, ldraw_lib__1_8ring2(realsolid)],
// 1 0 3 0 -7.17 0.5 0 0 0 1 0 0 0 -0.5 1-8ring1.dat
  [1,0,3,0,-7.17,0.5,0,0,0,1,0,0,0,-0.5, ldraw_lib__1_8ring1(realsolid)],
// 1 0 5 0 13 -0.5 0 0 0 1 0 0 0 0.5 1-4ring1.dat
  [1,0,5,0,13,-0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__1_4ring1(realsolid)],
// 1 0 5 0 13 -0.5 0 0 0 1 0 0 0 0.5 1-4ring2.dat
  [1,0,5,0,13,-0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__1_4ring2(realsolid)],
...
// 1 15 -30.3 0 -2.975 -3 0 0 0 1 0 0 0 3 4-4ndis.dat
  [1,15,-30.3,0,-2.975,-3,0,0,0,1,0,0,0,3, ldraw_lib__4_4ndis(realsolid)],
// 1 15 -8.2 0 -2.975 -3 0 0 0 1 0 0 0 3 4-4ndis.dat
  [1,15,-8.2,0,-2.975,-3,0,0,0,1,0,0,0,3, ldraw_lib__4_4ndis(realsolid)],
...
// 1 15 -5 0 13 0.5 0 0 0 1 0 0 0 0.5 1-4chrd.dat
  [1,15,-5,0,13,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -33.5 0 -13 -1.5 0 0 0 1 0 0 0 -1.5 1-4ndis.dat
  [1,16,-33.5,0,-13,-1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -33.5 0 13 0 0 -1.5 0 1 0 1.5 0 0 1-4ndis.dat
  [1,16,-33.5,0,13,0,0,-1.5,0,1,0,1.5,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -5 0 -13 0 0 1.5 0 1 0 -1.5 0 0 1-4ndis.dat
  [1,16,-5,0,-13,0,0,1.5,0,1,0,-1.5,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -5 0 13 1.5 0 0 0 1 0 0 0 1.5 1-4ndis.dat
  [1,16,-5,0,13,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__1_4ndis(realsolid)],
// 1 16 0 0 -13 0 0 -1.5 0 1 0 -1.5 0 0 3-8ndis.dat
  [1,16,0,0,-13,0,0,-1.5,0,1,0,-1.5,0,0, ldraw_lib__3_8ndis(realsolid)],
// 1 16 3 0 -7.17 0.5 0 0 0 1 0 0 0 -0.5 1-8chrd.dat
  [1,16,3,0,-7.17,0.5,0,0,0,1,0,0,0,-0.5, ldraw_lib__1_8chrd(realsolid)],
// 1 16 5 0 13 0 0 -1.5 0 1 0 1.5 0 0 1-4ndis.dat
  [1,16,5,0,13,0,0,-1.5,0,1,0,1.5,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 33.5 0 -13 0 0 1.5 0 1 0 -1.5 0 0 1-4ndis.dat
  [1,16,33.5,0,-13,0,0,1.5,0,1,0,-1.5,0,0, ldraw_lib__1_4ndis(realsolid)],
...
module ldraw_lib__s__87079pz0s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__87079pz0s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
