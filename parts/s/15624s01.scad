...
use <../../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__15624s01(realsolid=false) = [
...
// 1 16 42.5 0 -7.5 0 0 1.5 0 1 0 -2.5 0 0 rect2a.dat
  [1,16,42.5,0,-7.5,0,0,1.5,0,1,0,-2.5,0,0, ldraw_lib__rect2a(realsolid)],
// 1 16 42.5 0 3.5 1.5 0 0 0 1 0 0 0 6.5 rect3.dat
  [1,16,42.5,0,3.5,1.5,0,0,0,1,0,0,0,6.5, ldraw_lib__rect3(realsolid)],
// 1 16 42.5 4 10 1.5 0 0 0 0 4 0 -1 0 rect3.dat
  [1,16,42.5,4,10,1.5,0,0,0,0,4,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 -42.5 0 -7.5 0 0 -1.5 0 1 0 -2.5 0 0 rect2a.dat
  [1,16,-42.5,0,-7.5,0,0,-1.5,0,1,0,-2.5,0,0, ldraw_lib__rect2a(realsolid)],
// 1 16 -42.5 0 3.5 -1.5 0 0 0 1 0 0 0 6.5 rect3.dat
  [1,16,-42.5,0,3.5,-1.5,0,0,0,1,0,0,0,6.5, ldraw_lib__rect3(realsolid)],
...
// 1 16 20 0 6 -7.391 0 3.062 0 8 0 3.062 0 7.391 3-8cyli.dat
  [1,16,20,0,6,-7.391,0,3.062,0,8,0,3.062,0,7.391, ldraw_lib__3_8cyli(realsolid)],
// 1 16 20 8 6 -7.391 0 3.062 0 1 0 3.062 0 7.391 3-8edge.dat
  [1,16,20,8,6,-7.391,0,3.062,0,1,0,3.062,0,7.391, ldraw_lib__3_8edge(realsolid)],
// 1 16 20 0 6 7.391 0 3.062 0 1 0 3.062 0 -7.391 5-8edge.dat
  [1,16,20,0,6,7.391,0,3.062,0,1,0,3.062,0,-7.391, ldraw_lib__5_8edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 0 6 -5.543 0 2.296 0 8 0 2.296 0 5.543 3-8cyli.dat
  [1,16,20,0,6,-5.543,0,2.296,0,8,0,2.296,0,5.543, ldraw_lib__3_8cyli(realsolid)],
// 1 16 20 8 6 -5.543 0 2.296 0 1 0 2.296 0 5.543 3-8edge.dat
  [1,16,20,8,6,-5.543,0,2.296,0,1,0,2.296,0,5.543, ldraw_lib__3_8edge(realsolid)],
// 1 16 20 0 6 5.543 0 2.296 0 1 0 2.296 0 -5.543 5-8edge.dat
  [1,16,20,0,6,5.543,0,2.296,0,1,0,2.296,0,-5.543, ldraw_lib__5_8edge(realsolid)],
// 1 16 20 0 6 1 0 0 0 1 0 0 0 1 stud4a.dat
  [1,16,20,0,6,1,0,0,0,1,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 
...
// 1 16 0 0 -7.5 0 0 -1 0 -4 0 -2.5 0 0 box3u6.dat
  [1,16,0,0,-7.5,0,0,-1,0,-4,0,-2.5,0,0, ldraw_lib__box3u6(realsolid)],
// 1 16 1 -2 -4 0 3 0 0 0 -2 -1 0 0 box4-2p.dat
  [1,16,1,-2,-4,0,3,0,0,0,-2,-1,0,0, ldraw_lib__box4_2p(realsolid)],
...
// 1 16 1 2 16 0 3 0 0 0 -6 -1 0 0 box4-2p.dat
  [1,16,1,2,16,0,3,0,0,0,-6,-1,0,0, ldraw_lib__box4_2p(realsolid)],
// 4 16 -1 -4 15 1 -4 15 1 -4 17 -1 -4 17
  [4,16,-1,-4,15,1,-4,15,1,-4,17,-1,-4,17],
// 1 16 -1 2 16 0 -3 0 0 0 -6 1 0 0 box4-2p.dat
  [1,16,-1,2,16,0,-3,0,0,0,-6,1,0,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 0 8 17.5 0 0 -1 0 -12 0 -0.5 0 0 box3u8p.dat
  [1,16,0,8,17.5,0,0,-1,0,-12,0,-0.5,0,0, ldraw_lib__box3u8p(realsolid)],
// 
// 1 16 -40 0 -7.5 0 0 -1 0 -4 0 -2.5 0 0 box3u6.dat
  [1,16,-40,0,-7.5,0,0,-1,0,-4,0,-2.5,0,0, ldraw_lib__box3u6(realsolid)],
// 1 16 -39 -2 -4 0 3 0 0 0 -2 -1 0 0 box4-2p.dat
  [1,16,-39,-2,-4,0,3,0,0,0,-2,-1,0,0, ldraw_lib__box4_2p(realsolid)],
// 4 16 -41 -4 -5 -39 -4 -5 -39 -4 -3 -41 -4 -3
  [4,16,-41,-4,-5,-39,-4,-5,-39,-4,-3,-41,-4,-3],
// 1 16 -41 -2 -4 0 -3 0 0 0 -2 1 0 0 box4-3p.dat
  [1,16,-41,-2,-4,0,-3,0,0,0,-2,1,0,0, ldraw_lib__box4_3p(realsolid)],
// 
// 2 24 -39 -4 15 -39 -4 -3
  [2,24,-39,-4,15,-39,-4,-3],
// 2 24 -41 -4 -3 -41 -4 15
...
// 1 16 -39 2 16 0 3 0 0 0 -6 -1 0 0 box4-2p.dat
  [1,16,-39,2,16,0,3,0,0,0,-6,-1,0,0, ldraw_lib__box4_2p(realsolid)],
// 4 16 -41 -4 15 -39 -4 15 -39 -4 17 -41 -4 17
  [4,16,-41,-4,15,-39,-4,15,-39,-4,17,-41,-4,17],
// 1 16 -41 2 16 0 -3 0 0 0 -6 1 0 0 box4-2p.dat
  [1,16,-41,2,16,0,-3,0,0,0,-6,1,0,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 -40 8 17.5 0 0 -1 0 -12 0 -0.5 0 0 box3u8p.dat
  [1,16,-40,8,17.5,0,0,-1,0,-12,0,-0.5,0,0, ldraw_lib__box3u8p(realsolid)],
// 
// 1 16 40 0 -7.5 0 0 -1 0 -4 0 -2.5 0 0 box3u6.dat
  [1,16,40,0,-7.5,0,0,-1,0,-4,0,-2.5,0,0, ldraw_lib__box3u6(realsolid)],
// 1 16 41 -2 -4 0 3 0 0 0 -2 -1 0 0 box4-3p.dat
...
// 1 16 0 12 -4 -40 0 0 0 -8 0 0 0 10 box4-1.dat
  [1,16,0,12,-4,-40,0,0,0,-8,0,0,0,10, ldraw_lib__box4_1(realsolid)],
// 2 24 1 -4 -10 39 -4 -10
  [2,24,1,-4,-10,39,-4,-10],
...
// 1 16 0 4 0 -39 0 0 0 -4 0 0 0 10 box2-9p.dat
  [1,16,0,4,0,-39,0,0,0,-4,0,0,0,10, ldraw_lib__box2_9p(realsolid)],
];
module ldraw_lib__s__15624s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__15624s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
