...
use <../../p/clip4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__30258s01(realsolid=false) = [
...
// 1 16 0 0 -9 20 0 0 0 0 20 0 3 0 box5.dat
  [1,16,0,0,-9,20,0,0,0,0,20,0,3,0, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__s__30258s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__30258s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
