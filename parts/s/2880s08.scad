...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__2880s08(realsolid=false) = [
...
// 1 16 -1.5 10 0 1.5 0 0 3 -1 0 0 0 7 rect.dat
  [1,16,-1.5,10,0,1.5,0,0,3,-1,0,0,0,7, ldraw_lib__rect(realsolid)],
// 3 16 0 7 -7 0 13 -7 -3 7 -7
  [3,16,0,7,-7,0,13,-7,-3,7,-7],
// 3 16 0 7 7 -3 7 7 0 13 7
  [3,16,0,7,7,-3,7,7,0,13,7],
// 1 16 0 3.5 0 0 1 0 0 0 3.5 -2 0 0 rect3.dat
  [1,16,0,3.5,0,0,1,0,0,0,3.5,-2,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 10 11 0 0 0 -10 0 -1 0 2 0 0 rect3.dat
  [1,16,10,11,0,0,0,-10,0,-1,0,2,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 20 5.5 0 0 -1 0 0 0 -5.5 -2 0 0 rect.dat
  [1,16,20,5.5,0,0,-1,0,0,0,-5.5,-2,0,0, ldraw_lib__rect(realsolid)],
];
module ldraw_lib__s__2880s08(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__2880s08(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
