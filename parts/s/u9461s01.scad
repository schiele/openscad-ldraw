...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__u9461s01(realsolid=false) = [
...
// 1 16 12 -20 0 0 1 0 0 0 6 -6 0 0 1-4ndis.dat
  [1,16,12,-20,0,0,1,0,0,0,6,-6,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 12 -20 0 0 1 0 0 0 -6 6 0 0 1-4ndis.dat
  [1,16,12,-20,0,0,1,0,0,0,-6,6,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 12 -20 0 0 1 0 0 0 1 1 0 0 1-4ring6.dat
  [1,16,12,-20,0,0,1,0,0,0,1,1,0,0, ldraw_lib__1_4ring6(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 12 -20 0 0 -2 0 0 0 7 7 0 0 1-4cylo.dat
  [1,16,12,-20,0,0,-2,0,0,0,7,7,0,0, ldraw_lib__1_4cylo(realsolid)],
// 4 16 12 -20 -6 12 -14 -6 12 -13 -9 12 -20 -9
  [4,16,12,-20,-6,12,-14,-6,12,-13,-9,12,-20,-9],
// 4 16 12 -13 0 12 -13 -9 12 -14 -6 12 -14 0
  [4,16,12,-13,0,12,-13,-9,12,-14,-6,12,-14,0],
// 1 16 11 -13 -4.5 -1 0 0 0 1 0 0 0 -4.5 rect3.dat
  [1,16,11,-13,-4.5,-1,0,0,0,1,0,0,0,-4.5, ldraw_lib__rect3(realsolid)],
// 4 16 12 -29 7 12 -26 6 12 -26 0 12 -29 0
  [4,16,12,-29,7,12,-26,6,12,-26,0,12,-29,0],
// 4 16 12 -26 6 12 -29 7 12 -20 7 12 -20 6
  [4,16,12,-26,6,12,-29,7,12,-20,7,12,-20,6],
// 1 16 11 -24.5 7 1 0 0 0 0 -4.5 0 1 0 rect3.dat
  [1,16,11,-24.5,7,1,0,0,0,0,-4.5,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 10 -20 0 0 -1 0 0 0 -9 -9 0 0 1-4chrd.dat
  [1,16,10,-20,0,0,-1,0,0,0,-9,-9,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 10 -20 0 0 -1 0 0 0 7 7 0 0 1-4chrd.dat
  [1,16,10,-20,0,0,-1,0,0,0,7,7,0,0, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 28 -16.5 32.5 0 0 1 -2.5 1 0 -2.5 0 0 rect.dat
  [1,16,28,-16.5,32.5,0,0,1,-2.5,1,0,-2.5,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 28 16.5 32.5 -1 0 0 0 -1 -2.5 0 0 2.5 rect.dat
  [1,16,28,16.5,32.5,-1,0,0,0,-1,-2.5,0,0,2.5, ldraw_lib__rect(realsolid)],
// 1 16 28 0 35 0 0 1 -14 0 0 0 -1 0 rect2p.dat
  [1,16,28,0,35,0,0,1,-14,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 18 0 -8 0 1 0 0 0 -4 -1 0 0 rect.dat
  [1,16,18,0,-8,0,1,0,0,0,-4,-1,0,0, ldraw_lib__rect(realsolid)],
// 1 16 12.9719 -4 -8 0 0 -5.02815 0 -1 0 -1 0 0 rect3.dat
  [1,16,12.9719,-4,-8,0,0,-5.02815,0,-1,0,-1,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 12.9719 4 -8 0 0 -5.02815 0 1 0 1 0 0 rect3.dat
  [1,16,12.9719,4,-8,0,0,-5.02815,0,1,0,1,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 26.2 -10 63 1.2 0 0 0 0 5 0 -1 0 rect.dat
  [1,16,26.2,-10,63,1.2,0,0,0,0,5,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 28.2 -10 61 0 -1 0.8 -5 0 0 0 0 -2 rect3.dat
  [1,16,28.2,-10,61,0,-1,0.8,-5,0,0,0,0,-2, ldraw_lib__rect3(realsolid)],
// 1 16 29 -10 58 0 -1 0 -5 0 0 0 0 -1 rect3.dat
  [1,16,29,-10,58,0,-1,0,-5,0,0,0,0,-1, ldraw_lib__rect3(realsolid)],
// 1 16 28 -10 57 0 0 -1 -5 0 0 0 1 0 rect3.dat
  [1,16,28,-10,57,0,0,-1,-5,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 12 -20 0 0 17 0 0 0 -9 -9 0 0 1-4cyli.dat
  [1,16,12,-20,0,0,17,0,0,0,-9,-9,0,0, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 30 -20 0 0 -1 0 0 0 -9 -9 0 0 4-4edge.dat
  [1,16,30,-20,0,0,-1,0,0,0,-9,-9,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 30 -20 0 0 -1 0 0 0 -9 -9 0 0 4-4cyli.dat
  [1,16,30,-20,0,0,-1,0,0,0,-9,-9,0,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 29 -20 0 0 -1 0 0 0 9 -9 0 0 3-4edge.dat
  [1,16,29,-20,0,0,-1,0,0,0,9,-9,0,0, ldraw_lib__3_4edge(realsolid)],
// 1 16 29 -20 0 0 -1 0 0 0 9 -9 0 0 3-4ndis.dat
  [1,16,29,-20,0,0,-1,0,0,0,9,-9,0,0, ldraw_lib__3_4ndis(realsolid)],
...
// 1 16 7.1539 -5.182 -8 -0.78985 1 0 -1.182 0 0 0 0 1 rect2p.dat
  [1,16,7.1539,-5.182,-8,-0.78985,1,0,-1.182,0,0,0,0,1, ldraw_lib__rect2p(realsolid)],
// 1 16 7.1539 5.182 -8 0.78985 1 0 -1.182 0 0 0 0 1 rect2p.dat
  [1,16,7.1539,5.182,-8,0.78985,1,0,-1.182,0,0,0,0,1, ldraw_lib__rect2p(realsolid)],
...
// 1 16 20 30 20 -6.36396 0 6.36396 0 -16 0 -6.36396 0 -6.36396 1-4cyli.dat
  [1,16,20,30,20,-6.36396,0,6.36396,0,-16,0,-6.36396,0,-6.36396, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 17.5 -19.5 8 9.5 0 0 0 0 7.5 0 -1 0 rect.dat
  [1,16,17.5,-19.5,8,9.5,0,0,0,0,7.5,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 17.5 -12 0.5 9.5 0 0 0 -1 0 0 0 -7.5 rect3.dat
  [1,16,17.5,-12,0.5,9.5,0,0,0,-1,0,0,0,-7.5, ldraw_lib__rect3(realsolid)],
// 2 24 8 27 0 8 20 -7
  [2,24,8,27,0,8,20,-7],
// 2 24 8 20 -7 8 12 -7
  [2,24,8,20,-7,8,12,-7],
...
// 1 16 17.5 19.5 27 0 0 -9.5 7.5 0 0 0 -1 0 rect.dat
  [1,16,17.5,19.5,27,0,0,-9.5,7.5,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
...
module ldraw_lib__s__u9461s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u9461s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
