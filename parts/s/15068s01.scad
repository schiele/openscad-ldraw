...
use <../../p/stud3a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__15068s01(realsolid=false) = [
...
// 1 16 0 -12 10 1 0 0 0 -1 0 0 0 -1 stud3.dat
  [1,16,0,-12,10,1,0,0,0,-1,0,0,0,-1, ldraw_lib__stud3(realsolid)],
// 1 16 0 -4 -10 1 0 0 0 -1 0 0 0 -1 stud3a.dat
  [1,16,0,-4,-10,1,0,0,0,-1,0,0,0,-1, ldraw_lib__stud3a(realsolid)],
// 1 16 0 -4 -10 0 0 -4 0 -1.2 0 -4 0 0 4-4cylse.dat
  [1,16,0,-4,-10,0,0,-4,0,-1.2,0,-4,0,0, ldraw_lib__4_4cylse(realsolid)],
// 1 16 0 -12 20 0 0 -20 4 0 0 0 -1 0 rect.dat
  [1,16,0,-12,20,0,0,-20,4,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
...
// 1 16 0 -10 13 16 0 0 0 0 -2 0 3 0 box2-7.dat
  [1,16,0,-10,13,16,0,0,0,0,-2,0,3,0, ldraw_lib__box2_7(realsolid)],
...
// 1 16 -10 -12 10 -6 0 0 0 -1 2 0 0 -6 3-16ndis.dat
  [1,16,-10,-12,10,-6,0,0,0,-1,2,0,0,-6, ldraw_lib__3_16ndis(realsolid)],
// 1 16 10 -12 10 6 0 0 0 -1 2 0 0 -6 3-16ndis.dat
  [1,16,10,-12,10,6,0,0,0,-1,2,0,0,-6, ldraw_lib__3_16ndis(realsolid)],
// 1 16 -10 -12 10 -6 0 0 0 -1 2 0 0 -6 3-16edge.dat
  [1,16,-10,-12,10,-6,0,0,0,-1,2,0,0,-6, ldraw_lib__3_16edge(realsolid)],
// 1 16 10 -12 10 6 0 0 0 -1 2 0 0 -6 3-16edge.dat
  [1,16,10,-12,10,6,0,0,0,-1,2,0,0,-6, ldraw_lib__3_16edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -10 -12 10 0 0 -6 0 2 0 6 0 0 3-16cys2.dat
  [1,16,-10,-12,10,0,0,-6,0,2,0,6,0,0, ldraw_lib__3_16cys2(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 -12 10 0 0 6 0 2 0 6 0 0 3-16cys2.dat
  [1,16,10,-12,10,0,0,6,0,2,0,6,0,0, ldraw_lib__3_16cys2(realsolid)],
// 1 16 -10 -12 10 -6 0 0 0 -1 0 0 0 -6 3-16edge.dat
  [1,16,-10,-12,10,-6,0,0,0,-1,0,0,0,-6, ldraw_lib__3_16edge(realsolid)],
// 1 16 10 -12 10 6 0 0 0 -1 0 0 0 -6 3-16edge.dat
  [1,16,10,-12,10,6,0,0,0,-1,0,0,0,-6, ldraw_lib__3_16edge(realsolid)],
// 1 16 -10 -12 10 -6 0 0 0 -1 0 0 0 -6 3-16chrd.dat
  [1,16,-10,-12,10,-6,0,0,0,-1,0,0,0,-6, ldraw_lib__3_16chrd(realsolid)],
// 1 16 10 -12 10 6 0 0 0 -1 0 0 0 -6 3-16chrd.dat
  [1,16,10,-12,10,6,0,0,0,-1,0,0,0,-6, ldraw_lib__3_16chrd(realsolid)],
...
// 1 16 -13.75 -9 2 -2.25 0 0 0 -.333 .667 0 0 -2 box2-7.dat
  [1,16,-13.75,-9,2,-2.25,0,0,0,-.333,.667,0,0,-2, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 13.75 -9 2 -2.25 0 0 0 -.333 .667 0 0 -2 box2-7.dat
  [1,16,13.75,-9,2,-2.25,0,0,0,-.333,.667,0,0,-2, ldraw_lib__box2_7(realsolid)],
...
// 1 16 -10 -9.5 2 0 0 1.5 0 1.5 0 -2 0 0 box2-5.dat
  [1,16,-10,-9.5,2,0,0,1.5,0,1.5,0,-2,0,0, ldraw_lib__box2_5(realsolid)],
// 1 16 10 -9.5 2 0 0 -1.5 0 1.5 0 -2 0 0 box2-5.dat
  [1,16,10,-9.5,2,0,0,-1.5,0,1.5,0,-2,0,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -5 -9.5 2 -3.5 0 0 0 -1.5 0 0 0 -2 box2-11.dat
  [1,16,-5,-9.5,2,-3.5,0,0,0,-1.5,0,0,0,-2, ldraw_lib__box2_11(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 5 -9.5 2 -3.5 0 0 0 -1.5 0 0 0 -2 box2-11.dat
  [1,16,5,-9.5,2,-3.5,0,0,0,-1.5,0,0,0,-2, ldraw_lib__box2_11(realsolid)],
...
// 1 16 0 -11 2 1.5 0 0 0 3 0 0 0 2 box4-2p.dat
  [1,16,0,-11,2,1.5,0,0,0,3,0,0,0,2, ldraw_lib__box4_2p(realsolid)],
...
// 1 16 0 0 -10 20 0 0 0 1 0 0 0 10 recte4.dat
  [1,16,0,0,-10,20,0,0,0,1,0,0,0,10, ldraw_lib__recte4(realsolid)],
...
// 1 16 0 0 -10 16 0 0 0 1 0 0 0 6 recte4.dat
  [1,16,0,0,-10,16,0,0,0,1,0,0,0,6, ldraw_lib__recte4(realsolid)],
// 1 16 0 -3.5 -4 -16 0 0 0 0 -3.5 0 1 0 rect3.dat
  [1,16,0,-3.5,-4,-16,0,0,0,0,-3.5,0,1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 -5.5 -9 16 0 0 0 -1 1.5 0 0 -5 rect3.dat
  [1,16,0,-5.5,-9,16,0,0,0,-1,1.5,0,0,-5, ldraw_lib__rect3(realsolid)],
// 1 16 0 -4 -15 0 0 -16 0 -1 0 1 0 0 rect2p.dat
  [1,16,0,-4,-15,0,0,-16,0,-1,0,1,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 -2 -20 20 0 0 0 0 -2 0 1 0 rect3.dat
  [1,16,0,-2,-20,20,0,0,0,0,-2,0,1,0, ldraw_lib__rect3(realsolid)],
// 
// 0 // Sides
...
// 1 16 -20 24.972 20 0 1 0 -28.9719 0 -28.9719 -40 0 40 48\1-8chrd.dat
  [1,16,-20,24.972,20,0,1,0,-28.9719,0,-28.9719,-40,0,40, ldraw_lib__48__1_8chrd(realsolid)],
// 1 16 20 24.972 20 0 -1 0 -28.9719 0 -28.9719 -40 0 40 48\1-8chrd.dat
  [1,16,20,24.972,20,0,-1,0,-28.9719,0,-28.9719,-40,0,40, ldraw_lib__48__1_8chrd(realsolid)],
// 1 16 -20 24.972 20 0 -1 0 -28.9719 0 -28.9719 -40 0 40 48\1-8edge.dat
  [1,16,-20,24.972,20,0,-1,0,-28.9719,0,-28.9719,-40,0,40, ldraw_lib__48__1_8edge(realsolid)],
// 1 16 20 24.972 20 0 -1 0 -28.9719 0 -28.9719 -40 0 40 48\1-8edge.dat
  [1,16,20,24.972,20,0,-1,0,-28.9719,0,-28.9719,-40,0,40, ldraw_lib__48__1_8edge(realsolid)],
];
module ldraw_lib__s__15068s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__15068s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
