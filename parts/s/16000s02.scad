...
use <16000s03.scad>
use <16000s06.scad>
function ldraw_lib__s__16000s02() = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\16000s03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__16000s03()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\16000s06.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__16000s06()],
];
module ldraw_lib__s__16000s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__16000s02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
