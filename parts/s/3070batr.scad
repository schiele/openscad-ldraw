...
use <../../p/2-4ring5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3070batr(realsolid=false) = [
...
// 1 16 1 0 3 0.5 0 0 0 1 0 0 0 0.5 1-4ring8.dat
  [1,16,1,0,3,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__1_4ring8(realsolid)],
...
// 1 16 0.5 0 -4 0.5 0 0 0 1 0 0 0 0.5 1-4ring5.dat
  [1,16,0.5,0,-4,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__1_4ring5(realsolid)],
// 1 16 0.5 0 -4 1 0 0 0 1 0 0 0 1 1-4ring3.dat
  [1,16,0.5,0,-4,1,0,0,0,1,0,0,0,1, ldraw_lib__1_4ring3(realsolid)],
// 1 16 0.5 0 -4 0.5 0 0 0 1 0 0 0 0.5 1-4ring8.dat
  [1,16,0.5,0,-4,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__1_4ring8(realsolid)],
// 0
];
module ldraw_lib__s__3070batr(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3070batr(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
