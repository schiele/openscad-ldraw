...
use <../../p/2-4chrd.scad>
use <../../p/4-4disc.scad>
function ldraw_lib__s__3001p10s01() = [
...
// 1 16 -28 12 -20 7 0 0 0 0 7 0 1 0 4-4disc.dat
  [1,16,-28,12,-20,7,0,0,0,0,7,0,1,0, ldraw_lib__4_4disc()],
// 1 16 28 12 -20 7 0 0 0 0 7 0 1 0 4-4disc.dat
  [1,16,28,12,-20,7,0,0,0,0,7,0,1,0, ldraw_lib__4_4disc()],
// 1 16 16 8.5 -20 0 0 2.5 2.5 0 0 0 1 0 2-4chrd.dat
  [1,16,16,8.5,-20,0,0,2.5,2.5,0,0,0,1,0, ldraw_lib__2_4chrd()],
// 1 16 16 15.5 -20 0 0 2.5 2.5 0 0 0 1 0 2-4chrd.dat
  [1,16,16,15.5,-20,0,0,2.5,2.5,0,0,0,1,0, ldraw_lib__2_4chrd()],
// 1 16 -16 8.5 -20 0 0 -2.5 2.5 0 0 0 1 0 2-4chrd.dat
  [1,16,-16,8.5,-20,0,0,-2.5,2.5,0,0,0,1,0, ldraw_lib__2_4chrd()],
// 1 16 -16 15.5 -20 0 0 -2.5 2.5 0 0 0 1 0 2-4chrd.dat
  [1,16,-16,15.5,-20,0,0,-2.5,2.5,0,0,0,1,0, ldraw_lib__2_4chrd()],
...
module ldraw_lib__s__3001p10s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3001p10s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
