...
use <../../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__35700s02(realsolid=false) = [
...
// 1 16 16 -18.5 -10 0 -3 0 -1.5 0 0 0 0 1.5 1-4cylo.dat
  [1,16,16,-18.5,-10,0,-3,0,-1.5,0,0,0,0,1.5, ldraw_lib__1_4cylo(realsolid)],
// 1 16 16 -18.5 -10 0 -1 0 -1.5 0 0 0 0 1.5 1-4chrd.dat
  [1,16,16,-18.5,-10,0,-1,0,-1.5,0,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 16 13 -18.5 -10 0 1 0 -1.5 0 0 0 0 1.5 1-4chrd.dat
  [1,16,13,-18.5,-10,0,1,0,-1.5,0,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 16 16 -18.5 -14.5 0 -3 0 -1.5 0 0 0 0 -1.5 1-4cylo.dat
  [1,16,16,-18.5,-14.5,0,-3,0,-1.5,0,0,0,0,-1.5, ldraw_lib__1_4cylo(realsolid)],
// 1 16 16 -18.5 -14.5 0 -1 0 -1.5 0 0 0 0 -1.5 1-4chrd.dat
  [1,16,16,-18.5,-14.5,0,-1,0,-1.5,0,0,0,0,-1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 16 13 -18.5 -14.5 0 1 0 -1.5 0 0 0 0 -1.5 1-4chrd.dat
  [1,16,13,-18.5,-14.5,0,1,0,-1.5,0,0,0,0,-1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 16 14.5 -17.25 -12.25 0 1.5 0 1.25 0 0 0 0 -3.75 box2-9.dat
  [1,16,14.5,-17.25,-12.25,0,1.5,0,1.25,0,0,0,0,-3.75, ldraw_lib__box2_9(realsolid)],
// 1 16 14.5 -17.25 -12.25 0 -1.5 0 1.25 0 0 0 0 3.75 box2-9p.dat
  [1,16,14.5,-17.25,-12.25,0,-1.5,0,1.25,0,0,0,0,3.75, ldraw_lib__box2_9p(realsolid)],
...
// 1 16 14.5 -20 -12.25 0 0 -1.5 0 1 0 2.25 0 0 rect2p.dat
  [1,16,14.5,-20,-12.25,0,0,-1.5,0,1,0,2.25,0,0, ldraw_lib__rect2p(realsolid)],
];
module ldraw_lib__s__35700s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__35700s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
