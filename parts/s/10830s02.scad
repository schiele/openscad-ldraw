...
use <../../p/7-8edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__10830s02(realsolid=false) = [
...
// 1 16 0 -10.5 0 4 0 0 0 20.5 0 0 0 4 4-4cyli.dat
  [1,16,0,-10.5,0,4,0,0,0,20.5,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -10.5 0 0 0 4 0 1 -0.78 -4 0 0 2-4edge.dat
  [1,16,0,-10.5,0,0,0,4,0,1,-0.78,-4,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -10.5 0 0 0 -4 0 1 -0.78 4 0 0 2-4edge.dat
  [1,16,0,-10.5,0,0,0,-4,0,1,-0.78,4,0,0, ldraw_lib__2_4edge(realsolid)],
// 
// 1 16 0 -10.5 0 4 0 0 0 -0.78 0 0 0 4 1-4cyls2.dat
  [1,16,0,-10.5,0,4,0,0,0,-0.78,0,0,0,4, ldraw_lib__1_4cyls2(realsolid)],
// 1 16 0 -10.5 0 4 0 0 0 -0.78 0 0 0 -4 1-4cyls2.dat
  [1,16,0,-10.5,0,4,0,0,0,-0.78,0,0,0,-4, ldraw_lib__1_4cyls2(realsolid)],
// 1 16 0 -10.5 0 -4 0 0 0 -0.78 0 0 0 4 1-4cyls2.dat
  [1,16,0,-10.5,0,-4,0,0,0,-0.78,0,0,0,4, ldraw_lib__1_4cyls2(realsolid)],
...
// 1 16 0 -29.5 -4 7.27099 0 17.55371 -17.55371 0 7.27099 0 8 0 7-8cylo.dat
  [1,16,0,-29.5,-4,7.27099,0,17.55371,-17.55371,0,7.27099,0,8,0, ldraw_lib__7_8cylo(realsolid)],
...
// 1 16 0 -29.5 4 2 0 0 0 0 2 0 -2.5 0 4-4ring7.dat
  [1,16,0,-29.5,4,2,0,0,0,0,2,0,-2.5,0, ldraw_lib__4_4ring7(realsolid)],
// 1 16 0 -29.5 4 2 0 0 0 0 2 0 -2.5 0 4-4ring8.dat
  [1,16,0,-29.5,4,2,0,0,0,0,2,0,-2.5,0, ldraw_lib__4_4ring8(realsolid)],
// 1 16 0 -29.5 4 1 0 0 0 0 1 0 -2.5 0 4-4rin18.dat
  [1,16,0,-29.5,4,1,0,0,0,0,1,0,-2.5,0, ldraw_lib__4_4rin18(realsolid)],
...
// 1 16 0 -29.5 4 0.5 0 0 0 0 -0.5 0 -2.5 0 1-4con27.dat
  [1,16,0,-29.5,4,0.5,0,0,0,0,-0.5,0,-2.5,0, ldraw_lib__1_4con27(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -29.5 4 0.5 0 0 0 0 0.5 0 -2.5 0 1-4con27.dat
  [1,16,0,-29.5,4,0.5,0,0,0,0,0.5,0,-2.5,0, ldraw_lib__1_4con27(realsolid)],
...
// 1 16 0 -29.5 -1.5 -13.5 0 0 0 0 -13.5 0 3 0 4-4cylo.dat
  [1,16,0,-29.5,-1.5,-13.5,0,0,0,0,-13.5,0,3,0, ldraw_lib__4_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -29.5 -4 .353553 0 -.353553 .353553 0 .353553 0 2.5 0 1-4con27.dat
  [1,16,0,-29.5,-4,.353553,0,-.353553,.353553,0,.353553,0,2.5,0, ldraw_lib__1_4con27(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -29.5 -4 -.353553 0 -.353553 -.353553 0 .353553 0 2.5 0 1-4con27.dat
  [1,16,0,-29.5,-4,-.353553,0,-.353553,-.353553,0,.353553,0,2.5,0, ldraw_lib__1_4con27(realsolid)],
...
// 1 16 0 -29.5 -4 5.35757 0 12.93431 -12.93431 0 5.35757 0 1 0 7-8edge.dat
  [1,16,0,-29.5,-4,5.35757,0,12.93431,-12.93431,0,5.35757,0,1,0, ldraw_lib__7_8edge(realsolid)],
...
module ldraw_lib__s__10830s02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__10830s02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
