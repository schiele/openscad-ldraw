...
$fa=1; $fs=0.2;
function ldraw_lib__s__logolambt01(realsolid=false) = [
...
// 1 80 0 0 0 1 0 0 0 1 0 0 0 1 logo-lamborghini-text.dat
  [1,80,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__logo_lamborghini_text(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 logo-lamborghini-text-bkgd.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__logo_lamborghini_text_bkgd(realsolid)],
];
module ldraw_lib__s__logolambt01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__logolambt01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
