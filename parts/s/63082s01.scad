...
use <../../p/stud4a.scad>
use <../../p/stug2.scad>
function ldraw_lib__s__63082s01() = [
...
// 1 16 0 4 0 6.1 0 0 0 -1 0 0 0 6.1 4-4ndis.dat
  [1,16,0,4,0,6.1,0,0,0,-1,0,0,0,6.1, ldraw_lib__4_4ndis()],
...
module ldraw_lib__s__63082s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__63082s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
