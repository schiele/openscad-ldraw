...
use <../../p/stug-1x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3023s01(realsolid=false) = [
// 0 ~Plate  1 x  2 without Front Face
// 0 Name: s\3023s01.dat
...
// 1 16 0 8 0 20 0 0 0 -8 0 0 0 10 box4t.dat
  [1,16,0,8,0,20,0,0,0,-8,0,0,0,10, ldraw_lib__box4t(realsolid)],
...
module ldraw_lib__s__3023s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3023s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__3023s01(line=0.2);