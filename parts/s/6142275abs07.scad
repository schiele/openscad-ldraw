...
use <../../p/1-4chrd.scad>
use <../../p/1-4cyli.scad>
function ldraw_lib__s__6142275abs07() = [
// 0 ~Sticker  1.9 x  0.8 with Headlight on Black and White Background Left - Bottom Face
// 0 Name: s\6142275abs07.dat
...
// 4 16 -6.5 0 19.2711 -6.5 -.25 19.2711 6.5 -.25 19.2711 6.5 0 19.2711
  [4,16,-6.5,0,19.2711,-6.5,-.25,19.2711,6.5,-.25,19.2711,6.5,0,19.2711],
// 3 16 -8 0 17.7711 -8 -.25 14.5 -8 -.25 17.7711
  [3,16,-8,0,17.7711,-8,-.25,14.5,-8,-.25,17.7711],
// 3 16 -8 0 17.7711 -8 -.25 13.8668 -8 -.25 14.5
  [3,16,-8,0,17.7711,-8,-.25,13.8668,-8,-.25,14.5],
// 3 16 8 0 17.7711 8 -.25 17.7711 8 -.25 13.8668
  [3,16,8,0,17.7711,8,-.25,17.7711,8,-.25,13.8668],
// 3 16 -8 0 17.7711 -8 -.25 6.5112 -8 -.25 13.8668
  [3,16,-8,0,17.7711,-8,-.25,6.5112,-8,-.25,13.8668],
// 3 16 8 0 17.7711 8 -.25 13.8668 8 -.25 7.75
  [3,16,8,0,17.7711,8,-.25,13.8668,8,-.25,7.75],
// 3 16 8 0 17.7711 8 -.25 7.75 8 -.25 6.5112
  [3,16,8,0,17.7711,8,-.25,7.75,8,-.25,6.5112],
...
module ldraw_lib__s__6142275abs07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6142275abs07(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__6142275abs07(line=0.2);