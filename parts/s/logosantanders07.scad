...
$fa=1; $fs=0.2;
function ldraw_lib__s__logosantanders07(realsolid=false) = [
...
// 1 16 -29.304 0 0 3 0 0 0 1 0 0 0 3 s\logosantanders05.dat
  [1,16,-29.304,0,0,3,0,0,0,1,0,0,0,3, ldraw_lib__s__logosantanders05(realsolid)],
// 1 16 10.605 0 -1.735 5 0 0 0 1 0 0 0 5 s\logosantanders04.dat
  [1,16,10.605,0,-1.735,5,0,0,0,1,0,0,0,5, ldraw_lib__s__logosantanders04(realsolid)],
// 0 // Outer box
...
module ldraw_lib__s__logosantanders07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__logosantanders07(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
