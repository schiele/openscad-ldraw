...
use <../../p/stud2s2e.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__11203s01(realsolid=false) = [
...
// 1 16 -10 0 10 -1 0 0 0 4 0 0 0 1 stud2s2e.dat
  [1,16,-10,0,10,-1,0,0,0,4,0,0,0,1, ldraw_lib__stud2s2e(realsolid)],
...
// 1 16 -10 4 10 -3.5 0 0 0 1 0 0 0 3.5 4-4edge.dat
  [1,16,-10,4,10,-3.5,0,0,0,1,0,0,0,3.5, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 0 10 -1 0 0 0 1 0 0 0 1 stud2a.dat
  [1,16,10,0,10,-1,0,0,0,1,0,0,0,1, ldraw_lib__stud2a(realsolid)],
// 1 16 10 0 10 -1 0 0 0 4 0 0 0 1 stud2s2e.dat
  [1,16,10,0,10,-1,0,0,0,4,0,0,0,1, ldraw_lib__stud2s2e(realsolid)],
// 1 16 10 4 10 0 0 6 0 1 0 6 0 0 4-4edge.dat
  [1,16,10,4,10,0,0,6,0,1,0,6,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 4 10 0 0 3.5 0 1 0 3.5 0 0 4-4edge.dat
  [1,16,10,4,10,0,0,3.5,0,1,0,3.5,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 -10 0 -10 -1 0 0 0 1 0 0 0 1 stud2a.dat
  [1,16,-10,0,-10,-1,0,0,0,1,0,0,0,1, ldraw_lib__stud2a(realsolid)],
// 1 16 -10 0 -10 -1 0 0 0 4 0 0 0 1 stud2s2e.dat
  [1,16,-10,0,-10,-1,0,0,0,4,0,0,0,1, ldraw_lib__stud2s2e(realsolid)],
...
// 1 16 0 0 0 -17 0 0 0 4 0 0 0 17 box5.dat
  [1,16,0,0,0,-17,0,0,0,4,0,0,0,17, ldraw_lib__box5(realsolid)],
...
// 1 16 0 0 0 -19 0 0 0 1 0 0 0 19 box4.dat
  [1,16,0,0,0,-19,0,0,0,1,0,0,0,19, ldraw_lib__box4(realsolid)],
...
// 1 16 0 1 0 -20 0 0 0 7 0 0 0 20 box4.dat
  [1,16,0,1,0,-20,0,0,0,7,0,0,0,20, ldraw_lib__box4(realsolid)],
// 
// 1 16 0 2 -9 1 0 0 0 0 -2 0 5 0 box4-2p.dat
  [1,16,0,2,-9,1,0,0,0,0,-2,0,5,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 -9 2 0 0 5 0 0 0 -2 -1 0 0 box4-2p.dat
  [1,16,-9,2,0,0,5,0,0,0,-2,-1,0,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 0 2 9 -1 0 0 0 0 -2 0 -5 0 box4-2p.dat
  [1,16,0,2,9,-1,0,0,0,0,-2,0,-5,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 9 2 0 0 -5 0 0 0 -2 1 0 0 box4-2p.dat
  [1,16,9,2,0,0,-5,0,0,0,-2,1,0,0, ldraw_lib__box4_2p(realsolid)],
...
// 1 16 -2.599 2 9 0 0 -1.599 -2 0 0 0 1 0 rect3.dat
  [1,16,-2.599,2,9,0,0,-1.599,-2,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 2 11 0 0 -4.199 2 0 0 0 -1 0 rect.dat
  [1,16,0,2,11,0,0,-4.199,2,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 2.599 2 9 0 0 1.599 2 0 0 0 1 0 rect3.dat
  [1,16,2.599,2,9,0,0,1.599,2,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 
...
// 1 16 -9 2 -2.599 0 -1 0 -2 0 0 0 0 -1.599 rect3.dat
  [1,16,-9,2,-2.599,0,-1,0,-2,0,0,0,0,-1.599, ldraw_lib__rect3(realsolid)],
// 1 16 -11 2 0 0 1 0 2 0 0 0 0 -4.199 rect.dat
  [1,16,-11,2,0,0,1,0,2,0,0,0,0,-4.199, ldraw_lib__rect(realsolid)],
// 1 16 -9 2 2.599 0 -1 0 2 0 0 0 0 1.599 rect3.dat
  [1,16,-9,2,2.599,0,-1,0,2,0,0,0,0,1.599, ldraw_lib__rect3(realsolid)],
// 
// 2 24 -4.199 0 -9 -4 0 -10
...
module ldraw_lib__s__11203s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__11203s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
