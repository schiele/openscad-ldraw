...
use <2525ps1a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__43ps1a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2525ps1a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2525ps1a(realsolid)],
];
module ldraw_lib__s__43ps1a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__43ps1a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
