...
use <../../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__u9467s01(realsolid=false) = [
...
// 1 16 40 0 0 0 0 20 -20 0 0 0 1 0 2-4ndis.dat
  [1,16,40,0,0,0,0,20,-20,0,0,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 40 0 0 0 0 -20 20 0 0 0 1 0 3-16ndis.dat
  [1,16,40,0,0,0,0,-20,20,0,0,0,1,0, ldraw_lib__3_16ndis(realsolid)],
// 1 16 17.8 11 0 0 0 5 -5 0 0 0 1 0 1-8chrd.dat
  [1,16,17.8,11,0,0,0,5,-5,0,0,0,1,0, ldraw_lib__1_8chrd(realsolid)],
...
// 1 16 68 0 44 0 0 1 -14 0 0 0 -1 0 rect3.dat
  [1,16,68,0,44,0,0,1,-14,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 64.5 0 0 4.5 0 0 0 0 -20 0 1 0 rect1.dat
  [1,16,64.5,0,0,4.5,0,0,0,0,-20,0,1,0, ldraw_lib__rect1(realsolid)],
// 4 16 69 -14 44 69 -19 39 69 19 39 69 14 44
  [4,16,69,-14,44,69,-19,39,69,19,39,69,14,44],
// 1 16 69 -20 9 0 -1 0 -9 0 0 0 0 -9 1-4chrd.dat
  [1,16,69,-20,9,0,-1,0,-9,0,0,0,0,-9, ldraw_lib__1_4chrd(realsolid)],
// 1 16 69 20 9 0 -1 0 9 0 0 0 0 -9 1-4chrd.dat
  [1,16,69,20,9,0,-1,0,9,0,0,0,0,-9, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 40 0 4 0 0 20 -20 0 0 0 -1 0 2-4ndis.dat
  [1,16,40,0,4,0,0,20,-20,0,0,0,-1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 40 0 4 0 0 -20 20 0 0 0 -1 0 3-16ndis.dat
  [1,16,40,0,4,0,0,-20,20,0,0,0,-1,0, ldraw_lib__3_16ndis(realsolid)],
// 1 16 17.8 11 4 0 0 5 -5 0 0 0 -1 0 1-8chrd.dat
  [1,16,17.8,11,4,0,0,5,-5,0,0,0,-1,0, ldraw_lib__1_8chrd(realsolid)],
// 4 16 17.8 6 4 21.3355 7.4645 4 21.522 7.654 4 20 20 4
  [4,16,17.8,6,4,21.3355,7.4645,4,21.522,7.654,4,20,20,4],
// 1 16 62.5 0 4 2.5 0 0 0 0 20 0 -1 0 rect1.dat
  [1,16,62.5,0,4,2.5,0,0,0,0,20,0,-1,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 68 -16.5 41.5 -1 0 0 0 1 -2.5 0 0 -2.5 rect3.dat
  [1,16,68,-16.5,41.5,-1,0,0,0,1,-2.5,0,0,-2.5, ldraw_lib__rect3(realsolid)],
// 1 16 68 16.5 41.5 1 0 0 0 -1 2.5 0 0 -2.5 rect3.dat
  [1,16,68,16.5,41.5,1,0,0,0,-1,2.5,0,0,-2.5, ldraw_lib__rect3(realsolid)],
// 
...
// 1 16 66 0 44 1 0 0 0 0 6.5 0 3 0 box3u2p.dat
  [1,16,66,0,44,1,0,0,0,0,6.5,0,3,0, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 53 -27 42 0 0 4 0 2 0 2 0 0 box4.dat
  [1,16,53,-27,42,0,0,4,0,2,0,2,0,0, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 27 -27 42 0 0 3 0 2 0 2 0 0 box4.dat
  [1,16,27,-27,42,0,0,3,0,2,0,2,0,0, ldraw_lib__box4(realsolid)],
...
// 1 16 22 -26 48.5 0 1 1 -1 0 0 0 0 2.5 rect.dat
  [1,16,22,-26,48.5,0,1,1,-1,0,0,0,0,2.5, ldraw_lib__rect(realsolid)],
...
// 1 16 20 27 42 0 0 4 0 -2 0 2 0 0 box4.dat
  [1,16,20,27,42,0,0,4,0,-2,0,2,0,0, ldraw_lib__box4(realsolid)],
...
module ldraw_lib__s__u9467s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__u9467s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
