...
use <../../p/t04o6250.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__3626cs01(realsolid=false) = [
// 0 ~Minifig Head - Closed Hollow Stud with Back Surface
// 0 Name: s\3626cs01.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !HISTORY 2012-10-04 [MagFors] used s\3626cs02.dat
...
module ldraw_lib__s__3626cs01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__3626cs01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
