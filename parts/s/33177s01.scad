...
use <../../p/4-8sphe.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__33177s01(realsolid=false) = [
...
// 1 16 0 4 0 3 0 0 0 4 0 0 0 3 4-4con2.dat
  [1,16,0,4,0,3,0,0,0,4,0,0,0,3, ldraw_lib__4_4con2(realsolid)],
// 1 16 0 8 0 6 0 0 0 1.7 0 0 0 6 4-8sphe.dat
  [1,16,0,8,0,6,0,0,0,1.7,0,0,0,6, ldraw_lib__4_8sphe(realsolid)],
];
module ldraw_lib__s__33177s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__33177s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__33177s01(line=0.2);