...
use <../../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__33230s01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,0,0,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 
// 1 16 13.9 0 0 -6.1 0 0 0 10 0 0 0 1 box3u6.dat
  [1,16,13.9,0,0,-6.1,0,0,0,10,0,0,0,1, ldraw_lib__box3u6(realsolid)],
// 1 16 0 0 -13.9 0 0 1 0 10 0 6.1 0 0 box3u6.dat
  [1,16,0,0,-13.9,0,0,1,0,10,0,6.1,0,0, ldraw_lib__box3u6(realsolid)],
// 1 16 -13.9 0 0 6.1 0 0 0 10 0 0 0 -1 box3u6.dat
  [1,16,-13.9,0,0,6.1,0,0,0,10,0,0,0,-1, ldraw_lib__box3u6(realsolid)],
// 1 16 0 0 13.9 0 0 -1 0 10 0 -6.1 0 0 box3u6.dat
  [1,16,0,0,13.9,0,0,-1,0,10,0,-6.1,0,0, ldraw_lib__box3u6(realsolid)],
...
// 1 16 5.387 10 0 2.41421 0 1 0 1 0 1 0 -2.41421 1-8edge.dat
  [1,16,5.387,10,0,2.41421,0,1,0,1,0,1,0,-2.41421, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 10 5.387 -1 0 2.41421 0 1 0 2.41421 0 1 1-8edge.dat
  [1,16,0,10,5.387,-1,0,2.41421,0,1,0,2.41421,0,1, ldraw_lib__1_8edge(realsolid)],
// 1 16 -5.387 10 0 -2.41421 0 -1 0 1 0 -1 0 2.41421 1-8edge.dat
  [1,16,-5.387,10,0,-2.41421,0,-1,0,1,0,-1,0,2.41421, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 10 -5.387 1 0 -2.41421 0 1 0 -2.41421 0 -1 1-8edge.dat
  [1,16,0,10,-5.387,1,0,-2.41421,0,1,0,-2.41421,0,-1, ldraw_lib__1_8edge(realsolid)],
...
module ldraw_lib__s__33230s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__33230s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
