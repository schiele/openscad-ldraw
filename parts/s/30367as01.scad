...
use <../../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__30367as01(realsolid=false) = [
...
module ldraw_lib__s__30367as01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__30367as01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__30367as01(line=0.2);