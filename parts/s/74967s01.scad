...
use <30027s02.scad>
use <../../p/wpinhol2.scad>
function ldraw_lib__s__74967s01() = [
...
// 1 16 0 0 10 6 0 0 0 0 6 0 -2 0 4-4cylo.dat
  [1,16,0,0,10,6,0,0,0,0,6,0,-2,0, ldraw_lib__4_4cylo()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__s__74967s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__74967s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
