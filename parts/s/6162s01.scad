...
use <../../p/tri3a4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__6162s01(realsolid=false) = [
...
// 1 16 -116 24 -116 0 0 36 0 -20 0 232 0 0 tri3a4.dat
  [1,16,-116,24,-116,0,0,36,0,-20,0,232,0,0, ldraw_lib__tri3a4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 116 24 116 0 0 -232 0 -20 0 -36 0 0 tri3a4.dat
  [1,16,116,24,116,0,0,-232,0,-20,0,-36,0,0, ldraw_lib__tri3a4(realsolid)],
// 
...
// 1 16 -120 24 -120 0 0 40 0 -24 0 240 0 0 tri3a4.dat
  [1,16,-120,24,-120,0,0,40,0,-24,0,240,0,0, ldraw_lib__tri3a4(realsolid)],
// 1 16 120 24 120 0 0 -240 0 -24 0 -40 0 0 tri3a4.dat
  [1,16,120,24,120,0,0,-240,0,-24,0,-40,0,0, ldraw_lib__tri3a4(realsolid)],
// 
// 0 // base fill
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\6162s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6162s02(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 -1 0 0 s\6162s02.dat
  [1,16,0,0,0,0,0,-1,0,1,0,-1,0,0, ldraw_lib__s__6162s02(realsolid)],
// 
// 1 16 -40 0 0 1 0 0 0 1 0 0 0 1 stug-8x8.dat
  [1,16,-40,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_8x8(realsolid)],
// 1 16 -30 0 -90 1 0 0 0 1 0 0 0 1 stug-1x5.dat
  [1,16,-30,0,-90,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x5(realsolid)],
// 1 16 -60 0 -110 1 0 0 0 1 0 0 0 1 stug-1x2.dat
  [1,16,-60,0,-110,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x2(realsolid)],
...
// 1 16 50 0 10 1 0 0 0 1 0 0 0 1 stug-7x1.dat
  [1,16,50,0,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_7x1(realsolid)],
// 1 16 70 0 20 1 0 0 0 1 0 0 0 1 stug-6x1.dat
  [1,16,70,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_6x1(realsolid)],
// 1 16 90 0 30 1 0 0 0 1 0 0 0 1 stug-5x1.dat
  [1,16,90,0,30,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_5x1(realsolid)],
// 1 16 110 0 60 1 0 0 0 1 0 0 0 1 stug-2x1.dat
  [1,16,110,0,60,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x1(realsolid)],
// 
...
// 1 16 -101.9 4 80 14.1 0 0 0 19 0 0 0 1 box3u2p.dat
  [1,16,-101.9,4,80,14.1,0,0,0,19,0,0,0,1, ldraw_lib__box3u2p(realsolid)],
// 1 16 -80 0 80 -1 0 0 0 1 0 0 0 1 s\6161s02.dat
  [1,16,-80,0,80,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__6161s02(realsolid)],
// 1 16 -40 0 80 -1 0 0 0 1 0 0 0 1 s\6161s02.dat
  [1,16,-40,0,80,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__6161s02(realsolid)],
// 1 16 0 0 80 -1 0 0 0 1 0 0 0 1 s\6161s02.dat
  [1,16,0,0,80,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__6161s02(realsolid)],
// 1 16 40 0 80 -1 0 0 0 1 0 0 0 1 s\6161s02.dat
  [1,16,40,0,80,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__6161s02(realsolid)],
// 1 16 100 4 100 0 0 1 0 -5 0 1 0 0 stud4.dat
  [1,16,100,4,100,0,0,1,0,-5,0,1,0,0, ldraw_lib__stud4(realsolid)],
// 1 16 80 4 101.9 0 0 1 0 19 0 -14.1 0 0 box3u2p.dat
  [1,16,80,4,101.9,0,0,1,0,19,0,-14.1,0,0, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 -80 0 40 0 0 -1 0 1 0 -1 0 0 s\6161s02.dat
  [1,16,-80,0,40,0,0,-1,0,1,0,-1,0,0, ldraw_lib__s__6161s02(realsolid)],
// 1 16 -40 0 40 1 0 0 0 1 0 0 0 1 s\6161s01.dat
  [1,16,-40,0,40,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6161s01(realsolid)],
// 1 16 0 0 40 1 0 0 0 1 0 0 0 1 s\6161s01.dat
  [1,16,0,0,40,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6161s01(realsolid)],
// 1 16 40 0 40 1 0 0 0 1 0 0 0 1 s\6161s01.dat
  [1,16,40,0,40,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6161s01(realsolid)],
// 1 16 80 0 40 1 0 0 0 1 0 0 0 1 s\6161s01.dat
  [1,16,80,0,40,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6161s01(realsolid)],
...
// 1 16 99.8 4 40 -12 0 0 0 19 0 0 0 1 box3u6.dat
  [1,16,99.8,4,40,-12,0,0,0,19,0,0,0,1, ldraw_lib__box3u6(realsolid)],
...
// 1 16 -80 0 0 0 0 -1 0 1 0 -1 0 0 s\6161s02.dat
  [1,16,-80,0,0,0,0,-1,0,1,0,-1,0,0, ldraw_lib__s__6161s02(realsolid)],
// 1 16 -40 0 0 1 0 0 0 1 0 0 0 1 s\6161s01.dat
  [1,16,-40,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6161s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\6161s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6161s01(realsolid)],
// 1 16 40 0 0 1 0 0 0 1 0 0 0 1 s\6161s01.dat
  [1,16,40,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6161s01(realsolid)],
// 1 16 80 0 0 1 0 0 0 1 0 0 0 1 s\6161s01.dat
  [1,16,80,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6161s01(realsolid)],
// 1 16 93.8 4 0 -6 0 0 0 19 0 0 0 1 box3u6.dat
  [1,16,93.8,4,0,-6,0,0,0,19,0,0,0,1, ldraw_lib__box3u6(realsolid)],
...
// 1 16 80 4 -21.05 0 0 -1 0 19 0 13.25 0 0 box3u6.dat
  [1,16,80,4,-21.05,0,0,-1,0,19,0,13.25,0,0, ldraw_lib__box3u6(realsolid)],
// 1 16 61.8 4 -40 -14 0 0 0 19 0 0 0 1 box3u6.dat
  [1,16,61.8,4,-40,-14,0,0,0,19,0,0,0,1, ldraw_lib__box3u6(realsolid)],
...
// 1 16 -80 0 -80 0 0 -1 0 1 0 -1 0 0 s\6161s02.dat
  [1,16,-80,0,-80,0,0,-1,0,1,0,-1,0,0, ldraw_lib__s__6161s02(realsolid)],
// 1 16 -40 0 -80 1 0 0 0 1 0 0 0 1 s\6161s01.dat
  [1,16,-40,0,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6161s01(realsolid)],
// 1 16 0 0 -80 1 0 0 0 1 0 0 0 1 s\6161s01.dat
  [1,16,0,0,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6161s01(realsolid)],
...
// 1 16 21.05 4 -80 -13.25 0 0 0 19 0 0 0 1 box3u6.dat
  [1,16,21.05,4,-80,-13.25,0,0,0,19,0,0,0,1, ldraw_lib__box3u6(realsolid)],
// 1 16 40 4 -61.8 0 0 -1 0 19 0 14 0 0 box3u6.dat
  [1,16,40,4,-61.8,0,0,-1,0,19,0,14,0,0, ldraw_lib__box3u6(realsolid)],
...
// 1 16 -60 4 -100 0 0 -1 0 -5 0 -1 0 0 stud4.dat
  [1,16,-60,4,-100,0,0,-1,0,-5,0,-1,0,0, ldraw_lib__stud4(realsolid)],
// 1 16 -40 4 -99.8 0 0 -1 0 19 0 12 0 0 box3u6.dat
  [1,16,-40,4,-99.8,0,0,-1,0,19,0,12,0,0, ldraw_lib__box3u6(realsolid)],
// 1 16 0 4 -93.8 0 0 -1 0 19 0 6 0 0 box3u6.dat
  [1,16,0,4,-93.8,0,0,-1,0,19,0,6,0,0, ldraw_lib__box3u6(realsolid)],
...
module ldraw_lib__s__6162s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__6162s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
