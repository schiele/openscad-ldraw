...
use <58381s03.scad>
use <58381s04.scad>
function ldraw_lib__s__60658s01() = [
...
// 1 16 0 72 0 1 0 0 0 1 0 0 0 1 s\58381s02.dat
  [1,16,0,72,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__58381s02()],
...
// 1 16 0 36 40 1 0 0 0 1 0 0 0 1 s\58381s04.dat
  [1,16,0,36,40,1,0,0,0,1,0,0,0,1, ldraw_lib__s__58381s04()],
// 
...
// 1 16 8 36 50 -2 0 0 0 0 -36 0 -1 0 rect3.dat
  [1,16,8,36,50,-2,0,0,0,0,-36,0,-1,0, ldraw_lib__rect3()],
// 1 16 -1.33 34 -4.4135 -7.33 0.0798 0 0 0 -30 -0.5865 -1 0 rect.dat
  [1,16,-1.33,34,-4.4135,-7.33,0.0798,0,0,0,-30,-0.5865,-1,0, ldraw_lib__rect()],
// 1 16 6 34 3.0865 0 1 0 0 0 30 6.9135 0 0 rect2p.dat
  [1,16,6,34,3.0865,0,1,0,0,0,30,6.9135,0,0, ldraw_lib__rect2p()],
...
// 1 16 0 4 0 -8.6603 0 5 0 60 0 -5 0 -8.6603 48\1-6cyli.dat
  [1,16,0,4,0,-8.6603,0,5,0,60,0,-5,0,-8.6603, ldraw_lib__48__1_6cyli()],
// 1 16 0 4 0 0 0 10 0 60 0 -10 0 0 48\1-4cyli.dat
  [1,16,0,4,0,0,0,10,0,60,0,-10,0,0, ldraw_lib__48__1_4cyli()],
];
module ldraw_lib__s__60658s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__60658s01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
