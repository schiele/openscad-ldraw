...
use <../u9146.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__765s01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 u9146.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9146(realsolid)],
// 1 16 0 -5.5 -5 1 0 0 0 1 0 0 0 1 u9020.dat
  [1,16,0,-5.5,-5,1,0,0,0,1,0,0,0,1, ldraw_lib__u9020(realsolid)],
];
module ldraw_lib__s__765s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__765s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__765s01(line=0.2);