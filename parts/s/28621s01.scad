...
use <../../p/stud2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__28621s01(realsolid=false) = [
...
// 1 16 0 21 0 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,0,21,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 3 0 6 0 0 0 21 0 0 0 6 4-4cyli.dat
  [1,16,0,3,0,6,0,0,0,21,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 21 0 8 0 0 0 3 0 0 0 8 4-4cyli.dat
  [1,16,0,21,0,8,0,0,0,3,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 filstud2.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__filstud2(realsolid)],
];
module ldraw_lib__s__28621s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__28621s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__s__28621s01(line=0.2);