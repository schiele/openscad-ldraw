...
use <../../p/stud4f2w.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s__60219s01(realsolid=false) = [
...
// 1 16 0 16 0 0 0 -6 0 4 0 6 0 0 1-4edge.dat
  [1,16,0,16,0,0,0,-6,0,4,0,6,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -20 16 0 6 0 0 0 4 0 0 0 6 2-4edge.dat
  [1,16,-20,16,0,6,0,0,0,4,0,0,0,6, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 -20 20 20 0 0 1 0 -1 0 -1 0 0 stud4f2w.dat
  [1,16,-20,20,20,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stud4f2w(realsolid)],
...
// 1 16 -20 20 10 0 0 2 0 4 0 -2 0 0 box3u8p.dat
  [1,16,-20,20,10,0,0,2,0,4,0,-2,0,0, ldraw_lib__box3u8p(realsolid)],
// 1 16 -20 20 32 0 0 -2 0 4 0 4 0 0 box3u6.dat
  [1,16,-20,20,32,0,0,-2,0,4,0,4,0,0, ldraw_lib__box3u6(realsolid)],
// 
...
// 1 16 -30 4 50 0 0 -1 0 6 0 1 0 0 stud2s2.dat
  [1,16,-30,4,50,0,0,-1,0,6,0,1,0,0, ldraw_lib__stud2s2(realsolid)],
// 1 16 -10 0 50 0 0 -1 0 4 0 1 0 0 stud2s2e.dat
  [1,16,-10,0,50,0,0,-1,0,4,0,1,0,0, ldraw_lib__stud2s2e(realsolid)],
// 1 16 -30 0 50 0 0 -1 0 4 0 1 0 0 stud2s2e.dat
  [1,16,-30,0,50,0,0,-1,0,4,0,1,0,0, ldraw_lib__stud2s2e(realsolid)],
...
// 1 16 -30 0 46.613 1 0 -2.41421 0 -1 0 -2.41421 0 -1 1-8edge.dat
  [1,16,-30,0,46.613,1,0,-2.41421,0,-1,0,-2.41421,0,-1, ldraw_lib__1_8edge(realsolid)],
...
// 1 16 -29 22 18 0 -7 0 2 0 0 0 0 18 box2-7.dat
  [1,16,-29,22,18,0,-7,0,2,0,0,0,0,18, ldraw_lib__box2_7(realsolid)],
// 1 16 -10 22 36 8 0 0 0 0 -2 0 1 0 rect2p.dat
  [1,16,-10,22,36,8,0,0,0,0,-2,0,1,0, ldraw_lib__rect2p(realsolid)],
// 
// 1 16 0 20 0 0 0 -8 0 -2 0 8 0 0 1-4ndis.dat
  [1,16,0,20,0,0,0,-8,0,-2,0,8,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -20 20 0 8 0 0 0 -2 0 0 0 8 2-4ndis.dat
  [1,16,-20,20,0,8,0,0,0,-2,0,0,0,8, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 -40 20 20 0 1 0 0 0 -4 -20 0 0 rect2p.dat
  [1,16,-40,20,20,0,1,0,0,0,-4,-20,0,0, ldraw_lib__rect2p(realsolid)],
// 3 16 -40 24 40 -40 16 40 -40 4 60
  [3,16,-40,24,40,-40,16,40,-40,4,60],
// 4 16 -40 16 40 -40 0 40 -40 0 60 -40 4 60
  [4,16,-40,16,40,-40,0,40,-40,0,60,-40,4,60],
// 1 16 -20 12 50 20 0 0 0 2 -10 0 0 10 box2-9p.dat
  [1,16,-20,12,50,20,0,0,0,2,-10,0,0,10, ldraw_lib__box2_9p(realsolid)],
// 4 16 -38 2 58 -38 0 58 -38 0 42 -38 18 42
  [4,16,-38,2,58,-38,0,58,-38,0,42,-38,18,42],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -19 9 50 -19 0 0 0 -8 1 0 8 0 box2-9.dat
  [1,16,-19,9,50,-19,0,0,0,-8,1,0,8,0, ldraw_lib__box2_9(realsolid)],
// 1 16 -34.5 9 42 0 0 -3.5 9 0 0 0 -1 0 rect.dat
  [1,16,-34.5,9,42,0,0,-3.5,9,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 -20 9 42 0 0 -9 9 0 0 0 -1 0 rect.dat
  [1,16,-20,9,42,0,0,-9,9,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 -4.5 9 42 0 0 -4.5 9 0 0 0 -1 0 rect3.dat
  [1,16,-4.5,9,42,0,0,-4.5,9,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 -20 8 40 0 0 -20 8 0 0 0 1 0 rect3.dat
  [1,16,-20,8,40,0,0,-20,8,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 16 0 0 0 -6 0 4 0 6 0 0 1-4cyli.dat
  [1,16,0,16,0,0,0,-6,0,4,0,6,0,0, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -20 16 0 6 0 0 0 4 0 0 0 6 2-4cyli.dat
  [1,16,-20,16,0,6,0,0,0,4,0,0,0,6, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 16 0 0 0 -6 0 2 0 6 0 0 1-4ndis.dat
  [1,16,0,16,0,0,0,-6,0,2,0,6,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -20 16 0 6 0 0 0 2 0 0 0 6 2-4ndis.dat
  [1,16,-20,16,0,6,0,0,0,2,0,0,0,6, ldraw_lib__2_4ndis(realsolid)],
...
module ldraw_lib__s__60219s01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s__60219s01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
