...
use <s/3068bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3068bp91(realsolid=false) = [
...
// 1 0 0 0 0 4.5 0 0 0 4.5 0 0 0 4.5 4-4disc.dat
  [1,0,0,0,0,4.5,0,0,0,4.5,0,0,0,4.5, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 0 4.5 0 0 0 4.5 0 0 0 4.5 4-4ndis.dat
  [1,16,0,0,0,4.5,0,0,0,4.5,0,0,0,4.5, ldraw_lib__4_4ndis(realsolid)],
...
module ldraw_lib__3068bp91(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068bp91(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
