...
use <../p/bump5000.scad>
$fa=1; $fs=0.2;
function ldraw_lib__56555(realsolid=false) = [
...
// 1 16 0 0 0 12 0 0 0 0 -12 0 1 0 2-4cylc.dat
  [1,16,0,0,0,12,0,0,0,0,-12,0,1,0, ldraw_lib__2_4cylc(realsolid)],
// 1 16 0 0 1 12 0 0 0 0 -12 0 -1 0 2-4disc.dat
  [1,16,0,0,1,12,0,0,0,0,-12,0,-1,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 0 0 0.5 12 0 0 0 10 0 0 0 0.5 box5-4a.dat
  [1,16,0,0,0.5,12,0,0,0,10,0,0,0,0.5, ldraw_lib__box5_4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -1 1 0 0 0 0 1 0 -1 0 bump5000.dat
  [1,16,0,0,-1,1,0,0,0,0,1,0,-1,0, ldraw_lib__bump5000(realsolid)],
// 1 16 0 0 -1 1 0 0 0 0 1 0 1 0 4-4ring1.dat
  [1,16,0,0,-1,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4ring1(realsolid)],
// 1 16 0 0 -1 2 0 0 0 0 2 0 1 0 4-4ring1.dat
  [1,16,0,0,-1,2,0,0,0,0,2,0,1,0, ldraw_lib__4_4ring1(realsolid)],
...
// 1 16 0 0 0 2 0 0 0 0 2 0 -1 0 4-4con2.dat
  [1,16,0,0,0,2,0,0,0,0,2,0,-1,0, ldraw_lib__4_4con2(realsolid)],
...
module ldraw_lib__56555(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__56555(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
