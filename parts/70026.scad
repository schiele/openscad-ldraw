...
use <868.scad>
$fa=1; $fs=0.2;
function ldraw_lib__70026(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 459b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__459b(realsolid)],
// 1 0 -40 -8 0 0 0 1 0 1 0 -1 0 0 868.dat
  [1,0,-40,-8,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__868(realsolid)],
];
module ldraw_lib__70026(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__70026(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
