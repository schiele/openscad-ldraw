...
use <s/41944s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__41944p02(realsolid=false) = [
...
// 1 0 0 -12.02133 -7.12133 2.5 0 0 0 1 -1.767775 0 0 1.767775 4-4disc.dat
  [1,0,0,-12.02133,-7.12133,2.5,0,0,0,1,-1.767775,0,0,1.767775, ldraw_lib__4_4disc(realsolid)],
// 1 80 0 -9.9 -5 1 0 0 0 .70711 -.70711 0 .70711 .70711 s\41944s03.dat
  [1,80,0,-9.9,-5,1,0,0,0,.70711,-.70711,0,.70711,.70711, ldraw_lib__s__41944s03(realsolid)],
// 1 80 0 -9.9 -5 -1 0 0 0 .70711 -.70711 0 .70711 .70711 s\41944s03.dat
  [1,80,0,-9.9,-5,-1,0,0,0,.70711,-.70711,0,.70711,.70711, ldraw_lib__s__41944s03(realsolid)],
];
module ldraw_lib__41944p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__41944p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
