...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 4864bpx3, Rebrickable 4864bpr0008, Set 10020
// 
// 0 !CMDLINE -c47
// 
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\4864bp12s01.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4864bp12s01()],
];
module ldraw_lib__4864bp13(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4864bp13(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4864bp13(line=0.2);