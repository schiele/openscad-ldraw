...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS 9V, BrickLink 2974c01, dacta, Mindstorm, RCX, Rebrickable 2974c01
// 
// 0 !CMDLINE -c14
// 
...
// 1 0 20 40 0 -1 0 0 0 1 0 0 0 -1 6625c01.dat
  [1,0,20,40,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__6625c01()],
...
// 1 256 -160 44.5 0 0 164 0 1 0 0 0 0 1 993.dat
  [1,256,-160,44.5,0,0,164,0,1,0,0,0,0,1, ldraw_lib__993()],
...
module ldraw_lib__72631c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__72631c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
