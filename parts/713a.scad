...
use <../p/stug-4x4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__713a(realsolid=false) = [
...
// 1 16 20 8 -20 0 0 60 0 -8 0 60 0 0 48\1-4cylo.dat
  [1,16,20,8,-20,0,0,60,0,-8,0,60,0,0, ldraw_lib__48__1_4cylo(realsolid)],
...
module ldraw_lib__713a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__713a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
