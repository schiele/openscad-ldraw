...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__85834(realsolid=false) = [
...
// 1 16 0 -6 0 1 0 0 0 -1.5 0 0 0 1 stud4a.dat
  [1,16,0,-6,0,1,0,0,0,-1.5,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 
// 1 16 0 -6 0 1 0 0 0 1 0 0 0 1 axl3hol3.dat
  [1,16,0,-6,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl3hol3(realsolid)],
// 1 16 0 -6 0 1 0 0 0 1 0 0 0 1 axl3hol9.dat
  [1,16,0,-6,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl3hol9(realsolid)],
// 1 16 0 -6 0 1 0 0 0 -1 0 0 0 1 axl3ho10.dat
  [1,16,0,-6,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__axl3ho10(realsolid)],
// 1 16 0 -28 0 1 0 0 0 22 0 0 0 1 axl3hol8.dat
  [1,16,0,-28,0,1,0,0,0,22,0,0,0,1, ldraw_lib__axl3hol8(realsolid)],
// 1 16 0 -28 0 1 0 0 0 1 0 0 0 1 axl3hol2.dat
  [1,16,0,-28,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl3hol2(realsolid)],
// 1 16 0 -28 0 1 0 0 0 1 0 0 0 1 axl3hol9.dat
  [1,16,0,-28,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl3hol9(realsolid)],
// 1 16 0 -28 0 1 0 0 0 -1 0 0 0 1 axl3end.dat
  [1,16,0,-28,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__axl3end(realsolid)],
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\85834s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__85834s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\85834s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__85834s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\85834s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__85834s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\85834s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__85834s02(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\85834s03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__85834s03(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\85834s03.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__85834s03(realsolid)],
];
module ldraw_lib__85834(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__85834(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
