...
use <u9230.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9230c01(realsolid=false) = [
...
// 1 0 0 -80 180 1 0 0 0 1 0 0 0 1 3245bp02.dat
  [1,0,0,-80,180,1,0,0,0,1,0,0,0,1, ldraw_lib__3245bp02(realsolid)],
];
module ldraw_lib__u9230c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9230c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
