...
use <24118p02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__26530(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 24118p02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__24118p02(realsolid)],
];
module ldraw_lib__26530(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__26530(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
