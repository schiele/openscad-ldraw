...
// 1 16 0 6 0 -0.6 0 0 0 0.6 0 0 0 -1 s\3009p17a.dat
  [1,16,0,6,0,-0.6,0,0,0,0.6,0,0,0,-1, ldraw_lib__s__3009p17a()],
...
module ldraw_lib__4865apt2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4865apt2(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
