...
use <92255.scad>
function ldraw_lib__92198p01c05() = [
...
// 1 29 0 0 0 1 0 0 0 1 0 0 0 1 92250p08c01.dat
  [1,29,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__92250p08c01()],
...
module ldraw_lib__92198p01c05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92198p01c05(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
