...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4597(realsolid=false) = [
// 0 Cockpit  6 x  6
// 0 Name: 4597.dat
...
// 1 16 -20 28 20 -1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-20,28,20,-1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
// 1 16 -20 28 0 -1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-20,28,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
// 1 16 -30 28 38 -1.5 0 0 0 4 0 0 0 -2 box4-1.dat
  [1,16,-30,28,38,-1.5,0,0,0,4,0,0,0,-2, ldraw_lib__box4_1(realsolid)],
// 1 16 -10 28 38 -1.5 0 0 0 4 0 0 0 -2 box4-1.dat
  [1,16,-10,28,38,-1.5,0,0,0,4,0,0,0,-2, ldraw_lib__box4_1(realsolid)],
// 1 16 10 28 38 -1.5 0 0 0 4 0 0 0 -2 box4-1.dat
  [1,16,10,28,38,-1.5,0,0,0,4,0,0,0,-2, ldraw_lib__box4_1(realsolid)],
// 1 16 30 28 38 -1.5 0 0 0 4 0 0 0 -2 box4-1.dat
  [1,16,30,28,38,-1.5,0,0,0,4,0,0,0,-2, ldraw_lib__box4_1(realsolid)],
...
// 1 16 -20 4 50 -1 0 0 0 -7 0 0 0 1 stud3.dat
  [1,16,-20,4,50,-1,0,0,0,-7,0,0,0,1, ldraw_lib__stud3(realsolid)],
...
// 1 16 42 4 50 2 0 0 0 4 0 0 0 1.5 box5.dat
  [1,16,42,4,50,2,0,0,0,4,0,0,0,1.5, ldraw_lib__box5(realsolid)],
// 1 16 -42 4 50 2 0 0 0 4 0 0 0 1.5 box5.dat
  [1,16,-42,4,50,2,0,0,0,4,0,0,0,1.5, ldraw_lib__box5(realsolid)],
// 1 16 42 4 -50 2 0 0 0 4 0 0 0 1.5 box5.dat
  [1,16,42,4,-50,2,0,0,0,4,0,0,0,1.5, ldraw_lib__box5(realsolid)],
...
// 1 16 0 28 0 36 0 0 0 4 0 0 0 40 box4.dat
  [1,16,0,28,0,36,0,0,0,4,0,0,0,40, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 32 50 -36 0 0 0 -28 0 0 0 6 box5.dat
  [1,16,0,32,50,-36,0,0,0,-28,0,0,0,6, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 32 -50 -36 0 0 0 -28 0 0 0 6 box5.dat
  [1,16,0,32,-50,-36,0,0,0,-28,0,0,0,6, ldraw_lib__box5(realsolid)],
...
// 1 16 42 8 0 -2 0 0 0 -1 0 0 0 44 rect.dat
  [1,16,42,8,0,-2,0,0,0,-1,0,0,0,44, ldraw_lib__rect(realsolid)],
// 1 16 -42 8 0 -2 0 0 0 -1 0 0 0 44 rect.dat
  [1,16,-42,8,0,-2,0,0,0,-1,0,0,0,44, ldraw_lib__rect(realsolid)],
// 
...
module ldraw_lib__4597(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4597(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
