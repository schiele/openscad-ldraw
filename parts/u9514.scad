...
use <s/u9517s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9514(realsolid=false) = [
...
// 1 16 0 2 -24 0 0 2 0 1 0 -2 0 0 4-8sphe.dat
  [1,16,0,2,-24,0,0,2,0,1,0,-2,0,0, ldraw_lib__4_8sphe(realsolid)],
// 1 16 0 0 -24 0 0 2 0 2 0 -2 0 0 4-4cyli.dat
  [1,16,0,0,-24,0,0,2,0,2,0,-2,0,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -24 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,0,0,-24,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -24 4.5 0 0 0 -1 0 0 0 2 rect.dat
  [1,16,0,0,-24,4.5,0,0,0,-1,0,0,0,2, ldraw_lib__rect(realsolid)],
];
module ldraw_lib__u9514(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9514(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
