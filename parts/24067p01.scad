...
use <s/24067s04.scad>
use <../p/stud4.scad>
function ldraw_lib__24067p01() = [
// 0 Minifig Bundled Baby with Stud Holder on Back with Yellow Smiling Face and Small Eyes Pattern
// 0 Name: 24067p01.dat
...
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 s\24067p01s02.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__24067p01s02()],
// 1 14 0 0 0 -1 0 0 0 1 0 0 0 1 s\24067p01s02.dat
  [1,14,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__24067p01s02()],
// 
...
module ldraw_lib__24067p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__24067p01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__24067p01(line=0.2);