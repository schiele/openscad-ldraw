...
use <4288.scad>
$fa=1; $fs=0.2;
function ldraw_lib__122c07(realsolid=false) = [
...
// 1 256 39 6 0 0 0 -1 0 1 0 1 0 0 4288.dat
  [1,256,39,6,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__4288(realsolid)],
// 1 256 -39 6 0 0 0 1 0 1 0 -1 0 0 4288.dat
  [1,256,-39,6,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__4288(realsolid)],
];
module ldraw_lib__122c07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__122c07(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
