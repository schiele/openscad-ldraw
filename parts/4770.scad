...
// 1 16 0 -12 0 8 0 0 0 -6 0 0 0 8 4-8sphe.dat
  [1,16,0,-12,0,8,0,0,0,-6,0,0,0,8, ldraw_lib__4_8sphe()],
// 1 16 0 -12 0 8 0 0 0 11 0 0 0 8 4-4cyli.dat
  [1,16,0,-12,0,8,0,0,0,11,0,0,0,8, ldraw_lib__4_4cyli()],
...
// 1 16 0 -1 0 7 0 0 0 1 0 0 0 7 4-4edge.dat
  [1,16,0,-1,0,7,0,0,0,1,0,0,0,7, ldraw_lib__4_4edge()],
// 1 16 0 -1 0 7 0 0 0 1 0 0 0 7 4-4cyli.dat
  [1,16,0,-1,0,7,0,0,0,1,0,0,0,7, ldraw_lib__4_4cyli()],
...
module ldraw_lib__4770(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4770(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
