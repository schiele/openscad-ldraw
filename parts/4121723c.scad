...
// 1 4 -30.7 -.25 -.4 1.2 0 0 0 1 0 0 0 1.2 s\4121723s05.dat
  [1,4,-30.7,-.25,-.4,1.2,0,0,0,1,0,0,0,1.2, ldraw_lib__s__4121723s05()],
// 1 16 -30.7 -.25 -.4 1.2 0 0 0 1 0 0 0 1.2 s\4121723s07.dat
  [1,16,-30.7,-.25,-.4,1.2,0,0,0,1,0,0,0,1.2, ldraw_lib__s__4121723s07()],
// 1 4 7.7 -.25 -.4 1.2 0 0 0 1 0 0 0 1.2 s\4121723s06.dat
  [1,4,7.7,-.25,-.4,1.2,0,0,0,1,0,0,0,1.2, ldraw_lib__s__4121723s06()],
// 1 16 7.7 -.25 -.4 1.2 0 0 0 1 0 0 0 1.2 s\4121723s08.dat
  [1,16,7.7,-.25,-.4,1.2,0,0,0,1,0,0,0,1.2, ldraw_lib__s__4121723s08()],
];
module ldraw_lib__4121723c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4121723c(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
