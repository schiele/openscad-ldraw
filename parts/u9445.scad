...
use <../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9445(realsolid=false) = [
...
// 1 16 20 -.25 20 4 0 0 0 .25 0 0 0 4 1-4cylo.dat
  [1,16,20,-.25,20,4,0,0,0,.25,0,0,0,4, ldraw_lib__1_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -20 -.25 20 -4 0 0 0 .25 0 0 0 4 1-4cylo.dat
  [1,16,-20,-.25,20,-4,0,0,0,.25,0,0,0,4, ldraw_lib__1_4cylo(realsolid)],
...
// 1 16 61 -.25 61 4 0 0 0 .25 0 0 0 4 1-4cylo.dat
  [1,16,61,-.25,61,4,0,0,0,.25,0,0,0,4, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -61 -.25 61 -4 0 0 0 .25 0 0 0 4 1-4cylo.dat
  [1,16,-61,-.25,61,-4,0,0,0,.25,0,0,0,4, ldraw_lib__1_4cylo(realsolid)],
// 1 16 61 -.25 -61 4 0 0 0 .25 0 0 0 -4 1-4cylo.dat
  [1,16,61,-.25,-61,4,0,0,0,.25,0,0,0,-4, ldraw_lib__1_4cylo(realsolid)],
...
// 1 16 0 -.125 65 -61 0 0 0 0 -.125 0 -1 0 rect2p.dat
  [1,16,0,-.125,65,-61,0,0,0,0,-.125,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 -.125 24 -20 0 0 0 0 .125 0 1 0 rect2p.dat
  [1,16,0,-.125,24,-20,0,0,0,0,.125,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 65 -.125 0 0 -1 0 0 0 -.125 61 0 0 rect2p.dat
  [1,16,65,-.125,0,0,-1,0,0,0,-.125,61,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 24 -.125 0 0 1 0 0 0 .125 20 0 0 rect2p.dat
  [1,16,24,-.125,0,0,1,0,0,0,.125,20,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 -.125 -65 61 0 0 0 0 -.125 0 1 0 rect2p.dat
  [1,16,0,-.125,-65,61,0,0,0,0,-.125,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 -.125 -24 20 0 0 0 0 .125 0 -1 0 rect2p.dat
  [1,16,0,-.125,-24,20,0,0,0,0,.125,0,-1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 20 -.25 20 4 0 0 0 1 0 0 0 4 1-4ndis.dat
  [1,16,20,-.25,20,4,0,0,0,1,0,0,0,4, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -20 -.25 20 -4 0 0 0 1 0 0 0 4 1-4ndis.dat
  [1,16,-20,-.25,20,-4,0,0,0,1,0,0,0,4, ldraw_lib__1_4ndis(realsolid)],
// 1 16 20 -.25 -20 4 0 0 0 1 0 0 0 -4 1-4ndis.dat
  [1,16,20,-.25,-20,4,0,0,0,1,0,0,0,-4, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 61 -.25 61 4 0 0 0 1 0 0 0 4 1-4chrd.dat
  [1,16,61,-.25,61,4,0,0,0,1,0,0,0,4, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -61 -.25 61 -4 0 0 0 1 0 0 0 4 1-4chrd.dat
  [1,16,-61,-.25,61,-4,0,0,0,1,0,0,0,4, ldraw_lib__1_4chrd(realsolid)],
// 1 16 61 -.25 -61 4 0 0 0 1 0 0 0 -4 1-4chrd.dat
  [1,16,61,-.25,-61,4,0,0,0,1,0,0,0,-4, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 20 0 20 4 0 0 0 -1 0 0 0 4 1-4ndis.dat
  [1,16,20,0,20,4,0,0,0,-1,0,0,0,4, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -20 0 20 -4 0 0 0 -1 0 0 0 4 1-4ndis.dat
  [1,16,-20,0,20,-4,0,0,0,-1,0,0,0,4, ldraw_lib__1_4ndis(realsolid)],
// 1 16 20 0 -20 4 0 0 0 -1 0 0 0 -4 1-4ndis.dat
  [1,16,20,0,-20,4,0,0,0,-1,0,0,0,-4, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 61 0 61 4 0 0 0 -1 0 0 0 4 1-4chrd.dat
  [1,16,61,0,61,4,0,0,0,-1,0,0,0,4, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -61 0 61 -4 0 0 0 -1 0 0 0 4 1-4chrd.dat
  [1,16,-61,0,61,-4,0,0,0,-1,0,0,0,4, ldraw_lib__1_4chrd(realsolid)],
// 1 16 61 0 -61 4 0 0 0 -1 0 0 0 -4 1-4chrd.dat
  [1,16,61,0,-61,4,0,0,0,-1,0,0,0,-4, ldraw_lib__1_4chrd(realsolid)],
...
module ldraw_lib__u9445(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9445(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
