...
use <267a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__267(realsolid=false) = [
// 0 ~Moved to 267a
// 0 Name: 267.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 267a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__267a(realsolid)],
];
module ldraw_lib__267(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__267(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
