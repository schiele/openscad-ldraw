...
use <../p/stud2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2711(realsolid=false) = [
...
// 1 16 20 8 0 6 0 0 0 -4 0 0 0 6 box5.dat
  [1,16,20,8,0,6,0,0,0,-4,0,0,0,6, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -20 8 0 6 0 0 0 -4 0 0 0 6 box5.dat
  [1,16,-20,8,0,6,0,0,0,-4,0,0,0,6, ldraw_lib__box5(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 8 0 0 0 1 axlehole.dat
  [1,16,0,0,0,1,0,0,0,8,0,0,0,1, ldraw_lib__axlehole(realsolid)],
...
// 1 16 0 8 0 1 0 0 0 1 0 0 0 1 axlehol2.dat
  [1,16,0,8,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axlehol2(realsolid)],
...
// 1 16 30 7 0 0 -1 0 1 0 0 0 0 -10 rect.dat
  [1,16,30,7,0,0,-1,0,1,0,0,0,0,-10, ldraw_lib__rect(realsolid)],
// 1 16 -30 7 0 0 1 0 1 0 0 0 0 10 rect.dat
  [1,16,-30,7,0,0,1,0,1,0,0,0,0,10, ldraw_lib__rect(realsolid)],
// 
...
// 1 16 40 0 0 0 0 1 0 1 0 -1 0 0 steerend.dat
  [1,16,40,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__steerend(realsolid)],
// 1 16 -40 0 0 0 0 -1 0 1 0 1 0 0 steerend.dat
  [1,16,-40,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__steerend(realsolid)],
// 
...
module ldraw_lib__2711(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2711(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
