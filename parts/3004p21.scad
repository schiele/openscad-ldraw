...
$fa=1; $fs=0.2;
function ldraw_lib__3004p21(realsolid=false) = [
...
// 1 16 0 1 -10 1 0 0 0 0 -1 0 1 0 s\3039p08s02.dat
  [1,16,0,1,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__s__3039p08s02(realsolid)],
// 1 16 0 1 -10 -1 0 0 0 0 -1 0 1 0 s\3039p08s02.dat
  [1,16,0,1,-10,-1,0,0,0,0,-1,0,1,0, ldraw_lib__s__3039p08s02(realsolid)],
...
module ldraw_lib__3004p21(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3004p21(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
