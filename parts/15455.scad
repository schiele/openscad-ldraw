...
use <../p/stug-4x1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__15455(realsolid=false) = [
...
// 1 16 0 -40 -90 0 0 1 0 1 0 -1 0 0 stug-4x1.dat
  [1,16,0,-40,-90,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_4x1(realsolid)],
// 
...
module ldraw_lib__15455(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__15455(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
