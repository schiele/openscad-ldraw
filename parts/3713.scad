...
use <../p/bush.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3713(realsolid=false) = [
...
// 1 16 0 0 -10 0 0 3 3 0 0 0 1 0 4-4ring2.dat
  [1,16,0,0,-10,0,0,3,3,0,0,0,1,0, ldraw_lib__4_4ring2(realsolid)],
// 1 16 0 0 -10 0 0 9 9 0 0 0 1 0 4-4edge.dat
  [1,16,0,0,-10,0,0,9,9,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -7 0 0 9 9 0 0 0 1 0 4-4edge.dat
  [1,16,0,0,-7,0,0,9,9,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 -10 0 0 9 9 0 0 0 3 0 4-4cyli.dat
  [1,16,0,0,-10,0,0,9,9,0,0,0,3,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -6.5 0 0 1 1 0 0 0 0.5 0 4-4con7.dat
  [1,16,0,0,-6.5,0,0,1,1,0,0,0,0.5,0, ldraw_lib__4_4con7(realsolid)],
// 1 16 0 0 -7 0 0 1 1 0 0 0 0.5 0 4-4con8.dat
  [1,16,0,0,-7,0,0,1,1,0,0,0,0.5,0, ldraw_lib__4_4con8(realsolid)],
// 0
];
module ldraw_lib__3713(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3713(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
