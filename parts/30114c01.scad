...
use <30126p01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30114c01(realsolid=false) = [
...
// 0 !KEYWORDS american native, boy, Feather, female, hippie, indian, male, man
// 0 !KEYWORDS men, plait, squaw, Warrior, west, western, wild west, woman, women
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 30114.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30114(realsolid)],
// 
// 0 // Minifig Feathers with Pin and Black Tip Pattern
// 1 15 0 3.83 17.76 1 0 0 0 1 0 0 0 1 30126p01.dat
  [1,15,0,3.83,17.76,1,0,0,0,1,0,0,0,1, ldraw_lib__30126p01(realsolid)],
// 0
];
module ldraw_lib__30114c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30114c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
