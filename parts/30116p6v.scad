...
use <../p/stug-2x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30116p6v(realsolid=false) = [
...
// 1 16 0 0 0 0 0 -1 0 1 0 -1 0 0 s\30116p6ua.dat
  [1,16,0,0,0,0,0,-1,0,1,0,-1,0,0, ldraw_lib__s__30116p6ua(realsolid)],
...
module ldraw_lib__30116p6v(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30116p6v(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
