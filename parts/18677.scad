...
$fa=1; $fs=0.2;
function ldraw_lib__18677(realsolid=false) = [
...
// 1 16 -1.5 4 0 0 0 -2.5 0 4 0 2 0 0 box4-1.dat
  [1,16,-1.5,4,0,0,0,-2.5,0,4,0,2,0,0, ldraw_lib__box4_1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -7.5 8 0 0 0 -8.5 0 -4 0 6 0 0 box5-1.dat
  [1,16,-7.5,8,0,0,0,-8.5,0,-4,0,6,0,0, ldraw_lib__box5_1(realsolid)],
// 1 16 10 10 10 9 0 0 0 0 9 0 -20 0 2-4cylo.dat
  [1,16,10,10,10,9,0,0,0,0,9,0,-20,0, ldraw_lib__2_4cylo(realsolid)],
// 2 24 1 8 10 1 10 10
  [2,24,1,8,10,1,10,10],
// 2 24 1 8 -10 1 10 -10
  [2,24,1,8,-10,1,10,-10],
...
// 1 16 -9.5 8 0 0 0 -10.5 0 1 0 10 0 0 recte3.dat
  [1,16,-9.5,8,0,0,0,-10.5,0,1,0,10,0,0, ldraw_lib__recte3(realsolid)],
...
// 1 16 10 10 0 1 0 0 0 0 1 0 1 0 connhole.dat
  [1,16,10,10,0,1,0,0,0,0,1,0,1,0, ldraw_lib__connhole(realsolid)],
// 1 16 10 10 10 9 0 0 0 0 -9 0 -1 0 2-4ndis.dat
  [1,16,10,10,10,9,0,0,0,0,-9,0,-1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 10 10 -10 9 0 0 0 0 -9 0 1 0 2-4ndis.dat
  [1,16,10,10,-10,9,0,0,0,0,-9,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 19 9 0 0 -1 0 1 0 0 0 0 10 rect2p.dat
  [1,16,19,9,0,0,-1,0,1,0,0,0,0,10, ldraw_lib__rect2p(realsolid)],
...
// 1 16 19.5 4 0 0 0.5 0 0 0 4 10 0 0 box2-5.dat
  [1,16,19.5,4,0,0,0.5,0,0,0,4,10,0,0, ldraw_lib__box2_5(realsolid)],
// 1 16 0 4 0 0 0 -20 0 -4 0 -10 0 0 box2-7.dat
  [1,16,0,4,0,0,0,-20,0,-4,0,-10,0,0, ldraw_lib__box2_7(realsolid)],
...
module ldraw_lib__18677(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__18677(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
