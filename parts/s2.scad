...
use <192425b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__s2(realsolid=false) = [
// 0 ~Moved to 192425b
// 0 Name: s2.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 192425b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__192425b(realsolid)],
];
module ldraw_lib__s2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__s2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
