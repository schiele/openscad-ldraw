...
use <64898.scad>
$fa=1; $fs=0.2;
function ldraw_lib__64892(realsolid=false) = [
...
// 1 72 0 -40 -39 1 0 0 0 1 0 0 0 1 64893.dat
  [1,72,0,-40,-39,1,0,0,0,1,0,0,0,1, ldraw_lib__64893(realsolid)],
// 1 47 7.5 -42 -60 0 1 0 -1 0 0 0 0 1 64897.dat
  [1,47,7.5,-42,-60,0,1,0,-1,0,0,0,0,1, ldraw_lib__64897(realsolid)],
// 1 47 -7.5 -42 -64 1 0 0 0 1 0 0 0 1 64898.dat
  [1,47,-7.5,-42,-64,1,0,0,0,1,0,0,0,1, ldraw_lib__64898(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 72 -7.5 -42 -51 5 0 0 0 0 5 0 -20 0 4-4cylc.dat
  [1,72,-7.5,-42,-51,5,0,0,0,0,5,0,-20,0, ldraw_lib__4_4cylc(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 72 7.5 -42 -51 7 0 0 0 0 7 0 -20 0 4-4cylc.dat
  [1,72,7.5,-42,-51,7,0,0,0,0,7,0,-20,0, ldraw_lib__4_4cylc(realsolid)],
...
module ldraw_lib__64892(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__64892(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
