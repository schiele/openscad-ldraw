...
use <s/3004s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3004p51(realsolid=false) = [
...
// 1 4 0 16 -10 4 0 0 0 0 4 0 1 0 4-4disc.dat
  [1,4,0,16,-10,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 16 -10 4 0 0 0 0 4 0 1 0 4-4ndis.dat
  [1,16,0,16,-10,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 0 -8 6 -10 3 0 0 0 0 3 0 1 0 4-4disc.dat
  [1,0,-8,6,-10,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 -8 6 -10 3 0 0 0 0 3 0 1 0 4-4ndis.dat
  [1,16,-8,6,-10,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 0 8 6 -10 3 0 0 0 0 3 0 1 0 4-4disc.dat
  [1,0,8,6,-10,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 8 6 -10 3 0 0 0 0 3 0 1 0 4-4ndis.dat
  [1,16,8,6,-10,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 4 16 -20 0 -10 20 0 -10 5 3 -10 -5 3 -10
  [4,16,-20,0,-10,20,0,-10,5,3,-10,-5,3,-10],
// 3 16 -20 0 -10 -5 3 -10 -11 3 -10
  [3,16,-20,0,-10,-5,3,-10,-11,3,-10],
// 3 16 11 3 -10 5 3 -10 20 0 -10
  [3,16,11,3,-10,5,3,-10,20,0,-10],
// 4 16 -20 0 -10 -11 3 -10 -11 9 -10 -20 24 -10
  [4,16,-20,0,-10,-11,3,-10,-11,9,-10,-20,24,-10],
// 4 16 11 9 -10 11 3 -10 20 0 -10 20 24 -10
  [4,16,11,9,-10,11,3,-10,20,0,-10,20,24,-10],
// 4 16 -20 24 -10 -11 9 -10 -5 9 -10 -4 12 -10
  [4,16,-20,24,-10,-11,9,-10,-5,9,-10,-4,12,-10],
// 4 16 5 9 -10 11 9 -10 20 24 -10 4 12 -10
  [4,16,5,9,-10,11,9,-10,20,24,-10,4,12,-10],
...
// 4 16 -20 24 -10 -4 20 -10 4 20 -10 20 24 -10
  [4,16,-20,24,-10,-4,20,-10,4,20,-10,20,24,-10],
// 4 16 -5 3 -10 5 3 -10 5 9 -10 -5 9 -10
  [4,16,-5,3,-10,5,3,-10,5,9,-10,-5,9,-10],
...
module ldraw_lib__3004p51(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3004p51(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
