...
use <54703.scad>
use <u9288.scad>
function ldraw_lib__54701p01c01() = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 54701c01pb01, Rebrickable 54701c01pr0001
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 54701p01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__54701p01()],
...
module ldraw_lib__54701p01c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__54701p01c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
