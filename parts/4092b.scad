...
// 4 16 -50 0 30 -6 0 6 7 0 6 50 0 30
  [4,16,-50,0,30,-6,0,6,7,0,6,50,0,30],
...
// 1 16 0 -4 0 0 0 4 0 8 0 4 0 0 4-4cyli.dat
  [1,16,0,-4,0,0,0,4,0,8,0,4,0,0, ldraw_lib__4_4cyli()],
...
module ldraw_lib__4092b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4092b(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
