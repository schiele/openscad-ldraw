...
use <s/16178s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__16178p01(realsolid=false) = [
...
// 0 !KEYWORDS Bricklink 16178pb01, Set 60074, Set 60125
// 
...
// 1 308 0 0 0 1 0 0 0 1 0 0 0 1 s\16178s02.dat
  [1,308,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__16178s02(realsolid)],
];
module ldraw_lib__16178p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__16178p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
