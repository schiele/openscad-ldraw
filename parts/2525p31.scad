...
use <s/2525s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2525p31(realsolid=false) = [
...
// 1 16 2 48 70 0 -1 0 0 0 -1 1 0 0 s\2525s02.dat
  [1,16,2,48,70,0,-1,0,0,0,-1,1,0,0, ldraw_lib__s__2525s02(realsolid)],
// 1 16 -2 48 70 0 1 0 0 0 -1 1 0 0 s\2525s02.dat
  [1,16,-2,48,70,0,1,0,0,0,-1,1,0,0, ldraw_lib__s__2525s02(realsolid)],
// 0 //
];
module ldraw_lib__2525p31(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2525p31(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
