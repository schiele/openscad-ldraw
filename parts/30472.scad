...
// 1 16 0 12 0 0 20 0 12 0 0 0 0 10 box3u4a.dat
  [1,16,0,12,0,0,20,0,12,0,0,0,0,10, ldraw_lib__box3u4a()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 0 0 6 0 0 0 2 0 0 0 6 box5.dat
  [1,16,10,0,0,6,0,0,0,2,0,0,0,6, ldraw_lib__box5()],
// 1 16 -10 24 0 0 0 -10 0 -24 0 10 0 0 box4-4a.dat
  [1,16,-10,24,0,0,0,-10,0,-24,0,10,0,0, ldraw_lib__box4_4a()],
...
module ldraw_lib__30472(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30472(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
