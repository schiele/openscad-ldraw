...
use <../p/4-4ring2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9226(realsolid=false) = [
...
// 1 16 0 0 0 6 0 0 0 24 0 0 0 6 4-4cyli.dat
  [1,16,0,0,0,6,0,0,0,24,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 0 6 0 0 0 22 0 0 0 6 4-4edge.dat
  [1,16,0,0,0,6,0,0,0,22,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 0 4 0 0 0 22 0 0 0 4 4-4edge.dat
  [1,16,0,0,0,4,0,0,0,22,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 24 0 6 0 0 0 22 0 0 0 6 4-4edge.dat
  [1,16,0,24,0,6,0,0,0,22,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 24 0 4 0 0 0 22 0 0 0 4 4-4edge.dat
  [1,16,0,24,0,4,0,0,0,22,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 24 0 2 0 0 0 -1 0 0 0 -2 4-4ring2.dat
  [1,16,0,24,0,2,0,0,0,-1,0,0,0,-2, ldraw_lib__4_4ring2(realsolid)],
];
module ldraw_lib__u9226(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9226(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
