...
use <../p/4-4ring1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9473(realsolid=false) = [
...
// 1 16 0 38 0 2 0 0 0 -38 0 0 0 2 4-4cylc.dat
  [1,16,0,38,0,2,0,0,0,-38,0,0,0,2, ldraw_lib__4_4cylc(realsolid)],
...
module ldraw_lib__u9473(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9473(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
