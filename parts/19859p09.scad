...
use <s/19859s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__19859p09(realsolid=false) = [
...
// 1 191 0 0 0 1 0 0 0 1 0 0 0 1 s\19859s02.dat
  [1,191,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__19859s02(realsolid)],
];
module ldraw_lib__19859p09(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__19859p09(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
