...
// 
// 0 !CATEGORY Brick
// 0 !KEYWORDS Automatic Binding Brick, BrickLink bslot04bR, Lego Mursten
// 0 !KEYWORDS Rebrickable upn0041b
// 
...
module ldraw_lib__u8004d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8004d(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
