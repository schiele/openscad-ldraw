...
$fa=1; $fs=0.2;
function ldraw_lib__u9107p04c02(realsolid=false) = [
// 0 _Figure Fabuland Raccoon  1 with Body Black/Yellow/Blue
// 0 Name: u9107p04c02.dat
...
module ldraw_lib__u9107p04c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9107p04c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9107p04c02(line=0.2);