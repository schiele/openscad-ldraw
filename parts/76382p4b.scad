...
use <3820.scad>
use <973p4b.scad>
function ldraw_lib__76382p4b() = [
// 0 Minifig Torso with Arms and Hands with Dragon Head Pattern
// 0 Name: 76382p4b.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973p4b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973p4b()],
...
module ldraw_lib__76382p4b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382p4b(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382p4b(line=0.2);