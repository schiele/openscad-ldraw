...
use <s/4209s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3245bp04(realsolid=false) = [
...
// 1 16 0 22 -10 .14 0 0 0 0 -.14 0 .14 0 s\4209s01.dat
  [1,16,0,22,-10,.14,0,0,0,0,-.14,0,.14,0, ldraw_lib__s__4209s01(realsolid)],
...
module ldraw_lib__3245bp04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3245bp04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
