...
$fa=1; $fs=0.2;
function ldraw_lib__4229(realsolid=false) = [
...
// 1 16 0 26 0 .86603 .5 0 -.5 .86603 0 0 0 1 s\4229s01.dat
  [1,16,0,26,0,.86603,.5,0,-.5,.86603,0,0,0,1, ldraw_lib__s__4229s01(realsolid)],
// 1 16 0 26 0 .5 .86603 0 -.86603 .5 0 0 0 1 s\4229s01.dat
  [1,16,0,26,0,.5,.86603,0,-.86603,.5,0,0,0,1, ldraw_lib__s__4229s01(realsolid)],
// 1 16 0 26 0 0 1 0 -1 0 0 0 0 1 s\4229s01.dat
  [1,16,0,26,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__s__4229s01(realsolid)],
// 1 16 0 26 0 -.5 .86603 0 -.86603 -.5 0 0 0 1 s\4229s01.dat
  [1,16,0,26,0,-.5,.86603,0,-.86603,-.5,0,0,0,1, ldraw_lib__s__4229s01(realsolid)],
// 1 16 0 26 0 0 -1 0 1 0 0 0 0 1 s\4229s01.dat
  [1,16,0,26,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__s__4229s01(realsolid)],
...
// 1 16 0 26 0 1 0 0 0 1 0 0 0 1 s\4229s01.dat
  [1,16,0,26,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4229s01(realsolid)],
// 1 16 0 26 0 -.86603 .5 0 -.5 -.86603 0 0 0 1 s\4229s01.dat
  [1,16,0,26,0,-.86603,.5,0,-.5,-.86603,0,0,0,1, ldraw_lib__s__4229s01(realsolid)],
// 1 16 0 26 0 -1 0 0 0 -1 0 0 0 1 s\4229s01.dat
  [1,16,0,26,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__s__4229s01(realsolid)],
...
// 1 16 0 4 0 20 0 0 0 -4 0 0 0 20 box5.dat
  [1,16,0,4,0,20,0,0,0,-4,0,0,0,20, ldraw_lib__box5(realsolid)],
// 1 16 -11 4 0 9 0 0 0 -1 0 0 0 -20 rect1.dat
  [1,16,-11,4,0,9,0,0,0,-1,0,0,0,-20, ldraw_lib__rect1(realsolid)],
// 1 16 11 4 0 -9 0 0 0 -1 0 0 0 -20 rect1.dat
  [1,16,11,4,0,-9,0,0,0,-1,0,0,0,-20, ldraw_lib__rect1(realsolid)],
// 1 16 0 26 40 6 0 0 0 0 6 0 1 0 4-4edge.dat
  [1,16,0,26,40,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 26 -40 6 0 0 0 0 6 0 1 0 4-4edge.dat
  [1,16,0,26,-40,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 26 -36 4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,16,0,26,-36,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 26 -36 4 0 0 0 0 4 0 -4 0 4-4cyli.dat
  [1,16,0,26,-36,4,0,0,0,0,4,0,-4,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 26 -40 1 0 0 0 0 1 0 1 0 stud2a.dat
  [1,16,0,26,-40,1,0,0,0,0,1,0,1,0, ldraw_lib__stud2a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 26 40 6 0 0 0 0 6 0 -60 0 4-4cyli.dat
  [1,16,0,26,40,6,0,0,0,0,6,0,-60,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 26 -36 1 0 0 0 0 1 0 16 0 axlehole.dat
  [1,16,0,26,-36,1,0,0,0,0,1,0,16,0, ldraw_lib__axlehole(realsolid)],
// 1 16 0 26 -36 1 0 0 0 0 1 0 1 0 axlehol2.dat
  [1,16,0,26,-36,1,0,0,0,0,1,0,1,0, ldraw_lib__axlehol2(realsolid)],
// 1 16 0 26 -20 1 0 0 0 0 1 0 1 0 axlehol3.dat
  [1,16,0,26,-20,1,0,0,0,0,1,0,1,0, ldraw_lib__axlehol3(realsolid)],
// 1 16 0 26 -40 6 0 0 0 0 6 0 1 0 48\4-4aring.dat
  [1,16,0,26,-40,6,0,0,0,0,6,0,1,0, ldraw_lib__48__4_4aring(realsolid)],
// 1 16 0 26 40 6 0 0 0 0 6 0 -1 0 48\4-4aring.dat
  [1,16,0,26,40,6,0,0,0,0,6,0,-1,0, ldraw_lib__48__4_4aring(realsolid)],
// 1 16 0 26 -36 2 0 0 0 0 2 0 -1 0 4-4ring2.dat
  [1,16,0,26,-36,2,0,0,0,0,2,0,-1,0, ldraw_lib__4_4ring2(realsolid)],
// 0 // Faces
...
module ldraw_lib__4229(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4229(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
