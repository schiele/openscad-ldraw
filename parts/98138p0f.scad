...
use <s/98138s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98138p0f(realsolid=false) = [
...
// 1 0 0 0 0 4 0 0 0 1 0 0 0 4 4-4disc.dat
  [1,0,0,0,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4disc(realsolid)],
...
// 1 16 0 0 0 0.5 0 0 0 1 0 0 0 0.5 4-4rin10.dat
  [1,16,0,0,0,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4rin10(realsolid)],
// 1 0 0 0 0 0.5 0 0 0 1 0 0 0 0.5 4-4rin11.dat
  [1,0,0,0,0,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4rin11(realsolid)],
...
module ldraw_lib__98138p0f(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98138p0f(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
