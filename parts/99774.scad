...
use <../p/stud2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__99774(realsolid=false) = [
...
// 1 16 10 1.5 -3.9 0 -1 0 1.5 0 0 0 0 17.9 rect2a.dat
  [1,16,10,1.5,-3.9,0,-1,0,1.5,0,0,0,0,17.9, ldraw_lib__rect2a(realsolid)],
// 1 16 0 3 31.35 -5 0 0 0 -1 0 0 0 8.65 rect3.dat
  [1,16,0,3,31.35,-5,0,0,0,-1,0,0,0,8.65, ldraw_lib__rect3(realsolid)],
...
// 1 16 -10 1.5 -3.9 0 1 0 0 0 1.5 17.9 0 0 rect2a.dat
  [1,16,-10,1.5,-3.9,0,1,0,0,0,1.5,17.9,0,0, ldraw_lib__rect2a(realsolid)],
...
// 1 16 10 -0.6 -30.45 0 -1 0 -1.45 0 -1.45 0.45 0 -4.5 rect3.dat
  [1,16,10,-0.6,-30.45,0,-1,0,-1.45,0,-1.45,0.45,0,-4.5, ldraw_lib__rect3(realsolid)],
// 1 16 7.6 -2.8 -37.25 0 -1 -2.4 -1.45 0 -0.75 0.45 0 -2.3 rect3.dat
  [1,16,7.6,-2.8,-37.25,0,-1,-2.4,-1.45,0,-0.75,0.45,0,-2.3, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 -3.55 -39.55 -5.2 0 0 0 0 1.45 0 1 -0.45 rect2p.dat
  [1,16,0,-3.55,-39.55,-5.2,0,0,0,0,1.45,0,1,-0.45, ldraw_lib__rect2p(realsolid)],
...
// 1 16 10 -0.2 -11.75 0 -1 0 0 0 -0.2 1.75 0 0 rect3.dat
  [1,16,10,-0.2,-11.75,0,-1,0,0,0,-0.2,1.75,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 -4.4 11.75 7.7 0 0 0 1 0 0 0 1.65 rect.dat
  [1,16,0,-4.4,11.75,7.7,0,0,0,1,0,0,0,1.65, ldraw_lib__rect(realsolid)],
// 1 16 10 -0.2 11.75 0 -1 0 0 0 -0.2 1.75 0 0 rect3.dat
  [1,16,10,-0.2,11.75,0,-1,0,0,0,-0.2,1.75,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 0 13.75 -10 0 0 0 1 0 0 0 -0.25 rect3.dat
  [1,16,0,0,13.75,-10,0,0,0,1,0,0,0,-0.25, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 3 0 5 0 0 0 -1 0 0 0 5 4-4ndis.dat
  [1,16,0,3,0,5,0,0,0,-1,0,0,0,5, ldraw_lib__4_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__99774(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__99774(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
