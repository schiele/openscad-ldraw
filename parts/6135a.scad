...
use <../p/axlehol6.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6135a(realsolid=false) = [
...
// 1 16 0 2 0 0 0 -1 0 1 0 1 0 0 axlehol3.dat
  [1,16,0,2,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__axlehol3(realsolid)],
];
module ldraw_lib__6135a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6135a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
