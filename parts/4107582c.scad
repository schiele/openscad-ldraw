...
use <../p/box3u12.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4107582c(realsolid=false) = [
...
// 1 7 15 -0.25 8 1.5 0 0 0 1 0 0 0 1.5 1-4chrd.dat
  [1,7,15,-0.25,8,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 7 15 -0.25 -5 0 0 1.5 0 1 0 -1.5 0 0 1-4chrd.dat
  [1,7,15,-0.25,-5,0,0,1.5,0,1,0,-1.5,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 7 -15 -0.25 -5 -1.5 0 0 0 1 0 0 0 -1.5 1-4chrd.dat
  [1,7,-15,-0.25,-5,-1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 7 -15 -0.25 8 0 0 -1.5 0 1 0 1.5 0 0 1-4chrd.dat
  [1,7,-15,-0.25,8,0,0,-1.5,0,1,0,1.5,0,0, ldraw_lib__1_4chrd(realsolid)],
// 
// 1 0 15 -0.25 -5 0 0 1.5 0 1 0 -1.5 0 0 1-4ring1.dat
  [1,0,15,-0.25,-5,0,0,1.5,0,1,0,-1.5,0,0, ldraw_lib__1_4ring1(realsolid)],
// 1 0 -15 -0.25 -5 -1.5 0 0 0 1 0 0 0 -1.5 1-4ring1.dat
  [1,0,-15,-0.25,-5,-1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__1_4ring1(realsolid)],
// 1 0 -15 -0.25 8 0 0 -1.5 0 1 0 1.5 0 0 1-4ring1.dat
  [1,0,-15,-0.25,8,0,0,-1.5,0,1,0,1.5,0,0, ldraw_lib__1_4ring1(realsolid)],
// 1 0 15 -0.25 8 1.5 0 0 0 1 0 0 0 1.5 1-4ring1.dat
  [1,0,15,-0.25,8,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__1_4ring1(realsolid)],
// 
// 1 16 -15 -0.25 -5 -3 0 0 0 1 0 0 0 -3 1-4ndis.dat
  [1,16,-15,-0.25,-5,-3,0,0,0,1,0,0,0,-3, ldraw_lib__1_4ndis(realsolid)],
// 1 16 15 -0.25 -5 0 0 3 0 1 0 -3 0 0 1-4ndis.dat
  [1,16,15,-0.25,-5,0,0,3,0,1,0,-3,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 17.25 -0.25 -10.25 0.75 0 0 0 1 0 0 0 0.75 1-4ndis.dat
  [1,16,17.25,-0.25,-10.25,0.75,0,0,0,1,0,0,0,0.75, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -17.25 -0.25 -10.25 0 0 -0.75 0 1 0 0.75 0 0 1-4ndis.dat
  [1,16,-17.25,-0.25,-10.25,0,0,-0.75,0,1,0,0.75,0,0, ldraw_lib__1_4ndis(realsolid)],
// 
// 1 0 17.25 -0.25 -10.25 0 0 0.75 0 1 0 -0.75 0 0 2-4chrd.dat
  [1,0,17.25,-0.25,-10.25,0,0,0.75,0,1,0,-0.75,0,0, ldraw_lib__2_4chrd(realsolid)],
// 1 0 -17.25 -0.25 -10.25 0 0 -0.75 0 1 0 0.75 0 0 2-4chrd.dat
  [1,0,-17.25,-0.25,-10.25,0,0,-0.75,0,1,0,0.75,0,0, ldraw_lib__2_4chrd(realsolid)],
// 
...
// 1 16 0 -0.25 -1.125 0 0 18 0 0.25 0 -9.125 0 0 box3u12.dat
  [1,16,0,-0.25,-1.125,0,0,18,0,0.25,0,-9.125,0,0, ldraw_lib__box3u12(realsolid)],
// 
// 1 16 15 -0.25 8 3 0 0 0 0.25 0 0 0 3 1-4cyli.dat
  [1,16,15,-0.25,8,3,0,0,0,0.25,0,0,0,3, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -15 -0.25 8 -3 0 0 0 0.25 0 0 0 3 1-4cyli.dat
  [1,16,-15,-0.25,8,-3,0,0,0,0.25,0,0,0,3, ldraw_lib__1_4cyli(realsolid)],
// 1 16 17.25 -0.25 -10.25 0.75 0 0 0 0.25 0 0 0 -0.75 1-4cyli.dat
  [1,16,17.25,-0.25,-10.25,0.75,0,0,0,0.25,0,0,0,-0.75, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -17.25 -0.25 -10.25 -0.75 0 0 0 0.25 0 0 0 -0.75 1-4cyli.dat
  [1,16,-17.25,-0.25,-10.25,-0.75,0,0,0,0.25,0,0,0,-0.75, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -15 0 8 -3 0 0 0 -1 0 0 0 3 1-4chrd.dat
  [1,16,-15,0,8,-3,0,0,0,-1,0,0,0,3, ldraw_lib__1_4chrd(realsolid)],
// 1 16 15 0 8 3 0 0 0 -1 0 0 0 3 1-4chrd.dat
  [1,16,15,0,8,3,0,0,0,-1,0,0,0,3, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -17.25 0 -10.25 -0.75 0 0 0 -1 0 0 0 -0.75 1-4chrd.dat
  [1,16,-17.25,0,-10.25,-0.75,0,0,0,-1,0,0,0,-0.75, ldraw_lib__1_4chrd(realsolid)],
// 1 16 17.25 0 -10.25 0.75 0 0 0 -1 0 0 0 -0.75 1-4chrd.dat
  [1,16,17.25,0,-10.25,0.75,0,0,0,-1,0,0,0,-0.75, ldraw_lib__1_4chrd(realsolid)],
// 
...
module ldraw_lib__4107582c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4107582c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
