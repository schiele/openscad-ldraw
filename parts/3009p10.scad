...
use <s/3009s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3009p10(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Air Canada, bricklink 3009pb102L, Jetliner, set 611-2
// 
...
module ldraw_lib__3009p10(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3009p10(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
