...
use <4599.scad>
$fa=1; $fs=0.2;
function ldraw_lib__459923(realsolid=false) = [
...
// 1 1 0 0 0 1 0 0 0 1 0 0 0 1 4599.dat
  [1,1,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4599(realsolid)],
];
module ldraw_lib__459923(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__459923(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
