...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 10130c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__10130c01()],
// 1 25 0 0 0 1 0 0 0 1 0 0 0 1 10152.dat
  [1,25,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__10152()],
];
module ldraw_lib__99498(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__99498(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
