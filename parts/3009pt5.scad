...
use <s/3009s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3009pt5(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3009pt5a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3009pt5a(realsolid)],
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\3009pt5b.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3009pt5b(realsolid)],
];
module ldraw_lib__3009pt5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3009pt5(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
