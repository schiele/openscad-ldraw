...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u8027(realsolid=false) = [
...
// 1 16 0 35 -10 29 0 0 0 0 27 0 4 0 box4.dat
  [1,16,0,35,-10,29,0,0,0,0,27,0,4,0, ldraw_lib__box4(realsolid)],
// 1 16 0 35 -10 31 0 0 0 0 29 0 3 0 box4.dat
  [1,16,0,35,-10,31,0,0,0,0,29,0,3,0, ldraw_lib__box4(realsolid)],
...
// 1 16 -45 35 -10 10 0 0 0 0 27 0 4 0 box4.dat
  [1,16,-45,35,-10,10,0,0,0,0,27,0,4,0, ldraw_lib__box4(realsolid)],
// 1 16 -45 35 -10 12 0 0 0 0 29 0 3 0 box4.dat
  [1,16,-45,35,-10,12,0,0,0,0,29,0,3,0, ldraw_lib__box4(realsolid)],
...
// 1 16 0 65 -7 -60 0 0 0 0 1 0 1 0 rect3.dat
  [1,16,0,65,-7,-60,0,0,0,0,1,0,1,0, ldraw_lib__rect3(realsolid)],
// 2 24 60 3 -7 -60 3 -7
  [2,24,60,3,-7,-60,3,-7],
...
// 1 16 -60 36 0.5 0 1 0 -36 0 0 0 0 7.5 rect3.dat
  [1,16,-60,36,0.5,0,1,0,-36,0,0,0,0,7.5, ldraw_lib__rect3(realsolid)],
// 1 16 60 36 0.5 0 -1 0 36 0 0 0 0 7.5 rect3.dat
  [1,16,60,36,0.5,0,-1,0,36,0,0,0,0,7.5, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 72 -9.7 60 0 0 0 -1 0 0 0 -2.75 rect3.dat
  [1,16,0,72,-9.7,60,0,0,0,-1,0,0,0,-2.75, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__u8027(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8027(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u8027(line=0.2);