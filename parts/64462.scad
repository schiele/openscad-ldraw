...
$fa=1; $fs=0.2;
function ldraw_lib__64462(realsolid=false) = [
...
// 1 16 -77.5 80 0 0 0 -1.5 -14 0 0 0 5 0 box4-1.dat
  [1,16,-77.5,80,0,0,0,-1.5,-14,0,0,0,5,0, ldraw_lib__box4_1(realsolid)],
...
// 1 16 -90 90 8 -10 0 0 0 0 10 0 -1 0 1-4chrd.dat
  [1,16,-90,90,8,-10,0,0,0,0,10,0,-1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -90 70 8 -10 0 0 0 0 -10 0 -1 0 1-4chrd.dat
  [1,16,-90,70,8,-10,0,0,0,0,-10,0,-1,0, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 -100 80 4 0 1 0 10 0 0 0 0 -4 rect2p.dat
  [1,16,-100,80,4,0,1,0,10,0,0,0,0,-4, ldraw_lib__rect2p(realsolid)],
...
// 1 16 -97 80 0 1 0 0 0 0 -10 0 1 0 rect1.dat
  [1,16,-97,80,0,1,0,0,0,0,-10,0,1,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 -90 80 2 0 6 0 0 0 16 2 0 0 box3u4a.dat
  [1,16,-90,80,2,0,6,0,0,0,16,2,0,0, ldraw_lib__box3u4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -90 90 0 -6 0 0 0 0 6 0 4 0 1-4cylo.dat
  [1,16,-90,90,0,-6,0,0,0,0,6,0,4,0, ldraw_lib__1_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -90 70 0 -6 0 0 0 0 -6 0 4 0 1-4cylo.dat
  [1,16,-90,70,0,-6,0,0,0,0,-6,0,4,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -96 80 2 0 -1 0 10 0 0 0 0 2 rect2p.dat
  [1,16,-96,80,2,0,-1,0,10,0,0,0,0,2, ldraw_lib__rect2p(realsolid)],
// 1 16 -90 80 4 -1 0 0 0 0 1 0 1 0 stud3.dat
  [1,16,-90,80,4,-1,0,0,0,0,1,0,1,0, ldraw_lib__stud3(realsolid)],
// 1 16 -90 80 4 -4 0 0 0 0 4 0 1 0 4-4ndis.dat
  [1,16,-90,80,4,-4,0,0,0,0,4,0,1,0, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 78 26 2 2 0 0 0 6 0 0 0 -2 box2-7.dat
  [1,16,78,26,2,2,0,0,0,6,0,0,0,-2, ldraw_lib__box2_7(realsolid)],
// 1 16 78 132 2 2 0 0 0 -4 0 0 0 -2 box2-7.dat
  [1,16,78,132,2,2,0,0,0,-4,0,0,0,-2, ldraw_lib__box2_7(realsolid)],
// 1 16 78 114 4 -2 0 0 0 0 14 0 1 0 rect.dat
  [1,16,78,114,4,-2,0,0,0,0,14,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 78 80 4 0 0 -2 -17 0 0 0 1 0 rect.dat
  [1,16,78,80,4,0,0,-2,-17,0,0,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 78 46 4 -2 0 0 0 0 14 0 1 0 rect.dat
  [1,16,78,46,4,-2,0,0,0,0,14,0,1,0, ldraw_lib__rect(realsolid)],
// 
...
// 1 16 0 63 0 1 0 0 0 1 0 0 0 1 s\64462s01.dat
  [1,16,0,63,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__64462s01(realsolid)],
// 1 16 0 97 0 1 0 0 0 -1 0 0 0 1 s\64462s01.dat
  [1,16,0,97,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__64462s01(realsolid)],
// 4 16 86.3639 63 9 90 63 9 90 97 9 86.3639 97 9
  [4,16,86.3639,63,9,90,63,9,90,97,9,86.3639,97,9],
// 1 16 82.2869 80 9 0 0 -2.2869 17 0 0 0 -1 0 rect3.dat
  [1,16,82.2869,80,9,0,0,-2.2869,17,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 85.46885 80 9 -.89505 0 0 0 0 -17 0 -1 0 rect2p.dat
  [1,16,85.46885,80,9,-.89505,0,0,0,0,-17,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 80 80 10.31805 0 -1 0 0 0 -17 1.31805 0 0 rect2p.dat
  [1,16,80,80,10.31805,0,-1,0,0,0,-17,1.31805,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 90 63 0 0 0 9 0 34 0 9 0 0 3-8cyli.dat
  [1,16,90,63,0,0,0,9,0,34,0,9,0,0, ldraw_lib__3_8cyli(realsolid)],
// 1 16 96.3639 80 -3.18195 0 1 0 17 0 0 0 0 -3.18195 rect3.dat
  [1,16,96.3639,80,-3.18195,0,1,0,17,0,0,0,0,-3.18195, ldraw_lib__rect3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 90.3639 63 0 0 0 6 0 34 0 6 0 0 1-4cylo.dat
  [1,16,90.3639,63,0,0,0,6,0,34,0,6,0,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 80 80 5 0 -1 0 0 0 17 -1 0 0 rect2p.dat
  [1,16,80,80,5,0,-1,0,0,0,17,-1,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 85.18195 80 6 0 0 -5.18195 -17 0 0 0 1 0 rect3.dat
  [1,16,85.18195,80,6,0,0,-5.18195,-17,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
];
module ldraw_lib__64462(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__64462(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
