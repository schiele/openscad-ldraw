...
use <../p/wpin.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4870(realsolid=false) = [
...
// 1 16 2 29 16 0 1 0 6 0 0 0 0 6 4-4edge.dat
  [1,16,2,29,16,0,1,0,6,0,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 -2 29 16 0 1 0 6 0 0 0 0 6 4-4edge.dat
  [1,16,-2,29,16,0,1,0,6,0,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 2 29 16 0 -1 0 6 0 0 0 0 6 4-4disc.dat
  [1,16,2,29,16,0,-1,0,6,0,0,0,0,6, ldraw_lib__4_4disc(realsolid)],
// 1 16 -2 29 16 0 1 0 6 0 0 0 0 6 4-4disc.dat
  [1,16,-2,29,16,0,1,0,6,0,0,0,0,6, ldraw_lib__4_4disc(realsolid)],
// 1 16 2 29 16 0 -4 0 6 0 0 0 0 6 4-4cyli.dat
  [1,16,2,29,16,0,-4,0,6,0,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 2 29 16 0 -1 0 0 0 1 1 0 0 wpin.dat
  [1,16,2,29,16,0,-1,0,0,0,1,1,0,0, ldraw_lib__wpin(realsolid)],
// 1 16 -2 29 16 0 1 0 0 0 1 1 0 0 wpin.dat
  [1,16,-2,29,16,0,1,0,0,0,1,1,0,0, ldraw_lib__wpin(realsolid)],
// 
...
// 1 16 1.5 29 16 0 -1 0 0 0 -6 -6 0 0 5-16edge.dat
  [1,16,1.5,29,16,0,-1,0,0,0,-6,-6,0,0, ldraw_lib__5_16edge(realsolid)],
// 2 24 -1.5 24.5953 20 -1.5 23.4566 18.2962
  [2,24,-1.5,24.5953,20,-1.5,23.4566,18.2962],
// 1 16 -1.5 29 16 0 -1 0 0 0 -6 -6 0 0 5-16edge.dat
  [1,16,-1.5,29,16,0,-1,0,0,0,-6,-6,0,0, ldraw_lib__5_16edge(realsolid)],
...
// 1 16 0 14.29765 20 1.5 0 0 0 0 10.29765 0 -1 0 rect3.dat
  [1,16,0,14.29765,20,1.5,0,0,0,0,10.29765,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 16.5 5 0 0 1.5 12.5 -1 0 5 0 0 rect.dat
  [1,16,0,16.5,5,0,0,1.5,12.5,-1,0,5,0,0, ldraw_lib__rect(realsolid)],
// 
...
// 1 16 0 4 0 20 0 0 0 -4 0 0 0 -20 box5-1.dat
  [1,16,0,4,0,20,0,0,0,-4,0,0,0,-20, ldraw_lib__box5_1(realsolid)],
...
module ldraw_lib__4870(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4870(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
