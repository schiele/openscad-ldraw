...
$fa=1; $fs=0.2;
function ldraw_lib__191888e(realsolid=false) = [
...
// 1 16 0 -0.25 0 21.45 0 0 0 0.25 0 0 0 -20 box5-12.dat
  [1,16,0,-0.25,0,21.45,0,0,0,0.25,0,0,0,-20, ldraw_lib__box5_12(realsolid)],
// 1 16 0 -0.25 0 0.31 0 0 0 1 0 0 0 0.31 s\196945sde.dat
  [1,16,0,-0.25,0,0.31,0,0,0,1,0,0,0,0.31, ldraw_lib__s__196945sde(realsolid)],
...
module ldraw_lib__191888e(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__191888e(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
