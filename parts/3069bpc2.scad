...
use <s/3069bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3069bpc2(realsolid=false) = [
...
// 1 16 15.7 0 5.7 2.5 0 0 0 1 0 0 0 2.5 1-4ndis.dat
  [1,16,15.7,0,5.7,2.5,0,0,0,1,0,0,0,2.5, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -15.7 0 5.7 0 0 -2.5 0 1 0 2.5 0 0 1-4ndis.dat
  [1,16,-15.7,0,5.7,0,0,-2.5,0,1,0,2.5,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -15.7 0 -5.7 -2.5 0 0 0 1 0 0 0 -2.5 1-4ndis.dat
  [1,16,-15.7,0,-5.7,-2.5,0,0,0,1,0,0,0,-2.5, ldraw_lib__1_4ndis(realsolid)],
// 1 16 15.7 0 -5.7 0 0 2.5 0 1 0 -2.5 0 0 1-4ndis.dat
  [1,16,15.7,0,-5.7,0,0,2.5,0,1,0,-2.5,0,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 15 -15.7 0 5.7 0 0 -1.4 0 1 0 1.4 0 0 1-4disc.dat
  [1,15,-15.7,0,5.7,0,0,-1.4,0,1,0,1.4,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 0 -15.7 0 5.7 0 0 -0.7 0 1 0 0.7 0 0 1-4ring2.dat
  [1,0,-15.7,0,5.7,0,0,-0.7,0,1,0,0.7,0,0, ldraw_lib__1_4ring2(realsolid)],
// 1 0 -15.7 0 5.7 0 0 -0.5 0 1 0 0.5 0 0 1-4ring4.dat
  [1,0,-15.7,0,5.7,0,0,-0.5,0,1,0,0.5,0,0, ldraw_lib__1_4ring4(realsolid)],
// 1 0 15.7 0 5.7 0.7 0 0 0 1 0 0 0 0.7 1-4ring2.dat
  [1,0,15.7,0,5.7,0.7,0,0,0,1,0,0,0,0.7, ldraw_lib__1_4ring2(realsolid)],
// 1 15 15.7 0 5.7 0.7 0 0 0 1 0 0 0 0.7 1-4ring1.dat
  [1,15,15.7,0,5.7,0.7,0,0,0,1,0,0,0,0.7, ldraw_lib__1_4ring1(realsolid)],
// 1 15 15.7 0 -5.7 0 0 0.7 0 1 0 -0.7 0 0 1-4ring1.dat
  [1,15,15.7,0,-5.7,0,0,0.7,0,1,0,-0.7,0,0, ldraw_lib__1_4ring1(realsolid)],
// 1 15 -0.5 0 -5.7 -0.7 0 0 0 1 0 0 0 -0.7 1-4ring1.dat
  [1,15,-0.5,0,-5.7,-0.7,0,0,0,1,0,0,0,-0.7, ldraw_lib__1_4ring1(realsolid)],
// 1 15 -0.5 0 5.7 0 0 -0.7 0 1 0 0.7 0 0 1-4ring1.dat
  [1,15,-0.5,0,5.7,0,0,-0.7,0,1,0,0.7,0,0, ldraw_lib__1_4ring1(realsolid)],
// 1 0 15.7 0 5.7 0.5 0 0 0 1 0 0 0 0.5 1-4ring4.dat
  [1,0,15.7,0,5.7,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__1_4ring4(realsolid)],
// 1 0 15.7 0 -5.7 0 0 0.7 0 1 0 -0.7 0 0 1-4ring2.dat
  [1,0,15.7,0,-5.7,0,0,0.7,0,1,0,-0.7,0,0, ldraw_lib__1_4ring2(realsolid)],
// 1 0 15.7 0 -5.7 0 0 0.5 0 1 0 -0.5 0 0 1-4ring4.dat
  [1,0,15.7,0,-5.7,0,0,0.5,0,1,0,-0.5,0,0, ldraw_lib__1_4ring4(realsolid)],
...
// 1 15 -15.7 0 -5.7 -1.4 0 0 0 1 0 0 0 -1.4 1-4disc.dat
  [1,15,-15.7,0,-5.7,-1.4,0,0,0,1,0,0,0,-1.4, ldraw_lib__1_4disc(realsolid)],
// 1 15 -4.5 0 -5.7 0 0 1.4 0 1 0 -1.4 0 0 1-4disc.dat
  [1,15,-4.5,0,-5.7,0,0,1.4,0,1,0,-1.4,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 0 -4.5 0 -5.7 0 0 1.4 0 1 0 -1.4 0 0 1-4ndis.dat
  [1,0,-4.5,0,-5.7,0,0,1.4,0,1,0,-1.4,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 15 -4.5 0 5.7 1.4 0 0 0 1 0 0 0 1.4 1-4disc.dat
  [1,15,-4.5,0,5.7,1.4,0,0,0,1,0,0,0,1.4, ldraw_lib__1_4disc(realsolid)],
// 1 0 15.7 0 5.7 0.7 0 0 0 1 0 0 0 0.7 1-4disc.dat
  [1,0,15.7,0,5.7,0.7,0,0,0,1,0,0,0,0.7, ldraw_lib__1_4disc(realsolid)],
// 1 0 15.7 0 -5.7 0 0 0.7 0 1 0 -0.7 0 0 1-4disc.dat
  [1,0,15.7,0,-5.7,0,0,0.7,0,1,0,-0.7,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 0 -0.5 0 -5.7 -0.7 0 0 0 1 0 0 0 -0.7 1-4disc.dat
  [1,0,-0.5,0,-5.7,-0.7,0,0,0,1,0,0,0,-0.7, ldraw_lib__1_4disc(realsolid)],
// 1 0 -0.5 0 5.7 0 0 -0.7 0 1 0 0.7 0 0 1-4disc.dat
  [1,0,-0.5,0,5.7,0,0,-0.7,0,1,0,0.7,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 0 -4.5 0 5.7 1.4 0 0 0 1 0 0 0 1.4 1-4ndis.dat
  [1,0,-4.5,0,5.7,1.4,0,0,0,1,0,0,0,1.4, ldraw_lib__1_4ndis(realsolid)],
// 1 0 -0.5 0 5.7 0 0 -1.4 0 1 0 1.4 0 0 1-4ndis.dat
  [1,0,-0.5,0,5.7,0,0,-1.4,0,1,0,1.4,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 0 -0.5 0 -5.7 -1.4 0 0 0 1 0 0 0 -1.4 1-4ndis.dat
  [1,0,-0.5,0,-5.7,-1.4,0,0,0,1,0,0,0,-1.4, ldraw_lib__1_4ndis(realsolid)],
...
// 1 0 -10.1 0 -2.1 -3.629 0 -0.722 0 1 0 0.722 0 -3.629 3-4disc.dat
  [1,0,-10.1,0,-2.1,-3.629,0,-0.722,0,1,0,0.722,0,-3.629, ldraw_lib__3_4disc(realsolid)],
// 1 15 -10.1 0 -2.1 -3.629 0 -0.722 0 1 0 0.722 0 -3.629 3-4ndis.dat
  [1,15,-10.1,0,-2.1,-3.629,0,-0.722,0,1,0,0.722,0,-3.629, ldraw_lib__3_4ndis(realsolid)],
// 1 0 -10.1 0 -2.1 -0.722 0 -3.629 0 1 0 3.629 0 -0.722 3-16disc.dat
  [1,0,-10.1,0,-2.1,-0.722,0,-3.629,0,1,0,3.629,0,-0.722, ldraw_lib__3_16disc(realsolid)],
// 1 15 -10.1 0 -2.1 -0.722 0 -3.629 0 1 0 3.629 0 -0.722 3-16ndis.dat
  [1,15,-10.1,0,-2.1,-0.722,0,-3.629,0,1,0,3.629,0,-0.722, ldraw_lib__3_16ndis(realsolid)],
...
module ldraw_lib__3069bpc2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3069bpc2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
