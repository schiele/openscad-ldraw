...
use <s/30259s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30259p04(realsolid=false) = [
...
// 1 0 0 7 -9 0.5 0 0 0 0 0.5 0 1 0 4-4ring5.dat
  [1,0,0,7,-9,0.5,0,0,0,0,0.5,0,1,0, ldraw_lib__4_4ring5(realsolid)],
// 1 0 0 0 -9 0.5 0 0 0 0 0.5 0 1 0 4-4ring5.dat
  [1,0,0,0,-9,0.5,0,0,0,0,0.5,0,1,0, ldraw_lib__4_4ring5(realsolid)],
// 1 0 0 -7 -9 0.5 0 0 0 0 0.5 0 1 0 4-4ring5.dat
  [1,0,0,-7,-9,0.5,0,0,0,0,0.5,0,1,0, ldraw_lib__4_4ring5(realsolid)],
// 
// 1 2 0 7 -9 2.5 0 0 0 0 2.5 0 1 0 4-4disc.dat
  [1,2,0,7,-9,2.5,0,0,0,0,2.5,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 14 0 0 -9 2.5 0 0 0 0 2.5 0 1 0 4-4disc.dat
  [1,14,0,0,-9,2.5,0,0,0,0,2.5,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 4 0 -7 -9 2.5 0 0 0 0 2.5 0 1 0 4-4disc.dat
  [1,4,0,-7,-9,2.5,0,0,0,0,2.5,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 
// 1 16 0 7 -9 3 0 0 0 0 3 0 1 0 4-4ndis.dat
  [1,16,0,7,-9,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 0 -9 3 0 0 0 0 3 0 1 0 4-4ndis.dat
  [1,16,0,0,-9,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 -7 -9 3 0 0 0 0 3 0 1 0 4-4ndis.dat
  [1,16,0,-7,-9,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 
...
module ldraw_lib__30259p04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30259p04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
