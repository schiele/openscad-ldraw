...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\50858s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__50858s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\50858s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__50858s01()],
...
// 1 16 0 -10 -20 -9 0 0 0 18 0 0 0 -9 2-4cyli.dat
  [1,16,0,-10,-20,-9,0,0,0,18,0,0,0,-9, ldraw_lib__2_4cyli()],
...
// 1 16 2.5 0.5 36.5 0 -5 0 0 0 -7.5 12.5 0 0 1-4cyli.dat
  [1,16,2.5,0.5,36.5,0,-5,0,0,0,-7.5,12.5,0,0, ldraw_lib__1_4cyli()],
// 0 //
];
module ldraw_lib__50858(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__50858(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
