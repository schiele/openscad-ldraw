...
use <70081c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3888ac01(realsolid=false) = [
...
// 1 7 0 13 110 1 0 0 0 1 0 0 0 1 70081c01.dat
  [1,7,0,13,110,1,0,0,0,1,0,0,0,1, ldraw_lib__70081c01(realsolid)],
// 1 7 0 13 -110 1 0 0 0 1 0 0 0 1 70081c01.dat
  [1,7,0,13,-110,1,0,0,0,1,0,0,0,1, ldraw_lib__70081c01(realsolid)],
// 
];
module ldraw_lib__3888ac01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3888ac01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
