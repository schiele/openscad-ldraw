...
use <s/16000s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__16000p01(realsolid=false) = [
// 0 Minifig Arm Right with Yellow Lower Arm Pattern
// 0 Name: 16000p01.dat
...
// 
// 
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 s\16000s01.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__16000s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\16000s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__16000s02(realsolid)],
];
module ldraw_lib__16000p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__16000p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__16000p01(line=0.2);