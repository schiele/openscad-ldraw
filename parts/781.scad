...
use <../p/stug4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__781(realsolid=false) = [
// 0 Car Base  6 x 12
// 0 Name: 781.dat
...
// 
// 
// 1 16 20 0 -80 0 0 1 0 1 0 -1 0 0 stug4.dat
  [1,16,20,0,-80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug4(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 stug4.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug4(realsolid)],
// 1 16 -20 0 80 0 0 1 0 1 0 -1 0 0 stug4.dat
  [1,16,-20,0,80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug4(realsolid)],
// 1 16 40 0 100 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,40,0,100,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 1 16 40 0 60 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,40,0,60,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 1 16 -40 0 -60 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-40,0,-60,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 1 16 -40 0 -100 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,-40,0,-100,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 4 16 -40 0 40 -40 0 -40 40 0 -40 40 0 40
  [4,16,-40,0,40,-40,0,-40,40,0,-40,40,0,40],
// 4 16 56 8 -44 60 8 -40 60 8 -120 56 8 -116
  [4,16,56,8,-44,60,8,-40,60,8,-120,56,8,-116],
...
// 4 16 56 8 44 60 8 40 40 8 40 36 8 44
  [4,16,56,8,44,60,8,40,40,8,40,36,8,44],
// 4 16 56 8 116 60 8 120 60 8 40 56 8 44
  [4,16,56,8,116,60,8,120,60,8,40,56,8,44],
// 4 16 -56 8 -116 -60 8 -120 -60 8 -40 -56 8 -44
  [4,16,-56,8,-116,-60,8,-120,-60,8,-40,-56,8,-44],
// 4 16 -56 8 -44 -60 8 -40 -40 8 -40 -36 8 -44
...
// 4 16 60 8 -120 -60 8 -120 -56 8 -116 56 8 -116
  [4,16,60,8,-120,-60,8,-120,-56,8,-116,56,8,-116],
// 4 16 56 8 116 -56 8 116 -60 8 120 60 8 120
  [4,16,56,8,116,-56,8,116,-60,8,120,60,8,120],
...
// 1 16 60 4 0 0 -20 0 -4 0 0 0 0 -40 box3u2p.dat
  [1,16,60,4,0,0,-20,0,-4,0,0,0,0,-40, ldraw_lib__box3u2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -60 4 0 0 20 0 -4 0 0 0 0 40 box3u2p.dat
  [1,16,-60,4,0,0,20,0,-4,0,0,0,0,40, ldraw_lib__box3u2p(realsolid)],
// 1 16 -56 6 0 0 20 0 -2 0 0 0 0 44 box3u2p.dat
  [1,16,-56,6,0,0,20,0,-2,0,0,0,0,44, ldraw_lib__box3u2p(realsolid)],
// 1 16 56 6 0 0 -20 0 -2 0 0 0 0 -44 box3u2p.dat
  [1,16,56,6,0,0,-20,0,-2,0,0,0,0,-44, ldraw_lib__box3u2p(realsolid)],
// 1 16 0 8 -80 60 0 0 0 -8 0 0 0 -40 box4-4a.dat
  [1,16,0,8,-80,60,0,0,0,-8,0,0,0,-40, ldraw_lib__box4_4a(realsolid)],
// 1 16 0 8 80 -60 0 0 0 -8 0 0 0 40 box4-4a.dat
  [1,16,0,8,80,-60,0,0,0,-8,0,0,0,40, ldraw_lib__box4_4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 80 -56 0 0 0 -4 0 0 0 36 box4-4a.dat
  [1,16,0,8,80,-56,0,0,0,-4,0,0,0,36, ldraw_lib__box4_4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 -80 56 0 0 0 -4 0 0 0 -36 box4-4a.dat
  [1,16,0,8,-80,56,0,0,0,-4,0,0,0,-36, ldraw_lib__box4_4a(realsolid)],
// 1 16 40 4 100 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,40,4,100,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
// 1 16 0 4 100 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,4,100,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -20 4 100 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-20,4,100,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -40 4 100 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-40,4,100,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
module ldraw_lib__781(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__781(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__781(line=0.2);