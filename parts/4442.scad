...
// 1 16 0 8 0 60 0 0 0 -8 0 0 0 10 box3u8p.dat
  [1,16,0,8,0,60,0,0,0,-8,0,0,0,10, ldraw_lib__box3u8p()],
...
// 1 16 60 7 0 0 -1 0 1 0 0 0 0 10 rect.dat
  [1,16,60,7,0,0,-1,0,1,0,0,0,0,10, ldraw_lib__rect()],
// 1 16 -60 7 0 0 1 0 1 0 0 0 0 10 rect.dat
  [1,16,-60,7,0,0,1,0,1,0,0,0,0,10, ldraw_lib__rect()],
// 1 16 70 0 0 0 0 1 0 1 0 -1 0 0 steerend.dat
  [1,16,70,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__steerend()],
// 1 16 -70 0 0 0 0 -1 0 1 0 1 0 0 steerend.dat
  [1,16,-70,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__steerend()],
...
module ldraw_lib__4442(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4442(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
