...
// 1 10 0 5 0 1 0 0 0 1 0 0 0 1 33183.dat
  [1,10,0,5,0,1,0,0,0,1,0,0,0,1, ldraw_lib__33183()],
// 
];
module ldraw_lib__33172c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__33172c02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
