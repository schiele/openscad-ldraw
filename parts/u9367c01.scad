...
use <u9391.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9367c01(realsolid=false) = [
...
// 1 322 0 0 140 1 0 0 0 1 0 0 0 1 u9390.dat
  [1,322,0,0,140,1,0,0,0,1,0,0,0,1, ldraw_lib__u9390(realsolid)],
// 1 322 0 0 140 1 0 0 0 1 0 0 0 1 u9391.dat
  [1,322,0,0,140,1,0,0,0,1,0,0,0,1, ldraw_lib__u9391(realsolid)],
// 0 // Cable stub
// 1 511 0 14 142 0 0 1 -1 0 0 0 -1 0 s\23816s01.dat
  [1,511,0,14,142,0,0,1,-1,0,0,0,-1,0, ldraw_lib__s__23816s01(realsolid)],
...
module ldraw_lib__u9367c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9367c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
