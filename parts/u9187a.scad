...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\822s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__822s02()],
// 2 24 2.5 -8.5 -1.5 -9.5 -8.5 -1.5
  [2,24,2.5,-8.5,-1.5,-9.5,-8.5,-1.5],
// 1 16 -3.5 1.5 -1.5 0 0 -6 6 0 0 0 3.5 0 1-4cylo.dat
  [1,16,-3.5,1.5,-1.5,0,0,-6,6,0,0,0,3.5,0, ldraw_lib__1_4cylo()],
...
// 1 16 -3.5 1.5 -1.5 0 0 -6 6 0 0 0 1 0 1-4chrd.dat
  [1,16,-3.5,1.5,-1.5,0,0,-6,6,0,0,0,1,0, ldraw_lib__1_4chrd()],
...
// 1 16 -3.5 1.5 2 0 0 -6 6 0 0 0 -1 0 1-4chrd.dat
  [1,16,-3.5,1.5,2,0,0,-6,6,0,0,0,-1,0, ldraw_lib__1_4chrd()],
// 1 16 -9.5 -3.5 .25 0 1 0 0 0 -5 -1.75 0 0 rect3.dat
  [1,16,-9.5,-3.5,.25,0,1,0,0,0,-5,-1.75,0,0, ldraw_lib__rect3()],
// 1 16 -0.5 -0.5 .25 0 0 3 0 8 0 1.75 0 0 box2-7.dat
  [1,16,-0.5,-0.5,.25,0,0,3,0,8,0,1.75,0,0, ldraw_lib__box2_7()],
// 0 // hinge pin
// 1 16 0 0 8 0 0 1.89 1.89 0 0 0 -6 0 4-4cylc.dat
  [1,16,0,0,8,0,0,1.89,1.89,0,0,0,-6,0, ldraw_lib__4_4cylc()],
];
module ldraw_lib__u9187a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9187a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
