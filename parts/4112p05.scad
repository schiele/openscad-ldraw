...
module ldraw_lib__4112p05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4112p05(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4112p05(line=0.2);