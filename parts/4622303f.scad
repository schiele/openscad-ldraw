...
use <4622303e.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4622303f(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 4622303e.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__4622303e(realsolid)],
];
module ldraw_lib__4622303f(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4622303f(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
