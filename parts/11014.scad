...
use <s/11014s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__11014(realsolid=false) = [
...
// 1 16 0 0 0 -1.76777 0 -1.76777 1.76777 0 -1.76777 0 1 0 3-4ring5.dat
  [1,16,0,0,0,-1.76777,0,-1.76777,1.76777,0,-1.76777,0,1,0, ldraw_lib__3_4ring5(realsolid)],
// 1 16 0 13 0 2.15 0 0 0 0 2.15 0 1 0 2-4ring4.dat
  [1,16,0,13,0,2.15,0,0,0,0,2.15,0,1,0, ldraw_lib__2_4ring4(realsolid)],
...
module ldraw_lib__11014(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11014(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
