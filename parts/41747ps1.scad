...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__41747ps1(realsolid=false) = [
// 0 Wedge  2 x  6 Double Right with AT-TE Pattern
// 0 Name: 41747ps1.dat
...
module ldraw_lib__41747ps1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__41747ps1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__41747ps1(line=0.2);