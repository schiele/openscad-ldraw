...
// 1 16 9 0 0 0 -1 0 0 0 10 60 0 0 rect2p.dat
  [1,16,9,0,0,0,-1,0,0,0,10,60,0,0, ldraw_lib__rect2p()],
// 1 16 -9 0 0 0 1 0 0 0 10 -60 0 0 rect2p.dat
  [1,16,-9,0,0,0,1,0,0,0,10,-60,0,0, ldraw_lib__rect2p()],
// 1 16 0 -10 60 -9 0 0 0 1 0 0 0 9 2-4edge.dat
  [1,16,0,-10,60,-9,0,0,0,1,0,0,0,9, ldraw_lib__2_4edge()],
...
module ldraw_lib__32524(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32524(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
