...
// 1 16 0 -38 0 1 0 0 0 1 0 0 0 1 30375ps3.dat
  [1,16,0,-38,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30375ps3()],
...
module ldraw_lib__30375cs3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30375cs3(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
