...
use <s/62271s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__62271(realsolid=false) = [
...
// 1 16 0 -20 -10 1 0 0 0 1 0 0 0 1 s\62271s01.dat
  [1,16,0,-20,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__62271s01(realsolid)],
// 1 16 0 -20 -10 -1 0 0 0 1 0 0 0 1 s\62271s01.dat
  [1,16,0,-20,-10,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__62271s01(realsolid)],
...
// 1 16 -10 0 -20 0 20 0 -9 0 0 0 0 -9 2-4cyli.dat
  [1,16,-10,0,-20,0,20,0,-9,0,0,0,0,-9, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -10 0 0 0 20 0 9 0 0 0 0 9 1-4cyli.dat
  [1,16,-10,0,0,0,20,0,9,0,0,0,0,9, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 -20 14 0 0 -14 14 0 0 0 48 0 4-4cyli.dat
  [1,16,0,-20,14,0,0,-14,14,0,0,0,48,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -20 62 0 0 -14 14 0 0 0 48 0 4-4edge.dat
  [1,16,0,-20,62,0,0,-14,14,0,0,0,48,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -20 14 0 0 -14 14 0 0 0 48 0 4-4edge.dat
  [1,16,0,-20,14,0,0,-14,14,0,0,0,48,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -20 14 0 0 -9 9 0 0 0 48 0 4-4edge.dat
  [1,16,0,-20,14,0,0,-9,9,0,0,0,48,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -20 -10 0 0 -9 9 0 0 0 48 0 4-4edge.dat
  [1,16,0,-20,-10,0,0,-9,9,0,0,0,48,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -20 62 0 0 -16 16 0 0 0 1 0 4-4edge.dat
  [1,16,0,-20,62,0,0,-16,16,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -20 30 0 0 -16 16 0 0 0 32 0 4-4cyli.dat
  [1,16,0,-20,30,0,0,-16,16,0,0,0,32,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -20 62 0 0 -2 2 0 0 0 -1 0 4-4ring7.dat
  [1,16,0,-20,62,0,0,-2,2,0,0,0,-1,0, ldraw_lib__4_4ring7(realsolid)],
...
module ldraw_lib__62271(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__62271(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
