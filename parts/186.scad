...
// 1 16 0 10 100 -72 0 0 0 0 2 0 -1 0 rect.dat
  [1,16,0,10,100,-72,0,0,0,0,2,0,-1,0, ldraw_lib__rect()],
// 1 16 0 10 -60 72 0 0 0 0 2 0 1 0 rect3.dat
  [1,16,0,10,-60,72,0,0,0,0,2,0,1,0, ldraw_lib__rect3()],
// 1 16 -58 8 -68 0 0 -2 0 -1 0 8 0 0 rect1.dat
  [1,16,-58,8,-68,0,0,-2,0,-1,0,8,0,0, ldraw_lib__rect1()],
// 1 16 0 8 -78 0 0 72 0 -1 0 -2 0 0 rect1.dat
  [1,16,0,8,-78,0,0,72,0,-1,0,-2,0,0, ldraw_lib__rect1()],
// 1 16 0 12 20 0 0 -72 0 -1 0 80 0 0 rect2p.dat
  [1,16,0,12,20,0,0,-72,0,-1,0,80,0,0, ldraw_lib__rect2p()],
// 1 16 58 8 -68 0 0 -2 0 -1 0 8 0 0 rect1.dat
  [1,16,58,8,-68,0,0,-2,0,-1,0,8,0,0, ldraw_lib__rect1()],
// 1 16 70 8 -68 0 0 -2 0 -1 0 8 0 0 rect1.dat
  [1,16,70,8,-68,0,0,-2,0,-1,0,8,0,0, ldraw_lib__rect1()],
// 1 16 -70 8 -68 0 0 -2 0 -1 0 8 0 0 rect1.dat
  [1,16,-70,8,-68,0,0,-2,0,-1,0,8,0,0, ldraw_lib__rect1()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 8 90 72 0 0 0 1 0 0 0 -10 rect3.dat
  [1,16,0,8,90,72,0,0,0,1,0,0,0,-10, ldraw_lib__rect3()],
// 1 16 0 4 80 72 0 0 0 0 -4 0 -1 0 rect3.dat
  [1,16,0,4,80,72,0,0,0,0,-4,0,-1,0, ldraw_lib__rect3()],
// 1 16 72 4 -70 0 -1 0 4 0 0 0 0 -10 rect2a.dat
  [1,16,72,4,-70,0,-1,0,4,0,0,0,0,-10, ldraw_lib__rect2a()],
...
// 1 16 -72 4 -70 0 1 0 0 0 4 -10 0 0 rect2a.dat
  [1,16,-72,4,-70,0,1,0,0,0,4,-10,0,0, ldraw_lib__rect2a()],
// 1 16 0 0 0 72 0 0 0 1 0 0 0 -80 rect3.dat
  [1,16,0,0,0,72,0,0,0,1,0,0,0,-80, ldraw_lib__rect3()],
...
module ldraw_lib__186(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__186(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
