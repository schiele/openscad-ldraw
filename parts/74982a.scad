...
use <74982-f1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__74982a(realsolid=false) = [
// 0 ~Moved to 74982-f1
// 0 Name: 74982a.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 74982-f1.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__74982_f1(realsolid)],
];
module ldraw_lib__74982a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__74982a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
