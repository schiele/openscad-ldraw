...
use <6518.scad>
$fa=1; $fs=0.2;
function ldraw_lib__75349(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6518.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6518(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6517.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6517(realsolid)],
];
module ldraw_lib__75349(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__75349(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
