...
use <2454adq7.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2454dq7(realsolid=false) = [
// 0 ~Moved to 2454adq7
// 0 Name: 2454dq7.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2454adq7.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2454adq7(realsolid)],
];
module ldraw_lib__2454dq7(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2454dq7(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
