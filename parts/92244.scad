...
use <s/92244s05.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92244(realsolid=false) = [
// 0 Figure Friends Female Left Arm
// 0 Name: 92244.dat
...
// 0 !HISTORY 2014-07-10 [Philo] Subparted for patterns
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\92244s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92244s02(realsolid)],
...
module ldraw_lib__92244(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92244(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__92244(line=0.2);