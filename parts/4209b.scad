...
$fa=1; $fs=0.2;
function ldraw_lib__4209b(realsolid=false) = [
...
// 1 16 0 48 0 37 0 0 0 -4 0 0 0 16 box5.dat
  [1,16,0,48,0,37,0,0,0,-4,0,0,0,16, ldraw_lib__box5(realsolid)],
// 1 16 36.5 44 10 0 0 -.5 0 3.5 0 1.25 0 0 box4-1.dat
  [1,16,36.5,44,10,0,0,-.5,0,3.5,0,1.25,0,0, ldraw_lib__box4_1(realsolid)],
// 1 16 36.5 44 -10 0 0 -.5 0 3.5 0 1.25 0 0 box4-1.dat
  [1,16,36.5,44,-10,0,0,-.5,0,3.5,0,1.25,0,0, ldraw_lib__box4_1(realsolid)],
// 1 16 -36.5 44 -10 0 0 .5 0 3.5 0 -1.25 0 0 box4-1.dat
  [1,16,-36.5,44,-10,0,0,.5,0,3.5,0,-1.25,0,0, ldraw_lib__box4_1(realsolid)],
...
// 1 16 0 48 0 0 0 -40 0 -48 0 20 0 0 box3u2p.dat
  [1,16,0,48,0,0,0,-40,0,-48,0,20,0,0, ldraw_lib__box3u2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 22 -20 0 0 -36 18 0 0 0 40 0 box4.dat
  [1,16,0,22,-20,0,0,-36,18,0,0,0,40,0, ldraw_lib__box4(realsolid)],
...
module ldraw_lib__4209b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4209b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
