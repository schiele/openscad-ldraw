...
use <3005ptd.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3005_d(realsolid=false) = [
// 0 ~Moved to 3005ptd
// 0 Name: 3005-d.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3005ptd.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3005ptd(realsolid)],
];
module ldraw_lib__3005_d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3005_d(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
