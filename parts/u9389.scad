...
use <../p/4-4disc.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9389(realsolid=false) = [
...
// 1 16 0 34 0 2.5 0 0 0 -34 0 0 0 2.5 4-4cylc.dat
  [1,16,0,34,0,2.5,0,0,0,-34,0,0,0,2.5, ldraw_lib__4_4cylc(realsolid)],
...
// 1 16 0 -2 0 6 0 0 0 2 0 0 0 6 4-4cylc.dat
  [1,16,0,-2,0,6,0,0,0,2,0,0,0,6, ldraw_lib__4_4cylc(realsolid)],
];
module ldraw_lib__u9389(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9389(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
