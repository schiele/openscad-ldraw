...
use <s/2586s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2586(realsolid=false) = [
...
// 1 16 0 -14.5 -8 20 0 0 0 0 -20 0 1 0 2-4disc.dat
  [1,16,0,-14.5,-8,20,0,0,0,0,-20,0,1,0, ldraw_lib__2_4disc(realsolid)],
...
// 1 16 0 31.5 -8 -4.243 0 4.243 4.243 0 4.243 0 1 0 1-4disc.dat
  [1,16,0,31.5,-8,-4.243,0,4.243,4.243,0,4.243,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 
...
module ldraw_lib__2586(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2586(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
