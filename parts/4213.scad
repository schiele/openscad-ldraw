...
use <../p/stug-4x1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4213(realsolid=false) = [
...
// 1 16 0 5.5 28 0 0 36 2.5 0 0 0 -64 0 box3u4a.dat
  [1,16,0,5.5,28,0,0,36,2.5,0,0,0,-64,0, ldraw_lib__box3u4a(realsolid)],
// 
// 1 16 34 5.5 28 0 0 2 2.5 0 0 0 1 0 rect3.dat
  [1,16,34,5.5,28,0,0,2,2.5,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 -34 5.5 28 0 0 -2 2.5 0 0 0 1 0 rect3.dat
  [1,16,-34,5.5,28,0,0,-2,2.5,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 
...
// 1 16 0 5.5 28 0 0 6 2.5 0 0 0 1 0 rect1.dat
  [1,16,0,5.5,28,0,0,6,2.5,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 29 5.5 28 3 0 0 0 0 -2.5 0 8 0 box4-2p.dat
  [1,16,29,5.5,28,3,0,0,0,0,-2.5,0,8,0, ldraw_lib__box4_2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 5.5 28 4 0 0 0 0 -2.5 0 8 0 box4-1.dat
  [1,16,10,5.5,28,4,0,0,0,0,-2.5,0,8,0, ldraw_lib__box4_1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -10 5.5 28 4 0 0 0 0 -2.5 0 8 0 box4-1.dat
  [1,16,-10,5.5,28,4,0,0,0,0,-2.5,0,8,0, ldraw_lib__box4_1(realsolid)],
...
// 1 16 0 3 16.125 0 0 21.25 0 -1 0 -11.875 0 0 box3u5p.dat
  [1,16,0,3,16.125,0,0,21.25,0,-1,0,-11.875,0,0, ldraw_lib__box3u5p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 2 4.25 21.25 0 0 0 1 0 0 0 -21.25 48\2-4cylc.dat
  [1,16,0,2,4.25,21.25,0,0,0,1,0,0,0,-21.25, ldraw_lib__48__2_4cylc(realsolid)],
// 
// 1 16 0 3 4.25 21.25 0 0 0 -1 0 0 0 -21.25 48\2-4ndis.dat
  [1,16,0,3,4.25,21.25,0,0,0,-1,0,0,0,-21.25, ldraw_lib__48__2_4ndis(realsolid)],
...
// 1 16 0 3 -20 -7.39104 0 3.06147 0 5 0 -3.06147 0 -7.39104 3-8cylo.dat
  [1,16,0,3,-20,-7.39104,0,3.06147,0,5,0,-3.06147,0,-7.39104, ldraw_lib__3_8cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 3 -20 -5.54328 0 2.2961 0 5 0 -2.2961 0 -5.54328 3-8cylo.dat
  [1,16,0,3,-20,-5.54328,0,2.2961,0,5,0,-2.2961,0,-5.54328, ldraw_lib__3_8cylo(realsolid)],
// 1 16 0 8 -20 -1.84776 0 0.76538 0 -1 0 -0.76538 0 -1.84776 3-8ring3.dat
  [1,16,0,8,-20,-1.84776,0,0.76538,0,-1,0,-0.76538,0,-1.84776, ldraw_lib__3_8ring3(realsolid)],
// 1 16 -6.46717 5.5 -22.67879 0 0.38267 -0.92387 2.5 0 0 0 -0.92387 -0.38267 rect.dat
  [1,16,-6.46717,5.5,-22.67879,0,0.38267,-0.92387,2.5,0,0,0,-0.92387,-0.38267, ldraw_lib__rect(realsolid)],
// 1 16 6.46717 5.5 -22.67879 0 -0.38267 -0.92387 2.5 0 0 0 -0.92387 0.38267 rect.dat
  [1,16,6.46717,5.5,-22.67879,0,-0.38267,-0.92387,2.5,0,0,0,-0.92387,0.38267, ldraw_lib__rect(realsolid)],
// 
...
module ldraw_lib__4213(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4213(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
