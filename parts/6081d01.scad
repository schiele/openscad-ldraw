...
use <6081.scad>
use <821472hc01.scad>
function ldraw_lib__6081d01() = [
// 0 Brick  2 x  4 x  1.333 with Curved Top with Right Black and Light Grey Grid on Transparent Background Sticker
// 0 Name: 6081d01.dat
...
module ldraw_lib__6081d01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6081d01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
