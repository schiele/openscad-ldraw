...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2524(realsolid=false) = [
...
// 1 16 0 0 16 0 0 -14 0 30 0 6 0 0 box3u5p.dat
  [1,16,0,0,16,0,0,-14,0,30,0,6,0,0, ldraw_lib__box3u5p(realsolid)],
// 1 16 0 20 22 0 0 -14 10 0 0 0 -1 0 rect.dat
  [1,16,0,20,22,0,0,-14,10,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 14 10 12 0 0 0 0 -14 0 10 0 box4o4a.dat
  [1,16,0,14,10,12,0,0,0,0,-14,0,10,0, ldraw_lib__box4o4a(realsolid)],
// 1 16 0 18 21 12 0 0 0 0 -10 0 -1 0 box2-5.dat
  [1,16,0,18,21,12,0,0,0,0,-10,0,-1,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 20 12 0 0 0 0 -4 0 2 0 box4-7a.dat
  [1,16,0,4,20,12,0,0,0,0,-4,0,2,0, ldraw_lib__box4_7a(realsolid)],
// 1 16 0 4 17 15 0 0 0 0 -6 0 7 0 box2-7.dat
  [1,16,0,4,17,15,0,0,0,0,-6,0,7,0, ldraw_lib__box2_7(realsolid)],
// 1 16 0 10 22.5 -15 0 0 0 -1 0 0 0 1.5 rect3.dat
  [1,16,0,10,22.5,-15,0,0,0,-1,0,0,0,1.5, ldraw_lib__rect3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -14.5 5 15.5 .5 0 0 0 0 -5 0 5.5 0 box2-5.dat
  [1,16,-14.5,5,15.5,.5,0,0,0,0,-5,0,5.5,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 14.5 5 15.5 .5 0 0 0 0 -5 0 5.5 0 box2-5.dat
  [1,16,14.5,5,15.5,.5,0,0,0,0,-5,0,5.5,0, ldraw_lib__box2_5(realsolid)],
...
// 1 16 0 -.1 0 -6 0 0 0 -1 0 0 0 -6 4-4ndis.dat
  [1,16,0,-.1,0,-6,0,0,0,-1,0,0,0,-6, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 -6 -.1 -6 -4 0 0 0 1 0 0 0 -4 1-4edge.dat
  [1,16,-6,-.1,-6,-4,0,0,0,1,0,0,0,-4, ldraw_lib__1_4edge(realsolid)],
// 1 16 -6 -2 -6 -4 0 0 0 1.9 0 0 0 -4 1-4cyli.dat
  [1,16,-6,-2,-6,-4,0,0,0,1.9,0,0,0,-4, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 -6 -.1 -6 -4 0 0 0 -1 0 0 0 -4 1-4disc.dat
  [1,16,-6,-.1,-6,-4,0,0,0,-1,0,0,0,-4, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 6 -.1 -6 0 0 4 0 1 0 -4 0 0 1-4edge.dat
  [1,16,6,-.1,-6,0,0,4,0,1,0,-4,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 6 -2 -6 0 0 4 0 1.9 0 -4 0 0 1-4cyli.dat
  [1,16,6,-2,-6,0,0,4,0,1.9,0,-4,0,0, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 6 -.1 -6 0 0 4 0 -1 0 -4 0 0 1-4disc.dat
  [1,16,6,-.1,-6,0,0,4,0,-1,0,-4,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 0 -1.05 -6 6 0 0 0 0 .95 0 -4 0 box3u10p.dat
  [1,16,0,-1.05,-6,6,0,0,0,0,.95,0,-4,0, ldraw_lib__box3u10p(realsolid)],
// 1 16 -10 -1.05 2 0 1 0 -.95 0 0 0 0 8 rect3.dat
  [1,16,-10,-1.05,2,0,1,0,-.95,0,0,0,0,8, ldraw_lib__rect3(realsolid)],
// 1 16 10 -1.05 2 0 -1 0 .95 0 0 0 0 8 rect3.dat
  [1,16,10,-1.05,2,0,-1,0,.95,0,0,0,0,8, ldraw_lib__rect3(realsolid)],
...
// 1 16 6.5 -5 13 0 0 1.5 -3 0 0 0 -1 0 box3u5p.dat
  [1,16,6.5,-5,13,0,0,1.5,-3,0,0,0,-1,0, ldraw_lib__box3u5p(realsolid)],
// 1 16 -6.5 -5 13 0 0 1.5 -3 0 0 0 -1 0 box3u5p.dat
  [1,16,-6.5,-5,13,0,0,1.5,-3,0,0,0,-1,0, ldraw_lib__box3u5p(realsolid)],
// 1 16 11 -2.5 18 -3 0 0 0 0 -.5 0 -1 0 rect.dat
  [1,16,11,-2.5,18,-3,0,0,0,0,-.5,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 -11 -2.5 18 -3 0 0 0 0 -.5 0 -1 0 rect.dat
  [1,16,-11,-2.5,18,-3,0,0,0,0,-.5,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 -2.5 18 -5 0 0 0 0 -.5 0 -1 0 rect.dat
  [1,16,0,-2.5,18,-5,0,0,0,0,-.5,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 -5 18 0 0 14 -3 0 0 0 -5 0 box3u7a.dat
  [1,16,0,-5,18,0,0,14,-3,0,0,0,-5,0, ldraw_lib__box3u7a(realsolid)],
// 1 16 14 -8 18 0 -1 0 5 0 0 0 0 5 3-4disc.dat
  [1,16,14,-8,18,0,-1,0,5,0,0,0,0,5, ldraw_lib__3_4disc(realsolid)],
// 1 16 -14 -8 18 0 1 0 5 0 0 0 0 5 3-4disc.dat
  [1,16,-14,-8,18,0,1,0,5,0,0,0,0,5, ldraw_lib__3_4disc(realsolid)],
// 1 16 -14 -8 18 0 28 0 0 0 -5 -5 0 0 3-4cylo.dat
  [1,16,-14,-8,18,0,28,0,0,0,-5,-5,0,0, ldraw_lib__3_4cylo(realsolid)],
// 
// 1 16 8 -8 18 0 1 0 0 0 -5 -5 0 0 3-4edge.dat
  [1,16,8,-8,18,0,1,0,0,0,-5,-5,0,0, ldraw_lib__3_4edge(realsolid)],
// 1 16 5 -8 18 0 1 0 0 0 -5 -5 0 0 3-4edge.dat
  [1,16,5,-8,18,0,1,0,0,0,-5,-5,0,0, ldraw_lib__3_4edge(realsolid)],
// 1 16 -8 -8 18 0 1 0 0 0 -5 -5 0 0 3-4edge.dat
  [1,16,-8,-8,18,0,1,0,0,0,-5,-5,0,0, ldraw_lib__3_4edge(realsolid)],
// 1 16 -5 -8 18 0 1 0 0 0 -5 -5 0 0 3-4edge.dat
  [1,16,-5,-8,18,0,1,0,0,0,-5,-5,0,0, ldraw_lib__3_4edge(realsolid)],
// 1 16 8 -8 18 0 -1 0 0 0 -1 -1 0 0 3-4ring5.dat
  [1,16,8,-8,18,0,-1,0,0,0,-1,-1,0,0, ldraw_lib__3_4ring5(realsolid)],
// 1 16 5 -8 18 0 1 0 0 0 -1 -1 0 0 3-4ring5.dat
  [1,16,5,-8,18,0,1,0,0,0,-1,-1,0,0, ldraw_lib__3_4ring5(realsolid)],
// 1 16 -8 -8 18 0 1 0 0 0 -1 -1 0 0 3-4ring5.dat
  [1,16,-8,-8,18,0,1,0,0,0,-1,-1,0,0, ldraw_lib__3_4ring5(realsolid)],
// 1 16 -5 -8 18 0 -1 0 0 0 -1 -1 0 0 3-4ring5.dat
  [1,16,-5,-8,18,0,-1,0,0,0,-1,-1,0,0, ldraw_lib__3_4ring5(realsolid)],
// 1 16 5 -8 18 0 3 0 0 0 -6 -6 0 0 3-4cylo.dat
  [1,16,5,-8,18,0,3,0,0,0,-6,-6,0,0, ldraw_lib__3_4cylo(realsolid)],
// 1 16 -8 -8 18 0 3 0 0 0 -6 -6 0 0 3-4cylo.dat
  [1,16,-8,-8,18,0,3,0,0,0,-6,-6,0,0, ldraw_lib__3_4cylo(realsolid)],
// 
// 0 // strap
// 1 16 6.5 6.5 24.5 1.5 0 0 0 0 -4.5 0 .5 0 box2-5.dat
  [1,16,6.5,6.5,24.5,1.5,0,0,0,0,-4.5,0,.5,0, ldraw_lib__box2_5(realsolid)],
// 1 16 6.5 16 22.5 -1.5 0 0 0 0 2 0 .5 0 box2-5.dat
  [1,16,6.5,16,22.5,-1.5,0,0,0,0,2,0,.5,0, ldraw_lib__box2_5(realsolid)],
// 1 16 6.5 12.5 24 0 0 1.5 -1.5 -1 0 1 0 0 rect2p.dat
  [1,16,6.5,12.5,24,0,0,1.5,-1.5,-1,0,1,0,0, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__2524(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2524(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
