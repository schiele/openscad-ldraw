...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3068pb0026, Dragster, Race, Rebrickable 3068bpr0055
// 0 !KEYWORDS Set 1528
// 
...
module ldraw_lib__3068bp26(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068bp26(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
