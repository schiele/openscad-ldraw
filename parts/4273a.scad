...
use <s/4273s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4273a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\4273s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4273s01(realsolid)],
// 1 16 0 0 -10 0 0 1 1 0 0 0 18 0 axlehol7.dat
  [1,16,0,0,-10,0,0,1,1,0,0,0,18,0, ldraw_lib__axlehol7(realsolid)],
// 1 16 0 0 -6 0 0 7 7 0 0 0 12 0 4-4cyli.dat
  [1,16,0,0,-6,0,0,7,7,0,0,0,12,0, ldraw_lib__4_4cyli(realsolid)],
];
module ldraw_lib__4273a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4273a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
