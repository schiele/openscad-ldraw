...
use <s/3665bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3665b(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3665bs01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3665bs01(realsolid)],
// 4 16 10 24 -10 10 4 -30 -10 4 -30 -10 24 -10
  [4,16,10,24,-10,10,4,-30,-10,4,-30,-10,24,-10],
];
module ldraw_lib__3665b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3665b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
