...
use <s/30460s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30460(realsolid=false) = [
...
// 1 16 0 0 -1 -1 0 0 0 1 0 0 0 1 s\30460s01.dat
  [1,16,0,0,-1,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30460s01(realsolid)],
// 1 16 0 0 -1 1 0 0 0 1 0 0 0 1 s\30460s01.dat
  [1,16,0,0,-1,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30460s01(realsolid)],
// 1 16 10.75 0 0 0 2 0 2 0 0.095 0.095 0 -2 bump5000.dat
  [1,16,10.75,0,0,0,2,0,2,0,0.095,0.095,0,-2, ldraw_lib__bump5000(realsolid)],
// 1 16 -10.75 0 0 0 -2 0 2 0 0.095 0.095 0 -2 bump5000.dat
  [1,16,-10.75,0,0,0,-2,0,2,0,0.095,0.095,0,-2, ldraw_lib__bump5000(realsolid)],
];
module ldraw_lib__30460(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30460(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
