...
use <s/32533s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32533(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\32533s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__32533s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\32533s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__32533s01(realsolid)],
// 1 16 0 0 0 -0.5 0 -0.866025 0 1 0 0.866025 0 -0.5 s\32533s01.dat
  [1,16,0,0,0,-0.5,0,-0.866025,0,1,0,0.866025,0,-0.5, ldraw_lib__s__32533s01(realsolid)],
// 1 16 0 0 0 0.5 0 -0.866025 0 1 0 -0.866025 0 -0.5 s\32533s01.dat
  [1,16,0,0,0,0.5,0,-0.866025,0,1,0,-0.866025,0,-0.5, ldraw_lib__s__32533s01(realsolid)],
// 1 16 0 0 0 -0.5 0 0.866025 0 1 0 -0.866025 0 -0.5 s\32533s01.dat
  [1,16,0,0,0,-0.5,0,0.866025,0,1,0,-0.866025,0,-0.5, ldraw_lib__s__32533s01(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\32533s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__32533s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\32533s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__32533s02(realsolid)],
// 1 16 0 0 0 -0.5 0 -0.866025 0 1 0 0.866025 0 -0.5 s\32533s02.dat
  [1,16,0,0,0,-0.5,0,-0.866025,0,1,0,0.866025,0,-0.5, ldraw_lib__s__32533s02(realsolid)],
// 1 16 0 0 0 0.5 0 -0.866025 0 1 0 -0.866025 0 -0.5 s\32533s02.dat
  [1,16,0,0,0,0.5,0,-0.866025,0,1,0,-0.866025,0,-0.5, ldraw_lib__s__32533s02(realsolid)],
// 1 16 0 0 0 -0.5 0 0.866025 0 1 0 -0.866025 0 -0.5 s\32533s02.dat
  [1,16,0,0,0,-0.5,0,0.866025,0,1,0,-0.866025,0,-0.5, ldraw_lib__s__32533s02(realsolid)],
...
module ldraw_lib__32533(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32533(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
