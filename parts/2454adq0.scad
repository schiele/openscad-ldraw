...
// 1 16 0 60 -10 1 0 0 0 0 -1 0 1 0 4613857f.dat
  [1,16,0,60,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__4613857f()],
];
module ldraw_lib__2454adq0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2454adq0(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
