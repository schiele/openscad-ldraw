...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 821435c.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__821435c()],
];
module ldraw_lib__169675g(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__169675g(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
