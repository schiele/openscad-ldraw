...
use <s/3596s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3596p04(realsolid=false) = [
...
// 1 14 2 -132 34 0 -1 0 0 0 -1 -1 0 0 s\190315s01.dat
  [1,14,2,-132,34,0,-1,0,0,0,-1,-1,0,0, ldraw_lib__s__190315s01(realsolid)],
// 1 14 -2 -132 34 0 1 0 0 0 -1 -1 0 0 s\190315s01.dat
  [1,14,-2,-132,34,0,1,0,0,0,-1,-1,0,0, ldraw_lib__s__190315s01(realsolid)],
// 0 //
];
module ldraw_lib__3596p04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3596p04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
