...
use <4490.scad>
$fa=1; $fs=0.2;
function ldraw_lib__278(realsolid=false) = [
// 0 ~Moved to 4490
// 0 Name: 278.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 4490.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4490(realsolid)],
];
module ldraw_lib__278(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__278(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
