...
use <4615865h.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3001d02(realsolid=false) = [
...
// 1 16 0 12 -20 1 0 0 0 0 -1 0 1 0 4615865h.dat
  [1,16,0,12,-20,1,0,0,0,0,-1,0,1,0, ldraw_lib__4615865h(realsolid)],
];
module ldraw_lib__3001d02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3001d02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
