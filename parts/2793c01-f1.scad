...
// 1 0 0 -120 0 1 0 0 0 1 0 0 0 1 2796c01.dat
  [1,0,0,-120,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2796c01()],
];
module ldraw_lib__2793c01_f1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2793c01_f1(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2793c01_f1(line=0.2);