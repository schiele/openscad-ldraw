...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87754(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\87754s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87754s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\87754s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87754s01(realsolid)],
// 1 16 0 29.5 21 2.2 0 0 0 0 9.5 0 -1 0 rect.dat
  [1,16,0,29.5,21,2.2,0,0,0,0,9.5,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 29.5 19 2.2 0 0 0 0 9.5 0 1 0 rect.dat
  [1,16,0,29.5,19,2.2,0,0,0,0,9.5,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 23 28 -10 0 0 0 0 -1 0 -1 0 rect2p.dat
  [1,16,0,23,28,-10,0,0,0,0,-1,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 19.182 27.182 0 0 10 -2.8181 1 0 -0.8181 0 0 rect1.dat
  [1,16,0,19.182,27.182,0,0,10,-2.8181,1,0,-0.8181,0,0, ldraw_lib__rect1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -2 10 20 0 4 0 0 0 8 8 0 0 3-8cyli.dat
  [1,16,-2,10,20,0,4,0,0,0,8,8,0,0, ldraw_lib__3_8cyli(realsolid)],
// 1 16 -2 10 20 0 4 0 0 0 9 9 0 0 1-8cyli.dat
  [1,16,-2,10,20,0,4,0,0,0,9,9,0,0, ldraw_lib__1_8cyli(realsolid)],
...
// 1 16 0 48 -20 4 0 0 0 -16 0 0 0 -4 2-4cylo.dat
  [1,16,0,48,-20,4,0,0,0,-16,0,0,0,-4, ldraw_lib__2_4cylo(realsolid)],
// 1 16 0 32 -20 2 0 0 0 -1 0 0 0 -2 2-4con1.dat
  [1,16,0,32,-20,2,0,0,0,-1,0,0,0,-2, ldraw_lib__2_4con1(realsolid)],
// 1 16 0 31 -20 2 0 0 0 -2 0 0 0 -2 2-4cylo.dat
  [1,16,0,31,-20,2,0,0,0,-2,0,0,0,-2, ldraw_lib__2_4cylo(realsolid)],
// 1 16 0 48 -20 4 0 0 0 -1 0 0 0 4 4-4disc.dat
  [1,16,0,48,-20,4,0,0,0,-1,0,0,0,4, ldraw_lib__4_4disc(realsolid)],
...
module ldraw_lib__87754(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87754(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__87754(line=0.2);