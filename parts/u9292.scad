...
// 1 16 10 8 0 0 0 -6 0 -1 0 6 0 0 2-4ndis.dat
  [1,16,10,8,0,0,0,-6,0,-1,0,6,0,0, ldraw_lib__2_4ndis()],
...
// 1 16 10 0 0 0 0 -4 0 8 0 4 0 0 4-4cylo.dat
  [1,16,10,0,0,0,0,-4,0,8,0,4,0,0, ldraw_lib__4_4cylo()],
// 1 16 10 0 0 0 0 2 0 1 0 -2 0 0 4-4ring2.dat
  [1,16,10,0,0,0,0,2,0,1,0,-2,0,0, ldraw_lib__4_4ring2()],
// 1 16 10 8 0 0 0 -2 0 -1 0 -2 0 0 4-4ring2.dat
  [1,16,10,8,0,0,0,-2,0,-1,0,-2,0,0, ldraw_lib__4_4ring2()],
// 1 16 10 4 0 0 -6 0 4 0 0 0 0 6 box3u4a.dat
  [1,16,10,4,0,0,-6,0,4,0,0,0,0,6, ldraw_lib__box3u4a()],
// 1 16 10 0 0 0 0 6 0 8 0 -6 0 0 2-4cylo.dat
  [1,16,10,0,0,0,0,6,0,8,0,-6,0,0, ldraw_lib__2_4cylo()],
// 
// 1 16 -10 8 0 0 0 6 0 -1 0 -6 0 0 2-4ndis.dat
  [1,16,-10,8,0,0,0,6,0,-1,0,-6,0,0, ldraw_lib__2_4ndis()],
// 1 16 -10 0 0 0 0 6 0 1 0 -6 0 0 2-4ndis.dat
...
module ldraw_lib__u9292(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9292(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
