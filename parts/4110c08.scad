...
// 1 16 0 0 80 1 0 0 0 1 0 0 0 1 4113a.dat
  [1,16,0,0,80,1,0,0,0,1,0,0,0,1, ldraw_lib__4113a()],
];
module ldraw_lib__4110c08(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4110c08(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4110c08(line=0.2);