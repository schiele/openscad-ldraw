...
use <15436.scad>
use <16095.scad>
function ldraw_lib__15864() = [
// 0 Minifig Helmet Large Square with Side Extensions
// 0 Name: 15864.dat
...
// 1 16 0 -42 -14 1 0 0 0 1 0 0 0 1 15436.dat
  [1,16,0,-42,-14,1,0,0,0,1,0,0,0,1, ldraw_lib__15436()],
];
module ldraw_lib__15864(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__15864(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__15864(line=0.2);