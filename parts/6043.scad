...
use <../p/triangle.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6043(realsolid=false) = [
...
// 1 16 0 36 0 1 0 0 0 40 0 0 0 1 axlehole.dat
  [1,16,0,36,0,1,0,0,0,40,0,0,0,1, ldraw_lib__axlehole(realsolid)],
// 1 16 0 36 0 1 0 0 0 1 0 0 0 1 axlehol2.dat
  [1,16,0,36,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axlehol2(realsolid)],
...
// 1 16 0 40 0 8 0 0 0 36 0 0 0 8 4-4cyli.dat
  [1,16,0,40,0,8,0,0,0,36,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 40 8 0 0 -1 0 20 0 -1 0 0 boxjcyl4.dat
  [1,16,0,40,8,0,0,-1,0,20,0,-1,0,0, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 0 40 12 0 0 1 0 20 0 -4 0 0 box3u5p.dat
  [1,16,0,40,12,0,0,1,0,20,0,-4,0,0, ldraw_lib__box3u5p(realsolid)],
// 1 16 0 40 -8 0 0 -1 0 20 0 1 0 0 boxjcyl4.dat
  [1,16,0,40,-8,0,0,-1,0,20,0,1,0,0, ldraw_lib__boxjcyl4(realsolid)],
// 1 16 0 40 -12 0 0 1 0 20 0 4 0 0 box3u5p.dat
  [1,16,0,40,-12,0,0,1,0,20,0,4,0,0, ldraw_lib__box3u5p(realsolid)],
...
// 1 16 0 20 16 1 0 0 0 0 1 0 -1 0 stud4a.dat
  [1,16,0,20,16,1,0,0,0,0,1,0,-1,0, ldraw_lib__stud4a(realsolid)],
// 1 16 0 20 -16 1 0 0 0 0 1 0 32 0 axlehole.dat
  [1,16,0,20,-16,1,0,0,0,0,1,0,32,0, ldraw_lib__axlehole(realsolid)],
// 1 16 0 20 -16 1 0 0 0 0 1 0 -1 0 axlehol2.dat
  [1,16,0,20,-16,1,0,0,0,0,1,0,-1,0, ldraw_lib__axlehol2(realsolid)],
// 1 16 0 20 16 1 0 0 0 0 1 0 -1 0 axlehol3.dat
  [1,16,0,20,16,1,0,0,0,0,1,0,-1,0, ldraw_lib__axlehol3(realsolid)],
// 1 16 0 20 -16 8 0 0 0 0 8 0 32 0 4-4cyli.dat
  [1,16,0,20,-16,8,0,0,0,0,8,0,32,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 20 -16 8 0 0 0 0 8 0 -1 0 4-4edge.dat
  [1,16,0,20,-16,8,0,0,0,0,8,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 
// 1 16 0 20 -22 8 0 0 0 0 8 8 -1 0 1-8edge.dat
  [1,16,0,20,-22,8,0,0,0,0,8,8,-1,0, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 20 -22 -8 0 0 0 0 8 8 -1 0 1-8edge.dat
  [1,16,0,20,-22,-8,0,0,0,0,8,8,-1,0, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 20 -22 8 0 0 0 0 -8 8 -1 0 1-8edge.dat
  [1,16,0,20,-22,8,0,0,0,0,-8,8,-1,0, ldraw_lib__1_8edge(realsolid)],
...
// 1 16 0 40 0 8 0 0 0 -1 0 0 0 8 4-4ndis.dat
  [1,16,0,40,0,8,0,0,0,-1,0,0,0,8, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 0 36 0 6 0 0 0 1 0 0 0 6 4-4ndis.dat
  [1,16,0,36,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 0 4 0 0 0 -6 0 -1 0 -16 0 0 rect2p.dat
  [1,16,0,4,0,0,0,-6,0,-1,0,-16,0,0, ldraw_lib__rect2p(realsolid)],
// 
...
// 1 16 -16 20 5 0 -1 0 6 0 0 0 0 -11 rect3.dat
  [1,16,-16,20,5,0,-1,0,6,0,0,0,0,-11, ldraw_lib__rect3(realsolid)],
// 
...
// 1 16 0 40 0 8 0 0 0 -40 0 0 0 -20 box2-5.dat
  [1,16,0,40,0,8,0,0,0,-40,0,0,0,-20, ldraw_lib__box2_5(realsolid)],
// 
// 1 16 0 60 20 -8 0 0 0 0 20 0 -1 0 rect3.dat
  [1,16,0,60,20,-8,0,0,0,0,20,0,-1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 58 16 6 0 0 0 0 -18 0 1 0 rect3.dat
  [1,16,0,58,16,6,0,0,0,0,-18,0,1,0, ldraw_lib__rect3(realsolid)],
// 
// 3 16 -12 80 -16 -12 76 -16 -6 76 -16
  [3,16,-12,80,-16,-12,76,-16,-6,76,-16],
// 4 16 -12 80 -16 -6 76 -16 6 76 -16 12 80 -16
...
// 1 16 16 54 0 0 1 0 0 0 -22 -6 0 0 rect3.dat
  [1,16,16,54,0,0,1,0,0,0,-22,-6,0,0, ldraw_lib__rect3(realsolid)],
// 
// 3 16 -16 80 12 -16 76 12 -16 76 6
  [3,16,-16,80,12,-16,76,12,-16,76,6],
// 4 16 -16 80 12 -16 76 6 -16 76 -6 -16 80 -12
...
// 1 16 0 20 -16 0 0 6 16 0 0 0 -1 0 rect.dat
  [1,16,0,20,-16,0,0,6,16,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 
...
// 1 16 -12 36 20 4 1 0 4 0 0 0 0 -4 triangle.dat
  [1,16,-12,36,20,4,1,0,4,0,0,0,0,-4, ldraw_lib__triangle(realsolid)],
...
module ldraw_lib__6043(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6043(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
