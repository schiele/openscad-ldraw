...
use <../p/stug-8x8.scad>
$fa=1; $fs=0.2;
function ldraw_lib__10p03(realsolid=false) = [
...
// 1 16 -110 0 170 1 0 0 0 1 0 0 0 1 stug-7x7.dat
  [1,16,-110,0,170,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_7x7(realsolid)],
// 1 16 30 0 170 1 0 0 0 1 0 0 0 1 stug-7x7.dat
  [1,16,30,0,170,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_7x7(realsolid)],
// 1 16 200 0 230 1 0 0 0 1 0 0 0 1 stug-1x10.dat
  [1,16,200,0,230,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x10(realsolid)],
// 1 16 220 0 210 1 0 0 0 1 0 0 0 1 stug-1x10.dat
  [1,16,220,0,210,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x10(realsolid)],
// 1 16 140 0 180 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,140,0,180,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 1 16 220 0 180 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,220,0,180,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 1 16 300 0 180 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,300,0,180,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 1 16 270 0 110 1 0 0 0 1 0 0 0 1 stug-5x5.dat
  [1,16,270,0,110,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_5x5(realsolid)],
// 1 16 170 0 110 1 0 0 0 1 0 0 0 1 stug-5x5.dat
  [1,16,170,0,110,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_5x5(realsolid)],
// 1 16 -280 0 90 1 0 0 0 1 0 0 0 1 stug-1x4.dat
  [1,16,-280,0,90,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x4(realsolid)],
// 1 16 -300 0 60 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,-300,0,60,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 1 16 -190 0 50 1 0 0 0 1 0 0 0 1 stug-5x5.dat
  [1,16,-190,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_5x5(realsolid)],
// 1 16 -190 0 -50 1 0 0 0 1 0 0 0 1 stug-5x5.dat
  [1,16,-190,0,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_5x5(realsolid)],
// 1 16 -90 0 50 1 0 0 0 1 0 0 0 1 stug-5x5.dat
  [1,16,-90,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_5x5(realsolid)],
...
// 1 16 -290 0 -60 1 0 0 0 1 0 0 0 1 stug-6x1.dat
  [1,16,-290,0,-60,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_6x1(realsolid)],
// 1 16 -250 0 -50 1 0 0 0 1 0 0 0 1 stug-5x1.dat
  [1,16,-250,0,-50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_5x1(realsolid)],
// 1 16 -240 0 -110 1 0 0 0 1 0 0 0 1 stug-1x2.dat
  [1,16,-240,0,-110,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x2(realsolid)],
...
// 1 16 -40 0 -160 1 0 0 0 1 0 0 0 1 stug-8x8.dat
  [1,16,-40,0,-160,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_8x8(realsolid)],
...
// 1 16 -150 0 -150 1 0 0 0 1 0 0 0 1 stug-3x3.dat
  [1,16,-150,0,-150,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_3x3(realsolid)],
// 1 16 -80 0 -40 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,-80,0,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4(realsolid)],
// 1 16 100 0 -180 1 0 0 0 1 0 0 0 1 stug-6x6.dat
  [1,16,100,0,-180,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_6x6(realsolid)],
...
// 1 16 270 0 -30 1 0 0 0 1 0 0 0 1 stug-5x5.dat
  [1,16,270,0,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_5x5(realsolid)],
// 1 16 170 0 -30 1 0 0 0 1 0 0 0 1 stug-5x5.dat
  [1,16,170,0,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_5x5(realsolid)],
// 1 16 300 0 40 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,300,0,40,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
...
// 1 16 290 0 -160 1 0 0 0 1 0 0 0 1 stug-8x1.dat
  [1,16,290,0,-160,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_8x1(realsolid)],
// 1 16 210 0 -90 1 0 0 0 1 0 0 0 1 stug-1x3.dat
  [1,16,210,0,-90,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x3(realsolid)],
// 1 16 210 0 -110 1 0 0 0 1 0 0 0 1 stug-1x3.dat
  [1,16,210,0,-110,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x3(realsolid)],
// 1 16 210 0 50 1 0 0 0 1 0 0 0 1 stug-1x3.dat
  [1,16,210,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x3(realsolid)],
// 1 16 210 0 30 1 0 0 0 1 0 0 0 1 stug-1x3.dat
  [1,16,210,0,30,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x3(realsolid)],
// 1 16 -10 0 70 1 0 0 0 1 0 0 0 1 stug-3x3.dat
  [1,16,-10,0,70,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_3x3(realsolid)],
// 1 16 -10 0 10 1 0 0 0 1 0 0 0 1 stug-3x3.dat
  [1,16,-10,0,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_3x3(realsolid)],
// 1 16 90 0 70 1 0 0 0 1 0 0 0 1 stug-3x3.dat
  [1,16,90,0,70,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_3x3(realsolid)],
...
// 1 16 110 0 -90 1 0 0 0 1 0 0 0 1 stug-1x3.dat
  [1,16,110,0,-90,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x3(realsolid)],
// 1 16 110 0 -110 1 0 0 0 1 0 0 0 1 stug-1x3.dat
  [1,16,110,0,-110,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x3(realsolid)],
// 1 16 130 0 40 1 0 0 0 1 0 0 0 1 stug-2x1.dat
  [1,16,130,0,40,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x1(realsolid)],
...
// 1 16 40 0 0 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,40,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 1 16 -30 0 -60 1 0 0 0 1 0 0 0 1 stug-2x1.dat
  [1,16,-30,0,-60,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x1(realsolid)],
// 1 16 10 0 -30 1 0 0 0 1 0 0 0 1 stug-1x5.dat
  [1,16,10,0,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x5(realsolid)],
// 
// 1 16 110 0 210 1 0 0 0 1 0 0 0 1 studp01.dat
  [1,16,110,0,210,1,0,0,0,1,0,0,0,1, ldraw_lib__studp01(realsolid)],
// 1 16 -190 0 210 1 0 0 0 1 0 0 0 1 studp01.dat
  [1,16,-190,0,210,1,0,0,0,1,0,0,0,1, ldraw_lib__studp01(realsolid)],
...
// 1 16 110 0 110 1 0 0 0 1 0 0 0 1 studp01.dat
  [1,16,110,0,110,1,0,0,0,1,0,0,0,1, ldraw_lib__studp01(realsolid)],
...
module ldraw_lib__10p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__10p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
