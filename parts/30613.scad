...
// 1 16 -50 0 40 1 0 0 0 1 0 0 0 1 stud2a.dat
  [1,16,-50,0,40,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2a()],
// 1 16 -50 0 20 1 0 0 0 1 0 0 0 1 stud2a.dat
  [1,16,-50,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2a()],
...
module ldraw_lib__30613(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30613(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
