...
use <s/24246s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__24246p03(realsolid=false) = [
...
// 1 0 0 0 0 9.5 0 0 0 1 0 0 0 -9.5 2-4chrd.dat
  [1,0,0,0,0,9.5,0,0,0,1,0,0,0,-9.5, ldraw_lib__2_4chrd(realsolid)],
// 1 16 0 0 0 .5 0 0 0 1 0 0 0 -.5 2-4ring19.dat
  [1,16,0,0,0,.5,0,0,0,1,0,0,0,-.5, ldraw_lib__2_4ring19(realsolid)],
// 0 // Black faces
...
module ldraw_lib__24246p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__24246p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
