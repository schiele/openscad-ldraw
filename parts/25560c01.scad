...
use <../p/recte4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__25560c01(realsolid=false) = [
// 0 ~Electric Control+ Hub Bottom with Electric Contacts
// 0 Name: 25560c01.dat
...
// 
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 25560.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__25560(realsolid)],
// 0 // Contacts
...
// 4 494 5 -20 74 5 8 74 5 7 75 5 -20 75
  [4,494,5,-20,74,5,8,74,5,7,75,5,-20,75],
// 4 494 -13 8 74 -13 7 75 -13 7 80 -13 8 80
  [4,494,-13,8,74,-13,7,75,-13,7,80,-13,8,80],
...
// 4 494 -37 -20 74 -37 8 74 -37 7 75 -37 -20 75
  [4,494,-37,-20,74,-37,8,74,-37,7,75,-37,-20,75],
// 4 494 -55 8 74 -55 7 75 -55 7 80 -55 8 80
  [4,494,-55,8,74,-55,7,75,-55,7,80,-55,8,80],
// 4 494 -55 -20 74 -55 -20 75 -55 7 75 -55 8 74
  [4,494,-55,-20,74,-55,-20,75,-55,7,75,-55,8,74],
// 0 // Battery rubber button
// 1 496 26 -24 50 6 0 0 0 6 0 0 0 6 4-4cylc.dat
  [1,496,26,-24,50,6,0,0,0,6,0,0,0,6, ldraw_lib__4_4cylc(realsolid)],
// 1 496 26 -18 50 6 0 0 0 -1 0 0 0 6 4-4disc.dat
  [1,496,26,-18,50,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4disc(realsolid)],
// 1 496 26 -16.5 50 2 0 0 0 -1.5 0 0 0 2 4-4cylc.dat
  [1,496,26,-16.5,50,2,0,0,0,-1.5,0,0,0,2, ldraw_lib__4_4cylc(realsolid)],
];
module ldraw_lib__25560c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__25560c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__25560c01(line=0.2);