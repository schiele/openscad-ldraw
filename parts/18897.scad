...
use <../p/stug-4x4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__18897(realsolid=false) = [
...
// 1 16 0 20 0 1 0 0 0 -1 0 0 0 1 stud18a.dat
  [1,16,0,20,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud18a(realsolid)],
// 1 16 0 20 0 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,0,20,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge(realsolid)],
// 1 16 -20 4 40 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-20,4,40,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 20 4 40 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,20,4,40,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
// 1 16 0 8 0 6 0 0 0 12 0 0 0 6 4-4cyli.dat
  [1,16,0,8,0,6,0,0,0,12,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 8 0 1 0 0 0 1 0 0 0 1 4-4ring6.dat
  [1,16,0,8,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4ring6(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 7 0 0 0 8 0 0 0 7 4-4cyli.dat
  [1,16,0,0,0,7,0,0,0,8,0,0,0,7, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 10 0 8 0 0 0 10 0 0 0 8 4-4cyli.dat
  [1,16,0,10,0,8,0,0,0,10,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 4 0 10 0 0 0 6 0 0 0 10 4-4cyli.dat
  [1,16,0,4,0,10,0,0,0,6,0,0,0,10, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 10 0 10 0 0 0 1 0 0 0 10 4-4edge.dat
  [1,16,0,10,0,10,0,0,0,1,0,0,0,10, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 8 0 7 0 0 0 1 0 0 0 7 4-4edge.dat
  [1,16,0,8,0,7,0,0,0,1,0,0,0,7, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\18897s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__18897s01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 1 0 0 s\18897s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,1,0,0, ldraw_lib__s__18897s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\18897s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__18897s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\18897s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__18897s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\18897s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__18897s01(realsolid)],
...
// 1 16 0 4 0 5 0 0 0 -1 0 0 0 5 4-4ring2.dat
  [1,16,0,4,0,5,0,0,0,-1,0,0,0,5, ldraw_lib__4_4ring2(realsolid)],
// 1 16 0 4 0 3 0 0 0 -1 0 0 0 3 4-4ring5.dat
  [1,16,0,4,0,3,0,0,0,-1,0,0,0,3, ldraw_lib__4_4ring5(realsolid)],
// 1 16 0 4 0 9 0 0 0 -1 0 0 0 9 4-4ring2.dat
  [1,16,0,4,0,9,0,0,0,-1,0,0,0,9, ldraw_lib__4_4ring2(realsolid)],
// 1 16 0 4 0 27 0 0 0 -1 0 0 0 27 4-4ring1.dat
  [1,16,0,4,0,27,0,0,0,-1,0,0,0,27, ldraw_lib__4_4ring1(realsolid)],
// 1 16 0 4 0 54 0 0 0 -1 0 0 0 54 48\4-4aring.dat
  [1,16,0,4,0,54,0,0,0,-1,0,0,0,54, ldraw_lib__48__4_4aring(realsolid)],
// 1 16 0 4 0 2 0 0 0 -1 0 0 0 2 48\4-4rin27.dat
  [1,16,0,4,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__48__4_4rin27(realsolid)],
...
// 1 16 0 0 0 4 0 0 0 1 0 0 0 4 4-4ring2.dat
  [1,16,0,0,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4ring2(realsolid)],
...
// 1 16 0 0 0 15 0 0 0 1 0 0 0 15 4-4ring1.dat
  [1,16,0,0,0,15,0,0,0,1,0,0,0,15, ldraw_lib__4_4ring1(realsolid)],
// 1 16 0 0 0 30 0 0 0 1 0 0 0 30 4-4ring1.dat
  [1,16,0,0,0,30,0,0,0,1,0,0,0,30, ldraw_lib__4_4ring1(realsolid)],
// 1 16 0 0 0 60 0 0 0 1 0 0 0 60 48\4-4aring.dat
  [1,16,0,0,0,60,0,0,0,1,0,0,0,60, ldraw_lib__48__4_4aring(realsolid)],
...
// 1 16 0 0 0 60 0 0 0 1 0 0 0 60 48\4-4edge.dat
  [1,16,0,0,0,60,0,0,0,1,0,0,0,60, ldraw_lib__48__4_4edge(realsolid)],
// 0 // Studs
// 1 16 -10 0 50 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,-10,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
// 1 16 10 0 50 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,10,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
// 1 16 -50 0 10 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,-50,0,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
// 1 16 50 0 10 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,50,0,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
...
module ldraw_lib__18897(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__18897(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
