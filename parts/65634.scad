...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\65634s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__65634s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\65634s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__65634s01()],
// 
// 1 16 10 16 0 0 0 -1 0 1 0 1 0 0 stug2-4x4.dat
  [1,16,10,16,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug2_4x4()],
// 1 16 -40 16 0 0 0 -1 0 1 0 1 0 0 stug2-1x4.dat
  [1,16,-40,16,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug2_1x4()],
// 1 16 0 0 50 0 0 -1 0 1 0 1 0 0 stug-6x1.dat
  [1,16,0,0,50,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_6x1()],
// 1 16 0 0 -50 0 0 -1 0 1 0 1 0 0 stug-6x1.dat
  [1,16,0,0,-50,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_6x1()],
// 1 16 0 8 70 0 0 -1 0 1 0 1 0 0 stug-6x1.dat
  [1,16,0,8,70,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_6x1()],
// 1 16 0 8 -70 0 0 -1 0 1 0 1 0 0 stug-6x1.dat
  [1,16,0,8,-70,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_6x1()],
// 1 16 0 8 90 0 0 -1 0 1 0 1 0 0 stug-4x1.dat
  [1,16,0,8,90,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_4x1()],
// 1 16 0 8 -90 0 0 -1 0 1 0 1 0 0 stug-4x1.dat
  [1,16,0,8,-90,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_4x1()],
// 1 16 0 8 110 0 0 -1 0 1 0 1 0 0 stug-4x1.dat
  [1,16,0,8,110,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_4x1()],
// 1 16 0 8 -110 0 0 -1 0 1 0 1 0 0 stug-4x1.dat
  [1,16,0,8,-110,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_4x1()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 20 0 40 0 0 0 4 0 0 0 40 box4.dat
  [1,16,0,20,0,40,0,0,0,4,0,0,0,40, ldraw_lib__box4()],
// 1 16 0 20 0 0 0 -4 0 1 0 40 0 0 box3u2p.dat
  [1,16,0,20,0,0,0,-4,0,1,0,40,0,0, ldraw_lib__box3u2p()],
];
module ldraw_lib__65634(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__65634(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
