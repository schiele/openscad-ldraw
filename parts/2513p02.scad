...
use <s/2513s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2513p02(realsolid=false) = [
...
// 1 16 0 0.5 -11 0.9 0 0 0 1 -0.44 0 0 0.88 s\2513p02s01.dat
  [1,16,0,0.5,-11,0.9,0,0,0,1,-0.44,0,0,0.88, ldraw_lib__s__2513p02s01(realsolid)],
// 1 16 0 0.5 -11 -0.9 0 0 0 1 -0.44 0 0 0.88 s\2513p02s01.dat
  [1,16,0,0.5,-11,-0.9,0,0,0,1,-0.44,0,0,0.88, ldraw_lib__s__2513p02s01(realsolid)],
...
module ldraw_lib__2513p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2513p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
