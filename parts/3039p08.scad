...
use <s/3039s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3039p08(realsolid=false) = [
...
// 1 16 0 2.8 -12.8 1 0 0 0 1 -.70711 0 0 .70711 s\3039p08s02.dat
  [1,16,0,2.8,-12.8,1,0,0,0,1,-.70711,0,0,.70711, ldraw_lib__s__3039p08s02(realsolid)],
// 1 16 0 2.8 -12.8 -1 0 0 0 1 -.70711 0 0 .70711 s\3039p08s02.dat
  [1,16,0,2.8,-12.8,-1,0,0,0,1,-.70711,0,0,.70711, ldraw_lib__s__3039p08s02(realsolid)],
...
module ldraw_lib__3039p08(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3039p08(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
