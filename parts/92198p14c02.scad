...
function ldraw_lib__92198p14c02() = [
...
// 1 191 0 -64 0 1 0 0 0 1 0 0 0 1 21490c01.dat
  [1,191,0,-64,0,1,0,0,0,1,0,0,0,1, ldraw_lib__21490c01()],
];
module ldraw_lib__92198p14c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92198p14c02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
