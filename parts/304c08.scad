...
// 1 4 0 16 30 0 0 1 0 1 0 -1 0 0 304c06.dat
  [1,4,0,16,30,0,0,1,0,1,0,-1,0,0, ldraw_lib__304c06()],
...
module ldraw_lib__304c08(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__304c08(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
