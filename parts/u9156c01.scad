...
use <55209.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9156c01(realsolid=false) = [
// 0 Electric Sound Brick  2 x  4 x  2 with Grey Button
// 0 Name: u9156c01.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 55205c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__55205c01(realsolid)],
// 1 71 48 34 0 0 0 -1 0 1 0 1 0 0 55209.dat
  [1,71,48,34,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__55209(realsolid)],
];
module ldraw_lib__u9156c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9156c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
