...
use <../p/tri4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4768(realsolid=false) = [
...
// 1 16 0 9 0 16 0 0 0 1 0 0 0 8 recte4.dat
  [1,16,0,9,0,16,0,0,0,1,0,0,0,8, ldraw_lib__recte4(realsolid)],
...
// 1 16 0 12.5 8 16 0 0 0 0 3.5 0 1 0 recte3.dat
  [1,16,0,12.5,8,16,0,0,0,0,3.5,0,1,0, ldraw_lib__recte3(realsolid)],
// 
// 4 16 16 16 -8 16 9 -8 3 9 -8 3 12 -8
  [4,16,16,16,-8,16,9,-8,3,9,-8,3,12,-8],
// 4 16 -16 16 -8 16 16 -8 3 12 -8 -3 12 -8
...
// 1 494 16.25 12.5 0 0 0.25 0 3.5 0 0 0 0 8 box.dat
  [1,494,16.25,12.5,0,0,0.25,0,3.5,0,0,0,0,8, ldraw_lib__box(realsolid)],
// 1 494 -16.25 12.5 0 0 0.25 0 3.5 0 0 0 0 8 box.dat
  [1,494,-16.25,12.5,0,0,0.25,0,3.5,0,0,0,0,8, ldraw_lib__box(realsolid)],
// 
// 1 494 5 8.25 6 0 10 0 0.25 0 0 0 0 0.25 4-4cylc.dat
  [1,494,5,8.25,6,0,10,0,0.25,0,0,0,0,0.25, ldraw_lib__4_4cylc(realsolid)],
// 1 494 15 8.25 6 0 -1 0 0.25 0 0 0 0 0.25 4-4disc.dat
  [1,494,15,8.25,6,0,-1,0,0.25,0,0,0,0,0.25, ldraw_lib__4_4disc(realsolid)],
// 1 494 5 8.25 -6 0 10 0 0.25 0 0 0 0 0.25 4-4cylc.dat
  [1,494,5,8.25,-6,0,10,0,0.25,0,0,0,0,0.25, ldraw_lib__4_4cylc(realsolid)],
// 1 494 15 8.25 -6 0 -1 0 0.25 0 0 0 0 0.25 4-4disc.dat
  [1,494,15,8.25,-6,0,-1,0,0.25,0,0,0,0,0.25, ldraw_lib__4_4disc(realsolid)],
...
// 1 47 0 -6 0 4 0 0 0 -4 0 0 0 4 4-8sphe.dat
  [1,47,0,-6,0,4,0,0,0,-4,0,0,0,4, ldraw_lib__4_8sphe(realsolid)],
// 1 47 0 -6 0 4 0 0 0 8 0 0 0 4 4-4cyli.dat
  [1,47,0,-6,0,4,0,0,0,8,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 47 0 2 0 4 0 0 0 -1 0 0 0 4 4-4disc.dat
  [1,47,0,2,0,4,0,0,0,-1,0,0,0,4, ldraw_lib__4_4disc(realsolid)],
// 1 47 0 2 0 4 0 0 0 -1 0 0 0 4 4-4edge.dat
  [1,47,0,2,0,4,0,0,0,-1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
];
module ldraw_lib__4768(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4768(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
