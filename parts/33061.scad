...
use <../p/r04o1000.scad>
$fa=1; $fs=0.2;
function ldraw_lib__33061(realsolid=false) = [
...
// 1 16 0 4 0 7.5 0 0 0 1 0 0 0 7.5 4-4edge.dat
  [1,16,0,4,0,7.5,0,0,0,1,0,0,0,7.5, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 4 0 7.5 0 0 0 14 0 0 0 7.5 4-4cyli.dat
  [1,16,0,4,0,7.5,0,0,0,14,0,0,0,7.5, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 18 0 7.5 0 0 0 1 0 0 0 7.5 4-4disc.dat
  [1,16,0,18,0,7.5,0,0,0,1,0,0,0,7.5, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 18 0 7.5 0 0 0 1 0 0 0 7.5 4-4edge.dat
  [1,16,0,18,0,7.5,0,0,0,1,0,0,0,7.5, ldraw_lib__4_4edge(realsolid)],
// 
// 0 // outside
// 1 16 0 14 0 1 0 0 0 -8 0 0 0 1 4-4con11.dat
  [1,16,0,14,0,1,0,0,0,-8,0,0,0,1, ldraw_lib__4_4con11(realsolid)],
// 1 16 0 6 0 1 0 0 0 -6 0 0 0 1 4-4con10.dat
  [1,16,0,6,0,1,0,0,0,-6,0,0,0,1, ldraw_lib__4_4con10(realsolid)],
// 1 16 0 14 0 6 0 0 0 6 0 0 0 6 r04o1000.dat
  [1,16,0,14,0,6,0,0,0,6,0,0,0,6, ldraw_lib__r04o1000(realsolid)],
// 1 16 0 14 0 6 0 0 0 6 0 0 0 -6 r04o1000.dat
  [1,16,0,14,0,6,0,0,0,6,0,0,0,-6, ldraw_lib__r04o1000(realsolid)],
// 1 16 0 14 0 -6 0 0 0 6 0 0 0 6 r04o1000.dat
  [1,16,0,14,0,-6,0,0,0,6,0,0,0,6, ldraw_lib__r04o1000(realsolid)],
...
// 1 16 0 48 0 2 0 0 0 -1 0 0 0 2 4-4ring4.dat
  [1,16,0,48,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring4(realsolid)],
// 1 16 0 48 0 10 0 0 0 1 0 0 0 10 4-4edge.dat
  [1,16,0,48,0,10,0,0,0,1,0,0,0,10, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 44 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,44,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 44 0 6 0 0 0 4 0 0 0 6 4-4cyli.dat
  [1,16,0,44,0,6,0,0,0,4,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 44 0 6 0 0 0 -1 0 0 0 6 4-4disc.dat
  [1,16,0,44,0,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 40 0 1 0 0 0 1 0 0 0 1 4-4ring4.dat
  [1,16,0,40,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4ring4(realsolid)],
// 1 16 0 46 0 5 0 0 0 -6 0 0 0 5 r04o1000.dat
  [1,16,0,46,0,5,0,0,0,-6,0,0,0,5, ldraw_lib__r04o1000(realsolid)],
// 1 16 0 46 0 5 0 0 0 -6 0 0 0 -5 r04o1000.dat
  [1,16,0,46,0,5,0,0,0,-6,0,0,0,-5, ldraw_lib__r04o1000(realsolid)],
// 1 16 0 46 0 -5 0 0 0 -6 0 0 0 5 r04o1000.dat
  [1,16,0,46,0,-5,0,0,0,-6,0,0,0,5, ldraw_lib__r04o1000(realsolid)],
...
// 1 16 0 46 0 10 0 0 0 2 0 0 0 10 4-4cyli.dat
  [1,16,0,46,0,10,0,0,0,2,0,0,0,10, ldraw_lib__4_4cyli(realsolid)],
// 
// 0 // stem
...
// 1 16 0 40 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,0,40,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
...
module ldraw_lib__33061(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__33061(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
