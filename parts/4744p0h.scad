...
use <s/4744s01.scad>
function ldraw_lib__4744p0h() = [
// 0 Brick  2 x  4 x  2 with Curved Top with Medium Orange Animal Face Pattern
// 0 Name: 4744p0h.dat
...
// 0 !KEYWORDS Rebrickable 4744pr0015, Set 1705
// 
...
// 1 462 0 0 0 1 0 0 0 1 0 0 0 1 s\4744p0gs02.dat
  [1,462,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4744p0gs02()],
];
module ldraw_lib__4744p0h(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4744p0h(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4744p0h(line=0.2);