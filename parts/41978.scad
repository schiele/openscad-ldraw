...
$fa=1; $fs=0.2;
function ldraw_lib__41978(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\41978s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__41978s01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\41978s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__41978s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\41978s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__41978s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\41978s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__41978s01(realsolid)],
...
module ldraw_lib__41978(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__41978(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__41978(line=0.2);