...
use <4613908m.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3245bdq2(realsolid=false) = [
...
// 1 16 0 24 -10 1 0 0 0 0 -1 0 1 0 4613908m.dat
  [1,16,0,24,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__4613908m(realsolid)],
];
module ldraw_lib__3245bdq2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3245bdq2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
