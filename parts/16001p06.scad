use <../lib.scad>
use <16000p06.scad>
function ldraw_lib__16001p06() = [
// 0 Minifig Arm Left with Bright Light Yellow Lower Arm Pattern
// 0 Name: 16001p06.dat
...
// 
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 16000p06.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__16000p06()],
];
module ldraw_lib__16001p06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__16001p06(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__16001p06(line=0.2);