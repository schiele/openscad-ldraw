...
use <41539.scad>
$fa=1; $fs=0.2;
function ldraw_lib__42534(realsolid=false) = [
// 0 =Plate  8 x  8
// 0 Name: 42534.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 41539.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__41539(realsolid)],
];
module ldraw_lib__42534(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__42534(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
