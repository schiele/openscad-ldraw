...
use <u9580.scad>
use <u9581.scad>
function ldraw_lib__u9582a() = [
// 0 Train Brick  2 x  4 x  1.333 Sliding Wheel Block - Type A
// 0 Name: u9582a.dat
...
// 0 !HELP 1 16 0 0 -26 1 0 0 0 1 0 0 0 1 u9582a.dat
...
// 
// 
// 1 16 0 0 76 1 0 0 0 1 0 0 0 1 u9579a.dat
  [1,16,0,0,76,1,0,0,0,1,0,0,0,1, ldraw_lib__u9579a()],
// 
// 0 // Axle Bushes
...
module ldraw_lib__u9582a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9582a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9582a(line=0.2);