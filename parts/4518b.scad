...
use <s/4518s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4518b(realsolid=false) = [
...
// 1 16 0 2 -14 20 0 0 0 0 -4 0 4 0 box4o8a.dat
  [1,16,0,2,-14,20,0,0,0,0,-4,0,4,0, ldraw_lib__box4o8a(realsolid)],
// 2 24 20 -2 -10 -20 -2 -10
  [2,24,20,-2,-10,-20,-2,-10],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 2 -4 0 0 1.5 -4 0 0 0 -6 0 box3u7a.dat
  [1,16,0,2,-4,0,0,1.5,-4,0,0,0,-6,0, ldraw_lib__box3u7a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 2 -4 0 0 4 -4 0 0 0 -6 0 box3u7a.dat
  [1,16,10,2,-4,0,0,4,-4,0,0,0,-6,0, ldraw_lib__box3u7a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -10 2 -4 0 0 4 -4 0 0 0 -6 0 box3u7a.dat
  [1,16,-10,2,-4,0,0,4,-4,0,0,0,-6,0, ldraw_lib__box3u7a(realsolid)],
// 1 16 17 2 -7 0 0 3 0 4 0 -3 0 0 box2-11.dat
  [1,16,17,2,-7,0,0,3,0,4,0,-3,0,0, ldraw_lib__box2_11(realsolid)],
// 1 16 -17 2 -7 0 0 -3 0 4 0 3 0 0 box2-11.dat
  [1,16,-17,2,-7,0,0,-3,0,4,0,3,0,0, ldraw_lib__box2_11(realsolid)],
...
// 1 16 3.75 -4 -7 2.25 0 0 0 -2 0 0 2 -1 box2-7.dat
  [1,16,3.75,-4,-7,2.25,0,0,0,-2,0,0,2,-1, ldraw_lib__box2_7(realsolid)],
// 1 16 -3.75 -4 -7 2.25 0 0 0 -2 0 0 2 -1 box2-7.dat
  [1,16,-3.75,-4,-7,2.25,0,0,0,-2,0,0,2,-1, ldraw_lib__box2_7(realsolid)],
// 1 16 17 -4 -7 3 0 0 0 -2 0 0 2 -1 box2-7.dat
  [1,16,17,-4,-7,3,0,0,0,-2,0,0,2,-1, ldraw_lib__box2_7(realsolid)],
// 1 16 -17 -4 -7 3 0 0 0 -2 0 0 2 -1 box2-7.dat
  [1,16,-17,-4,-7,3,0,0,0,-2,0,0,2,-1, ldraw_lib__box2_7(realsolid)],
// 1 16 -10 0 -4 1 0 0 0 -1 0 0 0 1 clh10.dat
  [1,16,-10,0,-4,1,0,0,0,-1,0,0,0,1, ldraw_lib__clh10(realsolid)],
// 1 16 -8.6667 0 -4 -1.3333 0 0 0 -1 0 0 0 1 clh10.dat
  [1,16,-8.6667,0,-4,-1.3333,0,0,0,-1,0,0,0,1, ldraw_lib__clh10(realsolid)],
// 1 16 10 0 -4 -1 0 0 0 1 0 0 0 1 clh10.dat
  [1,16,10,0,-4,-1,0,0,0,1,0,0,0,1, ldraw_lib__clh10(realsolid)],
// 1 16 8.6667 0 -4 1.3333 0 0 0 1 0 0 0 1 clh10.dat
  [1,16,8.6667,0,-4,1.3333,0,0,0,1,0,0,0,1, ldraw_lib__clh10(realsolid)],
...
// 1 16 0 -2 -24 1 0 0 0 1 0 0 0 1 s\4518s01.dat
  [1,16,0,-2,-24,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4518s01(realsolid)],
];
module ldraw_lib__4518b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4518b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
