...
use <../p/stug-2x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__28326(realsolid=false) = [
...
// 1 16 0 8 -10 0 0 -16 0 -4 0 26 0 0 box5.dat
  [1,16,0,8,-10,0,0,-16,0,-4,0,26,0,0, ldraw_lib__box5(realsolid)],
...
// 1 16 0 4 -20 -20 0 0 0 0 -4 0 40 0 box4-2p.dat
  [1,16,0,4,-20,-20,0,0,0,0,-4,0,40,0, ldraw_lib__box4_2p(realsolid)],
...
// 1 16 0 4 -37.5 20 0 0 0 -1.5 2.5 0 0 -2.5 box2-9p.dat
  [1,16,0,4,-37.5,20,0,0,0,-1.5,2.5,0,0,-2.5, ldraw_lib__box2_9p(realsolid)],
...
// 1 16 20 20 -20 0 0 12 -12 0 0 0 -4 0 1-4cylo.dat
  [1,16,20,20,-20,0,0,12,-12,0,0,0,-4,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 20 20 -24 0 0 4 -4 0 0 0 1 0 1-4ring3.dat
  [1,16,20,20,-24,0,0,4,-4,0,0,0,1,0, ldraw_lib__1_4ring3(realsolid)],
// 1 16 20 6 -30 0 -1 0 -2 0 0 0 0 -6 rect.dat
  [1,16,20,6,-30,0,-1,0,-2,0,0,0,0,-6, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 20 -36 0 0 16 -16 0 0 0 12 0 1-4cylo.dat
  [1,16,20,20,-36,0,0,16,-16,0,0,0,12,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 20 20 -36 0 0 4 -4 0 0 0 -1 0 1-4ring3.dat
  [1,16,20,20,-36,0,0,4,-4,0,0,0,-1,0, ldraw_lib__1_4ring3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 20 -40 0 0 12 -12 0 0 0 4 0 1-4cylo.dat
  [1,16,20,20,-40,0,0,12,-12,0,0,0,4,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 20 20 -20 0 0 4 -4 0 0 0 -1 0 1-4ring3.dat
  [1,16,20,20,-20,0,0,4,-4,0,0,0,-1,0, ldraw_lib__1_4ring3(realsolid)],
// 1 16 20 20 -20 0 0 4 -4 0 0 0 -1 0 1-4ring4.dat
  [1,16,20,20,-20,0,0,4,-4,0,0,0,-1,0, ldraw_lib__1_4ring4(realsolid)],
// 1 16 20 20 -20 0 0 20 -20 0 0 0 -15 0 1-4cylo.dat
  [1,16,20,20,-20,0,0,20,-20,0,0,0,-15,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 20 20 -40 0 0 15 -15 0 0 0 -1 0 1-4edge.dat
  [1,16,20,20,-40,0,0,15,-15,0,0,0,-1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 20 20 -35 0 0 5 -5 0 0 0 -5 0 1-4con3.dat
  [1,16,20,20,-35,0,0,5,-5,0,0,0,-5,0, ldraw_lib__1_4con3(realsolid)],
// 1 16 20 20 -40 0 0 3 -3 0 0 0 1 0 1-4ring4.dat
  [1,16,20,20,-40,0,0,3,-3,0,0,0,1,0, ldraw_lib__1_4ring4(realsolid)],
...
// 1 16 40 22 -27.5 0 -1 0 0 0 2 -7.5 0 0 rect3.dat
  [1,16,40,22,-27.5,0,-1,0,0,0,2,-7.5,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 34 22 -40 0 0 -2 2 0 0 0 4 0 1-4cylo.dat
  [1,16,34,22,-40,0,0,-2,2,0,0,0,4,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 34 22 -24 0 0 -2 2 0 0 0 4 0 1-4cylo.dat
  [1,16,34,22,-24,0,0,-2,2,0,0,0,4,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 34 22 -40 0 0 -2 2 0 0 0 1 0 1-4chrd.dat
  [1,16,34,22,-40,0,0,-2,2,0,0,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 34 22 -24 0 0 -2 2 0 0 0 1 0 1-4chrd.dat
  [1,16,34,22,-24,0,0,-2,2,0,0,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 34 22 -36 0 0 -2 2 0 0 0 -1 0 1-4chrd.dat
  [1,16,34,22,-36,0,0,-2,2,0,0,0,-1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 34 22 -20 0 0 -2 2 0 0 0 -1 0 1-4chrd.dat
  [1,16,34,22,-20,0,0,-2,2,0,0,0,-1,0, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 37.5 22 -37.5 -2.5 -1 0 0 0 2 -2.5 0 0 rect2a.dat
  [1,16,37.5,22,-37.5,-2.5,-1,0,0,0,2,-2.5,0,0, ldraw_lib__rect2a(realsolid)],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -20 20 -20 0 0 -12 -12 0 0 0 -4 0 1-4cylo.dat
...
module ldraw_lib__28326(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__28326(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
