...
use <s/99141s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3068bpt2(realsolid=false) = [
...
// 1 16 0 0 0 1.9 0 0 0 1 0 0 0 1.9 s\99141s02.dat
  [1,16,0,0,0,1.9,0,0,0,1,0,0,0,1.9, ldraw_lib__s__99141s02(realsolid)],
...
module ldraw_lib__3068bpt2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068bpt2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
