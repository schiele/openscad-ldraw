...
use <../p/4-4ring2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3111(realsolid=false) = [
// 0 ~Axle Bush 1.4L
// 0 Name: 3111.dat
...
// 1 16 14 0 0 0 1 0 6 0 0 0 0 6 4-4edge.dat
  [1,16,14,0,0,0,1,0,6,0,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 -14 0 0 0 1 0 6 0 0 0 0 6 4-4edge.dat
  [1,16,-14,0,0,0,1,0,6,0,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 14 0 0 0 -1 0 2 0 0 0 0 2 4-4ring2.dat
  [1,16,14,0,0,0,-1,0,2,0,0,0,0,2, ldraw_lib__4_4ring2(realsolid)],
// 1 16 -14 0 0 0 1 0 2 0 0 0 0 2 4-4ring2.dat
  [1,16,-14,0,0,0,1,0,2,0,0,0,0,2, ldraw_lib__4_4ring2(realsolid)],
// 0
// 
...
module ldraw_lib__3111(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3111(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
