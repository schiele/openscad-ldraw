...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__90509(realsolid=false) = [
// 0 Minifig Ski 6L
// 0 Name: 90509.dat
...
// 1 16 0 1.5 -50 -9 0 0 0 0 1.5 0 100 0 box5-4a.dat
  [1,16,0,1.5,-50,-9,0,0,0,0,1.5,0,100,0, ldraw_lib__box5_4a(realsolid)],
// 1 16 6.75 0 -11 2.25 0 0 0 1 0 0 0 1 2-4edge.dat
  [1,16,6.75,0,-11,2.25,0,0,0,1,0,0,0,1, ldraw_lib__2_4edge(realsolid)],
// 1 16 6.75 0 -29 -2.25 0 0 0 1 0 0 0 -1 2-4edge.dat
  [1,16,6.75,0,-29,-2.25,0,0,0,1,0,0,0,-1, ldraw_lib__2_4edge(realsolid)],
// 2 24 4.5 0 -11 4.5 0 -29
  [2,24,4.5,0,-11,4.5,0,-29],
// 1 16 6.75 0 -11 -2.25 0 0 0 -1 0 0 0 1 2-8sphe.dat
  [1,16,6.75,0,-11,-2.25,0,0,0,-1,0,0,0,1, ldraw_lib__2_8sphe(realsolid)],
// 1 16 6.75 0 -29 2.25 0 0 0 -1 0 0 0 -1 2-8sphe.dat
  [1,16,6.75,0,-29,2.25,0,0,0,-1,0,0,0,-1, ldraw_lib__2_8sphe(realsolid)],
// 1 16 6.75 0 -11 -2.25 0 0 0 0 -1 0 -18 0 2-4cyli.dat
  [1,16,6.75,0,-11,-2.25,0,0,0,0,-1,0,-18,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -6.75 0 -29 -2.25 0 0 0 1 0 0 0 -1 2-4edge.dat
  [1,16,-6.75,0,-29,-2.25,0,0,0,1,0,0,0,-1, ldraw_lib__2_4edge(realsolid)],
// 1 16 -6.75 0 -11 2.25 0 0 0 1 0 0 0 1 2-4edge.dat
  [1,16,-6.75,0,-11,2.25,0,0,0,1,0,0,0,1, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 -6.75 0 -29 2.25 0 0 0 0 -1 0 18 0 2-4cyli.dat
  [1,16,-6.75,0,-29,2.25,0,0,0,0,-1,0,18,0, ldraw_lib__2_4cyli(realsolid)],
...
module ldraw_lib__90509(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__90509(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
