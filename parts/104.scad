...
use <../p/8-8sphe.scad>
$fa=1; $fs=0.2;
function ldraw_lib__104(realsolid=false) = [
// 0 Antenna  6H
// 0 Name: 104.dat
...
// 1 16 0 0 0 5 0 0 0 1 0 0 0 5 4-4edge.dat
  [1,16,0,0,0,5,0,0,0,1,0,0,0,5, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -3 0 5 0 0 0 1 0 0 0 5 4-4edge.dat
  [1,16,0,-3,0,5,0,0,0,1,0,0,0,5, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 -34 0 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,0,-34,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -137.535 0 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,0,-137.535,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 -3 0 5 0 0 0 3 0 0 0 5 4-4cyli.dat
  [1,16,0,-3,0,5,0,0,0,3,0,0,0,5, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -3 0 5 0 0 0 1 0 0 0 5 4-4disc.dat
  [1,16,0,-3,0,5,0,0,0,1,0,0,0,5, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 -32 0 4 0 0 0 29 0 0 0 4 4-4cyli.dat
  [1,16,0,-32,0,4,0,0,0,29,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -32 0 -2 0 0 0 -2 0 0 0 2 4-4con1.dat
  [1,16,0,-32,0,-2,0,0,0,-2,0,0,0,2, ldraw_lib__4_4con1(realsolid)],
// 1 16 0 -141 0 2 0 0 0 107 0 0 0 2 4-4cyli.dat
  [1,16,0,-141,0,2,0,0,0,107,0,0,0,2, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -141 0 4 0 0 0 4 0 0 0 4 8-8sphe.dat
  [1,16,0,-141,0,4,0,0,0,4,0,0,0,4, ldraw_lib__8_8sphe(realsolid)],
// 0
];
module ldraw_lib__104(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__104(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
