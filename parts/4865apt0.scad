...
use <s/4865as01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4865apt0(realsolid=false) = [
...
// 1 16 0 12 10 -1 0 0 0 0 -1 0 -1 0 s\3069bs18.dat
  [1,16,0,12,10,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__s__3069bs18(realsolid)],
...
module ldraw_lib__4865apt0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4865apt0(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
