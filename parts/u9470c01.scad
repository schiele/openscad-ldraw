...
use <u9470.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9470c01(realsolid=false) = [
...
// 1 16 0 0 -70 1 0 0 0 1 0 0 0 1 u9469.dat
  [1,16,0,0,-70,1,0,0,0,1,0,0,0,1, ldraw_lib__u9469(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 u9470.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9470(realsolid)],
// 0 // Cable Stub
// 1 511 0 14 3 0 0 1 -1 0 0 0 -1 0 s\23816s01.dat
  [1,511,0,14,3,0,0,1,-1,0,0,0,-1,0, ldraw_lib__s__23816s01(realsolid)],
...
module ldraw_lib__u9470c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9470c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
