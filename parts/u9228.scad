...
use <../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9228(realsolid=false) = [
...
// 1 16 10 0 0 4.5 0 0 0 0 4.5 0 1 0 4-4edge.dat
  [1,16,10,0,0,4.5,0,0,0,0,4.5,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 0 0 0 0 -4.5 4.5 0 0 0 1 0 2-4ndis.dat
  [1,16,10,0,0,0,0,-4.5,4.5,0,0,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 10 0 24 3.5 0 0 0 0 3.5 0 1 0 4-4edge.dat
  [1,16,10,0,24,3.5,0,0,0,0,3.5,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 0 23 3.5 0 0 0 0 3.5 0 1 0 4-4cyli.dat
  [1,16,10,0,23,3.5,0,0,0,0,3.5,0,1,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 10 0 23 3.5 0 0 0 0 3.5 0 1 0 4-4edge.dat
  [1,16,10,0,23,3.5,0,0,0,0,3.5,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 0 23 0.5 0 0 0 0 0.5 0 1 0 4-4ring7.dat
  [1,16,10,0,23,0.5,0,0,0,0,0.5,0,1,0, ldraw_lib__4_4ring7(realsolid)],
// 1 16 10 0 23 0.563 0 0 0 0 0.563 0 1 0 4-4ring7.dat
  [1,16,10,0,23,0.563,0,0,0,0,0.563,0,1,0, ldraw_lib__4_4ring7(realsolid)],
// 1 16 10 0 23 4.5 0 0 0 0 4.5 0 1 0 4-4edge.dat
  [1,16,10,0,23,4.5,0,0,0,0,4.5,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 0 0 4.5 0 0 0 0 4.5 0 23 0 4-4cyli.dat
  [1,16,10,0,0,4.5,0,0,0,0,4.5,0,23,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -10 0 0 0 0 4.5 -4.5 0 0 0 1 0 2-4ndis.dat
  [1,16,-10,0,0,0,0,4.5,-4.5,0,0,0,1,0, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 0 -6 21 10 0 0 0 0.5 0 0 0 1.5 box5.dat
  [1,16,0,-6,21,10,0,0,0,0.5,0,0,0,1.5, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -6 15 10 0 0 0 0.5 0 0 0 1.5 box5.dat
  [1,16,0,-6,15,10,0,0,0,0.5,0,0,0,1.5, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -6 3 10 0 0 0 0.5 0 0 0 1.5 box5.dat
  [1,16,0,-6,3,10,0,0,0,0.5,0,0,0,1.5, ldraw_lib__box5(realsolid)],
...
// 1 16 0 6 9 10 0 0 0 -0.5 0 0 0 -1.5 box5.dat
  [1,16,0,6,9,10,0,0,0,-0.5,0,0,0,-1.5, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 6 15 10 0 0 0 -0.5 0 0 0 -1.5 box5.dat
  [1,16,0,6,15,10,0,0,0,-0.5,0,0,0,-1.5, ldraw_lib__box5(realsolid)],
...
// 1 16 -10 0 0 0 0 -6 6 0 0 0 24 0 2-4cyli.dat
  [1,16,-10,0,0,0,0,-6,6,0,0,0,24,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -10 0 0 0 0 -6 6 0 0 0 24 0 2-4edge.dat
  [1,16,-10,0,0,0,0,-6,6,0,0,0,24,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -10 0 0 0 0 -1.5 1.5 0 0 0 1 0 2-4ring3.dat
  [1,16,-10,0,0,0,0,-1.5,1.5,0,0,0,1,0, ldraw_lib__2_4ring3(realsolid)],
// 1 16 10 0 0 0 0 1.5 -1.5 0 0 0 1 0 2-4ring3.dat
  [1,16,10,0,0,0,0,1.5,-1.5,0,0,0,1,0, ldraw_lib__2_4ring3(realsolid)],
// 1 16 -10 0 24 0 0 4.5 4.5 0 0 0 -1 0 2-4ndis.dat
  [1,16,-10,0,24,0,0,4.5,4.5,0,0,0,-1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 10 0 24 0 0 -4.5 -4.5 0 0 0 -1 0 2-4ndis.dat
  [1,16,10,0,24,0,0,-4.5,-4.5,0,0,0,-1,0, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 10 0 24 0 0 1.5 1.5 0 0 0 -1 0 2-4ring3.dat
  [1,16,10,0,24,0,0,1.5,1.5,0,0,0,-1,0, ldraw_lib__2_4ring3(realsolid)],
// 1 16 10 0 24 0 0 0.5 0.5 0 0 0 -1 0 4-4ring7.dat
  [1,16,10,0,24,0,0,0.5,0.5,0,0,0,-1,0, ldraw_lib__4_4ring7(realsolid)],
// 1 16 10 0 24 0 0 0.5 0.5 0 0 0 -1 0 4-4ring8.dat
  [1,16,10,0,24,0,0,0.5,0.5,0,0,0,-1,0, ldraw_lib__4_4ring8(realsolid)],
// 1 16 -10 0 24 0 0 0.5 0.5 0 0 0 -1 0 4-4ring7.dat
  [1,16,-10,0,24,0,0,0.5,0.5,0,0,0,-1,0, ldraw_lib__4_4ring7(realsolid)],
// 1 16 -10 0 24 0 0 0.5 0.5 0 0 0 -1 0 4-4ring8.dat
  [1,16,-10,0,24,0,0,0.5,0.5,0,0,0,-1,0, ldraw_lib__4_4ring8(realsolid)],
...
// 1 16 -10 0 24 0 0 -6 6 0 0 0 24 0 2-4edge.dat
  [1,16,-10,0,24,0,0,-6,6,0,0,0,24,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 10 0 0 0 0 6 -6 0 0 0 24 0 2-4cyli.dat
  [1,16,10,0,0,0,0,6,-6,0,0,0,24,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 10 0 0 0 0 6 -6 0 0 0 24 0 2-4edge.dat
  [1,16,10,0,0,0,0,6,-6,0,0,0,24,0, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 0 0 9 4 0 0 0 1 0 0 0 4 4-4disc.dat
  [1,16,0,0,9,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 9 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,0,0,9,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
];
module ldraw_lib__u9228(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9228(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
