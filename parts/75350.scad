...
use <6516.scad>
$fa=1; $fs=0.2;
function ldraw_lib__75350(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6516.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6516(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6515.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6515(realsolid)],
];
module ldraw_lib__75350(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__75350(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
