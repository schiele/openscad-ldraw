...
use <../p/wpin.scad>
$fa=1; $fs=0.2;
function ldraw_lib__24326(realsolid=false) = [
...
// 1 16 0 4 40 22 0 0 0 0 4 0 -1 0 rect.dat
  [1,16,0,4,40,22,0,0,0,0,4,0,-1,0, ldraw_lib__rect(realsolid)],
// 
// 1 16 0 4 -30 -1 0 0 0 -1 0 0 0 -1 stud3.dat
  [1,16,0,4,-30,-1,0,0,0,-1,0,0,0,-1, ldraw_lib__stud3(realsolid)],
// 0 BFC INVERTNEXT
...
// 1 16 0 0 0 27 0 0 0 8 0 0 0 20 box4.dat
  [1,16,0,0,0,27,0,0,0,8,0,0,0,20, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 10 24 0 0 20 -2 0 0 0 -7 0 box3u2p.dat
  [1,16,0,10,24,0,0,20,-2,0,0,0,-7,0, ldraw_lib__box3u2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 10 -24 0 0 -20 -2 0 0 0 7 0 box3u2p.dat
  [1,16,0,10,-24,0,0,-20,-2,0,0,0,7,0, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 0 12 0 1 0 0 0 -1 0 0 0 1 stud4f2w.dat
  [1,16,0,12,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4f2w(realsolid)],
...
// 1 16 0 8 0 6 0 0 0 4 0 0 0 6 4-4cyli.dat
  [1,16,0,8,0,6,0,0,0,4,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 8 0 0 0 -1 0 1 0 1 0 0 stug2-2x2.dat
  [1,16,0,8,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug2_2x2(realsolid)],
// 
// 1 16 16.2 12 0 8.2 0 0 0 4 0 0 0 2 box3u6.dat
  [1,16,16.2,12,0,8.2,0,0,0,4,0,0,0,2, ldraw_lib__box3u6(realsolid)],
// 1 16 -16.2 12 0 -8.2 0 0 0 4 0 0 0 -2 box3u6.dat
  [1,16,-16.2,12,0,-8.2,0,0,0,4,0,0,0,-2, ldraw_lib__box3u6(realsolid)],
...
// 1 16 20.55 6 30 0 -1.55 0 2 0 0 0 0 6 box2-5.dat
  [1,16,20.55,6,30,0,-1.55,0,2,0,0,0,0,6, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20.55 6 -30 0 -1.55 0 2 0 0 0 0 -6 box2-5.dat
  [1,16,20.55,6,-30,0,-1.55,0,2,0,0,0,0,-6, ldraw_lib__box2_5(realsolid)],
...
// 1 16 30 5 20 0 -1 0 0 0 -5 5 0 0 2-4ndis.dat
  [1,16,30,5,20,0,-1,0,0,0,-5,5,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 32 5 20 0 -2 0 0 0 -5 5 0 0 2-4cylc.dat
  [1,16,32,5,20,0,-2,0,0,0,-5,5,0,0, ldraw_lib__2_4cylc(realsolid)],
// 1 16 30 7.5 20 0 2 0 0 0 2.5 5 0 0 box4-4a.dat
  [1,16,30,7.5,20,0,2,0,0,0,2.5,5,0,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 32 5 20 0 -1 0 1 0 0 0 0 1 wpin.dat
  [1,16,32,5,20,0,-1,0,1,0,0,0,0,1, ldraw_lib__wpin(realsolid)],
// 
// 1 16 30 5 -20 0 -1 0 0 0 -5 5 0 0 2-4ndis.dat
  [1,16,30,5,-20,0,-1,0,0,0,-5,5,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 32 5 -20 0 -2 0 0 0 -5 5 0 0 2-4cylc.dat
...
module ldraw_lib__24326(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__24326(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
