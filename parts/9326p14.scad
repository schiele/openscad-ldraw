...
use <973p14.scad>
$fa=1; $fs=0.2;
function ldraw_lib__9326p14(realsolid=false) = [
// 0 ~Moved to 973p14
// 0 Name: 9326p14.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973p14.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973p14(realsolid)],
// 0
];
module ldraw_lib__9326p14(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__9326p14(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
