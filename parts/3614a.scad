...
use <../p/stud4od.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3614a(realsolid=false) = [
...
// 1 16 0 4 -19 8 0 0 0 8 0 0 0 8 8-8sphe.dat
  [1,16,0,4,-19,8,0,0,0,8,0,0,0,8, ldraw_lib__8_8sphe(realsolid)],
// 0 // Wrist
// 1 16 0 4 -19 4 0 0 0 0 4 0 -4 0 4-4cyl1sph2.dat
  [1,16,0,4,-19,4,0,0,0,0,4,0,-4,0, ldraw_lib__4_4cyl1sph2(realsolid)],
// 1 16 0 4 -10 4 0 0 0 0 4 0 -1 0 4-4cyli.dat
  [1,16,0,4,-10,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4cyli(realsolid)],
...
module ldraw_lib__3614a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3614a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
