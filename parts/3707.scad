...
use <../p/axle.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3707(realsolid=false) = [
// 0 Technic Axle  8
// 0 Name: 3707.dat
...
// 1 16 80 0 0 0 -160 0 1 0 0 0 0 1 axle.dat
  [1,16,80,0,0,0,-160,0,1,0,0,0,0,1, ldraw_lib__axle(realsolid)],
// 0
// 
];
module ldraw_lib__3707(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3707(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
