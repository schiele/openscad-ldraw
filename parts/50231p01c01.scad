...
// 0 !KEYWORDS 522, BrickLink 522pb005, Cloak, Drape, Neckwear, Poncho
// 0 !KEYWORDS Rebrickable 50231pr0009, Shawl
// 
...
module ldraw_lib__50231p01c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__50231p01c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
