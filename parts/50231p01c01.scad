...
use <s/50231s04.scad>
$fa=1; $fs=0.2;
function ldraw_lib__50231p01c01(realsolid=false) = [
...
// 1 320 0 0 0 1 0 0 0 1 0 0 0 1 s\50231s01.dat
  [1,320,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__50231s01(realsolid)],
...
// 1 320 0 0 0 1 0 0 0 1 0 0 0 1 s\50231s03.dat
  [1,320,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__50231s03(realsolid)],
// 1 320 0 0 0 -1 0 0 0 1 0 0 0 1 s\50231s03.dat
  [1,320,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__50231s03(realsolid)],
...
module ldraw_lib__50231p01c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__50231p01c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__50231p01c01(line=0.2);