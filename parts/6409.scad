...
use <../p/box4-1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6409(realsolid=false) = [
...
// 1 16 0 24 -32 0 0 40 24 0 0 0 72 0 box3u4a.dat
  [1,16,0,24,-32,0,0,40,24,0,0,0,72,0, ldraw_lib__box3u4a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 26 -32 0 0 36 22 0 0 0 68 0 box3u4a.dat
  [1,16,0,26,-32,0,0,36,22,0,0,0,68,0, ldraw_lib__box3u4a(realsolid)],
...
// 1 16 0 4 0 16 0 0 0 40 0 0 0 16 4-4cylo.dat
  [1,16,0,4,0,16,0,0,0,40,0,0,0,16, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 44 0 2 0 0 0 -1 0 0 0 2 4-4ring7.dat
  [1,16,0,44,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 14 0 0 0 44 0 0 0 14 4-4cylo.dat
  [1,16,0,0,0,14,0,0,0,44,0,0,0,14, ldraw_lib__4_4cylo(realsolid)],
...
// 1 16 0 24 -40 16 0 0 0 0 16 0 1 0 4-4ndis.dat
  [1,16,0,24,-40,16,0,0,0,0,16,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 24 -40 14 0 0 0 0 14 0 1 0 4-4disc.dat
  [1,16,0,24,-40,14,0,0,0,0,14,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 24 -38 16 0 0 0 0 16 0 -2 0 4-4cylo.dat
  [1,16,0,24,-38,16,0,0,0,0,16,0,-2,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 24 -38 14 0 0 0 0 14 0 -2 0 4-4cylo.dat
  [1,16,0,24,-38,14,0,0,0,0,14,0,-2,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 24 -38 2 0 0 0 0 2 0 1 0 4-4ring7.dat
  [1,16,0,24,-38,2,0,0,0,0,2,0,1,0, ldraw_lib__4_4ring7(realsolid)],
...
// 1 16 -32 0 -32 -8 0 0 0 48 0 0 0 -8 1-4cylo.dat
  [1,16,-32,0,-32,-8,0,0,0,48,0,0,0,-8, ldraw_lib__1_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -32 4 -32 -4 0 0 0 44 0 0 0 -4 1-4cylo.dat
  [1,16,-32,4,-32,-4,0,0,0,44,0,0,0,-4, ldraw_lib__1_4cylo(realsolid)],
// 1 16 32 0 -32 8 0 0 0 48 0 0 0 -8 1-4cylo.dat
  [1,16,32,0,-32,8,0,0,0,48,0,0,0,-8, ldraw_lib__1_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 -32 48 -32 -4 0 0 0 -1 0 0 0 -4 1-4ring1.dat
  [1,16,-32,48,-32,-4,0,0,0,-1,0,0,0,-4, ldraw_lib__1_4ring1(realsolid)],
// 1 16 32 48 -32 4 0 0 0 -1 0 0 0 -4 1-4ring1.dat
  [1,16,32,48,-32,4,0,0,0,-1,0,0,0,-4, ldraw_lib__1_4ring1(realsolid)],
// 4 16 -32 4 -36 32 4 -36 32 48 -36 -32 48 -36
  [4,16,-32,4,-36,32,4,-36,32,48,-36,-32,48,-36],
// 1 16 -32 4 -32 -4 0 0 0 -1 0 0 0 -4 1-4chrd.dat
  [1,16,-32,4,-32,-4,0,0,0,-1,0,0,0,-4, ldraw_lib__1_4chrd(realsolid)],
// 1 16 32 4 -32 4 0 0 0 -1 0 0 0 -4 1-4chrd.dat
  [1,16,32,4,-32,4,0,0,0,-1,0,0,0,-4, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 32 0 -32 8 0 0 0 1 0 0 0 -8 1-4chrd.dat
  [1,16,32,0,-32,8,0,0,0,1,0,0,0,-8, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -32 0 -32 -8 0 0 0 1 0 0 0 -8 1-4chrd.dat
  [1,16,-32,0,-32,-8,0,0,0,1,0,0,0,-8, ldraw_lib__1_4chrd(realsolid)],
...
module ldraw_lib__6409(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6409(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
