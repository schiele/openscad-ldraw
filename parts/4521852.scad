...
use <30165.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4521852(realsolid=false) = [
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 30165.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30165(realsolid)],
];
module ldraw_lib__4521852(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4521852(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
