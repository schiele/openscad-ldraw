...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32124(realsolid=false) = [
...
// 1 16 0 4 0 8.31492 0 3.44415 0 -1 0 -3.44415 0 8.31492 1-8edge.dat
  [1,16,0,4,0,8.31492,0,3.44415,0,-1,0,-3.44415,0,8.31492, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 4 0 -8.31492 0 -3.44415 0 -1 0 3.44415 0 -8.31492 1-8edge.dat
  [1,16,0,4,0,-8.31492,0,-3.44415,0,-1,0,3.44415,0,-8.31492, ldraw_lib__1_8edge(realsolid)],
...
// 1 16 10 6 0 0 1 0 2 0 0 0 0 6 rect.dat
  [1,16,10,6,0,0,1,0,2,0,0,0,0,6, ldraw_lib__rect(realsolid)],
...
// 1 16 40 0 0 0 0 10 0 1 0 10 0 0 2-4edge.dat
  [1,16,40,0,0,0,0,10,0,1,0,10,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 40 4 0 0 0 6 0 1 0 6 0 0 2-4edge.dat
  [1,16,40,4,0,0,0,6,0,1,0,6,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 40 8 0 0 0 10 0 1 0 10 0 0 2-4edge.dat
  [1,16,40,8,0,0,0,10,0,1,0,10,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 40 8 0 0 0 6 0 1 0 6 0 0 2-4edge.dat
  [1,16,40,8,0,0,0,6,0,1,0,6,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 40 8 0 0 0 3 0 -1 0 3 0 0 2-4ring2.dat
  [1,16,40,8,0,0,0,3,0,-1,0,3,0,0, ldraw_lib__2_4ring2(realsolid)],
// 1 16 40 8 0 0 0 1 0 -1 0 1 0 0 2-4ring9.dat
  [1,16,40,8,0,0,0,1,0,-1,0,1,0,0, ldraw_lib__2_4ring9(realsolid)],
// 1 16 -40 8 0 0 0 -3 0 -1 0 -3 0 0 2-4ring2.dat
  [1,16,-40,8,0,0,0,-3,0,-1,0,-3,0,0, ldraw_lib__2_4ring2(realsolid)],
// 1 16 -40 8 0 0 0 -1 0 -1 0 -1 0 0 2-4ring9.dat
  [1,16,-40,8,0,0,0,-1,0,-1,0,-1,0,0, ldraw_lib__2_4ring9(realsolid)],
...
// 1 16 40 8 0 0 0 6 0 -4 0 6 0 0 2-4cyli.dat
  [1,16,40,8,0,0,0,6,0,-4,0,6,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 40 8 0 0 0 10 0 -8 0 10 0 0 2-4cyli.dat
  [1,16,40,8,0,0,0,10,0,-8,0,10,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 40 4 0 0 0 6 0 -1 0 6 0 0 2-4disc.dat
  [1,16,40,4,0,0,0,6,0,-1,0,6,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 40 0 0 0 0 10 0 1 0 10 0 0 2-4disc.dat
  [1,16,40,0,0,0,0,10,0,1,0,10,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 -40 0 0 0 0 -10 0 1 0 10 0 0 2-4edge.dat
  [1,16,-40,0,0,0,0,-10,0,1,0,10,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -40 4 0 0 0 -6 0 1 0 6 0 0 2-4edge.dat
  [1,16,-40,4,0,0,0,-6,0,1,0,6,0,0, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 0 4 10 40 0 0 0 0 4 0 -1 0 rect2p.dat
  [1,16,0,4,10,40,0,0,0,0,4,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 4 -10 -40 0 0 0 0 4 0 1 0 rect2p.dat
  [1,16,0,4,-10,-40,0,0,0,0,4,0,1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 27 8 0 13 0 0 0 -4 0 0 0 6 box3u8p.dat
  [1,16,27,8,0,13,0,0,0,-4,0,0,0,6, ldraw_lib__box3u8p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -27 8 0 13 0 0 0 -4 0 0 0 6 box3u8p.dat
  [1,16,-27,8,0,13,0,0,0,-4,0,0,0,6, ldraw_lib__box3u8p(realsolid)],
// 1 16 14 6 0 0 -1 0 -2 0 0 0 0 6 rect.dat
  [1,16,14,6,0,0,-1,0,-2,0,0,0,0,6, ldraw_lib__rect(realsolid)],
// 1 16 -14 6 0 0 1 0 -2 0 0 0 0 -6 rect.dat
  [1,16,-14,6,0,0,1,0,-2,0,0,0,0,-6, ldraw_lib__rect(realsolid)],
// 0
];
module ldraw_lib__32124(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32124(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
