...
use <s/2586s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2586p4m(realsolid=false) = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\2586p4ms01.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2586p4ms01(realsolid)],
// 1 1 0 0 0 -1 0 0 0 1 0 0 0 1 s\2586p4ms01.dat
  [1,1,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__2586p4ms01(realsolid)],
];
module ldraw_lib__2586p4m(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2586p4m(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
