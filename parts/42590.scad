...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 u9181.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9181()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 u9182.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9182()],
// 1 79 0 -20 100 1 0 0 0 1 0 0 0 1 u9029.dat
  [1,79,0,-20,100,1,0,0,0,1,0,0,0,1, ldraw_lib__u9029()],
// 1 494 8 -40 120 0 -1 0 0 0 1.2 1.2 0 0 u9022.dat
  [1,494,8,-40,120,0,-1,0,0,0,1.2,1.2,0,0, ldraw_lib__u9022()],
// 1 494 8 -20 0 0 -1 0 0 0 1.2 1.2 0 0 u9022.dat
  [1,494,8,-20,0,0,-1,0,0,0,1.2,1.2,0,0, ldraw_lib__u9022()],
// 1 494 8 -80 0 0 -1 0 0 0 1.2 1.2 0 0 u9022.dat
  [1,494,8,-80,0,0,-1,0,0,0,1.2,1.2,0,0, ldraw_lib__u9022()],
// 
];
module ldraw_lib__42590(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__42590(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
