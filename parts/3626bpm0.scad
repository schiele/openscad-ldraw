...
use <../p/t08o6250.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3626bpm0(realsolid=false) = [
// 0 Minifig Head with LOTR Uruk-Hai Scowl and White Hand 2-Sided Pattern (Hollow Stud with Pierced Base)
// 0 Name: 3626bpm0.dat
...
module ldraw_lib__3626bpm0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3626bpm0(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3626bpm0(line=0.2);