...
use <3817bp6w.scad>
$fa=1; $fs=0.2;
function ldraw_lib__73200p6w(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3815bp6w.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3815bp6w(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3816bp6w.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816bp6w(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3817bp6w.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817bp6w(realsolid)],
// 
];
module ldraw_lib__73200p6w(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73200p6w(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
