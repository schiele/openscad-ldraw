...
function ldraw_lib__6148328ar() = [
// 0 Sticker  1.0 x  3.8 with Red "PORSCHE" and Black "DMG MORI" and Dark Grey Squares on White Background Right
// 0 Name: 6148328ar.dat
...
module ldraw_lib__6148328ar(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6148328ar(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6148328ar(line=0.2);