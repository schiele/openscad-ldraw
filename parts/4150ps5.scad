...
use <s/4150s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4150ps5(realsolid=false) = [
...
// 1 16 0 0 0 1.76 0 0 0 1 0 0 0 1.76 48\4-4ring9.dat
  [1,16,0,0,0,1.76,0,0,0,1,0,0,0,1.76, ldraw_lib__48__4_4ring9(realsolid)],
// 1 16 0 0 0 1.6 0 0 0 1 0 0 0 1.6 48\4-4rin11.dat
  [1,16,0,0,0,1.6,0,0,0,1,0,0,0,1.6, ldraw_lib__48__4_4rin11(realsolid)],
// 1 16 0 0 0 0.8 0 0 0 1 0 0 0 0.8 4-4rin24.dat
  [1,16,0,0,0,0.8,0,0,0,1,0,0,0,0.8, ldraw_lib__4_4rin24(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\4150ps5s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4150ps5s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\4150ps5s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__4150ps5s01(realsolid)],
// 1 16 0 0 0 0.5 0 -0.86603 0 1 0 0.86603 0 0.5 s\4150ps5s01.dat
  [1,16,0,0,0,0.5,0,-0.86603,0,1,0,0.86603,0,0.5, ldraw_lib__s__4150ps5s01(realsolid)],
// 1 16 0 0 0 -0.5 0 -0.86603 0 1 0 -0.86603 0 0.5 s\4150ps5s01.dat
  [1,16,0,0,0,-0.5,0,-0.86603,0,1,0,-0.86603,0,0.5, ldraw_lib__s__4150ps5s01(realsolid)],
// 1 16 0 0 0 -0.5 0 -0.86603 0 1 0 0.86603 0 -0.5 s\4150ps5s01.dat
  [1,16,0,0,0,-0.5,0,-0.86603,0,1,0,0.86603,0,-0.5, ldraw_lib__s__4150ps5s01(realsolid)],
...
module ldraw_lib__4150ps5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4150ps5(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
