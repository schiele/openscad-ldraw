...
use <s/3817bs01.scad>
function ldraw_lib__3817bpw3() = [
// 0 ~Minifig Leg Left with Dark Turquoise/White Triangles, White Fringe Pattern (Obsolete)
// 0 Name: 3817bpw3.dat
...
// 0 !HISTORY 2023-02-03 [Holly-Wood] Obsoleted for bad geometry. Use 3817cpw3 instead.
...
// 1 3 0 0 0 1 0 0 0 1 0 0 0 1 s\3817bpw1s02.dat
  [1,3,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3817bpw1s02()],
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\3817bpw1s03.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3817bpw1s03()],
];
module ldraw_lib__3817bpw3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3817bpw3(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
