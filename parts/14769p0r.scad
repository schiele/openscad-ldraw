...
// 1 16 0 0 0 -7 0 0 0 1 0 0 0 -7 5-8disc.dat
  [1,16,0,0,0,-7,0,0,0,1,0,0,0,-7, ldraw_lib__5_8disc()],
// 1 16 0 0 0 -7 0 0 0 1 0 0 0 7 1-8disc.dat
  [1,16,0,0,0,-7,0,0,0,1,0,0,0,7, ldraw_lib__1_8disc()],
// 1 15 0 0 0 0 0 7 0 1 0 7 0 0 1-8disc.dat
  [1,15,0,0,0,0,0,7,0,1,0,7,0,0, ldraw_lib__1_8disc()],
// 1 15 0 0 0 0 0 -7 0 1 0 7 0 0 1-8disc.dat
  [1,15,0,0,0,0,0,-7,0,1,0,7,0,0, ldraw_lib__1_8disc()],
// 1 15 0 0 0 7 0 0 0 1 0 0 0 7 4-4ring1.dat
  [1,15,0,0,0,7,0,0,0,1,0,0,0,7, ldraw_lib__4_4ring1()],
// 1 16 0 0 0 -3.5 0 0 0 1 0 0 0 3.5 4-4ring4.dat
  [1,16,0,0,0,-3.5,0,0,0,1,0,0,0,3.5, ldraw_lib__4_4ring4()],
// 1 16 0 0 0 -2.5 0 0 0 1 0 0 0 2.5 4-4ring7.dat
  [1,16,0,0,0,-2.5,0,0,0,1,0,0,0,2.5, ldraw_lib__4_4ring7()],
];
module ldraw_lib__14769p0r(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__14769p0r(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
