...
use <s/99244s02.scad>
use <../p/stud4h.scad>
function ldraw_lib__99244() = [
// 0 Minifig Headdress Rabbit
// 0 Name: 99244.dat
...
// 0 !KEYWORDS Bunny, Costume, Ears, mask
// 
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\99244s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__99244s01()],
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\99244s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__99244s02()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\99244s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__99244s02()],
// 
...
module ldraw_lib__99244(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__99244(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__99244(line=0.2);