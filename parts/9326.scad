...
use <973.scad>
$fa=1; $fs=0.2;
function ldraw_lib__9326(realsolid=false) = [
// 0 ~Moved to 973
// 0 Name: 9326.dat
// 0 Author: [PTadmin]
...
module ldraw_lib__9326(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__9326(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__9326(line=0.2);