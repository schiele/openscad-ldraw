...
// 1 13 0 0 0 1 0 0 0 1 0 0 0 1 s\4066bp10s01.dat
  [1,13,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4066bp10s01()],
// 1 8 0 0 0 1 0 0 0 1 0 0 0 1 s\4066bp10s02.dat
  [1,8,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4066bp10s02()],
// 1 6 0 0 0 1 0 0 0 1 0 0 0 1 s\4066bp10s03.dat
  [1,6,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4066bp10s03()],
...
module ldraw_lib__4066bp1j(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4066bp1j(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
