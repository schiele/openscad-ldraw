...
// 1 0 0 -80 180 0 0 1 0 1 0 -1 0 0 3245bp02.dat
  [1,0,0,-80,180,0,0,1,0,1,0,-1,0,0, ldraw_lib__3245bp02()],
];
module ldraw_lib__u9230c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9230c02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
