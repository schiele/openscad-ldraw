...
use <../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__11478(realsolid=false) = [
...
// 1 16 0 -5 -40 9 0 0 0 10 0 0 0 -9 2-4cylo.dat
  [1,16,0,-5,-40,9,0,0,0,10,0,0,0,-9, ldraw_lib__2_4cylo(realsolid)],
...
// 1 16 0 5 -40 3 0 0 0 -3 0 0 0 -3 2-4ring2.dat
  [1,16,0,5,-40,3,0,0,0,-3,0,0,0,-3, ldraw_lib__2_4ring2(realsolid)],
// 1 16 0 -5 -40 -3 0 0 0 3 0 0 0 -3 2-4ring2.dat
  [1,16,0,-5,-40,-3,0,0,0,3,0,0,0,-3, ldraw_lib__2_4ring2(realsolid)],
// 1 16 0 5 40 -3 0 0 0 -3 0 0 0 3 2-4ring2.dat
  [1,16,0,5,40,-3,0,0,0,-3,0,0,0,3, ldraw_lib__2_4ring2(realsolid)],
...
module ldraw_lib__11478(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11478(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
