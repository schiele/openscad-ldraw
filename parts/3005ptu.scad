...
// 1 16 0 15 -10 3 0 0 0 0 3 0 1 0 2-4disc.dat
  [1,16,0,15,-10,3,0,0,0,0,3,0,1,0, ldraw_lib__2_4disc()],
// 1 16 0 15 -10 5 0 0 0 0 5 0 1 0 2-4ndis.dat
  [1,16,0,15,-10,5,0,0,0,0,5,0,1,0, ldraw_lib__2_4ndis()],
// 1 1 0 15 -10 1 0 0 0 0 1 0 1 0 2-4ring3.dat
  [1,1,0,15,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__2_4ring3()],
// 1 1 0 15 -10 1 0 0 0 0 1 0 1 0 2-4ring4.dat
  [1,1,0,15,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__2_4ring4()],
// 0
];
module ldraw_lib__3005ptu(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3005ptu(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
