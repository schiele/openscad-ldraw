...
use <67351.scad>
$fa=1; $fs=0.2;
function ldraw_lib__67351c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 67351.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__67351(realsolid)],
// 1 14 0 -1 0 1 0 0 0 1 0 0 0 1 66757.dat
  [1,14,0,-1,0,1,0,0,0,1,0,0,0,1, ldraw_lib__66757(realsolid)],
];
module ldraw_lib__67351c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__67351c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
