...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 4478px2, Rebrickable 4478pr0003, Set 6349
// 
...
module ldraw_lib__4478p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4478p03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4478p03(line=0.2);