...
use <s/4478s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4478p03(realsolid=false) = [
...
// 1 7 0 0 0 1 0 0 0 1 0 0 0 1 s\4478p03a.dat
  [1,7,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4478p03a(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\4478p03b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4478p03b(realsolid)],
...
module ldraw_lib__4478p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4478p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
