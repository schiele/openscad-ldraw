...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\11650s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__11650s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\11650s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__11650s01()],
// 1 16 0 26.75 0 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,0,26.75,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge()],
// 1 16 0 26.75 0 8 0 0 0 -1 0 0 0 8 4-4ndis.dat
  [1,16,0,26.75,0,8,0,0,0,-1,0,0,0,8, ldraw_lib__4_4ndis()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 24 0 6 0 0 0 2.75 0 0 0 6 4-4cyli.dat
  [1,16,0,24,0,6,0,0,0,2.75,0,0,0,6, ldraw_lib__4_4cyli()],
...
// 1 16 0 26.75 0 1 0 0 0 -1.3125 0 0 0 1 stud4a.dat
  [1,16,0,26.75,0,1,0,0,0,-1.3125,0,0,0,1, ldraw_lib__stud4a()],
// 
// 1 16 0 30 -100 0 0 1 1 0 0 0 1 0 stug2-4x1.dat
  [1,16,0,30,-100,0,0,1,1,0,0,0,1,0, ldraw_lib__stug2_4x1()],
// 1 16 0 10 -100 0 0 1 1 0 0 0 1 0 stug2-4x1.dat
  [1,16,0,10,-100,0,0,1,1,0,0,0,1,0, ldraw_lib__stug2_4x1()],
// 1 16 0 30 100 0 0 -1 1 0 0 0 -1 0 stug2-4x1.dat
  [1,16,0,30,100,0,0,-1,1,0,0,0,-1,0, ldraw_lib__stug2_4x1()],
// 1 16 0 10 100 0 0 -1 1 0 0 0 -1 0 stug2-4x1.dat
  [1,16,0,10,100,0,0,-1,1,0,0,0,-1,0, ldraw_lib__stug2_4x1()],
...
// 1 16 0 0 -70 0 0 -1 0 1 0 1 0 0 stug2-2x1.dat
  [1,16,0,0,-70,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug2_2x1()],
// 1 16 0 0 70 0 0 -1 0 1 0 1 0 0 stug2-2x1.dat
  [1,16,0,0,70,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug2_2x1()],
// 1 16 0 24 -50 0 0 -1 0 1 0 1 0 0 stug2-2x1.dat
  [1,16,0,24,-50,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug2_2x1()],
// 1 16 0 24 50 0 0 -1 0 1 0 1 0 0 stug2-2x1.dat
  [1,16,0,24,50,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug2_2x1()],
...
module ldraw_lib__11650(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11650(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
