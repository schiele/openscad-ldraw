...
use <s/3070bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3070bpf0(realsolid=false) = [
...
// 0 BFC CERTIFY CW
  ...
  [0,"BFC","CW"],
// 
// 0 !KEYWORDS Jewellery, Ring, Scala
// 
...
// 1 1 0 0 0 2.5 0 0 0 2.5 0 0 0 2.5 4-4disc.dat
  [1,1,0,0,0,2.5,0,0,0,2.5,0,0,0,2.5, ldraw_lib__4_4disc(realsolid)],
// 1 4 0 0 0 2.5 0 0 0 2.5 0 0 0 2.5 4-4ndis.dat
  [1,4,0,0,0,2.5,0,0,0,2.5,0,0,0,2.5, ldraw_lib__4_4ndis(realsolid)],
...
module ldraw_lib__3070bpf0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3070bpf0(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
