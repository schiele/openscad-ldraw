...
use <s/20904s01.scad>
function ldraw_lib__20904ps0() = [
// 0 Minifig Helmet SW Stormtrooper Episode  8 with Pointed Mouth Pattern
// 0 Name: 20904ps0.dat
...
module ldraw_lib__20904ps0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__20904ps0(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__20904ps0(line=0.2);