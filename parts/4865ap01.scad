...
use <s/4865as01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4865ap01(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS bricklink 4865pb004, Set 1656, set 6389
// 
...
// 1 16 0 12 10 -0.085 0 0 0 0 -0.085 0 -1 0 s\4209s01.dat
  [1,16,0,12,10,-0.085,0,0,0,0,-0.085,0,-1,0, ldraw_lib__s__4209s01(realsolid)],
...
module ldraw_lib__4865ap01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4865ap01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
