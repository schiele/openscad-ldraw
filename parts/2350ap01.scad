...
use <../p/stug-1x8.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2350ap01(realsolid=false) = [
// 0 Crane Arm Outside Narrow 16 Studs With Liftarm and Arrows Pattern
// 0 Name: 2350ap01.dat
...
// 0 !HISTORY 2015-03-02 [GeraldLasser] Redone from Subfiles and new Pattern
...
// 1 16 12 0 -20 0 0 -1 0 1 0 1 0 0 s\2350ap01s01.dat
  [1,16,12,0,-20,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__2350ap01s01(realsolid)],
// 1 16 -12 0 -20 0 0 1 0 1 0 -1 0 0 s\2350ap01s01.dat
  [1,16,-12,0,-20,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__2350ap01s01(realsolid)],
];
module ldraw_lib__2350ap01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2350ap01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2350ap01(line=0.2);