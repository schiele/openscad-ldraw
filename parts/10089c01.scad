...
// 1 16 0 0 130 1 0 0 0 1 0 0 0 1 10089.dat
  [1,16,0,0,130,1,0,0,0,1,0,0,0,1, ldraw_lib__10089()],
// 1 72 0 0 0 1 0 0 0 1 0 0 0 1 10090.dat
  [1,72,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__10090()],
// 1 79 0 0 20 1 0 0 0 1 0 0 0 1 10092.dat
  [1,79,0,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__10092()],
// 1 16 0 0 134 1 0 0 0 1 0 0 0 1 10091.dat
  [1,16,0,0,134,1,0,0,0,1,0,0,0,1, ldraw_lib__10091()],
// 1 0 0 0 127 0 0 1 -1 0 0 0 -4 0 s\58124s03.dat
  [1,0,0,0,127,0,0,1,-1,0,0,0,-4,0, ldraw_lib__s__58124s03()],
];
module ldraw_lib__10089c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__10089c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
