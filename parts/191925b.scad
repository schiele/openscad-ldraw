...
$fa=1; $fs=0.2;
function ldraw_lib__191925b(realsolid=false) = [
...
// 1 16 0 -0.25 -4.5 0.415 0 0 0 1 0 0 0 0.415 s\191925s01.dat
  [1,16,0,-0.25,-4.5,0.415,0,0,0,1,0,0,0,0.415, ldraw_lib__s__191925s01(realsolid)],
...
module ldraw_lib__191925b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__191925b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
