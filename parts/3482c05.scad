...
use <3482.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3482c05(realsolid=false) = [
...
// 1 375 0 0 0 1 0 0 0 1 0 0 0 1 2346.dat
  [1,375,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2346(realsolid)],
];
module ldraw_lib__3482c05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3482c05(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
