...
use <s/3068bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3068bp17(realsolid=false) = [
...
// 1 16 0 0 0 14 0 0 0 1 0 0 0 14 4-4ndis.dat
  [1,16,0,0,0,14,0,0,0,1,0,0,0,14, ldraw_lib__4_4ndis(realsolid)],
...
// 1 0 0 0 0 14 0 0 0 1 0 0 0 14 4-4disc.dat
  [1,0,0,0,0,14,0,0,0,1,0,0,0,14, ldraw_lib__4_4disc(realsolid)],
// 0
];
module ldraw_lib__3068bp17(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068bp17(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
