...
use <s/37366s01.scad>
use <s/37366s03.scad>
function ldraw_lib__37366() = [
// 0 Minifig Leg Medium Left
// 0 Name: 37366.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !HISTORY 2023-02-07 [MagFors] Corrected the foot position.
...
// 3 16 1.5 6.4793 -5.75 1.5 12 -5.75 2 6.4793 -5.75
  [3,16,1.5,6.4793,-5.75,1.5,12,-5.75,2,6.4793,-5.75],
// 0 // Foot Front
// 4 16 19.25 20 -11.25 18.9022 12 -11.25 1.5 12 -11.25 1.5 20 -11.25
  [4,16,19.25,20,-11.25,18.9022,12,-11.25,1.5,12,-11.25,1.5,20,-11.25],
// 0 // Foot Top
// 4 16 1.5 12 -5.75 1.5 12 -11.25 18.9022 12 -11.25 18.9022 12 -5.75
  [4,16,1.5,12,-5.75,1.5,12,-11.25,18.9022,12,-11.25,18.9022,12,-5.75],
];
module ldraw_lib__37366(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__37366(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__37366(line=0.2);