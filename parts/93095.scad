...
// 1 16 0 24 0 20 0 0 0 -8 0 0 0 10 box4o4a.dat
  [1,16,0,24,0,20,0,0,0,-8,0,0,0,10, ldraw_lib__box4o4a()],
// 
// 1 16 -10.75 16 -2 9.25 0 0 0 1 0 0 0 8 rect.dat
  [1,16,-10.75,16,-2,9.25,0,0,0,1,0,0,0,8, ldraw_lib__rect()],
// 1 16 10.75 16 -2 9.25 0 0 0 1 0 0 0 8 rect.dat
  [1,16,10.75,16,-2,9.25,0,0,0,1,0,0,0,8, ldraw_lib__rect()],
// 
// 1 16 -1.5 4 -6 0 3 0 0 0 -4 -4 0 0 1-4cylc.dat
  [1,16,-1.5,4,-6,0,3,0,0,0,-4,-4,0,0, ldraw_lib__1_4cylc()],
// 1 16 1.5 4 -6 0 -1 0 0 0 -4 -4 0 0 1-4disc.dat
  [1,16,1.5,4,-6,0,-1,0,0,0,-4,-4,0,0, ldraw_lib__1_4disc()],
// 1 16 -1.5 2 0 0 1 0 0 0 -2 6 0 0 rect2a.dat
  [1,16,-1.5,2,0,0,1,0,0,0,-2,6,0,0, ldraw_lib__rect2a()],
// 1 16 -1.5 10 -2 0 1 0 -6 0 0 0 0 -8 rect2p.dat
  [1,16,-1.5,10,-2,0,1,0,-6,0,0,0,0,-8, ldraw_lib__rect2p()],
// 1 16 1.5 2 0 0 -1 0 0 0 -2 6 0 0 rect2a.dat
  [1,16,1.5,2,0,0,-1,0,0,0,-2,6,0,0, ldraw_lib__rect2a()],
// 1 16 1.5 10 -2 0 -1 0 -6 0 0 0 0 -8 rect2p.dat
  [1,16,1.5,10,-2,0,-1,0,-6,0,0,0,0,-8, ldraw_lib__rect2p()],
...
// 1 16 18 2 6 2 0 0 0 0 -2 0 4 0 1-4cylc.dat
  [1,16,18,2,6,2,0,0,0,0,-2,0,4,0, ldraw_lib__1_4cylc()],
// 1 16 18 2 10 2 0 0 0 0 -2 0 -1 0 1-4disc.dat
  [1,16,18,2,10,2,0,0,0,0,-2,0,-1,0, ldraw_lib__1_4disc()],
// 1 16 -18 2 10 -2 0 0 0 0 -2 0 -4 0 1-4cylc.dat
  [1,16,-18,2,10,-2,0,0,0,0,-2,0,-4,0, ldraw_lib__1_4cylc()],
// 1 16 -18 2 6 -2 0 0 0 0 -2 0 1 0 1-4disc.dat
  [1,16,-18,2,6,-2,0,0,0,0,-2,0,1,0, ldraw_lib__1_4disc()],
// 
// 1 16 0 1 10 0 0 18 -1 0 0 0 -1 0 rect1.dat
  [1,16,0,1,10,0,0,18,-1,0,0,0,-1,0, ldraw_lib__rect1()],
// 1 16 0 9 10 0 0 20 -7 0 0 0 -1 0 rect2p.dat
  [1,16,0,9,10,0,0,20,-7,0,0,0,-1,0, ldraw_lib__rect2p()],
// 1 16 9.75 1 6 0 0 -8.25 -1 0 0 0 1 0 rect1.dat
  [1,16,9.75,1,6,0,0,-8.25,-1,0,0,0,1,0, ldraw_lib__rect1()],
// 1 16 10.75 9 6 9.25 0 0 0 0 -7 0 1 0 rect1.dat
  [1,16,10.75,9,6,9.25,0,0,0,0,-7,0,1,0, ldraw_lib__rect1()],
// 1 16 -9.75 1 6 0 0 -8.25 -1 0 0 0 1 0 rect1.dat
  [1,16,-9.75,1,6,0,0,-8.25,-1,0,0,0,1,0, ldraw_lib__rect1()],
// 1 16 -10.75 9 6 -9.25 0 0 0 0 7 0 1 0 rect1.dat
  [1,16,-10.75,9,6,-9.25,0,0,0,0,7,0,1,0, ldraw_lib__rect1()],
...
module ldraw_lib__93095(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__93095(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
