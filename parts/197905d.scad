...
use <197905c.scad>
$fa=1; $fs=0.2;
function ldraw_lib__197905d(realsolid=false) = [
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 197905c.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__197905c(realsolid)],
];
module ldraw_lib__197905d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__197905d(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
