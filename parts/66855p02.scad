...
use <s/66855s01.scad>
function ldraw_lib__66855p02() = [
// 0 Plate  2 x  2 with Truncated Cube Extension with Red Circle on 4 Sides Pattern
// 0 Name: 66855p02.dat
...
// 1 4 0 26.5 -30 20 0 0 0 0 -20 0 1 0 48\4-4disc.dat
  [1,4,0,26.5,-30,20,0,0,0,0,-20,0,1,0, ldraw_lib__48__4_4disc()],
...
// 4 16 -25 48 -30 25 48 -30 20 46.5 -30 -20 46.5 -30
  [4,16,-25,48,-30,25,48,-30,20,46.5,-30,-20,46.5,-30],
// 1 4 -30 26.5 0 0 1 0 0 0 -20 -20 0 0 48\4-4disc.dat
  [1,4,-30,26.5,0,0,1,0,0,0,-20,-20,0,0, ldraw_lib__48__4_4disc()],
...
module ldraw_lib__66855p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__66855p02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__66855p02(line=0.2);