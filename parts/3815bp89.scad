...
use <s/3815bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3815bp89(realsolid=false) = [
...
// 1 15 -2 12 0 0 4 0 8.08395 0 -3.34848 -3.34848 0 -8.08395 5-16cyli.dat
  [1,15,-2,12,0,0,4,0,8.08395,0,-3.34848,-3.34848,0,-8.08395, ldraw_lib__5_16cyli(realsolid)],
...
module ldraw_lib__3815bp89(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3815bp89(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
