...
// 1 0 0 16 0 1 0 0 0 1 0 0 0 1 2727bc01.dat
  [1,0,0,16,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2727bc01()],
...
module ldraw_lib__2726c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2726c02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
