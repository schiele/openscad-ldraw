...
$fa=1; $fs=0.2;
function ldraw_lib__6159a(realsolid=false) = [
...
// 1 16 0 68 -60 1 0 0 0 -1 0 0 0 1 stug3-1x3.dat
  [1,16,0,68,-60,1,0,0,0,-1,0,0,0,1, ldraw_lib__stug3_1x3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 72 -60 40 0 0 0 1 0 0 0 10 recte4.dat
  [1,16,0,72,-60,40,0,0,0,1,0,0,0,10, ldraw_lib__recte4(realsolid)],
// 1 16 0 68 -55.75 -37 0 0 0 -4 0 0 0 5.75 box2-7.dat
  [1,16,0,68,-55.75,-37,0,0,0,-4,0,0,0,5.75, ldraw_lib__box2_7(realsolid)],
// 1 16 0 70 -70 40 0 0 0 0 -2 0 1 0 rect3.dat
  [1,16,0,70,-70,40,0,0,0,0,-2,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 38.5 38 -20 0 0 1.5 -34 0 0 30 -1 0 rect2p.dat
  [1,16,38.5,38,-20,0,0,1.5,-34,0,0,30,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -38.5 38 -20 0 0 -1.5 34 0 0 -30 -1 0 rect2p.dat
  [1,16,-38.5,38,-20,0,0,-1.5,34,0,0,-30,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 4 0.75 37 0 0 0 -1 0 0 0 -9.25 rect3.dat
  [1,16,0,4,0.75,37,0,0,0,-1,0,0,0,-9.25, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 16.017 -24.132 35 0 0 0 2.4811 -12.0303 0 2.8119 10.6151 box4.dat
  [1,16,0,16.017,-24.132,35,0,0,0,2.4811,-12.0303,0,2.8119,10.6151, ldraw_lib__box4(realsolid)],
...
// 1 16 0 46.775 -51.27 35 0 0 0 2.4811 -14.7605 0 2.8119 13.0241 box4.dat
  [1,16,0,46.775,-51.27,35,0,0,0,2.4811,-14.7605,0,2.8119,13.0241, ldraw_lib__box4(realsolid)],
// 0 // inside surface
...
module ldraw_lib__6159a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6159a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
