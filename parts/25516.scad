...
use <s/25516s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__25516(realsolid=false) = [
...
// 1 16 0 0 0 4 0 0 0 10 0 0 0 4 4-4cylo.dat
  [1,16,0,0,0,4,0,0,0,10,0,0,0,4, ldraw_lib__4_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -6 0 2 0 0 0 16 0 0 0 2 4-4cylo.dat
  [1,16,0,-6,0,2,0,0,0,16,0,0,0,2, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 10 0 2 0 0 0 -1 0 0 0 2 4-4ring1.dat
  [1,16,0,10,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -12 0 1.75 0 0 0 6 0 0 0 1.75 4-4cylc.dat
  [1,16,0,-12,0,1.75,0,0,0,6,0,0,0,1.75, ldraw_lib__4_4cylc(realsolid)],
// 1 16 0 -6 0 0.25 0 0 0 -1 0 0 0 0.25 4-4ring7.dat
  [1,16,0,-6,0,0.25,0,0,0,-1,0,0,0,0.25, ldraw_lib__4_4ring7(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\25516s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__25516s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\25516s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__25516s01(realsolid)],
// 1 16 0 0 0 0.5 0 0.86603 0 1 0 -0.86603 0 0.5 s\25516s01.dat
  [1,16,0,0,0,0.5,0,0.86603,0,1,0,-0.86603,0,0.5, ldraw_lib__s__25516s01(realsolid)],
// 1 16 0 0 0 0.5 0 -0.86603 0 1 0 -0.86603 0 -0.5 s\25516s01.dat
  [1,16,0,0,0,0.5,0,-0.86603,0,1,0,-0.86603,0,-0.5, ldraw_lib__s__25516s01(realsolid)],
// 1 16 0 0 0 -0.5 0 0.86603 0 1 0 -0.86603 0 -0.5 s\25516s01.dat
  [1,16,0,0,0,-0.5,0,0.86603,0,1,0,-0.86603,0,-0.5, ldraw_lib__s__25516s01(realsolid)],
...
module ldraw_lib__25516(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__25516(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
