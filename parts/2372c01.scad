...
use <2373.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2372c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2372.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2372(realsolid)],
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 2373.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2373(realsolid)],
];
module ldraw_lib__2372c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2372c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
