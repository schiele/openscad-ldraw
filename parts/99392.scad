...
use <s/99392s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__99392(realsolid=false) = [
// 0 ~Electric Mindstorms EV3 Infrared Sensor Shell Front
// 0 Name: 99392.dat
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\99392s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__99392s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\99392s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__99392s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\99392s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__99392s02(realsolid)],
...
module ldraw_lib__99392(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__99392(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__99392(line=0.2);