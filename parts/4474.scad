...
use <s/4474s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4474(realsolid=false) = [
// 0 Windscreen  6 x  4 x  2 Canopy
// 0 Name: 4474.dat
...
// 0 !HISTORY 2002-05-10 [bbroich] Update--refined the shape of the part
// 0 !HISTORY 2002-11-30 [PTadmin] Official Update 2002-05
// 0 !HISTORY 2003-06-08 [jriley] BFC compliancy
// 0 !HISTORY 2003-09-21 [OrionP] Moved guts to subfile
...
// 1 16 -40 41.5 1.5 0 1 0 2.5 0 0 0 0 2.5 1-4disc.dat
  [1,16,-40,41.5,1.5,0,1,0,2.5,0,0,0,0,2.5, ldraw_lib__1_4disc(realsolid)],
// 
...
// 1 16 40 41.5 1.5 0 -1 0 2.5 0 0 0 0 2.5 1-4disc.dat
  [1,16,40,41.5,1.5,0,-1,0,2.5,0,0,0,0,2.5, ldraw_lib__1_4disc(realsolid)],
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\4474s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4474s01(realsolid)],
];
module ldraw_lib__4474(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4474(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4474(line=0.2);