...
// 1 15 0 34 0 -1 0 0 0 1 0 0 0 -1 t1053p06.dat
  [1,15,0,34,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1053p06()],
// 
// 0 // bottom contacts
...
// 1 15 0 29.5 0 1 0 0 0 1 0 0 0 1 t1109.dat
  [1,15,0,29.5,0,1,0,0,0,1,0,0,0,1, ldraw_lib__t1109()],
];
module ldraw_lib__t1052c10(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1052c10(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
