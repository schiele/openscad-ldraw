...
use <t1109.scad>
$fa=1; $fs=0.2;
function ldraw_lib__t1052c10(realsolid=false) = [
// 0 | Circuit Cubes Potentiometer
// 0 Name: t1052c10.dat
...
// 
// 0 // PCB
// 1 15 0 34 0 -1 0 0 0 1 0 0 0 -1 t1053p06.dat
  [1,15,0,34,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1053p06(realsolid)],
// 
// 0 // bottom contacts
...
// 
// 0 // Trimmer
// 1 15 0 29.5 0 1 0 0 0 1 0 0 0 1 t1109.dat
  [1,15,0,29.5,0,1,0,0,0,1,0,0,0,1, ldraw_lib__t1109(realsolid)],
];
module ldraw_lib__t1052c10(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1052c10(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__t1052c10(line=0.2);