...
use <s/62576s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__62576(realsolid=false) = [
...
// 1 16 70 44 40 -6 0 0 0 -1 0 0 0 6 1-4disc.dat
  [1,16,70,44,40,-6,0,0,0,-1,0,0,0,6, ldraw_lib__1_4disc(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 70 44 40 -6 0 0 0 4 0 0 0 6 1-4cylo.dat
  [1,16,70,44,40,-6,0,0,0,4,0,0,0,6, ldraw_lib__1_4cylo(realsolid)],
// 1 16 70 48 40 -3 0 0 0 -1 0 0 0 3 1-4ring2.dat
  [1,16,70,48,40,-3,0,0,0,-1,0,0,0,3, ldraw_lib__1_4ring2(realsolid)],
// 1 16 70 48 40 -1 0 0 0 -1 0 0 0 1 1-4ring9.dat
  [1,16,70,48,40,-1,0,0,0,-1,0,0,0,1, ldraw_lib__1_4ring9(realsolid)],
// 1 16 70 48 40 -10 0 0 0 -8 0 0 0 10 1-4cylo.dat
  [1,16,70,48,40,-10,0,0,0,-8,0,0,0,10, ldraw_lib__1_4cylo(realsolid)],
// 1 16 70 40 40 -10 0 0 0 1 0 0 0 10 1-4disc.dat
  [1,16,70,40,40,-10,0,0,0,1,0,0,0,10, ldraw_lib__1_4disc(realsolid)],
// 1 16 -70 44 40 6 0 0 0 -1 0 0 0 6 1-4disc.dat
  [1,16,-70,44,40,6,0,0,0,-1,0,0,0,6, ldraw_lib__1_4disc(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__62576(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__62576(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
