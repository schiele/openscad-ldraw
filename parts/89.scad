...
use <9244.scad>
$fa=1; $fs=0.2;
function ldraw_lib__89(realsolid=false) = [
// 0 ~Moved to 9244
// 0 Name: 89.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 9244.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__9244(realsolid)],
];
module ldraw_lib__89(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__89(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
