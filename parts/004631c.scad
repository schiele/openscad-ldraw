...
use <../p/4-4ndis.scad>
$fa=1; $fs=0.2;
function ldraw_lib__004631c(realsolid=false) = [
...
// 1 4 -3.3 -.25 2.7 -5.7 0 0 0 1 0 0 0 5.7 1-4chrd.dat
  [1,4,-3.3,-.25,2.7,-5.7,0,0,0,1,0,0,0,5.7, ldraw_lib__1_4chrd(realsolid)],
// 1 4 -3.3 -.25 4.1 5.7 0 0 0 1 0 0 0 4.3 1-4chrd.dat
  [1,4,-3.3,-.25,4.1,5.7,0,0,0,1,0,0,0,4.3, ldraw_lib__1_4chrd(realsolid)],
// 1 4 -4.6 -.25 4.1 7 0 0 0 1 0 0 0 -4.9 1-8chrd.dat
  [1,4,-4.6,-.25,4.1,7,0,0,0,1,0,0,0,-4.9, ldraw_lib__1_8chrd(realsolid)],
// 1 4 -3.3 -.25 -2.4 -6.2 0 0 0 1 0 0 0 -5.8 1-4chrd.dat
  [1,4,-3.3,-.25,-2.4,-6.2,0,0,0,1,0,0,0,-5.8, ldraw_lib__1_4chrd(realsolid)],
// 1 4 -3.3 -.25 -3 6.3 0 0 0 1 0 0 0 -5.2 1-4chrd.dat
  [1,4,-3.3,-.25,-3,6.3,0,0,0,1,0,0,0,-5.2, ldraw_lib__1_4chrd(realsolid)],
// 1 4 -4.6 -.25 -3 7.6 0 0 0 1 0 0 0 4.7 1-8chrd.dat
  [1,4,-4.6,-.25,-3,7.6,0,0,0,1,0,0,0,4.7, ldraw_lib__1_8chrd(realsolid)],
// 1 4 -3.3 -.25 2.7 -2.5 0 0 0 1 0 0 0 2.8 1-4ndis.dat
  [1,4,-3.3,-.25,2.7,-2.5,0,0,0,1,0,0,0,2.8, ldraw_lib__1_4ndis(realsolid)],
// 1 4 -3.3 -.25 4 2.5 0 0 0 1 0 0 0 1.5 1-4ndis.dat
  [1,4,-3.3,-.25,4,2.5,0,0,0,1,0,0,0,1.5, ldraw_lib__1_4ndis(realsolid)],
// 1 4 -4.6 -.25 4 3.8 0 0 0 1 0 0 0 -2.3 1-4ndis.dat
  [1,4,-4.6,-.25,4,3.8,0,0,0,1,0,0,0,-2.3, ldraw_lib__1_4ndis(realsolid)],
// 1 4 -3.3 -.25 -2.4 -2.6 0 0 0 1 0 0 0 -2.7 1-4ndis.dat
  [1,4,-3.3,-.25,-2.4,-2.6,0,0,0,1,0,0,0,-2.7, ldraw_lib__1_4ndis(realsolid)],
// 1 4 -3.3 -.25 -3 2.6 0 0 0 1 0 0 0 -2.1 1-4ndis.dat
  [1,4,-3.3,-.25,-3,2.6,0,0,0,1,0,0,0,-2.1, ldraw_lib__1_4ndis(realsolid)],
// 1 4 -4.6 -.25 -3 3.9 0 0 0 1 0 0 0 2.2 1-4ndis.dat
  [1,4,-4.6,-.25,-3,3.9,0,0,0,1,0,0,0,2.2, ldraw_lib__1_4ndis(realsolid)],
...
// 1 15 -3.3 -.25 2.7 -5.7 0 0 0 1 0 0 0 5.7 1-4ndis.dat
  [1,15,-3.3,-.25,2.7,-5.7,0,0,0,1,0,0,0,5.7, ldraw_lib__1_4ndis(realsolid)],
// 1 15 -3.3 -.25 4.1 5.7 0 0 0 1 0 0 0 4.3 1-4ndis.dat
  [1,15,-3.3,-.25,4.1,5.7,0,0,0,1,0,0,0,4.3, ldraw_lib__1_4ndis(realsolid)],
// 1 15 -4.6 -.25 4.1 7 0 0 0 1 0 0 0 -4.9 1-8tang.dat
  [1,15,-4.6,-.25,4.1,7,0,0,0,1,0,0,0,-4.9, ldraw_lib__1_8tang(realsolid)],
// 1 15 -3.3 -.25 -2.4 -6.2 0 0 0 1 0 0 0 -5.8 1-4ndis.dat
  [1,15,-3.3,-.25,-2.4,-6.2,0,0,0,1,0,0,0,-5.8, ldraw_lib__1_4ndis(realsolid)],
// 1 15 -3.3 -.25 -3 6.3 0 0 0 1 0 0 0 -5.2 1-4ndis.dat
  [1,15,-3.3,-.25,-3,6.3,0,0,0,1,0,0,0,-5.2, ldraw_lib__1_4ndis(realsolid)],
// 1 15 -4.6 -.25 -3 7.6 0 0 0 1 0 0 0 4.7 1-8tang.dat
  [1,15,-4.6,-.25,-3,7.6,0,0,0,1,0,0,0,4.7, ldraw_lib__1_8tang(realsolid)],
// 1 15 -3.3 -.25 2.7 -2.5 0 0 0 1 0 0 0 2.8 1-4chrd.dat
  [1,15,-3.3,-.25,2.7,-2.5,0,0,0,1,0,0,0,2.8, ldraw_lib__1_4chrd(realsolid)],
// 1 15 -3.3 -.25 4 2.5 0 0 0 1 0 0 0 1.5 1-4chrd.dat
  [1,15,-3.3,-.25,4,2.5,0,0,0,1,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 15 -4.6 -.25 4 3.8 0 0 0 1 0 0 0 -2.3 1-4chrd.dat
  [1,15,-4.6,-.25,4,3.8,0,0,0,1,0,0,0,-2.3, ldraw_lib__1_4chrd(realsolid)],
// 1 15 -3.3 -.25 -2.4 -2.6 0 0 0 1 0 0 0 -2.7 1-4chrd.dat
  [1,15,-3.3,-.25,-2.4,-2.6,0,0,0,1,0,0,0,-2.7, ldraw_lib__1_4chrd(realsolid)],
// 1 15 -3.3 -.25 -3 2.6 0 0 0 1 0 0 0 -2.1 1-4chrd.dat
  [1,15,-3.3,-.25,-3,2.6,0,0,0,1,0,0,0,-2.1, ldraw_lib__1_4chrd(realsolid)],
// 1 15 -4.6 -.25 -3 3.9 0 0 0 1 0 0 0 2.2 1-4chrd.dat
  [1,15,-4.6,-.25,-3,3.9,0,0,0,1,0,0,0,2.2, ldraw_lib__1_4chrd(realsolid)],
...
// 1 4 10.8 -.25 4 6 0 0 0 1 0 0 0 4.4 1-4chrd.dat
  [1,4,10.8,-.25,4,6,0,0,0,1,0,0,0,4.4, ldraw_lib__1_4chrd(realsolid)],
// 1 4 10.8 -.25 4 -6 0 0 0 1 0 0 0 4.4 1-4chrd.dat
  [1,4,10.8,-.25,4,-6,0,0,0,1,0,0,0,4.4, ldraw_lib__1_4chrd(realsolid)],
// 1 4 10.8 -.25 4 -6 0 0 0 1 0 0 0 -4.4 1-8chrd.dat
  [1,4,10.8,-.25,4,-6,0,0,0,1,0,0,0,-4.4, ldraw_lib__1_8chrd(realsolid)],
// 1 4 10.8 -.25 4 6 0 0 0 1 0 0 0 -4.4 1-8chrd.dat
  [1,4,10.8,-.25,4,6,0,0,0,1,0,0,0,-4.4, ldraw_lib__1_8chrd(realsolid)],
// 1 4 10.8 -.25 4 2.4 0 0 0 1 0 0 0 2 4-4ndis.dat
  [1,4,10.8,-.25,4,2.4,0,0,0,1,0,0,0,2, ldraw_lib__4_4ndis(realsolid)],
// 1 4 10.8 -.25 -3 6.5 0 0 0 1 0 0 0 -5.2 1-4chrd.dat
  [1,4,10.8,-.25,-3,6.5,0,0,0,1,0,0,0,-5.2, ldraw_lib__1_4chrd(realsolid)],
// 1 4 10.8 -.25 -3 -6.5 0 0 0 1 0 0 0 -5.2 1-4chrd.dat
  [1,4,10.8,-.25,-3,-6.5,0,0,0,1,0,0,0,-5.2, ldraw_lib__1_4chrd(realsolid)],
// 1 4 10.8 -.25 -3 -6.5 0 0 0 1 0 0 0 5.2 1-8chrd.dat
  [1,4,10.8,-.25,-3,-6.5,0,0,0,1,0,0,0,5.2, ldraw_lib__1_8chrd(realsolid)],
// 1 4 10.8 -.25 -3 6.5 0 0 0 1 0 0 0 5.2 1-8chrd.dat
  [1,4,10.8,-.25,-3,6.5,0,0,0,1,0,0,0,5.2, ldraw_lib__1_8chrd(realsolid)],
// 1 4 10.8 -.25 -3 2.9 0 0 0 1 0 0 0 2.6 4-4ndis.dat
  [1,4,10.8,-.25,-3,2.9,0,0,0,1,0,0,0,2.6, ldraw_lib__4_4ndis(realsolid)],
...
// 1 15 10.8 -.25 4 6 0 0 0 1 0 0 0 4.4 2-4ndis.dat
  [1,15,10.8,-.25,4,6,0,0,0,1,0,0,0,4.4, ldraw_lib__2_4ndis(realsolid)],
// 1 15 10.8 -.25 4 -6 0 0 0 1 0 0 0 -4.4 1-8tang.dat
  [1,15,10.8,-.25,4,-6,0,0,0,1,0,0,0,-4.4, ldraw_lib__1_8tang(realsolid)],
// 1 15 10.8 -.25 4 6 0 0 0 1 0 0 0 -4.4 1-8tang.dat
  [1,15,10.8,-.25,4,6,0,0,0,1,0,0,0,-4.4, ldraw_lib__1_8tang(realsolid)],
// 1 15 10.8 -.25 -3 6.5 0 0 0 1 0 0 0 -5.2 2-4ndis.dat
  [1,15,10.8,-.25,-3,6.5,0,0,0,1,0,0,0,-5.2, ldraw_lib__2_4ndis(realsolid)],
// 1 15 10.8 -.25 -3 6.5 0 0 0 1 0 0 0 5.2 1-8ndis.dat
  [1,15,10.8,-.25,-3,6.5,0,0,0,1,0,0,0,5.2, ldraw_lib__1_8ndis(realsolid)],
// 1 15 10.8 -.25 -3 -6.5 0 0 0 1 0 0 0 5.2 1-8ndis.dat
  [1,15,10.8,-.25,-3,-6.5,0,0,0,1,0,0,0,5.2, ldraw_lib__1_8ndis(realsolid)],
// 1 15 10.8 -.25 4 2.4 0 0 0 1 0 0 0 2 4-4disc.dat
  [1,15,10.8,-.25,4,2.4,0,0,0,1,0,0,0,2, ldraw_lib__4_4disc(realsolid)],
// 1 15 10.8 -.25 -3 2.9 0 0 0 1 0 0 0 2.6 4-4disc.dat
  [1,15,10.8,-.25,-3,2.9,0,0,0,1,0,0,0,2.6, ldraw_lib__4_4disc(realsolid)],
...
// 1 4 25 -.25 -2.4 2.9 0 0 0 1 0 0 0 2.9 4-4ndis.dat
  [1,4,25,-.25,-2.4,2.9,0,0,0,1,0,0,0,2.9, ldraw_lib__4_4ndis(realsolid)],
// 1 4 24.7 -.25 3.9 6 0 0 0 1 0 0 0 4.5 1-4chrd.dat
  [1,4,24.7,-.25,3.9,6,0,0,0,1,0,0,0,4.5, ldraw_lib__1_4chrd(realsolid)],
// 1 4 24.7 -.25 .1 0 0 -6.6 0 1 0 8.3 0 0 1-8chrd.dat
  [1,4,24.7,-.25,.1,0,0,-6.6,0,1,0,8.3,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 4 24.7 -.25 .1 -6.6 0 0 0 1 0 0 0 8.3 1-8chrd.dat
  [1,4,24.7,-.25,.1,-6.6,0,0,0,1,0,0,0,8.3, ldraw_lib__1_8chrd(realsolid)],
// 1 4 24.7 -.25 .1 -6.6 0 0 0 1 0 0 0 -8.3 1-8chrd.dat
  [1,4,24.7,-.25,.1,-6.6,0,0,0,1,0,0,0,-8.3, ldraw_lib__1_8chrd(realsolid)],
// 1 4 24.7 -.25 .1 0 0 -6.6 0 1 0 -8.3 0 0 1-8chrd.dat
  [1,4,24.7,-.25,.1,0,0,-6.6,0,1,0,-8.3,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 4 24.7 -.25 -2.5 0 0 6.4 0 1 0 -5.7 0 0 1-8chrd.dat
  [1,4,24.7,-.25,-2.5,0,0,6.4,0,1,0,-5.7,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 4 24.7 -.25 -2.5 6.4 0 0 0 1 0 0 0 -5.7 1-8chrd.dat
  [1,4,24.7,-.25,-2.5,6.4,0,0,0,1,0,0,0,-5.7, ldraw_lib__1_8chrd(realsolid)],
// 1 4 25.7 -.25 -2.5 5.4 0 0 0 1 0 0 0 5.7 1-8chrd.dat
  [1,4,25.7,-.25,-2.5,5.4,0,0,0,1,0,0,0,5.7, ldraw_lib__1_8chrd(realsolid)],
// 1 4 25.7 -.25 -2.5 0 0 5.4 0 1 0 5.7 0 0 1-8chrd.dat
  [1,4,25.7,-.25,-2.5,0,0,5.4,0,1,0,5.7,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 4 25.7 -.25 -1 0 0 -5.1 0 1 0 4.2 0 0 1-8chrd.dat
  [1,4,25.7,-.25,-1,0,0,-5.1,0,1,0,4.2,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 4 24.7 -.25 2 -2.7 0 0 0 1 0 0 0 3.5 1-4ndis.dat
  [1,4,24.7,-.25,2,-2.7,0,0,0,1,0,0,0,3.5, ldraw_lib__1_4ndis(realsolid)],
// 1 4 24.7 -.25 3.9 2.7 0 0 0 1 0 0 0 1.6 1-4ndis.dat
  [1,4,24.7,-.25,3.9,2.7,0,0,0,1,0,0,0,1.6, ldraw_lib__1_4ndis(realsolid)],
...
// 1 15 25 -.25 -2.4 2.9 0 0 0 1 0 0 0 2.9 4-4disc.dat
  [1,15,25,-.25,-2.4,2.9,0,0,0,1,0,0,0,2.9, ldraw_lib__4_4disc(realsolid)],
// 1 15 24.7 -.25 .1 0 0 -6.6 0 1 0 8.3 0 0 2-4ndis.dat
  [1,15,24.7,-.25,.1,0,0,-6.6,0,1,0,8.3,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 15 24.7 -.25 -2.5 0 0 6.4 0 1 0 -5.7 0 0 1-4ndis.dat
  [1,15,24.7,-.25,-2.5,0,0,6.4,0,1,0,-5.7,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 15 25.7 -.25 -2.5 0 0 5.4 0 1 0 5.7 0 0 1-4ndis.dat
  [1,15,25.7,-.25,-2.5,0,0,5.4,0,1,0,5.7,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 15 24.7 -.25 3.9 6 0 0 0 1 0 0 0 4.5 1-4ndis.dat
  [1,15,24.7,-.25,3.9,6,0,0,0,1,0,0,0,4.5, ldraw_lib__1_4ndis(realsolid)],
// 1 15 24.7 -.25 3.9 2.7 0 0 0 1 0 0 0 1.6 1-4disc.dat
  [1,15,24.7,-.25,3.9,2.7,0,0,0,1,0,0,0,1.6, ldraw_lib__1_4disc(realsolid)],
// 1 15 24.7 -.25 2 -2.7 0 0 0 1 0 0 0 3.5 1-4chrd.dat
  [1,15,24.7,-.25,2,-2.7,0,0,0,1,0,0,0,3.5, ldraw_lib__1_4chrd(realsolid)],
// 1 15 25.7 -.25 -1 0 0 -5.1 0 1 0 4.2 0 0 1-8tang.dat
  [1,15,25.7,-.25,-1,0,0,-5.1,0,1,0,4.2,0,0, ldraw_lib__1_8tang(realsolid)],
...
module ldraw_lib__004631c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__004631c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
