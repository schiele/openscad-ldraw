...
use <44302a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4183048(realsolid=false) = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 44302a.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__44302a(realsolid)],
];
module ldraw_lib__4183048(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4183048(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
