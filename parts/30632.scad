...
use <s/30632s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30632(realsolid=false) = [
...
// 1 16 20 0 0 1 0 0 0 1 0 0 0 1 s\30632s01.dat
  [1,16,20,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30632s01(realsolid)],
// 1 16 -20 0 0 -1 0 0 0 1 0 0 0 1 s\30632s01.dat
  [1,16,-20,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30632s01(realsolid)],
// 1 16 0 8.25 -30 1 0 0 0 1 0 0 0 1 s\30632s02.dat
  [1,16,0,8.25,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30632s02(realsolid)],
// 1 16 0 -47.75 -30 1 0 0 0 1 0 0 0 1 s\30632s02.dat
  [1,16,0,-47.75,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30632s02(realsolid)],
// 1 16 0 0 -30 1 0 0 0 1 0 0 0 1 s\30632s03.dat
  [1,16,0,0,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30632s03(realsolid)],
// 1 16 0 0 -30 -1 0 0 0 1 0 0 0 1 s\30632s03.dat
  [1,16,0,0,-30,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30632s03(realsolid)],
];
module ldraw_lib__30632(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30632(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
