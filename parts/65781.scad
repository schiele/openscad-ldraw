...
use <65418.scad>
$fa=1; $fs=0.2;
function ldraw_lib__65781(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 65418.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__65418(realsolid)],
// 1 1 0 0 0 1 0 0 0 1 0 0 0 1 65417.dat
  [1,1,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__65417(realsolid)],
];
module ldraw_lib__65781(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__65781(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
