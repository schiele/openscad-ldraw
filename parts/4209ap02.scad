...
use <s/4209as02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4209ap02(realsolid=false) = [
...
// 1 16 40 24 0 1 0 0 0 1 0 0 0 1 s\4209ap02s01.dat
  [1,16,40,24,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4209ap02s01(realsolid)],
...
module ldraw_lib__4209ap02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4209ap02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
