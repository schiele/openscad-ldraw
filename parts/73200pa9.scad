...
use <3817bpa9.scad>
$fa=1; $fs=0.2;
function ldraw_lib__73200pa9(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 970c00pb0040, Indiana Jones
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3815bpa9.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3815bpa9(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3816bpa9.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816bpa9(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3817bpa9.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817bpa9(realsolid)],
];
module ldraw_lib__73200pa9(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73200pa9(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
