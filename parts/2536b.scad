...
use <../p/stud2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2536b(realsolid=false) = [
...
// 1 16 0 -12 0 6 0 0 0 20 0 0 0 6 4-4cylo.dat
  [1,16,0,-12,0,6,0,0,0,20,0,0,0,6, ldraw_lib__4_4cylo(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2536bs01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2536bs01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\2536bs01.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__2536bs01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\2536bs01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__2536bs01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\2536bs01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__2536bs01(realsolid)],
];
module ldraw_lib__2536b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2536b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2536b(line=0.2);