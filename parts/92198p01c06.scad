...
use <92255.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92198p01c06(realsolid=false) = [
...
// 1 31 0 -121.9 0.9 -1 0 0 0 1 0 0 0 -1 11618.dat
  [1,31,0,-121.9,0.9,-1,0,0,0,1,0,0,0,-1, ldraw_lib__11618(realsolid)],
];
module ldraw_lib__92198p01c06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92198p01c06(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
