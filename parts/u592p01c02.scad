...
use <u9103.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u592p01c02(realsolid=false) = [
...
// 1 7 0 -67 4 1 0 0 0 1 0 0 0 1 u592p01c01.dat
  [1,7,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u592p01c01(realsolid)],
...
module ldraw_lib__u592p01c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u592p01c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u592p01c02(line=0.2);