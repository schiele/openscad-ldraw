...
use <3816bpbb.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3817bpbb(realsolid=false) = [
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 3816bpbb.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__3816bpbb(realsolid)],
];
module ldraw_lib__3817bpbb(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3817bpbb(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
