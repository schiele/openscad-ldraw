...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4033(realsolid=false) = [
...
// 1 16 26 12 -10 4 0 0 0 0 -4 0 1 0 1-4edge.dat
  [1,16,26,12,-10,4,0,0,0,0,-4,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 2 24 30 12 -10 30 60 -10
  [2,24,30,12,-10,30,60,-10],
// 1 16 26 60 -10 4 0 0 0 0 4 0 1 0 1-4edge.dat
  [1,16,26,60,-10,4,0,0,0,0,4,0,1,0, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 26 12 -6 4 0 0 0 0 -4 0 1 0 1-4edge.dat
  [1,16,26,12,-6,4,0,0,0,0,-4,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 2 24 30 12 -6 30 60 -6
  [2,24,30,12,-6,30,60,-6],
// 1 16 26 60 -6 4 0 0 0 0 4 0 1 0 1-4edge.dat
  [1,16,26,60,-6,4,0,0,0,0,4,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -26 60 -6 -4 0 0 0 0 4 0 1 0 1-4edge.dat
  [1,16,-26,60,-6,-4,0,0,0,0,4,0,1,0, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 26 12 -10 4 0 0 0 0 -4 0 4 0 1-4cyli.dat
  [1,16,26,12,-10,4,0,0,0,0,-4,0,4,0, ldraw_lib__1_4cyli(realsolid)],
// 4 16 30 12 -6 30 60 -6 30 60 -10 30 12 -10
  [4,16,30,12,-6,30,60,-6,30,60,-10,30,12,-10],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 26 60 -10 4 0 0 0 0 4 0 4 0 1-4cyli.dat
  [1,16,26,60,-10,4,0,0,0,0,4,0,4,0, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 40 34 -3.5 0 -1 0 2.5 0 0 0 0 2.5 4-4ndis.dat
  [1,16,40,34,-3.5,0,-1,0,2.5,0,0,0,0,2.5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 40 34 -3.5 0 -1 0 2.5 0 0 0 0 2.5 4-4edge.dat
  [1,16,40,34,-3.5,0,-1,0,2.5,0,0,0,0,2.5, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 36 34 -3.5 0 4 0 2.5 0 0 0 0 2.5 4-4cyli.dat
  [1,16,36,34,-3.5,0,4,0,2.5,0,0,0,0,2.5, ldraw_lib__4_4cyli(realsolid)],
// 1 16 36 34 -3.5 0 1 0 2.5 0 0 0 0 2.5 4-4ndis.dat
  [1,16,36,34,-3.5,0,1,0,2.5,0,0,0,0,2.5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 36 34 -3.5 0 1 0 2.5 0 0 0 0 2.5 4-4edge.dat
  [1,16,36,34,-3.5,0,1,0,2.5,0,0,0,0,2.5, ldraw_lib__4_4edge(realsolid)],
// 
// 1 16 -40 34 -3.5 0 1 0 2.5 0 0 0 0 2.5 4-4ndis.dat
  [1,16,-40,34,-3.5,0,1,0,2.5,0,0,0,0,2.5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -40 34 -3.5 0 1 0 2.5 0 0 0 0 2.5 4-4edge.dat
...
// 1 16 -40 34 -3.5 0 4 0 2.5 0 0 0 0 2.5 4-4cyli.dat
  [1,16,-40,34,-3.5,0,4,0,2.5,0,0,0,0,2.5, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -36 34 -3.5 0 -1 0 2.5 0 0 0 0 2.5 4-4ndis.dat
  [1,16,-36,34,-3.5,0,-1,0,2.5,0,0,0,0,2.5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -36 34 -3.5 0 -1 0 2.5 0 0 0 0 2.5 4-4edge.dat
  [1,16,-36,34,-3.5,0,-1,0,2.5,0,0,0,0,2.5, ldraw_lib__4_4edge(realsolid)],
...
module ldraw_lib__4033(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4033(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
