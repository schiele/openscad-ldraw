...
$fa=1; $fs=0.2;
function ldraw_lib__52035(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\52035s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__52035s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\52035s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__52035s01(realsolid)],
...
// 1 16 -10 10 -10 0 1 0 1 0 0 0 0 -1 stud2.dat
  [1,16,-10,10,-10,0,1,0,1,0,0,0,0,-1, ldraw_lib__stud2(realsolid)],
// 1 16 10 10 -10 0 -1 0 1 0 0 0 0 1 stud2.dat
  [1,16,10,10,-10,0,-1,0,1,0,0,0,0,1, ldraw_lib__stud2(realsolid)],
// 1 16 40 -22 -76.22 1 0 0 0 0 -1 0 1 0 stud2.dat
  [1,16,40,-22,-76.22,1,0,0,0,0,-1,0,1,0, ldraw_lib__stud2(realsolid)],
// 1 16 -40 -22 -76.22 1 0 0 0 0 -1 0 1 0 stud2.dat
  [1,16,-40,-22,-76.22,1,0,0,0,0,-1,0,1,0, ldraw_lib__stud2(realsolid)],
// 1 16 0 2 -99.95 1 0 0 0 0 -1 0 1 0 stud2.dat
  [1,16,0,2,-99.95,1,0,0,0,0,-1,0,1,0, ldraw_lib__stud2(realsolid)],
];
module ldraw_lib__52035(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__52035(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
