...
use <s/6050s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2556(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2556s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2556s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\2556s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__2556s01(realsolid)],
...
// 1 16 10 117.5 0 1.5 0 0 0 0 2.5 0 -4 0 box4-1.dat
  [1,16,10,117.5,0,1.5,0,0,0,0,2.5,0,-4,0, ldraw_lib__box4_1(realsolid)],
...
// 1 16 0 116 120 60 0 0 0 0 12 0 -1 0 rect.dat
  [1,16,0,116,120,60,0,0,0,0,12,0,-1,0, ldraw_lib__rect(realsolid)],
...
// 1 16 0 104 40 65 0 0 0 24 0 0 0 25 box4.dat
  [1,16,0,104,40,65,0,0,0,24,0,0,0,25, ldraw_lib__box4(realsolid)],
// 4 16 65 128 15 20 128 0 -20 128 0 -65 128 15
  [4,16,65,128,15,20,128,0,-20,128,0,-65,128,15],
// 1 16 0 124 0 0 0 20 4 0 0 0 1 0 rect1.dat
  [1,16,0,124,0,0,0,20,4,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 0 120 -10 16 0 0 0 -5 0 0 0 10 box4-2p.dat
  [1,16,0,120,-10,16,0,0,0,-5,0,0,0,10, ldraw_lib__box4_2p(realsolid)],
...
module ldraw_lib__2556(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2556(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
