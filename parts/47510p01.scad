...
use <47207.scad>
$fa=1; $fs=0.2;
function ldraw_lib__47510p01(realsolid=false) = [
...
// 1 2 0 0 0 1 0 0 0 1 0 0 0 1 47205.dat
  [1,2,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__47205(realsolid)],
...
// 1 2 0 -37 6 1 0 0 0 1 0 0 0 1 47204.dat
  [1,2,0,-37,6,1,0,0,0,1,0,0,0,1, ldraw_lib__47204(realsolid)],
// 1 73 0 -37 6 1 0 0 0 1 0 0 0 1 47203p02.dat
  [1,73,0,-37,6,1,0,0,0,1,0,0,0,1, ldraw_lib__47203p02(realsolid)],
// 1 73 0 -64 6.5 1 0 0 0 1 0 0 0 1 47198p01.dat
  [1,73,0,-64,6.5,1,0,0,0,1,0,0,0,1, ldraw_lib__47198p01(realsolid)],
// 1 73 0 -64 6.5 -1 0 0 0 1 0 0 0 -1 47198p01.dat
  [1,73,0,-64,6.5,-1,0,0,0,1,0,0,0,-1, ldraw_lib__47198p01(realsolid)],
// 1 92 0 -79 8 1 0 0 0 1 0 0 0 1 47206p02.dat
  [1,92,0,-79,8,1,0,0,0,1,0,0,0,1, ldraw_lib__47206p02(realsolid)],
// 1 0 0 -79 8 1 0 0 0 1 0 0 0 1 47200.dat
  [1,0,0,-79,8,1,0,0,0,1,0,0,0,1, ldraw_lib__47200(realsolid)],
];
module ldraw_lib__47510p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__47510p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
