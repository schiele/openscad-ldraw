use <../lib.scad>
use <169665a.scad>
function ldraw_lib__169655a() = [
// 0 =Sticker  3.9 x  5.6 with Black Space Shuttle Tail Lines Left Side
// 0 Name: 169655a.dat
...
module ldraw_lib__169655a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__169655a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__169655a(line=0.2);