...
use <../p/stud16.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30370ps5(realsolid=false) = [
// 0 Minifig Helmet SW Rebel Pilot with Yellow Grid on Grey Pattern
// 0 Name: 30370ps5.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30370s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30370s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\30370s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30370s02(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30370ps1a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30370ps1a(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\30370ps1a.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30370ps1a(realsolid)],
// 1 8 0 0 0 1 0 0 0 1 0 0 0 1 s\30370ps1b.dat
  [1,8,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30370ps1b(realsolid)],
// 1 8 0 0 0 -1 0 0 0 1 0 0 0 1 s\30370ps1b.dat
  [1,8,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30370ps1b(realsolid)],
...
module ldraw_lib__30370ps5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30370ps5(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__30370ps5(line=0.2);