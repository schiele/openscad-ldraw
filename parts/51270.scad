...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__51270(realsolid=false) = [
// 0 Plant Pumpkin
// 0 Name: 51270.dat
...
// 1 16 0 4 0 12 0 0 0 23 0 0 0 12 4-4cylo.dat
  [1,16,0,4,0,12,0,0,0,23,0,0,0,12, ldraw_lib__4_4cylo(realsolid)],
...
// 1 16 0 27 0 0.33333 0 0 0 -1 0 0 0 0.33333 4-4rin36.dat
  [1,16,0,27,0,0.33333,0,0,0,-1,0,0,0,0.33333, ldraw_lib__4_4rin36(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\51270s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__51270s01(realsolid)],
// 1 16 0 0 0 0.70711 0 0.70711 0 1 0 -0.70711 0 0.70711 s\51270s01.dat
  [1,16,0,0,0,0.70711,0,0.70711,0,1,0,-0.70711,0,0.70711, ldraw_lib__s__51270s01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\51270s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__51270s01(realsolid)],
// 1 16 0 0 0 -0.70711 0 0.70711 0 1 0 -0.70711 0 -0.70711 s\51270s01.dat
  [1,16,0,0,0,-0.70711,0,0.70711,0,1,0,-0.70711,0,-0.70711, ldraw_lib__s__51270s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\51270s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__51270s01(realsolid)],
...
// 1 16 0 4 0 1 0 0 0 20 0 0 0 -1 axlehol6.dat
  [1,16,0,4,0,1,0,0,0,20,0,0,0,-1, ldraw_lib__axlehol6(realsolid)],
// 1 16 0 4 0 1 0 0 0 20 0 0 0 1 axlehol6.dat
  [1,16,0,4,0,1,0,0,0,20,0,0,0,1, ldraw_lib__axlehol6(realsolid)],
// 1 16 0 4 0 -1 0 0 0 20 0 0 0 -1 axlehol6.dat
  [1,16,0,4,0,-1,0,0,0,20,0,0,0,-1, ldraw_lib__axlehol6(realsolid)],
...
// 1 16 0 24 0 1 0 0 0 1 0 0 0 -1 axlehol3.dat
  [1,16,0,24,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__axlehol3(realsolid)],
];
module ldraw_lib__51270(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__51270(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
