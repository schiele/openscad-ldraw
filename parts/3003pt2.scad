...
$fa=1; $fs=0.2;
function ldraw_lib__3003pt2(realsolid=false) = [
...
// 0 BFC CERTIFY CW
  ...
  [0,"BFC","CW"],
// 
// 0 !KEYWORDS Bricklink 3003px3, Set 614
// 
...
// 1 16 0 0 -20 1 0 0 0 1 0 0 0 1 s\3004pt5s01.dat
  [1,16,0,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3004pt5s01(realsolid)],
];
module ldraw_lib__3003pt2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3003pt2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
