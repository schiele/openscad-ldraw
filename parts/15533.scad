...
$fa=1; $fs=0.2;
function ldraw_lib__15533(realsolid=false) = [
...
// 1 16 0 23.7 8 40 0 0 0 0 0.3 0 -24 0 rect2p.dat
  [1,16,0,23.7,8,40,0,0,0,0,0.3,0,-24,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 22.95 9 -40 0 0 0 -16 -0.45 0 -7.2 1 rect3.dat
  [1,16,0,22.95,9,-40,0,0,0,-16,-0.45,0,-7.2,1, ldraw_lib__rect3(realsolid)],
// 1 16 0 18 10 0 0 40 -4.5 0 0 0 -1 0 rect1.dat
  [1,16,0,18,10,0,0,40,-4.5,0,0,0,-1,0, ldraw_lib__rect1(realsolid)],
// 1 16 0 13.05 9 -40 0 0 0 20 -0.45 0 -9 -1 rect3.dat
  [1,16,0,13.05,9,-40,0,0,0,20,-0.45,0,-9,-1, ldraw_lib__rect3(realsolid)],
// 1 16 0 12 8 0 0 40 -0.6 0 0 0 -1.02128 0 rect1.dat
  [1,16,0,12,8,0,0,40,-0.6,0,0,0,-1.02128,0, ldraw_lib__rect1(realsolid)],
// 1 16 0 10.95 9 -40 0 0 0 -20 -0.45 0 -9 1 rect3.dat
  [1,16,0,10.95,9,-40,0,0,0,-20,-0.45,0,-9,1, ldraw_lib__rect3(realsolid)],
// 1 16 0 6 10 0 0 40 -4.5 0 0 0 -1 0 rect1.dat
  [1,16,0,6,10,0,0,40,-4.5,0,0,0,-1,0, ldraw_lib__rect1(realsolid)],
// 1 16 0 1.05 9 -40 0 0 0 20 -0.45 0 -9 -1 rect3.dat
  [1,16,0,1.05,9,-40,0,0,0,20,-0.45,0,-9,-1, ldraw_lib__rect3(realsolid)],
// 4 16 -40 0.6 8 -40 0 8 40 0 8 40 0.6 8
  [4,16,-40,0.6,8,-40,0,8,40,0,8,40,0.6,8],
// 0 // Brick front
// 1 16 -25.3 18 -8 0 0 14.7 5.4 0 0 0 1 0 recte3.dat
  [1,16,-25.3,18,-8,0,0,14.7,5.4,0,0,0,1,0, ldraw_lib__recte3(realsolid)],
// 1 16 10 18 -8 19.4 0 0 0 0 -5.4 0 1 0 recte4.dat
  [1,16,10,18,-8,19.4,0,0,0,0,-5.4,0,1,0, ldraw_lib__recte4(realsolid)],
// 1 16 35.3 18 -8 0 0 -4.7 -5.4 0 0 0 1 0 recte3.dat
  [1,16,35.3,18,-8,0,0,-4.7,-5.4,0,0,0,1,0, ldraw_lib__recte3(realsolid)],
// 1 16 -35.3 6 -8 0 0 4.7 5.4 0 0 0 1 0 recte3.dat
  [1,16,-35.3,6,-8,0,0,4.7,5.4,0,0,0,1,0, ldraw_lib__recte3(realsolid)],
// 1 16 -10 6 -8 19.4 0 0 0 0 -5.4 0 1 0 recte4.dat
  [1,16,-10,6,-8,19.4,0,0,0,0,-5.4,0,1,0, ldraw_lib__recte4(realsolid)],
// 1 16 25.3 6 -8 0 0 -14.7 -5.4 0 0 0 1 0 recte3.dat
  [1,16,25.3,6,-8,0,0,-14.7,-5.4,0,0,0,1,0, ldraw_lib__recte3(realsolid)],
// 1 16 -25.75 18 -10 0 0 14.25 4.5 0 0 0 1 0 rect3.dat
  [1,16,-25.75,18,-10,0,0,14.25,4.5,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 10 18 -10 0 0 18.5 4.5 0 0 0 1 0 rect.dat
  [1,16,10,18,-10,0,0,18.5,4.5,0,0,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 35.75 18 -10 0 0 -4.25 -4.5 0 0 0 1 0 rect3.dat
  [1,16,35.75,18,-10,0,0,-4.25,-4.5,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 -35.75 6 -10 0 0 4.25 4.5 0 0 0 1 0 rect3.dat
  [1,16,-35.75,6,-10,0,0,4.25,4.5,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 -10 6 -10 0 0 -18.5 -4.5 0 0 0 1 0 rect.dat
  [1,16,-10,6,-10,0,0,-18.5,-4.5,0,0,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 25.75 6 -10 0 0 -14.25 -4.5 0 0 0 1 0 rect3.dat
  [1,16,25.75,6,-10,0,0,-14.25,-4.5,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 0 0 40 0 0 0 1 0 0 0 8 rect.dat
  [1,16,0,0,0,40,0,0,0,1,0,0,0,8, ldraw_lib__rect(realsolid)],
...
module ldraw_lib__15533(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__15533(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
