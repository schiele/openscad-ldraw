...
// 0 !KEYWORDS BrickLink 16175pb02, Rebrickable 16175pr0002, Set 71008-9
// 
...
// 1 84 0 0 0 1 0 0 0 1 0 0 0 1 s\16175s02.dat
  [1,84,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__16175s02()],
];
module ldraw_lib__16175p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__16175p02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
