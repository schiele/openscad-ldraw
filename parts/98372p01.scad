...
use <s/98372s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98372p01(realsolid=false) = [
...
// 1 4 0 19 0 0 0 1 0 1 0 -1 0 0 s\98372s02.dat
  [1,4,0,19,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__98372s02(realsolid)],
// 1 4 0 19 0 0 0 1 0 1 0 1 0 0 s\98372s02.dat
  [1,4,0,19,0,0,0,1,0,1,0,1,0,0, ldraw_lib__s__98372s02(realsolid)],
...
module ldraw_lib__98372p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98372p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
