...
use <3817b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__84637c07(realsolid=false) = [
// 0 Minifig Hips and Legs with Metallic Dark Grey Wooden Leg Right
// 0 Name: 84637c07.dat
...
// 1 87 0 12 0 1 0 0 0 1 0 0 0 1 2532.dat
  [1,87,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2532(realsolid)],
];
module ldraw_lib__84637c07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__84637c07(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
