...
use <../p/4-4edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30043(realsolid=false) = [
...
// 1 16 0 24 -20 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,0,24,-20,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 24 -20 4 0 0 0 -16 0 0 0 4 4-4cyli.dat
  [1,16,0,24,-20,4,0,0,0,-16,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 8 -20 -4 0 0 0 -4 0 0 0 -4 2-4cyli.dat
  [1,16,0,8,-20,-4,0,0,0,-4,0,0,0,-4, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 8 -20 0 0 -4 0 -4 0 4 0 0 1-4cyls.dat
  [1,16,0,8,-20,0,0,-4,0,-4,0,4,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 0 8 -20 0 0 4 0 -4 0 4 0 0 1-4cyls.dat
  [1,16,0,8,-20,0,0,4,0,-4,0,4,0,0, ldraw_lib__1_4cyls(realsolid)],
...
module ldraw_lib__30043(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30043(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
