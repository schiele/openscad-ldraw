...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4727(realsolid=false) = [
...
// 1 16 18 0 18 2 0 0 0 8 0 0 0 2 1-4cylc.dat
  [1,16,18,0,18,2,0,0,0,8,0,0,0,2, ldraw_lib__1_4cylc(realsolid)],
// 1 16 -18 0 18 -2 0 0 0 8 0 0 0 2 1-4cylc.dat
  [1,16,-18,0,18,-2,0,0,0,8,0,0,0,2, ldraw_lib__1_4cylc(realsolid)],
// 1 16 18 0 -18 2 0 0 0 8 0 0 0 -2 1-4cylc.dat
  [1,16,18,0,-18,2,0,0,0,8,0,0,0,-2, ldraw_lib__1_4cylc(realsolid)],
...
// 1 16 18 8 18 2 0 0 0 -1 0 0 0 2 1-4disc.dat
  [1,16,18,8,18,2,0,0,0,-1,0,0,0,2, ldraw_lib__1_4disc(realsolid)],
// 1 16 -18 8 18 -2 0 0 0 -1 0 0 0 2 1-4disc.dat
  [1,16,-18,8,18,-2,0,0,0,-1,0,0,0,2, ldraw_lib__1_4disc(realsolid)],
// 1 16 18 8 -18 2 0 0 0 -1 0 0 0 -2 1-4disc.dat
  [1,16,18,8,-18,2,0,0,0,-1,0,0,0,-2, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 13 6 16 -3 0 0 0 0 2 0 1 0 rect.dat
  [1,16,13,6,16,-3,0,0,0,0,2,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 -13 6 16 0 0 3 2 0 0 0 1 0 rect.dat
  [1,16,-13,6,16,0,0,3,2,0,0,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 13 6 -16 0 0 -3 2 0 0 0 -1 0 rect.dat
  [1,16,13,6,-16,0,0,-3,2,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 -13 6 -16 3 0 0 0 0 2 0 -1 0 rect.dat
  [1,16,-13,6,-16,3,0,0,0,0,2,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 6.915 6 12.62 0 -1 -3.085 -2 0 0 0 0 -3.38 rect3.dat
  [1,16,6.915,6,12.62,0,-1,-3.085,-2,0,0,0,0,-3.38, ldraw_lib__rect3(realsolid)],
// 1 16 -6.915 6 12.62 0 1 3.085 2 0 0 0 0 -3.38 rect3.dat
  [1,16,-6.915,6,12.62,0,1,3.085,2,0,0,0,0,-3.38, ldraw_lib__rect3(realsolid)],
// 1 16 6.915 6 -12.62 0 -1 -3.085 2 0 0 0 0 3.38 rect3.dat
  [1,16,6.915,6,-12.62,0,-1,-3.085,2,0,0,0,0,3.38, ldraw_lib__rect3(realsolid)],
...
// 1 16 16 6 13 0 1 0 2 0 0 0 0 -3 rect3.dat
  [1,16,16,6,13,0,1,0,2,0,0,0,0,-3, ldraw_lib__rect3(realsolid)],
// 1 16 -16 6 13 0 -1 0 -2 0 0 0 0 -3 rect3.dat
  [1,16,-16,6,13,0,-1,0,-2,0,0,0,0,-3, ldraw_lib__rect3(realsolid)],
// 1 16 16 6 -13 0 1 0 -2 0 0 0 0 3 rect3.dat
  [1,16,16,6,-13,0,1,0,-2,0,0,0,0,3, ldraw_lib__rect3(realsolid)],
...
// 1 16 12.62 6 6.915 0 0 -3.38 2 0 0 0 -1 -3.085 rect3.dat
  [1,16,12.62,6,6.915,0,0,-3.38,2,0,0,0,-1,-3.085, ldraw_lib__rect3(realsolid)],
// 1 16 -12.62 6 6.915 0 0 3.38 -2 0 0 0 -1 -3.085 rect3.dat
  [1,16,-12.62,6,6.915,0,0,3.38,-2,0,0,0,-1,-3.085, ldraw_lib__rect3(realsolid)],
// 1 16 12.62 6 -6.915 0 0 -3.38 -2 0 0 0 1 3.085 rect3.dat
  [1,16,12.62,6,-6.915,0,0,-3.38,-2,0,0,0,1,3.085, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__4727(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4727(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
