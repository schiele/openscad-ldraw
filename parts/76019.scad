...
use <32053.scad>
$fa=1; $fs=0.2;
function ldraw_lib__76019(realsolid=false) = [
...
// 1 8 0 0 0 1 0 0 0 1 0 0 0 1 32053.dat
  [1,8,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32053(realsolid)],
...
module ldraw_lib__76019(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76019(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
