...
use <s/3068bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3068bpf0(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Scala, set 311, set 312
// 
// 0 !CMDLINE -c15
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3068bpf0s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3068bpf0s01(realsolid)],
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\3068bpf0s02.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3068bpf0s02(realsolid)],
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 s\3068bpf0s03.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3068bpf0s03(realsolid)],
];
module ldraw_lib__3068bpf0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068bpf0(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
