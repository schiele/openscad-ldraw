...
function ldraw_lib__6148328ah() = [
// 0 Sticker  1.8 x  0.8 with Black Headlamp on White Background Left (Needs Work)
// 0 Name: 6148328ah.dat
...
module ldraw_lib__6148328ah(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6148328ah(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6148328ah(line=0.2);