...
use <s/87688s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87688(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\87688s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87688s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\87688s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87688s01(realsolid)],
// 1 16 0 0 0 4 0 0 0 4 0 0 0 4 4-4cylo.dat
  [1,16,0,0,0,4,0,0,0,4,0,0,0,4, ldraw_lib__4_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 2 0 0 0 4 0 0 0 2 4-4cylo.dat
  [1,16,0,0,0,2,0,0,0,4,0,0,0,2, ldraw_lib__4_4cylo(realsolid)],
...
module ldraw_lib__87688(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87688(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
