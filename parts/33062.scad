...
use <../p/stud5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__33062(realsolid=false) = [
// 0 Scala Plate  4 x  4
// 0 Name: 33062.dat
...
// 1 16 0 8 0 40 0 0 0 -8 0 0 0 40 box5.dat
  [1,16,0,8,0,40,0,0,0,-8,0,0,0,40, ldraw_lib__box5(realsolid)],
// 1 16 20 0 20 1 0 0 0 1 0 0 0 1 stud5.dat
  [1,16,20,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud5(realsolid)],
// 1 16 -20 0 20 1 0 0 0 1 0 0 0 1 stud5.dat
  [1,16,-20,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud5(realsolid)],
// 1 16 -20 0 -20 1 0 0 0 1 0 0 0 1 stud5.dat
  [1,16,-20,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud5(realsolid)],
...
module ldraw_lib__33062(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__33062(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
