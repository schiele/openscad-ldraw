...
use <3678ap4h.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3678p4h(realsolid=false) = [
// 0 ~Moved to 3678ap4h
// 0 Name: 3678p4h.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3678ap4h.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3678ap4h(realsolid)],
];
module ldraw_lib__3678p4h(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3678p4h(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
