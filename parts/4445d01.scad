...
use <821472f.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4445d01(realsolid=false) = [
...
// 1 16 0 9.898 -19.899 1 0 0 0 0.707107 -0.707107 0 0.707107 0.707107 821472f.dat
  [1,16,0,9.898,-19.899,1,0,0,0,0.707107,-0.707107,0,0.707107,0.707107, ldraw_lib__821472f(realsolid)],
];
module ldraw_lib__4445d01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4445d01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
