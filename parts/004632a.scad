...
$fa=1; $fs=0.2;
function ldraw_lib__004632a(realsolid=false) = [
...
// 1 16 0 0 0 .38888 0 0 0 1 0 0 0 .38888 s\004488es01.dat
  [1,16,0,0,0,.38888,0,0,0,1,0,0,0,.38888, ldraw_lib__s__004488es01(realsolid)],
// 
// 0 // Small cylinder
// 1 16 0 0 0 8.75 0 0 0 -1 0 0 0 8.75 48\4-4disc.dat
  [1,16,0,0,0,8.75,0,0,0,-1,0,0,0,8.75, ldraw_lib__48__4_4disc(realsolid)],
// 1 16 0 -.25 0 8.75 0 0 0 .25 0 0 0 8.75 48\4-4cyli.dat
  [1,16,0,-.25,0,8.75,0,0,0,.25,0,0,0,8.75, ldraw_lib__48__4_4cyli(realsolid)],
];
module ldraw_lib__004632a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__004632a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
