...
// 1 16 0 0 5 22 0 0 0 0 22 0 1 0 4-4edge.dat
  [1,16,0,0,5,22,0,0,0,0,22,0,1,0, ldraw_lib__4_4edge()],
...
// 1 16 0 0 -12 22 0 0 0 0 22 0 1 0 4-4edge.dat
  [1,16,0,0,-12,22,0,0,0,0,22,0,1,0, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 0 4 19 0 0 0 0 19 0 -12 0 4-4cyli.dat
  [1,16,0,0,4,19,0,0,0,0,19,0,-12,0, ldraw_lib__4_4cyli()],
// 1 16 0 0 8 22 0 0 0 0 22 0 -3 0 4-4cyli.dat
  [1,16,0,0,8,22,0,0,0,0,22,0,-3,0, ldraw_lib__4_4cyli()],
// 1 16 0 0 -9 22 0 0 0 0 22 0 -3 0 4-4cyli.dat
  [1,16,0,0,-9,22,0,0,0,0,22,0,-3,0, ldraw_lib__4_4cyli()],
...
// 1 16 0 0 -12 22 0 0 0 0 22 0 1 0 4-4disc.dat
  [1,16,0,0,-12,22,0,0,0,0,22,0,1,0, ldraw_lib__4_4disc()],
// 
// 1 16 2 11.602 0 0 -1 0 0 0 4 8 0 0 rect.dat
  [1,16,2,11.602,0,0,-1,0,0,0,4,8,0,0, ldraw_lib__rect()],
// 1 16 -2 11.602 0 0 1 0 0 0 4 8 0 0 rect.dat
  [1,16,-2,11.602,0,0,1,0,0,0,4,8,0,0, ldraw_lib__rect()],
...
// 2 24 -2 7.602 8 0 8 8
  [2,24,-2,7.602,8,0,8,8],
// 4 16 0 16 8 0 8 8 2 7.602 8 2 15.602 8
  [4,16,0,16,8,0,8,8,2,7.602,8,2,15.602,8],
// 4 16 -2 15.602 8 -2 7.602 8 0 8 8 0 18 8
  [4,16,-2,15.602,8,-2,7.602,8,0,8,8,0,18,8],
// 
// 1 16 2 -11.602 0 0 -1 0 0 0 4 8 0 0 rect.dat
  [1,16,2,-11.602,0,0,-1,0,0,0,4,8,0,0, ldraw_lib__rect()],
...
module ldraw_lib__497a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__497a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
