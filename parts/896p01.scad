...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink x1170px1, Rebrickable 896pr0001, Set 355
// 
...
// 1 16 -170 0 90 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,-170,0,90,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3()],
// 1 16 -170 0 30 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,-170,0,30,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3()],
// 1 16 -170 0 -30 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,-170,0,-30,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3()],
// 1 16 -170 0 -90 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,-170,0,-90,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3()],
// 1 16 -100 0 -100 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,-100,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4()],
// 1 16 -20 0 -100 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,-20,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4()],
// 1 16 60 0 -100 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,60,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4()],
// 1 16 140 0 -100 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,140,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4()],
// 1 16 140 0 -20 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,140,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4()],
// 1 16 60 0 -20 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,60,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4()],
// 1 16 140 0 60 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,140,0,60,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4()],
// 1 16 -60 0 20 1 0 0 0 1 0 0 0 1 stug6.dat
  [1,16,-60,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug6()],
// 1 16 20 0 60 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,20,0,60,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 60 0 60 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,60,0,60,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 -120 0 120 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-120,0,120,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
...
// 1 16 -40 0 120 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-40,0,120,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 0 0 120 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,0,0,120,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 40 0 120 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,40,0,120,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 80 0 120 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,80,0,120,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
...
// 1 16 160 0 120 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,160,0,120,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
...
// 1 16 160 4 100 40 0 0 0 1 0 0 0 40 1-4edge.dat
  [1,16,160,4,100,40,0,0,0,1,0,0,0,40, ldraw_lib__1_4edge()],
// 1 16 -160 4 100 -40 0 0 0 1 0 0 0 40 1-4edge.dat
  [1,16,-160,4,100,-40,0,0,0,1,0,0,0,40, ldraw_lib__1_4edge()],
// 1 16 160 4 -100 40 0 0 0 1 0 0 0 -40 1-4edge.dat
  [1,16,160,4,-100,40,0,0,0,1,0,0,0,-40, ldraw_lib__1_4edge()],
...
// 1 16 160 0 100 40 0 0 0 1 0 0 0 40 1-4edge.dat
  [1,16,160,0,100,40,0,0,0,1,0,0,0,40, ldraw_lib__1_4edge()],
// 1 16 -160 0 100 -40 0 0 0 1 0 0 0 40 1-4edge.dat
  [1,16,-160,0,100,-40,0,0,0,1,0,0,0,40, ldraw_lib__1_4edge()],
// 1 16 160 0 -100 40 0 0 0 1 0 0 0 -40 1-4edge.dat
  [1,16,160,0,-100,40,0,0,0,1,0,0,0,-40, ldraw_lib__1_4edge()],
...
// 1 16 160 4 100 40 0 0 0 -1 0 0 0 40 1-4disc.dat
  [1,16,160,4,100,40,0,0,0,-1,0,0,0,40, ldraw_lib__1_4disc()],
// 1 16 -160 4 100 -40 0 0 0 -1 0 0 0 40 1-4disc.dat
  [1,16,-160,4,100,-40,0,0,0,-1,0,0,0,40, ldraw_lib__1_4disc()],
// 1 16 160 4 -100 40 0 0 0 -1 0 0 0 -40 1-4disc.dat
  [1,16,160,4,-100,40,0,0,0,-1,0,0,0,-40, ldraw_lib__1_4disc()],
...
// 1 16 160 0 100 40 0 0 0 1 0 0 0 40 1-4disc.dat
  [1,16,160,0,100,40,0,0,0,1,0,0,0,40, ldraw_lib__1_4disc()],
// 1 16 -160 0 100 -40 0 0 0 1 0 0 0 40 1-4disc.dat
  [1,16,-160,0,100,-40,0,0,0,1,0,0,0,40, ldraw_lib__1_4disc()],
// 1 16 160 0 -100 40 0 0 0 1 0 0 0 -40 1-4disc.dat
  [1,16,160,0,-100,40,0,0,0,1,0,0,0,-40, ldraw_lib__1_4disc()],
...
// 1 16 160 0 100 40 0 0 0 4 0 0 0 40 1-4cyli.dat
  [1,16,160,0,100,40,0,0,0,4,0,0,0,40, ldraw_lib__1_4cyli()],
// 1 16 -160 0 100 -40 0 0 0 4 0 0 0 40 1-4cyli.dat
  [1,16,-160,0,100,-40,0,0,0,4,0,0,0,40, ldraw_lib__1_4cyli()],
// 1 16 160 0 -100 40 0 0 0 4 0 0 0 -40 1-4cyli.dat
  [1,16,160,0,-100,40,0,0,0,4,0,0,0,-40, ldraw_lib__1_4cyli()],
...
module ldraw_lib__896p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__896p01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
