...
$fa=1; $fs=0.2;
function ldraw_lib__22408(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\22408s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__22408s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\22408s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__22408s01(realsolid)],
...
// 1 16 .00075 -19.98725 -11.5595 0 0 -12.506 0 1 0 1.5535 0 0 rect1.dat
  [1,16,.00075,-19.98725,-11.5595,0,0,-12.506,0,1,0,1.5535,0,0, ldraw_lib__rect1(realsolid)],
...
module ldraw_lib__22408(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__22408(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
