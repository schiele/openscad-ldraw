...
use <3816bpbf.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3817bpbf(realsolid=false) = [
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 3816bpbf.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__3816bpbf(realsolid)],
];
module ldraw_lib__3817bpbf(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3817bpbf(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
