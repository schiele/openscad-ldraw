...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 42060pb17, Pharaoh's Quest, Rebrickable 42060pr0001
// 0 !KEYWORDS Scorpion Claw, Set 7327
// 
// 0 !CMDLINE -c28
// 
...
module ldraw_lib__42060pq0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__42060pq0(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
