...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__42060pq0(realsolid=false) = [
// 0 Wedge 12 x  3 Double Right with Bricks & Hieroglyphs Pattern
// 0 Name: 42060pq0.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\42060s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__42060s02(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\42060pq0a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__42060pq0a(realsolid)],
];
module ldraw_lib__42060pq0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__42060pq0(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__42060pq0(line=0.2);