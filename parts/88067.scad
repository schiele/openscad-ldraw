...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\88067s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__88067s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\88067s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__88067s01()],
// 1 16 0 -4 -80 1 0 0 0 -1 0 0 0 -1 stud3.dat
  [1,16,0,-4,-80,1,0,0,0,-1,0,0,0,-1, ldraw_lib__stud3()],
// 1 16 60 -4 -40 1 0 0 0 -1 0 0 0 -1 stud3.dat
  [1,16,60,-4,-40,1,0,0,0,-1,0,0,0,-1, ldraw_lib__stud3()],
// 1 16 -60 -4 -40 1 0 0 0 -1 0 0 0 -1 stud3.dat
  [1,16,-60,-4,-40,1,0,0,0,-1,0,0,0,-1, ldraw_lib__stud3()],
...
module ldraw_lib__88067(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__88067(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
