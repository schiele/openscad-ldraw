...
$fa=1; $fs=0.2;
function ldraw_lib__4207712bc01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 4198678dc01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4198678dc01(realsolid)],
];
module ldraw_lib__4207712bc01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4207712bc01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
