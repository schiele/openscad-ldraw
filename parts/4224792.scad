...
use <49668.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4224792(realsolid=false) = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 49668.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__49668(realsolid)],
];
module ldraw_lib__4224792(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4224792(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
