...
use <789.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4320c03(realsolid=false) = [
...
// 1 4 0 -16 0 1 0 0 0 1 0 0 0 1 789.dat
  [1,4,0,-16,0,1,0,0,0,1,0,0,0,1, ldraw_lib__789(realsolid)],
];
module ldraw_lib__4320c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4320c03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
