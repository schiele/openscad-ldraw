...
use <t1091.scad>
$fa=1; $fs=0.2;
function ldraw_lib__t1052c05(realsolid=false) = [
...
// 1 0 0 29.5 0 1 0 0 0 1 0 0 0 1 t1090.dat
  [1,0,0,29.5,0,1,0,0,0,1,0,0,0,1, ldraw_lib__t1090(realsolid)],
// 
// 0 // Button
// 1 4 0 13.5 0 1 0 0 0 1 0 0 0 1 t1091.dat
  [1,4,0,13.5,0,1,0,0,0,1,0,0,0,1, ldraw_lib__t1091(realsolid)],
];
module ldraw_lib__t1052c05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1052c05(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
