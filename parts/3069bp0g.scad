...
$fa=1; $fs=0.2;
function ldraw_lib__3069bp0g(realsolid=false) = [
...
// 1 8 0 0 0 1 0 0 0 1 0 0 0 1 s\3069p0fs01.dat
  [1,8,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3069p0fs01(realsolid)],
...
module ldraw_lib__3069bp0g(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3069bp0g(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
