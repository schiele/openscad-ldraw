...
function ldraw_lib__6142271d() = [
// 0 Sticker  1.8 x  4 with Dark Grey Rear Windshield with Black Air Vents and White "Sport" Text on White Face
// 0 Name: 6142271d.dat
...
// 
// 
// 1 16 0 0 20.7523 1 0 0 0 1 0 0 0 1 s\6142271ds01.dat
  [1,16,0,0,20.7523,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6142271ds01()],
...
module ldraw_lib__6142271d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6142271d(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6142271d(line=0.2);