...
$fa=1; $fs=0.2;
function ldraw_lib__3039p23(realsolid=false) = [
...
// 1 16 0 20 -30 1 0 0 0 -1 0 0 1 1 s\3660bp01s01.dat
  [1,16,0,20,-30,1,0,0,0,-1,0,0,1,1, ldraw_lib__s__3660bp01s01(realsolid)],
];
module ldraw_lib__3039p23(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3039p23(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
