...
use <u8036.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u8025c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 u8025.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u8025(realsolid)],
// 1 47 0 0 0 1 0 0 0 1 0 0 0 1 u8036.dat
  [1,47,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u8036(realsolid)],
];
module ldraw_lib__u8025c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8025c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
