...
use <s/25727s03.scad>
function ldraw_lib__100937p03() = [
// 0 Figure Friends Legs with Folded Trousers with Nougat Feet and Dark Turquoise Shoes with White Laces and Sole Pattern
// 0 Name: 100937p03.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 100937c00pb003, Nova, Rebrickable 101347c01pr0176
// 0 !KEYWORDS Set 41755, Set 42609
// 
...
// 1 92 -10 0 0 -1 0 0 0 1 0 0 0 1 s\25727s03.dat
  [1,92,-10,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__25727s03()],
// 
// 1 3 10 0 0 1 0 0 0 1 0 0 0 1 s\1023035p01s01.dat
  [1,3,10,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__1023035p01s01()],
...
module ldraw_lib__100937p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__100937p03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__100937p03(line=0.2);