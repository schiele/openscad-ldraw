...
use <s/3069bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3069bp0m(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 3069bpb806, Lamborghini, set 42115, Sian
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3069bp0ms02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3069bp0ms02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\3069bp0ms02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3069bp0ms02(realsolid)],
];
module ldraw_lib__3069bp0m(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3069bp0m(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
