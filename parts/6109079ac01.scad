...
$fa=1; $fs=0.2;
function ldraw_lib__6109079ac01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 -0.1 0 0 1 s\6109079as01.dat
  [1,16,0,0,0,1,0,0,0,1,-0.1,0,0,1, ldraw_lib__s__6109079as01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 -0.2 0 0 1 s\6109079as02.dat
  [1,16,0,0,0,1,0,0,0,1,-0.2,0,0,1, ldraw_lib__s__6109079as02(realsolid)],
// 
...
module ldraw_lib__6109079ac01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6109079ac01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
