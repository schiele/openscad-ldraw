...
function ldraw_lib__6142617l() = [
// 0 Sticker  0.5 x  1.8 with Fog Light and Silver Stripe on Black Background Left
// 0 Name: 6142617l.dat
...
module ldraw_lib__6142617l(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6142617l(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6142617l(line=0.2);