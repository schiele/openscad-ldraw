...
function ldraw_lib__1021704p03() = [
// 0 Figure Friends Legs with Bell-Bottoms Pants with Medium Lavender Shoes with White Soles Pattern
// 0 Name: 1021704p03.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 2125c00pb002, Rebrickable 101117c01pr0022, Set 41757
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\1021704s04.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__1021704s04()],
// 1 30 0 0 0 1 0 0 0 1 0 0 0 1 s\1021704s02.dat
  [1,30,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__1021704s02()],
// 1 30 0 0 0 -1 0 0 0 1 0 0 0 1 s\1021704s02.dat
  [1,30,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__1021704s02()],
...
module ldraw_lib__1021704p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__1021704p03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__1021704p03(line=0.2);