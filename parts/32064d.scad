...
use <../p/stud3a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32064d(realsolid=false) = [
...
// 1 16 0 10 10 1 0 0 0 0 1 0 -20 0 axl3hole.dat
  [1,16,0,10,10,1,0,0,0,0,1,0,-20,0, ldraw_lib__axl3hole(realsolid)],
...
module ldraw_lib__32064d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32064d(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
