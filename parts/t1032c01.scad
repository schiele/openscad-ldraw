...
// 0 // LED
// 1 35 0 16 -36 4 0 0 0 0 4 0 -4 0 4-8sphe.dat
  [1,35,0,16,-36,4,0,0,0,0,4,0,-4,0, ldraw_lib__4_8sphe()],
// 1 494 0 16 -36 -4 0 0 0 0 4 0 1 0 4-4disc.dat
  [1,494,0,16,-36,-4,0,0,0,0,4,0,1,0, ldraw_lib__4_4disc()],
];
module ldraw_lib__t1032c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1032c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__t1032c01(line=0.2);