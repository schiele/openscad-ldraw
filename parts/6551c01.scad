...
use <6551a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6551c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6550.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6550(realsolid)],
// 1 8 0 8 0 1 0 0 0 1 0 0 0 1 6551a.dat
  [1,8,0,8,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6551a(realsolid)],
];
module ldraw_lib__6551c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6551c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
