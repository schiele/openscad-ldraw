...
$fa=1; $fs=0.2;
function ldraw_lib__2726c01(realsolid=false) = [
...
// 1 0 0 16 0 1 0 0 0 1 0 0 0 1 2727ac01.dat
  [1,0,0,16,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2727ac01(realsolid)],
// 1 256 0 0 0 1 0 0 0 1 0 0 0 1 s\2726c01s01.dat
  [1,256,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2726c01s01(realsolid)],
];
module ldraw_lib__2726c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2726c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2726c01(line=0.2);