...
use <92255.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92198p01c01(realsolid=false) = [
// 0 _Figure Friends Stephanie with Medium Lavender Pleated Skirt, White Top
// 0 Name: 92198p01c01.dat
...
// 1 78 0 -64 0 1 0 0 0 1 0 0 0 1 92241p01c01.dat
  [1,78,0,-64,0,1,0,0,0,1,0,0,0,1, ldraw_lib__92241p01c01(realsolid)],
...
module ldraw_lib__92198p01c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92198p01c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__92198p01c01(line=0.2);