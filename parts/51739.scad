...
use <../p/stug-2x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__51739(realsolid=false) = [
// 0 Wing  2 x  4
// 0 Name: 51739.dat
...
// 1 16 0 4 17 0 0 38.5 4 0 0 0 3 0 box3u4a.dat
  [1,16,0,4,17,0,0,38.5,4,0,0,0,3,0, ldraw_lib__box3u4a(realsolid)],
// 1 16 0 4 -20 0 0 -20 4 0 0 0 1 0 rect.dat
  [1,16,0,4,-20,0,0,-20,4,0,0,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 3 0 0 0 -1 0 -1.25 0 1 0 0 stud4.dat
  [1,16,0,3,0,0,0,-1,0,-1.25,0,1,0,0, ldraw_lib__stud4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 0 0 -16 0 -5 0 16 0 0 box5.dat
  [1,16,0,8,0,0,0,-16,0,-5,0,16,0,0, ldraw_lib__box5(realsolid)],
// 4 16 -16 8 -16 -20 8 -20 20 8 -20 16 8 -16
  [4,16,-16,8,-16,-20,8,-20,20,8,-20,16,8,-16],
// 4 16 16 8 16 38.5 8 20 -38.5 8 20 -16 8 16
  [4,16,16,8,16,38.5,8,20,-38.5,8,20,-16,8,16],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\51739s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__51739s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\51739s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__51739s01(realsolid)],
...
module ldraw_lib__51739(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__51739(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
