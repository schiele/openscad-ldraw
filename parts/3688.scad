...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3688(realsolid=false) = [
...
// 1 16 0 20 0 1 0 0 0 -7 0 0 0 1 stud4a.dat
  [1,16,0,20,0,1,0,0,0,-7,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 12 44 0 4 0 0 0 -1 0 0 0 1 rect.dat
  [1,16,12,44,0,4,0,0,0,-1,0,0,0,1, ldraw_lib__rect(realsolid)],
// 1 16 -12 44 0 4 0 0 0 -1 0 0 0 1 rect.dat
  [1,16,-12,44,0,4,0,0,0,-1,0,0,0,1, ldraw_lib__rect(realsolid)],
...
// 1 16 0 42 0 16 0 0 0 6 0 0 0 16 box4.dat
  [1,16,0,42,0,16,0,0,0,6,0,0,0,16, ldraw_lib__box4(realsolid)],
// 1 16 0 44 0 20 0 0 0 4 0 0 0 20 box4.dat
  [1,16,0,44,0,20,0,0,0,4,0,0,0,20, ldraw_lib__box4(realsolid)],
...
// 1 16 0 4 0 6 0 0 0 6 0 0 0 6 4-4edge.dat
  [1,16,0,4,0,6,0,0,0,6,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 4 0 2 0 0 0 -1 0 0 0 2 ring2.dat
  [1,16,0,4,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__ring2(realsolid)],
...
module ldraw_lib__3688(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3688(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
