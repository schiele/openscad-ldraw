...
use <s/4478s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4478p01(realsolid=false) = [
...
// 1 16 -118 0 -310 -10 0 0 0 1 0 0 0 10 1-8ndis.dat
  [1,16,-118,0,-310,-10,0,0,0,1,0,0,0,10, ldraw_lib__1_8ndis(realsolid)],
// 1 7 135 0 -306 -10 0 0 0 1 0 0 0 10 1-8ndis.dat
  [1,7,135,0,-306,-10,0,0,0,1,0,0,0,10, ldraw_lib__1_8ndis(realsolid)],
// 1 16 135 0 -306 -10 0 0 0 1 0 0 0 10 1-8disc.dat
  [1,16,135,0,-306,-10,0,0,0,1,0,0,0,10, ldraw_lib__1_8disc(realsolid)],
// 1 7 112 0 -52 10 0 0 0 1 0 0 0 -10 1-8ndis.dat
  [1,7,112,0,-52,10,0,0,0,1,0,0,0,-10, ldraw_lib__1_8ndis(realsolid)],
...
// 1 7 -118 0 -310 -10 0 0 0 1 0 0 0 10 1-8disc.dat
  [1,7,-118,0,-310,-10,0,0,0,1,0,0,0,10, ldraw_lib__1_8disc(realsolid)],
// 1 16 266 0 -147 10 0 0 0 1 0 0 0 -10 1-8ndis.dat
  [1,16,266,0,-147,10,0,0,0,1,0,0,0,-10, ldraw_lib__1_8ndis(realsolid)],
// 1 7 266 0 -147 10 0 0 0 1 0 0 0 -10 1-8disc.dat
  [1,7,266,0,-147,10,0,0,0,1,0,0,0,-10, ldraw_lib__1_8disc(realsolid)],
...
module ldraw_lib__4478p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4478p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
