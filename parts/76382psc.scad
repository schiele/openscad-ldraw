...
use <3820.scad>
use <973psc.scad>
function ldraw_lib__76382psc() = [
// 0 Minifig Torso with Arms and Hands with SW Pocket-Vest and Techno-Buckle Pattern
// 0 Name: 76382psc.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973psc.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973psc()],
...
module ldraw_lib__76382psc(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382psc(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382psc(line=0.2);