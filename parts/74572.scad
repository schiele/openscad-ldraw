...
use <3483.scad>
$fa=1; $fs=0.2;
function ldraw_lib__74572(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2574c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2574c01(realsolid)],
// 1 256 55 34 50 0 0 1 0 1 0 -1 0 0 3483.dat
  [1,256,55,34,50,0,0,1,0,1,0,-1,0,0, ldraw_lib__3483(realsolid)],
// 1 256 -55 34 50 0 0 1 0 1 0 -1 0 0 3483.dat
  [1,256,-55,34,50,0,0,1,0,1,0,-1,0,0, ldraw_lib__3483(realsolid)],
];
module ldraw_lib__74572(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__74572(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
