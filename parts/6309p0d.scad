...
use <s/6309s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6309p0d(realsolid=false) = [
...
// 1 1 -38 0 -38 76 0 0 0 1 0 0 0 76 48\1-4ndis.dat
  [1,1,-38,0,-38,76,0,0,0,1,0,0,0,76, ldraw_lib__48__1_4ndis(realsolid)],
// 0
];
module ldraw_lib__6309p0d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6309p0d(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
