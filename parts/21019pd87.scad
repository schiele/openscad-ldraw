...
use <3815b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__21019pd87(realsolid=false) = [
...
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 20460pd87.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__20460pd87(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 20461pd87.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__20461pd87(realsolid)],
];
module ldraw_lib__21019pd87(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__21019pd87(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
