...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\973pb1s.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973pb1s()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\973pb1s.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__973pb1s()],
];
module ldraw_lib__973pb1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973pb1(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
