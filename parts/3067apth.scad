...
use <s/3067s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3067apth(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3009pths01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3009pths01(realsolid)],
];
module ldraw_lib__3067apth(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3067apth(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
