...
use <../p/stud3a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3895(realsolid=false) = [
...
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 112 14 0 0 0 4 0 -10 0 -6 0 0 box2-5.dat
  [1,16,112,14,0,0,0,4,0,-10,0,-6,0,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -112 14 0 0 0 -4 0 -10 0 6 0 0 box2-5.dat
  [1,16,-112,14,0,0,0,-4,0,-10,0,6,0,0, ldraw_lib__box2_5(realsolid)],
...
// 1 16 -100 10 6 8 0 0 0 0 8 0 -12 0 2-4cyli.dat
  [1,16,-100,10,6,8,0,0,0,0,8,0,-12,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 108 7 0 0 -1 0 -3 0 0 0 0 -6 rect2p.dat
  [1,16,108,7,0,0,-1,0,-3,0,0,0,0,-6, ldraw_lib__rect2p(realsolid)],
// 1 16 -108 7 0 0 1 0 -3 0 0 0 0 6 rect2p.dat
  [1,16,-108,7,0,0,1,0,-3,0,0,0,0,6, ldraw_lib__rect2p(realsolid)],
...
// 1 16 -100 10 -6 8 0 0 0 0 8 0 -1 0 2-4edge.dat
  [1,16,-100,10,-6,8,0,0,0,0,8,0,-1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 24 0 0 0 -120 0 -24 0 -10 0 0 box3u2p.dat
  [1,16,0,24,0,0,0,-120,0,-24,0,-10,0,0, ldraw_lib__box3u2p(realsolid)],
...
module ldraw_lib__3895(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3895(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3895(line=0.2);