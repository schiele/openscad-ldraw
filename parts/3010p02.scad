...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3010p02(realsolid=false) = [
...
// 1 16 0 24 0 40 0 0 0 -24 0 0 0 10 box4-1.dat
  [1,16,0,24,0,40,0,0,0,-24,0,0,0,10, ldraw_lib__box4_1(realsolid)],
...
module ldraw_lib__3010p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3010p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
