...
use <s/92244s04.scad>
use <s/92244s05.scad>
function ldraw_lib__92244p03() = [
// 0 Figure Friends Female Left Arm with Lavender Short Sleeve Pattern
// 0 Name: 92244p03.dat
...
// 1 31 0 0 0 1 0 0 0 1 0 0 0 1 s\92244s02.dat
  [1,31,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92244s02()],
...
module ldraw_lib__92244p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92244p03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__92244p03(line=0.2);