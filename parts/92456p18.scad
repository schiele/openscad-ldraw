...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink FTGpb064c01, Rebrickable 92456c01pr0067, set 41063
// 
// 0 !HISTORY 2017-12-30 [PTadmin] Official Update 2017-01
// 0 !HISTORY 2025-01-11 [OrionP] Moved from 92241p18c01.dat
...
module ldraw_lib__92456p18(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92456p18(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__92456p18(line=0.2);