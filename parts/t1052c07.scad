...
use <t1101.scad>
$fa=1; $fs=0.2;
function ldraw_lib__t1052c07(realsolid=false) = [
...
// 1 15 0 34 0 -1 0 0 0 1 0 0 0 -1 t1053p05.dat
  [1,15,0,34,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1053p05(realsolid)],
// 
// 0 // bottom contacts
...
// 1 47 0 29.5 0 1 0 0 0 1 0 0 0 1 t1101.dat
  [1,47,0,29.5,0,1,0,0,0,1,0,0,0,1, ldraw_lib__t1101(realsolid)],
// 
// 0 // Cover
// 1 47 0 29.5 0 1 0 0 0 1 0 0 0 1 t1100.dat
  [1,47,0,29.5,0,1,0,0,0,1,0,0,0,1, ldraw_lib__t1100(realsolid)],
];
module ldraw_lib__t1052c07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1052c07(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__t1052c07(line=0.2);