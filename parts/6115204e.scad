...
$fa=1; $fs=0.2;
function ldraw_lib__6115204e(realsolid=false) = [
...
// 1 73 0 -0.25 0 1 0 0 0 1 0 0 0 1 s\6115204ds01.dat
  [1,73,0,-0.25,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6115204ds01(realsolid)],
// 1 72 0 -0.25 0 1 0 0 0 1 0 0 0 1 s\6115204ds02.dat
  [1,72,0,-0.25,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6115204ds02(realsolid)],
];
module ldraw_lib__6115204e(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6115204e(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
