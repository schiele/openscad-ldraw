...
// 1 16 30 24 0 0 0 6 0 -4 0 -16 0 0 box5.dat
  [1,16,30,24,0,0,0,6,0,-4,0,-16,0,0, ldraw_lib__box5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -30 24 0 0 0 6 0 -4 0 -16 0 0 box5.dat
  [1,16,-30,24,0,0,0,6,0,-4,0,-16,0,0, ldraw_lib__box5()],
...
// 1 16 20 24 0 0 0 1.5 0 -4 0 -16 0 0 box5.dat
  [1,16,20,24,0,0,0,1.5,0,-4,0,-16,0,0, ldraw_lib__box5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -20 24 0 0 0 1.5 0 -4 0 -16 0 0 box5.dat
  [1,16,-20,24,0,0,0,1.5,0,-4,0,-16,0,0, ldraw_lib__box5()],
...
// 1 16 -30 20 0 0 0 1 0 -1 0 -1 0 0 stud3.dat
  [1,16,-30,20,0,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stud3()],
// 1 16 30 20 0 0 0 1 0 -1 0 -1 0 0 stud3.dat
  [1,16,30,20,0,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stud3()],
...
// 1 16 0 16 0 20 0 0 0 -16 0 0 0 20 box5-4a.dat
  [1,16,0,16,0,20,0,0,0,-16,0,0,0,20, ldraw_lib__box5_4a()],
// 1 16 0 24 0 40 0 0 0 -8 0 0 0 20 box4o4a.dat
  [1,16,0,24,0,40,0,0,0,-8,0,0,0,20, ldraw_lib__box4o4a()],
// 1 16 -30 16 0 10 0 0 0 1 0 0 0 20 rect.dat
  [1,16,-30,16,0,10,0,0,0,1,0,0,0,20, ldraw_lib__rect()],
// 1 16 30 16 0 -10 0 0 0 1 0 0 0 -20 rect.dat
  [1,16,30,16,0,-10,0,0,0,1,0,0,0,-20, ldraw_lib__rect()],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 connect.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__connect()],
...
// 1 16 30 16 -10 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,30,16,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__stud()],
// 1 16 30 16 10 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,30,16,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stud()],
// 1 16 -30 16 10 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-30,16,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stud()],
...
module ldraw_lib__30592(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30592(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
