...
use <../p/stud16.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6122(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\6122s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6122s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\6122s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__6122s01(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 4 -19.4 -12.6 0 -8 0 4 0 0 0 0 4 2-4cylo.dat
  [1,16,4,-19.4,-12.6,0,-8,0,4,0,0,0,0,4, ldraw_lib__2_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -16 9 2 0 0 0 -6 0 0 0 -2 4-4cylc.dat
  [1,16,0,-16,9,2,0,0,0,-6,0,0,0,-2, ldraw_lib__4_4cylc(realsolid)],
// 1 16 0 -22 9 4.1 0 0 0 1 0 0 0 4.1 4-4edge.dat
  [1,16,0,-22,9,4.1,0,0,0,1,0,0,0,4.1, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -22 9 0.205 0 0 0 1 0 0 0 0.205 4-4rin19.dat
  [1,16,0,-22,9,0.205,0,0,0,1,0,0,0,0.205, ldraw_lib__4_4rin19(realsolid)],
// 1 16 0 -22 9 2 0 0 0 1 0 0 0 2 4-4ring1.dat
  [1,16,0,-22,9,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4ring1(realsolid)],
// 1 16 0 -13 9 -4.1 0 0 0 -9 0 0 0 4.1 4-4cyli.dat
  [1,16,0,-13,9,-4.1,0,0,0,-9,0,0,0,4.1, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -7 0 8 0 0 0 -1 0 0 0 -8 4-4disc.dat
  [1,16,0,-7,0,8,0,0,0,-1,0,0,0,-8, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 -7 0 1 0 0 0 -1.75 0 0 0 1 stud16.dat
  [1,16,0,-7,0,1,0,0,0,-1.75,0,0,0,1, ldraw_lib__stud16(realsolid)],
// 0 //
...
module ldraw_lib__6122(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6122(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
