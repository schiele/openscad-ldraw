...
use <3787.scad>
$fa=1; $fs=0.2;
function ldraw_lib__121(realsolid=false) = [
// 0 ~Moved to 3787
// 0 Name: 121.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3787.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3787(realsolid)],
];
module ldraw_lib__121(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__121(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
