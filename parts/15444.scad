...
// 1 16 0 48 0 6 0 0 0 1 0 0 0 -6 recte4.dat
  [1,16,0,48,0,6,0,0,0,1,0,0,0,-6, ldraw_lib__recte4()],
// 1 16 0 26 6 0 0 6 22 0 0 0 1 0 rect2p.dat
  [1,16,0,26,6,0,0,6,22,0,0,0,1,0, ldraw_lib__rect2p()],
...
// 1 16 0 36 -6 -6 0 0 0 0 -12 0 -1 0 rect3.dat
  [1,16,0,36,-6,-6,0,0,0,0,-12,0,-1,0, ldraw_lib__rect3()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 18 -10 6 0 0 0 0 -6 0 4 0 box4o4a.dat
  [1,16,0,18,-10,6,0,0,0,0,-6,0,4,0, ldraw_lib__box4o4a()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 -6 0 0 0 -4 0 0 0 -6 box2-5.dat
  [1,16,0,8,0,-6,0,0,0,-4,0,0,0,-6, ldraw_lib__box2_5()],
// 1 16 0 24 -10 10 0 0 0 0 -24 0 20 0 box4t.dat
  [1,16,0,24,-10,10,0,0,0,0,-24,0,20,0, ldraw_lib__box4t()],
...
module ldraw_lib__15444(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__15444(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
