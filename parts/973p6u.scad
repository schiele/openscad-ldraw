...
use <s/973s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973p6u(realsolid=false) = [
...
// 1 16 0 0 -10 1 0 0 0 1 0 0 0 1 s\973p6ua.dat
  [1,16,0,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p6ua(realsolid)],
// 1 16 0 0 -10 -1 0 0 0 1 0 0 0 1 s\973p6ua.dat
  [1,16,0,0,-10,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p6ua(realsolid)],
];
module ldraw_lib__973p6u(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p6u(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
