...
use <../p/t08o6250.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3626cpm9(realsolid=false) = [
...
// 1 16 0 4 0 9.1924 0 9.1924 0 13 0 -9.1924 0 9.1924 1-8cyli.dat
  [1,16,0,4,0,9.1924,0,9.1924,0,13,0,-9.1924,0,9.1924, ldraw_lib__1_8cyli(realsolid)],
...
// 1 16 0 17 0 5.6569 0 5.6569 0 6.4 0 -5.6569 0 5.6569 t08o6250.dat
  [1,16,0,17,0,5.6569,0,5.6569,0,6.4,0,-5.6569,0,5.6569, ldraw_lib__t08o6250(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3626cpm9s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3626cpm9s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\3626cpm9s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3626cpm9s01(realsolid)],
];
module ldraw_lib__3626cpm9(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3626cpm9(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
