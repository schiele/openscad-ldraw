...
// 1 35 0 0 0 1 0 0 0 1 0 0 0 1 s\68495s02.dat
  [1,35,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__68495s02()],
];
module ldraw_lib__68495p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__68495p02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
