...
use <4352c01.scad>
use <4354.scad>
function ldraw_lib__73261_f2() = [
// 0 Electric 4.5V  3 C-Cell Battery Box Polarity Switch  2 x  4 (Lever tilted left)
// 0 Name: 73261-f2.dat
...
module ldraw_lib__73261_f2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73261_f2(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__73261_f2(line=0.2);