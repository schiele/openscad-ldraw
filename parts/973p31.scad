...
use <s/973s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973p31(realsolid=false) = [
// 0 Minifig Torso with Pirate Stripes Red/Cream Pattern
// 0 Name: 973p31.dat
...
module ldraw_lib__973p31(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p31(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
