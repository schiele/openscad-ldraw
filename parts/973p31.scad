...
use <../p/1-4cyli.scad>
use <s/973s01.scad>
function ldraw_lib__973p31() = [
// 0 Minifig Torso with Pirate Stripes Red/White Pattern
// 0 Name: 973p31.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 973p31, set 6285
// 
...
// 0 !HISTORY 2015-10-11 [OrionP] Fixed stripe color, added keywords
...
// 4 4 -17.878 22.5 -10 17.878 22.5 -10 17.104 18 -10 -17.104 18 -10
  [4,4,-17.878,22.5,-10,17.878,22.5,-10,17.104,18,-10,-17.104,18,-10],
// 
// 4 15 12.5 9 -10 11.5 4.5 -10 -11.5 4.5 -10 -12.5 9 -10
  [4,15,12.5,9,-10,11.5,4.5,-10,-11.5,4.5,-10,-12.5,9,-10],
// 4 15 17.104 18 -10 16.328 13.5 -10 -16.328 13.5 -10 -17.104 18 -10
  [4,15,17.104,18,-10,16.328,13.5,-10,-16.328,13.5,-10,-17.104,18,-10],
// 3 15 -17.878 22.5 -10 -18.483 26 -10 -6 26 -10
  [3,15,-17.878,22.5,-10,-18.483,26,-10,-6,26,-10],
// 3 15 6 26 -10 18.483 26 -10 17.878 22.5 -10
  [3,15,6,26,-10,18.483,26,-10,17.878,22.5,-10],
// 4 15 -17.878 22.5 -10 -6 26 -10 6 26 -10 17.878 22.5 -10
  [4,15,-17.878,22.5,-10,-6,26,-10,6,26,-10,17.878,22.5,-10],
// 
...
module ldraw_lib__973p31(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p31(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__973p31(line=0.2);