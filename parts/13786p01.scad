...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 13786pb01, Rebrickable 13786pr0001, set 10668, set 71002
// 
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\13786p01s01.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__13786p01s01()],
// 
// 0 // Chest Border
...
module ldraw_lib__13786p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__13786p01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
