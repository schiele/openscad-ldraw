...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__28598(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\28598s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__28598s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\28598s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__28598s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 stud2a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2a(realsolid)],
// 1 16 0 28 0 -1 0 0 0 -11 0 0 0 1 stud4a.dat
  [1,16,0,28,0,-1,0,0,0,-11,0,0,0,1, ldraw_lib__stud4a(realsolid)],
];
module ldraw_lib__28598(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__28598(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
