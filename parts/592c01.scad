...
use <u9021.scad>
$fa=1; $fs=0.2;
function ldraw_lib__592c01(realsolid=false) = [
...
// 1 494 0 0 0 1 0 0 0 1 0 0 0 1 u9018.dat
  [1,494,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9018(realsolid)],
// 1 494 0 -6 17 0.707107 0 -0.707107 0 1 0 0.707107 0 0.707107 u9021.dat
  [1,494,0,-6,17,0.707107,0,-0.707107,0,1,0,0.707107,0,0.707107, ldraw_lib__u9021(realsolid)],
];
module ldraw_lib__592c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__592c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
