...
use <../p/stug4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__54091(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\54091s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__54091s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\54091s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__54091s01(realsolid)],
...
// 1 16 50 24 70 0 0 1 0 1 0 -1 0 0 stud2.dat
  [1,16,50,24,70,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud2(realsolid)],
...
// 1 16 10 24 70 0 0 1 0 1 0 -1 0 0 stud2.dat
  [1,16,10,24,70,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud2(realsolid)],
// 1 16 -10 24 70 0 0 1 0 1 0 -1 0 0 stud2.dat
  [1,16,-10,24,70,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud2(realsolid)],
// 1 16 -30 24 70 0 0 1 0 1 0 -1 0 0 stud2.dat
  [1,16,-30,24,70,0,0,1,0,1,0,-1,0,0, ldraw_lib__stud2(realsolid)],
...
module ldraw_lib__54091(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__54091(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
