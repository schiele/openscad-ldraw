...
function ldraw_lib__164795b() = [
// 0 Sticker  2.9 x  3.7 with Arla Dairy Logo Right
// 0 Name: 164795b.dat
...
module ldraw_lib__164795b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__164795b(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__164795b(line=0.2);