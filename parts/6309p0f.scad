...
use <s/6309s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6309p0f(realsolid=false) = [
...
module ldraw_lib__6309p0f(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6309p0f(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6309p0f(line=0.2);