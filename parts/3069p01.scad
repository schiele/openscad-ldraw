...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3069bp01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3069bp01()],
];
module ldraw_lib__3069p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3069p01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
