...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3957a(realsolid=false) = [
...
// 1 16 0 -84 0 4 0 0 0 -4 0 0 0 4 4-8sphe.dat
  [1,16,0,-84,0,4,0,0,0,-4,0,0,0,4, ldraw_lib__4_8sphe(realsolid)],
...
// 1 16 0 4 0 3 0 0 0 -1 0 0 0 3 4-4ring1.dat
  [1,16,0,4,0,3,0,0,0,-1,0,0,0,3, ldraw_lib__4_4ring1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 3 0 0 0 4 0 0 0 3 4-4cylc.dat
  [1,16,0,0,0,3,0,0,0,4,0,0,0,3, ldraw_lib__4_4cylc(realsolid)],
...
// 1 16 0 -84 0 4 0 0 0 80 0 0 0 4 4-4cyli.dat
  [1,16,0,-84,0,4,0,0,0,80,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
];
module ldraw_lib__3957a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3957a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
