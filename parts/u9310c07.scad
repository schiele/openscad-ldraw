...
use <u9316.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9310c07(realsolid=false) = [
...
// 1 14 100 72 0 0 0 -1 0 1 0 1 0 0 3979.dat
  [1,14,100,72,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__3979(realsolid)],
// 1 14 100 72 120 0 0 -1 0 1 0 1 0 0 3979.dat
  [1,14,100,72,120,0,0,-1,0,1,0,1,0,0, ldraw_lib__3979(realsolid)],
...
module ldraw_lib__u9310c07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9310c07(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
