...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Rebrickable 4215apr0015, Set 7745
// 
...
module ldraw_lib__4215ap25(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4215ap25(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
