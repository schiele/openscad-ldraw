...
// 1 16 0 0 -10 1 0 0 0 1 0 0 0 1 joint8ball.dat
  [1,16,0,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__joint8ball()],
];
module ldraw_lib__22484(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__22484(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
