...
use <3005pua.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3005_ae(realsolid=false) = [
// 0 ~Moved to 3005pua
// 0 Name: 3005-ae.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3005pua.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3005pua(realsolid)],
];
module ldraw_lib__3005_ae(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3005_ae(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
