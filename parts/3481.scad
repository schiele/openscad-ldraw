...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3481(realsolid=false) = [
...
// 1 16 18 4 -10 0 0 -2 0 4 0 1 0 0 box4-4a.dat
  [1,16,18,4,-10,0,0,-2,0,4,0,1,0,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 18 4 10 0 0 -2 0 4 0 1 0 0 box4-4a.dat
  [1,16,18,4,10,0,0,-2,0,4,0,1,0,0, ldraw_lib__box4_4a(realsolid)],
...
// 1 16 36 -8 0 0 -1.6 0 4.5484 0 -1.884 -1.884 0 -4.5484 4-4edge.dat
  [1,16,36,-8,0,0,-1.6,0,4.5484,0,-1.884,-1.884,0,-4.5484, ldraw_lib__4_4edge(realsolid)],
// 1 16 36 -8 0 0 -1.6 0 7.3912 0 -3.0615 -3.0615 0 -7.3912 4-4edge.dat
  [1,16,36,-8,0,0,-1.6,0,7.3912,0,-3.0615,-3.0615,0,-7.3912, ldraw_lib__4_4edge(realsolid)],
// 1 16 39 -8 0 0 -1.6 0 7.3912 0 -3.0615 -3.0615 0 -7.3912 4-4edge.dat
  [1,16,39,-8,0,0,-1.6,0,7.3912,0,-3.0615,-3.0615,0,-7.3912, ldraw_lib__4_4edge(realsolid)],
// 1 16 39 -8 0 0 -3.2 0 7.3912 0 -3.0615 3.0615 0 7.3912 4-4cyli.dat
  [1,16,39,-8,0,0,-3.2,0,7.3912,0,-3.0615,3.0615,0,7.3912, ldraw_lib__4_4cyli(realsolid)],
// 1 16 39 -8 0 0 -1.6 0 6.8227 0 -2.826 -2.826 0 -6.8227 4-4edge.dat
  [1,16,39,-8,0,0,-1.6,0,6.8227,0,-2.826,-2.826,0,-6.8227, ldraw_lib__4_4edge(realsolid)],
// 1 16 39 -8 0 0 -1.6 0 -0.5686 0 0.2355 -0.2355 0 -0.5686 4-4rin12.dat
  [1,16,39,-8,0,0,-1.6,0,-0.5686,0,0.2355,-0.2355,0,-0.5686, ldraw_lib__4_4rin12(realsolid)],
// 1 16 36 -8 0 0 -1.6 0 1.2308 0 0 0 0 1.2308 connect4.dat
  [1,16,36,-8,0,0,-1.6,0,1.2308,0,0,0,0,1.2308, ldraw_lib__connect4(realsolid)],
// 0 // stud
...
module ldraw_lib__3481(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3481(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
