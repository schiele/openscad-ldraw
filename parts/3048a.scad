...
use <../p/triangle.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3048a(realsolid=false) = [
...
// 1 16 0 24 0 20 0 0 0 -4 0 0 0 10 box4o4a.dat
  [1,16,0,24,0,20,0,0,0,-4,0,0,0,10, ldraw_lib__box4o4a(realsolid)],
// 1 16 20 20 10 0 -1 -20 0 0 -20 -20 0 0 triangle.dat
  [1,16,20,20,10,0,-1,-20,0,0,-20,-20,0,0, ldraw_lib__triangle(realsolid)],
// 1 16 -20 20 10 0 1 20 0 0 -20 -20 0 0 triangle.dat
  [1,16,-20,20,10,0,1,20,0,0,-20,-20,0,0, ldraw_lib__triangle(realsolid)],
// 
// 0 BFC INVERTNEXT
...
// 1 16 0 24 0 16 0 0 0 -4 0 0 0 6 box4o4a.dat
  [1,16,0,24,0,16,0,0,0,-4,0,0,0,6, ldraw_lib__box4o4a(realsolid)],
// 1 16 16 20 6 0 1 -12 0 0 -12 -12 0 0 triangle.dat
  [1,16,16,20,6,0,1,-12,0,0,-12,-12,0,0, ldraw_lib__triangle(realsolid)],
// 1 16 -16 20 6 0 -1 12 0 0 -12 -12 0 0 triangle.dat
  [1,16,-16,20,6,0,-1,12,0,0,-12,-12,0,0, ldraw_lib__triangle(realsolid)],
// 
...
module ldraw_lib__3048a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3048a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
