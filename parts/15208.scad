...
use <../p/stug-1x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__15208(realsolid=false) = [
...
// 1 16 0 0 -4.5 0.63 0 0 0 1 0 0 0 0.55 s\49668s01.dat
  [1,16,0,0,-4.5,0.63,0,0,0,1,0,0,0,0.55, ldraw_lib__s__49668s01(realsolid)],
// 1 16 -13.7 0 -4.5 0.63 0 0 0 1 0 0 0 0.55 s\49668s01.dat
  [1,16,-13.7,0,-4.5,0.63,0,0,0,1,0,0,0,0.55, ldraw_lib__s__49668s01(realsolid)],
// 1 16 13.7 0 -4.5 0.63 0 0 0 1 0 0 0 0.55 s\49668s01.dat
  [1,16,13.7,0,-4.5,0.63,0,0,0,1,0,0,0,0.55, ldraw_lib__s__49668s01(realsolid)],
...
module ldraw_lib__15208(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__15208(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
