...
use <../p/1-4ring1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4107582b(realsolid=false) = [
...
// 1 0 12 -0.25 -6.5 0 0 1.5 0 1 0 -1.5 0 0 1-4ring1.dat
  [1,0,12,-0.25,-6.5,0,0,1.5,0,1,0,-1.5,0,0, ldraw_lib__1_4ring1(realsolid)],
// 1 0 12 -0.25 6.5 1.5 0 0 0 1 0 0 0 1.5 1-4ring1.dat
  [1,0,12,-0.25,6.5,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__1_4ring1(realsolid)],
// 1 0 -12 -0.25 -6.5 -1.5 0 0 0 1 0 0 0 -1.5 1-4ring1.dat
  [1,0,-12,-0.25,-6.5,-1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__1_4ring1(realsolid)],
// 1 0 -12 -0.25 6.5 0 0 -1.5 0 1 0 1.5 0 0 1-4ring1.dat
  [1,0,-12,-0.25,6.5,0,0,-1.5,0,1,0,1.5,0,0, ldraw_lib__1_4ring1(realsolid)],
...
// 1 7 -12 -0.25 -6.5 -1.5 0 0 0 1 0 0 0 -1.5 1-4chrd.dat
  [1,7,-12,-0.25,-6.5,-1.5,0,0,0,1,0,0,0,-1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 7 -12 -0.25 6.5 0 0 -1.5 0 1 0 1.5 0 0 1-4chrd.dat
  [1,7,-12,-0.25,6.5,0,0,-1.5,0,1,0,1.5,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 7 12 -0.25 -6.5 0 0 1.5 0 1 0 -1.5 0 0 1-4chrd.dat
  [1,7,12,-0.25,-6.5,0,0,1.5,0,1,0,-1.5,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 7 12 -0.25 6.5 1.5 0 0 0 1 0 0 0 1.5 1-4chrd.dat
  [1,7,12,-0.25,6.5,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 -12 0 6.5 -3 0 0 0 -0.25 0 0 0 3 1-4cyli.dat
  [1,16,-12,0,6.5,-3,0,0,0,-0.25,0,0,0,3, ldraw_lib__1_4cyli(realsolid)],
// 1 16 12 0 -6.5 3 0 0 0 -0.25 0 0 0 -3 1-4cyli.dat
  [1,16,12,0,-6.5,3,0,0,0,-0.25,0,0,0,-3, ldraw_lib__1_4cyli(realsolid)],
// 1 16 12 0 6.5 3 0 0 0 -0.25 0 0 0 3 1-4cyli.dat
  [1,16,12,0,6.5,3,0,0,0,-0.25,0,0,0,3, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 12 0 6.5 3 0 0 0 -1 0 0 0 3 1-4chrd.dat
  [1,16,12,0,6.5,3,0,0,0,-1,0,0,0,3, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -12 0 -6.5 -3 0 0 0 -1 0 0 0 -3 1-4chrd.dat
  [1,16,-12,0,-6.5,-3,0,0,0,-1,0,0,0,-3, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -12 0 6.5 -3 0 0 0 -1 0 0 0 3 1-4chrd.dat
  [1,16,-12,0,6.5,-3,0,0,0,-1,0,0,0,3, ldraw_lib__1_4chrd(realsolid)],
...
module ldraw_lib__4107582b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4107582b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
