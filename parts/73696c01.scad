...
use <73696.scad>
$fa=1; $fs=0.2;
function ldraw_lib__73696c01(realsolid=false) = [
// 0 Train Track 12V Slotted Point Left Manual (Straight)
// 0 Name: 73696c01.dat
...
module ldraw_lib__73696c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73696c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__73696c01(line=0.2);