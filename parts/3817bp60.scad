...
use <s/3817bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3817bp60(realsolid=false) = [
// 0 Minifig Leg Left with Insectoids Robot Pattern
// 0 Name: 3817bp60.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3817bp60s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3817bp60s01(realsolid)],
// 0 // Foot Front
...
module ldraw_lib__3817bp60(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3817bp60(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
