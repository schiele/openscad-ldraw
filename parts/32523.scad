...
use <s/32523s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32523(realsolid=false) = [
// 0 Technic Beam  3
// 0 Name: 32523.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\32523s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__32523s01(realsolid)],
// 4 16 9 10 20 9 -10 20 9 -10 -20 9 10 -20
  [4,16,9,10,20,9,-10,20,9,-10,-20,9,10,-20],
];
module ldraw_lib__32523(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32523(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
