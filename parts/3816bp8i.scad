...
use <s/3817bs02.scad>
use <s/3817bs03.scad>
function ldraw_lib__3816bp8i() = [
// 0 ~Minifig Leg Right with Reflective Stripe and Silver Triangles on Foot Pattern (Obsolete)
// 0 Name: 3816bp8i.dat
...
// 0 !HISTORY 2023-05-22 [Holly-Wood] Obsoleted due to bad geometry
...
module ldraw_lib__3816bp8i(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3816bp8i(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
