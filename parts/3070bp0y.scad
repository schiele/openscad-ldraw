...
use <s/3070bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3070bp0y(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 3070bpb153, Dots, Set 41916
// 
...
module ldraw_lib__3070bp0y(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3070bp0y(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
