...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3829a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3829a()],
// 1 0 0 -26.32 -0.24 0 0 1 -0.8 0.6 0 -0.6 -0.8 0 3828.dat
  [1,0,0,-26.32,-0.24,0,0,1,-0.8,0.6,0,-0.6,-0.8,0, ldraw_lib__3828()],
// 0
];
module ldraw_lib__3829c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3829c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
