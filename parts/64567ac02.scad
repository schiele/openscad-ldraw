...
use <30374.scad>
use <64567a.scad>
function ldraw_lib__64567ac02() = [
// 0 Minifig Lightsaber with Slight Sloping Fingers with Bottom Ring Chrome Silver - 2 Sides On
// 0 Name: 64567ac02.dat
...
// 0 !HISTORY 2021-03-10 [cwdee] Renamed from 577bc02
...
module ldraw_lib__64567ac02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__64567ac02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__64567ac02(line=0.2);