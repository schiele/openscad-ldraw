...
use <s/32627s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32627(realsolid=false) = [
...
// 1 16 0 0 0 40 0 0 0 1 0 0 0 40 48\4-4disc.dat
  [1,16,0,0,0,40,0,0,0,1,0,0,0,40, ldraw_lib__48__4_4disc(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\32627s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__32627s01(realsolid)],
];
module ldraw_lib__32627(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32627(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
