...
use <4146.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9523(realsolid=false) = [
// 0 ~Moved to 4146
// 0 Name: u9523.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 4146.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4146(realsolid)],
];
module ldraw_lib__u9523(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9523(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
