...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 32276c01.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32276c01()],
];
module ldraw_lib__76424(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76424(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
