...
$fa=1; $fs=0.2;
function ldraw_lib__4201639b(realsolid=false) = [
...
// 1 15 0 -0.25 0 0.6 0 0 0 1 0 0 0 0.6 s\4201639s01b.dat
  [1,15,0,-0.25,0,0.6,0,0,0,1,0,0,0,0.6, ldraw_lib__s__4201639s01b(realsolid)],
...
module ldraw_lib__4201639b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4201639b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
