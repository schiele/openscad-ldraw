...
$fa=1; $fs=0.2;
function ldraw_lib__11293(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\11293s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__11293s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\11293s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__11293s01(realsolid)],
// 
...
// 1 16 0 51.875 -95.147 0 0 1.5 0 -1 0 1.0935 0 0 rect2p.dat
  [1,16,0,51.875,-95.147,0,0,1.5,0,-1,0,1.0935,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 33.399 -78.9575 1.5 0 0 0 -1 18.476 0 0 -15.0955 rect.dat
  [1,16,0,33.399,-78.9575,1.5,0,0,0,-1,18.476,0,0,-15.0955, ldraw_lib__rect(realsolid)],
...
// 1 16 0 2.75 10 1 0 0 0 -1.3125 0 0 0 1 stug3-1x3.dat
  [1,16,0,2.75,10,1,0,0,0,-1.3125,0,0,0,1, ldraw_lib__stug3_1x3(realsolid)],
// 
...
module ldraw_lib__11293(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11293(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
