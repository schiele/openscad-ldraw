...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6190(realsolid=false) = [
// 0 Bar  1 x  3
// 0 Name: 6190.dat
...
// 1 16 -20 0 0 1 0 0 0 -2 0 0 0 -1 stud4a.dat
  [1,16,-20,0,0,1,0,0,0,-2,0,0,0,-1, ldraw_lib__stud4a(realsolid)],
// 
// 1 16 20 0 0 1 0 0 0 -2 0 0 0 -1 stud4a.dat
  [1,16,20,0,0,1,0,0,0,-2,0,0,0,-1, ldraw_lib__stud4a(realsolid)],
// 1 16 13 -4 0 0 -26 0 -4 0 0 0 0 -4 4-4cyli.dat
  [1,16,13,-4,0,0,-26,0,-4,0,0,0,0,-4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -20 0 0 -8 0 0 0 -4 0 0 0 8 2-4cyls.dat
  [1,16,-20,0,0,-8,0,0,0,-4,0,0,0,8, ldraw_lib__2_4cyls(realsolid)],
// 1 16 -20 0 0 -8 0 0 0 -4 0 0 0 -8 2-4cyls.dat
  [1,16,-20,0,0,-8,0,0,0,-4,0,0,0,-8, ldraw_lib__2_4cyls(realsolid)],
// 1 16 20 0 0 8 0 0 0 -4 0 0 0 -8 2-4cyls.dat
  [1,16,20,0,0,8,0,0,0,-4,0,0,0,-8, ldraw_lib__2_4cyls(realsolid)],
...
// 1 16 20 -4 0 8 0.559017 0 4 -1.11803 0 0 0 8 4-8sphe.dat
  [1,16,20,-4,0,8,0.559017,0,4,-1.11803,0,0,0,8, ldraw_lib__4_8sphe(realsolid)],
// 1 16 -20 -4 0 -8 -0.559017 0 4 -1.11803 0 0 0 -8 4-8sphe.dat
  [1,16,-20,-4,0,-8,-0.559017,0,4,-1.11803,0,0,0,-8, ldraw_lib__4_8sphe(realsolid)],
// 1 16 13 -4 0 0 0.5 0 4 0 0 0 0 4 1-4cyls.dat
  [1,16,13,-4,0,0,0.5,0,4,0,0,0,0,4, ldraw_lib__1_4cyls(realsolid)],
// 1 16 13 -4 0 0 0.5 0 -4 0 0 0 0 4 1-4cyls.dat
  [1,16,13,-4,0,0,0.5,0,-4,0,0,0,0,4, ldraw_lib__1_4cyls(realsolid)],
// 1 16 13 -4 0 0 0.5 0 -4 0 0 0 0 -4 1-4cyls.dat
  [1,16,13,-4,0,0,0.5,0,-4,0,0,0,0,-4, ldraw_lib__1_4cyls(realsolid)],
...
// 1 16 -20 0 0 -6 0 0 0 -1 0 0 0 6 4-4disc.dat
  [1,16,-20,0,0,-6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4disc(realsolid)],
// 1 16 20 0 0 -6 0 0 0 -1 0 0 0 6 4-4disc.dat
  [1,16,20,0,0,-6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4disc(realsolid)],
...
module ldraw_lib__6190(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6190(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
