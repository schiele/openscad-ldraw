...
use <../p/t04q4000.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4083(realsolid=false) = [
...
// 1 16 30 44 0 1 0 0 0 -1 0 0 0 1 stud4a.dat
  [1,16,30,44,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 -30 44 0 1 0 0 0 -1 0 0 0 1 stud4a.dat
  [1,16,-30,44,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 30 44 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,30,44,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 -30 44 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-30,44,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 30 44 0 6 0 0 0 -1 0 0 0 6 4-4disc.dat
  [1,16,30,44,0,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4disc(realsolid)],
// 1 16 -30 44 0 6 0 0 0 -1 0 0 0 6 4-4disc.dat
  [1,16,-30,44,0,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4disc(realsolid)],
// 1 16 30 40 0 8 0 0 0 4 0 0 0 8 4-4cyli.dat
  [1,16,30,40,0,8,0,0,0,4,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -30 40 0 8 0 0 0 4 0 0 0 8 4-4cyli.dat
  [1,16,-30,40,0,8,0,0,0,4,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
// 1 16 30 40 0 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,30,40,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge(realsolid)],
// 1 16 -30 40 0 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,-30,40,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge(realsolid)],
// 1 16 30 40 0 8 0 0 0 1 0 0 0 8 4-4disc.dat
  [1,16,30,40,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4disc(realsolid)],
// 1 16 -30 40 0 8 0 0 0 1 0 0 0 8 4-4disc.dat
  [1,16,-30,40,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4disc(realsolid)],
// 
// 1 16 30 40 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,30,40,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 -30 40 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,-30,40,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 20 14 0 10 0 0 0 0 -10 0 10 0 t04q4000.dat
  [1,16,20,14,0,10,0,0,0,0,-10,0,10,0, ldraw_lib__t04q4000(realsolid)],
// 1 16 -20 14 0 -10 0 0 0 0 -10 0 10 0 t04q4000.dat
  [1,16,-20,14,0,-10,0,0,0,0,-10,0,10,0, ldraw_lib__t04q4000(realsolid)],
// 1 16 30 14 0 4 0 0 0 26 0 0 0 4 4-4cyli.dat
  [1,16,30,14,0,4,0,0,0,26,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -30 14 0 4 0 0 0 26 0 0 0 4 4-4cyli.dat
  [1,16,-30,14,0,4,0,0,0,26,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 
// 1 16 20 4 0 0 -4 0 4 0 0 0 0 4 4-4cyli.dat
  [1,16,20,4,0,0,-4,0,4,0,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -20 4 0 0 4 0 4 0 0 0 0 4 4-4cyli.dat
  [1,16,-20,4,0,0,4,0,4,0,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 4 4 0 0 -8 0 4 0 0 0 0 4 4-4cyli.dat
  [1,16,4,4,0,0,-8,0,4,0,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 16 4 0 0 1 0 0 0 -1 -1 0 0 cylj4x6.dat
  [1,16,16,4,0,0,1,0,0,0,-1,-1,0,0, ldraw_lib__cylj4x6(realsolid)],
// 1 16 4 4 0 0 -1 0 0 0 -1 1 0 0 cylj4x6.dat
  [1,16,4,4,0,0,-1,0,0,0,-1,1,0,0, ldraw_lib__cylj4x6(realsolid)],
// 1 16 -16 4 0 0 -1 0 0 0 -1 1 0 0 cylj4x6.dat
  [1,16,-16,4,0,0,-1,0,0,0,-1,1,0,0, ldraw_lib__cylj4x6(realsolid)],
// 1 16 -4 4 0 0 1 0 0 0 -1 -1 0 0 cylj4x6.dat
  [1,16,-4,4,0,0,1,0,0,0,-1,-1,0,0, ldraw_lib__cylj4x6(realsolid)],
...
// 1 16 30 36 0 0 -60 0 4 0 0 0 0 4 4-4cyli.dat
  [1,16,30,36,0,0,-60,0,4,0,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 30 36 0 0 0 -4 0 1 4 4 0 0 2-4edge.dat
  [1,16,30,36,0,0,0,-4,0,1,4,4,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -30 36 0 0 0 4 0 1 4 4 0 0 2-4edge.dat
  [1,16,-30,36,0,0,0,4,0,1,4,4,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 30 36 0 0 0 -4 0 1 -4 4 0 0 2-4edge.dat
  [1,16,30,36,0,0,0,-4,0,1,-4,4,0,0, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 -10 8 0 4 0 0 0 -1 0 0 0 -4 4-4edge.dat
  [1,16,-10,8,0,4,0,0,0,-1,0,0,0,-4, ldraw_lib__4_4edge(realsolid)],
// 1 16 -10 8 0 6 0 0 0 -1 0 0 0 -6 4-4edge.dat
  [1,16,-10,8,0,6,0,0,0,-1,0,0,0,-6, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -10 8 0 4 0 0 0 -8 0 0 0 -4 4-4cyli.dat
  [1,16,-10,8,0,4,0,0,0,-8,0,0,0,-4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -10 8 0 6 0 0 0 -8 0 0 0 -6 4-4cyli.dat
  [1,16,-10,8,0,6,0,0,0,-8,0,0,0,-6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -10 8 0 2 0 0 0 -1 0 0 0 -2 4-4ring2.dat
  [1,16,-10,8,0,2,0,0,0,-1,0,0,0,-2, ldraw_lib__4_4ring2(realsolid)],
// 1 16 10 8 0 4 0 0 0 -1 0 0 0 -4 4-4edge.dat
  [1,16,10,8,0,4,0,0,0,-1,0,0,0,-4, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 8 0 6 0 0 0 -1 0 0 0 -6 4-4edge.dat
  [1,16,10,8,0,6,0,0,0,-1,0,0,0,-6, ldraw_lib__4_4edge(realsolid)],
...
module ldraw_lib__4083(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4083(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
