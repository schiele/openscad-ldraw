...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__t1090(realsolid=false) = [
...
// 1 16 15 -4.5 0 0 -1 0 4.5 0 0 0 0 12.5 rect.dat
  [1,16,15,-4.5,0,0,-1,0,4.5,0,0,0,0,12.5, ldraw_lib__rect(realsolid)],
// 1 16 13.75 -4.5 -13.75 0 -1 -1.25 -4.5 0 0 0 0 -1.25 rect3.dat
  [1,16,13.75,-4.5,-13.75,0,-1,-1.25,-4.5,0,0,0,0,-1.25, ldraw_lib__rect3(realsolid)],
// 1 16 0 -4.5 -15 0 0 -12.5 -4.5 0 0 0 1 0 rect3.dat
  [1,16,0,-4.5,-15,0,0,-12.5,-4.5,0,0,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 -13.75 -4.5 -13.75 0 1 -1.25 -4.5 0 0 0 0 1.25 rect3.dat
  [1,16,-13.75,-4.5,-13.75,0,1,-1.25,-4.5,0,0,0,0,1.25, ldraw_lib__rect3(realsolid)],
// 1 16 -15 -4.5 0 0 1 0 -4.5 0 0 0 0 12.5 rect3.dat
  [1,16,-15,-4.5,0,0,1,0,-4.5,0,0,0,0,12.5, ldraw_lib__rect3(realsolid)],
// 1 16 -13.75 -4.5 13.75 0 1 1.25 -4.5 0 0 0 0 1.25 rect3.dat
  [1,16,-13.75,-4.5,13.75,0,1,1.25,-4.5,0,0,0,0,1.25, ldraw_lib__rect3(realsolid)],
// 1 16 0 -4.5 15 0 0 12.5 -4.5 0 0 0 -1 0 rect3.dat
  [1,16,0,-4.5,15,0,0,12.5,-4.5,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 13.75 -4.5 13.75 -1.25 -1 0 0 0 -4.5 1.25 0 0 rect2p.dat
  [1,16,13.75,-4.5,13.75,-1.25,-1,0,0,0,-4.5,1.25,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 -11 0 9 0 0 0 2 0 0 0 9 4-4cylc.dat
  [1,16,0,-11,0,9,0,0,0,2,0,0,0,9, ldraw_lib__4_4cylc(realsolid)],
// 1 16 0 -11 0 4 0 0 0 -3 0 0 0 4 box4.dat
  [1,16,0,-11,0,4,0,0,0,-3,0,0,0,4, ldraw_lib__box4(realsolid)],
// 1 16 0 -16 0 5 0 0 0 -2 0 0 0 5 box.dat
  [1,16,0,-16,0,5,0,0,0,-2,0,0,0,5, ldraw_lib__box(realsolid)],
// 4 494 -12.5 -9 15 -12.5 -9 -15 12.5 -9 -15 12.5 -9 15
  [4,494,-12.5,-9,15,-12.5,-9,-15,12.5,-9,-15,12.5,-9,15],
// 1 16 10 -10 -10 0 0 -2 0 1 0 2 0 0 4-4cylc.dat
  [1,16,10,-10,-10,0,0,-2,0,1,0,2,0,0, ldraw_lib__4_4cylc(realsolid)],
// 1 16 -10 -10 -10 2 0 0 0 1 0 0 0 2 4-4cylc.dat
  [1,16,-10,-10,-10,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4cylc(realsolid)],
// 1 16 -10 -10 10 0 0 2 0 1 0 -2 0 0 4-4cylc.dat
  [1,16,-10,-10,10,0,0,2,0,1,0,-2,0,0, ldraw_lib__4_4cylc(realsolid)],
// 1 16 10 -10 10 -2 0 0 0 1 0 0 0 -2 4-4cylc.dat
  [1,16,10,-10,10,-2,0,0,0,1,0,0,0,-2, ldraw_lib__4_4cylc(realsolid)],
...
module ldraw_lib__t1090(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1090(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
