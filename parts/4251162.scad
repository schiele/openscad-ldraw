...
use <50950.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4251162(realsolid=false) = [
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 50950.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__50950(realsolid)],
];
module ldraw_lib__4251162(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4251162(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
