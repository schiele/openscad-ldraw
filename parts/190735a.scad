...
use <s/4215as19.scad>
$fa=1; $fs=0.2;
function ldraw_lib__190735a(realsolid=false) = [
...
// 
// 
// 1 16 0 -0.25 0 0.75 0 0 0 1 0 0 0 0.75 48\4-4rin16.dat
  [1,16,0,-0.25,0,0.75,0,0,0,1,0,0,0,0.75, ldraw_lib__48__4_4rin16(realsolid)],
// 1 16 0 -0.25 0 0 0 0.4 0 1 0 -0.4 0 0 s\4215as19.dat
  [1,16,0,-0.25,0,0,0,0.4,0,1,0,-0.4,0,0, ldraw_lib__s__4215as19(realsolid)],
// 1 16 0 -0.25 0 0.34641 0 0.2 0 1 0 -0.2 0 0.34641 s\4215as19.dat
  [1,16,0,-0.25,0,0.34641,0,0.2,0,1,0,-0.2,0,0.34641, ldraw_lib__s__4215as19(realsolid)],
// 1 16 0 -0.25 0 0.34641 0 -0.2 0 1 0 0.2 0 0.34641 s\4215as19.dat
  [1,16,0,-0.25,0,0.34641,0,-0.2,0,1,0,0.2,0,0.34641, ldraw_lib__s__4215as19(realsolid)],
// 1 16 0 -0.25 0 0 0 -0.4 0 1 0 0.4 0 0 s\4215as19.dat
  [1,16,0,-0.25,0,0,0,-0.4,0,1,0,0.4,0,0, ldraw_lib__s__4215as19(realsolid)],
...
// 1 16 0 0 0 12.75 0 0 0 -1 0 0 0 -12.75 48\4-4disc.dat
  [1,16,0,0,0,12.75,0,0,0,-1,0,0,0,-12.75, ldraw_lib__48__4_4disc(realsolid)],
// 1 16 0 0 0 12.75 0 0 0 -0.25 0 0 0 12.75 48\4-4cyli.dat
  [1,16,0,0,0,12.75,0,0,0,-0.25,0,0,0,12.75, ldraw_lib__48__4_4cyli(realsolid)],
];
module ldraw_lib__190735a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__190735a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
