...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\004452cs01.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__004452cs01()],
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\004452cs02.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__004452cs02()],
];
module ldraw_lib__004659g(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__004659g(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
