...
use <s/4209p70a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3004p70(realsolid=false) = [
...
// 1 16 0 13 -10 0.75 0 0 0 0.75 0 0 0 1 s\4209p70a.dat
  [1,16,0,13,-10,0.75,0,0,0,0.75,0,0,0,1, ldraw_lib__s__4209p70a(realsolid)],
// 
...
module ldraw_lib__3004p70(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3004p70(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3004p70(line=0.2);