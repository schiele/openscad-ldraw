...
// 1 16 0 10.5455 0 3.625 0 0 0 -10.5455 0 0 0 3.625 4-4con4.dat
  [1,16,0,10.5455,0,3.625,0,0,0,-10.5455,0,0,0,3.625, ldraw_lib__4_4con4()],
// 1 16 0 12.3636 0 0.625 0 0 0 -1.8182 0 0 0 0.625 4-4con29.dat
  [1,16,0,12.3636,0,0.625,0,0,0,-1.8182,0,0,0,0.625, ldraw_lib__4_4con29()],
// 1 16 0 16 0 1.25 0 0 0 -3.6364 0 0 0 1.25 4-4con15.dat
  [1,16,0,16,0,1.25,0,0,0,-3.6364,0,0,0,1.25, ldraw_lib__4_4con15()],
];
module ldraw_lib__98100(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98100(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
