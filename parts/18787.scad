...
use <s/18787s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__18787(realsolid=false) = [
...
// 1 16 2 13.045 0 0 .25 0 2.56326 0 2.56326 -2.56326 0 2.56326 box5.dat
  [1,16,2,13.045,0,0,.25,0,2.56326,0,2.56326,-2.56326,0,2.56326, ldraw_lib__box5(realsolid)],
// 1 16 0 -6.75 0 0 0 -4 0 1 0 4 0 0 4-4disc.dat
  [1,16,0,-6.75,0,0,0,-4,0,1,0,4,0,0, ldraw_lib__4_4disc(realsolid)],
// 
// 1 16 0 -6.75 0 0 0 -1 -0.707107 0.707107 0 0.707107 0.707107 0 s\18787s02.dat
  [1,16,0,-6.75,0,0,0,-1,-0.707107,0.707107,0,0.707107,0.707107,0, ldraw_lib__s__18787s02(realsolid)],
// 1 16 0 -6.75 0 0 0 1 -0.707107 0.707107 0 -0.707107 -0.707107 0 s\18787s02.dat
  [1,16,0,-6.75,0,0,0,1,-0.707107,0.707107,0,-0.707107,-0.707107,0, ldraw_lib__s__18787s02(realsolid)],
];
module ldraw_lib__18787(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__18787(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
