...
// 1 0 0 -0.25 0 1.7 0 0 0 0 1 0 1.7 0 s\4865p01c.dat
  [1,0,0,-0.25,0,1.7,0,0,0,0,1,0,1.7,0, ldraw_lib__s__4865p01c()],
// 
...
module ldraw_lib__164575f(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__164575f(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
