...
use <s/32294s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32294(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\32294s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__32294s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\32294s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__32294s01(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -12 80 0 0 6 0 -16 0 6 0 0 4-4cyli.dat
  [1,16,0,-12,80,0,0,6,0,-16,0,6,0,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 18 -60 0 0 6 0 -6 0 6 0 0 4-4cyli.dat
  [1,16,0,18,-60,0,0,6,0,-6,0,6,0,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 20 -60 -1 0 0 0 -1 0 0 0 1 peghole.dat
  [1,16,0,20,-60,-1,0,0,0,-1,0,0,0,1, ldraw_lib__peghole(realsolid)],
// 1 16 0 10 -80 -9 0 0 0 10 0 0 0 -9 2-4cyli.dat
  [1,16,0,10,-80,-9,0,0,0,10,0,0,0,-9, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 15 -80 1 0 0 0 1 0 0 0 1 beamhol2.dat
  [1,16,0,15,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__beamhol2(realsolid)],
...
// 1 16 0 20 -80 -9 0 0 0 1 0 0 0 -9 2-4edge.dat
  [1,16,0,20,-80,-9,0,0,0,1,0,0,0,-9, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -10 80 -3.44 0 -8.31 0 -20 0 -8.31 0 3.44 7-8cyli.dat
  [1,16,0,-10,80,-3.44,0,-8.31,0,-20,0,-8.31,0,3.44, ldraw_lib__7_8cyli(realsolid)],
// 1 16 0 -10 80 -3.44 0 -8.31 0 -1 0 -8.31 0 3.44 7-8edge.dat
  [1,16,0,-10,80,-3.44,0,-8.31,0,-1,0,-8.31,0,3.44, ldraw_lib__7_8edge(realsolid)],
// 1 16 0 -30 80 -3.44 0 -8.31 0 -1 0 -8.31 0 3.44 7-8edge.dat
  [1,16,0,-30,80,-3.44,0,-8.31,0,-1,0,-8.31,0,3.44, ldraw_lib__7_8edge(realsolid)],
...
// 1 16 0 20 -60 1 0 0 0 -1 0 0 0 1 4-4ring8.dat
  [1,16,0,20,-60,1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4ring8(realsolid)],
// 1 16 0 -30 80 1 0 0 0 1 0 0 0 1 peghole.dat
  [1,16,0,-30,80,1,0,0,0,1,0,0,0,1, ldraw_lib__peghole(realsolid)],
...
// 1 16 0 -30 80 1 0 0 0 1 0 0 0 1 4-4ring8.dat
  [1,16,0,-30,80,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4ring8(realsolid)],
// 1 16 0 -10 80 1 0 0 0 -1 0 0 0 1 4-4ring8.dat
  [1,16,0,-10,80,1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4ring8(realsolid)],
// 0
];
module ldraw_lib__32294(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32294(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__32294(line=0.2);