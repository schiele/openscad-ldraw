...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6112(realsolid=false) = [
// 0 Brick  1 x 12
// 0 Name: 6112.dat
...
// 1 16 100 4 0 1 0 0 0 -5 0 0 0 1 stud3.dat
  [1,16,100,4,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud3(realsolid)],
// 1 16 80 4 0 1 0 0 0 -5 0 0 0 1 stud3.dat
  [1,16,80,4,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud3(realsolid)],
// 1 16 60 4 0 1 0 0 0 -5 0 0 0 1 stud3.dat
  [1,16,60,4,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud3(realsolid)],
// 1 16 40 4 0 1 0 0 0 -5 0 0 0 1 stud3.dat
  [1,16,40,4,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud3(realsolid)],
...
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 24 0 116 0 0 0 -20 0 0 0 6 box5.dat
  [1,16,0,24,0,116,0,0,0,-20,0,0,0,6, ldraw_lib__box5(realsolid)],
// 
...
// 4 16 120 24 -10 116 24 -6 116 24 6 120 24 10
  [4,16,120,24,-10,116,24,-6,116,24,6,120,24,10],
// 
// 1 16 0 24 0 120 0 0 0 -24 0 0 0 10 box5.dat
  [1,16,0,24,0,120,0,0,0,-24,0,0,0,10, ldraw_lib__box5(realsolid)],
// 
...
module ldraw_lib__6112(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6112(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6112(line=0.2);