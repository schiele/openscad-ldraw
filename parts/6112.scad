...
// 1 16 0 24 0 116 0 0 0 -20 0 0 0 6 box5.dat
  [1,16,0,24,0,116,0,0,0,-20,0,0,0,6, ldraw_lib__box5()],
// 
...
// 1 16 0 24 0 120 0 0 0 -24 0 0 0 10 box5.dat
  [1,16,0,24,0,120,0,0,0,-24,0,0,0,10, ldraw_lib__box5()],
// 
...
module ldraw_lib__6112(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6112(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
