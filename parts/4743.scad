...
use <../p/stug2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4743(realsolid=false) = [
// 0 Arch  2 x  8 x  3
// 0 Name: 4743.dat
...
// 1 16 60 4 0 1 0 0 0 -17 0 0 0 1 stud4.dat
  [1,16,60,4,0,1,0,0,0,-17,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -60 4 0 1 0 0 0 -17 0 0 0 1 stud4.dat
  [1,16,-60,4,0,1,0,0,0,-17,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
// 1 16 60 72 0 16 0 0 0 -68 0 0 0 16 box5.dat
  [1,16,60,72,0,16,0,0,0,-68,0,0,0,16, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -60 72 0 16 0 0 0 -68 0 0 0 16 box5.dat
  [1,16,-60,72,0,16,0,0,0,-68,0,0,0,16, ldraw_lib__box5(realsolid)],
...
// 1 16 20 44 20 20 0 0 0 0 -20 0 1 0 1-4edge.dat
  [1,16,20,44,20,20,0,0,0,0,-20,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -20 44 20 -20 0 0 0 0 -20 0 1 0 1-4edge.dat
  [1,16,-20,44,20,-20,0,0,0,0,-20,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 20 44 -20 20 0 0 0 0 -20 0 1 0 1-4edge.dat
  [1,16,20,44,-20,20,0,0,0,0,-20,0,1,0, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 20 44 16 20 0 0 0 0 -20 0 1 0 1-4edge.dat
  [1,16,20,44,16,20,0,0,0,0,-20,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -20 44 16 -20 0 0 0 0 -20 0 1 0 1-4edge.dat
  [1,16,-20,44,16,-20,0,0,0,0,-20,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 20 44 -16 20 0 0 0 0 -20 0 1 0 1-4edge.dat
  [1,16,20,44,-16,20,0,0,0,0,-20,0,1,0, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 -30 14 0 0 0 10 0 -10 0 -16 0 0 box2-5.dat
  [1,16,-30,14,0,0,0,10,0,-10,0,-16,0,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 30 14 0 0 0 -10 0 -10 0 16 0 0 box2-5.dat
  [1,16,30,14,0,0,0,-10,0,-10,0,16,0,0, ldraw_lib__box2_5(realsolid)],
...
// 1 16 0 72 0 0 0 80 0 -72 0 20 0 0 box3u2p.dat
  [1,16,0,72,0,0,0,80,0,-72,0,20,0,0, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 20 44 20 20 0 0 0 0 -20 0 -4 0 1-4cyli.dat
  [1,16,20,44,20,20,0,0,0,0,-20,0,-4,0, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -20 44 20 -20 0 0 0 0 -20 0 -4 0 1-4cyli.dat
  [1,16,-20,44,20,-20,0,0,0,0,-20,0,-4,0, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 -40 58 0 0 -1 0 0 0 14 20 0 0 rect3.dat
  [1,16,-40,58,0,0,-1,0,0,0,14,20,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 40 58 0 0 1 0 0 0 14 20 0 0 rect3.dat
  [1,16,40,58,0,0,1,0,0,0,14,20,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 -40 24 0 0 -1 0 20 0 0 0 0 -16 rect2p.dat
  [1,16,-40,24,0,0,-1,0,20,0,0,0,0,-16, ldraw_lib__rect2p(realsolid)],
// 1 16 40 24 0 0 1 0 20 0 0 0 0 -16 rect2p.dat
  [1,16,40,24,0,0,1,0,20,0,0,0,0,-16, ldraw_lib__rect2p(realsolid)],
...
// 1 16 20 44 20 20 0 0 0 0 -20 0 -1 0 1-4ndis.dat
  [1,16,20,44,20,20,0,0,0,0,-20,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -20 44 20 -20 0 0 0 0 -20 0 -1 0 1-4ndis.dat
  [1,16,-20,44,20,-20,0,0,0,0,-20,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 20 44 16 20 0 0 0 0 -20 0 1 0 1-4ndis.dat
  [1,16,20,44,16,20,0,0,0,0,-20,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -20 44 16 -20 0 0 0 0 -20 0 1 0 1-4ndis.dat
  [1,16,-20,44,16,-20,0,0,0,0,-20,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 4 16 20 24 -16 20 4 -16 40 4 -16 40 24 -16
  [4,16,20,24,-16,20,4,-16,40,4,-16,40,24,-16],
...
// 1 16 71.901 4 0 4.099 0 0 0 60 0 0 0 1 box3u8p.dat
  [1,16,71.901,4,0,4.099,0,0,0,60,0,0,0,1, ldraw_lib__box3u8p(realsolid)],
...
// 1 16 48.099 4 0 -4.099 0 0 0 60 0 0 0 -1 box3u8p.dat
  [1,16,48.099,4,0,-4.099,0,0,0,60,0,0,0,-1, ldraw_lib__box3u8p(realsolid)],
...
module ldraw_lib__4743(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4743(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
