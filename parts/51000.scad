...
use <../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__51000(realsolid=false) = [
...
// 1 16 0 60 10 2 0 0 0 0 32 0 1 0 rect.dat
  [1,16,0,60,10,2,0,0,0,0,32,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 60 110 2 0 0 0 0 20 0 -1 0 rect.dat
  [1,16,0,60,110,2,0,0,0,0,20,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 10 20 2 0 0 0 10 10 0 10 -10 rect.dat
  [1,16,0,10,20,2,0,0,0,10,10,0,10,-10, ldraw_lib__rect(realsolid)],
// 1 16 0 110 20 2 0 0 0 -10 10 0 10 10 rect.dat
  [1,16,0,110,20,2,0,0,0,-10,10,0,10,10, ldraw_lib__rect(realsolid)],
// 1 16 0 20 70 0 0 2 20 20 0 40 -40 0 rect2p.dat
  [1,16,0,20,70,0,0,2,20,20,0,40,-40,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 100 70 0 0 2 -20 -20 0 40 -40 0 rect2p.dat
  [1,16,0,100,70,0,0,2,-20,-20,0,40,-40,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 24 0 1 0 0 0 1 0 0 0 1 clip1.dat
  [1,16,0,24,0,1,0,0,0,1,0,0,0,1, ldraw_lib__clip1(realsolid)],
// 1 16 0 96 0 1 0 0 0 1 0 0 0 1 clip1.dat
  [1,16,0,96,0,1,0,0,0,1,0,0,0,1, ldraw_lib__clip1(realsolid)],
// 
...
module ldraw_lib__51000(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__51000(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
