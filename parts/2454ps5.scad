...
use <2454aps5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2454ps5(realsolid=false) = [
// 0 ~Moved to 2454aps5
// 0 Name: 2454ps5.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2454aps5.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2454aps5(realsolid)],
];
module ldraw_lib__2454ps5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2454ps5(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
