...
function ldraw_lib__4121723a() = [
// 0 Sticker  3.3 x  5.5 with Extended Corner, Octan Logo and White "DIESEL POWER" on Red Background - Right Aligned
// 0 Name: 4121723a.dat
...
module ldraw_lib__4121723a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4121723a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4121723a(line=0.2);