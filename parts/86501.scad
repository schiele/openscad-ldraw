...
use <s/86501s04.scad>
$fa=1; $fs=0.2;
function ldraw_lib__86501(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\86501s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__86501s01(realsolid)],
// 1 16 0 0 -160 1 0 0 0 1 0 0 0 1 s\86501s04.dat
  [1,16,0,0,-160,1,0,0,0,1,0,0,0,1, ldraw_lib__s__86501s04(realsolid)],
// 1 16 0 0 -160 1 0 0 0 1 0 0 0 1 s\86501s02.dat
  [1,16,0,0,-160,1,0,0,0,1,0,0,0,1, ldraw_lib__s__86501s02(realsolid)],
// 1 16 180 0 180 0 0 1 0 1 0 -1 0 0 s\86501s03.dat
  [1,16,180,0,180,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__86501s03(realsolid)],
// 1 16 -180 0 180 0 0 -1 0 1 0 -1 0 0 s\86501s03.dat
  [1,16,-180,0,180,0,0,-1,0,1,0,-1,0,0, ldraw_lib__s__86501s03(realsolid)],
];
module ldraw_lib__86501(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__86501(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
