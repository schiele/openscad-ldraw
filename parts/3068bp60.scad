...
use <s/3068bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3068bp60(realsolid=false) = [
...
// 1 16 0 0 -0.752 1.143 0 0 0 0 1.143 0 -1.143 0 s\3004s60.dat
  [1,16,0,0,-0.752,1.143,0,0,0,0,1.143,0,-1.143,0, ldraw_lib__s__3004s60(realsolid)],
...
module ldraw_lib__3068bp60(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068bp60(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
