...
use <../p/stud2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__59900(realsolid=false) = [
...
// 1 16 0 19 0 8 0 0 0 5 0 0 0 8 4-4cylo.dat
  [1,16,0,19,0,8,0,0,0,5,0,0,0,8, ldraw_lib__4_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 18 0 0 0 -1 0 -1 0 -1 0 0 axl3ho10.dat
  [1,16,0,18,0,0,0,-1,0,-1,0,-1,0,0, ldraw_lib__axl3ho10(realsolid)],
// 1 16 0 18 0 0 0 -1 0 -1 0 -1 0 0 axl3hol9.dat
  [1,16,0,18,0,0,0,-1,0,-1,0,-1,0,0, ldraw_lib__axl3hol9(realsolid)],
// 1 16 0 8 0 1 0 0 0 10 0 0 0 1 axl3hol8.dat
  [1,16,0,8,0,1,0,0,0,10,0,0,0,1, ldraw_lib__axl3hol8(realsolid)],
// 1 16 0 8 0 1 0 0 0 1 0 0 0 1 axl3hol2.dat
  [1,16,0,8,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl3hol2(realsolid)],
// 1 16 0 8 0 0 0 -1 0 -1 0 -1 0 0 axl3hol9.dat
  [1,16,0,8,0,0,0,-1,0,-1,0,-1,0,0, ldraw_lib__axl3hol9(realsolid)],
// 1 16 0 8 0 1 0 0 0 1 0 0 0 1 axl3ho10.dat
  [1,16,0,8,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl3ho10(realsolid)],
...
// 1 16 0 0 0 0.5 0 0 0 1 0 0 0 0.5 4-4rin12.dat
  [1,16,0,0,0,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4rin12(realsolid)],
...
// 1 16 0 19 0 -2 0 0 0 -10.5 0 0 0 2 4-4con4.dat
  [1,16,0,19,0,-2,0,0,0,-10.5,0,0,0,2, ldraw_lib__4_4con4(realsolid)],
// 1 16 0 8.5 0 -1 0 0 0 -5.5 0 0 0 1 4-4con7.dat
  [1,16,0,8.5,0,-1,0,0,0,-5.5,0,0,0,1, ldraw_lib__4_4con7(realsolid)],
// 1 16 0 3 0 -0.5 0 0 0 -3 0 0 0 0.5 4-4con13.dat
  [1,16,0,3,0,-0.5,0,0,0,-3,0,0,0,0.5, ldraw_lib__4_4con13(realsolid)],
];
module ldraw_lib__59900(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__59900(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
