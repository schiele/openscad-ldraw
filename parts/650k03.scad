...
use <../p/box4o8a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__650k03(realsolid=false) = [
...
// 1 16 0 0 0 1.5 0 0 0 1 0 0 0 -2.25 box4o8a.dat
  [1,16,0,0,0,1.5,0,0,0,1,0,0,0,-2.25, ldraw_lib__box4o8a(realsolid)],
];
module ldraw_lib__650k03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__650k03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
