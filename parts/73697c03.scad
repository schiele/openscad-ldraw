...
use <73697.scad>
$fa=1; $fs=0.2;
function ldraw_lib__73697c03(realsolid=false) = [
// 0 Train Track 12V Slotted Point Right Electric (Straight)
// 0 Name: 73697c03.dat
...
module ldraw_lib__73697c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73697c03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__73697c03(line=0.2);