...
use <../p/recte4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4220a(realsolid=false) = [
...
// 1 16 0 0 12.5 0 1 0 1 0 0 0 0 -1 arm2.dat
  [1,16,0,0,12.5,0,1,0,1,0,0,0,0,-1, ldraw_lib__arm2(realsolid)],
// 
...
module ldraw_lib__4220a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4220a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
