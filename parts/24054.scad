...
use <../p/stud2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__24054(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\24054s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__24054s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\24054s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__24054s01(realsolid)],
// 0 // Hinge
// 0 // Primitives
...
// 1 16 0 0 0 4 0 0 0 6.5 0 0 0 4 4-4cyli.dat
  [1,16,0,0,0,4,0,0,0,6.5,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 5.024 6.5 0 1.976 0 0 0 -4.5 0 0 0 2.5 box3u4p.dat
  [1,16,5.024,6.5,0,1.976,0,0,0,-4.5,0,0,0,2.5, ldraw_lib__box3u4p(realsolid)],
// 1 16 5.024 125.5 0 1.976 0 0 0 4.5 0 0 0 2.5 box3u4p.dat
  [1,16,5.024,125.5,0,1.976,0,0,0,4.5,0,0,0,2.5, ldraw_lib__box3u4p(realsolid)],
// 1 16 0 132 0 4 0 0 0 -6.5 0 0 0 4 4-4cyli.dat
  [1,16,0,132,0,4,0,0,0,-6.5,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 132 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,0,132,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 132 0 2 0 0 0 -1 0 0 0 2 4-4ring1.dat
  [1,16,0,132,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring1(realsolid)],
// 1 16 0 132 0 2 0 0 0 -1.5 0 0 0 2 bump5000.dat
  [1,16,0,132,0,2,0,0,0,-1.5,0,0,0,2, ldraw_lib__bump5000(realsolid)],
// 1 16 66 78 4 0 0 -1 1 0 0 0 -1 0 stud2.dat
  [1,16,66,78,4,0,0,-1,1,0,0,0,-1,0, ldraw_lib__stud2(realsolid)],
// 1 16 66 78 -4 0 0 1 1 0 0 0 1 0 stud2.dat
  [1,16,66,78,-4,0,0,1,1,0,0,0,1,0, ldraw_lib__stud2(realsolid)],
// 1 16 76 39 0 0 -1 0 0 0 91 4 0 0 rect.dat
  [1,16,76,39,0,0,-1,0,0,0,91,4,0,0, ldraw_lib__rect(realsolid)],
// 1 16 76 28 4 0 0 -80 -80 0 0 0 -8 0 48\7-48cylo.dat
  [1,16,76,28,4,0,0,-80,-80,0,0,0,-8,0, ldraw_lib__48__7_48cylo(realsolid)],
// 1 16 9.764 -16.5618 0 0 0 -2.764 0 1 4.1422 4 0 0 rect3.dat
  [1,16,9.764,-16.5618,0,0,0,-2.764,0,1,4.1422,4,0,0, ldraw_lib__rect3(realsolid)],
// 0 // Faces
...
module ldraw_lib__24054(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__24054(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
