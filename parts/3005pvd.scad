...
use <s/3005s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3005pvd(realsolid=false) = [
...
// 1 9 -1 13 -10 0 0 1.75 2 0 0 0 1 0 2-4ring2.dat
  [1,9,-1,13,-10,0,0,1.75,2,0,0,0,1,0, ldraw_lib__2_4ring2(realsolid)],
// 1 9 -1 13 -10 0 0 1.75 1.75 0 0 0 1 0 2-4ring3.dat
  [1,9,-1,13,-10,0,0,1.75,1.75,0,0,0,1,0, ldraw_lib__2_4ring3(realsolid)],
// 1 16 -1 13 -10 0 0 3.5 4 0 0 0 1 0 2-4disc.dat
  [1,16,-1,13,-10,0,0,3.5,4,0,0,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 -1 13 -10 0 0 7 7 0 0 0 1 0 2-4ndis.dat
  [1,16,-1,13,-10,0,0,7,7,0,0,0,1,0, ldraw_lib__2_4ndis(realsolid)],
...
module ldraw_lib__3005pvd(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3005pvd(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
