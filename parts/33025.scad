...
use <s/33025s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__33025(realsolid=false) = [
// 0 Scala Hair Dryer
// 0 Name: 33025.dat
...
// 1 16 0 -14.5 0 0 0 4 0 25 0 -4 0 0 4-4cyli.dat
  [1,16,0,-14.5,0,0,0,4,0,25,0,-4,0,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 10.5 0 0 0 4 0 4 0 -4 0 0 4-8sphe.dat
  [1,16,0,10.5,0,0,0,4,0,4,0,-4,0,0, ldraw_lib__4_8sphe(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\33025s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__33025s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\33025s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__33025s01(realsolid)],
];
module ldraw_lib__33025(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__33025(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
