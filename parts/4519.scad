...
// 1 16 -30 0 0 0 1 0 1 0 0 0 0 -1 axleend2.dat
  [1,16,-30,0,0,0,1,0,1,0,0,0,0,-1, ldraw_lib__axleend2()],
// 1 16 27.5 0 0 0 -55 0 1 0 0 0 0 1 axlehol8.dat
  [1,16,27.5,0,0,0,-55,0,1,0,0,0,0,1, ldraw_lib__axlehol8()],
];
module ldraw_lib__4519(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4519(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
