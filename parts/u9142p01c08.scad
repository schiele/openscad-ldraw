...
$fa=1; $fs=0.2;
function ldraw_lib__u9142p01c08(realsolid=false) = [
// 0 _Figure Fabuland Bulldog 1 Brown with Body Red/Red/Yellow
// 0 Name: u9142p01c08.dat
...
// 1 450 0 -67 4 1 0 0 0 1 0 0 0 1 u9142p01c01.dat
  [1,450,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u9142p01c01(realsolid)],
...
module ldraw_lib__u9142p01c08(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9142p01c08(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9142p01c08(line=0.2);