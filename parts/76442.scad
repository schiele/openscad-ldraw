...
use <30462.scad>
$fa=1; $fs=0.2;
function ldraw_lib__76442(realsolid=false) = [
...
// 1 16 0 63.817 -60.25 1 0 0 0 1 0 0 0 1 30462.dat
  [1,16,0,63.817,-60.25,1,0,0,0,1,0,0,0,1, ldraw_lib__30462(realsolid)],
];
module ldraw_lib__76442(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76442(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
