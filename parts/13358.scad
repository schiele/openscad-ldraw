...
use <../p/stud8a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__13358(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\13358s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__13358s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\13358s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__13358s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\13358s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__13358s01(realsolid)],
...
// 1 16 0 4 0 1 0 0 0 -4 0 0 0 1 stud8a.dat
  [1,16,0,4,0,1,0,0,0,-4,0,0,0,1, ldraw_lib__stud8a(realsolid)],
...
// 1 16 0 24 0 36 0 0 0 -20 0 0 0 36 box4.dat
  [1,16,0,24,0,36,0,0,0,-20,0,0,0,36, ldraw_lib__box4(realsolid)],
...
// 1 16 32 0 0 0 0 8 0 1 0 -16 0 0 rect2p.dat
  [1,16,32,0,0,0,0,8,0,1,0,-16,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 19.5 -25 0 0 1 0.5 0 0 -1 -1.5 0 0 rect2p.dat
  [1,16,19.5,-25,0,0,1,0.5,0,0,-1,-1.5,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 19 -12 0 0 1 0 12 0 0 0 0 -1.5 rect1.dat
  [1,16,19,-12,0,0,1,0,12,0,0,0,0,-1.5, ldraw_lib__rect1(realsolid)],
// 1 16 -19.5 -25 0 0 -1 -0.5 0 0 -1 1.5 0 0 rect2p.dat
  [1,16,-19.5,-25,0,0,-1,-0.5,0,0,-1,1.5,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -19 -12 0 0 -1 0 12 0 0 0 0 1.5 rect1.dat
  [1,16,-19,-12,0,0,-1,0,12,0,0,0,0,1.5, ldraw_lib__rect1(realsolid)],
...
module ldraw_lib__13358(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__13358(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
