...
use <s/24074s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__24074(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\24074s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__24074s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\24074s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__24074s01(realsolid)],
];
module ldraw_lib__24074(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__24074(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
