...
use <s/u9142s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9142(realsolid=false) = [
// 0 ~Figure Fabuland Bulldog Head without Pattern
// 0 Name: u9142.dat
...
// 
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9142s00.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9142s00(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9142s00.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9142s00(realsolid)],
...
module ldraw_lib__u9142(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9142(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9142(line=0.2);