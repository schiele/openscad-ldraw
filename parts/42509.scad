...
use <s/42509s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__42509(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\42509s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__42509s01(realsolid)],
...
module ldraw_lib__42509(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__42509(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
