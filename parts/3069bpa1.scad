...
use <s/3069bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3069bpa1(realsolid=false) = [
...
// 1 16 -6.8 0 0 -3.2 0 0 0 1 0 0 0 3.4 7-16ndis.dat
  [1,16,-6.8,0,0,-3.2,0,0,0,1,0,0,0,3.4, ldraw_lib__7_16ndis(realsolid)],
// 1 15 -6.8 0 0 -.8 0 0 0 1 0 0 0 .85 7-16rin3.dat
  [1,15,-6.8,0,0,-.8,0,0,0,1,0,0,0,.85, ldraw_lib__7_16rin3(realsolid)],
// 1 16 -6.8 0 0 -2.4 0 0 0 1 0 0 0 2.55 7-16chrd.dat
  [1,16,-6.8,0,0,-2.4,0,0,0,1,0,0,0,2.55, ldraw_lib__7_16chrd(realsolid)],
...
// 1 15 -6.8 0 0 -0.8 0 0 0 1 0 0 0 -0.85 7-16rin3.dat
  [1,15,-6.8,0,0,-0.8,0,0,0,1,0,0,0,-0.85, ldraw_lib__7_16rin3(realsolid)],
// 0 // Digit 5
...
// 1 15 2 0 -1 -0.8 0 0 0 1 0 0 0 -0.8 3-4ring2.dat
  [1,15,2,0,-1,-0.8,0,0,0,1,0,0,0,-0.8, ldraw_lib__3_4ring2(realsolid)],
// 1 16 2 0 -1 -1.6 0 0 0 1 0 0 0 -1.6 3-4chrd.dat
  [1,16,2,0,-1,-1.6,0,0,0,1,0,0,0,-1.6, ldraw_lib__3_4chrd(realsolid)],
// 1 16 2 0 -1 -2.4 0 0 0 1 0 0 0 -2.4 3-4ndis.dat
  [1,16,2,0,-1,-2.4,0,0,0,1,0,0,0,-2.4, ldraw_lib__3_4ndis(realsolid)],
// 0 // Digit 1
// 1 15 6.1 0 3.4 1.8 0 0 0 1 0 0 0 -1.3 1-4ndis.dat
  [1,15,6.1,0,3.4,1.8,0,0,0,1,0,0,0,-1.3, ldraw_lib__1_4ndis(realsolid)],
// 1 16 6.1 0 3.4 1.8 0 0 0 1 0 0 0 -1.3 1-4chrd.dat
  [1,16,6.1,0,3.4,1.8,0,0,0,1,0,0,0,-1.3, ldraw_lib__1_4chrd(realsolid)],
...
module ldraw_lib__3069bpa1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3069bpa1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
