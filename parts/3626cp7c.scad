...
use <../p/1-4cyli.scad>
use <../p/1-8cyli.scad>
use <s/3626cp7cs01.scad>
use <s/3626cs02.scad>
use <../p/t04o6250.scad>
use <../p/t08o6250.scad>
function ldraw_lib__3626cp7c() = [
// 0 Minifig Head with Black Moustache and Eyebrows, Nougat Cheek Lines and Smile Pattern
// 0 Name: 3626cp7c.dat
...
// 1 16 0 17 0 -8 0 0 0 6.4 0 0 0 8 t04o6250.dat
  [1,16,0,17,0,-8,0,0,0,6.4,0,0,0,8, ldraw_lib__t04o6250()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3626cp7cs01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3626cp7cs01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\3626cp7cs01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3626cp7cs01()],
...
module ldraw_lib__3626cp7c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3626cp7c(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3626cp7c(line=0.2);