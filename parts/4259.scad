...
use <../p/stug-2x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4259(realsolid=false) = [
...
// 1 16 0 0 -7.333 1 0 0 0 0 1 0 0.333333 0 4-4con19.dat
  [1,16,0,0,-7.333,1,0,0,0,0,1,0,0.333333,0, ldraw_lib__4_4con19(realsolid)],
// 1 16 0 0 -8 2 0 0 0 0 2 0 0.666667 0 4-4con10.dat
  [1,16,0,0,-8,2,0,0,0,0,2,0,0.666667,0, ldraw_lib__4_4con10(realsolid)],
// 1 16 0 0 6.334 -1 0 0 0 0 1 0 -0.333333 0 4-4con19.dat
  [1,16,0,0,6.334,-1,0,0,0,0,1,0,-0.333333,0, ldraw_lib__4_4con19(realsolid)],
// 1 16 0 0 7.001 -2 0 0 0 0 2 0 -0.666667 0 4-4con10.dat
  [1,16,0,0,7.001,-2,0,0,0,0,2,0,-0.666667,0, ldraw_lib__4_4con10(realsolid)],
// 1 16 0 0 6 19 0 0 0 0 19 0 1 0 4-4edge.dat
  [1,16,0,0,6,19,0,0,0,0,19,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 7 22 0 0 0 0 22 0 1 0 4-4edge.dat
  [1,16,0,0,7,22,0,0,0,0,22,0,1,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 9 16 0 0 0 0 16 0 1 0 4-4edge.dat
  [1,16,0,0,9,16,0,0,0,0,16,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -7 16 0 0 0 0 16 0 1 0 4-4edge.dat
  [1,16,0,0,-7,16,0,0,0,0,16,0,1,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 -7 8 0 0 0 0 8 0 17 0 4-4cyli.dat
  [1,16,0,0,-7,8,0,0,0,0,8,0,17,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -7 16 0 0 0 0 16 0 16 0 4-4cyli.dat
  [1,16,0,0,-7,16,0,0,0,0,16,0,16,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -7 19 0 0 0 0 19 0 13 0 4-4cyli.dat
  [1,16,0,0,-7,19,0,0,0,0,19,0,13,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -10 22 0 0 0 0 22 0 2 0 4-4cyli.dat
  [1,16,0,0,-10,22,0,0,0,0,22,0,2,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 7 22 0 0 0 0 22 0 2 0 4-4cyli.dat
  [1,16,0,0,7,22,0,0,0,0,22,0,2,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 0 -7 -8 0 0 0 0 8 0 -1 0 4-4ring1.dat
  [1,16,0,0,-7,-8,0,0,0,0,8,0,-1,0, ldraw_lib__4_4ring1(realsolid)],
// 1 16 0 0 -10 11 0 0 0 0 11 0 1 0 4-4ring1.dat
  [1,16,0,0,-10,11,0,0,0,0,11,0,1,0, ldraw_lib__4_4ring1(realsolid)],
// 1 16 0 0 -10 6 0 0 0 0 6 0 1 0 4-4ring1.dat
  [1,16,0,0,-10,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4ring1(realsolid)],
// 1 16 0 0 -8 2 0 0 0 0 2 0 1 0 4-4ring2.dat
  [1,16,0,0,-8,2,0,0,0,0,2,0,1,0, ldraw_lib__4_4ring2(realsolid)],
// 1 16 0 0 9 4 0 0 0 0 4 0 -1 0 4-4ring4.dat
  [1,16,0,0,9,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4ring4(realsolid)],
// 1 16 0 0 9 2 0 0 0 0 2 0 -1 0 4-4rin10.dat
  [1,16,0,0,9,2,0,0,0,0,2,0,-1,0, ldraw_lib__4_4rin10(realsolid)],
// 1 16 0 0 -10 1 0 0 0 0 -1 0 1 0 stug-2x2.dat
  [1,16,0,0,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__stug_2x2(realsolid)],
// 1 16 -0.5 -11.902 0.5 0 -0.5 0 4 0.098 0 0 0 7.5 box2-7.dat
  [1,16,-0.5,-11.902,0.5,0,-0.5,0,4,0.098,0,0,0,7.5, ldraw_lib__box2_7(realsolid)],
...
// 1 16 -11.902 0.5 0.5 4 0.098 0 0 0.5 0 0 0 7.5 box2-7.dat
  [1,16,-11.902,0.5,0.5,4,0.098,0,0,0.5,0,0,0,7.5, ldraw_lib__box2_7(realsolid)],
...
module ldraw_lib__4259(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4259(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
