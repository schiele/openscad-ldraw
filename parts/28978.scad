...
use <64451.scad>
$fa=1; $fs=0.2;
function ldraw_lib__28978(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 64451.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__64451(realsolid)],
// 0
];
module ldraw_lib__28978(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__28978(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
