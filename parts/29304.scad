...
$fa=1; $fs=0.2;
function ldraw_lib__29304(realsolid=false) = [
...
// 1 16 60 0 -60 1 0 0 0 2.75 0 0 0 1 stug7-3x3.dat
  [1,16,60,0,-60,1,0,0,0,2.75,0,0,0,1, ldraw_lib__stug7_3x3(realsolid)],
// 1 16 -60 0 -60 1 0 0 0 2.75 0 0 0 1 stug7-3x3.dat
  [1,16,-60,0,-60,1,0,0,0,2.75,0,0,0,1, ldraw_lib__stug7_3x3(realsolid)],
// 1 16 0 0 -140 1 0 0 0 2.75 0 0 0 1 stug7-1x2.dat
  [1,16,0,0,-140,1,0,0,0,2.75,0,0,0,1, ldraw_lib__stug7_1x2(realsolid)],
...
// 1 16 0 0 0 160 0 0 0 1 0 0 0 -160 48\2-4edge.dat
  [1,16,0,0,0,160,0,0,0,1,0,0,0,-160, ldraw_lib__48__2_4edge(realsolid)],
// 1 16 0 0 0 160 0 0 0 1 0 0 0 -160 48\2-4chrd.dat
  [1,16,0,0,0,160,0,0,0,1,0,0,0,-160, ldraw_lib__48__2_4chrd(realsolid)],
// 1 16 0 12 0 0 0 160 -12 0 0 0 -1 0 rect.dat
  [1,16,0,12,0,0,0,160,-12,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 0 0 160 0 0 0 4 0 0 0 -160 48\2-4cyli.dat
  [1,16,0,0,0,160,0,0,0,4,0,0,0,-160, ldraw_lib__48__2_4cyli(realsolid)],
// 1 16 0 14 -4 -155.7364 0 0 0 0 10 0 1 0 rect.dat
  [1,16,0,14,-4,-155.7364,0,0,0,0,10,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 155.2009 14 -12.18105 0.5355 1 0 0 0 10 8.18105 0 0 rect2p.dat
  [1,16,155.2009,14,-12.18105,0.5355,1,0,0,0,10,8.18105,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 4 0 154.6654 0 -20.36209 0 20 0 -20.36209 0 -154.6654 48\1-48cylo.dat
  [1,16,0,4,0,154.6654,0,-20.36209,0,20,0,-20.36209,0,-154.6654, ldraw_lib__48__1_48cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 0 -154.6654 0 20.36209 0 20 0 -20.36209 0 -154.6654 48\1-48cylo.dat
  [1,16,0,4,0,-154.6654,0,20.36209,0,20,0,-20.36209,0,-154.6654, ldraw_lib__48__1_48cylo(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\29304s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__29304s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 -1 0 0 s\29304s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,-1,0,0, ldraw_lib__s__29304s01(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 0 0 0 156 0 20 0 -156 0 0 48\1-24cylo.dat
  [1,16,0,4,0,0,0,156,0,20,0,-156,0,0, ldraw_lib__48__1_24cylo(realsolid)],
// 1 16 0 4 0 0 0 156 0 -1 0 -156 0 0 48\1-24chrd.dat
  [1,16,0,4,0,0,0,156,0,-1,0,-156,0,0, ldraw_lib__48__1_24chrd(realsolid)],
...
// 1 16 0 4 -34.2 0 0 1.5 0 8 0 -30.2 0 0 box3u5p.dat
  [1,16,0,4,-34.2,0,0,1.5,0,8,0,-30.2,0,0, ldraw_lib__box3u5p(realsolid)],
...
// 1 16 0 4 -125.8 0 0 1.5 0 8 0 30.2 0 0 box3u8p.dat
  [1,16,0,4,-125.8,0,0,1.5,0,8,0,30.2,0,0, ldraw_lib__box3u8p(realsolid)],
...
// 1 16 -80 4 -34.2 0 0 1.5 0 8 0 -30.2 0 0 box3u5p.dat
  [1,16,-80,4,-34.2,0,0,1.5,0,8,0,-30.2,0,0, ldraw_lib__box3u5p(realsolid)],
...
// 1 16 40 4 -80 24.2983 0 0 0 8 0 0 0 -1.5 box3u4p.dat
  [1,16,40,4,-80,24.2983,0,0,0,8,0,0,0,-1.5, ldraw_lib__box3u4p(realsolid)],
...
// 1 16 -20 4 -6 1.5 0 0 0 19 0 0 0 -2 box4-1.dat
  [1,16,-20,4,-6,1.5,0,0,0,19,0,0,0,-2, ldraw_lib__box4_1(realsolid)],
// 1 16 -60 4 -6 1.5 0 0 0 19 0 0 0 -2 box4-1.dat
  [1,16,-60,4,-6,1.5,0,0,0,19,0,0,0,-2, ldraw_lib__box4_1(realsolid)],
// 1 16 -100 4 -6 1.5 0 0 0 19 0 0 0 -2 box4-1.dat
  [1,16,-100,4,-6,1.5,0,0,0,19,0,0,0,-2, ldraw_lib__box4_1(realsolid)],
// 1 16 -140 4 -6 1.5 0 0 0 19 0 0 0 -2 box4-1.dat
  [1,16,-140,4,-6,1.5,0,0,0,19,0,0,0,-2, ldraw_lib__box4_1(realsolid)],
// 1 16 20 4 -6 -1.5 0 0 0 19 0 0 0 -2 box4-1.dat
  [1,16,20,4,-6,-1.5,0,0,0,19,0,0,0,-2, ldraw_lib__box4_1(realsolid)],
// 1 16 60 4 -6 -1.5 0 0 0 19 0 0 0 -2 box4-1.dat
  [1,16,60,4,-6,-1.5,0,0,0,19,0,0,0,-2, ldraw_lib__box4_1(realsolid)],
...
module ldraw_lib__29304(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__29304(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
