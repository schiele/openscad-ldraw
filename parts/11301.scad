...
$fa=1; $fs=0.2;
function ldraw_lib__11301(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\11301s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__11301s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\11301s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__11301s01(realsolid)],
// 1 16 0 42 0 1 0 0 0 -1.5 0 0 0 1 stud4a.dat
  [1,16,0,42,0,1,0,0,0,-1.5,0,0,0,1, ldraw_lib__stud4a(realsolid)],
...
// 1 16 0 24 -10 1 0 0 0 1 0 0 0 1 stug2-1x4.dat
  [1,16,0,24,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2_1x4(realsolid)],
// 1 16 0 24 10 1 0 0 0 1 0 0 0 1 stug2-1x4.dat
  [1,16,0,24,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2_1x4(realsolid)],
];
module ldraw_lib__11301(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11301(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
