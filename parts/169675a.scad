...
// 1 16 0 -0.25 0 1 0 0 0 1 0 0 0 1 s\169675as01.dat
  [1,16,0,-0.25,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__169675as01()],
// 1 16 0 -.25 0 15 0 0 0 .25 0 0 0 -11 box5-12.dat
  [1,16,0,-.25,0,15,0,0,0,.25,0,0,0,-11, ldraw_lib__box5_12()],
...
module ldraw_lib__169675a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__169675a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
