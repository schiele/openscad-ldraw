...
use <s/98570s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98570(realsolid=false) = [
// 0 Constraction Shell Chest Badge "H" with  2 Bars
// 0 Name: 98570.dat
...
// 1 16 0 10 0 1 0 0 0 1 0 0 0 1 s\98570s01.dat
  [1,16,0,10,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__98570s01(realsolid)],
// 1 16 0 10 0 -1 0 0 0 1 0 0 0 1 s\98570s01.dat
  [1,16,0,10,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__98570s01(realsolid)],
// 1 16 0 10 0 1 0 0 0 -1 0 0 0 1 s\98570s01.dat
  [1,16,0,10,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__98570s01(realsolid)],
...
// 1 16 0 10 -14.9 -2.375 0 0 0 0 -2.5 0 -4.9 0 box3u4p.dat
  [1,16,0,10,-14.9,-2.375,0,0,0,0,-2.5,0,-4.9,0, ldraw_lib__box3u4p(realsolid)],
// 1 16 0 -3.818 -16.7875 -2.25 0 0 0 2.75 0 0 0 -1.8875 box4-2p.dat
  [1,16,0,-3.818,-16.7875,-2.25,0,0,0,2.75,0,0,0,-1.8875, ldraw_lib__box4_2p(realsolid)],
// 1 16 0 23.818 -16.7875 -2.25 0 0 0 -2.75 0 0 0 -1.8875 box4-2p.dat
  [1,16,0,23.818,-16.7875,-2.25,0,0,0,-2.75,0,0,0,-1.8875, ldraw_lib__box4_2p(realsolid)],
...
// 1 16 2.375 10 -17.35 0 5.125 0 0 0 6.75 2.45 0 0 box3u2p.dat
  [1,16,2.375,10,-17.35,0,5.125,0,0,0,6.75,2.45,0,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 10.721 10 -14.9 3.221 0 0 0 0 -1.275 0 -2.35 0 box3u5p.dat
  [1,16,10.721,10,-14.9,3.221,0,0,0,0,-1.275,0,-2.35,0, ldraw_lib__box3u5p(realsolid)],
// 1 16 18.177 10 -13.625 0 -1 0 -1.629 0 0 0 0 -3.625 rect2p.dat
  [1,16,18.177,10,-13.625,0,-1,0,-1.629,0,0,0,0,-3.625, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 0 0 4 0 0 0 0 4 0 -10 0 4-4cylc.dat
  [1,16,0,0,0,4,0,0,0,0,4,0,-10,0, ldraw_lib__4_4cylc(realsolid)],
// 1 16 0 20 0 4 0 0 0 0 4 0 -10 0 4-4cylc.dat
  [1,16,0,20,0,4,0,0,0,0,4,0,-10,0, ldraw_lib__4_4cylc(realsolid)],
// 
// 1 16 0 10 -14.9 14.25 0 0 0 0 14.25 0 1 0 4-4disc.dat
  [1,16,0,10,-14.9,14.25,0,0,0,0,14.25,0,1,0, ldraw_lib__4_4disc(realsolid)],
];
module ldraw_lib__98570(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98570(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__98570(line=0.2);