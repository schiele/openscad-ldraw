...
// 1 16 0 10 -14.9 14.25 0 0 0 0 14.25 0 1 0 4-4disc.dat
  [1,16,0,10,-14.9,14.25,0,0,0,0,14.25,0,1,0, ldraw_lib__4_4disc()],
];
module ldraw_lib__98570(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98570(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
