...
use <s/747s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__747p01(realsolid=false) = [
...
// 1 0 0 -50 -2 1 0 0 0 0 1 0 1 0 2-4disc.dat
  [1,0,0,-50,-2,1,0,0,0,0,1,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 15 0 -50 -2 1 0 0 0 0 1 0 1 0 2-4ndis.dat
  [1,15,0,-50,-2,1,0,0,0,0,1,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 0 0 -60 -2 1 0 0 0 0 -1 0 1 0 2-4disc.dat
  [1,0,0,-60,-2,1,0,0,0,0,-1,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 15 0 -60 -2 1 0 0 0 0 -1 0 1 0 2-4ndis.dat
  [1,15,0,-60,-2,1,0,0,0,0,-1,0,1,0, ldraw_lib__2_4ndis(realsolid)],
...
module ldraw_lib__747p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__747p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
