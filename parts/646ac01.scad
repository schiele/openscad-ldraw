...
use <854.scad>
$fa=1; $fs=0.2;
function ldraw_lib__646ac01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 646a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__646a(realsolid)],
// 1 47 0 0 0 1 0 0 0 1 0 0 0 1 854.dat
  [1,47,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__854(realsolid)],
// 0
];
module ldraw_lib__646ac01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__646ac01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
