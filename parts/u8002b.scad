...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u8002b(realsolid=false) = [
...
// 1 16 0 24 0 0 0 -16 0 -20 0 16 0 0 box4-1.dat
  [1,16,0,24,0,0,0,-16,0,-20,0,16,0,0, ldraw_lib__box4_1(realsolid)],
// 1 16 20 12 0 0 -40 0 -12 0 0 0 0 20 box3u2p.dat
  [1,16,20,12,0,0,-40,0,-12,0,0,0,0,20, ldraw_lib__box3u2p(realsolid)],
...
module ldraw_lib__u8002b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8002b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
