...
// 1 16 30 0 0 1 0 0 0 1 0 0 0 1 3751.dat
  [1,16,30,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3751()],
// 1 16 -30 0 0 1 0 0 0 1 0 0 0 1 3751.dat
  [1,16,-30,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3751()],
];
module ldraw_lib__3750c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3750c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
