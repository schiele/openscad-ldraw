...
use <s/4215as01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4215ap07(realsolid=false) = [
// 0 Panel  1 x  4 x  3 Left with Red/Blue Stripe Pattern
// 0 Name: 4215ap07.dat
...
module ldraw_lib__4215ap07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4215ap07(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
