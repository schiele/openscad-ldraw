...
$fa=1; $fs=0.2;
function ldraw_lib__003672a(realsolid=false) = [
...
// 1 16 0 -0.25 0 17 0 0 0 0.25 0 0 0 17 box5-12.dat
  [1,16,0,-0.25,0,17,0,0,0,0.25,0,0,0,17, ldraw_lib__box5_12(realsolid)],
// 
// 0 // www.holly-wood.it
// 
// 0 // Pattern Subpart
// 1 16 0 0 0 1.7 0 0 0 1 0 0 0 1.7 s\003672bs01.dat
  [1,16,0,0,0,1.7,0,0,0,1,0,0,0,1.7, ldraw_lib__s__003672bs01(realsolid)],
];
module ldraw_lib__003672a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__003672a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
