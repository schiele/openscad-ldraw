...
$fa=1; $fs=0.2;
function ldraw_lib__003428b(realsolid=false) = [
...
// 1 15 8 -.25 2.5 -.8 0 0 0 1 0 0 0 -.8 4-4disc.dat
  [1,15,8,-.25,2.5,-.8,0,0,0,1,0,0,0,-.8, ldraw_lib__4_4disc(realsolid)],
// 1 15 -8 -.25 2.5 -.8 0 0 0 1 0 0 0 -.8 4-4disc.dat
  [1,15,-8,-.25,2.5,-.8,0,0,0,1,0,0,0,-.8, ldraw_lib__4_4disc(realsolid)],
// 1 15 -1.3 -.25 8.7 -.8 0 0 0 1 0 0 0 -.8 4-4disc.dat
  [1,15,-1.3,-.25,8.7,-.8,0,0,0,1,0,0,0,-.8, ldraw_lib__4_4disc(realsolid)],
// 1 15 -1.3 -.25 4.2 -.8 0 0 0 1 0 0 0 -.8 4-4disc.dat
  [1,15,-1.3,-.25,4.2,-.8,0,0,0,1,0,0,0,-.8, ldraw_lib__4_4disc(realsolid)],
// 1 15 -1.3 -.25 -.3 -.8 0 0 0 1 0 0 0 -.8 4-4disc.dat
  [1,15,-1.3,-.25,-.3,-.8,0,0,0,1,0,0,0,-.8, ldraw_lib__4_4disc(realsolid)],
// 1 15 -1.3 -.25 -4.8 -.8 0 0 0 1 0 0 0 -.8 4-4disc.dat
  [1,15,-1.3,-.25,-4.8,-.8,0,0,0,1,0,0,0,-.8, ldraw_lib__4_4disc(realsolid)],
// 1 15 -1.3 -.25 -9.3 -.8 0 0 0 1 0 0 0 -.8 4-4disc.dat
  [1,15,-1.3,-.25,-9.3,-.8,0,0,0,1,0,0,0,-.8, ldraw_lib__4_4disc(realsolid)],
// 1 1 -8 -.25 2.5 -.8 0 0 0 1 0 0 0 -.8 4-4ndis.dat
  [1,1,-8,-.25,2.5,-.8,0,0,0,1,0,0,0,-.8, ldraw_lib__4_4ndis(realsolid)],
// 1 1 8 -.25 2.5 -.8 0 0 0 1 0 0 0 -.8 4-4ndis.dat
  [1,1,8,-.25,2.5,-.8,0,0,0,1,0,0,0,-.8, ldraw_lib__4_4ndis(realsolid)],
// 1 1 -1.3 -.25 8.7 -.8 0 0 0 1 0 0 0 -.8 4-4ndis.dat
  [1,1,-1.3,-.25,8.7,-.8,0,0,0,1,0,0,0,-.8, ldraw_lib__4_4ndis(realsolid)],
// 1 1 -1.3 -.25 4.2 -.8 0 0 0 1 0 0 0 -.8 4-4ndis.dat
  [1,1,-1.3,-.25,4.2,-.8,0,0,0,1,0,0,0,-.8, ldraw_lib__4_4ndis(realsolid)],
// 1 1 -1.3 -.25 -.3 -.8 0 0 0 1 0 0 0 -.8 4-4ndis.dat
  [1,1,-1.3,-.25,-.3,-.8,0,0,0,1,0,0,0,-.8, ldraw_lib__4_4ndis(realsolid)],
// 1 1 -1.3 -.25 -4.8 -.8 0 0 0 1 0 0 0 -.8 4-4ndis.dat
  [1,1,-1.3,-.25,-4.8,-.8,0,0,0,1,0,0,0,-.8, ldraw_lib__4_4ndis(realsolid)],
// 1 1 -1.3 -.25 -9.3 -.8 0 0 0 1 0 0 0 -.8 4-4ndis.dat
  [1,1,-1.3,-.25,-9.3,-.8,0,0,0,1,0,0,0,-.8, ldraw_lib__4_4ndis(realsolid)],
// 1 1 8 -.25 -1.5 2.4 0 0 0 1 0 0 0 -2.4 2-4chrd.dat
  [1,1,8,-.25,-1.5,2.4,0,0,0,1,0,0,0,-2.4, ldraw_lib__2_4chrd(realsolid)],
// 1 15 8 -.25 -1.5 .8 0 0 0 1 0 0 0 -.8 2-4ring3.dat
  [1,15,8,-.25,-1.5,.8,0,0,0,1,0,0,0,-.8, ldraw_lib__2_4ring3(realsolid)],
// 1 1 -8 -.25 -1.5 2.4 0 0 0 1 0 0 0 -2.4 2-4chrd.dat
  [1,1,-8,-.25,-1.5,2.4,0,0,0,1,0,0,0,-2.4, ldraw_lib__2_4chrd(realsolid)],
// 1 15 -8 -.25 -1.5 .8 0 0 0 1 0 0 0 -.8 2-4ring3.dat
  [1,15,-8,-.25,-1.5,.8,0,0,0,1,0,0,0,-.8, ldraw_lib__2_4ring3(realsolid)],
// 1 1 8 -.25 -1.5 3.2 0 0 0 1 0 0 0 -3.2 2-4ndis.dat
  [1,1,8,-.25,-1.5,3.2,0,0,0,1,0,0,0,-3.2, ldraw_lib__2_4ndis(realsolid)],
// 1 1 -8 -.25 -1.5 3.2 0 0 0 1 0 0 0 -3.2 2-4ndis.dat
  [1,1,-8,-.25,-1.5,3.2,0,0,0,1,0,0,0,-3.2, ldraw_lib__2_4ndis(realsolid)],
...
module ldraw_lib__003428b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__003428b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
