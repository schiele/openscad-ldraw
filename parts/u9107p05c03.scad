...
use <u9102.scad>
use <u9103.scad>
use <u9107p05c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9107p05c03(realsolid=false) = [
// 0 _Figure Fabuland Raccoon  2 with Body White/Yellow/Black
// 0 Name: u9107p05c03.dat
...
// 
// 
// 0 // This figure is different from u9107p04c03.dat which is from set 3669
// 0 // and has a different face pattern.
// 
// 0 // The color choice for the head has been done simply by color appearance.
// 0 // Maybe a different number needs to be used.
// 
// 1 84 0 -67 4 1 0 0 0 1 0 0 0 1 u9107p05c01.dat
  [1,84,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u9107p05c01(realsolid)],
...
module ldraw_lib__u9107p05c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9107p05c03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9107p05c03(line=0.2);