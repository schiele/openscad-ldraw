...
function ldraw_lib__u9107p05c03() = [
...
// 1 84 0 -67 4 1 0 0 0 1 0 0 0 1 u9107p05c01.dat
  [1,84,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u9107p05c01()],
...
module ldraw_lib__u9107p05c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9107p05c03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
