...
// 1 16 45.8 4 0 -30.2 0 0 0 8 0 0 0 -1.5 box3u5p.dat
  [1,16,45.8,4,0,-30.2,0,0,0,8,0,0,0,-1.5, ldraw_lib__box3u5p()],
...
// 1 16 0 4 -45.8 0 0 -1.5 0 8 0 30.2 0 0 box3u5p.dat
  [1,16,0,4,-45.8,0,0,-1.5,0,8,0,30.2,0,0, ldraw_lib__box3u5p()],
...
module ldraw_lib__14721(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__14721(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
