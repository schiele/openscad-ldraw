...
// 1 16 10 0 0 1 0 0 0 1 0 0 0 1 592c04.dat
  [1,16,10,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__592c04()],
// 1 16 -10 0 0 1 0 0 0 1 0 0 0 1 592c04.dat
  [1,16,-10,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__592c04()],
...
module ldraw_lib__592c05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__592c05(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
