...
use <s/u9365s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9365(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9365s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9365s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9365s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9365s01(realsolid)],
// 1 16 0 8 55 -14 0 0 0 0 -1 0 -1 0 rect2p.dat
  [1,16,0,8,55,-14,0,0,0,0,-1,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 4 16 -12 7 28 -9 7 9 9 7 9 12 7 28
  [4,16,-12,7,28,-9,7,9,9,7,9,12,7,28],
// 4 16 -9 7 -9 -8 7 -12 8 7 -12 9 7 -9
  [4,16,-9,7,-9,-8,7,-12,8,7,-12,9,7,-9],
// 1 16 0 -0.5 -12 8 0 0 0 0 7.5 0 -1 0 rect2p.dat
  [1,16,0,-0.5,-12,8,0,0,0,0,7.5,0,-1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 -8.5 -27 0 0 27 -0.5 0 0 0 -1 0 rect1.dat
  [1,16,0,-8.5,-27,0,0,27,-0.5,0,0,0,-1,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 0 0 -20 1 0 0 0 -1 0 0 0 1 connhol3.dat
  [1,16,0,0,-20,1,0,0,0,-1,0,0,0,1, ldraw_lib__connhol3(realsolid)],
// 1 16 0 -8 -20 0 0 6 0 1 0 6 0 0 4-4ndis.dat
  [1,16,0,-8,-20,0,0,6,0,1,0,6,0,0, ldraw_lib__4_4ndis(realsolid)],
];
module ldraw_lib__u9365(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9365(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
