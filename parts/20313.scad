...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 20312.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__20312()],
];
module ldraw_lib__20313(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__20313(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
