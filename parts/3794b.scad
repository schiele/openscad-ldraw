...
// 1 16 0 8 0 19 0 0 0 -1 0 0 0 9 box4.dat
  [1,16,0,8,0,19,0,0,0,-1,0,0,0,9, ldraw_lib__box4()],
...
// 1 16 0 7 0 20 0 0 0 -7 0 0 0 10 box5.dat
  [1,16,0,7,0,20,0,0,0,-7,0,0,0,10, ldraw_lib__box5()],
...
module ldraw_lib__3794b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3794b(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
