...
use <u9488.scad>
$fa=1; $fs=0.2;
function ldraw_lib__62274c02(realsolid=false) = [
...
// 1 494 0 0 -19 1 0 0 0 1 0 0 0 1 u9488.dat
  [1,494,0,0,-19,1,0,0,0,1,0,0,0,1, ldraw_lib__u9488(realsolid)],
];
module ldraw_lib__62274c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__62274c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
