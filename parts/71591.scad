...
use <s/71591s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__71591(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\71591s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__71591s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\71591s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__71591s01(realsolid)],
// 0 // Primitives
// 1 16 -6.725 0 0 0 13.45 0 4 0 0 0 0 4 4-4cyli.dat
  [1,16,-6.725,0,0,0,13.45,0,4,0,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
];
module ldraw_lib__71591(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__71591(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
