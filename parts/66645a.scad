...
function ldraw_lib__66645a() = [
// 0 Sail 13 x 42 Trapezoid
// 0 Name: 66645a.dat
...
// 1 16 -.25 0 0 -1 0 0 0 1 0 0 0 1 s\66645as01.dat
  [1,16,-.25,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__66645as01()],
// 1 16 .25 0 0 1 0 0 0 1 0 0 0 1 s\66645as01.dat
  [1,16,.25,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__66645as01()],
...
module ldraw_lib__66645a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__66645a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
