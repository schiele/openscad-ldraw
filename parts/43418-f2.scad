...
module ldraw_lib__43418_f2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__43418_f2(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__43418_f2(line=0.2);