...
// 1 80 -15.552 9 0 0.985 -0.17 0 0.17 0.985 0 0 0 1 62691.dat
  [1,80,-15.552,9,0,0.985,-0.17,0,0.17,0.985,0,0,0,1, ldraw_lib__62691()],
...
module ldraw_lib__63208p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__63208p01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
