...
use <t1108.scad>
$fa=1; $fs=0.2;
function ldraw_lib__t1052c09(realsolid=false) = [
...
// 1 47 0 29.5 0 -1 0 0 0 1 0 0 0 -1 t1107.dat
  [1,47,0,29.5,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1107(realsolid)],
// 
// 0 // Bottom Plate
// 1 47 0 29.5 0 -1 0 0 0 1 0 0 0 -1 t1108.dat
  [1,47,0,29.5,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1108(realsolid)],
// 
// 0 // Buzzer
// 1 494 0 26.2 0 -1 0 0 0 1 0 0 0 -1 t1106.dat
  [1,494,0,26.2,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1106(realsolid)],
];
module ldraw_lib__t1052c09(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1052c09(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
