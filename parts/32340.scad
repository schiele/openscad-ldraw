...
use <../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32340(realsolid=false) = [
...
// 1 16 0 20 0 136 0 0 0 -20 0 0 0 -83 box5.dat
  [1,16,0,20,0,136,0,0,0,-20,0,0,0,-83, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 20 0 132 0 0 0 -12 0 0 0 -79 box5.dat
  [1,16,0,20,0,132,0,0,0,-12,0,0,0,-79, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__32340(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32340(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
