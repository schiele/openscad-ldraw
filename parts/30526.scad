...
// 1 16 -10 10 -10 4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,16,-10,10,-10,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge()],
...
// 1 16 -10 10 -10 0 0 1 1 0 0 0 1 0 connect.dat
  [1,16,-10,10,-10,0,0,1,1,0,0,0,1,0, ldraw_lib__connect()],
// 1 16 10 10 -10 0 0 1 1 0 0 0 1 0 connect.dat
  [1,16,10,10,-10,0,0,1,1,0,0,0,1,0, ldraw_lib__connect()],
];
module ldraw_lib__30526(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30526(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
