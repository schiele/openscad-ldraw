...
use <s/3680s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3680(realsolid=false) = [
...
// 1 16 0 0 0 20 0 0 0 7 0 0 0 20 box4.dat
  [1,16,0,0,0,20,0,0,0,7,0,0,0,20, ldraw_lib__box4(realsolid)],
];
module ldraw_lib__3680(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3680(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
