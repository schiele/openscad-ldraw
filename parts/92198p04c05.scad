...
use <93352.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92198p04c05(realsolid=false) = [
...
// 1 84 0 -64 0 1 0 0 0 1 0 0 0 1 92241p16c01.dat
  [1,84,0,-64,0,1,0,0,0,1,0,0,0,1, ldraw_lib__92241p16c01(realsolid)],
...
// 1 308 0 -110 0.9 1 0 0 0 1 0 0 0 1 93352.dat
  [1,308,0,-110,0.9,1,0,0,0,1,0,0,0,1, ldraw_lib__93352(realsolid)],
];
module ldraw_lib__92198p04c05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92198p04c05(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__92198p04c05(line=0.2);