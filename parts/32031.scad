...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32031(realsolid=false) = [
...
// 1 16 -53 0 0 0 1 0 38 0 0 0 0 38 4-4edge.dat
  [1,16,-53,0,0,0,1,0,38,0,0,0,0,38, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 20 34 0 1 0 0 0 -1 0 0 0 1 stud4a.dat
  [1,16,20,34,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 0 34 0 1 0 0 0 -1 0 0 0 1 stud4a.dat
  [1,16,0,34,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 -20 34 0 1 0 0 0 -1 0 0 0 1 stud4a.dat
  [1,16,-20,34,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 -20 16 0 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,-20,16,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 -20 16 0 1 0 0 0 1 0 0 0 1 axl2hol2.dat
  [1,16,-20,16,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl2hol2(realsolid)],
// 1 16 -20 16 0 1 0 0 0 1 0 0 0 1 axl2hol9.dat
  [1,16,-20,16,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl2hol9(realsolid)],
// 1 16 -20 34 0 1 0 0 0 1 0 0 0 1 axl2hol9.dat
  [1,16,-20,34,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl2hol9(realsolid)],
// 1 16 -20 16 0 1 0 0 0 18 0 0 0 1 axl2hol8.dat
  [1,16,-20,16,0,1,0,0,0,18,0,0,0,1, ldraw_lib__axl2hol8(realsolid)],
// 1 16 -20 34 0 0 0 1 0 -1 0 1 0 0 axl2ho10.dat
  [1,16,-20,34,0,0,0,1,0,-1,0,1,0,0, ldraw_lib__axl2ho10(realsolid)],
// 1 16 -20 34 0 1 0 0 0 1 0 0 0 1 axl2hol3.dat
  [1,16,-20,34,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl2hol3(realsolid)],
// 
// 1 16 0 16 0 1 0 0 0 1 0 0 0 1 axl2hol2.dat
  [1,16,0,16,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl2hol2(realsolid)],
// 1 16 0 16 0 1 0 0 0 1 0 0 0 1 axl2hol9.dat
  [1,16,0,16,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl2hol9(realsolid)],
// 1 16 0 34 0 1 0 0 0 1 0 0 0 1 axl2hol9.dat
  [1,16,0,34,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl2hol9(realsolid)],
// 1 16 0 16 0 1 0 0 0 18 0 0 0 1 axl2hol8.dat
  [1,16,0,16,0,1,0,0,0,18,0,0,0,1, ldraw_lib__axl2hol8(realsolid)],
// 1 16 0 34 0 0 0 1 0 -1 0 1 0 0 axl2ho10.dat
  [1,16,0,34,0,0,0,1,0,-1,0,1,0,0, ldraw_lib__axl2ho10(realsolid)],
// 1 16 0 34 0 1 0 0 0 1 0 0 0 1 axl2hol3.dat
  [1,16,0,34,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl2hol3(realsolid)],
// 
// 1 16 20 16 0 1 0 0 0 1 0 0 0 1 axl2hol2.dat
  [1,16,20,16,0,1,0,0,0,1,0,0,0,1, ldraw_lib__axl2hol2(realsolid)],
// 1 16 20 16 0 1 0 0 0 1 0 0 0 1 axl2hol9.dat
...
// 1 16 -20 16 0 8 0 0 0 18 0 0 0 8 4-4cyli.dat
  [1,16,-20,16,0,8,0,0,0,18,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 16 0 8 0 0 0 18 0 0 0 8 4-4cyli.dat
  [1,16,0,16,0,8,0,0,0,18,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
// 1 16 20 16 0 8 0 0 0 18 0 0 0 8 4-4cyli.dat
  [1,16,20,16,0,8,0,0,0,18,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
// 
...
// 1 16 46.5 38.73 0 6.5 0 0 0 -1 0 0 0 10 rect.dat
  [1,16,46.5,38.73,0,6.5,0,0,0,-1,0,0,0,10, ldraw_lib__rect(realsolid)],
// 1 16 -46.5 38.73 0 6.5 0 0 0 -1 0 0 0 10 rect.dat
  [1,16,-46.5,38.73,0,6.5,0,0,0,-1,0,0,0,10, ldraw_lib__rect(realsolid)],
// 1 16 0 33.82 0 40 0 0 0 4.18 0 0 0 20 box4.dat
  [1,16,0,33.82,0,40,0,0,0,4.18,0,0,0,20, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 34 0 36 0 0 0 4 0 0 0 16 box4.dat
  [1,16,0,34,0,36,0,0,0,4,0,0,0,16, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 34 0 30 0 0 0 -18 0 0 0 10 box5.dat
  [1,16,0,34,0,30,0,0,0,-18,0,0,0,10, ldraw_lib__box5(realsolid)],
// 
// 1 16 53 0 0 0 -1 0 -2 0 0 0 0 2 3-8ring19.dat
  [1,16,53,0,0,0,-1,0,-2,0,0,0,0,2, ldraw_lib__3_8ring19(realsolid)],
// 1 16 53 0 0 0 -1 0 -2 0 0 0 0 -2 3-8ring19.dat
  [1,16,53,0,0,0,-1,0,-2,0,0,0,0,-2, ldraw_lib__3_8ring19(realsolid)],
// 1 16 -53 0 0 0 1 0 -2 0 0 0 0 2 3-8ring19.dat
  [1,16,-53,0,0,0,1,0,-2,0,0,0,0,2, ldraw_lib__3_8ring19(realsolid)],
...
// 1 16 -53 0 0 0 106 0 -40 0 0 0 0 40 3-8cylo.dat
  [1,16,-53,0,0,0,106,0,-40,0,0,0,0,40, ldraw_lib__3_8cylo(realsolid)],
// 1 16 -53 0 0 0 106 0 -40 0 0 0 0 -40 3-8cylo.dat
  [1,16,-53,0,0,0,106,0,-40,0,0,0,0,-40, ldraw_lib__3_8cylo(realsolid)],
// 
...
module ldraw_lib__32031(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32031(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__32031(line=0.2);