...
use <s/3005s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3005pwc(realsolid=false) = [
...
// 1 16 0 4 -10 1.2 0 0 0 0 0.6 0 1 0 4-4disc.dat
  [1,16,0,4,-10,1.2,0,0,0,0,0.6,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 9 0 4 -10 1.2 0 0 0 0 0.6 0 1 0 4-4ring1.dat
  [1,9,0,4,-10,1.2,0,0,0,0,0.6,0,1,0, ldraw_lib__4_4ring1(realsolid)],
// 1 16 0 4 -10 2.4 0 0 0 0 1.2 0 1 0 4-4ndis.dat
  [1,16,0,4,-10,2.4,0,0,0,0,1.2,0,1,0, ldraw_lib__4_4ndis(realsolid)],
...
module ldraw_lib__3005pwc(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3005pwc(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
