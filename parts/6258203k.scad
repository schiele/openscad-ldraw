...
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 s\6258203js01.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6258203js01()],
];
module ldraw_lib__6258203k(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6258203k(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
