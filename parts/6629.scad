...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6629(realsolid=false) = [
...
// 1 16 0 -10 0 1 0 0 0 20 0 0 0 1 axlehol4.dat
  [1,16,0,-10,0,1,0,0,0,20,0,0,0,1, ldraw_lib__axlehol4(realsolid)],
// 1 16 0 -10 0 -3 0 0 0 1 0 0 0 -3 2-4ring2.dat
  [1,16,0,-10,0,-3,0,0,0,1,0,0,0,-3, ldraw_lib__2_4ring2(realsolid)],
// 1 16 0 10 0 -3 0 0 0 -1 0 0 0 -3 2-4ring2.dat
  [1,16,0,10,0,-3,0,0,0,-1,0,0,0,-3, ldraw_lib__2_4ring2(realsolid)],
// 1 16 0 -10 10 1 0 0 0 20 0 0 0 1 npeghol4.dat
  [1,16,0,-10,10,1,0,0,0,20,0,0,0,1, ldraw_lib__npeghol4(realsolid)],
...
// 1 16 0 -10 90 1 0 0 0 8 0 0 0 1 npeghole.dat
  [1,16,0,-10,90,1,0,0,0,8,0,0,0,1, ldraw_lib__npeghole(realsolid)],
// 1 16 0 10 90 1 0 0 0 -8 0 0 0 1 npeghole.dat
  [1,16,0,10,90,1,0,0,0,-8,0,0,0,1, ldraw_lib__npeghole(realsolid)],
...
// 1 16 9 0 47.75 0 -1 0 10 0 0 0 0 47.75 rect3.dat
  [1,16,9,0,47.75,0,-1,0,10,0,0,0,0,47.75, ldraw_lib__rect3(realsolid)],
// 1 16 -9 0 50 0 1 0 0 0 -10 50 0 0 rect2p.dat
  [1,16,-9,0,50,0,1,0,0,0,-10,50,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 -10 100 1 0 0 0 1 0 0 0 1 peghole.dat
  [1,16,0,-10,100,1,0,0,0,1,0,0,0,1, ldraw_lib__peghole(realsolid)],
// 1 16 0 -10 100 -0.3536 0 0.3536 0 1 0 0.3536 0 0.3536 2-4rin16.dat
  [1,16,0,-10,100,-0.3536,0,0.3536,0,1,0,0.3536,0,0.3536, ldraw_lib__2_4rin16(realsolid)],
// 1 16 0 -10 100 -0.9239 0 -0.3827 0 1 0 0.3827 0 -0.9239 2-4ring8.dat
  [1,16,0,-10,100,-0.9239,0,-0.3827,0,1,0,0.3827,0,-0.9239, ldraw_lib__2_4ring8(realsolid)],
// 1 16 0 -10 100 -0.3827 0 -0.9239 0 1 0 0.9239 0 -0.3827 1-8ring8.dat
  [1,16,0,-10,100,-0.3827,0,-0.9239,0,1,0,0.9239,0,-0.3827, ldraw_lib__1_8ring8(realsolid)],
// 1 16 0 -10 100 0.5957 0 0.3527 0 1 0 -0.3527 0 0.5957 3-8rin12.dat
  [1,16,0,-10,100,0.5957,0,0.3527,0,1,0,-0.3527,0,0.5957, ldraw_lib__3_8rin12(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -8 100 6 0 0 0 16 0 0 0 6 4-4cyli.dat
  [1,16,0,-8,100,6,0,0,0,16,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 10 100 1 0 0 0 -1 0 0 0 1 peghole.dat
  [1,16,0,10,100,1,0,0,0,-1,0,0,0,1, ldraw_lib__peghole(realsolid)],
// 1 16 0 10 100 -0.3536 0 0.3536 0 -1 0 0.3536 0 0.3536 2-4rin16.dat
  [1,16,0,10,100,-0.3536,0,0.3536,0,-1,0,0.3536,0,0.3536, ldraw_lib__2_4rin16(realsolid)],
...
// 1 16 8 -10 106 0.6 0 -0.8 0 8 0 -0.8 0 -0.6 npeghole.dat
  [1,16,8,-10,106,0.6,0,-0.8,0,8,0,-0.8,0,-0.6, ldraw_lib__npeghole(realsolid)],
// 1 16 8 10 106 0.6 0 -0.8 0 -8 0 -0.8 0 -0.6 npeghole.dat
  [1,16,8,10,106,0.6,0,-0.8,0,-8,0,-0.8,0,-0.6, ldraw_lib__npeghole(realsolid)],
...
// 1 16 0 -10 100 -9 0 0 0 -1 0 0 0 9 1-8edge.dat
  [1,16,0,-10,100,-9,0,0,0,-1,0,0,0,9, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 10 100 -9 0 0 0 -1 0 0 0 9 1-8edge.dat
  [1,16,0,10,100,-9,0,0,0,-1,0,0,0,9, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 10 100 -9 0 0 0 -20 0 0 0 9 1-8cyli.dat
  [1,16,0,10,100,-9,0,0,0,-20,0,0,0,9, ldraw_lib__1_8cyli(realsolid)],
// 1 16 16 0 112 0.6 0 0.8 0 1 0 -0.8 0 0.6 connhole.dat
  [1,16,16,0,112,0.6,0,0.8,0,1,0,-0.8,0,0.6, ldraw_lib__connhole(realsolid)],
// 1 16 32 0 124 -0.6 0 -0.8 0 1 0 0.8 0 -0.6 beamhole.dat
  [1,16,32,0,124,-0.6,0,-0.8,0,1,0,0.8,0,-0.6, ldraw_lib__beamhole(realsolid)],
// 1 16 48 -10 136 5.4 0 7.2 0 1 0 -7.2 0 5.4 2-4edge.dat
  [1,16,48,-10,136,5.4,0,7.2,0,1,0,-7.2,0,5.4, ldraw_lib__2_4edge(realsolid)],
// 1 16 48 10 136 5.4 0 7.2 0 1 0 -7.2 0 5.4 2-4edge.dat
  [1,16,48,10,136,5.4,0,7.2,0,1,0,-7.2,0,5.4, ldraw_lib__2_4edge(realsolid)],
// 1 16 48 -10 136 5.4 0 7.2 0 20 0 -7.2 0 5.4 2-4cyli.dat
  [1,16,48,-10,136,5.4,0,7.2,0,20,0,-7.2,0,5.4, ldraw_lib__2_4cyli(realsolid)],
// 1 16 48 -10 136 0.6 0 -0.8 0 20 0 -0.8 0 -0.6 axlehol4.dat
  [1,16,48,-10,136,0.6,0,-0.8,0,20,0,-0.8,0,-0.6, ldraw_lib__axlehol4(realsolid)],
// 1 16 48 -10 136 -1.8 0 2.4 0 1 0 2.4 0 1.8 2-4ring2.dat
  [1,16,48,-10,136,-1.8,0,2.4,0,1,0,2.4,0,1.8, ldraw_lib__2_4ring2(realsolid)],
// 1 16 48 10 136 -1.8 0 2.4 0 -1 0 2.4 0 1.8 2-4ring2.dat
  [1,16,48,10,136,-1.8,0,2.4,0,-1,0,2.4,0,1.8, ldraw_lib__2_4ring2(realsolid)],
// 1 16 40 -10 130 0.6 0 -0.8 0 20 0 -0.8 0 -0.6 npeghol4.dat
  [1,16,40,-10,130,0.6,0,-0.8,0,20,0,-0.8,0,-0.6, ldraw_lib__npeghol4(realsolid)],
// 1 16 31.2 0 112.15 -22.2 -0.6 0 0 0 10 -16.65 0.8 0 rect2p.dat
  [1,16,31.2,0,112.15,-22.2,-0.6,0,0,0,10,-16.65,0.8,0, ldraw_lib__rect2p(realsolid)],
// 1 16 18.118 0 124.782 -24.482 0.6 0 0 0 -10 -18.418 -0.8 0 rect2p.dat
  [1,16,18.118,0,124.782,-24.482,0.6,0,0,0,-10,-18.418,-0.8,0, ldraw_lib__rect2p(realsolid)],
];
module ldraw_lib__6629(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6629(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6629(line=0.2);