...
// 1 16 0 -10 100 -0.3536 0 0.3536 0 1 0 0.3536 0 0.3536 2-4ring16.dat
  [1,16,0,-10,100,-0.3536,0,0.3536,0,1,0,0.3536,0,0.3536, ldraw_lib__2_4ring16()],
...
// 1 16 0 -10 100 0.5957 0 0.3527 0 1 0 -0.3527 0 0.5957 3-8ring12.dat
  [1,16,0,-10,100,0.5957,0,0.3527,0,1,0,-0.3527,0,0.5957, ldraw_lib__3_8ring12()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__6629(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6629(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
