...
use <s/3070bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3070bptb(realsolid=false) = [
...
// 1 80 0 0 0 1 0 0 0 1 0 0 0 1 s\3070batb.dat
  [1,80,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3070batb(realsolid)],
...
// 1 16 0.5 0 3.5 0 0 2 0 1 0 2 0 0 2-4disc.dat
  [1,16,0.5,0,3.5,0,0,2,0,1,0,2,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 0.5 0 3.5 0 0 4 0 1 0 4 0 0 1-4ndis.dat
  [1,16,0.5,0,3.5,0,0,4,0,1,0,4,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 0.5 0 -3 0 0 2.5 0 1 0 2.5 0 0 2-4disc.dat
  [1,16,0.5,0,-3,0,0,2.5,0,1,0,2.5,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 0.5 0 -3 0 0 4.5 0 1 0 -4.5 0 0 1-4ndis.dat
  [1,16,0.5,0,-3,0,0,4.5,0,1,0,-4.5,0,0, ldraw_lib__1_4ndis(realsolid)],
// 
];
module ldraw_lib__3070bptb(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3070bptb(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
