...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3021(realsolid=false) = [
// 0 Plate  2 x  3
// 0 Name: 3021.dat
...
// 1 16 10 4 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,10,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -10 4 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-10,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 
// 0 BFC INVERTNEXT
...
// 1 16 0 8 0 30 0 0 0 -8 0 0 0 20 box5.dat
  [1,16,0,8,0,30,0,0,0,-8,0,0,0,20, ldraw_lib__box5(realsolid)],
// 
...
module ldraw_lib__3021(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3021(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
