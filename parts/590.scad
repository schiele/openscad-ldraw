...
use <2894c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__590(realsolid=false) = [
// 0 ~Moved to 2894c01
// 0 Name: 590.dat
// 0 Author: [PTadmin]
...
// 1 16 0 8 0 1 0 0 0 1 0 0 0 1 2894c01.dat
  [1,16,0,8,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2894c01(realsolid)],
];
module ldraw_lib__590(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__590(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
