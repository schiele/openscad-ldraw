...
use <s/41014s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__41014(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\41014s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__41014s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\41014s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__41014s02(realsolid)],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 1 s\41014s02.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__41014s02(realsolid)],
...
// 1 16 0 49 45 0 0 29 0 -1 0 5 0 0 rect1.dat
  [1,16,0,49,45,0,0,29,0,-1,0,5,0,0, ldraw_lib__rect1(realsolid)],
// 4 16 -30 29 31 -29 40 31 29 40 31 30 29 31
  [4,16,-30,29,31,-29,40,31,29,40,31,30,29,31],
// 1 16 29 40 40 0 -58 0 0 0 9 -9 0 0 1-4cyli.dat
  [1,16,29,40,40,0,-58,0,0,0,9,-9,0,0, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 40 0 20 0 -1 0 0 0 -1 1 0 0 connhol3.dat
  [1,16,40,0,20,0,-1,0,0,0,-1,1,0,0, ldraw_lib__connhol3(realsolid)],
// 1 16 39.5 0 11 -9.5 0 0 0 0 20 0 1 0 rect1.dat
  [1,16,39.5,0,11,-9.5,0,0,0,0,20,0,1,0, ldraw_lib__rect1(realsolid)],
// 1 16 49.5 0 11 0.5 0 0 0 0 -20 0 1 0 rect1.dat
  [1,16,49.5,0,11,0.5,0,0,0,0,-20,0,1,0, ldraw_lib__rect1(realsolid)],
// 1 16 49.5 0 29 0 0 -0.5 20 0 0 0 -1 0 rect2p.dat
  [1,16,49.5,0,29,0,0,-0.5,20,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 30 0 20 0 1 0 0 0 -1 1 0 0 peghole.dat
  [1,16,30,0,20,0,1,0,0,0,-1,1,0,0, ldraw_lib__peghole(realsolid)],
// 1 16 30 0 20 0 -1 0 0 0 8 8 0 0 4-4disc.dat
  [1,16,30,0,20,0,-1,0,0,0,8,8,0,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 -20 0 0 -1 0 0 0 0 -1 0 1 0 connhol3.dat
  [1,16,-20,0,0,-1,0,0,0,0,-1,0,1,0, ldraw_lib__connhol3(realsolid)],
// 2 24 -30 -20 -9 -30 20 -9
  [2,24,-30,-20,-9,-30,20,-9],
...
// 1 16 37.5 0 30 0 0 -9.5 27 0 0 0 -1 0 rect2p.dat
  [1,16,37.5,0,30,0,0,-9.5,27,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 28 0 19 0 1 0 0 0 -27 -11 0 0 rect1.dat
  [1,16,28,0,19,0,1,0,0,0,-27,-11,0,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 48 0 55 0 0 1 -20 0 0 0 -1 0 rect2p.dat
  [1,16,48,0,55,0,0,1,-20,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -37.5 0 30 0 0 9.5 -27 0 0 0 -1 0 rect2p.dat
  [1,16,-37.5,0,30,0,0,9.5,-27,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -28 0 19 0 -1 0 0 0 27 -11 0 0 rect1.dat
  [1,16,-28,0,19,0,-1,0,0,0,27,-11,0,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 0 -27 19 0 0 -28 0 -1 0 -11 0 0 rect1.dat
  [1,16,0,-27,19,0,0,-28,0,-1,0,-11,0,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 28 0 12 0 -16 0 8 0 0 0 0 1 box5.dat
  [1,16,28,0,12,0,-16,0,8,0,0,0,0,1, ldraw_lib__box5(realsolid)],
// 1 16 -28 0 12 0 16 0 8 0 0 0 0 1 box5.dat
  [1,16,-28,0,12,0,16,0,8,0,0,0,0,1, ldraw_lib__box5(realsolid)],
];
module ldraw_lib__41014(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__41014(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
