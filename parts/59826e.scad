...
use <s/59826s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__59826e(realsolid=false) = [
...
// 1 15 0 -0.25 0 1 0 0 0 -1 0 0 0 1 s\59826s02.dat
  [1,15,0,-0.25,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__59826s02(realsolid)],
// 0 //
];
module ldraw_lib__59826e(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__59826e(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
