...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 6133, Rebrickable 6133
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6133.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6133()],
// 0
];
module ldraw_lib__30130(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30130(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
