...
use <s/u9364s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9364(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9364s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9364s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9364s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9364s01(realsolid)],
...
// 1 16 0 19.5 -27 0 0 -27 11.5 0 0 0 -1 0 rect1.dat
  [1,16,0,19.5,-27,0,0,-27,11.5,0,0,0,-1,0, ldraw_lib__rect1(realsolid)],
// 1 16 0 1 -26.5 -12 0 0 0 0 -7 0 -1 0.5 rect2p.dat
  [1,16,0,1,-26.5,-12,0,0,0,0,-7,0,-1,0.5, ldraw_lib__rect2p(realsolid)],
// 1 16 0 -6.5 -25.5 0 0 12 -0.5 -1 0 0.5 0 0 rect1.dat
  [1,16,0,-6.5,-25.5,0,0,12,-0.5,-1,0,0.5,0,0, ldraw_lib__rect1(realsolid)],
...
module ldraw_lib__u9364(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9364(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9364(line=0.2);