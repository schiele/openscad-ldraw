...
use <30171.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30171c01(realsolid=false) = [
// 0 Minifig Cap Aviator with Black Goggles
// 0 Name: 30171c01.dat
...
// 1 0 0 8 0 1 0 0 0 0.808222 0.588841 0 -0.588841 0.808222 30170.dat
  [1,0,0,8,0,1,0,0,0,0.808222,0.588841,0,-0.588841,0.808222, ldraw_lib__30170(realsolid)],
];
module ldraw_lib__30171c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30171c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
