...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 2419.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2419()],
];
module ldraw_lib__241921(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__241921(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
