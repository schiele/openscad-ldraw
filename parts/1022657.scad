...
function ldraw_lib__1022657() = [
// 0 Figure Friends Legs with Shorts (Thin Hinge)
// 0 Name: 1022657.dat
...
module ldraw_lib__1022657(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__1022657(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__1022657(line=0.2);