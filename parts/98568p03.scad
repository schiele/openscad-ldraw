...
use <s/98568s02.scad>
use <s/98568s03.scad>
function ldraw_lib__98568p03() = [
// 0 Constraction Blade 11.5L with Sawtooth Back with Trans Medium Blue Blade Pattern
// 0 Name: 98568p03.dat
...
// 1 41 0 0 0 1 0 0 0 0.99889 0.04711 0 -0.04711 0.99889 s\98568s02.dat
  [1,41,0,0,0,1,0,0,0,0.99889,0.04711,0,-0.04711,0.99889, ldraw_lib__s__98568s02()],
...
module ldraw_lib__98568p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98568p03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
