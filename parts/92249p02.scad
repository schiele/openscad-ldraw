...
use <s/92252s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92249p02(realsolid=false) = [
...
// 1 30 0 0 0 1 0 0 0 1 0 0 0 1 s\92249p02s02.dat
  [1,30,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92249p02s02(realsolid)],
// 1 78 0 0 0 1 0 0 0 1 0 0 0 1 s\92249p02s01.dat
  [1,78,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92249p02s01(realsolid)],
// 1 30 0 0 0 -1 0 0 0 1 0 0 0 1 s\92249p02s02.dat
  [1,30,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__92249p02s02(realsolid)],
// 1 78 0 0 0 -1 0 0 0 1 0 0 0 1 s\92249p02s01.dat
  [1,78,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__92249p02s01(realsolid)],
...
module ldraw_lib__92249p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92249p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
