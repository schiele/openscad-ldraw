...
use <s/95341s04.scad>
use <s/95341s05.scad>
function ldraw_lib__95341p02() = [
// 0 Animal Goat with Black Eyes and Dark Tan Horns Pattern
// 0 Name: 95341p02.dat
...
// 
// 1 28 0 0 0 1 0 0 0 1 0 0 0 1 s\95341s05.dat
  [1,28,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__95341s05()],
// 1 28 0 0 0 -1 0 0 0 1 0 0 0 1 s\95341s05.dat
  [1,28,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__95341s05()],
];
module ldraw_lib__95341p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__95341p02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__95341p02(line=0.2);