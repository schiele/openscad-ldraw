...
use <25561c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__22127(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 25561c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__25561c01(realsolid)],
// 1 72 0 50 0 1 0 0 0 1 0 0 0 1 24849.dat
  [1,72,0,50,0,1,0,0,0,1,0,0,0,1, ldraw_lib__24849(realsolid)],
...
module ldraw_lib__22127(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__22127(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
