...
use <u9103.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u595p01c08(realsolid=false) = [
// 0 _Figure Fabuland Monkey  1 with Body White/Black/Blue
// 0 Name: u595p01c08.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Alfred le singe, Mike Monkey, Set 3672, Set 3681
// 
...
module ldraw_lib__u595p01c08(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u595p01c08(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u595p01c08(line=0.2);