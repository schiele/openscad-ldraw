...
// 0 !HISTORY 2022-01-28 [PTadmin] Moved from 6217.dat
...
module ldraw_lib__6217a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6217a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6217a(line=0.2);