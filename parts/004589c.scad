...
$fa=1; $fs=0.2;
function ldraw_lib__004589c(realsolid=false) = [
...
// 1 15 0 9.75 12 1 0 0 0 0 1 0 -1 0 s\3004p13s01.dat
  [1,15,0,9.75,12,1,0,0,0,0,1,0,-1,0, ldraw_lib__s__3004p13s01(realsolid)],
];
module ldraw_lib__004589c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__004589c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
