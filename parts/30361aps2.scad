...
$fa=1; $fs=0.2;
function ldraw_lib__30361aps2(realsolid=false) = [
// 0 Cylinder  2 x  2 x  2 Robot Body w. SW Red/Grey R2 Pattern
// 0 Name: 30361aps2.dat
...
// 0 !HISTORY 2012-05-15 [PTadmin] Renamed from 30361ps2
...
module ldraw_lib__30361aps2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30361aps2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__30361aps2(line=0.2);