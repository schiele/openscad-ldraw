...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS astromech, droid, minifig, R5-D4, Rebrickable 30361apr0017
// 0 !KEYWORDS red droid, set 7150, Star Wars
// 
// 0 !CMDLINE -c15
// 
...
module ldraw_lib__30361aps2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30361aps2(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
