...
use <s/72046s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__72046p01(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 72046pb01, Set 41921
// 
...
// 1 37 0 0 0 1 0 0 0 1 0 0 0 1 s\72046s02.dat
  [1,37,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__72046s02(realsolid)],
];
module ldraw_lib__72046p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__72046p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
