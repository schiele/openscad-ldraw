...
use <815c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__814c01_f1(realsolid=false) = [
...
// 1 15 0 -28 0 1 0 0 0 1 0 0 0 1 815c01.dat
  [1,15,0,-28,0,1,0,0,0,1,0,0,0,1, ldraw_lib__815c01(realsolid)],
];
module ldraw_lib__814c01_f1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__814c01_f1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
