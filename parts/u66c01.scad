...
$fa=1; $fs=0.2;
function ldraw_lib__u66c01(realsolid=false) = [
// 0 Sheet Plastic  6 x 12 Triangular (Formed Shape 1)
// 0 Name: u66c01.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u66c01s03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u66c01s03(realsolid)],
];
module ldraw_lib__u66c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u66c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
