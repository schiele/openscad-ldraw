...
use <s/4744s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4744p04(realsolid=false) = [
...
// 1 0 11 25 -20 1 0 0 0 0 1 0 1 0 4-4ring6.dat
  [1,0,11,25,-20,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4ring6(realsolid)],
// 1 0 11 27 -20 5 0 0 0 0 5 0 1 0 4-4disc.dat
  [1,0,11,27,-20,5,0,0,0,0,5,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 14 11 25 -20 7 0 0 0 0 7 0 1 0 4-4ndis.dat
  [1,14,11,25,-20,7,0,0,0,0,7,0,1,0, ldraw_lib__4_4ndis(realsolid)],
...
// 1 14 3 36 -20 0 0 -3 -2 0 0 0 1 0 1-4ndis.dat
  [1,14,3,36,-20,0,0,-3,-2,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 14 4 36 -20 -1 0 5 -2 0 1 0 1 0 1-4ndis.dat
  [1,14,4,36,-20,-1,0,5,-2,0,1,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 14 -3 36 -20 0 0 3 -2 0 0 0 1 0 1-4ndis.dat
  [1,14,-3,36,-20,0,0,3,-2,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 14 -4 36 -20 1 0 -5 -2 0 1 0 1 0 1-4ndis.dat
  [1,14,-4,36,-20,1,0,-5,-2,0,1,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 14 0 37 -20 9 0 0 0 0 5 0 1 0 2-4ndis.dat
  [1,14,0,37,-20,9,0,0,0,0,5,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 
...
// 1 14 12 38 -20 16 0 0 0 0 9.5 0 1 0 1-4disc.dat
  [1,14,12,38,-20,16,0,0,0,0,9.5,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 14 -12 38 -20 -16 0 0 0 0 9.5 0 1 0 1-4disc.dat
  [1,14,-12,38,-20,-16,0,0,0,0,9.5,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 
// 0 lips
// 1 4 3 36 -20 0 0 -3 -2 0 0 0 1 0 1-4disc.dat
  [1,4,3,36,-20,0,0,-3,-2,0,0,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 4 4 36 -20 -1 0 5 -2 0 1 0 1 0 1-4disc.dat
  [1,4,4,36,-20,-1,0,5,-2,0,1,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 4 -3 36 -20 0 0 3 -2 0 0 0 1 0 1-4disc.dat
  [1,4,-3,36,-20,0,0,3,-2,0,0,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 4 -4 36 -20 1 0 -5 -2 0 1 0 1 0 1-4disc.dat
  [1,4,-4,36,-20,1,0,-5,-2,0,1,0,1,0, ldraw_lib__1_4disc(realsolid)],
...
// 1 4 0 37 -20 9 0 0 0 0 5 0 1 0 2-4disc.dat
  [1,4,0,37,-20,9,0,0,0,0,5,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 
// 0 earrings
// 1 15 32 34 -20 4 0 0 0 0 4 0 1 0 4-4disc.dat
  [1,15,32,34,-20,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 15 -32 34 -20 4 0 0 0 0 4 0 1 0 4-4disc.dat
  [1,15,-32,34,-20,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 
// 0 pattern background
// 1 16 32 34 -20 4 0 0 0 0 4 0 1 0 4-4ndis.dat
  [1,16,32,34,-20,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -32 34 -20 4 0 0 0 0 4 0 1 0 4-4ndis.dat
  [1,16,-32,34,-20,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 12 38 -20 16 0 0 0 0 9.5 0 1 0 1-4ndis.dat
  [1,16,12,38,-20,16,0,0,0,0,9.5,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -12 38 -20 -16 0 0 0 0 9.5 0 1 0 1-4ndis.dat
  [1,16,-12,38,-20,-16,0,0,0,0,9.5,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 
// 1 16 -20 20 -20 -20 0 0 0 0 -20 0 1 0 1-4chrd.dat
  [1,16,-20,20,-20,-20,0,0,0,0,-20,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 20 20 -20 20 0 0 0 0 -20 0 1 0 1-4chrd.dat
  [1,16,20,20,-20,20,0,0,0,0,-20,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 0
];
module ldraw_lib__4744p04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4744p04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
