...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 826p02, Rebrickable 826pr0002, Set 338
// 
// 0 !CMDLINE -c47
// 
...
module ldraw_lib__826ap02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__826ap02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
