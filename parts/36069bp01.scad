...
$fa=1; $fs=0.2;
function ldraw_lib__36069bp01(realsolid=false) = [
// 0 Sheet Plastic 13 x 26 Triangular Sail with Technic Racing Yacht Pattern
...
// 1 16 -.25 0 0 -1 0 0 0 1 0 0 0 1 s\36069bp01s01.dat
  [1,16,-.25,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__36069bp01s01(realsolid)],
// 1 16 .25 0 0 1 0 0 0 1 0 0 0 1 s\36069bp01s01.dat
  [1,16,.25,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__36069bp01s01(realsolid)],
// 0 !TEXMAP END
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\36069bs02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__36069bs02(realsolid)],
];
module ldraw_lib__36069bp01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__36069bp01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
