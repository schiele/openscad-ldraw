...
$fa=1; $fs=0.2;
function ldraw_lib__53540(realsolid=false) = [
...
// 1 16 -10 10 -10 0 0 1 1 0 0 0 1 0 confric10.dat
  [1,16,-10,10,-10,0,0,1,1,0,0,0,1,0, ldraw_lib__confric10(realsolid)],
// 1 16 10 10 -10 0 0 1 1 0 0 0 1 0 confric10.dat
  [1,16,10,10,-10,0,0,1,1,0,0,0,1,0, ldraw_lib__confric10(realsolid)],
// 1 16 -10 10 -10 2.82843 0 2.82843 2.82843 0 -2.82843 0 1 0 1-4edge.dat
  [1,16,-10,10,-10,2.82843,0,2.82843,2.82843,0,-2.82843,0,1,0, ldraw_lib__1_4edge(realsolid)],
...
module ldraw_lib__53540(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__53540(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
