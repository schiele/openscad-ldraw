...
use <3626b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3626(realsolid=false) = [
// 0 ~Moved to 3626b
// 0 Name: 3626.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3626b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3626b(realsolid)],
];
module ldraw_lib__3626(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3626(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
