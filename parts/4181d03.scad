...
use <195475a.scad>
use <4181.scad>
function ldraw_lib__4181d03() = [
// 0 Train Door  1 x  4 x  5 Left with White DB 7755 Sticker
// 0 Name: 4181d03.dat
...
module ldraw_lib__4181d03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4181d03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
