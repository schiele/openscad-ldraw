...
use <s/3846s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3846p4n(realsolid=false) = [
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\3846p4ns01.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3846p4ns01(realsolid)],
// 1 4 0 0 0 -1 0 0 0 1 0 0 0 1 s\3846p4ns01.dat
  [1,4,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3846p4ns01(realsolid)],
];
module ldraw_lib__3846p4n(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3846p4n(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
