...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 62537p03.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__62537p03()],
];
module ldraw_lib__4585450(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4585450(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
