...
use <../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__678(realsolid=false) = [
...
// 1 16 43 -17 22 0 0 5 0 -1 0 5 0 0 1-4chrd.dat
  [1,16,43,-17,22,0,0,5,0,-1,0,5,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -43 -17 22 0 0 -5 0 -1 0 5 0 0 1-4chrd.dat
  [1,16,-43,-17,22,0,0,-5,0,-1,0,5,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 8 -17 22 0 0 -5 0 -1 0 5 0 0 1-4chrd.dat
  [1,16,8,-17,22,0,0,-5,0,-1,0,5,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -8 -17 22 0 0 5 0 -1 0 5 0 0 1-4chrd.dat
  [1,16,-8,-17,22,0,0,5,0,-1,0,5,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 43 -20 22 0 0 5 0 1 0 5 0 0 1-4chrd.dat
  [1,16,43,-20,22,0,0,5,0,1,0,5,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -43 -20 22 0 0 -5 0 1 0 5 0 0 1-4chrd.dat
  [1,16,-43,-20,22,0,0,-5,0,1,0,5,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 8 -20 22 0 0 -5 0 1 0 5 0 0 1-4chrd.dat
  [1,16,8,-20,22,0,0,-5,0,1,0,5,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -8 -20 22 0 0 5 0 1 0 5 0 0 1-4chrd.dat
  [1,16,-8,-20,22,0,0,5,0,1,0,5,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 43 -17 22 0 0 5 0 -3 0 5 0 0 1-4cylo.dat
  [1,16,43,-17,22,0,0,5,0,-3,0,5,0,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -43 -17 22 0 0 -5 0 -3 0 5 0 0 1-4cylo.dat
  [1,16,-43,-17,22,0,0,-5,0,-3,0,5,0,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 8 -17 22 0 0 -5 0 -3 0 5 0 0 1-4cylo.dat
  [1,16,8,-17,22,0,0,-5,0,-3,0,5,0,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -8 -17 22 0 0 5 0 -3 0 5 0 0 1-4cylo.dat
  [1,16,-8,-17,22,0,0,5,0,-3,0,5,0,0, ldraw_lib__1_4cylo(realsolid)],
...
// 1 16 25.5 -18.5 27 -17.5 0 0 0 0 -1.5 0 -1 0 rect2p.dat
  [1,16,25.5,-18.5,27,-17.5,0,0,0,0,-1.5,0,-1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 25.5 -18.5 20 22.5 0 0 0 0 -1.5 0 2 0 box4o4a.dat
  [1,16,25.5,-18.5,20,22.5,0,0,0,0,-1.5,0,2,0, ldraw_lib__box4o4a(realsolid)],
// 1 16 -25.5 -18.5 27 17.5 0 0 0 0 1.5 0 -1 0 rect2p.dat
  [1,16,-25.5,-18.5,27,17.5,0,0,0,0,1.5,0,-1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 -15.6 16 0 0 -46 -2.6 0 0 0 1 0 rect.dat
  [1,16,0,-15.6,16,0,0,-46,-2.6,0,0,0,1,0, ldraw_lib__rect(realsolid)],
...
// 1 16 0 -15.6 10.25 0 0 46 -2.6 -529 0 5.75 -239.2 0 rect2p.dat
  [1,16,0,-15.6,10.25,0,0,46,-2.6,-529,0,5.75,-239.2,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 -22.2 16 0 0 -50 -1.8 20 0 4 9 0 rect2p.dat
  [1,16,0,-22.2,16,0,0,-50,-1.8,20,0,4,9,0, ldraw_lib__rect2p(realsolid)],
];
module ldraw_lib__678(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__678(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
