...
use <s/3009s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3009p27(realsolid=false) = [
...
// 1 16 -0.5 11.25 -10 1 0 0 0 0 -1 0 1 0 s\3009p27a.dat
  [1,16,-0.5,11.25,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__s__3009p27a(realsolid)],
...
module ldraw_lib__3009p27(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3009p27(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
