...
use <6141875m.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3298dy1(realsolid=false) = [
...
// 1 16 0 10 -30 0 0 1 .447214 .894427 0 -.894427 .447214 0 6141875m.dat
  [1,16,0,10,-30,0,0,1,.447214,.894427,0,-.894427,.447214,0, ldraw_lib__6141875m(realsolid)],
];
module ldraw_lib__3298dy1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3298dy1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
