...
use <s/3069bs18.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3002p18b(realsolid=false) = [
...
// 1 16 0 12 -20 1.6 0 0 0 0 -1.1 0 1.6 0 s\3069bs18.dat
  [1,16,0,12,-20,1.6,0,0,0,0,-1.1,0,1.6,0, ldraw_lib__s__3069bs18(realsolid)],
// 
...
module ldraw_lib__3002p18b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3002p18b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
