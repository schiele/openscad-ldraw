...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 60593.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__60593()],
// 1 47 0 0 0 1 0 0 0 1 0 0 0 1 60602.dat
  [1,47,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__60602()],
// 0
];
module ldraw_lib__60593c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__60593c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
