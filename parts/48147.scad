...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 47974c01, Rebrickable 47974c01
// 
// 0 !HISTORY 2013-07-21 [PTadmin] Official Update 2013-01
// 
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 47974.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__47974()],
// 1 16 -20 10 0 0 0 -1 0 1 0 1 0 0 42865.dat
  [1,16,-20,10,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__42865()],
// 1 16 20 10 0 0 0 -1 0 1 0 1 0 0 42865.dat
  [1,16,20,10,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__42865()],
// 0 //
];
module ldraw_lib__48147(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48147(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
