...
use <s/24309s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__24309(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\24309s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__24309s01(realsolid)],
// 1 16 -20 68.2828 30 0 40 0 -68.2828 0 0 0 0 -84.8536 48\1-8cyli.dat
  [1,16,-20,68.2828,30,0,40,0,-68.2828,0,0,0,0,-84.8536, ldraw_lib__48__1_8cyli(realsolid)],
];
module ldraw_lib__24309(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__24309(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
