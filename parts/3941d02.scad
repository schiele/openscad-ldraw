...
// 1 16 0 10 -20 1 0 0 0 0 -1 0 1 0 165395ec01.dat
  [1,16,0,10,-20,1,0,0,0,0,-1,0,1,0, ldraw_lib__165395ec01()],
];
module ldraw_lib__3941d02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3941d02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
