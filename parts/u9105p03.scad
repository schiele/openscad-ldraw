...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9105s08.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9105s08()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9105s08.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9105s08()],
// 0 // Whiskers
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9105s09.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9105s09()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9105s09.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9105s09()],
// 0 // Forehead
...
module ldraw_lib__u9105p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9105p03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
