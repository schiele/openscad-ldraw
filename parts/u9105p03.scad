...
use <s/u9105s09.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9105p03(realsolid=false) = [
// 0 ~Figure Fabuland Mouse Head  3
// 0 Name: u9105p03.dat
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9105s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9105s01(realsolid)],
// 0 // Eyes
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9105s08.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9105s08(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9105s08.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9105s08(realsolid)],
// 0 // Whiskers
...
module ldraw_lib__u9105p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9105p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9105p03(line=0.2);