...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30185(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30185s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30185s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\30185s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30185s01(realsolid)],
...
// 1 16 0 26 -10 36 0 0 0 0 19 0 4 0 box4.dat
  [1,16,0,26,-10,36,0,0,0,0,19,0,4,0, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 70 -10 36 0 0 0 0 19 0 4 0 box4.dat
  [1,16,0,70,-10,36,0,0,0,0,19,0,4,0, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 114 -10 36 0 0 0 0 19 0 4 0 box4.dat
  [1,16,0,114,-10,36,0,0,0,0,19,0,4,0, ldraw_lib__box4(realsolid)],
...
// 1 16 0 2 10 40 0 0 0 0 2 0 -1 0 rect.dat
  [1,16,0,2,10,40,0,0,0,0,2,0,-1,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__30185(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30185(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
