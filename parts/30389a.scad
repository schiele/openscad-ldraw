...
// 1 16 -2 24 0 0 0 -18 0 -24 0 -20 0 0 box4-4a.dat
  [1,16,-2,24,0,0,0,-18,0,-24,0,-20,0,0, ldraw_lib__box4_4a()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 24 0 0 0 -16 0 -20 0 -16 0 0 box4-4a.dat
  [1,16,0,24,0,0,0,-16,0,-20,0,-16,0,0, ldraw_lib__box4_4a()],
// 1 16 17.5 0 0 0 0 2.5 0 1 0 20 0 0 rect3.dat
  [1,16,17.5,0,0,0,0,2.5,0,1,0,20,0,0, ldraw_lib__rect3()],
...
// 1 16 18.5 21.5 0 0 0 1.5 0 -1 -1.5 20 0 0 rect3.dat
  [1,16,18.5,21.5,0,0,0,1.5,0,-1,-1.5,20,0,0, ldraw_lib__rect3()],
// 1 16 16.5 23.5 -18 0 -1 -0.5 0 0 0.5 -2 0 0 rect3.dat
  [1,16,16.5,23.5,-18,0,-1,-0.5,0,0,0.5,-2,0,0, ldraw_lib__rect3()],
// 1 16 16.5 23.5 18 0 -1 -0.5 0 0 0.5 -2 0 0 rect3.dat
  [1,16,16.5,23.5,18,0,-1,-0.5,0,0,0.5,-2,0,0, ldraw_lib__rect3()],
...
// 1 16 16.5 23 0 0 0 0.5 0 -1 0 16 0 0 rect3.dat
  [1,16,16.5,23,0,0,0,0.5,0,-1,0,16,0,0, ldraw_lib__rect3()],
// 3 16 16 23 16 16 24 16 17 23 16
  [3,16,16,23,16,16,24,16,17,23,16],
// 3 16 16 23 -16 17 23 -16 16 24 -16
  [3,16,16,23,-16,17,23,-16,16,24,-16],
// 4 16 16 24 -16 16 24 -20 -20 24 -20 -16 24 -16
  [4,16,16,24,-16,16,24,-20,-20,24,-20,-16,24,-16],
// 4 16 -20 24 20 -16 24 16 -16 24 -16 -20 24 -20
  [4,16,-20,24,20,-16,24,16,-16,24,-16,-20,24,-20],
// 4 16 16 24 20 16 24 16 -16 24 16 -20 24 20
  [4,16,16,24,20,16,24,16,-16,24,16,-20,24,20],
// 4 16 20 20 20 16 24 20 16 0 20 20 0 20
  [4,16,20,20,20,16,24,20,16,0,20,20,0,20],
// 4 16 16 24 -20 20 20 -20 20 0 -20 16 0 -20
  [4,16,16,24,-20,20,20,-20,20,0,-20,16,0,-20],
// 0
];
module ldraw_lib__30389a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30389a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
