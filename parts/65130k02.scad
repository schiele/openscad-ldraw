...
use <../p/4-8sphe.scad>
use <../p/bump5000.scad>
function ldraw_lib__65130k02() = [
// 0 ~Strap  2 x 16 with End Rings - Strap Segment
// 0 Name: 65130k02.dat
...
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 3 0 0 0 -2 0 0 0 3 bump5000.dat
  [1,16,0,0,0,3,0,0,0,-2,0,0,0,3, ldraw_lib__bump5000()],
...
module ldraw_lib__65130k02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__65130k02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__65130k02(line=0.2);