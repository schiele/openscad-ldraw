...
use <4593.scad>
$fa=1; $fs=0.2;
function ldraw_lib__73587p03(realsolid=false) = [
...
// 1 7 0 -2 0 1 0 0 0 1 0 0 0 1 4593.dat
  [1,7,0,-2,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4593(realsolid)],
];
module ldraw_lib__73587p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73587p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
