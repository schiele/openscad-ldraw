...
use <s/90391s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__90391p01(realsolid=false) = [
...
// 1 80 0 -59.7 0 1 0 0 0 1 0 0 0 1 s\90391s01.dat
  [1,80,0,-59.7,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__90391s01(realsolid)],
// 1 80 0 -59.7 0 -1 0 0 0 1 0 0 0 1 s\90391s01.dat
  [1,80,0,-59.7,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__90391s01(realsolid)],
// 1 80 0 -59.7 0 1 0 0 0 1 0 0 0 -1 s\90391s01.dat
  [1,80,0,-59.7,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__90391s01(realsolid)],
...
module ldraw_lib__90391p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__90391p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
