...
// 1 16 0 12 -39 6 0 0 0 0 -6 0 1 0 4-4ndis.dat
  [1,16,0,12,-39,6,0,0,0,0,-6,0,1,0, ldraw_lib__4_4ndis()],
// 1 16 0 12 -39 6 0 0 0 0 -6 0 1 0 4-4edge.dat
  [1,16,0,12,-39,6,0,0,0,0,-6,0,1,0, ldraw_lib__4_4edge()],
// 1 16 0 12 -36 6 0 0 0 0 -6 0 1 0 4-4edge.dat
  [1,16,0,12,-36,6,0,0,0,0,-6,0,1,0, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 12 -39 6 0 0 0 0 -6 0 3 0 4-4cyli.dat
  [1,16,0,12,-39,6,0,0,0,0,-6,0,3,0, ldraw_lib__4_4cyli()],
// 1 16 0 -2 -39 6 0 0 0 0 -6 0 1 0 4-4ndis.dat
  [1,16,0,-2,-39,6,0,0,0,0,-6,0,1,0, ldraw_lib__4_4ndis()],
// 1 16 0 -2 -39 6 0 0 0 0 -6 0 1 0 4-4edge.dat
  [1,16,0,-2,-39,6,0,0,0,0,-6,0,1,0, ldraw_lib__4_4edge()],
// 1 16 0 -2 -36 6 0 0 0 0 -6 0 1 0 4-4edge.dat
  [1,16,0,-2,-36,6,0,0,0,0,-6,0,1,0, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -2 -39 6 0 0 0 0 -6 0 3 0 4-4cyli.dat
  [1,16,0,-2,-39,6,0,0,0,0,-6,0,3,0, ldraw_lib__4_4cyli()],
...
// 1 16 0 12 -36 6 0 0 0 0 -6 0 -1 0 4-4ndis.dat
  [1,16,0,12,-36,6,0,0,0,0,-6,0,-1,0, ldraw_lib__4_4ndis()],
// 1 16 0 -2 -36 6 0 0 0 0 -6 0 -1 0 4-4ndis.dat
  [1,16,0,-2,-36,6,0,0,0,0,-6,0,-1,0, ldraw_lib__4_4ndis()],
];
module ldraw_lib__u9110(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9110(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
