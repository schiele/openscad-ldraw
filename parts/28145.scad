...
use <s/28145s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__28145(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\28145s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__28145s02(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\28145s03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__28145s03(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\28145s03.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__28145s03(realsolid)],
];
module ldraw_lib__28145(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__28145(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
