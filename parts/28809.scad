...
use <18677.scad>
$fa=1; $fs=0.2;
function ldraw_lib__28809(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 18677.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__18677(realsolid)],
];
module ldraw_lib__28809(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__28809(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
