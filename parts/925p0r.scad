...
use <s/925s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__925p0r(realsolid=false) = [
...
// 1 10 0 0 0 1 0 0 0 1 0 0 0 1 s\925p0rs01.dat
  [1,10,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__925p0rs01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\925p0rs02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__925p0rs02(realsolid)],
];
module ldraw_lib__925p0r(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__925p0r(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
