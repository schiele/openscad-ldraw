...
$fa=1; $fs=0.2;
function ldraw_lib__6229(realsolid=false) = [
...
// 1 16 18 0 18 2 0 0 0 4 0 0 0 2 1-4cylc.dat
  [1,16,18,0,18,2,0,0,0,4,0,0,0,2, ldraw_lib__1_4cylc(realsolid)],
// 1 16 -18 0 18 0 0 -2 0 4 0 2 0 0 1-4cylc.dat
  [1,16,-18,0,18,0,0,-2,0,4,0,2,0,0, ldraw_lib__1_4cylc(realsolid)],
// 1 16 -18 0 -18 -2 0 0 0 4 0 0 0 -2 1-4cylc.dat
  [1,16,-18,0,-18,-2,0,0,0,4,0,0,0,-2, ldraw_lib__1_4cylc(realsolid)],
// 1 16 18 0 -18 0 0 2 0 4 0 -2 0 0 1-4cylc.dat
  [1,16,18,0,-18,0,0,2,0,4,0,-2,0,0, ldraw_lib__1_4cylc(realsolid)],
// 1 16 18 4 -18 0 0 2 0 -1 0 -2 0 0 1-4chrd.dat
  [1,16,18,4,-18,0,0,2,0,-1,0,-2,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -18 4 -18 -2 0 0 0 -1 0 0 0 -2 1-4chrd.dat
  [1,16,-18,4,-18,-2,0,0,0,-1,0,0,0,-2, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -18 4 18 0 0 -2 0 -1 0 2 0 0 1-4chrd.dat
  [1,16,-18,4,18,0,0,-2,0,-1,0,2,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 18 4 18 2 0 0 0 -1 0 0 0 2 1-4chrd.dat
  [1,16,18,4,18,2,0,0,0,-1,0,0,0,2, ldraw_lib__1_4chrd(realsolid)],
// 1 16 0 4 0 0 0 20 0 -4 0 -18 0 0 box3u8p.dat
  [1,16,0,4,0,0,0,20,0,-4,0,-18,0,0, ldraw_lib__box3u8p(realsolid)],
// 1 16 0 2 -19 -18 0 0 0 -2 0 0 0 -1 box2-11.dat
  [1,16,0,2,-19,-18,0,0,0,-2,0,0,0,-1, ldraw_lib__box2_11(realsolid)],
// 1 16 0 2 19 18 0 0 0 -2 0 0 0 1 box2-11.dat
  [1,16,0,2,19,18,0,0,0,-2,0,0,0,1, ldraw_lib__box2_11(realsolid)],
// 1 16 2 26 16 0 2 0 6 0 0 0 0 6 4-4cyli.dat
  [1,16,2,26,16,0,2,0,6,0,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 4 26 16 0 1 0 6 0 0 0 0 6 4-4edge.dat
  [1,16,4,26,16,0,1,0,6,0,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 -4 26 16 0 1 0 6 0 0 0 0 6 4-4edge.dat
  [1,16,-4,26,16,0,1,0,6,0,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 -2 26 16 0 4 0 6 0 0 0 0 -6 5-16cyli.dat
  [1,16,-2,26,16,0,4,0,6,0,0,0,0,-6, ldraw_lib__5_16cyli(realsolid)],
// 1 16 -2 26 16 0 4 0 6 0 0 0 0 6 3-8cyli.dat
  [1,16,-2,26,16,0,4,0,6,0,0,0,0,6, ldraw_lib__3_8cyli(realsolid)],
// 1 16 -4 26 16 0 2 0 6 0 0 0 0 6 4-4cyli.dat
  [1,16,-4,26,16,0,2,0,6,0,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 12.797 20 2 0 0 0 0 8.797 0 -1 0 rect3.dat
  [1,16,0,12.797,20,2,0,0,0,0,8.797,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 13.852 2.228 0 0 2 9.852 0 0 8.228 1 0 rect.dat
  [1,16,0,13.852,2.228,0,0,2,9.852,0,0,8.228,1,0, ldraw_lib__rect(realsolid)],
// 1 16 2 26 16 0 -1 0 -5.543 0 -2.296 2.296 0 -5.543 1-4ndis.dat
  [1,16,2,26,16,0,-1,0,-5.543,0,-2.296,2.296,0,-5.543, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -2 26 16 0 1 0 -5.543 0 -2.296 2.296 0 -5.543 1-4ndis.dat
  [1,16,-2,26,16,0,1,0,-5.543,0,-2.296,2.296,0,-5.543, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 2 26 16 0 -1 0 -5.543 0 -2.296 2.296 0 -5.543 1-4edge.dat
  [1,16,2,26,16,0,-1,0,-5.543,0,-2.296,2.296,0,-5.543, ldraw_lib__1_4edge(realsolid)],
// 1 16 -2 26 16 0 -1 0 -5.543 0 -2.296 2.296 0 -5.543 1-4edge.dat
  [1,16,-2,26,16,0,-1,0,-5.543,0,-2.296,2.296,0,-5.543, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 -4 26 16 0 1 0 2 0 0 0 0 2 4-4ring2.dat
  [1,16,-4,26,16,0,1,0,2,0,0,0,0,2, ldraw_lib__4_4ring2(realsolid)],
// 1 16 4 26 16 0 -1 0 2 0 0 0 0 2 4-4ring2.dat
  [1,16,4,26,16,0,-1,0,2,0,0,0,0,2, ldraw_lib__4_4ring2(realsolid)],
// 1 16 4 26 16 0 3 0 4 0 0 0 0 4 4-4cylo.dat
  [1,16,4,26,16,0,3,0,4,0,0,0,0,4, ldraw_lib__4_4cylo(realsolid)],
// 1 16 11 26 16 0 2.5 0 4 0 0 0 0 4 4-4cylo.dat
  [1,16,11,26,16,0,2.5,0,4,0,0,0,0,4, ldraw_lib__4_4cylo(realsolid)],
// 1 16 11 26 16 0 -0.5 0 0.5 0 0 0 0 0.5 4-4con7.dat
  [1,16,11,26,16,0,-0.5,0,0.5,0,0,0,0,0.5, ldraw_lib__4_4con7(realsolid)],
// 1 16 7 26 16 0 0.5 0 0.5 0 0 0 0 0.5 4-4con7.dat
  [1,16,7,26,16,0,0.5,0,0.5,0,0,0,0,0.5, ldraw_lib__4_4con7(realsolid)],
// 1 16 13.5 26 16 0 0.5 0 0.5 0 0 0 0 0.5 4-4con7.dat
  [1,16,13.5,26,16,0,0.5,0,0.5,0,0,0,0,0.5, ldraw_lib__4_4con7(realsolid)],
// 1 16 7.5 26 16 0 3 0 3.5 0 0 0 0 3.5 4-4cylo.dat
  [1,16,7.5,26,16,0,3,0,3.5,0,0,0,0,3.5, ldraw_lib__4_4cylo(realsolid)],
// 1 16 14 26 16 0 1 0 3.5 0 0 0 0 3.5 4-4edge.dat
  [1,16,14,26,16,0,1,0,3.5,0,0,0,0,3.5, ldraw_lib__4_4edge(realsolid)],
// 1 16 14 26 16 0 -1 0 3.5 0 0 0 0 3.5 4-4disc.dat
  [1,16,14,26,16,0,-1,0,3.5,0,0,0,0,3.5, ldraw_lib__4_4disc(realsolid)],
// 1 16 -4 26 16 0 -3 0 4 0 0 0 0 -4 4-4cylo.dat
  [1,16,-4,26,16,0,-3,0,4,0,0,0,0,-4, ldraw_lib__4_4cylo(realsolid)],
// 1 16 -11 26 16 0 -2.5 0 4 0 0 0 0 -4 4-4cylo.dat
  [1,16,-11,26,16,0,-2.5,0,4,0,0,0,0,-4, ldraw_lib__4_4cylo(realsolid)],
...
module ldraw_lib__6229(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6229(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
