...
use <s/93598s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__93598(realsolid=false) = [
...
// 1 16 20 0 0 10 0 0 0 40 0 0 -20 -10 1-4cyli.dat
  [1,16,20,0,0,10,0,0,0,40,0,0,-20,-10, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -20 0 0 -10 0 0 0 40 0 0 -20 -10 1-4cyli.dat
  [1,16,-20,0,0,-10,0,0,0,40,0,0,-20,-10, ldraw_lib__1_4cyli(realsolid)],
...
module ldraw_lib__93598(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__93598(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
