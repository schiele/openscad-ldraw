...
use <u9087.scad>
$fa=1; $fs=0.2;
function ldraw_lib__60797c04(realsolid=false) = [
...
// 1 47 0 0 0 1 0 0 0 1 0 0 0 1 u9087.dat
  [1,47,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9087(realsolid)],
];
module ldraw_lib__60797c04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__60797c04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
