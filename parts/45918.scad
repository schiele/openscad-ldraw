...
// 1 16 -19 0 0 0 1 0 4 0 0 0 0 4 4-4disc.dat
  [1,16,-19,0,0,0,1,0,4,0,0,0,0,4, ldraw_lib__4_4disc()],
...
// 1 16 -24 0 0 0 1 0 4 0 0 0 0 4 4-4edge.dat
  [1,16,-24,0,0,0,1,0,4,0,0,0,0,4, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -24 0 0 0 5 0 4 0 0 0 0 4 4-4cyli.dat
  [1,16,-24,0,0,0,5,0,4,0,0,0,0,4, ldraw_lib__4_4cyli()],
// 1 16 -24 0 0 0 1 0 2 0 0 0 0 2 4-4ring2.dat
  [1,16,-24,0,0,0,1,0,2,0,0,0,0,2, ldraw_lib__4_4ring2()],
// 1 16 -24 0 0 0 -1 0 6 0 0 0 0 6 4-4edge.dat
  [1,16,-24,0,0,0,-1,0,6,0,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 -22 0 0 0 -2 0 2 0 0 0 0 2 4-4con3.dat
  [1,16,-22,0,0,0,-2,0,2,0,0,0,0,2, ldraw_lib__4_4con3()],
// 1 16 -14.5 0 0 0 -7.5 0 8 0 0 0 0 8 4-4cyli.dat
  [1,16,-14.5,0,0,0,-7.5,0,8,0,0,0,0,8, ldraw_lib__4_4cyli()],
// 1 16 -14.5 0 0 0 -1 0 8 0 0 0 0 8 4-4edge.dat
  [1,16,-14.5,0,0,0,-1,0,8,0,0,0,0,8, ldraw_lib__4_4edge()],
// 1 16 -22 0 0 0 -1 0 8 0 0 0 0 8 4-4edge.dat
  [1,16,-22,0,0,0,-1,0,8,0,0,0,0,8, ldraw_lib__4_4edge()],
// 1 16 -14.5 0 0 0 2 0 2 0 0 0 0 2 4-4con3.dat
  [1,16,-14.5,0,0,0,2,0,2,0,0,0,0,2, ldraw_lib__4_4con3()],
// 1 16 -12.5 0 0 0 -1 0 6 0 0 0 0 6 4-4edge.dat
  [1,16,-12.5,0,0,0,-1,0,6,0,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 -12.5 0 0 0 -1 0 1 0 0 0 0 1 4-4ring5.dat
  [1,16,-12.5,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__4_4ring5()],
// 1 16 -4 0 0 0 -8.5 0 5 0 0 0 0 5 4-4cyli.dat
  [1,16,-4,0,0,0,-8.5,0,5,0,0,0,0,5, ldraw_lib__4_4cyli()],
// 1 16 -4 0 0 0 -8.5 0 5 0 0 0 0 5 4-4edge.dat
  [1,16,-4,0,0,0,-8.5,0,5,0,0,0,0,5, ldraw_lib__4_4edge()],
// 1 16 -12.5 0 0 0 -8.5 0 5 0 0 0 0 5 4-4edge.dat
  [1,16,-12.5,0,0,0,-8.5,0,5,0,0,0,0,5, ldraw_lib__4_4edge()],
// 1 16 -4 0 0 0 -1 0 1 0 0 0 0 1 4-4ring4.dat
  [1,16,-4,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__4_4ring4()],
// 1 16 -4 0 0 0 8 0 4 0 0 0 0 4 4-4cyli.dat
  [1,16,-4,0,0,0,8,0,4,0,0,0,0,4, ldraw_lib__4_4cyli()],
...
module ldraw_lib__45918(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__45918(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
