...
// 
// 0 !CATEGORY Vehicle
// 0 !KEYWORDS BrickLink bb0046, Rebrickable 384
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 u9236c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9236c01()],
// 1 4 -50 58 40 0 0 1 1 0 0 0 1 0 7039.dat
  [1,4,-50,58,40,0,0,1,1,0,0,0,1,0, ldraw_lib__7039()],
// 1 4 50 58 40 0 0 -1 1 0 0 0 -1 0 7039.dat
  [1,4,50,58,40,0,0,-1,1,0,0,0,-1,0, ldraw_lib__7039()],
];
module ldraw_lib__u9236c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9236c02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
