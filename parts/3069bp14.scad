...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3069pb0017, Rebrickable 3069bpr9981, set 2126
// 
...
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 s\3069p06b.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3069p06b()],
...
module ldraw_lib__3069bp14(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3069bp14(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
