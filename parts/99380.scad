...
use <99397.scad>
$fa=1; $fs=0.2;
function ldraw_lib__99380(realsolid=false) = [
...
// 1 71 0 -69 -20 1 0 0 0 1 0 0 0 1 99397.dat
  [1,71,0,-69,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__99397(realsolid)],
...
// 1 71 0 0 0 1 0 0 0 1 0 0 0 1 99377p01.dat
  [1,71,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__99377p01(realsolid)],
];
module ldraw_lib__99380(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__99380(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
