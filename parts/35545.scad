...
// 1 16 0 0 0 6.5 0 0 0 1 0 0 0 1.5 box5.dat
  [1,16,0,0,0,6.5,0,0,0,1,0,0,0,1.5, ldraw_lib__box5()],
...
module ldraw_lib__35545(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__35545(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
