...
// 1 324 0 -14 -17 1 0 0 0 1 0 0 0 1 14149.dat
  [1,324,0,-14,-17,1,0,0,0,1,0,0,0,1, ldraw_lib__14149()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 57518.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__57518()],
];
module ldraw_lib__57518c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__57518c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
