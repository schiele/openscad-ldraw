...
use <s/3009s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3009p01(realsolid=false) = [
...
// 1 0 51.3 8.2 -10 3 0 0 0 0 -3 0 1 0 1-4chrd.dat
  [1,0,51.3,8.2,-10,3,0,0,0,0,-3,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 51.3 8.2 -10 1 0 0 0 0 -1 0 1 0 1-4ring3.dat
  [1,16,51.3,8.2,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__1_4ring3(realsolid)],
// 1 0 43.5 8.2 -10 0 0 -3 -3 0 0 0 1 0 1-4chrd.dat
  [1,0,43.5,8.2,-10,0,0,-3,-3,0,0,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 43.5 8.2 -10 0 0 -3 -3 0 0 0 1 0 1-4ndis.dat
  [1,16,43.5,8.2,-10,0,0,-3,-3,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 0 43.5 15.8 -10 -3 0 0 0 0 3 0 1 0 1-4chrd.dat
  [1,0,43.5,15.8,-10,-3,0,0,0,0,3,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 43.5 15.8 -10 -3 0 0 0 0 3 0 1 0 1-4ndis.dat
  [1,16,43.5,15.8,-10,-3,0,0,0,0,3,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 0 51.3 15.8 -10 0 0 3 3 0 0 0 1 0 1-4chrd.dat
  [1,0,51.3,15.8,-10,0,0,3,3,0,0,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 51.3 15.8 -10 0 0 1 1 0 0 0 1 0 1-4ring3.dat
  [1,16,51.3,15.8,-10,0,0,1,1,0,0,0,1,0, ldraw_lib__1_4ring3(realsolid)],
...
// 1 0 -43.5 8.2 -10 3 0 0 0 0 -3 0 1 0 1-4chrd.dat
  [1,0,-43.5,8.2,-10,3,0,0,0,0,-3,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -43.5 8.2 -10 3 0 0 0 0 -3 0 1 0 1-4ndis.dat
  [1,16,-43.5,8.2,-10,3,0,0,0,0,-3,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 0 -51.3 8.2 -10 0 0 -1 -1 0 0 0 1 0 1-4ring4.dat
  [1,0,-51.3,8.2,-10,0,0,-1,-1,0,0,0,1,0, ldraw_lib__1_4ring4(realsolid)],
// 1 0 -51.3 8.2 -10 0 0 -0.5 -0.5 0 0 0 1 0 1-4rin10.dat
  [1,0,-51.3,8.2,-10,0,0,-0.5,-0.5,0,0,0,1,0, ldraw_lib__1_4rin10(realsolid)],
// 1 16 -51.3 8.2 -10 0 0 -5.5 -5.5 0 0 0 1 0 1-4ndis.dat
  [1,16,-51.3,8.2,-10,0,0,-5.5,-5.5,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 0 -51.3 15.8 -10 -1 0 0 0 0 1 0 1 0 1-4ring4.dat
  [1,0,-51.3,15.8,-10,-1,0,0,0,0,1,0,1,0, ldraw_lib__1_4ring4(realsolid)],
// 1 0 -51.3 15.8 -10 -0.5 0 0 0 0 0.5 0 1 0 1-4rin10.dat
  [1,0,-51.3,15.8,-10,-0.5,0,0,0,0,0.5,0,1,0, ldraw_lib__1_4rin10(realsolid)],
// 1 16 -51.3 15.8 -10 -5.5 0 0 0 0 5.5 0 1 0 1-4ndis.dat
  [1,16,-51.3,15.8,-10,-5.5,0,0,0,0,5.5,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 0 51.3 15.8 -10 0 0 1 1 0 0 0 1 0 1-4ring4.dat
  [1,0,51.3,15.8,-10,0,0,1,1,0,0,0,1,0, ldraw_lib__1_4ring4(realsolid)],
// 1 0 51.3 15.8 -10 0 0 0.5 0.5 0 0 0 1 0 1-4rin10.dat
  [1,0,51.3,15.8,-10,0,0,0.5,0.5,0,0,0,1,0, ldraw_lib__1_4rin10(realsolid)],
// 1 16 51.3 15.8 -10 0 0 5.5 5.5 0 0 0 1 0 1-4ndis.dat
  [1,16,51.3,15.8,-10,0,0,5.5,5.5,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 0 51.3 8.2 -10 1 0 0 0 0 -1 0 1 0 1-4ring4.dat
  [1,0,51.3,8.2,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__1_4ring4(realsolid)],
// 1 16 51.3 8.2 -10 5.5 0 0 0 0 -5.5 0 1 0 1-4ndis.dat
  [1,16,51.3,8.2,-10,5.5,0,0,0,0,-5.5,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 0 51.3 8.2 -10 0.5 0 0 0 0 -0.5 0 1 0 1-4rin10.dat
  [1,0,51.3,8.2,-10,0.5,0,0,0,0,-0.5,0,1,0, ldraw_lib__1_4rin10(realsolid)],
// 1 0 -51.3 8.2 -10 0 0 -3 -3 0 0 0 1 0 1-4chrd.dat
  [1,0,-51.3,8.2,-10,0,0,-3,-3,0,0,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -51.3 8.2 -10 0 0 -1 -1 0 0 0 1 0 1-4ring3.dat
  [1,16,-51.3,8.2,-10,0,0,-1,-1,0,0,0,1,0, ldraw_lib__1_4ring3(realsolid)],
// 1 0 -51.3 15.8 -10 -3 0 0 0 0 3 0 1 0 1-4chrd.dat
  [1,0,-51.3,15.8,-10,-3,0,0,0,0,3,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -51.3 15.8 -10 -1 0 0 0 0 1 0 1 0 1-4ring3.dat
  [1,16,-51.3,15.8,-10,-1,0,0,0,0,1,0,1,0, ldraw_lib__1_4ring3(realsolid)],
// 1 0 -43.5 15.8 -10 0 0 3 3 0 0 0 1 0 1-4chrd.dat
  [1,0,-43.5,15.8,-10,0,0,3,3,0,0,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -43.5 15.8 -10 0 0 3 3 0 0 0 1 0 1-4ndis.dat
  [1,16,-43.5,15.8,-10,0,0,3,3,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
];
module ldraw_lib__3009p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3009p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
