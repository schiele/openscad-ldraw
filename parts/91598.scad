...
use <2486.scad>
$fa=1; $fs=0.2;
function ldraw_lib__91598(realsolid=false) = [
// 0 =Bar  1 x  8 x  2
// 0 Name: 91598.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2486.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2486(realsolid)],
];
module ldraw_lib__91598(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__91598(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
