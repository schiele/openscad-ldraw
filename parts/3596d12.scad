...
use <3596.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3596d12(realsolid=false) = [
...
// 1 16 2 -132 34 0 -1 0 0 0 -1 1 0 0 003432c.dat
  [1,16,2,-132,34,0,-1,0,0,0,-1,1,0,0, ldraw_lib__003432c(realsolid)],
// 0 // Sticker Back
// 1 16 -2 -132 34 0 1 0 0 0 -1 1 0 0 003432c.dat
  [1,16,-2,-132,34,0,1,0,0,0,-1,1,0,0, ldraw_lib__003432c(realsolid)],
// 0
...
module ldraw_lib__3596d12(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3596d12(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
