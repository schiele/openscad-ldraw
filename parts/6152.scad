...
use <../p/stud2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6152(realsolid=false) = [
...
// 1 16 30 28 -10 -10 0 0 0 1 0 0 0 10 1-4edge.dat
  [1,16,30,28,-10,-10,0,0,0,1,0,0,0,10, ldraw_lib__1_4edge(realsolid)],
// 1 16 -30 28 -10 0 0 10 0 1 0 10 0 0 1-4edge.dat
  [1,16,-30,28,-10,0,0,10,0,1,0,10,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 30 32 -10 -10 0 0 0 1 0 0 0 10 1-4edge.dat
  [1,16,30,32,-10,-10,0,0,0,1,0,0,0,10, ldraw_lib__1_4edge(realsolid)],
// 1 16 -30 32 -10 0 0 10 0 1 0 10 0 0 1-4edge.dat
  [1,16,-30,32,-10,0,0,10,0,1,0,10,0,0, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 30 28 -10 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,30,28,-10,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 30 32 -10 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,30,32,-10,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 30 32 -10 6 0 0 0 -4 0 0 0 6 4-4cyli.dat
  [1,16,30,32,-10,6,0,0,0,-4,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -30 28 -10 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-30,28,-10,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 -30 32 -10 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-30,32,-10,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 10 28 -70 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,10,28,-70,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 32 -70 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,10,32,-70,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 32 -70 6 0 0 0 -4 0 0 0 6 4-4cyli.dat
  [1,16,10,32,-70,6,0,0,0,-4,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -10 28 -70 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-10,28,-70,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 -10 32 -70 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-10,32,-70,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 30 32 -10 -6 0 0 0 -1 0 0 0 -6 3-4ndis.dat
  [1,16,30,32,-10,-6,0,0,0,-1,0,0,0,-6, ldraw_lib__3_4ndis(realsolid)],
// 1 16 30 32 -10 0 0 -2 0 -1 0 2 0 0 1-4ring3.dat
  [1,16,30,32,-10,0,0,-2,0,-1,0,2,0,0, ldraw_lib__1_4ring3(realsolid)],
// 1 16 30 32 -10 0 0 -2 0 -1 0 2 0 0 1-4ring4.dat
  [1,16,30,32,-10,0,0,-2,0,-1,0,2,0,0, ldraw_lib__1_4ring4(realsolid)],
// 4 16 36 32 -4 36 32 0 30 32 0 30 32 -4
  [4,16,36,32,-4,36,32,0,30,32,0,30,32,-4],
// 0 // edge top
// 1 16 30 28 -10 -6 0 0 0 1 0 0 0 -6 3-4ndis.dat
  [1,16,30,28,-10,-6,0,0,0,1,0,0,0,-6, ldraw_lib__3_4ndis(realsolid)],
...
// 1 16 30 28 -10 0 0 -2 0 1 0 2 0 0 1-4ring3.dat
  [1,16,30,28,-10,0,0,-2,0,1,0,2,0,0, ldraw_lib__1_4ring3(realsolid)],
// 1 16 30 28 -10 0 0 -2 0 1 0 2 0 0 1-4ring4.dat
  [1,16,30,28,-10,0,0,-2,0,1,0,2,0,0, ldraw_lib__1_4ring4(realsolid)],
...
// 1 16 30 28 -10 -10 0 0 0 4 0 0 0 10 1-4cyli.dat
  [1,16,30,28,-10,-10,0,0,0,4,0,0,0,10, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -30 28 -10 10 0 0 0 4 0 0 0 10 1-4cyli.dat
  [1,16,-30,28,-10,10,0,0,0,4,0,0,0,10, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 10 28 -70 6 0 0 0 1 0 0 0 6 2-4ndis.dat
  [1,16,10,28,-70,6,0,0,0,1,0,0,0,6, ldraw_lib__2_4ndis(realsolid)],
// 1 16 10 28 -70 6 0 0 0 -1 0 0 0 -6 2-4disc.dat
  [1,16,10,28,-70,6,0,0,0,-1,0,0,0,-6, ldraw_lib__2_4disc(realsolid)],
...
// 1 16 10 32 -70 6 0 0 0 -1 0 0 0 6 4-4ndis.dat
  [1,16,10,32,-70,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -10 32 -70 6 0 0 0 -1 0 0 0 6 4-4ndis.dat
  [1,16,-10,32,-70,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 18 0 6 0 0 6 0 1 0 -6 0 0 3-16edge.dat
  [1,16,18,0,6,0,0,6,0,1,0,-6,0,0, ldraw_lib__3_16edge(realsolid)],
...
// 1 16 18 4 6 0 0 6 0 1 0 -6 0 0 3-16edge.dat
  [1,16,18,4,6,0,0,6,0,1,0,-6,0,0, ldraw_lib__3_16edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 18 0 6 0 0 6 0 4 0 -6 0 0 3-16cyli.dat
  [1,16,18,0,6,0,0,6,0,4,0,-6,0,0, ldraw_lib__3_16cyli(realsolid)],
// 0 //
...
module ldraw_lib__6152(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6152(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
