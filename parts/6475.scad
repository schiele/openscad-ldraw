...
$fa=1; $fs=0.2;
function ldraw_lib__6475(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\6475s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6475s01(realsolid)],
// 
...
// 1 16 408 0 248 72 0 0 0 1 0 0 0 72 48\1-4chrd.dat
  [1,16,408,0,248,72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4chrd(realsolid)],
// 1 16 -408 0 248 -72 0 0 0 1 0 0 0 72 48\1-4chrd.dat
  [1,16,-408,0,248,-72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4chrd(realsolid)],
// 1 16 -408 0 -248 -72 0 0 0 1 0 0 0 -72 48\1-4chrd.dat
  [1,16,-408,0,-248,-72,0,0,0,1,0,0,0,-72, ldraw_lib__48__1_4chrd(realsolid)],
...
// 1 16 300 0 140 1 0 0 0 1 0 0 0 1 stug20-7x7.dat
  [1,16,300,0,140,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_7x7(realsolid)],
// 1 16 -300 0 140 1 0 0 0 1 0 0 0 1 stug20-7x7.dat
  [1,16,-300,0,140,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_7x7(realsolid)],
// 1 16 300 0 -140 1 0 0 0 1 0 0 0 1 stug20-7x7.dat
  [1,16,300,0,-140,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_7x7(realsolid)],
...
// 1 16 0 0 160 1 0 0 0 1 0 0 0 1 stug20-8x8.dat
  [1,16,0,0,160,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_8x8(realsolid)],
// 1 16 0 0 -160 1 0 0 0 1 0 0 0 1 stug20-8x8.dat
  [1,16,0,0,-160,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_8x8(realsolid)],
// 1 16 460 0 140 1 0 0 0 1 0 0 0 1 stug20-7x1.dat
  [1,16,460,0,140,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_7x1(realsolid)],
// 1 16 -460 0 140 1 0 0 0 1 0 0 0 1 stug20-7x1.dat
  [1,16,-460,0,140,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_7x1(realsolid)],
// 1 16 460 0 -140 1 0 0 0 1 0 0 0 1 stug20-7x1.dat
  [1,16,460,0,-140,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_7x1(realsolid)],
...
// 1 16 300 0 300 1 0 0 0 1 0 0 0 1 stug20-1x7.dat
  [1,16,300,0,300,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x7(realsolid)],
// 1 16 -300 0 300 1 0 0 0 1 0 0 0 1 stug20-1x7.dat
  [1,16,-300,0,300,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x7(realsolid)],
// 1 16 300 0 -300 1 0 0 0 1 0 0 0 1 stug20-1x7.dat
  [1,16,300,0,-300,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x7(realsolid)],
...
module ldraw_lib__6475(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6475(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
