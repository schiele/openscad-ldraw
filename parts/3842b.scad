...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3842b(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3842as01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3842as01(realsolid)],
// 0 // Structure left
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\3842as01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3842as01(realsolid)],
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3842bs02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3842bs02(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3842as03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3842as03(realsolid)],
// 0 // Pivot left
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\3842as03.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3842as03(realsolid)],
];
module ldraw_lib__3842b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3842b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
