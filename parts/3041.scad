...
use <s/3041s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3041(realsolid=false) = [
...
// 1 16 0 00 0 1 0 0 0 1 0 0 0 1 s\3041s01.dat
  [1,16,0,00,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3041s01(realsolid)],
// 1 16 0 20 0 -40 0 0 0 -10 -10 0 -10 10 box2-5.dat
  [1,16,0,20,0,-40,0,0,0,-10,-10,0,-10,10, ldraw_lib__box2_5(realsolid)],
];
module ldraw_lib__3041(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3041(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
