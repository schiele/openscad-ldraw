...
use <../p/stug-4x4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__712ap01(realsolid=false) = [
...
// 1 4 -20 0 -20 0 0 -60 0 8 0 60 0 0 48\1-4cylo.dat
  [1,4,-20,0,-20,0,0,-60,0,8,0,60,0,0, ldraw_lib__48__1_4cylo(realsolid)],
// 1 4 -80 4 -30 0 1 0 4 0 0 0 0 -10 rect3.dat
  [1,4,-80,4,-30,0,1,0,4,0,0,0,0,-10, ldraw_lib__rect3(realsolid)],
// 1 4 30 4 40 0 0 50 -4 0 0 0 -1 0 rect3.dat
  [1,4,30,4,40,0,0,50,-4,0,0,0,-1,0, ldraw_lib__rect3(realsolid)],
// 
...
module ldraw_lib__712ap01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__712ap01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__712ap01(line=0.2);