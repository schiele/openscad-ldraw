...
use <u9354.scad>
$fa=1; $fs=0.2;
function ldraw_lib__26912(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 u9352.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9352(realsolid)],
// 0 // bottom
// 1 71 0 8 0 1 0 0 0 1 0 0 0 1 u9354.dat
  [1,71,0,8,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9354(realsolid)],
// 0 // LED support
// 1 0 0 17 -40 1 0 0 0 1 0 0 0 1 u9353.dat
  [1,0,0,17,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__u9353(realsolid)],
// 0 // cable stub
// 1 256 0 8 36 0 0 1 -1 0 0 0 -3 0 s\23816s01.dat
  [1,256,0,8,36,0,0,1,-1,0,0,0,-3,0, ldraw_lib__s__23816s01(realsolid)],
// 0 // phototransistor
// 1 47 10 24 -25 1 0 0 0 1 0 0 0 1 64898.dat
  [1,47,10,24,-25,1,0,0,0,1,0,0,0,1, ldraw_lib__64898(realsolid)],
// 0 // IR LED
// 1 40 -10 24 -25 1 0 0 0 1 0 0 0 1 64898.dat
  [1,40,-10,24,-25,1,0,0,0,1,0,0,0,1, ldraw_lib__64898(realsolid)],
// 0 // RGB LED
// 1 47 0 34 -22 0 1 0 -1 0 0 0 0 1 64897.dat
  [1,47,0,34,-22,0,1,0,-1,0,0,0,0,1, ldraw_lib__64897(realsolid)],
...
module ldraw_lib__26912(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__26912(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
