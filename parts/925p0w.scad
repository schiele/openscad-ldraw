...
use <s/925s02.scad>
function ldraw_lib__925p0w() = [
// 0 Brick  1 x  8 without Centre Studs with Green "KØBMAND" Italic Pattern
// 0 Name: 925p0w.dat
...
// 1 2 0 0 0 1 0 0 0 1 0 0 0 1 s\925p0rs01.dat
  [1,2,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__925p0rs01()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\925p0rs02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__925p0rs02()],
];
module ldraw_lib__925p0w(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__925p0w(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__925p0w(line=0.2);