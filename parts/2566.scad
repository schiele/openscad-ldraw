...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2566(realsolid=false) = [
...
// 1 16 0 8 0 4 0 0 0 -8 0 0 0 4 4-4cyli.dat
  [1,16,0,8,0,4,0,0,0,-8,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 
// 1 16 0 24 0 1 0 0 0 -4 0 0 0 1 stud3.dat
  [1,16,0,24,0,1,0,0,0,-4,0,0,0,1, ldraw_lib__stud3(realsolid)],
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2566s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2566s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\2566s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__2566s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\2566s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__2566s01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\2566s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__2566s01(realsolid)],
...
module ldraw_lib__2566(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2566(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
