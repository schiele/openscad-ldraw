...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4161(realsolid=false) = [
...
// 1 16 10 4 -10 6 0 0 0 0.894 3 0 0.447 -6 2-4edge.dat
  [1,16,10,4,-10,6,0,0,0,0.894,3,0,0.447,-6, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 10 4 -10 8 0 0 0 0.894 4 0 0.447 -8 2-4edge.dat
  [1,16,10,4,-10,8,0,0,0,0.894,4,0,0.447,-8, ldraw_lib__2_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 10 7 -10 6 0 0 0 13 0 0 0 -6 2-4cyli.dat
  [1,16,10,7,-10,6,0,0,0,13,0,0,0,-6, ldraw_lib__2_4cyli(realsolid)],
...
// 1 16 10 8 -10 8 0 0 0 12 0 0 0 -8 2-4cyli.dat
  [1,16,10,8,-10,8,0,0,0,12,0,0,0,-8, ldraw_lib__2_4cyli(realsolid)],
// 
// 1 16 -10 20 -10 1 0 0 0 -1 0 0 0 1 stud4a.dat
  [1,16,-10,20,-10,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 -10 4 -10 6 0 0 0 1 0 0 0 6 2-4edge.dat
...
// 1 16 10 14 -30 6 0 0 0 0.894 3 0 0.447 -6 4-4edge.dat
  [1,16,10,14,-30,6,0,0,0,0.894,3,0,0.447,-6, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 14 -30 8 0 0 0 0.894 4 0 0.447 -8 4-4edge.dat
  [1,16,10,14,-30,8,0,0,0,0.894,4,0,0.447,-8, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 14 -30 6 0 0 0 9 -3 0 0 6 2-4cyli.dat
  [1,16,10,14,-30,6,0,0,0,9,-3,0,0,6, ldraw_lib__2_4cyli(realsolid)],
// 1 16 10 14 -30 8 0 0 0 10 -4 0 0 8 2-4cyli.dat
  [1,16,10,14,-30,8,0,0,0,10,-4,0,0,8, ldraw_lib__2_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 14 -30 6 0 0 0 6 3 0 0 -6 2-4cyli.dat
  [1,16,10,14,-30,6,0,0,0,6,3,0,0,-6, ldraw_lib__2_4cyli(realsolid)],
// 1 16 10 14 -30 8 0 0 0 6 4 0 0 -8 2-4cyli.dat
  [1,16,10,14,-30,8,0,0,0,6,4,0,0,-8, ldraw_lib__2_4cyli(realsolid)],
// 
// 1 16 -10 20 -30 1 0 0 0 -1 0 0 0 1 stud4a.dat
  [1,16,-10,20,-30,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 1 16 -10 14 -30 6 0 0 0 0.894 3 0 0.447 -6 4-4edge.dat
...
module ldraw_lib__4161(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4161(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
