...
use <s/3068bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3068bpfe(realsolid=false) = [
...
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 s\3068bpfds02.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3068bpfds02(realsolid)],
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\3068bpfds03.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3068bpfds03(realsolid)],
];
module ldraw_lib__3068bpfe(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068bpfe(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
