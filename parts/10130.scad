...
use <s/10130s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__10130(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\10130s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__10130s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\10130s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__10130s01(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -35 49 12.5 0 0 0 0 -12.5 0 -0.5 0 box5.dat
  [1,16,0,-35,49,12.5,0,0,0,0,-12.5,0,-0.5,0, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -30 9 0 0 0 0 -9 0 -3 0 4-4cylo.dat
  [1,16,0,0,-30,9,0,0,0,0,-9,0,-3,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 0 -30 9 0 0 0 0 -9 0 -3 0 4-4ndis.dat
  [1,16,0,0,-30,9,0,0,0,0,-9,0,-3,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 0 -33 -9 0 0 0 0 -9 0 3 0 4-4ndis.dat
  [1,16,0,0,-33,-9,0,0,0,0,-9,0,3,0, ldraw_lib__4_4ndis(realsolid)],
...
module ldraw_lib__10130(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__10130(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
