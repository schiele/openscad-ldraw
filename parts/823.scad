...
use <822bp01c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__823(realsolid=false) = [
...
// 1 47 52.5 -62.5 0 1 0 0 0 1 0 0 0 1 822bp01c01.dat
  [1,47,52.5,-62.5,0,1,0,0,0,1,0,0,0,1, ldraw_lib__822bp01c01(realsolid)],
];
module ldraw_lib__823(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__823(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
