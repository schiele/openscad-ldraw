...
use <s/265s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__265ac01(realsolid=false) = [
...
// 1 494 -10 12.5 16 1 0 0 0 0 1 0 -1 0 s\265s01.dat
  [1,494,-10,12.5,16,1,0,0,0,0,1,0,-1,0, ldraw_lib__s__265s01(realsolid)],
// 1 494 10 12.5 16 1 0 0 0 0 1 0 -1 0 s\265s01.dat
  [1,494,10,12.5,16,1,0,0,0,0,1,0,-1,0, ldraw_lib__s__265s01(realsolid)],
];
module ldraw_lib__265ac01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__265ac01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
