...
// 1 16 40 -10 0 10 0 0 0 0 10 0 -10 0 t04q4000.dat
  [1,16,40,-10,0,10,0,0,0,0,10,0,-10,0, ldraw_lib__t04q4000()],
// 1 16 60 -10 0 -10 0 0 0 0 -10 0 -10 0 t04q4000.dat
  [1,16,60,-10,0,-10,0,0,0,0,-10,0,-10,0, ldraw_lib__t04q4000()],
// 1 16 80 -20 0 0 -20 0 0 0 4 4 0 0 4-4cylc3.dat
  [1,16,80,-20,0,0,-20,0,0,0,4,4,0,0, ldraw_lib__4_4cylc3()],
// 1 16 -40 0 0 0 80 0 0 0 4 4 0 0 4-4cylc3.dat
  [1,16,-40,0,0,0,80,0,0,0,4,4,0,0, ldraw_lib__4_4cylc3()],
// 1 16 80 -20 0 0 1 0 0 0 4 4 0 0 4-4edge.dat
  [1,16,80,-20,0,0,1,0,0,0,4,4,0,0, ldraw_lib__4_4edge()],
// 1 16 -40 0 0 0 1 0 0 0 4 4 0 0 4-4edge.dat
  [1,16,-40,0,0,0,1,0,0,0,4,4,0,0, ldraw_lib__4_4edge()],
];
module ldraw_lib__763(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__763(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
