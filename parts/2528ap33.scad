...
use <s/2528as03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2528ap33(realsolid=false) = [
...
// 1 82 0 0 0 1 0 0 0 1 0 0 0 1 s\2528ap30s01.dat
  [1,82,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2528ap30s01(realsolid)],
...
// 1 82 0 0 0 1 0 0 0 1 0 0 0 1 s\2528ap30s03.dat
  [1,82,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2528ap30s03(realsolid)],
// 1 82 0 0 0 -1 0 0 0 1 0 0 0 1 s\2528ap30s03.dat
  [1,82,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__2528ap30s03(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2528ap33s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2528ap33s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\2528ap33s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__2528ap33s01(realsolid)],
];
module ldraw_lib__2528ap33(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2528ap33(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
