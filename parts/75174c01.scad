...
use <75174.scad>
$fa=1; $fs=0.2;
function ldraw_lib__75174c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 75174.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__75174(realsolid)],
// 0 // arms
...
// 1 16 0 64 64 1 0 0 0 1 0 0 0 1 6028.dat
  [1,16,0,64,64,1,0,0,0,1,0,0,0,1, ldraw_lib__6028(realsolid)],
// 0 // head, open
// 0 // 1 16 0 -57.5 -61 1 0 0 0 1 0 0 0 1 6027.dat
// 0 // head, closed
// 1 16 0 -57.5 -61 1 0 0 0 0.924 -0.383 0 0.383 0.924 6027.dat
  [1,16,0,-57.5,-61,1,0,0,0,0.924,-0.383,0,0.383,0.924, ldraw_lib__6027(realsolid)],
// 0 // wings, turned 30 degrees, halfway position
// 1 4 29 19 -57 0.707 0.707 0 -0.612 0.612 0.5 0.354 -0.354 0.866 6133.dat
  [1,4,29,19,-57,0.707,0.707,0,-0.612,0.612,0.5,0.354,-0.354,0.866, ldraw_lib__6133(realsolid)],
// 1 4 -29 19 -57 -0.707 0.707 0 -0.612 -0.612 0.5 0.354 0.353 0.866 6133.dat
  [1,4,-29,19,-57,-0.707,0.707,0,-0.612,-0.612,0.5,0.354,0.353,0.866, ldraw_lib__6133(realsolid)],
...
module ldraw_lib__75174c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__75174c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
