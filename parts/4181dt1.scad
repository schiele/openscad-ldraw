...
use <4181.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4181dt1(realsolid=false) = [
...
// 1 16 10 102 30 0 -1 0 0 0 -1 1 0 0 193445c.dat
  [1,16,10,102,30,0,-1,0,0,0,-1,1,0,0, ldraw_lib__193445c(realsolid)],
];
module ldraw_lib__4181dt1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4181dt1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
