...
// 1 16 20 0 0 0 1 0 -1 0 0 0 0 1 bush0.dat
  [1,16,20,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__bush0()],
// 1 16 -20 0 0 0 1 0 -1 0 0 0 0 1 bush0.dat
  [1,16,-20,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__bush0()],
// 
// 1 16 0 0 -16.5 0 0 1 1 0 0 0 0.5 0 4-4con7.dat
  [1,16,0,0,-16.5,0,0,1,1,0,0,0,0.5,0, ldraw_lib__4_4con7()],
// 1 16 0 0 -17 0 0 1 1 0 0 0 0.5 0 4-4con8.dat
  [1,16,0,0,-17,0,0,1,1,0,0,0,0.5,0, ldraw_lib__4_4con8()],
// 1 16 0 0 -20 0 0 9 9 0 0 0 3 0 4-4cylo.dat
  [1,16,0,0,-20,0,0,9,9,0,0,0,3,0, ldraw_lib__4_4cylo()],
...
// 1 16 0 0 17 0 0 9 9 0 0 0 3 0 4-4cylo.dat
  [1,16,0,0,17,0,0,9,9,0,0,0,3,0, ldraw_lib__4_4cylo()],
// 1 16 0 0 20 0 0 -3 3 0 0 0 -1 0 4-4ring2.dat
  [1,16,0,0,20,0,0,-3,3,0,0,0,-1,0, ldraw_lib__4_4ring2()],
// 
// 1 16 0 0 -20 1 0 0 0 0 -1 0 40 0 axlehol5.dat
  [1,16,0,0,-20,1,0,0,0,0,-1,0,40,0, ldraw_lib__axlehol5()],
// 1 16 0 0 -5 7 0 0 0 0 -7 0 10 0 4-4cyli.dat
  [1,16,0,0,-5,7,0,0,0,0,-7,0,10,0, ldraw_lib__4_4cyli()],
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\11272s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__11272s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\11272s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__11272s01()],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 -1 s\11272s01.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,-1, ldraw_lib__s__11272s01()],
...
module ldraw_lib__11272(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11272(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
