...
use <32183c02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__76320_f2(realsolid=false) = [
...
// 1 0 0 120 0 1 0 0 0 1 0 0 0 1 32183c02.dat
  [1,0,0,120,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32183c02(realsolid)],
// 1 494 0 84 0 1 0 0 0 1 0 0 0 1 22020-f2.dat
  [1,494,0,84,0,1,0,0,0,1,0,0,0,1, ldraw_lib__22020_f2(realsolid)],
];
module ldraw_lib__76320_f2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76320_f2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
