...
use <s/33299s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__33299a(realsolid=false) = [
...
// 1 16 0 0 20 -1 0 0 0 10 0 0 0 -1 axl2hole.dat
  [1,16,0,0,20,-1,0,0,0,10,0,0,0,-1, ldraw_lib__axl2hole(realsolid)],
// 1 16 0 -10 0 -1 0 0 0 20 0 0 0 -1 axl2hole.dat
  [1,16,0,-10,0,-1,0,0,0,20,0,0,0,-1, ldraw_lib__axl2hole(realsolid)],
// 1 16 0 0 30 -1 0 0 0 8 0 0 0 -1 npeghole.dat
  [1,16,0,0,30,-1,0,0,0,8,0,0,0,-1, ldraw_lib__npeghole(realsolid)],
// 1 16 0 0 20 -3 0 0 0 1 0 0 0 -3 4-4ring2.dat
  [1,16,0,0,20,-3,0,0,0,1,0,0,0,-3, ldraw_lib__4_4ring2(realsolid)],
...
// 1 16 0 10 20 -9 0 0 0 -1 0 0 0 -9 4-4ndis.dat
  [1,16,0,10,20,-9,0,0,0,-1,0,0,0,-9, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 10 40 -8 0 0 0 -1 0 0 0 -8 2-4ndis.dat
  [1,16,0,10,40,-8,0,0,0,-1,0,0,0,-8, ldraw_lib__2_4ndis(realsolid)],
// 4 16 9 10 32 9 10 29 -9 10 29 -9 10 32
  [4,16,9,10,32,9,10,29,-9,10,29,-9,10,32],
];
module ldraw_lib__33299a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__33299a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__33299a(line=0.2);