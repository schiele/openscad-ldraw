...
use <s/3144s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3144(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3144s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3144s01(realsolid)],
// 
// 0 // Subpart Antenna 5H with Side Spokes - Spokes
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3144s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3144s02(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\3144s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3144s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\3144s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3144s02(realsolid)],
...
module ldraw_lib__3144(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3144(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
