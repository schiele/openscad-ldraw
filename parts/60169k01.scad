...
use <../p/t04q3750.scad>
$fa=1; $fs=0.2;
function ldraw_lib__60169k01(realsolid=false) = [
...
// 1 16 4 1.5 7.5029 0 0 -1.5 1.5 0 0 0 5.4971 0 4-4cyli.dat
  [1,16,4,1.5,7.5029,0,0,-1.5,1.5,0,0,0,5.4971,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 1.5 13 4 0 0 0 4 0 0 0 4 t04q3750.dat
  [1,16,0,1.5,13,4,0,0,0,4,0,0,0,4, ldraw_lib__t04q3750(realsolid)],
// 1 16 0 1.5 13 -4 0 0 0 -4 0 0 0 4 t04q3750.dat
  [1,16,0,1.5,13,-4,0,0,0,-4,0,0,0,4, ldraw_lib__t04q3750(realsolid)],
// 
// 1 16 -4 1.5 7.5029 0 0 1.5 1.5 0 0 0 5.4971 0 4-4cyli.dat
...
module ldraw_lib__60169k01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__60169k01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
