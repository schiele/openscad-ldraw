...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__41767(realsolid=false) = [
// 0 Wedge  4 x  2 Right
// 0 Name: 41767.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\41767s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__41767s01(realsolid)],
// 0
];
module ldraw_lib__41767(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__41767(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
