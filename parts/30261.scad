...
use <s/469s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30261(realsolid=false) = [
...
// 1 16 0 0 -9 20 0 0 0 0 20 0 1 0 4-4disc.dat
  [1,16,0,0,-9,20,0,0,0,0,20,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\469s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__469s01(realsolid)],
];
module ldraw_lib__30261(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30261(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
