...
use <s/25269s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__25269p01(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 25269pb001, Set 10255, set 41126
// 
...
// 1 16 -10 0 10 20 0 0 0 1 0 0 0 -20 1-4ering.dat
  [1,16,-10,0,10,20,0,0,0,1,0,0,0,-20, ldraw_lib__1_4ering(realsolid)],
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\25269p01s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__25269p01s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 -1 0 0 s\25269p01s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,-1,0,0, ldraw_lib__s__25269p01s01(realsolid)],
];
module ldraw_lib__25269p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__25269p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
