...
use <2921.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2872(realsolid=false) = [
// 0 ~Moved to 2921
// 0 Name: 2872.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2921.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2921(realsolid)],
];
module ldraw_lib__2872(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2872(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
