...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9250(realsolid=false) = [
// 0 ~Electric LED
// 0 Name: u9250.dat
...
// 1 16 0 -10.75 0 3.7 0 0 0 -3.5 0 0 0 -3.7 4-8sphe.dat
  [1,16,0,-10.75,0,3.7,0,0,0,-3.5,0,0,0,-3.7, ldraw_lib__4_8sphe(realsolid)],
// 1 16 0 -10.75 0 3.7 0 0 0 7.25 0 0 0 -3.7 4-4cyli.dat
  [1,16,0,-10.75,0,3.7,0,0,0,7.25,0,0,0,-3.7, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -3.5 0 3.7 0 0 0 -1 0 0 0 -3.7 4-4edge.dat
  [1,16,0,-3.5,0,3.7,0,0,0,-1,0,0,0,-3.7, ldraw_lib__4_4edge(realsolid)],
// 1 16 -3.7 -1.75 -.9056 0 1 0 1.75 0 0 0 0 -.90555 rect3.dat
  [1,16,-3.7,-1.75,-.9056,0,1,0,1.75,0,0,0,0,-.90555, ldraw_lib__rect3(realsolid)],
// 1 16 -3.7 -1.75 .9056 0 1 0 -1.75 0 0 0 0 .90555 rect3.dat
  [1,16,-3.7,-1.75,.9056,0,1,0,-1.75,0,0,0,0,.90555, ldraw_lib__rect3(realsolid)],
// 1 16 -3.3217 -1.75 -2.3772 -.37835 1 0 0 0 1.75 .5661 0 0 rect2p.dat
  [1,16,-3.3217,-1.75,-2.3772,-.37835,1,0,0,0,1.75,.5661,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -3.3217 -1.75 2.3772 -.37835 1 0 0 0 -1.75 -.5661 0 0 rect2p.dat
  [1,16,-3.3217,-1.75,2.3772,-.37835,1,0,0,0,-1.75,-.5661,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 -3.5 0 .4625 0 0 0 1 0 0 0 -.4625 3-8ring8.dat
  [1,16,0,-3.5,0,.4625,0,0,0,1,0,0,0,-.4625, ldraw_lib__3_8ring8(realsolid)],
// 1 16 0 -3.5 0 .4625 0 0 0 1 0 0 0 .4625 3-8ring8.dat
  [1,16,0,-3.5,0,.4625,0,0,0,1,0,0,0,.4625, ldraw_lib__3_8ring8(realsolid)],
// 1 16 0 -3.5 0 4.1625 0 0 0 3.5 0 0 0 -4.1625 3-8cylo.dat
  [1,16,0,-3.5,0,4.1625,0,0,0,3.5,0,0,0,-4.1625, ldraw_lib__3_8cylo(realsolid)],
// 1 16 0 -3.5 0 4.1625 0 0 0 3.5 0 0 0 4.1625 3-8cylo.dat
  [1,16,0,-3.5,0,4.1625,0,0,0,3.5,0,0,0,4.1625, ldraw_lib__3_8cylo(realsolid)],
// 1 16 0 0 0 4.1625 0 0 0 -1 0 0 0 -4.1625 3-8chrd.dat
  [1,16,0,0,0,4.1625,0,0,0,-1,0,0,0,-4.1625, ldraw_lib__3_8chrd(realsolid)],
// 1 16 0 0 0 4.1625 0 0 0 -1 0 0 0 4.1625 3-8chrd.dat
  [1,16,0,0,0,4.1625,0,0,0,-1,0,0,0,4.1625, ldraw_lib__3_8chrd(realsolid)],
...
// 1 494 -2.6 0 0 -.4 0 0 0 -7.75 0 0 0 .4 box5.dat
  [1,494,-2.6,0,0,-.4,0,0,0,-7.75,0,0,0,.4, ldraw_lib__box5(realsolid)],
// 
// 1 494 2.6 0 0 -.4 0 0 0 -5 0 0 0 .4 box4o4a.dat
  [1,494,2.6,0,0,-.4,0,0,0,-5,0,0,0,.4, ldraw_lib__box4o4a(realsolid)],
// 1 494 3 -6.375 0 0 -1 0 0 0 -1.375 .4 0 0 rect3.dat
  [1,494,3,-6.375,0,0,-1,0,0,0,-1.375,.4,0,0, ldraw_lib__rect3(realsolid)],
// 1 494 .15 -6.225 0 0 0 -1.55 0 -1 -1.225 -.4 0 0 rect3.dat
  [1,494,.15,-6.225,0,0,0,-1.55,0,-1,-1.225,-.4,0,0, ldraw_lib__rect3(realsolid)],
// 1 494 1.95 -5 0 0 0 -.25 0 -1 0 -.4 0 0 rect.dat
  [1,494,1.95,-5,0,0,0,-.25,0,-1,0,-.4,0,0, ldraw_lib__rect(realsolid)],
// 
...
// 1 21 0 -7.55 0 -.5 0 0 0 -.3 0 0 0 .5 box5.dat
  [1,21,0,-7.55,0,-.5,0,0,0,-.3,0,0,0,.5, ldraw_lib__box5(realsolid)],
];
module ldraw_lib__u9250(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9250(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
