...
use <s/3811p02e.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3811p02(realsolid=false) = [
...
// 0 BFC CERTIFY CW
  ...
  [0,"BFC","CW"],
// 
// 0 !KEYWORDS Beach, Imperial Guard, Imperial Navy, islanders, Pirate, Pirates
// 0 !KEYWORDS shore, tropical island, tropics
// 
// 0 !CMDLINE -c7
// 
...
// 1 1 0 0 0 1 0 0 0 1 0 0 0 1 s\3811p02d.dat
  [1,1,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3811p02d(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3811p02e.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3811p02e(realsolid)],
// 0
];
module ldraw_lib__3811p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3811p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
