...
use <../p/bump5000.scad>
$fa=1; $fs=0.2;
function ldraw_lib__791(realsolid=false) = [
...
// 1 16 25 54 -2 27 0 0 0 0 54 0 4 0 box4.dat
  [1,16,25,54,-2,27,0,0,0,0,54,0,4,0, ldraw_lib__box4(realsolid)],
...
// 1 16 0 108 0 -2 0 0 0 -2 0 0 0 2 bump5000.dat
  [1,16,0,108,0,-2,0,0,0,-2,0,0,0,2, ldraw_lib__bump5000(realsolid)],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 26 100.4515 2 0 0 22 -1.5485 0 0 0 -1 0 box5.dat
  [1,16,26,100.4515,2,0,0,22,-1.5485,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 26 94.258 2 0 0 22 -1.548 0 0 0 -1 0 box5.dat
  [1,16,26,94.258,2,0,0,22,-1.548,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 26 88.0645 2 0 0 22 -1.548 0 0 0 -1 0 box5.dat
  [1,16,26,88.0645,2,0,0,22,-1.548,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 26 81.871 2 0 0 22 -1.548 0 0 0 -1 0 box5.dat
  [1,16,26,81.871,2,0,0,22,-1.548,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 26 75.6775 2 0 0 22 -1.548 0 0 0 -1 0 box5.dat
  [1,16,26,75.6775,2,0,0,22,-1.548,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 26 69.484 2 0 0 22 -1.548 0 0 0 -1 0 box5.dat
  [1,16,26,69.484,2,0,0,22,-1.548,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 26 63.2905 2 0 0 22 -1.548 0 0 0 -1 0 box5.dat
  [1,16,26,63.2905,2,0,0,22,-1.548,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 26 57.097 2 0 0 22 -1.548 0 0 0 -1 0 box5.dat
  [1,16,26,57.097,2,0,0,22,-1.548,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 26 50.9035 2 0 0 22 -1.548 0 0 0 -1 0 box5.dat
  [1,16,26,50.9035,2,0,0,22,-1.548,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 26 44.71 2 0 0 22 -1.548 0 0 0 -1 0 box5.dat
  [1,16,26,44.71,2,0,0,22,-1.548,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 26 38.5165 2 0 0 22 -1.548 0 0 0 -1 0 box5.dat
  [1,16,26,38.5165,2,0,0,22,-1.548,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 26 32.323 2 0 0 22 -1.548 0 0 0 -1 0 box5.dat
  [1,16,26,32.323,2,0,0,22,-1.548,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 26 26.1295 2 0 0 22 -1.548 0 0 0 -1 0 box5.dat
  [1,16,26,26.1295,2,0,0,22,-1.548,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 26 19.936 2 0 0 22 -1.548 0 0 0 -1 0 box5.dat
  [1,16,26,19.936,2,0,0,22,-1.548,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 26 13.7425 2 0 0 22 -1.548 0 0 0 -1 0 box5.dat
  [1,16,26,13.7425,2,0,0,22,-1.548,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
...
// 1 16 26 7.549 2 0 0 22 -1.548 0 0 0 -1 0 box5.dat
  [1,16,26,7.549,2,0,0,22,-1.548,0,0,0,-1,0, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 26 7.549 -2 0 0 22 -1.548 0 0 0 1 0 box5.dat
  [1,16,26,7.549,-2,0,0,22,-1.548,0,0,0,1,0, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__791(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__791(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
