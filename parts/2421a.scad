...
use <s/2421a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2421a(realsolid=false) = [
// 0 ~Moved to s\2421a
// 0 Name: 2421a.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2421a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2421a(realsolid)],
];
module ldraw_lib__2421a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2421a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
