...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 63586.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__63586()],
];
module ldraw_lib__61190d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__61190d(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
