...
use <2911.scad>
$fa=1; $fs=0.2;
function ldraw_lib__74780_f1(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2882.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2882(realsolid)],
// 
// 0 // Top
...
module ldraw_lib__74780_f1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__74780_f1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
