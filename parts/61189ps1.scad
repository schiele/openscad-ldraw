...
use <s/61189s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__61189ps1(realsolid=false) = [
...
// 0 !KEYWORDS Bricklink 61189pb14, set 75019
// 
// 0 !CMDLINE -c15
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\61189ps1s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__61189ps1s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\61189ps1s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__61189ps1s01(realsolid)],
...
module ldraw_lib__61189ps1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__61189ps1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
