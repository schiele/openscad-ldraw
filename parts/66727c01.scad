...
use <66727.scad>
$fa=1; $fs=0.2;
function ldraw_lib__66727c01(realsolid=false) = [
...
// 1 16 0 0 6 1 0 0 0 1 0 0 0 1 66727.dat
  [1,16,0,0,6,1,0,0,0,1,0,0,0,1, ldraw_lib__66727(realsolid)],
// 1 256 0 0 0 1 0 0 0 1 0 0 0 1 18977.dat
  [1,256,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__18977(realsolid)],
];
module ldraw_lib__66727c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__66727c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
