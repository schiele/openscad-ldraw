...
use <s/4478s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4478(realsolid=false) = [
// 0 Baseplate 32 x 32 Road 9-Stud Driveway
// 0 Name: 4478.dat
...
module ldraw_lib__4478(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4478(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4478(line=0.2);