...
use <75174p01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__75174p01c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 75174p01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__75174p01(realsolid)],
// 0 // arms
// 1 16 20 14 -77 1 0 0 0 1 0 0 0 1 6128.dat
  [1,16,20,14,-77,1,0,0,0,1,0,0,0,1, ldraw_lib__6128(realsolid)],
// 1 16 -20 14 -77 1 0 0 0 1 0 0 0 1 6127.dat
  [1,16,-20,14,-77,1,0,0,0,1,0,0,0,1, ldraw_lib__6127(realsolid)],
// 0 // tail oriental
// 1 16 0 64 64 1 0 0 0 1 0 0 0 1 45106p01.dat
  [1,16,0,64,64,1,0,0,0,1,0,0,0,1, ldraw_lib__45106p01(realsolid)],
// 0 // head oriental, open
// 1 334 0 -57.5 -61 1 0 0 0 1 0 0 0 1 43900.dat
  [1,334,0,-57.5,-61,1,0,0,0,1,0,0,0,1, ldraw_lib__43900(realsolid)],
// 0 // eyes
// 1 36 -12 -72.1 -84.4 0 1 0 1 0 0 0 0 -1 30153.dat
  [1,36,-12,-72.1,-84.4,0,1,0,1,0,0,0,0,-1, ldraw_lib__30153(realsolid)],
// 1 36 12 -72.1 -84.4 0 -1 0 1 0 0 0 0 1 30153.dat
  [1,36,12,-72.1,-84.4,0,-1,0,1,0,0,0,0,1, ldraw_lib__30153(realsolid)],
...
// 1 36 29 19 -57 0.707 0.707 0 -0.612 0.612 0.5 0.354 -0.354 0.866 30130.dat
  [1,36,29,19,-57,0.707,0.707,0,-0.612,0.612,0.5,0.354,-0.354,0.866, ldraw_lib__30130(realsolid)],
// 1 36 -29 19 -57 -0.707 0.707 0 -0.612 -0.612 0.5 0.354 0.353 0.866 30130.dat
  [1,36,-29,19,-57,-0.707,0.707,0,-0.612,-0.612,0.5,0.354,0.353,0.866, ldraw_lib__30130(realsolid)],
...
// 1 38 0 -31.8 -116.3 0 -1 0 -0.924 0 0.383 -0.383 0 -0.924 6126.dat
  [1,38,0,-31.8,-116.3,0,-1,0,-0.924,0,0.383,-0.383,0,-0.924, ldraw_lib__6126(realsolid)],
];
module ldraw_lib__75174p01c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__75174p01c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
