...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 181.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__181()],
];
module ldraw_lib__164c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__164c02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
