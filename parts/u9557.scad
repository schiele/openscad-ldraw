...
use <s/u9557s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9557(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9557s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9557s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\u9557s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__u9557s01(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 .5 -44 0 46.5 0 0 0 42 0 0 0 41 box5.dat
  [1,16,.5,-44,0,46.5,0,0,0,42,0,0,0,41, ldraw_lib__box5(realsolid)],
// 4 16 47 -44 -41 48 -44 -27 48 -44 27 47 -44 41
  [4,16,47,-44,-41,48,-44,-27,48,-44,27,47,-44,41],
// 1 16 51 -44 0 1 0 0 0 1 0 0 0 12 rect1.dat
  [1,16,51,-44,0,1,0,0,0,1,0,0,0,12, ldraw_lib__rect1(realsolid)],
// 1 16 52 -22 0 0 -1 0 22 0 0 0 0 12 rect1.dat
  [1,16,52,-22,0,0,-1,0,22,0,0,0,0,12, ldraw_lib__rect1(realsolid)],
// 4 16 52 0 12 52 0 -12 50 0 -12 50 0 12
  [4,16,52,0,12,52,0,-12,50,0,-12,50,0,12],
// 4 16 50 0 12 50 0 -12 -47 0 -3 -47 0 3
  [4,16,50,0,12,50,0,-12,-47,0,-3,-47,0,3],
// 1 16 -47 -22 0 0 1 0 0 0 -22 -3 0 0 rect2p.dat
  [1,16,-47,-22,0,0,1,0,0,0,-22,-3,0,0, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__u9557(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9557(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
