...
use <3820.scad>
use <973pbs.scad>
function ldraw_lib__76382pbs() = [
// 0 Minifig Torso with Arms and Hands with Hoodie Scarlet Spider over Red Shirt and Silver Belt Pattern
// 0 Name: 76382pbs.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973pbs.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973pbs()],
...
module ldraw_lib__76382pbs(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382pbs(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382pbs(line=0.2);