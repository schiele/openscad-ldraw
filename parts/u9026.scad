...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9026(realsolid=false) = [
...
// 1 16 0 0 0 10 0 0 0 24 0 0 0 10 4-4cyli.dat
  [1,16,0,0,0,10,0,0,0,24,0,0,0,10, ldraw_lib__4_4cyli(realsolid)],
...
module ldraw_lib__u9026(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9026(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
