...
use <s/3068bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3068bps4(realsolid=false) = [
...
// 1 16 0 0 -20 20 0 0 0 1 0 0 0 40 2-4ndis.dat
  [1,16,0,0,-20,20,0,0,0,1,0,0,0,40, ldraw_lib__2_4ndis(realsolid)],
// 1 288 0 0 -20 20 0 0 0 1 0 0 0 40 2-4disc.dat
  [1,288,0,0,-20,20,0,0,0,1,0,0,0,40, ldraw_lib__2_4disc(realsolid)],
];
module ldraw_lib__3068bps4(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068bps4(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
