...
// 1 16 0 0 6 9 0 0 0 0 9 0 -26 0 4-4cyli.dat
  [1,16,0,0,6,9,0,0,0,0,9,0,-26,0, ldraw_lib__4_4cyli()],
// 1 16 0 0 -20 9 0 0 0 0 9 0 -26 0 4-4edge.dat
  [1,16,0,0,-20,9,0,0,0,0,9,0,-26,0, ldraw_lib__4_4edge()],
...
// 1 16 0 0 10 1 0 0 0 0 1 0 -30 0 axlehol6.dat
  [1,16,0,0,10,1,0,0,0,0,1,0,-30,0, ldraw_lib__axlehol6()],
// 1 16 0 0 10 -1 0 0 0 0 -1 0 -30 0 axlehol6.dat
  [1,16,0,0,10,-1,0,0,0,0,-1,0,-30,0, ldraw_lib__axlehol6()],
// 1 16 0 0 10 -1 0 0 0 0 -1 0 -26 0 axlehol2.dat
  [1,16,0,0,10,-1,0,0,0,0,-1,0,-26,0, ldraw_lib__axlehol2()],
// 1 16 0 0 -20 -1 0 0 0 0 -1 0 -26 0 axlehol2.dat
  [1,16,0,0,-20,-1,0,0,0,0,-1,0,-26,0, ldraw_lib__axlehol2()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 10 0 0 6 -6 0 0 0 -30 0 4-4cyli.dat
  [1,16,0,0,10,0,0,6,-6,0,0,0,-30,0, ldraw_lib__4_4cyli()],
// 1 16 0 0 10 0 0 6 -6 0 0 0 -26 0 1-4edge.dat
  [1,16,0,0,10,0,0,6,-6,0,0,0,-26,0, ldraw_lib__1_4edge()],
// 1 16 0 0 -20 0 0 6 -6 0 0 0 -26 0 1-4edge.dat
  [1,16,0,0,-20,0,0,6,-6,0,0,0,-26,0, ldraw_lib__1_4edge()],
// 1 16 0 0 10 0 0 -6 6 0 0 0 -26 0 1-4edge.dat
  [1,16,0,0,10,0,0,-6,6,0,0,0,-26,0, ldraw_lib__1_4edge()],
// 1 16 0 0 -20 0 0 -6 6 0 0 0 -26 0 1-4edge.dat
  [1,16,0,0,-20,0,0,-6,6,0,0,0,-26,0, ldraw_lib__1_4edge()],
...
module ldraw_lib__32020(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32020(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
