...
use <u9364c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__54696c01(realsolid=false) = [
// 0 Electric Spike Prime Medium Motor with Coiled Cable
// 0 Name: 54696c01.dat
...
module ldraw_lib__54696c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__54696c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
