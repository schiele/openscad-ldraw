...
$fa=1; $fs=0.2;
function ldraw_lib__18455(realsolid=false) = [
...
// 1 16 20 24 0 0 0 -8 0 -20 0 8 0 0 2-4cylo.dat
  [1,16,20,24,0,0,0,-8,0,-20,0,8,0,0, ldraw_lib__2_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 24 0 0 0 -6 0 -20 0 6 0 0 2-4cylo.dat
  [1,16,20,24,0,0,0,-6,0,-20,0,6,0,0, ldraw_lib__2_4cylo(realsolid)],
// 1 16 20 24 0 0 0 -2 0 -1 0 2 0 0 2-4ring3.dat
  [1,16,20,24,0,0,0,-2,0,-1,0,2,0,0, ldraw_lib__2_4ring3(realsolid)],
// 2 24 20 4 -8 20 24 -8
  [2,24,20,4,-8,20,24,-8],
// 2 24 20 4 -6 20 24 -6
  [2,24,20,4,-6,20,24,-6],
...
// 1 16 -10 4 0 1 0 0 0 -5 0 0 0 1 stug4-1x2.dat
  [1,16,-10,4,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stug4_1x2(realsolid)],
// 
// 0 // Inner studs small
// 1 16 24.8787 -12 -5 .8787 0 0 0 36 0 0 0 .7574 box3u4p.dat
  [1,16,24.8787,-12,-5,.8787,0,0,0,36,0,0,0,.7574, ldraw_lib__box3u4p(realsolid)],
// 1 16 25.7574 6 -5 0 .5666 .5666 -18 0 0 0 -.3787 .3787 box2-7.dat
  [1,16,25.7574,6,-5,0,.5666,.5666,-18,0,0,0,-.3787,.3787, ldraw_lib__box2_7(realsolid)],
...
// 1 16 35.1213 -12 5 -.8787 0 0 0 36 0 0 0 -.7574 box3u4p.dat
  [1,16,35.1213,-12,5,-.8787,0,0,0,36,0,0,0,-.7574, ldraw_lib__box3u4p(realsolid)],
// 1 16 34.2426 6 5 0 -.5666 -.5666 -18 0 0 0 .3787 -.3787 box2-7.dat
  [1,16,34.2426,6,5,0,-.5666,-.5666,-18,0,0,0,.3787,-.3787, ldraw_lib__box2_7(realsolid)],
...
// 1 16 30 24 0 0 0 -6 0 -36 0 16 0 0 box5-2p.dat
  [1,16,30,24,0,0,0,-6,0,-36,0,16,0,0, ldraw_lib__box5_2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -8 24 0 0 0 -28 0 -20 0 16 0 0 box5-1.dat
  [1,16,-8,24,0,0,0,-28,0,-20,0,16,0,0, ldraw_lib__box5_1(realsolid)],
...
// 1 16 -10 24 0 0 0 -30 0 -24 0 20 0 0 box4-4a.dat
  [1,16,-10,24,0,0,0,-30,0,-24,0,20,0,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 20 4.5 0 0 20 0 -19.5 0 0 0 0 -20 box3u7a.dat
  [1,16,20,4.5,0,0,20,0,-19.5,0,0,0,0,-20, ldraw_lib__box3u7a(realsolid)],
// 1 16 40 -15.5 0 0 -1 0 0 0 -.5 20 0 0 rect3.dat
  [1,16,40,-15.5,0,0,-1,0,0,0,-.5,20,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 30 -15 0 0 0 -1 0 1 0 1 0 0 clh13.dat
  [1,16,30,-15,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__clh13(realsolid)],
// 
// 0 // Studs
...
module ldraw_lib__18455(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__18455(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
