...
// 1 16 92 14 0 0 0 4 0 -10 0 -6 0 0 box2-5.dat
  [1,16,92,14,0,0,0,4,0,-10,0,-6,0,0, ldraw_lib__box2_5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -92 14 0 0 0 -4 0 -10 0 6 0 0 box2-5.dat
  [1,16,-92,14,0,0,0,-4,0,-10,0,6,0,0, ldraw_lib__box2_5()],
...
// 1 16 88 7 0 0 -1 0 -3 0 0 0 0 -6 rect2p.dat
  [1,16,88,7,0,0,-1,0,-3,0,0,0,0,-6, ldraw_lib__rect2p()],
// 1 16 -88 7 0 0 1 0 -3 0 0 0 0 6 rect2p.dat
  [1,16,-88,7,0,0,1,0,-3,0,0,0,0,6, ldraw_lib__rect2p()],
...
// 1 16 0 24 0 0 0 -100 0 -24 0 -10 0 0 box3u2p.dat
  [1,16,0,24,0,0,0,-100,0,-24,0,-10,0,0, ldraw_lib__box3u2p()],
...
module ldraw_lib__2730(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2730(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
