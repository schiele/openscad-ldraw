...
use <650k03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__650c(realsolid=false) = [
// 0 ~Moved to 650k03
// 0 Name: 650c.dat
// 0 Author: [PTadmin]
...
// 1 16 0 2.25 1 1 0 0 0 1 0 0 0 1 650k03.dat
  [1,16,0,2.25,1,1,0,0,0,1,0,0,0,1, ldraw_lib__650k03(realsolid)],
];
module ldraw_lib__650c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__650c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
