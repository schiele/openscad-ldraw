...
use <61280.scad>
use <71830-f2.scad>
function ldraw_lib__57796bc02() = [
// 0 Technic Competition Cannon with Flat Bottom with Short Trigger (Loaded with Arrow)
// 0 Name: 57796bc02.dat
...
module ldraw_lib__57796bc02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__57796bc02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__57796bc02(line=0.2);