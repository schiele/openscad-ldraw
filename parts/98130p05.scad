...
use <s/98130s02.scad>
use <s/98130s03.scad>
function ldraw_lib__98130p05() = [
// 0 Minifig Kendo Mask with Metallic Gold Grille Pattern
// 0 Name: 98130p05.dat
...
module ldraw_lib__98130p05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98130p05(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__98130p05(line=0.2);