...
use <s/92911s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92911(realsolid=false) = [
...
// 1 16 10 -10 40 0 0 1 0 1 0 -1 0 0 npeghol8.dat
  [1,16,10,-10,40,0,0,1,0,1,0,-1,0,0, ldraw_lib__npeghol8(realsolid)],
// 1 16 -10 -10 40 0 0 -1 0 1 0 1 0 0 npeghol8.dat
  [1,16,-10,-10,40,0,0,-1,0,1,0,1,0,0, ldraw_lib__npeghol8(realsolid)],
// 1 16 10 10 40 0 0 1 0 -1 0 1 0 0 npeghol8.dat
  [1,16,10,10,40,0,0,1,0,-1,0,1,0,0, ldraw_lib__npeghol8(realsolid)],
...
// 1 16 0 0 40 1 0 0 0 0 -1 0 1 0 connhole.dat
  [1,16,0,0,40,1,0,0,0,0,-1,0,1,0, ldraw_lib__connhole(realsolid)],
// 1 16 0 0 30 1 0 0 0 0 -1 0 1 0 4-4ring9.dat
  [1,16,0,0,30,1,0,0,0,0,-1,0,1,0, ldraw_lib__4_4ring9(realsolid)],
// 1 16 0 0 50 9 0 0 0 0 -9 0 -1 0 4-4ndis.dat
  [1,16,0,0,50,9,0,0,0,0,-9,0,-1,0, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 20 -10 40 0 0 9 0 20 0 -9 0 0 2-4cylo.dat
  [1,16,20,-10,40,0,0,9,0,20,0,-9,0,0, ldraw_lib__2_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 20 0 0 10 10 0 0 0 10 0 4-4cylo.dat
  [1,16,0,0,20,0,0,10,10,0,0,0,10,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 0 20 0 0 3.33333 3.33333 0 0 0 1 0 4-4ring3.dat
  [1,16,0,0,20,0,0,3.33333,3.33333,0,0,0,1,0, ldraw_lib__4_4ring3(realsolid)],
// 1 16 0 0 20 0 0 13.3333 13.3333 0 0 0 1 0 4-4edge.dat
  [1,16,0,0,20,0,0,13.3333,13.3333,0,0,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 25 9.42807 0 9.42807 9.42807 0 -9.42807 0 1 0 1-4edge.dat
  [1,16,0,0,25,9.42807,0,9.42807,9.42807,0,-9.42807,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 0 25 9.42807 0 9.42807 9.42807 0 -9.42807 0 -5 0 1-4cyli.dat
  [1,16,0,0,25,9.42807,0,9.42807,9.42807,0,-9.42807,0,-5,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 0 0 25 -9.42807 0 -9.42807 -9.42807 0 9.42807 0 1 0 1-4edge.dat
  [1,16,0,0,25,-9.42807,0,-9.42807,-9.42807,0,9.42807,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 0 25 -9.42807 0 -9.42807 -9.42807 0 9.42807 0 -5 0 1-4cyli.dat
  [1,16,0,0,25,-9.42807,0,-9.42807,-9.42807,0,9.42807,0,-5,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 20 -10 40 -0.38268 0 -0.92388 0 1 0 0.92388 0 -0.38268 3-8ring9.dat
  [1,16,20,-10,40,-0.38268,0,-0.92388,0,1,0,0.92388,0,-0.38268, ldraw_lib__3_8ring9(realsolid)],
...
// 1 16 0 0 26 14 0 0 0 0 -14 0 4 0 4-4cylo.dat
  [1,16,0,0,26,14,0,0,0,0,-14,0,4,0, ldraw_lib__4_4cylo(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\92911s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92911s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\92911s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__92911s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 1 s\92911s01.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__92911s01(realsolid)],
...
module ldraw_lib__92911(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92911(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
