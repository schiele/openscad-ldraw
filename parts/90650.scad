...
use <s/90650s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__90650(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\90650s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__90650s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\90650s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__90650s02(realsolid)],
// 
// 0 // ball clip
...
// 1 16 0 -69.25 -21.75 8.39 0 0 0 1 0 0 0 1.75 rect2p.dat
  [1,16,0,-69.25,-21.75,8.39,0,0,0,1,0,0,0,1.75, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__90650(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__90650(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
