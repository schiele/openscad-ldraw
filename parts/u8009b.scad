...
function ldraw_lib__u8009b() = [
// 0 Mursten Brick  4 x  4 Corner with 1 Slot Right
// 0 Name: u8009b.dat
...
// 
// 0 !CATEGORY Brick
// 0 !KEYWORDS Automatic Binding Brick, BrickLink bslot16R, Lego Mursten
// 0 !KEYWORDS Rebrickable upn0046a
// 
// 0 !HISTORY 2022-03-27 [MagFors] Studs without logo
// 0 !HISTORY 2024-12-30 [OrionP] Official Update 2024-11
// 
// 
// 4 16 16 24 56 -16 24 56 -20 24 60 20 24 60
  [4,16,16,24,56,-16,24,56,-20,24,60,20,24,60],
...
// 1 16 0 14 56 -16 0 0 0 0 -10 0 1 0 rect.dat
  [1,16,0,14,56,-16,0,0,0,0,-10,0,1,0, ldraw_lib__rect()],
...
// 1 16 0 12 40 0 0 20 -12 0 0 0 20 0 box2-7.dat
  [1,16,0,12,40,0,0,20,-12,0,0,0,20,0, ldraw_lib__box2_7()],
// 1 16 40 12 20 -20 0 0 0 0 -12 0 -1 0 rect.dat
  [1,16,40,12,20,-20,0,0,0,0,-12,0,-1,0, ldraw_lib__rect()],
// 4 16 20 0 20 -20 0 -20 56 0 -20 56 0 20
  [4,16,20,0,20,-20,0,-20,56,0,-20,56,0,20],
// 4 16 -20 0 -20 20 0 20 20 0 60 -20 0 60
  [4,16,-20,0,-20,20,0,20,20,0,60,-20,0,60],
...
module ldraw_lib__u8009b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8009b(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u8009b(line=0.2);