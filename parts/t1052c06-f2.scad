...
use <t1099.scad>
$fa=1; $fs=0.2;
function ldraw_lib__t1052c06_f2(realsolid=false) = [
// 0 | Circuit Cubes Knife Switch (Opened)
// 0 Name: t1052c06-f2.dat
...
// 1 15 0 34 0 -1 0 0 0 1 0 0 0 -1 t1053p03.dat
  [1,15,0,34,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1053p03(realsolid)],
// 
// 0 // bottom contacts
...
// 1 494 -19.5 29.5 0 1 0 0 0 1 0 0 0 1 t1098.dat
  [1,494,-19.5,29.5,0,1,0,0,0,1,0,0,0,1, ldraw_lib__t1098(realsolid)],
// 1 494 19.5 29.5 0 1 0 0 0 1 0 0 0 1 t1098.dat
  [1,494,19.5,29.5,0,1,0,0,0,1,0,0,0,1, ldraw_lib__t1098(realsolid)],
// 
// 0 // Lever
// 1 494 -19.5 13.5 0 -0.25882 0.96593 0 -0.96593 -0.25882 0 0 0 1 t1099.dat
  [1,494,-19.5,13.5,0,-0.25882,0.96593,0,-0.96593,-0.25882,0,0,0,1, ldraw_lib__t1099(realsolid)],
];
module ldraw_lib__t1052c06_f2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1052c06_f2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
