...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 26021.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__26021()],
// 1 72 -25 17.4 0 0 0 1 0 1 0 -1 0 0 24869.dat
  [1,72,-25,17.4,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__24869()],
// 1 72 25 17.4 0 0 0 1 0 1 0 -1 0 0 24869.dat
  [1,72,25,17.4,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__24869()],
];
module ldraw_lib__26021c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__26021c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
