...
$fa=1; $fs=0.2;
function ldraw_lib__23405(realsolid=false) = [
...
// 1 16 0 58 10 56 0 0 0 0 54 0 -16 0 box4.dat
  [1,16,0,58,10,56,0,0,0,0,54,0,-16,0, ldraw_lib__box4(realsolid)],
...
// 1 16 0 116 0 -1 0 0 0 -1 0 0 0 -1 stug3-1x5.dat
  [1,16,0,116,0,-1,0,0,0,-1,0,0,0,-1, ldraw_lib__stug3_1x5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 -42 58 -8 0 -8 2 -54 0 0 0 0 2 box2-5.dat
  [1,16,-42,58,-8,0,-8,2,-54,0,0,0,0,2, ldraw_lib__box2_5(realsolid)],
// 1 16 -30 58 -8 0 0 2 -54 0 0 0 1 -2 rect3.dat
  [1,16,-30,58,-8,0,0,2,-54,0,0,0,1,-2, ldraw_lib__rect3(realsolid)],
// 4 16 -28 4 -10 -28 112 -10 -12 112 -10 -12 4 -10
  [4,16,-28,4,-10,-28,112,-10,-12,112,-10,-12,4,-10],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -2 58 -8 0 -8 2 -54 0 0 0 0 2 box2-5.dat
  [1,16,-2,58,-8,0,-8,2,-54,0,0,0,0,2, ldraw_lib__box2_5(realsolid)],
// 1 16 10 58 -8 0 0 2 -54 0 0 0 1 -2 rect3.dat
  [1,16,10,58,-8,0,0,2,-54,0,0,0,1,-2, ldraw_lib__rect3(realsolid)],
...
// 1 16 -52.5 58 -4 0 1.5 -2 -54 0 0 0 0 -2 box2-5.dat
  [1,16,-52.5,58,-4,0,1.5,-2,-54,0,0,0,0,-2, ldraw_lib__box2_5(realsolid)],
// 1 16 -38 58 -4 0 9 -2 54 0 0 0 0 2 box2-7.dat
  [1,16,-38,58,-4,0,9,-2,54,0,0,0,0,2, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -18 58 -4 0 7 -2 -54 0 0 0 0 -2 box2-5.dat
  [1,16,-18,58,-4,0,7,-2,-54,0,0,0,0,-2, ldraw_lib__box2_5(realsolid)],
// 1 16 0 58 -2 9 0 0 0 0 -54 0 -1 0 rect2p.dat
  [1,16,0,58,-2,9,0,0,0,0,-54,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 18 58 -4 0 -7 2 -54 0 0 0 0 -2 box2-5.dat
  [1,16,18,58,-4,0,-7,2,-54,0,0,0,0,-2, ldraw_lib__box2_5(realsolid)],
...
module ldraw_lib__23405(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__23405(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
