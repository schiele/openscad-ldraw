...
use <s/3010s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3010pza(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Brickheadz, BrickLink 3010pb210, Set 41490
// 
...
// 1 16 0 0 -10 1 0 0 0 1 0 0 0 1 s\3010pzas01.dat
  [1,16,0,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010pzas01(realsolid)],
// 1 16 0 0 -10 -1 0 0 0 1 0 0 0 1 s\3010pzas01.dat
  [1,16,0,0,-10,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010pzas01(realsolid)],
];
module ldraw_lib__3010pza(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3010pza(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
