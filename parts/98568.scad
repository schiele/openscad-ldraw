...
// 0 Constraction Blade 11.5L with Sawtooth Back
// 0 Name: 98568.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS hero factory, sword, Technic, Weapon
// 
...
module ldraw_lib__98568(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98568(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
