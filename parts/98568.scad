...
use <s/98568s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98568(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 0.99889 0.04711 0 -0.04711 0.99889 s\98568s02.dat
  [1,16,0,0,0,1,0,0,0,0.99889,0.04711,0,-0.04711,0.99889, ldraw_lib__s__98568s02(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\98568s03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__98568s03(realsolid)],
];
module ldraw_lib__98568(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98568(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__98568(line=0.2);