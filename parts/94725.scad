...
use <s/94725s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__94725(realsolid=false) = [
...
// 1 16 0 0 0 2 0 0 0 -5.5 0 0 0 2 4-4cylc.dat
  [1,16,0,0,0,2,0,0,0,-5.5,0,0,0,2, ldraw_lib__4_4cylc(realsolid)],
// 
// 0 // Body
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\94725s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__94725s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\94725s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__94725s01(realsolid)],
...
module ldraw_lib__94725(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__94725(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
