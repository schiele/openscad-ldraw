...
use <../p/znap6.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32229(realsolid=false) = [
// 0 Znap Beam  7 Holes
// 0 Name: 32229.dat
...
// 1 16 0 0 -140 1 0 0 0 1 0 0 0 1 znap6.dat
  [1,16,0,0,-140,1,0,0,0,1,0,0,0,1, ldraw_lib__znap6(realsolid)],
// 1 16 0 0 -100 1 0 0 0 1 0 0 0 1 znap1.dat
  [1,16,0,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__znap1(realsolid)],
// 1 16 0 0 -120 1 0 0 0 1 0 0 0 1 connhole.dat
  [1,16,0,0,-120,1,0,0,0,1,0,0,0,1, ldraw_lib__connhole(realsolid)],
// 1 16 0 0 60 1 0 0 0 1 0 0 0 1 znap1.dat
  [1,16,0,0,60,1,0,0,0,1,0,0,0,1, ldraw_lib__znap1(realsolid)],
// 1 16 0 0 -60 1 0 0 0 1 0 0 0 1 znap1.dat
  [1,16,0,0,-60,1,0,0,0,1,0,0,0,1, ldraw_lib__znap1(realsolid)],
// 1 16 0 0 140 -1 0 0 0 1 0 0 0 -1 znap6.dat
  [1,16,0,0,140,-1,0,0,0,1,0,0,0,-1, ldraw_lib__znap6(realsolid)],
...
// 1 16 0 0 -20 -1 0 0 0 1 0 0 0 -1 znap1.dat
  [1,16,0,0,-20,-1,0,0,0,1,0,0,0,-1, ldraw_lib__znap1(realsolid)],
// 1 16 0 0 20 -1 0 0 0 1 0 0 0 -1 znap1.dat
  [1,16,0,0,20,-1,0,0,0,1,0,0,0,-1, ldraw_lib__znap1(realsolid)],
// 1 16 -10 0 0 0 1 0 10 0 0 0 0 145 rect.dat
  [1,16,-10,0,0,0,1,0,10,0,0,0,0,145, ldraw_lib__rect(realsolid)],
// 1 16 10 0 0 0 -1 0 10 0 0 0 0 145 rect.dat
  [1,16,10,0,0,0,-1,0,10,0,0,0,0,145, ldraw_lib__rect(realsolid)],
// 0
];
module ldraw_lib__32229(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32229(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
