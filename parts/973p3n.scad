...
// 1 1 0 0 0 1 0 0 0 1 0 0 0 1 s\973p35c.dat
  [1,1,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p35c()],
...
module ldraw_lib__973p3n(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p3n(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
