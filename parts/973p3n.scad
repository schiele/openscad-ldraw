...
use <s/973s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973p3n(realsolid=false) = [
// 0 Minifig Torso with Blue Imperial Guard Pattern
// 0 Name: 973p3n.dat
...
// 1 1 0 0 0 1 0 0 0 1 0 0 0 1 s\973p35c.dat
  [1,1,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p35c(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\973p35d.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p35d(realsolid)],
];
module ldraw_lib__973p3n(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p3n(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__973p3n(line=0.2);