...
// 0 !HELP 1 16 0 0 1.25 1 0 0 0 1 0 0 0 1 3816cp71.dat
...
// 
// 
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 3817cp71.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__3817cp71()],
];
module ldraw_lib__3816cp71(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3816cp71(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3816cp71(line=0.2);