...
use <41769.scad>
$fa=1; $fs=0.2;
function ldraw_lib__63330(realsolid=false) = [
// 0 =Wing  2 x  4 Right
// 0 Name: 63330.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 41769.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__41769(realsolid)],
];
module ldraw_lib__63330(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__63330(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
