...
use <4221.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4220ac01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 4220a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4220a(realsolid)],
// 1 16 0 0 0 1 0 0 0 0.9911 0.133121 0 -0.133121 0.9911 4221.dat
  [1,16,0,0,0,1,0,0,0,0.9911,0.133121,0,-0.133121,0.9911, ldraw_lib__4221(realsolid)],
// 1 16 0 0 0 -1 0 0 0 -0.9911 -0.133121 0 -0.133121 0.9911 4221.dat
  [1,16,0,0,0,-1,0,0,0,-0.9911,-0.133121,0,-0.133121,0.9911, ldraw_lib__4221(realsolid)],
];
module ldraw_lib__4220ac01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4220ac01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
