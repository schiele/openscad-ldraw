...
use <../p/t04o6250.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3626bp8m(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 3626bpb0450, Set 10223, Set 40083, Set 7188, Set 7946
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3626bp8ms01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3626bp8ms01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\3626bp8ms01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3626bp8ms01(realsolid)],
];
module ldraw_lib__3626bp8m(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3626bp8m(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
