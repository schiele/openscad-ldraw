...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 80679pb01, Rebrickable 80679pr0001, Set 60330
// 
...
// 1 70 0 0 0 1 0 0 0 1 0 0 0 1 s\80679p01s02.dat
  [1,70,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__80679p01s02()],
// 1 70 0 0 0 -1 0 0 0 1 0 0 0 1 s\80679p01s02.dat
  [1,70,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__80679p01s02()],
...
module ldraw_lib__80679p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__80679p01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
