...
use <s/92198s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92198p03(realsolid=false) = [
...
// 1 29 0 0 0 1 0 0 0 1 0 0 0 1 s\92198p01s02.dat
  [1,29,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92198p01s02(realsolid)],
// 1 6 0 0 0 1 0 0 0 1 0 0 0 1 s\92198p01s03.dat
  [1,6,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92198p01s03(realsolid)],
];
module ldraw_lib__92198p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92198p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
