...
use <s/35787s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__35787ps1(realsolid=false) = [
...
// 1 87 -15.1 0 -15.1 -1.76777 0 -2.89914 0 1 0 1.76777 0 -2.89914 2-4disc.dat
  [1,87,-15.1,0,-15.1,-1.76777,0,-2.89914,0,1,0,1.76777,0,-2.89914, ldraw_lib__2_4disc(realsolid)],
// 1 16 -15.1 0 -15.1 -1.76777 0 -2.89914 0 1 0 1.76777 0 -2.89914 2-4ndis.dat
  [1,16,-15.1,0,-15.1,-1.76777,0,-2.89914,0,1,0,1.76777,0,-2.89914, ldraw_lib__2_4ndis(realsolid)],
...
// 1 80 12.9 0 -16.8 1.5 0 0 0 1 0 0 0 1.5 4-4disc.dat
  [1,80,12.9,0,-16.8,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__4_4disc(realsolid)],
// 1 16 12.9 0 -16.8 1.5 0 0 0 1 0 0 0 1.5 4-4ndis.dat
  [1,16,12.9,0,-16.8,1.5,0,0,0,1,0,0,0,1.5, ldraw_lib__4_4ndis(realsolid)],
...
// 1 80 -16.8 0 12.9 0 0 1.5 0 1 0 1.5 0 0 4-4disc.dat
  [1,80,-16.8,0,12.9,0,0,1.5,0,1,0,1.5,0,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 -16.8 0 12.9 0 0 1.5 0 1 0 1.5 0 0 4-4ndis.dat
  [1,16,-16.8,0,12.9,0,0,1.5,0,1,0,1.5,0,0, ldraw_lib__4_4ndis(realsolid)],
...
module ldraw_lib__35787ps1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__35787ps1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
