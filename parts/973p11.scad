...
use <s/973s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973p11(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\973p11a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p11a(realsolid)],
// 0 Pattern background in white
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\973p11b.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p11b(realsolid)],
// 0
// 
];
module ldraw_lib__973p11(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p11(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
