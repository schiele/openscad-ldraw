...
$fa=1; $fs=0.2;
function ldraw_lib__30367aps2(realsolid=false) = [
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\30367ps2s02.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30367ps2s02(realsolid)],
// 1 4 0 0 0 -1 0 0 0 1 0 0 0 1 s\30367ps2s02.dat
  [1,4,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30367ps2s02(realsolid)],
// 1 4 0 0 0 1 0 0 0 1 0 0 0 -1 s\30367ps2s02.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__30367ps2s02(realsolid)],
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\30367ps2s04.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30367ps2s04(realsolid)],
];
module ldraw_lib__30367aps2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30367aps2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
