...
use <938.scad>
$fa=1; $fs=0.2;
function ldraw_lib__ms1042(realsolid=false) = [
...
// 1 0 0 -40 -39 1 0 0 0 1 0 0 0 1 938.dat
  [1,0,0,-40,-39,1,0,0,0,1,0,0,0,1, ldraw_lib__938(realsolid)],
...
module ldraw_lib__ms1042(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__ms1042(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
