...
use <3820.scad>
use <973p79.scad>
function ldraw_lib__76382p79() = [
// 0 Minifig Torso with Arms and Hands with Lifebelt Logo and ID Card Pattern
// 0 Name: 76382p79.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973p79.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973p79()],
...
module ldraw_lib__76382p79(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382p79(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382p79(line=0.2);