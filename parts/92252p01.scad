...
use <s/92252s05.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92252p01(realsolid=false) = [
...
// 1 13 0 0 0 1 0 0 0 1 0 0 0 1 s\92252p01s01.dat
  [1,13,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92252p01s01(realsolid)],
// 1 78 0 0 0 1 0 0 0 1 0 0 0 1 s\92252p01s02.dat
  [1,78,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92252p01s02(realsolid)],
// 1 78 0 0 0 -1 0 0 0 1 0 0 0 1 s\92252s04.dat
  [1,78,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__92252s04(realsolid)],
// 1 78 0 0 0 -1 0 0 0 1 0 0 0 1 s\92252s03.dat
  [1,78,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__92252s03(realsolid)],
...
module ldraw_lib__92252p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92252p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
