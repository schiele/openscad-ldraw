...
use <s/3070bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3070bpty(realsolid=false) = [
...
// 1 80 0 0 0 1 0 0 0 1 0 0 0 1 s\3070baty.dat
  [1,80,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3070baty(realsolid)],
...
module ldraw_lib__3070bpty(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3070bpty(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
