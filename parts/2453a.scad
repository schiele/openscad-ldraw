...
use <../p/stud2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2453a(realsolid=false) = [
...
// 1 16 0 4 0 6 0 0 0 116 0 0 0 6 box4.dat
  [1,16,0,4,0,6,0,0,0,116,0,0,0,6, ldraw_lib__box4(realsolid)],
...
// 1 16 0 0 0 10 0 0 0 120 0 0 0 10 box4.dat
  [1,16,0,0,0,10,0,0,0,120,0,0,0,10, ldraw_lib__box4(realsolid)],
...
module ldraw_lib__2453a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2453a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
