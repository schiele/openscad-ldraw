...
use <3817bpx2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__73200px2(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3815bpx2.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3815bpx2(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3816bpx2.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816bpx2(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3817bpx2.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817bpx2(realsolid)],
];
module ldraw_lib__73200px2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73200px2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
