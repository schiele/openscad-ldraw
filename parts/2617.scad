...
use <../p/stug2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2617(realsolid=false) = [
...
// 1 16 118 33.5 156 0 0 2 -22.5 0 0 0 1 0 rect1.dat
  [1,16,118,33.5,156,0,0,2,-22.5,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
// 1 16 100 29.5 156 0 0 16 -26.5 0 0 0 1 0 rect1.dat
  [1,16,100,29.5,156,0,0,16,-26.5,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 0 56 0 36 0 0 0 -53 0 0 0 36 box4.dat
  [1,16,0,56,0,36,0,0,0,-53,0,0,0,36, ldraw_lib__box4(realsolid)],
// 1 16 0 56 0 40 0 0 0 -53 0 0 0 40 box4.dat
  [1,16,0,56,0,40,0,0,0,-53,0,0,0,40, ldraw_lib__box4(realsolid)],
// 0 //
...
// 1 16 126 11 0 -10 0 0 0 -1 0 0 0 156 rect1.dat
  [1,16,126,11,0,-10,0,0,0,-1,0,0,0,156, ldraw_lib__rect1(realsolid)],
// 4 16 -136 11 84 -156 11 84 -156 11 120 -136 11 120
  [4,16,-136,11,84,-156,11,84,-156,11,120,-136,11,120],
// 4 16 -136 11 -120 -156 11 -120 -156 11 -84 -136 11 -84
  [4,16,-136,11,-120,-156,11,-120,-156,11,-84,-136,11,-84],
...
// 1 16 116 7 0 0 1 0 0 0 -4 -156 0 0 rect3.dat
  [1,16,116,7,0,0,1,0,0,0,-4,-156,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 -116 7 0 0 -1 0 0 0 -4 -156 0 0 rect3.dat
  [1,16,-116,7,0,0,-1,0,0,0,-4,-156,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 120 4 0 0 -1 0 0 0 -4 -160 0 0 rect.dat
  [1,16,120,4,0,0,-1,0,0,0,-4,-160,0,0, ldraw_lib__rect(realsolid)],
// 1 16 -120 4 0 0 1 0 0 0 -4 -160 0 0 rect.dat
  [1,16,-120,4,0,0,1,0,0,0,-4,-160,0,0, ldraw_lib__rect(realsolid)],
// 1 16 0 3 0 -116 0 0 0 -1 0 0 0 156 rect2p.dat
  [1,16,0,3,0,-116,0,0,0,-1,0,0,0,156, ldraw_lib__rect2p(realsolid)],
// 1 16 0 0 0 -120 0 0 0 1 0 0 0 160 rect2p.dat
  [1,16,0,0,0,-120,0,0,0,1,0,0,0,160, ldraw_lib__rect2p(realsolid)],
// 0 //
...
module ldraw_lib__2617(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2617(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
