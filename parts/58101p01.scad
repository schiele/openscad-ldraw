...
use <s/58101s07.scad>
use <../p/stud2.scad>
function ldraw_lib__58101p01() = [
// 0 Figure Legs Mario Id "100001" with Reddish Brown Feet Pattern
// 0 Name: 58101p01.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 58101pb01, Rebrickable 58101pr0001, Regular, Set 71360
// 
...
// 1 16 21.8 -21.3 -27 1 0 0 0 1 0 0 0 1 s\58101s05.dat
  [1,16,21.8,-21.3,-27,1,0,0,0,1,0,0,0,1, ldraw_lib__s__58101s05()],
// 1 16 -6.9 -21.3 -27 1 0 0 0 1 0 0 0 1 s\58101s04.dat
  [1,16,-6.9,-21.3,-27,1,0,0,0,1,0,0,0,1, ldraw_lib__s__58101s04()],
// 1 16 -14.3 -21.3 -27 1 0 0 0 1 0 0 0 1 s\58101s04.dat
  [1,16,-14.3,-21.3,-27,1,0,0,0,1,0,0,0,1, ldraw_lib__s__58101s04()],
...
module ldraw_lib__58101p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__58101p01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__58101p01(line=0.2);