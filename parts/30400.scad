...
use <../p/stug-4x4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30400(realsolid=false) = [
...
// 1 16 -140 4 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-140,4,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 -100 4 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-100,4,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 -140 4 0 0 0 -1 0 -5 0 -1 0 0 stud4f4s.dat
  [1,16,-140,4,0,0,0,-1,0,-5,0,-1,0,0, ldraw_lib__stud4f4s(realsolid)],
// 1 16 -120 4 0 1 0 0 0 1 0 0 0 1 filletr0s.dat
  [1,16,-120,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__filletr0s(realsolid)],
// 1 16 -100 4 0 0 0 -1 0 -5 0 -1 0 0 stud4f4s.dat
  [1,16,-100,4,0,0,0,-1,0,-5,0,-1,0,0, ldraw_lib__stud4f4s(realsolid)],
// 1 16 -80 4 0 1 0 0 0 1 0 0 0 1 filletr0s.dat
  [1,16,-80,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__filletr0s(realsolid)],
// 1 16 -60 4 0 0 0 -1 0 -5 0 -1 0 0 stud4f4s.dat
  [1,16,-60,4,0,0,0,-1,0,-5,0,-1,0,0, ldraw_lib__stud4f4s(realsolid)],
// 1 16 -40 4 0 1 0 0 0 1 0 0 0 1 filletr0s.dat
  [1,16,-40,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__filletr0s(realsolid)],
// 1 16 -20 4 0 0 0 -1 0 -5 0 -1 0 0 stud4f4s.dat
  [1,16,-20,4,0,0,0,-1,0,-5,0,-1,0,0, ldraw_lib__stud4f4s(realsolid)],
// 1 16 0 4 0 1 0 0 0 1 0 0 0 1 filletr0s.dat
  [1,16,0,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__filletr0s(realsolid)],
// 1 16 20 4 0 0 0 -1 0 -5 0 -1 0 0 stud4f4s.dat
  [1,16,20,4,0,0,0,-1,0,-5,0,-1,0,0, ldraw_lib__stud4f4s(realsolid)],
// 1 16 40 4 0 1 0 0 0 1 0 0 0 1 filletr0s.dat
  [1,16,40,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__filletr0s(realsolid)],
...
// 1 16 -140 4 0 -1 0 0 0 1 0 0 0 -1 filletr2s.dat
  [1,16,-140,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletr2s(realsolid)],
// 1 16 -100 4 0 -1 0 0 0 1 0 0 0 -1 filletr1s.dat
  [1,16,-100,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletr1s(realsolid)],
// 1 16 -60 4 0 -1 0 0 0 1 0 0 0 -1 filletr1s.dat
  [1,16,-60,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletr1s(realsolid)],
// 1 16 -20 4 0 -1 0 0 0 1 0 0 0 -1 filletr1s.dat
  [1,16,-20,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletr1s(realsolid)],
// 1 16 20 4 0 -1 0 0 0 1 0 0 0 -1 filletr1s.dat
  [1,16,20,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletr1s(realsolid)],
// 1 16 60 4 0 -1 0 0 0 1 0 0 0 -1 filletr1s.dat
  [1,16,60,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletr1s(realsolid)],
...
// 1 16 140 4 0 -1 0 0 0 1 0 0 0 -1 filletr1s.dat
  [1,16,140,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletr1s(realsolid)],
// 1 16 140 4 0 0 0 1 0 1 0 -1 0 0 filletr2s.dat
  [1,16,140,4,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__filletr2s(realsolid)],
// 1 16 140 4 0 1 0 0 0 1 0 0 0 1 filletr2s.dat
  [1,16,140,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__filletr2s(realsolid)],
// 1 16 100 4 0 1 0 0 0 1 0 0 0 1 filletr1s.dat
  [1,16,100,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__filletr1s(realsolid)],
...
// 1 16 -160 4 20 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-160,4,20,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -120 4 20 1 0 0 0 -5 0 0 0 1 stud4.dat
  [1,16,-120,4,20,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
// 1 16 0 24 0 180 0 0 0 -24 0 0 0 40 box5.dat
  [1,16,0,24,0,180,0,0,0,-24,0,0,0,40, ldraw_lib__box5(realsolid)],
// 1 16 -170 0 0 1 0 0 0 1 0 0 0 1 stug-4x1.dat
  [1,16,-170,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x1(realsolid)],
// 1 16 -120 0 0 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,-120,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4(realsolid)],
...
module ldraw_lib__30400(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30400(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
