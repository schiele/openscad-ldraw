...
use <../p/connect.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2460(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 connect.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__connect(realsolid)],
// 0
];
module ldraw_lib__2460(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2460(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2460(line=0.2);