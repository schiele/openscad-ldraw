...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2399(realsolid=false) = [
// 0 Wedge  3 x  4
// 0 Name: 2399.dat
...
// 1 16 30 4 -8 1 0 0 0 20 0 0 0 2 box5.dat
  [1,16,30,4,-8,1,0,0,0,20,0,0,0,2, ldraw_lib__box5(realsolid)],
// 1 16 -30 4 -8 1 0 0 0 20 0 0 0 2 box5.dat
  [1,16,-30,4,-8,1,0,0,0,20,0,0,0,2, ldraw_lib__box5(realsolid)],
// 1 16 18 12 -20 2 0 0 0 12 0 0 0 1 box5.dat
  [1,16,18,12,-20,2,0,0,0,12,0,0,0,1, ldraw_lib__box5(realsolid)],
// 1 16 -18 12 -20 2 0 0 0 12 0 0 0 1 box5.dat
  [1,16,-18,12,-20,2,0,0,0,12,0,0,0,1, ldraw_lib__box5(realsolid)],
// 1 16 18 12 -40 2 0 0 0 12 0 0 0 1 box5.dat
  [1,16,18,12,-40,2,0,0,0,12,0,0,0,1, ldraw_lib__box5(realsolid)],
// 1 16 -18 12 -40 2 0 0 0 12 0 0 0 1 box5.dat
  [1,16,-18,12,-40,2,0,0,0,12,0,0,0,1, ldraw_lib__box5(realsolid)],
...
// 1 16 0 8 -30 20 0 0 0 1 0 0 0 20 rect.dat
  [1,16,0,8,-30,20,0,0,0,1,0,0,0,20, ldraw_lib__rect(realsolid)],
...
// 1 16 10 8 -20 0 0 -1 0 1 0 1 0 0 stud.dat
  [1,16,10,8,-20,0,0,-1,0,1,0,1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -10 8 -20 0 0 -1 0 1 0 1 0 0 stud.dat
  [1,16,-10,8,-20,0,0,-1,0,1,0,1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 10 8 -40 0 0 -1 0 1 0 1 0 0 stud.dat
  [1,16,10,8,-40,0,0,-1,0,1,0,1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 -10 8 -40 0 0 -1 0 1 0 1 0 0 stud.dat
  [1,16,-10,8,-40,0,0,-1,0,1,0,1,0,0, ldraw_lib__stud(realsolid)],
...
module ldraw_lib__2399(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2399(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
