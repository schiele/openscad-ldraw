...
// 1 16 0 -10 0 1 0 0 0 -6 0 0 0 1 4-4con4.dat
  [1,16,0,-10,0,1,0,0,0,-6,0,0,0,1, ldraw_lib__4_4con4()],
...
// 1 16 0 -10 0 3.53553 0 3.53553 0 1 0 -3.53553 0 3.53553 4-4ndis.dat
  [1,16,0,-10,0,3.53553,0,3.53553,0,1,0,-3.53553,0,3.53553, ldraw_lib__4_4ndis()],
// 1 16 0 -10 0 15 0 0 0 1 0 0 0 15 1-4chrd.dat
  [1,16,0,-10,0,15,0,0,0,1,0,0,0,15, ldraw_lib__1_4chrd()],
// 1 16 0 -10 0 0 0 15 0 1 0 -15 0 0 1-4chrd.dat
  [1,16,0,-10,0,0,0,15,0,1,0,-15,0,0, ldraw_lib__1_4chrd()],
// 1 16 0 -10 0 -15 0 0 0 1 0 0 0 -15 1-4chrd.dat
  [1,16,0,-10,0,-15,0,0,0,1,0,0,0,-15, ldraw_lib__1_4chrd()],
// 1 16 0 -10 0 0 0 -15 0 1 0 15 0 0 1-4chrd.dat
  [1,16,0,-10,0,0,0,-15,0,1,0,15,0,0, ldraw_lib__1_4chrd()],
...
module ldraw_lib__u9349(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9349(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
