...
$fa=1; $fs=0.2;
function ldraw_lib__4186(realsolid=false) = [
// 0 Baseplate 48 x 48
// 0 Name: 4186.dat
...
// 1 16 -320 0 320 1 0 0 0 1 0 0 0 1 stug-16x16.dat
  [1,16,-320,0,320,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_16x16(realsolid)],
// 1 16 0 0 320 1 0 0 0 1 0 0 0 1 stug-16x16.dat
  [1,16,0,0,320,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_16x16(realsolid)],
// 1 16 320 0 320 1 0 0 0 1 0 0 0 1 stug-16x16.dat
  [1,16,320,0,320,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_16x16(realsolid)],
// 1 16 -320 0 0 1 0 0 0 1 0 0 0 1 stug-16x16.dat
  [1,16,-320,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_16x16(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 stug-16x16.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_16x16(realsolid)],
// 1 16 320 0 0 1 0 0 0 1 0 0 0 1 stug-16x16.dat
  [1,16,320,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_16x16(realsolid)],
// 1 16 -320 0 -320 1 0 0 0 1 0 0 0 1 stug-16x16.dat
  [1,16,-320,0,-320,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_16x16(realsolid)],
...
// 1 16 -476 2 0 0 952 0 -2 0 0 0 0 480 box4o8a.dat
  [1,16,-476,2,0,0,952,0,-2,0,0,0,0,480, ldraw_lib__box4o8a(realsolid)],
...
// 1 16 476 4 476 4 0 0 0 -1 0 0 0 4 1-4chrd.dat
  [1,16,476,4,476,4,0,0,0,-1,0,0,0,4, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -476 4 476 -4 0 0 0 -1 0 0 0 4 1-4chrd.dat
  [1,16,-476,4,476,-4,0,0,0,-1,0,0,0,4, ldraw_lib__1_4chrd(realsolid)],
// 1 16 476 4 -476 4 0 0 0 -1 0 0 0 -4 1-4chrd.dat
  [1,16,476,4,-476,4,0,0,0,-1,0,0,0,-4, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 480 2 0 0 -1 0 0 0 2 -476 0 0 rect2p.dat
  [1,16,480,2,0,0,-1,0,0,0,2,-476,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -480 2 0 0 1 0 0 0 2 476 0 0 rect2p.dat
  [1,16,-480,2,0,0,1,0,0,0,2,476,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 476 0 476 4 0 0 0 4 0 0 0 4 1-4cylo.dat
  [1,16,476,0,476,4,0,0,0,4,0,0,0,4, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -476 0 476 -4 0 0 0 4 0 0 0 4 1-4cylo.dat
  [1,16,-476,0,476,-4,0,0,0,4,0,0,0,4, ldraw_lib__1_4cylo(realsolid)],
// 1 16 476 0 -476 4 0 0 0 4 0 0 0 -4 1-4cylo.dat
  [1,16,476,0,-476,4,0,0,0,4,0,0,0,-4, ldraw_lib__1_4cylo(realsolid)],
...
// 1 16 476 0 476 4 0 0 0 1 0 0 0 4 1-4chrd.dat
  [1,16,476,0,476,4,0,0,0,1,0,0,0,4, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -476 0 476 -4 0 0 0 1 0 0 0 4 1-4chrd.dat
  [1,16,-476,0,476,-4,0,0,0,1,0,0,0,4, ldraw_lib__1_4chrd(realsolid)],
// 1 16 476 0 -476 4 0 0 0 1 0 0 0 -4 1-4chrd.dat
  [1,16,476,0,-476,4,0,0,0,1,0,0,0,-4, ldraw_lib__1_4chrd(realsolid)],
...
module ldraw_lib__4186(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4186(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
