...
use <s/92252s04.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92250p08(realsolid=false) = [
// 0 Figure Friends Legs with Layered Skirt with Light Nougat Legs and White Shoes Pattern
// 0 Name: 92250p08.dat
...
// 1 78 0 0 0 1 0 0 0 1 0 0 0 1 s\92251p04s02.dat
  [1,78,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92251p04s02(realsolid)],
// 1 78 0 0 0 -1 0 0 0 1 0 0 0 1 s\92251p04s02.dat
  [1,78,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__92251p04s02(realsolid)],
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 s\92251p04s01.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92251p04s01(realsolid)],
// 1 15 0 0 0 -1 0 0 0 1 0 0 0 1 s\92251p04s01.dat
  [1,15,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__92251p04s01(realsolid)],
...
module ldraw_lib__92250p08(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92250p08(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__92250p08(line=0.2);