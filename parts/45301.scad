...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\45301s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__45301s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\45301s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__45301s01()],
...
// 1 16 10 16 -270 0 0 -1 0 1 0 1 0 0 stud.dat
  [1,16,10,16,-270,0,0,-1,0,1,0,1,0,0, ldraw_lib__stud()],
// 1 16 -10 16 -270 0 0 -1 0 1 0 1 0 0 stud.dat
  [1,16,-10,16,-270,0,0,-1,0,1,0,1,0,0, ldraw_lib__stud()],
// 1 16 0 20 -260 0 0 1 0 -1 0 1 0 0 stud4a.dat
  [1,16,0,20,-260,0,0,1,0,-1,0,1,0,0, ldraw_lib__stud4a()],
...
// 1 16 0 5.695 -100 0 0 1 0 -2.57625 0 1 0 0 stud4a.dat
  [1,16,0,5.695,-100,0,0,1,0,-2.57625,0,1,0,0, ldraw_lib__stud4a()],
// 1 16 0 7.051 -120 0 0 1 0 -2.23725 0 1 0 0 stud4a.dat
  [1,16,0,7.051,-120,0,0,1,0,-2.23725,0,1,0,0, ldraw_lib__stud4a()],
// 1 16 0 8.407 -140 0 0 1 0 -1.89825 0 1 0 0 stud4a.dat
  [1,16,0,8.407,-140,0,0,1,0,-1.89825,0,1,0,0, ldraw_lib__stud4a()],
// 1 16 0 9.763 -160 0 0 1 0 -1.55925 0 1 0 0 stud4a.dat
  [1,16,0,9.763,-160,0,0,1,0,-1.55925,0,1,0,0, ldraw_lib__stud4a()],
// 1 16 0 11.119 -180 0 0 1 0 -1.22025 0 1 0 0 stud4a.dat
  [1,16,0,11.119,-180,0,0,1,0,-1.22025,0,1,0,0, ldraw_lib__stud4a()],
// 1 16 0 15.429 -220 0 0 1 0 -2.14275 0 1 0 0 stud4a.dat
  [1,16,0,15.429,-220,0,0,1,0,-2.14275,0,1,0,0, ldraw_lib__stud4a()],
// 1 16 0 18.286 -240 0 0 1 0 -1.4285 0 1 0 0 stud4a.dat
  [1,16,0,18.286,-240,0,0,1,0,-1.4285,0,1,0,0, ldraw_lib__stud4a()],
// 1 16 0 18.286 -240 0 0 -1 0 1.143 0 -1 0 0 stud4s.dat
  [1,16,0,18.286,-240,0,0,-1,0,1.143,0,-1,0,0, ldraw_lib__stud4s()],
// 1 16 0 15.429 -220 0 0 -1 0 1.143 0 -1 0 0 stud4s.dat
  [1,16,0,15.429,-220,0,0,-1,0,1.143,0,-1,0,0, ldraw_lib__stud4s()],
// 1 16 0 11.119 -180 0 0 -1 0 0.543 0 -1 0 0 stud4s.dat
  [1,16,0,11.119,-180,0,0,-1,0,0.543,0,-1,0,0, ldraw_lib__stud4s()],
// 1 16 0 9.763 -160 0 0 -1 0 0.543 0 -1 0 0 stud4s.dat
  [1,16,0,9.763,-160,0,0,-1,0,0.543,0,-1,0,0, ldraw_lib__stud4s()],
// 1 16 0 8.407 -140 0 0 -1 0 0.543 0 -1 0 0 stud4s.dat
  [1,16,0,8.407,-140,0,0,-1,0,0.543,0,-1,0,0, ldraw_lib__stud4s()],
// 1 16 0 7.051 -120 0 0 -1 0 0.543 0 -1 0 0 stud4s.dat
  [1,16,0,7.051,-120,0,0,-1,0,0.543,0,-1,0,0, ldraw_lib__stud4s()],
// 1 16 0 5.695 -100 0 0 -1 0 0.543 0 -1 0 0 stud4s.dat
  [1,16,0,5.695,-100,0,0,-1,0,0.543,0,-1,0,0, ldraw_lib__stud4s()],
// 0
];
module ldraw_lib__45301(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__45301(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
