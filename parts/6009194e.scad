...
$fa=1; $fs=0.2;
function ldraw_lib__6009194e(realsolid=false) = [
...
// 1 16 0 0 15 1 0 0 0 1 0 0 0 1 s\6009194es01.dat
  [1,16,0,0,15,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6009194es01(realsolid)],
// 1 16 0 0 15 1 0 0 0 1 0 0 0 1 s\6009194es02.dat
  [1,16,0,0,15,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6009194es02(realsolid)],
// 1 16 0 0 15 1 0 0 0 1 0 0 0 1 s\6009194es03.dat
  [1,16,0,0,15,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6009194es03(realsolid)],
// 0 // Fillers
...
module ldraw_lib__6009194e(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6009194e(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
