...
use <../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9117(realsolid=false) = [
...
// 1 16 0 60 -23.5 27 0 0 0 0 -43 0 1 0 box5.dat
  [1,16,0,60,-23.5,27,0,0,0,0,-43,0,1,0, ldraw_lib__box5(realsolid)],
];
module ldraw_lib__u9117(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9117(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
