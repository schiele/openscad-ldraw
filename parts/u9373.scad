...
use <s/u9373s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9373(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9373s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9373s01(realsolid)],
// 
// 0 // top hole
// 1 16 0 17.5 40 4 0 0 0 0 1.5 0 -1 0 rect3.dat
  [1,16,0,17.5,40,4,0,0,0,0,1.5,0,-1,0, ldraw_lib__rect3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 19 50 4 0 0 0 -3 0 0 0 4 2-4cylo.dat
  [1,16,0,19,50,4,0,0,0,-3,0,0,0,4, ldraw_lib__2_4cylo(realsolid)],
// 1 16 4 17.5 45 0 1 0 1.5 0 0 0 0 -5 rect3.dat
  [1,16,4,17.5,45,0,1,0,1.5,0,0,0,0,-5, ldraw_lib__rect3(realsolid)],
// 1 16 -4 17.5 45 0 -1 0 -1.5 0 0 0 0 -5 rect3.dat
  [1,16,-4,17.5,45,0,-1,0,-1.5,0,0,0,0,-5, ldraw_lib__rect3(realsolid)],
// 1 16 0 19 50 4 0 0 0 -1 0 0 0 4 2-4ndis.dat
  [1,16,0,19,50,4,0,0,0,-1,0,0,0,4, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 16 50 4 0 0 0 1 0 0 0 4 2-4ndis.dat
  [1,16,0,16,50,4,0,0,0,1,0,0,0,4, ldraw_lib__2_4ndis(realsolid)],
...
// 1 16 0 25 56 4 0 0 0 0 -4 0 4 0 4-4cylo.dat
  [1,16,0,25,56,4,0,0,0,0,-4,0,4,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 25 56 4 0 0 0 0 -4 0 1 0 4-4ndis.dat
  [1,16,0,25,56,4,0,0,0,0,-4,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 25 60 4 0 0 0 0 -4 0 -1 0 4-4ndis.dat
  [1,16,0,25,60,4,0,0,0,0,-4,0,-1,0, ldraw_lib__4_4ndis(realsolid)],
// 
// 0 // vision blocker
// 1 0 0 25 40 0 0 16 -6 0 0 0 -2 0 box.dat
  [1,0,0,25,40,0,0,16,-6,0,0,0,-2,0, ldraw_lib__box(realsolid)],
// 
// 0 // contact plates
// 1 494 13.75 25 42 0 0 -0.25 -5.5 0 0 0 14 0 box5.dat
  [1,494,13.75,25,42,0,0,-0.25,-5.5,0,0,0,14,0, ldraw_lib__box5(realsolid)],
// 1 494 6.25 25 42 0 0 -0.25 -5.5 0 0 0 14 0 box5.dat
  [1,494,6.25,25,42,0,0,-0.25,-5.5,0,0,0,14,0, ldraw_lib__box5(realsolid)],
// 1 494 -6.25 25 42 0 0 -0.25 -5.5 0 0 0 14 0 box5.dat
  [1,494,-6.25,25,42,0,0,-0.25,-5.5,0,0,0,14,0, ldraw_lib__box5(realsolid)],
// 1 494 -13.75 25 42 0 0 -0.25 -5.5 0 0 0 14 0 box5.dat
  [1,494,-13.75,25,42,0,0,-0.25,-5.5,0,0,0,14,0, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__u9373(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9373(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
