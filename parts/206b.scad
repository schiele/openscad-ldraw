...
// 1 16 0 0 20.5 1 0 0 0 1 0 0 0 1 4142.dat
  [1,16,0,0,20.5,1,0,0,0,1,0,0,0,1, ldraw_lib__4142()],
];
module ldraw_lib__206b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__206b(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
