...
use <../p/box.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u8034(realsolid=false) = [
...
// 1 16 0 24 4.5 40 0 0 0 0 19.5 0 0.5 0 box.dat
  [1,16,0,24,4.5,40,0,0,0,0,19.5,0,0.5,0, ldraw_lib__box(realsolid)],
];
module ldraw_lib__u8034(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8034(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
