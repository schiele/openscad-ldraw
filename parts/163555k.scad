...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 163555j.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__163555j()],
];
module ldraw_lib__163555k(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__163555k(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
