...
use <s/54094s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__54094(realsolid=false) = [
...
// 1 16 0 184 -140 0 0 -1 0 1 0 1 0 0 s\54094s01.dat
  [1,16,0,184,-140,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__54094s01(realsolid)],
// 1 16 0 184 -140 0 0 1 0 1 0 1 0 0 s\54094s01.dat
  [1,16,0,184,-140,0,0,1,0,1,0,1,0,0, ldraw_lib__s__54094s01(realsolid)],
...
module ldraw_lib__54094(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__54094(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
