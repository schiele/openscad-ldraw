...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9496c02s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9496c02s02()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -.25 0 0 1 0 0 0 1 0 0 0 1 s\u9496c02s02.dat
  [1,16,-.25,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9496c02s02()],
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9496c02s04.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9496c02s04()],
];
module ldraw_lib__u9496c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9496c02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
