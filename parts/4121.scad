...
$fa=1; $fs=0.2;
function ldraw_lib__4121(realsolid=false) = [
...
// 1 16 0 4 0 1 0 0 0 -2 0 0 0 1 stug8-1x3.dat
  [1,16,0,4,0,1,0,0,0,-2,0,0,0,1, ldraw_lib__stug8_1x3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 60 4 -34 1.5 0 0 0 11 0 0 0 2 box4-1.dat
  [1,16,60,4,-34,1.5,0,0,0,11,0,0,0,2, ldraw_lib__box4_1(realsolid)],
// 1 16 20 4 -34 1.5 0 0 0 11 0 0 0 2 box4-1.dat
  [1,16,20,4,-34,1.5,0,0,0,11,0,0,0,2, ldraw_lib__box4_1(realsolid)],
// 1 16 -20 4 -34 1.5 0 0 0 11 0 0 0 2 box4-1.dat
  [1,16,-20,4,-34,1.5,0,0,0,11,0,0,0,2, ldraw_lib__box4_1(realsolid)],
// 1 16 -60 4 -34 1.5 0 0 0 11 0 0 0 2 box4-1.dat
  [1,16,-60,4,-34,1.5,0,0,0,11,0,0,0,2, ldraw_lib__box4_1(realsolid)],
...
// 1 16 74 4 20 0 0 -2 0 11 0 -1.5 0 0 box4-1.dat
  [1,16,74,4,20,0,0,-2,0,11,0,-1.5,0,0, ldraw_lib__box4_1(realsolid)],
// 1 16 74 4 -20 0 0 -2 0 11 0 -1.5 0 0 box4-1.dat
  [1,16,74,4,-20,0,0,-2,0,11,0,-1.5,0,0, ldraw_lib__box4_1(realsolid)],
// 1 16 -74 4 20 0 0 2 0 11 0 -1.5 0 0 box4-1.dat
  [1,16,-74,4,20,0,0,2,0,11,0,-1.5,0,0, ldraw_lib__box4_1(realsolid)],
...
module ldraw_lib__4121(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4121(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4121(line=0.2);