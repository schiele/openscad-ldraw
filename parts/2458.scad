...
use <../p/connect.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2458(realsolid=false) = [
...
// 1 16 0 10 -10 4 0 0 0 0 4 0 -1 0 4-4edge.dat
  [1,16,0,10,-10,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 10 -10 8 0 0 0 0 8 0 -1 0 4-4edge.dat
  [1,16,0,10,-10,8,0,0,0,0,8,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 10 -10 0 0 1 1 0 0 0 1 0 connect.dat
  [1,16,0,10,-10,0,0,1,1,0,0,0,1,0, ldraw_lib__connect(realsolid)],
// 0
];
module ldraw_lib__2458(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2458(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2458(line=0.2);