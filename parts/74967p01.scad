...
use <s/74967s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__74967p01(realsolid=false) = [
...
// 1 14 0 0 -10 0.5 0 0 0 0 0.5 0 1 0 4-4rin17.dat
  [1,14,0,0,-10,0.5,0,0,0,0,0.5,0,1,0, ldraw_lib__4_4rin17(realsolid)],
// 1 14 0 0 -10 1 0 0 0 0 1 0 1 0 4-4ring9.dat
  [1,14,0,0,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4ring9(realsolid)],
];
module ldraw_lib__74967p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__74967p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
