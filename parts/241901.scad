...
use <2419.scad>
$fa=1; $fs=0.2;
function ldraw_lib__241901(realsolid=false) = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 2419.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2419(realsolid)],
];
module ldraw_lib__241901(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__241901(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
