...
use <s/3070bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3070bps2(realsolid=false) = [
...
// 1 15 -6.5 0 4 0.5 0 0 0 1 0 0 0 0.5 2-4disc.dat
  [1,15,-6.5,0,4,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__2_4disc(realsolid)],
// 1 15 -6.5 0 0 -0.5 0 0 0 1 0 0 0 -0.5 2-4disc.dat
  [1,15,-6.5,0,0,-0.5,0,0,0,1,0,0,0,-0.5, ldraw_lib__2_4disc(realsolid)],
// 4 15 -7 0 4 -7 0 0 -6 0 0 -6 0 4
  [4,15,-7,0,4,-7,0,0,-6,0,0,-6,0,4],
// 1 16 -6.5 0 4 0.5 0 0 0 1 0 0 0 0.5 2-4ndis.dat
  [1,16,-6.5,0,4,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -6.5 0 0 -0.5 0 0 0 1 0 0 0 -0.5 2-4ndis.dat
  [1,16,-6.5,0,0,-0.5,0,0,0,1,0,0,0,-0.5, ldraw_lib__2_4ndis(realsolid)],
// 4 16 -6 0 4.5 -6 0 -0.5 -5.5 0 -0.5 -5.5 0 4.5
  [4,16,-6,0,4.5,-6,0,-0.5,-5.5,0,-0.5,-5.5,0,4.5],
// 1 15 -5 0 4 0.5 0 0 0 1 0 0 0 0.5 4-4disc.dat
  [1,15,-5,0,4,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4disc(realsolid)],
// 1 15 -5 0 2 0.5 0 0 0 1 0 0 0 0.5 4-4disc.dat
  [1,15,-5,0,2,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4disc(realsolid)],
// 1 15 -5 0 0 0.5 0 0 0 1 0 0 0 0.5 4-4disc.dat
  [1,15,-5,0,0,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4disc(realsolid)],
// 1 16 -5 0 4 0.5 0 0 0 1 0 0 0 0.5 4-4ndis.dat
  [1,16,-5,0,4,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -5 0 2 0.5 0 0 0 1 0 0 0 0.5 4-4ndis.dat
  [1,16,-5,0,2,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -5 0 0 0.5 0 0 0 1 0 0 0 0.5 4-4ndis.dat
  [1,16,-5,0,0,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4ndis(realsolid)],
...
// 1 15 -2 0 4 0.5 0 0 0 1 0 0 0 0.5 4-4disc.dat
  [1,15,-2,0,4,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4disc(realsolid)],
// 1 16 -2 0 4 0.5 0 0 0 1 0 0 0 0.5 4-4ndis.dat
  [1,16,-2,0,4,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4ndis(realsolid)],
...
// 1 15 -0.5 0 4 0.5 0 0 0 1 0 0 0 0.5 2-4disc.dat
  [1,15,-0.5,0,4,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__2_4disc(realsolid)],
// 1 15 -0.5 0 0 -0.5 0 0 0 1 0 0 0 -0.5 2-4disc.dat
  [1,15,-0.5,0,0,-0.5,0,0,0,1,0,0,0,-0.5, ldraw_lib__2_4disc(realsolid)],
// 4 15 -1 0 4 -1 0 0 0 0 0 0 0 4
  [4,15,-1,0,4,-1,0,0,0,0,0,0,0,4],
// 1 16 -0.5 0 4 0.5 0 0 0 1 0 0 0 0.5 2-4ndis.dat
  [1,16,-0.5,0,4,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -0.5 0 0 -0.5 0 0 0 1 0 0 0 -0.5 2-4ndis.dat
  [1,16,-0.5,0,0,-0.5,0,0,0,1,0,0,0,-0.5, ldraw_lib__2_4ndis(realsolid)],
// 4 16 0 0 4.5 0 0 -0.5 0.5 0 -0.5 0.5 0 4.5
  [4,16,0,0,4.5,0,0,-0.5,0.5,0,-0.5,0.5,0,4.5],
// 1 15 1 0 4 0.5 0 0 0 1 0 0 0 0.5 4-4disc.dat
  [1,15,1,0,4,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4disc(realsolid)],
// 1 15 1 0 2 0.5 0 0 0 1 0 0 0 0.5 4-4disc.dat
  [1,15,1,0,2,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4disc(realsolid)],
// 1 15 1 0 0 0.5 0 0 0 1 0 0 0 0.5 4-4disc.dat
  [1,15,1,0,0,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4disc(realsolid)],
// 1 16 1 0 4 0.5 0 0 0 1 0 0 0 0.5 4-4ndis.dat
  [1,16,1,0,4,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 1 0 2 0.5 0 0 0 1 0 0 0 0.5 4-4ndis.dat
  [1,16,1,0,2,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 1 0 0 0.5 0 0 0 1 0 0 0 0.5 4-4ndis.dat
  [1,16,1,0,0,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4ndis(realsolid)],
...
module ldraw_lib__3070bps2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3070bps2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
