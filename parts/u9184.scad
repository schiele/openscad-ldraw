...
use <../p/axlehole.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9184(realsolid=false) = [
...
// 1 16 -40 0 0 0 1 0 0 0 1 1 0 0 4-4ring6.dat
  [1,16,-40,0,0,0,1,0,0,0,1,1,0,0, ldraw_lib__4_4ring6(realsolid)],
// 1 16 40 0 0 0 -1 0 0 0 1 -1 0 0 axlehol2.dat
  [1,16,40,0,0,0,-1,0,0,0,1,-1,0,0, ldraw_lib__axlehol2(realsolid)],
// 1 16 40 0 0 0 -1 0 0 0 1 -1 0 0 4-4ring6.dat
  [1,16,40,0,0,0,-1,0,0,0,1,-1,0,0, ldraw_lib__4_4ring6(realsolid)],
// 1 16 40 0 0 0 -80 0 7 0 0 0 0 -7 4-4cylo.dat
  [1,16,40,0,0,0,-80,0,7,0,0,0,0,-7, ldraw_lib__4_4cylo(realsolid)],
];
module ldraw_lib__u9184(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9184(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
