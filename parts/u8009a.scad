...
// 1 16 56 14 0 0 12 0 0 0 -10 16 0 0 rect.dat
  [1,16,56,14,0,0,12,0,0,0,-10,16,0,0, ldraw_lib__rect()],
// 1 16 0 14 56 -16 0 0 0 0 -10 0 12 0 rect.dat
  [1,16,0,14,56,-16,0,0,0,0,-10,0,12,0, ldraw_lib__rect()],
...
// 1 16 60 12 0 0 -4 0 -12 0 0 0 0 -20 rect.dat
  [1,16,60,12,0,0,-4,0,-12,0,0,0,0,-20, ldraw_lib__rect()],
// 1 16 0 12 60 0 0 20 -12 0 0 0 -4 0 rect.dat
  [1,16,0,12,60,0,0,20,-12,0,0,0,-4,0, ldraw_lib__rect()],
...
module ldraw_lib__u8009a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8009a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
