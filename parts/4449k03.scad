...
use <../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4449k03(realsolid=false) = [
...
// 1 16 -13 0 -12 1 0 0 0 1 0 0 0 -1 2-4edge.dat
  [1,16,-13,0,-12,1,0,0,0,1,0,0,0,-1, ldraw_lib__2_4edge(realsolid)],
// 1 16 13 0 -12 1 0 0 0 1 0 0 0 -1 2-4edge.dat
  [1,16,13,0,-12,1,0,0,0,1,0,0,0,-1, ldraw_lib__2_4edge(realsolid)],
// 0
...
// 1 16 -13 5 -12 1 0 0 0 0 1 0 1 0 2-4edge.dat
  [1,16,-13,5,-12,1,0,0,0,0,1,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 13 5 -12 1 0 0 0 0 1 0 1 0 2-4edge.dat
  [1,16,13,5,-12,1,0,0,0,0,1,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 0
...
// 1 16 -13 0 -12 1 0 0 0 1 0 0 0 -1 2-4disc.dat
  [1,16,-13,0,-12,1,0,0,0,1,0,0,0,-1, ldraw_lib__2_4disc(realsolid)],
// 1 16 13 0 -12 1 0 0 0 1 0 0 0 -1 2-4disc.dat
  [1,16,13,0,-12,1,0,0,0,1,0,0,0,-1, ldraw_lib__2_4disc(realsolid)],
// 1 16 -13 0 -12 1 0 0 0 5 0 0 0 -1 2-4cyli.dat
  [1,16,-13,0,-12,1,0,0,0,5,0,0,0,-1, ldraw_lib__2_4cyli(realsolid)],
// 1 16 13 0 -12 1 0 0 0 5 0 0 0 -1 2-4cyli.dat
  [1,16,13,0,-12,1,0,0,0,5,0,0,0,-1, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -13 5 -12 1 0 0 0 1 0 0 0 -1 2-8sphe.dat
  [1,16,-13,5,-12,1,0,0,0,1,0,0,0,-1, ldraw_lib__2_8sphe(realsolid)],
// 1 16 13 5 -12 1 0 0 0 1 0 0 0 -1 2-8sphe.dat
  [1,16,13,5,-12,1,0,0,0,1,0,0,0,-1, ldraw_lib__2_8sphe(realsolid)],
// 0
// 0 // handle
...
// 1 16 0 0 0 18 0 0 0 6 0 0 0 10 box5.dat
  [1,16,0,0,0,18,0,0,0,6,0,0,0,10, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__4449k03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4449k03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
