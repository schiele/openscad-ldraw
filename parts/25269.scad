...
use <s/25269s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__25269(realsolid=false) = [
...
// 1 16 -10 0 10 0 0 20 0 1 0 -20 0 0 1-4disc.dat
  [1,16,-10,0,10,0,0,20,0,1,0,-20,0,0, ldraw_lib__1_4disc(realsolid)],
];
module ldraw_lib__25269(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__25269(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
