...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Brickowl 1046644, Brickset 30337
// 
...
// 0 !HISTORY 2025-05-12 [MagFors] Renumbered to 6192a
// 0 !HISTORY 2025-06-08 [WUIt] Removed overlap/microgap between 6192s01 and stud4a
...
// 1 16 -20 4 0 1 0 0 0 1 0 0 0 1 s\6192s01.dat
  [1,16,-20,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6192s01()],
// 
// 1 16 20 6.472 0 1 0 0 0 -4.382 0 0 0 1 stud4a.dat
  [1,16,20,6.472,0,1,0,0,0,-4.382,0,0,0,1, ldraw_lib__stud4a()],
// 1 16 0 6.472 0 1 0 0 0 -4.382 0 0 0 1 stud4a.dat
  [1,16,0,6.472,0,1,0,0,0,-4.382,0,0,0,1, ldraw_lib__stud4a()],
// 1 16 -20 6.472 0 1 0 0 0 -4.382 0 0 0 1 stud4a.dat
  [1,16,-20,6.472,0,1,0,0,0,-4.382,0,0,0,1, ldraw_lib__stud4a()],
];
module ldraw_lib__6192a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6192a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6192a(line=0.2);