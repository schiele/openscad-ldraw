...
use <../p/stud2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92263ph1(realsolid=false) = [
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\92262ph1s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__92262ph1s01(realsolid)],
...
module ldraw_lib__92263ph1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92263ph1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
