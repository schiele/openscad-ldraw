...
$fa=1; $fs=0.2;
function ldraw_lib__96714c01(realsolid=false) = [
// 0 Sheet Fabric 17.5 x 12.5 Trapezoidal Sail (Formed)
// 0 Name: 96714c01.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\96714c01s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__96714c01s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\96714c01s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__96714c01s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\96714c01s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__96714c01s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\96714c01s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__96714c01s02(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0.25 1 0 0 0 1 0 0 0 1 s\96714c01s01.dat
  [1,16,0,0,0.25,1,0,0,0,1,0,0,0,1, ldraw_lib__s__96714c01s01(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0.25 -1 0 0 0 1 0 0 0 1 s\96714c01s01.dat
  [1,16,0,0,0.25,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__96714c01s01(realsolid)],
...
module ldraw_lib__96714c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__96714c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
