...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3070pb029, Rebrickable 3070bpr0083, Set 4677
// 
...
// 3 16 6 0 -1.5 6 0 -7.5 10 0 -10
  [3,16,6,0,-1.5,6,0,-7.5,10,0,-10],
// 3 16 10 0 -10 6 0 -7.5 0 0 -7.5
  [3,16,10,0,-10,6,0,-7.5,0,0,-7.5],
// 4 16 -6 0 -7.5 -10 0 -10 10 0 -10 0 0 -7.5
  [4,16,-6,0,-7.5,-10,0,-10,10,0,-10,0,0,-7.5],
// 3 16 -4 0 7.5 -4 0 -1.5 0 0 -1.5
  [3,16,-4,0,7.5,-4,0,-1.5,0,0,-1.5],
// 4 16 4 0 -1.5 4 0 7.5 -4 0 7.5 0 0 -1.5
  [4,16,4,0,-1.5,4,0,7.5,-4,0,7.5,0,0,-1.5],
];
