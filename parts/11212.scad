...
// 1 16 0 8 0 30 0 0 0 -8 0 0 0 30 box5.dat
  [1,16,0,8,0,30,0,0,0,-8,0,0,0,30, ldraw_lib__box5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 26 0 0 0 -4 0 0 0 26 box5.dat
  [1,16,0,8,0,26,0,0,0,-4,0,0,0,26, ldraw_lib__box5()],
...
module ldraw_lib__11212(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11212(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
