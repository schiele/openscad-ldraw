...
use <6258203k.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2431dt5(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6258203k.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6258203k(realsolid)],
];
module ldraw_lib__2431dt5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2431dt5(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
