...
use <../p/4-4ring2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30527k01(realsolid=false) = [
...
// 1 16 0 8 0 4 0 0 0 12 0 0 0 4 4-4cyli.dat
  [1,16,0,8,0,4,0,0,0,12,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
];
module ldraw_lib__30527k01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30527k01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
