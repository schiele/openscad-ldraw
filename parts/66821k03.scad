...
use <../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__66821k03(realsolid=false) = [
...
// 1 16 -22.5 2.25 0 0 1 0 0 0 -2.25 -8 0 0 rect2p.dat
  [1,16,-22.5,2.25,0,0,1,0,0,0,-2.25,-8,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 22.5 2.25 0 0 -1 0 0 0 2.25 -8 0 0 rect2p.dat
  [1,16,22.5,2.25,0,0,-1,0,0,0,2.25,-8,0,0, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__66821k03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__66821k03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
