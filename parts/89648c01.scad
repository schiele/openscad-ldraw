...
use <89649.scad>
$fa=1; $fs=0.2;
function ldraw_lib__89648c01(realsolid=false) = [
// 0 Window  2 x  8 x  2 Inverted Sloped Reinforced with TransBlack Glass
// 0 Name: 89648c01.dat
...
// 1 40 0 0 0 1 0 0 0 1 0 0 0 1 89649.dat
  [1,40,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__89649(realsolid)],
];
module ldraw_lib__89648c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__89648c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
