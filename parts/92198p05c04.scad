...
use <92257.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92198p05c04(realsolid=false) = [
...
// 1 9 0 0 0 1 0 0 0 1 0 0 0 1 92252p06c01.dat
  [1,9,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__92252p06c01(realsolid)],
...
module ldraw_lib__92198p05c04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92198p05c04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
