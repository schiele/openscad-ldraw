...
// 1 16 3 -8 0 1 0 0 0 1 0 0 0 1 s\u9119s02.dat
  [1,16,3,-8,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9119s02()],
// 1 16 3 -8 0 1 0 0 0 1 0 0 0 -1 s\u9119s02.dat
  [1,16,3,-8,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__u9119s02()],
...
module ldraw_lib__u9119(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9119(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
