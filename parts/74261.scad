...
use <98613.scad>
$fa=1; $fs=0.2;
function ldraw_lib__74261(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 98613.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__98613(realsolid)],
// 0 // rubber inlay
// 1 256 0 0 -11.2 7.3 0 0 0 0 -7.3 0 1 0 4-4cylc.dat
  [1,256,0,0,-11.2,7.3,0,0,0,0,-7.3,0,1,0, ldraw_lib__4_4cylc(realsolid)],
// 1 256 0 0 -10.2 7.3 0 0 0 0 -7.3 0 -1 0 4-4disc.dat
  [1,256,0,0,-10.2,7.3,0,0,0,0,-7.3,0,-1,0, ldraw_lib__4_4disc(realsolid)],
];
module ldraw_lib__74261(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__74261(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
