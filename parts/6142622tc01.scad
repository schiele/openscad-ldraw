...
$fa=1; $fs=0.2;
function ldraw_lib__6142622tc01(realsolid=false) = [
...
// 1 16 0 1.2836 19.12 1 0 0 0 .998116 -.061359 0 .061359 .998116 s\6142622ts01.dat
  [1,16,0,1.2836,19.12,1,0,0,0,.998116,-.061359,0,.061359,.998116, ldraw_lib__s__6142622ts01(realsolid)],
// 1 16 0 1.2836 19.12 1 0 0 0 .983244 -.182294 0 .182294 .983244 s\6142622ts02.dat
  [1,16,0,1.2836,19.12,1,0,0,0,.983244,-.182294,0,.182294,.983244, ldraw_lib__s__6142622ts02(realsolid)],
// 1 16 0 11.3582 -21.232 1 0 0 0 .953465 -.301503 0 .301503 .953465 s\6142622ts03.dat
  [1,16,0,11.3582,-21.232,1,0,0,0,.953465,-.301503,0,.301503,.953465, ldraw_lib__s__6142622ts03(realsolid)],
// 1 16 0 11.3582 -21.232 1 0 0 0 .908334 -.418246 0 .418246 .908334 s\6142622ts04.dat
  [1,16,0,11.3582,-21.232,1,0,0,0,.908334,-.418246,0,.418246,.908334, ldraw_lib__s__6142622ts04(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\6142622ts06.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6142622ts06(realsolid)],
];
module ldraw_lib__6142622tc01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6142622tc01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
