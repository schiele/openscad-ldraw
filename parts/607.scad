...
use <s/607s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__607(realsolid=false) = [
// 0 Baseplate 32 x 32 Road 9-Stud Crossroads
// 0 Name: 607.dat
...
// 0 !HISTORY 2008-07-07 [anathema] Used subfile, BFC'd (2008-07-03)
// 0 !HISTORY 2010-04-09 [mikeheide] Moved portions from subfile
// 0 !HISTORY 2010-07-05 [PTadmin] Official Update 2010-02
// 
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\607s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__607s01(realsolid)],
...
module ldraw_lib__607(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__607(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__607(line=0.2);