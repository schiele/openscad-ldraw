...
use <3817b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__73200_f2(realsolid=false) = [
...
// 1 16 0 12 0 1 0 0 0 0 1 0 -1 0 3816b.dat
  [1,16,0,12,0,1,0,0,0,0,1,0,-1,0, ldraw_lib__3816b(realsolid)],
// 1 16 0 12 0 1 0 0 0 0 1 0 -1 0 3817b.dat
  [1,16,0,12,0,1,0,0,0,0,1,0,-1,0, ldraw_lib__3817b(realsolid)],
];
module ldraw_lib__73200_f2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73200_f2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
