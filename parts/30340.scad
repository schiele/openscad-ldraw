...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30340(realsolid=false) = [
// 0 Minifig Life Ring
// 0 Name: 30340.dat
...
// 1 16 0 -4 0 1 0 0 0 1 0 0 0 1 s\30340s01.dat
  [1,16,0,-4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30340s01(realsolid)],
// 1 16 0 -4 0 -1 0 0 0 1 0 0 0 1 s\30340s01.dat
  [1,16,0,-4,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30340s01(realsolid)],
// 1 16 0 12 0 1 0 0 0 -1 0 0 0 1 s\30340s01.dat
  [1,16,0,12,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__30340s01(realsolid)],
// 1 16 0 12 0 -1 0 0 0 -1 0 0 0 1 s\30340s01.dat
  [1,16,0,12,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__s__30340s01(realsolid)],
...
// 1 16 0 4 0 1 0 0 0 1 0 0 0 1 s\30340s02.dat
  [1,16,0,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30340s02(realsolid)],
// 1 16 0 4 0 1 0 0 0 -1 0 0 0 1 s\30340s02.dat
  [1,16,0,4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__30340s02(realsolid)],
// 
];
module ldraw_lib__30340(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30340(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__30340(line=0.2);