...
$fa=1; $fs=0.2;
function ldraw_lib__2041(realsolid=false) = [
// 0 Fabuland Bench
// 0 Name: 2041.dat
...
// 1 16 0 2 0 60 0 0 0 2 0 0 0 10 box.dat
  [1,16,0,2,0,60,0,0,0,2,0,0,0,10, ldraw_lib__box(realsolid)],
// 1 16 0 -13.5 20.25 60 0 0 0 0 7.5 0 2 -2.25 box.dat
  [1,16,0,-13.5,20.25,60,0,0,0,0,7.5,0,2,-2.25, ldraw_lib__box(realsolid)],
// 1 16 0 -32.5 25.95 60 0 0 0 0 7.5 0 2 -2.25 box.dat
  [1,16,0,-32.5,25.95,60,0,0,0,0,7.5,0,2,-2.25, ldraw_lib__box(realsolid)],
// 1 16 0 5.7 -21 60 0 0 0 2 -2.5 0 0 7 box.dat
  [1,16,0,5.7,-21,60,0,0,0,2,-2.5,0,0,7, ldraw_lib__box(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 stug2-6x1.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2_6x1(realsolid)],
// 1 16 36 32 -10 0 4 0 0 0 -28 -29 0 0 48\1-4cylo.dat
  [1,16,36,32,-10,0,4,0,0,0,-28,-29,0,0, ldraw_lib__48__1_4cylo(realsolid)],
// 1 16 36 32 10 0 4 0 0 0 -28 29 0 0 48\7-48cyli.dat
  [1,16,36,32,10,0,4,0,0,0,-28,29,0,0, ldraw_lib__48__7_48cyli(realsolid)],
// 1 16 36 32 10 0 1 0 0 0 -28 29 0 0 48\7-48edge.dat
  [1,16,36,32,10,0,1,0,0,0,-28,29,0,0, ldraw_lib__48__7_48edge(realsolid)],
// 1 16 36 32 10 0 1 0 0 0 -28 29 0 0 48\7-48chrd.dat
  [1,16,36,32,10,0,1,0,0,0,-28,29,0,0, ldraw_lib__48__7_48chrd(realsolid)],
// 1 16 36 -30 33.3 0 4 0 -6 0 0 0 0 6 5-16cylo.dat
  [1,16,36,-30,33.3,0,4,0,-6,0,0,0,0,6, ldraw_lib__5_16cylo(realsolid)],
// 1 16 36 -30 33.3 0 1 0 -6 0 0 0 0 6 5-16chrd.dat
  [1,16,36,-30,33.3,0,1,0,-6,0,0,0,0,6, ldraw_lib__5_16chrd(realsolid)],
// 1 16 36 32 -10 0 1 0 0 0 -28 -29 0 0 48\1-4chrd.dat
  [1,16,36,32,-10,0,1,0,0,0,-28,-29,0,0, ldraw_lib__48__1_4chrd(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 36 32 0 0 4 0 0 0 -15 21 0 0 48\2-4cylo.dat
  [1,16,36,32,0,0,4,0,0,0,-15,21,0,0, ldraw_lib__48__2_4cylo(realsolid)],
// 1 16 36 32 0 0 1 0 0 0 -15 21 0 0 48\2-4ndis.dat
  [1,16,36,32,0,0,1,0,0,0,-15,21,0,0, ldraw_lib__48__2_4ndis(realsolid)],
...
// 1 16 40 32 10 0 -1 0 0 0 -28 29 0 0 48\7-48edge.dat
  [1,16,40,32,10,0,-1,0,0,0,-28,29,0,0, ldraw_lib__48__7_48edge(realsolid)],
// 1 16 40 32 10 0 -1 0 0 0 -28 29 0 0 48\7-48chrd.dat
  [1,16,40,32,10,0,-1,0,0,0,-28,29,0,0, ldraw_lib__48__7_48chrd(realsolid)],
// 1 16 40 -30 33.3 0 -1 0 -6 0 0 0 0 6 5-16chrd.dat
  [1,16,40,-30,33.3,0,-1,0,-6,0,0,0,0,6, ldraw_lib__5_16chrd(realsolid)],
// 1 16 40 32 -10 0 -1 0 0 0 -28 -29 0 0 48\1-4chrd.dat
  [1,16,40,32,-10,0,-1,0,0,0,-28,-29,0,0, ldraw_lib__48__1_4chrd(realsolid)],
// 1 16 40 32 0 0 -1 0 0 0 -15 21 0 0 48\2-4ndis.dat
  [1,16,40,32,0,0,-1,0,0,0,-15,21,0,0, ldraw_lib__48__2_4ndis(realsolid)],
...
// 1 16 38 4 3.5 2 0 0 0 1 0 0 0 13.5 rect3.dat
  [1,16,38,4,3.5,2,0,0,0,1,0,0,0,13.5, ldraw_lib__rect3(realsolid)],
// 1 16 38 -16 23 2 0 0 0 0 -20 0 1 6 rect3.dat
  [1,16,38,-16,23,2,0,0,0,0,-20,0,1,6, ldraw_lib__rect3(realsolid)],
// 1 16 38 -36 31.15 0 0 -2 0 1 0 2.15 0 0 rect2p.dat
  [1,16,38,-36,31.15,0,0,-2,0,1,0,2.15,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 38 -8.9595 33.2493 2 0 0 0 0 18.7443 0 -1 -5.5941 rect3.dat
  [1,16,38,-8.9595,33.2493,2,0,0,0,0,18.7443,0,-1,-5.5941, ldraw_lib__rect3(realsolid)],
// 1 16 42 34 -30 0 0 2 0 -2 0 9 0 0 box2-5.dat
  [1,16,42,34,-30,0,0,2,0,-2,0,9,0,0, ldraw_lib__box2_5(realsolid)],
// 1 16 40 32 -30 0 0 -4 0 4 0 9 0 0 box4-7a.dat
  [1,16,40,32,-30,0,0,-4,0,4,0,9,0,0, ldraw_lib__box4_7a(realsolid)],
// 1 16 42 34 30 0 0 2 0 -2 0 9 0 0 box2-5.dat
  [1,16,42,34,30,0,0,2,0,-2,0,9,0,0, ldraw_lib__box2_5(realsolid)],
// 1 16 40 32 30 0 0 -4 0 4 0 9 0 0 box4-7a.dat
  [1,16,40,32,30,0,0,-4,0,4,0,9,0,0, ldraw_lib__box4_7a(realsolid)],
...
module ldraw_lib__2041(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2041(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
