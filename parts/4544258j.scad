...
use <../p/box5-12.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4544258j(realsolid=false) = [
...
// 1 82 21.4 -0.25 2.9 0 0 1.2 0 1 0 -1.2 0 0 2-4ndis.dat
  [1,82,21.4,-0.25,2.9,0,0,1.2,0,1,0,-1.2,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 82 22.9 -0.25 3.4 0 0 3 0 1 0 -3 0 0 2-4disc.dat
  [1,82,22.9,-0.25,3.4,0,0,3,0,1,0,-3,0,0, ldraw_lib__2_4disc(realsolid)],
...
// 1 0 21.4 -0.25 2.9 0 0 1.2 0 1 0 -1.2 0 0 2-4disc.dat
  [1,0,21.4,-0.25,2.9,0,0,1.2,0,1,0,-1.2,0,0, ldraw_lib__2_4disc(realsolid)],
...
// 1 16 22.9 -0.25 3.4 0 0 3 0 1 0 -3 0 0 2-4ndis.dat
  [1,16,22.9,-0.25,3.4,0,0,3,0,1,0,-3,0,0, ldraw_lib__2_4ndis(realsolid)],
...
module ldraw_lib__4544258j(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4544258j(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
