...
use <6258203n.scad>
$fa=1; $fs=0.2;
function ldraw_lib__27925dt1(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 27925.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__27925(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6258203n.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6258203n(realsolid)],
];
module ldraw_lib__27925dt1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__27925dt1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
