...
use <s/43891s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__43891(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\43891s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__43891s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 1 s\43891s01.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__43891s01(realsolid)],
// 1 16 -10 0 0 0 10 0 4 0 0 0 0 4 4-4cylc.dat
  [1,16,-10,0,0,0,10,0,4,0,0,0,0,4, ldraw_lib__4_4cylc(realsolid)],
...
module ldraw_lib__43891(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__43891(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
