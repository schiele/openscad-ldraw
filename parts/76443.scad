...
// 1 16 0 63.725 -80.254 1 0 0 0 1 0 0 0 1 30462.dat
  [1,16,0,63.725,-80.254,1,0,0,0,1,0,0,0,1, ldraw_lib__30462()],
];
module ldraw_lib__76443(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76443(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
