...
// 1 16 0 0 0.5 -5 0 0 0 12 0 0 0 -0.5 box.dat
  [1,16,0,0,0.5,-5,0,0,0,12,0,0,0,-0.5, ldraw_lib__box()],
// 1 16 -2 -2 0 0 4 0 2 0 0 0 0 -1 2-4cyli.dat
  [1,16,-2,-2,0,0,4,0,2,0,0,0,0,-1, ldraw_lib__2_4cyli()],
// 1 16 -2 -2 0 0 -2 0 2 0 0 0 0 -1 2-8sphe.dat
  [1,16,-2,-2,0,0,-2,0,2,0,0,0,0,-1, ldraw_lib__2_8sphe()],
// 1 16 -2 -2 0 0 0 -2 2 0 0 0 1 0 2-4edge.dat
  [1,16,-2,-2,0,0,0,-2,2,0,0,0,1,0, ldraw_lib__2_4edge()],
// 1 16 2 -2 0 0 2 0 2 0 0 0 0 -1 2-8sphe.dat
  [1,16,2,-2,0,0,2,0,2,0,0,0,0,-1, ldraw_lib__2_8sphe()],
// 1 16 2 -2 0 0 0 2 2 0 0 0 1 0 2-4edge.dat
  [1,16,2,-2,0,0,0,2,2,0,0,0,1,0, ldraw_lib__2_4edge()],
...
module ldraw_lib__89662(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__89662(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
