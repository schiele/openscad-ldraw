...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\20460bs02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__20460bs02()],
];
module ldraw_lib__20460b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__20460b(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__20460b(line=0.2);