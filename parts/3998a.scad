...
use <s/3998as01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3998a(realsolid=false) = [
...
// 1 16 4.2 63.5 9.5 0.6 -1 0 0 0 4 -3.8 0 0 2-4ring2.dat
  [1,16,4.2,63.5,9.5,0.6,-1,0,0,0,4,-3.8,0,0, ldraw_lib__2_4ring2(realsolid)],
// 1 16 4.2 63.5 9.5 1.2 -1 0 0 0 8 -7.6 0 0 2-4edge.dat
  [1,16,4.2,63.5,9.5,1.2,-1,0,0,0,8,-7.6,0,0, ldraw_lib__2_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 4.2 63.5 9.5 1.2 -4 0 0 0 8 -7.6 0 0 2-4cyli.dat
  [1,16,4.2,63.5,9.5,1.2,-4,0,0,0,8,-7.6,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 4.2 63.5 9.5 1.8 -4 0 0 0 12 -11.4 0 0 2-4cyli.dat
  [1,16,4.2,63.5,9.5,1.8,-4,0,0,0,12,-11.4,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -4.2 63.5 9.5 -0.6 1 0 0 0 4 -3.8 0 0 2-4ring2.dat
  [1,16,-4.2,63.5,9.5,-0.6,1,0,0,0,4,-3.8,0,0, ldraw_lib__2_4ring2(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 4.2 63.5 9.5 1.8 -1 0 0 0 12 -11.4 0 0 2-4edge.dat
  [1,16,4.2,63.5,9.5,1.8,-1,0,0,0,12,-11.4,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -4.2 63.5 9.5 -1.2 1 0 0 0 8 -7.6 0 0 2-4edge.dat
  [1,16,-4.2,63.5,9.5,-1.2,1,0,0,0,8,-7.6,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -4.2 63.5 9.5 -1.8 1 0 0 0 12 -11.4 0 0 2-4edge.dat
  [1,16,-4.2,63.5,9.5,-1.8,1,0,0,0,12,-11.4,0,0, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 6 31.90115 0 0 -1 0 -25.09885 0 0 0 0 -2 rect2p.dat
  [1,16,6,31.90115,0,0,-1,0,-25.09885,0,0,0,0,-2, ldraw_lib__rect2p(realsolid)],
// 1 16 -6 31.90115 0 0 1 0 25.09885 0 0 0 0 -2 rect2p.dat
  [1,16,-6,31.90115,0,0,1,0,25.09885,0,0,0,0,-2, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__3998a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3998a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
