...
use <../p/stug-1x5.scad>
use <../p/stug-1x8.scad>
function ldraw_lib__50305() = [
// 0 Wing  3 x  8 Pentagonal Left
// 0 Name: 50305.dat
...
module ldraw_lib__50305(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__50305(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__50305(line=0.2);