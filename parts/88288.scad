...
use <s/88288s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__88288(realsolid=false) = [
// 0 Minifig Dagger
// 0 Name: 88288.dat
...
// 1 16 0 10 0 1 0 0 0 1 0 0 0 1 s\88288s01.dat
  [1,16,0,10,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__88288s01(realsolid)],
...
module ldraw_lib__88288(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__88288(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
