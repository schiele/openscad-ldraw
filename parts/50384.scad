...
$fa=1; $fs=0.2;
function ldraw_lib__50384(realsolid=false) = [
// 0 Duplo Baseplate 12 x 16 with  6 x 16 Stud Gap
// 0 Name: 50384.dat
...
// 1 16 248 0 168 72 0 0 0 1 0 0 0 72 48\1-4disc.dat
  [1,16,248,0,168,72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 -248 0 168 -72 0 0 0 1 0 0 0 72 48\1-4disc.dat
  [1,16,-248,0,168,-72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 -248 0 -168 -72 0 0 0 1 0 0 0 -72 48\1-4disc.dat
  [1,16,-248,0,-168,-72,0,0,0,1,0,0,0,-72, ldraw_lib__48__1_4disc(realsolid)],
...
// 1 16 248 4 168 72 0 0 0 -1 0 0 0 72 48\1-4disc.dat
  [1,16,248,4,168,72,0,0,0,-1,0,0,0,72, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 -248 4 168 -72 0 0 0 -1 0 0 0 72 48\1-4disc.dat
  [1,16,-248,4,168,-72,0,0,0,-1,0,0,0,72, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 -248 4 -168 -72 0 0 0 -1 0 0 0 -72 48\1-4disc.dat
  [1,16,-248,4,-168,-72,0,0,0,-1,0,0,0,-72, ldraw_lib__48__1_4disc(realsolid)],
...
// 1 16 248 0 168 72 0 0 0 4 0 0 0 72 48\1-4cyli.dat
  [1,16,248,0,168,72,0,0,0,4,0,0,0,72, ldraw_lib__48__1_4cyli(realsolid)],
// 1 16 -248 0 168 -72 0 0 0 4 0 0 0 72 48\1-4cyli.dat
  [1,16,-248,0,168,-72,0,0,0,4,0,0,0,72, ldraw_lib__48__1_4cyli(realsolid)],
// 1 16 -248 0 -168 -72 0 0 0 4 0 0 0 -72 48\1-4cyli.dat
  [1,16,-248,0,-168,-72,0,0,0,4,0,0,0,-72, ldraw_lib__48__1_4cyli(realsolid)],
...
// 1 16 248 0 168 72 0 0 0 1 0 0 0 72 48\1-4edge.dat
  [1,16,248,0,168,72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 -248 0 168 -72 0 0 0 1 0 0 0 72 48\1-4edge.dat
  [1,16,-248,0,168,-72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 -248 0 -168 -72 0 0 0 1 0 0 0 -72 48\1-4edge.dat
  [1,16,-248,0,-168,-72,0,0,0,1,0,0,0,-72, ldraw_lib__48__1_4edge(realsolid)],
...
// 1 16 248 4 168 72 0 0 0 1 0 0 0 72 48\1-4edge.dat
  [1,16,248,4,168,72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 -248 4 168 -72 0 0 0 1 0 0 0 72 48\1-4edge.dat
  [1,16,-248,4,168,-72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4edge(realsolid)],
// 1 16 -248 4 -168 -72 0 0 0 1 0 0 0 -72 48\1-4edge.dat
  [1,16,-248,4,-168,-72,0,0,0,1,0,0,0,-72, ldraw_lib__48__1_4edge(realsolid)],
...
// 1 16 160 0 180 1 0 0 0 1 0 0 0 1 stug20-1x8.dat
  [1,16,160,0,180,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x8(realsolid)],
// 1 16 160 0 -180 1 0 0 0 1 0 0 0 1 stug20-1x8.dat
  [1,16,160,0,-180,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x8(realsolid)],
// 1 16 -160 0 180 1 0 0 0 1 0 0 0 1 stug20-1x8.dat
  [1,16,-160,0,180,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x8(realsolid)],
// 1 16 -160 0 -180 1 0 0 0 1 0 0 0 1 stug20-1x8.dat
  [1,16,-160,0,-180,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x8(realsolid)],
// 1 16 -160 0 140 1 0 0 0 1 0 0 0 1 stug20-1x8.dat
  [1,16,-160,0,140,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x8(realsolid)],
// 1 16 160 0 140 1 0 0 0 1 0 0 0 1 stug20-1x8.dat
  [1,16,160,0,140,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x8(realsolid)],
// 1 16 -160 0 100 1 0 0 0 1 0 0 0 1 stug20-1x8.dat
  [1,16,-160,0,100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x8(realsolid)],
// 1 16 160 0 100 1 0 0 0 1 0 0 0 1 stug20-1x8.dat
  [1,16,160,0,100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x8(realsolid)],
// 1 16 140 0 220 1 0 0 0 1 0 0 0 1 stug20-1x7.dat
  [1,16,140,0,220,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x7(realsolid)],
// 1 16 140 0 -220 1 0 0 0 1 0 0 0 1 stug20-1x7.dat
  [1,16,140,0,-220,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x7(realsolid)],
// 1 16 -140 0 220 1 0 0 0 1 0 0 0 1 stug20-1x7.dat
  [1,16,-140,0,220,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x7(realsolid)],
...
module ldraw_lib__50384(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__50384(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__50384(line=0.2);