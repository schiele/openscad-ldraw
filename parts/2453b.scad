...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2453b(realsolid=false) = [
...
// 1 16 0 120 0 10 0 0 0 -120 0 0 0 -10 box5.dat
  [1,16,0,120,0,10,0,0,0,-120,0,0,0,-10, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 120 0 6 0 0 0 -116 0 0 0 -6 box5.dat
  [1,16,0,120,0,6,0,0,0,-116,0,0,0,-6, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__2453b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2453b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
