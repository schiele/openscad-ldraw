...
// 1 16 -75 0 0 0 -1 0 1 0 0 0 0 -1 71944k01.dat
  [1,16,-75,0,0,0,-1,0,1,0,0,0,0,-1, ldraw_lib__71944k01()],
...
module ldraw_lib__71951(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__71951(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
