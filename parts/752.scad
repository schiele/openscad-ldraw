...
use <../p/4-4ring4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__752(realsolid=false) = [
...
// 1 16 0 18 0 6 0 0 0 -8 0 0 0 6 4-4cylo.dat
  [1,16,0,18,0,6,0,0,0,-8,0,0,0,6, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 10 0 2 0 0 0 -1 0 0 0 2 4-4ring2.dat
  [1,16,0,10,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring2(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 10 0 4 0 0 0 -4 0 0 0 4 4-4cylo.dat
  [1,16,0,10,0,4,0,0,0,-4,0,0,0,4, ldraw_lib__4_4cylo(realsolid)],
...
// 1 16 0 18 0 8 0 0 0 -10 0 0 0 8 4-4cylo.dat
  [1,16,0,18,0,8,0,0,0,-10,0,0,0,8, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 2.6667 0 1 0 0 0 -2.66667 0 0 0 -1 4-4con5.dat
  [1,16,0,2.6667,0,1,0,0,0,-2.66667,0,0,0,-1, ldraw_lib__4_4con5(realsolid)],
// 1 16 0 8 0 2 0 0 0 -5.33333 0 0 0 -2 4-4con3.dat
  [1,16,0,8,0,2,0,0,0,-5.33333,0,0,0,-2, ldraw_lib__4_4con3(realsolid)],
];
module ldraw_lib__752(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__752(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
