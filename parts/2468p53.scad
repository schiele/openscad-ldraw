...
use <s/2468s01.scad>
use <s/3298p53c.scad>
function ldraw_lib__2468p53() = [
// 0 Panel  3 x  3 x  6 Corner Convex with Space Police Left Pattern
// 0 Name: 2468p53.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 2468pb02, Rebrickable 2468pr0001, Set 6886
...
// 4 16 10 90 -50 50 90 -10 46.2 84.3 -13.8 13.8 84.3 -46.2
  [4,16,10,90,-50,50,90,-10,46.2,84.3,-13.8,13.8,84.3,-46.2],
// 1 16 30 61.5 -30 0 0 -0.81 -1.14 0 0 0 1 -0.81 s\3298p53c.dat
  [1,16,30,61.5,-30,0,0,-0.81,-1.14,0,0,0,1,-0.81, ldraw_lib__s__3298p53c()],
];
module ldraw_lib__2468p53(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2468p53(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2468p53(line=0.2);