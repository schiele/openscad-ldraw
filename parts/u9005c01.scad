...
use <u9004.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9005c01(realsolid=false) = [
...
// 1 16 0 8 0 1 0 0 0 1 0 0 0 1 u9004.dat
  [1,16,0,8,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9004(realsolid)],
// 1 16 -40 31 60 1 0 0 0 1 0 0 0 1 u9001p03.dat
  [1,16,-40,31,60,1,0,0,0,1,0,0,0,1, ldraw_lib__u9001p03(realsolid)],
// 1 16 40 31 60 1 0 0 0 1 0 0 0 1 u9002p03.dat
  [1,16,40,31,60,1,0,0,0,1,0,0,0,1, ldraw_lib__u9002p03(realsolid)],
];
module ldraw_lib__u9005c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9005c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
