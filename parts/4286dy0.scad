...
// 1 16 0 10 -30 0 0 -1 -.447214 .894427 0 .894427 .447214 0 6141875h.dat
  [1,16,0,10,-30,0,0,-1,-.447214,.894427,0,.894427,.447214,0, ldraw_lib__6141875h()],
];
module ldraw_lib__4286dy0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4286dy0(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
