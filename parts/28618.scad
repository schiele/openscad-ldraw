...
use <6126b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__28618(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6126b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6126b(realsolid)],
];
module ldraw_lib__28618(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__28618(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
