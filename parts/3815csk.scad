...
use <3817psk.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3815csk(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3815psk.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3815psk(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3816psk.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816psk(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3817psk.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817psk(realsolid)],
];
module ldraw_lib__3815csk(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3815csk(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
