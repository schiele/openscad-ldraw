...
use <t1105.scad>
$fa=1; $fs=0.2;
function ldraw_lib__t1052c08(realsolid=false) = [
...
// 1 47 0 29.5 0 -1 0 0 0 1 0 0 0 -1 t1102.dat
  [1,47,0,29.5,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1102(realsolid)],
// 
// 0 // Bottom Plate
// 1 47 0 29.5 0 -1 0 0 0 1 0 0 0 -1 t1103.dat
  [1,47,0,29.5,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1103(realsolid)],
// 
// 0 // Motor core
// 1 494 0 15 11 -1 0 0 0 1 0 0 0 -1 t1105.dat
  [1,494,0,15,11,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1105(realsolid)],
// 
// 0 // Output shaft
// 1 47 0 15 40 1 0 0 0 1 0 0 0 1 t1104.dat
  [1,47,0,15,40,1,0,0,0,1,0,0,0,1, ldraw_lib__t1104(realsolid)],
];
module ldraw_lib__t1052c08(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1052c08(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
