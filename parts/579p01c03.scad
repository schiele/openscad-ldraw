...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 579p01c02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__579p01c02()],
// 1 4 50 82 -60 0 0 -1 1 0 0 0 -1 0 245c02.dat
  [1,4,50,82,-60,0,0,-1,1,0,0,0,-1,0, ldraw_lib__245c02()],
// 1 4 -50 82 -60 0 0 1 1 0 0 0 1 0 245c02.dat
  [1,4,-50,82,-60,0,0,1,1,0,0,0,1,0, ldraw_lib__245c02()],
// 1 4 50 82 60 0 0 -1 1 0 0 0 -1 0 245c02.dat
  [1,4,50,82,60,0,0,-1,1,0,0,0,-1,0, ldraw_lib__245c02()],
...
module ldraw_lib__579p01c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__579p01c03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
