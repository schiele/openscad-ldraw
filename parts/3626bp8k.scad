...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3626pb0193, Rebrickable 3626bpr0282, set 7047, Set 7632
// 0 !KEYWORDS Set 7633, Set 7891, Set 7994
// 
...
// 1 16 0 4 0 12.01043 0 4.97488 0 13 0 -4.97488 0 12.01043 1-16cyli.dat
  [1,16,0,4,0,12.01043,0,4.97488,0,13,0,-4.97488,0,12.01043, ldraw_lib__1_16cyli()],
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3626bp8ks01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3626bp8ks01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\3626bp8ks01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3626bp8ks01()],
];
module ldraw_lib__3626bp8k(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3626bp8k(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
