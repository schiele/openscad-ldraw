...
use <29125.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9356(realsolid=false) = [
// 0 ~Moved to 29125
// 0 Name: u9356.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 29125.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__29125(realsolid)],
];
module ldraw_lib__u9356(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9356(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
