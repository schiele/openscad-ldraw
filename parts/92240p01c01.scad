...
$fa=1; $fs=0.2;
function ldraw_lib__92240p01c01(realsolid=false) = [
...
// 1 272 0 0 0 1 0 0 0 1 0 0 0 1 92253p01c01.dat
  [1,272,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__92253p01c01(realsolid)],
// 1 78 0 -64 0 1 0 0 0 1 0 0 0 1 92242p01c01.dat
  [1,78,0,-64,0,1,0,0,0,1,0,0,0,1, ldraw_lib__92242p01c01(realsolid)],
// 1 78 0 -111.4 3.9 1 0 0 0 1 0 0 0 1 92240p01.dat
  [1,78,0,-111.4,3.9,1,0,0,0,1,0,0,0,1, ldraw_lib__92240p01(realsolid)],
// 1 70 0 -111.4 0.9 1 0 0 0 1 0 0 0 1 62810.dat
  [1,70,0,-111.4,0.9,1,0,0,0,1,0,0,0,1, ldraw_lib__62810(realsolid)],
];
module ldraw_lib__92240p01c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92240p01c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
