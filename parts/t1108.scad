...
use <../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__t1108(realsolid=false) = [
...
// 1 16 0 0 0 0 0 19 0 -1 0 21 0 0 rect2p.dat
  [1,16,0,0,0,0,0,19,0,-1,0,21,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 -3.2 0 0 0 19 0 1 0 -21 0 0 rect2p.dat
  [1,16,0,-3.2,0,0,0,19,0,1,0,-21,0,0, ldraw_lib__rect2p(realsolid)],
// 4 16 -15 -3.2 27 -19 -3.2 21 19 -3.2 21 15 -3.2 27
  [4,16,-15,-3.2,27,-19,-3.2,21,19,-3.2,21,15,-3.2,27],
// 1 16 -17 -1.6 -24 0 1 2 1.6 0 0 0 0 -3 rect.dat
  [1,16,-17,-1.6,-24,0,1,2,1.6,0,0,0,0,-3, ldraw_lib__rect(realsolid)],
// 1 16 17 -1.6 -24 0 -1 -2 -1.6 0 0 0 0 -3 rect.dat
  [1,16,17,-1.6,-24,0,-1,-2,-1.6,0,0,0,0,-3, ldraw_lib__rect(realsolid)],
// 1 16 17 -1.6 24 0 -1 -2 1.6 0 0 0 0 3 rect.dat
  [1,16,17,-1.6,24,0,-1,-2,1.6,0,0,0,0,3, ldraw_lib__rect(realsolid)],
...
// 1 16 0 -1.6 -27 -15 0 0 0 0 1.6 0 1 0 rect2p.dat
  [1,16,0,-1.6,-27,-15,0,0,0,0,1.6,0,1,0, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__t1108(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1108(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
