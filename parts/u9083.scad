...
use <../p/stug-2x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9083(realsolid=false) = [
...
// 1 16 0 4 0 20 0 0 0 4 0 0 0 40 box.dat
  [1,16,0,4,0,20,0,0,0,4,0,0,0,40, ldraw_lib__box(realsolid)],
];
module ldraw_lib__u9083(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9083(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
