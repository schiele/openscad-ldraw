...
use <s/3818s01.scad>
function ldraw_lib__3818pdg7() = [
// 0 Minifig Arm Right with Reddish Brown Fur Pattern
// 0 Name: 3818pdg7.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 982pb296, CMF, Fozzie Bear, set 71033, The Muppets
// 
...
// 1 70 0 0 0 1 0 0 0 1 0 0 0 1 s\3818pdg1s02.dat
  [1,70,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3818pdg1s02()],
];
module ldraw_lib__3818pdg7(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3818pdg7(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3818pdg7(line=0.2);