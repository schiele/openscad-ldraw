...
use <../p/wpinhol2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30027d(realsolid=false) = [
...
// 1 16 0 0 10 6 0 0 0 0 6 0 -2 0 4-4edge.dat
  [1,16,0,0,10,6,0,0,0,0,6,0,-2,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 10 6 0 0 0 0 6 0 -2 0 4-4cyli.dat
  [1,16,0,0,10,6,0,0,0,0,6,0,-2,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 0 8 1 0 0 0 1 0 0 0 4 s\30027s03.dat
  [1,16,0,0,8,1,0,0,0,1,0,0,0,4, ldraw_lib__s__30027s03(realsolid)],
// 1 16 0 0 8 0 -1 0 1 0 0 0 0 4 s\30027s03.dat
  [1,16,0,0,8,0,-1,0,1,0,0,0,0,4, ldraw_lib__s__30027s03(realsolid)],
// 1 16 0 0 8 -1 0 0 0 -1 0 0 0 4 s\30027s03.dat
  [1,16,0,0,8,-1,0,0,0,-1,0,0,0,4, ldraw_lib__s__30027s03(realsolid)],
// 1 16 0 0 8 0 1 0 -1 0 0 0 0 4 s\30027s03.dat
  [1,16,0,0,8,0,1,0,-1,0,0,0,0,4, ldraw_lib__s__30027s03(realsolid)],
...
module ldraw_lib__30027d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30027d(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
