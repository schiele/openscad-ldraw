...
use <32183c02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32183c01(realsolid=false) = [
// 0 ~Moved to 32183c02
// 0 Name: 32183c01.dat
// 0 Author: [PTadmin]
...
// 1 16 0 30 0 1 0 0 0 1 0 0 0 1 32183c02.dat
  [1,16,0,30,0,1,0,0,0,1,0,0,0,1, ldraw_lib__32183c02(realsolid)],
];
module ldraw_lib__32183c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32183c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
