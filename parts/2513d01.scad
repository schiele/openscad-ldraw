...
use <821410d.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2513d01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2513.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2513(realsolid)],
// 1 16 0 10 -30 1 0 0 0 0.894427 -0.447214 0 0.447214 0.894427 821410d.dat
  [1,16,0,10,-30,1,0,0,0,0.894427,-0.447214,0,0.447214,0.894427, ldraw_lib__821410d(realsolid)],
// 0
];
module ldraw_lib__2513d01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2513d01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
