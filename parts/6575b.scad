...
use <s/6575s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6575b(realsolid=false) = [
...
// 1 16 0 -10 -5 1 0 0 0 0 -1 0 10 0 axlehol5.dat
  [1,16,0,-10,-5,1,0,0,0,0,-1,0,10,0, ldraw_lib__axlehol5(realsolid)],
...
// 1 16 -2 -15.801 0 0 -1 0 -0.199 0 0 0 0 -5 rect2p.dat
  [1,16,-2,-15.801,0,0,-1,0,-0.199,0,0,0,0,-5, ldraw_lib__rect2p(realsolid)],
...
// 1 16 -2 -4.199 0 0 -1 0 0.199 0 0 0 0 -5 rect2p.dat
  [1,16,-2,-4.199,0,0,-1,0,0.199,0,0,0,0,-5, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 10.5 5 1.5 0 0 0 0 -1.5 0 -1 0 8\2-4ndis.dat
  [1,16,0,10.5,5,1.5,0,0,0,0,-1.5,0,-1,0, ldraw_lib__8__2_4ndis(realsolid)],
// 1 16 0 10.5 -5 1.5 0 0 0 0 -1.5 0 1 0 8\2-4ndis.dat
  [1,16,0,10.5,-5,1.5,0,0,0,0,-1.5,0,1,0, ldraw_lib__8__2_4ndis(realsolid)],
...
// 1 16 0 10.5 -5 1.5 0 0 0 0 -1.5 0 10 0 8\2-4cylo.dat
  [1,16,0,10.5,-5,1.5,0,0,0,0,-1.5,0,10,0, ldraw_lib__8__2_4cylo(realsolid)],
...
module ldraw_lib__6575b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6575b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
