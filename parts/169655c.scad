...
function ldraw_lib__169655c() = [
// 0 Sticker  2.0 x  6.3 with Launch Command Logo, Blue V and Red Lines and Number "3" Left Side
// 0 Name: 169655c.dat
...
module ldraw_lib__169655c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__169655c(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__169655c(line=0.2);