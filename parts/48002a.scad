...
use <s/48002s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48002a(realsolid=false) = [
...
// 1 16 0 460 0 1 0 0 0 14 0 0 0 1 axl3hole.dat
  [1,16,0,460,0,1,0,0,0,14,0,0,0,1, ldraw_lib__axl3hole(realsolid)],
];
module ldraw_lib__48002a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48002a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
