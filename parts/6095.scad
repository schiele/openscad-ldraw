...
use <../p/4-8sphe.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6095(realsolid=false) = [
...
// 1 16 0 -10 0 20 0 0 0 -9.5 0 0 0 20 4-4cylo.dat
  [1,16,0,-10,0,20,0,0,0,-9.5,0,0,0,20, ldraw_lib__4_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -10 0 16 0 0 0 -6.5 0 0 0 16 4-4cylo.dat
  [1,16,0,-10,0,16,0,0,0,-6.5,0,0,0,16, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 -19.5 0 4 0 0 0 1 0 0 0 4 4-4ring4.dat
  [1,16,0,-19.5,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4ring4(realsolid)],
...
// 1 16 0 -16.5 0 16 0 0 0 -2.5 0 0 0 16 4-8sphe.dat
  [1,16,0,-16.5,0,16,0,0,0,-2.5,0,0,0,16, ldraw_lib__4_8sphe(realsolid)],
// 1 16 0 -19.5 0 16 0 0 0 1 0 0 0 16 4-4edge.dat
  [1,16,0,-19.5,0,16,0,0,0,1,0,0,0,16, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -19.5 0 16 0 0 0 -2.5 0 0 0 16 4-8sphe.dat
  [1,16,0,-19.5,0,16,0,0,0,-2.5,0,0,0,16, ldraw_lib__4_8sphe(realsolid)],
];
module ldraw_lib__6095(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6095(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
