...
use <s/11203s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__11203(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\11203s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__11203s01(realsolid)],
// 4 16 -20 8 20 20 8 20 20 8 -20 -20 8 -20
  [4,16,-20,8,20,20,8,20,20,8,-20,-20,8,-20],
];
module ldraw_lib__11203(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11203(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
