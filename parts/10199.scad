...
// 1 16 40 4 0 0 0 -1.5 0 8 0 24 0 0 box3u8p.dat
  [1,16,40,4,0,0,0,-1.5,0,8,0,24,0,0, ldraw_lib__box3u8p()],
// 1 16 40 4 24 0 0 -1.5 0 8 0 1.5 0 0 boxjcyl4.dat
  [1,16,40,4,24,0,0,-1.5,0,8,0,1.5,0,0, ldraw_lib__boxjcyl4()],
// 1 16 40 4 56 0 0 1.5 0 8 0 -1.5 0 0 boxjcyl4.dat
  [1,16,40,4,56,0,0,1.5,0,8,0,-1.5,0,0, ldraw_lib__boxjcyl4()],
...
module ldraw_lib__10199(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__10199(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
