...
use <u9082.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9081c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 u9081.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9081(realsolid)],
// 1 494 0 0 0 1 0 0 0 1 0 0 0 1 11140.dat
  [1,494,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__11140(realsolid)],
// 1 494 0 0 0 0 0 -1 0 1 0 1 0 0 u9082.dat
  [1,494,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__u9082(realsolid)],
];
module ldraw_lib__u9081c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9081c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
