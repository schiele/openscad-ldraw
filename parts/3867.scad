...
use <../p/stug8.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3867(realsolid=false) = [
// 0 Baseplate 16 x 16
// 0 Name: 3867.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !HISTORY 2005-08-29 [DeannaEarley] BFC'd, fixed errors, and used stud groups
...
module ldraw_lib__3867(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3867(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3867(line=0.2);