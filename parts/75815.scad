...
use <6639.scad>
$fa=1; $fs=0.2;
function ldraw_lib__75815(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6637c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6637c01(realsolid)],
// 1 16 0 34 0 1 0 0 0 1 0 0 0 1 6639.dat
  [1,16,0,34,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6639(realsolid)],
];
module ldraw_lib__75815(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__75815(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
