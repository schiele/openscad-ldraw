...
use <973.scad>
$fa=1; $fs=0.2;
function ldraw_lib__10677(realsolid=false) = [
...
// 1 16 15.552 9 0 -0.985 0 0.17 0.17 0 0.985 0 1 0 10303.dat
  [1,16,15.552,9,0,-0.985,0,0.17,0.17,0,0.985,0,1,0, ldraw_lib__10303(realsolid)],
// 1 16 -15.552 9 0 0.985 0 -0.17 0.17 0 0.985 0 -1 0 10303.dat
  [1,16,-15.552,9,0,0.985,0,-0.17,0.17,0,0.985,0,-1,0, ldraw_lib__10303(realsolid)],
// 1 16 33.212 -6.22 0 0.91521 0 -0.4019 0.4019 0 0.91521 0 -1 0 3820.dat
  [1,16,33.212,-6.22,0,0.91521,0,-0.4019,0.4019,0,0.91521,0,-1,0, ldraw_lib__3820(realsolid)],
// 1 16 -33.212 -6.22 0 0.91521 0 0.4019 -0.4019 0 0.91521 0 -1 0 3820.dat
  [1,16,-33.212,-6.22,0,0.91521,0,0.4019,-0.4019,0,0.91521,0,-1,0, ldraw_lib__3820(realsolid)],
];
module ldraw_lib__10677(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__10677(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
