...
// 1 0 -120 -144 -80 1 0 0 0 1 0 0 0 1 stug-1x3.dat
  [1,0,-120,-144,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x3()],
...
// 1 7 -80 -144 -80 1 0 0 0 1 0 0 0 1 stud.dat
  [1,7,-80,-144,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__stud()],
...
// 1 0 -150 -144 -240 1 0 0 0 1 0 0 0 1 stug-1x2.dat
  [1,0,-150,-144,-240,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x2()],
...
// 1 0 -110 -144 -240 1 0 0 0 1 0 0 0 1 stug-1x2.dat
  [1,0,-110,-144,-240,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_1x2()],
// 1 0 -100 -144 -220 1 0 0 0 1 0 0 0 1 stud.dat
  [1,0,-100,-144,-220,1,0,0,0,1,0,0,0,1, ldraw_lib__stud()],
// 
// 0 // Inside
...
// 1 16 0 0 -310 1 0 0 0 1 0 0 -0.277778 1 s\2552p05s05.dat
  [1,16,0,0,-310,1,0,0,0,1,0,0,-0.277778,1, ldraw_lib__s__2552p05s05()],
// 
// 0 // Upper Front
// 1 16 0 0 -150 1 0 0 0 1 0 0 -0.277778 1 s\2552p05s04.dat
  [1,16,0,0,-150,1,0,0,0,1,0,0,-0.277778,1, ldraw_lib__s__2552p05s04()],
// 
// 0 // Right
// 1 16 290 0 0 1 0.277778 0 0 1 0 0 0 1 s\2552p05s02.dat
  [1,16,290,0,0,1,0.277778,0,0,1,0,0,0,1, ldraw_lib__s__2552p05s02()],
// 
// 0 // Back
// 1 16 0 0 290 1 0 0 0 1 0 0 0.277778 1 s\2552p05s01.dat
  [1,16,0,0,290,1,0,0,0,1,0,0,0.277778,1, ldraw_lib__s__2552p05s01()],
// 
// 0 // Left
// 1 16 -310 0 0 1 -0.277778 0 0 1 0 0 0 1 s\2552p05s03.dat
  [1,16,-310,0,0,1,-0.277778,0,0,1,0,0,0,1, ldraw_lib__s__2552p05s03()],
// 
// 0 // Ramp
// 1 16 0 -109.9 0 1 0 0 0.378947 1 0 0 0 1 s\2552p05s08.dat
  [1,16,0,-109.9,0,1,0,0,0.378947,1,0,0,0,1, ldraw_lib__s__2552p05s08()],
// 
// 0 // Top
// 1 16 0 -144 0 1 0 0 0 1 0 0 0 1 s\2552p05s06.dat
  [1,16,0,-144,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2552p05s06()],
// 
// 0 // Pit
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2552p05s07.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2552p05s07()],
// 
// 0 // Bottom Perimeter
...
module ldraw_lib__2552p05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2552p05(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
