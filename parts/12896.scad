...
use <973.scad>
$fa=1; $fs=0.2;
function ldraw_lib__12896(realsolid=false) = [
...
// 1 16 23.6904 26.774 -9.8982 -.1202 .9851 -.1202 -.6964 -.1697 -.6964 -.707 0 .707 13543.dat
  [1,16,23.6904,26.774,-9.8982,-.1202,.9851,-.1202,-.6964,-.1697,-.6964,-.707,0,.707, ldraw_lib__13543(realsolid)],
];
module ldraw_lib__12896(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__12896(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
