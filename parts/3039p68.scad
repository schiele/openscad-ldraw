...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Rebrickable 3039pr9992, Set 5154
// 
...
// 1 16 0 10 -20 0.622254 0 0 0 0.44 -0.44 0 0.44 0.44 s\3068p68a.dat
  [1,16,0,10,-20,0.622254,0,0,0,0.44,-0.44,0,0.44,0.44, ldraw_lib__s__3068p68a()],
...
module ldraw_lib__3039p68(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3039p68(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
