...
use <s/30152s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30152(realsolid=false) = [
...
// 1 16 0 50 0 1 0 0 0 1 0 0 0 1 s\30152s02.dat
  [1,16,0,50,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30152s02(realsolid)],
// 1 47 0 28 0 1 0 0 0 1 0 0 0 1 s\30152s01.dat
  [1,47,0,28,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30152s01(realsolid)],
];
module ldraw_lib__30152(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30152(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
