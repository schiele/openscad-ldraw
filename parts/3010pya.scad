...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS bricklink 3010pb255, Jack Skellington, Rebrickable 3010pr0058
...
// 1 16 -30 0 0 1 0 0 0 1 0 0 0 1 s\3005pz3s01.dat
  [1,16,-30,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3005pz3s01()],
// 1 16 -10 0 0 1 0 0 0 1 0 0 0 1 s\3005pz3s01.dat
  [1,16,-10,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3005pz3s01()],
// 1 16 10 0 0 1 0 0 0 1 0 0 0 1 s\3005pz3s01.dat
  [1,16,10,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3005pz3s01()],
// 1 16 30 0 0 1 0 0 0 1 0 0 0 1 s\3005pz3s01.dat
  [1,16,30,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3005pz3s01()],
...
module ldraw_lib__3010pya(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3010pya(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
