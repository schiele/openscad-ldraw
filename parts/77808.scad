...
// 1 16 10 4 0 3.5 0 0 0 -4 0 0 0 3.5 4-4cylo.dat
  [1,16,10,4,0,3.5,0,0,0,-4,0,0,0,3.5, ldraw_lib__4_4cylo()],
// 1 16 10 8 0 4 0 0 0 8 0 0 0 4 4-4cylo.dat
  [1,16,10,8,0,4,0,0,0,8,0,0,0,4, ldraw_lib__4_4cylo()],
// 1 16 10 0 0 .5 0 0 0 1 0 0 0 .5 4-4ring7.dat
  [1,16,10,0,0,.5,0,0,0,1,0,0,0,.5, ldraw_lib__4_4ring7()],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -10 4 0 3.5 0 0 0 -4 0 0 0 3.5 4-4cylo.dat
...
// 1 16 10 24 0 0 0 2 0 -1 0 -2 0 0 2-4ring3.dat
  [1,16,10,24,0,0,0,2,0,-1,0,-2,0,0, ldraw_lib__2_4ring3()],
// 1 16 10 24 0 0 0 2 0 -1 0 -2 0 0 2-4ring4.dat
  [1,16,10,24,0,0,0,2,0,-1,0,-2,0,0, ldraw_lib__2_4ring4()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 20 0 0 0 6 0 4 0 -6 0 0 2-4cylo.dat
  [1,16,10,20,0,0,0,6,0,4,0,-6,0,0, ldraw_lib__2_4cylo()],
// 1 16 10 20 0 0 0 6 0 -1 0 -6 0 0 2-4chrd.dat
  [1,16,10,20,0,0,0,6,0,-1,0,-6,0,0, ldraw_lib__2_4chrd()],
// 1 16 10 10 0 0 0 -2 0 -1 0 -2 0 0 4-4disc.dat
  [1,16,10,10,0,0,0,-2,0,-1,0,-2,0,0, ldraw_lib__4_4disc()],
// 1 16 10 16 0 0 0 10 0 8 0 -10 0 0 2-4cylo.dat
  [1,16,10,16,0,0,0,10,0,8,0,-10,0,0, ldraw_lib__2_4cylo()],
// 1 16 10 16 0 0 0 2 0 1 0 -2 0 0 2-4ring4.dat
  [1,16,10,16,0,0,0,2,0,1,0,-2,0,0, ldraw_lib__2_4ring4()],
// 1 16 10 16 0 0 0 4 0 1 0 -4 0 0 2-4ring1.dat
  [1,16,10,16,0,0,0,4,0,1,0,-4,0,0, ldraw_lib__2_4ring1()],
// 1 16 10 16 0 0 0 -4 0 1 0 -4 0 0 2-4ndis.dat
  [1,16,10,16,0,0,0,-4,0,1,0,-4,0,0, ldraw_lib__2_4ndis()],
...
// 1 16 0 20 -8 -10 0 0 0 0 -4 0 -2 0 box3u10p.dat
  [1,16,0,20,-8,-10,0,0,0,0,-4,0,-2,0, ldraw_lib__box3u10p()],
// 1 16 0 22 -7 -10 0 0 0 0 2 0 1 0 box2-11.dat
  [1,16,0,22,-7,-10,0,0,0,0,2,0,1,0, ldraw_lib__box2_11()],
// 
// 1 16 -10 24 0 0 0 -2 0 -1 0 2 0 0 2-4ring3.dat
  [1,16,-10,24,0,0,0,-2,0,-1,0,2,0,0, ldraw_lib__2_4ring3()],
// 1 16 -10 24 0 0 0 -2 0 -1 0 2 0 0 2-4ring4.dat
...
// 1 16 10 0 0 0 0 8 0 4 0 -8 0 0 2-4cylo.dat
  [1,16,10,0,0,0,0,8,0,4,0,-8,0,0, ldraw_lib__2_4cylo()],
// 1 16 10 4 0 0 0 8 0 1 0 8 0 0 2-4chrd.dat
  [1,16,10,4,0,0,0,8,0,1,0,8,0,0, ldraw_lib__2_4chrd()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -10 0 0 0 0 -8 0 4 0 8 0 0 2-4cylo.dat
  [1,16,-10,0,0,0,0,-8,0,4,0,8,0,0, ldraw_lib__2_4cylo()],
...
// 1 16 0 0 0 10 0 0 0 4 0 0 0 8 box3u8p.dat
  [1,16,0,0,0,10,0,0,0,4,0,0,0,8, ldraw_lib__box3u8p()],
// 
...
// 1 16 10 8 0 0 0 4 0 -1 0 -4 0 0 2-4ring1.dat
  [1,16,10,8,0,0,0,4,0,-1,0,-4,0,0, ldraw_lib__2_4ring1()],
// 1 16 -10 8 0 0 0 -2 0 -1 0 2 0 0 2-4ring4.dat
  [1,16,-10,8,0,0,0,-2,0,-1,0,2,0,0, ldraw_lib__2_4ring4()],
// 1 16 -10 8 0 0 0 -4 0 -1 0 4 0 0 2-4ring1.dat
  [1,16,-10,8,0,0,0,-4,0,-1,0,4,0,0, ldraw_lib__2_4ring1()],
// 1 16 10 8 0 0 0 -4 0 -1 0 -4 0 0 2-4ndis.dat
  [1,16,10,8,0,0,0,-4,0,-1,0,-4,0,0, ldraw_lib__2_4ndis()],
// 1 16 -10 8 0 0 0 4 0 -1 0 4 0 0 2-4ndis.dat
  [1,16,-10,8,0,0,0,4,0,-1,0,4,0,0, ldraw_lib__2_4ndis()],
...
// 1 16 10 4 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,10,4,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 -10 0 0 6 0 0 0 4 0 0 0 6 4-4cyli.dat
  [1,16,-10,0,0,6,0,0,0,4,0,0,0,6, ldraw_lib__4_4cyli()],
// 1 16 -10 4 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-10,4,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 0 4 0 4 0 0 0 -4 0 0 0 2 box3u8p.dat
  [1,16,0,4,0,4,0,0,0,-4,0,0,0,2, ldraw_lib__box3u8p()],
// 1 16 4 4 0 2 0 0 0 -4 0 0 0 2 boxjcyl4.dat
  [1,16,4,4,0,2,0,0,0,-4,0,0,0,2, ldraw_lib__boxjcyl4()],
// 1 16 -4 4 0 -2 0 0 0 -4 0 0 0 2 boxjcyl4.dat
  [1,16,-4,4,0,-2,0,0,0,-4,0,0,0,2, ldraw_lib__boxjcyl4()],
];
module ldraw_lib__77808(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__77808(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
