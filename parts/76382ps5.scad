...
use <3820.scad>
use <973ps5.scad>
function ldraw_lib__76382ps5() = [
// 0 Minifig Torso with Arms and Hands with SW Vest, White Shirt & Yellow Neck Pattern
// 0 Name: 76382ps5.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973ps5.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973ps5()],
...
module ldraw_lib__76382ps5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382ps5(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382ps5(line=0.2);