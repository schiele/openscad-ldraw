...
// 1 16 -19.5 3.5 0 0 -.5 0 0 0 3.5 10 0 0 box2-5.dat
  [1,16,-19.5,3.5,0,0,-.5,0,0,0,3.5,10,0,0, ldraw_lib__box2_5()],
// 
...
module ldraw_lib__44301a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__44301a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
