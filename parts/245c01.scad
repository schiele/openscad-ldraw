...
use <269.scad>
$fa=1; $fs=0.2;
function ldraw_lib__245c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 245.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__245(realsolid)],
// 1 60 0 0 12 1 0 0 0 1 0 0 0 1 269.dat
  [1,60,0,0,12,1,0,0,0,1,0,0,0,1, ldraw_lib__269(realsolid)],
];
module ldraw_lib__245c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__245c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
