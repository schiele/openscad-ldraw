...
use <s/3003s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3003pe4(realsolid=false) = [
...
// 1 4 0 12 -20 11 0 0 0 0 -11 0 1 0 4-4disc.dat
  [1,4,0,12,-20,11,0,0,0,0,-11,0,1,0, ldraw_lib__4_4disc(realsolid)],
...
module ldraw_lib__3003pe4(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3003pe4(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3003pe4(line=0.2);