...
use <55967.scad>
$fa=1; $fs=0.2;
function ldraw_lib__53793c00(realsolid=false) = [
...
// 1 72 0 -40 -39 1 0 0 0 1 0 0 0 1 55967.dat
  [1,72,0,-40,-39,1,0,0,0,1,0,0,0,1, ldraw_lib__55967(realsolid)],
// 1 16 0 -70 -24 1 0 0 0 1 0 0 0 1 55966.dat
  [1,16,0,-70,-24,1,0,0,0,1,0,0,0,1, ldraw_lib__55966(realsolid)],
];
module ldraw_lib__53793c00(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__53793c00(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__53793c00(line=0.2);