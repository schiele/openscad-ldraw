...
use <../p/t04q1000.scad>
$fa=1; $fs=0.2;
function ldraw_lib__72634c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 72634.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__72634(realsolid)],
// 1 0 20 48 0 -1 0 0 0 1 0 0 0 -1 6625c01.dat
  [1,0,20,48,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__6625c01(realsolid)],
// 0 // cable, undefined length
// 1 256 -36 22.5 0 0 -124 0 -1 0 0 0 0 1 993.dat
  [1,256,-36,22.5,0,0,-124,0,-1,0,0,0,0,1, ldraw_lib__993(realsolid)],
// 1 256 -160 52.5 0 0 164 0 1 0 0 0 0 1 993.dat
  [1,256,-160,52.5,0,0,164,0,1,0,0,0,0,1, ldraw_lib__993(realsolid)],
// 1 256 -160 37.5 0 0 0 -14.4 -14.4 0 0 0 1 0 2-4edge.dat
  [1,256,-160,37.5,0,0,0,-14.4,-14.4,0,0,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 256 -160 37.5 0 0 0 -15.6 -15.6 0 0 0 1 0 2-4edge.dat
  [1,256,-160,37.5,0,0,0,-15.6,-15.6,0,0,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 256 -160 37.5 -1.3852 0 0 -15 -15 0 0 0 15 0 t04q1000.dat
  [1,256,-160,37.5,-1.3852,0,0,-15,-15,0,0,0,15,0, ldraw_lib__t04q1000(realsolid)],
// 1 256 -160 37.5 -1.3852 0 0 -15 15 0 0 0 15 0 t04q1000.dat
  [1,256,-160,37.5,-1.3852,0,0,-15,15,0,0,0,15,0, ldraw_lib__t04q1000(realsolid)],
// 1 256 -160 37.5 1.3852 0 0 -15 -15 0 0 0 15 0 t04q1000.dat
  [1,256,-160,37.5,1.3852,0,0,-15,-15,0,0,0,15,0, ldraw_lib__t04q1000(realsolid)],
...
module ldraw_lib__72634c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__72634c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
