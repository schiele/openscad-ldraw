...
use <99396.scad>
$fa=1; $fs=0.2;
function ldraw_lib__95650(realsolid=false) = [
...
// 1 71 0 -69 -20 1 0 0 0 1 0 0 0 1 99388.dat
  [1,71,0,-69,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__99388(realsolid)],
// 1 0 0 -46.5 -70 1 0 0 0 1 0 0 0 1 11014p01.dat
  [1,0,0,-46.5,-70,1,0,0,0,1,0,0,0,1, ldraw_lib__11014p01(realsolid)],
...
// 1 47 0 -46.5 -52 1 0 0 0 1 0 0 0 1 11013.dat
  [1,47,0,-46.5,-52,1,0,0,0,1,0,0,0,1, ldraw_lib__11013(realsolid)],
// 1 47 0 -33.5 -56 1 0 0 0 1 0 0 0 1 99396.dat
  [1,47,0,-33.5,-56,1,0,0,0,1,0,0,0,1, ldraw_lib__99396(realsolid)],
];
module ldraw_lib__95650(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__95650(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
