...
use <3817bpq1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__73200pq1(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3815bpq1.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3815bpq1(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3816bpq1.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816bpq1(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3817bpq1.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817bpq1(realsolid)],
];
module ldraw_lib__73200pq1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73200pq1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
