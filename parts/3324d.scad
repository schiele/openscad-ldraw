...
use <../p/stug2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3324d(realsolid=false) = [
// 0 Hinge Plate  2 x  9 Base with Small Hole
// 0 Name: 3324d.dat
...
// 0 !HISTORY 2008-07-08 [guyvivan] Fixed bad orientation of studs and move hole and size near hinge (2005-11-01)
// 0 !HISTORY 2008-07-09 [PTadmin] Renamed from 3324 (2005-12-22)
...
// 1 16 0 2 -90 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,2,-90,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 0 2 -110 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,2,-110,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 0 2 -130 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,2,-130,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 0 2 -150 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,2,-150,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 2 -90 16 0 0 0 4 0 0 0 76 box4.dat
  [1,16,0,2,-90,16,0,0,0,4,0,0,0,76, ldraw_lib__box4(realsolid)],
...
// 4 16 -20 6 -10 -16 6 -14 -16 6 -166 -20 6 -170
  [4,16,-20,6,-10,-16,6,-14,-16,6,-166,-20,6,-170],
// 4 16 -16 2 -166 -3 2 -21 3 2 -21 16 2 -166
  [4,16,-16,2,-166,-3,2,-21,3,2,-21,16,2,-166],
// 4 16 16 2 -166 3 2 -21 3 2 -15 16 2 -14
  [4,16,16,2,-166,3,2,-21,3,2,-15,16,2,-14],
// 4 16 -16 2 -14 -3 2 -15 -3 2 -21 -16 2 -166
  [4,16,-16,2,-14,-3,2,-15,-3,2,-21,-16,2,-166],
// 1 16 0 2 -10 10 0 0 0 0 4 0 -1 0 rect.dat
  [1,16,0,2,-10,10,0,0,0,0,4,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 2 -170 20 0 0 0 0 4 0 1 0 rect.dat
  [1,16,0,2,-170,20,0,0,0,0,4,0,1,0, ldraw_lib__rect(realsolid)],
...
// 4 16 -20 -2 -10 -3 -2 -15 3 -2 -15 20 -2 -10
  [4,16,-20,-2,-10,-3,-2,-15,3,-2,-15,20,-2,-10],
// 4 16 20 -2 -170 3 -2 -21 -3 -2 -21 -20 -2 -170
  [4,16,20,-2,-170,3,-2,-21,-3,-2,-21,-20,-2,-170],
// 4 16 20 -2 -10 3 -2 -15 3 -2 -21 20 -2 -170
  [4,16,20,-2,-10,3,-2,-15,3,-2,-21,20,-2,-170],
// 4 16 -20 -2 -170 -3 -2 -21 -3 -2 -15 -20 -2 -10
  [4,16,-20,-2,-170,-3,-2,-21,-3,-2,-15,-20,-2,-10],
// 1 16 0 -2 -150 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,0,-2,-150,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 1 16 0 -2 -110 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,0,-2,-110,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 1 16 0 -2 -70 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,0,-2,-70,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
// 1 16 0 -2 -30 0 0 1 0 1 0 -1 0 0 stug2.dat
  [1,16,0,-2,-30,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug2(realsolid)],
...
module ldraw_lib__3324d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3324d(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3324d(line=0.2);