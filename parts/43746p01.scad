...
use <s/43746s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__43746p01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\43746s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__43746s01(realsolid)],
// 
// 0 // Scales Pattern
// 0 // Left
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\43746p01s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__43746p01s01(realsolid)],
// 0 // Right
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\43746p01s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__43746p01s01(realsolid)],
];
module ldraw_lib__43746p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__43746p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
