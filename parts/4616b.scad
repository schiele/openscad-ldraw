...
use <../p/stug-2x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4616b(realsolid=false) = [
...
// 1 16 0 24 -38 1 0 0 0 0 -1 0 1 0 4-4ring6.dat
  [1,16,0,24,-38,1,0,0,0,0,-1,0,1,0, ldraw_lib__4_4ring6(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 24 -22 6 0 0 0 0 6 0 -16 0 4-4cyli.dat
  [1,16,0,24,-22,6,0,0,0,0,6,0,-16,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 24 -16 6.5 0 0 0 0 6.5 0 -6 0 4-4cyli.dat
  [1,16,0,24,-16,6.5,0,0,0,0,6.5,0,-6,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 24 -38 6 0 0 0 0 6 0 -6 0 4-4edge.dat
  [1,16,0,24,-38,6,0,0,0,0,6,0,-6,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 24 -22 0.5 0 0 0 0 -0.5 0 -0.5 0 4-4rin12.dat
  [1,16,0,24,-22,0.5,0,0,0,0,-0.5,0,-0.5,0, ldraw_lib__4_4rin12(realsolid)],
// 1 16 0 24 -16 0.5 0 0 0 0 -0.5 0 -0.5 0 4-4rin13.dat
  [1,16,0,24,-16,0.5,0,0,0,0,-0.5,0,-0.5,0, ldraw_lib__4_4rin13(realsolid)],
// 1 16 0 24 -22 6 0 0 0 0 -6 0 6 0 4-4edge.dat
  [1,16,0,24,-22,6,0,0,0,0,-6,0,6,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 24 -22 6.5 0 0 0 0 -6.5 0 6.5 0 4-4edge.dat
  [1,16,0,24,-22,6.5,0,0,0,0,-6.5,0,6.5,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 24 -16 6.5 0 0 0 0 -6.5 0 6.5 0 4-4edge.dat
  [1,16,0,24,-16,6.5,0,0,0,0,-6.5,0,6.5,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 24 -38 -2.679 0 6.467 6.467 0 2.679 0 1 0 1-8edge.dat
  [1,16,0,24,-38,-2.679,0,6.467,6.467,0,2.679,0,1,0, ldraw_lib__1_8edge(realsolid)],
// 1 16 0 24 -38 2.679 0 -6.467 -6.467 0 -2.679 0 1 0 1-8edge.dat
  [1,16,0,24,-38,2.679,0,-6.467,-6.467,0,-2.679,0,1,0, ldraw_lib__1_8edge(realsolid)],
];
module ldraw_lib__4616b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4616b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
