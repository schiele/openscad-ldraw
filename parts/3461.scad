...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3461(realsolid=false) = [
...
// 1 16 0 -16 0 7.5 0 0 0 1 0 0 0 7.5 4-4edge.dat
  [1,16,0,-16,0,7.5,0,0,0,1,0,0,0,7.5, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 -8 0 0.5 0 0 0 -1 0 0 0 0.5 4-4rin15.dat
  [1,16,0,-8,0,0.5,0,0,0,-1,0,0,0,0.5, ldraw_lib__4_4rin15(realsolid)],
// 1 16 0 -16 0 0.5 0 0 0 1 0 0 0 0.5 4-4rin15.dat
  [1,16,0,-16,0,0.5,0,0,0,1,0,0,0,0.5, ldraw_lib__4_4rin15(realsolid)],
// 0
...
// 1 16 0 -4 0 10 0 0 0 -8 0 0 0 10 box4.dat
  [1,16,0,-4,0,10,0,0,0,-8,0,0,0,10, ldraw_lib__box4(realsolid)],
...
// 1 16 -30 -16 0 1 0 0 0 -1 0 0 0 1 stud3.dat
  [1,16,-30,-16,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -30 -12 0 16 0 0 0 -4 0 0 0 6 box5.dat
  [1,16,-30,-12,0,16,0,0,0,-4,0,0,0,6, ldraw_lib__box5(realsolid)],
...
// 1 16 -30 -12 0 0 0 -20 0 -8 0 10 0 0 box4-4a.dat
  [1,16,-30,-12,0,0,0,-20,0,-8,0,10,0,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 -20 -20 0 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-20,-20,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 -40 -20 0 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-40,-20,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 0
// 1 16 0 -16 -30 0 0 -1 0 -1 0 1 0 0 stud3.dat
  [1,16,0,-16,-30,0,0,-1,0,-1,0,1,0,0, ldraw_lib__stud3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -12 -30 0 0 -6 0 -4 0 16 0 0 box5.dat
  [1,16,0,-12,-30,0,0,-6,0,-4,0,16,0,0, ldraw_lib__box5(realsolid)],
...
// 1 16 0 -12 -30 -10 0 0 0 -8 0 0 0 -20 box4-4a.dat
  [1,16,0,-12,-30,-10,0,0,0,-8,0,0,0,-20, ldraw_lib__box4_4a(realsolid)],
// 1 16 0 -20 -20 0 0 -1 0 1 0 1 0 0 stud.dat
  [1,16,0,-20,-20,0,0,-1,0,1,0,1,0,0, ldraw_lib__stud(realsolid)],
// 1 16 0 -20 -40 0 0 -1 0 1 0 1 0 0 stud.dat
  [1,16,0,-20,-40,0,0,-1,0,1,0,1,0,0, ldraw_lib__stud(realsolid)],
// 0
// 1 16 30 -16 0 -1 0 0 0 -1 0 0 0 -1 stud3.dat
  [1,16,30,-16,0,-1,0,0,0,-1,0,0,0,-1, ldraw_lib__stud3(realsolid)],
// 0 BFC INVERTNEXT
...
module ldraw_lib__3461(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3461(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
