...
use <../p/confric4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__18651(realsolid=false) = [
...
// 1 16 -10 0 0 0 1 0 0 0 1 1 0 0 confric4.dat
  [1,16,-10,0,0,0,1,0,0,0,1,1,0,0, ldraw_lib__confric4(realsolid)],
...
module ldraw_lib__18651(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__18651(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
