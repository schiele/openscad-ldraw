...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u8009d(realsolid=false) = [
...
// 1 16 40 0 0 0 0 -1 0 1 0 1 0 0 slotm.dat
  [1,16,40,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__slotm(realsolid)],
// 1 16 0 0 40 -1 0 0 0 1 0 0 0 -1 slotm.dat
  [1,16,0,0,40,-1,0,0,0,1,0,0,0,-1, ldraw_lib__slotm(realsolid)],
// 0
...
module ldraw_lib__u8009d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8009d(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
