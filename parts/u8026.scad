...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u8026(realsolid=false) = [
...
// 1 16 0 35 -10 35 0 0 0 0 27 0 4 0 box4.dat
  [1,16,0,35,-10,35,0,0,0,0,27,0,4,0, ldraw_lib__box4(realsolid)],
// 1 16 0 35 -10 37 0 0 0 0 29 0 3 0 box4.dat
  [1,16,0,35,-10,37,0,0,0,0,29,0,3,0, ldraw_lib__box4(realsolid)],
...
// 1 16 0 1.5 -10 40 0 0 0 0 -1.5 0 3 0 box4o4a.dat
  [1,16,0,1.5,-10,40,0,0,0,0,-1.5,0,3,0, ldraw_lib__box4o4a(realsolid)],
// 4 16 40 0 -10 40 3 -10 -40 3 -10 -40 0 -10
  [4,16,40,0,-10,40,3,-10,-40,3,-10,-40,0,-10],
// 1 16 0 65 -7 -40 0 0 0 0 1 0 1 0 rect3.dat
  [1,16,0,65,-7,-40,0,0,0,0,1,0,1,0, ldraw_lib__rect3(realsolid)],
// 2 24 40 3 -7 -40 3 -7
  [2,24,40,3,-7,-40,3,-7],
...
// 1 16 -40 36 0.5 0 1 0 -36 0 0 0 0 7.5 rect3.dat
  [1,16,-40,36,0.5,0,1,0,-36,0,0,0,0,7.5, ldraw_lib__rect3(realsolid)],
// 1 16 40 36 0.5 0 -1 0 36 0 0 0 0 7.5 rect3.dat
  [1,16,40,36,0.5,0,-1,0,36,0,0,0,0,7.5, ldraw_lib__rect3(realsolid)],
// 1 16 38 36 -6 0 0 -2 -36 0 0 0 18 0 box4-7a.dat
  [1,16,38,36,-6,0,0,-2,-36,0,0,0,18,0, ldraw_lib__box4_7a(realsolid)],
// 1 16 -38 36 -6 0 0 2 36 0 0 0 18 0 box4-7a.dat
  [1,16,-38,36,-6,0,0,2,36,0,0,0,18,0, ldraw_lib__box4_7a(realsolid)],
// 1 16 -44 36 10 0 4 0 -36 0 0 0 0 2 box4o4a.dat
  [1,16,-44,36,10,0,4,0,-36,0,0,0,0,2, ldraw_lib__box4o4a(realsolid)],
...
// 1 16 0 72 -9.7 40 0 0 0 -1 0 0 0 -2.75 rect3.dat
  [1,16,0,72,-9.7,40,0,0,0,-1,0,0,0,-2.75, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__u8026(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8026(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
