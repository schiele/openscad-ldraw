...
// 1 16 52.5 -62.5 0 1 0 0 0 1 0 0 0 1 822ac01.dat
  [1,16,52.5,-62.5,0,1,0,0,0,1,0,0,0,1, ldraw_lib__822ac01()],
];
module ldraw_lib__822(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__822(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
