...
use <970c00.scad>
$fa=1; $fs=0.2;
function ldraw_lib__74040(realsolid=false) = [
...
// 1 2 0 0 0 1 0 0 0 1 0 0 0 1 970c00.dat
  [1,2,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__970c00(realsolid)],
];
module ldraw_lib__74040(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__74040(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
