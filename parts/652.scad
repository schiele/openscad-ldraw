...
use <s/652s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__652(realsolid=false) = [
...
// 1 16 40 -5 -10 0 0 -10 10 0 0 0 4 0 1-8cylo.dat
  [1,16,40,-5,-10,0,0,-10,10,0,0,0,4,0, ldraw_lib__1_8cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 40 -5 10 0 0 -10 10 0 0 0 -4 0 1-8cylo.dat
  [1,16,40,-5,10,0,0,-10,10,0,0,0,-4,0, ldraw_lib__1_8cylo(realsolid)],
// 1 16 32.23695 1.0355 8 -0.69205 -1 0 -1.0355 0 0 0 0 -2 rect2p.dat
  [1,16,32.23695,1.0355,8,-0.69205,-1,0,-1.0355,0,0,0,0,-2, ldraw_lib__rect2p(realsolid)],
// 1 16 32.23695 1.0355 -8 -0.69205 -1 0 -1.0355 0 0 0 0 -2 rect2p.dat
  [1,16,32.23695,1.0355,-8,-0.69205,-1,0,-1.0355,0,0,0,0,-2, ldraw_lib__rect2p(realsolid)],
...
// 1 16 30.1 -4.5 0 0.1 1 0 0.5 0 0 0 0 -6 rect2p.dat
  [1,16,30.1,-4.5,0,0.1,1,0,0.5,0,0,0,0,-6, ldraw_lib__rect2p(realsolid)],
// 5 24 30 -5 6 30 -5 -6 30.2 -4 -6 30.761 -8.827 -6
  [5,24,30,-5,6,30,-5,-6,30.2,-4,-6,30.761,-8.827,-6],
// 1 16 40 -5 -6 0 0 10 10 0 0 0 12 0 3-4cylo.dat
  [1,16,40,-5,-6,0,0,10,10,0,0,0,12,0, ldraw_lib__3_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 40 -5 -6 0 0 7 7 0 0 0 12 0 4-4cylo.dat
  [1,16,40,-5,-6,0,0,7,7,0,0,0,12,0, ldraw_lib__4_4cylo(realsolid)],
...
module ldraw_lib__652(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__652(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
