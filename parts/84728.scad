...
use <../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__84728(realsolid=false) = [
...
// 1 494 0 1 0 1 0 0 0 14 0 0 0 1 4-4cylc.dat
  [1,494,0,1,0,1,0,0,0,14,0,0,0,1, ldraw_lib__4_4cylc(realsolid)],
// 1 494 0 15 0 2 0 0 0 1 0 0 0 2 4-4cylc.dat
  [1,494,0,15,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4cylc(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 16 0 5 0 0 0 -16 0 0 0 5 4-4cylc.dat
  [1,16,0,16,0,5,0,0,0,-16,0,0,0,5, ldraw_lib__4_4cylc(realsolid)],
// 1 16 0 0 0 5 0 0 0 1 0 0 0 5 4-4ndis.dat
  [1,16,0,0,0,5,0,0,0,1,0,0,0,5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 0 0 9 0 0 0 18 0 0 0 6 box5.dat
  [1,16,0,0,0,9,0,0,0,18,0,0,0,6, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__84728(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__84728(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
