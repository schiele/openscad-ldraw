...
use <../p/stug8.scad>
$fa=1; $fs=0.2;
function ldraw_lib__374p02(realsolid=false) = [
...
// 1 16 -180 0 80 1 0 0 0 1 0 0 0 1 stug8.dat
  [1,16,-180,0,80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug8(realsolid)],
// 1 16 -180 0 -80 1 0 0 0 1 0 0 0 1 stug8.dat
  [1,16,-180,0,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug8(realsolid)],
// 1 16 -290 0 110 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,-290,0,110,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3(realsolid)],
// 1 16 -290 0 50 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,-290,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3(realsolid)],
// 1 16 -290 0 -10 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,-290,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3(realsolid)],
...
// 1 16 -50 0 110 1 0 0 0 1 0 0 0 1 stug5.dat
  [1,16,-50,0,110,1,0,0,0,1,0,0,0,1, ldraw_lib__stug5(realsolid)],
// 1 16 50 0 110 1 0 0 0 1 0 0 0 1 stug5.dat
  [1,16,50,0,110,1,0,0,0,1,0,0,0,1, ldraw_lib__stug5(realsolid)],
// 1 16 220 0 100 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,220,0,100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4(realsolid)],
// 1 16 290 0 110 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,290,0,110,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3(realsolid)],
// 1 16 290 0 50 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,290,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3(realsolid)],
// 1 16 230 0 30 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,230,0,30,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3(realsolid)],
// 1 16 290 0 -10 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,290,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3(realsolid)],
// 1 16 280 0 -80 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,280,0,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4(realsolid)],
// 1 16 240 0 -20 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,240,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2(realsolid)],
...
// 1 16 160 0 140 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,160,0,140,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2(realsolid)],
...
// 1 16 -40 0 20 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,-40,0,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4(realsolid)],
// 1 16 -30 0 -90 1 0 0 0 1 0 0 0 1 stug7.dat
  [1,16,-30,0,-90,1,0,0,0,1,0,0,0,1, ldraw_lib__stug7(realsolid)],
// 1 16 90 0 -110 1 0 0 0 1 0 0 0 1 stug5.dat
  [1,16,90,0,-110,1,0,0,0,1,0,0,0,1, ldraw_lib__stug5(realsolid)],
// 1 16 190 0 -110 1 0 0 0 1 0 0 0 1 stug5.dat
  [1,16,190,0,-110,1,0,0,0,1,0,0,0,1, ldraw_lib__stug5(realsolid)],
...
module ldraw_lib__374p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__374p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
