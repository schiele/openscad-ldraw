...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3626pb0798, Rebrickable 3626bpr1162, Set 10245, set 40125
// 0 !KEYWORDS Set 60024, Set 60099, Set 60133
// 
// 0 !CMDLINE -c14
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3626p0hs01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3626p0hs01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\3626p0hs01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3626p0hs01()],
// 
// 0 // Condlines
...
module ldraw_lib__3626bp0h(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3626bp0h(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
