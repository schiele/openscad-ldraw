...
use <s/4716s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32905(realsolid=false) = [
...
// 1 16 0 0 -20 0 0 -1 1 0 0 0 -1 0 axl4hol2.dat
  [1,16,0,0,-20,0,0,-1,1,0,0,0,-1,0, ldraw_lib__axl4hol2(realsolid)],
// 1 16 0 0 18.5 0 0 -1 1 0 0 0 -38.5 0 axl4hole.dat
  [1,16,0,0,18.5,0,0,-1,1,0,0,0,-38.5,0, ldraw_lib__axl4hole(realsolid)],
// 1 16 0 0 18.5 0 0 -1 1 0 0 0 -1 0 axl4hol3.dat
  [1,16,0,0,18.5,0,0,-1,1,0,0,0,-1,0, ldraw_lib__axl4hol3(realsolid)],
// 1 16 0 0 20 6 0 0 0 0 6 0 -6 0 4-4edge.dat
  [1,16,0,0,20,6,0,0,0,0,6,0,-6,0, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 20 6 0 0 0 0 6 0 -1.5 0 4-4cyli.dat
  [1,16,0,0,20,6,0,0,0,0,6,0,-1.5,0, ldraw_lib__4_4cyli(realsolid)],
...
module ldraw_lib__32905(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32905(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
