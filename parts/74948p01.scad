...
use <u9349p01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__74948p01(realsolid=false) = [
...
// 1 47 0 0 0 1 0 0 0 1 0 0 0 1 6095.dat
  [1,47,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6095(realsolid)],
// 1 494 0 0 0 1 0 0 0 1 0 0 0 1 70926.dat
  [1,494,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__70926(realsolid)],
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 u9349p01.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9349p01(realsolid)],
];
module ldraw_lib__74948p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__74948p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
