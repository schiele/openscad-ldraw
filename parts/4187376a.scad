...
use <004239a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4187376a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 004239a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__004239a(realsolid)],
];
module ldraw_lib__4187376a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4187376a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
