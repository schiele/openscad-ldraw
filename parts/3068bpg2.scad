...
$fa=1; $fs=0.2;
function ldraw_lib__3068bpg2(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS bricklink 3068bpb0053, Scala, set 309-1
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\4150pf2s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4150pf2s01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\4150pf2s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__4150pf2s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\4150pf2s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__4150pf2s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\4150pf2s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__4150pf2s01(realsolid)],
...
module ldraw_lib__3068bpg2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068bpg2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
