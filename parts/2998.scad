...
use <s/2998b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2998(realsolid=false) = [
...
// 1 16 0 0 13 0 1 0 -1 0 0 0 0 1 s\2998a.dat
  [1,16,0,0,13,0,1,0,-1,0,0,0,0,1, ldraw_lib__s__2998a(realsolid)],
// 1 16 -40 0 0 0 1 0 -1 0 0 0 0 1 s\2998b.dat
  [1,16,-40,0,0,0,1,0,-1,0,0,0,0,1, ldraw_lib__s__2998b(realsolid)],
// 1 16 -20 -34.64106 0 0.866025 0.5 0 -0.5 0.866025 0 0 0 1 s\2998b.dat
  [1,16,-20,-34.64106,0,0.866025,0.5,0,-0.5,0.866025,0,0,0,1, ldraw_lib__s__2998b(realsolid)],
// 1 16 20 -34.64106 0 0.866025 -0.5 0 0.5 0.866025 0 0 0 1 s\2998b.dat
  [1,16,20,-34.64106,0,0.866025,-0.5,0,0.5,0.866025,0,0,0,1, ldraw_lib__s__2998b(realsolid)],
// 1 16 40 0 0 0 -1 0 1 0 0 0 0 1 s\2998b.dat
  [1,16,40,0,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__s__2998b(realsolid)],
...
module ldraw_lib__2998(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2998(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
