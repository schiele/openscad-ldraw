...
use <s/2431s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2431pt1(realsolid=false) = [
...
// 1 4 24 0 -0.5 0.9 0 0 0 1 0 0 0 0.9 s\170876s1.dat
  [1,4,24,0,-0.5,0.9,0,0,0,1,0,0,0,0.9, ldraw_lib__s__170876s1(realsolid)],
// 1 15 24 0 -0.5 0.9 0 0 0 1 0 0 0 0.9 s\170876s2.dat
  [1,15,24,0,-0.5,0.9,0,0,0,1,0,0,0,0.9, ldraw_lib__s__170876s2(realsolid)],
// 1 2 25 0 0.5 -0.9 0 0 0 1 0 0 0 -0.9 s\170876s1.dat
  [1,2,25,0,0.5,-0.9,0,0,0,1,0,0,0,-0.9, ldraw_lib__s__170876s1(realsolid)],
// 1 15 25 0 0.5 -0.9 0 0 0 1 0 0 0 -0.9 s\170876s2.dat
  [1,15,25,0,0.5,-0.9,0,0,0,1,0,0,0,-0.9, ldraw_lib__s__170876s2(realsolid)],
// 1 15 24.5 0 0 1.55 0 0 0 1 0 0 0 1.05 4-4ring7.dat
  [1,15,24.5,0,0,1.55,0,0,0,1,0,0,0,1.05, ldraw_lib__4_4ring7(realsolid)],
// 1 16 24.5 0 0 12.4 0 0 0 1 0 0 0 8.4 4-4ndis.dat
  [1,16,24.5,0,0,12.4,0,0,0,1,0,0,0,8.4, ldraw_lib__4_4ndis(realsolid)],
// 1 4 -25 0 -0.5 0.9 0 0 0 1 0 0 0 0.9 s\170876s1.dat
  [1,4,-25,0,-0.5,0.9,0,0,0,1,0,0,0,0.9, ldraw_lib__s__170876s1(realsolid)],
// 1 15 -25 0 -0.5 0.9 0 0 0 1 0 0 0 0.9 s\170876s2.dat
  [1,15,-25,0,-0.5,0.9,0,0,0,1,0,0,0,0.9, ldraw_lib__s__170876s2(realsolid)],
// 1 2 -24 0 0.5 -0.9 0 0 0 1 0 0 0 -0.9 s\170876s1.dat
  [1,2,-24,0,0.5,-0.9,0,0,0,1,0,0,0,-0.9, ldraw_lib__s__170876s1(realsolid)],
// 1 15 -24 0 0.5 -0.9 0 0 0 1 0 0 0 -0.9 s\170876s2.dat
  [1,15,-24,0,0.5,-0.9,0,0,0,1,0,0,0,-0.9, ldraw_lib__s__170876s2(realsolid)],
// 1 15 -24.5 0 0 -1.55 0 0 0 1 0 0 0 1.05 4-4ring7.dat
  [1,15,-24.5,0,0,-1.55,0,0,0,1,0,0,0,1.05, ldraw_lib__4_4ring7(realsolid)],
...
module ldraw_lib__2431pt1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2431pt1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
