...
// 1 0 0 -19 63 1 0 0 0 1 0 0 0 1 3136.dat
  [1,0,0,-19,63,1,0,0,0,1,0,0,0,1, ldraw_lib__3136()],
// 0
];
module ldraw_lib__3135c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3135c03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
