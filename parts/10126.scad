...
use <10127.scad>
$fa=1; $fs=0.2;
function ldraw_lib__10126(realsolid=false) = [
// 0 Bigfig Hand Right
// 0 Name: 10126.dat
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 10127.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__10127(realsolid)],
];
module ldraw_lib__10126(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__10126(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
