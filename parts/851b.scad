...
// 1 16 -15 -20 -16.5 115 0 0 0 1 0 0 0 2.5 rect.dat
  [1,16,-15,-20,-16.5,115,0,0,0,1,0,0,0,2.5, ldraw_lib__rect()],
// 
// 1 16 0 -5 16.5 -130 0 0 0 -1 0 0 0 2.5 rect3.dat
  [1,16,0,-5,16.5,-130,0,0,0,-1,0,0,0,2.5, ldraw_lib__rect3()],
// 1 16 0 -12.5 14 0 0 130 -7.5 0 0 0 5 0 box3u10p.dat
...
module ldraw_lib__851b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__851b(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
