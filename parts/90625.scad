...
use <s/90626s01.scad>
use <s/98590s01.scad>
function ldraw_lib__90625() = [
// 0 Constraction Torso  9 x  9
// 0 Name: 90625.dat
...
module ldraw_lib__90625(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__90625(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__90625(line=0.2);