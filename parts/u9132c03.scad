...
use <u9132c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9132c03(realsolid=false) = [
...
// 1 256 -31 0 0 1 0 0 0 1 0 0 0 1 3139.dat
  [1,256,-31,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3139(realsolid)],
// 1 256 31 0 0 -1 0 0 0 1 0 0 0 -1 3139.dat
  [1,256,31,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__3139(realsolid)],
];
module ldraw_lib__u9132c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9132c03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
