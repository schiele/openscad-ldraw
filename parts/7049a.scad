...
use <3112.scad>
$fa=1; $fs=0.2;
function ldraw_lib__7049a(realsolid=false) = [
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 3110.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3110(realsolid)],
// 1 4 0 10 0 1 0 0 0 1 0 0 0 1 3112.dat
  [1,4,0,10,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3112(realsolid)],
// 1 4 22 10 0 1 0 0 0 1 0 0 0 1 3111.dat
  [1,4,22,10,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3111(realsolid)],
// 1 4 -22 10 0 1 0 0 0 1 0 0 0 1 3111.dat
  [1,4,-22,10,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3111(realsolid)],
];
module ldraw_lib__7049a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__7049a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
