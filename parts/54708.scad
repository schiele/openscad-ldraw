...
use <s/54708s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__54708(realsolid=false) = [
...
// 1 16 -49 -2 -111 28 0 0 0 0 -2 0 1 0 rect2p.dat
  [1,16,-49,-2,-111,28,0,0,0,0,-2,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 49 -2 -111 28 0 0 0 0 -2 0 1 0 rect2p.dat
  [1,16,49,-2,-111,28,0,0,0,0,-2,0,1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 -16 -2 0 0 1 0 0 0 -2 -88.5 0 0 rect2p.dat
  [1,16,-16,-2,0,0,1,0,0,0,-2,-88.5,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -21 -2 0 0 -1 0 0 0 -2 88.5 0 0 rect2p.dat
  [1,16,-21,-2,0,0,-1,0,0,0,-2,88.5,0,0, ldraw_lib__rect2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -18.5 -4 88.5 2.5 0 0 0 4 0 0 0 2.5 2-4cyli.dat
  [1,16,-18.5,-4,88.5,2.5,0,0,0,4,0,0,0,2.5, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -18.5 -4 88.5 2.5 0 0 0 4 0 0 0 2.5 2-4edge.dat
  [1,16,-18.5,-4,88.5,2.5,0,0,0,4,0,0,0,2.5, ldraw_lib__2_4edge(realsolid)],
// 1 16 -18.5 -4 88.5 2.5 0 0 0 4 0 0 0 2.5 2-4ndis.dat
  [1,16,-18.5,-4,88.5,2.5,0,0,0,4,0,0,0,2.5, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -18.5 0 88.5 2.5 0 0 0 4 0 0 0 2.5 2-4edge.dat
  [1,16,-18.5,0,88.5,2.5,0,0,0,4,0,0,0,2.5, ldraw_lib__2_4edge(realsolid)],
// 1 16 -18.5 0 88.5 2.5 0 0 0 -4 0 0 0 2.5 2-4ndis.dat
  [1,16,-18.5,0,88.5,2.5,0,0,0,-4,0,0,0,2.5, ldraw_lib__2_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -18.5 -4 -88.5 -2.5 0 0 0 4 0 0 0 -2.5 2-4cyli.dat
  [1,16,-18.5,-4,-88.5,-2.5,0,0,0,4,0,0,0,-2.5, ldraw_lib__2_4cyli(realsolid)],
...
// 1 16 0 -13 -114 7 0 0 0 0 -7 0 1 0 2-4disc.dat
  [1,16,0,-13,-114,7,0,0,0,0,-7,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 0 -13 -114 7 0 0 0 0 -7 0 1 0 2-4edge.dat
  [1,16,0,-13,-114,7,0,0,0,0,-7,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -13 -111 7 0 0 0 0 -7 0 1 0 2-4edge.dat
  [1,16,0,-13,-111,7,0,0,0,0,-7,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -13 -114 7 0 0 0 0 -7 0 3 0 2-4cyli.dat
  [1,16,0,-13,-114,7,0,0,0,0,-7,0,3,0, ldraw_lib__2_4cyli(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\54708s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__54708s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\54708s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__54708s01(realsolid)],
// 1 16 0 0 36 1 0 0 0 1 0 0 0 1 s\54708s01.dat
  [1,16,0,0,36,1,0,0,0,1,0,0,0,1, ldraw_lib__s__54708s01(realsolid)],
// 1 16 0 0 36 -1 0 0 0 1 0 0 0 -1 s\54708s01.dat
  [1,16,0,0,36,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__54708s01(realsolid)],
// 1 16 0 0 72 1 0 0 0 1 0 0 0 1 s\54708s01.dat
  [1,16,0,0,72,1,0,0,0,1,0,0,0,1, ldraw_lib__s__54708s01(realsolid)],
// 1 16 0 0 72 -1 0 0 0 1 0 0 0 -1 s\54708s01.dat
  [1,16,0,0,72,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__54708s01(realsolid)],
// 1 16 0 0 -72 1 0 0 0 1 0 0 0 1 s\54708s01.dat
  [1,16,0,0,-72,1,0,0,0,1,0,0,0,1, ldraw_lib__s__54708s01(realsolid)],
...
module ldraw_lib__54708(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__54708(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
