...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3195p03(realsolid=false) = [
...
// 1 1 10 40 40 0 0 -1 0 -2 0 2 0 0 s\4865p01c.dat
  [1,1,10,40,40,0,0,-1,0,-2,0,2,0,0, ldraw_lib__s__4865p01c(realsolid)],
// 1 16 10 40 40 0 0 -1 0 -2 0 2 0 0 s\4865p01b.dat
  [1,16,10,40,40,0,0,-1,0,-2,0,2,0,0, ldraw_lib__s__4865p01b(realsolid)],
// 
// 0 // Subpart
...
module ldraw_lib__3195p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3195p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
