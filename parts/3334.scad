...
// 1 16 160 0 80 1 0 0 0 1 0 0 0 1 stug-8x8.dat
  [1,16,160,0,80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_8x8()],
// 1 16 160 0 -80 1 0 0 0 1 0 0 0 1 stug-8x8.dat
  [1,16,160,0,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_8x8()],
// 1 16 0 0 80 1 0 0 0 1 0 0 0 1 stug-8x8.dat
  [1,16,0,0,80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_8x8()],
// 1 16 0 0 -80 1 0 0 0 1 0 0 0 1 stug-8x8.dat
  [1,16,0,0,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_8x8()],
// 1 16 -160 0 80 1 0 0 0 1 0 0 0 1 stug-8x8.dat
  [1,16,-160,0,80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_8x8()],
...
// 1 16 0 4 158 0 0 236 0 -1 0 2 0 0 rect1.dat
  [1,16,0,4,158,0,0,236,0,-1,0,2,0,0, ldraw_lib__rect1()],
// 1 16 -236 4 156 -4 0 0 0 -1 0 0 0 4 1-4disc.dat
  [1,16,-236,4,156,-4,0,0,0,-1,0,0,0,4, ldraw_lib__1_4disc()],
// 1 16 -238 4 0 -2 0 0 0 -1 0 0 0 156 rect1.dat
  [1,16,-238,4,0,-2,0,0,0,-1,0,0,0,156, ldraw_lib__rect1()],
// 1 16 -236 4 -156 -4 0 0 0 -1 0 0 0 -4 1-4disc.dat
  [1,16,-236,4,-156,-4,0,0,0,-1,0,0,0,-4, ldraw_lib__1_4disc()],
// 1 16 0 4 -158 0 0 -236 0 -1 0 -2 0 0 rect1.dat
  [1,16,0,4,-158,0,0,-236,0,-1,0,-2,0,0, ldraw_lib__rect1()],
...
// 1 16 0 0 158 0 0 -236 0 1 0 2 0 0 rect1.dat
  [1,16,0,0,158,0,0,-236,0,1,0,2,0,0, ldraw_lib__rect1()],
// 1 16 -236 0 156 -4 0 0 0 1 0 0 0 4 1-4disc.dat
  [1,16,-236,0,156,-4,0,0,0,1,0,0,0,4, ldraw_lib__1_4disc()],
// 1 16 -238 0 0 -2 0 0 0 1 0 0 0 -156 rect1.dat
  [1,16,-238,0,0,-2,0,0,0,1,0,0,0,-156, ldraw_lib__rect1()],
// 1 16 -236 0 -156 -4 0 0 0 1 0 0 0 -4 1-4disc.dat
  [1,16,-236,0,-156,-4,0,0,0,1,0,0,0,-4, ldraw_lib__1_4disc()],
// 1 16 0 0 -158 0 0 236 0 1 0 -2 0 0 rect1.dat
  [1,16,0,0,-158,0,0,236,0,1,0,-2,0,0, ldraw_lib__rect1()],
...
// 1 16 236 0 156 4 0 0 0 4 0 0 0 4 1-4cylo.dat
  [1,16,236,0,156,4,0,0,0,4,0,0,0,4, ldraw_lib__1_4cylo()],
...
module ldraw_lib__3334(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3334(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
