...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__62470(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\62470s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__62470s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\62470s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__62470s01(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 22 -34 16 0 0 0 0 -2 0 90 0 box4-2p.dat
  [1,16,0,22,-34,16,0,0,0,0,-2,0,90,0, ldraw_lib__box4_2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 16 58 -18 0 0 0 0 2 0 -93 0 box4-4a.dat
  [1,16,0,16,58,-18,0,0,0,0,2,0,-93,0, ldraw_lib__box4_4a(realsolid)],
// 1 16 0 11.813 -35 18 0 0 0 0 -2.187 0 -1 0 rect3.dat
  [1,16,0,11.813,-35,18,0,0,0,0,-2.187,0,-1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 20 20 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,20,20,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
// 1 16 0 16 59 -6 0 0 0 1 0 0 0 1 rect2p.dat
  [1,16,0,16,59,-6,0,0,0,1,0,0,0,1, ldraw_lib__rect2p(realsolid)],
// 2 24 -20 24 60 20 24 60
  [2,24,-20,24,60,20,24,60],
// 0
];
module ldraw_lib__62470(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__62470(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
