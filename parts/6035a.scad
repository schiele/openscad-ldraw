...
use <../p/box.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6035a(realsolid=false) = [
...
// 1 494 16.667 20 0 0 0 -.667 0 -4 0 -7 0 0 box.dat
  [1,494,16.667,20,0,0,0,-.667,0,-4,0,-7,0,0, ldraw_lib__box(realsolid)],
// 1 494 -16.667 20 0 0 0 -.667 0 -4 0 -7 0 0 box.dat
  [1,494,-16.667,20,0,0,0,-.667,0,-4,0,-7,0,0, ldraw_lib__box(realsolid)],
// 1 10 0 15 -1 17.334 0 0 0 1 0 0 0 6 box.dat
  [1,10,0,15,-1,17.334,0,0,0,1,0,0,0,6, ldraw_lib__box(realsolid)],
// 
// 0 // light
// 1 0 0 10 -8 6 0 0 0 0 6 0 1 0 4-4disc.dat
  [1,0,0,10,-8,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 10 -8 6 0 0 0 0 -6 0 -10 0 4-4cyli.dat
  [1,16,0,10,-8,6,0,0,0,0,-6,0,-10,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 10 -18 6 0 0 0 0 -6 0 -6 0 4-8sphe.dat
  [1,16,0,10,-18,6,0,0,0,0,-6,0,-6,0, ldraw_lib__4_8sphe(realsolid)],
// 1 16 0 10 -7 6 0 0 0 0 -6 0 -1 0 4-4cylc.dat
  [1,16,0,10,-7,6,0,0,0,0,-6,0,-1,0, ldraw_lib__4_4cylc(realsolid)],
];
module ldraw_lib__6035a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6035a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
