...
use <3082.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3081bc01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3081b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3081b(realsolid)],
...
module ldraw_lib__3081bc01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3081bc01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
