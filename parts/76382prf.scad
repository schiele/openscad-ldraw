...
use <3820.scad>
use <973prf.scad>
function ldraw_lib__76382prf() = [
// 0 Minifig Torso with Arms and Hands with SW Tank Top Pattern
// 0 Name: 76382prf.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973prf.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973prf()],
...
module ldraw_lib__76382prf(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382prf(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382prf(line=0.2);