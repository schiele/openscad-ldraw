...
$fa=1; $fs=0.2;
function ldraw_lib__191915d(realsolid=false) = [
...
// 1 16 0 -0.25 0 0.31 0 0 0 1 0 0 0 0.31 s\191915sde.dat
  [1,16,0,-0.25,0,0.31,0,0,0,1,0,0,0,0.31, ldraw_lib__s__191915sde(realsolid)],
...
module ldraw_lib__191915d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__191915d(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
