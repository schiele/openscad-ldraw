...
use <s/3626bs04.scad>
use <../p/t16o6250.scad>
function ldraw_lib__3626bp43() = [
// 0 Minifig Head with Red Moustache, Beard and Messy Hair Pattern
// 0 Name: 3626bp43.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 3626bpx22, Brickowl 535595, Rebrickable 3626bpr0011
// 0 !KEYWORDS set 6277, set 6286
// 
...
module ldraw_lib__3626bp43(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3626bp43(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3626bp43(line=0.2);