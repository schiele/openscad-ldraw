...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__41539(realsolid=false) = [
// 0 Plate  8 x  8
// 0 Name: 41539.dat
// 0 Author: Martin G Cormier
...
// 0 !HISTORY 2004-10-06 [guyvivan] Made BFC Compliant
...
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 76 0 0 0 -4 0 0 0 76 box5.dat
  [1,16,0,8,0,76,0,0,0,-4,0,0,0,76, ldraw_lib__box5(realsolid)],
// 4 16 80 8 80 76 8 76 -76 8 76 -80 8 80
  [4,16,80,8,80,76,8,76,-76,8,76,-80,8,80],
// 4 16 -80 8 80 -76 8 76 -76 8 -76 -80 8 -80
  [4,16,-80,8,80,-76,8,76,-76,8,-76,-80,8,-80],
// 4 16 -80 8 -80 -76 8 -76 76 8 -76 80 8 -80
...
// 4 16 80 8 -80 76 8 -76 76 8 76 80 8 80
  [4,16,80,8,-80,76,8,-76,76,8,76,80,8,80],
// 1 16 0 8 0 80 0 0 0 -8 0 0 0 80 box5.dat
  [1,16,0,8,0,80,0,0,0,-8,0,0,0,80, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__41539(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__41539(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__41539(line=0.2);