...
use <s/20596s06.scad>
use <s/20596s07.scad>
function ldraw_lib__20596() = [
// 0 Minifig Hair Female Pigtails High, Long Bangs, Hole on Top
// 0 Name: 20596.dat
...
// 0 // Hair ties left
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\20596s03.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__20596s03()],
// 0 // Tips right
...
module ldraw_lib__20596(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__20596(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__20596(line=0.2);