...
function ldraw_lib__u9142p03c04() = [
...
// 1 15 0 -67 4 1 0 0 0 1 0 0 0 1 u9142p03c02.dat
  [1,15,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u9142p03c02()],
// 1 4 0 -37 4 1 0 0 0 1 0 0 0 1 u9102p08.dat
  [1,4,0,-37,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u9102p08()],
...
module ldraw_lib__u9142p03c04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9142p03c04(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
