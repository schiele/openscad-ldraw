...
$fa=1; $fs=0.2;
function ldraw_lib__46413d02(realsolid=false) = [
...
// 1 10047 0 2 -40 1 0 0 0 1 0 0 0 1 6109079ac01.dat
  [1,10047,0,2,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__6109079ac01(realsolid)],
];
module ldraw_lib__46413d02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__46413d02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
