...
use <../p/box5.scad>
$fa=1; $fs=0.2;
function ldraw_lib__671(realsolid=false) = [
// 0 Door  1 x  6 x 10
// 0 Name: 671.dat
...
// 1 16 -46.5 -6 0 0 0 2.5 0 -1 0 2.5 0 0 2-4edge.dat
  [1,16,-46.5,-6,0,0,0,2.5,0,-1,0,2.5,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -46.5 -6 0 0 0 2.5 0 -1 0 2.5 0 0 2-4ndis.dat
  [1,16,-46.5,-6,0,0,0,2.5,0,-1,0,2.5,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -46.5 -6 0 0 0 2.5 0 2.5 0 2.5 0 0 4-8sphe.dat
  [1,16,-46.5,-6,0,0,0,2.5,0,2.5,0,2.5,0,0, ldraw_lib__4_8sphe(realsolid)],
// 2 24 -46.5 -6 -2.5 -44 -6 -2.5
  [2,24,-46.5,-6,-2.5,-44,-6,-2.5],
// 2 24 -46.5 -6 2.5 -44 -6 2.5
  [2,24,-46.5,-6,2.5,-44,-6,2.5],
// 1 16 -46.5 -219 0 0 0 2.5 0 -1 0 2.5 0 0 2-4edge.dat
  [1,16,-46.5,-219,0,0,0,2.5,0,-1,0,2.5,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -46.5 -219 0 0 0 2.5 0 1 0 2.5 0 0 2-4ndis.dat
  [1,16,-46.5,-219,0,0,0,2.5,0,1,0,2.5,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -46.5 -219 0 0 0 2.5 0 -2.5 0 2.5 0 0 4-8sphe.dat
  [1,16,-46.5,-219,0,0,0,2.5,0,-2.5,0,2.5,0,0, ldraw_lib__4_8sphe(realsolid)],
// 2 24 -46.5 -219 -2.5 -44 -219 -2.5
  [2,24,-46.5,-219,-2.5,-44,-219,-2.5],
// 2 24 -46.5 -219 2.5 -44 -219 2.5
  [2,24,-46.5,-219,2.5,-44,-219,2.5],
// 1 16 -46.5 -6 0 0 0 -2.5 0 -213 0 2.5 0 0 2-4cyli.dat
  [1,16,-46.5,-6,0,0,0,-2.5,0,-213,0,2.5,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -44 -112.5 0 0 91 0 0 0 106.5 2.5 0 0 box3u4a.dat
  [1,16,-44,-112.5,0,0,91,0,0,0,106.5,2.5,0,0, ldraw_lib__box3u4a(realsolid)],
// 1 16 39 -112.5 9 0 0 3 3 0 0 0 -1 0 2-4chrd.dat
  [1,16,39,-112.5,9,0,0,3,3,0,0,0,-1,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 33 -112.5 9 0 0 -3 3 0 0 0 -1 0 2-4chrd.dat
  [1,16,33,-112.5,9,0,0,-3,3,0,0,0,-1,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 39 -112.5 9 0 0 3 3 0 0 0 -6.5 0 2-4cylo.dat
  [1,16,39,-112.5,9,0,0,3,3,0,0,0,-6.5,0, ldraw_lib__2_4cylo(realsolid)],
// 1 16 33 -112.5 9 0 0 -3 3 0 0 0 -6.5 0 2-4cylo.dat
  [1,16,33,-112.5,9,0,0,-3,3,0,0,0,-6.5,0, ldraw_lib__2_4cylo(realsolid)],
// 1 16 36 -112.5 2.5 3 0 0 0 0 3 0 6.5 0 box3u8p.dat
  [1,16,36,-112.5,2.5,3,0,0,0,0,3,0,6.5,0, ldraw_lib__box3u8p(realsolid)],
// 1 16 39 -112.5 -9 0 0 3 3 0 0 0 1 0 2-4chrd.dat
  [1,16,39,-112.5,-9,0,0,3,3,0,0,0,1,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 33 -112.5 -9 0 0 -3 3 0 0 0 1 0 2-4chrd.dat
  [1,16,33,-112.5,-9,0,0,-3,3,0,0,0,1,0, ldraw_lib__2_4chrd(realsolid)],
...
// 1 16 0 -112.5 -2.5 27 0 0 0 0 86.5 0 1 0 box4.dat
  [1,16,0,-112.5,-2.5,27,0,0,0,0,86.5,0,1,0, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -112.5 2.5 27 0 0 0 0 86.5 0 -1 0 box4.dat
  [1,16,0,-112.5,2.5,27,0,0,0,0,86.5,0,-1,0, ldraw_lib__box4(realsolid)],
// 1 16 0 -112.5 -1.5 19 0 0 0 0 78.5 0 -1 0 box5.dat
  [1,16,0,-112.5,-1.5,19,0,0,0,0,78.5,0,-1,0, ldraw_lib__box5(realsolid)],
// 1 16 0 -112.5 1.5 19 0 0 0 0 78.5 0 1 0 box5.dat
  [1,16,0,-112.5,1.5,19,0,0,0,0,78.5,0,1,0, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__671(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__671(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
