...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30414(realsolid=false) = [
...
// 1 16 -10 10 -6 4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,16,-10,10,-6,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 -10 10 -6 4 0 0 0 0 4 0 -1 0 4-4ndis.dat
  [1,16,-10,10,-6,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 10 10 -6 4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,16,10,10,-6,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 10 -6 4 0 0 0 0 4 0 -1 0 4-4ndis.dat
  [1,16,10,10,-6,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 -30 10 -10 6 0 0 0 0 6 0 1 0 4-4edge.dat
  [1,16,-30,10,-10,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 -30 10 -10 6 0 0 0 0 6 0 1 0 4-4ndis.dat
  [1,16,-30,10,-10,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -30 10 -10 4 0 0 0 0 4 0 4 0 4-4cyli.dat
  [1,16,-30,10,-10,4,0,0,0,0,4,0,4,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -30 10 -10 1 0 0 0 0 1 0 1 0 stud2a.dat
  [1,16,-30,10,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__stud2a(realsolid)],
// 1 16 -10 10 -10 6 0 0 0 0 6 0 1 0 4-4edge.dat
  [1,16,-10,10,-10,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 -10 10 -10 6 0 0 0 0 6 0 1 0 4-4ndis.dat
  [1,16,-10,10,-10,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -10 10 -10 4 0 0 0 0 4 0 4 0 4-4cyli.dat
  [1,16,-10,10,-10,4,0,0,0,0,4,0,4,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -10 10 -10 1 0 0 0 0 1 0 1 0 stud2a.dat
  [1,16,-10,10,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__stud2a(realsolid)],
// 1 16 10 10 -10 6 0 0 0 0 6 0 1 0 4-4edge.dat
  [1,16,10,10,-10,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 10 -10 6 0 0 0 0 6 0 1 0 4-4ndis.dat
  [1,16,10,10,-10,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4ndis(realsolid)],
...
module ldraw_lib__30414(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30414(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
