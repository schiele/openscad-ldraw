...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Rebrickable 3010pr9964, Set 351
// 
...
// 1 15 0 0 -10 1 0 0 0 1 0 0 0 1 s\3010p30s01.dat
  [1,15,0,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010p30s01()],
...
module ldraw_lib__3010p31(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3010p31(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
