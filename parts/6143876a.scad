...
// 1 16 0 -0.25 0 36.25 0 0 0 0.25 0 0 0 28 box5-12.dat
  [1,16,0,-0.25,0,36.25,0,0,0,0.25,0,0,0,28, ldraw_lib__box5_12()],
// 1 16 0 -0.25 0 1 0 0 0 1 0 0 0 1 s\6143876as01.dat
  [1,16,0,-0.25,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6143876as01()],
// 1 16 0 -0.25 0 -1 0 0 0 1 0 0 0 1 s\6143876as01.dat
  [1,16,0,-0.25,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__6143876as01()],
];
module ldraw_lib__6143876a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6143876a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
