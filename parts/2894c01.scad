...
use <2895.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2894c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2894.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2894(realsolid)],
// 1 16 0 54 0 1 0 0 0 1 0 0 0 1 2893.dat
  [1,16,0,54,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2893(realsolid)],
// 1 16 40 42 -60 0 0 -1 1 0 0 0 -1 0 2895.dat
  [1,16,40,42,-60,0,0,-1,1,0,0,0,-1,0, ldraw_lib__2895(realsolid)],
// 1 16 40 42 60 0 0 -1 1 0 0 0 -1 0 2895.dat
  [1,16,40,42,60,0,0,-1,1,0,0,0,-1,0, ldraw_lib__2895(realsolid)],
// 1 16 -40 42 60 0 0 1 1 0 0 0 1 0 2895.dat
  [1,16,-40,42,60,0,0,1,1,0,0,0,1,0, ldraw_lib__2895(realsolid)],
...
module ldraw_lib__2894c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2894c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
