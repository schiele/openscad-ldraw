...
function ldraw_lib__1023035() = [
// 0 Figure Friends Legs with Cargo Pants (Thin Hinge)
// 0 Name: 1023035.dat
...
module ldraw_lib__1023035(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__1023035(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__1023035(line=0.2);