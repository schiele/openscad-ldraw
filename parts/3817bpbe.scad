...
use <3816bpbe.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3817bpbe(realsolid=false) = [
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 3816bpbe.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__3816bpbe(realsolid)],
];
module ldraw_lib__3817bpbe(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3817bpbe(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
