...
// 1 16 0 44 10 1 0 0 0 -1 0 0 0 1 stud3.dat
  [1,16,0,44,10,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud3()],
// 1 16 0 44 -10 1 0 0 0 -1 0 0 0 1 stud3.dat
  [1,16,0,44,-10,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud3()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 48 10 56 0 0 0 -4 0 0 0 6 box5.dat
  [1,16,0,48,10,56,0,0,0,-4,0,0,0,6, ldraw_lib__box5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 48 -10 56 0 0 0 -4 0 0 0 6 box5.dat
  [1,16,0,48,-10,56,0,0,0,-4,0,0,0,6, ldraw_lib__box5()],
...
// 1 16 0 48 0 60 0 0 0 -48 0 0 0 20 box5.dat
  [1,16,0,48,0,60,0,0,0,-48,0,0,0,20, ldraw_lib__box5()],
...
module ldraw_lib__73090a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73090a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
