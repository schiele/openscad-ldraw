...
use <../p/rect.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2606(realsolid=false) = [
...
// 1 16 0 0 -8 -6 0 0 0 0 6 0 1 0 4-4ndis.dat
  [1,16,0,0,-8,-6,0,0,0,0,6,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 0 8 6 0 0 0 0 6 0 -1 0 4-4ndis.dat
  [1,16,0,0,8,6,0,0,0,0,6,0,-1,0, ldraw_lib__4_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 16 -6.5 0 0 -1 0 15.5 0 0 0 0 6 rect.dat
  [1,16,16,-6.5,0,0,-1,0,15.5,0,0,0,0,6, ldraw_lib__rect(realsolid)],
// 1 16 -16 -6.5 0 0 1 0 15.5 0 0 0 0 6 rect.dat
  [1,16,-16,-6.5,0,0,1,0,15.5,0,0,0,0,6, ldraw_lib__rect(realsolid)],
// 1 16 0 9 0 16 0 0 0 -1 0 0 0 -6 rect.dat
  [1,16,0,9,0,16,0,0,0,-1,0,0,0,-6, ldraw_lib__rect(realsolid)],
// 1 16 12 -22 0 4 0 0 0 1 0 0 0 6 rect.dat
  [1,16,12,-22,0,4,0,0,0,1,0,0,0,6, ldraw_lib__rect(realsolid)],
// 1 16 -12 -22 0 4 0 0 0 1 0 0 0 6 rect.dat
  [1,16,-12,-22,0,4,0,0,0,1,0,0,0,6, ldraw_lib__rect(realsolid)],
// 1 16 10.5 -6.5 2 0 0 -2.5 12.5 0 0 0 -1 0 rect.dat
  [1,16,10.5,-6.5,2,0,0,-2.5,12.5,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 13 -6.5 4 0 1 0 12.5 0 0 0 0 -2 rect.dat
  [1,16,13,-6.5,4,0,1,0,12.5,0,0,0,0,-2, ldraw_lib__rect(realsolid)],
// 1 16 10.5 6 4 2.5 0 0 0 1 0 0 0 2 rect.dat
  [1,16,10.5,6,4,2.5,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 10.5 -19 4 2.5 0 0 0 -1 0 0 0 -2 rect.dat
  [1,16,10.5,-19,4,2.5,0,0,0,-1,0,0,0,-2, ldraw_lib__rect(realsolid)],
...
// 1 16 0 -8 0 8 0 0 0 1 0 0 0 6 rect.dat
  [1,16,0,-8,0,8,0,0,0,1,0,0,0,6, ldraw_lib__rect(realsolid)],
// 1 16 0 -7.5 6 8 0 0 0 0 .5 0 -1 0 rect.dat
  [1,16,0,-7.5,6,8,0,0,0,0,.5,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 -7.5 -6 8 0 0 0 0 -.5 0 1 0 rect.dat
  [1,16,0,-7.5,-6,8,0,0,0,0,-.5,0,1,0, ldraw_lib__rect(realsolid)],
// 2 24 8 -19 6 8 -22 6
  [2,24,8,-19,6,8,-22,6],
...
// 1 16 0 -8 0 4 0 0 0 -11 0 0 0 -4 4-4cyli.dat
  [1,16,0,-8,0,4,0,0,0,-11,0,0,0,-4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -19 0 2 0 0 0 -3 0 0 0 2 4-4con1.dat
  [1,16,0,-19,0,2,0,0,0,-3,0,0,0,2, ldraw_lib__4_4con1(realsolid)],
// 1 16 0 -22 0 2 0 0 0 1 0 0 0 -2 4-4disc.dat
  [1,16,0,-22,0,2,0,0,0,1,0,0,0,-2, ldraw_lib__4_4disc(realsolid)],
...
// 1 16 0 -19 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,0,-19,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -22 0 2 0 0 0 1 0 0 0 2 4-4edge.dat
  [1,16,0,-22,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4edge(realsolid)],
// 0
// 0 end of file
];
module ldraw_lib__2606(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2606(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2606(line=0.2);