...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3960pb002, Radar Dish, Rebrickable 3960pr9987, Round
// 0 !KEYWORDS Set 1484, Space
// 
// 0 !CMDLINE -c15
// 
...
// 1 1 0 0 0 1 0 0 0 1 0 0 0 1 s\3960p04s03.dat
  [1,1,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3960p04s03()],
// 1 1 0 0 0 -1 0 0 0 1 0 0 0 -1 s\3960p04s03.dat
  [1,1,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3960p04s03()],
// 1 1 0 0 0 -1 0 0 0 1 0 0 0 1 s\3960p04s01.dat
  [1,1,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3960p04s01()],
// 1 1 0 0 0 1 0 0 0 1 0 0 0 -1 s\3960p04s01.dat
  [1,1,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3960p04s01()],
// 1 1 0 0 0 0 0 1 0 1 0 -1 0 0 s\3960p04s01.dat
  [1,1,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__3960p04s01()],
// 1 1 0 0 0 0 0 -1 0 1 0 1 0 0 s\3960p04s01.dat
  [1,1,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3960p04s01()],
// 
...
module ldraw_lib__3960p04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3960p04(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
