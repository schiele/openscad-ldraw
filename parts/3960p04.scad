...
use <s/3960s05.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3960p04(realsolid=false) = [
// 0 Dish  4 x  4 Inverted with Red and Blue Stripes Pattern
// 0 Name: 3960p04.dat
...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 -1 s\3960s02.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3960s02(realsolid)],
// 1 4 0 0 0 -1 0 0 0 1 0 0 0 1 s\3960s02.dat
  [1,4,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3960s02(realsolid)],
// 1 4 0 0 0 0 0 -1 0 1 0 1 0 0 s\3960s02.dat
  [1,4,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3960s02(realsolid)],
// 1 4 0 0 0 0 0 1 0 1 0 -1 0 0 s\3960s02.dat
  [1,4,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__3960s02(realsolid)],
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 s\3960s04.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3960s04(realsolid)],
// 1 4 0 0 0 -1 0 0 0 1 0 0 0 -1 s\3960s04.dat
  [1,4,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3960s04(realsolid)],
// 
// 1 1 0 0 0 1 0 0 0 1 0 0 0 1 s\3960p04s03.dat
  [1,1,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3960p04s03(realsolid)],
// 1 1 0 0 0 -1 0 0 0 1 0 0 0 -1 s\3960p04s03.dat
  [1,1,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3960p04s03(realsolid)],
// 1 1 0 0 0 -1 0 0 0 1 0 0 0 1 s\3960p04s01.dat
  [1,1,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3960p04s01(realsolid)],
// 1 1 0 0 0 1 0 0 0 1 0 0 0 -1 s\3960p04s01.dat
  [1,1,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3960p04s01(realsolid)],
// 1 1 0 0 0 0 0 1 0 1 0 -1 0 0 s\3960p04s01.dat
  [1,1,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__3960p04s01(realsolid)],
// 1 1 0 0 0 0 0 -1 0 1 0 1 0 0 s\3960p04s01.dat
  [1,1,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__3960p04s01(realsolid)],
// 
...
module ldraw_lib__3960p04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3960p04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3960p04(line=0.2);