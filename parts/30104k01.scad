...
// 1 16 4 1.5 7.5029 0 0 -1.5 1.5 0 0 0 6.9971 0 4-4cyli.dat
  [1,16,4,1.5,7.5029,0,0,-1.5,1.5,0,0,0,6.9971,0, ldraw_lib__4_4cyli()],
...
// 1 16 0 1.5 14.5 4 0 0 0 4 0 0 0 4 t04q3750.dat
  [1,16,0,1.5,14.5,4,0,0,0,4,0,0,0,4, ldraw_lib__t04q3750()],
// 1 16 0 1.5 14.5 -4 0 0 0 -4 0 0 0 4 t04q3750.dat
  [1,16,0,1.5,14.5,-4,0,0,0,-4,0,0,0,4, ldraw_lib__t04q3750()],
// 
// 1 16 -4 1.5 7.5029 0 0 1.5 1.5 0 0 0 6.9971 0 4-4cyli.dat
...
module ldraw_lib__30104k01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30104k01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
