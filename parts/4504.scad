...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4504(realsolid=false) = [
...
// 1 16 0 4 -10 60 0 0 0 0 -4 0 1 0 rect2p.dat
  [1,16,0,4,-10,60,0,0,0,0,-4,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 4 10 -60 0 0 0 0 -4 0 -1 0 rect2p.dat
  [1,16,0,4,10,-60,0,0,0,0,-4,0,-1,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 60 4 0 0 1 0 1 0 0 0 0 1 h1.dat
  [1,16,60,4,0,0,1,0,1,0,0,0,0,1, ldraw_lib__h1(realsolid)],
// 1 16 -60 4 0 0 -1 0 1 0 0 0 0 1 h2.dat
  [1,16,-60,4,0,0,-1,0,1,0,0,0,0,1, ldraw_lib__h2(realsolid)],
...
module ldraw_lib__4504(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4504(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
