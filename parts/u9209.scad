...
use <s/16820s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9209(realsolid=false) = [
// 0 Minifig Skirt  1.4L with Straight Bottom
// 0 Name: u9209.dat
...
// 1 16 0 -0.125 -10 55.1 0 0 0 0 0.125 0 -28 0 box5-4a.dat
  [1,16,0,-0.125,-10,55.1,0,0,0,0,0.125,0,-28,0, ldraw_lib__box5_4a(realsolid)],
];
module ldraw_lib__u9209(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9209(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
