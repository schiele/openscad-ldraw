...
use <../p/stug-8x1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30295(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30295s4.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30295s4(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\30295s4.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30295s4(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\30295s4.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__30295s4(realsolid)],
...
// 1 16 0 28 60 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,28,60,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 0 28 -60 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,28,-60,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 0 28 100 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,28,100,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 0 28 -100 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,28,-100,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 0 28 140 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,28,140,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 0 28 -140 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,28,-140,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 0 4 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,4,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 4 0 1 0 0 0 -7 0 0 0 1 stud4f4s.dat
  [1,16,0,4,0,1,0,0,0,-7,0,0,0,1, ldraw_lib__stud4f4s(realsolid)],
// 1 16 66.25 4 0 -2.25 0 0 0 28 0 0 0 -1.5 box3u6.dat
  [1,16,66.25,4,0,-2.25,0,0,0,28,0,0,0,-1.5, ldraw_lib__box3u6(realsolid)],
// 1 16 73.75 4 0 2.25 0 0 0 28 0 0 0 1.5 box3u6.dat
  [1,16,73.75,4,0,2.25,0,0,0,28,0,0,0,1.5, ldraw_lib__box3u6(realsolid)],
// 1 16 70 18 -1.5 1.5 0 0 0 0 14 0 -3 0 box4-2p.dat
  [1,16,70,18,-1.5,1.5,0,0,0,0,14,0,-3,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 70 18 1.5 -1.5 0 0 0 0 14 0 3 0 box4-2p.dat
  [1,16,70,18,1.5,-1.5,0,0,0,0,14,0,3,0, ldraw_lib__box4_2p(realsolid)],
...
// 1 16 20 4 0 -12 0 0 0 28 0 0 0 1.5 box3u8p.dat
  [1,16,20,4,0,-12,0,0,0,28,0,0,0,1.5, ldraw_lib__box3u8p(realsolid)],
// 1 16 -20 4 0 -12 0 0 0 28 0 0 0 1.5 box3u8p.dat
  [1,16,-20,4,0,-12,0,0,0,28,0,0,0,1.5, ldraw_lib__box3u8p(realsolid)],
// 1 16 0 4 -12 0 0 -1.5 0 28 0 -4 0 0 box3u6.dat
  [1,16,0,4,-12,0,0,-1.5,0,28,0,-4,0,0, ldraw_lib__box3u6(realsolid)],
// 1 16 0 4 12 0 0 1.5 0 28 0 4 0 0 box3u6.dat
  [1,16,0,4,12,0,0,1.5,0,28,0,4,0,0, ldraw_lib__box3u6(realsolid)],
...
// 1 16 -40 4 0 1 0 0 0 -7 0 0 0 1 stud4f4s.dat
  [1,16,-40,4,0,1,0,0,0,-7,0,0,0,1, ldraw_lib__stud4f4s(realsolid)],
// 1 16 -40 4 -12 0 0 -1.5 0 28 0 -4 0 0 box3u6.dat
  [1,16,-40,4,-12,0,0,-1.5,0,28,0,-4,0,0, ldraw_lib__box3u6(realsolid)],
// 1 16 -54 4 0 -6 0 0 0 28 0 0 0 1.5 box3u6.dat
  [1,16,-54,4,0,-6,0,0,0,28,0,0,0,1.5, ldraw_lib__box3u6(realsolid)],
// 1 16 54 4 0 6 0 0 0 28 0 0 0 -1.5 box3u6.dat
  [1,16,54,4,0,6,0,0,0,28,0,0,0,-1.5, ldraw_lib__box3u6(realsolid)],
// 1 16 -40 4 12 0 0 1.5 0 28 0 4 0 0 box3u6.dat
  [1,16,-40,4,12,0,0,1.5,0,28,0,4,0,0, ldraw_lib__box3u6(realsolid)],
...
// 1 16 0 24 80 0 0 1 0 1 0 -1 0 0 stug-6x6.dat
  [1,16,0,24,80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_6x6(realsolid)],
// 1 16 0 24 -80 0 0 1 0 1 0 -1 0 0 stug-6x6.dat
  [1,16,0,24,-80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_6x6(realsolid)],
// 1 16 0 0 -10 0 0 1 0 1 0 -1 0 0 stug-8x1.dat
  [1,16,0,0,-10,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_8x1(realsolid)],
// 1 16 0 0 10 0 0 1 0 1 0 -1 0 0 stug-8x1.dat
  [1,16,0,0,10,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_8x1(realsolid)],
...
// 1 16 60 24 150 0 0 1 0 1 0 -1 0 0 stug-6x1.dat
  [1,16,60,24,150,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_6x1(realsolid)],
// 1 16 -60 24 150 0 0 1 0 1 0 -1 0 0 stug-6x1.dat
  [1,16,-60,24,150,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_6x1(realsolid)],
// 1 16 0 24 170 0 0 1 0 1 0 -1 0 0 stug-6x1.dat
  [1,16,0,24,170,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_6x1(realsolid)],
// 1 16 -60 24 -150 0 0 1 0 1 0 -1 0 0 stug-6x1.dat
  [1,16,-60,24,-150,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_6x1(realsolid)],
// 1 16 60 24 -150 0 0 1 0 1 0 -1 0 0 stug-6x1.dat
  [1,16,60,24,-150,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_6x1(realsolid)],
...
// 1 16 -100 0 130 0 0 1 0 1 0 -1 0 0 stug-2x1.dat
  [1,16,-100,0,130,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_2x1(realsolid)],
// 1 16 -70 0 80 0 0 1 0 1 0 -1 0 0 stug-1x6.dat
  [1,16,-70,0,80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x6(realsolid)],
// 1 16 100 0 130 0 0 1 0 1 0 -1 0 0 stug-2x1.dat
  [1,16,100,0,130,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_2x1(realsolid)],
// 1 16 70 0 80 0 0 1 0 1 0 -1 0 0 stug-1x6.dat
  [1,16,70,0,80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_1x6(realsolid)],
...
module ldraw_lib__30295(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30295(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
