...
// 1 16 0 4 0 1 0 0 0 -4 0 0 0 1 stug8-1x3.dat
  [1,16,0,4,0,1,0,0,0,-4,0,0,0,1, ldraw_lib__stug8_1x3()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__6413(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6413(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
