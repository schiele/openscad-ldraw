...
use <3069bp12.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3069p12(realsolid=false) = [
// 0 ~Moved to 3069bp12
// 0 Name: 3069p12.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3069bp12.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3069bp12(realsolid)],
];
module ldraw_lib__3069p12(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3069p12(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
