...
use <54101.scad>
$fa=1; $fs=0.2;
function ldraw_lib__54779c02(realsolid=false) = [
...
// 1 72 0 0 0 1 0 0 0 1 0 0 0 1 54101.dat
  [1,72,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__54101(realsolid)],
];
module ldraw_lib__54779c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__54779c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
