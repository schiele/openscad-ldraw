...
use <../p/stud4.scad>
function ldraw_lib__90462bpq2() = [
// 0 Minifig Headdress Nemes with Medium Blue Stripes on Metallic Gold Pattern
// 0 Name: 90462bpq2.dat
...
// 1 73 0 -2 0 1 0 0 0 1 0 0 0 1 s\90462bpq1s03.dat
  [1,73,0,-2,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__90462bpq1s03()],
// 1 73 0 -2 0 -1 0 0 0 1 0 0 0 1 s\90462bpq1s03.dat
  [1,73,0,-2,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__90462bpq1s03()],
];
module ldraw_lib__90462bpq2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__90462bpq2(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__90462bpq2(line=0.2);