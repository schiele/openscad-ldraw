...
$fa=1; $fs=0.2;
function ldraw_lib__64991c02(realsolid=false) = [
// 0 Sheet Fabric 28 x 17 Trapezoidal Sail (Formed Shape 2)
// 0 Name: 64991c02.dat
...
// 1 16 0 0 0 1 0 0 0 1.03671 -0.06163 0 0.0769 0.84772 s\64991c01s01.dat
  [1,16,0,0,0,1,0,0,0,1.03671,-0.06163,0,0.0769,0.84772, ldraw_lib__s__64991c01s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1.03671 -0.06163 0 0.0769 0.84772 s\64991c01s01.dat
  [1,16,0,0,0,-1,0,0,0,1.03671,-0.06163,0,0.0769,0.84772, ldraw_lib__s__64991c01s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1.03671 -0.06163 0 0.0769 0.84772 s\64991c01s02.dat
  [1,16,0,0,0,1,0,0,0,1.03671,-0.06163,0,0.0769,0.84772, ldraw_lib__s__64991c01s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1.03671 -0.06163 0 0.0769 0.84772 s\64991c01s02.dat
  [1,16,0,0,0,-1,0,0,0,1.03671,-0.06163,0,0.0769,0.84772, ldraw_lib__s__64991c01s02(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -0.015 0.212 1 0 0 0 1.03671 -0.06163 0 0.0769 0.84772 s\64991c01s01.dat
  [1,16,0,-0.015,0.212,1,0,0,0,1.03671,-0.06163,0,0.0769,0.84772, ldraw_lib__s__64991c01s01(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -0.015 0.212 -1 0 0 0 1.03671 -0.06163 0 0.0769 0.84772 s\64991c01s01.dat
  [1,16,0,-0.015,0.212,-1,0,0,0,1.03671,-0.06163,0,0.0769,0.84772, ldraw_lib__s__64991c01s01(realsolid)],
...
module ldraw_lib__64991c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__64991c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
