...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Brickheadz, BrickLink 3010pb211, Rebrickable 3010pr9991, Set 41491
// 
...
// 1 16 0 0 -10 1 0 0 0 1 0 0 0 1 s\3010pzbs01.dat
  [1,16,0,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010pzbs01()],
// 1 16 0 0 -10 -1 0 0 0 1 0 0 0 1 s\3010pzbs01.dat
  [1,16,0,0,-10,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010pzbs01()],
];
module ldraw_lib__3010pzb(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3010pzb(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
