...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3037px10, Rebrickable 3037pr0009, set 6330
// 
...
// 1 16 0 9.899495 -19.89949 1.2 0 0 0 0.7071068 -0.8485281 0 0.7071068 0.8485281 logo-octantext.dat
  [1,16,0,9.899495,-19.89949,1.2,0,0,0,0.7071068,-0.8485281,0,0.7071068,0.8485281, ldraw_lib__logo_octantext()],
...
module ldraw_lib__3037pt1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3037pt1(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
