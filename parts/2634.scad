...
use <2634c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2634(realsolid=false) = [
// 0 ~Moved to 2634c01
// 0 Name: 2634.dat
// 0 Author: [PTadmin]
...
// 1 16 0 -40 0 1 0 0 0 1 0 0 0 1 2634c01.dat
  [1,16,0,-40,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2634c01(realsolid)],
];
module ldraw_lib__2634(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2634(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
