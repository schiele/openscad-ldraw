...
use <s/87567s04.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87567p01(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 87567pb01, General Grievous, set 8095, set 9015, Star Wars
// 
...
// 1 19 0 0 0 1 0 0 0 1 0 0 0 1 s\87567p01s02.dat
  [1,19,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87567p01s02(realsolid)],
// 1 19 0 0 0 -1 0 0 0 1 0 0 0 1 s\87567p01s02.dat
  [1,19,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87567p01s02(realsolid)],
// 1 19 0 0 0 1 0 0 0 1 0 0 0 1 s\87567s02.dat
  [1,19,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87567s02(realsolid)],
// 1 19 0 0 0 -1 0 0 0 1 0 0 0 1 s\87567s02.dat
  [1,19,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87567s02(realsolid)],
// 1 80 0 0 0 1 0 0 0 1 0 0 0 1 s\87567s04.dat
  [1,80,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87567s04(realsolid)],
// 1 80 0 0 0 -1 0 0 0 1 0 0 0 1 s\87567s04.dat
  [1,80,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87567s04(realsolid)],
];
module ldraw_lib__87567p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87567p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
