...
$fa=1; $fs=0.2;
function ldraw_lib__u9147p01c06(realsolid=false) = [
// 0 _Figure Fabuland Pig  1 with Body White/White/Red
// 0 Name: u9147p01c06.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS hog, Kor, Peter Pig, Set 3703, swine
// 
...
module ldraw_lib__u9147p01c06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9147p01c06(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9147p01c06(line=0.2);