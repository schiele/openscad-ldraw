...
use <6124787d.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3675dx1(realsolid=false) = [
...
// 1 272 17.25 10.059 -30.119 1 0 0 0 0.894 -0.447 0 0.447 0.894 6124787d.dat
  [1,272,17.25,10.059,-30.119,1,0,0,0,0.894,-0.447,0,0.447,0.894, ldraw_lib__6124787d(realsolid)],
];
module ldraw_lib__3675dx1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3675dx1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
