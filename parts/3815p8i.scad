...
use <s/3815s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3815p8i(realsolid=false) = [
...
// 1 0 0 3 -10 0 0 0.4 0.4 0 0 0 1 0 1-4ring2.dat
  [1,0,0,3,-10,0,0,0.4,0.4,0,0,0,1,0, ldraw_lib__1_4ring2(realsolid)],
// 1 0 0 3 -10 0 0 0.4 0.4 0 0 0 1 0 1-4ring3.dat
  [1,0,0,3,-10,0,0,0.4,0.4,0,0,0,1,0, ldraw_lib__1_4ring3(realsolid)],
// 1 0 0 3 -10 0 0 -0.4 -0.4 0 0 0 1 0 1-4ring2.dat
  [1,0,0,3,-10,0,0,-0.4,-0.4,0,0,0,1,0, ldraw_lib__1_4ring2(realsolid)],
// 1 0 0 3 -10 0 0 -0.4 -0.4 0 0 0 1 0 1-4ring3.dat
  [1,0,0,3,-10,0,0,-0.4,-0.4,0,0,0,1,0, ldraw_lib__1_4ring3(realsolid)],
// 1 0 1.2 3 -10 0.4 0 0 0 0 -0.4 0 1 0 2-4disc.dat
  [1,0,1.2,3,-10,0.4,0,0,0,0,-0.4,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 0 -1.2 3 -10 -0.4 0 0 0 0 0.4 0 1 0 2-4disc.dat
  [1,0,-1.2,3,-10,-0.4,0,0,0,0,0.4,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 0 0 4.2 -10 0 0 -0.4 0.4 0 0 0 1 0 2-4disc.dat
  [1,0,0,4.2,-10,0,0,-0.4,0.4,0,0,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 0 0 1.8 -10 0 0 0.4 -0.4 0 0 0 1 0 2-4disc.dat
  [1,0,0,1.8,-10,0,0,0.4,-0.4,0,0,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 80 0 3 -10 0 0 0.8 0.8 0 0 0 1 0 1-4disc.dat
  [1,80,0,3,-10,0,0,0.8,0.8,0,0,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 80 0 3 -10 0 0 -0.8 -0.8 0 0 0 1 0 1-4disc.dat
  [1,80,0,3,-10,0,0,-0.8,-0.8,0,0,0,1,0, ldraw_lib__1_4disc(realsolid)],
// 1 80 0 3 -10 0 0 1.6 1.6 0 0 0 1 0 1-4ndis.dat
  [1,80,0,3,-10,0,0,1.6,1.6,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 80 0 3 -10 0 0 -1.6 -1.6 0 0 0 1 0 1-4ndis.dat
  [1,80,0,3,-10,0,0,-1.6,-1.6,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 80 1.2 3 -10 0.4 0 0 0 0 -0.4 0 1 0 2-4ndis.dat
  [1,80,1.2,3,-10,0.4,0,0,0,0,-0.4,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 80 -1.2 3 -10 -0.4 0 0 0 0 0.4 0 1 0 2-4ndis.dat
  [1,80,-1.2,3,-10,-0.4,0,0,0,0,0.4,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 80 0 4.2 -10 0 0 -0.4 0.4 0 0 0 1 0 2-4ndis.dat
  [1,80,0,4.2,-10,0,0,-0.4,0.4,0,0,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 80 0 1.8 -10 0 0 0.4 -0.4 0 0 0 1 0 2-4ndis.dat
  [1,80,0,1.8,-10,0,0,0.4,-0.4,0,0,0,1,0, ldraw_lib__2_4ndis(realsolid)],
...
module ldraw_lib__3815p8i(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3815p8i(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
