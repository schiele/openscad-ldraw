...
// 1 16 0 114 0 10 0 0 0 6 0 0 0 10 4-4cylc.dat
  [1,16,0,114,0,10,0,0,0,6,0,0,0,10, ldraw_lib__4_4cylc()],
// 
// 1 16 0 112 0 2 0 0 0 2 0 0 0 10 box5-4a.dat
  [1,16,0,112,0,2,0,0,0,2,0,0,0,10, ldraw_lib__box5_4a()],
// 1 16 0 109 -6 -2 0 0 0 0 -3 0 -4 0 box4-7a.dat
  [1,16,0,109,-6,-2,0,0,0,0,-3,0,-4,0, ldraw_lib__box4_7a()],
// 
// 1 16 0 112 39 -2 0 0 0 -1 0 0 0 29 rect.dat
  [1,16,0,112,39,-2,0,0,0,-1,0,0,0,29, ldraw_lib__rect()],
...
// 1 16 0 57 -6 -2 0 0 0 0 49 0 1 0 rect.dat
  [1,16,0,57,-6,-2,0,0,0,0,49,0,1,0, ldraw_lib__rect()],
// 1 16 0 2 39 -2 0 0 0 1 0 0 0 -29 rect.dat
  [1,16,0,2,39,-2,0,0,0,1,0,0,0,-29, ldraw_lib__rect()],
...
// 1 16 0 2 0 -2 0 0 0 -2 0 0 0 10 box5-4a.dat
  [1,16,0,2,0,-2,0,0,0,-2,0,0,0,10, ldraw_lib__box5_4a()],
// 1 16 0 5 -6 2 0 0 0 0 3 0 -4 0 box4-7a.dat
  [1,16,0,5,-6,2,0,0,0,0,3,0,-4,0, ldraw_lib__box4_7a()],
// 
...
module ldraw_lib__4344(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4344(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
