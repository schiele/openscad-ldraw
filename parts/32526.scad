...
// 1 16 40 -10 80 0 0 9 0 1 0 9 0 0 2-4edge.dat
  [1,16,40,-10,80,0,0,9,0,1,0,9,0,0, ldraw_lib__2_4edge()],
// 1 16 40 10 80 0 0 9 0 1 0 9 0 0 2-4edge.dat
  [1,16,40,10,80,0,0,9,0,1,0,9,0,0, ldraw_lib__2_4edge()],
// 1 16 40 -10 80 0 0 9 0 20 0 9 0 0 2-4cyli.dat
  [1,16,40,-10,80,0,0,9,0,20,0,9,0,0, ldraw_lib__2_4cyli()],
...
// 1 16 20 0 89 20 0 0 0 0 -10 0 -1 0 rect2p.dat
  [1,16,20,0,89,20,0,0,0,0,-10,0,-1,0, ldraw_lib__rect2p()],
...
// 1 16 0 -10 80 -9 0 0 0 20 0 0 0 9 1-4cyli.dat
  [1,16,0,-10,80,-9,0,0,0,20,0,0,0,9, ldraw_lib__1_4cyli()],
...
// 1 16 20 -10 80 1 0 0 0 1 0 0 0 1 peghole.dat
  [1,16,20,-10,80,1,0,0,0,1,0,0,0,1, ldraw_lib__peghole()],
// 1 16 20 10 80 1 0 0 0 -1 0 0 0 1 peghole.dat
  [1,16,20,10,80,1,0,0,0,-1,0,0,0,1, ldraw_lib__peghole()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 -8 80 6 0 0 0 16 0 0 0 6 4-4cyli.dat
  [1,16,20,-8,80,6,0,0,0,16,0,0,0,6, ldraw_lib__4_4cyli()],
...
// 1 16 20 -10 80 1 0 0 0 1 0 0 0 -1 4-4ring8.dat
  [1,16,20,-10,80,1,0,0,0,1,0,0,0,-1, ldraw_lib__4_4ring8()],
// 1 16 0 10 60 1 0 0 0 -1 0 0 0 1 4-4ring8.dat
  [1,16,0,10,60,1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4ring8()],
// 1 16 0 10 80 1 0 0 0 -1 0 0 0 1 4-4ring8.dat
  [1,16,0,10,80,1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4ring8()],
...
makepoly(ldraw_lib__32526(), line=0.2);