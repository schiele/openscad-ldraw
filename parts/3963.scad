...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3963(realsolid=false) = [
...
// 1 16 0 4 12 1.5 0 0 0 4 0 0 0 2 box5.dat
  [1,16,0,4,12,1.5,0,0,0,4,0,0,0,2, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 4 18 6 0 0 0 -1 0 0 0 8 rect.dat
  [1,16,0,4,18,6,0,0,0,-1,0,0,0,8, ldraw_lib__rect(realsolid)],
...
// 1 16 10 10 0 0 1 0 4 0 0 0 0 4 4-4edge.dat
  [1,16,10,10,0,0,1,0,4,0,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 -10 10 0 0 1 0 4 0 0 0 0 4 4-4edge.dat
  [1,16,-10,10,0,0,1,0,4,0,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 18 10 0 0 1 0 4 0 0 0 0 4 4-4edge.dat
  [1,16,18,10,0,0,1,0,4,0,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 -18 10 0 0 1 0 4 0 0 0 0 4 4-4edge.dat
  [1,16,-18,10,0,0,1,0,4,0,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 30 10 0 0 1 0 6 0 0 0 0 6 4-4edge.dat
  [1,16,30,10,0,0,1,0,6,0,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 -30 10 0 0 1 0 6 0 0 0 0 6 4-4edge.dat
  [1,16,-30,10,0,0,1,0,6,0,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 10 -30 10 0 0 0 0 10 0 1 0 4-4edge.dat
  [1,16,0,10,-30,10,0,0,0,0,10,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 30 10 0 0 1 0 10 0 0 0 0 10 4-4edge.dat
  [1,16,30,10,0,0,1,0,10,0,0,0,0,10, ldraw_lib__4_4edge(realsolid)],
// 1 16 -30 10 0 0 1 0 10 0 0 0 0 10 4-4edge.dat
  [1,16,-30,10,0,0,1,0,10,0,0,0,0,10, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 10 -10 4 0 0 0 0 4 0 -8 0 4-4cyli.dat
  [1,16,0,10,-10,4,0,0,0,0,4,0,-8,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 10 0 0 8 0 4 0 0 0 0 4 4-4cyli.dat
  [1,16,10,10,0,0,8,0,4,0,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -10 10 0 0 -8 0 4 0 0 0 0 4 4-4cyli.dat
  [1,16,-10,10,0,0,-8,0,4,0,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 10 -30 6 0 0 0 0 6 0 4 0 4-4cyli.dat
  [1,16,0,10,-30,6,0,0,0,0,6,0,4,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 30 10 0 0 -4 0 6 0 0 0 0 6 4-4cyli.dat
  [1,16,30,10,0,0,-4,0,6,0,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -30 10 0 0 4 0 6 0 0 0 0 6 4-4cyli.dat
  [1,16,-30,10,0,0,4,0,6,0,0,0,0,6, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 10 -18 1 0 0 0 0 1 0 -8 0 axlehole.dat
  [1,16,0,10,-18,1,0,0,0,0,1,0,-8,0, ldraw_lib__axlehole(realsolid)],
// 1 16 18 10 0 0 8 0 0 0 1 1 0 0 axlehole.dat
  [1,16,18,10,0,0,8,0,0,0,1,1,0,0, ldraw_lib__axlehole(realsolid)],
// 1 16 -18 10 0 0 -8 0 0 0 1 1 0 0 axlehole.dat
  [1,16,-18,10,0,0,-8,0,0,0,1,1,0,0, ldraw_lib__axlehole(realsolid)],
// 1 16 0 10 -18 1 0 0 0 0 1 0 1 0 axlehol2.dat
  [1,16,0,10,-18,1,0,0,0,0,1,0,1,0, ldraw_lib__axlehol2(realsolid)],
// 1 16 18 10 0 0 1 0 1 0 0 0 0 1 axlehol2.dat
  [1,16,18,10,0,0,1,0,1,0,0,0,0,1, ldraw_lib__axlehol2(realsolid)],
// 1 16 -18 10 0 0 1 0 1 0 0 0 0 1 axlehol2.dat
  [1,16,-18,10,0,0,1,0,1,0,0,0,0,1, ldraw_lib__axlehol2(realsolid)],
// 1 16 0 10 -26 1 0 0 0 0 1 0 1 0 axlehol3.dat
  [1,16,0,10,-26,1,0,0,0,0,1,0,1,0, ldraw_lib__axlehol3(realsolid)],
// 1 16 26 10 0 0 1 0 1 0 0 0 0 1 axlehol3.dat
  [1,16,26,10,0,0,1,0,1,0,0,0,0,1, ldraw_lib__axlehol3(realsolid)],
// 1 16 -26 10 0 0 1 0 1 0 0 0 0 1 axlehol3.dat
  [1,16,-26,10,0,0,1,0,1,0,0,0,0,1, ldraw_lib__axlehol3(realsolid)],
// 1 16 18 10 0 0 -1 0 2 0 0 0 0 2 1-4ring2.dat
  [1,16,18,10,0,0,-1,0,2,0,0,0,0,2, ldraw_lib__1_4ring2(realsolid)],
// 1 16 18 10 0 0 -1 0 2 0 0 0 0 -2 1-4ring2.dat
  [1,16,18,10,0,0,-1,0,2,0,0,0,0,-2, ldraw_lib__1_4ring2(realsolid)],
// 1 16 18 10 0 0 -1 0 -2 0 0 0 0 -2 1-4ring2.dat
  [1,16,18,10,0,0,-1,0,-2,0,0,0,0,-2, ldraw_lib__1_4ring2(realsolid)],
...
// 1 16 0 10 -18 0 0 2 2 0 0 0 1 0 1-4ring2.dat
  [1,16,0,10,-18,0,0,2,2,0,0,0,1,0, ldraw_lib__1_4ring2(realsolid)],
// 1 16 0 10 -18 0 0 -2 2 0 0 0 1 0 1-4ring2.dat
  [1,16,0,10,-18,0,0,-2,2,0,0,0,1,0, ldraw_lib__1_4ring2(realsolid)],
// 1 16 0 10 -18 0 0 2 -2 0 0 0 1 0 1-4ring2.dat
  [1,16,0,10,-18,0,0,2,-2,0,0,0,1,0, ldraw_lib__1_4ring2(realsolid)],
...
// 1 16 0 10 -20 2 0 0 0 0 2 0 10 0 4-4con3.dat
  [1,16,0,10,-20,2,0,0,0,0,2,0,10,0, ldraw_lib__4_4con3(realsolid)],
// 1 16 0 10 -30 2 0 0 0 0 2 0 10 0 4-4con4.dat
  [1,16,0,10,-30,2,0,0,0,0,2,0,10,0, ldraw_lib__4_4con4(realsolid)],
// 1 16 0 10 -30 2 0 0 0 0 2 0 1 0 1-4ring3.dat
  [1,16,0,10,-30,2,0,0,0,0,2,0,1,0, ldraw_lib__1_4ring3(realsolid)],
// 1 16 0 10 -30 2 0 0 0 0 2 0 1 0 1-4ring4.dat
  [1,16,0,10,-30,2,0,0,0,0,2,0,1,0, ldraw_lib__1_4ring4(realsolid)],
// 1 16 0 10 -30 2 0 0 0 0 -2 0 1 0 1-4ring3.dat
  [1,16,0,10,-30,2,0,0,0,0,-2,0,1,0, ldraw_lib__1_4ring3(realsolid)],
// 1 16 0 10 -30 2 0 0 0 0 -2 0 1 0 1-4ring4.dat
  [1,16,0,10,-30,2,0,0,0,0,-2,0,1,0, ldraw_lib__1_4ring4(realsolid)],
...
// 1 16 20 10 0 0 -10 0 0 0 2 2 0 0 4-4con3.dat
  [1,16,20,10,0,0,-10,0,0,0,2,2,0,0, ldraw_lib__4_4con3(realsolid)],
// 1 16 30 10 0 0 -10 0 0 0 2 2 0 0 4-4con4.dat
  [1,16,30,10,0,0,-10,0,0,0,2,2,0,0, ldraw_lib__4_4con4(realsolid)],
// 1 16 30 10 0 0 -1 0 0 0 2 2 0 0 1-4ring3.dat
  [1,16,30,10,0,0,-1,0,0,0,2,2,0,0, ldraw_lib__1_4ring3(realsolid)],
// 1 16 30 10 0 0 -1 0 0 0 2 2 0 0 1-4ring4.dat
  [1,16,30,10,0,0,-1,0,0,0,2,2,0,0, ldraw_lib__1_4ring4(realsolid)],
// 1 16 30 10 0 0 -1 0 0 0 -2 2 0 0 1-4ring3.dat
  [1,16,30,10,0,0,-1,0,0,0,-2,2,0,0, ldraw_lib__1_4ring3(realsolid)],
// 1 16 30 10 0 0 -1 0 0 0 -2 2 0 0 1-4ring4.dat
  [1,16,30,10,0,0,-1,0,0,0,-2,2,0,0, ldraw_lib__1_4ring4(realsolid)],
...
module ldraw_lib__3963(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3963(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
