...
use <99249.scad>
$fa=1; $fs=0.2;
function ldraw_lib__99249c01(realsolid=false) = [
...
// 1 16 0 -31.261 11.425 -1 0 0 0 0.8339 -0.5519 0 -0.5519 -0.8339 3742.dat
  [1,16,0,-31.261,11.425,-1,0,0,0,0.8339,-0.5519,0,-0.5519,-0.8339, ldraw_lib__3742(realsolid)],
// 1 16 -11.328 -33.763 -6.54 0.5 0.478 0.7222 0 0.8339 -0.5519 -0.866 0.276 0.4169 3742.dat
  [1,16,-11.328,-33.763,-6.54,0.5,0.478,0.7222,0,0.8339,-0.5519,-0.866,0.276,0.4169, ldraw_lib__3742(realsolid)],
// 1 16 13.002 -36.682 -7.506 0.5 -0.478 -0.7222 0 0.8339 -0.5519 0.866 0.276 0.4169 3742.dat
  [1,16,13.002,-36.682,-7.506,0.5,-0.478,-0.7222,0,0.8339,-0.5519,0.866,0.276,0.4169, ldraw_lib__3742(realsolid)],
];
module ldraw_lib__99249c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__99249c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
