...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3069p07, Rebrickable 3069bpr0024, Set 6781
// 
...
// 1 80 0 0 0 1 0 0 0 1 0 0 0 1 s\3069p06b.dat
  [1,80,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3069p06b()],
// 1 320 0 0 0 1 0 0 0 1 0 0 0 1 s\3069p06c.dat
  [1,320,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3069p06c()],
];
module ldraw_lib__3069bp07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3069bp07(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
