...
// 1 0 0 128 0 0 0 -1 0 1 0 1 0 0 942.dat
  [1,0,0,128,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__942()],
];
module ldraw_lib__3443bc03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3443bc03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
