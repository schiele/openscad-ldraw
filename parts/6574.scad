...
use <../p/toothr.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6574(realsolid=false) = [
...
// 1 16 -23.5 -1 0 0 0 -0.5 0 1 0 10 0 0 rect3.dat
  [1,16,-23.5,-1,0,0,0,-0.5,0,1,0,10,0,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 3.5 -10 24 0 0 0 0 4.5 0 1 0 rect3.dat
  [1,16,0,3.5,-10,24,0,0,0,0,4.5,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 3.5 10 24 0 0 0 0 4.5 0 -1 0 rect3.dat
  [1,16,0,3.5,10,24,0,0,0,0,4.5,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 8 8.1 0 0 24 0 -1 0 -1.9 0 0 rect2p.dat
  [1,16,0,8,8.1,0,0,24,0,-1,0,-1.9,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 8 -8.1 0 0 24 0 -1 0 -1.9 0 0 rect2p.dat
  [1,16,0,8,-8.1,0,0,24,0,-1,0,-1.9,0,0, ldraw_lib__rect2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 -24 0 0 0 -6 0 0 0 6.2 box3u2p.dat
  [1,16,0,8,0,-24,0,0,0,-6,0,0,0,6.2, ldraw_lib__box3u2p(realsolid)],
...
// 1 16 -20 4 10 -4 0 0 0 0 -4 0 -1 0 4-4edge.dat
  [1,16,-20,4,10,-4,0,0,0,0,-4,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 20 4 10 -4 0 0 0 0 -4 0 -1 0 4-4edge.dat
  [1,16,20,4,10,-4,0,0,0,0,-4,0,-1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 -20 4 10 4 0 0 0 0 -4 0 2 0 4-4cyli.dat
  [1,16,-20,4,10,4,0,0,0,0,-4,0,2,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 20 4 10 4 0 0 0 0 -4 0 2 0 4-4cyli.dat
  [1,16,20,4,10,4,0,0,0,0,-4,0,2,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -20 4 20 -4 0 0 0 0 4 0 4 0 4-4cyl1sph2.dat
  [1,16,-20,4,20,-4,0,0,0,0,4,0,4,0, ldraw_lib__4_4cyl1sph2(realsolid)],
// 1 16 20 4 20 -4 0 0 0 0 4 0 4 0 4-4cyl1sph2.dat
  [1,16,20,4,20,-4,0,0,0,0,4,0,4,0, ldraw_lib__4_4cyl1sph2(realsolid)],
// 1 16 -20 4 20 -8 0 0 0 -8 0 0 0 8 8-8sphe.dat
  [1,16,-20,4,20,-8,0,0,0,-8,0,0,0,8, ldraw_lib__8_8sphe(realsolid)],
// 1 16 20 4 20 -8 0 0 0 -8 0 0 0 8 8-8sphe.dat
  [1,16,20,4,20,-8,0,0,0,-8,0,0,0,8, ldraw_lib__8_8sphe(realsolid)],
];
module ldraw_lib__6574(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6574(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
