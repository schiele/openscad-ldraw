...
use <3070b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30039(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3070b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3070b(realsolid)],
// 0
];
module ldraw_lib__30039(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30039(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__30039(line=0.2);