...
use <s/61068s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__61068p01(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 61068pb001, Emerald Night, set 10194
// 
...
// 1 16 39 24.972 20 0 1 0 -28.9719 0 -28.9719 -40 0 40 48\1-8cyli.dat
  [1,16,39,24.972,20,0,1,0,-28.9719,0,-28.9719,-40,0,40, ldraw_lib__48__1_8cyli(realsolid)],
// 1 82 36.2 24.972 20 0 2.8 0 -28.9719 0 -28.9719 -40 0 40 48\1-8cyli.dat
  [1,82,36.2,24.972,20,0,2.8,0,-28.9719,0,-28.9719,-40,0,40, ldraw_lib__48__1_8cyli(realsolid)],
// 1 16 -36.2 24.972 20 0 72.4 0 -28.9719 0 -28.9719 -40 0 40 48\1-8cyli.dat
  [1,16,-36.2,24.972,20,0,72.4,0,-28.9719,0,-28.9719,-40,0,40, ldraw_lib__48__1_8cyli(realsolid)],
// 1 82 -39 24.972 20 0 2.8 0 -28.9719 0 -28.9719 -40 0 40 48\1-8cyli.dat
  [1,82,-39,24.972,20,0,2.8,0,-28.9719,0,-28.9719,-40,0,40, ldraw_lib__48__1_8cyli(realsolid)],
// 1 16 -40 24.972 20 0 1 0 -28.9719 0 -28.9719 -40 0 40 48\1-8cyli.dat
  [1,16,-40,24.972,20,0,1,0,-28.9719,0,-28.9719,-40,0,40, ldraw_lib__48__1_8cyli(realsolid)],
];
module ldraw_lib__61068p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__61068p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
