...
$fa=1; $fs=0.2;
function ldraw_lib__u9105p01c05(realsolid=false) = [
...
// 1 7 0 -67 4 1 0 0 0 1 0 0 0 1 u9105p01c04.dat
  [1,7,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u9105p01c04(realsolid)],
...
module ldraw_lib__u9105p01c05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9105p01c05(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
