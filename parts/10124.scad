...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 10154.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__10154()],
];
module ldraw_lib__10124(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__10124(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
