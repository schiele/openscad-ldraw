...
// 1 16 0 34 -96 0 0 -4 -2 0 0 0 12 0 box4o8a.dat
  [1,16,0,34,-96,0,0,-4,-2,0,0,0,12,0, ldraw_lib__box4o8a()],
// 1 16 0 34 84 0 0 -4 -2 0 0 0 12 0 box4o8a.dat
  [1,16,0,34,84,0,0,-4,-2,0,0,0,12,0, ldraw_lib__box4o8a()],
// 1 16 0 36 -118 4 0 0 0 12 0 0 0 2 box5-4a.dat
  [1,16,0,36,-118,4,0,0,0,12,0,0,0,2, ldraw_lib__box5_4a()],
...
module ldraw_lib__581(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__581(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
