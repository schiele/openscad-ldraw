...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30150(realsolid=false) = [
...
// 1 16 0 0 -10 4 0 0 0 1 0 0 0 4 4-4ndis.dat
  [1,16,0,0,-10,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 0 10 4 0 0 0 1 0 0 0 4 4-4ndis.dat
  [1,16,0,0,10,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 -26 -18 -30 0 3 0 0 0 -18 -6 0 0 box5.dat
  [1,16,-26,-18,-30,0,3,0,0,0,-18,-6,0,0, ldraw_lib__box5(realsolid)],
// 1 16 -26 -18 -10 0 3 0 0 0 -18 -6 0 0 box5.dat
  [1,16,-26,-18,-10,0,3,0,0,0,-18,-6,0,0, ldraw_lib__box5(realsolid)],
// 1 16 -26 -18 10 0 3 0 0 0 -18 -6 0 0 box5.dat
  [1,16,-26,-18,10,0,3,0,0,0,-18,-6,0,0, ldraw_lib__box5(realsolid)],
// 1 16 -26 -18 30 0 3 0 0 0 -18 -6 0 0 box5.dat
  [1,16,-26,-18,30,0,3,0,0,0,-18,-6,0,0, ldraw_lib__box5(realsolid)],
...
// 1 16 -30 -12 -30 0 1 0 20 0 0 0 0 -10 rect.dat
  [1,16,-30,-12,-30,0,1,0,20,0,0,0,0,-10, ldraw_lib__rect(realsolid)],
// 1 16 -30 -12 30 0 1 0 20 0 0 0 0 -10 rect.dat
  [1,16,-30,-12,30,0,1,0,20,0,0,0,0,-10, ldraw_lib__rect(realsolid)],
// 1 16 30 -12 30 0 -1 0 20 0 0 0 0 10 rect.dat
  [1,16,30,-12,30,0,-1,0,20,0,0,0,0,10, ldraw_lib__rect(realsolid)],
...
// 1 16 -28 1.5 0 0 1 0 6.5 0 0 0 0 -20 rect.dat
  [1,16,-28,1.5,0,0,1,0,6.5,0,0,0,0,-20, ldraw_lib__rect(realsolid)],
// 1 16 -29 -12 0 0 1 0 7 0 0 0 0 -20 rect.dat
  [1,16,-29,-12,0,0,1,0,7,0,0,0,0,-20, ldraw_lib__rect(realsolid)],
// 1 16 -30 -25.5 0 0 1 0 6.5 0 0 0 0 -20 rect.dat
  [1,16,-30,-25.5,0,0,1,0,6.5,0,0,0,0,-20, ldraw_lib__rect(realsolid)],
// 0
...
// 1 16 0 -16 -38 12 0 0 0 1 0 0 0 2 rect.dat
  [1,16,0,-16,-38,12,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 0 -24 -38 12 0 0 0 -1 0 0 0 -2 rect.dat
  [1,16,0,-24,-38,12,0,0,0,-1,0,0,0,-2, ldraw_lib__rect(realsolid)],
// 1 16 0 -16 38 12 0 0 0 1 0 0 0 2 rect.dat
  [1,16,0,-16,38,12,0,0,0,1,0,0,0,2, ldraw_lib__rect(realsolid)],
// 1 16 0 -24 38 -12 0 0 0 -1 0 0 0 2 rect.dat
  [1,16,0,-24,38,-12,0,0,0,-1,0,0,0,2, ldraw_lib__rect(realsolid)],
...
// 1 16 -12 -20 -38 0 -1 0 0 0 -4 2 0 0 rect.dat
  [1,16,-12,-20,-38,0,-1,0,0,0,-4,2,0,0, ldraw_lib__rect(realsolid)],
// 1 16 12 -20 -38 0 1 0 0 0 -4 -2 0 0 rect.dat
  [1,16,12,-20,-38,0,1,0,0,0,-4,-2,0,0, ldraw_lib__rect(realsolid)],
// 1 16 -12 -20 38 0 -1 0 0 0 -4 2 0 0 rect.dat
  [1,16,-12,-20,38,0,-1,0,0,0,-4,2,0,0, ldraw_lib__rect(realsolid)],
...
module ldraw_lib__30150(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30150(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
