...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__41740(realsolid=false) = [
...
// 1 16 0 8 0 20 0 0 0 -5 0 0 0 6 box5.dat
  [1,16,0,8,0,20,0,0,0,-5,0,0,0,6, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 30 8 0 6 0 0 0 -5 0 0 0 6 box5.dat
  [1,16,30,8,0,6,0,0,0,-5,0,0,0,6, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -30 8 0 6 0 0 0 -5 0 0 0 6 box5.dat
  [1,16,-30,8,0,6,0,0,0,-5,0,0,0,6, ldraw_lib__box5(realsolid)],
...
// 1 16 0 7 0 40 0 0 0 -7 0 0 0 10 box5.dat
  [1,16,0,7,0,40,0,0,0,-7,0,0,0,10, ldraw_lib__box5(realsolid)],
...
// 1 16 -15 3 5.5 0 0 -1.5 0 4.8 0 -.5 0 0 box3u5p.dat
  [1,16,-15,3,5.5,0,0,-1.5,0,4.8,0,-.5,0,0, ldraw_lib__box3u5p(realsolid)],
// 1 16 -15 5.4 5 0 .75 -.75 2.4 0 0 0 -.75 -.75 box2-5.dat
  [1,16,-15,5.4,5,0,.75,-.75,2.4,0,0,0,-.75,-.75, ldraw_lib__box2_5(realsolid)],
...
module ldraw_lib__41740(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__41740(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
