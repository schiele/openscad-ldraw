...
use <s/87690s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87690(realsolid=false) = [
// 0 Scala Clip-On Bow
// 0 Name: 87690.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\87690s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87690s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\87690s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87690s01(realsolid)],
...
module ldraw_lib__87690(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87690(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
