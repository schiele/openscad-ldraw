...
use <s/3817bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3817bpw2(realsolid=false) = [
...
// 1 1 0 0 0 1 0 0 0 1 0 0 0 1 s\3817bpw1s02.dat
  [1,1,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3817bpw1s02(realsolid)],
...
module ldraw_lib__3817bpw2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3817bpw2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
