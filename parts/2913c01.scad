...
use <u9188.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2913c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2913.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2913(realsolid)],
// 1 494 0 24 -20 0 0 1 0 1 0 -1 0 0 u9188.dat
  [1,494,0,24,-20,0,0,1,0,1,0,-1,0,0, ldraw_lib__u9188(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2912.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2912(realsolid)],
];
module ldraw_lib__2913c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2913c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
