...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__750(realsolid=false) = [
...
// 1 16 0 7 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,7,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 7 0 -2 0 0 0 -1 0 0 0 2 4-4ring2.dat
  [1,16,0,7,0,-2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring2(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 7 0 1 0 0 0 -2.25 0 0 0 1 stud4a.dat
  [1,16,0,7,0,1,0,0,0,-2.25,0,0,0,1, ldraw_lib__stud4a(realsolid)],
// 
...
// 1 16 1 3.5 6.80115 1 0 0 0 0 -3.5 -0.19885 1 0 box2-9.dat
  [1,16,1,3.5,6.80115,1,0,0,0,0,-3.5,-0.19885,1,0, ldraw_lib__box2_9(realsolid)],
// 1 16 -1 3.5 6.80115 -1 0 0 0 0 -3.5 -0.19885 1 0 box2-9.dat
  [1,16,-1,3.5,6.80115,-1,0,0,0,0,-3.5,-0.19885,1,0, ldraw_lib__box2_9(realsolid)],
...
// 1 16 0 7 0 1.84776 0 -0.76537 0 -7 0 0.76537 0 1.84776 1-8con3.dat
  [1,16,0,7,0,1.84776,0,-0.76537,0,-7,0,0.76537,0,1.84776, ldraw_lib__1_8con3(realsolid)],
...
// 1 16 6.80115 3.5 -1 -0.19885 1 0 0 0 -3.5 -1 0 0 box2-9.dat
  [1,16,6.80115,3.5,-1,-0.19885,1,0,0,0,-3.5,-1,0,0, ldraw_lib__box2_9(realsolid)],
// 1 16 6.80115 3.5 1 -0.19885 1 0 0 0 -3.5 1 0 0 box2-9.dat
  [1,16,6.80115,3.5,1,-0.19885,1,0,0,0,-3.5,1,0,0, ldraw_lib__box2_9(realsolid)],
...
// 1 16 0 7 0 0.76537 0 1.84776 0 -7 0 -1.84776 0 0.76537 1-8con3.dat
  [1,16,0,7,0,0.76537,0,1.84776,0,-7,0,-1.84776,0,0.76537, ldraw_lib__1_8con3(realsolid)],
...
module ldraw_lib__750(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__750(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
