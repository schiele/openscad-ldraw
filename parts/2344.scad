...
use <../p/4-4edge.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2344(realsolid=false) = [
// 0 ~Train Wheels Pin
// 0 Name: 2344.dat
...
// 1 16 0 0 32 4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,16,0,0,32,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 32 3 0 0 0 0 3 0 1 0 4-4edge.dat
  [1,16,0,0,32,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 44 3 0 0 0 0 3 0 1 0 4-4edge.dat
  [1,16,0,0,44,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 -8 6 0 0 0 0 6 0 -1 0 4-4disc.dat
  [1,16,0,0,-8,6,0,0,0,0,6,0,-1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 32 4 0 0 0 0 4 0 -1 0 4-4disc.dat
  [1,16,0,0,32,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 44 3 0 0 0 0 3 0 -1 0 4-4disc.dat
  [1,16,0,0,44,3,0,0,0,0,3,0,-1,0, ldraw_lib__4_4disc(realsolid)],
...
// 1 16 0 0 32 4 0 0 0 0 4 0 -40 0 4-4cyli.dat
  [1,16,0,0,32,4,0,0,0,0,4,0,-40,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 44 3 0 0 0 0 3 0 -12 0 4-4cyli.dat
  [1,16,0,0,44,3,0,0,0,0,3,0,-12,0, ldraw_lib__4_4cyli(realsolid)],
// 0
];
module ldraw_lib__2344(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2344(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
