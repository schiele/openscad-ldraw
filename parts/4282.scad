...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4282(realsolid=false) = [
// 0 Plate  2 x 16
// 0 Name: 4282.dat
...
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 156 0 0 0 -4 0 0 0 16 box5.dat
  [1,16,0,8,0,156,0,0,0,-4,0,0,0,16, ldraw_lib__box5(realsolid)],
// 4 16 160 8 20 156 8 16 -156 8 16 -160 8 20
  [4,16,160,8,20,156,8,16,-156,8,16,-160,8,20],
// 4 16 160 8 -20 -160 8 -20 -156 8 -16 156 8 -16
  [4,16,160,8,-20,-160,8,-20,-156,8,-16,156,8,-16],
// 4 16 160 8 20 160 8 -20 156 8 -16 156 8 16
  [4,16,160,8,20,160,8,-20,156,8,-16,156,8,16],
// 4 16 -160 8 20 -156 8 16 -156 8 -16 -160 8 -20
  [4,16,-160,8,20,-156,8,16,-156,8,-16,-160,8,-20],
// 1 16 0 8 0 160 0 0 0 -8 0 0 0 20 box5.dat
  [1,16,0,8,0,160,0,0,0,-8,0,0,0,20, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__4282(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4282(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4282(line=0.2);