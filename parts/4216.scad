...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4216(realsolid=false) = [
...
// 1 16 -10 24 0 0 0 6 0 1 0 -6 0 0 1-4edge.dat
  [1,16,-10,24,0,0,0,6,0,1,0,-6,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 24 0 4 0 0 0 4 0 0 0 4 2-4edge.dat
  [1,16,0,24,0,4,0,0,0,4,0,0,0,4, ldraw_lib__2_4edge(realsolid)],
// 1 16 10 24 0 -6 0 0 0 1 0 0 0 -6 1-4edge.dat
  [1,16,10,24,0,-6,0,0,0,1,0,0,0,-6, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 -10 4 0 0 0 6 0 20 0 -6 0 0 1-4cyli.dat
  [1,16,-10,4,0,0,0,6,0,20,0,-6,0,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 0 4 0 4 0 0 0 20 0 0 0 4 2-4cyli.dat
  [1,16,0,4,0,4,0,0,0,20,0,0,0,4, ldraw_lib__2_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 10 4 0 -6 0 0 0 20 0 0 0 -6 1-4cyli.dat
  [1,16,10,4,0,-6,0,0,0,20,0,0,0,-6, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 -10 4 0 0 0 6 0 -1 0 -6 0 0 1-4disc.dat
  [1,16,-10,4,0,0,0,6,0,-1,0,-6,0,0, ldraw_lib__1_4disc(realsolid)],
// 4 16 -10 4 0 -4 4 0 -4 4 6 -10 4 6
  [4,16,-10,4,0,-4,4,0,-4,4,6,-10,4,6],
// 1 16 0 4 0 0 0 -4 0 -1 0 4 0 0 1-4ndis.dat
  [1,16,0,4,0,0,0,-4,0,-1,0,4,0,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 10 4 0 -6 0 0 0 -1 0 0 0 -6 1-4disc.dat
  [1,16,10,4,0,-6,0,0,0,-1,0,0,0,-6, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 -10 24 0 0 0 6 0 -1 0 -6 0 0 1-4ndis.dat
  [1,16,-10,24,0,0,0,6,0,-1,0,-6,0,0, ldraw_lib__1_4ndis(realsolid)],
// 4 16 -4 24 -5 4 24 -5 4 24 0 -4 24 0
  [4,16,-4,24,-5,4,24,-5,4,24,0,-4,24,0],
// 1 16 0 24 0 4 0 0 0 -1 0 0 0 4 2-4disc.dat
  [1,16,0,24,0,4,0,0,0,-1,0,0,0,4, ldraw_lib__2_4disc(realsolid)],
// 1 16 10 24 0 -6 0 0 0 -1 0 0 0 -6 1-4ndis.dat
  [1,16,10,24,0,-6,0,0,0,-1,0,0,0,-6, ldraw_lib__1_4ndis(realsolid)],
...
module ldraw_lib__4216(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4216(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
