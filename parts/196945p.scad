...
$fa=1; $fs=0.2;
function ldraw_lib__196945p(realsolid=false) = [
...
// 1 16 0 -0.25 7.328 0.34 0 0 0 1 0 0 0 0.34 s\196945sch.dat
  [1,16,0,-0.25,7.328,0.34,0,0,0,1,0,0,0,0.34, ldraw_lib__s__196945sch(realsolid)],
...
module ldraw_lib__196945p(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__196945p(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
