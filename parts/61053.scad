...
// 1 16 0 0 -20 1 0 0 0 1 0 0 0 1 s\60176s01.dat
  [1,16,0,0,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__s__60176s01()],
// 1 16 0 0 20 1 0 0 0 1 0 0 0 -1 s\60176s01.dat
  [1,16,0,0,20,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__60176s01()],
// 
// 1 16 -0.25 0 -20 0 -19.25 0 1 0 0 0 0 1 axl3hol8.dat
  [1,16,-0.25,0,-20,0,-19.25,0,1,0,0,0,0,1, ldraw_lib__axl3hol8()],
// 1 16 0.25 0 -20 0 19.25 0 1 0 0 0 0 -1 axl3hol8.dat
  [1,16,0.25,0,-20,0,19.25,0,1,0,0,0,0,-1, ldraw_lib__axl3hol8()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -0.25 0 -20 0 0.5 0 3.5 0 0 0 0 3.5 4-4cylo.dat
  [1,16,-0.25,0,-20,0,0.5,0,3.5,0,0,0,0,3.5, ldraw_lib__4_4cylo()],
// 1 16 -0.25 0 -20 0 1 0 0.5 0 0 0 0 0.5 4-4ring7.dat
  [1,16,-0.25,0,-20,0,1,0,0.5,0,0,0,0,0.5, ldraw_lib__4_4ring7()],
// 1 16 -0.25 0 -20 0 1 0 0 0 2 2 0 0 4-4ring2.dat
  [1,16,-0.25,0,-20,0,1,0,0,0,2,2,0,0, ldraw_lib__4_4ring2()],
// 1 16 0.25 0 -20 0 -1 0 0.5 0 0 0 0 -0.5 4-4ring7.dat
  [1,16,0.25,0,-20,0,-1,0,0.5,0,0,0,0,-0.5, ldraw_lib__4_4ring7()],
// 1 16 0.25 0 -20 0 -1 0 0 0 2 -2 0 0 4-4ring2.dat
  [1,16,0.25,0,-20,0,-1,0,0,0,2,-2,0,0, ldraw_lib__4_4ring2()],
...
// 1 16 19.5 0 -20 0 -1 0 1 0 0 0 0 -1 axl3ho10.dat
  [1,16,19.5,0,-20,0,-1,0,1,0,0,0,0,-1, ldraw_lib__axl3ho10()],
// 1 16 19.5 0 -20 0 -1 0 1 0 0 0 0 -1 axl3hol9.dat
  [1,16,19.5,0,-20,0,-1,0,1,0,0,0,0,-1, ldraw_lib__axl3hol9()],
// 1 16 19.5 0 -20 0 -1 0 1 0 0 0 0 -1 axl3hol3.dat
  [1,16,19.5,0,-20,0,-1,0,1,0,0,0,0,-1, ldraw_lib__axl3hol3()],
// 1 16 0.25 0 -20 0 -1 0 1 0 0 0 0 -1 axl3hol9.dat
  [1,16,0.25,0,-20,0,-1,0,1,0,0,0,0,-1, ldraw_lib__axl3hol9()],
// 1 16 0.25 0 -20 0 -1 0 1 0 0 0 0 -1 axl3hol2.dat
  [1,16,0.25,0,-20,0,-1,0,1,0,0,0,0,-1, ldraw_lib__axl3hol2()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 20 0 -20 0 -0.5 0 6 0 0 0 0 6 4-4cyli.dat
  [1,16,20,0,-20,0,-0.5,0,6,0,0,0,0,6, ldraw_lib__4_4cyli()],
// 1 16 20 0 -20 0 -1 0 6 0 0 0 0 6 4-4edge.dat
  [1,16,20,0,-20,0,-1,0,6,0,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 19.5 0 20 0 -1 0 1 0 0 0 0 -1 axl3ho10.dat
  [1,16,19.5,0,20,0,-1,0,1,0,0,0,0,-1, ldraw_lib__axl3ho10()],
// 1 16 19.5 0 20 0 -1 0 1 0 0 0 0 -1 axl3hol9.dat
  [1,16,19.5,0,20,0,-1,0,1,0,0,0,0,-1, ldraw_lib__axl3hol9()],
...
module ldraw_lib__61053(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__61053(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
