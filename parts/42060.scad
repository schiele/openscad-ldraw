...
use <s/42060s01.scad>
use <../p/stud.scad>
function ldraw_lib__42060() = [
// 0 Wedge 12 x  3 x  1 Double Rounded Right
// 0 Name: 42060.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\42060s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__42060s01()],
...
module ldraw_lib__42060(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__42060(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__42060(line=0.2);