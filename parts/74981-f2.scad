...
use <2947a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__74981_f2(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2947a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2947a(realsolid)],
// 1 0 0 -68 0 1 0 0 0 1 0 0 0 1 2941.dat
  [1,0,0,-68,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2941(realsolid)],
// 1 0 0 -116 0 1 0 0 0 1 0 0 0 1 2944c01.dat
  [1,0,0,-116,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2944c01(realsolid)],
];
module ldraw_lib__74981_f2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__74981_f2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
