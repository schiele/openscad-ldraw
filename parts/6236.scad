...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6236(realsolid=false) = [
...
// 1 16 40 100 0 1 0 0 0 -11 0 0 0 1 stud4.dat
  [1,16,40,100,0,1,0,0,0,-11,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 20 100 0 1 0 0 0 -11 0 0 0 1 stud4.dat
  [1,16,20,100,0,1,0,0,0,-11,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 0 100 0 1 0 0 0 -11 0 0 0 1 stud4.dat
  [1,16,0,100,0,1,0,0,0,-11,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -20 100 0 1 0 0 0 -11 0 0 0 1 stud4.dat
  [1,16,-20,100,0,1,0,0,0,-11,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -40 100 0 1 0 0 0 -11 0 0 0 1 stud4.dat
  [1,16,-40,100,0,1,0,0,0,-11,0,0,0,1, ldraw_lib__stud4(realsolid)],
...
// 1 16 0 144 0 56 0 0 0 -44 0 0 0 16 box5.dat
  [1,16,0,144,0,56,0,0,0,-44,0,0,0,16, ldraw_lib__box5(realsolid)],
...
// 1 16 0 96 2 57 0 0 0 1 0 0 0 18 rect.dat
  [1,16,0,96,2,57,0,0,0,1,0,0,0,18, ldraw_lib__rect(realsolid)],
// 1 16 50 90 -10 2 0 0 0 1 0 0 0 2 1-4edge.dat
  [1,16,50,90,-10,2,0,0,0,1,0,0,0,2, ldraw_lib__1_4edge(realsolid)],
// 2 24 50 90 -8 48 90 -8
  [2,24,50,90,-8,48,90,-8],
// 1 16 48 90 -10 -2 0 0 0 1 0 0 0 2 1-4edge.dat
  [1,16,48,90,-10,-2,0,0,0,1,0,0,0,2, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 50 90 -10 0 0 2 0 -1 0 2 0 0 1-4disc.dat
  [1,16,50,90,-10,0,0,2,0,-1,0,2,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 48 90 -10 0 0 -2 0 -1 0 2 0 0 1-4disc.dat
  [1,16,48,90,-10,0,0,-2,0,-1,0,2,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 -48 90 -10 0 0 2 0 -1 0 2 0 0 1-4disc.dat
  [1,16,-48,90,-10,0,0,2,0,-1,0,2,0,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 -50 90 -10 0 0 -2 0 -1 0 2 0 0 1-4disc.dat
  [1,16,-50,90,-10,0,0,-2,0,-1,0,2,0,0, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 0 88 -15 50 0 0 0 1 0 0 0 5 rect.dat
  [1,16,0,88,-15,50,0,0,0,1,0,0,0,5, ldraw_lib__rect(realsolid)],
// 2 24 50 88 -12 48 88 -12
  [2,24,50,88,-12,48,88,-12],
// 1 16 48 88 -10 -2 0 0 0 1 0 0 0 -2 1-4edge.dat
  [1,16,48,88,-10,-2,0,0,0,1,0,0,0,-2, ldraw_lib__1_4edge(realsolid)],
// 1 16 -48 88 -10 2 0 0 0 1 0 0 0 -2 1-4edge.dat
  [1,16,-48,88,-10,2,0,0,0,1,0,0,0,-2, ldraw_lib__1_4edge(realsolid)],
// 2 24 -50 88 -12 -48 88 -12
  [2,24,-50,88,-12,-48,88,-12],
...
// 1 16 -48 10 -10 0 -1 2 0 0 2 -2 0 0 2-4edge.dat
  [1,16,-48,10,-10,0,-1,2,0,0,2,-2,0,0, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 48 88 -10 0 0 -2 0 2 0 2 0 0 1-4cyli.dat
  [1,16,48,88,-10,0,0,-2,0,2,0,2,0,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 48 10 -10 0 0 -2 0 78 0 2 0 0 2-4cyli.dat
  [1,16,48,10,-10,0,0,-2,0,78,0,2,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 -48 88 -10 0 0 2 0 2 0 2 0 0 1-4cyli.dat
  [1,16,-48,88,-10,0,0,2,0,2,0,2,0,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -48 10 -10 0 0 2 0 78 0 2 0 0 2-4cyli.dat
  [1,16,-48,10,-10,0,0,2,0,78,0,2,0,0, ldraw_lib__2_4cyli(realsolid)],
...
// 1 16 50 8 -10 2 0 0 0 82 0 0 0 2 1-4cyli.dat
  [1,16,50,8,-10,2,0,0,0,82,0,0,0,2, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -50 8 -10 -2 0 0 0 82 0 0 0 2 1-4cyli.dat
  [1,16,-50,8,-10,-2,0,0,0,82,0,0,0,2, ldraw_lib__1_4cyli(realsolid)],
...
module ldraw_lib__6236(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6236(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
