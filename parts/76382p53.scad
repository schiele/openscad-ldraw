...
use <3820.scad>
use <973p53.scad>
function ldraw_lib__76382p53() = [
// 0 Minifig Torso with Arms and Hands with Insectoids Robot Pattern
// 0 Name: 76382p53.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973p53.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973p53()],
...
module ldraw_lib__76382p53(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382p53(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382p53(line=0.2);