...
use <421.scad>
$fa=1; $fs=0.2;
function ldraw_lib__420c01_f2(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 420.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__420(realsolid)],
// 1 16 -160 0 0 1 0 0 0 1 0 0 0 1 421.dat
  [1,16,-160,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__421(realsolid)],
];
module ldraw_lib__420c01_f2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__420c01_f2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
