...
use <../p/stud2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30396(realsolid=false) = [
...
// 1 16 0 -7 10 3.5 0 0 0 1 0 0 0 3.5 4-4edge.dat
  [1,16,0,-7,10,3.5,0,0,0,1,0,0,0,3.5, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -10 10 3.5 0 0 0 1 0 0 0 3.5 4-4edge.dat
  [1,16,0,-10,10,3.5,0,0,0,1,0,0,0,3.5, ldraw_lib__4_4edge(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -10 10 3.5 0 0 0 3 0 0 0 3.5 4-4cyli.dat
  [1,16,0,-10,10,3.5,0,0,0,3,0,0,0,3.5, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 10 10 3.5 0 0 0 1 0 0 0 3.5 4-4edge.dat
  [1,16,0,10,10,3.5,0,0,0,1,0,0,0,3.5, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 10 10 3.5 0 0 0 -1 0 0 0 -3.5 4-4ndis.dat
  [1,16,0,10,10,3.5,0,0,0,-1,0,0,0,-3.5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 7 10 3.5 0 0 0 1 0 0 0 3.5 4-4ndis.dat
  [1,16,0,7,10,3.5,0,0,0,1,0,0,0,3.5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 -7 10 3.5 0 0 0 -1 0 0 0 -3.5 4-4ndis.dat
  [1,16,0,-7,10,3.5,0,0,0,-1,0,0,0,-3.5, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 -10 10 3.5 0 0 0 1 0 0 0 3.5 4-4ndis.dat
  [1,16,0,-10,10,3.5,0,0,0,1,0,0,0,3.5, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 0 7 10 3.5 0 0 0 3 0 0 0 3.5 4-4cyli.dat
  [1,16,0,7,10,3.5,0,0,0,3,0,0,0,3.5, ldraw_lib__4_4cyli(realsolid)],
// 2 24 5 -7 18 5 -7 -5
  [2,24,5,-7,18,5,-7,-5],
...
// 1 16 0 -10 0 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,0,-10,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
// 1 16 0 10 0 1 0 0 0 -1 0 0 0 -1 stud2.dat
  [1,16,0,10,0,1,0,0,0,-1,0,0,0,-1, ldraw_lib__stud2(realsolid)],
...
// 1 16 0 0 -16 1 0 0 0 -1 0 0 0 -1 clh4.dat
  [1,16,0,0,-16,1,0,0,0,-1,0,0,0,-1, ldraw_lib__clh4(realsolid)],
// 1 16 0 0 -16 -1 0 0 0 1 0 0 0 -1 clh4.dat
  [1,16,0,0,-16,-1,0,0,0,1,0,0,0,-1, ldraw_lib__clh4(realsolid)],
// 1 16 6.25 0 -10 0 0 -2.25 6 0 0 0 -6 0 box4o4a.dat
  [1,16,6.25,0,-10,0,0,-2.25,6,0,0,0,-6,0, ldraw_lib__box4o4a(realsolid)],
// 1 16 -6.25 0 -10 0 0 -2.25 6 0 0 0 -6 0 box4o4a.dat
  [1,16,-6.25,0,-10,0,0,-2.25,6,0,0,0,-6,0, ldraw_lib__box4o4a(realsolid)],
// 1 16 3 7 -1 0 0 -2 0 -14 0 -4 0 0 box4.dat
  [1,16,3,7,-1,0,0,-2,0,-14,0,-4,0,0, ldraw_lib__box4(realsolid)],
// 1 16 -3 7 -1 0 0 -2 0 -14 0 -4 0 0 box4.dat
  [1,16,-3,7,-1,0,0,-2,0,-14,0,-4,0,0, ldraw_lib__box4(realsolid)],
];
module ldraw_lib__30396(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30396(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
