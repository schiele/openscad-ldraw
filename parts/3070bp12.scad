...
use <s/3070bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3070bp12(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 3070bpb160, Bricklink 3070bpb161, Dots, Go Team, Set 41911
// 
...
// 1 16 -9 0 -9 14 0 0 0 1 0 0 0 14 1-4disc.dat
  [1,16,-9,0,-9,14,0,0,0,1,0,0,0,14, ldraw_lib__1_4disc(realsolid)],
// 1 15 -9 0 -9 2 0 0 0 1 0 0 0 2 1-4ring7.dat
  [1,15,-9,0,-9,2,0,0,0,1,0,0,0,2, ldraw_lib__1_4ring7(realsolid)],
// 1 15 -9 0 -9 2 0 0 0 1 0 0 0 2 1-4ring8.dat
  [1,15,-9,0,-9,2,0,0,0,1,0,0,0,2, ldraw_lib__1_4ring8(realsolid)],
// 1 16 -9 0 -9 18 0 0 0 1 0 0 0 18 1-4ndis.dat
  [1,16,-9,0,-9,18,0,0,0,1,0,0,0,18, ldraw_lib__1_4ndis(realsolid)],
...
module ldraw_lib__3070bp12(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3070bp12(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
