...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4864ap03(realsolid=false) = [
...
// 1 16 14 6 10 4 0 0 0 0 -4 0 -1 0 1-4ndis.dat
  [1,16,14,6,10,4,0,0,0,0,-4,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -14 6 10 -4 0 0 0 0 -4 0 -1 0 1-4ndis.dat
  [1,16,-14,6,10,-4,0,0,0,0,-4,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 14 42 10 4 0 0 0 0 4 0 -1 0 1-4ndis.dat
  [1,16,14,42,10,4,0,0,0,0,4,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -14 42 10 -4 0 0 0 0 4 0 -1 0 1-4ndis.dat
  [1,16,-14,42,10,-4,0,0,0,0,4,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
// 0 Black border
// 1 0 14 6 10 1 0 0 0 0 -1 0 -1 0 1-4ring2.dat
  [1,0,14,6,10,1,0,0,0,0,-1,0,-1,0, ldraw_lib__1_4ring2(realsolid)],
// 1 0 -14 6 10 -1 0 0 0 0 -1 0 -1 0 1-4ring2.dat
  [1,0,-14,6,10,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__1_4ring2(realsolid)],
// 1 0 14 42 10 1 0 0 0 0 1 0 -1 0 1-4ring2.dat
  [1,0,14,42,10,1,0,0,0,0,1,0,-1,0, ldraw_lib__1_4ring2(realsolid)],
// 1 0 -14 42 10 -1 0 0 0 0 1 0 -1 0 1-4ring2.dat
  [1,0,-14,42,10,-1,0,0,0,0,1,0,-1,0, ldraw_lib__1_4ring2(realsolid)],
// 1 0 14 6 10 1 0 0 0 0 -1 0 -1 0 1-4ring3.dat
  [1,0,14,6,10,1,0,0,0,0,-1,0,-1,0, ldraw_lib__1_4ring3(realsolid)],
// 1 0 -14 6 10 -1 0 0 0 0 -1 0 -1 0 1-4ring3.dat
  [1,0,-14,6,10,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__1_4ring3(realsolid)],
// 1 0 14 42 10 1 0 0 0 0 1 0 -1 0 1-4ring3.dat
  [1,0,14,42,10,1,0,0,0,0,1,0,-1,0, ldraw_lib__1_4ring3(realsolid)],
// 1 0 -14 42 10 -1 0 0 0 0 1 0 -1 0 1-4ring3.dat
  [1,0,-14,42,10,-1,0,0,0,0,1,0,-1,0, ldraw_lib__1_4ring3(realsolid)],
...
// 1 15 14 6 10 2 0 0 0 0 -2 0 -1 0 1-4disc.dat
  [1,15,14,6,10,2,0,0,0,0,-2,0,-1,0, ldraw_lib__1_4disc(realsolid)],
// 1 15 -14 6 10 -2 0 0 0 0 -2 0 -1 0 1-4disc.dat
  [1,15,-14,6,10,-2,0,0,0,0,-2,0,-1,0, ldraw_lib__1_4disc(realsolid)],
// 1 15 14 42 10 2 0 0 0 0 2 0 -1 0 1-4disc.dat
  [1,15,14,42,10,2,0,0,0,0,2,0,-1,0, ldraw_lib__1_4disc(realsolid)],
// 1 15 -14 42 10 -2 0 0 0 0 2 0 -1 0 1-4disc.dat
  [1,15,-14,42,10,-2,0,0,0,0,2,0,-1,0, ldraw_lib__1_4disc(realsolid)],
...
module ldraw_lib__4864ap03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4864ap03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
