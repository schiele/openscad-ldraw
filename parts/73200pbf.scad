...
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3816bpbf.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816bpbf()],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3817bpbf.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817bpbf()],
];
module ldraw_lib__73200pbf(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73200pbf(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
