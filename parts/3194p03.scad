...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3194p03(realsolid=false) = [
// 0 Door  1 x  5 x  4 Right w. rd/wh/bl Stripe & bl Tr. Logo Pattern
// 0 Name: 3194p03.dat
...
// 4 16 -10 0 90 -10 72 90 -10 53 82 -10 43 82
  [4,16,-10,0,90,-10,72,90,-10,53,82,-10,43,82],
// 4 16 -10 0 70 -10 0 90 -10 43 82 -10 43 78
  [4,16,-10,0,70,-10,0,90,-10,43,82,-10,43,78],
// 4 16 -10 32 60 -10 0 70 -10 43 78 -10 48 60
  [4,16,-10,32,60,-10,0,70,-10,43,78,-10,48,60],
// 4 16 -10 32 20 -10 0 0 -10 0 70 -10 32 60
  [4,16,-10,32,20,-10,0,0,-10,0,70,-10,32,60],
// 3 16 -10 53 78 -10 48 60 -10 43 78
  [3,16,-10,53,78,-10,48,60,-10,43,78],
// 4 16 -10 72 0 -10 48 20 -10 48 60 -10 53 78
  [4,16,-10,72,0,-10,48,20,-10,48,60,-10,53,78],
// 4 16 -10 72 0 -10 0 0 -10 32 20 -10 48 20
  [4,16,-10,72,0,-10,0,0,-10,32,20,-10,48,20],
// 
...
module ldraw_lib__3194p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3194p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3194p03(line=0.2);