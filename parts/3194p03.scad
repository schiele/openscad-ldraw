...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3194px1, Metroliner, Rebrickable 3194pr0001, Set 4558
// 
...
module ldraw_lib__3194p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3194p03(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
