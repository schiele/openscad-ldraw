...
// 1 16 0 56 0 1 0 0 0 -4 0 0 0 1 stug4-3x3.dat
  [1,16,0,56,0,1,0,0,0,-4,0,0,0,1, ldraw_lib__stug4_3x3()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 72 0 36 0 0 0 -16 0 0 0 36 box5.dat
  [1,16,0,72,0,36,0,0,0,-16,0,0,0,36, ldraw_lib__box5()],
...
// 1 16 0 28 -40 0 0 36 24 0 0 0 76 0 box5.dat
  [1,16,0,28,-40,0,0,36,24,0,0,0,76,0, ldraw_lib__box5()],
// 1 16 36 24.5 8 0 -3 0 -1.5 0 0 0 0 -28 box4-1.dat
  [1,16,36,24.5,8,0,-3,0,-1.5,0,0,0,0,-28, ldraw_lib__box4_1()],
// 1 16 36 31.5 1 0 -3 0 -1.5 0 0 0 0 -35 box4-1.dat
  [1,16,36,31.5,1,0,-3,0,-1.5,0,0,0,0,-35, ldraw_lib__box4_1()],
// 1 16 -36 24.5 8 0 3 0 1.5 0 0 0 0 -28 box4-1.dat
  [1,16,-36,24.5,8,0,3,0,1.5,0,0,0,0,-28, ldraw_lib__box4_1()],
// 1 16 -36 31.5 1 0 3 0 1.5 0 0 0 0 -35 box4-1.dat
  [1,16,-36,31.5,1,0,3,0,1.5,0,0,0,0,-35, ldraw_lib__box4_1()],
// 1 16 0 72 0 -40 0 0 0 -72 0 0 0 40 box4t.dat
  [1,16,0,72,0,-40,0,0,0,-72,0,0,0,40, ldraw_lib__box4t()],
...
// 1 16 33.5 57.5 -40 1 0 0 0 1 0 0 0 1 s\841s01.dat
  [1,16,33.5,57.5,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__s__841s01()],
// 1 16 25.5 57.5 -40 1 0 0 0 1 0 0 0 1 s\841s01.dat
  [1,16,25.5,57.5,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__s__841s01()],
// 1 16 -25.5 57.5 -40 1 0 0 0 1 0 0 0 1 s\841s01.dat
  [1,16,-25.5,57.5,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__s__841s01()],
// 1 16 -33.5 57.5 -40 1 0 0 0 1 0 0 0 1 s\841s01.dat
  [1,16,-33.5,57.5,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__s__841s01()],
...
module ldraw_lib__841(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__841(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
