...
use <s/3070bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3070bpto(realsolid=false) = [
...
// 1 80 0 0 0 1 0 0 0 1 0 0 0 1 s\3070bato.dat
  [1,80,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3070bato(realsolid)],
// 1 16 0 0 0 5.5 0 0 0 1 0 0 0 5.5 4-4disc.dat
  [1,16,0,0,0,5.5,0,0,0,1,0,0,0,5.5, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 0 7.5 0 0 0 1 0 0 0 7.5 4-4ndis.dat
  [1,16,0,0,0,7.5,0,0,0,1,0,0,0,7.5, ldraw_lib__4_4ndis(realsolid)],
...
module ldraw_lib__3070bpto(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3070bpto(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
