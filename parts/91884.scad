...
use <s/91884s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__91884(realsolid=false) = [
...
// 1 16 0 0 -9 25 0 0 0 0 25 0 1 0 48\4-4disc.dat
  [1,16,0,0,-9,25,0,0,0,0,25,0,1,0, ldraw_lib__48__4_4disc(realsolid)],
];
module ldraw_lib__91884(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__91884(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
