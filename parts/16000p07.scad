...
use <s/16000s01.scad>
use <s/16000s02.scad>
function ldraw_lib__16000p07() = [
// 0 Minifig Arm Right with Bright Green Lower Arm Pattern
// 0 Name: 16000p07.dat
...
// 
// 1 10 0 0 0 1 0 0 0 1 0 0 0 1 s\16000s01.dat
  [1,10,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__16000s01()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\16000s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__16000s02()],
];
module ldraw_lib__16000p07(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__16000p07(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__16000p07(line=0.2);