...
use <53451.scad>
$fa=1; $fs=0.2;
function ldraw_lib__53450c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 53450.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__53450(realsolid)],
// 1 15 16.25 -4.12 0 0 0 1 0 1 0 1 0 0 53451.dat
  [1,15,16.25,-4.12,0,0,0,1,0,1,0,1,0,0, ldraw_lib__53451(realsolid)],
// 1 15 -16.25 -4.12 0 0 0 -1 0 1 0 1 0 0 53451.dat
  [1,15,-16.25,-4.12,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__53451(realsolid)],
// 0
];
module ldraw_lib__53450c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__53450c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
