...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\66859s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__66859s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\66859s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__66859s01()],
// 1 16 10 2 0 0 -20 0 2 0 0 0 0 20 box4o8a.dat
  [1,16,10,2,0,0,-20,0,2,0,0,0,0,20, ldraw_lib__box4o8a()],
// 1 16 0 4 0 1.5 0 0 0 2 0 0 0 7 box5.dat
  [1,16,0,4,0,1.5,0,0,0,2,0,0,0,7, ldraw_lib__box5()],
...
module ldraw_lib__66859(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__66859(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
