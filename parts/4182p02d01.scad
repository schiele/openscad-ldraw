...
use <4182p02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4182p02d01(realsolid=false) = [
...
// 1 4 -10 96 30 0 1 0 0 0 -1 -1 0 0 196945a.dat
  [1,4,-10,96,30,0,1,0,0,0,-1,-1,0,0, ldraw_lib__196945a(realsolid)],
];
module ldraw_lib__4182p02d01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4182p02d01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
