...
use <s/u600s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u600(realsolid=false) = [
// 0 ~Figure Fabuland Poodle without Pattern
// 0 Name: u600.dat
...
// 
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u600s00.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u600s00(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u600s00.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u600s00(realsolid)],
...
module ldraw_lib__u600(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u600(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u600(line=0.2);