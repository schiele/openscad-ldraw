...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\87611s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87611s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\87611s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87611s01()],
// 1 16 -20 18.75 -20 0 0 1 0 -1.3125 0 -1 0 0 stug4-1x5.dat
  [1,16,-20,18.75,-20,0,0,1,0,-1.3125,0,-1,0,0, ldraw_lib__stug4_1x5()],
// 1 16 20 18.75 -20 0 0 1 0 -1.3125 0 -1 0 0 stug4-1x5.dat
  [1,16,20,18.75,-20,0,0,1,0,-1.3125,0,-1,0,0, ldraw_lib__stug4_1x5()],
// 1 16 0 18.75 10 0 0 1 0 -1.3125 0 -1 0 0 stug4-1x2.dat
  [1,16,0,18.75,10,0,0,1,0,-1.3125,0,-1,0,0, ldraw_lib__stug4_1x2()],
...
// 1 16 0 16 -20 6 0 0 0 2.75 0 0 0 6 4-4cyli.dat
  [1,16,0,16,-20,6,0,0,0,2.75,0,0,0,6, ldraw_lib__4_4cyli()],
// 1 16 0 18.75 -20 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,0,18.75,-20,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge()],
// 1 16 0 18.75 -20 -8 0 0 0 -1 0 0 0 8 4-4ndis.dat
  [1,16,0,18.75,-20,-8,0,0,0,-1,0,0,0,8, ldraw_lib__4_4ndis()],
// 1 16 0 18.75 -20 0 0 1 0 -1.3125 0 -1 0 0 stud4a.dat
  [1,16,0,18.75,-20,0,0,1,0,-1.3125,0,-1,0,0, ldraw_lib__stud4a()],
// 1 16 0 18.75 -40 0 0 1 0 -1.3125 0 -1 0 0 stud4.dat
  [1,16,0,18.75,-40,0,0,1,0,-1.3125,0,-1,0,0, ldraw_lib__stud4()],
// 1 16 0 18.75 -60 -8 0 0 0 -1 0 0 0 8 4-4ndis.dat
  [1,16,0,18.75,-60,-8,0,0,0,-1,0,0,0,8, ldraw_lib__4_4ndis()],
// 1 16 0 18.75 -60 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,0,18.75,-60,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge()],
// 1 16 0 18.75 -60 0 0 1 0 -1.3125 0 -1 0 0 stud4a.dat
  [1,16,0,18.75,-60,0,0,1,0,-1.3125,0,-1,0,0, ldraw_lib__stud4a()],
// 1 16 0 18.75 -80 0 0 1 0 -1.3125 0 -1 0 0 stud4.dat
  [1,16,0,18.75,-80,0,0,1,0,-1.3125,0,-1,0,0, ldraw_lib__stud4()],
// 1 16 0 18.75 -100 -8 0 0 0 -1 0 0 0 8 4-4ndis.dat
  [1,16,0,18.75,-100,-8,0,0,0,-1,0,0,0,8, ldraw_lib__4_4ndis()],
// 1 16 0 18.75 -100 8 0 0 0 1 0 0 0 8 4-4edge.dat
  [1,16,0,18.75,-100,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4edge()],
// 1 16 0 18.75 -100 0 0 1 0 -1.3125 0 -1 0 0 stud4a.dat
  [1,16,0,18.75,-100,0,0,1,0,-1.3125,0,-1,0,0, ldraw_lib__stud4a()],
...
// 1 16 0 8 -60 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,8,-60,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 -60 6 0 0 0 10.75 0 0 0 6 4-4cyli.dat
  [1,16,0,8,-60,6,0,0,0,10.75,0,0,0,6, ldraw_lib__4_4cyli()],
// 1 16 0 8 -60 9 0 0 0 8 0 0 0 9 4-4cylo.dat
  [1,16,0,8,-60,9,0,0,0,8,0,0,0,9, ldraw_lib__4_4cylo()],
// 1 16 0 8 -60 3 0 0 0 1 0 0 0 3 4-4ring2.dat
  [1,16,0,8,-60,3,0,0,0,1,0,0,0,3, ldraw_lib__4_4ring2()],
// 1 16 0 8 -100 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,8,-100,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 -100 6 0 0 0 10.75 0 0 0 6 4-4cyli.dat
  [1,16,0,8,-100,6,0,0,0,10.75,0,0,0,6, ldraw_lib__4_4cyli()],
// 1 16 0 16 -100 6.36396 0 6.36396 0 8 0 -6.36396 0 6.36396 3-4edge.dat
  [1,16,0,16,-100,6.36396,0,6.36396,0,8,0,-6.36396,0,6.36396, ldraw_lib__3_4edge()],
...
// 1 16 0 8 -100 9 0 0 0 1 0 0 0 9 4-4edge.dat
  [1,16,0,8,-100,9,0,0,0,1,0,0,0,9, ldraw_lib__4_4edge()],
// 1 16 0 8 -100 9 0 0 0 8 0 0 0 9 4-4cyli.dat
  [1,16,0,8,-100,9,0,0,0,8,0,0,0,9, ldraw_lib__4_4cyli()],
// 1 16 0 8 -100 3 0 0 0 1 0 0 0 3 4-4ring2.dat
  [1,16,0,8,-100,3,0,0,0,1,0,0,0,3, ldraw_lib__4_4ring2()],
...
module ldraw_lib__87611(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87611(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
