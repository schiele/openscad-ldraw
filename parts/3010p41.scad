...
use <s/3010s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3010p41(realsolid=false) = [
...
// 1 16 -28 12 -10 1 0 0 0 1 0 0 0 1 s\3010p41a.dat
  [1,16,-28,12,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010p41a(realsolid)],
// 1 16 -14 12 -10 1 0 0 0 1 0 0 0 1 s\3010p41a.dat
  [1,16,-14,12,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010p41a(realsolid)],
// 1 16 0 12 -10 1 0 0 0 1 0 0 0 1 s\3010p41a.dat
  [1,16,0,12,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010p41a(realsolid)],
// 1 16 14 12 -10 1 0 0 0 1 0 0 0 1 s\3010p41a.dat
  [1,16,14,12,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010p41a(realsolid)],
// 1 16 28 12 -10 1 0 0 0 1 0 0 0 1 s\3010p41a.dat
  [1,16,28,12,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010p41a(realsolid)],
...
module ldraw_lib__3010p41(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3010p41(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
