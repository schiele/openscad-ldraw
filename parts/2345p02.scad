...
use <s/2345s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2345p02(realsolid=false) = [
...
// 1 8 0 0 0 1 0 0 0 1 0 0 0 1 s\2345p02b.dat
  [1,8,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2345p02b(realsolid)],
// 0
];
module ldraw_lib__2345p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2345p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
