...
$fa=1; $fs=0.2;
function ldraw_lib__4082(realsolid=false) = [
...
// 1 16 0 28 0 1 0 0 0 -1 0 0 0 1 stug4-5x5.dat
  [1,16,0,28,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stug4_5x5(realsolid)],
// 1 16 60 28 0 0 0 1 0 -1 0 -1 0 0 stug4-1x5.dat
  [1,16,60,28,0,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stug4_1x5(realsolid)],
// 1 16 -60 28 0 0 0 1 0 -1 0 -1 0 0 stug4-1x5.dat
  [1,16,-60,28,0,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stug4_1x5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 32 0 76 0 0 0 -4 0 0 0 56 box5.dat
  [1,16,0,32,0,76,0,0,0,-4,0,0,0,56, ldraw_lib__box5(realsolid)],
...
// 1 16 0 0 0 80 0 0 0 32 0 0 0 60 box4.dat
  [1,16,0,0,0,80,0,0,0,32,0,0,0,60, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 76 0 0 0 24 0 0 0 56 box5.dat
  [1,16,0,0,0,76,0,0,0,24,0,0,0,56, ldraw_lib__box5(realsolid)],
// 1 16 0 24 0 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,0,24,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4(realsolid)],
// 1 16 50 24 0 1 0 0 0 1 0 0 0 1 stug-4x1.dat
  [1,16,50,24,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x1(realsolid)],
// 1 16 -50 24 0 1 0 0 0 1 0 0 0 1 stug-4x1.dat
  [1,16,-50,24,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x1(realsolid)],
];
module ldraw_lib__4082(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4082(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
