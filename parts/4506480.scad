...
use <58176.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4506480(realsolid=false) = [
...
// 1 41 0 0 0 1 0 0 0 1 0 0 0 1 58176.dat
  [1,41,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__58176(realsolid)],
];
module ldraw_lib__4506480(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4506480(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
