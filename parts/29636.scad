...
// 1 16 0 7.5 0 4 0 0 0 -15 0 0 0 4 4-4cylc.dat
  [1,16,0,7.5,0,4,0,0,0,-15,0,0,0,4, ldraw_lib__4_4cylc()],
// 1 16 0 -7.5 0 5 0 0 0 -3 0 0 0 5 4-4cylc.dat
  [1,16,0,-7.5,0,5,0,0,0,-3,0,0,0,5, ldraw_lib__4_4cylc()],
// 1 16 0 -10.5 0 5 0 0 0 1 0 0 0 5 4-4disc.dat
  [1,16,0,-10.5,0,5,0,0,0,1,0,0,0,5, ldraw_lib__4_4disc()],
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\29636s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__29636s01()],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\29636s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__29636s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\29636s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__29636s01()],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\29636s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__29636s01()],
...
module ldraw_lib__29636(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__29636(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
