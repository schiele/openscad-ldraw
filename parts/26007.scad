...
use <../p/t01o3333.scad>
$fa=1; $fs=0.2;
function ldraw_lib__26007(realsolid=false) = [
...
// 1 16 0 0 0 8 0 0 0 -2.5 0 0 0 8 4-4cylo.dat
  [1,16,0,0,0,8,0,0,0,-2.5,0,0,0,8, ldraw_lib__4_4cylo(realsolid)],
...
// 1 16 0 -1 0 10 0 0 0 -1.5 0 0 0 10 4-4cylo.dat
  [1,16,0,-1,0,10,0,0,0,-1.5,0,0,0,10, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 -1 0 3.33333 0 0 0 -1 0 0 0 3.33333 4-4ring3.dat
  [1,16,0,-1,0,3.33333,0,0,0,-1,0,0,0,3.33333, ldraw_lib__4_4ring3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -1 0 13.33333 0 0 0 1.5 0 0 0 13.33333 4-4cylo.dat
  [1,16,0,-1,0,13.33333,0,0,0,1.5,0,0,0,13.33333, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 0.5 0 6.66667 0 0 0 -1 0 0 0 6.66667 4-4ring2.dat
  [1,16,0,0.5,0,6.66667,0,0,0,-1,0,0,0,6.66667, ldraw_lib__4_4ring2(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0.5 0 20 0 0 0 1.5 0 0 0 20 4-4cylo.dat
  [1,16,0,0.5,0,20,0,0,0,1.5,0,0,0,20, ldraw_lib__4_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 20 0 0 0 -18 0 0 0 20 t01o3333.dat
  [1,16,0,8,0,20,0,0,0,-18,0,0,0,20, ldraw_lib__t01o3333(realsolid)],
// 1 16 0 8 0 26.66667 0 0 0 -1 0 0 0 26.66667 4-4edge.dat
  [1,16,0,8,0,26.66667,0,0,0,-1,0,0,0,26.66667, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 8 0 2.22222 0 0 0 -1 0 0 0 2.22222 4-4rin12.dat
  [1,16,0,8,0,2.22222,0,0,0,-1,0,0,0,2.22222, ldraw_lib__4_4rin12(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\26007s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__26007s01(realsolid)],
// 1 16 0 0 0 0.92388 0 0.38268 0 1 0 -0.38268 0 0.92388 s\26007s01.dat
  [1,16,0,0,0,0.92388,0,0.38268,0,1,0,-0.38268,0,0.92388, ldraw_lib__s__26007s01(realsolid)],
// 1 16 0 0 0 0.70711 0 0.70711 0 1 0 -0.70711 0 0.70711 s\26007s01.dat
  [1,16,0,0,0,0.70711,0,0.70711,0,1,0,-0.70711,0,0.70711, ldraw_lib__s__26007s01(realsolid)],
// 1 16 0 0 0 0.38268 0 0.92388 0 1 0 -0.92388 0 0.38268 s\26007s01.dat
  [1,16,0,0,0,0.38268,0,0.92388,0,1,0,-0.92388,0,0.38268, ldraw_lib__s__26007s01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\26007s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__26007s01(realsolid)],
// 1 16 0 0 0 -0.38268 0 0.92388 0 1 0 -0.92388 0 -0.38268 s\26007s01.dat
  [1,16,0,0,0,-0.38268,0,0.92388,0,1,0,-0.92388,0,-0.38268, ldraw_lib__s__26007s01(realsolid)],
// 1 16 0 0 0 -0.70711 0 0.70711 0 1 0 -0.70711 0 -0.70711 s\26007s01.dat
  [1,16,0,0,0,-0.70711,0,0.70711,0,1,0,-0.70711,0,-0.70711, ldraw_lib__s__26007s01(realsolid)],
...
module ldraw_lib__26007(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__26007(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
