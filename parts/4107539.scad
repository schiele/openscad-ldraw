...
use <61.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4107539(realsolid=false) = [
...
// 1 15 0 0 0 1 0 0 0 1 0 0 0 1 60.dat
  [1,15,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__60(realsolid)],
// 1 8 0 0 0 1 0 0 0 1 0 0 0 1 61.dat
  [1,8,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__61(realsolid)],
];
module ldraw_lib__4107539(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4107539(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
