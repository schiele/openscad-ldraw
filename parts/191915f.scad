...
use <../p/4-4ring6.scad>
$fa=1; $fs=0.2;
function ldraw_lib__191915f(realsolid=false) = [
...
// 1 15 0 0 0 14 0 0 0 -0.25 0 0 0 -14 4-4cylc3.dat
  [1,15,0,0,0,14,0,0,0,-0.25,0,0,0,-14, ldraw_lib__4_4cylc3(realsolid)],
// 1 2 0 -0.25 0 7.5 0 0 0 1 0 0 0 7.5 4-4disc.dat
  [1,2,0,-0.25,0,7.5,0,0,0,1,0,0,0,7.5, ldraw_lib__4_4disc(realsolid)],
// 1 15 0 -0.25 0 2.5 0 0 0 1 0 0 0 2.5 4-4ring3.dat
  [1,15,0,-0.25,0,2.5,0,0,0,1,0,0,0,2.5, ldraw_lib__4_4ring3(realsolid)],
// 1 15 0 -0.25 0 2 0 0 0 1 0 0 0 2 4-4ring5.dat
  [1,15,0,-0.25,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4ring5(realsolid)],
// 1 15 0 -0.25 0 2 0 0 0 1 0 0 0 2 4-4ring6.dat
  [1,15,0,-0.25,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4ring6(realsolid)],
// 
];
module ldraw_lib__191915f(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__191915f(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
