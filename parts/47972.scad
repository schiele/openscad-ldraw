...
// 1 16 -20 0 0 0 -2 0 0 0 4 4 0 0 4-4cyli.dat
  [1,16,-20,0,0,0,-2,0,0,0,4,4,0,0, ldraw_lib__4_4cyli()],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\47972s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__47972s01()],
// 1 16 0 0 0 1 0 0 0 -1 0 0 0 1 s\47972s01.dat
  [1,16,0,0,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__47972s01()],
// 1 16 -20 0 0 0 1 0 0 0 -10 9 0 0 rect.dat
  [1,16,-20,0,0,0,1,0,0,0,-10,9,0,0, ldraw_lib__rect()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -4 0 0 0 -12 0 0 0 -8 -5 0 0 box3u2p.dat
  [1,16,-4,0,0,0,-12,0,0,0,-8,-5,0,0, ldraw_lib__box3u2p()],
// 1 16 -16 0 -8.5 0 -1 0 0 0 9 -.5 0 0 rect.dat
  [1,16,-16,0,-8.5,0,-1,0,0,0,9,-.5,0,0, ldraw_lib__rect()],
// 1 16 -16 0 8.5 0 -1 0 0 0 9 -.5 0 0 rect.dat
  [1,16,-16,0,8.5,0,-1,0,0,0,9,-.5,0,0, ldraw_lib__rect()],
...
// 1 16 -5.0525 0 -8 5.0525 0 0 0 0 -16 0 1 0 rect1.dat
  [1,16,-5.0525,0,-8,5.0525,0,0,0,0,-16,0,1,0, ldraw_lib__rect1()],
// 1 16 -5.0525 0 8 5.0525 0 0 0 0 16 0 -1 0 rect1.dat
  [1,16,-5.0525,0,8,5.0525,0,0,0,0,16,0,-1,0, ldraw_lib__rect1()],
...
// 1 16 -2 0 -5 2 0 0 0 0 12.724 0 -1 0 rect1.dat
  [1,16,-2,0,-5,2,0,0,0,0,12.724,0,-1,0, ldraw_lib__rect1()],
// 1 16 -2 0 5 2 0 0 0 0 -12.724 0 1 0 rect1.dat
  [1,16,-2,0,5,2,0,0,0,0,-12.724,0,1,0, ldraw_lib__rect1()],
];
module ldraw_lib__47972(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__47972(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
