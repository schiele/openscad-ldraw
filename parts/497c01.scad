...
use <497a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__497c01(realsolid=false) = [
...
// 1 60 0 0 12 0.7071 0.7071 0 -0.7071 0.7071 0 0 0 1 269.dat
  [1,60,0,0,12,0.7071,0.7071,0,-0.7071,0.7071,0,0,0,1, ldraw_lib__269(realsolid)],
];
module ldraw_lib__497c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__497c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
