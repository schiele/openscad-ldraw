...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2546p02s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2546p02s01()],
// 1 2 0 0 0 1 0 0 0 1 0 0 0 1 s\2546p02s02.dat
  [1,2,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2546p02s02()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\2546p02s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__2546p02s01()],
// 1 2 0 0 0 -1 0 0 0 1 0 0 0 1 s\2546p02s02.dat
  [1,2,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__2546p02s02()],
// 1 2 0 0 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,2,0,0,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
// 1 2 0 -4 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,2,0,-4,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
// 1 2 0 -4 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,2,0,-4,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge()],
// 1 2 0 -32 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,2,0,-32,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge()],
// 1 2 0 -32 0 -4 0 0 0 -1 0 0 0 -4 4-4disc.dat
  [1,2,0,-32,0,-4,0,0,0,-1,0,0,0,-4, ldraw_lib__4_4disc()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 2 0 -32 0 4 0 0 0 28 0 0 0 4 4-4cyli.dat
  [1,2,0,-32,0,4,0,0,0,28,0,0,0,4, ldraw_lib__4_4cyli()],
// 1 2 0 -4 0 2 0 0 0 -1 0 0 0 2 4-4ring2.dat
  [1,2,0,-4,0,2,0,0,0,-1,0,0,0,2, ldraw_lib__4_4ring2()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 2 0 -4 0 6 0 0 0 4 0 0 0 6 4-4cyli.dat
  [1,2,0,-4,0,6,0,0,0,4,0,0,0,6, ldraw_lib__4_4cyli()],
];
module ldraw_lib__2546p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2546p02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
