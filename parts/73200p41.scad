...
use <3817bp41.scad>
$fa=1; $fs=0.2;
function ldraw_lib__73200p41(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3815bp41.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3815bp41(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3816bp41.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816bp41(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3817bp41.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817bp41(realsolid)],
];
module ldraw_lib__73200p41(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73200p41(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
