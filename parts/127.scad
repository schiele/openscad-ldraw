...
// 1 16 0 82 0 0 0 19 0 -82 0 19 0 0 4-4cyli.dat
  [1,16,0,82,0,0,0,19,0,-82,0,19,0,0, ldraw_lib__4_4cyli()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 82 0 0 0 18 0 -82 0 18 0 0 4-4cyli.dat
  [1,16,0,82,0,0,0,18,0,-82,0,18,0,0, ldraw_lib__4_4cyli()],
// 1 16 0 82 0 0 0 18 0 -1 0 18 0 0 4-4edge.dat
  [1,16,0,82,0,0,0,18,0,-1,0,18,0,0, ldraw_lib__4_4edge()],
...
// 1 16 0 82 0 0 0 19 0 -1 0 19 0 0 4-4edge.dat
  [1,16,0,82,0,0,0,19,0,-1,0,19,0,0, ldraw_lib__4_4edge()],
// 0
];
module ldraw_lib__127(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__127(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
