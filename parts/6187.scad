...
use <../p/t04q4000.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6187(realsolid=false) = [
// 0 Bar  1 x  4 x  2
// 0 Name: 6187.dat
...
// 1 16 0 48 0 20 0 0 0 -8 0 0 0 10 box4o4a.dat
  [1,16,0,48,0,20,0,0,0,-8,0,0,0,10, ldraw_lib__box4o4a(realsolid)],
// 1 16 0 40 6.414 20 0 0 0 1 0 0 0 3.586 rect.dat
  [1,16,0,40,6.414,20,0,0,0,1,0,0,0,3.586, ldraw_lib__rect(realsolid)],
// 1 16 0 40 -6.414 20 0 0 0 1 0 0 0 3.586 rect.dat
  [1,16,0,40,-6.414,20,0,0,0,1,0,0,0,3.586, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 48 0 16 0 0 0 -4 0 0 0 6 box5.dat
  [1,16,0,48,0,16,0,0,0,-4,0,0,0,6, ldraw_lib__box5(realsolid)],
...
// 1 16 26 36 0 0 -52 0 4 0 0 0 0 4 4-4cyli.dat
  [1,16,26,36,0,0,-52,0,4,0,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 26 26 0 10 0 0 0 0 10 0 10 0 t04q4000.dat
  [1,16,26,26,0,10,0,0,0,0,10,0,10,0, ldraw_lib__t04q4000(realsolid)],
// 1 16 -26 26 0 -10 0 0 0 0 10 0 10 0 t04q4000.dat
  [1,16,-26,26,0,-10,0,0,0,0,10,0,10,0, ldraw_lib__t04q4000(realsolid)],
// 1 16 36 14 0 4 0 0 0 12 0 0 0 4 4-4cyli.dat
  [1,16,36,14,0,4,0,0,0,12,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -36 14 0 4 0 0 0 12 0 0 0 4 4-4cyli.dat
  [1,16,-36,14,0,4,0,0,0,12,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 26 14 0 10 0 0 0 0 -10 0 10 0 t04q4000.dat
  [1,16,26,14,0,10,0,0,0,0,-10,0,10,0, ldraw_lib__t04q4000(realsolid)],
// 1 16 -26 14 0 -10 0 0 0 0 -10 0 10 0 t04q4000.dat
  [1,16,-26,14,0,-10,0,0,0,0,-10,0,10,0, ldraw_lib__t04q4000(realsolid)],
// 1 16 26 4 0 0 -52 0 4 0 0 0 0 4 4-4cyli.dat
  [1,16,26,4,0,0,-52,0,4,0,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 40 0 20 0 0 0 -1.172 0 0 0 2.828 box4o8a.dat
  [1,16,0,40,0,20,0,0,0,-1.172,0,0,0,2.828, ldraw_lib__box4o8a(realsolid)],
// 2 24 20 38.828 2.828 -20 38.828 2.828
  [2,24,20,38.828,2.828,-20,38.828,2.828],
// 2 24 20 38.828 -2.828 -20 38.828 -2.828
  [2,24,20,38.828,-2.828,-20,38.828,-2.828],
// 1 16 20 36 0 0 1 0 2.82843 0 2.82843 -2.82843 0 2.82843 1-4edge.dat
  [1,16,20,36,0,0,1,0,2.82843,0,2.82843,-2.82843,0,2.82843, ldraw_lib__1_4edge(realsolid)],
// 1 16 -20 36 0 0 1 0 2.82843 0 2.82843 -2.82843 0 2.82843 1-4edge.dat
  [1,16,-20,36,0,0,1,0,2.82843,0,2.82843,-2.82843,0,2.82843, ldraw_lib__1_4edge(realsolid)],
];
module ldraw_lib__6187(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6187(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
