...
use <996.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4180d(realsolid=false) = [
// 0 ~Moved to 996
// 0 Name: 4180d.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 996.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__996(realsolid)],
];
module ldraw_lib__4180d(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4180d(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
