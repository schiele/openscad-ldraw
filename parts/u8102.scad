...
use <../p/stud26.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u8102(realsolid=false) = [
...
// 1 16 -40 4 -12 2 0 0 0 1 0 0 0 -2 bump5000.dat
  [1,16,-40,4,-12,2,0,0,0,1,0,0,0,-2, ldraw_lib__bump5000(realsolid)],
...
// 1 16 40 64 -12 -2 0 0 0 -1 0 0 0 -2 bump5000.dat
  [1,16,40,64,-12,-2,0,0,0,-1,0,0,0,-2, ldraw_lib__bump5000(realsolid)],
...
// 1 16 0 72 1.5 0 0 36 0 -70 0 8.5 0 0 box3u8p.dat
  [1,16,0,72,1.5,0,0,36,0,-70,0,8.5,0,0, ldraw_lib__box3u8p(realsolid)],
...
// 1 16 0 4 -9 0 0 39 0 57 0 1 0 0 box3u2p.dat
  [1,16,0,4,-9,0,0,39,0,57,0,1,0,0, ldraw_lib__box3u2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 2.5 -10 36 0 0 0 0 0.5 0 1 0 box5-4a.dat
  [1,16,0,2.5,-10,36,0,0,0,0,0.5,0,1,0, ldraw_lib__box5_4a(realsolid)],
// 
// 0 // sotto ante
...
// 1 16 28.5 13.5 -8.5 0 0 7.5 0 -7.5 0 1.5 0 0 box2-9p.dat
  [1,16,28.5,13.5,-8.5,0,0,7.5,0,-7.5,0,1.5,0,0, ldraw_lib__box2_9p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -28.5 13.5 -8.5 0 0 -7.5 0 -7.5 0 1.5 0 0 box2-9p.dat
  [1,16,-28.5,13.5,-8.5,0,0,-7.5,0,-7.5,0,1.5,0,0, ldraw_lib__box2_9p(realsolid)],
...
// 1 16 -28.5 51.5 -8.5 0 -7.5 0 0 0 7.5 1.5 0 0 box2-9p.dat
  [1,16,-28.5,51.5,-8.5,0,-7.5,0,0,0,7.5,1.5,0,0, ldraw_lib__box2_9p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 28.5 51.5 -8.5 0 0 7.5 0 7.5 0 1.5 0 0 box2-9p.dat
  [1,16,28.5,51.5,-8.5,0,0,7.5,0,7.5,0,1.5,0,0, ldraw_lib__box2_9p(realsolid)],
// 
// 0 // base inferiore
...
// 1 16 21 42 -8.5 0 15 0 2 0 0 0 0 1.5 box4o8a.dat
  [1,16,21,42,-8.5,0,15,0,2,0,0,0,0,1.5, ldraw_lib__box4o8a(realsolid)],
// 1 16 21 23 -8.5 0 15 0 2 0 0 0 0 1.5 box4o8a.dat
  [1,16,21,23,-8.5,0,15,0,2,0,0,0,0,1.5, ldraw_lib__box4o8a(realsolid)],
// 
// 0 // quadrati della griglia seconda colonna a destra (oriz)
// 1 16 2 42 -8.5 0 15 0 2 0 0 0 0 1.5 box4o8a.dat
  [1,16,2,42,-8.5,0,15,0,2,0,0,0,0,1.5, ldraw_lib__box4o8a(realsolid)],
// 1 16 2 23 -8.5 0 15 0 2 0 0 0 0 1.5 box4o8a.dat
  [1,16,2,23,-8.5,0,15,0,2,0,0,0,0,1.5, ldraw_lib__box4o8a(realsolid)],
// 
// 0 // quadrati della griglia terza colonna a destra (oriz)
// 1 16 -17 42 -8.5 0 15 0 2 0 0 0 0 1.5 box4o8a.dat
  [1,16,-17,42,-8.5,0,15,0,2,0,0,0,0,1.5, ldraw_lib__box4o8a(realsolid)],
// 1 16 -17 23 -8.5 0 15 0 2 0 0 0 0 1.5 box4o8a.dat
  [1,16,-17,23,-8.5,0,15,0,2,0,0,0,0,1.5, ldraw_lib__box4o8a(realsolid)],
// 
// 0 // quadrati della griglia quarta colonna a destra (oriz)
// 1 16 -36 42 -8.5 0 15 0 2 0 0 0 0 1.5 box4o8a.dat
  [1,16,-36,42,-8.5,0,15,0,2,0,0,0,0,1.5, ldraw_lib__box4o8a(realsolid)],
// 1 16 -36 23 -8.5 0 15 0 2 0 0 0 0 1.5 box4o8a.dat
  [1,16,-36,23,-8.5,0,15,0,2,0,0,0,0,1.5, ldraw_lib__box4o8a(realsolid)],
// 
// 0 // quadrati della griglia verticali
// 1 16 19 6 -8.5 0 0 2 0 15 0 1.5 0 0 box4o8a.dat
  [1,16,19,6,-8.5,0,0,2,0,15,0,1.5,0,0, ldraw_lib__box4o8a(realsolid)],
// 1 16 0 6 -8.5 0 0 2 0 15 0 1.5 0 0 box4o8a.dat
  [1,16,0,6,-8.5,0,0,2,0,15,0,1.5,0,0, ldraw_lib__box4o8a(realsolid)],
// 1 16 -19 6 -8.5 0 0 2 0 15 0 1.5 0 0 box4o8a.dat
  [1,16,-19,6,-8.5,0,0,2,0,15,0,1.5,0,0, ldraw_lib__box4o8a(realsolid)],
// 1 16 19 25 -8.5 0 0 2 0 15 0 1.5 0 0 box4o8a.dat
  [1,16,19,25,-8.5,0,0,2,0,15,0,1.5,0,0, ldraw_lib__box4o8a(realsolid)],
// 1 16 0 25 -8.5 0 0 2 0 15 0 1.5 0 0 box4o8a.dat
  [1,16,0,25,-8.5,0,0,2,0,15,0,1.5,0,0, ldraw_lib__box4o8a(realsolid)],
// 1 16 -19 25 -8.5 0 0 2 0 15 0 1.5 0 0 box4o8a.dat
  [1,16,-19,25,-8.5,0,0,2,0,15,0,1.5,0,0, ldraw_lib__box4o8a(realsolid)],
// 1 16 19 44 -8.5 0 0 2 0 15 0 1.5 0 0 box4o8a.dat
  [1,16,19,44,-8.5,0,0,2,0,15,0,1.5,0,0, ldraw_lib__box4o8a(realsolid)],
// 1 16 0 44 -8.5 0 0 2 0 15 0 1.5 0 0 box4o8a.dat
  [1,16,0,44,-8.5,0,0,2,0,15,0,1.5,0,0, ldraw_lib__box4o8a(realsolid)],
// 1 16 -19 44 -8.5 0 0 2 0 15 0 1.5 0 0 box4o8a.dat
  [1,16,-19,44,-8.5,0,0,2,0,15,0,1.5,0,0, ldraw_lib__box4o8a(realsolid)],
// 
...
module ldraw_lib__u8102(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8102(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
