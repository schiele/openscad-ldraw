...
use <3067ap14.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3067p14(realsolid=false) = [
// 0 ~Moved to 3067ap14
// 0 Name: 3067p14.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3067ap14.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3067ap14(realsolid)],
];
module ldraw_lib__3067p14(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3067p14(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
