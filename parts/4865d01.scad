...
use <4865a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4865d01(realsolid=false) = [
...
// 1 16 0 12 10 1 0 0 0 0 1 0 -1 0 168265a.dat
  [1,16,0,12,10,1,0,0,0,0,1,0,-1,0, ldraw_lib__168265a(realsolid)],
];
module ldraw_lib__4865d01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4865d01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
