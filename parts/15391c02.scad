...
// 1 57 0 -35.76 -24.814 0 0 1 -0.92388 -0.38268 0 0.38268 -0.92388 0 4073.dat
  [1,57,0,-35.76,-24.814,0,0,1,-0.92388,-0.38268,0,0.38268,-0.92388,0, ldraw_lib__4073()],
];
module ldraw_lib__15391c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__15391c02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
