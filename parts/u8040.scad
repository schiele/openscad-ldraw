...
// 1 16 0 63 -3 8 0 0 0 0 3 0 -1 0 box5.dat
  [1,16,0,63,-3,8,0,0,0,0,3,0,-1,0, ldraw_lib__box5()],
...
module ldraw_lib__u8040(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8040(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
