...
// 1 16 0 8 0 76 0 0 0 -4 0 0 0 2 box5.dat
  [1,16,0,8,0,76,0,0,0,-4,0,0,0,2, ldraw_lib__box5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 20 76 0 0 0 -4 0 0 0 16 box5.dat
  [1,16,0,8,20,76,0,0,0,-4,0,0,0,16, ldraw_lib__box5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 -20 76 0 0 0 -4 0 0 0 16 box5.dat
  [1,16,0,8,-20,76,0,0,0,-4,0,0,0,16, ldraw_lib__box5()],
...
module ldraw_lib__6576(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6576(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
