...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4447(realsolid=false) = [
...
// 1 16 20 68 -60 1 0 0 0 -1 0 0 0 1 stud3.dat
  [1,16,20,68,-60,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud3(realsolid)],
// 1 16 0 68 -60 1 0 0 0 -1 0 0 0 1 stud3.dat
  [1,16,0,68,-60,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud3(realsolid)],
// 1 16 -20 68 -60 1 0 0 0 -1 0 0 0 1 stud3.dat
  [1,16,-20,68,-60,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 72 -60 36 0 0 0 -4 0 0 0 6 box5.dat
  [1,16,0,72,-60,36,0,0,0,-4,0,0,0,6, ldraw_lib__box5(realsolid)],
...
// 1 16 40 34 -33.735 0 1 0 0 0 -2 -2 0 0 4-4edge.dat
  [1,16,40,34,-33.735,0,1,0,0,0,-2,-2,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 36 34 -33.735 0 1 0 0 0 -2 -2 0 0 4-4ndis.dat
  [1,16,36,34,-33.735,0,1,0,0,0,-2,-2,0,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 40 34 -33.735 0 -1 0 0 0 -2 2 0 0 4-4ndis.dat
  [1,16,40,34,-33.735,0,-1,0,0,0,-2,2,0,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -36 34 -33.735 0 -1 0 0 0 -2 2 0 0 4-4ndis.dat
  [1,16,-36,34,-33.735,0,-1,0,0,0,-2,2,0,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -40 34 -33.735 0 1 0 0 0 -2 -2 0 0 4-4ndis.dat
  [1,16,-40,34,-33.735,0,1,0,0,0,-2,-2,0,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 36 34 -33.735 0 1 0 0 0 -2 -2 0 0 4-4edge.dat
  [1,16,36,34,-33.735,0,1,0,0,0,-2,-2,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 -36 34 -33.735 0 1 0 0 0 -2 -2 0 0 4-4edge.dat
  [1,16,-36,34,-33.735,0,1,0,0,0,-2,-2,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 -40 34 -33.735 0 1 0 0 0 -2 -2 0 0 4-4edge.dat
  [1,16,-40,34,-33.735,0,1,0,0,0,-2,-2,0,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 -40 34 -33.735 0 4 0 0 0 -2 -2 0 0 4-4cyli.dat
  [1,16,-40,34,-33.735,0,4,0,0,0,-2,-2,0,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 36 34 -33.735 0 4 0 0 0 -2 -2 0 0 4-4cyli.dat
  [1,16,36,34,-33.735,0,4,0,0,0,-2,-2,0,0, ldraw_lib__4_4cyli(realsolid)],
// 0
];
module ldraw_lib__4447(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4447(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__4447(line=0.2);