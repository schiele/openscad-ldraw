...
use <s/6023s00.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6023(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\6023s00.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6023s00(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\6023s00.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__6023s00(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -2.6 0.04 6.16 0 0 0 2.6 0 0 0 -6.16 4-4cyli.dat
  [1,16,0,-2.6,0.04,6.16,0,0,0,2.6,0,0,0,-6.16, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 -2.6 0.04 6.16 0 0 0 2.6 0 0 0 -6.16 4-4edge.dat
  [1,16,0,-2.6,0.04,6.16,0,0,0,2.6,0,0,0,-6.16, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 0.04 6.16 0 0 0 2.6 0 0 0 -6.16 4-4edge.dat
  [1,16,0,0,0.04,6.16,0,0,0,2.6,0,0,0,-6.16, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 -2.6 0.04 6.16 0 0 0 1 0 0 0 -6.16 4-4ndis.dat
  [1,16,0,-2.6,0.04,6.16,0,0,0,1,0,0,0,-6.16, ldraw_lib__4_4ndis(realsolid)],
// 1 16 0 0 0.04 6.16 0 0 0 -1 0 0 0 -6.16 4-4ndis.dat
  [1,16,0,0,0.04,6.16,0,0,0,-1,0,0,0,-6.16, ldraw_lib__4_4ndis(realsolid)],
];
module ldraw_lib__6023(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6023(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
