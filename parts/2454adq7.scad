...
use <4613908o.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2454adq7(realsolid=false) = [
...
// 1 16 0 60 -10 1 0 0 0 0 -1 0 1 0 4613908o.dat
  [1,16,0,60,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__4613908o(realsolid)],
];
module ldraw_lib__2454adq7(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2454adq7(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
