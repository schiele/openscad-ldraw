...
use <763.scad>
$fa=1; $fs=0.2;
function ldraw_lib__559c01(realsolid=false) = [
// 0 Winch  4 x  4 x  2 with Sloped Top with Black Drum (Complete)
// 0 Name: 559c01.dat
...
// 1 0 0 8 0 1 0 0 0 1 0 0 0 1 762.dat
  [1,0,0,8,0,1,0,0,0,1,0,0,0,1, ldraw_lib__762(realsolid)],
// 
];
module ldraw_lib__559c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__559c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__559c01(line=0.2);