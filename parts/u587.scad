...
use <s/u587s00.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u587(realsolid=false) = [
// 0 ~Figure Fabuland Dog Head without Pattern
// 0 Name: u587.dat
...
// 
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u587s00.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u587s00(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u587s00.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u587s00(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__u587(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u587(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u587(line=0.2);