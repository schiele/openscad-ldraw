...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3832(realsolid=false) = [
// 0 Plate  2 x 10
// 0 Name: 3832.dat
...
// 1 16 0 8 0 96 0 0 0 -4 0 0 0 16 box5.dat
  [1,16,0,8,0,96,0,0,0,-4,0,0,0,16, ldraw_lib__box5(realsolid)],
...
// 1 16 0 8 0 100 0 0 0 -8 0 0 0 20 box5.dat
  [1,16,0,8,0,100,0,0,0,-8,0,0,0,20, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__3832(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3832(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
