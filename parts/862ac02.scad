...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 862ac01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__862ac01()],
// 1 7 0 8 100 0 0 -1 0 1 0 1 0 0 3020.dat
  [1,7,0,8,100,0,0,-1,0,1,0,1,0,0, ldraw_lib__3020()],
// 1 7 0 16 110 0 0 -1 0 1 0 1 0 0 3021.dat
  [1,7,0,16,110,0,0,-1,0,1,0,1,0,0, ldraw_lib__3021()],
...
// 1 0 4 -254 120 0 1 0 -1 0 0 0 0 1 70022.dat
  [1,0,4,-254,120,0,1,0,-1,0,0,0,0,1, ldraw_lib__70022()],
];
module ldraw_lib__862ac02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__862ac02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
