...
use <s/44343s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__44343p03(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\44341s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__44341s02(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\44341s02.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__44341s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\44341s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__44341s02(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\44341s02.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__44341s02(realsolid)],
// 1 16 -182 0 182 0 0 -1 0 1 0 1 0 0 s\44341s05.dat
  [1,16,-182,0,182,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__44341s05(realsolid)],
// 1 16 182 0 182 1 0 0 0 1 0 0 0 1 s\44341s05.dat
  [1,16,182,0,182,1,0,0,0,1,0,0,0,1, ldraw_lib__s__44341s05(realsolid)],
// 1 16 182 0 -182 0 0 1 0 1 0 -1 0 0 s\44341s05.dat
  [1,16,182,0,-182,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__44341s05(realsolid)],
// 1 16 -182 0 -182 -1 0 0 0 1 0 0 0 -1 s\44341s05.dat
  [1,16,-182,0,-182,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__44341s05(realsolid)],
...
module ldraw_lib__44343p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__44343p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
