...
use <s/72514s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__72514p01(realsolid=false) = [
...
// 1 334 0 0 0 1 0 0 0 1 0 0 0 1 s\72514s02.dat
  [1,334,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__72514s02(realsolid)],
// 1 334 0 0 0 -1 0 0 0 1 0 0 0 1 s\72514s02.dat
  [1,334,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__72514s02(realsolid)],
];
module ldraw_lib__72514p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__72514p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
