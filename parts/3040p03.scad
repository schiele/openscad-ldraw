...
use <s/3040s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3040p03(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 3040pb003, phone, telephone
// 
// 0 !CMDLINE -c15
// 
...
// 1 0 0 20 -30 1 0 0 0 1 -.70711 0 0 .70711 s\3040p02s02.dat
  [1,0,0,20,-30,1,0,0,0,1,-.70711,0,0,.70711, ldraw_lib__s__3040p02s02(realsolid)],
];
module ldraw_lib__3040p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3040p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
