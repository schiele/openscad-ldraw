...
use <s/973s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973p83(realsolid=false) = [
...
// 1 0 1.1 24.3 -10 1.2 0 0 0 0 1.2 0 1 0 4-4disc.dat
  [1,0,1.1,24.3,-10,1.2,0,0,0,0,1.2,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 0 1.1 29.6 -10 1.2 0 0 0 0 1.2 0 1 0 4-4disc.dat
  [1,0,1.1,29.6,-10,1.2,0,0,0,0,1.2,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 1.1 24.3 -10 1.2 0 0 0 0 1.2 0 1 0 4-4ndis.dat
  [1,16,1.1,24.3,-10,1.2,0,0,0,0,1.2,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 1.1 29.6 -10 1.2 0 0 0 0 1.2 0 1 0 4-4ndis.dat
  [1,16,1.1,29.6,-10,1.2,0,0,0,0,1.2,0,1,0, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 10.8 17.9 -10 .525 0 0 0 .525 0 0 0 1 s\4865p01b.dat
  [1,16,10.8,17.9,-10,.525,0,0,0,.525,0,0,0,1, ldraw_lib__s__4865p01b(realsolid)],
// 1 0 10.8 17.9 -10 .525 0 0 0 .525 0 0 0 1 s\4865p01c.dat
  [1,0,10.8,17.9,-10,.525,0,0,0,.525,0,0,0,1, ldraw_lib__s__4865p01c(realsolid)],
...
module ldraw_lib__973p83(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p83(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
