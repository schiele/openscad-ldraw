...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\23860s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__23860s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\23860s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__23860s01()],
// 0 // Primitives
...
// 1 16 0 -10 0 4 0 0 0 -1 0 0 0 7.125 rect.dat
  [1,16,0,-10,0,4,0,0,0,-1,0,0,0,7.125, ldraw_lib__rect()],
];
module ldraw_lib__23860(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__23860(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
