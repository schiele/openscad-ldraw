...
use <../p/stud2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__25893(realsolid=false) = [
...
// 1 16 0 3 0 -10 0 0 0 -1 0 0 0 10 4-4disc.dat
  [1,16,0,3,0,-10,0,0,0,-1,0,0,0,10, ldraw_lib__4_4disc(realsolid)],
...
// 1 16 0 3 0 9.6 0 0 0 3.61797 0 0 0 2 box4o4a.dat
  [1,16,0,3,0,9.6,0,0,0,3.61797,0,0,0,2, ldraw_lib__box4o4a(realsolid)],
...
module ldraw_lib__25893(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__25893(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
