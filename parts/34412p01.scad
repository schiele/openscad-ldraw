...
use <973.scad>
$fa=1; $fs=0.2;
function ldraw_lib__34412p01(realsolid=false) = [
...
// 1 179 -15.552 9 0 0.985 -0.17 0 0.17 0.985 0 0 0 1 34335.dat
  [1,179,-15.552,9,0,0.985,-0.17,0,0.17,0.985,0,0,0,1, ldraw_lib__34335(realsolid)],
...
module ldraw_lib__34412p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__34412p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__34412p01(line=0.2);