...
use <s/61406s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__61406p03(realsolid=false) = [
...
// 1 350 0 0 0 1 0 0 0 1 0 0 0 1 s\61406s01.dat
  [1,350,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__61406s01(realsolid)],
...
module ldraw_lib__61406p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__61406p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
