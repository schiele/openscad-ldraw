...
use <../p/box5-12.scad>
$fa=1; $fs=0.2;
function ldraw_lib__004488c(realsolid=false) = [
// 0 Sticker  1 x  6 with White "POLICE" on Blue Background
// 0 Name: 004488c.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS dock, harbor, port, set 364, wharf
// 
...
// 1 1 -26.5 -.25 2.5 0 0 4.3 0 1 0 -4.5 0 0 2-4ndis.dat
  [1,1,-26.5,-.25,2.5,0,0,4.3,0,1,0,-4.5,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 1 -27.2 -.25 2.5 0 0 2 0 1 0 -2 0 0 2-4disc.dat
  [1,1,-27.2,-.25,2.5,0,0,2,0,1,0,-2,0,0, ldraw_lib__2_4disc(realsolid)],
// 0 // White
// 1 15 -27.2 -.25 2.5 0 0 2 0 1 0 -2 0 0 2-4ndis.dat
  [1,15,-27.2,-.25,2.5,0,0,2,0,1,0,-2,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 15 -26.5 -.25 2.5 4.3 0 0 0 1 0 0 0 4.5 1-4chrd.dat
  [1,15,-26.5,-.25,2.5,4.3,0,0,0,1,0,0,0,4.5, ldraw_lib__1_4chrd(realsolid)],
// 1 15 -26.5 -.25 2.5 0 0 4.3 0 1 0 -4.5 0 0 1-4chrd.dat
  [1,15,-26.5,-.25,2.5,0,0,4.3,0,1,0,-4.5,0,0, ldraw_lib__1_4chrd(realsolid)],
...
// 1 1 -15 -.25 0 6.6 0 0 0 1 0 0 0 7.2 4-4ndis.dat
  [1,1,-15,-.25,0,6.6,0,0,0,1,0,0,0,7.2, ldraw_lib__4_4ndis(realsolid)],
// 1 1 -15 -.25 0 3.5 0 0 0 1 0 0 0 4.6 4-4disc.dat
  [1,1,-15,-.25,0,3.5,0,0,0,1,0,0,0,4.6, ldraw_lib__4_4disc(realsolid)],
// 0 // White
// 1 15 -15 -.25 0 4.66691 0 -4.66691 0 1 0 5.09 0 5.09 1-4chrd.dat
  [1,15,-15,-.25,0,4.66691,0,-4.66691,0,1,0,5.09,0,5.09, ldraw_lib__1_4chrd(realsolid)],
// 1 15 -15 -.25 0 3.5 0 0 0 1 0 0 0 4.6 4-4ndis.dat
  [1,15,-15,-.25,0,3.5,0,0,0,1,0,0,0,4.6, ldraw_lib__4_4ndis(realsolid)],
// 1 15 -15 -.25 0 -4.66691 0 4.66691 0 1 0 -5.09 0 -5.09 1-4chrd.dat
  [1,15,-15,-.25,0,-4.66691,0,4.66691,0,1,0,-5.09,0,-5.09, ldraw_lib__1_4chrd(realsolid)],
// 1 15 -15 -.25 0 -4.6669 0 -4.6669 0 1 0 5.09 0 -5.09 1-4chrd.dat
  [1,15,-15,-.25,0,-4.6669,0,-4.6669,0,1,0,5.09,0,-5.09, ldraw_lib__1_4chrd(realsolid)],
// 1 15 -15 -.25 0 4.6669 0 4.6669 0 1 0 -5.09 0 5.09 1-4chrd.dat
  [1,15,-15,-.25,0,4.6669,0,4.6669,0,1,0,-5.09,0,5.09, ldraw_lib__1_4chrd(realsolid)],
...
// 1 1 14.8 -.25 0 0 0 -6.5 0 1 0 7.2 0 0 2-4ndis.dat
  [1,1,14.8,-.25,0,0,0,-6.5,0,1,0,7.2,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 1 14.8 -.25 0 0 0 -3.5 0 1 0 4.6 0 0 2-4disc.dat
  [1,1,14.8,-.25,0,0,0,-3.5,0,1,0,4.6,0,0, ldraw_lib__2_4disc(realsolid)],
// 1 1 14.8 -.25 2.4 2.8 0 0 0 1 0 0 0 2.2 1-4chrd.dat
  [1,1,14.8,-.25,2.4,2.8,0,0,0,1,0,0,0,2.2, ldraw_lib__1_4chrd(realsolid)],
// 1 1 14.8 -.25 -2.2 0 0 2.8 0 1 0 -2.4 0 0 1-4chrd.dat
  [1,1,14.8,-.25,-2.2,0,0,2.8,0,1,0,-2.4,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 1 14.8 -.25 2.4 5.8 0 0 0 1 0 0 0 4.8 1-4ndis.dat
  [1,1,14.8,-.25,2.4,5.8,0,0,0,1,0,0,0,4.8, ldraw_lib__1_4ndis(realsolid)],
// 1 1 14.8 -.25 -2.2 0 0 5.8 0 1 0 -5 0 0 1-4ndis.dat
  [1,1,14.8,-.25,-2.2,0,0,5.8,0,1,0,-5,0,0, ldraw_lib__1_4ndis(realsolid)],
// 0 // White
// 1 15 14.8 -.25 0 0 0 -3.5 0 1 0 4.6 0 0 2-4ndis.dat
  [1,15,14.8,-.25,0,0,0,-3.5,0,1,0,4.6,0,0, ldraw_lib__2_4ndis(realsolid)],
// 1 15 14.8 -.25 0 0 0 -6.5 0 1 0 7.2 0 0 1-8chrd.dat
  [1,15,14.8,-.25,0,0,0,-6.5,0,1,0,7.2,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 15 14.8 -.25 0 0 0 -6.5 0 1 0 -7.2 0 0 1-8chrd.dat
  [1,15,14.8,-.25,0,0,0,-6.5,0,1,0,-7.2,0,0, ldraw_lib__1_8chrd(realsolid)],
// 1 15 14.8 -.25 0 -6.5 0 0 0 1 0 0 0 7.2 1-8chrd.dat
  [1,15,14.8,-.25,0,-6.5,0,0,0,1,0,0,0,7.2, ldraw_lib__1_8chrd(realsolid)],
// 1 15 14.8 -.25 0 -6.5 0 0 0 1 0 0 0 -7.2 1-8chrd.dat
  [1,15,14.8,-.25,0,-6.5,0,0,0,1,0,0,0,-7.2, ldraw_lib__1_8chrd(realsolid)],
// 
// 1 15 14.8 -.25 2.4 2.8 0 0 0 1 0 0 0 2.2 1-4ndis.dat
  [1,15,14.8,-.25,2.4,2.8,0,0,0,1,0,0,0,2.2, ldraw_lib__1_4ndis(realsolid)],
// 1 15 14.8 -.25 -2.2 0 0 2.8 0 1 0 -2.4 0 0 1-4ndis.dat
  [1,15,14.8,-.25,-2.2,0,0,2.8,0,1,0,-2.4,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 15 14.8 -.25 2.4 5.8 0 0 0 1 0 0 0 4.8 1-4chrd.dat
  [1,15,14.8,-.25,2.4,5.8,0,0,0,1,0,0,0,4.8, ldraw_lib__1_4chrd(realsolid)],
// 1 15 14.8 -.25 -2.2 0 0 5.8 0 1 0 -5 0 0 1-4chrd.dat
  [1,15,14.8,-.25,-2.2,0,0,5.8,0,1,0,-5,0,0, ldraw_lib__1_4chrd(realsolid)],
// 
...
// 4 1 32.5 -.25 4.5 31.6 -.25 1.9 31.6 -.25 -.7 32.6 -.25 -4.3
  [4,1,32.5,-.25,4.5,31.6,-.25,1.9,31.6,-.25,-.7,32.6,-.25,-4.3],
// 3 1 0 -.25 10 -3.5 -.25 7 3.8 -.25 7
  [3,1,0,-.25,10,-3.5,-.25,7,3.8,-.25,7],
// 4 1 -6.5 -.25 7 -3.5 -.25 7 0 -.25 10 -8.4 -.25 7.2
  [4,1,-6.5,-.25,7,-3.5,-.25,7,0,-.25,10,-8.4,-.25,7.2],
// 4 1 -21.6 -.25 7.2 -8.4 -.25 7.2 0 -.25 10 -30 -.25 10
  [4,1,-21.6,-.25,7.2,-8.4,-.25,7.2,0,-.25,10,-30,-.25,10],
// 4 1 -22.2 -.25 7 -21.6 -.25 7.2 -30 -.25 10 -26.5 -.25 7
  [4,1,-22.2,-.25,7,-21.6,-.25,7.2,-30,-.25,10,-26.5,-.25,7],
// 4 1 -32.5 -.25 7 -26.5 -.25 7 -30 -.25 10 -60 -.25 10
  [4,1,-32.5,-.25,7,-26.5,-.25,7,-30,-.25,10,-60,-.25,10],
// 4 1 -32.5 -.25 -7 -32.5 -.25 7 -60 -.25 10 -60 -.25 -10
  [4,1,-32.5,-.25,-7,-32.5,-.25,7,-60,-.25,10,-60,-.25,-10],
// 4 1 -32.5 -.25 -7 -60 -.25 -10 -30 -.25 -10 -29.5 -.25 -7
  [4,1,-32.5,-.25,-7,-60,-.25,-10,-30,-.25,-10,-29.5,-.25,-7],
// 4 1 -21.6 -.25 -7.2 -29.5 -.25 -7 -30 -.25 -10 0 -.25 -10
  [4,1,-21.6,-.25,-7.2,-29.5,-.25,-7,-30,-.25,-10,0,-.25,-10],
// 3 1 -8.4 -.25 -7.2 -21.6 -.25 -7.2 0 -.25 -10
  [3,1,-8.4,-.25,-7.2,-21.6,-.25,-7.2,0,-.25,-10],
// 4 1 -6.5 -.25 -7 -8.4 -.25 -7.2 0 -.25 -10 2.8 -.25 -7
  [4,1,-6.5,-.25,-7,-8.4,-.25,-7.2,0,-.25,-10,2.8,-.25,-7],
// 3 1 3.8 -.25 -7 2.8 -.25 -7 0 -.25 -10
  [3,1,3.8,-.25,-7,2.8,-.25,-7,0,-.25,-10],
// 4 1 6.8 -.25 -7 3.8 -.25 -7 0 -.25 -10 8.3 -.25 -7.2
  [4,1,6.8,-.25,-7,3.8,-.25,-7,0,-.25,-10,8.3,-.25,-7.2],
// 4 1 20.6 -.25 -7.2 8.3 -.25 -7.2 0 -.25 -10 30 -.25 -10
  [4,1,20.6,-.25,-7.2,8.3,-.25,-7.2,0,-.25,-10,30,-.25,-10],
// 4 1 22.4 -.25 -7 20.6 -.25 -7.2 30 -.25 -10 32.6 -.25 -7
  [4,1,22.4,-.25,-7,20.6,-.25,-7.2,30,-.25,-10,32.6,-.25,-7],
// 3 1 32.6 -.25 -7 30 -.25 -10 60 -.25 -10
  [3,1,32.6,-.25,-7,30,-.25,-10,60,-.25,-10],
// 4 1 32.6 -.25 -4.3 32.6 -.25 -7 60 -.25 -10 60 -.25 10
  [4,1,32.6,-.25,-4.3,32.6,-.25,-7,60,-.25,-10,60,-.25,10],
// 4 1 32.5 -.25 4.5 32.6 -.25 -4.3 60 -.25 10 32.5 -.25 7
  [4,1,32.5,-.25,4.5,32.6,-.25,-4.3,60,-.25,10,32.5,-.25,7],
// 4 1 32.5 -.25 7 60 -.25 10 30 -.25 10 22.4 -.25 7
  [4,1,32.5,-.25,7,60,-.25,10,30,-.25,10,22.4,-.25,7],
// 3 1 30 -.25 10 20.6 -.25 7.2 22.4 -.25 7
  [3,1,30,-.25,10,20.6,-.25,7.2,22.4,-.25,7],
// 4 1 8.3 -.25 7.2 20.6 -.25 7.2 30 -.25 10 0 -.25 10
  [4,1,8.3,-.25,7.2,20.6,-.25,7.2,30,-.25,10,0,-.25,10],
// 4 1 6.8 -.25 7 8.3 -.25 7.2 0 -.25 10 3.8 -.25 7
  [4,1,6.8,-.25,7,8.3,-.25,7.2,0,-.25,10,3.8,-.25,7],
// 
// 0 // Small Box
// 1 16 0 -0.25 0 60 0 0 0 0.25 0 0 0 10 box5-12.dat
  [1,16,0,-0.25,0,60,0,0,0,0.25,0,0,0,10, ldraw_lib__box5_12(realsolid)],
];
module ldraw_lib__004488c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__004488c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__004488c(line=0.2);