...
$fa=1; $fs=0.2;
function ldraw_lib__821435b(realsolid=false) = [
...
// 1 15 -8.5 -.25 -1.25 12 0 0 0 1 0 0 0 12 type-swiss721bt-bold-n1.dat
  [1,15,-8.5,-.25,-1.25,12,0,0,0,1,0,0,0,12, ldraw_lib__type_swiss721bt_bold_n1(realsolid)],
...
module ldraw_lib__821435b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__821435b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
