...
use <s/91884s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__91884p03(realsolid=false) = [
...
// 1 16 0 0 -9 1 0 0 0 0 -1 0 1 0 s\91884p03s01.dat
  [1,16,0,0,-9,1,0,0,0,0,-1,0,1,0, ldraw_lib__s__91884p03s01(realsolid)],
// 1 16 0 0 -9 1 0 0 0 0 1 0 1 0 s\91884p03s01.dat
  [1,16,0,0,-9,1,0,0,0,0,1,0,1,0, ldraw_lib__s__91884p03s01(realsolid)],
];
module ldraw_lib__91884p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__91884p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
