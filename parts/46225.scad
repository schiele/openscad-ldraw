...
use <../p/axlehole.scad>
$fa=1; $fs=0.2;
function ldraw_lib__46225(realsolid=false) = [
...
// 1 16 0 0 -20 9 0 0 0 0 9 0 18 0 4-4cyli.dat
  [1,16,0,0,-20,9,0,0,0,0,9,0,18,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 2 9 0 0 0 0 9 0 18 0 4-4cyli.dat
  [1,16,0,0,2,9,0,0,0,0,9,0,18,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 0 -5 16 0 0 0 0 16 0 10 0 4-4cyli.dat
  [1,16,0,0,-5,16,0,0,0,0,16,0,10,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -5 16 0 0 0 0 16 0 1 0 4-4edge.dat
  [1,16,0,0,-5,16,0,0,0,0,16,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 5 16 0 0 0 0 16 0 1 0 4-4edge.dat
  [1,16,0,0,5,16,0,0,0,0,16,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -5 2 0 0 0 0 2 0 1 0 4-4ring7.dat
  [1,16,0,0,-5,2,0,0,0,0,2,0,1,0, ldraw_lib__4_4ring7(realsolid)],
// 1 16 0 0 -9 2 0 0 0 0 2 0 1 0 4-4ring6.dat
  [1,16,0,0,-9,2,0,0,0,0,2,0,1,0, ldraw_lib__4_4ring6(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 9 2 0 0 0 0 2 0 1 0 4-4ring6.dat
  [1,16,0,0,9,2,0,0,0,0,2,0,1,0, ldraw_lib__4_4ring6(realsolid)],
...
// 1 16 0 0 -9 12 0 0 0 0 12 0 7 0 4-4cyli.dat
  [1,16,0,0,-9,12,0,0,0,0,12,0,7,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -9 14 0 0 0 0 14 0 4 0 4-4cyli.dat
  [1,16,0,0,-9,14,0,0,0,0,14,0,4,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 5 14 0 0 0 0 14 0 4 0 4-4cyli.dat
  [1,16,0,0,5,14,0,0,0,0,14,0,4,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 2 12 0 0 0 0 12 0 7 0 4-4cyli.dat
  [1,16,0,0,2,12,0,0,0,0,12,0,7,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -9 12 0 0 0 0 12 0 1 0 4-4edge.dat
  [1,16,0,0,-9,12,0,0,0,0,12,0,1,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 -5 14 0 0 0 0 14 0 1 0 4-4edge.dat
  [1,16,0,0,-5,14,0,0,0,0,14,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -9 14 0 0 0 0 14 0 1 0 4-4edge.dat
  [1,16,0,0,-9,14,0,0,0,0,14,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 5 14 0 0 0 0 14 0 1 0 4-4edge.dat
  [1,16,0,0,5,14,0,0,0,0,14,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 9 14 0 0 0 0 14 0 1 0 4-4edge.dat
  [1,16,0,0,9,14,0,0,0,0,14,0,1,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 2 3 0 0 0 0 3 0 1 0 4-4ring3.dat
  [1,16,0,0,2,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4ring3(realsolid)],
// 1 16 0 0 -2 3 0 0 0 0 3 0 1 0 4-4ring3.dat
  [1,16,0,0,-2,3,0,0,0,0,3,0,1,0, ldraw_lib__4_4ring3(realsolid)],
...
module ldraw_lib__46225(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__46225(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
