...
use <s/30103s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30103(realsolid=false) = [
// 0 Animal Bat
// 0 Name: 30103.dat
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\30103s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30103s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30103s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30103s01(realsolid)],
// 
...
// 1 16 0 -16 0 3 0 0 0 1 0 0 0 3 4-4edge.dat
  [1,16,0,-16,0,3,0,0,0,1,0,0,0,3, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 -6 0 4 0 0 0 -10 0 0 0 4 4-4cyli.dat
  [1,16,0,-6,0,4,0,0,0,-10,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -16 0 3 0 0 0 -10 0 0 0 3 4-4cyli.dat
  [1,16,0,-16,0,3,0,0,0,-10,0,0,0,3, ldraw_lib__4_4cyli(realsolid)],
// 
...
// 1 16 0 -16 0 1 0 0 0 -1 0 0 0 1 4-4ring3.dat
  [1,16,0,-16,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__4_4ring3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -26 0 3 0 0 0 -1 0 0 0 3 4-4con0.dat
  [1,16,0,-26,0,3,0,0,0,-1,0,0,0,3, ldraw_lib__4_4con0(realsolid)],
// 
// 0
];
module ldraw_lib__30103(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30103(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
