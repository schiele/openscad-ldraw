...
$fa=1; $fs=0.2;
function ldraw_lib__22885(realsolid=false) = [
...
// 1 16 -6.5 22 0 0 -9.5 0 18 0 0 0 0 6 box3u4a.dat
  [1,16,-6.5,22,0,0,-9.5,0,18,0,0,0,0,6, ldraw_lib__box3u4a(realsolid)],
// 1 16 -5 4 5.5 0 0 -1.5 0 36 0 0.5 0 0 box3u6.dat
  [1,16,-5,4,5.5,0,0,-1.5,0,36,0,0.5,0,0, ldraw_lib__box3u6(realsolid)],
// 3 16 -3.5 40 5 -5 40 3.5 -6.5 40 5
  [3,16,-3.5,40,5,-5,40,3.5,-6.5,40,5],
// 1 16 -5 22 5 0 0.75 -0.75 18 0 0 0 -0.75 -0.75 box2-5.dat
  [1,16,-5,22,5,0,0.75,-0.75,18,0,0,0,-0.75,-0.75, ldraw_lib__box2_5(realsolid)],
// 1 16 -5 4 -5.5 0 0 1.5 0 36 0 -0.5 0 0 box3u6.dat
  [1,16,-5,4,-5.5,0,0,1.5,0,36,0,-0.5,0,0, ldraw_lib__box3u6(realsolid)],
...
// 1 16 0 22 6 3.5 0 0 0 0 -18 0 1 0 rect2p.dat
  [1,16,0,22,6,3.5,0,0,0,0,-18,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 22 -6 -3.5 0 0 0 0 -18 0 -1 0 rect2p.dat
  [1,16,0,22,-6,-3.5,0,0,0,0,-18,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 5 4 5.5 0 0 -1.5 0 36 0 0.5 0 0 box3u6.dat
  [1,16,5,4,5.5,0,0,-1.5,0,36,0,0.5,0,0, ldraw_lib__box3u6(realsolid)],
...
// 1 16 0 40 0 20 0 0 0 -40 0 0 0 10 box5.dat
  [1,16,0,40,0,20,0,0,0,-40,0,0,0,10, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__22885(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__22885(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
