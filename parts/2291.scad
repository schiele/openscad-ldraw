...
use <../p/stud8.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2291(realsolid=false) = [
// 0 Duplo Brick  2 x 10
// 0 Name: 2291.dat
...
// 
// 
// 1 16 160 4 0 1 0 0 0 -10 0 0 0 1 stud8.dat
  [1,16,160,4,0,1,0,0,0,-10,0,0,0,1, ldraw_lib__stud8(realsolid)],
// 1 16 120 4 0 1 0 0 0 -10 0 0 0 1 stud8.dat
  [1,16,120,4,0,1,0,0,0,-10,0,0,0,1, ldraw_lib__stud8(realsolid)],
...
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 48 0 196 0 0 0 -44 0 0 0 36 box5.dat
  [1,16,0,48,0,196,0,0,0,-44,0,0,0,36, ldraw_lib__box5(realsolid)],
...
// 4 16 200 48 -40 196 48 -36 196 48 36 200 48 40
  [4,16,200,48,-40,196,48,-36,196,48,36,200,48,40],
// 1 16 0 48 0 200 0 0 0 -48 0 0 0 40 box5.dat
  [1,16,0,48,0,200,0,0,0,-48,0,0,0,40, ldraw_lib__box5(realsolid)],
// 1 16 180 0 20 1 0 0 0 2.75 0 0 0 1 stud7.dat
  [1,16,180,0,20,1,0,0,0,2.75,0,0,0,1, ldraw_lib__stud7(realsolid)],
...
// 1 16 -180 0 -20 1 0 0 0 2.75 0 0 0 1 stud7.dat
  [1,16,-180,0,-20,1,0,0,0,2.75,0,0,0,1, ldraw_lib__stud7(realsolid)],
// 1 16 180 4 -34 1.5 0 0 0 43 0 0 0 2 box4-1.dat
  [1,16,180,4,-34,1.5,0,0,0,43,0,0,0,2, ldraw_lib__box4_1(realsolid)],
// 1 16 140 4 -34 1.5 0 0 0 43 0 0 0 2 box4-1.dat
  [1,16,140,4,-34,1.5,0,0,0,43,0,0,0,2, ldraw_lib__box4_1(realsolid)],
...
// 1 16 -180 4 34 1.5 0 0 0 43 0 0 0 -2 box4-1.dat
  [1,16,-180,4,34,1.5,0,0,0,43,0,0,0,-2, ldraw_lib__box4_1(realsolid)],
// 1 16 -194 4 -20 0 0 2 0 43 0 -1.5 0 0 box4-1.dat
  [1,16,-194,4,-20,0,0,2,0,43,0,-1.5,0,0, ldraw_lib__box4_1(realsolid)],
// 1 16 194 4 -20 0 0 -2 0 43 0 1.5 0 0 box4-1.dat
  [1,16,194,4,-20,0,0,-2,0,43,0,1.5,0,0, ldraw_lib__box4_1(realsolid)],
// 1 16 -194 4 20 0 0 2 0 43 0 -1.5 0 0 box4-1.dat
  [1,16,-194,4,20,0,0,2,0,43,0,-1.5,0,0, ldraw_lib__box4_1(realsolid)],
...
module ldraw_lib__2291(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2291(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2291(line=0.2);