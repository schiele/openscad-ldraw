...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30117p62(realsolid=false) = [
...
// 1 16 0 0 0 0 0 -1 0 1 0 -1 0 0 s\30117p61s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,-1,0,0, ldraw_lib__s__30117p61s01(realsolid)],
// 0 BFC CLIP
  [0,"BFC","CLIP"],
];
module ldraw_lib__30117p62(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30117p62(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
