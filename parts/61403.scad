...
// 1 16 0 0 10 8 0 0 0 0 8 0 -1 0 48\4-4aring.dat
  [1,16,0,0,10,8,0,0,0,0,8,0,-1,0, ldraw_lib__48__4_4aring()],
// 1 16 0 0 -10 1 0 0 0 0 -1 0 1 0 peghole.dat
  [1,16,0,0,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__peghole()],
// 1 16 0 0 -10 8 0 0 0 0 -8 0 1 0 48\4-4aring.dat
  [1,16,0,0,-10,8,0,0,0,0,-8,0,1,0, ldraw_lib__48__4_4aring()],
...
// 1 16 0 0 -10 1 0 0 0 0 -1 0 1 0 48\4-4ring8.dat
  [1,16,0,0,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__48__4_4ring8()],
// 1 16 0 0 10 1 0 0 0 0 1 0 -1 0 48\4-4ring8.dat
  [1,16,0,0,10,1,0,0,0,0,1,0,-1,0, ldraw_lib__48__4_4ring8()],
// 1 16 0 0 -10 9 0 0 0 0 -9 0 1 0 48\4-4edge.dat
  [1,16,0,0,-10,9,0,0,0,0,-9,0,1,0, ldraw_lib__48__4_4edge()],
// 1 16 0 0 10 9 0 0 0 0 -9 0 1 0 48\4-4edge.dat
  [1,16,0,0,10,9,0,0,0,0,-9,0,1,0, ldraw_lib__48__4_4edge()],
// 1 16 0 0 1.5 9 0 0 0 0 -9 0 1 0 48\4-4edge.dat
  [1,16,0,0,1.5,9,0,0,0,0,-9,0,1,0, ldraw_lib__48__4_4edge()],
// 1 16 0 0 -1.5 9 0 0 0 0 -9 0 1 0 48\4-4edge.dat
  [1,16,0,0,-1.5,9,0,0,0,0,-9,0,1,0, ldraw_lib__48__4_4edge()],
// 1 16 0 0 -10 9 0 0 0 0 -9 0 8.5 0 48\4-4cyli.dat
  [1,16,0,0,-10,9,0,0,0,0,-9,0,8.5,0, ldraw_lib__48__4_4cyli()],
// 1 16 0 0 1.5 9 0 0 0 0 -9 0 8.5 0 48\4-4cyli.dat
  [1,16,0,0,1.5,9,0,0,0,0,-9,0,8.5,0, ldraw_lib__48__4_4cyli()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\61403s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__61403s01()],
// 1 16 0 0 0 -0.901 0.4339 0 0.4339 0.901 0 0 0 -1 s\61403s01.dat
  [1,16,0,0,0,-0.901,0.4339,0,0.4339,0.901,0,0,0,-1, ldraw_lib__s__61403s01()],
// 1 16 0 0 0 -0.6235 0.7818 0 0.7818 0.6235 0 0 0 -1 s\61403s01.dat
  [1,16,0,0,0,-0.6235,0.7818,0,0.7818,0.6235,0,0,0,-1, ldraw_lib__s__61403s01()],
// 1 16 0 0 0 -0.2225 0.9749 0 0.9749 0.2225 0 0 0 -1 s\61403s01.dat
  [1,16,0,0,0,-0.2225,0.9749,0,0.9749,0.2225,0,0,0,-1, ldraw_lib__s__61403s01()],
// 1 16 0 0 0 0.2225 0.9749 0 0.9749 -0.2225 0 0 0 -1 s\61403s01.dat
  [1,16,0,0,0,0.2225,0.9749,0,0.9749,-0.2225,0,0,0,-1, ldraw_lib__s__61403s01()],
// 1 16 0 0 0 0.6235 0.7818 0 0.7818 -0.6235 0 0 0 -1 s\61403s01.dat
  [1,16,0,0,0,0.6235,0.7818,0,0.7818,-0.6235,0,0,0,-1, ldraw_lib__s__61403s01()],
...
module ldraw_lib__61403(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__61403(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
