...
use <s/98570s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98570p01(realsolid=false) = [
...
// 1 71 0 10 -14.9 14.25 0 0 0 0 14.25 0 1 0 4-4disc.dat
  [1,71,0,10,-14.9,14.25,0,0,0,0,14.25,0,1,0, ldraw_lib__4_4disc(realsolid)],
];
module ldraw_lib__98570p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98570p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
