...
use <../p/tri3a4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__26601(realsolid=false) = [
...
// 1 16 -16 8 -16 14.3432 0 0 0 -4 0 0 0 32 tri3a4.dat
  [1,16,-16,8,-16,14.3432,0,0,0,-4,0,0,0,32, ldraw_lib__tri3a4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 16 8 16 0 0 -32 0 -4 0 -14.3432 0 0 tri3a4.dat
  [1,16,16,8,16,0,0,-32,0,-4,0,-14.3432,0,0, ldraw_lib__tri3a4(realsolid)],
// 1 16 15.1213 6 -2.0503 0 -2.2929 -1.4142 2 0 0 0 -2.2929 1.4142 box2-5.dat
  [1,16,15.1213,6,-2.0503,0,-2.2929,-1.4142,2,0,0,0,-2.2929,1.4142, ldraw_lib__box2_5(realsolid)],
// 1 16 2.0503 6 -15.1213 0 2.2929 -1.4142 2 0 0 0 2.2929 1.4142 box2-5.dat
  [1,16,2.0503,6,-15.1213,0,2.2929,-1.4142,2,0,0,0,2.2929,1.4142, ldraw_lib__box2_5(realsolid)],
// 1 16 8.5858 4 -8.5858 1.4142 0 -4.2426 0 -1 0 -1.4142 0 -4.2426 rect1.dat
  [1,16,8.5858,4,-8.5858,1.4142,0,-4.2426,0,-1,0,-1.4142,0,-4.2426, ldraw_lib__rect1(realsolid)],
...
// 1 16 10 4 -10 10 -1 0 0 0 -4 10 0 0 recte3.dat
  [1,16,10,4,-10,10,-1,0,0,0,-4,10,0,0, ldraw_lib__recte3(realsolid)],
...
// 1 16 -20 8 -20 20 0 0 0 -8 0 0 0 40 tri3a4.dat
  [1,16,-20,8,-20,20,0,0,0,-8,0,0,0,40, ldraw_lib__tri3a4(realsolid)],
// 1 16 20 8 20 0 0 -40 0 -8 0 -20 0 0 tri3a4.dat
  [1,16,20,8,20,0,0,-40,0,-8,0,-20,0,0, ldraw_lib__tri3a4(realsolid)],
// 
...
module ldraw_lib__26601(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__26601(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
