...
use <s/3005s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3005pt0(realsolid=false) = [
...
// 1 16 0 12 -10 0 0 -4.8 -5 0 0 0 1 0 4-4disc.dat
  [1,16,0,12,-10,0,0,-4.8,-5,0,0,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 1 0 12 -10 0 0 -1.36 -1.4 0 0 0 1 0 ring4.dat
  [1,1,0,12,-10,0,0,-1.36,-1.4,0,0,0,1,0, ldraw_lib__ring4(realsolid)],
// 1 1 0 12 -10 0 0 -1.2 -1.25 0 0 0 1 0 ring4.dat
  [1,1,0,12,-10,0,0,-1.2,-1.25,0,0,0,1,0, ldraw_lib__ring4(realsolid)],
// 1 16 0 12 -10 0 0 -6.8 -7 0 0 0 1 0 4-4ndis.dat
  [1,16,0,12,-10,0,0,-6.8,-7,0,0,0,1,0, ldraw_lib__4_4ndis(realsolid)],
...
module ldraw_lib__3005pt0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3005pt0(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
