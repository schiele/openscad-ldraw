...
use <../p/stug-2x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4616a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\4616s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4616s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\4616s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__4616s01(realsolid)],
...
// 1 16 0 44 0 -1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,44,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 20 44 0 -1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,20,44,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 -20 44 0 -1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,-20,44,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4(realsolid)],
// 1 16 0 24 -16 7 0 0 0 0 -7 0 11 0 4-4cylo.dat
  [1,16,0,24,-16,7,0,0,0,0,-7,0,11,0, ldraw_lib__4_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 24 -20 3 0 0 0 0 -3 0 15 0 4-4cylo.dat
  [1,16,0,24,-20,3,0,0,0,0,-3,0,15,0, ldraw_lib__4_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 24 -39 4 0 0 0 0 -4 0 19 0 4-4cylo.dat
  [1,16,0,24,-39,4,0,0,0,0,-4,0,19,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 24 -40 7 0 0 0 0 -7 0 2 0 4-4cyli.dat
  [1,16,0,24,-40,7,0,0,0,0,-7,0,2,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 24 -40 6 0 0 0 0 -6 0 1 0 4-4cyli.dat
  [1,16,0,24,-40,6,0,0,0,0,-6,0,1,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 24 -40 1 0 0 0 0 -1 0 1 0 4-4ring6.dat
  [1,16,0,24,-40,1,0,0,0,0,-1,0,1,0, ldraw_lib__4_4ring6(realsolid)],
// 1 16 0 24 -40 7 0 0 0 0 -7 0 7 0 4-4edge.dat
  [1,16,0,24,-40,7,0,0,0,0,-7,0,7,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 24 -40 6 0 0 0 0 -6 0 6 0 4-4edge.dat
  [1,16,0,24,-40,6,0,0,0,0,-6,0,6,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 24 -39 6 0 0 0 0 -6 0 6 0 4-4edge.dat
  [1,16,0,24,-39,6,0,0,0,0,-6,0,6,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 24 -39 2 0 0 0 0 -2 0 1 0 4-4ring2.dat
  [1,16,0,24,-39,2,0,0,0,0,-2,0,1,0, ldraw_lib__4_4ring2(realsolid)],
// 1 16 0 24 -20 1 0 0 0 0 -1 0 1 0 4-4ring3.dat
  [1,16,0,24,-20,1,0,0,0,0,-1,0,1,0, ldraw_lib__4_4ring3(realsolid)],
// 1 16 0 24 -5 -3 0 0 0 0 -3 0 -1 0 4-4ring1.dat
  [1,16,0,24,-5,-3,0,0,0,0,-3,0,-1,0, ldraw_lib__4_4ring1(realsolid)],
// 1 16 0 24 -5 -1 0 0 0 0 -1 0 -1 0 4-4ring6.dat
  [1,16,0,24,-5,-1,0,0,0,0,-1,0,-1,0, ldraw_lib__4_4ring6(realsolid)],
...
// 1 16 0 24 -38 4.95 0 4.95 4.95 0 -4.95 0 1 0 1-4edge.dat
  [1,16,0,24,-38,4.95,0,4.95,4.95,0,-4.95,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 24 -38 -4.95 0 -4.95 -4.95 0 4.95 0 1 0 1-4edge.dat
  [1,16,0,24,-38,-4.95,0,-4.95,-4.95,0,4.95,0,1,0, ldraw_lib__1_4edge(realsolid)],
];
module ldraw_lib__4616a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4616a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
