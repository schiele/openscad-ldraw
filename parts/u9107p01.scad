...
use <s/u9107s07.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9107p01(realsolid=false) = [
// 0 ~Figure Fabuland Bear Head  1
// 0 Name: u9107p01.dat
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9107s04.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9107s04(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9107s06.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9107s06(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9107s06.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9107s06(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9107s07.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9107s07(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9107s07.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9107s07(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__u9107p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9107p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9107p01(line=0.2);