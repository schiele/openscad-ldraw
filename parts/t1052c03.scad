...
use <t1058.scad>
$fa=1; $fs=0.2;
function ldraw_lib__t1052c03(realsolid=false) = [
// 0 | Circuit Cubes Geared Motor
// 0 Name: t1052c03.dat
...
// 1 15 0 34 0 -1 0 0 0 1 0 0 0 -1 t1053.dat
  [1,15,0,34,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1053(realsolid)],
// 
// 0 // bottom contacts
...
// 1 494 -30 34 30 -0.70711 0 -0.70711 0 1 0 0.70711 0 -0.70711 t1054.dat
  [1,494,-30,34,30,-0.70711,0,-0.70711,0,1,0,0.70711,0,-0.70711, ldraw_lib__t1054(realsolid)],
// 1 494 30 34 30 0.70711 0 -0.70711 0 1 0 0.70711 0 0.70711 t1054.dat
  [1,494,30,34,30,0.70711,0,-0.70711,0,1,0,0.70711,0,0.70711, ldraw_lib__t1054(realsolid)],
// 
// 0 // Motor Cover
// 1 47 0 29.5 0 -1 0 0 0 1 0 0 0 -1 t1055.dat
  [1,47,0,29.5,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1055(realsolid)],
// 
// 0 // Gear Reduction
// 1 82 0 17 34 -1 0 0 0 1 0 0 0 -1 t1056.dat
  [1,82,0,17,34,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1056(realsolid)],
// 
// 0 // Motor core
// 1 0 0 17 11 -1 0 0 0 1 0 0 0 -1 t1057.dat
  [1,0,0,17,11,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1057(realsolid)],
// 
// 0 // Output shaft
// 1 47 0 18 36 -1 0 0 0 1 0 0 0 -1 t1058.dat
  [1,47,0,18,36,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1058(realsolid)],
];
module ldraw_lib__t1052c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1052c03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__t1052c03(line=0.2);