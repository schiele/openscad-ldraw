...
use <../p/stug-8x8.scad>
$fa=1; $fs=0.2;
function ldraw_lib__10a(realsolid=false) = [
...
// 1 16 -80 0 80 1 0 0 0 1 0 0 0 1 stug-16x16.dat
  [1,16,-80,0,80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_16x16(realsolid)],
...
// 1 16 260 0 220 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,260,0,220,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 1 16 260 0 -220 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,260,0,-220,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
// 1 16 -260 0 220 1 0 0 0 1 0 0 0 1 stug-2x2.dat
  [1,16,-260,0,220,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_2x2(realsolid)],
...
module ldraw_lib__10a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__10a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
