...
use <45590.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4198367(realsolid=false) = [
...
// 1 256 0 0 0 1 0 0 0 1 0 0 0 1 45590.dat
  [1,256,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__45590(realsolid)],
];
module ldraw_lib__4198367(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4198367(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
