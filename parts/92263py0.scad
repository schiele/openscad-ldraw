...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 92263pb002, Hot Rod, Model A, Rebrickable 92263pr0001
...
module ldraw_lib__92263py0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92263py0(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
