...
// 1 16 0 24 0 96 0 0 0 -20 0 0 0 96 box5.dat
  [1,16,0,24,0,96,0,0,0,-20,0,0,0,96, ldraw_lib__box5()],
// 
...
// 1 16 0 24 0 100 0 0 0 -24 0 0 0 100 box5.dat
  [1,16,0,24,0,100,0,0,0,-24,0,0,0,100, ldraw_lib__box5()],
// 
...
module ldraw_lib__733(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__733(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
