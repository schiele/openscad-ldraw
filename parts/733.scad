...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__733(realsolid=false) = [
// 0 Brick 10 x 10
// 0 Name: 733.dat
...
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 24 0 96 0 0 0 -20 0 0 0 96 box5.dat
  [1,16,0,24,0,96,0,0,0,-20,0,0,0,96, ldraw_lib__box5(realsolid)],
// 
// 4 16 -100 24 100 100 24 100 96 24 96 -96 24 96
  [4,16,-100,24,100,100,24,100,96,24,96,-96,24,96],
// 4 16 -100 24 -100 -96 24 -96 96 24 -96 100 24 -100
  [4,16,-100,24,-100,-96,24,-96,96,24,-96,100,24,-100],
// 4 16 -100 24 -100 -100 24 100 -96 24 96 -96 24 -96
  [4,16,-100,24,-100,-100,24,100,-96,24,96,-96,24,-96],
// 4 16 100 24 -100 96 24 -96 96 24 96 100 24 100
  [4,16,100,24,-100,96,24,-96,96,24,96,100,24,100],
// 
// 1 16 0 24 0 100 0 0 0 -24 0 0 0 100 box5.dat
  [1,16,0,24,0,100,0,0,0,-24,0,0,0,100, ldraw_lib__box5(realsolid)],
// 
...
module ldraw_lib__733(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__733(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__733(line=0.2);