...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4536(realsolid=false) = [
...
// 1 16 0 8 -18 -24 0 0 0 0 8 0 -1 0 rect.dat
  [1,16,0,8,-18,-24,0,0,0,0,8,0,-1,0, ldraw_lib__rect(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 4 -2 24 0 0 0 12 0 0 0 16 box4-7a.dat
  [1,16,0,4,-2,24,0,0,0,12,0,0,0,16, ldraw_lib__box4_7a(realsolid)],
...
// 1 16 0 9 -20 -26 0 0 0 0 -9 0 1 0 rect3.dat
  [1,16,0,9,-20,-26,0,0,0,0,-9,0,1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 11 -2 26 0 0 0 7 0 0 0 18 box2-5.dat
  [1,16,0,11,-2,26,0,0,0,7,0,0,0,18, ldraw_lib__box2_5(realsolid)],
...
// 1 16 25 2 -16 1 0 0 0 1 2 0 -1 2 rect.dat
  [1,16,25,2,-16,1,0,0,0,1,2,0,-1,2, ldraw_lib__rect(realsolid)],
// 4 16 -24 4 14 -26 4 16 -26 4 -14 -24 4 -14
  [4,16,-24,4,14,-26,4,16,-26,4,-14,-24,4,-14],
// 1 16 -25 2 -16 -1 0 0 0 1 -2 0 -1 -2 rect.dat
  [1,16,-25,2,-16,-1,0,0,0,1,-2,0,-1,-2, ldraw_lib__rect(realsolid)],
// 1 16 0 0 -19 0 0 -26 0 1 0 1 0 0 rect2p.dat
  [1,16,0,0,-19,0,0,-26,0,1,0,1,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 4 -21 6 0 0 0 1 0 0 0 1 rect.dat
  [1,16,0,4,-21,6,0,0,0,1,0,0,0,1, ldraw_lib__rect(realsolid)],
// 1 16 3 4 -22 3 0 0 0 0 -3 0 1 0 1-4edge.dat
  [1,16,3,4,-22,3,0,0,0,0,-3,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -3 4 -22 -3 0 0 0 0 -3 0 1 0 1-4edge.dat
  [1,16,-3,4,-22,-3,0,0,0,0,-3,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 3 4 -22 0 0 3 -3 0 0 0 -1 0 1-4disc.dat
  [1,16,3,4,-22,0,0,3,-3,0,0,0,-1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 -3 4 -22 0 0 -3 -3 0 0 0 -1 0 1-4disc.dat
  [1,16,-3,4,-22,0,0,-3,-3,0,0,0,-1,0, ldraw_lib__1_4disc(realsolid)],
// 1 16 3 4 -20 3 0 0 0 0 3 0 1 0 1-4edge.dat
  [1,16,3,4,-20,3,0,0,0,0,3,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 -3 4 -20 -3 0 0 0 0 3 0 1 0 1-4edge.dat
  [1,16,-3,4,-20,-3,0,0,0,0,3,0,1,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 3 4 -22 3 0 0 0 0 3 0 2 0 1-4cyli.dat
  [1,16,3,4,-22,3,0,0,0,0,3,0,2,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 -3 4 -22 -3 0 0 0 0 3 0 2 0 1-4cyli.dat
  [1,16,-3,4,-22,-3,0,0,0,0,3,0,2,0, ldraw_lib__1_4cyli(realsolid)],
// 2 24 -3 7 -20 3 7 -20
  [2,24,-3,7,-20,3,7,-20],
// 1 16 3 4 -24 0 0 3 3 0 0 0 1 0 2-4edge.dat
  [1,16,3,4,-24,0,0,3,3,0,0,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -3 4 -24 0 0 -3 3 0 0 0 1 0 2-4edge.dat
  [1,16,-3,4,-24,0,0,-3,3,0,0,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 3 4 -24 0 0 3 3 0 0 0 1 0 2-4disc.dat
  [1,16,3,4,-24,0,0,3,3,0,0,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 -3 4 -24 0 0 -3 -3 0 0 0 1 0 2-4disc.dat
  [1,16,-3,4,-24,0,0,-3,-3,0,0,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 -3 4 -22 0 0 -3 3 0 0 0 -2 0 2-4cyli.dat
  [1,16,-3,4,-22,0,0,-3,3,0,0,0,-2,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 3 4 -24 0 0 3 3 0 0 0 2 0 2-4cyli.dat
  [1,16,3,4,-24,0,0,3,3,0,0,0,2,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 0 4 -22 -3 0 0 0 3 0 0 0 -2 box2-11.dat
  [1,16,0,4,-22,-3,0,0,0,3,0,0,0,-2, ldraw_lib__box2_11(realsolid)],
// 1 16 0 3 -23 -3 0 0 0 -2 0 0 0 1 box2-11.dat
  [1,16,0,3,-23,-3,0,0,0,-2,0,0,0,1, ldraw_lib__box2_11(realsolid)],
// 2 24 -3 1 -24 3 1 -24
  [2,24,-3,1,-24,3,1,-24],
// 0
];
module ldraw_lib__4536(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4536(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
