...
use <../p/rect.scad>
$fa=1; $fs=0.2;
function ldraw_lib__72634(realsolid=false) = [
...
// 1 8 0 24 0 1 0 0 0 1 0 0 0 1 2982.dat
  [1,8,0,24,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2982(realsolid)],
// 1 16 0 24 0 1 0 0 0 1 0 0 0 1 70839.dat
  [1,16,0,24,0,1,0,0,0,1,0,0,0,1, ldraw_lib__70839(realsolid)],
// 0 // cable
// 1 256 -34 22.5 0 0 -2 0 -1 0 0 0 0 1 993.dat
  [1,256,-34,22.5,0,0,-2,0,-1,0,0,0,0,1, ldraw_lib__993(realsolid)],
// 1 256 -36 22.5 1.3858 0 1 0 -0.574 0 -1.3858 -1.3858 0 0.574 7-8chrd.dat
  [1,256,-36,22.5,1.3858,0,1,0,-0.574,0,-1.3858,-1.3858,0,0.574, ldraw_lib__7_8chrd(realsolid)],
// 1 256 -36 22.5 -1.3858 0 1 0 0.574 0 1.3858 1.3858 0 -0.574 7-8chrd.dat
  [1,256,-36,22.5,-1.3858,0,1,0,0.574,0,1.3858,1.3858,0,-0.574, ldraw_lib__7_8chrd(realsolid)],
// 1 0 -34 22 0 0 1 0 -2 0 0 0 0 4.5 rect.dat
  [1,0,-34,22,0,0,1,0,-2,0,0,0,0,4.5, ldraw_lib__rect(realsolid)],
];
module ldraw_lib__72634(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__72634(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
