...
use <4253.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4253c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 4253.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4253(realsolid)],
// 1 16 0 66 40 1 0 0 0 1 0 0 0 1 4252.dat
  [1,16,0,66,40,1,0,0,0,1,0,0,0,1, ldraw_lib__4252(realsolid)],
];
module ldraw_lib__4253c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4253c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
