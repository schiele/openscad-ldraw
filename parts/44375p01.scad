...
use <44375aps1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__44375p01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 44375aps1.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__44375aps1(realsolid)],
];
module ldraw_lib__44375p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__44375p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
