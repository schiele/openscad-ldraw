...
// 1 16 -410 0 410 1 0 0 0 1 0 0 0 1 stug9.dat
  [1,16,-410,0,410,1,0,0,0,1,0,0,0,1, ldraw_lib__stug9()],
// 1 16 -410 0 -410 1 0 0 0 1 0 0 0 1 stug9.dat
  [1,16,-410,0,-410,1,0,0,0,1,0,0,0,1, ldraw_lib__stug9()],
// 1 16 -230 0 -410 1 0 0 0 1 0 0 0 1 stug9.dat
  [1,16,-230,0,-410,1,0,0,0,1,0,0,0,1, ldraw_lib__stug9()],
// 1 16 410 0 410 1 0 0 0 1 0 0 0 1 stug9.dat
  [1,16,410,0,410,1,0,0,0,1,0,0,0,1, ldraw_lib__stug9()],
// 1 16 410 0 230 1 0 0 0 1 0 0 0 1 stug9.dat
  [1,16,410,0,230,1,0,0,0,1,0,0,0,1, ldraw_lib__stug9()],
// 1 16 410 0 50 1 0 0 0 1 0 0 0 1 stug9.dat
  [1,16,410,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug9()],
// 1 16 410 0 -130 1 0 0 0 1 0 0 0 1 stug9.dat
  [1,16,410,0,-130,1,0,0,0,1,0,0,0,1, ldraw_lib__stug9()],
// 1 16 410 0 -310 1 0 0 0 1 0 0 0 1 stug9.dat
  [1,16,410,0,-310,1,0,0,0,1,0,0,0,1, ldraw_lib__stug9()],
// 1 16 230 0 410 1 0 0 0 1 0 0 0 1 stug9.dat
  [1,16,230,0,410,1,0,0,0,1,0,0,0,1, ldraw_lib__stug9()],
// 1 16 -260 0 -240 1 0 0 0 1 0 0 0 1 stug8.dat
  [1,16,-260,0,-240,1,0,0,0,1,0,0,0,1, ldraw_lib__stug8()],
// 1 16 -420 0 -240 1 0 0 0 1 0 0 0 1 stug8.dat
  [1,16,-420,0,-240,1,0,0,0,1,0,0,0,1, ldraw_lib__stug8()],
// 1 16 -430 0 250 1 0 0 0 1 0 0 0 1 stug7.dat
  [1,16,-430,0,250,1,0,0,0,1,0,0,0,1, ldraw_lib__stug7()],
// 1 16 -250 0 430 1 0 0 0 1 0 0 0 1 stug7.dat
  [1,16,-250,0,430,1,0,0,0,1,0,0,0,1, ldraw_lib__stug7()],
// 1 16 200 0 -440 1 0 0 0 1 0 0 0 1 stug6.dat
  [1,16,200,0,-440,1,0,0,0,1,0,0,0,1, ldraw_lib__stug6()],
// 1 16 -80 0 -40 1 0 0 0 1 0 0 0 1 stug6.dat
  [1,16,-80,0,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__stug6()],
// 1 16 450 0 -450 1 0 0 0 1 0 0 0 1 stug5.dat
  [1,16,450,0,-450,1,0,0,0,1,0,0,0,1, ldraw_lib__stug5()],
// 1 16 350 0 -450 1 0 0 0 1 0 0 0 1 stug5.dat
  [1,16,350,0,-450,1,0,0,0,1,0,0,0,1, ldraw_lib__stug5()],
// 1 16 -110 0 -150 1 0 0 0 1 0 0 0 1 stug5.dat
  [1,16,-110,0,-150,1,0,0,0,1,0,0,0,1, ldraw_lib__stug5()],
// 1 16 270 0 -330 1 0 0 0 1 0 0 0 1 stug5.dat
  [1,16,270,0,-330,1,0,0,0,1,0,0,0,1, ldraw_lib__stug5()],
// 1 16 -320 0 280 1 0 0 0 1 0 0 0 1 stug4.dat
  [1,16,-320,0,280,1,0,0,0,1,0,0,0,1, ldraw_lib__stug4()],
...
// 1 16 -250 0 330 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,-250,0,330,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3()],
// 1 16 -150 0 -230 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,-150,0,-230,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3()],
// 1 16 210 0 290 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,210,0,290,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3()],
...
// 1 16 -480 0 160 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-480,0,160,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 -440 0 160 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-440,0,160,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
...
// 1 16 200 0 -360 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,200,0,-360,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
...
// 1 16 -160 0 -60 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-160,0,-60,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
...
// 1 16 280 0 -400 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,280,0,-400,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 280 0 -440 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,280,0,-440,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 280 0 -480 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,280,0,-480,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 -340 0 220 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-340,0,220,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 -160 0 440 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-160,0,440,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 -160 0 480 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-160,0,480,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
...
// 1 16 240 0 220 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,240,0,220,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 -300 0 340 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-300,0,340,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
...
// 1 16 -498 4 0 -2 0 0 0 -1 0 0 0 -496 rect1.dat
  [1,16,-498,4,0,-2,0,0,0,-1,0,0,0,-496, ldraw_lib__rect1()],
// 1 16 0 4 0 -496 0 0 0 -1 0 0 0 -500 rect2p.dat
  [1,16,0,4,0,-496,0,0,0,-1,0,0,0,-500, ldraw_lib__rect2p()],
// 1 16 498 4 0 2 0 0 0 -1 0 0 0 496 rect1.dat
  [1,16,498,4,0,2,0,0,0,-1,0,0,0,496, ldraw_lib__rect1()],
...
// 1 16 -500 2 0 0 1 0 -2 0 0 0 0 -496 rect1.dat
  [1,16,-500,2,0,0,1,0,-2,0,0,0,0,-496, ldraw_lib__rect1()],
// 1 16 0 2 500 0 0 -496 -2 0 0 0 -1 0 rect1.dat
  [1,16,0,2,500,0,0,-496,-2,0,0,0,-1,0, ldraw_lib__rect1()],
// 1 16 500 2 0 0 -1 0 -2 0 0 0 0 496 rect1.dat
  [1,16,500,2,0,0,-1,0,-2,0,0,0,0,496, ldraw_lib__rect1()],
// 1 16 0 2 -500 0 0 496 -2 0 0 0 1 0 rect1.dat
  [1,16,0,2,-500,0,0,496,-2,0,0,0,1,0, ldraw_lib__rect1()],
...
makepoly(ldraw_lib__385(), line=0.2);