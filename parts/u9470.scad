...
use <s/u9470s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9470(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9470s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9470s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9470s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9470s01(realsolid)],
...
// 1 16 50 20 0 0 -100 0 0 0 5 5 0 0 1-4cylo.dat
  [1,16,50,20,0,0,-100,0,0,0,5,5,0,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 0 25 -4.5 0 0 -50 0 -1 0 -4.5 0 0 rect1.dat
  [1,16,0,25,-4.5,0,0,-50,0,-1,0,-4.5,0,0, ldraw_lib__rect1(realsolid)],
// 1 16 50 -20 0 0 -100 0 0 0 -5 5 0 0 1-4cylo.dat
  [1,16,50,-20,0,0,-100,0,0,0,-5,5,0,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 0 -25 -4.5 0 0 50 0 1 0 -4.5 0 0 rect1.dat
  [1,16,0,-25,-4.5,0,0,50,0,1,0,-4.5,0,0, ldraw_lib__rect1(realsolid)],
// 1 16 7.5 8.5 2 0 -15 0 0 0 3 3 0 0 1-4cyli.dat
  [1,16,7.5,8.5,2,0,-15,0,0,0,3,3,0,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 7.5 19.5 2 0 -15 0 0 0 -3 3 0 0 1-4cyli.dat
  [1,16,7.5,19.5,2,0,-15,0,0,0,-3,3,0,0, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 0 -27 -24 -67 0 0 0 -1 0 0 0 6 rect2p.dat
  [1,16,0,-27,-24,-67,0,0,0,-1,0,0,0,6, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__u9470(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9470(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
