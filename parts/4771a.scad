...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4771a(realsolid=false) = [
...
// 1 16 0 8 0 40 0 0 0 8 0 0 0 10 box0.dat
  [1,16,0,8,0,40,0,0,0,8,0,0,0,10, ldraw_lib__box0(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 30 0 0 6 0 0 0 2 0 0 0 6 4-4cylo.dat
  [1,16,30,0,0,6,0,0,0,2,0,0,0,6, ldraw_lib__4_4cylo(realsolid)],
// 1 16 -30 0 0 6 0 0 0 1 0 0 0 6 4-4ndis.dat
  [1,16,-30,0,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4ndis(realsolid)],
// 4 16 -20 0 -10 -20 0 10 -24 0 6 -24 0 -6
  [4,16,-20,0,-10,-20,0,10,-24,0,6,-24,0,-6],
...
// 1 16 33 10.5 10 3 0 0 0 0 1.5 0 -2 0 box4.dat
  [1,16,33,10.5,10,3,0,0,0,0,1.5,0,-2,0, ldraw_lib__box4(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 38 9 0 0 1 0 0 0 7 8 0 0 rect.dat
  [1,16,38,9,0,0,1,0,0,0,7,8,0,0, ldraw_lib__rect(realsolid)],
// 1 16 -38 9 0 0 -1 0 0 0 7 8 0 0 rect.dat
  [1,16,-38,9,0,0,-1,0,0,0,7,8,0,0, ldraw_lib__rect(realsolid)],
// 
// 1 16 30 2 0 6 0 0 0 -1 0 0 0 6 4-4ndis.dat
  [1,16,30,2,0,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 28.5 2 0 0 0 -9.5 0 1 0 8 0 0 recte3.dat
  [1,16,28.5,2,0,0,0,-9.5,0,1,0,8,0,0, ldraw_lib__recte3(realsolid)],
...
// 1 16 17.75 6.5 7 1.25 0 0 0 -1 0 0 0 1 rect.dat
  [1,16,17.75,6.5,7,1.25,0,0,0,-1,0,0,0,1, ldraw_lib__rect(realsolid)],
// 1 16 17.75 6.5 -7 1.25 0 0 0 -1 0 0 0 1 rect.dat
  [1,16,17.75,6.5,-7,1.25,0,0,0,-1,0,0,0,1, ldraw_lib__rect(realsolid)],
...
// 1 16 17.75 6.5 0 1.25 0 0 0 9.5 0 0 0 6 box5-4a.dat
  [1,16,17.75,6.5,0,1.25,0,0,0,9.5,0,0,0,6, ldraw_lib__box5_4a(realsolid)],
// 
// 1 16 -30 2 0 6 0 0 0 -1 0 0 0 6 4-4ndis.dat
  [1,16,-30,2,0,6,0,0,0,-1,0,0,0,6, ldraw_lib__4_4ndis(realsolid)],
// 4 16 -38 2 -8 -38 2 8 -36 2 6 -36 2 -6
...
// 1 16 0 4 0 16.5 0 0 0 -1 0 0 0 8 rect.dat
  [1,16,0,4,0,16.5,0,0,0,-1,0,0,0,8, ldraw_lib__rect(realsolid)],
// 
...
module ldraw_lib__4771a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4771a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
