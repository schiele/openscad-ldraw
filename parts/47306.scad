...
use <../p/toothb12.scad>
$fa=1; $fs=0.2;
function ldraw_lib__47306(realsolid=false) = [
...
// 1 16 0 -40 0 1 0 0 0 0 -1 0 1 0 32316.dat
  [1,16,0,-40,0,1,0,0,0,0,-1,0,1,0, ldraw_lib__32316(realsolid)],
// 1 16 0 20 0 1 0 0 0 1 0 0 0 1 toothb12.dat
  [1,16,0,20,0,1,0,0,0,1,0,0,0,1, ldraw_lib__toothb12(realsolid)],
// 1 16 0 0 -10 -1.7321 0 1 1 0 1.7321 0 1 0 48\1-3ring9.dat
  [1,16,0,0,-10,-1.7321,0,1,1,0,1.7321,0,1,0, ldraw_lib__48__1_3ring9(realsolid)],
// 1 16 0 0 -10 -0.866 0 0.5 0.5 0 0.866 0 1 0 48\1-3rin17.dat
  [1,16,0,0,-10,-0.866,0,0.5,0.5,0,0.866,0,1,0, ldraw_lib__48__1_3rin17(realsolid)],
// 1 16 0 0 10 0.866 0 -0.5 0.5 0 0.866 0 -1 0 48\1-3rin17.dat
  [1,16,0,0,10,0.866,0,-0.5,0.5,0,0.866,0,-1,0, ldraw_lib__48__1_3rin17(realsolid)],
// 1 16 0 0 10 1.7321 0 -1 1 0 1.7321 0 -1 0 48\1-3ring9.dat
  [1,16,0,0,10,1.7321,0,-1,1,0,1.7321,0,-1,0, ldraw_lib__48__1_3ring9(realsolid)],
...
// 1 16 0 0 -10 -14.7224 0 8.5 8.5 0 14.7224 0 20 0 48\1-3cyli.dat
  [1,16,0,0,-10,-14.7224,0,8.5,8.5,0,14.7224,0,20,0, ldraw_lib__48__1_3cyli(realsolid)],
// 1 16 0 0 -2 -1 0 0 0 0 1 0 1 0 48\2-4rin16.dat
  [1,16,0,0,-2,-1,0,0,0,0,1,0,1,0, ldraw_lib__48__2_4rin16(realsolid)],
// 1 16 0 0 2 1 0 0 0 0 1 0 -1 0 48\2-4rin16.dat
  [1,16,0,0,2,1,0,0,0,0,1,0,-1,0, ldraw_lib__48__2_4rin16(realsolid)],
// 1 16 0 0 -2 -2 0 0 0 0 2 0 1 0 2-4ring5.dat
  [1,16,0,0,-2,-2,0,0,0,0,2,0,1,0, ldraw_lib__2_4ring5(realsolid)],
// 1 16 0 0 2 2 0 0 0 0 2 0 -1 0 2-4ring5.dat
  [1,16,0,0,2,2,0,0,0,0,2,0,-1,0, ldraw_lib__2_4ring5(realsolid)],
// 1 16 0 0 -2 -1 0 0 0 0 1 0 1 0 2-4ring9.dat
  [1,16,0,0,-2,-1,0,0,0,0,1,0,1,0, ldraw_lib__2_4ring9(realsolid)],
// 1 16 0 0 2 1 0 0 0 0 1 0 -1 0 2-4ring9.dat
  [1,16,0,0,2,1,0,0,0,0,1,0,-1,0, ldraw_lib__2_4ring9(realsolid)],
// 1 16 0 0 -2 -16 0 0 0 0 16 0 1 0 48\2-4aring.dat
  [1,16,0,0,-2,-16,0,0,0,0,16,0,1,0, ldraw_lib__48__2_4aring(realsolid)],
// 1 16 0 0 2 16 0 0 0 0 16 0 -1 0 48\2-4aring.dat
  [1,16,0,0,2,16,0,0,0,0,16,0,-1,0, ldraw_lib__48__2_4aring(realsolid)],
// 1 16 0 0 -2 -4 0 0 0 0 4 0 1 0 2-4ring3.dat
  [1,16,0,0,-2,-4,0,0,0,0,4,0,1,0, ldraw_lib__2_4ring3(realsolid)],
// 1 16 0 0 2 4 0 0 0 0 4 0 -1 0 2-4ring3.dat
  [1,16,0,0,2,4,0,0,0,0,4,0,-1,0, ldraw_lib__2_4ring3(realsolid)],
// 1 16 0 0 -2 -9 0 0 0 0 9 0 20 0 2-4edge.dat
  [1,16,0,0,-2,-9,0,0,0,0,9,0,20,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 0 2 9 0 0 0 0 9 0 -20 0 2-4edge.dat
  [1,16,0,0,2,9,0,0,0,0,9,0,-20,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 0 2 -9 0 0 0 0 9 0 20 0 2-4edge.dat
  [1,16,0,0,2,-9,0,0,0,0,9,0,20,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 0 -10 -14.7224 0 8.5 8.5 0 14.7224 0 20 0 48\1-3edge.dat
  [1,16,0,0,-10,-14.7224,0,8.5,8.5,0,14.7224,0,20,0, ldraw_lib__48__1_3edge(realsolid)],
// 1 16 0 0 10 -14.7224 0 8.5 8.5 0 14.7224 0 20 0 48\1-3edge.dat
  [1,16,0,0,10,-14.7224,0,8.5,8.5,0,14.7224,0,20,0, ldraw_lib__48__1_3edge(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\47306s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__47306s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\47306s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__47306s01(realsolid)],
// 0 //
// 0 //
...
module ldraw_lib__47306(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__47306(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
