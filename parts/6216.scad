...
use <s/6216s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6216(realsolid=false) = [
...
// 1 16 20 44 -20 20 0 0 0 0 -20 0 1 0 1-4chrd.dat
  [1,16,20,44,-20,20,0,0,0,0,-20,0,1,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -20 44 -20 -20 0 0 0 0 -20 0 1 0 1-4chrd.dat
  [1,16,-20,44,-20,-20,0,0,0,0,-20,0,1,0, ldraw_lib__1_4chrd(realsolid)],
...
module ldraw_lib__6216(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6216(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
