...
use <s/14769s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__14769(realsolid=false) = [
...
// 1 16 0 0 0 20 0 0 0 1 0 0 0 20 4-4disc.dat
  [1,16,0,0,0,20,0,0,0,1,0,0,0,20, ldraw_lib__4_4disc(realsolid)],
];
module ldraw_lib__14769(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__14769(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
