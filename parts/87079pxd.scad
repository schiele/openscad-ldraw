...
use <s/87079s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87079pxd(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 87079pb0252, Doctor Who, Set 71204, Tardis
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\87079pxds01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87079pxds01(realsolid)],
...
module ldraw_lib__87079pxd(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87079pxd(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
