...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__75937(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\75937s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__75937s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 -1 0 0 s\75937s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,-1,0,0, ldraw_lib__s__75937s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\75937s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__75937s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\75937s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__75937s01(realsolid)],
...
// 1 16 10 0 10 5.54328 0 -2.2961 0 -1 0 2.2961 0 5.54328 1-8disc.dat
  [1,16,10,0,10,5.54328,0,-2.2961,0,-1,0,2.2961,0,5.54328, ldraw_lib__1_8disc(realsolid)],
// 1 16 10 0 -10 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,10,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 10 0 -10 2.2961 0 5.54328 0 -1 0 -5.54328 0 2.2961 1-8disc.dat
  [1,16,10,0,-10,2.2961,0,5.54328,0,-1,0,-5.54328,0,2.2961, ldraw_lib__1_8disc(realsolid)],
// 1 16 -10 0 -10 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-10,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 -10 0 -10 -5.54328 0 2.2961 0 -1 0 -2.2961 0 -5.54328 1-8disc.dat
  [1,16,-10,0,-10,-5.54328,0,2.2961,0,-1,0,-2.2961,0,-5.54328, ldraw_lib__1_8disc(realsolid)],
...
module ldraw_lib__75937(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__75937(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
