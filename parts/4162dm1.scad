...
use <6005724o2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4162dm1(realsolid=false) = [
...
// 1 16 -60 0 0 1 0 0 0 1 0 0 0 1 6005724o2.dat
  [1,16,-60,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6005724o2(realsolid)],
];
module ldraw_lib__4162dm1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4162dm1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
