...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3036(realsolid=false) = [
// 0 Plate  6 x  8
// 0 Name: 3036.dat
...
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 76 0 0 0 -4 0 0 0 56 box5.dat
  [1,16,0,8,0,76,0,0,0,-4,0,0,0,56, ldraw_lib__box5(realsolid)],
...
// 1 16 0 8 0 80 0 0 0 -8 0 0 0 60 box5.dat
  [1,16,0,8,0,80,0,0,0,-8,0,0,0,60, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__3036(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3036(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3036(line=0.2);