...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3070pb071, Rebrickable 3070bpr0100, Set 850425, underscore
// 
...
module ldraw_lib__3070bpug(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3070bpug(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
