...
use <s/98578s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98578(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\98578s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__98578s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\98578s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__98578s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\98578s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__98578s01(realsolid)],
...
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\98578s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__98578s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 -1 0 0 s\98578s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,-1,0,0, ldraw_lib__s__98578s01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 1 0 0 s\98578s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,1,0,0, ldraw_lib__s__98578s01(realsolid)],
...
// 1 16 0 0 0 -1 0 0 0 -40 0 0 0 -1 axlehol6.dat
  [1,16,0,0,0,-1,0,0,0,-40,0,0,0,-1, ldraw_lib__axlehol6(realsolid)],
// 1 16 0 0 0 -1 0 0 0 -40 0 0 0 1 axlehol6.dat
  [1,16,0,0,0,-1,0,0,0,-40,0,0,0,1, ldraw_lib__axlehol6(realsolid)],
// 1 16 0 0 0 1 0 0 0 -40 0 0 0 -1 axlehol6.dat
  [1,16,0,0,0,1,0,0,0,-40,0,0,0,-1, ldraw_lib__axlehol6(realsolid)],
...
// 1 16 0 -20.25 -8.5 -1.2 0 0 0 1 0 0 0 -1.2 2-4edge.dat
  [1,16,0,-20.25,-8.5,-1.2,0,0,0,1,0,0,0,-1.2, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -20.25 -8.5 -1.2 0 0 0 1 0 0 0 -1.2 2-4disc.dat
  [1,16,0,-20.25,-8.5,-1.2,0,0,0,1,0,0,0,-1.2, ldraw_lib__2_4disc(realsolid)],
...
// 1 16 1.8 -20 -2.45 0 1 -0.2 0.25 0 0 0 0 -0.45 rect3.dat
  [1,16,1.8,-20,-2.45,0,1,-0.2,0.25,0,0,0,0,-0.45, ldraw_lib__rect3(realsolid)],
// 1 16 1.15 -20 -3.05 -0.45 0 0 0 0 -0.25 -0.15 -1 0 rect2p.dat
  [1,16,1.15,-20,-3.05,-0.45,0,0,0,0,-0.25,-0.15,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0.35 -20 -3.25 -0.35 0 0 0 0 -0.25 -0.05 -1 0 rect2p.dat
  [1,16,0.35,-20,-3.25,-0.35,0,0,0,0,-0.25,-0.05,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -0.35 -20 -3.25 -0.35 0 0 0 0 -0.25 0.05 -1 0 rect2p.dat
  [1,16,-0.35,-20,-3.25,-0.35,0,0,0,0,-0.25,0.05,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -1.15 -20 -3.05 0 0 -0.45 0.25 0 0 0 -1 0.15 rect3.dat
  [1,16,-1.15,-20,-3.05,0,0,-0.45,0.25,0,0,0,-1,0.15, ldraw_lib__rect3(realsolid)],
// 1 16 -1.8 -20 -2.45 -0.2 -1 0 0 0 -0.25 0.45 0 0 rect2p.dat
  [1,16,-1.8,-20,-2.45,-0.2,-1,0,0,0,-0.25,0.45,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 -19.75 -8.5 -1.2 0 0 0 -1 0 0 0 -1.2 2-4edge.dat
  [1,16,0,-19.75,-8.5,-1.2,0,0,0,-1,0,0,0,-1.2, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -19.75 -8.5 -1.2 0 0 0 -1 0 0 0 -1.2 2-4disc.dat
  [1,16,0,-19.75,-8.5,-1.2,0,0,0,-1,0,0,0,-1.2, ldraw_lib__2_4disc(realsolid)],
...
// 1 16 -2.45 -20 1.75 0 0 -0.45 -0.25 0 0 0 1 -0.25 rect3.dat
  [1,16,-2.45,-20,1.75,0,0,-0.45,-0.25,0,0,0,1,-0.25, ldraw_lib__rect3(realsolid)],
// 1 16 -2.9 -20 1.35 0 -1 0 -0.25 0 0 0 0 -0.15 rect3.dat
  [1,16,-2.9,-20,1.35,0,-1,0,-0.25,0,0,0,0,-0.15, ldraw_lib__rect3(realsolid)],
// 1 16 -4.326 -20 1.2 -1.424 0 0 0 0 0.25 0 1 0 rect2p.dat
  [1,16,-4.326,-20,1.2,-1.424,0,0,0,0,0.25,0,1,0, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__98578(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98578(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
