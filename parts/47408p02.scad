...
use <s/47408s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__47408p02(realsolid=false) = [
...
// 1 0 0 27 0 2 0 0 0 -9 0 0 0 2 48\4-4con12.dat
  [1,0,0,27,0,2,0,0,0,-9,0,0,0,2, ldraw_lib__48__4_4con12(realsolid)],
// 1 16 0 32.85 0 1.3 0 0 0 -5.85 0 0 0 1.3 48\4-4con20.dat
  [1,16,0,32.85,0,1.3,0,0,0,-5.85,0,0,0,1.3, ldraw_lib__48__4_4con20(realsolid)],
// 1 0 0 36.2625 0 0.75833 0 0 0 -3.4125 0 0 0 0.75833 48\4-4con36.dat
  [1,0,0,36.2625,0,0.75833,0,0,0,-3.4125,0,0,0,0.75833, ldraw_lib__48__4_4con36(realsolid)],
// 1 16 0 42.5756 0 1.40292 0 0 0 -6.31313 0 0 0 1.40292 48\4-4con20.dat
  [1,16,0,42.5756,0,1.40292,0,0,0,-6.31313,0,0,0,1.40292, ldraw_lib__48__4_4con20(realsolid)],
// 1 0 0 48.8888 0 1.40292 0 0 0 -6.31313 0 0 0 1.40292 48\4-4con21.dat
  [1,0,0,48.8888,0,1.40292,0,0,0,-6.31313,0,0,0,1.40292, ldraw_lib__48__4_4con21(realsolid)],
// 1 16 0 72.0369 0 5.14403 0 0 0 -23.14813 0 0 0 5.14403 48\4-4con6.dat
  [1,16,0,72.0369,0,5.14403,0,0,0,-23.14813,0,0,0,5.14403, ldraw_lib__48__4_4con6(realsolid)],
];
module ldraw_lib__47408p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__47408p02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
