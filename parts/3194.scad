...
// 0 !HISTORY 2024-08-03 [RainbowDolphin] Made BFC CCW
...
module ldraw_lib__3194(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3194(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
