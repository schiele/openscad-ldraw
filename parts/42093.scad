...
use <u9032.scad>
$fa=1; $fs=0.2;
function ldraw_lib__42093(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 42092.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__42092(realsolid)],
// 1 0 -68.5 0 -57 0 0 1 1 0 0 0 1 0 u9032.dat
  [1,0,-68.5,0,-57,0,0,1,1,0,0,0,1,0, ldraw_lib__u9032(realsolid)],
// 1 0 68.5 0 -57 0 0 1 1 0 0 0 1 0 u9032.dat
  [1,0,68.5,0,-57,0,0,1,1,0,0,0,1,0, ldraw_lib__u9032(realsolid)],
// 1 0 -68.5 0 57 0 0 1 1 0 0 0 1 0 u9032.dat
  [1,0,-68.5,0,57,0,0,1,1,0,0,0,1,0, ldraw_lib__u9032(realsolid)],
...
module ldraw_lib__42093(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__42093(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
