...
// 1 16 0 0 -11.5 1.06667 0 0 0 0 -1.06667 0 0.95833 0 55652.dat
  [1,16,0,0,-11.5,1.06667,0,0,0,0,-1.06667,0,0.95833,0, ldraw_lib__55652()],
];
module ldraw_lib__99957(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__99957(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
