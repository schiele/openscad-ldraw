...
// 0 !HISTORY 2020-08-03 [PTadmin] Renamed from 73697 to correct numbering error
...
module ldraw_lib__73696a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73696a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__73696a(line=0.2);