...
use <499c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__187c01(realsolid=false) = [
...
// 1 79 0 13 30 0.961262 0 0.275637 0 1 0 -0.275637 0 0.961262 187.dat
  [1,79,0,13,30,0.961262,0,0.275637,0,1,0,-0.275637,0,0.961262, ldraw_lib__187(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 188.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__188(realsolid)],
// 1 1 0 8 -100 0 0 1 0 1 0 -1 0 0 499c01.dat
  [1,1,0,8,-100,0,0,1,0,1,0,-1,0,0, ldraw_lib__499c01(realsolid)],
];
module ldraw_lib__187c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__187c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
