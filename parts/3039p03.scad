...
$fa=1; $fs=0.2;
function ldraw_lib__3039p03(realsolid=false) = [
...
// 1 16 0 3.03 -13.03 0.5 0 0 0 0.353553 0.707107 0 -0.353553 0.707107 s\4864ap04s01.dat
  [1,16,0,3.03,-13.03,0.5,0,0,0,0.353553,0.707107,0,-0.353553,0.707107, ldraw_lib__s__4864ap04s01(realsolid)],
...
module ldraw_lib__3039p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3039p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
