...
use <../p/box.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6202(realsolid=false) = [
...
// 1 16 0 70 -4 36 0 0 0 66 0 0 0 2 box.dat
  [1,16,0,70,-4,36,0,0,0,66,0,0,0,2, ldraw_lib__box(realsolid)],
];
module ldraw_lib__6202(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6202(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
