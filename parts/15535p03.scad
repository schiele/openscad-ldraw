...
use <s/15535s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__15535p03(realsolid=false) = [
...
// 1 0 0 0 0 0.40625 0 0 0 1 0 0 0 0.40625 4-4rin20.dat
  [1,0,0,0,0,0.40625,0,0,0,1,0,0,0,0.40625, ldraw_lib__4_4rin20(realsolid)],
// 1 16 0 0 0 0.75 0 0 0 1 0 0 0 0.75 4-4ring8.dat
  [1,16,0,0,0,0.75,0,0,0,1,0,0,0,0.75, ldraw_lib__4_4ring8(realsolid)],
// 1 0 0 0 0 0.75 0 0 0 1 0 0 0 0.75 4-4ring9.dat
  [1,0,0,0,0,0.75,0,0,0,1,0,0,0,0.75, ldraw_lib__4_4ring9(realsolid)],
// 1 71 0 0 0 0.625 0 0 0 1 0 0 0 0.625 4-4rin12.dat
  [1,71,0,0,0,0.625,0,0,0,1,0,0,0,0.625, ldraw_lib__4_4rin12(realsolid)],
// 1 0 0 0 0 19.5 0 0 0 1 0 0 0 19.5 4-4ering.dat
  [1,0,0,0,0,19.5,0,0,0,1,0,0,0,19.5, ldraw_lib__4_4ering(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\15535p03s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__15535p03s01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\15535p03s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__15535p03s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\15535p03s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__15535p03s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\15535p03s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__15535p03s01(realsolid)],
...
module ldraw_lib__15535p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__15535p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
