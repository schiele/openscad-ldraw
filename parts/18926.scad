...
use <../p/stug-6x1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__18926(realsolid=false) = [
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\18926s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__18926s01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\18926s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__18926s01(realsolid)],
// 0 // Studs
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 stug-6x1.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_6x1(realsolid)],
// 1 16 -70 24 150 0 0 -1 0 1 0 1 0 0 stug-1x6.dat
  [1,16,-70,24,150,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_1x6(realsolid)],
// 1 16 70 24 150 0 0 -1 0 1 0 1 0 0 stug-1x6.dat
  [1,16,70,24,150,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_1x6(realsolid)],
// 1 16 0 48 220 0 0 -1 0 1 0 1 0 0 stug-6x1.dat
  [1,16,0,48,220,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_6x1(realsolid)],
// 1 16 -10 88 140 0 0 -1 0 1 0 1 0 0 stug-3x3.dat
  [1,16,-10,88,140,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_3x3(realsolid)],
// 1 16 30 88 140 0 0 -1 0 1 0 1 0 0 stug-1x3.dat
  [1,16,30,88,140,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_1x3(realsolid)],
// 1 16 0 88 70 0 0 -1 0 1 0 1 0 0 stug-4x4.dat
  [1,16,0,88,70,0,0,-1,0,1,0,1,0,0, ldraw_lib__stug_4x4(realsolid)],
// 1 16 0 92 90 1 0 0 0 -5 0 0 0 1 stud4f4n.dat
  [1,16,0,92,90,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4f4n(realsolid)],
// 1 16 0 92 50 1 0 0 0 -5 0 0 0 1 stud4f4n.dat
  [1,16,0,92,50,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4f4n(realsolid)],
// 1 16 0 92 50 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,92,50,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 92 90 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,0,92,90,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge(realsolid)],
// 0 // Inside
// 0 // Primitives
// 1 16 0 40 14 0 0 60 40 0 0 0 -1 0 rect2p.dat
  [1,16,0,40,14,0,0,60,40,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 48 217 60 0 0 0 1 0 0 0 13 rect.dat
  [1,16,0,48,217,60,0,0,0,1,0,0,0,13, ldraw_lib__rect(realsolid)],
// 1 16 0 88 95 52 0 0 0 1 0 0 0 81 recte4.dat
  [1,16,0,88,95,52,0,0,0,1,0,0,0,81, ldraw_lib__recte4(realsolid)],
// 0 // Faces
...
// 1 16 0 108 10 0 0 40 4 0 0 0 1 0 rect1.dat
  [1,16,0,108,10,0,0,40,4,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
// 1 16 64 156 14 0 -1 0 -152 0 0 0 0 152 1-16chrd.dat
  [1,16,64,156,14,0,-1,0,-152,0,0,0,0,152, ldraw_lib__1_16chrd(realsolid)],
// 0 // Faces
...
// 1 16 0 92 30 0 0 1 0 -5 0 1 0 0 filletr0n.dat
  [1,16,0,92,30,0,0,1,0,-5,0,1,0,0, ldraw_lib__filletr0n(realsolid)],
// 1 16 0 92 70 0 0 1 0 -5 0 1 0 0 filletr0n.dat
  [1,16,0,92,70,0,0,1,0,-5,0,1,0,0, ldraw_lib__filletr0n(realsolid)],
// 1 16 0 92 16 0 0 1 0 20 0 2 0 0 box3u8p.dat
  [1,16,0,92,16,0,0,1,0,20,0,2,0,0, ldraw_lib__box3u8p(realsolid)],
// 1 16 0 92 99.125 0 0 1 0 20 0 -1.125 0 0 box3u8p.dat
  [1,16,0,92,99.125,0,0,1,0,20,0,-1.125,0,0, ldraw_lib__box3u8p(realsolid)],
// 1 16 0 92 104.125 0 0 1 0 20 0 1.875 0 0 box3u6.dat
  [1,16,0,92,104.125,0,0,1,0,20,0,1.875,0,0, ldraw_lib__box3u6(realsolid)],
// 0 // Faces
...
// 1 16 0 108 114 0 0 41 -4 0 0 0 -4 0 box3u7a.dat
  [1,16,0,108,114,0,0,41,-4,0,0,0,-4,0, ldraw_lib__box3u7a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 94 170 20 0 0 0 0 -2 0 -60 0 box4-7a.dat
  [1,16,0,94,170,20,0,0,0,0,-2,0,-60,0, ldraw_lib__box4_7a(realsolid)],
// 1 16 0 90 177 -36 0 0 0 0 2 0 1 -2 box2-7.dat
  [1,16,0,90,177,-36,0,0,0,0,2,0,1,-2, ldraw_lib__box2_7(realsolid)],
// 0 // Faces
...
// 1 16 0 4 2 60 0 0 0 0 -4 0 -12 0 box2-9p.dat
  [1,16,0,4,2,60,0,0,0,0,-4,0,-12,0, ldraw_lib__box2_9p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 6 6 8 0 0 0 0 -2 0 4 0 box4-7a.dat
  [1,16,0,6,6,8,0,0,0,0,-2,0,4,0, ldraw_lib__box4_7a(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 54 208 8 0 0 0 -2 0 0 1.35485 -4.64515 box2-7.dat
  [1,16,0,54,208,8,0,0,0,-2,0,0,1.35485,-4.64515, ldraw_lib__box2_7(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 54 222 0 0 -60 2 0 0 0 4 0 box3u4a.dat
  [1,16,0,54,222,0,0,-60,2,0,0,0,4,0, ldraw_lib__box3u4a(realsolid)],
// 1 16 0 6 -6 -58.3432 0 0 0 0 -2 0 -1 0 rect2p.dat
  [1,16,0,6,-6,-58.3432,0,0,0,0,-2,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 0 // Faces
...
module ldraw_lib__18926(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__18926(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
