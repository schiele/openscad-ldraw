...
// 1 16 0 -0.25 0 35 0 0 0 0.25 0 0 0 23 box5-12.dat
  [1,16,0,-0.25,0,35,0,0,0,0.25,0,0,0,23, ldraw_lib__box5_12()],
// 0 BFC NOCLIP
  [0,"BFC","NOCLIP"],
// 1 16 0 -.25 0 1.8 0 0 0 1 0 0 0 1.8 s\4346p03a.dat
  [1,16,0,-.25,0,1.8,0,0,0,1,0,0,0,1.8, ldraw_lib__s__4346p03a()],
// 0 BFC CLIP
  [0,"BFC","CLIP"],
...
module ldraw_lib__196815b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__196815b(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
