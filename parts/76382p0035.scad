...
use <3820.scad>
use <973pua.scad>
function ldraw_lib__76382p0035() = [
// 0 Minifig Torso with Yellow Arms and Medium Nougat Hands with Jacket with Striped Trim, Silver Buttons and Pockets over White Undershirt Pattern
// 0 Name: 76382p0035.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 973pb3624c03, Brickowl 472606, Brickset 76382, Ned Leeds
// 0 !KEYWORDS Rebrickable 973c01h23pr6810, Set 76261, Spider-Man
// 
...
module ldraw_lib__76382p0035(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382p0035(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382p0035(line=0.2);