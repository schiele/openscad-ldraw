...
use <../p/box.scad>
$fa=1; $fs=0.2;
function ldraw_lib__848(realsolid=false) = [
...
// 1 16 0 22 -4 26 0 0 0 0 19 0 -1 0 box.dat
  [1,16,0,22,-4,26,0,0,0,0,19,0,-1,0, ldraw_lib__box(realsolid)],
// 1 16 10 3 -4 1 0 0 0 1 0 0 0 1 4-4edge.dat
  [1,16,10,3,-4,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4edge(realsolid)],
// 1 16 -10 3 -4 1 0 0 0 1 0 0 0 1 4-4edge.dat
  [1,16,-10,3,-4,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4edge(realsolid)],
// 1 16 -10 3 -4 1 0 0 0 -1 0 0 0 1 4-8sphe.dat
  [1,16,-10,3,-4,1,0,0,0,-1,0,0,0,1, ldraw_lib__4_8sphe(realsolid)],
// 1 16 10 3 -4 1 0 0 0 -1 0 0 0 1 4-8sphe.dat
  [1,16,10,3,-4,1,0,0,0,-1,0,0,0,1, ldraw_lib__4_8sphe(realsolid)],
// 0
// 
...
module ldraw_lib__848(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__848(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
