...
use <s/2335s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2335p40(realsolid=false) = [
...
// 1 80 2 0 0 1 0 0 0 1 0 0 0 1 s\2335ps4a.dat
  [1,80,2,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2335ps4a(realsolid)],
// 1 82 2 0 0 1 0 0 0 1 0 0 0 1 s\2335ps4b.dat
  [1,82,2,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2335ps4b(realsolid)],
// 1 80 -2 40 0 -1 0 0 0 -1 0 0 0 1 s\2335ps4a.dat
  [1,80,-2,40,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__s__2335ps4a(realsolid)],
// 1 82 -2 40 0 -1 0 0 0 -1 0 0 0 1 s\2335ps4b.dat
  [1,82,-2,40,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__s__2335ps4b(realsolid)],
// 1 16 2 0 0 1 0 0 0 1 0 0 0 1 s\2335p40s01.dat
  [1,16,2,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2335p40s01(realsolid)],
// 1 16 -2 40 0 -1 0 0 0 -1 0 0 0 1 s\2335p40s01.dat
  [1,16,-2,40,0,-1,0,0,0,-1,0,0,0,1, ldraw_lib__s__2335p40s01(realsolid)],
];
module ldraw_lib__2335p40(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2335p40(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
