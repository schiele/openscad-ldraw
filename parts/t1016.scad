...
use <s/t1012s01.scad>
use <t1011.scad>
function ldraw_lib__t1016() = [
// 0 | Brickstuff 1:2 Expansion Adapter Board with Standard Connectors
// 0 Name: t1016.dat
...
// 1 78 14.5 -8 -8 0 0 -1 0 1 0 1 0 0 t1011.dat
  [1,78,14.5,-8,-8,0,0,-1,0,1,0,1,0,0, ldraw_lib__t1011()],
// 1 78 14.5 -8 8 0 0 -1 0 1 0 1 0 0 t1011.dat
  [1,78,14.5,-8,8,0,0,-1,0,1,0,1,0,0, ldraw_lib__t1011()],
];
module ldraw_lib__t1016(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1016(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__t1016(line=0.2);