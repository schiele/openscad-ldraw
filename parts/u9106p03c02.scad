...
$fa=1; $fs=0.2;
function ldraw_lib__u9106p03c02(realsolid=false) = [
...
// 1 19 0 -67 4 1 0 0 0 1 0 0 0 1 u9106p03c01.dat
  [1,19,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u9106p03c01(realsolid)],
// 1 15 0 -37 4 1 0 0 0 1 0 0 0 1 u9102p03.dat
  [1,15,0,-37,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u9102p03(realsolid)],
...
module ldraw_lib__u9106p03c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9106p03c02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9106p03c02(line=0.2);