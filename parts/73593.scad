...
use <69c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__73593(realsolid=false) = [
...
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 69c01.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__69c01(realsolid)],
];
module ldraw_lib__73593(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73593(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
