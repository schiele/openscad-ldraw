...
use <3817bpc4b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__73200pc4b(realsolid=false) = [
...
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3816bpc4b.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3816bpc4b(realsolid)],
// 1 16 0 12 0 1 0 0 0 1 0 0 0 1 3817bpc4b.dat
  [1,16,0,12,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817bpc4b(realsolid)],
];
module ldraw_lib__73200pc4b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__73200pc4b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
