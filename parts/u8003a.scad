...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u8003a(realsolid=false) = [
...
// 1 16 0 24 0 26 0 0 0 -20 0 0 0 16 box5.dat
  [1,16,0,24,0,26,0,0,0,-20,0,0,0,16, ldraw_lib__box5(realsolid)],
...
// 1 16 0 24 0 0 0 30 0 -24 0 -20 0 0 box5.dat
  [1,16,0,24,0,0,0,30,0,-24,0,-20,0,0, ldraw_lib__box5(realsolid)],
...
module ldraw_lib__u8003a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8003a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
