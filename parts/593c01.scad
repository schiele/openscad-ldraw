...
use <u9566.scad>
$fa=1; $fs=0.2;
function ldraw_lib__593c01(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink bb0045c01, Brickowl 537045, Rebrickable 468c01, set 102
// 0 !KEYWORDS set 113-2, Set 116-2, set 371-2
// 
...
// 1 7 0 64 0 1 0 0 0 1 0 0 0 1 593.dat
  [1,7,0,64,0,1,0,0,0,1,0,0,0,1, ldraw_lib__593(realsolid)],
// 0 // Lid
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 u9023.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9023(realsolid)],
// 0 // Pole reverser
// 1 1 0 4 -87.8 1 0 0 0 1 0 0 0 1 u9024.dat
  [1,1,0,4,-87.8,1,0,0,0,1,0,0,0,1, ldraw_lib__u9024(realsolid)],
// 0 // Lever
// 1 178 0 34 -96.5 1 0 0 0 1 0 0 0 1 563.dat
  [1,178,0,34,-96.5,1,0,0,0,1,0,0,0,1, ldraw_lib__563(realsolid)],
// 0 // Screw
// 1 494 0 68 36 1 0 0 0 -1 0 0 0 1 u9566.dat
  [1,494,0,68,36,1,0,0,0,-1,0,0,0,1, ldraw_lib__u9566(realsolid)],
];
module ldraw_lib__593c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__593c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
