...
use <s/86500s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30208(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30208-1.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30208_1(realsolid)],
// 1 16 0 0 0 0.5 0 0.86602 0 1 0 -0.86602 0 0.5 s\30208-1.dat
  [1,16,0,0,0,0.5,0,0.86602,0,1,0,-0.86602,0,0.5, ldraw_lib__s__30208_1(realsolid)],
// 1 16 0 0 0 0.5 0 -0.86602 0 1 0 0.86602 0 0.5 s\30208-1.dat
  [1,16,0,0,0,0.5,0,-0.86602,0,1,0,0.86602,0,0.5, ldraw_lib__s__30208_1(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\30208-1.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__30208_1(realsolid)],
...
module ldraw_lib__30208(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30208(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
