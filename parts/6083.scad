...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6083(realsolid=false) = [
...
// 1 16 -60 96 10 0 1 0 0 0 24 20 0 0 rect1.dat
  [1,16,-60,96,10,0,1,0,0,0,24,20,0,0, ldraw_lib__rect1(realsolid)],
// 1 16 -60 120 -20 0 1 0 0 0 24 -10 0 0 rect1.dat
  [1,16,-60,120,-20,0,1,0,0,0,24,-10,0,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 0 156 -30 0 0 80 12 0 0 0 1 0 rect1.dat
  [1,16,0,156,-30,0,0,80,12,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 0 164 30 0 0 40 4 0 0 0 -40 0 box3u2p.dat
  [1,16,0,164,30,0,0,40,4,0,0,0,-40,0, ldraw_lib__box3u2p(realsolid)],
// 0
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 62 124 20 0 0 2 0 20 0 1.50 0 0 box4-1.dat
  [1,16,62,124,20,0,0,2,0,20,0,1.50,0,0, ldraw_lib__box4_1(realsolid)],
// 1 16 62 124 0 0 0 2 0 20 0 1.50 0 0 box4-1.dat
  [1,16,62,124,0,0,0,2,0,20,0,1.50,0,0, ldraw_lib__box4_1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -68 144 10 0 0 -8 0 -20 0 16 0 0 box4-1.dat
  [1,16,-68,144,10,0,0,-8,0,-20,0,16,0,0, ldraw_lib__box4_1(realsolid)],
...
// 1 16 62 148 -20 0 0 2 0 20 0 1.50 0 0 box4-1.dat
  [1,16,62,148,-20,0,0,2,0,20,0,1.50,0,0, ldraw_lib__box4_1(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -68 168 -20 8 0 0 0 -20 0 0 0 6 box5.dat
  [1,16,-68,168,-20,8,0,0,0,-20,0,0,0,6, ldraw_lib__box5(realsolid)],
...
// 1 16 70 156 -20 10 0 0 0 -12 0 0 0 10 box3-3.dat
  [1,16,70,156,-20,10,0,0,0,-12,0,0,0,10, ldraw_lib__box3_3(realsolid)],
// 1 16 -70 156 -20 -10 0 0 0 -12 0 0 0 10 box3-3.dat
  [1,16,-70,156,-20,-10,0,0,0,-12,0,0,0,10, ldraw_lib__box3_3(realsolid)],
// 1 16 70 132 10 10 0 0 0 -12 0 0 0 -20 box3-3.dat
  [1,16,70,132,10,10,0,0,0,-12,0,0,0,-20, ldraw_lib__box3_3(realsolid)],
// 1 16 -70 132 10 -10 0 0 0 -12 0 0 0 -20 box3-3.dat
  [1,16,-70,132,10,-10,0,0,0,-12,0,0,0,-20, ldraw_lib__box3_3(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 10 120 -20 0 0 -10 0 -24 0 10 0 0 box2-5.dat
  [1,16,10,120,-20,0,0,-10,0,-24,0,10,0,0, ldraw_lib__box2_5(realsolid)],
...
// 1 16 -10 144 -20 10 0 0 0 1 0 0 0 10 rect2p.dat
  [1,16,-10,144,-20,10,0,0,0,1,0,0,0,10, ldraw_lib__rect2p(realsolid)],
...
// 1 16 70 120 20 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,70,120,20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
...
// 1 16 70 120 0 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,70,120,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
...
// 1 16 70 144 -20 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,70,144,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
...
// 1 16 -10 144 -20 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,-10,144,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
// 1 16 -30 72 -20 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,-30,72,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
// 1 16 -50 96 -20 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,-50,96,-20,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2(realsolid)],
...
module ldraw_lib__6083(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6083(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
