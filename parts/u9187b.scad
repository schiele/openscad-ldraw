...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 u9187a.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__u9187a()],
];
module ldraw_lib__u9187b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9187b(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
