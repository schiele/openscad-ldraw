...
// 1 16 40 10 0 0 -1 0 8 0 0 0 0 8 4-4edge.dat
  [1,16,40,10,0,0,-1,0,8,0,0,0,0,8, ldraw_lib__4_4edge()],
// 1 16 -40 10 0 0 -1 0 8 0 0 0 0 8 4-4edge.dat
  [1,16,-40,10,0,0,-1,0,8,0,0,0,0,8, ldraw_lib__4_4edge()],
...
module ldraw_lib__6249(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6249(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
