...
use <s/u9267s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9267(realsolid=false) = [
...
// 1 16 0 30.5 0 4 0 0 0 -30.5 0 0 0 4 4-4cylc.dat
  [1,16,0,30.5,0,4,0,0,0,-30.5,0,0,0,4, ldraw_lib__4_4cylc(realsolid)],
...
// 1 16 0 0 0 7 0 0 0 -4 0 0 0 7 4-4cyli.dat
  [1,16,0,0,0,7,0,0,0,-4,0,0,0,7, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9267s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9267s01(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 s\u9267s01.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__s__u9267s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\u9267s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__u9267s01(realsolid)],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\u9267s01.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__u9267s01(realsolid)],
...
module ldraw_lib__u9267(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9267(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
