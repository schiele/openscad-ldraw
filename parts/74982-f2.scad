...
use <2944c02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__74982_f2(realsolid=false) = [
...
// 1 0 0 -130 0 1 0 0 0 1 0 0 0 1 2944c02.dat
  [1,0,0,-130,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2944c02(realsolid)],
// 0
];
module ldraw_lib__74982_f2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__74982_f2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
