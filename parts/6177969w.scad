...
function ldraw_lib__6177969w() = [
// 0 Sticker  2.2 x  1.7 with Ford Logo, Grey Exhaust Pipes and White Number 66 in Green Rectangle on Red Background Left
// 0 Name: 6177969w.dat
...
module ldraw_lib__6177969w(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6177969w(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6177969w(line=0.2);