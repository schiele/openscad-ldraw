...
use <../p/axl3hol6.scad>
$fa=1; $fs=0.2;
function ldraw_lib__86208(realsolid=false) = [
...
// 1 16 0 0 26 4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,16,0,0,26,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 26 4 0 0 0 0 4 0 -1 0 4-4disc.dat
  [1,16,0,0,26,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 4 4 0 0 0 0 4 0 22 0 4-4cyli.dat
  [1,16,0,0,4,4,0,0,0,0,4,0,22,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 0 4 0 0 0 -0.707 4 0 0.707 4 2-4edge.dat
  [1,16,0,0,0,4,0,0,0,-0.707,4,0,0.707,4, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 0 0 4 0 0 0 0.707 4 0 0.707 -4 2-4edge.dat
  [1,16,0,0,0,4,0,0,0,0.707,4,0,0.707,-4, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 0 0 -8 -4 0 0 0 0 4 0 -1 0 4-4ring1.dat
  [1,16,0,0,-8,-4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4ring1(realsolid)],
...
// 1 16 0 0 -11 6 0 0 0 0 6 0 1 0 4-4disc.dat
  [1,16,0,0,-11,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 -11 1 0 0 0 0 1 0 1 0 axl3hol2.dat
  [1,16,0,0,-11,1,0,0,0,0,1,0,1,0, ldraw_lib__axl3hol2(realsolid)],
// 1 16 0 0 -16 1 0 0 0 0 1 0 1 0 axl3hol3.dat
  [1,16,0,0,-16,1,0,0,0,0,1,0,1,0, ldraw_lib__axl3hol3(realsolid)],
// 1 16 0 0 -11 1 0 0 0 0 1 0 -5 0 axl3hol6.dat
  [1,16,0,0,-11,1,0,0,0,0,1,0,-5,0, ldraw_lib__axl3hol6(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 -20 6 0 0 0 0 6 0 9 0 4-4cyli.dat
  [1,16,0,0,-20,6,0,0,0,0,6,0,9,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -16 10 0 0 0 0 10 0 1 0 4-4edge.dat
  [1,16,0,0,-16,10,0,0,0,0,10,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -16 10 0 0 0 0 10 0 8 0 4-4cyli.dat
  [1,16,0,0,-16,10,0,0,0,0,10,0,8,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 0 -16 2 0 0 0 0 2 0 1 0 4-4ring4.dat
  [1,16,0,0,-16,2,0,0,0,0,2,0,1,0, ldraw_lib__4_4ring4(realsolid)],
...
// 1 16 0 0 -20 8 0 0 0 0 8 0 4 0 4-4cyli.dat
  [1,16,0,0,-20,8,0,0,0,0,8,0,4,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -20 6 0 0 0 0 6 0 1 0 4-4edge.dat
  [1,16,0,0,-20,6,0,0,0,0,6,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 -20 2 0 0 0 0 2 0 1 0 4-4ring3.dat
  [1,16,0,0,-20,2,0,0,0,0,2,0,1,0, ldraw_lib__4_4ring3(realsolid)],
];
module ldraw_lib__86208(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__86208(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__86208(line=0.2);