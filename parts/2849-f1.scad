...
use <2849k03.scad>
use <2849k04.scad>
function ldraw_lib__2849_f1() = [
// 0 Electric 9V Battery Box  4 x 14 x  4 - Buttons - Left Button Pressed
// 0 Name: 2849-f1.dat
...
module ldraw_lib__2849_f1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2849_f1(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__2849_f1(line=0.2);