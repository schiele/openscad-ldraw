...
use <../p/rect.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9413(realsolid=false) = [
...
// 1 16 0 -10 0 8 0 0 0 -12 0 0 0 8 4-4cylc.dat
  [1,16,0,-10,0,8,0,0,0,-12,0,0,0,8, ldraw_lib__4_4cylc(realsolid)],
// 1 16 0 -22 0 8 0 0 0 1 0 0 0 8 4-4ndis.dat
  [1,16,0,-22,0,8,0,0,0,1,0,0,0,8, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 0 -10 -10 4 0 0 0 0 4 0 -10 0 4-4cylo.dat
  [1,16,0,-10,-10,4,0,0,0,0,4,0,-10,0, ldraw_lib__4_4cylo(realsolid)],
...
// 1 16 0 -16 0 9.5 0 0 0 6 0 0 0 9.5 3-16cyli.dat
  [1,16,0,-16,0,9.5,0,0,0,6,0,0,0,9.5, ldraw_lib__3_16cyli(realsolid)],
// 1 16 0 -16 0 9.5 0 0 0 1 0 0 0 9.5 3-16edge.dat
  [1,16,0,-16,0,9.5,0,0,0,1,0,0,0,9.5, ldraw_lib__3_16edge(realsolid)],
// 1 16 0 -10 0 9.5 0 0 0 10 0 0 0 9.5 3-16cyls.dat
  [1,16,0,-10,0,9.5,0,0,0,10,0,0,0,9.5, ldraw_lib__3_16cyls(realsolid)],
// 1 16 10 0 0 0 -1 0 -10 0 0 0 0 10 1-8edge.dat
  [1,16,10,0,0,0,-1,0,-10,0,0,0,0,10, ldraw_lib__1_8edge(realsolid)],
// 1 16 10 0 0 0 -0.5 0 -10 0 0 0 0 10 1-8cyli.dat
  [1,16,10,0,0,0,-0.5,0,-10,0,0,0,0,10, ldraw_lib__1_8cyli(realsolid)],
// 1 16 9.5 0 0 0 -12 0 -10 0 0 0 0 10 1-8cyls.dat
  [1,16,9.5,0,0,0,-12,0,-10,0,0,0,0,10, ldraw_lib__1_8cyls(realsolid)],
...
// 1 16 8.0942 -11.53555 7.0711 0 0 -1.9058 -4.46445 0 0 0 1 0 rect.dat
  [1,16,8.0942,-11.53555,7.0711,0,0,-1.9058,-4.46445,0,0,0,1,0, ldraw_lib__rect(realsolid)],
...
// 1 16 8.0942 -11.53555 -7.0711 1.9058 0 0 0 0 4.46445 0 -1 0 rect.dat
  [1,16,8.0942,-11.53555,-7.0711,1.9058,0,0,0,0,4.46445,0,-1,0, ldraw_lib__rect(realsolid)],
...
// 1 16 9 -6 9 0 0 1 0 -16 0 1 0 0 8\1-4cyli.dat
  [1,16,9,-6,9,0,0,1,0,-16,0,1,0,0, ldraw_lib__8__1_4cyli(realsolid)],
// 1 16 9 -22 9 0 0 1 0 -1 0 1 0 0 8\1-4edge.dat
  [1,16,9,-22,9,0,0,1,0,-1,0,1,0,0, ldraw_lib__8__1_4edge(realsolid)],
// 1 16 9 -22 9 0 0 1 0 1 0 1 0 0 8\1-4chrd.dat
  [1,16,9,-22,9,0,0,1,0,1,0,1,0,0, ldraw_lib__8__1_4chrd(realsolid)],
// 1 16 9 -6 9 0 1 1 0 6 0 1 1 0 8\1-4con0.dat
  [1,16,9,-6,9,0,1,1,0,6,0,1,1,0, ldraw_lib__8__1_4con0(realsolid)],
...
// 1 16 -10 0 0 0 20 0 0 0 10 10 0 0 2-4cylo.dat
  [1,16,-10,0,0,0,20,0,0,0,10,10,0,0, ldraw_lib__2_4cylo(realsolid)],
...
module ldraw_lib__u9413(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9413(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
