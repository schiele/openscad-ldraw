...
use <s/50859s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__50859a(realsolid=false) = [
...
// 1 16 13 -10.93 17.36 0 -3 0 -4 0 0 0 0 -4 4-4cylc.dat
  [1,16,13,-10.93,17.36,0,-3,0,-4,0,0,0,0,-4, ldraw_lib__4_4cylc(realsolid)],
// 1 16 -13 -10.93 17.36 0 3 0 -4 0 0 0 0 -4 4-4cylc.dat
  [1,16,-13,-10.93,17.36,0,3,0,-4,0,0,0,0,-4, ldraw_lib__4_4cylc(realsolid)],
];
module ldraw_lib__50859a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__50859a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
