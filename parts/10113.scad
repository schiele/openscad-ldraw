...
use <../p/stud4o.scad>
$fa=1; $fs=0.2;
function ldraw_lib__10113(realsolid=false) = [
...
// 1 16 0 -8 0 1 0 0 0 -2 0 0 0 1 stud4o.dat
  [1,16,0,-8,0,1,0,0,0,-2,0,0,0,1, ldraw_lib__stud4o(realsolid)],
// 1 16 0 -7 0 8 0 0 0 7 0 0 0 8 4-4cyli.dat
  [1,16,0,-7,0,8,0,0,0,7,0,0,0,8, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 -2 0 1 0 0 0 1 0 0 0 1 s\10113s01.dat
  [1,16,0,-2,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__10113s01(realsolid)],
// 1 16 0 -2 0 -1 0 0 0 1 0 0 0 1 s\10113s01.dat
  [1,16,0,-2,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__10113s01(realsolid)],
];
module ldraw_lib__10113(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__10113(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__10113(line=0.2);