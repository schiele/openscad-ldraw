...
use <3820.scad>
use <973p7y.scad>
function ldraw_lib__76382p7y() = [
// 0 Minifig Torso with Arms and White Hands with Female Jacket with Medium Lavender Scarf with Fringe and Grey Belt Pattern
// 0 Name: 76382p7y.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973p7y.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973p7y()],
...
module ldraw_lib__76382p7y(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382p7y(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382p7y(line=0.2);