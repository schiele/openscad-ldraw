...
use <s/3754s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3754(realsolid=false) = [
// 0 Brick  1 x  6 x  5
// 0 Name: 3754.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3754s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3754s01(realsolid)],
// 0
];
module ldraw_lib__3754(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3754(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
