...
use <3820.scad>
use <973psx.scad>
function ldraw_lib__76382psx() = [
// 0 Minifig Torso with Arms and Hands with SW Dark Red Robe Pattern
// 0 Name: 76382psx.dat
...
module ldraw_lib__76382psx(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382psx(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382psx(line=0.2);