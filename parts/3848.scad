...
use <../p/4-8sphe.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3848(realsolid=false) = [
// 0 Minifig Battleaxe
// 0 Name: 3848.dat
...
// 0 !KEYWORDS axe, battleaxe, Castle, infantry, medieval, polearm, poleaxe, Weapon
// 
// 0 !CMDLINE -c6
// 
...
// 1 16 0 -52 0 4 0 0 0 112 0 0 0 4 4-4cyli.dat
  [1,16,0,-52,0,4,0,0,0,112,0,0,0,4, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 -60 0 -2 0 0 0 -2 0 0 0 2 4-8sphe.dat
  [1,16,0,-60,0,-2,0,0,0,-2,0,0,0,2, ldraw_lib__4_8sphe(realsolid)],
// 1 16 0 -52 0 -2 0 0 0 -8 0 0 0 2 4-4con1.dat
  [1,16,0,-52,0,-2,0,0,0,-8,0,0,0,2, ldraw_lib__4_4con1(realsolid)],
...
// 1 16 1.5 -52 10 0 1 0 6 0 0 0 0 6 1-4edge.dat
  [1,16,1.5,-52,10,0,1,0,6,0,0,0,0,6, ldraw_lib__1_4edge(realsolid)],
// 1 16 -1.5 -52 10 0 1 0 6 0 0 0 0 6 1-4edge.dat
  [1,16,-1.5,-52,10,0,1,0,6,0,0,0,0,6, ldraw_lib__1_4edge(realsolid)],
// 1 16 1.5 -30 10 0 1 0 -6 0 0 0 0 6 1-4edge.dat
  [1,16,1.5,-30,10,0,1,0,-6,0,0,0,0,6, ldraw_lib__1_4edge(realsolid)],
// 1 16 -1.5 -30 10 0 1 0 -6 0 0 0 0 6 1-4edge.dat
  [1,16,-1.5,-30,10,0,1,0,-6,0,0,0,0,6, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 1.5 -41 6.67 0 1 0 0 0 15.71 13.33 0 0 1-8edge.dat
  [1,16,1.5,-41,6.67,0,1,0,0,0,15.71,13.33,0,0, ldraw_lib__1_8edge(realsolid)],
// 1 16 -1.5 -41 6.67 0 1 0 0 0 15.71 13.33 0 0 1-8edge.dat
  [1,16,-1.5,-41,6.67,0,1,0,0,0,15.71,13.33,0,0, ldraw_lib__1_8edge(realsolid)],
// 1 16 1.5 -41 6.67 0 1 0 0 0 -15.71 13.33 0 0 1-8edge.dat
  [1,16,1.5,-41,6.67,0,1,0,0,0,-15.71,13.33,0,0, ldraw_lib__1_8edge(realsolid)],
...
// 1 16 0 -41 16 0 1 0 17 0 0 0 0 10 2-4edge.dat
  [1,16,0,-41,16,0,1,0,17,0,0,0,0,10, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 1.5 -52 10 0 -1 0 6 0 0 0 0 6 1-4ndis.dat
  [1,16,1.5,-52,10,0,-1,0,6,0,0,0,0,6, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -1.5 -52 10 0 1 0 6 0 0 0 0 6 1-4ndis.dat
  [1,16,-1.5,-52,10,0,1,0,6,0,0,0,0,6, ldraw_lib__1_4ndis(realsolid)],
// 1 16 1.5 -30 10 0 -1 0 -6 0 0 0 0 6 1-4ndis.dat
  [1,16,1.5,-30,10,0,-1,0,-6,0,0,0,0,6, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -1.5 -30 10 0 1 0 -6 0 0 0 0 6 1-4ndis.dat
  [1,16,-1.5,-30,10,0,1,0,-6,0,0,0,0,6, ldraw_lib__1_4ndis(realsolid)],
// 
// 0 BFC INVERTNEXT
...
// 1 16 1.5 -52 10 0 -3 0 6 0 0 0 0 6 1-4cyli.dat
  [1,16,1.5,-52,10,0,-3,0,6,0,0,0,0,6, ldraw_lib__1_4cyli(realsolid)],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 1.5 -30 10 0 -3 0 -6 0 0 0 0 6 1-4cyli.dat
  [1,16,1.5,-30,10,0,-3,0,-6,0,0,0,0,6, ldraw_lib__1_4cyli(realsolid)],
// 
...
module ldraw_lib__3848(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3848(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3848(line=0.2);