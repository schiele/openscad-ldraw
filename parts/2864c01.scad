...
use <u9074.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2864c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2864.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2864(realsolid)],
// 1 494 -65.125 3.5 0 1 0 0 0 1 0 0 0 1 u9074.dat
  [1,494,-65.125,3.5,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9074(realsolid)],
];
module ldraw_lib__2864c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2864c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
