...
use <27205.scad>
$fa=1; $fs=0.2;
function ldraw_lib__26910(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 27191c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__27191c01(realsolid)],
// 0 // Axle hubs
// 1 4 -60 66 140 0 0 1 0 1 0 -1 0 0 27205.dat
  [1,4,-60,66,140,0,0,1,0,1,0,-1,0,0, ldraw_lib__27205(realsolid)],
// 1 4 60 66 140 0 0 -1 0 1 0 1 0 0 27205.dat
  [1,4,60,66,140,0,0,-1,0,1,0,1,0,0, ldraw_lib__27205(realsolid)],
];
module ldraw_lib__26910(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__26910(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
