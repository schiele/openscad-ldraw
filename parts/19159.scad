...
use <s/47994s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__19159(realsolid=false) = [
...
// 1 16 0 -20 0 0 -1 0 0 0 1 1 0 0 connect7.dat
  [1,16,0,-20,0,0,-1,0,0,0,1,1,0,0, ldraw_lib__connect7(realsolid)],
// 1 16 0 20 0 0 -1 0 0 0 1 1 0 0 connect7.dat
  [1,16,0,20,0,0,-1,0,0,0,1,1,0,0, ldraw_lib__connect7(realsolid)],
...
// 1 16 0 20 0 0 -1 0 2.82843 0 2.82843 2.82843 0 -2.82843 1-4edge.dat
  [1,16,0,20,0,0,-1,0,2.82843,0,2.82843,2.82843,0,-2.82843, ldraw_lib__1_4edge(realsolid)],
// 1 16 0 20 0 0 -1 0 -2.82843 0 -2.82843 2.82843 0 -2.82843 1-4edge.dat
  [1,16,0,20,0,0,-1,0,-2.82843,0,-2.82843,2.82843,0,-2.82843, ldraw_lib__1_4edge(realsolid)],
...
module ldraw_lib__19159(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__19159(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
