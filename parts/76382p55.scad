...
use <3820.scad>
use <973p55.scad>
function ldraw_lib__76382p55() = [
// 0 Minifig Torso with Arms and Hands with Explorien Logo Pattern
// 0 Name: 76382p55.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973p55.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973p55()],
...
module ldraw_lib__76382p55(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382p55(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382p55(line=0.2);