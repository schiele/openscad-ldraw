...
use <s/2586s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2586p4c(realsolid=false) = [
...
// 1 1 0 0 -8 1 0 0 0 1 0 0 0 1 s\2586p4bs01.dat
  [1,1,0,0,-8,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2586p4bs01(realsolid)],
// 1 1 0 0 -8 1 0 0 0 1 0 0 0 1 s\2586p4bs02.dat
  [1,1,0,0,-8,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2586p4bs02(realsolid)],
];
module ldraw_lib__2586p4c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2586p4c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
