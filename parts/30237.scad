...
use <../p/clip14.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30237(realsolid=false) = [
...
// 1 16 0 12 -10 1 0 0 0 1 0 0 0 1 clip14.dat
  [1,16,0,12,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__clip14(realsolid)],
];
module ldraw_lib__30237(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30237(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
