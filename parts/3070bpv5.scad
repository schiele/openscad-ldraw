...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3070pb065, Rebrickable 3070bpr0093, Set 850425
// 
...
module ldraw_lib__3070bpv5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3070bpv5(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
