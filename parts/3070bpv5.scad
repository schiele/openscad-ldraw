...
use <s/3070bs01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3070bpv5(realsolid=false) = [
...
// 1 80 0 0 -2.5 -0.92388 0 0.38268 0 1 0 -0.38268 0 -0.92388 3-4ring4.dat
  [1,80,0,0,-2.5,-0.92388,0,0.38268,0,1,0,-0.38268,0,-0.92388, ldraw_lib__3_4ring4(realsolid)],
// 1 80 0 0 -2.5 -0.92388 0 0.38268 0 1 0 -0.38268 0 -0.92388 3-4ring3.dat
  [1,80,0,0,-2.5,-0.92388,0,0.38268,0,1,0,-0.38268,0,-0.92388, ldraw_lib__3_4ring3(realsolid)],
...
module ldraw_lib__3070bpv5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3070bpv5(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3070bpv5(line=0.2);