...
use <../p/stud3a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3702(realsolid=false) = [
...
// 1 16 72 14 0 0 0 4 0 -10 0 -6 0 0 box2-5.dat
  [1,16,72,14,0,0,0,4,0,-10,0,-6,0,0, ldraw_lib__box2_5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -72 14 0 0 0 -4 0 -10 0 6 0 0 box2-5.dat
  [1,16,-72,14,0,0,0,-4,0,-10,0,6,0,0, ldraw_lib__box2_5(realsolid)],
...
// 1 16 68 7 0 0 -1 0 -3 0 0 0 0 -6 rect2p.dat
  [1,16,68,7,0,0,-1,0,-3,0,0,0,0,-6, ldraw_lib__rect2p(realsolid)],
// 1 16 -68 7 0 0 1 0 -3 0 0 0 0 6 rect2p.dat
  [1,16,-68,7,0,0,1,0,-3,0,0,0,0,6, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__3702(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3702(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
