...
use <s/3815pbda.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3815bpbg(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3815pbda.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3815pbda(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\3815pbda.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3815pbda(realsolid)],
// 
...
module ldraw_lib__3815bpbg(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3815bpbg(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3815bpbg(line=0.2);