...
$fa=1; $fs=0.2;
function ldraw_lib__30350bp01(realsolid=false) = [
...
// 1 0 8.4 0 5 -.65 0 0 0 1 0 0 0 1 1-4chrd.dat
  [1,0,8.4,0,5,-.65,0,0,0,1,0,0,0,1, ldraw_lib__1_4chrd(realsolid)],
// 1 16 8.4 0 5 -.65 0 0 0 1 0 0 0 1 1-4ndis.dat
  [1,16,8.4,0,5,-.65,0,0,0,1,0,0,0,1, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 8.8 0 4.35 -.4 0 0 0 1 0 0 0 .4 1-4chrd.dat
  [1,16,8.8,0,4.35,-.4,0,0,0,1,0,0,0,.4, ldraw_lib__1_4chrd(realsolid)],
// 1 0 8.8 0 4.35 -.4 0 0 0 1 0 0 0 .4 1-4ndis.dat
  [1,0,8.8,0,4.35,-.4,0,0,0,1,0,0,0,.4, ldraw_lib__1_4ndis(realsolid)],
// 
// 0 // Corner II
// 1 0 3.7 0 -10.1 -.65 0 0 0 1 0 0 0 1 1-4chrd.dat
  [1,0,3.7,0,-10.1,-.65,0,0,0,1,0,0,0,1, ldraw_lib__1_4chrd(realsolid)],
// 1 16 3.7 0 -10.1 -.65 0 0 0 1 0 0 0 1 1-4ndis.dat
  [1,16,3.7,0,-10.1,-.65,0,0,0,1,0,0,0,1, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 3.9 0 -10.85 -.2 0 0 0 1 0 0 0 .2 1-4chrd.dat
  [1,16,3.9,0,-10.85,-.2,0,0,0,1,0,0,0,.2, ldraw_lib__1_4chrd(realsolid)],
// 1 0 3.9 0 -10.85 -.2 0 0 0 1 0 0 0 .2 1-4ndis.dat
  [1,0,3.9,0,-10.85,-.2,0,0,0,1,0,0,0,.2, ldraw_lib__1_4ndis(realsolid)],
// 
// 0 // Corner III
// 1 0 15.6 0 -10.1 .65 0 0 0 1 0 0 0 1 1-4chrd.dat
  [1,0,15.6,0,-10.1,.65,0,0,0,1,0,0,0,1, ldraw_lib__1_4chrd(realsolid)],
// 1 16 15.6 0 -10.1 .65 0 0 0 1 0 0 0 1 1-4ndis.dat
  [1,16,15.6,0,-10.1,.65,0,0,0,1,0,0,0,1, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 15.4 0 -10.85 .2 0 0 0 1 0 0 0 .2 1-4chrd.dat
  [1,16,15.4,0,-10.85,.2,0,0,0,1,0,0,0,.2, ldraw_lib__1_4chrd(realsolid)],
// 1 0 15.4 0 -10.85 .2 0 0 0 1 0 0 0 .2 1-4ndis.dat
  [1,0,15.4,0,-10.85,.2,0,0,0,1,0,0,0,.2, ldraw_lib__1_4ndis(realsolid)],
// 
// 0 // Corner IV
// 1 16 15.6 0 -28.06 .65 0 0 0 1 0 0 0 -.65 1-4ndis.dat
  [1,16,15.6,0,-28.06,.65,0,0,0,1,0,0,0,-.65, ldraw_lib__1_4ndis(realsolid)],
// 1 0 15.6 0 -28.06 .65 0 0 0 1 0 0 0 -.65 1-4chrd.dat
  [1,0,15.6,0,-28.06,.65,0,0,0,1,0,0,0,-.65, ldraw_lib__1_4chrd(realsolid)],
// 1 0 15.3 0 -27.76 .3 0 0 0 1 0 0 0 -.3 1-4ndis.dat
  [1,0,15.3,0,-27.76,.3,0,0,0,1,0,0,0,-.3, ldraw_lib__1_4ndis(realsolid)],
// 1 16 15.3 0 -27.76 .3 0 0 0 1 0 0 0 -.3 1-4chrd.dat
  [1,16,15.3,0,-27.76,.3,0,0,0,1,0,0,0,-.3, ldraw_lib__1_4chrd(realsolid)],
// 3 0 15.6 0 -28.71 16.25 0 -28.06 15.6 0 -28.06
  [3,0,15.6,0,-28.71,16.25,0,-28.06,15.6,0,-28.06],
// 
// 0 // Corner V
// 1 16 3.7 0 -28.06 -.65 0 0 0 1 0 0 0 -.65 1-4ndis.dat
  [1,16,3.7,0,-28.06,-.65,0,0,0,1,0,0,0,-.65, ldraw_lib__1_4ndis(realsolid)],
// 1 0 3.7 0 -28.06 -.65 0 0 0 1 0 0 0 -.65 1-4chrd.dat
  [1,0,3.7,0,-28.06,-.65,0,0,0,1,0,0,0,-.65, ldraw_lib__1_4chrd(realsolid)],
// 1 0 4 0 -27.76 -.3 0 0 0 1 0 0 0 -.3 1-4ndis.dat
  [1,0,4,0,-27.76,-.3,0,0,0,1,0,0,0,-.3, ldraw_lib__1_4ndis(realsolid)],
// 1 16 4 0 -27.76 -.3 0 0 0 1 0 0 0 -.3 1-4chrd.dat
  [1,16,4,0,-27.76,-.3,0,0,0,1,0,0,0,-.3, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 10.9 0 1 1 0 0 0 1 0 0 0 1 s\87079pt3s02.dat
  [1,16,10.9,0,1,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87079pt3s02(realsolid)],
// 1 16 10.9 0 -6 1 0 0 0 1 0 0 0 1 s\87079pt3s02.dat
  [1,16,10.9,0,-6,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87079pt3s02(realsolid)],
// 1 16 -10.9 0 1 -1 0 0 0 1 0 0 0 1 s\87079pt3s02.dat
  [1,16,-10.9,0,1,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87079pt3s02(realsolid)],
// 1 16 -10.9 0 -6 -1 0 0 0 1 0 0 0 1 s\87079pt3s02.dat
  [1,16,-10.9,0,-6,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87079pt3s02(realsolid)],
...
module ldraw_lib__30350bp01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30350bp01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
