...
use <73666.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4767(realsolid=false) = [
// 0 ~Moved to 73666
// 0 Name: 4767.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 73666.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__73666(realsolid)],
];
module ldraw_lib__4767(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4767(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
