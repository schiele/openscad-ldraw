...
use <../p/connect.scad>
$fa=1; $fs=0.2;
function ldraw_lib__40394(realsolid=false) = [
...
// 1 16 0 0 -4 1 0 0 0 0 1 0 1 0 connect.dat
  [1,16,0,0,-4,1,0,0,0,0,1,0,1,0, ldraw_lib__connect(realsolid)],
// 1 16 0 0 -4 8 0 0 0 0 8 0 4 0 4-4cyli.dat
  [1,16,0,0,-4,8,0,0,0,0,8,0,4,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 -4 4 0 0 0 0 4 0 1 0 4-4disc.dat
  [1,16,0,0,-4,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 -4 4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,16,0,0,-4,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 0 0 5.5 0 0 0 0 5.5 0 1 0 4-4edge.dat
  [1,16,0,0,0,5.5,0,0,0,0,5.5,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 0 0 5.5 0 0 0 0 5.5 0 5 0 4-4cyli.dat
  [1,16,0,0,0,5.5,0,0,0,0,5.5,0,5,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 5 5.5 0 0 0 0 5.5 0 -1 0 4-4disc.dat
  [1,16,0,0,5,5.5,0,0,0,0,5.5,0,-1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 0 5 5.5 0 0 0 0 5.5 0 1 0 4-4edge.dat
  [1,16,0,0,5,5.5,0,0,0,0,5.5,0,1,0, ldraw_lib__4_4edge(realsolid)],
];
module ldraw_lib__40394(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__40394(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
