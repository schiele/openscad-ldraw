...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\32273s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__32273s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\32273s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__32273s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\32273s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__32273s01()],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\32273s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__32273s02()],
// 1 16 0 0 0 0 0 -1 0 1 0 -1 0 0 s\32273s02.dat
  [1,16,0,0,0,0,0,-1,0,1,0,-1,0,0, ldraw_lib__s__32273s02()],
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 s\32273s02.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__s__32273s02()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\32273s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__32273s02()],
...
// 1 16 0 2 -40 6 0 0 0 6 0 0 0 6 4-4cyli.dat
  [1,16,0,2,-40,6,0,0,0,6,0,0,0,6, ldraw_lib__4_4cyli()],
...
// 1 16 0 5 -49 -20 0 0 0 0 5 0 1 0 rect2p.dat
  [1,16,0,5,-49,-20,0,0,0,0,5,0,1,0, ldraw_lib__rect2p()],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 2 40 -6 0 0 0 6 0 0 0 -6 4-4cyli.dat
...
module ldraw_lib__32273(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32273(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
