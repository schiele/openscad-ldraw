...
function ldraw_lib__6221655u() = [
// 0 Sticker  0.8 x  1.8 with Yellow Headlamp and Red Stripe on Black Background Left
// 0 Name: 6221655u.dat
...
module ldraw_lib__6221655u(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6221655u(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6221655u(line=0.2);