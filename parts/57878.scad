...
// 1 16 0 0 -2 0 0 3.125 3.125 0 0 0 1 0 4-4ring1.dat
  [1,16,0,0,-2,0,0,3.125,3.125,0,0,0,1,0, ldraw_lib__4_4ring1()],
// 1 16 0 0 -2 3.125 0 0 0 0 3.125 0 -0.625 0 4-4cylo.dat
  [1,16,0,0,-2,3.125,0,0,0,0,3.125,0,-0.625,0, ldraw_lib__4_4cylo()],
// 1 16 0 0 -2.625 0 0 3.125 3.125 0 0 0 -3.125 0 4-4con0.dat
  [1,16,0,0,-2.625,0,0,3.125,3.125,0,0,0,-3.125,0, ldraw_lib__4_4con0()],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 2.5 0 0 0 0 2.5 0 8 0 4-4cylc.dat
  [1,16,0,0,0,2.5,0,0,0,0,2.5,0,8,0, ldraw_lib__4_4cylc()],
// 
// 1 16 0 0 8 0 0 2.5 2.5 0 0 0 -1 0 4-4ring1.dat
  [1,16,0,0,8,0,0,2.5,2.5,0,0,0,-1,0, ldraw_lib__4_4ring1()],
// 1 16 0 0 8 0 0 1.25 1.25 0 0 0 -1 0 4-4ring4.dat
  [1,16,0,0,8,0,0,1.25,1.25,0,0,0,-1,0, ldraw_lib__4_4ring4()],
];
module ldraw_lib__57878(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__57878(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
