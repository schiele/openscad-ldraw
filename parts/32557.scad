...
use <../p/rect.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32557(realsolid=false) = [
...
// 1 16 10 -20 0 0 -20 0 0 0 -9 9 0 0 2-4cyli.dat
  [1,16,10,-20,0,0,-20,0,0,0,-9,9,0,0, ldraw_lib__2_4cyli(realsolid)],
// 1 16 10 -20 0 0 -20 0 0 0 -9 9 0 0 2-4edge.dat
  [1,16,10,-20,0,0,-20,0,0,0,-9,9,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -10 -20 0 0 -20 0 0 0 -9 9 0 0 2-4edge.dat
  [1,16,-10,-20,0,0,-20,0,0,0,-9,9,0,0, ldraw_lib__2_4edge(realsolid)],
...
// 1 16 -10 20 10 0 0 -1 1 0 0 0 -1 0 4-4ring8.dat
  [1,16,-10,20,10,0,0,-1,1,0,0,0,-1,0, ldraw_lib__4_4ring8(realsolid)],
...
// 1 16 10 -20 0 0 -1 0 0 0 -1 1 0 0 4-4ring8.dat
  [1,16,10,-20,0,0,-1,0,0,0,-1,1,0,0, ldraw_lib__4_4ring8(realsolid)],
...
module ldraw_lib__32557(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32557(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
