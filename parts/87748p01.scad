...
use <s/87748s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87748p01(realsolid=false) = [
...
// 1 16 0 -4 0 1 0 0 0 1 0 0 0 1 s\87748ps2.dat
  [1,16,0,-4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87748ps2(realsolid)],
// 1 16 0 -4 0 -1 0 0 0 1 0 0 0 1 s\87748ps2.dat
  [1,16,0,-4,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__87748ps2(realsolid)],
...
module ldraw_lib__87748p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87748p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
