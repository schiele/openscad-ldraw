...
use <s/459s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__459a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\459s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__459s01(realsolid)],
// 4 16 80 0 40 80 40 40 80 40 -40 80 0 -40
  [4,16,80,0,40,80,40,40,80,40,-40,80,0,-40],
];
module ldraw_lib__459a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__459a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
