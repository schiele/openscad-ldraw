...
use <../p/rect3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9407(realsolid=false) = [
...
// 1 16 -10.5 10.5 0 0 0 -9 9 0 0 0 1 0 1-4ndis.dat
  [1,16,-10.5,10.5,0,0,0,-9,9,0,0,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -10.5 10.5 2 0 0 -9 9 0 0 0 -1 0 1-4ndis.dat
  [1,16,-10.5,10.5,2,0,0,-9,9,0,0,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 -10.5 -10.5 0 -9 0 0 0 0 -9 0 1 0 1-4ndis.dat
  [1,16,-10.5,-10.5,0,-9,0,0,0,0,-9,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -10.5 -10.5 2 -9 0 0 0 0 -9 0 -1 0 1-4ndis.dat
  [1,16,-10.5,-10.5,2,-9,0,0,0,0,-9,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 -29 -20 9 0 58 0 -9 0 0 0 0 -9 1-4cylo.dat
  [1,16,-29,-20,9,0,58,0,-9,0,0,0,0,-9, ldraw_lib__1_4cylo(realsolid)],
...
// 1 16 -28 -16.5 21.5 1 0 0 0 1 2.5 0 0 2.5 rect.dat
  [1,16,-28,-16.5,21.5,1,0,0,0,1,2.5,0,0,2.5, ldraw_lib__rect(realsolid)],
...
// 1 16 -28 16.5 21.5 0 0 -1 2.5 -1 0 -2.5 0 0 rect.dat
  [1,16,-28,16.5,21.5,0,0,-1,2.5,-1,0,-2.5,0,0, ldraw_lib__rect(realsolid)],
// 1 16 -28 0 24 0 0 -1 14 0 0 0 -1 0 rect2p.dat
  [1,16,-28,0,24,0,0,-1,14,0,0,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 -29 -20 9 0 1 0 -9 0 0 0 0 -9 1-4chrd.dat
  [1,16,-29,-20,9,0,1,0,-9,0,0,0,0,-9, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -29 20 9 0 1 0 9 0 0 0 0 -9 1-4chrd.dat
  [1,16,-29,20,9,0,1,0,9,0,0,0,0,-9, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 -27 -20 9 0 54 0 -7 0 0 0 0 -7 1-4cylo.dat
  [1,16,-27,-20,9,0,54,0,-7,0,0,0,0,-7, ldraw_lib__1_4cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -27 20 9 0 54 0 7 0 0 0 0 -7 1-4cylo.dat
  [1,16,-27,20,9,0,54,0,7,0,0,0,0,-7, ldraw_lib__1_4cylo(realsolid)],
...
// 1 16 -27 -20 9 0 -1 0 -7 0 0 0 0 -7 1-4chrd.dat
  [1,16,-27,-20,9,0,-1,0,-7,0,0,0,0,-7, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -27 20 9 0 -1 0 7 0 0 0 0 -7 1-4chrd.dat
  [1,16,-27,20,9,0,-1,0,7,0,0,0,0,-7, ldraw_lib__1_4chrd(realsolid)],
...
// 1 16 -27 0 14 0 -1 0 0 0 27 -5 0 0 rect2p.dat
  [1,16,-27,0,14,0,-1,0,0,0,27,-5,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 -27 14 0 0 27 0 -1 0 5 0 0 rect1.dat
  [1,16,0,-27,14,0,0,27,0,-1,0,5,0,0, ldraw_lib__rect1(realsolid)],
// 4 16 29 -29 19 27 -27 19 -27 -27 19 -29 -29 19
  [4,16,29,-29,19,27,-27,19,-27,-27,19,-29,-29,19],
// 1 16 0 -29 14 29 0 0 0 1 0 0 0 5 rect3.dat
  [1,16,0,-29,14,29,0,0,0,1,0,0,0,5, ldraw_lib__rect3(realsolid)],
// 1 16 0 27 14 0 0 -27 0 1 0 5 0 0 rect1.dat
  [1,16,0,27,14,0,0,-27,0,1,0,5,0,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 -20 26.17485 35 -5 0 0 0 0 -1.22515 0 -1 0 rect.dat
  [1,16,-20,26.17485,35,-5,0,0,0,0,-1.22515,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 -20 28.2 33 5 0 0 0 -1 0.8 0 0 -2 rect3.dat
  [1,16,-20,28.2,33,5,0,0,0,-1,0.8,0,0,-2, ldraw_lib__rect3(realsolid)],
// 1 16 -20 29 30 5 0 0 0 -1 0 0 0 -1 rect3.dat
  [1,16,-20,29,30,5,0,0,0,-1,0,0,0,-1, ldraw_lib__rect3(realsolid)],
// 1 16 -20 28 29 5 0 0 0 0 -1 0 1 0 rect3.dat
  [1,16,-20,28,29,5,0,0,0,0,-1,0,1,0, ldraw_lib__rect3(realsolid)],
...
// 1 16 -20 27 18 0 0 5 0 -1 0 11 0 0 rect2p.dat
  [1,16,-20,27,18,0,0,5,0,-1,0,11,0,0, ldraw_lib__rect2p(realsolid)],
// 4 16 -15 27 29 -15 24.9497 35 -15 24.9497 4.0503 -15 27 7
  [4,16,-15,27,29,-15,24.9497,35,-15,24.9497,4.0503,-15,27,7],
// 1 16 -20 24.9497 19.52515 -5 0 0 0 1 0 0 0 -15.47485 rect3.dat
  [1,16,-20,24.9497,19.52515,-5,0,0,0,1,0,0,0,-15.47485, ldraw_lib__rect3(realsolid)],
// 1 16 -25 20 9 0 -1 0 7 0 0 0 0 -7 1-8edge.dat
  [1,16,-25,20,9,0,-1,0,7,0,0,0,0,-7, ldraw_lib__1_8edge(realsolid)],
// 1 16 -15 20 9 0 -1 0 7 0 0 0 0 -7 1-8edge.dat
  [1,16,-15,20,9,0,-1,0,7,0,0,0,0,-7, ldraw_lib__1_8edge(realsolid)],
// 1 16 20 26.17485 35 -5 0 0 0 0 -1.22515 0 -1 0 rect.dat
  [1,16,20,26.17485,35,-5,0,0,0,0,-1.22515,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 20 28.2 33 5 0 0 0 -1 0.8 0 0 -2 rect3.dat
  [1,16,20,28.2,33,5,0,0,0,-1,0.8,0,0,-2, ldraw_lib__rect3(realsolid)],
...
// 1 16 -20 -26.17485 35 0 0 5 -1.22515 0 0 0 -1 0 rect.dat
  [1,16,-20,-26.17485,35,0,0,5,-1.22515,0,0,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 -20 -28.2 33 -5 0 0 0 1 -0.8 0 0 -2 rect3.dat
  [1,16,-20,-28.2,33,-5,0,0,0,1,-0.8,0,0,-2, ldraw_lib__rect3(realsolid)],
// 1 16 -20 -29 30 -5 0 0 0 1 0 0 0 -1 rect3.dat
  [1,16,-20,-29,30,-5,0,0,0,1,0,0,0,-1, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__u9407(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9407(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
