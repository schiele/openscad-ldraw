...
use <../p/stug-4x4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__44042(realsolid=false) = [
...
// 1 16 -20 4 0 0 0 -1 0 1 0 1 0 0 filletr2s.dat
  [1,16,-20,4,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__filletr2s(realsolid)],
...
// 1 16 20 4 0 1 0 0 0 1 0 0 0 1 filletr2s.dat
  [1,16,20,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__filletr2s(realsolid)],
// 1 16 20 4 0 0 0 1 0 1 0 -1 0 0 filletr2s.dat
  [1,16,20,4,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__filletr2s(realsolid)],
// 1 16 20 4 0 -1 0 0 0 1 0 0 0 -1 filletr1s.dat
  [1,16,20,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletr1s(realsolid)],
...
module ldraw_lib__44042(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__44042(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
