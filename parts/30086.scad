...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30086s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30086s02()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\30086s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30086s02()],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\30086s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30086s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\30086s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30086s01()],
// 1 16 0 0 -100 1 0 0 0 1 0 0 0 1 s\30086s01.dat
  [1,16,0,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30086s01()],
// 1 16 0 0 -100 -1 0 0 0 1 0 0 0 1 s\30086s01.dat
  [1,16,0,0,-100,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__30086s01()],
...
// 1 16 0 -8 0 -24 0 0 0 8 0 0 0 60 box4-1.dat
  [1,16,0,-8,0,-24,0,0,0,8,0,0,0,60, ldraw_lib__box4_1()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 10 -16 0 0 0 -4 0 0 0 66 box5.dat
  [1,16,0,8,10,-16,0,0,0,-4,0,0,0,66, ldraw_lib__box5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -8 70 -40 0 0 0 8 0 0 0 6 box5.dat
  [1,16,0,-8,70,-40,0,0,0,8,0,0,0,6, ldraw_lib__box5()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -16 -110 -13 0 0 0 8 0 0 0 6 box5.dat
  [1,16,0,-16,-110,-13,0,0,0,8,0,0,0,6, ldraw_lib__box5()],
...
module ldraw_lib__30086(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30086(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
