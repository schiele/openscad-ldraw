...
use <s/87079s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87079px5(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS A-Team, Bricklink 87079pb343R, Lego Dimensions, Set 71251
// 
...
module ldraw_lib__87079px5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87079px5(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
