...
// 1 32 0 -69 -40 1 0 0 0 1 0 0 0 1 99392p01.dat
  [1,32,0,-69,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__99392p01()],
// 1 71 -40 -40 -41 -1 0 0 0 1 0 0 0 1 99393.dat
  [1,71,-40,-40,-41,-1,0,0,0,1,0,0,0,1, ldraw_lib__99393()],
// 1 71 40 -40 -41 1 0 0 0 1 0 0 0 1 99393.dat
  [1,71,40,-40,-41,1,0,0,0,1,0,0,0,1, ldraw_lib__99393()],
// 1 47 0 -60 -76 1 0 0 0 1 0 0 0 1 99961.dat
  [1,47,0,-60,-76,1,0,0,0,1,0,0,0,1, ldraw_lib__99961()],
// 1 0 0 -69 -71 1 0 0 0 1 0 0 0 1 11016.dat
  [1,0,0,-69,-71,1,0,0,0,1,0,0,0,1, ldraw_lib__11016()],
];
module ldraw_lib__95654(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__95654(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
