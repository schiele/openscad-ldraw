...
$fa=1; $fs=0.2;
function ldraw_lib__36069b(realsolid=false) = [
...
// 1 16 -.25 0 0 -1 0 0 0 1 0 0 0 1 s\36069bs01.dat
  [1,16,-.25,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__36069bs01(realsolid)],
// 1 16 .25 0 0 1 0 0 0 1 0 0 0 1 s\36069bs01.dat
  [1,16,.25,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__36069bs01(realsolid)],
...
module ldraw_lib__36069b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__36069b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
