...
$fa=1; $fs=0.2;
function ldraw_lib__u8104(realsolid=false) = [
...
// 1 16 0 48 0 0 0 -100 0 -48 0 20 0 0 box3u2p.dat
  [1,16,0,48,0,0,0,-100,0,-48,0,20,0,0, ldraw_lib__box3u2p(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 48 0 0 0 -60 0 -44 0 16 0 0 box3u2p.dat
  [1,16,0,48,0,0,0,-60,0,-44,0,16,0,0, ldraw_lib__box3u2p(realsolid)],
// 
// 1 16 80 4 0 1 0 0 0 -11 0 0 0 1 stud12.dat
  [1,16,80,4,0,1,0,0,0,-11,0,0,0,1, ldraw_lib__stud12(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 80 48 0 16 0 0 0 -44 0 0 0 16 box5.dat
  [1,16,80,48,0,16,0,0,0,-44,0,0,0,16, ldraw_lib__box5(realsolid)],
...
// 1 16 0 0 10 1 0 0 0 1 0 0 0 1 stug2-1x10.dat
  [1,16,0,0,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2_1x10(realsolid)],
// 1 16 0 0 -10 1 0 0 0 1 0 0 0 1 stug2-1x10.dat
  [1,16,0,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2_1x10(realsolid)],
// 
// 0 // arch a outside
// 1 16 0 72 -20 0 0 65 -64 0 0 0 1 0 48\1-6ndis.dat
  [1,16,0,72,-20,0,0,65,-64,0,0,0,1,0, ldraw_lib__48__1_6ndis(realsolid)],
// 1 16 0 72 -20 0 0 -65 -64 0 0 0 1 0 48\1-6ndis.dat
  [1,16,0,72,-20,0,0,-65,-64,0,0,0,1,0, ldraw_lib__48__1_6ndis(realsolid)],
...
// 1 16 0 72 -20 0 0 65 -64 0 0 0 4 0 48\1-6cylo.dat
  [1,16,0,72,-20,0,0,65,-64,0,0,0,4,0, ldraw_lib__48__1_6cylo(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 72 -20 0 0 -65 -64 0 0 0 4 0 48\1-6cylo.dat
  [1,16,0,72,-20,0,0,-65,-64,0,0,0,4,0, ldraw_lib__48__1_6cylo(realsolid)],
// 1 16 -58.145 44 -18 0 0 -1.855 0 -1 4 -2 0 0 rect3.dat
  [1,16,-58.145,44,-18,0,0,-1.855,0,-1,4,-2,0,0, ldraw_lib__rect3(realsolid)],
// 1 16 58.145 44 -18 0 0 1.855 0 -1 4 2 0 0 rect3.dat
  [1,16,58.145,44,-18,0,0,1.855,0,-1,4,2,0,0, ldraw_lib__rect3(realsolid)],
// 
// 0 // arch inside
...
// 1 16 -31 4 0 29 0 0 0 4 0 0 0 2 box3u5p.dat
  [1,16,-31,4,0,29,0,0,0,4,0,0,0,2, ldraw_lib__box3u5p(realsolid)],
// 1 16 31 4 0 -29 0 0 0 4 0 0 0 2 box3u5p.dat
  [1,16,31,4,0,-29,0,0,0,4,0,0,0,2, ldraw_lib__box3u5p(realsolid)],
// 1 16 0 4 -9 0 0 -2 0 4 0 7 0 0 box3u5p.dat
  [1,16,0,4,-9,0,0,-2,0,4,0,7,0,0, ldraw_lib__box3u5p(realsolid)],
// 1 16 0 4 9 0 0 -2 0 4 0 -7 0 0 box3u5p.dat
  [1,16,0,4,9,0,0,-2,0,4,0,-7,0,0, ldraw_lib__box3u5p(realsolid)],
// 2 24 2 4 -2 2 8 -2
  [2,24,2,4,-2,2,8,-2],
...
module ldraw_lib__u8104(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u8104(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
