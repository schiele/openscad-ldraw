...
use <62272.scad>
$fa=1; $fs=0.2;
function ldraw_lib__62271c01(realsolid=false) = [
...
// 1 72 0 20 10 1 0 0 0 1 0 0 0 1 62271.dat
  [1,72,0,20,10,1,0,0,0,1,0,0,0,1, ldraw_lib__62271(realsolid)],
// 1 16 0 0 158 1 0 0 0 1 0 0 0 1 62272.dat
  [1,16,0,0,158,1,0,0,0,1,0,0,0,1, ldraw_lib__62272(realsolid)],
];
module ldraw_lib__62271c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__62271c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
