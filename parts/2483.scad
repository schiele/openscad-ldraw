...
use <s/2483s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2483(realsolid=false) = [
...
// 1 16 0 36 -66 0 0 -32 -20 0 0 10 1 0 rect1.dat
  [1,16,0,36,-66,0,0,-32,-20,0,0,10,1,0, ldraw_lib__rect1(realsolid)],
// 4 16 32 16 -56 36 -4 -4 -36 -4 -4 -32 16 -56
  [4,16,32,16,-56,36,-4,-4,-36,-4,-4,-32,16,-56],
];
module ldraw_lib__2483(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2483(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
