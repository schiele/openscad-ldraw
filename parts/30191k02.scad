...
use <../p/t01o1154.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30191k02(realsolid=false) = [
...
// 1 16 -14 0 0 0 1 0 -2.5 0 0 0 0 -2.5 4-4edge.dat
  [1,16,-14,0,0,0,1,0,-2.5,0,0,0,0,-2.5, ldraw_lib__4_4edge(realsolid)],
// 1 16 -14 0 0 0 1 0 -3.586 0 0 0 0 -3.586 4-4edge.dat
  [1,16,-14,0,0,0,1,0,-3.586,0,0,0,0,-3.586, ldraw_lib__4_4edge(realsolid)],
// 1 16 -14 0 0 0 1 0 -3.586 0 0 0 0 -3.586 4-4disc.dat
  [1,16,-14,0,0,0,1,0,-3.586,0,0,0,0,-3.586, ldraw_lib__4_4disc(realsolid)],
...
// 1 16 -8 0 0 0 1 0 0 0 -3.586 3.586 0 0 4-4edge.dat
  [1,16,-8,0,0,0,1,0,0,0,-3.586,3.586,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 -7 0 0 0 -8.65 0 0 0 -3.586 3.586 0 0 t01o1154.dat
  [1,16,-7,0,0,0,-8.65,0,0,0,-3.586,3.586,0,0, ldraw_lib__t01o1154(realsolid)],
// 1 16 -7 0 0 0 8.65 0 0 0 -3.586 3.586 0 0 t01o1154.dat
  [1,16,-7,0,0,0,8.65,0,0,0,-3.586,3.586,0,0, ldraw_lib__t01o1154(realsolid)],
// 1 16 -6 0 0 0 1 0 0 0 -3.586 3.586 0 0 4-4edge.dat
  [1,16,-6,0,0,0,1,0,0,0,-3.586,3.586,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 -5 0 0 0 -8.65 0 0 0 -3.586 3.586 0 0 t01o1154.dat
  [1,16,-5,0,0,0,-8.65,0,0,0,-3.586,3.586,0,0, ldraw_lib__t01o1154(realsolid)],
// 1 16 -5 0 0 0 8.65 0 0 0 -3.586 3.586 0 0 t01o1154.dat
  [1,16,-5,0,0,0,8.65,0,0,0,-3.586,3.586,0,0, ldraw_lib__t01o1154(realsolid)],
// 1 16 -4 0 0 0 1 0 0 0 -3.586 3.586 0 0 4-4edge.dat
  [1,16,-4,0,0,0,1,0,0,0,-3.586,3.586,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 -3 0 0 0 -8.65 0 0 0 -3.586 3.586 0 0 t01o1154.dat
  [1,16,-3,0,0,0,-8.65,0,0,0,-3.586,3.586,0,0, ldraw_lib__t01o1154(realsolid)],
// 1 16 0 0 0 0 -3 0 -4 0 0 0 0 -4 4-4cyli.dat
  [1,16,0,0,0,0,-3,0,-4,0,0,0,0,-4, ldraw_lib__4_4cyli(realsolid)],
];
module ldraw_lib__30191k02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30191k02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
