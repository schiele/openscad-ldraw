...
$fa=1; $fs=0.2;
function ldraw_lib__u9151p01c03(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Set 3791, Willem Walroß, William Walrus
// 
// 0 !HISTORY 2011-07-25 [PTadmin] Official Update 2011-01
// 
// 
// 1 450 0 -67 4 1 0 0 0 1 0 0 0 1 u9151p01c01.dat
  [1,450,0,-67,4,1,0,0,0,1,0,0,0,1, ldraw_lib__u9151p01c01(realsolid)],
...
module ldraw_lib__u9151p01c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9151p01c03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
