...
// 1 16 0 15.75 0 1 0 0 0 -1 0 0 0 1 s\18673s01.dat
  [1,16,0,15.75,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__s__18673s01()],
// 1 16 0 15.75 0 1 0 0 0 1 0 0 0 1 s\18673s01.dat
  [1,16,0,15.75,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__18673s01()],
// 1 16 0 7.3 0 4 0 0 0 16.9 0 0 0 4 4-4cylo.dat
  [1,16,0,7.3,0,4,0,0,0,16.9,0,0,0,4, ldraw_lib__4_4cylo()],
];
module ldraw_lib__18673(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__18673(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
