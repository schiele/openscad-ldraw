...
use <s/98138s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98138p13(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\98138p13s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__98138p13s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\98138p13s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__98138p13s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 -1 s\98138p13s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__98138p13s01(realsolid)],
...
// 1 353 0 0 0 6.8 0 0 0 1 0 0 0 6.8 4-4ering.dat
  [1,353,0,0,0,6.8,0,0,0,1,0,0,0,6.8, ldraw_lib__4_4ering(realsolid)],
// 1 15 0 0 0 .4 0 0 0 1 0 0 0 .4 4-4rin17.dat
  [1,15,0,0,0,.4,0,0,0,1,0,0,0,.4, ldraw_lib__4_4rin17(realsolid)],
// 1 15 0 0 0 .4 0 0 0 1 0 0 0 .4 4-4rin18.dat
  [1,15,0,0,0,.4,0,0,0,1,0,0,0,.4, ldraw_lib__4_4rin18(realsolid)],
// 1 3 0 0 0 .4 0 0 0 1 0 0 0 .4 4-4rin19.dat
  [1,3,0,0,0,.4,0,0,0,1,0,0,0,.4, ldraw_lib__4_4rin19(realsolid)],
// 1 3 0 0 0 1 0 0 0 1 0 0 0 1 4-4ring8.dat
  [1,3,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4ring8(realsolid)],
];
module ldraw_lib__98138p13(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98138p13(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
