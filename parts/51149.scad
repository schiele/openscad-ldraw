...
use <s/6641s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__51149(realsolid=false) = [
...
// 1 16 10 0 -42 0 -20 0 0 0 1.5 1.5 0 0 4-4cylo.dat
  [1,16,10,0,-42,0,-20,0,0,0,1.5,1.5,0,0, ldraw_lib__4_4cylo(realsolid)],
// 1 16 10 0 -42 0 -1 0 0 0 1.5 1.5 0 0 4-4ndis.dat
  [1,16,10,0,-42,0,-1,0,0,0,1.5,1.5,0,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -10 0 -42 0 1 0 0 0 1.5 1.5 0 0 4-4ndis.dat
  [1,16,-10,0,-42,0,1,0,0,0,1.5,1.5,0,0, ldraw_lib__4_4ndis(realsolid)],
...
// 1 16 10 0 -20 0 -20 0 1 0 0 0 0 1 axl4hole.dat
  [1,16,10,0,-20,0,-20,0,1,0,0,0,0,1, ldraw_lib__axl4hole(realsolid)],
// 1 16 10 0 -20 0 -1 0 6 0 0 0 0 6 1-4edge.dat
  [1,16,10,0,-20,0,-1,0,6,0,0,0,0,6, ldraw_lib__1_4edge(realsolid)],
// 1 16 10 0 -20 0 -1 0 -6 0 0 0 0 -6 1-4edge.dat
  [1,16,10,0,-20,0,-1,0,-6,0,0,0,0,-6, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 10 0 -20 0 -1 0 -6 0 0 0 0 6 1-4ering.dat
  [1,16,10,0,-20,0,-1,0,-6,0,0,0,0,6, ldraw_lib__1_4ering(realsolid)],
// 1 16 10 0 -20 0 -1 0 6 0 0 0 0 -6 1-4ering.dat
  [1,16,10,0,-20,0,-1,0,6,0,0,0,0,-6, ldraw_lib__1_4ering(realsolid)],
// 1 16 -10 0 -20 0 1 0 -6 0 0 0 0 6 1-4ering.dat
  [1,16,-10,0,-20,0,1,0,-6,0,0,0,0,6, ldraw_lib__1_4ering(realsolid)],
...
module ldraw_lib__51149(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__51149(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
