...
use <s/3648s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3648a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3648s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3648s01(realsolid)],
// 0
// 0 Center axleholes
// 0
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3648s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3648s02(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\3648s02.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3648s02(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\3648s02.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3648s02(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3648as01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3648as01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 -1 s\3648as01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,-1, ldraw_lib__s__3648as01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\3648as01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3648as01(realsolid)],
...
module ldraw_lib__3648a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3648a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
