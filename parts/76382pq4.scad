...
use <3820.scad>
use <973pq4.scad>
function ldraw_lib__76382pq4() = [
// 0 Minifig Torso with Arms and Hands with Tank Top, Braces & Yellow Skin Pattern
// 0 Name: 76382pq4.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973pq4.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973pq4()],
...
module ldraw_lib__76382pq4(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382pq4(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382pq4(line=0.2);