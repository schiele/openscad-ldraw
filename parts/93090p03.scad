...
use <s/93090s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__93090p03(realsolid=false) = [
...
// 1 323 0 0 0 1 0 0 0 1 0 0 0 1 s\93090s02.dat
  [1,323,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__93090s02(realsolid)],
// 1 323 0 0 0 -1 0 0 0 1 0 0 0 1 s\93090s02.dat
  [1,323,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__93090s02(realsolid)],
];
module ldraw_lib__93090p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__93090p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
