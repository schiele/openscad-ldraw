...
use <3817p3j.scad>
$fa=1; $fs=0.2;
function ldraw_lib__972p3j(realsolid=false) = [
// 0 ~Moved to 3817p3j
// 0 Name: 972p3j.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3817p3j.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3817p3j(realsolid)],
];
module ldraw_lib__972p3j(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__972p3j(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
