...
// 1 16 0 0 12.5 0 1 0 1 0 0 0 0 -1 arm3.dat
  [1,16,0,0,12.5,0,1,0,1,0,0,0,0,-1, ldraw_lib__arm3()],
// 
...
module ldraw_lib__4220b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4220b(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
