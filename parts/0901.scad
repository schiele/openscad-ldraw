...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__0901(realsolid=false) = [
...
// 1 16 296 4 156 4 0 0 0 1 0 0 0 4 1-4edge.dat
  [1,16,296,4,156,4,0,0,0,1,0,0,0,4, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 296 0 156 4 0 0 0 1 0 0 0 4 1-4edge.dat
  [1,16,296,0,156,4,0,0,0,1,0,0,0,4, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 296 4 156 4 0 0 0 -1 0 0 0 4 1-4disc.dat
  [1,16,296,4,156,4,0,0,0,-1,0,0,0,4, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 296 0 156 4 0 0 0 1 0 0 0 4 1-4disc.dat
  [1,16,296,0,156,4,0,0,0,1,0,0,0,4, ldraw_lib__1_4disc(realsolid)],
...
// 1 16 296 0 156 4 0 0 0 4 0 0 0 4 1-4cyli.dat
  [1,16,296,0,156,4,0,0,0,4,0,0,0,4, ldraw_lib__1_4cyli(realsolid)],
...
module ldraw_lib__0901(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__0901(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
