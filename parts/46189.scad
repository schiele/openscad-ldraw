...
use <../p/connect7.scad>
use <s/15461s01.scad>
function ldraw_lib__46189() = [
// 0 Technic Connector  3 x  1 x  2 with Peghole and Two Pins (Perpendicular Slits)
// 0 Name: 46189.dat
...
module ldraw_lib__46189(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__46189(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__46189(line=0.2);