...
// 1 16 0 60 0 1 0 0 0 1 0 0 0 1 u9340.dat
  [1,16,0,60,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9340()],
// 1 47 0 0 0 1 0 0 0 1 0 0 0 1 u9341.dat
  [1,47,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9341()],
];
module ldraw_lib__721(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__721(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
