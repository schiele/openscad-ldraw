...
use <s/32195s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__32195b(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\32195s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__32195s01(realsolid)],
// 0 //
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -3 -60 -7.391 0 3.061 0 6.8 0 -3.061 0 -7.391 3-8cyli.dat
  [1,16,0,-3,-60,-7.391,0,3.061,0,6.8,0,-3.061,0,-7.391, ldraw_lib__3_8cyli(realsolid)],
...
// 1 16 0 3.8 -60 0 0 8 0 3.2 0 -8 0 0 1-4cyls.dat
  [1,16,0,3.8,-60,0,0,8,0,3.2,0,-8,0,0, ldraw_lib__1_4cyls(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 3.8 -60 0 0 -8 0 3.2 0 -8 0 0 1-4cyls.dat
  [1,16,0,3.8,-60,0,0,-8,0,3.2,0,-8,0,0, ldraw_lib__1_4cyls(realsolid)],
...
// 1 16 0 7 -60 8 0 0 0 1 -3.2 0 0 -8 2-4edge.dat
  [1,16,0,7,-60,8,0,0,0,1,-3.2,0,0,-8, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 6.978 -60 -10 0 0 0 10 -4 0 0 -10 2-4edge.dat
  [1,16,0,6.978,-60,-10,0,0,0,10,-4,0,0,-10, ldraw_lib__2_4edge(realsolid)],
// 2 24 -8 7 -60 -10 7 -60
  [2,24,-8,7,-60,-10,7,-60],
// 2 24 8 7 -60 10 7 -60
  [2,24,8,7,-60,10,7,-60],
// 1 16 0 7 -60 2 0 0 0 -1 -0.8 0 0 -2 2-4ring4.dat
  [1,16,0,7,-60,2,0,0,0,-1,-0.8,0,0,-2, ldraw_lib__2_4ring4(realsolid)],
// 0 //
// 1 16 0 3 -60 0 0 10 0 4 0 -10 0 0 1-4cyls.dat
  [1,16,0,3,-60,0,0,10,0,4,0,-10,0,0, ldraw_lib__1_4cyls(realsolid)],
// 1 16 0 3 -60 0 0 -10 0 4 0 -10 0 0 1-4cyls.dat
  [1,16,0,3,-60,0,0,-10,0,4,0,-10,0,0, ldraw_lib__1_4cyls(realsolid)],
];
module ldraw_lib__32195b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32195b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
