...
$fa=1; $fs=0.2;
function ldraw_lib__004760b(realsolid=false) = [
...
// 1 7 0 -0.25 0 1 0 0 0 1 0 0 0 1 s\3068bp09s01.dat
  [1,7,0,-0.25,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3068bp09s01(realsolid)],
// 1 14 0 -0.25 0 1 0 0 0 1 0 0 0 1 s\3068bp09s02.dat
  [1,14,0,-0.25,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3068bp09s02(realsolid)],
...
module ldraw_lib__004760b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__004760b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
