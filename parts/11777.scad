...
use <11778.scad>
$fa=1; $fs=0.2;
function ldraw_lib__11777(realsolid=false) = [
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 11778.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__11778(realsolid)],
];
module ldraw_lib__11777(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11777(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
