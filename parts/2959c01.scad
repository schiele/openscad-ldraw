...
use <70023.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2959c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 4106.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__4106(realsolid)],
// 1 493 0 0 0 1 0 0 0 1 0 0 0 1 70023.dat
  [1,493,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__70023(realsolid)],
];
module ldraw_lib__2959c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2959c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
