...
use <s/3010s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3010pzh(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Brickheadz, Set 41497
// 
...
// 1 16 0 0 -10 1 0 0 0 1 0 0 0 1 s\3010pzhs01.dat
  [1,16,0,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010pzhs01(realsolid)],
// 1 16 0 0 -10 -1 0 0 0 1 0 0 0 1 s\3010pzhs01.dat
  [1,16,0,0,-10,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010pzhs01(realsolid)],
];
module ldraw_lib__3010pzh(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3010pzh(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
