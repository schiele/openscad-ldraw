...
use <s/3005s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3005pv9(realsolid=false) = [
...
// 1 16 0 11.1 -10 2.4 0 0 0 0 2.3 0 1 0 4-4disc.dat
  [1,16,0,11.1,-10,2.4,0,0,0,0,2.3,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 1 0 11.1 -10 2.4 0 0 0 0 2.3 0 1 0 1-4ndis.dat
  [1,1,0,11.1,-10,2.4,0,0,0,0,2.3,0,1,0, ldraw_lib__1_4ndis(realsolid)],
// 1 1 0 11.1 -10 5.6 0 0 0 0 5.1 0 1 0 1-8chrd.dat
  [1,1,0,11.1,-10,5.6,0,0,0,0,5.1,0,1,0, ldraw_lib__1_8chrd(realsolid)],
...
// 1 16 0 11.1 -10 5.6 0 0 0 0 5.1 0 1 0 1-8ndis.dat
  [1,16,0,11.1,-10,5.6,0,0,0,0,5.1,0,1,0, ldraw_lib__1_8ndis(realsolid)],
// 
// 0 // RING28N v1.0
// 1 1 0 11.1 -10 -2.4 0 0 0 0 2.3 0 1 0 1-4ndis.dat
  [1,1,0,11.1,-10,-2.4,0,0,0,0,2.3,0,1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 1 0 11.1 -10 -3.95976 0 3.95976 3.6062 0 3.6062 0 1 0 1-8chrd.dat
  [1,1,0,11.1,-10,-3.95976,0,3.95976,3.6062,0,3.6062,0,1,0, ldraw_lib__1_8chrd(realsolid)],
...
// 1 16 0 11.1 -10 5.6 0 0 0 0 -5.1 0 1 0 3-4ndis.dat
  [1,16,0,11.1,-10,5.6,0,0,0,0,-5.1,0,1,0, ldraw_lib__3_4ndis(realsolid)],
// 
...
module ldraw_lib__3005pv9(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3005pv9(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
