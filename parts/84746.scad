...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__84746(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\84746s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__84746s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\84746s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__84746s01(realsolid)],
...
// 1 1 -60 -3.5 -47.5 -2 0 0 0 1 0 0 0 2 2-4disc.dat
  [1,1,-60,-3.5,-47.5,-2,0,0,0,1,0,0,0,2, ldraw_lib__2_4disc(realsolid)],
// 4 4 62 -3.5 -55.5 62 -3.5 -47.5 58 -3.5 -47.5 58 -3.5 -55.5
  [4,4,62,-3.5,-55.5,62,-3.5,-47.5,58,-3.5,-47.5,58,-3.5,-55.5],
// 1 4 60 -3.5 -47.5 -2 0 0 0 1 0 0 0 2 2-4disc.dat
  [1,4,60,-3.5,-47.5,-2,0,0,0,1,0,0,0,2, ldraw_lib__2_4disc(realsolid)],
];
module ldraw_lib__84746(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__84746(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
