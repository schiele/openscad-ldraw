...
// 1 16 -42 0 0 0 84 0 1 0 0 0 0 1 axlehole.dat
  [1,16,-42,0,0,0,84,0,1,0,0,0,0,1, ldraw_lib__axlehole()],
// 1 16 -42 0 0 0 1 0 1 0 0 0 0 1 axlehol2.dat
  [1,16,-42,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__axlehol2()],
// 1 16 42 0 0 0 1 0 1 0 0 0 0 1 axlehol2.dat
  [1,16,42,0,0,0,1,0,1,0,0,0,0,1, ldraw_lib__axlehol2()],
// 1 16 42 0 0 0 -1 0 3 0 0 0 0 3 4-4ring2.dat
  [1,16,42,0,0,0,-1,0,3,0,0,0,0,3, ldraw_lib__4_4ring2()],
// 1 16 -42 0 0 0 1 0 3 0 0 0 0 3 4-4ring2.dat
  [1,16,-42,0,0,0,1,0,3,0,0,0,0,3, ldraw_lib__4_4ring2()],
// 1 16 -42 0 0 0 84 0 9 0 0 0 0 9 4-4cylo.dat
  [1,16,-42,0,0,0,84,0,9,0,0,0,0,9, ldraw_lib__4_4cylo()],
];
module ldraw_lib__u9511(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9511(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
