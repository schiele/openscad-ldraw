...
use <../p/stud2a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6105(realsolid=false) = [
...
// 1 16 2 16 60 0 -1 0 1 0 0 0 0 1 stud2a.dat
  [1,16,2,16,60,0,-1,0,1,0,0,0,0,1, ldraw_lib__stud2a(realsolid)],
// 1 16 -2 16 60 0 1 0 1 0 0 0 0 -1 stud2a.dat
  [1,16,-2,16,60,0,1,0,1,0,0,0,0,-1, ldraw_lib__stud2a(realsolid)],
// 1 16 0 .5 34.75 2 0 0 0 90.5 0 0 0 34.75 box2-7.dat
  [1,16,0,.5,34.75,2,0,0,0,90.5,0,0,0,34.75, ldraw_lib__box2_7(realsolid)],
// 1 16 0 -90 69.5 2 0 0 0 0 -2 0 -1 0 2-4chrd.dat
  [1,16,0,-90,69.5,2,0,0,0,0,-2,0,-1,0, ldraw_lib__2_4chrd(realsolid)],
// 1 16 0 -90 69.5 2 0 0 0 0 -2 0 1 0 2-4edge.dat
  [1,16,0,-90,69.5,2,0,0,0,0,-2,0,1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 91 0 -2 0 0 0 -1 0 0 0 -2 2-4chrd.dat
  [1,16,0,91,0,-2,0,0,0,-1,0,0,0,-2, ldraw_lib__2_4chrd(realsolid)],
// 1 16 0 91 0 2 0 0 0 -41 0 0 0 -2 2-4cylo.dat
  [1,16,0,91,0,2,0,0,0,-41,0,0,0,-2, ldraw_lib__2_4cylo(realsolid)],
...
// 1 16 0 -2 0 2 0 0 0 -18.5 0 0 0 -2 2-4cyli.dat
  [1,16,0,-2,0,2,0,0,0,-18.5,0,0,0,-2, ldraw_lib__2_4cyli(realsolid)],
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\6105s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__6105s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\6105s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__6105s01(realsolid)],
];
module ldraw_lib__6105(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6105(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
