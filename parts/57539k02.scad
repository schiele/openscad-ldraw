...
use <../p/t01o2500.scad>
$fa=1; $fs=0.2;
function ldraw_lib__57539k02(realsolid=false) = [
...
// 1 16 0 1.5 0 4 0 0 0 1 0 0 0 4 4-4edge.dat
  [1,16,0,1.5,0,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 1.25 0 1 0 0 0 0.25 0 0 0 1 4-4con4.dat
  [1,16,0,1.25,0,1,0,0,0,0.25,0,0,0,1, ldraw_lib__4_4con4(realsolid)],
// 1 16 0 0 0 5 0 0 0 5 0 0 0 5 t01o2500.dat
  [1,16,0,0,0,5,0,0,0,5,0,0,0,5, ldraw_lib__t01o2500(realsolid)],
// 1 16 0 0 0 5 0 0 0 -5 0 0 0 5 t01o2500.dat
  [1,16,0,0,0,5,0,0,0,-5,0,0,0,5, ldraw_lib__t01o2500(realsolid)],
// 1 16 0 -1.25 0 1 0 0 0 -0.25 0 0 0 1 4-4con4.dat
  [1,16,0,-1.25,0,1,0,0,0,-0.25,0,0,0,1, ldraw_lib__4_4con4(realsolid)],
...
// 1 16 0 -1.5 0 0.5 0 0 0 -2.8 0 0 0 0.5 4-4con7.dat
  [1,16,0,-1.5,0,0.5,0,0,0,-2.8,0,0,0,0.5, ldraw_lib__4_4con7(realsolid)],
// 1 16 0 1.5 0 0.5 0 0 0 2.8 0 0 0 0.5 4-4con7.dat
  [1,16,0,1.5,0,0.5,0,0,0,2.8,0,0,0,0.5, ldraw_lib__4_4con7(realsolid)],
];
module ldraw_lib__57539k02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__57539k02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
