...
use <t1061.scad>
use <u9401.scad>
function ldraw_lib__t1060c01() = [
// 0 | Circuit Cubes BLE Battery
// 0 Name: t1060c01.dat
...
// 
// 0 // Cover
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 t1060.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__t1060()],
// 0 // Base
...
// 1 494 37.7 25.7 -3.6 0 -1 0 0 0 -1 1 0 0 u9401.dat
  [1,494,37.7,25.7,-3.6,0,-1,0,0,0,-1,1,0,0, ldraw_lib__u9401()],
// 
// 0 // Metal Posts
...
// 1 0 0 23.5 36 -1 0 0 0 1 0 0 0 -1 t1047.dat
  [1,0,0,23.5,36,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1047()],
// 
// 0 // Side contacts
...
// 1 15 0 34 0 -1 0 0 0 1 0 0 0 -1 t1051.dat
  [1,15,0,34,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__t1051()],
// 
// 0 // bottom contacts
...
// 1 494 -30 34 -30 -0.70711 0 0.70711 0 1 0 -0.70711 0 -0.70711 t1050.dat
  [1,494,-30,34,-30,-0.70711,0,0.70711,0,1,0,-0.70711,0,-0.70711, ldraw_lib__t1050()],
// 
// 0 // Two pins connectors
// 1 0 0 29.5 -28 1 0 0 0 1 0 0 0 1 t1061.dat
  [1,0,0,29.5,-28,1,0,0,0,1,0,0,0,1, ldraw_lib__t1061()],
// 1 0 -12 29.5 -28 1 0 0 0 1 0 0 0 1 t1061.dat
  [1,0,-12,29.5,-28,1,0,0,0,1,0,0,0,1, ldraw_lib__t1061()],
// 1 0 12 29.5 -28 1 0 0 0 1 0 0 0 1 t1061.dat
  [1,0,12,29.5,-28,1,0,0,0,1,0,0,0,1, ldraw_lib__t1061()],
];
module ldraw_lib__t1060c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1060c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__t1060c01(line=0.2);