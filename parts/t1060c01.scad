...
use <u9401.scad>
$fa=1; $fs=0.2;
function ldraw_lib__t1060c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 t1060.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__t1060(realsolid)],
// 0 // Base
...
// 1 0 0 29.5 -28 1 0 0 0 1 0 0 0 1 t1061.dat
  [1,0,0,29.5,-28,1,0,0,0,1,0,0,0,1, ldraw_lib__t1061(realsolid)],
// 1 0 -12 29.5 -28 1 0 0 0 1 0 0 0 1 t1061.dat
  [1,0,-12,29.5,-28,1,0,0,0,1,0,0,0,1, ldraw_lib__t1061(realsolid)],
// 1 0 12 29.5 -28 1 0 0 0 1 0 0 0 1 t1061.dat
  [1,0,12,29.5,-28,1,0,0,0,1,0,0,0,1, ldraw_lib__t1061(realsolid)],
];
module ldraw_lib__t1060c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1060c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
