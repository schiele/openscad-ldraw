...
use <s/30375s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30375ps2(realsolid=false) = [
...
// 1 19 0 0 0 1 0 0 0 1 0 0 0 1 s\30375s02.dat
  [1,19,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30375s02(realsolid)],
// 1 19 0 0 0 1 0 0 0 1 0 0 0 1 s\30375s03.dat
  [1,19,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__30375s03(realsolid)],
];
module ldraw_lib__30375ps2(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30375ps2(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
