...
use <s/92252s03.scad>
$fa=1; $fs=0.2;
function ldraw_lib__11244p01(realsolid=false) = [
...
// 1 272 0 0 0 1 0 0 0 1 0 0 0 1 s\11244p01s03.dat
  [1,272,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__11244p01s03(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\11244p01s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__11244p01s01(realsolid)],
// 1 78 0 0 0 -1 0 0 0 1 0 0 0 1 s\11244p01s02.dat
  [1,78,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__11244p01s02(realsolid)],
...
module ldraw_lib__11244p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11244p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
