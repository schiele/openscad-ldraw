...
use <s/32533s01.scad>
use <s/32533s02.scad>
function ldraw_lib__32533p234() = [
// 0 Constraction Disc  5 x  5 Projectile with Bionicle Kanoka 234 Ga-Metru Pattern
// 0 Name: 32533p234.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 32171pb077, frisbee, Rebrickable 32533pr0234, Set 8613
// 0 !KEYWORDS Weapon
// 
...
module ldraw_lib__32533p234(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__32533p234(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__32533p234(line=0.2);