...
use <../p/stug2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2622(realsolid=false) = [
// 0 Boat Base  8 x 10
// 0 Name: 2622.dat
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2622s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2622s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\2622s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__2622s01(realsolid)],
...
module ldraw_lib__2622(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2622(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
