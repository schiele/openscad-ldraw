...
function ldraw_lib__6177973a() = [
// 0 Sticker  2.2 x  1.8 with White "EPSON" and 3 Grey Stripes on Black Background Right
// 0 Name: 6177973a.dat
...
// 3 0 6.0988 -.25 4.3 -6.39125 -.25 1.49475 3.9644 -.25 1.5
  [3,0,6.0988,-.25,4.3,-6.39125,-.25,1.49475,3.9644,-.25,1.5],
// 3 0 6.0988 -.25 4.3 3.9644 -.25 1.5 9.1423 -.25 1.5
  [3,0,6.0988,-.25,4.3,3.9644,-.25,1.5,9.1423,-.25,1.5],
// 3 0 6.0988 -.25 4.3 9.1423 -.25 1.5 16.39125 -.25 1.49475
  [3,0,6.0988,-.25,4.3,9.1423,-.25,1.5,16.39125,-.25,1.49475],
// 3 0 -18 -.25 -20.5 4.0481 -.25 -3.5 -6.39125 -.25 -3.50525
  [3,0,-18,-.25,-20.5,4.0481,-.25,-3.5,-6.39125,-.25,-3.50525],
// 4 0 -18 -.25 -20.5 18 -.25 -20.5 9.1423 -.25 -3.5 4.0481 -.25 -3.5
  [4,0,-18,-.25,-20.5,18,-.25,-20.5,9.1423,-.25,-3.5,4.0481,-.25,-3.5],
// 3 0 18 -.25 -20.5 16.39125 -.25 -3.50525 9.1423 -.25 -3.5
  [3,0,18,-.25,-20.5,16.39125,-.25,-3.50525,9.1423,-.25,-3.5],
];
module ldraw_lib__6177973a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6177973a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__6177973a(line=0.2);