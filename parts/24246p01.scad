...
use <s/24246s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__24246p01(realsolid=false) = [
...
// 1 16 0 0 -4.5 4 0 0 0 1 0 0 0 4 4-4ndis.dat
  [1,16,0,0,-4.5,4,0,0,0,1,0,0,0,4, ldraw_lib__4_4ndis(realsolid)],
// 1 71 0 0 -4.5 .5 0 0 0 1 0 0 0 .5 4-4ring7.dat
  [1,71,0,0,-4.5,.5,0,0,0,1,0,0,0,.5, ldraw_lib__4_4ring7(realsolid)],
// 1 0 0 0 -4.5 .5 0 0 0 1 0 0 0 .5 4-4ring6.dat
  [1,0,0,0,-4.5,.5,0,0,0,1,0,0,0,.5, ldraw_lib__4_4ring6(realsolid)],
// 1 16 0 0 -4.5 1 0 0 0 1 0 0 0 1 4-4ring2.dat
  [1,16,0,0,-4.5,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4ring2(realsolid)],
// 1 16 0 0 -4.5 .5 0 0 0 1 0 0 0 .5 4-4ring3.dat
  [1,16,0,0,-4.5,.5,0,0,0,1,0,0,0,.5, ldraw_lib__4_4ring3(realsolid)],
// 1 71 0 0 -4.5 .5 0 0 0 1 0 0 0 .5 4-4ring2.dat
  [1,71,0,0,-4.5,.5,0,0,0,1,0,0,0,.5, ldraw_lib__4_4ring2(realsolid)],
// 1 16 0 0 -4.5 1 0 0 0 1 0 0 0 1 4-4disc.dat
  [1,16,0,0,-4.5,1,0,0,0,1,0,0,0,1, ldraw_lib__4_4disc(realsolid)],
// 
...
module ldraw_lib__24246p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__24246p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
