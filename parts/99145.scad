...
use <../p/rect2p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__99145(realsolid=false) = [
...
// 1 16 15.5 13 -8.7 0 0 1.5 0 -0.3 0 -1.5 0 0 1-4chrd.dat
  [1,16,15.5,13,-8.7,0,0,1.5,0,-0.3,0,-1.5,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 7.75 0 0 -7.75 0 0 0 1 0 -0.005 0 -9.7 rect2p.dat
  [1,16,7.75,0,0,-7.75,0,0,0,1,0,-0.005,0,-9.7, ldraw_lib__rect2p(realsolid)],
...
// 1 16 15.5 0.3 -8.7 0 0 1.5 0 12.7 0 -1.5 0 0 1-4cylo.dat
  [1,16,15.5,0.3,-8.7,0,0,1.5,0,12.7,0,-1.5,0,0, ldraw_lib__1_4cylo(realsolid)],
// 1 16 17 6.65 0 0 -1 0 0 0 -6.35 8.7 0 0 rect2p.dat
  [1,16,17,6.65,0,0,-1,0,0,0,-6.35,8.7,0,0, ldraw_lib__rect2p(realsolid)],
// 1 16 15.5 0.3 -8.7 0 0 0.5 0 -0.3 0 -0.5 0 0 1-4con2.dat
  [1,16,15.5,0.3,-8.7,0,0,0.5,0,-0.3,0,-0.5,0,0, ldraw_lib__1_4con2(realsolid)],
// 1 16 15.5 0 -8.7 0 0 1 0 0.3 0 -1 0 0 1-4edge.dat
  [1,16,15.5,0,-8.7,0,0,1,0,0.3,0,-1,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 16.75 0.15 0 -0.25 -5.22 0 -0.15 8.7 0 0 0 -8.7 rect1.dat
  [1,16,16.75,0.15,0,-0.25,-5.22,0,-0.15,8.7,0,0,0,-8.7, ldraw_lib__rect1(realsolid)],
...
// 1 16 15.5 0 -8.7 0 0 1 0 0.3 0 -1 0 0 1-4chrd.dat
  [1,16,15.5,0,-8.7,0,0,1,0,0.3,0,-1,0,0, ldraw_lib__1_4chrd(realsolid)],
// 1 16 7.75 6.65 -10.2 7.75 0 0 0 0 -6.35 0 1 0 rect2p.dat
  [1,16,7.75,6.65,-10.2,7.75,0,0,0,0,-6.35,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 15.5 13 8.7 1.5 0 0 0 -0.3 0 0 0 1.5 1-4chrd.dat
  [1,16,15.5,13,8.7,1.5,0,0,0,-0.3,0,0,0,1.5, ldraw_lib__1_4chrd(realsolid)],
// 1 16 15.5 0.3 8.7 1.5 0 0 0 12.7 0 0 0 1.5 1-4cylo.dat
  [1,16,15.5,0.3,8.7,1.5,0,0,0,12.7,0,0,0,1.5, ldraw_lib__1_4cylo(realsolid)],
// 1 16 7.75 6.65 10.2 7.75 0 0 0 0 -6.35 0 -1 0 rect2p.dat
  [1,16,7.75,6.65,10.2,7.75,0,0,0,0,-6.35,0,-1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 15.5 0.3 8.7 0.5 0 0 0 -0.3 0 0 0 0.5 1-4con2.dat
  [1,16,15.5,0.3,8.7,0.5,0,0,0,-0.3,0,0,0,0.5, ldraw_lib__1_4con2(realsolid)],
// 1 16 15.5 0 8.7 1 0 0 0 0.3 0 0 0 1 1-4edge.dat
  [1,16,15.5,0,8.7,1,0,0,0,0.3,0,0,0,1, ldraw_lib__1_4edge(realsolid)],
// 1 16 15.5 0 8.7 1 0 0 0 0.3 0 0 0 1 1-4chrd.dat
  [1,16,15.5,0,8.7,1,0,0,0,0.3,0,0,0,1, ldraw_lib__1_4chrd(realsolid)],
// 1 16 0 13 0 0 0 -10.2 0 -12.7 0 10.2 0 0 2-4cylc.dat
  [1,16,0,13,0,0,0,-10.2,0,-12.7,0,10.2,0,0, ldraw_lib__2_4cylc(realsolid)],
// 1 16 0 0.3 0 0 0 -0.51 0 -0.3 0 0.51 0 0 2-4con19.dat
  [1,16,0,0.3,0,0,0,-0.51,0,-0.3,0,0.51,0,0, ldraw_lib__2_4con19(realsolid)],
// 1 16 0 0 0 0 0 -9.69 0 1 0 9.69 0 0 2-4edge.dat
  [1,16,0,0,0,0,0,-9.69,0,1,0,9.69,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 0 0 0 0 -9.69 0 1 0 9.69 0 0 2-4disc.dat
  [1,16,0,0,0,0,0,-9.69,0,1,0,9.69,0,0, ldraw_lib__2_4disc(realsolid)],
];
module ldraw_lib__99145(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__99145(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
