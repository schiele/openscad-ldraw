...
// 1 16 0 44 20 0 0 1 0 -1 0 -1 0 0 stug3-1x2.dat
  [1,16,0,44,20,0,0,1,0,-1,0,-1,0,0, ldraw_lib__stug3_1x2()],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 48 20 6 0 0 0 -4 0 0 0 26 box5.dat
  [1,16,0,48,20,6,0,0,0,-4,0,0,0,26, ldraw_lib__box5()],
// 
...
// 1 16 0 48 20 10 0 0 0 -8 0 0 0 30 box5.dat
  [1,16,0,48,20,10,0,0,0,-8,0,0,0,30, ldraw_lib__box5()],
// 
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__3359(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3359(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
