...
$fa=1; $fs=0.2;
function ldraw_lib__6851(realsolid=false) = [
...
// 1 16 248 0 168 72 0 0 0 1 0 0 0 72 48\1-4chrd.dat
  [1,16,248,0,168,72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4chrd(realsolid)],
// 1 16 -248 0 168 -72 0 0 0 1 0 0 0 72 48\1-4chrd.dat
  [1,16,-248,0,168,-72,0,0,0,1,0,0,0,72, ldraw_lib__48__1_4chrd(realsolid)],
// 1 16 -248 0 -168 -72 0 0 0 1 0 0 0 -72 48\1-4chrd.dat
  [1,16,-248,0,-168,-72,0,0,0,1,0,0,0,-72, ldraw_lib__48__1_4chrd(realsolid)],
...
// 1 16 248 4 168 72 0 0 0 -1 0 0 0 72 48\1-4chrd.dat
  [1,16,248,4,168,72,0,0,0,-1,0,0,0,72, ldraw_lib__48__1_4chrd(realsolid)],
// 1 16 -248 4 168 -72 0 0 0 -1 0 0 0 72 48\1-4chrd.dat
  [1,16,-248,4,168,-72,0,0,0,-1,0,0,0,72, ldraw_lib__48__1_4chrd(realsolid)],
// 1 16 -248 4 -168 -72 0 0 0 -1 0 0 0 -72 48\1-4chrd.dat
  [1,16,-248,4,-168,-72,0,0,0,-1,0,0,0,-72, ldraw_lib__48__1_4chrd(realsolid)],
...
// 1 16 248 0 168 72 0 0 0 4 0 0 0 72 48\1-4cylo.dat
  [1,16,248,0,168,72,0,0,0,4,0,0,0,72, ldraw_lib__48__1_4cylo(realsolid)],
// 1 16 -248 0 168 -72 0 0 0 4 0 0 0 72 48\1-4cylo.dat
  [1,16,-248,0,168,-72,0,0,0,4,0,0,0,72, ldraw_lib__48__1_4cylo(realsolid)],
// 1 16 -248 0 -168 -72 0 0 0 4 0 0 0 -72 48\1-4cylo.dat
  [1,16,-248,0,-168,-72,0,0,0,4,0,0,0,-72, ldraw_lib__48__1_4cylo(realsolid)],
...
// 1 16 -180 0 140 1 0 0 0 1 0 0 0 1 stug20-5x5.dat
  [1,16,-180,0,140,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_5x5(realsolid)],
// 1 16 20 0 140 1 0 0 0 1 0 0 0 1 stug20-5x5.dat
  [1,16,20,0,140,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_5x5(realsolid)],
// 1 16 200 0 120 1 0 0 0 1 0 0 0 1 stug20-4x4.dat
  [1,16,200,0,120,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_4x4(realsolid)],
// 1 16 200 0 220 1 0 0 0 1 0 0 0 1 stug20-1x4.dat
  [1,16,200,0,220,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_1x4(realsolid)],
...
// 1 16 140 0 -100 1 0 0 0 1 0 0 0 1 stug20-7x7.dat
  [1,16,140,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_7x7(realsolid)],
// 1 16 -140 0 -100 1 0 0 0 1 0 0 0 1 stug20-7x7.dat
  [1,16,-140,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug20_7x7(realsolid)],
];
module ldraw_lib__6851(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6851(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
