...
use <s/22587s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__22587a(realsolid=false) = [
...
// 1 15 0 -0.25 -2.32 3.2 0 0 0 1 0 0 0 3.2 s\22587s01.dat
  [1,15,0,-0.25,-2.32,3.2,0,0,0,1,0,0,0,3.2, ldraw_lib__s__22587s01(realsolid)],
// 0 //
...
module ldraw_lib__22587a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__22587a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
