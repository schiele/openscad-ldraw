...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\48493s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__48493s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\48493s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__48493s01()],
// 
// 0 BFC INVERTNEXT
...
// 1 16 0 0 0 13.15 0 0 0 10.94 0 0 0 13.15 2-4cyli.dat
  [1,16,0,0,0,13.15,0,0,0,10.94,0,0,0,13.15, ldraw_lib__2_4cyli()],
// 1 16 0 0 0 13.15 0 0 0 1 0 0 0 13.15 4-4edge.dat
  [1,16,0,0,0,13.15,0,0,0,1,0,0,0,13.15, ldraw_lib__4_4edge()],
// 1 16 0 10.94 0 13.15 0 0 0 1 0 0 0 13.15 2-4edge.dat
  [1,16,0,10.94,0,13.15,0,0,0,1,0,0,0,13.15, ldraw_lib__2_4edge()],
// 
// 1 16 0 -4 0 1 0 0 0 -1 0 0 0 1 stud4.dat
  [1,16,0,-4,0,1,0,0,0,-1,0,0,0,1, ldraw_lib__stud4()],
// 1 16 0 -4 0 8.766 0 0 0 -1 0 0 0 8.766 4-4disc.dat
  [1,16,0,-4,0,8.766,0,0,0,-1,0,0,0,8.766, ldraw_lib__4_4disc()],
// 1 16 0 -4 0 8.766 0 0 0 1 0 0 0 8.766 4-4edge.dat
  [1,16,0,-4,0,8.766,0,0,0,1,0,0,0,8.766, ldraw_lib__4_4edge()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 4.383 0 0 0 -4 0 0 0 4.383 4-4con2.dat
  [1,16,0,0,0,4.383,0,0,0,-4,0,0,0,4.383, ldraw_lib__4_4con2()],
// 
];
module ldraw_lib__48493(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48493(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
