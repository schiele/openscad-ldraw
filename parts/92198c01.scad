...
use <96490.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92198c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 92252.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__92252(realsolid)],
// 0 // Hips
...
// 1 16 0 -76.8 3.9 1 0 0 0 1 0 0 0 1 92241.dat
  [1,16,0,-76.8,3.9,1,0,0,0,1,0,0,0,1, ldraw_lib__92241(realsolid)],
// 0 // Head
// 1 16 0 -110 3.9 1 0 0 0 1 0 0 0 1 92198.dat
  [1,16,0,-110,3.9,1,0,0,0,1,0,0,0,1, ldraw_lib__92198(realsolid)],
// 0 // Wig
// 1 16 0 -110 0.9 1 0 0 0 1 0 0 0 1 92255.dat
  [1,16,0,-110,0.9,1,0,0,0,1,0,0,0,1, ldraw_lib__92255(realsolid)],
// 0 // Hair accessories (position depend on hairpiece!)
// 1 16 18.1 -110.2 4.4 0 -1 0 1 0 0 0 0 1 96489.dat
  [1,16,18.1,-110.2,4.4,0,-1,0,1,0,0,0,0,1, ldraw_lib__96489(realsolid)],
// 1 16 0 -121.9 0.9 1 0 0 0 1 0 0 0 1 96490.dat
  [1,16,0,-121.9,0.9,1,0,0,0,1,0,0,0,1, ldraw_lib__96490(realsolid)],
// 0 // Left arm
// 1 16 11 -76.8 3.9 1 0 0 0 1 0 0 0 1 92244.dat
  [1,16,11,-76.8,3.9,1,0,0,0,1,0,0,0,1, ldraw_lib__92244(realsolid)],
// 0 // Right Arm
// 1 16 -11 -76.8 3.9 1 0 0 0 1 0 0 0 1 92245.dat
  [1,16,-11,-76.8,3.9,1,0,0,0,1,0,0,0,1, ldraw_lib__92245(realsolid)],
// 0 // Accessory (bar connection)
// 1 16 26 -49.3 5.5 1 0 0 0 0 -1 0 1 0 55298.dat
  [1,16,26,-49.3,5.5,1,0,0,0,0,-1,0,1,0, ldraw_lib__55298(realsolid)],
// 0 // Accessory (stud connection)
// 1 16 -26 -49.3 -3.5 1 0 0 0 0 -1 0 1 0 33291.dat
  [1,16,-26,-49.3,-3.5,1,0,0,0,0,-1,0,1,0, ldraw_lib__33291(realsolid)],
];
module ldraw_lib__92198c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92198c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
