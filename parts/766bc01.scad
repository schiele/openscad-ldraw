...
use <u9020.scad>
$fa=1; $fs=0.2;
function ldraw_lib__766bc01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 766b.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__766b(realsolid)],
// 1 494 10 0 22 1 0 0 0 1 0 0 0 1 u9019.dat
  [1,494,10,0,22,1,0,0,0,1,0,0,0,1, ldraw_lib__u9019(realsolid)],
// 1 494 10 -6 17 0.707 0 -0.707 0 1 0 0.707 0 0.707 u9020.dat
  [1,494,10,-6,17,0.707,0,-0.707,0,1,0,0.707,0,0.707, ldraw_lib__u9020(realsolid)],
// 1 494 -10 0 22 1 0 0 0 1 0 0 0 1 u9019.dat
  [1,494,-10,0,22,1,0,0,0,1,0,0,0,1, ldraw_lib__u9019(realsolid)],
// 1 494 -10 -6 17 0.707 0 -0.707 0 1 0 0.707 0 0.707 u9020.dat
  [1,494,-10,-6,17,0.707,0,-0.707,0,1,0,0.707,0,0.707, ldraw_lib__u9020(realsolid)],
...
module ldraw_lib__766bc01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__766bc01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
