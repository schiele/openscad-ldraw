...
use <../p/stud3a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3049b(realsolid=false) = [
...
// 1 16 0 4 0 0 -0.707 4 0 0.707 4 4 0 0 2-4edge.dat
  [1,16,0,4,0,0,-0.707,4,0,0.707,4,4,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 4 0 0 0.707 -4 0 0.707 4 4 0 0 2-4edge.dat
  [1,16,0,4,0,0,0.707,-4,0,0.707,4,4,0,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 8 0 4 0 0 0 -4 0 0 0 4 1-4cyls.dat
  [1,16,0,8,0,4,0,0,0,-4,0,0,0,4, ldraw_lib__1_4cyls(realsolid)],
// 1 16 0 8 0 -4 0 0 0 -4 0 0 0 4 1-4cyls.dat
  [1,16,0,8,0,-4,0,0,0,-4,0,0,0,4, ldraw_lib__1_4cyls(realsolid)],
// 1 16 0 8 0 4 0 0 0 -4 0 0 0 -4 1-4cyls.dat
  [1,16,0,8,0,4,0,0,0,-4,0,0,0,-4, ldraw_lib__1_4cyls(realsolid)],
...
module ldraw_lib__3049b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3049b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
