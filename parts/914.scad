...
use <../p/axlehole.scad>
$fa=1; $fs=0.2;
function ldraw_lib__914(realsolid=false) = [
...
// 1 16 40 0 0 0 -1 0 9 0 0 0 0 9 4-4edge.dat
  [1,16,40,0,0,0,-1,0,9,0,0,0,0,9, ldraw_lib__4_4edge(realsolid)],
// 1 16 40 0 0 0 -1 0 3 0 0 0 0 3 4-4ring2.dat
  [1,16,40,0,0,0,-1,0,3,0,0,0,0,3, ldraw_lib__4_4ring2(realsolid)],
// 1 16 -40 0 0 0 -1 0 9 0 0 0 0 9 4-4edge.dat
  [1,16,-40,0,0,0,-1,0,9,0,0,0,0,9, ldraw_lib__4_4edge(realsolid)],
// 1 16 -40 0 0 0 1 0 3 0 0 0 0 3 4-4ring2.dat
  [1,16,-40,0,0,0,1,0,3,0,0,0,0,3, ldraw_lib__4_4ring2(realsolid)],
// 1 16 -18 0 0 0 58 0 9 0 0 0 0 9 4-4cyli.dat
  [1,16,-18,0,0,0,58,0,9,0,0,0,0,9, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -40 0 0 0 10 0 9 0 0 0 0 9 4-4cyli.dat
  [1,16,-40,0,0,0,10,0,9,0,0,0,0,9, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -18 0 0 0 -1 0 9 0 0 0 0 9 4-4edge.dat
  [1,16,-18,0,0,0,-1,0,9,0,0,0,0,9, ldraw_lib__4_4edge(realsolid)],
// 1 16 -30 0 0 0 -1 0 9 0 0 0 0 9 4-4edge.dat
  [1,16,-30,0,0,0,-1,0,9,0,0,0,0,9, ldraw_lib__4_4edge(realsolid)],
// 1 16 -18 0 0 0 -1 0 14 0 0 0 0 14 4-4edge.dat
  [1,16,-18,0,0,0,-1,0,14,0,0,0,0,14, ldraw_lib__4_4edge(realsolid)],
// 1 16 -30 0 0 0 -1 0 14 0 0 0 0 14 4-4edge.dat
  [1,16,-30,0,0,0,-1,0,14,0,0,0,0,14, ldraw_lib__4_4edge(realsolid)],
// 1 16 -18 0 0 0 -12 0 14 0 0 0 0 14 4-4cyli.dat
  [1,16,-18,0,0,0,-12,0,14,0,0,0,0,14, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -18 0 0 0 -1 0 3 0 0 0 0 3 4-4ring3.dat
  [1,16,-18,0,0,0,-1,0,3,0,0,0,0,3, ldraw_lib__4_4ring3(realsolid)],
// 1 16 -18 0 0 0 -1 0 2 0 0 0 0 2 4-4ring6.dat
  [1,16,-18,0,0,0,-1,0,2,0,0,0,0,2, ldraw_lib__4_4ring6(realsolid)],
// 1 16 -30 0 0 0 1 0 3 0 0 0 0 3 4-4ring3.dat
  [1,16,-30,0,0,0,1,0,3,0,0,0,0,3, ldraw_lib__4_4ring3(realsolid)],
// 1 16 -30 0 0 0 1 0 2 0 0 0 0 2 4-4ring6.dat
  [1,16,-30,0,0,0,1,0,2,0,0,0,0,2, ldraw_lib__4_4ring6(realsolid)],
];
module ldraw_lib__914(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__914(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
