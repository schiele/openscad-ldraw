...
use <s/t1102s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__t1102(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\t1102s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__t1102s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\t1102s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__t1102s01(realsolid)],
// 3 16 -20.5 -29.5 -26.5 0 -24 -26.5 20.5 -29.5 -26.5
  [3,16,-20.5,-29.5,-26.5,0,-24,-26.5,20.5,-29.5,-26.5],
// 1 16 0 -24 23.5 -20.5 0 0 0 0 2.5 0 1 0 rect2p.dat
  [1,16,0,-24,23.5,-20.5,0,0,0,0,2.5,0,1,0, ldraw_lib__rect2p(realsolid)],
// 1 16 0 -29.5 0 -20.5 0 0 0 1 0 0 0 -26.5 rect2p.dat
  [1,16,0,-29.5,0,-20.5,0,0,0,1,0,0,0,-26.5, ldraw_lib__rect2p(realsolid)],
// 1 16 0 -21.5 25 0 0 20.5 0 -1 0 1.5 0 0 rect1.dat
  [1,16,0,-21.5,25,0,0,20.5,0,-1,0,1.5,0,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 0 -26.5 0 0 0 -20.5 0 -1 0 -23.5 0 0 rect1.dat
  [1,16,0,-26.5,0,0,0,-20.5,0,-1,0,-23.5,0,0, ldraw_lib__rect1(realsolid)],
...
module ldraw_lib__t1102(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__t1102(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
