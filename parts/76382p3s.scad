...
use <3820.scad>
use <973p3s.scad>
function ldraw_lib__76382p3s() = [
// 0 Minifig Torso with Arms and Hands with Red Imperial Guard Officer Pattern
// 0 Name: 76382p3s.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973p3s.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973p3s()],
...
module ldraw_lib__76382p3s(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382p3s(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382p3s(line=0.2);