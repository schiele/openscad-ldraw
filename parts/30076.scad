...
// 1 16 60 4 22 0 0 -1.5 0 20 0 14 0 0 box3u6.dat
  [1,16,60,4,22,0,0,-1.5,0,20,0,14,0,0, ldraw_lib__box3u6()],
...
// 1 16 20 4 22 0 0 -1.5 0 20 0 14 0 0 box3u6.dat
  [1,16,20,4,22,0,0,-1.5,0,20,0,14,0,0, ldraw_lib__box3u6()],
...
// 1 16 82 4 0 14 0 0 0 20 0 0 0 1.5 box3u6.dat
  [1,16,82,4,0,14,0,0,0,20,0,0,0,1.5, ldraw_lib__box3u6()],
...
// 1 16 40 4 0 12 0 0 0 20 0 0 0 1.5 box3u8p.dat
  [1,16,40,4,0,12,0,0,0,20,0,0,0,1.5, ldraw_lib__box3u8p()],
...
// 1 16 0 4 0 12 0 0 0 20 0 0 0 1.5 box3u8p.dat
  [1,16,0,4,0,12,0,0,0,20,0,0,0,1.5, ldraw_lib__box3u8p()],
// 1 16 -20 4 0 6 0 0 0 1 0 0 0 6 4-4edge.dat
  [1,16,-20,4,0,6,0,0,0,1,0,0,0,6, ldraw_lib__4_4edge()],
// 1 16 -20 4 0 1 0 0 0 -5 0 0 0 1 stud4f4s.dat
  [1,16,-20,4,0,1,0,0,0,-5,0,0,0,1, ldraw_lib__stud4f4s()],
...
// 1 16 78.75 14 18.75 0 0 17.25 10 0 0 0 17.25 0 box2-9.dat
  [1,16,78.75,14,18.75,0,0,17.25,10,0,0,0,17.25,0, ldraw_lib__box2_9()],
// 1 16 40 14 36 0 0 18.5 10 0 0 0 1 0 rect1.dat
  [1,16,40,14,36,0,0,18.5,10,0,0,0,1,0, ldraw_lib__rect1()],
...
// 1 16 -78.75 14 18.75 0 -17.25 0 10 0 0 0 0 17.25 box2-9.dat
  [1,16,-78.75,14,18.75,0,-17.25,0,10,0,0,0,0,17.25, ldraw_lib__box2_9()],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 78.75 14 -18.75 0 17.25 0 10 0 0 0 0 -17.25 box2-9.dat
  [1,16,78.75,14,-18.75,0,17.25,0,10,0,0,0,0,-17.25, ldraw_lib__box2_9()],
...
// 1 16 0 4 0 96 0 0 0 -1 0 0 0 -36 rect.dat
  [1,16,0,4,0,96,0,0,0,-1,0,0,0,-36, ldraw_lib__rect()],
...
// 1 16 60 10 40 4 0 0 0 0 4 0 -1 0 4-4edge.dat
  [1,16,60,10,40,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4edge()],
// 1 16 -60 10 40 4 0 0 0 0 4 0 -1 0 4-4edge.dat
  [1,16,-60,10,40,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4edge()],
// 1 16 60 10 -40 4 0 0 0 0 4 0 -1 0 4-4edge.dat
  [1,16,60,10,-40,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4edge()],
...
// 1 16 60 10 40 8 0 0 0 0 8 0 -1 0 4-4edge.dat
  [1,16,60,10,40,8,0,0,0,0,8,0,-1,0, ldraw_lib__4_4edge()],
// 1 16 -60 10 40 8 0 0 0 0 8 0 -1 0 4-4edge.dat
  [1,16,-60,10,40,8,0,0,0,0,8,0,-1,0, ldraw_lib__4_4edge()],
// 1 16 60 10 -40 8 0 0 0 0 8 0 -1 0 4-4edge.dat
  [1,16,60,10,-40,8,0,0,0,0,8,0,-1,0, ldraw_lib__4_4edge()],
...
// 1 16 60 10 40 0 0 1 1 0 0 0 -1 0 connect.dat
  [1,16,60,10,40,0,0,1,1,0,0,0,-1,0, ldraw_lib__connect()],
// 1 16 -60 10 40 0 0 1 1 0 0 0 -1 0 connect.dat
  [1,16,-60,10,40,0,0,1,1,0,0,0,-1,0, ldraw_lib__connect()],
// 1 16 60 10 -40 0 0 1 1 0 0 0 1 0 connect.dat
  [1,16,60,10,-40,0,0,1,1,0,0,0,1,0, ldraw_lib__connect()],
...
// 1 16 -60 0 0 1 0 0 0 1 0 0 0 1 stug-4x4.dat
  [1,16,-60,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_4x4()],
...
module ldraw_lib__30076(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30076(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
