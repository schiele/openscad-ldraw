...
use <u9267.scad>
$fa=1; $fs=0.2;
function ldraw_lib__48083c01(realsolid=false) = [
...
// 1 4 0 14 0 1 0 0 0 0 -1 0 1 0 u9267.dat
  [1,4,0,14,0,1,0,0,0,0,-1,0,1,0, ldraw_lib__u9267(realsolid)],
];
module ldraw_lib__48083c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__48083c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
