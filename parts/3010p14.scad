...
// 1 16 -30 0 -10 1 0 0 0 1 0 0 0 1 s\3010p14s01.dat
  [1,16,-30,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010p14s01()],
// 1 16 -10 0 -10 1 0 0 0 1 0 0 0 1 s\3010p14s01.dat
  [1,16,-10,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010p14s01()],
// 1 16 10 0 -10 1 0 0 0 1 0 0 0 1 s\3010p14s01.dat
  [1,16,10,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010p14s01()],
// 1 16 30 0 -10 1 0 0 0 1 0 0 0 1 s\3010p14s01.dat
  [1,16,30,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3010p14s01()],
...
module ldraw_lib__3010p14(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3010p14(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
