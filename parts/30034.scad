...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30034(realsolid=false) = [
...
// 1 16 0 8 20 0 0 6 0 -4 0 -26 0 0 box5.dat
  [1,16,0,8,20,0,0,6,0,-4,0,-26,0,0, ldraw_lib__box5(realsolid)],
...
// 1 16 10 5.5 20 0 -1 0 2.5 0 0 0 0 30 rect.dat
  [1,16,10,5.5,20,0,-1,0,2.5,0,0,0,0,30, ldraw_lib__rect(realsolid)],
// 1 16 0 5.5 50 0 0 -10 2.5 0 0 0 -1 0 rect2a.dat
  [1,16,0,5.5,50,0,0,-10,2.5,0,0,0,-1,0, ldraw_lib__rect2a(realsolid)],
// 1 16 -10 5.5 20 0 1 0 2.5 0 0 0 0 -30 rect3.dat
  [1,16,-10,5.5,20,0,1,0,2.5,0,0,0,0,-30, ldraw_lib__rect3(realsolid)],
// 1 16 -7 5.5 -10 0 0 3 2.5 0 0 0 1 0 rect1.dat
  [1,16,-7,5.5,-10,0,0,3,2.5,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
// 1 16 7 5.5 -10 0 0 3 2.5 0 0 0 1 0 rect1.dat
  [1,16,7,5.5,-10,0,0,3,2.5,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
...
// 1 16 35 -10 10 15 -1 0 -4 0 -2 20 0 0 rect.dat
  [1,16,35,-10,10,15,-1,0,-4,0,-2,20,0,0, ldraw_lib__rect(realsolid)],
...
// 1 16 -35 -10 10 0 1 -15 -2 0 -4 0 0 20 rect.dat
  [1,16,-35,-10,10,0,1,-15,-2,0,-4,0,0,20, ldraw_lib__rect(realsolid)],
// 4 16 -50 -16 30 -30 0 50 -33 3 47 -50 -12 30
  [4,16,-50,-16,30,-30,0,50,-33,3,47,-50,-12,30],
// 3 16 -33 3 47 -30 0 50 -30 3 50
  [3,16,-33,3,47,-30,0,50,-30,3,50],
// 1 16 0 1.5 50 -30 0 0 0 0 -1.5 0 -1 0 rect3.dat
  [1,16,0,1.5,50,-30,0,0,0,0,-1.5,0,-1,0, ldraw_lib__rect3(realsolid)],
// 2 24 8 0 -10 4 0 -10
  [2,24,8,0,-10,4,0,-10],
// 2 24 -4 0 -10 -8 0 -10
  [2,24,-4,0,-10,-8,0,-10],
...
// 1 16 0 8 -13.31 4 0 0 0 -1 0 0 0 -3.31 rect3.dat
  [1,16,0,8,-13.31,4,0,0,0,-1,0,0,0,-3.31, ldraw_lib__rect3(realsolid)],
...
// 1 16 0 6.915 -25 4 0 0 0 0 -2.085 0 1 0 rect.dat
  [1,16,0,6.915,-25,4,0,0,0,0,-2.085,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 4.8292 -23.9142 4 0 0 0 1 -0.0008 0 0 1.0858 rect3.dat
  [1,16,0,4.8292,-23.9142,4,0,0,0,1,-0.0008,0,0,1.0858, ldraw_lib__rect3(realsolid)],
// 1 16 0 -0.8292 -23.9142 -4 0 0 0 -1 0.0008 0 0 1.0858 rect3.dat
  [1,16,0,-0.8292,-23.9142,-4,0,0,0,-1,0.0008,0,0,1.0858, ldraw_lib__rect3(realsolid)],
// 1 16 0 -2.915 -25 4 0 0 0 0 -2.085 0 1 0 rect.dat
  [1,16,0,-2.915,-25,4,0,0,0,0,-2.085,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 -5 -22.5 0 0 -4 0 1 0 2.5 0 0 rect2p.dat
  [1,16,0,-5,-22.5,0,0,-4,0,1,0,2.5,0,0, ldraw_lib__rect2p(realsolid)],
// 4 16 -4 -0.6789 -13.5327 4 -0.6789 -13.5327 4 0 -13.4 -4 0 -13.4
  [4,16,-4,-0.6789,-13.5327,4,-0.6789,-13.5327,4,0,-13.4,-4,0,-13.4],
// 1 16 0 0 -11.7 -4 0 0 0 1 0 0 0 -1.7 rect3.dat
  [1,16,0,0,-11.7,-4,0,0,0,1,0,0,0,-1.7, ldraw_lib__rect3(realsolid)],
...
// 1 16 -4 2 -20 0 8 0 2.82843 0 2.82843 -2.82843 0 2.82843 3-4cylo.dat
  [1,16,-4,2,-20,0,8,0,2.82843,0,2.82843,-2.82843,0,2.82843, ldraw_lib__3_4cylo(realsolid)],
// 1 16 -4 2 -20 0 8 0 -7 0 0 0 0 7 3-16cylo.dat
  [1,16,-4,2,-20,0,8,0,-7,0,0,0,0,7, ldraw_lib__3_16cylo(realsolid)],
...
module ldraw_lib__30034(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30034(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
