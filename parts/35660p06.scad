...
use <../p/stud4o.scad>
$fa=1; $fs=0.2;
function ldraw_lib__35660p06(realsolid=false) = [
...
// 1 29 0 0 0 1 0 0 0 1 0 0 0 1 s\35660s01.dat
  [1,29,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__35660s01(realsolid)],
// 1 29 0 0 0 -1 0 0 0 1 0 0 0 1 s\35660s01.dat
  [1,29,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__35660s01(realsolid)],
// 1 29 0 0 0 1 0 0 0 1 0 0 0 1 s\35660s04.dat
  [1,29,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__35660s04(realsolid)],
// 1 29 0 0 0 -1 0 0 0 1 0 0 0 1 s\35660s04.dat
  [1,29,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__35660s04(realsolid)],
];
module ldraw_lib__35660p06(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__35660p06(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
