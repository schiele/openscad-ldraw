...
use <s/98138s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__98138p1w(realsolid=false) = [
...
// 1 0 -4.8 0 1.9 1.1 0 0 0 1 0 0 0 -1.1 2-4chrd.dat
  [1,0,-4.8,0,1.9,1.1,0,0,0,1,0,0,0,-1.1, ldraw_lib__2_4chrd(realsolid)],
// 1 16 -4.8 0 1.9 1.1 0 0 0 1 0 0 0 -1.1 2-4ndis.dat
  [1,16,-4.8,0,1.9,1.1,0,0,0,1,0,0,0,-1.1, ldraw_lib__2_4ndis(realsolid)],
// 1 0 -4.8 0 1.3 .7 0 0 0 1 0 0 0 -.7 2-4ring3.dat
  [1,0,-4.8,0,1.3,.7,0,0,0,1,0,0,0,-.7, ldraw_lib__2_4ring3(realsolid)],
// 1 226 -4.8 0 1.3 2.8 0 0 0 1 0 0 0 -2.8 2-4ndis.dat
  [1,226,-4.8,0,1.3,2.8,0,0,0,1,0,0,0,-2.8, ldraw_lib__2_4ndis(realsolid)],
// 1 0 -4.8 0 1.3 2.8 0 0 0 1 0 0 0 2.8 1-16chrd.dat
  [1,0,-4.8,0,1.3,2.8,0,0,0,1,0,0,0,2.8, ldraw_lib__1_16chrd(realsolid)],
// 1 0 -4.8 0 1.3 -2.8 0 0 0 1 0 0 0 2.8 1-16chrd.dat
  [1,0,-4.8,0,1.3,-2.8,0,0,0,1,0,0,0,2.8, ldraw_lib__1_16chrd(realsolid)],
// 1 226 -4.8 0 1.3 2.8 0 0 0 1 0 0 0 2.8 1-16ndis.dat
  [1,226,-4.8,0,1.3,2.8,0,0,0,1,0,0,0,2.8, ldraw_lib__1_16ndis(realsolid)],
// 1 226 -4.8 0 1.3 -2.8 0 0 0 1 0 0 0 2.8 1-16ndis.dat
  [1,226,-4.8,0,1.3,-2.8,0,0,0,1,0,0,0,2.8, ldraw_lib__1_16ndis(realsolid)],
// 1 16 -4.8 0 1.3 2.1 0 0 0 1 0 0 0 -2.1 1-4chrd.dat
  [1,16,-4.8,0,1.3,2.1,0,0,0,1,0,0,0,-2.1, ldraw_lib__1_4chrd(realsolid)],
// 1 16 -4.8 0 1.3 -2.1 0 0 0 1 0 0 0 -2.1 1-4chrd.dat
  [1,16,-4.8,0,1.3,-2.1,0,0,0,1,0,0,0,-2.1, ldraw_lib__1_4chrd(realsolid)],
...
module ldraw_lib__98138p1w(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__98138p1w(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
