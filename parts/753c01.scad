...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 737ac04, Rebrickable 160ac02
// 
...
// 1 1 0 8 -30 0 0 1 0 1 0 -1 0 0 499c01.dat
  [1,1,0,8,-30,0,0,1,0,1,0,-1,0,0, ldraw_lib__499c01()],
];
module ldraw_lib__753c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__753c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
