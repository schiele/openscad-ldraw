...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3005pts.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3005pts()],
];
module ldraw_lib__3005_s(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3005_s(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
