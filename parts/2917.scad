...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\2917s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2917s01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\2917s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__2917s01()],
// 1 16 -50 8 30 1 0 0 0 1 0 0 0 1 stud2.dat
  [1,16,-50,8,30,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2()],
// 1 16 -50 0 10 1 0 0 0 1 0 0 0 1 stud2a.dat
  [1,16,-50,0,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stud2a()],
...
module ldraw_lib__2917(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2917(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
