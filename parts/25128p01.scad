...
use <s/25128s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__25128p01(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 25128pb001, set 60134, Toddler
// 
...
module ldraw_lib__25128p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__25128p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
