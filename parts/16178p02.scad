...
// 0 !KEYWORDS BrickLink 16178pb02, Rebrickable 16178pr0002, Set 60327
// 
...
// 1 92 0 0 0 1 0 0 0 1 0 0 0 1 s\16178s02.dat
  [1,92,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__16178s02()],
];
module ldraw_lib__16178p02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__16178p02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
