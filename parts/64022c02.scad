...
use <88492.scad>
use <88493.scad>
function ldraw_lib__64022c02() = [
// 0 Train Track Flexible Segment (Complete, Bent Right)
// 0 Name: 64022c02.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 88492c00, Rebrickable 64022
// 
...
module ldraw_lib__64022c02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__64022c02(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__64022c02(line=0.2);