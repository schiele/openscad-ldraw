...
use <../p/stug-4x4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4202(realsolid=false) = [
// 0 Brick  4 x 12
// 0 Name: 4202.dat
...
// 1 16 -80 4 0 -1 0 0 0 1 0 0 0 -1 filletp2s.dat
  [1,16,-80,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletp2s(realsolid)],
// 1 16 -40 4 0 -1 0 0 0 1 0 0 0 -1 filletp1s.dat
  [1,16,-40,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletp1s(realsolid)],
// 1 16 0 4 0 -1 0 0 0 1 0 0 0 -1 filletp1s.dat
  [1,16,0,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletp1s(realsolid)],
// 1 16 40 4 0 -1 0 0 0 1 0 0 0 -1 filletp1s.dat
  [1,16,40,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletp1s(realsolid)],
// 1 16 80 4 0 -1 0 0 0 1 0 0 0 -1 filletp1s.dat
  [1,16,80,4,0,-1,0,0,0,1,0,0,0,-1, ldraw_lib__filletp1s(realsolid)],
// 1 16 80 4 0 0 0 1 0 1 0 -1 0 0 filletp2s.dat
  [1,16,80,4,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__filletp2s(realsolid)],
// 1 16 80 4 0 1 0 0 0 1 0 0 0 1 filletp2s.dat
  [1,16,80,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__filletp2s(realsolid)],
// 1 16 40 4 0 1 0 0 0 1 0 0 0 1 filletp1s.dat
  [1,16,40,4,0,1,0,0,0,1,0,0,0,1, ldraw_lib__filletp1s(realsolid)],
...
// 4 16 -116 4 36 -116 4 -36 116 4 -36 116 4 36
  [4,16,-116,4,36,-116,4,-36,116,4,-36,116,4,36],
// 4 16 120 24 40 -120 24 40 -116 24 36 116 24 36
  [4,16,120,24,40,-120,24,40,-116,24,36,116,24,36],
...
module ldraw_lib__4202(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4202(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
