...
use <92711.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92709c05(realsolid=false) = [
...
// 1 28 0 0 0 1 0 0 0 1 0 0 0 1 92711.dat
  [1,28,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__92711(realsolid)],
...
module ldraw_lib__92709c05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92709c05(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
