...
use <s/92252s04.scad>
$fa=1; $fs=0.2;
function ldraw_lib__11202p03(realsolid=false) = [
...
// 1 84 0 0 0 1 0 0 0 1 0 0 0 1 s\92252p04s03.dat
  [1,84,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__92252p04s03(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\92252p04s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__92252p04s01(realsolid)],
// 1 26 0 0 0 -1 0 0 0 1 0 0 0 1 s\92252p04s02.dat
  [1,26,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__92252p04s02(realsolid)],
...
module ldraw_lib__11202p03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11202p03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
