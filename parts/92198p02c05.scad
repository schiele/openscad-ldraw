...
use <92258.scad>
$fa=1; $fs=0.2;
function ldraw_lib__92198p02c05(realsolid=false) = [
...
// 1 378 0 0 0 1 0 0 0 1 0 0 0 1 92252p05c01.dat
  [1,378,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__92252p05c01(realsolid)],
// 1 78 0 -64 0 1 0 0 0 1 0 0 0 1 92241p14c01.dat
  [1,78,0,-64,0,1,0,0,0,1,0,0,0,1, ldraw_lib__92241p14c01(realsolid)],
...
module ldraw_lib__92198p02c05(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92198p02c05(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
