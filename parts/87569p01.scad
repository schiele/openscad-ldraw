...
use <s/87569s02.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87569p01(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 87569pb01, General Grievous, set 75040, set 75199
// 0 !KEYWORDS Set 75286, set 8095, set 9515, Star Wars
// 
...
// 1 72 0 0 0 1 0 0 0 1 0 0 0 1 s\87569s02.dat
  [1,72,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__87569s02(realsolid)],
];
module ldraw_lib__87569p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87569p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
