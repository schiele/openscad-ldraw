...
use <820674b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3939d01(realsolid=false) = [
...
// 1 16 0 10 -30 -1 0 0 0 .89443 -.44721 0 .44721 .89443 820674b.dat
  [1,16,0,10,-30,-1,0,0,0,.89443,-.44721,0,.44721,.89443, ldraw_lib__820674b(realsolid)],
];
module ldraw_lib__3939d01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3939d01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
