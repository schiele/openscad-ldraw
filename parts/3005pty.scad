...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 3005ptY, Rebrickable 3005pr9891, Set 234
// 
...
module ldraw_lib__3005pty(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3005pty(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3005pty(line=0.2);