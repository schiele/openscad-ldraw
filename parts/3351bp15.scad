...
use <s/3351p15a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3351bp15(realsolid=false) = [
// 0 Roadsign Triangular Type 2 with Dangerous Intersection Pattern
// 0 Name: 3351bp15.dat
...
module ldraw_lib__3351bp15(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3351bp15(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3351bp15(line=0.2);