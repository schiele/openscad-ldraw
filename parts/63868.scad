...
use <../p/stug-1x2.scad>
$fa=1; $fs=0.2;
function ldraw_lib__63868(realsolid=false) = [
...
// 1 16 30 0 0 0 0 -1 0 1 0 1 0 0 clip6.dat
  [1,16,30,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__clip6(realsolid)],
...
// 1 16 20 4 -7 0 -1 0 -4 0 0 0 0 3 rect3.dat
  [1,16,20,4,-7,0,-1,0,-4,0,0,0,0,3, ldraw_lib__rect3(realsolid)],
// 1 16 20 4 7 0 -1 0 -4 0 0 0 0 -3 rect3.dat
  [1,16,20,4,7,0,-1,0,-4,0,0,0,0,-3, ldraw_lib__rect3(realsolid)],
...
module ldraw_lib__63868(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__63868(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
