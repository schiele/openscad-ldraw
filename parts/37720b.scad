...
use <../p/stud4a.scad>
$fa=1; $fs=0.2;
function ldraw_lib__37720b(realsolid=false) = [
...
// 1 16 0 -8.5 0 1 0 0 0 -2.125 0 0 0 1 stud4a.dat
  [1,16,0,-8.5,0,1,0,0,0,-2.125,0,0,0,1, ldraw_lib__stud4a(realsolid)],
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\37720bs01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__37720bs01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\37720bs01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__37720bs01(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -12.25 -2 4.8 0 0 0 0.5 0 0 0 3 box5.dat
  [1,16,0,-12.25,-2,4.8,0,0,0,0.5,0,0,0,3, ldraw_lib__box5(realsolid)],
...
// 1 16 0 -8.875 9.8025 2.6375 0 0 0 0 3.375 0 -1 0 rect2p.dat
  [1,16,0,-8.875,9.8025,2.6375,0,0,0,0,3.375,0,-1,0, ldraw_lib__rect2p(realsolid)],
...
module ldraw_lib__37720b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__37720b(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
