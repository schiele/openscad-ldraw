...
// 1 16 2 10 20 1 0 0 0 1 0 0 0 1 s\2335p41s01.dat
  [1,16,2,10,20,1,0,0,0,1,0,0,0,1, ldraw_lib__s__2335p41s01()],
// 1 16 -2 10 20 -1 0 0 0 1 0 0 0 1 s\2335p41s01.dat
  [1,16,-2,10,20,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__2335p41s01()],
];
module ldraw_lib__2335p41(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2335p41(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
