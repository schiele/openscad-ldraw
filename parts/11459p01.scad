...
use <s/11459s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__11459p01(realsolid=false) = [
...
// 1 84 0 0 0 4 0 0 0 -42 0 0 0 -4 4-4cyli.dat
  [1,84,0,0,0,4,0,0,0,-42,0,0,0,-4, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 0 0 4 0 0 0 -1 0 0 0 -4 4-4edge.dat
  [1,16,0,0,0,4,0,0,0,-1,0,0,0,-4, ldraw_lib__4_4edge(realsolid)],
// 1 84 0 -42 0 -4 0 0 0 -2 0 0 0 -4 4-8sphe.dat
  [1,84,0,-42,0,-4,0,0,0,-2,0,0,0,-4, ldraw_lib__4_8sphe(realsolid)],
];
module ldraw_lib__11459p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__11459p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
