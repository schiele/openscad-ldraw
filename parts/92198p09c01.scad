...
$fa=1; $fs=0.2;
function ldraw_lib__92198p09c01(realsolid=false) = [
...
// 1 19 0 -110 0.9 1 0 0 0 1 0 0 0 1 87991.dat
  [1,19,0,-110,0.9,1,0,0,0,1,0,0,0,1, ldraw_lib__87991(realsolid)],
];
module ldraw_lib__92198p09c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__92198p09c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
