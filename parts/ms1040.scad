...
use <931.scad>
$fa=1; $fs=0.2;
function ldraw_lib__ms1040(realsolid=false) = [
// 0 Electric Mindstorms NXT Accelerometer Sensor
// 0 Name: ms1040.dat
...
// 1 0 0 -40 -39 1 0 0 0 1 0 0 0 1 931.dat
  [1,0,0,-40,-39,1,0,0,0,1,0,0,0,1, ldraw_lib__931(realsolid)],
// 0 // shell top - light stone
// 1 16 0 -70 -24 1 0 0 0 1 0 0 0 1 55966.dat
  [1,16,0,-70,-24,1,0,0,0,1,0,0,0,1, ldraw_lib__55966(realsolid)],
];
module ldraw_lib__ms1040(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__ms1040(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__ms1040(line=0.2);