...
// 1 16 0 -0.25 -4.5 0.415 0 0 0 1 0 0 0 0.415 s\191888s01.dat
  [1,16,0,-0.25,-4.5,0.415,0,0,0,1,0,0,0,0.415, ldraw_lib__s__191888s01()],
...
module ldraw_lib__191888b(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__191888b(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
