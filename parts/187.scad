...
// 1 16 94 -3 0 0 0 6 0 3 0 -6 0 0 2-4cyli.dat
  [1,16,94,-3,0,0,0,6,0,3,0,-6,0,0, ldraw_lib__2_4cyli()],
// 1 16 94 0 0 0 0 6 0 1 0 -6 0 0 2-4edge.dat
  [1,16,94,0,0,0,0,6,0,1,0,-6,0,0, ldraw_lib__2_4edge()],
// 1 16 94 0 0 0 0 6 0 -1 0 6 0 0 2-4disc.dat
  [1,16,94,0,0,0,0,6,0,-1,0,6,0,0, ldraw_lib__2_4disc()],
// 1 16 94 -3 0 0 0 6 0 1 0 -6 0 0 2-4disc.dat
  [1,16,94,-3,0,0,0,6,0,1,0,-6,0,0, ldraw_lib__2_4disc()],
// 1 16 94 -3 0 0 0 6 0 1 0 -6 0 0 2-4edge.dat
  [1,16,94,-3,0,0,0,6,0,1,0,-6,0,0, ldraw_lib__2_4edge()],
// 1 16 0 -3 0 0 0 -6 0 3 0 6 0 0 2-4cyli.dat
  [1,16,0,-3,0,0,0,-6,0,3,0,6,0,0, ldraw_lib__2_4cyli()],
// 1 16 0 0 0 0 0 -6 0 1 0 6 0 0 2-4edge.dat
  [1,16,0,0,0,0,0,-6,0,1,0,6,0,0, ldraw_lib__2_4edge()],
// 1 16 0 0 0 0 0 -6 0 -1 0 -6 0 0 2-4disc.dat
  [1,16,0,0,0,0,0,-6,0,-1,0,-6,0,0, ldraw_lib__2_4disc()],
// 1 16 0 -3 0 0 0 -6 0 1 0 6 0 0 2-4disc.dat
  [1,16,0,-3,0,0,0,-6,0,1,0,6,0,0, ldraw_lib__2_4disc()],
// 1 16 0 -3 0 0 0 -6 0 1 0 6 0 0 2-4edge.dat
  [1,16,0,-3,0,0,0,-6,0,1,0,6,0,0, ldraw_lib__2_4edge()],
// 2 24 0 -3 6 94 -3 6
  [2,24,0,-3,6,94,-3,6],
// 2 24 0 0 6 94 0 6
  [2,24,0,0,6,94,0,6],
...
// 1 16 0 0 0 3 0 0 0 3 0 0 0 1.4 box5.dat
  [1,16,0,0,0,3,0,0,0,3,0,0,0,1.4, ldraw_lib__box5()],
// 0
];
module ldraw_lib__187(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__187(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
