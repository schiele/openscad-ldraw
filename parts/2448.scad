...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2448(realsolid=false) = [
...
// 1 16 10 134 -30 1.5 0 0 0 0 2 0 -4 0 box4-2p.dat
  [1,16,10,134,-30,1.5,0,0,0,0,2,0,-4,0, ldraw_lib__box4_2p(realsolid)],
// 1 16 -10 134 -30 1.5 0 0 0 0 2 0 -4 0 box4-2p.dat
  [1,16,-10,134,-30,1.5,0,0,0,0,2,0,-4,0, ldraw_lib__box4_2p(realsolid)],
...
// 1 16 0 136 -38 16 0 0 0 -4 0 0 0 -8 box4-1.dat
  [1,16,0,136,-38,16,0,0,0,-4,0,0,0,-8, ldraw_lib__box4_1(realsolid)],
...
// 1 16 20 20 -10 0 1 0 -12 0 0 0 0 -12 1-4edge.dat
  [1,16,20,20,-10,0,1,0,-12,0,0,0,0,-12, ldraw_lib__1_4edge(realsolid)],
// 1 16 16 20 -10 0 1 0 -12 0 0 0 0 -12 1-4edge.dat
  [1,16,16,20,-10,0,1,0,-12,0,0,0,0,-12, ldraw_lib__1_4edge(realsolid)],
// 1 16 -16 20 -10 0 1 0 -12 0 0 0 0 -12 1-4edge.dat
  [1,16,-16,20,-10,0,1,0,-12,0,0,0,0,-12, ldraw_lib__1_4edge(realsolid)],
// 1 16 -20 20 -10 0 1 0 -12 0 0 0 0 -12 1-4edge.dat
  [1,16,-20,20,-10,0,1,0,-12,0,0,0,0,-12, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 0 128 -40 0 0 20 0 1 0 10 0 0 rect2p.dat
  [1,16,0,128,-40,0,0,20,0,1,0,10,0,0, ldraw_lib__rect2p(realsolid)],
...
// 1 16 0 132 -50 20 0 0 0 0 4 0 1 0 rect.dat
  [1,16,0,132,-50,20,0,0,0,0,4,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 70 -30 20 0 0 0 0 58 0 1 0 rect.dat
  [1,16,0,70,-30,20,0,0,0,0,58,0,1,0, ldraw_lib__rect(realsolid)],
// 1 16 0 76 -26 16 0 0 0 0 60 0 -1 0 rect.dat
  [1,16,0,76,-26,16,0,0,0,0,60,0,-1,0, ldraw_lib__rect(realsolid)],
// 1 16 18 78 -22 2 0 0 0 0 58 0 -1 0 rect3.dat
  [1,16,18,78,-22,2,0,0,0,0,58,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 -18 78 -22 2 0 0 0 0 58 0 -1 0 rect3.dat
  [1,16,-18,78,-22,2,0,0,0,0,58,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 0 4 -10 16 0 0 0 0 4 0 1 0 rect.dat
  [1,16,0,4,-10,16,0,0,0,0,4,0,1,0, ldraw_lib__rect(realsolid)],
...
// 1 16 20 20 -10 0 -4 0 -12 0 0 0 0 -12 1-4cyli.dat
  [1,16,20,20,-10,0,-4,0,-12,0,0,0,0,-12, ldraw_lib__1_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -20 20 -10 0 4 0 -12 0 0 0 0 -12 1-4cyli.dat
  [1,16,-20,20,-10,0,4,0,-12,0,0,0,0,-12, ldraw_lib__1_4cyli(realsolid)],
...
// 1 16 20 20 -10 0 -1 0 -12 0 0 0 0 -12 1-4ndis.dat
  [1,16,20,20,-10,0,-1,0,-12,0,0,0,0,-12, ldraw_lib__1_4ndis(realsolid)],
// 1 16 16 20 -10 0 1 0 -12 0 0 0 0 -12 1-4ndis.dat
  [1,16,16,20,-10,0,1,0,-12,0,0,0,0,-12, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -16 20 -10 0 -1 0 -12 0 0 0 0 -12 1-4ndis.dat
  [1,16,-16,20,-10,0,-1,0,-12,0,0,0,0,-12, ldraw_lib__1_4ndis(realsolid)],
// 1 16 -20 20 -10 0 1 0 -12 0 0 0 0 -12 1-4ndis.dat
  [1,16,-20,20,-10,0,1,0,-12,0,0,0,0,-12, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 10 128 -40 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,10,128,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
// 1 16 -10 128 -40 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-10,128,-40,1,0,0,0,1,0,0,0,1, ldraw_lib__stud(realsolid)],
...
module ldraw_lib__2448(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2448(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
