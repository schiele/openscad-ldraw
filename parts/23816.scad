...
use <23816c01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__23816(realsolid=false) = [
// 0 ~Moved to 23816c01
// 0 Name: 23816.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 23816c01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__23816c01(realsolid)],
];
module ldraw_lib__23816(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__23816(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
