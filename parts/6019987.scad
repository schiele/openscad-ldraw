...
// 1 72 0 0 0 1 0 0 0 1 0 0 0 1 11458.dat
  [1,72,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__11458()],
];
module ldraw_lib__6019987(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6019987(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
