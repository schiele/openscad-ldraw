...
use <s/3068as01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3068a(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3068as01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3068as01(realsolid)],
// 4 16 20 0 -20 20 0 20 -20 0 20 -20 0 -20
  [4,16,20,0,-20,20,0,20,-20,0,20,-20,0,-20],
];
module ldraw_lib__3068a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
