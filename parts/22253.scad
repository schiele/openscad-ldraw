...
use <s/6595b.scad>
$fa=1; $fs=0.2;
function ldraw_lib__22253(realsolid=false) = [
...
// 1 16 0 0 3 1 0 0 0 0 1 0 16 0 axlehole.dat
  [1,16,0,0,3,1,0,0,0,0,1,0,16,0, ldraw_lib__axlehole(realsolid)],
...
module ldraw_lib__22253(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__22253(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__22253(line=0.2);