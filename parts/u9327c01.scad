...
use <u9327.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9327c01(realsolid=false) = [
...
// 1 71 0 0 0 1 0 0 0 1 0 0 0 1 u9327.dat
  [1,71,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9327(realsolid)],
// 1 16 0 -4 39 1 0 0 0 1 0 0 0 1 21972.dat
  [1,16,0,-4,39,1,0,0,0,1,0,0,0,1, ldraw_lib__21972(realsolid)],
// 1 256 0 -1.7 97.7 0 0 1 -0.7071 2.1213 0 -0.7071 -2.1213 0 s\23816s01.dat
  [1,256,0,-1.7,97.7,0,0,1,-0.7071,2.1213,0,-0.7071,-2.1213,0, ldraw_lib__s__23816s01(realsolid)],
...
module ldraw_lib__u9327c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9327c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
