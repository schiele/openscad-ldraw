...
use <s/973s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973p32(realsolid=false) = [
// 0 Minifig Torso with Pirate Stripes Blue/Cream Pattern
// 0 Name: 973p32.dat
...
// 4 16 7 0 -10 -7 0 -10 -3.5 2.25 -10 3.5 2.25 -10
  [4,16,7,0,-10,-7,0,-10,-3.5,2.25,-10,3.5,2.25,-10],
// 
// 4 1 -7 0 -10 -12 0 -10 -11.5 4.5 -10 -3.5 2.25 -10
  [4,1,-7,0,-10,-12,0,-10,-11.5,4.5,-10,-3.5,2.25,-10],
// 4 1 7 0 -10 3.5 2.25 -10 11.5 4.5 -10 12 0 -10
  [4,1,7,0,-10,3.5,2.25,-10,11.5,4.5,-10,12,0,-10],
// 3 1 -3.5 2.25 -10 -11.5 4.5 -10 0 3 -10
  [3,1,-3.5,2.25,-10,-11.5,4.5,-10,0,3,-10],
// 3 1 3.5 2.25 -10 0 3 -10 11.5 4.5 -10
  [3,1,3.5,2.25,-10,0,3,-10,11.5,4.5,-10],
// 3 1 0 3 -10 -11.5 4.5 -10 11.5 4.5 -10
  [3,1,0,3,-10,-11.5,4.5,-10,11.5,4.5,-10],
// 4 1 -16.328 13.5 -10 16.328 13.5 -10 12.5 9 -10 -12.5 9 -10
  [4,1,-16.328,13.5,-10,16.328,13.5,-10,12.5,9,-10,-12.5,9,-10],
// 4 1 -17.878 22.5 -10 17.878 22.5 -10 17.104 18 -10 -17.104 18 -10
  [4,1,-17.878,22.5,-10,17.878,22.5,-10,17.104,18,-10,-17.104,18,-10],
// 
// 4 78 12.5 9 -10 11.5 4.5 -10 -11.5 4.5 -10 -12.5 9 -10
  [4,78,12.5,9,-10,11.5,4.5,-10,-11.5,4.5,-10,-12.5,9,-10],
// 4 78 17.104 18 -10 16.328 13.5 -10 -16.328 13.5 -10 -17.104 18 -10
  [4,78,17.104,18,-10,16.328,13.5,-10,-16.328,13.5,-10,-17.104,18,-10],
// 3 78 -17.878 22.5 -10 -18.483 26 -10 -6 26 -10
  [3,78,-17.878,22.5,-10,-18.483,26,-10,-6,26,-10],
// 3 78 6 26 -10 18.483 26 -10 17.878 22.5 -10
  [3,78,6,26,-10,18.483,26,-10,17.878,22.5,-10],
// 4 78 -17.878 22.5 -10 -6 26 -10 6 26 -10 17.878 22.5 -10
  [4,78,-17.878,22.5,-10,-6,26,-10,6,26,-10,17.878,22.5,-10],
// 
...
module ldraw_lib__973p32(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p32(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
