...
use <../p/connhole.scad>
$fa=1; $fs=0.2;
function ldraw_lib__27940(realsolid=false) = [
...
// 1 16 0 0 0 0 0 -1 0 1 0 1 0 0 axleconnect.dat
  [1,16,0,0,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__axleconnect(realsolid)],
// 1 16 0 0 0 0 0 -1 0 -1 0 -1 0 0 axleconnect.dat
  [1,16,0,0,0,0,0,-1,0,-1,0,-1,0,0, ldraw_lib__axleconnect(realsolid)],
// 1 16 0 0 0 0 0 1 0 1 0 -1 0 0 axleconnect.dat
  [1,16,0,0,0,0,0,1,0,1,0,-1,0,0, ldraw_lib__axleconnect(realsolid)],
...
module ldraw_lib__27940(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__27940(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
