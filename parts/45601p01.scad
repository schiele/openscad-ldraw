...
// 1 16 0 -70 0 1 0 0 0 1 0 0 0 1 u9393p01.dat
  [1,16,0,-70,0,1,0,0,0,1,0,0,0,1, ldraw_lib__u9393p01()],
...
// 1 14 0 0 0 1 0 0 0 1 0 0 0 1 45610.dat
  [1,14,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__45610()],
];
module ldraw_lib__45601p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__45601p01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
