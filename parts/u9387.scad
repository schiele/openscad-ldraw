...
use <../p/box3u8p.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9387(realsolid=false) = [
...
// 1 16 0 0 0 6 0 0 0 -7 0 0 0 6 4-4cylo.dat
  [1,16,0,0,0,6,0,0,0,-7,0,0,0,6, ldraw_lib__4_4cylo(realsolid)],
// 1 16 0 -7 0 2 0 0 0 1 0 0 0 2 4-4ring3.dat
  [1,16,0,-7,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4ring3(realsolid)],
// 1 16 0 -7 0 2 0 0 0 1 0 0 0 2 4-4ring4.dat
  [1,16,0,-7,0,2,0,0,0,1,0,0,0,2, ldraw_lib__4_4ring4(realsolid)],
// 
...
// 1 16 0 -7 0 3.82683 0 9.2388 0 7 0 -9.2388 0 3.82683 3-8cyli.dat
  [1,16,0,-7,0,3.82683,0,9.2388,0,7,0,-9.2388,0,3.82683, ldraw_lib__3_8cyli(realsolid)],
// 1 16 0 -7 0 -3.82683 0 -9.2388 0 7 0 9.2388 0 -3.82683 3-8cyli.dat
  [1,16,0,-7,0,-3.82683,0,-9.2388,0,7,0,9.2388,0,-3.82683, ldraw_lib__3_8cyli(realsolid)],
// 
// 0 // hole
// 1 16 0.45 -4 -10.9105 0 0 1.5 1.5 0 0 0 1 0.3 2-4cylo.dat
  [1,16,0.45,-4,-10.9105,0,0,1.5,1.5,0,0,0,1,0.3, ldraw_lib__2_4cylo(realsolid)],
// 1 16 0.45 -4 -10.9105 0 0 1.5 1.5 0 0 0 1 0.3 2-4chrd.dat
  [1,16,0.45,-4,-10.9105,0,0,1.5,1.5,0,0,0,1,0.3, ldraw_lib__2_4chrd(realsolid)],
// 1 16 0.45 -4 -9.9105 0 0 1.5 1.5 0 0 0 1 0.3 2-4ndis.dat
  [1,16,0.45,-4,-9.9105,0,0,1.5,1.5,0,0,0,1,0.3, ldraw_lib__2_4ndis(realsolid)],
// 1 16 -0.45 -4 -10.9105 0 0 -1.5 1.5 0 0 0 1 0.3 2-4cylo.dat
  [1,16,-0.45,-4,-10.9105,0,0,-1.5,1.5,0,0,0,1,0.3, ldraw_lib__2_4cylo(realsolid)],
// 1 16 -0.45 -4 -10.9105 0 0 -1.5 1.5 0 0 0 1 0.3 2-4chrd.dat
  [1,16,-0.45,-4,-10.9105,0,0,-1.5,1.5,0,0,0,1,0.3, ldraw_lib__2_4chrd(realsolid)],
...
// 1 16 0.225 -4 -9.9553 0.225 0 0 0 0 1.5 0.04475 -1 0 box3u8p.dat
  [1,16,0.225,-4,-9.9553,0.225,0,0,0,0,1.5,0.04475,-1,0, ldraw_lib__box3u8p(realsolid)],
// 1 16 -0.225 -4 -9.9553 0.225 0 0 0 0 1.5 -0.04475 -1 0 box3u8p.dat
  [1,16,-0.225,-4,-9.9553,0.225,0,0,0,0,1.5,-0.04475,-1,0, ldraw_lib__box3u8p(realsolid)],
...
module ldraw_lib__u9387(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9387(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
