...
use <../p/stud.scad>
$fa=1; $fs=0.2;
function ldraw_lib__6177(realsolid=false) = [
...
// 1 16 0 0 0 80 0 0 0 1 0 0 0 80 48\1-4disc.dat
  [1,16,0,0,0,80,0,0,0,1,0,0,0,80, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 0 0 0 0 0 80 0 1 0 -80 0 0 48\1-4disc.dat
  [1,16,0,0,0,0,0,80,0,1,0,-80,0,0, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 0 0 0 -80 0 0 0 1 0 0 0 -80 48\1-4disc.dat
  [1,16,0,0,0,-80,0,0,0,1,0,0,0,-80, ldraw_lib__48__1_4disc(realsolid)],
// 1 16 0 0 0 0 0 -80 0 1 0 80 0 0 48\1-4disc.dat
  [1,16,0,0,0,0,0,-80,0,1,0,80,0,0, ldraw_lib__48__1_4disc(realsolid)],
...
module ldraw_lib__6177(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6177(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
