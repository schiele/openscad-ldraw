...
// 1 4 0 0 0 1 0 0 0 1 0 0 0 1 3005.dat
  [1,4,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3005()],
];
module ldraw_lib__300521(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__300521(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
