...
// 1 16 -140 0 260 1 0 0 0 1 0 0 0 1 stug6.dat
  [1,16,-140,0,260,1,0,0,0,1,0,0,0,1, ldraw_lib__stug6()],
// 1 16 10 0 230 1 0 0 0 1 0 0 0 1 stug9.dat
  [1,16,10,0,230,1,0,0,0,1,0,0,0,1, ldraw_lib__stug9()],
// 1 16 50 0 110 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,50,0,110,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3()],
// 1 16 120 0 180 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,120,0,180,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 120 0 220 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,120,0,220,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 120 0 260 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,120,0,260,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
...
// 1 16 -100 0 180 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,-100,0,180,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
...
// 1 16 110 0 110 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,110,0,110,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3()],
...
// 1 16 180 0 -100 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,180,0,-100,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 180 0 120 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,180,0,120,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 220 0 120 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,220,0,120,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
// 1 16 260 0 120 1 0 0 0 1 0 0 0 1 stug2.dat
  [1,16,260,0,120,1,0,0,0,1,0,0,0,1, ldraw_lib__stug2()],
...
// 1 16 110 0 50 1 0 0 0 1 0 0 0 1 stug3.dat
  [1,16,110,0,50,1,0,0,0,1,0,0,0,1, ldraw_lib__stug3()],
// 1 16 230 0 10 1 0 0 0 1 0 0 0 1 stug9.dat
  [1,16,230,0,10,1,0,0,0,1,0,0,0,1, ldraw_lib__stug9()],
...
// 1 16 -230 0 -270 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-230,0,-270,1,0,0,0,1,0,0,0,1, ldraw_lib__stud()],
// 1 16 -230 0 -290 1 0 0 0 1 0 0 0 1 stud.dat
  [1,16,-230,0,-290,1,0,0,0,1,0,0,0,1, ldraw_lib__stud()],
...
module ldraw_lib__44342(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__44342(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
