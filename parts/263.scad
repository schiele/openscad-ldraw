...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__263(realsolid=false) = [
...
// 1 16 -10 4 -8 1 0 0 0 4 0 0 0 2 box5.dat
  [1,16,-10,4,-8,1,0,0,0,4,0,0,0,2, ldraw_lib__box5(realsolid)],
// 1 16 10 4 -8 1 0 0 0 4 0 0 0 2 box5.dat
  [1,16,10,4,-8,1,0,0,0,4,0,0,0,2, ldraw_lib__box5(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
// 1 16 0 24 -10 20 0 0 0 0 16 0 -1 0 rect3.dat
  [1,16,0,24,-10,20,0,0,0,0,16,0,-1,0, ldraw_lib__rect3(realsolid)],
// 1 16 18 38 -20 0 0 -2 0 -2 0 6 0 0 box2-5.dat
  [1,16,18,38,-20,0,0,-2,0,-2,0,6,0,0, ldraw_lib__box2_5(realsolid)],
// 1 16 -18 38 -20 0 0 2 0 -2 0 6 0 0 box2-5.dat
  [1,16,-18,38,-20,0,0,2,0,-2,0,6,0,0, ldraw_lib__box2_5(realsolid)],
// 1 16 0 8 -20 0 0 16 -4.8 4 0 6 0 0 box3u2p.dat
  [1,16,0,8,-20,0,0,16,-4.8,4,0,6,0,0, ldraw_lib__box3u2p(realsolid)],
// 1 16 0 1.6 -12 20 0 0 0 1 -1.6 0 0 2 rect3.dat
  [1,16,0,1.6,-12,20,0,0,0,1,-1.6,0,0,2, ldraw_lib__rect3(realsolid)],
// 1 16 0 26.4 -28 20 0 0 0 -12 1.6 0 0 -2 box2-7.dat
  [1,16,0,26.4,-28,20,0,0,0,-12,1.6,0,0,-2, ldraw_lib__box2_7(realsolid)],
// 0
// 1 16 -18 19.6 -14 -2 0 0 0 0 -16.4 0 1 0 rect2a.dat
  [1,16,-18,19.6,-14,-2,0,0,0,0,-16.4,0,1,0, ldraw_lib__rect2a(realsolid)],
// 1 16 18 19.6 -14 2 0 0 0 0 -16.4 0 1 0 rect2a.dat
  [1,16,18,19.6,-14,2,0,0,0,0,-16.4,0,1,0, ldraw_lib__rect2a(realsolid)],
// 1 16 0 23.6 -14 0 0 16 16.4 0 0 0 1 0 rect1.dat
  [1,16,0,23.6,-14,0,0,16,16.4,0,0,0,1,0, ldraw_lib__rect1(realsolid)],
// 0
// 1 16 -18 24.4 -26 -2 0 0 0 0 -11.6 0 -1 0 rect2a.dat
  [1,16,-18,24.4,-26,-2,0,0,0,0,-11.6,0,-1,0, ldraw_lib__rect2a(realsolid)],
// 1 16 18 24.4 -26 2 0 0 0 0 -11.6 0 -1 0 rect2a.dat
  [1,16,18,24.4,-26,2,0,0,0,0,-11.6,0,-1,0, ldraw_lib__rect2a(realsolid)],
// 1 16 0 28.4 -26 0 0 16 11.6 0 0 0 -1 0 rect1.dat
  [1,16,0,28.4,-26,0,0,16,11.6,0,0,0,-1,0, ldraw_lib__rect1(realsolid)],
// 0
...
module ldraw_lib__263(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__263(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
