...
use <../p/axle.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9011(realsolid=false) = [
...
// 1 16 0 0 0 0 1 0 -3.5 0 0 0 0 3.5 4-4edge.dat
  [1,16,0,0,0,0,1,0,-3.5,0,0,0,0,3.5, ldraw_lib__4_4edge(realsolid)],
...
module ldraw_lib__u9011(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9011(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
