...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink x184, Rebrickable 184
// 
...
// 1 16 170 0 -80 1 0 0 0 1 0 0 0 1 stug-8x1.dat
  [1,16,170,0,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_8x1()],
// 1 16 170 0 80 1 0 0 0 1 0 0 0 1 stug-8x1.dat
  [1,16,170,0,80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_8x1()],
// 1 16 -170 0 -80 1 0 0 0 1 0 0 0 1 stug-8x1.dat
  [1,16,-170,0,-80,1,0,0,0,1,0,0,0,1, ldraw_lib__stug_8x1()],
...
// 1 16 176 0 156 4 0 0 0 4 0 0 0 4 1-4cylo.dat
  [1,16,176,0,156,4,0,0,0,4,0,0,0,4, ldraw_lib__1_4cylo()],
// 1 16 -176 0 156 -4 0 0 0 4 0 0 0 4 1-4cylo.dat
  [1,16,-176,0,156,-4,0,0,0,4,0,0,0,4, ldraw_lib__1_4cylo()],
// 1 16 -176 0 -156 -4 0 0 0 4 0 0 0 -4 1-4cylo.dat
  [1,16,-176,0,-156,-4,0,0,0,4,0,0,0,-4, ldraw_lib__1_4cylo()],
...
// 1 16 176 0 156 4 0 0 0 1 0 0 0 4 1-4chrd.dat
  [1,16,176,0,156,4,0,0,0,1,0,0,0,4, ldraw_lib__1_4chrd()],
// 1 16 -176 0 156 -4 0 0 0 1 0 0 0 4 1-4chrd.dat
  [1,16,-176,0,156,-4,0,0,0,1,0,0,0,4, ldraw_lib__1_4chrd()],
// 1 16 -176 0 -156 -4 0 0 0 1 0 0 0 -4 1-4chrd.dat
  [1,16,-176,0,-156,-4,0,0,0,1,0,0,0,-4, ldraw_lib__1_4chrd()],
...
// 1 16 176 4 156 4 0 0 0 -1 0 0 0 4 1-4chrd.dat
  [1,16,176,4,156,4,0,0,0,-1,0,0,0,4, ldraw_lib__1_4chrd()],
// 1 16 -176 4 156 -4 0 0 0 -1 0 0 0 4 1-4chrd.dat
  [1,16,-176,4,156,-4,0,0,0,-1,0,0,0,4, ldraw_lib__1_4chrd()],
// 1 16 -176 4 -156 -4 0 0 0 -1 0 0 0 -4 1-4chrd.dat
  [1,16,-176,4,-156,-4,0,0,0,-1,0,0,0,-4, ldraw_lib__1_4chrd()],
...
// 1 16 176 2 0 0 -352 0 2 0 0 0 0 160 box4o8a.dat
  [1,16,176,2,0,0,-352,0,2,0,0,0,0,160, ldraw_lib__box4o8a()],
...
// 1 16 -180 2 0 0 1 0 0 0 2 156 0 0 rect2p.dat
  [1,16,-180,2,0,0,1,0,0,0,2,156,0,0, ldraw_lib__rect2p()],
// 1 16 180 2 0 0 -1 0 0 0 2 -156 0 0 rect2p.dat
  [1,16,180,2,0,0,-1,0,0,0,2,-156,0,0, ldraw_lib__rect2p()],
];
module ldraw_lib__6850(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__6850(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
