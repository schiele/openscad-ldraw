...
use <99249.scad>
$fa=1; $fs=0.2;
function ldraw_lib__99249c03(realsolid=false) = [
...
// 1 16 0 -29.594 10.321 1 0 0 0 0.83389 0.55194 0 -0.55194 0.83389 95831.dat
  [1,16,0,-29.594,10.321,1,0,0,0,0.83389,0.55194,0,-0.55194,0.83389, ldraw_lib__95831(realsolid)],
// 1 16 -10.372 -32.095 -5.989 -0.5 0.47799 -0.72217 0 0.83389 0.55194 0.86603 0.27597 -0.41694 95831.dat
  [1,16,-10.372,-32.095,-5.989,-0.5,0.47799,-0.72217,0,0.83389,0.55194,0.86603,0.27597,-0.41694, ldraw_lib__95831(realsolid)],
// 1 16 12.045 -35.014 -6.954 -0.5 -0.47799 0.72217 0 0.83389 0.55194 -0.86603 0.27597 -0.41694 95831.dat
  [1,16,12.045,-35.014,-6.954,-0.5,-0.47799,0.72217,0,0.83389,0.55194,-0.86603,0.27597,-0.41694, ldraw_lib__95831(realsolid)],
];
module ldraw_lib__99249c03(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__99249c03(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
