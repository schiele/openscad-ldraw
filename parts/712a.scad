...
// 1 16 -20 0 -20 0 0 -60 0 8 0 60 0 0 48\1-4cylo.dat
  [1,16,-20,0,-20,0,0,-60,0,8,0,60,0,0, ldraw_lib__48__1_4cylo()],
...
module ldraw_lib__712a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__712a(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
