...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3029(realsolid=false) = [
// 0 Plate  4 x 12
// 0 Name: 3029.dat
...
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 8 0 116 0 0 0 -4 0 0 0 36 box5.dat
  [1,16,0,8,0,116,0,0,0,-4,0,0,0,36, ldraw_lib__box5(realsolid)],
// 
...
// 4 16 -120 8 40 -116 8 36 -116 8 -36 -120 8 -40
  [4,16,-120,8,40,-116,8,36,-116,8,-36,-120,8,-40],
// 
// 1 16 0 8 0 120 0 0 0 -8 0 0 0 40 box5.dat
  [1,16,0,8,0,120,0,0,0,-8,0,0,0,40, ldraw_lib__box5(realsolid)],
// 
...
module ldraw_lib__3029(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3029(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3029(line=0.2);