...
use <s/243s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__243(realsolid=false) = [
...
// 1 16 0 0 10 4 0 0 0 0 4 0 -18 0 4-4cylo.dat
  [1,16,0,0,10,4,0,0,0,0,4,0,-18,0, ldraw_lib__4_4cylo(realsolid)],
];
module ldraw_lib__243(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__243(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
