...
use <87079.scad>
$fa=1; $fs=0.2;
function ldraw_lib__87079dm0(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 6005724l.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__6005724l(realsolid)],
];
module ldraw_lib__87079dm0(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__87079dm0(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
