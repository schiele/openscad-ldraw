...
use <s/25727s03.scad>
function ldraw_lib__100937p04() = [
// 0 Figure Friends Legs with Folded Trousers with Medium Tan Feet and Black Shoes with White Laces and Sole Pattern
// 0 Name: 100937p04.dat
...
module ldraw_lib__100937p04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__100937p04(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__100937p04(line=0.2);