...
// 1 36 0 0 0 1 0 0 0 1 0 0 0 1 40574c01.dat
  [1,36,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__40574c01()],
];
module ldraw_lib__40573(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__40573(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
