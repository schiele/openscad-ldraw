...
use <93084p01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__93085p01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 93083p01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__93083p01(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 93084p01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__93084p01(realsolid)],
];
module ldraw_lib__93085p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__93085p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
