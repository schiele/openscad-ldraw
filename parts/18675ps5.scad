...
use <s/18675s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__18675ps5(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 18675pb01, First Order, Star Wars
// 
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\18675ps5s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__18675ps5s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\18675ps5s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__18675ps5s01(realsolid)],
];
module ldraw_lib__18675ps5(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__18675ps5(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
