...
use <s/u9102s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9102(realsolid=false) = [
...
// 1 16 -16 -30 -9 0 32 0 0 0 -5 -4 0 0 1-4cyli.dat
  [1,16,-16,-30,-9,0,32,0,0,0,-5,-4,0,0, ldraw_lib__1_4cyli(realsolid)],
...
module ldraw_lib__u9102(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9102(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
