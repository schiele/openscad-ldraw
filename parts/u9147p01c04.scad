...
$fa=1; $fs=0.2;
function ldraw_lib__u9147p01c04(realsolid=false) = [
// 0 _Figure Fabuland Pig  1 with Body Red/Red/Blue
// 0 Name: u9147p01c04.dat
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Blondi Pig, Blondie Schwein, hog, Set 128, Set 338, swine
// 
...
module ldraw_lib__u9147p01c04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9147p01c04(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9147p01c04(line=0.2);