...
use <2362ap54.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2362p54(realsolid=false) = [
// 0 ~Moved to 2362ap54
// 0 Name: 2362p54.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 2362ap54.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__2362ap54(realsolid)],
];
module ldraw_lib__2362p54(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2362p54(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
