...
use <3846.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3846d02(realsolid=false) = [
...
// 1 7 0 0 -10 1 0 0 0 0 -1 0 1 0 003238c.dat
  [1,7,0,0,-10,1,0,0,0,0,-1,0,1,0, ldraw_lib__003238c(realsolid)],
// 0
];
module ldraw_lib__3846d02(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3846d02(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
