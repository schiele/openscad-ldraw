...
use <s/3009s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3009pt3(realsolid=false) = [
...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS Bricklink 3009pb056
// 
...
// 1 16 0 0 -10 1 0 0 0 1 0 0 0 1 s\3009pt3s01.dat
  [1,16,0,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3009pt3s01(realsolid)],
// 1 15 0 0 -10 1 0 0 0 1 0 0 0 1 s\3009pt3s02.dat
  [1,15,0,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3009pt3s02(realsolid)],
...
module ldraw_lib__3009pt3(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3009pt3(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
