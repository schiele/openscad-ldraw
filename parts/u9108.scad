...
use <s/u9108s00.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9108(realsolid=false) = [
// 0 ~Figure Fabuland Cat Head without Pattern
// 0 Name: u9108.dat
...
// 
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\u9108s00.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9108s00(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\u9108s00.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__u9108s00(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
...
module ldraw_lib__u9108(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9108(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__u9108(line=0.2);