...
use <../p/stud4.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4529(realsolid=false) = [
// 0 Minifig Saucepan
// 0 Name: 4529.dat
...
// 1 16 0 0 0 13 0 0 0 20 0 0 0 13 4-4cyli.dat
  [1,16,0,0,0,13,0,0,0,20,0,0,0,13, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 11 0 0 0 18 0 0 0 11 4-4cyli.dat
  [1,16,0,0,0,11,0,0,0,18,0,0,0,11, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 20 0 13 0 0 0 -1 0 0 0 13 4-4disc.dat
  [1,16,0,20,0,13,0,0,0,-1,0,0,0,13, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 18 0 11 0 0 0 1 0 0 0 11 4-4disc.dat
  [1,16,0,18,0,11,0,0,0,1,0,0,0,11, ldraw_lib__4_4disc(realsolid)],
...
// 1 16 0 20 0 13 0 0 0 1 0 0 0 13 4-4edge.dat
  [1,16,0,20,0,13,0,0,0,1,0,0,0,13, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 18 0 11 0 0 0 1 0 0 0 11 4-4edge.dat
  [1,16,0,18,0,11,0,0,0,1,0,0,0,11, ldraw_lib__4_4edge(realsolid)],
...
// 1 16 0 6 13 -4 0 0 0 0 -4 0 -0.8 0 1-4cyls2.dat
  [1,16,0,6,13,-4,0,0,0,0,-4,0,-0.8,0, ldraw_lib__1_4cyls2(realsolid)],
// 1 16 0 6 13 4 0 0 0 0 -4 0 -0.8 0 1-4cyls2.dat
  [1,16,0,6,13,4,0,0,0,0,-4,0,-0.8,0, ldraw_lib__1_4cyls2(realsolid)],
// 1 16 0 6 13 -4 0 0 0 0 4 0 -0.8 0 1-4cyls2.dat
  [1,16,0,6,13,-4,0,0,0,0,4,0,-0.8,0, ldraw_lib__1_4cyls2(realsolid)],
...
// 1 16 0 6 13 0 0 -4 4 0 0 0 1 -0.8 2-4edge.dat
  [1,16,0,6,13,0,0,-4,4,0,0,0,1,-0.8, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 6 13 0 0 4 4 0 0 0 1 -0.8 2-4edge.dat
  [1,16,0,6,13,0,0,4,4,0,0,0,1,-0.8, ldraw_lib__2_4edge(realsolid)],
// 
// 1 16 0 6 13 4 0 0 0 0 4 0 17 0 4-4cyli.dat
  [1,16,0,6,13,4,0,0,0,0,4,0,17,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 6 30 4 0 0 0 0 4 0 -1 0 4-4disc.dat
  [1,16,0,6,30,4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 6 30 4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,16,0,6,30,4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 0
];
module ldraw_lib__4529(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4529(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
