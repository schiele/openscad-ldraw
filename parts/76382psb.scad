...
use <3820.scad>
use <973psb.scad>
function ldraw_lib__76382psb() = [
// 0 Minifig Torso with Arms and Hands with SW Blast Armour (Green Plates) Grey Pattern
// 0 Name: 76382psb.dat
...
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 973psb.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__973psb()],
...
module ldraw_lib__76382psb(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__76382psb(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__76382psb(line=0.2);