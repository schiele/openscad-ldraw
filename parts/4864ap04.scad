...
// 0 BFC CERTIFY CCW
  ...
  [0,"BFC","CCW"],
// 
// 0 !KEYWORDS BrickLink 4864apx6, Rebrickable 4864apr0006, Set 1721
// 
...
// 1 16 0 0 10 -1 0 0 0 1 0 0 0 -1 s\4864ap04s01.dat
  [1,16,0,0,10,-1,0,0,0,1,0,0,0,-1, ldraw_lib__s__4864ap04s01()],
];
module ldraw_lib__4864ap04(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4864ap04(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
