...
// 0 !HISTORY 2025-04-27 [Holly-Wood] Updated description
...
module ldraw_lib__u9495(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9495(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
