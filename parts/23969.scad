...
use <s/23969s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__23969(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\23969s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__23969s01(realsolid)],
// 4 16 20 24 10 -20 24 10 -20 0 10 20 0 10
  [4,16,20,24,10,-20,24,10,-20,0,10,20,0,10],
];
module ldraw_lib__23969(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__23969(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
