...
use <s/45274s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__45274(realsolid=false) = [
...
// 1 16 0 -20 40 9 0 0 0 17 0 0 0 9 2-4cylo.dat
  [1,16,0,-20,40,9,0,0,0,17,0,0,0,9, ldraw_lib__2_4cylo(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\45274s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__45274s01(realsolid)],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\45274s01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__45274s01(realsolid)],
...
module ldraw_lib__45274(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__45274(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
