...
use <../p/t04q1316.scad>
$fa=1; $fs=0.2;
function ldraw_lib__71861(realsolid=false) = [
...
// 1 16 -10 -31.25 0 0 1 0 0 0 2.5 2.5 0 0 4-4edge.dat
  [1,16,-10,-31.25,0,0,1,0,0,0,2.5,2.5,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 10 -31.25 0 0 1 0 0 0 2.5 2.5 0 0 4-4edge.dat
  [1,16,10,-31.25,0,0,1,0,0,0,2.5,2.5,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 -10 -31.25 0 0 20 0 0 0 4 4 0 0 4-4cylc.dat
  [1,16,-10,-31.25,0,0,20,0,0,0,4,4,0,0, ldraw_lib__4_4cylc(realsolid)],
// 1 16 10 -31.25 0 0 -1 0 0 0 4 4 0 0 4-4disc.dat
  [1,16,10,-31.25,0,0,-1,0,0,0,4,4,0,0, ldraw_lib__4_4disc(realsolid)],
// 
// 1 16 -19.75 0 0 0 -9.25 0 0 0 2.5 -2.5 0 0 4-4cyli.dat
  [1,16,-19.75,0,0,0,-9.25,0,0,0,2.5,-2.5,0,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -19.75 0 0 0 -1 0 0 0 2.5 -2.5 0 0 4-4disc.dat
  [1,16,-19.75,0,0,0,-1,0,0,0,2.5,-2.5,0,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 -19.75 0 0 0 1 0 0 0 2.5 -2.5 0 0 4-4edge.dat
  [1,16,-19.75,0,0,0,1,0,0,0,2.5,-2.5,0,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 -29 0 0 0 0 -2.5 0 2.5 0 2.5 0 0 2-8sphe.dat
  [1,16,-29,0,0,0,0,-2.5,0,2.5,0,2.5,0,0, ldraw_lib__2_8sphe(realsolid)],
// 1 16 -10 -12.25 0 0 0 -19 -19 0 0 0 19 0 t04q1316.dat
  [1,16,-10,-12.25,0,0,0,-19,-19,0,0,0,19,0, ldraw_lib__t04q1316(realsolid)],
// 1 16 -29 -12.25 0 0 0 -2.5 0 12.25 0 2.5 0 0 4-4cyli.dat
  [1,16,-29,-12.25,0,0,0,-2.5,0,12.25,0,2.5,0,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 -29 0 0 0 0.7071 2.5 0 0.7071 -2.5 -2.5 0 0 2-4edge.dat
  [1,16,-29,0,0,0,0.7071,2.5,0,0.7071,-2.5,-2.5,0,0, ldraw_lib__2_4edge(realsolid)],
// 
// 1 16 19.75 0 0 0 9.25 0 0 0 2.5 2.5 0 0 4-4cyli.dat
  [1,16,19.75,0,0,0,9.25,0,0,0,2.5,2.5,0,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 19.75 0 0 0 1 0 0 0 2.5 2.5 0 0 4-4disc.dat
...
module ldraw_lib__71861(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__71861(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
