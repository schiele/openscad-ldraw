...
use <s/14396s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__14396(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\14396s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__14396s01(realsolid)],
// 
// 0 // Plain Face
// 1 16 0 -18.5 8.5 17 0 0 0 0 -17 0 -1 0 48\4-4disc.dat
  [1,16,0,-18.5,8.5,17,0,0,0,0,-17,0,-1,0, ldraw_lib__48__4_4disc(realsolid)],
// 
// 0 // Face with Dimples
// 1 16 5.65 -18.5 -8.1 3.5 0 0 0 0 3.5 0 1 0 4-4disc.dat
  [1,16,5.65,-18.5,-8.1,3.5,0,0,0,0,3.5,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 5.65 -18.5 -8.5 3.75 0 0 0 0 -3.75 0 1 0 4-4ndis.dat
  [1,16,5.65,-18.5,-8.5,3.75,0,0,0,0,-3.75,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -5.65 -18.5 -8.1 3.5 0 0 0 0 3.5 0 1 0 4-4disc.dat
  [1,16,-5.65,-18.5,-8.1,3.5,0,0,0,0,3.5,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 -5.65 -18.5 -8.5 3.75 0 0 0 0 -3.75 0 1 0 4-4ndis.dat
  [1,16,-5.65,-18.5,-8.5,3.75,0,0,0,0,-3.75,0,1,0, ldraw_lib__4_4ndis(realsolid)],
...
module ldraw_lib__14396(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__14396(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
