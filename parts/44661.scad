...
use <../p/stud3.scad>
$fa=1; $fs=0.2;
function ldraw_lib__44661(realsolid=false) = [
...
// 1 16 11.5 4 0 0 0 8.5 -4 0 0 0 10 0 box3-3.dat
  [1,16,11.5,4,0,0,0,8.5,-4,0,0,0,10,0, ldraw_lib__box3_3(realsolid)],
// 1 16 -11.5 4 0 0 0 -8.5 -4 0 0 0 10 0 box3-3.dat
  [1,16,-11.5,4,0,0,0,-8.5,-4,0,0,0,10,0, ldraw_lib__box3_3(realsolid)],
...
// 1 16 0 -3 -10 3 0 0 0 0 -3 0 1 0 rect3.dat
  [1,16,0,-3,-10,3,0,0,0,0,-3,0,1,0, ldraw_lib__rect3(realsolid)],
// 4 16 3 -40 30 3 -6 -10 -3 -6 -10 -3 -40 30
  [4,16,3,-40,30,3,-6,-10,-3,-6,-10,-3,-40,30],
// 1 16 0 -28 39 -3 0 0 0 -12 0 0 0 9 box2-5.dat
  [1,16,0,-28,39,-3,0,0,0,-12,0,0,0,9, ldraw_lib__box2_5(realsolid)],
// 4 16 -3 -16 48 -3 8 10 3 8 10 3 -16 48
  [4,16,-3,-16,48,-3,8,10,3,8,10,3,-16,48],
// 0
];
module ldraw_lib__44661(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__44661(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__44661(line=0.2);