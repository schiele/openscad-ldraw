...
// 2 24 -3 -16 48 -3 8 10
  [2,24,-3,-16,48,-3,8,10],
// 4 16 3 8 10 3 -16 48 3 -40 48 3 0 10
  [4,16,3,8,10,3,-16,48,3,-40,48,3,0,10],
// 3 16 3 0 10 3 -40 48 3 -40 30
  [3,16,3,0,10,3,-40,48,3,-40,30],
// 4 16 3 -6 -10 3 0 -10 3 0 10 3 -40 30
  [4,16,3,-6,-10,3,0,-10,3,0,10,3,-40,30],
// 4 16 -3 -16 48 -3 8 10 -3 0 10 -3 -40 48
  [4,16,-3,-16,48,-3,8,10,-3,0,10,-3,-40,48],
// 3 16 -3 0 10 -3 -40 30 -3 -40 48
  [3,16,-3,0,10,-3,-40,30,-3,-40,48],
// 4 16 -3 0 10 -3 0 -10 -3 -6 -10 -3 -40 30
  [4,16,-3,0,10,-3,0,-10,-3,-6,-10,-3,-40,30],
...
module ldraw_lib__44661(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__44661(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
