use <../lib.scad>
use <../p/5-16cyli.scad>
use <s/3626cp7ps01.scad>
use <s/3626cs02.scad>
use <../p/t04o6250.scad>
use <../p/t16o6250.scad>
function ldraw_lib__3626cp7p() = [
// 0 Minifig Head with Laugh Lines, White and Light Bluish Grey Bushy Eyebrows, Beard and Moustache Pattern
// 0 Name: 3626cp7p.dat
...
// 0 !KEYWORDS BrickLink 3626pb2914, Brickowl 1154336, Brickset 79426
// 0 !KEYWORDS Rebrickable 3626cpr3560, Santa Claus, Set 10293, Set 10305
// 0 !KEYWORDS Set 10312, Set 21343, Set 21344
// 
...
// 1 16 0 17 0 8 0 0 0 6.4 0 0 0 -8 t16o6250.dat
  [1,16,0,17,0,8,0,0,0,6.4,0,0,0,-8, ldraw_lib__t16o6250()],
// 
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3626cp7ps01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3626cp7ps01()],
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\3626cp7ps01.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__3626cp7ps01()],
// 
// 5 24 0 17 -13 0 4 -13 -4.98 4 -12.01 4.98 4 -12.01
  [5,24,0,17,-13,0,4,-13,-4.98,4,-12.01,4.98,4,-12.01],
...
module ldraw_lib__3626cp7p(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3626cp7p(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
ldraw_lib__3626cp7p(line=0.2);