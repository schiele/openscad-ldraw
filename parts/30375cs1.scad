...
use <30378ps1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__30375cs1(realsolid=false) = [
...
// 1 16 0 -38 0 1 0 0 0 1 0 0 0 1 30375ps1.dat
  [1,16,0,-38,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30375ps1(realsolid)],
// 1 16 0 -70 0 1 0 0 0 1 0 0 0 1 30378ps1.dat
  [1,16,0,-70,0,1,0,0,0,1,0,0,0,1, ldraw_lib__30378ps1(realsolid)],
...
module ldraw_lib__30375cs1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__30375cs1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
