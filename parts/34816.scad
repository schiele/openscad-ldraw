...
// 1 16 20 17.5 0 0 8.1 0 -1.5 0 0 0 0 6 box4o4a.dat
  [1,16,20,17.5,0,0,8.1,0,-1.5,0,0,0,0,6, ldraw_lib__box4o4a()],
...
// 1 16 28.1 5 0 0 0 6 0 3 0 -6 0 0 2-4cylo.dat
  [1,16,28.1,5,0,0,0,6,0,3,0,-6,0,0, ldraw_lib__2_4cylo()],
// 1 16 28.1 5 0 0 0 6 0 1 0 -6 0 0 2-4chrd.dat
  [1,16,28.1,5,0,0,0,6,0,1,0,-6,0,0, ldraw_lib__2_4chrd()],
// 1 16 28.1 8 0 0 0 6 0 -1 0 -6 0 0 2-4chrd.dat
  [1,16,28.1,8,0,0,0,6,0,-1,0,-6,0,0, ldraw_lib__2_4chrd()],
// 1 16 28.1 16 0 0 0 6 0 1 0 -6 0 0 2-4chrd.dat
  [1,16,28.1,16,0,0,0,6,0,1,0,-6,0,0, ldraw_lib__2_4chrd()],
// 1 16 28.1 19 0 0 0 6 0 -1 0 -6 0 0 2-4chrd.dat
  [1,16,28.1,19,0,0,0,6,0,-1,0,-6,0,0, ldraw_lib__2_4chrd()],
// 1 16 28.1 19 0 0 0 6 0 -3 0 -6 0 0 2-4cylo.dat
  [1,16,28.1,19,0,0,0,6,0,-3,0,-6,0,0, ldraw_lib__2_4cylo()],
// 1 16 20 6.5 0 0 8.1 0 -1.5 0 0 0 0 6 box4o4a.dat
  [1,16,20,6.5,0,0,8.1,0,-1.5,0,0,0,0,6, ldraw_lib__box4o4a()],
];
module ldraw_lib__34816(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__34816(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
