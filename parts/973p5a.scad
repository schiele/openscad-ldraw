...
use <s/973s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__973p5a(realsolid=false) = [
// 0 Minifig Torso Female Jumpsuit with Zipper with 'SALLY' Name Tag Pattern
// 0 Name: 973p5a.dat
...
module ldraw_lib__973p5a(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p5a(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
