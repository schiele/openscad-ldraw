...
use <3068bps1.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3068ps1(realsolid=false) = [
// 0 ~Moved to 3068bps1
// 0 Name: 3068ps1.dat
// 0 Author: [PTadmin]
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 3068bps1.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__3068bps1(realsolid)],
];
module ldraw_lib__3068ps1(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3068ps1(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
