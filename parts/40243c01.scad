...
use <40243.scad>
$fa=1; $fs=0.2;
function ldraw_lib__40243c01(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 40243.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__40243(realsolid)],
// 1 16 0 16 0 .929 0 -.383 0 1 0 .383 0 .929 40243.dat
  [1,16,0,16,0,.929,0,-.383,0,1,0,.383,0,.929, ldraw_lib__40243(realsolid)],
// 1 16 0 32 0 .707 0 -.707 0 1 0 .707 0 .707 40243.dat
  [1,16,0,32,0,.707,0,-.707,0,1,0,.707,0,.707, ldraw_lib__40243(realsolid)],
// 1 16 0 48 0 .383 0 -.929 0 1 0 .929 0 .383 40243.dat
  [1,16,0,48,0,.383,0,-.929,0,1,0,.929,0,.383, ldraw_lib__40243(realsolid)],
// 1 16 0 64 0 0 0 -1 0 1 0 1 0 0 40243.dat
  [1,16,0,64,0,0,0,-1,0,1,0,1,0,0, ldraw_lib__40243(realsolid)],
// 1 16 0 80 0 -.383 0 -.929 0 1 0 .929 0 -.383 40243.dat
  [1,16,0,80,0,-.383,0,-.929,0,1,0,.929,0,-.383, ldraw_lib__40243(realsolid)],
// 1 16 0 96 0 -.707 0 -.707 0 1 0 .707 0 -.707 40243.dat
  [1,16,0,96,0,-.707,0,-.707,0,1,0,.707,0,-.707, ldraw_lib__40243(realsolid)],
// 1 16 0 112 0 -.929 0 -.383 0 1 0 .383 0 -.929 40243.dat
  [1,16,0,112,0,-.929,0,-.383,0,1,0,.383,0,-.929, ldraw_lib__40243(realsolid)],
// 0
];
module ldraw_lib__40243c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__40243c01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
