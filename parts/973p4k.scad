...
// 1 16 0 0 -10 1 0 0 0 1 0 0 0 1 s\973p4ks01.dat
  [1,16,0,0,-10,1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p4ks01()],
// 1 16 0 0 -10 -1 0 0 0 1 0 0 0 1 s\973p4ks01.dat
  [1,16,0,0,-10,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__973p4ks01()],
];
module ldraw_lib__973p4k(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__973p4k(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
