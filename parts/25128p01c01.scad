...
use <24581p01.scad>
use <25128p01.scad>
function ldraw_lib__25128p01c01() = [
...
// 1 14 0 -24 0 1 0 0 0 1 0 0 0 1 24581p01.dat
  [1,14,0,-24,0,1,0,0,0,1,0,0,0,1, ldraw_lib__24581p01()],
];
module ldraw_lib__25128p01c01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__25128p01c01(), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
