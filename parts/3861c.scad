...
use <../p/stud4o.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3861c(realsolid=false) = [
...
// 1 16 5 116 -5 0 0 5 0 -4 0 -5 0 0 box3-7a.dat
  [1,16,5,116,-5,0,0,5,0,-4,0,-5,0,0, ldraw_lib__box3_7a(realsolid)],
// 2 24 0 120 10 -10 120 10
  [2,24,0,120,10,-10,120,10],
// 2 24 -10 114 10 -6 114 10
  [2,24,-10,114,10,-6,114,10],
// 1 16 0 112 0 -6 0 0 0 1 0 0 0 -6 1-4edge.dat
  [1,16,0,112,0,-6,0,0,0,1,0,0,0,-6, ldraw_lib__1_4edge(realsolid)],
// 2 24 0 112 -6 0 112 -10
  [2,24,0,112,-6,0,112,-10],
// 2 24 -6 112 10 -6 114 10
  [2,24,-6,112,10,-6,114,10],
// 1 16 0 112 0 -6 0 0 0 1 0 0 0 -6 1-4disc.dat
  [1,16,0,112,0,-6,0,0,0,1,0,0,0,-6, ldraw_lib__1_4disc(realsolid)],
// 1 16 0 112 0 10 0 0 0 1 0 0 0 10 1-4disc.dat
  [1,16,0,112,0,10,0,0,0,1,0,0,0,10, ldraw_lib__1_4disc(realsolid)],
// 1 16 -3 112 5 -3 0 0 0 1 0 0 0 5 rect2a.dat
  [1,16,-3,112,5,-3,0,0,0,1,0,0,0,5, ldraw_lib__rect2a(realsolid)],
...
// 1 16 0 112 0 10 0 0 0 8 0 0 0 10 1-4cylo.dat
  [1,16,0,112,0,10,0,0,0,8,0,0,0,10, ldraw_lib__1_4cylo(realsolid)],
// 1 16 -10 117 5 0 1 0 3 0 0 0 0 5 rect2a.dat
  [1,16,-10,117,5,0,1,0,3,0,0,0,0,5, ldraw_lib__rect2a(realsolid)],
...
module ldraw_lib__3861c(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3861c(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
