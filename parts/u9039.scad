...
use <../p/4-4ndis.scad>
$fa=1; $fs=0.2;
function ldraw_lib__u9039(realsolid=false) = [
...
// 1 494 40 10 -16 -4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,494,40,10,-16,-4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 494 40 10 -16 -4 0 0 0 0 4 0 1 0 4-4ndis.dat
  [1,494,40,10,-16,-4,0,0,0,0,4,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 494 40 30 -16 -4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,494,40,30,-16,-4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 494 40 30 -16 -4 0 0 0 0 4 0 1 0 4-4ndis.dat
  [1,494,40,30,-16,-4,0,0,0,0,4,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 494 40 50 -16 -4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,494,40,50,-16,-4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 494 40 50 -16 -4 0 0 0 0 4 0 1 0 4-4ndis.dat
  [1,494,40,50,-16,-4,0,0,0,0,4,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 494 40 10 -4 -4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,494,40,10,-4,-4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 494 40 10 -4 -4 0 0 0 0 4 0 -1 0 4-4ndis.dat
  [1,494,40,10,-4,-4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 494 40 30 -4 -4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,494,40,30,-4,-4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 494 40 50 0 -4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,494,40,50,0,-4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 494 40 50 0 -4 0 0 0 0 4 0 -1 0 4-4ndis.dat
  [1,494,40,50,0,-4,0,0,0,0,4,0,-1,0, ldraw_lib__4_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 494 40 50 -16 -4 0 0 0 0 4 0 16 0 4-4cyli.dat
  [1,494,40,50,-16,-4,0,0,0,0,4,0,16,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 494 40 30 -16 -4 0 0 0 0 4 0 12 0 4-4cyli.dat
  [1,494,40,30,-16,-4,0,0,0,0,4,0,12,0, ldraw_lib__4_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 494 40 10 -16 -4 0 0 0 0 4 0 12 0 4-4cyli.dat
  [1,494,40,10,-16,-4,0,0,0,0,4,0,12,0, ldraw_lib__4_4cyli(realsolid)],
// 2 24 50 2 -4 50 18 -4
  [2,24,50,2,-4,50,18,-4],
...
// 1 16 0 30 -16 -4 0 0 0 0 4 0 12 0 4-4cyli.dat
  [1,16,0,30,-16,-4,0,0,0,0,4,0,12,0, ldraw_lib__4_4cyli(realsolid)],
// 1 16 0 30 -16 -4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,16,0,30,-16,-4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 1 16 0 30 -16 -4 0 0 0 0 4 0 1 0 4-4disc.dat
  [1,16,0,30,-16,-4,0,0,0,0,4,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 16 0 30 -4 -4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,16,0,30,-4,-4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
// 2 24 -24 2 0 24 2 0
  [2,24,-24,2,0,24,2,0],
...
// 1 494 -40 30 0 -4 0 0 0 0 4 0 1 0 4-4edge.dat
  [1,494,-40,30,0,-4,0,0,0,0,4,0,1,0, ldraw_lib__4_4edge(realsolid)],
...
// 1 494 -40 30 -4 -4 0 0 0 0 4 0 4 0 4-4cyli.dat
  [1,494,-40,30,-4,-4,0,0,0,0,4,0,4,0, ldraw_lib__4_4cyli(realsolid)],
...
module ldraw_lib__u9039(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__u9039(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
