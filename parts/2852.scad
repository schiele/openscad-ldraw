...
use <../p/peghole.scad>
$fa=1; $fs=0.2;
function ldraw_lib__2852(realsolid=false) = [
...
// 1 16 0 0 4 5.66 0 -5.66 -5.66 0 -5.66 0 1 0 1-4edge.dat
  [1,16,0,0,4,5.66,0,-5.66,-5.66,0,-5.66,0,1,0, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 0 -30 -4 -2 0 0 0 0 -2 0 -1 0 2-4edge.dat
  [1,16,0,-30,-4,-2,0,0,0,0,-2,0,-1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -18 -4 2 0 0 0 0 2 0 -1 0 2-4edge.dat
  [1,16,0,-18,-4,2,0,0,0,0,2,0,-1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -30 -2 -2 0 0 0 0 -2 0 1 0 2-4disc.dat
  [1,16,0,-30,-2,-2,0,0,0,0,-2,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 1 16 0 -30 -2 -2 0 0 0 0 -2 0 -1 0 2-4edge.dat
  [1,16,0,-30,-2,-2,0,0,0,0,-2,0,-1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 0 -18 -2 2 0 0 0 0 2 0 -1 0 2-4edge.dat
  [1,16,0,-18,-2,2,0,0,0,0,2,0,-1,0, ldraw_lib__2_4edge(realsolid)],
// 1 16 -2 -14.603 -9 0 1 0 0 0 5 5 0 0 1-4edge.dat
  [1,16,-2,-14.603,-9,0,1,0,0,0,5,5,0,0, ldraw_lib__1_4edge(realsolid)],
// 1 16 2 -14.603 -9 0 1 0 0 0 5 5 0 0 1-4edge.dat
  [1,16,2,-14.603,-9,0,1,0,0,0,5,5,0,0, ldraw_lib__1_4edge(realsolid)],
...
// 1 16 0 -40 0 8 0 0 0 0 -8 0 8 0 8-8sphe.dat
  [1,16,0,-40,0,8,0,0,0,0,-8,0,8,0, ldraw_lib__8_8sphe(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 0 0 5.66 0 -5.66 -5.66 0 -5.66 0 4 0 1-4cyli.dat
  [1,16,0,0,0,5.66,0,-5.66,-5.66,0,-5.66,0,4,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 0 0 4 5.66 0 -5.66 -5.66 0 -5.66 0 -1 0 1-4ndis.dat
  [1,16,0,0,4,5.66,0,-5.66,-5.66,0,-5.66,0,-1,0, ldraw_lib__1_4ndis(realsolid)],
...
// 1 16 0 -30 -4 -2 0 0 0 0 -2 0 1 0 2-4ndis.dat
  [1,16,0,-30,-4,-2,0,0,0,0,-2,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 1 16 0 -18 -4 2 0 0 0 0 2 0 1 0 2-4ndis.dat
  [1,16,0,-18,-4,2,0,0,0,0,2,0,1,0, ldraw_lib__2_4ndis(realsolid)],
// 4 16 2 -18 -2 2 -30 -2 -2 -30 -2 -2 -18 -2
  [4,16,2,-18,-2,2,-30,-2,-2,-30,-2,-2,-18,-2],
// 1 16 0 -18 -2 2 0 0 0 0 2 0 1 0 2-4disc.dat
  [1,16,0,-18,-2,2,0,0,0,0,2,0,1,0, ldraw_lib__2_4disc(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -30 -2 -2 0 0 0 0 -2 0 -2 0 2-4cyli.dat
  [1,16,0,-30,-2,-2,0,0,0,0,-2,0,-2,0, ldraw_lib__2_4cyli(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 0 -18 -2 2 0 0 0 0 2 0 -2 0 2-4cyli.dat
  [1,16,0,-18,-2,2,0,0,0,0,2,0,-2,0, ldraw_lib__2_4cyli(realsolid)],
...
// 1 16 -2 -14.603 -9 0 1 0 0 0 5 5 0 0 1-4ndis.dat
  [1,16,-2,-14.603,-9,0,1,0,0,0,5,5,0,0, ldraw_lib__1_4ndis(realsolid)],
// 1 16 2 -14.603 -9 0 -1 0 0 0 5 5 0 0 1-4ndis.dat
  [1,16,2,-14.603,-9,0,-1,0,0,0,5,5,0,0, ldraw_lib__1_4ndis(realsolid)],
// 0 BFC INVERTNEXT
  [0,"BFC","INVERTNEXT"],
// 1 16 -2 -14.603 -9 0 4 0 0 0 5 5 0 0 1-4cyli.dat
  [1,16,-2,-14.603,-9,0,4,0,0,0,5,5,0,0, ldraw_lib__1_4cyli(realsolid)],
// 1 16 0 0 -10 10 0 0 0 0 -10 0 6 0 4-4cyli.dat
  [1,16,0,0,-10,10,0,0,0,0,-10,0,6,0, ldraw_lib__4_4cyli(realsolid)],
...
// 1 16 0 0 -8 6 0 0 0 0 -6 0 8 0 4-4cyli.dat
  [1,16,0,0,-8,6,0,0,0,0,-6,0,8,0, ldraw_lib__4_4cyli(realsolid)],
...
module ldraw_lib__2852(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__2852(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
