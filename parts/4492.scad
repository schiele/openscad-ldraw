...
use <s/4492s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__4492(realsolid=false) = [
// 0 Animal Horse Head
// 0 Name: 4492.dat
...
// 1 16 0 0 0 -1 0 0 0 1 0 0 0 1 s\4492s00.dat
  [1,16,0,0,0,-1,0,0,0,1,0,0,0,1, ldraw_lib__s__4492s00(realsolid)],
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\4492s00.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__4492s00(realsolid)],
// 
...
module ldraw_lib__4492(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__4492(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
