...
use <s/3623s01.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3623p01(realsolid=false) = [
...
// 1 16 -25 4 -10 1.75 0 0 0 0 1.75 0 1 0 4-4ndis.dat
  [1,16,-25,4,-10,1.75,0,0,0,0,1.75,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -15 4 -10 1.75 0 0 0 0 1.75 0 1 0 4-4ndis.dat
  [1,16,-15,4,-10,1.75,0,0,0,0,1.75,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 -5 4 -10 1.75 0 0 0 0 1.75 0 1 0 4-4ndis.dat
  [1,16,-5,4,-10,1.75,0,0,0,0,1.75,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 5 4 -10 1.75 0 0 0 0 1.75 0 1 0 4-4ndis.dat
  [1,16,5,4,-10,1.75,0,0,0,0,1.75,0,1,0, ldraw_lib__4_4ndis(realsolid)],
// 1 16 15 4 -10 1.75 0 0 0 0 1.75 0 1 0 4-4ndis.dat
  [1,16,15,4,-10,1.75,0,0,0,0,1.75,0,1,0, ldraw_lib__4_4ndis(realsolid)],
...
// 1 0 -25 4 -10 .5 0 0 0 0 .5 0 1 0 4-4ring2.dat
  [1,0,-25,4,-10,.5,0,0,0,0,.5,0,1,0, ldraw_lib__4_4ring2(realsolid)],
// 1 0 -15 4 -10 .5 0 0 0 0 .5 0 1 0 4-4ring2.dat
  [1,0,-15,4,-10,.5,0,0,0,0,.5,0,1,0, ldraw_lib__4_4ring2(realsolid)],
// 1 0 -5 4 -10 .5 0 0 0 0 .5 0 1 0 4-4ring2.dat
  [1,0,-5,4,-10,.5,0,0,0,0,.5,0,1,0, ldraw_lib__4_4ring2(realsolid)],
// 1 0 5 4 -10 .5 0 0 0 0 .5 0 1 0 4-4ring2.dat
  [1,0,5,4,-10,.5,0,0,0,0,.5,0,1,0, ldraw_lib__4_4ring2(realsolid)],
// 1 0 15 4 -10 .5 0 0 0 0 .5 0 1 0 4-4ring2.dat
  [1,0,15,4,-10,.5,0,0,0,0,.5,0,1,0, ldraw_lib__4_4ring2(realsolid)],
...
// 1 0 -25 4 -10 .25 0 0 0 0 .25 0 1 0 4-4ring6.dat
  [1,0,-25,4,-10,.25,0,0,0,0,.25,0,1,0, ldraw_lib__4_4ring6(realsolid)],
// 1 0 -15 4 -10 .25 0 0 0 0 .25 0 1 0 4-4ring6.dat
  [1,0,-15,4,-10,.25,0,0,0,0,.25,0,1,0, ldraw_lib__4_4ring6(realsolid)],
// 1 0 -5 4 -10 .25 0 0 0 0 .25 0 1 0 4-4ring6.dat
  [1,0,-5,4,-10,.25,0,0,0,0,.25,0,1,0, ldraw_lib__4_4ring6(realsolid)],
// 1 0 5 4 -10 .25 0 0 0 0 .25 0 1 0 4-4ring6.dat
  [1,0,5,4,-10,.25,0,0,0,0,.25,0,1,0, ldraw_lib__4_4ring6(realsolid)],
// 1 0 15 4 -10 .25 0 0 0 0 .25 0 1 0 4-4ring6.dat
  [1,0,15,4,-10,.25,0,0,0,0,.25,0,1,0, ldraw_lib__4_4ring6(realsolid)],
...
// 1 80 -25 4 -10 1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,80,-25,4,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 80 -15 4 -10 1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,80,-15,4,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 80 -5 4 -10 1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,80,-5,4,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 80 5 4 -10 1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,80,5,4,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
// 1 80 15 4 -10 1 0 0 0 0 1 0 1 0 4-4disc.dat
  [1,80,15,4,-10,1,0,0,0,0,1,0,1,0, ldraw_lib__4_4disc(realsolid)],
...
module ldraw_lib__3623p01(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3623p01(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
