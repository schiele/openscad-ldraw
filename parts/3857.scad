...
use <../p/stug-8x8.scad>
$fa=1; $fs=0.2;
function ldraw_lib__3857(realsolid=false) = [
...
// 1 16 0 0 0 1 0 0 0 1 0 0 0 1 s\3857s01.dat
  [1,16,0,0,0,1,0,0,0,1,0,0,0,1, ldraw_lib__s__3857s01(realsolid)],
// 1 16 -240 0 -80 0 0 1 0 1 0 -1 0 0 stug-8x8.dat
  [1,16,-240,0,-80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_8x8(realsolid)],
// 1 16 -240 0 80 0 0 1 0 1 0 -1 0 0 stug-8x8.dat
  [1,16,-240,0,80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_8x8(realsolid)],
// 1 16 -80 0 -80 0 0 1 0 1 0 -1 0 0 stug-8x8.dat
  [1,16,-80,0,-80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_8x8(realsolid)],
// 1 16 -80 0 80 0 0 1 0 1 0 -1 0 0 stug-8x8.dat
  [1,16,-80,0,80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_8x8(realsolid)],
// 1 16 80 0 -80 0 0 1 0 1 0 -1 0 0 stug-8x8.dat
  [1,16,80,0,-80,0,0,1,0,1,0,-1,0,0, ldraw_lib__stug_8x8(realsolid)],
...
module ldraw_lib__3857(step=0, col=false, unit=2/5, alt=false, line=0.2, solid=!$preview)
    makepoly(ldraw_lib__3857(solid), step=step, col=col, unit=unit, alt=alt, line=line, solid=solid);
